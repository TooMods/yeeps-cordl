...
public:
  ...
  /// @brief Method GetLogicalOperationStack, addr 0x12b48a0, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Collections::Stack* GetLogicalOperationStack();

  static inline ::System::Diagnostics::CorrelationManager* New_ctor();

  /// @brief Method .ctor, addr 0x12b4894, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LogicalOperationStack, addr 0x12b489c, size 0x4, virtual false, abstract: false, final false
