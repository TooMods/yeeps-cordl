...
public:
  // Declarations
  /// @brief Method .ctor, addr 0xfa2080, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckIndexCondition, addr 0xfa2ae0, size 0x6c, virtual false, abstract: false, final false
  inline void CheckIndexCondition(int32_t attributeIndex);

  /// @brief Method DefaultLookupNamespace, addr 0xfa41a8, size 0x138, virtual false, abstract: false, final false
  inline ::StringW DefaultLookupNamespace(::StringW prefix);

  /// @brief Method GetAttribute, addr 0xfa32a8, size 0x1d4, virtual false, abstract: false, final false
  inline ::StringW GetAttribute(int32_t attributeIndex);

  /// @brief Method GetAttribute, addr 0xfa2ef4, size 0x19c, virtual false, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0xfa30d8, size 0x1d0, virtual false, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW ns);

  /// @brief Method GetAttributeFromElement, addr 0xfa2eb0, size 0x44, virtual false, abstract: false, final false
  inline ::StringW GetAttributeFromElement(::System::Xml::XmlElement* elem, ::StringW name);

  /// @brief Method GetAttributeFromElement, addr 0xfa3090, size 0x48, virtual false, abstract: false, final false
  inline ::StringW GetAttributeFromElement(::System::Xml::XmlElement* elem, ::StringW name, ::StringW ns);

  /// @brief Method GetDecAttrInd, addr 0xfa2c80, size 0x98, virtual false, abstract: false, final false
  inline int32_t GetDecAttrInd(::StringW name);

  /// @brief Method GetDeclarationAttr, addr 0xfa2b4c, size 0xe0, virtual false, abstract: false, final false
  inline ::StringW GetDeclarationAttr(::System::Xml::XmlDeclaration* decl, ::StringW name);

  /// @brief Method GetDeclarationAttr, addr 0xfa2c2c, size 0x54, virtual false, abstract: false, final false
  inline ::StringW GetDeclarationAttr(int32_t i);

  /// @brief Method GetDocTypeAttrInd, addr 0xfa2e18, size 0x98, virtual false, abstract: false, final false
  inline int32_t GetDocTypeAttrInd(::StringW name);

  /// @brief Method GetDocumentTypeAttr, addr 0xfa2d18, size 0xac, virtual false, abstract: false, final false
  inline ::StringW GetDocumentTypeAttr(::System::Xml::XmlDocumentType* docType, ::StringW name);

  /// @brief Method GetDocumentTypeAttr, addr 0xfa2dc4, size 0x54, virtual false, abstract: false, final false
  inline ::StringW GetDocumentTypeAttr(int32_t i);

  /// @brief Method GetNamespacesInScope, addr 0xfa46a4, size 0x4b4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method InitDecAttr, addr 0xfa2554, size 0x134, virtual false, abstract: false, final false
  inline void InitDecAttr();

  /// @brief Method InitDocTypeAttr, addr 0xfa2a0c, size 0xd4, virtual false, abstract: false, final false
  inline void InitDocTypeAttr();

  /// @brief Method IsLocalNameEmpty, addr 0xfa21e0, size 0x24, virtual false, abstract: false, final false
  inline bool IsLocalNameEmpty(::System::Xml::XmlNodeType nt);

  /// @brief Method LogMove, addr 0xfa347c, size 0x24, virtual false, abstract: false, final false
  inline void LogMove(int32_t level);

  /// @brief Method LookupNamespace, addr 0xfa3efc, size 0x2ac, virtual false, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0xfa42e0, size 0x3c4, virtual false, abstract: false, final false
  inline ::StringW LookupPrefix(::StringW namespaceName);

  /// @brief Method MoveToAttribute, addr 0xfa3768, size 0x60, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0xfa37c8, size 0x158, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW name, ::StringW namespaceURI);

  /// @brief Method MoveToAttribute, addr 0xfa39d8, size 0x1cc, virtual false, abstract: false, final false
  inline void MoveToAttribute(int32_t attributeIndex);

  /// @brief Method MoveToAttributeFromElement, addr 0xfa3920, size 0xb8, virtual false, abstract: false, final false
  inline bool MoveToAttributeFromElement(::System::Xml::XmlElement* elem, ::StringW name, ::StringW ns);

  /// @brief Method MoveToElement, addr 0xfa3e7c, size 0x80, virtual false, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstChild, addr 0xfa3da8, size 0x48, virtual false, abstract: false, final false
  inline bool MoveToFirstChild();

  /// @brief Method MoveToNext, addr 0xfa3e3c, size 0x40, virtual false, abstract: false, final false
  inline bool MoveToNext();

  /// @brief Method MoveToNextAttribute, addr 0xfa3ba4, size 0x1c4, virtual false, abstract: false, final false
  inline bool MoveToNextAttribute(ByRef<int32_t> level);

  /// @brief Method MoveToNextSibling, addr 0xfa3df0, size 0x4c, virtual false, abstract: false, final false
  inline bool MoveToNextSibling(::System::Xml::XmlNode* node);

  /// @brief Method MoveToParent, addr 0xfa3d68, size 0x40, virtual false, abstract: false, final false
  inline bool MoveToParent();

  static inline ::System::Xml::XmlNodeReaderNavigator* New_ctor(::System::Xml::XmlNode* node);

  /// @brief Method ReadAttributeValue, addr 0xfa4b58, size 0x1c0, virtual false, abstract: false, final false
  inline bool ReadAttributeValue(ByRef<int32_t> level, ByRef<bool> bResolveEntity, ByRef<::System::Xml::XmlNodeType> nt);

  /// @brief Method ResetMove, addr 0xfa359c, size 0x1cc, virtual false, abstract: false, final false
  inline void ResetMove(ByRef<int32_t> level, ByRef<::System::Xml::XmlNodeType> nt);

  /// @brief Method ResetToAttribute, addr 0xfa3504, size 0x98, virtual false, abstract: false, final false
  inline void ResetToAttribute(ByRef<int32_t> level);

  /// @brief Method RollBackMove, addr 0xfa34a0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa1eb0, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* node);

  /// @brief Method get_AttributeCount, addr 0xfa28a8, size 0x164, virtual false, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0xfa2688, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CreatedOnAttribute, addr 0xfa22b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CreatedOnAttribute();

  /// @brief Method get_Document, addr 0xfa4d18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_Document();

  /// @brief Method get_IsDefault, addr 0xfa27a0, size 0xdc, virtual false, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0xfa26f4, size 0xac, virtual false, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_IsOnDeclOrDocType, addr 0xfa34cc, size 0x38, virtual false, abstract: false, final false
  inline bool get_IsOnDeclOrDocType();

  /// @brief Method get_LocalName, addr 0xfa2204, size 0xac, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xfa20f0, size 0xf0, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0xfa28a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0xfa20cc, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0xfa2088, size 0x44, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0xfa22b8, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_SchemaInfo, addr 0xfa287c, size 0x24, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Value, addr 0xfa22dc, size 0x278, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XmlLang, addr 0xfa26d0, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0xfa26ac, size 0x24, virtual false, abstract: false, final false
