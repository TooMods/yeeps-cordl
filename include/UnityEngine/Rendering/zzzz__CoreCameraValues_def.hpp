...
public:
  ...
  /// @brief Method Equals, addr 0x2a99108, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a990d4, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::CoreCameraValues other);

  /// @brief Method GetHashCode, addr 0x2a991a0, size 0x20, virtual true, abstract: false, final false
