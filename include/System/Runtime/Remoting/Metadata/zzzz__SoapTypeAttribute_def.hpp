...
public:
  ...
  /// @brief Method SetReflectionObject, addr 0x185b68c, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x185b64c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInteropXmlElement, addr 0x185b67c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInteropXmlElement();

  /// @brief Method get_IsInteropXmlType, addr 0x185b684, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInteropXmlType();

  /// @brief Method get_UseAttribute, addr 0x185b654, size 0x8, virtual true, abstract: false, final false
  inline bool get_UseAttribute();

  /// @brief Method get_XmlElementName, addr 0x185b65c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlElementName();

  /// @brief Method get_XmlNamespace, addr 0x185b664, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_XmlNamespace();

  /// @brief Method get_XmlTypeName, addr 0x185b66c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlTypeName();

  /// @brief Method get_XmlTypeNamespace, addr 0x185b674, size 0x8, virtual false, abstract: false, final false
