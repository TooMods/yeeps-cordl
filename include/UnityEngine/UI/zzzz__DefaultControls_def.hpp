...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x1ffdd0c, size 0x74, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::GameObject> CreateGameObject(::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> components);

  static inline ::UnityEngine::UI::__DefaultControls__DefaultRuntimeFactory* New_ctor();

  /// @brief Method .ctor, addr 0x1ffdd80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateUIObject, addr 0x1ff95fc, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultColorTransitionValues, addr 0x1ff9900, size 0x10, virtual false, abstract: false, final false
  static inline void SetDefaultColorTransitionValues(::UnityEngine::UI::Selectable* slider);

  /// @brief Method SetDefaultTextValues, addr 0x1ff9824, size 0xdc, virtual false, abstract: false, final false
  static inline void SetDefaultTextValues(::UnityEngine::UI::Text* lbl);

  /// @brief Method SetLayerRecursively, addr 0x1ff9910, size 0xe4, virtual false, abstract: false, final false
  static inline void SetLayerRecursively(::UnityEngine::GameObject* go, int32_t layer);

  /// @brief Method SetParentAndAlign, addr 0x1ff9724, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method get_factory, addr 0x1ff9444, size 0x58, virtual false, abstract: false, final false
