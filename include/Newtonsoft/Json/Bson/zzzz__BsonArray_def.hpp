...
public:
  ...
  /// @brief Method Add, addr 0x2f64c84, size 0xb0, virtual false, abstract: false, final false
  inline void Add(::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x2f62b54, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2f64d3c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f64d40, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x2f64d34, size 0x8, virtual true, abstract: false, final false
