...
public:
  ...
  /// @brief Method MoveNext, addr 0x1ce3428, size 0xa0, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::Schema::XmlSchemaCollectionEnumerator* New_ctor(::System::Collections::Hashtable* collection);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x1ce3908, size 0xa0, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1ce3864, size 0xa4, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1ce39a8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ce318c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* collection);

  /// @brief Method get_Current, addr 0x1ce3350, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_Current();

  /// @brief Method get_CurrentNode, addr 0x1ce39ac, size 0xd4, virtual false, abstract: false, final false
