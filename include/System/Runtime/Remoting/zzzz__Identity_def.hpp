...
public:
  ...
  /// @brief Method NotifyClientDynamicSinks, addr 0x19744d0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyServerDynamicSinks, addr 0x1974544, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19743dc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri);

  /// @brief Method get_ChannelSink, addr 0x1974404, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_ChannelSink();

  /// @brief Method get_ClientDynamicProperties, addr 0x1974450, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Contexts::DynamicPropertyCollection* get_ClientDynamicProperties();

  /// @brief Method get_Disposed, addr 0x197443c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Disposed();

  /// @brief Method get_EnvoySink, addr 0x1974414, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_EnvoySink();

  /// @brief Method get_HasServerDynamicSinks, addr 0x19744bc, size 0x14, virtual false, abstract: false, final false
  inline bool get_HasServerDynamicSinks();

  /// @brief Method get_IsConnected, addr 0x197442c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsConnected();

  /// @brief Method get_ObjectUri, addr 0x197441c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ObjectUri();

  /// @brief Method set_ChannelSink, addr 0x197440c, size 0x8, virtual false, abstract: false, final false
  inline void set_ChannelSink(::System::Runtime::Remoting::Messaging::IMessageSink* value);

  /// @brief Method set_Disposed, addr 0x1974444, size 0xc, virtual false, abstract: false, final false
  inline void set_Disposed(bool value);

  /// @brief Method set_ObjectUri, addr 0x1974424, size 0x8, virtual false, abstract: false, final false
