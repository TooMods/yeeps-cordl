...
public:
  ...
  /// @brief Method GetTimestamp, addr 0x12b645c, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetTimestamp();

  static inline ::System::Diagnostics::Stopwatch* New_ctor();

  /// @brief Method Reset, addr 0x12bff40, size 0xc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Restart, addr 0x12bffc4, size 0x60, virtual false, abstract: false, final false
  inline void Restart();

  /// @brief Method Start, addr 0x12bfc4c, size 0x68, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartNew, addr 0x12bfbe0, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::Stopwatch* StartNew();

  /// @brief Method Stop, addr 0x12bff4c, size 0x78, virtual false, abstract: false, final false
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x12bfc44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Elapsed, addr 0x12bfcb4, size 0xf8, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_Elapsed();

  /// @brief Method get_ElapsedMilliseconds, addr 0x12bfe1c, size 0x11c, virtual false, abstract: false, final false
  inline int64_t get_ElapsedMilliseconds();

  /// @brief Method get_ElapsedTicks, addr 0x12bfdac, size 0x70, virtual false, abstract: false, final false
  inline int64_t get_ElapsedTicks();

  /// @brief Method get_IsRunning, addr 0x12bff38, size 0x8, virtual false, abstract: false, final false
