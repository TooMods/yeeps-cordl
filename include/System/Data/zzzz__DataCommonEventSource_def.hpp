...
public:
  ...
  /// @brief Method EnterScope, addr 0x24063bc, size 0xc4, virtual false, abstract: false, final false
  inline int64_t EnterScope(::StringW message);

  /// @brief Method ExitScope, addr 0x2406480, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x24063ac, size 0x10, virtual false, abstract: false, final false
  inline void Trace(::StringW message);

  /// @brief Method .ctor, addr 0x2406490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
