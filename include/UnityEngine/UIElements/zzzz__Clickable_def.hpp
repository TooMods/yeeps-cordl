...
public:
  ...
  /// @brief Method ContainsPointer, addr 0x2a3b090, size 0x88, virtual false, abstract: false, final false
  inline bool ContainsPointer(int32_t pointerId);

  /// @brief Method Invoke, addr 0x2a3b118, size 0x58, virtual false, abstract: false, final false
  inline void Invoke(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method IsNotMouseEvent, addr 0x2a3c48c, size 0x64, virtual false, abstract: false, final false
  static inline bool IsNotMouseEvent(int32_t pointerId);

  /// @brief Method IsRepeatable, addr 0x2a3b06c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method OnMouseCaptureOut, addr 0x2a3bd70, size 0x84, virtual false, abstract: false, final false
  inline void OnMouseCaptureOut(::UnityEngine::UIElements::MouseCaptureOutEvent* evt);

  /// @brief Method OnMouseDown, addr 0x2a3bb8c, size 0xb8, virtual false, abstract: false, final false
  inline void OnMouseDown(::UnityEngine::UIElements::MouseDownEvent* evt);

  /// @brief Method OnMouseMove, addr 0x2a3bc44, size 0x6c, virtual false, abstract: false, final false
  inline void OnMouseMove(::UnityEngine::UIElements::MouseMoveEvent* evt);

  /// @brief Method OnMouseUp, addr 0x2a3bcb0, size 0xc0, virtual false, abstract: false, final false
  inline void OnMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnPointerCancel, addr 0x2a3c404, size 0x88, virtual false, abstract: false, final false
  inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent* evt);

  /// @brief Method OnPointerCaptureOut, addr 0x2a3c4f0, size 0x78, virtual false, abstract: false, final false
  inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent* evt);

  /// @brief Method OnPointerDown, addr 0x2a3bdf4, size 0x124, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnPointerMove, addr 0x2a3c10c, size 0x118, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* evt);

  /// @brief Method OnPointerUp, addr 0x2a3c224, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* evt);

  /// @brief Method OnTimer, addr 0x2a3afc0, size 0xac, virtual false, abstract: false, final false
  inline void OnTimer(::UnityEngine::UIElements::TimerState timerState);

  /// @brief Method ProcessCancelEvent, addr 0x2a3ccd4, size 0x16c, virtual true, abstract: false, final false
  inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase* evt, int32_t pointerId);

  /// @brief Method ProcessDownEvent, addr 0x2a3c758, size 0x360, virtual true, abstract: false, final false
  inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::Vector2 localPosition, int32_t pointerId);

  /// @brief Method ProcessMoveEvent, addr 0x2a3cab8, size 0x74, virtual true, abstract: false, final false
  inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::Vector2 localPosition);

  /// @brief Method ProcessUpEvent, addr 0x2a3cb2c, size 0x1a8, virtual true, abstract: false, final false
  inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::Vector2 localPosition, int32_t pointerId);

  /// @brief Method RegisterCallbacksOnTarget, addr 0x2a3b170, size 0x520, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method SimulateSingleClick, addr 0x2a3c584, size 0x1d4, virtual false, abstract: false, final false
  inline void SimulateSingleClick(::UnityEngine::UIElements::EventBase* evt, int32_t delayMs);

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x2a3b690, size 0x4fc, virtual true, abstract: false, final false
  inline void UnregisterCallbacksFromTarget();

  /// @brief Method <SimulateSingleClick>b__43_0, addr 0x2a3ce40, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a3ae2c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Action* handler);

  /// @brief Method .ctor, addr 0x2a3ae00, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Action* handler, int64_t delay, int64_t interval);

  /// @brief Method .ctor, addr 0x2a3aef4, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Action_1<::UnityEngine::UIElements::EventBase*>* handler);

  /// @brief Method get_acceptClicksIfDisabled, addr 0x2a3adf0, size 0x8, virtual false, abstract: false, final false
  inline bool get_acceptClicksIfDisabled();

  /// @brief Method get_active, addr 0x2a3adcc, size 0x8, virtual false, abstract: false, final false
  inline bool get_active();

  /// @brief Method get_invokePolicy, addr 0x2a3adf8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::InvokePolicy get_invokePolicy();

  /// @brief Method get_lastMousePosition, addr 0x2a3ade0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_lastMousePosition();

  /// @brief Method set_active, addr 0x2a3add4, size 0xc, virtual false, abstract: false, final false
  inline void set_active(bool value);

  /// @brief Method set_lastMousePosition, addr 0x2a3ade8, size 0x8, virtual false, abstract: false, final false
