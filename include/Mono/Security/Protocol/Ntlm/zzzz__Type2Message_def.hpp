...
public:
  ...
  /// @brief Method Decode, addr 0x246d7e0, size 0x180, virtual true, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> message);

  /// @brief Method Finalize, addr 0x246d730, size 0xa8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x246d960, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246d68c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> message);

  /// @brief Method get_Nonce, addr 0x246c774, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Nonce();

  /// @brief Method get_TargetInfo, addr 0x246c6fc, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_TargetInfo();

  /// @brief Method get_TargetName, addr 0x246d7d8, size 0x8, virtual false, abstract: false, final false
