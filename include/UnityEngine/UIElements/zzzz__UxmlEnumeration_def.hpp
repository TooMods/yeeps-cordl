...
public:
  ...
  /// @brief Method Equals, addr 0x27de9ac, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27deaf8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_values, addr 0x27de948, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_values();

  /// @brief Method set_values, addr 0x27de950, size 0x5c, virtual false, abstract: false, final false
