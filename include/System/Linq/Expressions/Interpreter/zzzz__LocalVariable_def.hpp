...
public:
  ...
  /// @brief Method ToString, addr 0x1b53550, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b5350c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, bool closure);

  /// @brief Method get_InClosure, addr 0x1b4e0f0, size 0xc, virtual false, abstract: false, final false
  inline bool get_InClosure();

  /// @brief Method get_IsBoxed, addr 0x1b4e0fc, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsBoxed();

  /// @brief Method set_IsBoxed, addr 0x1b534f0, size 0x1c, virtual false, abstract: false, final false
