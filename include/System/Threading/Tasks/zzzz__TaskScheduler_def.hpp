...
public:
  ...
  /// @brief Method FromCurrentSynchronizationContext, addr 0xedeb6c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyWorkItemProgress, addr 0xedeb00, size 0x4, virtual true, abstract: false, final false
  inline void NotifyWorkItemProgress();

  /// @brief Method PublishUnobservedTaskException, addr 0xeddb20, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method TryDequeue, addr 0xedeaf8, size 0x8, virtual true, abstract: false, final false
  inline bool TryDequeue(::System::Threading::Tasks::Task* task);

  /// @brief Method TryExecuteTask, addr 0xedec7c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method TryRunInline, addr 0xed5914, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedeb0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Current, addr 0xed51d4, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_Current();

  /// @brief Method get_Default, addr 0xedeb14, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_Default();

  /// @brief Method get_Id, addr 0xed9210, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_InternalCurrent, addr 0xed8728, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_InternalCurrent();

  /// @brief Method get_RequiresAtomicStartTransition, addr 0xedeb04, size 0x8, virtual true, abstract: false, final false
