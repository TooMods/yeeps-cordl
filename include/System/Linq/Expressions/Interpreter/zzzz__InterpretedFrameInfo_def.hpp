...
public:
  // Declarations
  /// @brief Method ToString, addr 0x1a997e0, size 0x78, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1a95e88, size 0x8, virtual false, abstract: false, final false
