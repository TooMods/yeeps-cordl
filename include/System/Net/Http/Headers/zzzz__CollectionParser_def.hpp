...
public:
  ...
  /// @brief Method TryParse, addr 0x1621ca4, size 0xb0, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, int32_t minimalCount, ByRef<::System::Collections::Generic::List_1<::StringW>*> result);

  /// @brief Method TryParseStringElement, addr 0x1621d54, size 0xcc, virtual false, abstract: false, final false
