...
public:
  ...
  /// @brief Method ComputeWorldPosition, addr 0x25b38e0, size 0x2b4, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::Vector3> ComputeWorldPosition(::UnityEngine::Camera* camera);

  /// @brief Method ComputeWorldRotation, addr 0x25b40b8, size 0x2fc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::Quaternion> ComputeWorldRotation(::UnityEngine::Camera* camera);

  /// @brief Method .ctor, addr 0x25b3570, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsPositionTracked, addr 0x25b3828, size 0x5c, virtual false, abstract: false, final false
  inline bool get_IsPositionTracked();

  /// @brief Method get_IsRotationTracked, addr 0x25b3884, size 0x5c, virtual false, abstract: false, final false
  inline bool get_IsRotationTracked();

  /// @brief Method get_Position, addr 0x25b3808, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::Vector3> get_Position();

  /// @brief Method get_Rotation, addr 0x25b3814, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x25b3324, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x25b32fc, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRLocatable other);

  /// @brief Method GetHashCode, addr 0x25b339c, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRLocatable>.FromAnchor, addr 0x25b3154, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRLocatable IOVRAnchorComponent_OVRLocatable__FromAnchor(::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method IOVRAnchorComponent<OVRLocatable>.get_Handle, addr 0x25b314c, size 0x8, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRLocatable__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRLocatable>.get_Type, addr 0x25b313c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRLocatable__get_Type();

  /// @brief Method SetEnabledAsync, addr 0x25b3220, size 0xdc, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRTask_1<bool> SetEnabledAsync(bool enabled, double_t timeout);

  /// @brief Method ToString, addr 0x25b33e4, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetSceneAnchorPose, addr 0x25b3470, size 0xf8, virtual false, abstract: false, final false
  inline bool TryGetSceneAnchorPose(ByRef<::GlobalNamespace::__OVRLocatable__TrackingSpacePose> pose);

  /// @brief Method TryGetSpatialAnchorPose, addr 0x25b3700, size 0xf8, virtual false, abstract: false, final false
  inline bool TryGetSpatialAnchorPose(ByRef<::GlobalNamespace::__OVRLocatable__TrackingSpacePose> pose);

  /// @brief Method .ctor, addr 0x25b315c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  static inline ::GlobalNamespace::OVRLocatable getStaticF_Null();

  /// @brief Method get_Handle, addr 0x25b3468, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x25b3178, size 0xa8, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x25b3168, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Type, addr 0x25b3144, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x25b330c, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRLocatable lhs, ::GlobalNamespace::OVRLocatable rhs);

  /// @brief Method op_Inequality, addr 0x25b3318, size 0xc, virtual false, abstract: false, final false
