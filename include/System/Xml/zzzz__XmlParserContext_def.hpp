...
public:
  ...
  /// @brief Method .ctor, addr 0x14d39e8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14d3a14, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nt, ::System::Xml::XmlNamespaceManager* nsMgr, ::StringW docTypeName, ::StringW pubId, ::StringW sysId, ::StringW internalSubset, ::StringW baseURI,
                    ::StringW xmlLang, ::System::Xml::XmlSpace xmlSpace, ::System::Text::Encoding* enc);

  /// @brief Method .ctor, addr 0x14d3948, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseURI, addr 0x14d3bf8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_DocTypeName, addr 0x14d3be0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DocTypeName();

  /// @brief Method get_Encoding, addr 0x14d3c18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_HasDtdInfo, addr 0x14d3c20, size 0x9c, virtual false, abstract: false, final false
  inline bool get_HasDtdInfo();

  /// @brief Method get_InternalSubset, addr 0x14d3c00, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InternalSubset();

  /// @brief Method get_NameTable, addr 0x14d3bd0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceManager, addr 0x14d3bd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNamespaceManager* get_NamespaceManager();

  /// @brief Method get_PublicId, addr 0x14d3be8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PublicId();

  /// @brief Method get_SystemId, addr 0x14d3bf0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SystemId();

  /// @brief Method get_XmlLang, addr 0x14d3c08, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x14d3c10, size 0x8, virtual false, abstract: false, final false
