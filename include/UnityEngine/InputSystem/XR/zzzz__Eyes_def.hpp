...
public:
  ...
  /// @brief Method get_fixationPoint, addr 0x1d3b4c0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_fixationPoint();

  /// @brief Method get_leftEyeOpenAmount, addr 0x1d3b4d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_leftEyeOpenAmount();

  /// @brief Method get_leftEyePosition, addr 0x1d3b460, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftEyePosition();

  /// @brief Method get_leftEyeRotation, addr 0x1d3b478, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_leftEyeRotation();

  /// @brief Method get_rightEyeOpenAmount, addr 0x1d3b4e8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rightEyeOpenAmount();

  /// @brief Method get_rightEyePosition, addr 0x1d3b490, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightEyePosition();

  /// @brief Method get_rightEyeRotation, addr 0x1d3b4a8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rightEyeRotation();

  /// @brief Method set_fixationPoint, addr 0x1d3b4cc, size 0xc, virtual false, abstract: false, final false
  inline void set_fixationPoint(::UnityEngine::Vector3 value);

  /// @brief Method set_leftEyeOpenAmount, addr 0x1d3b4e0, size 0x8, virtual false, abstract: false, final false
  inline void set_leftEyeOpenAmount(float_t value);

  /// @brief Method set_leftEyePosition, addr 0x1d3b46c, size 0xc, virtual false, abstract: false, final false
  inline void set_leftEyePosition(::UnityEngine::Vector3 value);

  /// @brief Method set_leftEyeRotation, addr 0x1d3b484, size 0xc, virtual false, abstract: false, final false
  inline void set_leftEyeRotation(::UnityEngine::Quaternion value);

  /// @brief Method set_rightEyeOpenAmount, addr 0x1d3b4f0, size 0x8, virtual false, abstract: false, final false
  inline void set_rightEyeOpenAmount(float_t value);

  /// @brief Method set_rightEyePosition, addr 0x1d3b49c, size 0xc, virtual false, abstract: false, final false
  inline void set_rightEyePosition(::UnityEngine::Vector3 value);

  /// @brief Method set_rightEyeRotation, addr 0x1d3b4b4, size 0xc, virtual false, abstract: false, final false
