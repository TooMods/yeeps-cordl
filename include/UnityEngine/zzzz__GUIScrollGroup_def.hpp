...
public:
  ...
  /// @brief Method CalcHeight, addr 0x2014a90, size 0xfc, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x20148f0, size 0x7c, virtual true, abstract: false, final false
  inline void CalcWidth();

  static inline ::UnityEngine::GUIScrollGroup* New_ctor();

  /// @brief Method SetHorizontal, addr 0x201496c, size 0x124, virtual true, abstract: false, final false
  inline void SetHorizontal(float_t x, float_t width);

  /// @brief Method SetVertical, addr 0x2014b8c, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2014894, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
