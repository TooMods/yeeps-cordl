...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce6088, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_Language, addr 0x1ce5fb0, size 0xd0, virtual false, abstract: false, final false
  inline void set_Language(::StringW value);

  /// @brief Method set_Markup, addr 0x1ce6080, size 0x8, virtual false, abstract: false, final false
  inline void set_Markup(::ArrayW<::System::Xml::XmlNode*, ::Array<::System::Xml::XmlNode*>*> value);

  /// @brief Method set_Source, addr 0x1ce5fa8, size 0x8, virtual false, abstract: false, final false
