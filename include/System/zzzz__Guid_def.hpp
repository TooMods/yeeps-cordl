...
public:
  ...
  /// @brief Method CompareTo, addr 0x30d2574, size 0xdc, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Guid value);

  /// @brief Method CompareTo, addr 0x30d23e8, size 0x18c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method EatAllWhitespace, addr 0x30d16d4, size 0x23c, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> EatAllWhitespace(::System::ReadOnlySpan_1<char16_t> str);

  /// @brief Method Equals, addr 0x30d2394, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::System::Guid g);

  /// @brief Method Equals, addr 0x30d22ec, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x30d22d4, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetResult, addr 0x30d23d8, size 0x10, virtual false, abstract: false, final false
  inline int32_t GetResult(uint32_t me, uint32_t them);

  /// @brief Method HexToChar, addr 0x30d26d4, size 0x1c, virtual false, abstract: false, final false
  static inline char16_t HexToChar(int32_t a);

  /// @brief Method HexsToChars, addr 0x30d26f0, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t HexsToChars(::cordl_internals::Ptr<char16_t> guidChars, int32_t a, int32_t b);

  /// @brief Method HexsToCharsHexOutput, addr 0x30d276c, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t HexsToCharsHexOutput(::cordl_internals::Ptr<char16_t> guidChars, int32_t a, int32_t b);

  /// @brief Method IsHexPrefix, addr 0x30d1910, size 0xcc, virtual false, abstract: false, final false
  static inline bool IsHexPrefix(::System::ReadOnlySpan_1<char16_t> str, int32_t i);

  /// @brief Method NewGuid, addr 0x30cff20, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Guid NewGuid();

  /// @brief Method Parse, addr 0x30d0664, size 0x98, virtual false, abstract: false, final false
  static inline ::System::Guid Parse(::StringW input);

  /// @brief Method Parse, addr 0x30d06fc, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Guid Parse(::System::ReadOnlySpan_1<char16_t> input);

  /// @brief Method StringToInt, addr 0x30d1bac, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToInt, addr 0x30d19e8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToLong, addr 0x30d1a58, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToShort, addr 0x30d1da0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToShort, addr 0x30d1a14, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method System.ISpanFormattable.TryFormat, addr 0x30d2c2c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method ToByteArray, addr 0x30d1ef4, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToByteArray();

  /// @brief Method ToString, addr 0x30d2070, size 0x48, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x30d26d0, size 0x4, virtual false, abstract: false, final false
  inline ::StringW ToString(::StringW format);

  /// @brief Method ToString, addr 0x30d20b8, size 0x21c, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method TryFormat, addr 0x30d2808, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x30d0760, size 0x90, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Guid> result);

  /// @brief Method TryParse, addr 0x30d07f0, size 0x50, virtual false, abstract: false, final false
  static inline bool TryParse(::System::ReadOnlySpan_1<char16_t> input, ByRef<::System::Guid> result);

  /// @brief Method TryParseExact, addr 0x30d0840, size 0xc4, virtual false, abstract: false, final false
  static inline bool TryParseExact(::StringW input, ::StringW format, ByRef<::System::Guid> result);

  /// @brief Method TryParseExact, addr 0x30d0904, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuid, addr 0x30d02a0, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuidWithDashes, addr 0x30d0a70, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuidWithHexPrefix, addr 0x30d0d34, size 0x674, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuidWithNoStyle, addr 0x30d13a8, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteByteHelper, addr 0x30d1de4, size 0x110, virtual false, abstract: false, final false
  inline void WriteByteHelper(::System::Span_1<uint8_t> destination);

  /// @brief Method .ctor, addr 0x30d016c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30d012c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30cff6c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method .ctor, addr 0x30d0004, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<uint8_t> b);

  /// @brief Method .ctor, addr 0x30d01ac, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x30d2650, size 0x40, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Guid a, ::System::Guid b);

  /// @brief Method op_Inequality, addr 0x30d2690, size 0x40, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetGuidParseException, addr 0x30d04e8, size 0x17c, virtual false, abstract: false, final false
  inline ::System::Exception* GetGuidParseException();

  /// @brief Method Init, addr 0x30d2c30, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::__Guid__GuidParseThrowStyle canThrow);

  /// @brief Method SetFailure, addr 0x30d0a60, size 0x10, virtual false, abstract: false, final false
  inline void SetFailure(::System::__Guid__ParseFailureKind failure, ::StringW failureMessageID);

  /// @brief Method SetFailure, addr 0x30d19dc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x30d1694, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x30d1dd4, size 0x10, virtual false, abstract: false, final false
