...
public:
  ...
  /// @brief Method CanStartDrag, addr 0x27d9254, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetupDragAndDrop, addr 0x27d925c, size 0x5d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27d8dec, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView* view);

  /// @brief Method get_enableReordering, addr 0x27d9240, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_enableReordering, addr 0x27d9248, size 0xc, virtual true, abstract: false, final true
