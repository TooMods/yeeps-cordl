...
public:
  // Declarations
  /// @brief Method CountDigits, addr 0x2609bbc, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t CountDigits(uint32_t value);

  /// @brief Method CountDigits, addr 0x2609b00, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t CountDigits(uint64_t value);

  /// @brief Method CountHexDigits, addr 0x2609c28, size 0x48, virtual false, abstract: false, final false
