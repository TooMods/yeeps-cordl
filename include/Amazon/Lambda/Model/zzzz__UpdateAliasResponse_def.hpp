...
CORDL_MODULE_EXPORT(UpdateAliasResponse)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::Lambda::Model::UpdateAliasResponse);
// Type: Amazon.Lambda.Model::UpdateAliasResponse
// SizeInfo { instance_size: 88, native_size: -1, calculated_instance_size: 88, calculated_native_size: 88, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::Amazon.Lambda.Model::UpdateAliasResponse*
class CORDL_TYPE UpdateAliasResponse : public ::Amazon::Runtime::AmazonWebServiceResponse {
public:
  // Declarations
  ...
  /// @brief Method IsSetAliasArn, addr 0x3109790, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetAliasArn();

  /// @brief Method IsSetDescription, addr 0x31097b0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetDescription();

  /// @brief Method IsSetFunctionVersion, addr 0x31097d0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetFunctionVersion();

  /// @brief Method IsSetName, addr 0x31097f0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetName();

  /// @brief Method IsSetRevisionId, addr 0x3109810, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetRevisionId();

  /// @brief Method IsSetRoutingConfig, addr 0x3109830, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetRoutingConfig();

  static inline ::Amazon::Lambda::Model::UpdateAliasResponse* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x3109840, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AliasArn, addr 0x3109780, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AliasArn();

  /// @brief Method get_Description, addr 0x31097a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_FunctionVersion, addr 0x31097c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FunctionVersion();

  /// @brief Method get_Name, addr 0x31097e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_RevisionId, addr 0x3109800, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RevisionId();

  /// @brief Method get_RoutingConfig, addr 0x3109820, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::AliasRoutingConfiguration* get_RoutingConfig();

  /// @brief Method set_AliasArn, addr 0x3109788, size 0x8, virtual false, abstract: false, final false
  inline void set_AliasArn(::StringW value);

  /// @brief Method set_Description, addr 0x31097a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Description(::StringW value);

  /// @brief Method set_FunctionVersion, addr 0x31097c8, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionVersion(::StringW value);

  /// @brief Method set_Name, addr 0x31097e8, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_RevisionId, addr 0x3109808, size 0x8, virtual false, abstract: false, final false
  inline void set_RevisionId(::StringW value);

  /// @brief Method set_RoutingConfig, addr 0x3109828, size 0x8, virtual false, abstract: false, final false
  inline void set_RoutingConfig(::Amazon::Lambda::Model::AliasRoutingConfiguration* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr UpdateAliasResponse();

public:
  // Ctor Parameters [CppParam { name: "", ty: "UpdateAliasResponse", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UpdateAliasResponse(UpdateAliasResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UpdateAliasResponse", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UpdateAliasResponse(UpdateAliasResponse const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::UpdateAliasResponse, 0x58>, "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateAliasResponse, ____aliasArn) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateAliasResponse, ____description) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateAliasResponse, ____functionVersion) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateAliasResponse, ____name) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateAliasResponse, ____revisionId) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateAliasResponse, ____routingConfig) == 0x50, "Offset mismatch!");

} // namespace Amazon::Lambda::Model
NEED_NO_BOX(::Amazon::Lambda::Model::UpdateAliasResponse);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::UpdateAliasResponse*, "Amazon.Lambda.Model", "UpdateAliasResponse");
