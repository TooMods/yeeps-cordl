...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7678, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a7680, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_GenerateProxy, addr 0x23a76bc, size 0xc, virtual false, abstract: false, final false
  inline void set_GenerateProxy(bool value);

  /// @brief Method set_Name, addr 0x23a76a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Optional, addr 0x23a76b0, size 0xc, virtual false, abstract: false, final false
