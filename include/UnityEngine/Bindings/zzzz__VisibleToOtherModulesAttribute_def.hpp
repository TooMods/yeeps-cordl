...
public:
  ...
  /// @brief Method .ctor, addr 0x23a76c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a76d0, size 0x8, virtual false, abstract: false, final false
