...
public:
  ...
  /// @brief Method Complete, addr 0xedbdbc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedaa84, size 0x114, virtual false, abstract: false, final false
