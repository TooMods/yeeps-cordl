...
public:
  ...
  /// @brief Method .ctor, addr 0x2ded450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DomainName, addr 0x2ded2d4, size 0x17c, virtual true, abstract: false, final false
  inline ::StringW get_DomainName();

  /// @brief Method getdomainname, addr 0x2ded248, size 0x8c, virtual false, abstract: false, final false
