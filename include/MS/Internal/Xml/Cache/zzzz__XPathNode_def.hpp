...
public:
  ...
  /// @brief Method GetParent, addr 0x1b3295c, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetParent(ByRef<::ArrayW<::MS::Internal::Xml::Cache::XPathNode, ::Array<::MS::Internal::Xml::Cache::XPathNode>*>> pageNode);

  /// @brief Method GetSibling, addr 0x1b32830, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetSibling(ByRef<::ArrayW<::MS::Internal::Xml::Cache::XPathNode, ::Array<::MS::Internal::Xml::Cache::XPathNode>*>> pageNode);

  /// @brief Method get_CollapsedLinePosition, addr 0x1b32c54, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_CollapsedLinePosition();

  /// @brief Method get_Document, addr 0x1b3257c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Xml::XPath::XPathDocument* get_Document();

  /// @brief Method get_HasCollapsedText, addr 0x1b32cdc, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasCollapsedText();

  /// @brief Method get_HasNamespaceDecls, addr 0x1b32d48, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasNamespaceDecls();

  /// @brief Method get_HasSibling, addr 0x1b32ccc, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasSibling();

  /// @brief Method get_IsText, addr 0x1b32ce8, size 0x60, virtual false, abstract: false, final false
  inline bool get_IsText();

  /// @brief Method get_IsXmlNamespaceNode, addr 0x1b327a8, size 0x88, virtual false, abstract: false, final false
  inline bool get_IsXmlNamespaceNode();

  /// @brief Method get_LineNumber, addr 0x1b32b88, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x1b32c80, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x1b3246c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x1b324c4, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_NodeType, addr 0x1b32424, size 0xc, virtual false, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_NodeType();

  /// @brief Method get_PageInfo, addr 0x1b32cb0, size 0x1c, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo();

  /// @brief Method get_Prefix, addr 0x1b3251c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Value, addr 0x1b32d54, size 0x8, virtual false, abstract: false, final false
