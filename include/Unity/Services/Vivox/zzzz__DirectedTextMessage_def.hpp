...
CORDL_MODULE_EXPORT(DirectedTextMessage)
...
// Write type traits
MARK_REF_PTR_T(::Unity::Services::Vivox::DirectedTextMessage);
// Type: Unity.Services.Vivox::DirectedTextMessage
// SizeInfo { instance_size: 104, native_size: -1, calculated_instance_size: 104, calculated_native_size: 104, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Unity::Services::Vivox {
// Is value type: false
// CS Name: ::Unity.Services.Vivox::DirectedTextMessage*
class CORDL_TYPE DirectedTextMessage : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = get_ApplicationStanzaBody, put = set_ApplicationStanzaBody))::StringW ApplicationStanzaBody;

  __declspec(property(get = get_ApplicationStanzaNamespace, put = set_ApplicationStanzaNamespace))::StringW ApplicationStanzaNamespace;
  ...
  /// @brief Field <ApplicationStanzaBody>k__BackingField, offset 0x60, size 0x8
  __declspec(property(get = __cordl_internal_get__ApplicationStanzaBody_k__BackingField,
                      put = __cordl_internal_set__ApplicationStanzaBody_k__BackingField))::StringW _ApplicationStanzaBody_k__BackingField;

  /// @brief Field <ApplicationStanzaNamespace>k__BackingField, offset 0x58, size 0x8
  __declspec(property(get = __cordl_internal_get__ApplicationStanzaNamespace_k__BackingField,
                      put = __cordl_internal_set__ApplicationStanzaNamespace_k__BackingField))::StringW _ApplicationStanzaNamespace_k__BackingField;

  /// @brief Field <FromSelf>k__BackingField, offset 0x48, size 0x1
  ...
  /// @brief Convert operator to "::Unity::Services::Vivox::IDirectedTextMessage"
  constexpr operator ::Unity::Services::Vivox::IDirectedTextMessage*() noexcept;
  ...
  static inline ::Unity::Services::Vivox::DirectedTextMessage* New_ctor();
  ...
  constexpr ::StringW const& __cordl_internal_get__ApplicationStanzaBody_k__BackingField() const;

  constexpr ::StringW& __cordl_internal_get__ApplicationStanzaBody_k__BackingField();

  constexpr ::StringW const& __cordl_internal_get__ApplicationStanzaNamespace_k__BackingField() const;

  constexpr ::StringW& __cordl_internal_get__ApplicationStanzaNamespace_k__BackingField();
  ...
  constexpr void __cordl_internal_set__ApplicationStanzaBody_k__BackingField(::StringW value);

  constexpr void __cordl_internal_set__ApplicationStanzaNamespace_k__BackingField(::StringW value);
  ...
  /// @brief Method .ctor, addr 0x2cac4c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PropertyChanged, addr 0x2cac244, size 0x9c, virtual true, abstract: false, final true
  inline void add_PropertyChanged(::System::ComponentModel::PropertyChangedEventHandler* value);

  /// @brief Method get_ApplicationStanzaBody, addr 0x2cac4b8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_ApplicationStanzaBody();

  /// @brief Method get_ApplicationStanzaNamespace, addr 0x2cac4a8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_ApplicationStanzaNamespace();

  /// @brief Method get_Exception, addr 0x2cac37c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Exception* get_Exception();

  /// @brief Method get_FromSelf, addr 0x2cac484, size 0x8, virtual true, abstract: false, final true
  inline bool get_FromSelf();

  /// @brief Method get_Key, addr 0x2cac434, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_Key();

  /// @brief Method get_Language, addr 0x2cac464, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_Language();

  /// @brief Method get_LoginSession, addr 0x2cac474, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Services::Vivox::ILoginSession* get_LoginSession();

  /// @brief Method get_Message, addr 0x2cac454, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_Message();

  /// @brief Method get_ReceivedTime, addr 0x2cac444, size 0x8, virtual true, abstract: false, final true
  inline ::System::DateTime get_ReceivedTime();

  /// @brief Method get_Sender, addr 0x2cac498, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Convert to "::Unity::Services::Vivox::IDirectedTextMessage"
  constexpr ::Unity::Services::Vivox::IDirectedTextMessage* i___Unity__Services__Vivox__IDirectedTextMessage() noexcept;
  ...
  /// @brief Method remove_PropertyChanged, addr 0x2cac2e0, size 0x9c, virtual true, abstract: false, final true
  inline void remove_PropertyChanged(::System::ComponentModel::PropertyChangedEventHandler* value);

  /// @brief Method set_ApplicationStanzaBody, addr 0x2cac4c0, size 0x8, virtual false, abstract: false, final false
  inline void set_ApplicationStanzaBody(::StringW value);

  /// @brief Method set_ApplicationStanzaNamespace, addr 0x2cac4b0, size 0x8, virtual false, abstract: false, final false
  inline void set_ApplicationStanzaNamespace(::StringW value);

  /// @brief Method set_Exception, addr 0x2cac384, size 0xb0, virtual false, abstract: false, final false
  inline void set_Exception(::System::Exception* value);

  /// @brief Method set_FromSelf, addr 0x2cac48c, size 0xc, virtual false, abstract: false, final false
  inline void set_FromSelf(bool value);

  /// @brief Method set_Key, addr 0x2cac43c, size 0x8, virtual false, abstract: false, final false
  inline void set_Key(::StringW value);

  /// @brief Method set_Language, addr 0x2cac46c, size 0x8, virtual false, abstract: false, final false
  inline void set_Language(::StringW value);

  /// @brief Method set_LoginSession, addr 0x2cac47c, size 0x8, virtual false, abstract: false, final false
  inline void set_LoginSession(::Unity::Services::Vivox::ILoginSession* value);

  /// @brief Method set_Message, addr 0x2cac45c, size 0x8, virtual false, abstract: false, final false
  inline void set_Message(::StringW value);

  /// @brief Method set_ReceivedTime, addr 0x2cac44c, size 0x8, virtual false, abstract: false, final false
  inline void set_ReceivedTime(::System::DateTime value);

  /// @brief Method set_Sender, addr 0x2cac4a0, size 0x8, virtual false, abstract: false, final false
  inline void set_Sender(::Unity::Services::Vivox::AccountId* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr DirectedTextMessage();

public:
  // Ctor Parameters [CppParam { name: "", ty: "DirectedTextMessage", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DirectedTextMessage(DirectedTextMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DirectedTextMessage", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DirectedTextMessage(DirectedTextMessage const&) = delete;
  ...
  /// @brief Field <FromSelf>k__BackingField, offset: 0x48, size: 0x1, def value: None
  ...
  /// @brief Field <ApplicationStanzaNamespace>k__BackingField, offset: 0x58, size: 0x8, def value: None
  ::StringW ____ApplicationStanzaNamespace_k__BackingField;

  /// @brief Field <ApplicationStanzaBody>k__BackingField, offset: 0x60, size: 0x8, def value: None
  ::StringW ____ApplicationStanzaBody_k__BackingField;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Unity::Services::Vivox::DirectedTextMessage, 0x68>, "Size mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____exception) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ___PropertyChanged) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____Key_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____ReceivedTime_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____Message_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____Language_k__BackingField) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____LoginSession_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____FromSelf_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____Sender_k__BackingField) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____ApplicationStanzaNamespace_k__BackingField) == 0x58, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::DirectedTextMessage, ____ApplicationStanzaBody_k__BackingField) == 0x60, "Offset mismatch!");

} // namespace Unity::Services::Vivox
NEED_NO_BOX(::Unity::Services::Vivox::DirectedTextMessage);
DEFINE_IL2CPP_ARG_TYPE(::Unity::Services::Vivox::DirectedTextMessage*, "Unity.Services.Vivox", "DirectedTextMessage");
