...
public:
  ...
  /// @brief Method .ctor, addr 0x1868bec, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW frameworkName);

  /// @brief Method set_FrameworkDisplayName, addr 0x1868c64, size 0x8, virtual false, abstract: false, final false
