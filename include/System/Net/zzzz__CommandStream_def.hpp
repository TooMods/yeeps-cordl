...
public:
  ...
  /// @brief Method HasFlag, addr 0x1237168, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1238478, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW command);

  /// @brief Method .ctor, addr 0x12384a0, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Abort, addr 0x123663c, size 0x1fc, virtual true, abstract: false, final false
  inline void Abort(::System::Exception* e);

  /// @brief Method BuildCommandsList, addr 0x1236f64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckContinuePipeline, addr 0x12370b4, size 0xb4, virtual false, abstract: false, final false
  inline void CheckContinuePipeline();

  /// @brief Method CheckValid, addr 0x12382fc, size 0x8, virtual true, abstract: false, final false
  inline bool CheckValid(::System::Net::ResponseDescription* response, ByRef<int32_t> validThrough, ByRef<int32_t> completeLength);

  /// @brief Method ClearState, addr 0x1236f54, size 0x10, virtual true, abstract: false, final false
  inline void ClearState();

  /// @brief Method ContinueCommandPipeline, addr 0x1236a7c, size 0x4d8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* ContinueCommandPipeline();

  /// @brief Method Dispose, addr 0x1236838, size 0x94, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GenerateException, addr 0x1236fec, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateException, addr 0x1236f6c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method InitCommandPipeline, addr 0x12369ec, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeRequestCallback, addr 0x12368cc, size 0x70, virtual false, abstract: false, final false
  inline void InvokeRequestCallback(::System::Object* obj);

  /// @brief Method MarkAsRecoverableFailure, addr 0x1236954, size 0x18, virtual false, abstract: false, final false
  inline void MarkAsRecoverableFailure();

  static inline ::System::Net::CommandStream* New_ctor(::System::Net::Sockets::TcpClient* client);

  /// @brief Method PipelineCallback, addr 0x12377d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method PostReadCommandProcessing, addr 0x12375d4, size 0x200, virtual false, abstract: false, final false
  inline bool PostReadCommandProcessing(ByRef<::System::IO::Stream*> stream);

  /// @brief Method PostSendCommandProcessing, addr 0x1237178, size 0x130, virtual false, abstract: false, final false
  inline bool PostSendCommandProcessing(ByRef<::System::IO::Stream*> stream);

  /// @brief Method ReadCallback, addr 0x12377dc, size 0x2d4, virtual false, abstract: false, final false
  static inline void ReadCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method ReceiveCommandResponse, addr 0x12372a8, size 0x32c, virtual false, abstract: false, final false
  inline ::System::Net::ResponseDescription* ReceiveCommandResponse();

  /// @brief Method ReceiveCommandResponseCallback, addr 0x1237ab0, size 0x558, virtual false, abstract: false, final false
  inline void ReceiveCommandResponseCallback(::System::Net::ReceiveState* state, int32_t bytesRead);

  /// @brief Method SubmitRequest, addr 0x123696c, size 0x80, virtual false, abstract: false, final false
  inline ::System::IO::Stream* SubmitRequest(::System::Net::WebRequest* request, bool isAsync, bool readInitalResponseOnConnect);

  /// @brief Method WriteCallback, addr 0x1238008, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12365a4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Encoding, addr 0x12382bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_RecoverableFailure, addr 0x123694c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Encoding, addr 0x12382c4, size 0x38, virtual false, abstract: false, final false
