...
public:
  ...
  /// @brief Method IsLogging, addr 0x21c5138, size 0x4, virtual false, abstract: false, final false
  static inline bool IsLogging();

  /// @brief Method Log, addr 0x21c5140, size 0x6c, virtual false, abstract: false, final false
  static inline void Log(int32_t level, ::StringW category, ::StringW message);

  /// @brief Method Log_icall, addr 0x21c513c, size 0x4, virtual false, abstract: false, final false
  static inline void Log_icall(int32_t level, ByRef<::StringW> category, ByRef<::StringW> message);

  /// @brief Method NotifyOfCrossThreadDependency, addr 0x21c51ac, size 0x4, virtual false, abstract: false, final false
