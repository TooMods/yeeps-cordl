...
public:
  ...
  /// @brief Method Awake, addr 0x16eb078, size 0x1e4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ComponentComposition, addr 0x16ec298, size 0x338, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> ComponentComposition(::UnityEngine::GameObject* GO);

  /// @brief Method InitUIComponents, addr 0x16eb314, size 0x3b4, virtual false, abstract: false, final false
  inline void InitUIComponents();

  static inline ::GlobalNamespace::OVRDebugInfo* New_ctor();

  /// @brief Method OnDestroy, addr 0x16eb964, size 0x8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RiftPresentGUI, addr 0x16ec114, size 0x184, virtual false, abstract: false, final false
  inline void RiftPresentGUI(::UnityEngine::GameObject* guiMainOBj);

  /// @brief Method Update, addr 0x16eb25c, size 0xb8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDeviceDetection, addr 0x16eb6c8, size 0x34, virtual false, abstract: false, final false
  inline void UpdateDeviceDetection();

  /// @brief Method UpdateEyeDepthOffset, addr 0x16ebca4, size 0xc0, virtual false, abstract: false, final false
  inline void UpdateEyeDepthOffset();

  /// @brief Method UpdateEyeHeightOffset, addr 0x16ebbe4, size 0xc0, virtual false, abstract: false, final false
  inline void UpdateEyeHeightOffset();

  /// @brief Method UpdateFOV, addr 0x16ebd64, size 0x100, virtual false, abstract: false, final false
  inline void UpdateFOV();

  /// @brief Method UpdateFPS, addr 0x16ec034, size 0xe0, virtual false, abstract: false, final false
  inline void UpdateFPS();

  /// @brief Method UpdateIPD, addr 0x16ebb18, size 0xcc, virtual false, abstract: false, final false
  inline void UpdateIPD();

  /// @brief Method UpdateLatencyValues, addr 0x16ec030, size 0x4, virtual false, abstract: false, final false
  inline void UpdateLatencyValues();

  /// @brief Method UpdateResolutionEyeTexture, addr 0x16ebe64, size 0x1cc, virtual false, abstract: false, final false
  inline void UpdateResolutionEyeTexture();

  /// @brief Method UpdateStrings, addr 0x16eb734, size 0x230, virtual false, abstract: false, final false
  inline void UpdateStrings();

  /// @brief Method UpdateVariable, addr 0x16eb6fc, size 0x38, virtual false, abstract: false, final false
  inline void UpdateVariable();

  /// @brief Method VariableObjectManager, addr 0x16eb96c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16ec5d0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
