...
public:
  ...
  /// @brief Method .ctor, addr 0x23b5214, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a9e7c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(uint32_t unicode, ::UnityEngine::TextCore::Text::FontAsset* fontAsset, ::UnityEngine::TextCore::Glyph* glyph);

  /// @brief Method .ctor, addr 0x23ad348, size 0x40, virtual false, abstract: false, final false
