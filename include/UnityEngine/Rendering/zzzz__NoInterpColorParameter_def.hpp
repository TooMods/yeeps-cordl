...
public:
  ...
  /// @brief Method .ctor, addr 0x17d6bd8, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color value, bool hdr, bool showAlpha, bool showEyeDropper, bool overrideState);

  /// @brief Method .ctor, addr 0x17d6b48, size 0x90, virtual false, abstract: false, final false
