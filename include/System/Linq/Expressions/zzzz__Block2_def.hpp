...
public:
  ...
  /// @brief Method GetExpression, addr 0x182c91c, size 0x94, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182ca1c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182ca24, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182c8f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* arg0, ::System::Linq::Expressions::Expression* arg1);

  /// @brief Method get_ExpressionCount, addr 0x182ca14, size 0x8, virtual true, abstract: false, final false
