...
public:
  ...
  /// @brief Method InternalWriteItemNull, addr 0x1ab7c50, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteArrayAsBytes, addr 0x1ab81e8, size 0x22c, virtual false, abstract: false, final false
  inline void WriteArrayAsBytes(::System::Array* array, int32_t typeLength);

  /// @brief Method WriteAssembly, addr 0x1ab8a90, size 0xd4, virtual false, abstract: false, final false
  inline void WriteAssembly(::System::Type* type, ::StringW assemblyString, int32_t assemId, bool isNew);

  /// @brief Method WriteBegin, addr 0x1ab72bc, size 0x4, virtual false, abstract: false, final false
  inline void WriteBegin();

  /// @brief Method WriteBoolean, addr 0x1ab72e0, size 0x24, virtual false, abstract: false, final false
  inline void WriteBoolean(bool value);

  /// @brief Method WriteByte, addr 0x1ab0fd4, size 0x20, virtual false, abstract: false, final false
  inline void WriteByte(uint8_t value);

  /// @brief Method WriteBytes, addr 0x1ab7324, size 0x20, virtual false, abstract: false, final false
  inline void WriteBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> byteA, int32_t offset, int32_t size);

  /// @brief Method WriteBytes, addr 0x1ab7304, size 0x20, virtual false, abstract: false, final false
  inline void WriteBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method WriteChar, addr 0x1ab7344, size 0x24, virtual false, abstract: false, final false
  inline void WriteChar(char16_t value);

  /// @brief Method WriteChars, addr 0x1ab7368, size 0x24, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> value);

  /// @brief Method WriteDateTime, addr 0x1ab7520, size 0x24, virtual false, abstract: false, final false
  inline void WriteDateTime(::System::DateTime value);

  /// @brief Method WriteDecimal, addr 0x1ab738c, size 0xc0, virtual false, abstract: false, final false
  inline void WriteDecimal(::System::Decimal value);

  /// @brief Method WriteDelayedNullItem, addr 0x1ab8a4c, size 0x10, virtual false, abstract: false, final false
  inline void WriteDelayedNullItem();

  /// @brief Method WriteDouble, addr 0x1ab7470, size 0x24, virtual false, abstract: false, final false
  inline void WriteDouble(double_t value);

  /// @brief Method WriteEnd, addr 0x1ab72c0, size 0x20, virtual false, abstract: false, final false
  inline void WriteEnd();

  /// @brief Method WriteInt16, addr 0x1ab7494, size 0x24, virtual false, abstract: false, final false
  inline void WriteInt16(int16_t value);

  /// @brief Method WriteInt32, addr 0x1ab1018, size 0x24, virtual false, abstract: false, final false
  inline void WriteInt32(int32_t value);

  /// @brief Method WriteInt64, addr 0x1ab74b8, size 0x24, virtual false, abstract: false, final false
  inline void WriteInt64(int64_t value);

  /// @brief Method WriteItem, addr 0x1ab89fc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteItemEnd, addr 0x1ab8a5c, size 0x4, virtual false, abstract: false, final false
  inline void WriteItemEnd();

  /// @brief Method WriteItemObjectRef, addr 0x1ab8a60, size 0x30, virtual false, abstract: false, final false
  inline void WriteItemObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo* nameInfo, int32_t idRef);

  /// @brief Method WriteJaggedArray, addr 0x1ab8414, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMember, addr 0x1ab875c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMemberNested, addr 0x1ab8998, size 0x1c, virtual false, abstract: false, final false
  inline void WriteMemberNested(::System::Runtime::Serialization::Formatters::Binary::NameInfo* memberNameInfo);

  /// @brief Method WriteMemberObjectRef, addr 0x1ab8904, size 0x94, virtual false, abstract: false, final false
  inline void WriteMemberObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo* memberNameInfo, int32_t idRef);

  /// @brief Method WriteMemberString, addr 0x1ab89b4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMethodCall, addr 0x1ab76a8, size 0x80, virtual false, abstract: false, final false
  inline void WriteMethodCall();

  /// @brief Method WriteMethodReturn, addr 0x1ab7728, size 0x80, virtual false, abstract: false, final false
  inline void WriteMethodReturn();

  /// @brief Method WriteNullItem, addr 0x1ab8a3c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNullMember, addr 0x1ab8864, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObject, addr 0x1ab77a8, size 0x4a8, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method WriteObjectByteArray, addr 0x1ab86fc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObjectEnd, addr 0x1ab75b0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObjectString, addr 0x1ab7e5c, size 0x90, virtual false, abstract: false, final false
  inline void WriteObjectString(int32_t objectId, ::StringW value);

  /// @brief Method WriteRectangleArray, addr 0x1ab85a4, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteSByte, addr 0x1ab74dc, size 0x20, virtual false, abstract: false, final false
  inline void WriteSByte(int8_t value);

  /// @brief Method WriteSerializationHeader, addr 0x1ab7610, size 0x98, virtual false, abstract: false, final false
  inline void WriteSerializationHeader(int32_t topId, int32_t headerId, int32_t minorVersion, int32_t majorVersion);

  /// @brief Method WriteSerializationHeaderEnd, addr 0x1ab75b4, size 0x5c, virtual false, abstract: false, final false
  inline void WriteSerializationHeaderEnd();

  /// @brief Method WriteSingle, addr 0x1ab744c, size 0x24, virtual false, abstract: false, final false
  inline void WriteSingle(float_t value);

  /// @brief Method WriteSingleArray, addr 0x1ab7eec, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteString, addr 0x1ab0ff4, size 0x24, virtual false, abstract: false, final false
  inline void WriteString(::StringW value);

  /// @brief Method WriteTimeSpan, addr 0x1ab74fc, size 0x24, virtual false, abstract: false, final false
  inline void WriteTimeSpan(::System::TimeSpan value);

  /// @brief Method WriteUInt16, addr 0x1ab7544, size 0x24, virtual false, abstract: false, final false
  inline void WriteUInt16(uint16_t value);

  /// @brief Method WriteUInt32, addr 0x1ab7568, size 0x24, virtual false, abstract: false, final false
  inline void WriteUInt32(uint32_t value);

  /// @brief Method WriteUInt64, addr 0x1ab758c, size 0x24, virtual false, abstract: false, final false
  inline void WriteUInt64(uint64_t value);

  /// @brief Method WriteValue, addr 0x1ab1a84, size 0x668, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ab6ee8, size 0xb8, virtual false, abstract: false, final false
