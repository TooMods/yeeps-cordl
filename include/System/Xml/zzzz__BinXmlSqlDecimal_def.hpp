...
public:
  ...
  /// @brief Method ChFromDigit, addr 0x282b68c, size 0x8, virtual false, abstract: false, final false
  static inline char16_t ChFromDigit(uint32_t uiDigit);

  /// @brief Method MpDiv1, addr 0x282b56c, size 0xd4, virtual false, abstract: false, final false
  static inline void MpDiv1(::ArrayW<uint32_t, ::Array<uint32_t>*> rgulU, ByRef<int32_t> ciulU, uint32_t iulD, ByRef<uint32_t> iulR);

  /// @brief Method MpNormalize, addr 0x282b640, size 0x4c, virtual false, abstract: false, final false
  static inline void MpNormalize(::ArrayW<uint32_t, ::Array<uint32_t>*> rgulU, ByRef<int32_t> ciulU);

  /// @brief Method ToDecimal, addr 0x282b694, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Decimal ToDecimal();

  /// @brief Method ToString, addr 0x282b754, size 0x2ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TrimTrailingZeros, addr 0x282b3a4, size 0x1c8, virtual false, abstract: false, final false
  inline void TrimTrailingZeros();

  /// @brief Method UIntFromByteArray, addr 0x282b330, size 0x74, virtual false, abstract: false, final false
  static inline uint32_t UIntFromByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset);

  /// @brief Method .ctor, addr 0x282b0a0, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsPositive, addr 0x282b090, size 0x10, virtual false, abstract: false, final false
