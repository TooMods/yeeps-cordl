...
public:
  ...
  /// @brief Method .ctor, addr 0x2e788e4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeHandle, addr 0x2e7893c, size 0x58, virtual true, abstract: false, final false
