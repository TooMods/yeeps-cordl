...
public:
  ...
  /// @brief Method GetFileLineNumber, addr 0x21c5324, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetFileLineNumber();

  /// @brief Method GetFileName, addr 0x21c532c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetFileName();

  /// @brief Method GetILOffset, addr 0x21c5408, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetILOffset();

  /// @brief Method GetInternalMethodName, addr 0x21c5430, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetInternalMethodName();

  /// @brief Method GetMethod, addr 0x21c5410, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodBase* GetMethod();

  /// @brief Method GetMethodAddress, addr 0x21c5420, size 0x8, virtual false, abstract: false, final false
  inline int64_t GetMethodAddress();

  /// @brief Method GetMethodIndex, addr 0x21c5428, size 0x8, virtual false, abstract: false, final false
  inline uint32_t GetMethodIndex();

  /// @brief Method GetNativeOffset, addr 0x21c5418, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetNativeOffset();

  /// @brief Method GetSecureFileName, addr 0x21c5334, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW GetSecureFileName();

  static inline ::System::Diagnostics::StackFrame* New_ctor();

  static inline ::System::Diagnostics::StackFrame* New_ctor(int32_t skipFrames);

  static inline ::System::Diagnostics::StackFrame* New_ctor(int32_t skipFrames, bool fNeedFileInfo);

  /// @brief Method ToString, addr 0x21c5438, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c5218, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x21c5268, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(int32_t skipFrames);

  /// @brief Method .ctor, addr 0x21c52c4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(int32_t skipFrames, bool fNeedFileInfo);

  /// @brief Method get_frame_info, addr 0x21c5210, size 0x8, virtual false, abstract: false, final false
