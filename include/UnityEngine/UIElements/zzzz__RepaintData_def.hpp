...
public:
  ...
  /// @brief Method .ctor, addr 0x2a46554, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentOffset, addr 0x2a46524, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_currentOffset();

  /// @brief Method get_currentWorldClip, addr 0x2a46538, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_currentWorldClip();

  /// @brief Method get_repaintEvent, addr 0x2a46544, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Event* get_repaintEvent();

  /// @brief Method set_repaintEvent, addr 0x2a4654c, size 0x8, virtual false, abstract: false, final false
