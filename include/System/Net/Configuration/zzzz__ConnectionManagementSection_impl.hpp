...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::Configuration::ConnectionManagementSection::*)()>(
  ...
  constexpr static std::size_t addrs = 0x18cd5fc;
...
//  Writing Method size for method: ::System::Net::Configuration::ConnectionManagementSection.get_ConnectionManagement
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::Configuration::ConnectionManagementElementCollection* (
    ::System::Net::Configuration::ConnectionManagementSection::*)()>(&::System::Net::Configuration::ConnectionManagementSection::get_ConnectionManagement)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x18cd634;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::Configuration::ConnectionManagementSection*>::get(), "get_ConnectionManagement",
                                                 std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Configuration::ConfigurationPropertyCollection* (
  ...
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x18cd66c;
...
inline ::System::Net::Configuration::ConnectionManagementElementCollection* System::Net::Configuration::ConnectionManagementSection::get_ConnectionManagement() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::Configuration::ConnectionManagementSection*>::get(),
                                                                             "get_ConnectionManagement", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<::System::Net::Configuration::ConnectionManagementElementCollection*, false>(this, ___internal_method);
}
