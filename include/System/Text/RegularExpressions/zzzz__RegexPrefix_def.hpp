...
public:
  ...
  /// @brief Method .ctor, addr 0x1677174, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CaseInsensitive, addr 0x16814a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CaseInsensitive();

  /// @brief Method get_Empty, addr 0x16814a8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexPrefix get_Empty();

  /// @brief Method get_Prefix, addr 0x1681500, size 0x8, virtual false, abstract: false, final false
