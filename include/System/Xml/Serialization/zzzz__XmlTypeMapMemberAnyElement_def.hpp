...
public:
  ...
  /// @brief Method IsElementDefined, addr 0x3042598, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304579c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDefaultAny, addr 0x30454a0, size 0x2fc, virtual false, abstract: false, final false
