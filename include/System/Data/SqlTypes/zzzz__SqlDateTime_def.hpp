...
public:
  ...
  /// @brief Method CompareTo, addr 0x1e30274, size 0x144, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlDateTime value);

  /// @brief Method CompareTo, addr 0x1e30188, size 0xec, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method Equals, addr 0x1e303b8, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FromDateTime, addr 0x1e2f6fc, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDateTime FromDateTime(::System::DateTime value);

  /// @brief Method FromTimeSpan, addr 0x1e2fa34, size 0x1f4, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDateTime FromTimeSpan(::System::TimeSpan value);

  /// @brief Method GetHashCode, addr 0x1e30498, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x1e30800, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method GreaterThan, addr 0x1e30104, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method LessThan, addr 0x1e30080, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x1e304cc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x1e304d4, size 0x1e0, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x1e306b4, size 0x14c, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToDateTime, addr 0x1e2f9b4, size 0x80, virtual false, abstract: false, final false
  static inline ::System::DateTime ToDateTime(::System::Data::SqlTypes::SqlDateTime value);

  /// @brief Method ToString, addr 0x1e2fd98, size 0x90, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTimeSpan, addr 0x1e2f90c, size 0xa8, virtual false, abstract: false, final false
  static inline ::System::TimeSpan ToTimeSpan(::System::Data::SqlTypes::SqlDateTime value);

  /// @brief Method .ctor, addr 0x1e2f7cc, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(int32_t dayTicks, int32_t timeTicks);

  /// @brief Method .ctor, addr 0x1e2f684, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool fNull);

  /// @brief Method .ctor, addr 0x1e2f690, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DayTicks, addr 0x1e2fcc8, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_DayTicks();

  /// @brief Method get_IsNull, addr 0x1e2f8fc, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_TimeTicks, addr 0x1e2fd18, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_TimeTicks();

  /// @brief Method get_Value, addr 0x1e2fc28, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1e2fe28, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThan, addr 0x1e2ffb4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e2fd68, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDateTime op_Implicit___System__Data__SqlTypes__SqlDateTime(::System::DateTime value);

  /// @brief Method op_LessThan, addr 0x1e2fee8, size 0xcc, virtual false, abstract: false, final false
