...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5390, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PurchaseList* GetDataFromMessage(void* c_message);

  /// @brief Method GetPurchaseList, addr 0x19b5354, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b138c, size 0x58, virtual false, abstract: false, final false
