...
public:
  // Declarations
  /// @brief Method ToHtmlStringRGBA, addr 0x2845234, size 0x4fc, virtual false, abstract: false, final false
  static inline ::StringW ToHtmlStringRGBA(::UnityEngine::Color color);
