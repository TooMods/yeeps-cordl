...
public:
  ...
  /// @brief Method GetDefaultEncoding, addr 0x1e9ee94, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* GetDefaultEncoding();

  /// @brief Method InternalCodePage, addr 0x1ea20f0, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW InternalCodePage(ByRef<int32_t> code_page);

  /// @brief Method InvokeI18N, addr 0x1e9d2e4, size 0x70c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UTF8Unmarked, addr 0x1ea1f00, size 0x1f0, virtual false, abstract: false, final false
