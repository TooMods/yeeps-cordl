...
public:
  ...
  /// @brief Method .ctor, addr 0x2ce6494, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ce64e8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
