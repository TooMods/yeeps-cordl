...
public:
  ...
  /// @brief Method .ctor, addr 0x1b3163c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::__Function__FunctionType ftype, int32_t minargs, int32_t maxargs,
                    ::ArrayW<::System::Xml::XPath::XPathResultType, ::Array<::System::Xml::XPath::XPathResultType>*> argTypes);

  /// @brief Method get_ArgTypes, addr 0x1b31b88, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::XPath::XPathResultType, ::Array<::System::Xml::XPath::XPathResultType>*> get_ArgTypes();

  /// @brief Method get_FType, addr 0x1b31b70, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::__Function__FunctionType get_FType();

  /// @brief Method get_Maxargs, addr 0x1b31b80, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Maxargs();

  /// @brief Method get_Minargs, addr 0x1b31b78, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckNodeSet, addr 0x1b2f474, size 0x5c, virtual false, abstract: false, final false
  inline void CheckNodeSet(::System::Xml::XPath::XPathResultType t);

  /// @brief Method CheckToken, addr 0x1b3018c, size 0x64, virtual false, abstract: false, final false
  inline void CheckToken(::MS::Internal::Xml::XPath::__XPathScanner__LexKind t);

  /// @brief Method CreateAxesTable, addr 0x1b31680, size 0x2b0, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::Dictionary_2<::StringW, ::MS::Internal::Xml::XPath::__Axis__AxisType>* CreateAxesTable();

  /// @brief Method CreateFunctionTable, addr 0x1b30b18, size 0xb24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAxis, addr 0x1b2fdb0, size 0xe8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::__Axis__AxisType GetAxis();

  /// @brief Method IsNodeType, addr 0x1b2f4d0, size 0xf4, virtual false, abstract: false, final false
  static inline bool IsNodeType(::MS::Internal::Xml::XPath::XPathScanner* scaner);

  /// @brief Method IsPrimaryExpr, addr 0x1b2f5c4, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsPrimaryExpr(::MS::Internal::Xml::XPath::XPathScanner* scanner);

  /// @brief Method IsStep, addr 0x1b2fbe0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method NextLex, addr 0x1b2ed68, size 0x18, virtual false, abstract: false, final false
  inline void NextLex();

  /// @brief Method ParseAdditiveExpr, addr 0x1b2ef60, size 0xdc, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseAdditiveExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseAndExpr, addr 0x1b2ec28, size 0xf4, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseAndExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseEqualityExpr, addr 0x1b2ed80, size 0xdc, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseEqualityExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseExpression, addr 0x1b2ead0, size 0x64, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseExpression(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseFilterExpr, addr 0x1b2f674, size 0xb4, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseFilterExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseLocationPath, addr 0x1b2f7f4, size 0x150, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseLocationPath(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseMethod, addr 0x1b301f0, size 0x56c, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseMethod(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseMultiplicativeExpr, addr 0x1b2f03c, size 0x130, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseMultiplicativeExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseNodeTest, addr 0x1b2fe98, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseOrExpr, addr 0x1b2eb34, size 0xf4, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseOrExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParsePathExpr, addr 0x1b2f358, size 0x11c, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParsePathExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParsePredicate, addr 0x1b2fb54, size 0x6c, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParsePredicate(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParsePrimaryExpr, addr 0x1b2f944, size 0x210, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParsePrimaryExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseRelationalExpr, addr 0x1b2ee5c, size 0x104, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseRelationalExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseRelativeLocationPath, addr 0x1b2f728, size 0xcc, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseRelativeLocationPath(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseStep, addr 0x1b2fc28, size 0x188, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseStep(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseUnaryExpr, addr 0x1b2f16c, size 0xe4, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseUnaryExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseUnionExpr, addr 0x1b2f250, size 0x108, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* ParseUnionExpr(::MS::Internal::Xml::XPath::AstNode* qyInput);

  /// @brief Method ParseXPathExpression, addr 0x1b2e954, size 0xe4, virtual false, abstract: false, final false
  static inline ::MS::Internal::Xml::XPath::AstNode* ParseXPathExpression(::StringW xpathExpression);

  /// @brief Method PassToken, addr 0x1b2fbc0, size 0x20, virtual false, abstract: false, final false
  inline void PassToken(::MS::Internal::Xml::XPath::__XPathScanner__LexKind t);

  /// @brief Method TestOp, addr 0x1b2ed1c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b2e92c, size 0x28, virtual false, abstract: false, final false
