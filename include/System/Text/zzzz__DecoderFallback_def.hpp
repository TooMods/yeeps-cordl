...
public:
  ...
  /// @brief Method .ctor, addr 0xee2064, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0xee28f0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0xedf534, size 0x9c, virtual false, abstract: false, final false
