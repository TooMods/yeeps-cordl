...
public:
  // Declarations
  /// @brief Method GetHashCodeCaseInSensitive, addr 0x23a7f54, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetHashCodeCaseInSensitive(::StringW s);

  /// @brief Method ToUpperASCIIFast, addr 0x23b52d0, size 0x74, virtual false, abstract: false, final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method ToUpperFast, addr 0x23b525c, size 0x74, virtual false, abstract: false, final false
  static inline char16_t ToUpperFast(char16_t c);

  /// @brief Method UintToString, addr 0x23ae3e0, size 0xd8, virtual false, abstract: false, final false
