...
public:
  ...
  /// @brief Method BSwap, addr 0x1c91e0c, size 0x78, virtual false, abstract: false, final false
  static inline void BSwap(::ArrayW<uint8_t, ::Array<uint8_t>*> byteBuff);

  /// @brief Method CipherFunct, addr 0x1c918b8, size 0x230, virtual false, abstract: false, final false
  inline uint32_t CipherFunct(uint32_t r, int32_t n);

  /// @brief Method ECB, addr 0x1c9220c, size 0xa4, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method GetStrongKey, addr 0x1c91454, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Permutation, addr 0x1c91ae8, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x1c91e84, size 0x388, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method SetKey, addr 0x1c9152c, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c9122c, size 0x228, virtual false, abstract: false, final false
