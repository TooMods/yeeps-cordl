...
public:
  ...
  /// @brief Method Dispose, addr 0x21da97c, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x21da8b0, size 0x3c, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x21da8ec, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x21da918, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x21da2fc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputStateHistory* history);

  /// @brief Method get_Current, addr 0x21da8f8, size 0x20, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_statePtrWithControlIndex, addr 0x21da294, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> get_statePtrWithControlIndex();

  /// @brief Method get_statePtrWithoutControlIndex, addr 0x21da28c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckValid, addr 0x21daa44, size 0xb0, virtual false, abstract: false, final false
  inline void CheckValid();

  /// @brief Method CopyFrom, addr 0x21d91f0, size 0x380, virtual false, abstract: false, final false
  inline void CopyFrom(::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record record);

  /// @brief Method Equals, addr 0x21daed4, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x21daea0, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record other);

  /// @brief Method GetHashCode, addr 0x21daf6c, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUnsafeExtraMemoryPtr, addr 0x21dadb8, size 0x18, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> GetUnsafeExtraMemoryPtr();

  /// @brief Method GetUnsafeExtraMemoryPtrUnchecked, addr 0x21dadd0, size 0xd0, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> GetUnsafeExtraMemoryPtrUnchecked();

  /// @brief Method GetUnsafeMemoryPtr, addr 0x21dad20, size 0x18, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> GetUnsafeMemoryPtr();

  /// @brief Method GetUnsafeMemoryPtrUnchecked, addr 0x21dad38, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x21dace8, size 0x38, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method ToString, addr 0x21dafb4, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x21d9090, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_control, addr 0x21dab1c, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_header, addr 0x21da980, size 0x24, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::__InputStateHistory__RecordHeader> get_header();

  /// @brief Method get_index, addr 0x21daa08, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_next, addr 0x21dabd0, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record get_next();

  /// @brief Method get_owner, addr 0x21daa00, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputStateHistory* get_owner();

  /// @brief Method get_previous, addr 0x21dac60, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record get_previous();

  /// @brief Method get_recordIndex, addr 0x21da9a4, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_recordIndex();

  /// @brief Method get_time, addr 0x21daaf4, size 0x28, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_valid, addr 0x21da9b8, size 0x48, virtual false, abstract: false, final false
  inline bool get_valid();

  /// @brief Method get_version, addr 0x21da9b0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddRecord, addr 0x21d9a24, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Allocate, addr 0x21da388, size 0x254, virtual false, abstract: false, final false
  inline void Allocate();

  /// @brief Method AllocateRecord, addr 0x21d9a90, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x21d9a10, size 0x14, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Destroy, addr 0x21da310, size 0x78, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x21d99a8, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x21d9914, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetEnumerator, addr 0x21da29c, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetRecord, addr 0x21d8f98, size 0xf8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::__InputStateHistory__RecordHeader> GetRecord(int32_t index);

  /// @brief Method GetRecordUnchecked, addr 0x21da650, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x21da6fc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordIndexToUserIndex, addr 0x21da62c, size 0x24, virtual false, abstract: false, final false
  inline int32_t RecordIndexToUserIndex(int32_t index);

  /// @brief Method RecordStateChange, addr 0x21d9e64, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordStateChange, addr 0x21d9ffc, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method StartRecording, addr 0x21d9bb0, size 0x15c, virtual false, abstract: false, final false
  inline void StartRecording();

  /// @brief Method StopRecording, addr 0x21d9d0c, size 0x158, virtual false, abstract: false, final false
  inline void StopRecording();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x21da30c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged, addr 0x21da7d4, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired, addr 0x21da8ac, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UserIndexToRecordIndex, addr 0x21d8f80, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21d979c, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method .ctor, addr 0x21d9898, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::InputControl*>* controls);

  /// @brief Method .ctor, addr 0x21d9590, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(int32_t maxStateSizeInBytes);

  /// @brief Method .ctor, addr 0x21d9644, size 0x158, virtual false, abstract: false, final false
  inline void _ctor(::StringW path);

  /// @brief Method get_Count, addr 0x21d8abc, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x21d8e6c, size 0x114, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record get_Item(int32_t index);

  /// @brief Method get_bytesPerRecord, addr 0x21da5dc, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_bytesPerRecord();

  /// @brief Method get_controls, addr 0x21d8e04, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_controls();

  /// @brief Method get_extraMemoryPerRecord, addr 0x21d8bb8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_extraMemoryPerRecord();

  /// @brief Method get_historyDepth, addr 0x21d8acc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_historyDepth();

  /// @brief Method get_onRecordAdded, addr 0x21d9570, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record>* get_onRecordAdded();

  /// @brief Method get_onShouldRecordStateChange, addr 0x21d9580, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_updateMask, addr 0x21d8ca4, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_updateMask();

  /// @brief Method get_version, addr 0x21d8ac4, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_version();
  ...
  /// @brief Method set_Item, addr 0x21d90b8, size 0x138, virtual false, abstract: false, final false
  inline void set_Item(int32_t index, ::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record value);

  /// @brief Method set_extraMemoryPerRecord, addr 0x21d8bc0, size 0xe4, virtual false, abstract: false, final false
  inline void set_extraMemoryPerRecord(int32_t value);

  /// @brief Method set_historyDepth, addr 0x21d8ad4, size 0xe4, virtual false, abstract: false, final false
  inline void set_historyDepth(int32_t value);

  /// @brief Method set_onRecordAdded, addr 0x21d9578, size 0x8, virtual false, abstract: false, final false
  inline void set_onRecordAdded(::System::Action_1<::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record>* value);

  /// @brief Method set_onShouldRecordStateChange, addr 0x21d9588, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_updateMask, addr 0x21d8d38, size 0xcc, virtual false, abstract: false, final false
