...
public:
  ...
  /// @brief Method .ctor, addr 0x17d6400, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t min, int32_t max, bool overrideState);

  /// @brief Method get_value, addr 0x17d63dc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x17d63e4, size 0x1c, virtual true, abstract: false, final false
