...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x20960e0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2096008, size 0xd8, virtual false, abstract: false, final false
