...
public:
  ...
  /// @brief Method GetOrCreate, addr 0x1681570, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x1681a60, size 0x3a0, virtual false, abstract: false, final false
  inline ::StringW Replace(::System::Text::RegularExpressions::Regex* regex, ::StringW input, int32_t count, int32_t startat);

  /// @brief Method ReplacementImpl, addr 0x168168c, size 0x1a4, virtual false, abstract: false, final false
  inline void ReplacementImpl(::System::Text::StringBuilder* sb, ::System::Text::RegularExpressions::Match* match);

  /// @brief Method ReplacementImplRTL, addr 0x1681830, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x167c84c, size 0x4e8, virtual false, abstract: false, final false
  inline void _ctor(::StringW rep, ::System::Text::RegularExpressions::RegexNode* concat, ::System::Collections::Hashtable* _caps);

  /// @brief Method get_Pattern, addr 0x1681684, size 0x8, virtual false, abstract: false, final false
