...
public:
  ...
  /// @brief Method PhaseMatches, addr 0x2ccd8ac, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ccd880, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::CallbackPhase phase, ::UnityEngine::UIElements::InvokePolicy invokePolicy);

  /// @brief Method get_invokePolicy, addr 0x2ccd878, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::InvokePolicy get_invokePolicy();

  /// @brief Method get_phase, addr 0x2ccd870, size 0x8, virtual false, abstract: false, final false
