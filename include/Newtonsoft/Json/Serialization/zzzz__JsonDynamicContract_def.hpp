...
public:
  ...
  /// @brief Method CreateCallSiteGetter, addr 0xf0e860, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCallSiteSetter, addr 0xf0e994, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetMember, addr 0xf0eac8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method TrySetMember, addr 0xf0ebc8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf08d60, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* underlyingType);

  /// @brief Method get_Properties, addr 0xf0e848, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_Properties();

  /// @brief Method get_PropertyNameResolver, addr 0xf0e850, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::StringW, ::StringW>* get_PropertyNameResolver();

  /// @brief Method set_PropertyNameResolver, addr 0xf0e858, size 0x8, virtual false, abstract: false, final false
