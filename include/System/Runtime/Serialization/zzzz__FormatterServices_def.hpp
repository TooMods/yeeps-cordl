...
public:
  ...
  /// @brief Method <GetSerializableMembers>b__0, addr 0x1aa881c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1aa73f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckSerializable, addr 0x1aa6598, size 0x20, virtual false, abstract: false, final false
  static inline bool CheckSerializable(::System::RuntimeType* type);

  /// @brief Method GetClrAssemblyName, addr 0x1aa8198, size 0x16c, virtual false, abstract: false, final false
  static inline ::StringW GetClrAssemblyName(::System::Type* type, ByRef<bool> hasTypeForwardedFrom);

  /// @brief Method GetClrTypeFullName, addr 0x1aa8304, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW GetClrTypeFullName(::System::Type* type);

  /// @brief Method GetClrTypeFullNameForArray, addr 0x1aa8384, size 0x224, virtual false, abstract: false, final false
  static inline ::StringW GetClrTypeFullNameForArray(::System::Type* type);

  /// @brief Method GetClrTypeFullNameForNonArrayTypes, addr 0x1aa85a8, size 0x274, virtual false, abstract: false, final false
  static inline ::StringW GetClrTypeFullNameForNonArrayTypes(::System::Type* type);

  /// @brief Method GetEnableUnsafeTypeForwarders, addr 0x1aa75d4, size 0x8, virtual false, abstract: false, final false
  static inline bool GetEnableUnsafeTypeForwarders();

  /// @brief Method GetObjectData, addr 0x1aa7c30, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentTypes, addr 0x1aa6cbc, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSerializableMembers, addr 0x1aa6400, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSerializableMembers, addr 0x1aa7154, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeFromAssembly, addr 0x1aa8020, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Type* GetTypeFromAssembly(::System::Reflection::Assembly* assem, ::StringW name);

  /// @brief Method GetUninitializedObject, addr 0x1aa73fc, size 0x1d0, virtual false, abstract: false, final false
  static inline ::System::Object* GetUninitializedObject(::System::Type* type);

  /// @brief Method InternalGetSerializableMembers, addr 0x1aa65b8, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAssemblyFromString, addr 0x1aa80bc, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Reflection::Assembly* LoadAssemblyFromString(::StringW assemblyName);

  /// @brief Method LoadAssemblyFromStringNoThrow, addr 0x1aa80c4, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Reflection::Assembly* LoadAssemblyFromStringNoThrow(::StringW assemblyName);

  /// @brief Method PopulateObjectMembers, addr 0x1aa7918, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializationSetValue, addr 0x1aa7684, size 0x1e4, virtual false, abstract: false, final false
  static inline void SerializationSetValue(::System::Reflection::MemberInfo* fi, ::System::Object* target, ::System::Object* value);

  /// @brief Method UnsafeTypeForwardersIsEnabled, addr 0x1aa75dc, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method nativeGetUninitializedObject, addr 0x1aa75cc, size 0x8, virtual false, abstract: false, final false
