...
public:
  ...
  /// @brief Method Equals, addr 0x27e62f8, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x27e6388, size 0x84, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Pose other);

  /// @brief Method GetHashCode, addr 0x27e640c, size 0xac, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTransformedBy, addr 0x27e5f70, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose GetTransformedBy(::UnityEngine::Pose lhs);

  /// @brief Method GetTransformedBy, addr 0x27e6054, size 0xec, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose GetTransformedBy(::UnityEngine::Transform* lhs);

  /// @brief Method ToString, addr 0x27e5e7c, size 0xf4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x27e5e68, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_forward, addr 0x27e6140, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_forward();

  /// @brief Method get_identity, addr 0x27e6290, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose get_identity();

  /// @brief Method get_right, addr 0x27e61b0, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_right();

  /// @brief Method get_up, addr 0x27e6220, size 0x70, virtual false, abstract: false, final false
