...
public:
  ...
  /// @brief Method IsMarked, addr 0x1df4060, size 0x84, virtual false, abstract: false, final false
  inline bool IsMarked(int32_t bitPosition);

  /// @brief Method MarkBit, addr 0x1df3fe4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIntArrayLength, addr 0x1df40e4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1df3fb4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int32_t, ::Array<int32_t>*> bitArray, int32_t length);

  /// @brief Method .ctor, addr 0x1df3f7c, size 0x38, virtual false, abstract: false, final false
