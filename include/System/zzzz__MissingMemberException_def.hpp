...
public:
  ...
  /// @brief Method FormatSignature, addr 0x2f10ef4, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW FormatSignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method GetObjectData, addr 0x2f10d98, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f10974, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f109d4, size 0x184, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2f10904, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x2f10c6c, size 0x12c, virtual true, abstract: false, final false
