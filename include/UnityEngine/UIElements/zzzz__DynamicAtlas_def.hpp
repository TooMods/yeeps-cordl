...
public:
  ...
  /// @brief Method Create, addr 0x2a32ca8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2a32d48, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a32d00, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DestroyPages, addr 0x209627c, size 0x78, virtual false, abstract: false, final false
  inline void DestroyPages();

  /// @brief Method InitPages, addr 0x20963a0, size 0x108, virtual false, abstract: false, final false
  inline void InitPages();

  /// @brief Method IsTextureFormatSupported, addr 0x20969a8, size 0x34, virtual false, abstract: false, final false
  static inline bool IsTextureFormatSupported(::UnityEngine::TextureFormat format);

  /// @brief Method IsTextureValid, addr 0x20969dc, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method OnAssignedToPanel, addr 0x2096114, size 0xd0, virtual true, abstract: false, final false
  inline void OnAssignedToPanel(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method OnRemovedFromPanel, addr 0x20961e4, size 0x98, virtual true, abstract: false, final false
  inline void OnRemovedFromPanel(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method OnUpdateDynamicTextures, addr 0x2096940, size 0x68, virtual true, abstract: false, final false
  inline void OnUpdateDynamicTextures(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method Reset, addr 0x20962f4, size 0xac, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnAtlas, addr 0x2096804, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetAtlas, addr 0x20964a8, size 0x35c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2096bd4, size 0x10cc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_defaultFilters, addr 0x2096b44, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters();

  /// @brief Method get_isInitialized, addr 0x20960f4, size 0x20, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_maxSubTextureSize, addr 0x2096afc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxSubTextureSize();

  /// @brief Method set_activeFilters, addr 0x2096b4c, size 0x20, virtual false, abstract: false, final false
  inline void set_activeFilters(::UnityEngine::UIElements::DynamicAtlasFilters value);

  /// @brief Method set_customFilter, addr 0x2096b8c, size 0x48, virtual false, abstract: false, final false
  inline void set_customFilter(::UnityEngine::UIElements::DynamicAtlasCustomFilter* value);

  /// @brief Method set_maxAtlasSize, addr 0x2096b24, size 0x20, virtual false, abstract: false, final false
  inline void set_maxAtlasSize(int32_t value);

  /// @brief Method set_maxSubTextureSize, addr 0x2096b6c, size 0x20, virtual false, abstract: false, final false
  inline void set_maxSubTextureSize(int32_t value);

  /// @brief Method set_minAtlasSize, addr 0x2096b04, size 0x20, virtual false, abstract: false, final false
