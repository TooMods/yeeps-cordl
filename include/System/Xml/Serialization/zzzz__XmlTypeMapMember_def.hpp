...
public:
  ...
  /// @brief Method CheckOptionalValueType, addr 0x3045084, size 0x80, virtual false, abstract: false, final false
  inline void CheckOptionalValueType(::System::Type* type);

  /// @brief Method GetValue, addr 0x303dab0, size 0x138, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(::System::Object* ob);

  /// @brief Method GetValue, addr 0x3044bf4, size 0x144, virtual false, abstract: false, final false
  static inline ::System::Object* GetValue(::System::Object* ob, ::StringW name);

  /// @brief Method GetValueSpecified, addr 0x3041050, size 0x258, virtual false, abstract: false, final false
  inline bool GetValueSpecified(::System::Object* ob);

  /// @brief Method InitMember, addr 0x30449b8, size 0x23c, virtual false, abstract: false, final false
  inline void InitMember(::System::Type* type);

  /// @brief Method IsReadOnly, addr 0x3044904, size 0xb4, virtual false, abstract: false, final false
  inline bool IsReadOnly(::System::Type* type);

  static inline ::System::Xml::Serialization::XmlTypeMapMember* New_ctor();

  /// @brief Method SetValue, addr 0x3044e98, size 0x158, virtual false, abstract: false, final false
  static inline void SetValue(::System::Object* ob, ::StringW name, ::System::Object* value);

  /// @brief Method SetValue, addr 0x3044d38, size 0x160, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* ob, ::System::Object* value);

  /// @brief Method SetValueSpecified, addr 0x3045104, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3044874, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DefaultValue, addr 0x30448f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValue();

  /// @brief Method get_GlobalIndex, addr 0x3045010, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_GlobalIndex();

  /// @brief Method get_Index, addr 0x3045000, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Index();

  /// @brief Method get_IsOptionalValueType, addr 0x3041044, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsOptionalValueType();

  /// @brief Method get_IsReturnValue, addr 0x304504c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsReturnValue();

  /// @brief Method get_Name, addr 0x30448e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_TypeData, addr 0x3044ff0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_TypeData();

  /// @brief Method set_DefaultValue, addr 0x30448fc, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValue(::System::Object* value);

  /// @brief Method set_GlobalIndex, addr 0x3045018, size 0x8, virtual false, abstract: false, final false
  inline void set_GlobalIndex(int32_t value);

  /// @brief Method set_Index, addr 0x3045008, size 0x8, virtual false, abstract: false, final false
  inline void set_Index(int32_t value);

  /// @brief Method set_IsOptionalValueType, addr 0x3045020, size 0x2c, virtual false, abstract: false, final false
  inline void set_IsOptionalValueType(bool value);

  /// @brief Method set_IsReturnValue, addr 0x3045058, size 0x2c, virtual false, abstract: false, final false
  inline void set_IsReturnValue(bool value);

  /// @brief Method set_Name, addr 0x30448ec, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_TypeData, addr 0x3044ff8, size 0x8, virtual false, abstract: false, final false
