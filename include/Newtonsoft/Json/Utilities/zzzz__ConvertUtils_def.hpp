...
public:
  ...
  /// @brief Method <CreateCastConverter>b__0, addr 0x152c624, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1528cd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x1529564, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertOrCast, addr 0x152a640, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCastConverter, addr 0x1528a94, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method DecimalTryParse, addr 0x152aa88, size 0x958, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureTypeAssignable, addr 0x152a410, size 0x230, virtual false, abstract: false, final false
  static inline ::System::Object* EnsureTypeAssignable(::System::Object* value, ::System::Type* initialType, ::System::Type* targetType);

  /// @brief Method FromBigInteger, addr 0x1529058, size 0x50c, virtual false, abstract: false, final false
  static inline ::System::Object* FromBigInteger(::System::Numerics::BigInteger i, ::System::Type* targetType);

  /// @brief Method GetTypeCode, addr 0x15284cc, size 0x68, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Utilities::PrimitiveTypeCode GetTypeCode(::System::Type* t);

  /// @brief Method GetTypeCode, addr 0x1528534, size 0x268, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Utilities::PrimitiveTypeCode GetTypeCode(::System::Type* t, ByRef<bool> isEnum);

  /// @brief Method GetTypeInformation, addr 0x1528884, size 0xec, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Utilities::TypeInformation* GetTypeInformation(::System::IConvertible* convertable);

  /// @brief Method Int32TryParse, addr 0x152a7cc, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Int64TryParse, addr 0x152a930, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method IsConvertible, addr 0x1528970, size 0x94, virtual false, abstract: false, final false
  static inline bool IsConvertible(::System::Type* t);

  /// @brief Method IsInteger, addr 0x152a2e0, size 0x90, virtual false, abstract: false, final false
  static inline bool IsInteger(::System::Object* value);

  /// @brief Method ParseTimeSpan, addr 0x1528a04, size 0x90, virtual false, abstract: false, final false
  static inline ::System::TimeSpan ParseTimeSpan(::StringW input);

  /// @brief Method ToBigInteger, addr 0x1528cdc, size 0x37c, virtual false, abstract: false, final false
  static inline ::System::Numerics::BigInteger ToBigInteger(::System::Object* value);

  /// @brief Method TryConvert, addr 0x152a1d8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertGuid, addr 0x152b3e0, size 0x5c, virtual false, abstract: false, final false
  static inline bool TryConvertGuid(::StringW s, ByRef<::System::Guid> g);

  /// @brief Method TryConvertInternal, addr 0x15297e4, size 0x9f4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryHexTextToInt, addr 0x152b43c, size 0xbc, virtual false, abstract: false, final false
  static inline bool TryHexTextToInt(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t end, ByRef<int32_t> value);

  /// @brief Method VersionTryParse, addr 0x152a370, size 0x8, virtual false, abstract: false, final false
