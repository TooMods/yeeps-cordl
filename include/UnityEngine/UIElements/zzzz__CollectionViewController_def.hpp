...
public:
  ...
  /// @brief Method BindItem, addr 0x1290190, size 0x1d0, virtual true, abstract: false, final false
  inline void BindItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method DestroyItem, addr 0x1290394, size 0x34, virtual true, abstract: false, final false
  inline void DestroyItem(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method GetIdForIndex, addr 0x128fec0, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetIdForIndex(int32_t index);

  /// @brief Method GetItemCount, addr 0x128fe10, size 0xb0, virtual true, abstract: false, final false
  inline int32_t GetItemCount();

  /// @brief Method GetItemForIndex, addr 0x128fef8, size 0x13c, virtual true, abstract: false, final false
  inline ::System::Object* GetItemForIndex(int32_t index);

  /// @brief Method InvokeBindItem, addr 0x128e9a0, size 0xc8, virtual true, abstract: false, final false
  inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method InvokeDestroyItem, addr 0x1290090, size 0x24, virtual true, abstract: false, final false
  inline void InvokeDestroyItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method InvokeMakeItem, addr 0x1290034, size 0x38, virtual true, abstract: false, final false
  inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method InvokeUnbindItem, addr 0x129006c, size 0x24, virtual true, abstract: false, final false
  inline void InvokeUnbindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method MakeItem, addr 0x12900b4, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method RaiseItemIndexChanged, addr 0x128f4ac, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemIndexChanged(int32_t srcIndex, int32_t dstIndex);

  /// @brief Method RaiseItemsSourceChanged, addr 0x128fd58, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemsSourceChanged();

  /// @brief Method SetView, addr 0x128fd7c, size 0x94, virtual false, abstract: false, final false
  inline void SetView(::UnityEngine::UIElements::BaseVerticalCollectionView* view);

  /// @brief Method UnbindItem, addr 0x1290360, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x128fab0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_itemIndexChanged, addr 0x128fbf0, size 0xb0, virtual false, abstract: false, final false
  inline void add_itemIndexChanged(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method add_itemsSourceChanged, addr 0x128fab8, size 0x9c, virtual false, abstract: false, final false
  inline void add_itemsSourceChanged(::System::Action* value);

  /// @brief Method get_itemsSource, addr 0x128fd50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_itemsSource();

  /// @brief Method get_view, addr 0x128fd74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_view();

  /// @brief Method remove_itemIndexChanged, addr 0x128fca0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_itemIndexChanged(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method remove_itemsSourceChanged, addr 0x128fb54, size 0x9c, virtual false, abstract: false, final false
  inline void remove_itemsSourceChanged(::System::Action* value);

  /// @brief Method set_itemsSource, addr 0x128f1b4, size 0x2c, virtual false, abstract: false, final false
