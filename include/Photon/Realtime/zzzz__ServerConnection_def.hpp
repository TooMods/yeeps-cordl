...
// Type: Photon.Realtime::ServerConnection
...
public:
  ...
  /// @brief Field GameServer value: static_cast<int32_t>(0x1)
  static ::Photon::Realtime::ServerConnection const GameServer;

  /// @brief Field MasterServer value: static_cast<int32_t>(0x0)
  static ::Photon::Realtime::ServerConnection const MasterServer;

  /// @brief Field NameServer value: static_cast<int32_t>(0x2)
...
static_assert(::cordl_internals::size_check_v<::Photon::Realtime::ServerConnection, 0x4>, "Size mismatch!");
