...
public:
  ...
  /// @brief Method Awake, addr 0x16f1544, size 0xf4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Initialize, addr 0x16f1658, size 0xbc, virtual false, abstract: false, final false
  inline void Initialize(::GlobalNamespace::__OVRMesh__MeshType meshType);

  static inline ::GlobalNamespace::OVRMesh* New_ctor();

  /// @brief Method SetMeshType, addr 0x16f153c, size 0x8, virtual false, abstract: false, final false
  inline void SetMeshType(::GlobalNamespace::__OVRMesh__MeshType type);

  /// @brief Method ShouldInitialize, addr 0x16f1638, size 0x20, virtual false, abstract: false, final false
  inline bool ShouldInitialize();

  /// @brief Method TransformOvrpMesh, addr 0x16f1714, size 0xab4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16f21c8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInitialized, addr 0x16f1520, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_Mesh, addr 0x16f1534, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_Mesh();

  /// @brief Method set_IsInitialized, addr 0x16f1528, size 0xc, virtual false, abstract: false, final false
