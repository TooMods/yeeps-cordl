...
public:
  ...
  /// @brief Method Equals, addr 0x2a37650, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a376e8, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::ManipulatorActivationFilter other);

  /// @brief Method GetHashCode, addr 0x2a3771c, size 0x80, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HasModifiers, addr 0x2a378f4, size 0x1f4, virtual false, abstract: false, final false
  inline bool HasModifiers(::UnityEngine::UIElements::IMouseEvent* e);

  /// @brief Method HasModifiers, addr 0x2a37c94, size 0x1f4, virtual false, abstract: false, final false
  inline bool HasModifiers(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method MatchModifiers, addr 0x2a37ae8, size 0x54, virtual false, abstract: false, final false
  inline bool MatchModifiers(bool alt, bool ctrl, bool shift, bool command);

  /// @brief Method Matches, addr 0x2a3779c, size 0x158, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::UIElements::IMouseEvent* e);

  /// @brief Method Matches, addr 0x2a37b3c, size 0x158, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method get_button, addr 0x2a37630, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MouseButton get_button();

  /// @brief Method get_clickCount, addr 0x2a37648, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_clickCount();

  /// @brief Method get_modifiers, addr 0x2a37640, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_button, addr 0x2a37638, size 0x8, virtual false, abstract: false, final false
