...
public:
  ...
  /// @brief Method ToString, addr 0x2428554, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24284b0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentSize, addr 0x24284a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrentSize();

  /// @brief Method get_UserBuffer, addr 0x2428498, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer();

  /// @brief Method set_CurrentSize, addr 0x24284a8, size 0x8, virtual false, abstract: false, final false
