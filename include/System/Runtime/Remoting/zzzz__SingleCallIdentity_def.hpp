...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x19824b0, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x198229c, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1980dec, size 0x40, virtual false, abstract: false, final false
