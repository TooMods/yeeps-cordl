...
public:
  ...
  /// @brief Method Parse, addr 0x1b24f9c, size 0x8b0, virtual false, abstract: false, final false
  inline bool Parse(::StringW text, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method Parse2Dig, addr 0x1b27694, size 0x98, virtual false, abstract: false, final false
  inline bool Parse2Dig(int32_t start, ByRef<int32_t> num);

  /// @brief Method Parse4Dig, addr 0x1b27588, size 0x10c, virtual false, abstract: false, final false
  inline bool Parse4Dig(int32_t start, ByRef<int32_t> num);

  /// @brief Method ParseChar, addr 0x1b27294, size 0x44, virtual false, abstract: false, final false
  inline bool ParseChar(int32_t start, char16_t ch);

  /// @brief Method ParseDate, addr 0x1b270f4, size 0x1a0, virtual false, abstract: false, final false
  inline bool ParseDate(int32_t start);

  /// @brief Method ParseTime, addr 0x1b2772c, size 0x2f0, virtual false, abstract: false, final false
  inline bool ParseTime(ByRef<int32_t> start);

  /// @brief Method ParseTimeAndWhitespace, addr 0x1b27530, size 0x58, virtual false, abstract: false, final false
  inline bool ParseTimeAndWhitespace(int32_t start);

  /// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x1b272d8, size 0x44, virtual false, abstract: false, final false
  inline bool ParseTimeAndZoneAndWhitespace(int32_t start);

  /// @brief Method ParseZoneAndWhitespace, addr 0x1b2731c, size 0x214, virtual false, abstract: false, final false
  inline bool ParseZoneAndWhitespace(int32_t start);

  /// @brief Method Test, addr 0x1b270e8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InitiateXsdDateTime, addr 0x1b2584c, size 0x7c, virtual false, abstract: false, final false
  inline void InitiateXsdDateTime(::System::Xml::Schema::__XsdDateTime__Parser parser);

  /// @brief Method IntToCharArray, addr 0x1b26ae0, size 0x68, virtual false, abstract: false, final false
  inline void IntToCharArray(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t value, int32_t digits);

  /// @brief Method PrintDate, addr 0x1b26784, size 0x150, virtual false, abstract: false, final false
  inline void PrintDate(::System::Text::StringBuilder* sb);

  /// @brief Method PrintTime, addr 0x1b268d4, size 0x20c, virtual false, abstract: false, final false
  inline void PrintTime(::System::Text::StringBuilder* sb);

  /// @brief Method PrintZone, addr 0x1b26bb0, size 0x188, virtual false, abstract: false, final false
  inline void PrintZone(::System::Text::StringBuilder* sb);

  /// @brief Method ShortToCharArray, addr 0x1b26b48, size 0x68, virtual false, abstract: false, final false
  inline void ShortToCharArray(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t value);

  /// @brief Method ToString, addr 0x1b263ac, size 0x3d8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x1b258f8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b2596c, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method .ctor, addr 0x1b25ac8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset dateTimeOffset);

  /// @brief Method .ctor, addr 0x1b25ad0, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset dateTimeOffset, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method .ctor, addr 0x1b258c8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::__XsdDateTime__Parser parser);

  /// @brief Method .ctor, addr 0x1b24e60, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Day, addr 0x1b25c04, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Day();

  /// @brief Method get_Fraction, addr 0x1b25c24, size 0xd8, virtual false, abstract: false, final false
  inline int32_t get_Fraction();

  /// @brief Method get_Hour, addr 0x1b25c0c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Hour();

  /// @brief Method get_InternalKind, addr 0x1b25bec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::__XsdDateTime__XsdDateTimeKind get_InternalKind();

  /// @brief Method get_InternalTypeCode, addr 0x1b25be4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::__XsdDateTime__DateTimeTypeCode get_InternalTypeCode();

  /// @brief Method get_Minute, addr 0x1b25c14, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Minute();

  /// @brief Method get_Month, addr 0x1b25bfc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Month();

  /// @brief Method get_Second, addr 0x1b25c1c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Second();

  /// @brief Method get_Year, addr 0x1b25bf4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Year();

  /// @brief Method get_ZoneHour, addr 0x1b25cfc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ZoneHour();

  /// @brief Method get_ZoneMinute, addr 0x1b25d04, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ZoneMinute();

  /// @brief Method op_Implicit, addr 0x1b25d0c, size 0x420, virtual false, abstract: false, final false
  static inline ::System::DateTime op_Implicit___System__DateTime(::System::Xml::Schema::XsdDateTime xdt);

  /// @brief Method op_Implicit, addr 0x1b2612c, size 0x280, virtual false, abstract: false, final false
