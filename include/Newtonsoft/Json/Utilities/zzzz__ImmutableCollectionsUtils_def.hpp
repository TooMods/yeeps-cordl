...
public:
  ...
  /// @brief Method .ctor, addr 0x1534880, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW contractTypeName, ::StringW createdTypeName, ::StringW builderTypeName);

  /// @brief Method get_BuilderTypeName, addr 0x15348dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BuilderTypeName();

  /// @brief Method get_ContractTypeName, addr 0x15348bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ContractTypeName();

  /// @brief Method get_CreatedTypeName, addr 0x15348cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CreatedTypeName();

  /// @brief Method set_BuilderTypeName, addr 0x15348e4, size 0x8, virtual false, abstract: false, final false
  inline void set_BuilderTypeName(::StringW value);

  /// @brief Method set_ContractTypeName, addr 0x15348c4, size 0x8, virtual false, abstract: false, final false
  inline void set_ContractTypeName(::StringW value);

  /// @brief Method set_CreatedTypeName, addr 0x15348d4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <TryBuildImmutableForArrayContract>b__0, addr 0x15348ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1533aac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <TryBuildImmutableForArrayContract>b__24_1, addr 0x153497c, size 0x94, virtual false, abstract: false, final false
  inline bool _TryBuildImmutableForArrayContract_b__24_1(::System::Reflection::MethodInfo* m);

  /// @brief Method <TryBuildImmutableForDictionaryContract>b__25_1, addr 0x1534a10, size 0x150, virtual false, abstract: false, final false
  inline bool _TryBuildImmutableForDictionaryContract_b__25_1(::System::Reflection::MethodInfo* m);

  /// @brief Method .ctor, addr 0x1534974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <TryBuildImmutableForDictionaryContract>b__0, addr 0x1534b60, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1533f48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method TryBuildImmutableForArrayContract, addr 0x153366c, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method TryBuildImmutableForDictionaryContract, addr 0x1533ab4, size 0x494, virtual false, abstract: false, final false
