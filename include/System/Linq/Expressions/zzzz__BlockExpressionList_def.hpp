...
public:
  ...
  /// @brief Method MoveNext, addr 0x182dc70, size 0xcc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Linq::Expressions::__BlockExpressionList___GetEnumerator_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Linq.Expressions.Expression>.get_Current, addr 0x182dd3c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x182dd44, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x182dd84, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x182dc6c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x182dc40, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x182d96c, size 0x28, virtual true, abstract: false, final true
  inline void Add(::System::Linq::Expressions::Expression* item);

  /// @brief Method Clear, addr 0x182d994, size 0x28, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x182d9bc, size 0x18, virtual true, abstract: false, final true
  inline bool Contains(::System::Linq::Expressions::Expression* item);

  /// @brief Method CopyTo, addr 0x182d9d4, size 0x194, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEnumerator, addr 0x182dbd8, size 0x68, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::System::Linq::Expressions::Expression*>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x182d83c, size 0x88, virtual true, abstract: false, final true
  inline int32_t IndexOf(::System::Linq::Expressions::Expression* item);

  /// @brief Method Insert, addr 0x182d8c4, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x182dbb0, size 0x28, virtual true, abstract: false, final true
  inline bool Remove(::System::Linq::Expressions::Expression* item);

  /// @brief Method RemoveAt, addr 0x182d8ec, size 0x28, virtual true, abstract: false, final true
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x182dc68, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x182c8c8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::BlockExpression* provider, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_Count, addr 0x182db68, size 0x20, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x182db88, size 0x28, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x182d914, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x182d944, size 0x28, virtual true, abstract: false, final true
