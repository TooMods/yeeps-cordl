...
public:
  ...
  /// @brief Method Run, addr 0x184606c, size 0x38, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x18460a4, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1845ffc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x184602c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1846024, size 0x8, virtual true, abstract: false, final false
