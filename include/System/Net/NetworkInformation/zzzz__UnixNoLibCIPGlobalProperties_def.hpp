...
public:
  ...
  /// @brief Method .ctor, addr 0x2ded4a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DomainName, addr 0x2ded460, size 0x48, virtual true, abstract: false, final false
