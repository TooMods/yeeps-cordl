...
public:
  ...
  /// @brief Method DetermineMoveDirection, addr 0x2cd2908, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::__NavigationTabEvent__Direction DetermineMoveDirection(int32_t moveValue);

  /// @brief Method GetPooled, addr 0x2cd2924, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::NavigationTabEvent* GetPooled(int32_t moveValue);

  /// @brief Method Init, addr 0x2cd29b0, size 0x50, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x2cd2a00, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_direction, addr 0x2cd2900, size 0x8, virtual false, abstract: false, final false
