...
public:
  ...
  /// @brief Method Equals, addr 0xf53a2c, size 0xec, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0xf53b18, size 0x130, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIPAddress, addr 0xf53790, size 0x1f4, virtual false, abstract: false, final false
  inline ::System::Net::IPAddress* GetIPAddress();

  /// @brief Method GetIPEndPoint, addr 0xf53984, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0xf53c48, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf5338c, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::AddressFamily family, int32_t size);

  /// @brief Method .ctor, addr 0xf534ac, size 0x288, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* ipAddress);

  /// @brief Method .ctor, addr 0xf53734, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* ipaddress, int32_t port);

  /// @brief Method get_Family, addr 0xf532d0, size 0x38, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::AddressFamily get_Family();

  /// @brief Method get_Item, addr 0xf53310, size 0x7c, virtual false, abstract: false, final false
  inline uint8_t get_Item(int32_t offset);

  /// @brief Method get_Size, addr 0xf53308, size 0x8, virtual false, abstract: false, final false
