...
public:
  ...
  /// @brief Method .ctor, addr 0x27ba5ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x27ba3d8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_contentContainer, addr 0x27ba504, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x27b1cd8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
