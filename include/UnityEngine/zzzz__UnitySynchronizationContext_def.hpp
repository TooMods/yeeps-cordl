...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2841054, size 0xac, virtual false, abstract: false, final false
  inline void Invoke();

  /// @brief Method .ctor, addr 0x2840cb4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateCopy, addr 0x2840e28, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Threading::SynchronizationContext* CreateCopy();

  /// @brief Method Exec, addr 0x2840e94, size 0x1c0, virtual false, abstract: false, final false
  inline void Exec();

  /// @brief Method ExecutePendingTasks, addr 0x2841240, size 0xf0, virtual false, abstract: false, final false
  static inline bool ExecutePendingTasks(int64_t millisecondsTimeout);

  /// @brief Method ExecuteTasks, addr 0x28411dc, size 0x64, virtual false, abstract: false, final false
  static inline void ExecuteTasks();

  /// @brief Method HasPendingTasks, addr 0x2841100, size 0x60, virtual false, abstract: false, final false
  inline bool HasPendingTasks();

  /// @brief Method InitializeSynchronizationContext, addr 0x2841160, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OperationCompleted, addr 0x2840ccc, size 0xc, virtual true, abstract: false, final false
  inline void OperationCompleted();

  /// @brief Method OperationStarted, addr 0x2840cc0, size 0xc, virtual true, abstract: false, final false
  inline void OperationStarted();

  /// @brief Method Post, addr 0x2840cd8, size 0x150, virtual true, abstract: false, final false
  inline void Post(::System::Threading::SendOrPostCallback* callback, ::System::Object* state);

  /// @brief Method Send, addr 0x28409b0, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2840858, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(int32_t mainThreadID);

  /// @brief Method .ctor, addr 0x2840910, size 0xa0, virtual false, abstract: false, final false
