...
public:
  ...
  /// @brief Method Equals, addr 0x1b5366c, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1b536f4, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x1b53650, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t localIndex, ::System::Linq::Expressions::ParameterExpression* parameter);

  /// @brief Method get_Index, addr 0x1b5365c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Index();

  /// @brief Method get_Parameter, addr 0x1b53664, size 0x8, virtual false, abstract: false, final false
