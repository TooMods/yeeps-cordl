...
public:
  ...
  /// @brief Method <.ctor>b__0_0, addr 0x2099ab8, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::GradientRemap* __ctor_b__0_0();

  /// @brief Method <.ctor>b__0_1, addr 0x2099b58, size 0x14, virtual false, abstract: false, final false
  inline void __ctor_b__0_1(::UnityEngine::UIElements::UIR::GradientRemap* gradientRemap);

  /// @brief Method .ctor, addr 0x2099ab0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x20998c4, size 0x188, virtual false, abstract: false, final false
  inline void _ctor();
