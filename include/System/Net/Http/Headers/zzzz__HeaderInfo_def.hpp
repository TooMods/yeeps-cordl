...
public:
  ...
  /// @brief Method CreateCollection, addr 0x1623794, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1623764, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Net::Http::Headers::HttpHeaderKind headerKind);

  /// @brief Method get_CustomToString, addr 0x16237a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::System::Object*, ::StringW>* get_CustomToString();

  /// @brief Method get_Separator, addr 0x16237b4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_Separator();

  /// @brief Method set_CustomToString, addr 0x16237ac, size 0x8, virtual false, abstract: false, final false
