...
public:
  // Declarations
  __declspec(property(get = get_BlockSizeValue)) int32_t BlockSizeValue;
  ...
  /// @brief Method Clear, addr 0x1d243c0, size 0x8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Dec, addr 0x1d26210, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptData, addr 0x1d25298, size 0xa68, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x1d242fc, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1d24304, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Enc, addr 0x1d2604c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptData, addr 0x1d246c8, size 0xbd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyExpansion, addr 0x1d23da4, size 0x558, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method MulX, addr 0x1d264bc, size 0x24, virtual false, abstract: false, final false
  static inline int32_t MulX(int32_t x);

  static inline ::System::Security::Cryptography::RijndaelManagedTransform* New_ctor();
  ...
  /// @brief Method Reset, addr 0x1d25fe4, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SubWord, addr 0x1d263f8, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method TransformBlock, addr 0x1d243f0, size 0x2d8, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x1d25d00, size 0x2e4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1d266dc, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1d23798, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSizeValue, addr 0x1d243c8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_BlockSizeValue();

  /// @brief Method get_CanReuseTransform, addr 0x1d243e8, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanReuseTransform();

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x1d243e0, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x1d243d0, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x1d243d8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method rot1, addr 0x1d264e8, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x1d264e0, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x1d263f0, size 0x8, virtual false, abstract: false, final false
