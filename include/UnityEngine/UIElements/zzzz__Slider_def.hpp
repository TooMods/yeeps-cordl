...
public:
  ...
  /// @brief Method Init, addr 0x27be9f4, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27beca8, size 0x228, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ComputeValueFromKey, addr 0x27be728, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method ParseStringToValue, addr 0x27be658, size 0xd0, virtual true, abstract: false, final false
  inline float_t ParseStringToValue(::StringW stringValue);

  /// @brief Method SliderLerpUnclamped, addr 0x27be398, size 0x2b0, virtual true, abstract: false, final false
  inline float_t SliderLerpUnclamped(float_t a, float_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x27be648, size 0x10, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue);

  /// @brief Method .ctor, addr 0x27be228, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27be240, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27be38c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x27b1c90, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
