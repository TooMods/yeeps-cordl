...
public:
  ...
  /// @brief Method Clone, addr 0x1ce288c, size 0xf4, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  static inline ::System::Xml::Schema::XmlSchemaAttributeGroup* New_ctor();

  /// @brief Method SetQualifiedName, addr 0x1ce2884, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce2d0c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AnyAttribute, addr 0x1ce27b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AttributeUses, addr 0x1ce27d0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeUses();

  /// @brief Method get_AttributeWildcard, addr 0x1ce283c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AttributeWildcard();

  /// @brief Method get_Attributes, addr 0x1ce27b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes();

  /// @brief Method get_Name, addr 0x1ce27a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x1ce2874, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_QualifiedName, addr 0x1ce27c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_Redefined, addr 0x1ce2854, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttributeGroup* get_Redefined();

  /// @brief Method get_RedefinedAttributeGroup, addr 0x1ce284c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttributeGroup* get_RedefinedAttributeGroup();

  /// @brief Method get_SelfReferenceCount, addr 0x1ce2864, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SelfReferenceCount();

  /// @brief Method set_AnyAttribute, addr 0x1ce27c0, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_AttributeWildcard, addr 0x1ce2844, size 0x8, virtual false, abstract: false, final false
  inline void set_AttributeWildcard(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Name, addr 0x1ce27a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x1ce287c, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Redefined, addr 0x1ce285c, size 0x8, virtual false, abstract: false, final false
  inline void set_Redefined(::System::Xml::Schema::XmlSchemaAttributeGroup* value);

  /// @brief Method set_SelfReferenceCount, addr 0x1ce286c, size 0x8, virtual false, abstract: false, final false
