...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::DecalSettings::*)()>(
  ...
  constexpr static std::size_t addrs = 0x27293e4;
...
UnityEngine::Rendering::Universal::DecalSettings::__cordl_internal_get_dBufferSettings() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___dBufferSettings;
}
...
UnityEngine::Rendering::Universal::DecalSettings::__cordl_internal_get_screenSpaceSettings() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___screenSpaceSettings;
}
