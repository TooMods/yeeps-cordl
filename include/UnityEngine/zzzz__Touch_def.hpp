...
public:
  ...
  /// @brief Method get_altitudeAngle, addr 0x1e95754, size 0x8, virtual false, abstract: false, final false
  inline float_t get_altitudeAngle();

  /// @brief Method get_azimuthAngle, addr 0x1e9575c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_azimuthAngle();

  /// @brief Method get_deltaPosition, addr 0x1e95714, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_deltaPosition();

  /// @brief Method get_deltaTime, addr 0x1e95724, size 0x8, virtual false, abstract: false, final false
  inline float_t get_deltaTime();

  /// @brief Method get_fingerId, addr 0x1e956ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_fingerId();

  /// @brief Method get_maximumPossiblePressure, addr 0x1e95744, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maximumPossiblePressure();

  /// @brief Method get_phase, addr 0x1e95734, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TouchPhase get_phase();

  /// @brief Method get_position, addr 0x1e956f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_position();

  /// @brief Method get_pressure, addr 0x1e9573c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x1e95764, size 0x8, virtual false, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method get_radiusVariance, addr 0x1e9576c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_radiusVariance();

  /// @brief Method get_rawPosition, addr 0x1e95704, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_rawPosition();

  /// @brief Method get_tapCount, addr 0x1e9572c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tapCount();

  /// @brief Method get_type, addr 0x1e9574c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TouchType get_type();

  /// @brief Method set_deltaPosition, addr 0x1e9571c, size 0x8, virtual false, abstract: false, final false
  inline void set_deltaPosition(::UnityEngine::Vector2 value);

  /// @brief Method set_position, addr 0x1e956fc, size 0x8, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector2 value);

  /// @brief Method set_rawPosition, addr 0x1e9570c, size 0x8, virtual false, abstract: false, final false
