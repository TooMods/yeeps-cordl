...
public:
  ...
  /// @brief Method ParseMultiValue, addr 0xf59878, size 0x1f8, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> ParseMultiValue(::StringW value);

  /// @brief Method ParseSingleValue, addr 0xf597e8, size 0x90, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> ParseSingleValue(::StringW value);

  /// @brief Method .ctor, addr 0xf56d18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0xf545ec, size 0xdc, virtual false, abstract: false, final false
