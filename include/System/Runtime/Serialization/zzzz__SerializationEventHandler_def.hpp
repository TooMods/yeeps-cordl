...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x1869154, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1869090, size 0xc4, virtual false, abstract: false, final false
