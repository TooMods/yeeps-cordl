...
public:
  ...
  /// @brief Method Execute, addr 0x14961dc, size 0x98, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x1496274, size 0x7c, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x14962f0, size 0x220, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x1496510, size 0x14, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1496540, size 0x56c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRSceneVolumeMeshFilter___CreateVolumeMesh_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x1496afc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1496b04, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1496b44, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1496524, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x1496aac, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x149616c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateVolumeMesh, addr 0x1496104, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* CreateVolumeMesh();

  /// @brief Method IsJobDone, addr 0x1496194, size 0x40, virtual false, abstract: false, final false
  static inline bool IsJobDone(::Unity::Jobs::JobHandle job);

  static inline ::GlobalNamespace::OVRSceneVolumeMeshFilter* New_ctor();

  /// @brief Method Start, addr 0x1496030, size 0xd4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x14961d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsCompleted, addr 0x149601c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method set_IsCompleted, addr 0x1496024, size 0xc, virtual false, abstract: false, final false
