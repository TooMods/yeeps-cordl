...
public:
  ...
  /// @brief Method Init, addr 0x128b9b4, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x128bc14, size 0x20c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BindTreeItem, addr 0x128abfc, size 0x35c, virtual false, abstract: false, final false
  inline void BindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method CollapseItemByIndex, addr 0x12892ec, size 0x24c, virtual false, abstract: false, final false
  inline void CollapseItemByIndex(int32_t index);

  /// @brief Method CreateWrappers, addr 0x128b06c, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandItemByIndex, addr 0x1288fe4, size 0x308, virtual false, abstract: false, final false
  inline void ExpandItemByIndex(int32_t index);

  /// @brief Method GetAllItems, addr 0x1288de4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method GetItemId, addr 0x128af58, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetItemId(int32_t index);

  /// @brief Method IsExpandedByIndex, addr 0x1288f48, size 0x9c, virtual false, abstract: false, final false
  inline bool IsExpandedByIndex(int32_t index);

  /// @brief Method ListViewRefresh, addr 0x1288d68, size 0x1c, virtual false, abstract: false, final false
  inline void ListViewRefresh();

  /// @brief Method MakeTreeItem, addr 0x128a5e0, size 0x4e0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* MakeTreeItem();

  static inline ::UnityEngine::UIElements::InternalTreeView* New_ctor();

  /// @brief Method OnCustomStyleResolved, addr 0x128b710, size 0x150, virtual false, abstract: false, final false
  inline void OnCustomStyleResolved(::UnityEngine::UIElements::CustomStyleResolvedEvent* e);

  /// @brief Method OnItemMouseUp, addr 0x1289de4, size 0x7fc, virtual false, abstract: false, final false
  inline void OnItemMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnItemsChosen, addr 0x1289538, size 0x420, virtual false, abstract: false, final false
  inline void OnItemsChosen(::System::Collections::Generic::IEnumerable_1<::System::Object*>* chosenItems);

  /// @brief Method OnKeyDown, addr 0x1288e8c, size 0xbc, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnSelectionChange, addr 0x1289958, size 0x454, virtual false, abstract: false, final false
  inline void OnSelectionChange(::System::Collections::Generic::IEnumerable_1<::System::Object*>* selectedListItems);

  /// @brief Method OnTreeViewMouseUp, addr 0x1289dac, size 0x38, virtual false, abstract: false, final false
  inline void OnTreeViewMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnViewDataReady, addr 0x1288da8, size 0x3c, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method Rebuild, addr 0x1288d84, size 0x24, virtual false, abstract: false, final false
  inline void Rebuild();

  /// @brief Method RefreshItems, addr 0x1288cbc, size 0x24, virtual false, abstract: false, final false
  inline void RefreshItems();

  /// @brief Method RegenerateWrappers, addr 0x1288ce0, size 0x88, virtual false, abstract: false, final false
  inline void RegenerateWrappers();

  /// @brief Method ToggleExpandedState, addr 0x128b58c, size 0x184, virtual false, abstract: false, final false
  inline void ToggleExpandedState(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method UnbindTreeItem, addr 0x128aac0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1288768, size 0x554, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_unbindItem, addr 0x12886e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_itemHeight, addr 0x12886f0, size 0x20, virtual false, abstract: false, final false
  inline void set_itemHeight(int32_t value);

  /// @brief Method set_selectionType, addr 0x1288730, size 0x1c, virtual false, abstract: false, final false
  inline void set_selectionType(::UnityEngine::UIElements::SelectionType value);

  /// @brief Method set_showAlternatingRowBackgrounds, addr 0x128874c, size 0x1c, virtual false, abstract: false, final false
  inline void set_showAlternatingRowBackgrounds(::UnityEngine::UIElements::AlternatingRowBackground value);

  /// @brief Method set_showBorder, addr 0x1288710, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x128b96c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_id, addr 0x128afcc, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x128be24, size 0x3f8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.ITreeViewItem>.GetEnumerator, addr 0x128c26c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.ITreeViewItem>.get_Current, addr 0x128c21c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x128c30c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x128c224, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x128c264, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x128be20, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1288e48, size 0x44, virtual false, abstract: false, final false
