...
public:
  ...
  /// @brief Method MoveNext, addr 0x22aa49c, size 0x2bc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::XR::Management::__XRManagerSettings___InitializeLoader_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x22aa7a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x22aa7b0, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x22aa7f0, size 0x5eec8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x22aa480, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x22aa758, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x22a9da0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x22aa1c8, size 0x1a0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CheckGraphicsAPICompatibility, addr 0x22a9be4, size 0x154, virtual false, abstract: false, final false
  inline bool CheckGraphicsAPICompatibility(::UnityEngine::XR::Management::XRLoader* loader);

  /// @brief Method DeinitializeLoader, addr 0x22a9880, size 0xe4, virtual false, abstract: false, final false
  inline void DeinitializeLoader();

  /// @brief Method InitializeLoader, addr 0x22a9d38, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* InitializeLoader();

  /// @brief Method InitializeLoaderSync, addr 0x22a93e0, size 0x23c, virtual false, abstract: false, final false
  inline void InitializeLoaderSync();

  static inline ::UnityEngine::XR::Management::XRManagerSettings* New_ctor();

  /// @brief Method OnDestroy, addr 0x22aa398, size 0x10, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x22aa380, size 0x18, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Start, addr 0x22aa368, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSubsystems, addr 0x22a961c, size 0xdc, virtual false, abstract: false, final false
  inline void StartSubsystems();

  /// @brief Method StopSubsystems, addr 0x22a97a4, size 0xdc, virtual false, abstract: false, final false
  inline void StopSubsystems();

  /// @brief Method TryAddLoader, addr 0x22a9dc8, size 0x194, virtual false, abstract: false, final false
  inline bool TryAddLoader(::UnityEngine::XR::Management::XRLoader* loader, int32_t index);

  /// @brief Method TryRemoveLoader, addr 0x22a9f5c, size 0x94, virtual false, abstract: false, final false
  inline bool TryRemoveLoader(::UnityEngine::XR::Management::XRLoader* loader);

  /// @brief Method TrySetLoaders, addr 0x22a9ff0, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22aa3c0, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeLoader, addr 0x22a9bd4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::XR::Management::XRLoader> get_activeLoader();

  /// @brief Method get_activeLoaders, addr 0x22a9bc4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_activeLoaders();

  /// @brief Method get_automaticLoading, addr 0x22a9b94, size 0x8, virtual false, abstract: false, final false
  inline bool get_automaticLoading();

  /// @brief Method get_automaticRunning, addr 0x22a9ba8, size 0x8, virtual false, abstract: false, final false
  inline bool get_automaticRunning();

  /// @brief Method get_currentLoaders, addr 0x22aa3a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_currentLoaders();

  /// @brief Method get_isInitializationComplete, addr 0x22a9bcc, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitializationComplete();

  /// @brief Method get_loaders, addr 0x22a9bbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_loaders();

  /// @brief Method get_registeredLoaders, addr 0x22aa3b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_registeredLoaders();

  /// @brief Method set_activeLoader, addr 0x22a9bdc, size 0x8, virtual false, abstract: false, final false
  inline void set_activeLoader(::UnityEngine::XR::Management::XRLoader* value);

  /// @brief Method set_automaticLoading, addr 0x22a9b9c, size 0xc, virtual false, abstract: false, final false
  inline void set_automaticLoading(bool value);

  /// @brief Method set_automaticRunning, addr 0x22a9bb0, size 0xc, virtual false, abstract: false, final false
  inline void set_automaticRunning(bool value);

  /// @brief Method set_currentLoaders, addr 0x22aa3b0, size 0x8, virtual false, abstract: false, final false
