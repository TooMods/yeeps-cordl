...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4e28, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetDataFromMessage(void* c_message);

  /// @brief Method GetParty, addr 0x19b4dec, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b11d4, size 0x58, virtual false, abstract: false, final false
