...
public:
  ...
  /// @brief Method CanHaveMaxLength, addr 0x1ca3f10, size 0x64, virtual false, abstract: false, final false
  inline bool CanHaveMaxLength();

  /// @brief Method ConvertToAnnonymousSimpleType, addr 0x1ca3f74, size 0x74, virtual false, abstract: false, final false
  inline void ConvertToAnnonymousSimpleType();

  /// @brief Method CreateByteArrayType, addr 0x1ca3c38, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Data::SimpleType* CreateByteArrayType(::StringW encoding);

  /// @brief Method CreateEnumeratedType, addr 0x1ca3bc0, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Data::SimpleType* CreateEnumeratedType(::StringW values);

  /// @brief Method CreateLimitedStringType, addr 0x1ca3ca8, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Data::SimpleType* CreateLimitedStringType(int32_t length);

  /// @brief Method CreateSimpleType, addr 0x1ca3d20, size 0xf0, virtual false, abstract: false, final false
  static inline ::System::Data::SimpleType* CreateSimpleType(::System::Data::Common::StorageType typeCode, ::System::Type* type);

  /// @brief Method HasConflictingDefinition, addr 0x1ca3e10, size 0x100, virtual false, abstract: false, final false
  inline ::StringW HasConflictingDefinition(::System::Data::SimpleType* otherSimpleType);

  /// @brief Method IsPlainString, addr 0x1ca3508, size 0x138, virtual false, abstract: false, final false
  inline bool IsPlainString();

  /// @brief Method LoadTypeValues, addr 0x1ca2c34, size 0x894, virtual false, abstract: false, final false
  ...
  /// @brief Method QualifiedName, addr 0x1ca36f0, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW QualifiedName(::StringW name);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x1ca34c8, size 0x40, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToNode, addr 0x1ca376c, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ca2a88, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW baseType);

  /// @brief Method .ctor, addr 0x1ca2b14, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaSimpleType* node);

  /// @brief Method get_BaseSimpleType, addr 0x1ca3678, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::SimpleType* get_BaseSimpleType();

  /// @brief Method get_BaseType, addr 0x1ca3640, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BaseType();

  /// @brief Method get_Length, addr 0x1ca3660, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_MaxLength, addr 0x1ca3668, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxLength();

  /// @brief Method get_Name, addr 0x1ca3650, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x1ca3658, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_SimpleTypeQualifiedName, addr 0x1ca3680, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_SimpleTypeQualifiedName();

  /// @brief Method get_XmlBaseType, addr 0x1ca3648, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_XmlBaseType();

  /// @brief Convert to "::System::Runtime::Serialization::ISerializable"
  constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

  /// @brief Method set_MaxLength, addr 0x1ca3670, size 0x8, virtual false, abstract: false, final false
