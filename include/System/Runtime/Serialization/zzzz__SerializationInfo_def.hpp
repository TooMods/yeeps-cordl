...
public:
  ...
  /// @brief Method AddValue, addr 0x1aaf454, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, ::System::DateTime value);

  /// @brief Method AddValue, addr 0x1aaedc8, size 0xb8, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, ::System::Object* value);

  /// @brief Method AddValue, addr 0x1aadaac, size 0x84, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, ::System::Object* value, ::System::Type* type);

  /// @brief Method AddValue, addr 0x1aaee80, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, bool value);

  /// @brief Method AddValue, addr 0x1aaf378, size 0xdc, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, float_t value);

  /// @brief Method AddValue, addr 0x1aaf028, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, int16_t value);

  /// @brief Method AddValue, addr 0x1aaf0fc, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, int32_t value);

  /// @brief Method AddValue, addr 0x1aaf1d0, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, int64_t value);

  /// @brief Method AddValue, addr 0x1aaf2a4, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, uint64_t value);

  /// @brief Method AddValue, addr 0x1aaef54, size 0xd4, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, uint8_t value);

  /// @brief Method AddValueInternal, addr 0x1aaebe8, size 0x1e0, virtual false, abstract: false, final false
  inline void AddValueInternal(::StringW name, ::System::Object* value, ::System::Type* type);

  /// @brief Method Compare, addr 0x1aae87c, size 0x88, virtual false, abstract: false, final false
  static inline bool Compare(::ArrayW<uint8_t, ::Array<uint8_t>*> a, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method DemandForUnsafeAssemblyNameAssignments, addr 0x1aae878, size 0x4, virtual false, abstract: false, final false
  static inline void DemandForUnsafeAssemblyNameAssignments(::StringW originalAssemblyName, ::StringW newAssemblyName);

  /// @brief Method ExpandArrays, addr 0x1aaeadc, size 0x10c, virtual false, abstract: false, final false
  inline void ExpandArrays();

  /// @brief Method FindElement, addr 0x1aaf528, size 0xc8, virtual false, abstract: false, final false
  inline int32_t FindElement(::StringW name);

  /// @brief Method GetBoolean, addr 0x1aaf774, size 0x180, virtual false, abstract: false, final false
  inline bool GetBoolean(::StringW name);

  /// @brief Method GetElement, addr 0x1aaf5f0, size 0x108, virtual false, abstract: false, final false
  inline ::System::Object* GetElement(::StringW name, ByRef<::System::Type*> foundType);

  /// @brief Method GetElementNoThrow, addr 0x1aaf6f8, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Object* GetElementNoThrow(::StringW name, ByRef<::System::Type*> foundType);

  /// @brief Method GetEnumerator, addr 0x1aaea58, size 0x84, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationInfoEnumerator* GetEnumerator();

  /// @brief Method GetInt32, addr 0x1aaf8f4, size 0x174, virtual false, abstract: false, final false
  inline int32_t GetInt32(::StringW name);

  /// @brief Method GetInt64, addr 0x1aafa68, size 0x174, virtual false, abstract: false, final false
  inline int64_t GetInt64(::StringW name);

  /// @brief Method GetSingle, addr 0x1aafbdc, size 0x174, virtual false, abstract: false, final false
  inline float_t GetSingle(::StringW name);

  /// @brief Method GetString, addr 0x1aafd50, size 0x16c, virtual false, abstract: false, final false
  inline ::StringW GetString(::StringW name);

  /// @brief Method GetValue, addr 0x1aad714, size 0x214, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(::StringW name, ::System::Type* type);

  /// @brief Method GetValueNoThrow, addr 0x1aad60c, size 0x108, virtual false, abstract: false, final false
  inline ::System::Object* GetValueNoThrow(::StringW name, ::System::Type* type);

  /// @brief Method IsAssemblyNameAssignmentSafe, addr 0x1aae904, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method SetType, addr 0x1aadb30, size 0x138, virtual false, abstract: false, final false
  inline void SetType(::System::Type* type);

  /// @brief Method UpdateValue, addr 0x1aaaebc, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1aae680, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Runtime::Serialization::IFormatterConverter* converter);

  /// @brief Method .ctor, addr 0x1aae688, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AssemblyName, addr 0x1aae870, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AssemblyName();

  /// @brief Method get_FullTypeName, addr 0x1aae868, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FullTypeName();

  /// @brief Method get_IsAssemblyNameSetExplicit, addr 0x1aaea50, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAssemblyNameSetExplicit();

  /// @brief Method get_IsFullTypeNameSetExplicit, addr 0x1aaea48, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsFullTypeNameSetExplicit();

  /// @brief Method get_MemberCount, addr 0x1aaea38, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MemberCount();

  /// @brief Method get_ObjectType, addr 0x1aaea40, size 0x8, virtual false, abstract: false, final false
