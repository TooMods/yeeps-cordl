...
public:
  ...
  /// @brief Method CloneNode, addr 0xff92f0, size 0x60, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method IsValidChildType, addr 0xff94b8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetBaseURI, addr 0xff9574, size 0x8, virtual false, abstract: false, final false
  inline void SetBaseURI(::StringW inBaseURI);

  /// @brief Method WriteContentTo, addr 0xff9568, size 0x4, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* w);

  /// @brief Method WriteTo, addr 0xff9564, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff926c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseURI, addr 0xff956c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_InnerText, addr 0xff9368, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_InnerText();

  /// @brief Method get_IsContainer, addr 0xff93d0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsReadOnly, addr 0xff9350, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LastNode, addr 0xff93d8, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlLinkedNode* get_LastNode();

  /// @brief Method get_LocalName, addr 0xff9360, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xff9358, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0xff94f4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_SystemId, addr 0xff94fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SystemId();

  /// @brief Method set_InnerText, addr 0xff9370, size 0x60, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_InnerXml, addr 0xff9504, size 0x60, virtual true, abstract: false, final false
  inline void set_InnerXml(::StringW value);

  /// @brief Method set_LastNode, addr 0xff94b0, size 0x8, virtual true, abstract: false, final false
