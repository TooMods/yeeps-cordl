...
public:
  ...
  /// @brief Method SetParticle, addr 0x1ce73d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce73ec, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Particle, addr 0x1ce73cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaGroupBase* get_Particle();

  /// @brief Method get_Redefined, addr 0x1ce73dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaGroup* get_Redefined();

  /// @brief Method get_RefName, addr 0x1ce73c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_RefName();

  /// @brief Method set_Redefined, addr 0x1ce73e4, size 0x8, virtual false, abstract: false, final false
  inline void set_Redefined(::System::Xml::Schema::XmlSchemaGroup* value);

  /// @brief Method set_RefName, addr 0x1ce5160, size 0x98, virtual false, abstract: false, final false
