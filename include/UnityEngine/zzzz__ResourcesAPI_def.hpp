...
public:
  ...
  /// @brief Method FindObjectsOfTypeAll, addr 0x2a816a8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method FindShaderByName, addr 0x2a816e4, size 0x3c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> FindShaderByName(::StringW name);

  /// @brief Method Load, addr 0x2a81720, size 0x44, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> Load(::StringW path, ::System::Type* systemTypeInstance);

  /// @brief Method LoadAll, addr 0x2a81764, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a816a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ActiveAPI, addr 0x2a815a0, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::ResourcesAPI* get_ActiveAPI();

  /// @brief Method get_overrideAPI, addr 0x2a81648, size 0x58, virtual false, abstract: false, final false
