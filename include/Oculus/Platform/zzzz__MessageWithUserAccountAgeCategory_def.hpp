...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5a08, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserAccountAgeCategory* GetDataFromMessage(void* c_message);

  /// @brief Method GetUserAccountAgeCategory, addr 0x19b59cc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b164c, size 0x58, virtual false, abstract: false, final false
