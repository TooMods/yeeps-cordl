...
public:
  ...
  /// @brief Method Dispose, addr 0x30a805c, size 0x94, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Release, addr 0x30aa720, size 0x3c, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method ValidateCertificate, addr 0x30aa75c, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateCertificate(::ArrayW<uint8_t, ::Array<uint8_t>*> certificateData);

  /// @brief Method ValidateCertificateNative, addr 0x30aa764, size 0x23a40, virtual false, abstract: false, final false
