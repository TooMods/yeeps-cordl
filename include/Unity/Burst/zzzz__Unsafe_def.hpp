...
public:
  ...
  /// @brief Method CopyBlock, addr 0x1acbb54, size 0x8, virtual false, abstract: false, final false
  static inline void CopyBlock(::cordl_internals::Ptr<void> destination, ::cordl_internals::Ptr<void> source, uint32_t byteCount);

  /// @brief Method CopyBlock, addr 0x1acbb5c, size 0x8, virtual false, abstract: false, final false
  static inline void CopyBlock(ByRef<uint8_t> destination, ByRef<uint8_t> source, uint32_t byteCount);

  /// @brief Method CopyBlockUnaligned, addr 0x1acbb64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyBlockUnaligned, addr 0x1acbb6c, size 0x8, virtual false, abstract: false, final false
  static inline void CopyBlockUnaligned(ByRef<uint8_t> destination, ByRef<uint8_t> source, uint32_t byteCount);

  /// @brief Method InitBlock, addr 0x1acbb74, size 0x8, virtual false, abstract: false, final false
  static inline void InitBlock(::cordl_internals::Ptr<void> startAddress, uint8_t value, uint32_t byteCount);

  /// @brief Method InitBlock, addr 0x1acbb7c, size 0x8, virtual false, abstract: false, final false
  static inline void InitBlock(ByRef<uint8_t> startAddress, uint8_t value, uint32_t byteCount);

  /// @brief Method InitBlockUnaligned, addr 0x1acbb84, size 0x8, virtual false, abstract: false, final false
  static inline void InitBlockUnaligned(::cordl_internals::Ptr<void> startAddress, uint8_t value, uint32_t byteCount);

  /// @brief Method InitBlockUnaligned, addr 0x1acbb8c, size 0x8, virtual false, abstract: false, final false
