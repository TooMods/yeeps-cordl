...
public:
  // Declarations
  /// @brief Method ToString, addr 0x18417fc, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x18417f0, size 0xc, virtual false, abstract: false, final false
