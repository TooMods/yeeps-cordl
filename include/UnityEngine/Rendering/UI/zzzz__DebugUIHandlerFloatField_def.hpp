...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_Field, put = __cordl_internal_set_m_Field))::UnityEngine::Rendering::__DebugUI__FloatField* m_Field;
  ...
  /// @brief Method ChangeValue, addr 0x1d95a34, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDecrement, addr 0x1d95ae0, size 0xc, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnDeselection, addr 0x1d959d8, size 0x50, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnIncrement, addr 0x1d95a28, size 0xc, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method OnSelection, addr 0x1d95980, size 0x58, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x1d9582c, size 0x8c, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::__DebugUI__Widget* widget);

  /// @brief Method UpdateValueLabel, addr 0x1d958b8, size 0xc8, virtual false, abstract: false, final false
  inline void UpdateValueLabel();

  constexpr ::UnityEngine::Rendering::__DebugUI__FloatField*& __cordl_internal_get_m_Field();

  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::__DebugUI__FloatField*> const& __cordl_internal_get_m_Field() const;
  ...
  constexpr void __cordl_internal_set_m_Field(::UnityEngine::Rendering::__DebugUI__FloatField* value);
  ...
  /// @brief Method .ctor, addr 0x1d95aec, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::UnityEngine::Rendering::__DebugUI__FloatField* ___m_Field;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::UI::DebugUIHandlerFloatField, 0x70>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::UI::DebugUIHandlerFloatField, ___nameLabel) == 0x58, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::UI::DebugUIHandlerFloatField, ___valueLabel) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::UI::DebugUIHandlerFloatField, ___m_Field) == 0x68, "Offset mismatch!");
