...
public:
  // Declarations
  /// @brief Method CloseProcess, addr 0x2433250, size 0x4, virtual false, abstract: false, final false
  static inline bool CloseProcess(void* handle);

  /// @brief Method DuplicateHandle, addr 0x2432fe0, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method DuplicateHandle, addr 0x2432ddc, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcess, addr 0x243315c, size 0x4, virtual false, abstract: false, final false
  static inline void* GetCurrentProcess();

  /// @brief Method GetCurrentProcessId, addr 0x243324c, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetCurrentProcessId();

  /// @brief Method GetExitCodeProcess, addr 0x2433164, size 0xe8, virtual false, abstract: false, final false
  static inline bool GetExitCodeProcess(::Microsoft::Win32::SafeHandles::SafeProcessHandle* processHandle, ByRef<int32_t> exitCode);

  /// @brief Method GetExitCodeProcess, addr 0x2433160, size 0x4, virtual false, abstract: false, final false
