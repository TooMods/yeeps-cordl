...
public:
  // Declarations
  /// @brief Method CountBackslashes, addr 0x2ca042c, size 0xa4, virtual false, abstract: false, final false
  static inline int32_t CountBackslashes(::StringW data, int32_t index);

  /// @brief Method CountQuotedChars, addr 0x2c9f204, size 0x194, virtual false, abstract: false, final false
