...
public:
  ...
  /// @brief Method .ctor, addr 0x1b2e8d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReturnType, addr 0x1b2e8e8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x1b2e8e0, size 0x8, virtual true, abstract: false, final false
