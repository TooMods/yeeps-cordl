...
public:
  ...
  /// @brief Method .ctor, addr 0x10e4d58, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x10e4da4, size 0x8, virtual false, abstract: false, final false
