...
public:
  ...
  /// @brief Method Add, addr 0x1cdca00, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x1ce35a0, size 0x148, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* Add(::StringW ns, ::System::Xml::Schema::SchemaInfo* schemaInfo, ::System::Xml::Schema::XmlSchema* schema, bool compile,
                                               ::System::Xml::XmlResolver* resolver);

  /// @brief Method Add, addr 0x1ce36f0, size 0x13c, virtual false, abstract: false, final false
  inline void Add(::StringW ns, ::System::Xml::Schema::XmlSchemaCollectionNode* node);

  /// @brief Method GetEnumerator, addr 0x1ce31d0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaCollectionEnumerator* GetEnumerator();

  /// @brief Method GetSchemaInfo, addr 0x1cde370, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* GetSchemaInfo(::StringW ns);

  /// @brief Method GetSchemaNames, addr 0x1ce34f8, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x1ce3234, size 0x11c, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_Count, addr 0x1ce34d4, size 0x24, virtual true, abstract: false, final true
  inline int32_t System_Collections_ICollection_get_Count();

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x1ce34c8, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x1ce34d0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_ICollection_get_SyncRoot();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1ce3128, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ce2f2c, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nametable);

  /// @brief Method get_Count, addr 0x1ce3050, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_EventHandler, addr 0x1ce382c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ValidationEventHandler* get_EventHandler();

  /// @brief Method get_Item, addr 0x1ce3084, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_Item(::StringW ns);

  /// @brief Method get_NameTable, addr 0x1ce3074, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EventHandler, addr 0x1ce3834, size 0x8, virtual false, abstract: false, final false
  inline void set_EventHandler(::System::Xml::Schema::ValidationEventHandler* value);

  /// @brief Method set_XmlResolver, addr 0x1ce307c, size 0x8, virtual false, abstract: false, final false
