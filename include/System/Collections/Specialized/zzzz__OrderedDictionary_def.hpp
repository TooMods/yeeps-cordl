...
public:
  ...
  /// @brief Method MoveNext, addr 0x18efcb0, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x18efd50, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x18ef148, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* array, int32_t objectReturnType);

  /// @brief Method get_Current, addr 0x18ef7a8, size 0x1ac, virtual true, abstract: false, final true
  inline ::System::Object* get_Current();

  /// @brief Method get_Entry, addr 0x18ef954, size 0x194, virtual true, abstract: false, final true
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x18efae8, size 0xe4, virtual true, abstract: false, final true
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x18efbcc, size 0xe4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x18efdf4, size 0x3fc, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_Count, addr 0x18f01f0, size 0x24, virtual true, abstract: false, final true
  inline int32_t System_Collections_ICollection_get_Count();

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x18f0214, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x18f021c, size 0x24, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_ICollection_get_SyncRoot();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x18f0240, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18ee6d4, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x18eebf0, size 0x128, virtual true, abstract: false, final true
  inline void Add(::System::Object* key, ::System::Object* value);

  /// @brief Method Clear, addr 0x18eed18, size 0x98, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x18d1d30, size 0x2c, virtual true, abstract: false, final true
  inline bool Contains(::System::Object* key);

  /// @brief Method CopyTo, addr 0x18eedb0, size 0x3c, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x18ef0d4, size 0x74, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetObjectData, addr 0x18ef208, size 0x1d8, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method IndexOfKey, addr 0x18eea70, size 0x180, virtual false, abstract: false, final false
  inline int32_t IndexOfKey(::System::Object* key);

  /// @brief Method Insert, addr 0x18eedec, size 0x17c, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDeserialization, addr 0x18ef3f0, size 0x3b8, virtual true, abstract: false, final false
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method Remove, addr 0x18e10c0, size 0x108, virtual true, abstract: false, final true
  inline void Remove(::System::Object* key);

  /// @brief Method RemoveAt, addr 0x18eef68, size 0x16c, virtual true, abstract: false, final true
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x18ee650, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x18ee788, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_ICollection_get_SyncRoot();

  /// @brief Method System.Collections.IDictionary.get_IsFixedSize, addr 0x18ee640, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_IDictionary_get_IsFixedSize();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x18ef194, size 0x74, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x18ef3e0, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18ee554, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x18d1d04, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x18ee574, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, ::System::Collections::IEqualityComparer* comparer);

  /// @brief Method .ctor, addr 0x18ee5a4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_Count, addr 0x18d1edc, size 0x24, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x18ee648, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x18ee804, size 0x90, virtual true, abstract: false, final true
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x18e1094, size 0x2c, virtual true, abstract: false, final true
  inline ::System::Object* get_Item(::System::Object* key);

  /// @brief Method get_Keys, addr 0x18ee658, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_Values, addr 0x18d1f00, size 0x78, virtual true, abstract: false, final true
  inline ::System::Collections::ICollection* get_Values();

  /// @brief Method get_objectsArray, addr 0x18ee5cc, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_objectsArray();

  /// @brief Method get_objectsTable, addr 0x18ee704, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x18ee894, size 0x1dc, virtual true, abstract: false, final true
  inline void set_Item(int32_t index, ::System::Object* value);

  /// @brief Method set_Item, addr 0x18d1d5c, size 0x180, virtual true, abstract: false, final true
