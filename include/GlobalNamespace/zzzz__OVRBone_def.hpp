...
public:
  ...
  /// @brief Method .ctor, addr 0x169c1cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x169cf48, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::__OVRSkeleton__BoneId id, int16_t parentBoneIndex, ::UnityEngine::Transform* trans);

  /// @brief Method get_Id, addr 0x169cf18, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSkeleton__BoneId get_Id();

  /// @brief Method get_ParentBoneIndex, addr 0x169cf28, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_ParentBoneIndex();

  /// @brief Method get_Transform, addr 0x169cf38, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_Transform();

  /// @brief Method set_Id, addr 0x169cf20, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::GlobalNamespace::__OVRSkeleton__BoneId value);

  /// @brief Method set_ParentBoneIndex, addr 0x169cf30, size 0x8, virtual false, abstract: false, final false
  inline void set_ParentBoneIndex(int16_t value);

  /// @brief Method set_Transform, addr 0x169cf40, size 0x8, virtual false, abstract: false, final false
