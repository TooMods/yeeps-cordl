...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x183c728, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183c628, size 0x28, virtual false, abstract: false, final false
