...
public:
  ...
  /// @brief Method .ctor, addr 0x23a751c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW qualifiedCppName);

  /// @brief Method .ctor, addr 0x23a758c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW qualifiedCppName, ::StringW declaration);

  /// @brief Method set_Declaration, addr 0x23a7514, size 0x8, virtual false, abstract: false, final false
  inline void set_Declaration(::StringW value);

  /// @brief Method set_QualifiedNativeName, addr 0x23a750c, size 0x8, virtual false, abstract: false, final false
