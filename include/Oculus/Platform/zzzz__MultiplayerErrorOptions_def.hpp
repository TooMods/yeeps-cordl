...
public:
  ...
  /// @brief Method Finalize, addr 0x19b62a0, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::MultiplayerErrorOptions* New_ctor();

  /// @brief Method SetErrorKey, addr 0x19b61e0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b617c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x19b6248, size 0x58, virtual false, abstract: false, final false
