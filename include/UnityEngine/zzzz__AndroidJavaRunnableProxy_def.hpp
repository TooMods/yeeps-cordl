...
public:
  ...
  /// @brief Method .ctor, addr 0x2f49f6c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaRunnable* runnable);

  /// @brief Method run, addr 0x2f4a068, size 0x24, virtual false, abstract: false, final false
  inline void run();
