...
public:
  ...
  /// @brief Method RenderIntoCubemap, addr 0x16e8d70, size 0x580, virtual false, abstract: false, final false
  static inline void RenderIntoCubemap(::UnityEngine::Camera* ownerCamera, ::UnityEngine::Cubemap* outCubemap);

  /// @brief Method SaveCubemapCapture, addr 0x16e92f0, size 0x774, virtual false, abstract: false, final false
  static inline bool SaveCubemapCapture(::UnityEngine::Cubemap* cubemap, ::StringW pathName);

  /// @brief Method TriggerCubemapCapture, addr 0x16e8ac0, size 0x2b0, virtual false, abstract: false, final false
  static inline void TriggerCubemapCapture(::UnityEngine::Vector3 capturePos, int32_t cubemapSize, ::StringW pathName);

  /// @brief Method Update, addr 0x16e8a18, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16e9a64, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
