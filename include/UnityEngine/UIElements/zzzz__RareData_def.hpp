...
public:
  ...
  /// @brief Method Copy, addr 0x128cea4, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::RareData Copy();

  /// @brief Method CopyFrom, addr 0x128cec0, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::RareData> other);

  /// @brief Method Equals, addr 0x128d038, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x128cff4, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::RareData other);

  /// @brief Method GetHashCode, addr 0x128d0d8, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x128ced4, size 0x120, virtual false, abstract: false, final false
