...
public:
  ...
  /// @brief Method Awake, addr 0xfce808, size 0x170, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBackButtonState, addr 0xfce7a0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method RetreatOneLevel, addr 0xfcea4c, size 0xf8, virtual false, abstract: false, final false
  static inline bool RetreatOneLevel();

  /// @brief Method ShowConfirmQuitMenu, addr 0xfce978, size 0xd4, virtual false, abstract: false, final false
  inline void ShowConfirmQuitMenu();

  /// @brief Method Update, addr 0xfceb44, size 0x40, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0xfceb84, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
