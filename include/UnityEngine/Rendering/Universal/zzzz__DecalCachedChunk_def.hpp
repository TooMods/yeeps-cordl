...
// Type: UnityEngine.Rendering.Universal::DecalCachedChunk
...
public:
  ...
  /// @brief Field boundingSphereArray, offset 0x138, size 0x8
  __declspec(property(get = __cordl_internal_get_boundingSphereArray,
                      put = __cordl_internal_set_boundingSphereArray))::ArrayW<::UnityEngine::BoundingSphere, ::Array<::UnityEngine::BoundingSphere>*> boundingSphereArray;
  ...
  /// @brief Field dirty, offset 0x128, size 0x10
  ...
  /// @brief Field positions, offset 0xf8, size 0x10
  ...
  /// @brief Field rotation, offset 0x108, size 0x10
  ...
  /// @brief Field scales, offset 0x118, size 0x10
  ...
  /// @brief Method Dispose, addr 0x2e17094, size 0x1e8, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalCachedChunk* New_ctor();

  /// @brief Method RemoveAtSwapBack, addr 0x2e16b84, size 0x2cc, virtual true, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t entityIndex);

  /// @brief Method SetCapacity, addr 0x2e16e50, size 0x244, virtual true, abstract: false, final false
  ...
  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MaterialPropertyBlock*> const& __cordl_internal_get_propertyBlock() const;
  ...
  /// @brief Method .ctor, addr 0x2e1524c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field positions, offset: 0xf8, size: 0x10, def value: None
  ::Unity::Collections::NativeArray_1<::Unity::Mathematics::float3> ___positions;

  /// @brief Field rotation, offset: 0x108, size: 0x10, def value: None
  ::Unity::Collections::NativeArray_1<::Unity::Mathematics::quaternion> ___rotation;

  /// @brief Field scales, offset: 0x118, size: 0x10, def value: None
  ::Unity::Collections::NativeArray_1<::Unity::Mathematics::float3> ___scales;

  /// @brief Field dirty, offset: 0x128, size: 0x10, def value: None
  ::Unity::Collections::NativeArray_1<bool> ___dirty;

  /// @brief Field boundingSphereArray, offset: 0x138, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::BoundingSphere, ::Array<::UnityEngine::BoundingSphere>*> ___boundingSphereArray;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::Universal::DecalCachedChunk, 0x140>, "Size mismatch!");
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalCachedChunk, ___positions) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalCachedChunk, ___rotation) == 0x108, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalCachedChunk, ___scales) == 0x118, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalCachedChunk, ___dirty) == 0x128, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalCachedChunk, ___boundingSphereArray) == 0x138, "Offset mismatch!");
