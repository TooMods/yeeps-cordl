...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x18ac4cc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18ac3dc, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AttributeGroups, addr 0x18ac4b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeGroups();

  /// @brief Method get_Groups, addr 0x18ac4c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Groups();

  /// @brief Method get_Items, addr 0x18ac4ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items();

  /// @brief Method get_SchemaTypes, addr 0x18ac4bc, size 0x8, virtual false, abstract: false, final false
