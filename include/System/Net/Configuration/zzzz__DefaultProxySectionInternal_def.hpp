...
public:
  ...
  /// @brief Method GetDefaultProxy_UsingOldMonoCode, addr 0x2ded6f4, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Net::IWebProxy* GetDefaultProxy_UsingOldMonoCode();

  /// @brief Method GetSection, addr 0x2ded7a4, size 0x114, virtual false, abstract: false, final false
  static inline ::System::Net::Configuration::DefaultProxySectionInternal* GetSection();

  /// @brief Method GetSystemWebProxy, addr 0x2ded6fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ded8b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Object* getStaticF_classSyncObject();

  /// @brief Method get_ClassSyncObject, addr 0x2ded704, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Object* get_ClassSyncObject();

  /// @brief Method get_WebProxy, addr 0x2ded8c0, size 0x8, virtual false, abstract: false, final false
