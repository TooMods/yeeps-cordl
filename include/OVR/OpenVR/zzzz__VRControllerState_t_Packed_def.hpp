...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x2a75c70, size 0x3c, virtual false, abstract: false, final false
  inline void Unpack(ByRef<::OVR::OpenVR::VRControllerState_t> unpacked);

  /// @brief Method .ctor, addr 0x2a75c2c, size 0x44, virtual false, abstract: false, final false
