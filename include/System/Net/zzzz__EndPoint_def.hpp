...
public:
  ...
  /// @brief Method Create, addr 0xf51f08, size 0x24, virtual true, abstract: false, final false
  inline ::System::Net::EndPoint* Create(::System::Net::SocketAddress* socketAddress);

  static inline ::System::Net::EndPoint* New_ctor();

  /// @brief Method Serialize, addr 0xf51e5c, size 0x24, virtual true, abstract: false, final false
  inline ::System::Net::SocketAddress* Serialize();

  /// @brief Method .ctor, addr 0xf51f2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AddressFamily, addr 0xf51db0, size 0x24, virtual true, abstract: false, final false
