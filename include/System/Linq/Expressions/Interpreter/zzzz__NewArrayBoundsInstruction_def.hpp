...
public:
  ...
  /// @brief Method Run, addr 0x1841294, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1841214, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType, int32_t rank);

  /// @brief Method get_ConsumedStack, addr 0x1841244, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x1841254, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x184124c, size 0x8, virtual true, abstract: false, final false
