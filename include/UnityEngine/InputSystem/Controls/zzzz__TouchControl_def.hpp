...
public:
  ...
  /// @brief Method FinishSetup, addr 0x2266120, size 0x310, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Controls::TouchControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x2266430, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::TouchState ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x2266454, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22660a8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_delta, addr 0x2265fa4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::DeltaControl* get_delta();

  /// @brief Method get_displayIndex, addr 0x2265f74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_displayIndex();

  /// @brief Method get_indirectTouch, addr 0x2265fe4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_indirectTouch();

  /// @brief Method get_isInProgress, addr 0x2266034, size 0x74, virtual false, abstract: false, final false
  inline bool get_isInProgress();

  /// @brief Method get_phase, addr 0x2265fd4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::TouchPhaseControl* get_phase();

  /// @brief Method get_position, addr 0x2265f94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_position();

  /// @brief Method get_press, addr 0x2265f64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::TouchPressControl* get_press();

  /// @brief Method get_pressure, addr 0x2265fb4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_pressure();

  /// @brief Method get_radius, addr 0x2265fc4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_radius();

  /// @brief Method get_startPosition, addr 0x2266024, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_startPosition();

  /// @brief Method get_startTime, addr 0x2266014, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::DoubleControl* get_startTime();

  /// @brief Method get_tap, addr 0x2265ff4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_tap();

  /// @brief Method get_tapCount, addr 0x2266004, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_tapCount();

  /// @brief Method get_touchId, addr 0x2265f84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_touchId();

  /// @brief Method set_delta, addr 0x2265fac, size 0x8, virtual false, abstract: false, final false
  inline void set_delta(::UnityEngine::InputSystem::Controls::DeltaControl* value);

  /// @brief Method set_displayIndex, addr 0x2265f7c, size 0x8, virtual false, abstract: false, final false
  inline void set_displayIndex(::UnityEngine::InputSystem::Controls::IntegerControl* value);

  /// @brief Method set_indirectTouch, addr 0x2265fec, size 0x8, virtual false, abstract: false, final false
  inline void set_indirectTouch(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_phase, addr 0x2265fdc, size 0x8, virtual false, abstract: false, final false
  inline void set_phase(::UnityEngine::InputSystem::Controls::TouchPhaseControl* value);

  /// @brief Method set_position, addr 0x2265f9c, size 0x8, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::InputSystem::Controls::Vector2Control* value);

  /// @brief Method set_press, addr 0x2265f6c, size 0x8, virtual false, abstract: false, final false
  inline void set_press(::UnityEngine::InputSystem::Controls::TouchPressControl* value);

  /// @brief Method set_pressure, addr 0x2265fbc, size 0x8, virtual false, abstract: false, final false
  inline void set_pressure(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_radius, addr 0x2265fcc, size 0x8, virtual false, abstract: false, final false
  inline void set_radius(::UnityEngine::InputSystem::Controls::Vector2Control* value);

  /// @brief Method set_startPosition, addr 0x226602c, size 0x8, virtual false, abstract: false, final false
  inline void set_startPosition(::UnityEngine::InputSystem::Controls::Vector2Control* value);

  /// @brief Method set_startTime, addr 0x226601c, size 0x8, virtual false, abstract: false, final false
  inline void set_startTime(::UnityEngine::InputSystem::Controls::DoubleControl* value);

  /// @brief Method set_tap, addr 0x2265ffc, size 0x8, virtual false, abstract: false, final false
  inline void set_tap(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_tapCount, addr 0x226600c, size 0x8, virtual false, abstract: false, final false
  inline void set_tapCount(::UnityEngine::InputSystem::Controls::IntegerControl* value);

  /// @brief Method set_touchId, addr 0x2265f8c, size 0x8, virtual false, abstract: false, final false
