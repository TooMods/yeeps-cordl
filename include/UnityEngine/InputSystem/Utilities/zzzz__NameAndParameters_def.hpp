...
public:
  ...
  /// @brief Method <ToString>b__8_0, addr 0x226ef28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__8_0(::UnityEngine::InputSystem::Utilities::NamedValue x);

  /// @brief Method .ctor, addr 0x226ef20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Parse, addr 0x226ec90, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::NameAndParameters Parse(::StringW text);

  /// @brief Method ParseMultiple, addr 0x226e60c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMultiple, addr 0x226e6a8, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseName, addr 0x226ec10, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW ParseName(::StringW text);

  /// @brief Method ParseNameAndParameters, addr 0x226e884, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x226e424, size 0x1e8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_name, addr 0x226e400, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_parameters, addr 0x226e410, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::NamedValue> get_parameters();

  /// @brief Method set_name, addr 0x226e408, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_parameters, addr 0x226e41c, size 0x8, virtual false, abstract: false, final false
