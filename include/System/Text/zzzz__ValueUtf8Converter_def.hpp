...
public:
  // Declarations
  /// @brief Method ConvertAndTerminateString, addr 0x1e9b9b0, size 0x224, virtual false, abstract: false, final false
  inline ::System::Span_1<uint8_t> ConvertAndTerminateString(::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method Dispose, addr 0x1e9bc80, size 0xf4, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method .ctor, addr 0x1e9b9a4, size 0xc, virtual false, abstract: false, final false
