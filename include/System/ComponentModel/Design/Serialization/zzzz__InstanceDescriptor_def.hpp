...
public:
  ...
  /// @brief Method Invoke, addr 0x18d4254, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18ec07c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member, ::System::Collections::ICollection* arguments);

  /// @brief Method .ctor, addr 0x18ec084, size 0x50c, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member, ::System::Collections::ICollection* arguments, bool isComplete);

  /// @brief Method get_Arguments, addr 0x18ec590, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Arguments();

  /// @brief Method get_MemberInfo, addr 0x18ec598, size 0x8, virtual false, abstract: false, final false
