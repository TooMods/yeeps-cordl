...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x1f384fc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1f383cc, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x1f35508, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::StylePropertyValue GetValue(int32_t index);

  /// @brief Method GetValueType, addr 0x1f32e0c, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueType GetValueType(int32_t index);

  /// @brief Method IsKeyword, addr 0x1f32d68, size 0xa4, virtual false, abstract: false, final false
  inline bool IsKeyword(int32_t index, ::UnityEngine::UIElements::StyleValueKeyword keyword);

  /// @brief Method IsValueType, addr 0x1f32cd4, size 0x94, virtual false, abstract: false, final false
  inline bool IsValueType(int32_t index, ::UnityEngine::UIElements::StyleValueType type);

  /// @brief Method LoadProperties, addr 0x1f34fe8, size 0x434, virtual false, abstract: false, final false
  inline void LoadProperties();

  /// @brief Method MoveNextProperty, addr 0x1f3542c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAngle, addr 0x1f381c0, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Angle ReadAngle(::UnityEngine::UIElements::StyleSheets::StylePropertyValue value);

  /// @brief Method ReadAsString, addr 0x1f33d7c, size 0x60, virtual false, abstract: false, final false
  inline ::StringW ReadAsString(int32_t index);

  /// @brief Method ReadBackground, addr 0x1f36c40, size 0x270, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Background ReadBackground(int32_t index);

  /// @brief Method ReadColor, addr 0x1f334ac, size 0x104, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ReadColor(int32_t index);

  /// @brief Method ReadCursor, addr 0x1f37564, size 0x2ac, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Cursor ReadCursor(int32_t index);

  /// @brief Method ReadEnum, addr 0x1f362d8, size 0xfc, virtual false, abstract: false, final false
  inline int32_t ReadEnum(::UnityEngine::UIElements::StyleSheets::StyleEnumType enumType, int32_t index);

  /// @brief Method ReadEnum, addr 0x1f380f8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFloat, addr 0x1f32f80, size 0x68, virtual false, abstract: false, final false
  inline float_t ReadFloat(int32_t index);

  /// @brief Method ReadFont, addr 0x1f368fc, size 0x344, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> ReadFont(int32_t index);

  /// @brief Method ReadFontDefinition, addr 0x1f363d4, size 0x528, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::FontDefinition ReadFontDefinition(int32_t index);

  /// @brief Method ReadInt, addr 0x1f36160, size 0x84, virtual false, abstract: false, final false
  inline int32_t ReadInt(int32_t index);

  /// @brief Method ReadLength, addr 0x1f32e8c, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length ReadLength(int32_t index);

  /// @brief Method ReadListEasingFunction, addr 0x1f37a84, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadListStylePropertyName, addr 0x1f37e08, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadListTimeValue, addr 0x1f37c74, size 0x194, virtual false, abstract: false, final false
  inline void ReadListTimeValue(::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>* list, int32_t index);

  /// @brief Method ReadRotate, addr 0x1f35c74, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Rotate ReadRotate(int32_t index);

  /// @brief Method ReadRotate, addr 0x1f35d98, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadScale, addr 0x1f35e64, size 0x100, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Scale ReadScale(int32_t index);

  /// @brief Method ReadScale, addr 0x1f35f64, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTextShadow, addr 0x1f37810, size 0x274, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextShadow ReadTextShadow(int32_t index);

  /// @brief Method ReadTimeValue, addr 0x1f33ce4, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimeValue ReadTimeValue(int32_t index);

  /// @brief Method ReadTransformOrigin, addr 0x1f3597c, size 0x134, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TransformOrigin ReadTransformOrigin(int32_t index);

  /// @brief Method ReadTransformOrigin, addr 0x1f35ab0, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTransformOriginEnum, addr 0x1f37fa0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTranslate, addr 0x1f355c4, size 0x130, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Translate ReadTranslate(int32_t index);

  /// @brief Method ReadTranslate, addr 0x1f356f4, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method SetContext, addr 0x1f34d80, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentProperty, addr 0x1f35458, size 0xb0, virtual false, abstract: false, final false
  inline void SetCurrentProperty();

  /// @brief Method SetInlineContext, addr 0x1f3541c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetImageSourceFromValue, addr 0x1f36eb0, size 0x6b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1f382dc, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::StyleSheets::__StylePropertyReader__GetCursorIdFunction* getStaticF_getCursorIdFunc();

  /// @brief Method get_dpiScaling, addr 0x1f34d70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_dpiScaling();

  /// @brief Method get_property, addr 0x1f34d40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleProperty* get_property();

  /// @brief Method get_propertyId, addr 0x1f34d50, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId get_propertyId();

  /// @brief Method get_valueCount, addr 0x1f34d60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_dpiScaling, addr 0x1f34d78, size 0x8, virtual false, abstract: false, final false
  inline void set_dpiScaling(float_t value);

  /// @brief Method set_property, addr 0x1f34d48, size 0x8, virtual false, abstract: false, final false
  inline void set_property(::UnityEngine::UIElements::StyleProperty* value);

  /// @brief Method set_propertyId, addr 0x1f34d58, size 0x8, virtual false, abstract: false, final false
  inline void set_propertyId(::UnityEngine::UIElements::StyleSheets::StylePropertyId value);

  /// @brief Method set_valueCount, addr 0x1f34d68, size 0x8, virtual false, abstract: false, final false
