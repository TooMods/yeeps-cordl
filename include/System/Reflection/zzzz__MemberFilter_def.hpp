...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2610984, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2610854, size 0x130, virtual false, abstract: false, final false
