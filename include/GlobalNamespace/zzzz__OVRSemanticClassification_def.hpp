...
public:
  ...
  /// @brief Method Awake, addr 0x1496cb4, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Contains, addr 0x1496b54, size 0x160, virtual false, abstract: false, final false
  inline bool Contains(::StringW label);

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x1496d84, size 0x120, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  static inline ::GlobalNamespace::OVRSemanticClassification* New_ctor();

  /// @brief Method ValidateAndUpgradeLabels, addr 0x1496ea4, size 0x478, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x149731c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Labels, addr 0x1496b4c, size 0x8, virtual false, abstract: false, final false
