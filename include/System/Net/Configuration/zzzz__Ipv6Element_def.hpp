...
public:
  ...
  /// @brief Method .ctor, addr 0x18ce584, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Enabled, addr 0x18ce5bc, size 0x38, virtual false, abstract: false, final false
  inline bool get_Enabled();

  /// @brief Method get_Properties, addr 0x18ce62c, size 0x38, virtual true, abstract: false, final false
  inline ::System::Configuration::ConfigurationPropertyCollection* get_Properties();

  /// @brief Method set_Enabled, addr 0x18ce5f4, size 0x38, virtual false, abstract: false, final false
