...
public:
  ...
  /// @brief Method .ctor, addr 0x1e63590, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(uint64_t id, ::System::Nullable_1<uint64_t> pingTimeUsec);

  /// @brief Method get_ID, addr 0x1e635cc, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_ID();

  /// @brief Method get_IsTimeout, addr 0x1e63648, size 0x44, virtual false, abstract: false, final false
  inline bool get_IsTimeout();

  /// @brief Method get_PingTimeUsec, addr 0x1e635dc, size 0x6c, virtual false, abstract: false, final false
  inline uint64_t get_PingTimeUsec();

  /// @brief Method set_ID, addr 0x1e635d4, size 0x8, virtual false, abstract: false, final false
