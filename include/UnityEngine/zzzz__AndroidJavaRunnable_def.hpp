...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2f49d1c, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::AndroidJavaRunnable* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2f49c60, size 0xbc, virtual false, abstract: false, final false
