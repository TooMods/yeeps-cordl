...
public:
  ...
  /// @brief Method ApplyToObject, addr 0x226fb18, size 0x2e8, virtual false, abstract: false, final false
  inline void ApplyToObject(::System::Object* instance);

  /// @brief Method ConvertTo, addr 0x226eff0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::NamedValue ConvertTo(::System::TypeCode type);

  /// @brief Method Equals, addr 0x226f2ac, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x226f224, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x226f33c, size 0x5c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Parse, addr 0x226f7d8, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::NamedValue Parse(::StringW str);

  /// @brief Method ParseMultiple, addr 0x226ed20, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseParameter, addr 0x226f484, size 0x354, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::NamedValue ParseParameter(::StringW parameterString, ByRef<int32_t> index);

  /// @brief Method ToString, addr 0x226ef30, size 0x94, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_name, addr 0x226efc4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_type, addr 0x226efe8, size 0x8, virtual false, abstract: false, final false
  inline ::System::TypeCode get_type();

  /// @brief Method get_value, addr 0x226efd4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x226f420, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x226f450, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method set_name, addr 0x226efcc, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_value, addr 0x226efe0, size 0x8, virtual false, abstract: false, final false
