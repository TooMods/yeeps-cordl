...
public:
  ...
  __declspec(property(get = get_DefaultViewManager))::System::Data::DataViewManager* DefaultViewManager;
  ...
  /// @brief Field Initialized, offset 0xb0, size 0x8
  ...
  /// @brief Method BeginInit, addr 0x189bc8c, size 0xc, virtual true, abstract: false, final true
  inline void BeginInit();

  /// @brief Method Clear, addr 0x189bea8, size 0x208, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x189c0d8, size 0x1030, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* Clone();

  /// @brief Method DeserializeDataSet, addr 0x1895fc4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeDataSetData, addr 0x1897820, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeDataSetProperties, addr 0x18979f8, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeDataSetSchema, addr 0x1897334, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeRelations, addr 0x1897f60, size 0x870, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableConstraints, addr 0x1899c30, size 0x7b8, virtual false, abstract: false, final false
  inline void EnableConstraints();

  /// @brief Method EndInit, addr 0x189bc98, size 0x120, virtual true, abstract: false, final true
  inline void EndInit();

  /// @brief Method EstimatedXmlStringSize, addr 0x1896ff8, size 0x118, virtual false, abstract: false, final false
  inline int32_t EstimatedXmlStringSize();

  /// @brief Method FailedEnableConstraints, addr 0x1899210, size 0x30, virtual false, abstract: false, final false
  inline void FailedEnableConstraints();

  /// @brief Method FindTable, addr 0x18a21cc, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDataSetSchema, addr 0x18a25a0, size 0x258, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* GetDataSetSchema(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method GetObjectData, addr 0x189600c, size 0x8, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRemotingDiffGram, addr 0x189d10c, size 0x130, virtual false, abstract: false, final false
  inline ::StringW GetRemotingDiffGram(::System::Data::DataTable* table);

  /// @brief Method GetXmlSchemaForRemoting, addr 0x1896e60, size 0x198, virtual false, abstract: false, final false
  inline ::StringW GetXmlSchemaForRemoting(::System::Data::DataTable* table);

  /// @brief Method InferSchema, addr 0x189d788, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeDerivedDataSet, addr 0x1896634, size 0x4, virtual true, abstract: false, final false
  inline void InitializeDerivedDataSet();

  /// @brief Method IsEmpty, addr 0x18a02c0, size 0x300, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method Merge, addr 0x18a05c0, size 0x184, virtual false, abstract: false, final false
  inline void Merge(::System::Data::DataSet* dataSet);

  /// @brief Method Merge, addr 0x18a1580, size 0x268, virtual false, abstract: false, final false
  inline void Merge(::System::Data::DataSet* dataSet, bool preserveChanges, ::System::Data::MissingSchemaAction missingSchemaAction);

  /// @brief Method MoveToElement, addr 0x189d640, size 0xb4, virtual false, abstract: false, final false
  inline bool MoveToElement(::System::Xml::XmlReader* reader, int32_t depth);

  /// @brief Method MoveToElement, addr 0x189dae0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnClearFunctionCalled, addr 0x189c0b0, size 0x28, virtual false, abstract: false, final false
  inline void OnClearFunctionCalled(::System::Data::DataTable* table);

  /// @brief Method OnDataRowCreated, addr 0x18a1920, size 0x28, virtual false, abstract: false, final false
  inline void OnDataRowCreated(::System::Data::DataRow* row);

  /// @brief Method OnInitialized, addr 0x189be28, size 0x80, virtual false, abstract: false, final false
  inline void OnInitialized();

  /// @brief Method OnMergeFailed, addr 0x18a1810, size 0x60, virtual false, abstract: false, final false
  inline void OnMergeFailed(::System::Data::MergeFailedEventArgs* mfevent);

  /// @brief Method OnPropertyChanging, addr 0x18a17e8, size 0x28, virtual true, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method OnRemoveRelation, addr 0x18a1978, size 0x4, virtual true, abstract: false, final false
  inline void OnRemoveRelation(::System::Data::DataRelation* relation);

  /// @brief Method OnRemoveRelationHack, addr 0x1890154, size 0x10, virtual false, abstract: false, final false
  inline void OnRemoveRelationHack(::System::Data::DataRelation* relation);

  /// @brief Method OnRemoveTable, addr 0x18a1948, size 0x4, virtual true, abstract: false, final false
  inline void OnRemoveTable(::System::Data::DataTable* table);

  /// @brief Method OnRemovedTable, addr 0x18a194c, size 0x2c, virtual false, abstract: false, final false
  inline void OnRemovedTable(::System::Data::DataTable* table);

  /// @brief Method RaiseMergeFailed, addr 0x18a1870, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method RaisePropertyChanging, addr 0x189a3fc, size 0x80, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method ReadEndElement, addr 0x189d6f4, size 0x94, virtual false, abstract: false, final false
  inline void ReadEndElement(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXDRSchema, addr 0x189d244, size 0x158, virtual false, abstract: false, final false
  inline void ReadXDRSchema(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXSDSchema, addr 0x189d39c, size 0x2a4, virtual false, abstract: false, final false
  inline void ReadXSDSchema(::System::Xml::XmlReader* reader, bool denyResolving);

  /// @brief Method ReadXml, addr 0x189ddac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXml, addr 0x189ddb4, size 0x1140, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader, bool denyResolving);

  /// @brief Method ReadXml, addr 0x18990b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader, ::System::Data::XmlReadMode mode);

  /// @brief Method ReadXml, addr 0x18a0744, size 0xe3c, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader, ::System::Data::XmlReadMode mode, bool denyResolving);

  /// @brief Method ReadXmlDiffgram, addr 0x189ef5c, size 0x1364, virtual false, abstract: false, final false
  inline void ReadXmlDiffgram(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXmlSchema, addr 0x189d23c, size 0x8, virtual false, abstract: false, final false
  inline void ReadXmlSchema(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXmlSchema, addr 0x18987d0, size 0x8e8, virtual false, abstract: false, final false
  inline void ReadXmlSchema(::System::Xml::XmlReader* reader, bool denyResolving);

  /// @brief Method ReadXmlSerializable, addr 0x18a22c4, size 0x2dc, virtual true, abstract: false, final false
  inline void ReadXmlSerializable(::System::Xml::XmlReader* reader);

  /// @brief Method Reset, addr 0x18a1c54, size 0x2b8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RestoreEnforceConstraints, addr 0x189a3e8, size 0xc, virtual false, abstract: false, final false
  inline void RestoreEnforceConstraints(bool value);

  /// @brief Method SerializeDataSet, addr 0x1896014, size 0x620, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDataSetProperties, addr 0x1896638, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeRelations, addr 0x18967a8, size 0x6b8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLocaleValue, addr 0x189ad90, size 0x79c, virtual false, abstract: false, final false
  inline void SetLocaleValue(::System::Globalization::CultureInfo* value, bool userSet);

  /// @brief Method ShouldSerializeLocale, addr 0x189b980, size 0x8, virtual false, abstract: false, final false
  inline bool ShouldSerializeLocale();

  /// @brief Method System.ComponentModel.IListSource.GetList, addr 0x189d108, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IList* System_ComponentModel_IListSource_GetList();

  /// @brief Method System.ComponentModel.IListSource.get_ContainsListCollection, addr 0x1899af4, size 0x8, virtual true, abstract: false, final true
  inline bool System_ComponentModel_IListSource_get_ContainsListCollection();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x18a27f8, size 0x1d8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x18a29d0, size 0x250, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x18a2c20, size 0x34, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method TopLevelTables, addr 0x18a197c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*, ::Array<::System::Data::DataTable*>*> TopLevelTables();

  /// @brief Method TopLevelTables, addr 0x18a1984, size 0x2d0, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*, ::Array<::System::Data::DataTable*>*> TopLevelTables(bool forSchema);

  /// @brief Method ValidateCaseConstraint, addr 0x18996f8, size 0x3fc, virtual false, abstract: false, final false
  inline bool ValidateCaseConstraint();

  /// @brief Method ValidateLocaleConstraint, addr 0x189b52c, size 0x454, virtual false, abstract: false, final false
  inline bool ValidateLocaleConstraint();

  /// @brief Method WriteXml, addr 0x1897110, size 0x224, virtual false, abstract: false, final false
  inline void WriteXml(::System::Xml::XmlWriter* writer, ::System::Data::XmlWriteMode mode);

  /// @brief Method WriteXmlSchema, addr 0x189db58, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18956e8, size 0x23c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1895a78, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dataSetName);

  /// @brief Method .ctor, addr 0x1895dc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x1895dcc, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method add_Initialized, addr 0x189bb54, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method get_CaseSensitive, addr 0x18993cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_CaseSensitive();

  /// @brief Method get_DataSetName, addr 0x189a3f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DataSetName();

  /// @brief Method get_DefaultViewManager, addr 0x1899afc, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Data::DataViewManager* get_DefaultViewManager();

  /// @brief Method get_EnforceConstraints, addr 0x1899c28, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnforceConstraints();

  /// @brief Method get_ExtendedProperties, addr 0x18990c0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_IsInitialized, addr 0x189abd8, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsInitialized();

  /// @brief Method get_Locale, addr 0x189abe8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Locale();

  /// @brief Method get_MainTableName, addr 0x18a2c54, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MainTableName();

  /// @brief Method get_Namespace, addr 0x189a47c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ObjectID, addr 0x18a2c64, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_Prefix, addr 0x189aab0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Relations, addr 0x189bb44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataRelationCollection* get_Relations();

  /// @brief Method get_RemotingFormat, addr 0x1895be4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::SerializationFormat get_RemotingFormat();

  /// @brief Method get_SchemaSerializationMode, addr 0x1895dbc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Data::SchemaSerializationMode get_SchemaSerializationMode();

  /// @brief Method get_Site, addr 0x189b988, size 0x8, virtual true, abstract: false, final false
  inline ::System::ComponentModel::ISite* get_Site();

  /// @brief Method get_Tables, addr 0x189bb4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_Initialized, addr 0x189bbf0, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method set_CaseSensitive, addr 0x18993d4, size 0x324, virtual false, abstract: false, final false
  inline void set_CaseSensitive(bool value);

  /// @brief Method set_DataSetName, addr 0x1895aa0, size 0x144, virtual false, abstract: false, final false
  inline void set_DataSetName(::StringW value);

  /// @brief Method set_EnforceConstraints, addr 0x1899240, size 0x18c, virtual false, abstract: false, final false
  inline void set_EnforceConstraints(bool value);

  /// @brief Method set_Locale, addr 0x189abf0, size 0x1a0, virtual false, abstract: false, final false
  inline void set_Locale(::System::Globalization::CultureInfo* value);

  /// @brief Method set_MainTableName, addr 0x18a2c5c, size 0x8, virtual false, abstract: false, final false
  inline void set_MainTableName(::StringW value);

  /// @brief Method set_Namespace, addr 0x189a484, size 0x4b0, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_Prefix, addr 0x189aab8, size 0x120, virtual false, abstract: false, final false
  inline void set_Prefix(::StringW value);

  /// @brief Method set_RemotingFormat, addr 0x1895bec, size 0xa0, virtual false, abstract: false, final false
  inline void set_RemotingFormat(::System::Data::SerializationFormat value);

  /// @brief Method set_Site, addr 0x189b990, size 0x1b4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Field Initialized, offset: 0xb0, size: 0x8, def value: None
  ::System::EventHandler* ___Initialized;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::System::Data::DataSet, 0xb8>, "Size mismatch!");
...
static_assert(offsetof(::System::Data::DataSet, ___Initialized) == 0xb0, "Offset mismatch!");
