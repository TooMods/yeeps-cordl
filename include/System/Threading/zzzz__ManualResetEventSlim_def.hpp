...
public:
  ...
  /// @brief Method CancellationTokenCallback, addr 0x10e6c80, size 0x120, virtual false, abstract: false, final false
  static inline void CancellationTokenCallback(::System::Object* obj);

  /// @brief Method Dispose, addr 0x10e6b20, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x10e6b8c, size 0xf4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureLockObjectCreated, addr 0x10e62c0, size 0x88, virtual false, abstract: false, final false
  inline void EnsureLockObjectCreated();

  /// @brief Method ExtractStatePortion, addr 0x10e5e1c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ExtractStatePortion(int32_t state, int32_t mask);

  /// @brief Method ExtractStatePortionAndShiftRight, addr 0x10e5f44, size 0xc, virtual false, abstract: false, final false
  static inline int32_t ExtractStatePortionAndShiftRight(int32_t state, int32_t mask, int32_t rightBitShiftCount);

  /// @brief Method Initialize, addr 0x10e60f0, size 0xb0, virtual false, abstract: false, final false
  inline void Initialize(bool initialState, int32_t spinCount);

  /// @brief Method LazyInitializeEvent, addr 0x10e5c58, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x10e63cc, size 0x8, virtual false, abstract: false, final false
  inline void Set();

  /// @brief Method Set, addr 0x10e63d4, size 0x1ac, virtual false, abstract: false, final false
  inline void Set(bool duringCancellation);

  /// @brief Method ThrowIfDisposed, addr 0x10e5bf4, size 0x64, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method UpdateStateAtomically, addr 0x10e5e44, size 0xa4, virtual false, abstract: false, final false
  inline void UpdateStateAtomically(int32_t newBits, int32_t updateBitsMask);

  /// @brief Method Wait, addr 0x10e65d8, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e6074, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(bool initialState);

  /// @brief Method .ctor, addr 0x10e61a0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsSet, addr 0x10e5dc0, size 0x5c, virtual false, abstract: false, final false
  inline bool get_IsSet();

  /// @brief Method get_SpinCount, addr 0x10e5ee8, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_SpinCount();

  /// @brief Method get_WaitHandle, addr 0x10e5bb8, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Threading::WaitHandle* get_WaitHandle();

  /// @brief Method get_Waiters, addr 0x10e5f84, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsSet, addr 0x10e5e24, size 0x20, virtual false, abstract: false, final false
  inline void set_IsSet(bool value);

  /// @brief Method set_SpinCount, addr 0x10e5f50, size 0x34, virtual false, abstract: false, final false
  inline void set_SpinCount(int32_t value);

  /// @brief Method set_Waiters, addr 0x10e5fe0, size 0x94, virtual false, abstract: false, final false
