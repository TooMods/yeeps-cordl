...
public:
  ...
  /// @brief Method Create, addr 0x1b45ec0, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder Create();

  /// @brief Method SetException, addr 0x1b45fe4, size 0x58, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SetResult, addr 0x1b45f6c, size 0x78, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetStateMachine, addr 0x1b45ecc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Task, addr 0x1b45f24, size 0x48, virtual false, abstract: false, final false
