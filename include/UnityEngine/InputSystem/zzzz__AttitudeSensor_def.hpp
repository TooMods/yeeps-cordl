...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c72128, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c72050, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::AttitudeSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c720a4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c721a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::AttitudeSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_attitude, addr 0x1c71fac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_attitude();

  /// @brief Method get_current, addr 0x1c71fbc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_attitude, addr 0x1c71fb4, size 0x8, virtual false, abstract: false, final false
  inline void set_attitude(::UnityEngine::InputSystem::Controls::QuaternionControl* value);

  /// @brief Method set_current, addr 0x1c72004, size 0x4c, virtual false, abstract: false, final false
