...
public:
  ...
  /// @brief Method CanDispatchEvent, addr 0x2cd1aa8, size 0x54, virtual true, abstract: false, final true
  inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method DispatchEvent, addr 0x2cd1afc, size 0x108, virtual true, abstract: false, final true
  inline void DispatchEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::IPanel* iPanel);

  /// @brief Method IsDone, addr 0x2cd1ef0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method SendEventToIMGUIContainer, addr 0x2cd1d18, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method SendEventToRegularTarget, addr 0x2cd1ce0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method SendEventToTarget, addr 0x2cd1ca4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBestTargetForEvent, addr 0x2cd1c04, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateElementUnderMouse, addr 0x2cd1f38, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd2234, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
