...
public:
  ...
  /// @brief Method GetNamespacesInScope, addr 0x1255a64, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method IsText, addr 0x1255d64, size 0x10, virtual false, abstract: false, final false
  static inline bool IsText(::System::Xml::XPath::XPathNodeType type);

  /// @brief Method LookupNamespace, addr 0x12556d0, size 0x1a4, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x1255874, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method MoveToNamespace, addr 0x1255c7c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x12556c0, size 0x10, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x1253f64, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValueAs, addr 0x12553d4, size 0x2ec, virtual true, abstract: false, final false
  inline ::System::Object* ValueAs(::System::Type* returnType, ::System::Xml::IXmlNamespaceResolver* nsResolver);

  /// @brief Method .ctor, addr 0x1255d74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_SchemaInfo, addr 0x1255d1c, size 0x48, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_TypedValue, addr 0x12540f8, size 0x2dc, virtual true, abstract: false, final false
  inline ::System::Object* get_TypedValue();

  /// @brief Method get_UnderlyingObject, addr 0x1255c74, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_UnderlyingObject();

  /// @brief Method get_ValueAsBoolean, addr 0x12545e0, size 0x2c4, virtual true, abstract: false, final false
  inline bool get_ValueAsBoolean();

  /// @brief Method get_ValueAsDateTime, addr 0x12548a4, size 0x2cc, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValueAsDateTime();

  /// @brief Method get_ValueAsDouble, addr 0x1254b70, size 0x2cc, virtual true, abstract: false, final false
  inline double_t get_ValueAsDouble();

  /// @brief Method get_ValueAsInt, addr 0x1254e3c, size 0x2cc, virtual true, abstract: false, final false
  inline int32_t get_ValueAsInt();

  /// @brief Method get_ValueAsLong, addr 0x1255108, size 0x2cc, virtual true, abstract: false, final false
  inline int64_t get_ValueAsLong();

  /// @brief Method get_ValueType, addr 0x12543d4, size 0x20c, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlType, addr 0x1253f70, size 0x188, virtual true, abstract: false, final false
