...
public:
  ...
  /// @brief Method Dump, addr 0x1ab3b88, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::MemberReference* New_ctor();

  /// @brief Method Read, addr 0x1ab3b60, size 0x28, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x1ab3b04, size 0x8, virtual false, abstract: false, final false
  inline void Set(int32_t idRef);

  /// @brief Method Write, addr 0x1ab3b0c, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab3afc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
