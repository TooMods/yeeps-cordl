...
public:
  ...
  /// @brief Method IsInteropXmlElement, addr 0x185b3cc, size 0x8, virtual false, abstract: false, final false
  inline bool IsInteropXmlElement();

  static inline ::System::Runtime::Remoting::Metadata::SoapFieldAttribute* New_ctor();

  /// @brief Method SetReflectionObject, addr 0x185b3d4, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x185b3bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XmlElementName, addr 0x185b3c4, size 0x8, virtual false, abstract: false, final false
