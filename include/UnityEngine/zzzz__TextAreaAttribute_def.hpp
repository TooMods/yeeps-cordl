...
public:
  ...
  /// @brief Method .ctor, addr 0x2800968, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2800988, size 0x2c, virtual false, abstract: false, final false
