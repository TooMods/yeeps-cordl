...
public:
  ...
  /// @brief Method Clone, addr 0x18b42b8, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18b4230, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Content, addr 0x18b42a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleTypeContent* get_Content();

  /// @brief Method set_Content, addr 0x18b42b0, size 0x8, virtual false, abstract: false, final false
