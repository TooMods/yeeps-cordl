...
public:
  ...
  /// @brief Method .ctor, addr 0x2911d24, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x2911300, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material* baseMat, int32_t stencilID);

  /// @brief Method Add, addr 0x2911308, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x2911394, size 0x918, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material* baseMat, int32_t stencilID, ::UnityEngine::Rendering::StencilOp operation,
  ...
  /// @brief Method ClearAll, addr 0x2911ef4, size 0x11c, virtual false, abstract: false, final false
  static inline void ClearAll();

  /// @brief Method LogWarningWhenNotInBatchmode, addr 0x2911cac, size 0x78, virtual false, abstract: false, final false
  static inline void LogWarningWhenNotInBatchmode(::StringW warning, ::UnityEngine::Object* context);

  /// @brief Method Remove, addr 0x2911d34, size 0x1c0, virtual false, abstract: false, final false
