...
public:
  ...
  /// @brief Method AddChild, addr 0x167b67c, size 0x114, virtual false, abstract: false, final false
  inline void AddChild(::System::Text::RegularExpressions::RegexNode* newChild);

  /// @brief Method Child, addr 0x16773e8, size 0x58, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* Child(int32_t i);

  /// @brief Method ChildCount, addr 0x167739c, size 0x4c, virtual false, abstract: false, final false
  inline int32_t ChildCount();

  /// @brief Method MakeQuantifier, addr 0x167b560, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* MakeQuantifier(bool lazy, int32_t min, int32_t max);

  /// @brief Method MakeRep, addr 0x167aa30, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x167aa48, size 0x68, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* Reduce();

  /// @brief Method ReduceAlternation, addr 0x167aab0, size 0x3b8, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* ReduceAlternation();

  /// @brief Method ReduceConcatenation, addr 0x167ae68, size 0x368, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* ReduceConcatenation();

  /// @brief Method ReduceGroup, addr 0x167b35c, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* ReduceGroup();

  /// @brief Method ReduceRep, addr 0x167b1d0, size 0x18c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* ReduceRep();

  /// @brief Method ReduceSet, addr 0x167b388, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* ReduceSet();

  /// @brief Method ReverseLeft, addr 0x167a9b4, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* ReverseLeft();

  /// @brief Method StripEnation, addr 0x167b4a4, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexNode* StripEnation(int32_t emptyType);

  /// @brief Method Type, addr 0x167b790, size 0x8, virtual false, abstract: false, final false
  inline int32_t Type();

  /// @brief Method UseOptionR, addr 0x167a9a8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x167a874, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::System::Text::RegularExpressions::RegexOptions options);

  /// @brief Method .ctor, addr 0x167a8a4, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::System::Text::RegularExpressions::RegexOptions options, char16_t ch);

  /// @brief Method .ctor, addr 0x167a924, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::System::Text::RegularExpressions::RegexOptions options, int32_t m);

  /// @brief Method .ctor, addr 0x167a964, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::System::Text::RegularExpressions::RegexOptions options, int32_t m, int32_t n);

  /// @brief Method .ctor, addr 0x167a8e4, size 0x40, virtual false, abstract: false, final false
