...
public:
  ...
  /// @brief Method Build, addr 0x2ccc0e4, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x2ccc004, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x2ccc3dc, size 0x110, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x2ccbf38, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
