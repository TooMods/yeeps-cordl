...
public:
  ...
  /// @brief Method Equals, addr 0x20c2a6c, size 0x170, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x20c2960, size 0x10c, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Mathematics::bool4x4 rhs);

  /// @brief Method GetHashCode, addr 0x20c2bdc, size 0x1fc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x20c2dd8, size 0x4ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x20c2238, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20c2244, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20c22e4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool v);

  /// @brief Method get_Item, addr 0x20c2958, size 0x8, virtual false, abstract: false, final false
