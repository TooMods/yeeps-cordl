...
public:
  ...
  /// @brief Method FinishSetup, addr 0x18f9b98, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18f9cc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_airTap, addr 0x18f9b68, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_airTap();

  /// @brief Method get_deviceVelocity, addr 0x18f9b58, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_deviceVelocity();

  /// @brief Method get_sourceLossMitigationDirection, addr 0x18f9b88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_sourceLossMitigationDirection();

  /// @brief Method get_sourceLossRisk, addr 0x18f9b78, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_sourceLossRisk();

  /// @brief Method set_airTap, addr 0x18f9b70, size 0x8, virtual false, abstract: false, final false
  inline void set_airTap(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_deviceVelocity, addr 0x18f9b60, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceVelocity(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_sourceLossMitigationDirection, addr 0x18f9b90, size 0x8, virtual false, abstract: false, final false
  inline void set_sourceLossMitigationDirection(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_sourceLossRisk, addr 0x18f9b80, size 0x8, virtual false, abstract: false, final false
