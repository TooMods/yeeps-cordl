...
public:
  // Declarations
  /// @brief Method Assume, addr 0x198b84c, size 0x4, virtual false, abstract: false, final false
  static inline void Assume(bool condition);

  /// @brief Method Likely, addr 0x198b83c, size 0x8, virtual false, abstract: false, final false
  static inline bool Likely(bool condition);

  /// @brief Method Unlikely, addr 0x198b844, size 0x8, virtual false, abstract: false, final false
