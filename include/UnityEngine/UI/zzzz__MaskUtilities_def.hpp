...
public:
  // Declarations
  /// @brief Method FindRootSortOverrideCanvas, addr 0x26f3f1c, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetRectMaskForClippable, addr 0x26f4b40, size 0x41c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::UI::RectMask2D> GetRectMaskForClippable(::UnityEngine::UI::IClippable* clippable);

  /// @brief Method GetRectMasksForClip, addr 0x26f549c, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilDepth, addr 0x26f40bc, size 0x288, virtual false, abstract: false, final false
  static inline int32_t GetStencilDepth(::UnityEngine::Transform* transform, ::UnityEngine::Transform* stopAfter);

  /// @brief Method IsDescendantOrSelf, addr 0x26f534c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method Notify2DMaskStateChanged, addr 0x26f50f0, size 0x25c, virtual false, abstract: false, final false
  static inline void Notify2DMaskStateChanged(::UnityEngine::Component* mask);

  /// @brief Method NotifyStencilStateChanged, addr 0x26f37c0, size 0x258, virtual false, abstract: false, final false
  static inline void NotifyStencilStateChanged(::UnityEngine::Component* mask);

  /// @brief Method .ctor, addr 0x26f5800, size 0x15888, virtual false, abstract: false, final false
  inline void _ctor();
