...
public:
  ...
  /// @brief Method get_BindingType, addr 0x1839d84, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::MemberBindingType get_BindingType();

  /// @brief Method get_Member, addr 0x1839d8c, size 0x8, virtual false, abstract: false, final false
