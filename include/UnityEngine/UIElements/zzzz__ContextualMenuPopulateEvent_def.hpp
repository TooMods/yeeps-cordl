...
public:
  ...
  /// @brief Method Init, addr 0x2cd1558, size 0x70, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd15c8, size 0x34, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x2cd166c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd15fc, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menu, addr 0x2cd1538, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DropdownMenu* get_menu();

  /// @brief Method get_triggerEvent, addr 0x2cd1548, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* get_triggerEvent();

  /// @brief Method set_menu, addr 0x2cd1540, size 0x8, virtual false, abstract: false, final false
  inline void set_menu(::UnityEngine::UIElements::DropdownMenu* value);

  /// @brief Method set_triggerEvent, addr 0x2cd1550, size 0x8, virtual false, abstract: false, final false
