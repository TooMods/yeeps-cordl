...
public:
  ...
  /// @brief Method Close, addr 0x122fad8, size 0x1c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x122faf4, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method Open, addr 0x122fb10, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122f8f4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificates, addr 0x122fa2c, size 0x88, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_Certificates();

  /// @brief Method get_Factory, addr 0x122fab4, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Stores* get_Factory();

  /// @brief Method get_Store, addr 0x122fad0, size 0x8, virtual false, abstract: false, final false
