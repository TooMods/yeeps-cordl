...
public:
  // Declarations
  /// @brief Method RestoreTo, addr 0x14e76e8, size 0xc8, virtual false, abstract: false, final false
  inline void RestoreTo(::GlobalNamespace::OVRVirtualKeyboard* keyboard);

  /// @brief Method .ctor, addr 0x14e7c08, size 0xdc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DestroyKeyboard, addr 0x14e7b24, size 0xe4, virtual false, abstract: false, final false
  inline void DestroyKeyboard();

  /// @brief Method HideKeyboard, addr 0x14e7ae8, size 0x3c, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method MoveKeyboard, addr 0x14e7908, size 0x12c, virtual false, abstract: false, final false
  inline void MoveKeyboard();

  /// @brief Method MoveKeyboardFar, addr 0x14e7aa0, size 0x48, virtual false, abstract: false, final false
  inline void MoveKeyboardFar();

  /// @brief Method MoveKeyboardNear, addr 0x14e7a58, size 0x48, virtual false, abstract: false, final false
  inline void MoveKeyboardNear();

  static inline ::GlobalNamespace::OVRVirtualKeyboardSampleControls* New_ctor();

  /// @brief Method OnDestroy, addr 0x14e74fc, size 0x1ec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnHideKeyboard, addr 0x14e7ce4, size 0x4, virtual false, abstract: false, final false
  inline void OnHideKeyboard();

  /// @brief Method ShowKeyboard, addr 0x14e73f8, size 0x104, virtual false, abstract: false, final false
  inline void ShowKeyboard();

  /// @brief Method Start, addr 0x14e722c, size 0x1cc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x14e7ce8, size 0x274, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateButtonInteractable, addr 0x14e77b0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14e827c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
