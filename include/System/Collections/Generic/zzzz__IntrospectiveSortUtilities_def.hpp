...
public:
  // Declarations
  /// @brief Method FloorLog2PlusOne, addr 0x21d7aac, size 0x34, virtual false, abstract: false, final false
  static inline int32_t FloorLog2PlusOne(int32_t n);

  /// @brief Method ThrowOrIgnoreBadComparer, addr 0x21d7ae0, size 0x68, virtual false, abstract: false, final false
