...
public:
  ...
  /// @brief Method Clone, addr 0x2bf33a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x2bf3374, size 0x28, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::__Array__ArrayEnumerator* New_ctor(::System::Array* array);

  /// @brief Method Reset, addr 0x2bf339c, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2bf332c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* array);

  /// @brief Method get_Current, addr 0x2bf33b0, size 0x118, virtual true, abstract: false, final true
...
public:
  // Declarations
  /// @brief Method DownHeap, addr 0x2bf40a8, size 0x35c, virtual false, abstract: false, final false
  inline void DownHeap(int32_t i, int32_t n, int32_t lo);

  /// @brief Method Heapsort, addr 0x2bf3ddc, size 0xa0, virtual false, abstract: false, final false
  inline void Heapsort(int32_t lo, int32_t hi);

  /// @brief Method InsertionSort, addr 0x2bf3b40, size 0x29c, virtual false, abstract: false, final false
  inline void InsertionSort(int32_t lo, int32_t hi);

  /// @brief Method IntroSort, addr 0x2bf3a2c, size 0x114, virtual false, abstract: false, final false
  inline void IntroSort(int32_t lo, int32_t hi, int32_t depthLimit);

  /// @brief Method IntrospectiveSort, addr 0x2bf38dc, size 0x150, virtual false, abstract: false, final false
  inline void IntrospectiveSort(int32_t left, int32_t length);

  /// @brief Method PickPivotAndPartition, addr 0x2bf3e7c, size 0x22c, virtual false, abstract: false, final false
  inline int32_t PickPivotAndPartition(int32_t lo, int32_t hi);

  /// @brief Method Sort, addr 0x2bf38d8, size 0x4, virtual false, abstract: false, final false
  inline void Sort(int32_t left, int32_t length);

  /// @brief Method Swap, addr 0x2bf3774, size 0x164, virtual false, abstract: false, final false
  inline void Swap(int32_t i, int32_t j);

  /// @brief Method SwapIfGreaterWithItems, addr 0x2bf3544, size 0x230, virtual false, abstract: false, final false
  inline void SwapIfGreaterWithItems(int32_t a, int32_t b);

  /// @brief Method .ctor, addr 0x2bf34c8, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method DownHeap, addr 0x2bf4e50, size 0x2d0, virtual false, abstract: false, final false
  inline void DownHeap(int32_t i, int32_t n, int32_t lo);

  /// @brief Method Heapsort, addr 0x2bf4b94, size 0xa0, virtual false, abstract: false, final false
  inline void Heapsort(int32_t lo, int32_t hi);

  /// @brief Method InsertionSort, addr 0x2bf49ac, size 0x1e8, virtual false, abstract: false, final false
  inline void InsertionSort(int32_t lo, int32_t hi);

  /// @brief Method IntroSort, addr 0x2bf4898, size 0x114, virtual false, abstract: false, final false
  inline void IntroSort(int32_t lo, int32_t hi, int32_t depthLimit);

  /// @brief Method IntrospectiveSort, addr 0x2bf4740, size 0x158, virtual false, abstract: false, final false
  inline void IntrospectiveSort(int32_t left, int32_t length);

  /// @brief Method PickPivotAndPartition, addr 0x2bf4c34, size 0x21c, virtual false, abstract: false, final false
  inline int32_t PickPivotAndPartition(int32_t lo, int32_t hi);

  /// @brief Method Sort, addr 0x2bf473c, size 0x4, virtual false, abstract: false, final false
  inline void Sort(int32_t left, int32_t length);

  /// @brief Method Swap, addr 0x2bf4650, size 0xec, virtual false, abstract: false, final false
  inline void Swap(int32_t i, int32_t j);

  /// @brief Method SwapIfGreaterWithItems, addr 0x2bf4480, size 0x1d0, virtual false, abstract: false, final false
  inline void SwapIfGreaterWithItems(int32_t a, int32_t b);

  /// @brief Method .ctor, addr 0x2bf4404, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BinarySearch, addr 0x2f130d0, size 0x8, virtual false, abstract: false, final false
  static inline int32_t BinarySearch(::System::Array* array, int32_t index, int32_t length, ::System::Object* value);

  /// @brief Method BinarySearch, addr 0x2f12458, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method BinarySearch, addr 0x2f123c4, size 0x94, virtual false, abstract: false, final false
  static inline int32_t BinarySearch(::System::Array* array, ::System::Object* value);

  /// @brief Method BinarySearch, addr 0x2f130d8, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t BinarySearch(::System::Array* array, ::System::Object* value, ::System::Collections::IComparer* comparer);

  /// @brief Method CanAssignArrayElement, addr 0x2f14d68, size 0xd4, virtual false, abstract: false, final false
  static inline bool CanAssignArrayElement(::System::Type* source, ::System::Type* target);

  /// @brief Method Clear, addr 0x2f116c0, size 0x128, virtual false, abstract: false, final false
  static inline void Clear(::System::Array* array, int32_t index, int32_t length);

  /// @brief Method ClearInternal, addr 0x2f14d08, size 0x4, virtual false, abstract: false, final false
  static inline void ClearInternal(::System::Array* a, int32_t index, int32_t count);

  /// @brief Method Clone, addr 0x2f11ec8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method CombineHashCodes, addr 0x2f12244, size 0xc, virtual false, abstract: false, final false
  static inline int32_t CombineHashCodes(int32_t h1, int32_t h2);

  /// @brief Method ConstrainedCopy, addr 0x2f14e3c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x2f12974, size 0xcc, virtual false, abstract: false, final false
  static inline void Copy(::System::Array* sourceArray, ::System::Array* destinationArray, int32_t length);

  /// @brief Method Copy, addr 0x2f12900, size 0x74, virtual false, abstract: false, final false
  static inline void Copy(::System::Array* sourceArray, ::System::Array* destinationArray, int64_t length);

  /// @brief Method Copy, addr 0x2f11994, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x2f12a40, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTo, addr 0x2f118dc, size 0xb4, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method CopyTo, addr 0x2f12b14, size 0x74, virtual false, abstract: false, final false
  inline void CopyTo(::System::Array* array, int64_t index);

  /// @brief Method CreateArrayTypeMismatchException, addr 0x2f14d0c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::ArrayTypeMismatchException* CreateArrayTypeMismatchException();

  /// @brief Method CreateInstance, addr 0x2f14bf0, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Array* CreateInstance(::System::Type* elementType, int32_t length);

  /// @brief Method CreateInstance, addr 0x2f14b64, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Array* CreateInstance(::System::Type* elementType, int32_t length1, int32_t length2);

  /// @brief Method CreateInstance, addr 0x2f14c68, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Array* CreateInstance(::System::Type* elementType, int32_t length1, int32_t length2, int32_t length3);

  /// @brief Method CreateInstance, addr 0x2f1115c, size 0x294, virtual false, abstract: false, final false
  static inline ::System::Array* CreateInstance(::System::Type* elementType, ::ArrayW<int32_t, ::Array<int32_t>*> lengths);

  /// @brief Method CreateInstance, addr 0x2f1476c, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInstance, addr 0x2f10fd8, size 0x184, virtual false, abstract: false, final false
  static inline ::System::Array* CreateInstance(::System::Type* elementType, ::ArrayW<int64_t, ::Array<int64_t>*> lengths);

  /// @brief Method CreateInstanceImpl, addr 0x2f1472c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method FastCopy, addr 0x2f14728, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x2f145ec, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLength, addr 0x2f12bec, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetLength(int32_t dimension);

  /// @brief Method GetLongLength, addr 0x2f12bf0, size 0x14, virtual false, abstract: false, final false
  inline int64_t GetLongLength(int32_t dimension);

  /// @brief Method GetLowerBound, addr 0x2f116bc, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetLowerBound(int32_t dimension);

  /// @brief Method GetMedian, addr 0x2f13178, size 0xc, virtual false, abstract: false, final false
  static inline int32_t GetMedian(int32_t low, int32_t hi);

  /// @brief Method GetRank, addr 0x2f1471c, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetRank();

  /// @brief Method GetRawSzArrayData, addr 0x2f14664, size 0x14, virtual false, abstract: false, final false
  inline ByRef<uint8_t> GetRawSzArrayData();

  /// @brief Method GetUpperBound, addr 0x2f14730, size 0x38, virtual false, abstract: false, final false
  inline int32_t GetUpperBound(int32_t dimension);

  /// @brief Method GetValue, addr 0x2f07220, size 0x174, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(int32_t index);

  /// @brief Method GetValue, addr 0x2f12c04, size 0x74, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(int64_t index);

  /// @brief Method GetValue, addr 0x2f12d20, size 0x88, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(int32_t index1, int32_t index2);

  /// @brief Method GetValue, addr 0x2f12e7c, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(int32_t index1, int32_t index2, int32_t index3);

  /// @brief Method GetValue, addr 0x2f12c78, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(int64_t index1, int64_t index2);

  /// @brief Method GetValue, addr 0x2f12da8, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(int64_t index1, int64_t index2, int64_t index3);

  /// @brief Method GetValue, addr 0x2f130b0, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method GetValue, addr 0x2f12f1c, size 0x194, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(::ArrayW<int64_t, ::Array<int64_t>*> indices);

  /// @brief Method GetValueImpl, addr 0x2f14720, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x2f115f4, size 0x90, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::System::Array* array, ::System::Object* value);

  /// @brief Method IndexOf, addr 0x2f13424, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::System::Array* array, ::System::Object* value, int32_t startIndex);

  /// @brief Method IndexOf, addr 0x2f13184, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x2f14e40, size 0x1a120, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalArray__ICollection_Clear, addr 0x2f14678, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalArray__ICollection_get_Count, addr 0x2f14658, size 0x4, virtual false, abstract: false, final false
  inline int32_t InternalArray__ICollection_get_Count();

  /// @brief Method InternalArray__ICollection_get_IsReadOnly, addr 0x2f1465c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalArray__IReadOnlyCollection_get_Count, addr 0x2f146c8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalArray__RemoveAt, addr 0x2f146cc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x2f134c4, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(::System::Array* array, ::System::Object* value);

  /// @brief Method LastIndexOf, addr 0x2f1380c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(::System::Array* array, ::System::Object* value, int32_t startIndex);

  /// @brief Method LastIndexOf, addr 0x2f13550, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method Reverse, addr 0x2f13868, size 0x88, virtual false, abstract: false, final false
  static inline void Reverse(::System::Array* array);

  /// @brief Method Reverse, addr 0x2f138f0, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x2f11410, size 0x17c, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, int32_t index);

  /// @brief Method SetValue, addr 0x2f13b44, size 0x74, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, int64_t index);

  /// @brief Method SetValue, addr 0x2f13c60, size 0x98, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, int32_t index1, int32_t index2);

  /// @brief Method SetValue, addr 0x2f13dcc, size 0xa8, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, int32_t index1, int32_t index2, int32_t index3);

  /// @brief Method SetValue, addr 0x2f13bb8, size 0xa8, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, int64_t index1, int64_t index2);

  /// @brief Method SetValue, addr 0x2f13cf8, size 0xd4, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, int64_t index1, int64_t index2, int64_t index3);

  /// @brief Method SetValue, addr 0x2f14018, size 0x4, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method SetValue, addr 0x2f13e74, size 0x1a4, virtual false, abstract: false, final false
  inline void SetValue(::System::Object* value, ::ArrayW<int64_t, ::Array<int64_t>*> indices);

  /// @brief Method SetValueImpl, addr 0x2f14724, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Sort, addr 0x2f1401c, size 0x90, virtual false, abstract: false, final false
  static inline void Sort(::System::Array* array);

  /// @brief Method Sort, addr 0x2f14310, size 0x94, virtual false, abstract: false, final false
  static inline void Sort(::System::Array* array, ::System::Collections::IComparer* comparer);

  /// @brief Method Sort, addr 0x2f142fc, size 0x14, virtual false, abstract: false, final false
  static inline void Sort(::System::Array* array, int32_t index, int32_t length);

  /// @brief Method Sort, addr 0x2f143a4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Sort, addr 0x2f143b8, size 0x94, virtual false, abstract: false, final false
  static inline void Sort(::System::Array* keys, ::System::Array* items);

  /// @brief Method Sort, addr 0x2f1444c, size 0xa0, virtual false, abstract: false, final false
  static inline void Sort(::System::Array* keys, ::System::Array* items, ::System::Collections::IComparer* comparer);

  /// @brief Method Sort, addr 0x2f144ec, size 0x8, virtual false, abstract: false, final false
  static inline void Sort(::System::Array* keys, ::System::Array* items, int32_t index, int32_t length);

  /// @brief Method Sort, addr 0x2f140ac, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method SortImpl, addr 0x2f144f4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.get_Count, addr 0x2f113f0, size 0x4, virtual true, abstract: false, final true
  inline int32_t System_Collections_ICollection_get_Count();

  /// @brief Method System.Collections.IList.Add, addr 0x2f1158c, size 0x50, virtual true, abstract: false, final true
  inline int32_t System_Collections_IList_Add(::System::Object* value);

  /// @brief Method System.Collections.IList.Clear, addr 0x2f11684, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IList_Clear();

  /// @brief Method System.Collections.IList.Contains, addr 0x2f115dc, size 0x18, virtual true, abstract: false, final true
  inline bool System_Collections_IList_Contains(::System::Object* value);

  /// @brief Method System.Collections.IList.IndexOf, addr 0x2f117e8, size 0x4, virtual true, abstract: false, final true
  inline int32_t System_Collections_IList_IndexOf(::System::Object* value);

  /// @brief Method System.Collections.IList.Insert, addr 0x2f117ec, size 0x50, virtual true, abstract: false, final true
  inline void System_Collections_IList_Insert(int32_t index, ::System::Object* value);

  /// @brief Method System.Collections.IList.Remove, addr 0x2f1183c, size 0x50, virtual true, abstract: false, final true
  inline void System_Collections_IList_Remove(::System::Object* value);

  /// @brief Method System.Collections.IList.RemoveAt, addr 0x2f1188c, size 0x50, virtual true, abstract: false, final true
  inline void System_Collections_IList_RemoveAt(int32_t index);

  /// @brief Method System.Collections.IList.get_IsReadOnly, addr 0x2f113f4, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_IList_get_IsReadOnly();

  /// @brief Method System.Collections.IList.get_Item, addr 0x2f113fc, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IList_get_Item(int32_t index);

  /// @brief Method System.Collections.IList.set_Item, addr 0x2f11400, size 0x10, virtual true, abstract: false, final true
  inline void System_Collections_IList_set_Item(int32_t index, ::System::Object* value);

  /// @brief Method System.Collections.IStructuralComparable.CompareTo, addr 0x2f11ed0, size 0x1e4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IStructuralEquatable.Equals, addr 0x2f120b4, size 0x190, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IStructuralEquatable.GetHashCode, addr 0x2f12250, size 0x174, virtual true, abstract: false, final true
  ...
  /// @brief Method UnsafeCreateInstance, addr 0x2f14b60, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Array* UnsafeCreateInstance(::System::Type* elementType, int32_t length1, int32_t length2);

  /// @brief Method UnsafeCreateInstance, addr 0x2f14bec, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Array* UnsafeCreateInstance(::System::Type* elementType, ::ArrayW<int32_t, ::Array<int32_t>*> lengths);

  /// @brief Method UnsafeCreateInstance, addr 0x2f14768, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f14650, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsFixedSize, addr 0x2f130b4, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x2f130bc, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x2f130c4, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Length, addr 0x2f071c0, size 0x60, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_LongLength, addr 0x2f12b88, size 0x64, virtual false, abstract: false, final false
  inline int64_t get_LongLength();

  /// @brief Method get_Rank, addr 0x2f11990, size 0x4, virtual false, abstract: false, final false
  inline int32_t get_Rank();

  /// @brief Method get_SyncRoot, addr 0x2f130cc, size 0x4, virtual true, abstract: false, final true
