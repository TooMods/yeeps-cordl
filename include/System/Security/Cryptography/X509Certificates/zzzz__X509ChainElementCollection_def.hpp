...
public:
  ...
  /// @brief Method Add, addr 0x12cbd50, size 0x84, virtual false, abstract: false, final false
  inline void Add(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Clear, addr 0x12cbdd4, size 0x24, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x12cbdf8, size 0x110, virtual false, abstract: false, final false
  inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method GetEnumerator, addr 0x12cbbd4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x12cbbb0, size 0x24, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x12cbcec, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12cba40, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x12cbaac, size 0x24, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x12cbad0, size 0x24, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x12cbaf4, size 0x98, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElement* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x12cbb8c, size 0x24, virtual true, abstract: false, final true
