...
public:
  ...
  /// @brief Method Decode, addr 0x1cc9dac, size 0x268, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method DecodeDSA, addr 0x1cca79c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeRSA, addr 0x1cca1cc, size 0x3d0, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* DecodeRSA(::ArrayW<uint8_t, ::Array<uint8_t>*> keypair);

  /// @brief Method Encode, addr 0x1cca918, size 0x128, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode(::System::Security::Cryptography::AsymmetricAlgorithm* aa);

  /// @brief Method Encode, addr 0x1cca8c8, size 0x50, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method Encode, addr 0x1cca59c, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x1cca12c, size 0xa0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Normalize(::ArrayW<uint8_t, ::Array<uint8_t>*> bigInt, int32_t length);

  /// @brief Method RemoveLeadingZero, addr 0x1cca090, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cc9d14, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1cc9d84, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method get_Algorithm, addr 0x1cca014, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Algorithm();

  /// @brief Method get_PrivateKey, addr 0x1cca01c, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Decode, addr 0x1ccaa74, size 0x2c8, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> data);
  ...
  /// @brief Method .ctor, addr 0x1ccaa40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ccaa48, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method get_Algorithm, addr 0x1ccad3c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Algorithm();

  /// @brief Method get_EncryptedData, addr 0x1ccad44, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_EncryptedData();

  /// @brief Method get_IterationCount, addr 0x1ccae6c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_IterationCount();

  /// @brief Method get_Salt, addr 0x1ccadb8, size 0xb4, virtual false, abstract: false, final false
