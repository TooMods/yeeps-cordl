...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x1333bec, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method AnnotationForSealedType, addr 0x13359c8, size 0x144, virtual false, abstract: false, final false
  inline ::System::Object* AnnotationForSealedType(::System::Type* type);

  /// @brief Method GetSaveOptionsFromAnnotations, addr 0x13353f8, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::SaveOptions GetSaveOptionsFromAnnotations();

  static inline ::System::Xml::Linq::XObject* New_ctor();

  /// @brief Method NotifyChanged, addr 0x132d9b4, size 0xa8, virtual false, abstract: false, final false
  inline bool NotifyChanged(::System::Object* sender, ::System::Xml::Linq::XObjectChangeEventArgs* e);

  /// @brief Method NotifyChanging, addr 0x132d90c, size 0xa8, virtual false, abstract: false, final false
  inline bool NotifyChanging(::System::Object* sender, ::System::Xml::Linq::XObjectChangeEventArgs* e);

  /// @brief Method SetBaseUri, addr 0x1331b18, size 0x74, virtual false, abstract: false, final false
  inline void SetBaseUri(::StringW baseUri);

  /// @brief Method SetLineInfo, addr 0x1331b8c, size 0x78, virtual false, abstract: false, final false
  inline void SetLineInfo(int32_t lineNumber, int32_t linePosition);

  /// @brief Method SkipNotify, addr 0x132ee68, size 0x70, virtual false, abstract: false, final false
  inline bool SkipNotify();

  /// @brief Method System.Xml.IXmlLineInfo.HasLineInfo, addr 0x1335b0c, size 0x54, virtual true, abstract: false, final true
  inline bool System_Xml_IXmlLineInfo_HasLineInfo();

  /// @brief Method System.Xml.IXmlLineInfo.get_LineNumber, addr 0x1335b60, size 0x54, virtual true, abstract: false, final true
  inline int32_t System_Xml_IXmlLineInfo_get_LineNumber();

  /// @brief Method System.Xml.IXmlLineInfo.get_LinePosition, addr 0x1335bb4, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x132d07c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseUri, addr 0x1331cd0, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW get_BaseUri();

  /// @brief Method get_HasBaseUri, addr 0x1331c7c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parent, addr 0x133594c, size 0x7c, virtual false, abstract: false, final false
