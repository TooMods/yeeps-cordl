...
public:
  ...
  /// @brief Method Equals, addr 0x304dd28, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x304dca8, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304dc50, size 0x58, virtual false, abstract: false, final false
