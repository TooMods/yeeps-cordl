...
public:
  ...
  /// @brief Method Animate, addr 0x27dc684, size 0x340, virtual false, abstract: false, final false
  inline void Animate(::UnityEngine::UIElements::ReusableCollectionItem* element, float_t paddingTop);

  /// @brief Method ClearDragAndDropUI, addr 0x27dd558, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDrop, addr 0x27dd258, size 0x300, virtual true, abstract: false, final false
  inline void OnDrop(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method StartDrag, addr 0x27dbfa4, size 0x6e0, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::StartDragArgs* StartDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method TryGetDragPosition, addr 0x27dd55c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateDrag, addr 0x27dc9c4, size 0x894, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27dbfa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView* listView);

  /// @brief Method get_draggedItem, addr 0x27dbf90, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ReusableCollectionItem* get_draggedItem();

  /// @brief Method get_isDragging, addr 0x27dbf80, size 0x10, virtual false, abstract: false, final false
  inline bool get_isDragging();

  /// @brief Method get_supportsDragEvents, addr 0x27dbf98, size 0x8, virtual true, abstract: false, final false
