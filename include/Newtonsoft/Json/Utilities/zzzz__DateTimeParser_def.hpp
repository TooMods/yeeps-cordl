...
public:
  ...
  /// @brief Method Parse, addr 0x152c94c, size 0xd8, virtual false, abstract: false, final false
  inline bool Parse(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t startIndex, int32_t length);

  /// @brief Method Parse2Digit, addr 0x152cd24, size 0x94, virtual false, abstract: false, final false
  inline bool Parse2Digit(int32_t start, ByRef<int32_t> num);

  /// @brief Method Parse4Digit, addr 0x152cc48, size 0xdc, virtual false, abstract: false, final false
  inline bool Parse4Digit(int32_t start, ByRef<int32_t> num);

  /// @brief Method ParseChar, addr 0x152cbbc, size 0x4c, virtual false, abstract: false, final false
  inline bool ParseChar(int32_t start, char16_t ch);

  /// @brief Method ParseDate, addr 0x152ca24, size 0x198, virtual false, abstract: false, final false
  inline bool ParseDate(int32_t start);

  /// @brief Method ParseTime, addr 0x152cdb8, size 0x2c0, virtual false, abstract: false, final false
  inline bool ParseTime(ByRef<int32_t> start);

  /// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x152cc08, size 0x40, virtual false, abstract: false, final false
  inline bool ParseTimeAndZoneAndWhitespace(int32_t start);

  /// @brief Method ParseZone, addr 0x152d078, size 0x1d0, virtual false, abstract: false, final false
