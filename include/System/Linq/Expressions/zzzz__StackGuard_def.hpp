...
public:
  ...
  /// @brief Method TryEnterOnCurrentStack, addr 0x183c740, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183c7b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
