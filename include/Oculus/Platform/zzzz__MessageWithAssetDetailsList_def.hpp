...
public:
  // Declarations
  /// @brief Method GetAssetDetailsList, addr 0x19b2bc4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetailsList* GetAssetDetailsList();

  /// @brief Method GetDataFromMessage, addr 0x19b2c00, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0834, size 0x58, virtual false, abstract: false, final false
