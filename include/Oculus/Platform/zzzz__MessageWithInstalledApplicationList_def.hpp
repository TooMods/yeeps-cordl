...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3880, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InstalledApplicationList* GetDataFromMessage(void* c_message);

  /// @brief Method GetInstalledApplicationList, addr 0x19b3844, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b37ec, size 0x58, virtual false, abstract: false, final false
