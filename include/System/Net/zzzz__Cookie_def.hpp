...
public:
  ...
  /// @brief Method DomainCharsTest, addr 0xf5f30c, size 0x9c, virtual false, abstract: false, final false
  static inline bool DomainCharsTest(::StringW name);

  /// @brief Method Equals, addr 0xf5faec, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetComparer, addr 0xf5fa94, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Collections::IComparer* GetComparer();

  /// @brief Method GetHashCode, addr 0xf5fbbc, size 0x268, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method InternalSetName, addr 0xf5e6a8, size 0x104, virtual false, abstract: false, final false
  inline bool InternalSetName(::StringW value);

  /// @brief Method IsDomainEqualToHost, addr 0xf5e8bc, size 0x58, virtual false, abstract: false, final false
  static inline bool IsDomainEqualToHost(::StringW domain, ::StringW host);

  static inline ::System::Net::Cookie* New_ctor();

  /// @brief Method ToString, addr 0xf5fe24, size 0x310, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method VerifySetDefaults, addr 0xf5e914, size 0x9f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf5e328, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Comment, addr 0xf5e408, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Comment();

  /// @brief Method get_Domain, addr 0xf5e488, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Domain();

  /// @brief Method get_DomainKey, addr 0xf5f8fc, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_DomainKey();

  /// @brief Method get_Expired, addr 0xf5e5e0, size 0xb8, virtual false, abstract: false, final false
  inline bool get_Expired();

  /// @brief Method get_Name, addr 0xf5e6a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Path, addr 0xf5e7ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Path();

  /// @brief Method get_Plain, addr 0xf5e5d0, size 0x10, virtual false, abstract: false, final false
  inline bool get_Plain();

  /// @brief Method get_PortList, addr 0xf5f7a0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_PortList();

  /// @brief Method get_Secure, addr 0xf5f870, size 0x8, virtual false, abstract: false, final false
  inline bool get_Secure();

  /// @brief Method get_Value, addr 0xf5f884, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_Variant, addr 0xf5f8f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::CookieVariant get_Variant();

  /// @brief Method get_Version, addr 0xf5f918, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Version();

  /// @brief Method get__Domain, addr 0xf5e504, size 0xcc, virtual false, abstract: false, final false
  inline ::StringW get__Domain();

  /// @brief Method get__Path, addr 0xf5e820, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW get__Path();

  /// @brief Method get__Port, addr 0xf5f7a8, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW get__Port();

  /// @brief Method get__Version, addr 0xf5f998, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Comment, addr 0xf5e410, size 0x58, virtual false, abstract: false, final false
  inline void set_Comment(::StringW value);

  /// @brief Method set_CommentUri, addr 0xf5e468, size 0x8, virtual false, abstract: false, final false
  inline void set_CommentUri(::System::Uri* value);

  /// @brief Method set_Discard, addr 0xf5e47c, size 0xc, virtual false, abstract: false, final false
  inline void set_Discard(bool value);

  /// @brief Method set_Domain, addr 0xf5e490, size 0x74, virtual false, abstract: false, final false
  inline void set_Domain(::StringW value);

  /// @brief Method set_Expires, addr 0xf5e698, size 0x8, virtual false, abstract: false, final false
  inline void set_Expires(::System::DateTime value);

  /// @brief Method set_HttpOnly, addr 0xf5e470, size 0xc, virtual false, abstract: false, final false
  inline void set_HttpOnly(bool value);

  /// @brief Method set_Path, addr 0xf5e7b4, size 0x6c, virtual false, abstract: false, final false
  inline void set_Path(::StringW value);

  /// @brief Method set_Port, addr 0xf5f46c, size 0x334, virtual false, abstract: false, final false
  inline void set_Port(::StringW value);

  /// @brief Method set_Secure, addr 0xf5f878, size 0xc, virtual false, abstract: false, final false
  inline void set_Secure(bool value);

  /// @brief Method set_Value, addr 0xf5f88c, size 0x68, virtual false, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method set_Version, addr 0xf5f920, size 0x78, virtual false, abstract: false, final false
