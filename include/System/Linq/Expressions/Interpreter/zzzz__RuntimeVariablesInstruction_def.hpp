...
public:
  ...
  /// @brief Method Run, addr 0x1b53358, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b532e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t count);

  /// @brief Method get_ConsumedStack, addr 0x1b53310, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x1b53318, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1b53308, size 0x8, virtual true, abstract: false, final false
