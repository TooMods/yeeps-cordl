...
public:
  ...
  /// @brief Field ConnectToBest value: static_cast<int32_t>(0x3)
  static ::Photon::Pun::ConnectMethod const ConnectToBest;

  /// @brief Field ConnectToMaster value: static_cast<int32_t>(0x1)
  static ::Photon::Pun::ConnectMethod const ConnectToMaster;

  /// @brief Field ConnectToRegion value: static_cast<int32_t>(0x2)
  static ::Photon::Pun::ConnectMethod const ConnectToRegion;

  /// @brief Field NotCalled value: static_cast<int32_t>(0x0)
...
static_assert(::cordl_internals::size_check_v<::Photon::Pun::ConnectMethod, 0x4>, "Size mismatch!");
