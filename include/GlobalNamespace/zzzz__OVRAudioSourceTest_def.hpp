...
public:
  ...
  /// @brief Method Start, addr 0x14e9ff4, size 0x100, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x14ea0f4, size 0x1bc, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x14ea2b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
