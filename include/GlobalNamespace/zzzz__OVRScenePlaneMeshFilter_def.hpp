...
public:
  ...
  /// @brief Method Dispose, addr 0x1493e68, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetAt, addr 0x1493d28, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetAt(int32_t index);

  /// @brief Method RemoveAt, addr 0x1493e1c, size 0x3c, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method .ctor, addr 0x1493c78, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, ::Unity::Collections::Allocator allocator);

  /// @brief Method get_Count, addr 0x1493e58, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x1493d1c, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_Item(int32_t index);

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable();

  /// @brief Method set_Count, addr 0x1493e60, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cross, addr 0x1493d64, size 0x10, virtual false, abstract: false, final false
  static inline float_t Cross(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method Execute, addr 0x14938e4, size 0x394, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method PointInTriangle, addr 0x1493d74, size 0xa8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnDisable, addr 0x149384c, size 0x90, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method RequestMeshGeneration, addr 0x14925f4, size 0x30, virtual false, abstract: false, final false
  inline void RequestMeshGeneration();

  /// @brief Method ScheduleMeshGeneration, addr 0x1492b50, size 0x5c8, virtual false, abstract: false, final false
  inline void ScheduleMeshGeneration();

  /// @brief Method Start, addr 0x14929a4, size 0x1ac, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x1493118, size 0x734, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x14938dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
