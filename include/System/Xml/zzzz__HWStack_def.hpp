...
public:
  ...
  /// @brief Method AddToTop, addr 0xfa7024, size 0x6c, virtual false, abstract: false, final false
  inline void AddToTop(::System::Object* o);

  /// @brief Method Clone, addr 0xfa7208, size 0xdc, virtual true, abstract: false, final true
  ...
  /// @brief Method Peek, addr 0xfa6fe0, size 0x44, virtual false, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method Pop, addr 0xfa6f98, size 0x48, virtual false, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0xfa6e5c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa6de0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t GrowthRate);

  /// @brief Method .ctor, addr 0xfa6de8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(int32_t GrowthRate, int32_t limit);

  /// @brief Method .ctor, addr 0xfa71c4, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Object*, ::Array<::System::Object*>*> stack, int32_t growthRate, int32_t used, int32_t size);

  /// @brief Method get_Item, addr 0xfa7090, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method get_Length, addr 0xfa71bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Item, addr 0xfa710c, size 0xb0, virtual false, abstract: false, final false
