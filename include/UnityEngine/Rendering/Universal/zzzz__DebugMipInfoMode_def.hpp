...
// Type: UnityEngine.Rendering.Universal::DebugMipInfoMode
...
public:
  ...
  enum struct __DebugMipInfoMode_Unwrapped : int32_t {
    ...
    __E_Ratio = static_cast<int32_t>(0x3),
  };
  ...
  static ::UnityEngine::Rendering::Universal::DebugMipInfoMode const Count;

  /// @brief Field Level value: static_cast<int32_t>(0x1)
  static ::UnityEngine::Rendering::Universal::DebugMipInfoMode const Level;

  /// @brief Field None value: static_cast<int32_t>(0x0)
  static ::UnityEngine::Rendering::Universal::DebugMipInfoMode const None;

  /// @brief Field Ratio value: static_cast<int32_t>(0x3)
  static ::UnityEngine::Rendering::Universal::DebugMipInfoMode const Ratio;
