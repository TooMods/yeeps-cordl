...
public:
  // Declarations
  /// @brief Method Abs, addr 0x284ee50, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t Abs(int32_t a);

  /// @brief Method CbitHighZero, addr 0x2850ea8, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t CbitHighZero(uint32_t u);

  /// @brief Method CbitHighZero, addr 0x28565fc, size 0x24, virtual false, abstract: false, final false
  static inline int32_t CbitHighZero(uint64_t uu);

  /// @brief Method CombineHash, addr 0x284f3e8, size 0x8, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t n1, int32_t n2);

  /// @brief Method CombineHash, addr 0x2856620, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t CombineHash(uint32_t u1, uint32_t u2);

  /// @brief Method DangerousMakeTwosComplement, addr 0x284e658, size 0xbc, virtual false, abstract: false, final false
  static inline void DangerousMakeTwosComplement(::ArrayW<uint32_t, ::Array<uint32_t>*> d);

  /// @brief Method GetDoubleFromParts, addr 0x2850f24, size 0xa0, virtual false, abstract: false, final false
  static inline double_t GetDoubleFromParts(int32_t sign, int32_t exp, uint64_t man);

  /// @brief Method GetDoubleParts, addr 0x284de14, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeUlong, addr 0x284f590, size 0x10, virtual false, abstract: false, final false
