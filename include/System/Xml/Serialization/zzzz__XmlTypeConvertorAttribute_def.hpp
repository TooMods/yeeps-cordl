...
public:
  ...
  /// @brief Method .ctor, addr 0x12582d0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW method);

  /// @brief Method get_Method, addr 0x12582c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method set_Method, addr 0x12582c8, size 0x8, virtual false, abstract: false, final false
