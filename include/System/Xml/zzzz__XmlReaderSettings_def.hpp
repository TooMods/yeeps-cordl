...
public:
  ...
  /// @brief Method AddValidation, addr 0x14d69e0, size 0x108, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReader* AddValidation(::System::Xml::XmlReader* reader);

  /// @brief Method CheckReadOnly, addr 0x14d6b54, size 0xb8, virtual false, abstract: false, final false
  inline void CheckReadOnly(::StringW propertyName);

  /// @brief Method Clone, addr 0x14cc8c4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* Clone();

  /// @brief Method CreateDefaultResolver, addr 0x14d7564, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlResolver* CreateDefaultResolver();

  /// @brief Method CreateDtdValidatingReader, addr 0x14d76c0, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::XmlValidatingReaderImpl* CreateDtdValidatingReader(::System::Xml::XmlReader* baseReader);

  /// @brief Method CreateReader, addr 0x14d622c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReader, addr 0x14d64f8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableLegacyXmlSettings, addr 0x14d75c0, size 0x100, virtual false, abstract: false, final false
  static inline bool EnableLegacyXmlSettings();

  /// @brief Method GetEventHandler, addr 0x14d74ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler();

  /// @brief Method GetXmlResolver, addr 0x14d6ce8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetXmlResolver();

  /// @brief Method GetXmlResolver_CheckConfig, addr 0x14d6cf0, size 0x30, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetXmlResolver_CheckConfig();

  /// @brief Method Initialize, addr 0x14d6b44, size 0x8, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Initialize, addr 0x14d7500, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14cc92c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Nullable_1<bool> getStaticF_s_enableLegacyXmlSettings();

  /// @brief Method get_Async, addr 0x14d6b4c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Async();

  /// @brief Method get_CheckCharacters, addr 0x14d6ea0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckCharacters();

  /// @brief Method get_CloseInput, addr 0x14d7250, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseInput();

  /// @brief Method get_ConformanceLevel, addr 0x14d6de8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ConformanceLevel get_ConformanceLevel();

  /// @brief Method get_DtdProcessing, addr 0x14d7198, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::DtdProcessing get_DtdProcessing();

  /// @brief Method get_IgnoreComments, addr 0x14d7134, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreComments();

  /// @brief Method get_IgnoreProcessingInstructions, addr 0x14d70d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreProcessingInstructions();

  /// @brief Method get_IgnoreWhitespace, addr 0x14d706c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreWhitespace();

  /// @brief Method get_IsXmlResolverSet, addr 0x14d6c70, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsXmlResolverSet();

  /// @brief Method get_LineNumberOffset, addr 0x14d6d20, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumberOffset();

  /// @brief Method get_LinePositionOffset, addr 0x14d6d84, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePositionOffset();

  /// @brief Method get_MaxCharactersFromEntities, addr 0x14d6fb8, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxCharactersFromEntities();

  /// @brief Method get_MaxCharactersInDocument, addr 0x14d6f04, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxCharactersInDocument();

  /// @brief Method get_NameTable, addr 0x14d6c0c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_Schemas, addr 0x14d7424, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* get_Schemas();

  /// @brief Method get_ValidationFlags, addr 0x14d736c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaValidationFlags get_ValidationFlags();

  /// @brief Method get_ValidationType, addr 0x14d72b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Async, addr 0x14cc94c, size 0x5c, virtual false, abstract: false, final false
  inline void set_Async(bool value);

  /// @brief Method set_CheckCharacters, addr 0x14d6ea8, size 0x5c, virtual false, abstract: false, final false
  inline void set_CheckCharacters(bool value);

  /// @brief Method set_CloseInput, addr 0x14d7258, size 0x5c, virtual false, abstract: false, final false
  inline void set_CloseInput(bool value);

  /// @brief Method set_ConformanceLevel, addr 0x14d6df0, size 0xb0, virtual false, abstract: false, final false
  inline void set_ConformanceLevel(::System::Xml::ConformanceLevel value);

  /// @brief Method set_DtdProcessing, addr 0x14d71a0, size 0xb0, virtual false, abstract: false, final false
  inline void set_DtdProcessing(::System::Xml::DtdProcessing value);

  /// @brief Method set_IgnoreComments, addr 0x14d713c, size 0x5c, virtual false, abstract: false, final false
  inline void set_IgnoreComments(bool value);

  /// @brief Method set_IgnoreProcessingInstructions, addr 0x14d70d8, size 0x5c, virtual false, abstract: false, final false
  inline void set_IgnoreProcessingInstructions(bool value);

  /// @brief Method set_IgnoreWhitespace, addr 0x14d7074, size 0x5c, virtual false, abstract: false, final false
  inline void set_IgnoreWhitespace(bool value);

  /// @brief Method set_IsXmlResolverSet, addr 0x14d6c78, size 0xc, virtual false, abstract: false, final false
  inline void set_IsXmlResolverSet(bool value);

  /// @brief Method set_LineNumberOffset, addr 0x14d6d28, size 0x5c, virtual false, abstract: false, final false
  inline void set_LineNumberOffset(int32_t value);

  /// @brief Method set_LinePositionOffset, addr 0x14d6d8c, size 0x5c, virtual false, abstract: false, final false
  inline void set_LinePositionOffset(int32_t value);

  /// @brief Method set_MaxCharactersFromEntities, addr 0x14d6fc0, size 0xac, virtual false, abstract: false, final false
  inline void set_MaxCharactersFromEntities(int64_t value);

  /// @brief Method set_MaxCharactersInDocument, addr 0x14d6f0c, size 0xac, virtual false, abstract: false, final false
  inline void set_MaxCharactersInDocument(int64_t value);

  /// @brief Method set_NameTable, addr 0x14d6c14, size 0x5c, virtual false, abstract: false, final false
  inline void set_NameTable(::System::Xml::XmlNameTable* value);

  /// @brief Method set_ReadOnly, addr 0x14d74f4, size 0xc, virtual false, abstract: false, final false
  inline void set_ReadOnly(bool value);

  /// @brief Method set_Schemas, addr 0x14d7490, size 0x5c, virtual false, abstract: false, final false
  inline void set_Schemas(::System::Xml::Schema::XmlSchemaSet* value);

  /// @brief Method set_ValidationFlags, addr 0x14d7374, size 0xb0, virtual false, abstract: false, final false
  inline void set_ValidationFlags(::System::Xml::Schema::XmlSchemaValidationFlags value);

  /// @brief Method set_ValidationType, addr 0x14d72bc, size 0xb0, virtual false, abstract: false, final false
  inline void set_ValidationType(::System::Xml::ValidationType value);

  /// @brief Method set_XmlResolver, addr 0x14d6c84, size 0x64, virtual false, abstract: false, final false
