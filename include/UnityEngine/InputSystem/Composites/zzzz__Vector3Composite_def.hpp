...
public:
  ...
  /// @brief Method ReadValue, addr 0x1b37530, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b37784, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
