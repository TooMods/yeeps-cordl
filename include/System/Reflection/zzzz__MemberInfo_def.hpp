...
public:
  ...
  /// @brief Method Equals, addr 0x260f264, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x260f274, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260f0fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_MetadataToken, addr 0x2610a6c, size 0x40, virtual true, abstract: false, final false
  inline int32_t get_MetadataToken();

  /// @brief Method get_Module, addr 0x2610998, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2610aac, size 0x35c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::MemberInfo* left, ::System::Reflection::MemberInfo* right);

  /// @brief Method op_Inequality, addr 0x261103c, size 0x18, virtual false, abstract: false, final false
