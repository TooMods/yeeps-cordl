...
public:
  ...
  /// @brief Method Equals, addr 0x1334f78, size 0xc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Get, addr 0x1334998, size 0x154, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XName* Get(::StringW expandedName);

  /// @brief Method Get, addr 0x1334f48, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XName* Get(::StringW localName, ::StringW namespaceName);

  /// @brief Method GetHashCode, addr 0x1334f84, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method System.IEquatable<System.Xml.Linq.XName>.Equals, addr 0x1334f8c, size 0xc, virtual true, abstract: false, final true
  inline bool System_IEquatable_System_Xml_Linq_XName__Equals(::System::Xml::Linq::XName* other);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x1334f98, size 0x40, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToString, addr 0x1334908, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1334fd8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1334840, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XNamespace* ns, ::StringW localName);

  /// @brief Method get_LocalName, addr 0x13348f8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Namespace, addr 0x1334900, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XNamespace* get_Namespace();

  /// @brief Method get_NamespaceName, addr 0x132d7d8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x132d084, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::Linq::XName* left, ::System::Xml::Linq::XName* right);

  /// @brief Method op_Implicit, addr 0x1334f6c, size 0xc, virtual false, abstract: false, final false
