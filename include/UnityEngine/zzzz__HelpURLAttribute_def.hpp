...
public:
  ...
  /// @brief Method .ctor, addr 0x283ef24, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW url);

  /// @brief Method get_URL, addr 0x283ef8c, size 0x8, virtual false, abstract: false, final false
