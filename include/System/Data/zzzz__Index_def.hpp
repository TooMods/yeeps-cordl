...
public:
  ...
  /// @brief Method CompareNode, addr 0x1ca2998, size 0x18, virtual true, abstract: false, final false
  inline int32_t CompareNode(int32_t record1, int32_t record2);

  /// @brief Method CompareSateliteTreeNode, addr 0x1ca29b0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ca20a0, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <OnListChanged>b__85_0, addr 0x1ca2a40, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__22_0, addr 0x1ca2a34, size 0xc, virtual false, abstract: false, final false
  inline bool __ctor_b__22_0(::System::Data::DataViewListener* listener);

  /// @brief Method .ctor, addr 0x1ca2a2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <MaintainDataView>b__0, addr 0x1ca2a5c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ca2220, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AcceptRecord, addr 0x1ca0320, size 0x2c, virtual false, abstract: false, final false
  inline bool AcceptRecord(int32_t record);

  /// @brief Method AcceptRecord, addr 0x1ca034c, size 0x194, virtual false, abstract: false, final false
  inline bool AcceptRecord(int32_t record, ::System::Data::IFilter* filter);

  /// @brief Method AddRef, addr 0x1ca0598, size 0x1f4, virtual false, abstract: false, final false
  inline void AddRef();

  /// @brief Method ApplyChangeAction, addr 0x1ca0948, size 0xa4, virtual false, abstract: false, final false
  inline void ApplyChangeAction(int32_t record, int32_t action, int32_t changeRecord);

  /// @brief Method CheckUnique, addr 0x1ca0d78, size 0x18, virtual false, abstract: false, final false
  inline bool CheckUnique();

  /// @brief Method CompareDataRows, addr 0x1ca0ee0, size 0x6c, virtual false, abstract: false, final false
  inline int32_t CompareDataRows(int32_t record1, int32_t record2);

  /// @brief Method CompareDuplicateRecords, addr 0x1ca0f4c, size 0x14c, virtual false, abstract: false, final false
  inline int32_t CompareDuplicateRecords(int32_t record1, int32_t record2);

  /// @brief Method CompareRecordToKey, addr 0x1ca1098, size 0xd0, virtual false, abstract: false, final false
  inline int32_t CompareRecordToKey(int32_t record1, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> vals);

  /// @brief Method CompareRecords, addr 0x1ca0d90, size 0x150, virtual false, abstract: false, final false
  inline int32_t CompareRecords(int32_t record1, int32_t record2);

  /// @brief Method DeleteRecord, addr 0x1ca0d18, size 0x8, virtual false, abstract: false, final false
  inline void DeleteRecord(int32_t recordIndex);

  /// @brief Method DeleteRecord, addr 0x1ca1170, size 0x124, virtual false, abstract: false, final false
  inline void DeleteRecord(int32_t recordIndex, bool fireEvent);

  /// @brief Method DeleteRecordFromIndex, addr 0x1ca1168, size 0x8, virtual false, abstract: false, final false
  inline void DeleteRecordFromIndex(int32_t recordIndex);

  /// @brief Method Equal, addr 0x1ca0138, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindNodeByKey, addr 0x1ca16c8, size 0x214, virtual false, abstract: false, final false
  inline int32_t FindNodeByKey(::System::Object* originalKey);

  /// @brief Method FindNodeByKeyRecord, addr 0x1ca1b0c, size 0xf4, virtual false, abstract: false, final false
  inline int32_t FindNodeByKeyRecord(int32_t record);

  /// @brief Method FindNodeByKeys, addr 0x1ca18dc, size 0x230, virtual false, abstract: false, final false
  inline int32_t FindNodeByKeys(::ArrayW<::System::Object*, ::Array<::System::Object*>*> originalKey);

  /// @brief Method FindRecords, addr 0x1c97dfc, size 0x24, virtual false, abstract: false, final false
  inline ::System::Data::Range FindRecords(::ArrayW<::System::Object*, ::Array<::System::Object*>*> key);

  /// @brief Method FindRecords, addr 0x1ca1d28, size 0x24, virtual false, abstract: false, final false
  inline ::System::Data::Range FindRecords(::System::Object* key);

  /// @brief Method FireResetEvent, addr 0x1ca1d4c, size 0xe8, virtual false, abstract: false, final false
  inline void FireResetEvent();

  /// @brief Method GetAllFields, addr 0x1c9fc94, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChangeAction, addr 0x1ca2030, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetChangeAction(::System::Data::DataViewRowState oldState, ::System::Data::DataViewRowState newState);

  /// @brief Method GetEnumerator, addr 0x1ca144c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Data::__RBTree_1__RBTreeEnumerator<int32_t> GetEnumerator(int32_t startIndex);

  /// @brief Method GetIndex, addr 0x1ca0d20, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetIndex(int32_t record);

  /// @brief Method GetIndex, addr 0x1ca0bd8, size 0x140, virtual false, abstract: false, final false
  inline int32_t GetIndex(int32_t record, int32_t changeRecord);

  /// @brief Method GetRangeFromNode, addr 0x1ca1c00, size 0x128, virtual false, abstract: false, final false
  inline ::System::Data::Range GetRangeFromNode(int32_t nodeId);

  /// @brief Method GetRecord, addr 0x1ca0270, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetRecord(int32_t recordIndex);

  /// @brief Method GetReplaceAction, addr 0x1ca204c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetReplaceAction(::System::Data::DataViewRowState oldState);

  /// @brief Method GetRow, addr 0x1c98710, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* GetRow(int32_t i);

  /// @brief Method GetRows, addr 0x1c97e20, size 0x160, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataRow*, ::Array<::System::Data::DataRow*>*> GetRows(::System::Data::Range range);

  /// @brief Method GetRows, addr 0x1ca2074, size 0x2c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataRow*, ::Array<::System::Data::DataRow*>*> GetRows(::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method GetUniqueKeyValues, addr 0x1c97cd0, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetUniqueKeyValues();

  /// @brief Method GetUniqueKeyValues, addr 0x1ca14b4, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method InitRecords, addr 0x1c9fd58, size 0x3e0, virtual false, abstract: false, final false
  inline void InitRecords(::System::Data::IFilter* filter);

  /// @brief Method InsertRecord, addr 0x1ca09ec, size 0x1ec, virtual false, abstract: false, final false
  inline int32_t InsertRecord(int32_t record, bool fireEvent);

  /// @brief Method InsertRecordToIndex, addr 0x1ca2100, size 0x50, virtual false, abstract: false, final false
  inline int32_t InsertRecordToIndex(int32_t record);

  /// @brief Method IsKeyInIndex, addr 0x1c97de4, size 0x18, virtual false, abstract: false, final false
  inline bool IsKeyInIndex(::ArrayW<::System::Object*, ::Array<::System::Object*>*> key);

  /// @brief Method IsKeyInIndex, addr 0x1ca2150, size 0x18, virtual false, abstract: false, final false
  inline bool IsKeyInIndex(::System::Object* key);

  /// @brief Method IsKeyRecordInIndex, addr 0x1ca2168, size 0x18, virtual false, abstract: false, final false
  inline bool IsKeyRecordInIndex(int32_t record);

  /// @brief Method ListChangedAdd, addr 0x1ca04e0, size 0x58, virtual false, abstract: false, final false
  inline void ListChangedAdd(::System::Data::DataViewListener* listener);

  /// @brief Method ListChangedRemove, addr 0x1ca0538, size 0x58, virtual false, abstract: false, final false
  inline void ListChangedRemove(::System::Data::DataViewListener* listener);

  /// @brief Method MaintainDataView, addr 0x1ca1294, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method OnListChanged, addr 0x1ca13b4, size 0x98, virtual false, abstract: false, final false
  inline void OnListChanged(::System::ComponentModel::ListChangedType changedType, int32_t index);

  /// @brief Method OnListChanged, addr 0x1ca2180, size 0xa0, virtual false, abstract: false, final false
  inline void OnListChanged(::System::ComponentModel::ListChangedType changedType, int32_t newIndex, int32_t oldIndex);

  /// @brief Method OnListChanged, addr 0x1ca1eb4, size 0x17c, virtual false, abstract: false, final false
  inline void OnListChanged(::System::ComponentModel::ListChangedEventArgs* e);

  /// @brief Method RecordChanged, addr 0x1ca23d4, size 0x134, virtual false, abstract: false, final false
  inline void RecordChanged(int32_t oldIndex, int32_t newIndex);

  /// @brief Method RecordChanged, addr 0x1ca22f0, size 0xe4, virtual false, abstract: false, final false
  inline void RecordChanged(int32_t record);

  /// @brief Method RecordStateChanged, addr 0x1ca2610, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordStateChanged, addr 0x1ca2508, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveRef, addr 0x1ca078c, size 0x1bc, virtual false, abstract: false, final false
  inline int32_t RemoveRef();

  /// @brief Method Reset, addr 0x1ca2228, size 0xc8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1c9fc3c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c9f96c, size 0x2d0, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::ArrayW<::System::Data::IndexField, ::Array<::System::Data::IndexField>*> indexFields,
                    ::System::Comparison_1<::System::Data::DataRow*>* comparison, ::System::Data::DataViewRowState recordStates, ::System::Data::IFilter* rowFilter);

  /// @brief Method .ctor, addr 0x1c9f95c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DoListChanged, addr 0x1ca1e34, size 0x80, virtual false, abstract: false, final false
  inline bool get_DoListChanged();

  /// @brief Method get_HasDuplicates, addr 0x1ca02c8, size 0x50, virtual false, abstract: false, final false
  inline bool get_HasDuplicates();

  /// @brief Method get_HasRemoteAggregate, addr 0x1ca01e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasRemoteAggregate();

  /// @brief Method get_ObjectID, addr 0x1ca01e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_RecordCount, addr 0x1ca0318, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RecordCount();

  /// @brief Method get_RecordStates, addr 0x1ca01f0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataViewRowState get_RecordStates();

  /// @brief Method get_RefCount, addr 0x1ca0590, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RefCount();

  /// @brief Method get_RowFilter, addr 0x1ca01f8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Data::IFilter* get_RowFilter();

  /// @brief Method get_Table, addr 0x1ca2990, size 0x8, virtual false, abstract: false, final false
