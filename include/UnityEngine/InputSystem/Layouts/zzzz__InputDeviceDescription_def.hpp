...
public:
  ...
  /// @brief Method ComparePropertyToDeviceDescriptor, addr 0x21e9da8, size 0x90, virtual false, abstract: false, final false
  static inline bool ComparePropertyToDeviceDescriptor(::StringW propertyName, ::StringW propertyValue, ::StringW deviceDescriptor);

  /// @brief Method Equals, addr 0x21e9a28, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x21e9978, size 0xb0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Layouts::InputDeviceDescription other);

  /// @brief Method FromJson, addr 0x21e9cdc, size 0xcc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputDeviceDescription FromJson(::StringW json);

  /// @brief Method GetHashCode, addr 0x21e9ac0, size 0x128, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToJson, addr 0x21e9c5c, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method ToString, addr 0x21e9674, size 0x304, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_capabilities, addr 0x21e95e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_capabilities();

  /// @brief Method get_deviceClass, addr 0x21e9590, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_deviceClass();

  /// @brief Method get_empty, addr 0x21e95f0, size 0x84, virtual false, abstract: false, final false
  inline bool get_empty();

  /// @brief Method get_interfaceName, addr 0x21e9580, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_interfaceName();

  /// @brief Method get_manufacturer, addr 0x21e95a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_manufacturer();

  /// @brief Method get_product, addr 0x21e95b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_product();

  /// @brief Method get_serial, addr 0x21e95c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_serial();

  /// @brief Method get_version, addr 0x21e95d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x21e9be8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x21e9c20, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_capabilities, addr 0x21e95e8, size 0x8, virtual false, abstract: false, final false
  inline void set_capabilities(::StringW value);

  /// @brief Method set_deviceClass, addr 0x21e9598, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceClass(::StringW value);

  /// @brief Method set_interfaceName, addr 0x21e9588, size 0x8, virtual false, abstract: false, final false
  inline void set_interfaceName(::StringW value);

  /// @brief Method set_manufacturer, addr 0x21e95a8, size 0x8, virtual false, abstract: false, final false
  inline void set_manufacturer(::StringW value);

  /// @brief Method set_product, addr 0x21e95b8, size 0x8, virtual false, abstract: false, final false
  inline void set_product(::StringW value);

  /// @brief Method set_serial, addr 0x21e95c8, size 0x8, virtual false, abstract: false, final false
  inline void set_serial(::StringW value);

  /// @brief Method set_version, addr 0x21e95d8, size 0x8, virtual false, abstract: false, final false
