...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x2a7b0ac, size 0x24, virtual false, abstract: false, final false
  inline void Unpack(ByRef<::OVR::OpenVR::RenderModel_t> unpacked);

  /// @brief Method .ctor, addr 0x2a7b080, size 0x2c, virtual false, abstract: false, final false
