...
public:
  ...
  /// @brief Method .ctor, addr 0x30d2ce4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x30d2d40, size 0x8, virtual false, abstract: false, final false
