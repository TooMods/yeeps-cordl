...
public:
  ...
  /// @brief Method GetSupportedTrackingOriginModes, addr 0x18f7168, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::TrackingOriginModeFlags GetSupportedTrackingOriginModes();

  /// @brief Method GetTrackingOriginMode, addr 0x18f712c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::TrackingOriginModeFlags GetTrackingOriginMode();

  /// @brief Method InvokeBoundaryChangedEvent, addr 0x18f73c8, size 0xc4, virtual false, abstract: false, final false
  static inline void InvokeBoundaryChangedEvent(void* internalPtr);

  /// @brief Method InvokeTrackingOriginUpdatedEvent, addr 0x18f7304, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryRecenter, addr 0x18f70ac, size 0x3c, virtual false, abstract: false, final false
  inline bool TryRecenter();

  /// @brief Method TrySetTrackingOriginMode, addr 0x18f70e8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18f748c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_trackingOriginUpdated, addr 0x18f71a4, size 0xb0, virtual false, abstract: false, final false
  inline void add_trackingOriginUpdated(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method remove_trackingOriginUpdated, addr 0x18f7254, size 0xb0, virtual false, abstract: false, final false
