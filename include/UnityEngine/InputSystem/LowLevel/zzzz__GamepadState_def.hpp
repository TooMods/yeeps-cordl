...
public:
  ...
  /// @brief Method WithButton, addr 0x1e02ed8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e02e24, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x1e02dc4, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x1e02df4, size 0x30, virtual true, abstract: false, final true
