...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x19b3284, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x19b32c0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0af4, size 0x58, virtual false, abstract: false, final false
