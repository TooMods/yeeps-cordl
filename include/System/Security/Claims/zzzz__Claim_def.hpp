...
public:
  ...
  /// @brief Method Clone, addr 0x1970ecc, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDeserializedMethod, addr 0x1970e4c, size 0x60, virtual false, abstract: false, final false
  inline void OnDeserializedMethod(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToString, addr 0x1970f3c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1970b38, size 0x314, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Claims::Claim* other, ::System::Security::Claims::ClaimsIdentity* subject);

  /// @brief Method .ctor, addr 0x1970788, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19707a8, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Properties, addr 0x1970a00, size 0x138, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* get_Properties();

  /// @brief Method get_Subject, addr 0x1970eac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Claims::ClaimsIdentity* get_Subject();

  /// @brief Method get_Type, addr 0x1970ebc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Type();

  /// @brief Method get_Value, addr 0x1970ec4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Subject, addr 0x1970eb4, size 0x8, virtual false, abstract: false, final false
