...
public:
  ...
  /// @brief Method .ctor, addr 0x1711b94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x1711b9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllowIdnStatic, addr 0x14ee0f8, size 0xc8, virtual false, abstract: false, final false
  inline bool AllowIdnStatic(::System::UriParser* syntax, ::System::__Uri__Flags flags);

  /// @brief Method CalculateCaseInsensitiveHashCode, addr 0x14f3ac4, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t CalculateCaseInsensitiveHashCode(::StringW text);

  /// @brief Method CheckAuthorityHelper, addr 0x14f52ec, size 0xe04, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAuthorityHelperHandleAnyHostIri, addr 0x14f901c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAuthorityHelperHandleDnsIri, addr 0x14f8ccc, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCanonical, addr 0x14f67e8, size 0x3f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForConfigLoad, addr 0x14f9c30, size 0xac, virtual false, abstract: false, final false
  inline bool CheckForConfigLoad(::StringW data);

  /// @brief Method CheckForEscapedUnreserved, addr 0x14f9df4, size 0x1ac, virtual false, abstract: false, final false
  inline bool CheckForEscapedUnreserved(::StringW data);

  /// @brief Method CheckForUnicode, addr 0x14f9cdc, size 0x118, virtual false, abstract: false, final false
  inline bool CheckForUnicode(::StringW data);

  /// @brief Method CheckKnownSchemes, addr 0x14f87cc, size 0x500, virtual false, abstract: false, final false
  static inline bool CheckKnownSchemes(::cordl_internals::Ptr<int64_t> lptr, uint16_t nChars, ByRef<::System::UriParser*> syntax);

  /// @brief Method CheckSchemeName, addr 0x14f36b8, size 0x140, virtual false, abstract: false, final false
  static inline bool CheckSchemeName(::StringW schemeName);

  /// @brief Method CheckSchemeSyntax, addr 0x14f080c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CombineUri, addr 0x14f0968, size 0xa74, virtual false, abstract: false, final false
  static inline ::StringW CombineUri(::System::Uri* basePart, ::StringW relativePart, ::System::UriFormat uriFormat);

  /// @brief Method Compress, addr 0x14f2a1c, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHelper, addr 0x14f9fa0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHostString, addr 0x14ef44c, size 0x3fc, virtual false, abstract: false, final false
  inline void CreateHostString();

  /// @brief Method CreateHostStringHelper, addr 0x14f6604, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateThis, addr 0x14ef8cc, size 0x1c0, virtual false, abstract: false, final false
  inline void CreateThis(::StringW uri, bool dontEscape, ::System::UriKind uriKind);

  /// @brief Method CreateThisFromUri, addr 0x14f0278, size 0x120, virtual false, abstract: false, final false
  inline void CreateThisFromUri(::System::Uri* otherUri);

  /// @brief Method CreateUri, addr 0x14efbec, size 0x188, virtual false, abstract: false, final false
  inline void CreateUri(::System::Uri* baseUri, ::StringW relativeUri, bool dontEscape);

  /// @brief Method CreateUriInfo, addr 0x14ee290, size 0x594, virtual false, abstract: false, final false
  inline void CreateUriInfo(::System::__Uri__Flags cF);

  /// @brief Method EnsureHostString, addr 0x14ef3ec, size 0x60, virtual false, abstract: false, final false
  inline void EnsureHostString(bool allowDnsOptimization);

  /// @brief Method EnsureParseRemaining, addr 0x14ee824, size 0x10, virtual false, abstract: false, final false
  inline void EnsureParseRemaining();

  /// @brief Method EnsureUriInfo, addr 0x14ee26c, size 0x24, virtual false, abstract: false, final false
  inline ::System::__Uri__UriInfo* EnsureUriInfo();

  /// @brief Method Equals, addr 0x14f3e7c, size 0x588, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method EscapeDataString, addr 0x14fa950, size 0x130, virtual false, abstract: false, final false
  static inline ::StringW EscapeDataString(::StringW stringToEscape);

  /// @brief Method EscapeUnescapeIri, addr 0x14f877c, size 0x50, virtual false, abstract: false, final false
  inline ::StringW EscapeUnescapeIri(::StringW input, int32_t start, int32_t end, ::System::UriComponents component);

  /// @brief Method EscapeUriString, addr 0x14fa820, size 0x130, virtual false, abstract: false, final false
  static inline ::StringW EscapeUriString(::StringW stringToEscape);

  /// @brief Method FindEndOfComponent, addr 0x14f8728, size 0x54, virtual false, abstract: false, final false
  inline void FindEndOfComponent(::StringW input, ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method FindEndOfComponent, addr 0x14f9458, size 0x94, virtual false, abstract: false, final false
  inline void FindEndOfComponent(::cordl_internals::Ptr<char16_t> str, ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method FromHex, addr 0x14f38dc, size 0xb0, virtual false, abstract: false, final false
  static inline int32_t FromHex(char16_t digit);

  /// @brief Method GetCanonicalPath, addr 0x14f80c0, size 0x668, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCombinedString, addr 0x14f05bc, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x14f6be0, size 0x1dc, virtual false, abstract: false, final false
  inline ::StringW GetComponents(::System::UriComponents components, ::System::UriFormat format);

  /// @brief Method GetComponentsHelper, addr 0x14f3c30, size 0x218, virtual false, abstract: false, final false
  inline ::StringW GetComponentsHelper(::System::UriComponents uriComponents, ::System::UriFormat uriFormat);

  /// @brief Method GetEscapedParts, addr 0x14f6dbc, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW GetEscapedParts(::System::UriComponents uriParts);

  /// @brief Method GetException, addr 0x14f13dc, size 0x1a0, virtual false, abstract: false, final false
  static inline ::System::UriFormatException* GetException(::System::ParsingError err);

  /// @brief Method GetHashCode, addr 0x14f398c, size 0x138, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHostViaCustomSyntax, addr 0x14f61c4, size 0x440, virtual false, abstract: false, final false
  inline void GetHostViaCustomSyntax();

  /// @brief Method GetLocalPath, addr 0x14f1a48, size 0x5f4, virtual false, abstract: false, final false
  inline ::StringW GetLocalPath();

  /// @brief Method GetObjectData, addr 0x14f1684, size 0xd8, virtual false, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetParts, addr 0x14f175c, size 0x4, virtual false, abstract: false, final false
  inline ::StringW GetParts(::System::UriComponents uriParts, ::System::UriFormat formatAs);

  /// @brief Method GetRelativeSerializationString, addr 0x14fa458, size 0x220, virtual false, abstract: false, final false
  inline ::StringW GetRelativeSerializationString(::System::UriFormat format);

  /// @brief Method GetUnescapedParts, addr 0x14f2ef4, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW GetUnescapedParts(::System::UriComponents uriParts, ::System::UriFormat formatAs);

  /// @brief Method GetUriPartsFromUserString, addr 0x14f6e84, size 0x5b0, virtual false, abstract: false, final false
  inline ::StringW GetUriPartsFromUserString(::System::UriComponents uriParts);

  /// @brief Method InFact, addr 0x14ee250, size 0x10, virtual false, abstract: false, final false
  inline bool InFact(::System::__Uri__Flags flags);

  /// @brief Method InitializeUri, addr 0x14f975c, size 0x4d4, virtual false, abstract: false, final false
  inline void InitializeUri(::System::ParsingError err, ::System::UriKind uriKind, ByRef<::System::UriFormatException*> e);

  /// @brief Method InitializeUriConfig, addr 0x14f287c, size 0x1a0, virtual false, abstract: false, final false
  static inline void InitializeUriConfig();

  /// @brief Method InternalEscapeString, addr 0x14f44bc, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW InternalEscapeString(::StringW rawString);

  /// @brief Method IriParsingStatic, addr 0x14edfa0, size 0x8c, virtual false, abstract: false, final false
  static inline bool IriParsingStatic(::System::UriParser* syntax);

  /// @brief Method IsAsciiLetter, addr 0x14f37f8, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsAsciiLetter(char16_t character);

  /// @brief Method IsAsciiLetterOrDigit, addr 0x14f3824, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsAsciiLetterOrDigit(char16_t character);

  /// @brief Method IsBaseOf, addr 0x14faac0, size 0xb8, virtual false, abstract: false, final false
  inline bool IsBaseOf(::System::Uri* uri);

  /// @brief Method IsBaseOfHelper, addr 0x14fab78, size 0x204, virtual false, abstract: false, final false
  inline bool IsBaseOfHelper(::System::Uri* uriLink);

  /// @brief Method IsBidiControlCharacter, addr 0x14f9714, size 0x48, virtual false, abstract: false, final false
  static inline bool IsBidiControlCharacter(char16_t ch);

  /// @brief Method IsGenDelim, addr 0x14f366c, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsGenDelim(char16_t ch);

  /// @brief Method IsHexDigit, addr 0x14f38a0, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsHexDigit(char16_t character);

  /// @brief Method IsIntranet, addr 0x14ee1cc, size 0x8, virtual false, abstract: false, final false
  inline bool IsIntranet(::StringW schemeHost);

  /// @brief Method IsLWS, addr 0x14f52ac, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method NotAny, addr 0x14ee0e8, size 0x10, virtual false, abstract: false, final false
  inline bool NotAny(::System::__Uri__Flags flags);

  /// @brief Method ParseMinimal, addr 0x14f4bc4, size 0x80, virtual false, abstract: false, final false
  inline ::System::UriFormatException* ParseMinimal();

  /// @brief Method ParseRemaining, addr 0x14ee834, size 0xbb8, virtual false, abstract: false, final false
  inline void ParseRemaining();

  /// @brief Method ParseScheme, addr 0x14f459c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSchemeCheckImplicitFile, addr 0x14f467c, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method PrivateParseMinimal, addr 0x14f4c44, size 0x668, virtual false, abstract: false, final false
  inline ::System::ParsingError PrivateParseMinimal();

  /// @brief Method PrivateParseMinimalIri, addr 0x14f60f0, size 0xd4, virtual false, abstract: false, final false
  inline void PrivateParseMinimalIri(::StringW newHost, uint16_t idx);

  /// @brief Method ReCreateParts, addr 0x14f7434, size 0xc8c, virtual false, abstract: false, final false
  inline ::StringW ReCreateParts(::System::UriComponents parts, uint16_t nonCanonical, ::System::UriFormat formatAs);

  /// @brief Method ResolveHelper, addr 0x14efd74, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUserDrivenParsing, addr 0x14ee1e0, size 0x14, virtual false, abstract: false, final false
  inline void SetUserDrivenParsing();

  /// @brief Method StaticInFact, addr 0x14ee260, size 0xc, virtual false, abstract: false, final false
  static inline bool StaticInFact(::System::__Uri__Flags allFlags, ::System::__Uri__Flags checkFlags);

  /// @brief Method StaticIsFile, addr 0x14f2790, size 0x18, virtual false, abstract: false, final false
  static inline bool StaticIsFile(::System::UriParser* syntax);

  /// @brief Method StaticNotAny, addr 0x14ee1c0, size 0xc, virtual false, abstract: false, final false
  static inline bool StaticNotAny(::System::__Uri__Flags allFlags, ::System::__Uri__Flags checkFlags);

  /// @brief Method StripBidiControlCharacter, addr 0x14f92e0, size 0x178, virtual false, abstract: false, final false
  static inline ::StringW StripBidiControlCharacter(::cordl_internals::Ptr<char16_t> strToClean, int32_t start, int32_t length);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x14f1680, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method ToString, addr 0x14f3b64, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryCreate, addr 0x14fa214, size 0xd0, virtual false, abstract: false, final false
  static inline bool TryCreate(::System::Uri* baseUri, ::StringW relativeUri, ByRef<::System::Uri*> result);

  /// @brief Method TryCreate, addr 0x14fa2e4, size 0x174, virtual false, abstract: false, final false
  static inline bool TryCreate(::System::Uri* baseUri, ::System::Uri* relativeUri, ByRef<::System::Uri*> result);

  /// @brief Method TryCreate, addr 0x14f4404, size 0xb8, virtual false, abstract: false, final false
  static inline bool TryCreate(::StringW uriString, ::System::UriKind uriKind, ByRef<::System::Uri*> result);

  /// @brief Method UnescapeDataString, addr 0x14fa678, size 0x1a8, virtual false, abstract: false, final false
  static inline ::StringW UnescapeDataString(::StringW stringToUnescape);

  /// @brief Method UnescapeOnly, addr 0x14f94ec, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14efb14, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* baseUri, ::StringW relativeUri);

  /// @brief Method .ctor, addr 0x14f0398, size 0x224, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* baseUri, ::System::Uri* relativeUri);

  /// @brief Method .ctor, addr 0x14faa80, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::__Uri__Flags flags, ::System::UriParser* uriParser, ::StringW uri);

  /// @brief Method .ctor, addr 0x14f157c, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x14ef848, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW uriString);

  /// @brief Method .ctor, addr 0x14efa8c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AbsolutePath, addr 0x14f1760, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW get_AbsolutePath();

  /// @brief Method get_AbsoluteUri, addr 0x14f18d0, size 0x104, virtual false, abstract: false, final false
  inline ::StringW get_AbsoluteUri();

  /// @brief Method get_AllowIdn, addr 0x14ee02c, size 0xbc, virtual false, abstract: false, final false
  inline bool get_AllowIdn();

  /// @brief Method get_Authority, addr 0x14f203c, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW get_Authority();

  /// @brief Method get_DnsSafeHost, addr 0x14f3360, size 0x254, virtual false, abstract: false, final false
  inline ::StringW get_DnsSafeHost();

  /// @brief Method get_Fragment, addr 0x14f3198, size 0x108, virtual false, abstract: false, final false
  inline ::StringW get_Fragment();

  /// @brief Method get_HasAuthority, addr 0x14f9708, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasAuthority();

  /// @brief Method get_Host, addr 0x14f2714, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_HostNameType, addr 0x14f20b8, size 0x100, virtual false, abstract: false, final false
  inline ::System::UriHostNameType get_HostNameType();

  /// @brief Method get_HostType, addr 0x14edf7c, size 0xc, virtual false, abstract: false, final false
  inline ::System::__Uri__Flags get_HostType();

  /// @brief Method get_IdnHost, addr 0x14f35b4, size 0x30, virtual false, abstract: false, final false
  inline ::StringW get_IdnHost();

  /// @brief Method get_InitializeLock, addr 0x14f27a8, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Object* get_InitializeLock();

  /// @brief Method get_IsAbsoluteUri, addr 0x14efbdc, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsAbsoluteUri();

  /// @brief Method get_IsDefaultPort, addr 0x14f21b8, size 0xb0, virtual false, abstract: false, final false
  inline bool get_IsDefaultPort();

  /// @brief Method get_IsDosPath, addr 0x14edf64, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsDosPath();

  /// @brief Method get_IsFile, addr 0x14f2268, size 0xc8, virtual false, abstract: false, final false
  inline bool get_IsFile();

  /// @brief Method get_IsImplicitFile, addr 0x14edf48, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsImplicitFile();

  /// @brief Method get_IsLoopback, addr 0x14f2330, size 0x88, virtual false, abstract: false, final false
  inline bool get_IsLoopback();

  /// @brief Method get_IsNotAbsoluteUri, addr 0x14edf90, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsNotAbsoluteUri();

  /// @brief Method get_IsUnc, addr 0x14f2698, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsUnc();

  /// @brief Method get_IsUncOrDosPath, addr 0x14edf54, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsUncOrDosPath();

  /// @brief Method get_IsUncPath, addr 0x14edf70, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsUncPath();

  /// @brief Method get_LocalPath, addr 0x14f19d4, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_LocalPath();

  /// @brief Method get_OriginalString, addr 0x14f0940, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_OriginalString();

  /// @brief Method get_OriginalStringSwitched, addr 0x14f3318, size 0x48, virtual false, abstract: false, final false
  inline bool get_OriginalStringSwitched();

  /// @brief Method get_PathAndQuery, addr 0x14f23b8, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW get_PathAndQuery();

  /// @brief Method get_Port, addr 0x14f2fc4, size 0xcc, virtual false, abstract: false, final false
  inline int32_t get_Port();

  /// @brief Method get_PrivateAbsolutePath, addr 0x14f1828, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW get_PrivateAbsolutePath();

  /// @brief Method get_Query, addr 0x14f3090, size 0x108, virtual false, abstract: false, final false
  inline ::StringW get_Query();

  /// @brief Method get_Scheme, addr 0x14f32a0, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_Scheme();

  /// @brief Method get_SecuredPathIndex, addr 0x14ee1f4, size 0x5c, virtual false, abstract: false, final false
  inline uint16_t get_SecuredPathIndex();

  /// @brief Method get_Segments, addr 0x14f2488, size 0x210, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Segments();

  /// @brief Method get_Syntax, addr 0x14edf88, size 0x8, virtual false, abstract: false, final false
  inline ::System::UriParser* get_Syntax();

  /// @brief Method get_UserDrivenParsing, addr 0x14ee1d4, size 0xc, virtual false, abstract: false, final false
  inline bool get_UserDrivenParsing();

  /// @brief Method get_UserEscaped, addr 0x14f35e4, size 0xc, virtual false, abstract: false, final false
  inline bool get_UserEscaped();

  /// @brief Method get_UserInfo, addr 0x14f35f0, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW get_UserInfo();

  /// @brief Convert to "::System::Runtime::Serialization::ISerializable"
  constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

  /// @brief Method op_Equality, addr 0x14f3e48, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Uri* uri1, ::System::Uri* uri2);

  /// @brief Method op_Inequality, addr 0x14f0230, size 0x48, virtual false, abstract: false, final false
