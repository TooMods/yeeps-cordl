...
public:
  ...
  /// @brief Method CreateClass, addr 0x30290f8, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::StyleSelectorPart CreateClass(::StringW className);

  /// @brief Method CreateId, addr 0x3029110, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::StyleSelectorPart CreateId(::StringW Id);

  /// @brief Method CreatePredicate, addr 0x3029128, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::StyleSelectorPart CreatePredicate(::System::Object* predicate);

  /// @brief Method ToString, addr 0x3028fe8, size 0x110, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_type, addr 0x3028fd8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSelectorType get_type();

  /// @brief Method get_value, addr 0x3028fd0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_value();

  /// @brief Method set_type, addr 0x3028fe0, size 0x8, virtual false, abstract: false, final false
