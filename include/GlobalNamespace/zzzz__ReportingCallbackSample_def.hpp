...
public:
  ...
  /// @brief Method OnReportButtonIntentNotif, addr 0x198ec7c, size 0xa0, virtual false, abstract: false, final false
  inline void OnReportButtonIntentNotif(::Oculus::Platform::Message_1<::StringW>* message);

  /// @brief Method Start, addr 0x198ead8, size 0xf8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateConsole, addr 0x198ebd0, size 0xac, virtual false, abstract: false, final false
  inline void UpdateConsole(::StringW value);

  /// @brief Method <Start>b__2_0, addr 0x198ee70, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x198ee68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
