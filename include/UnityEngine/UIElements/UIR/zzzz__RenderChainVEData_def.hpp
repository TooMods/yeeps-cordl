...
public:
  ...
  /// @brief Method AllocatesID, addr 0x127497c, size 0x34, virtual false, abstract: false, final false
  static inline bool AllocatesID(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method InheritsID, addr 0x12749b0, size 0x30, virtual false, abstract: false, final false
  static inline bool InheritsID(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method get_lastClosingOrLastCommand, addr 0x1274964, size 0x18, virtual false, abstract: false, final false
