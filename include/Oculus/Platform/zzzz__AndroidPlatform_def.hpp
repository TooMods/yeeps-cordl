...
public:
  // Declarations
  /// @brief Method AsyncInitialize, addr 0x199026c, size 0x108, virtual false, abstract: false, final false
  inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW appId);

  /// @brief Method Initialize, addr 0x1990124, size 0xb0, virtual false, abstract: false, final false
  inline bool Initialize(::StringW appId);

  static inline ::Oculus::Platform::AndroidPlatform* New_ctor();

  /// @brief Method .ctor, addr 0x1990408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
