...
public:
  ...
  /// @brief Method .ctor, addr 0x28a7954, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(bool ownsHandle);

  /// @brief Method get_IsInvalid, addr 0x28a7a78, size 0x5c, virtual true, abstract: false, final false
