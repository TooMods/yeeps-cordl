...
public:
  ...
  /// @brief Method Destroy, addr 0x27fe37c, size 0xa0, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Finalize, addr 0x27fe2dc, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method InternalCreate, addr 0x27fe288, size 0x28, virtual false, abstract: false, final false
  static inline void* InternalCreate();

  /// @brief Method InternalDestroy, addr 0x27fe9d8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x27fea8c, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect Remove(::UnityEngine::Rect rect);

  /// @brief Method Remove_Injected, addr 0x27feaf0, size 0x54, virtual false, abstract: false, final false
  inline void Remove_Injected(ByRef<::UnityEngine::Rect> rect, ByRef<::UnityEngine::Rect> ret);

  /// @brief Method ToString, addr 0x27fe640, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x27fe64c, size 0x29c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27fe240, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27fe41c, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(int32_t left, int32_t right, int32_t top, int32_t bottom);

  /// @brief Method .ctor, addr 0x27fe2b0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* sourceStyle, void* source);

  /// @brief Method get_bottom, addr 0x27fe99c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_bottom();

  /// @brief Method get_horizontal, addr 0x27fea14, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_horizontal();

  /// @brief Method get_left, addr 0x27fe8e8, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_left();

  /// @brief Method get_right, addr 0x27fe924, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_right();

  /// @brief Method get_top, addr 0x27fe960, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_top();

  /// @brief Method get_vertical, addr 0x27fea50, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_vertical();

  /// @brief Convert to "::System::IFormattable"
  constexpr ::System::IFormattable* i___System__IFormattable() noexcept;

  /// @brief Method set_bottom, addr 0x27fe5fc, size 0x44, virtual false, abstract: false, final false
  inline void set_bottom(int32_t value);

  /// @brief Method set_left, addr 0x27fe530, size 0x44, virtual false, abstract: false, final false
  inline void set_left(int32_t value);

  /// @brief Method set_right, addr 0x27fe574, size 0x44, virtual false, abstract: false, final false
  inline void set_right(int32_t value);

  /// @brief Method set_top, addr 0x27fe5b8, size 0x44, virtual false, abstract: false, final false
