...
public:
  // Declarations
  /// @brief Method AdjustSpriteUVsForScaleMode, addr 0x3039da4, size 0x75c, virtual false, abstract: false, final false
  ...
  /// @brief Method AdjustUVsForScaleMode, addr 0x3039a80, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyPackingRotation, addr 0x303a7d0, size 0x12c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ApplyPackingRotation(::UnityEngine::Rect uv, ::UnityEngine::SpritePackingRotation rotation);

  /// @brief Method ComputeGeomRect, addr 0x303a620, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeGeomRect(::UnityEngine::Sprite* sprite);

  /// @brief Method ComputeUVRect, addr 0x303a6f8, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeUVRect(::UnityEngine::Sprite* sprite);

  /// @brief Method HasRadius, addr 0x303b364, size 0x1074, virtual false, abstract: false, final false
  inline bool HasRadius(float_t epsilon);

  /// @brief Method MakeSprite, addr 0x303aa68, size 0x7e0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams MakeSprite(::UnityEngine::Rect containerRect, ::UnityEngine::Rect subRect, ::UnityEngine::Sprite* sprite,
                                                                                                    ...
                                                                                                    bool hasRadius, ByRef<::UnityEngine::Vector4> slices);

  /// @brief Method MakeTextured, addr 0x303a8fc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeVectorTextured, addr 0x303b248, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method RectIntersection, addr 0x303a500, size 0x120, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x1284a6c, size 0x2a0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTextNativeSettings, addr 0x12850b4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeStyleBased, addr 0x1284d0c, size 0x3a8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AdjustBackgroundSizeForBorders, addr 0x303962c, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertBorderRadiusPercentToPoints, addr 0x3039354, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVisualElementRadii, addr 0x3039390, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rectangle, addr 0x3039120, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Text, addr 0x3039220, size 0x134, virtual false, abstract: false, final false
