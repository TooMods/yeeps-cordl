...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce36e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Schema, addr 0x1ce3854, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_Schema();

  /// @brief Method get_SchemaInfo, addr 0x1ce3844, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_SchemaInfo();

  /// @brief Method set_NamespaceURI, addr 0x1ce383c, size 0x8, virtual false, abstract: false, final false
  inline void set_NamespaceURI(::StringW value);

  /// @brief Method set_Schema, addr 0x1ce385c, size 0x8, virtual false, abstract: false, final false
  inline void set_Schema(::System::Xml::Schema::XmlSchema* value);

  /// @brief Method set_SchemaInfo, addr 0x1ce384c, size 0x8, virtual false, abstract: false, final false
