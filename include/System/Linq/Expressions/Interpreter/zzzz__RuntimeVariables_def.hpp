...
public:
  ...
  /// @brief Method Create, addr 0x1b5348c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b5e3fc, size 0x28, virtual false, abstract: false, final false
