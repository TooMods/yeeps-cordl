...
public:
  ...
  __declspec(property(get = get_DesignTimeOnly)) bool DesignTimeOnly;
  ...
  /// @brief Method CheckAttributesValid, addr 0x1b1661c, size 0xb0, virtual false, abstract: false, final false
  inline void CheckAttributesValid();

  /// @brief Method CreateAttributeCollection, addr 0x1b17578, size 0x7c, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* CreateAttributeCollection();

  /// @brief Method Equals, addr 0x1b175f4, size 0x264, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method FillAttributes, addr 0x1b06004, size 0xf4, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributeList);

  /// @brief Method FilterAttributesIfNeeded, addr 0x1b166cc, size 0x74c, virtual false, abstract: false, final false
  inline void FilterAttributesIfNeeded();

  /// @brief Method FindMethod, addr 0x1b0beb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMethod, addr 0x1b17858, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* FindMethod(::System::Type* componentClass, ::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> args, ::System::Type* returnType,
                                                             bool publicOnly);

  /// @brief Method GetHashCode, addr 0x1b178fc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetInvocationTarget, addr 0x1b066c8, size 0x114, virtual true, abstract: false, final false
  inline ::System::Object* GetInvocationTarget(::System::Type* type, ::System::Object* instance);

  /// @brief Method GetInvokee, addr 0x1b17904, size 0x114, virtual false, abstract: false, final false
  static inline ::System::Object* GetInvokee(::System::Type* componentClass, ::System::Object* component);

  /// @brief Method GetSite, addr 0x1b0b270, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::ComponentModel::ISite* GetSite(::System::Object* component);

  static inline ::System::ComponentModel::MemberDescriptor* New_ctor(::System::ComponentModel::MemberDescriptor* descr);

  static inline ::System::ComponentModel::MemberDescriptor* New_ctor(::StringW name);
  ...
  /// @brief Method .ctor, addr 0x1b04f20, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::MemberDescriptor* descr);

  /// @brief Method .ctor, addr 0x1b165f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x1b04d78, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> attributes);

  /// @brief Method .ctor, addr 0x1b05040, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeArray, addr 0x1b165fc, size 0x20, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> get_AttributeArray();

  /// @brief Method get_Attributes, addr 0x1b16edc, size 0xec, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* get_Attributes();

  /// @brief Method get_Category, addr 0x1b16fc8, size 0x130, virtual true, abstract: false, final false
  inline ::StringW get_Category();

  /// @brief Method get_Description, addr 0x1b170f8, size 0x12c, virtual true, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_DesignTimeOnly, addr 0x1b1735c, size 0xf4, virtual true, abstract: false, final false
  inline bool get_DesignTimeOnly();

  /// @brief Method get_DisplayName, addr 0x1b17450, size 0x128, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_IsBrowsable, addr 0x1b17224, size 0xe0, virtual true, abstract: false, final false
  inline bool get_IsBrowsable();

  /// @brief Method get_Name, addr 0x1b17304, size 0x50, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameHashCode, addr 0x1b17354, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_NameHashCode();

  /// @brief Method set_AttributeArray, addr 0x1b16e18, size 0xc4, virtual true, abstract: false, final false
