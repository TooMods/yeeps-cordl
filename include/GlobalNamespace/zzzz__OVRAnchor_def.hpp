...
public:
  ...
  /// @brief Method CreateSpatialAnchorAsync, addr 0x25b2a60, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchorAsync, addr 0x25b2bb8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x25b3074, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Equals, addr 0x25b2f04, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x25b2e9c, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRAnchor other);

  /// @brief Method FetchAnchors, addr 0x25b2424, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchAnchorsAsync, addr 0x25b2348, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchAnchorsAsync, addr 0x25b25f4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x25b2ff8, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetQueryInfo, addr 0x25b2250, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQueryInfo, addr 0x25b22cc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpaceQueryCompleteData, addr 0x25b2740, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x25b304c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b2a54, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint64_t handle, ::System::Guid uuid);

  static inline ::GlobalNamespace::OVRAnchor getStaticF_Null();

  /// @brief Method get_Handle, addr 0x25b2e88, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_Uuid, addr 0x25b2e90, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x25b2f94, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRAnchor lhs, ::GlobalNamespace::OVRAnchor rhs);

  /// @brief Method op_Inequality, addr 0x25b2fc4, size 0x34, virtual false, abstract: false, final false
