...
public:
  ...
  /// @brief Method HasLineInfo, addr 0xfa73e8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa73b8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method get_LineNumber, addr 0xfa7488, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0xfa752c, size 0xa4, virtual true, abstract: false, final false
