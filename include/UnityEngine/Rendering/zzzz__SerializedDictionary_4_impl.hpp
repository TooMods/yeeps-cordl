...
template <typename K, typename V, typename SK, typename SV>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<SK>*> const& UnityEngine::Rendering::SerializedDictionary_4<K, V, SK, SV>::__cordl_internal_get_m_Keys() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Keys;
}
template <typename K, typename V, typename SK, typename SV>
...
template <typename K, typename V, typename SK, typename SV>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<SV>*> const& UnityEngine::Rendering::SerializedDictionary_4<K, V, SK, SV>::__cordl_internal_get_m_Values() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Values;
}
template <typename K, typename V, typename SK, typename SV>
