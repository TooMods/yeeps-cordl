...
public:
  ...
  /// @brief Method GetEntityAsync, addr 0x1252da0, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveUri, addr 0x1252a80, size 0x1d8, virtual true, abstract: false, final false
  inline ::System::Uri* ResolveUri(::System::Uri* baseUri, ::StringW relativeUri);

  /// @brief Method SupportsType, addr 0x1252c58, size 0x148, virtual true, abstract: false, final false
  inline bool SupportsType(::System::Uri* absoluteUri, ::System::Type* type);

  /// @brief Method .ctor, addr 0x1252de0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
