...
public:
  ...
  /// @brief Method <GetStaticNullForUdtType>b__0, addr 0x225bd10, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225a930, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Aggregate, addr 0x225aa3c, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* Aggregate(::ArrayW<int32_t, ::Array<int32_t>*> records, ::System::Data::AggregateType kind);

  /// @brief Method Compare, addr 0x225aa6c, size 0x38, virtual true, abstract: false, final false
  inline int32_t Compare(int32_t recordNo1, int32_t recordNo2);

  /// @brief Method CompareValueTo, addr 0x225aaa4, size 0x28c, virtual true, abstract: false, final false
  inline int32_t CompareValueTo(int32_t recordNo1, ::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x225b5ec, size 0x328, virtual true, abstract: false, final false
  inline ::StringW ConvertObjectToXml(::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x225b914, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertXmlToObject, addr 0x225b008, size 0x348, virtual true, abstract: false, final false
  inline ::System::Object* ConvertXmlToObject(::StringW s);

  /// @brief Method ConvertXmlToObject, addr 0x225b350, size 0x29c, virtual true, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x225ad30, size 0x84, virtual true, abstract: false, final false
  inline void Copy(int32_t recordNo1, int32_t recordNo2);

  /// @brief Method CopyValue, addr 0x225bab4, size 0x138, virtual true, abstract: false, final false
  inline void CopyValue(int32_t record, ::System::Object* store, ::System::Collections::BitArray* nullbits, int32_t storeIndex);

  /// @brief Method Get, addr 0x225adb4, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* Get(int32_t recordNo);

  /// @brief Method GetEmptyStorage, addr 0x225ba6c, size 0x48, virtual true, abstract: false, final false
  inline ::System::Object* GetEmptyStorage(int32_t recordCount);

  /// @brief Method GetStaticNullForUdtType, addr 0x225a69c, size 0x10c, virtual false, abstract: false, final false
  static inline ::System::Object* GetStaticNullForUdtType(::System::Type* type);

  /// @brief Method IsNull, addr 0x225a938, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x225ade4, size 0x160, virtual true, abstract: false, final false
  inline void Set(int32_t recordNo, ::System::Object* value);

  /// @brief Method SetCapacity, addr 0x225af44, size 0xc4, virtual true, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetStorage, addr 0x225bbec, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225a624, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataColumn* column, ::System::Type* type);

  /// @brief Method .ctor, addr 0x225a7a8, size 0x188, virtual false, abstract: false, final false
