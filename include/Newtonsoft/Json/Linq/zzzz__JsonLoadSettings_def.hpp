...
public:
  ...
  /// @brief Method .ctor, addr 0x1346314, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CommentHandling, addr 0x134633c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::CommentHandling get_CommentHandling();

  /// @brief Method get_DuplicatePropertyNameHandling, addr 0x1346414, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling get_DuplicatePropertyNameHandling();

  /// @brief Method get_LineInfoHandling, addr 0x13463a8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::LineInfoHandling get_LineInfoHandling();

  /// @brief Method set_CommentHandling, addr 0x1346344, size 0x64, virtual false, abstract: false, final false
  inline void set_CommentHandling(::Newtonsoft::Json::Linq::CommentHandling value);

  /// @brief Method set_DuplicatePropertyNameHandling, addr 0x134641c, size 0x64, virtual false, abstract: false, final false
  inline void set_DuplicatePropertyNameHandling(::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling value);

  /// @brief Method set_LineInfoHandling, addr 0x13463b0, size 0x64, virtual false, abstract: false, final false
