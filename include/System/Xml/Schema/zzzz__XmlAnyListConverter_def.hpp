...
public:
  ...
  /// @brief Method ChangeType, addr 0x1924404, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1924390, size 0x4, virtual false, abstract: false, final false
