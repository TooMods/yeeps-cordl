...
public:
  ...
  /// @brief Method AddMember, addr 0x30464a4, size 0xc64, virtual false, abstract: false, final false
  inline void AddMember(::System::Xml::Serialization::XmlTypeMapMember* member);

  /// @brief Method BuildKey, addr 0x3047108, size 0xe0, virtual false, abstract: false, final false
  inline ::StringW BuildKey(::StringW name, ::StringW ns, int32_t explicitOrder);

  /// @brief Method GetAttribute, addr 0x3047288, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapMemberAttribute* GetAttribute(::StringW name, ::StringW ns);

  /// @brief Method GetElement, addr 0x304770c, size 0x3a4, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfo* GetElement(::StringW name, ::StringW ns);

  /// @brief Method GetElement, addr 0x3047344, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterFlatList, addr 0x30471e8, size 0xa0, virtual false, abstract: false, final false
  inline void RegisterFlatList(::System::Xml::Serialization::XmlTypeMapMemberExpandable* member);

  /// @brief Method SetCanBeSimpleType, addr 0x30480a8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3048120, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AllMembers, addr 0x3047ea8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_AllMembers();

  /// @brief Method get_AttributeMembers, addr 0x303eed4, size 0x414, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_AttributeMembers();

  /// @brief Method get_DefaultAnyAttributeMember, addr 0x3047e90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapMemberAnyAttribute* get_DefaultAnyAttributeMember();

  /// @brief Method get_DefaultAnyElementMember, addr 0x3047e88, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapMemberAnyElement* get_DefaultAnyElementMember();

  /// @brief Method get_ElementMembers, addr 0x3047ea0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_ElementMembers();

  /// @brief Method get_FlatLists, addr 0x3047eb0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_FlatLists();

  /// @brief Method get_HasSimpleContent, addr 0x30480b4, size 0x6c, virtual false, abstract: false, final false
  inline bool get_HasSimpleContent();

  /// @brief Method get_IsOrderDependentMap, addr 0x3047ab0, size 0x3d8, virtual false, abstract: false, final false
  inline bool get_IsOrderDependentMap();

  /// @brief Method get_ListMembers, addr 0x3047eb8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_ListMembers();

  /// @brief Method get_NamespaceDeclarations, addr 0x3047e98, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapMemberNamespaces* get_NamespaceDeclarations();

  /// @brief Method get_ReturnMember, addr 0x3047ec8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapMember* get_ReturnMember();

  /// @brief Method get_SimpleContentBaseType, addr 0x3047ed0, size 0x1d8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_SimpleContentBaseType();

  /// @brief Method get_XmlTextCollector, addr 0x3047ec0, size 0x8, virtual false, abstract: false, final false
