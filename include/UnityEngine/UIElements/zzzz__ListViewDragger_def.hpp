...
public:
  ...
  /// @brief Method Equals, addr 0x27dbe9c, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x27db2cc, size 0x58, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::__ListViewDragger__DragPosition other);

  /// @brief Method GetHashCode, addr 0x27dbf38, size 0x48, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyDragAndDropUI, addr 0x27da780, size 0x5e0, virtual false, abstract: false, final false
  inline void ApplyDragAndDropUI(::UnityEngine::UIElements::__ListViewDragger__DragPosition dragPosition);

  /// @brief Method CanStartDrag, addr 0x27d9e20, size 0x23c, virtual true, abstract: false, final false
  inline bool CanStartDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method ClearDragAndDropUI, addr 0x27db984, size 0x410, virtual true, abstract: false, final false
  inline void ClearDragAndDropUI();

  /// @brief Method GetRecycledItem, addr 0x27da05c, size 0x398, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ReusableCollectionItem* GetRecycledItem(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method GetVisualMode, addr 0x27da61c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleDragAndScroll, addr 0x27dad60, size 0x23c, virtual false, abstract: false, final false
  inline void HandleDragAndScroll(::UnityEngine::Vector2 pointerPosition);

  /// @brief Method MakeDragAndDropArgs, addr 0x27daf9c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDrop, addr 0x27db0ec, size 0x1e0, virtual true, abstract: false, final false
  inline void OnDrop(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method PlaceHoverBarAt, addr 0x27db324, size 0x184, virtual false, abstract: false, final false
  inline void PlaceHoverBarAt(float_t top);

  /// @brief Method PlaceHoverBarAtElement, addr 0x27db4a8, size 0xbc, virtual false, abstract: false, final false
  inline void PlaceHoverBarAtElement(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method StartDrag, addr 0x27da3f4, size 0x1bc, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::StartDragArgs* StartDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method TryGetDragPosition, addr 0x27db564, size 0x340, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateDrag, addr 0x27da5b0, size 0x6c, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::DragVisualMode UpdateDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method <ApplyDragAndDropUI>b__22_0, addr 0x27dbd94, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27d9ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView* listView);

  /// @brief Method get_dragAndDropController, addr 0x27d9cd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ICollectionDragAndDropController* get_dragAndDropController();

  /// @brief Method get_targetListView, addr 0x27d9c38, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_targetListView();

  /// @brief Method get_targetScrollView, addr 0x27d9cb4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ScrollView* get_targetScrollView();

  /// @brief Method set_dragAndDropController, addr 0x27d9cd8, size 0x8, virtual false, abstract: false, final false
