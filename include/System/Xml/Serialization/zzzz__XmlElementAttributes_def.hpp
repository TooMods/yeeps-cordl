...
public:
  ...
  /// @brief Method Add, addr 0x129bccc, size 0xb8, virtual false, abstract: false, final false
  inline int32_t Add(::System::Xml::Serialization::XmlElementAttribute* attribute);

  /// @brief Method AddKeyHash, addr 0x129bdec, size 0xcc, virtual false, abstract: false, final false
  inline void AddKeyHash(::System::Text::StringBuilder* sb);

  static inline ::System::Xml::Serialization::XmlElementAttributes* New_ctor();

  /// @brief Method .ctor, addr 0x129b68c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x129e850, size 0x100, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlElementAttribute* get_Item(int32_t index);

  /// @brief Method get_Order, addr 0x129cde8, size 0x2e0, virtual false, abstract: false, final false
