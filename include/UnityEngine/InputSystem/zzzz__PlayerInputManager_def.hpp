...
public:
  ...
  /// @brief Method .ctor, addr 0x1d364cc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x1d3657c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckIfPlayerCanJoin, addr 0x1d36940, size 0x2d8, virtual false, abstract: false, final false
  inline bool CheckIfPlayerCanJoin(int32_t playerIndex);

  /// @brief Method DisableJoining, addr 0x1d360d4, size 0xd8, virtual false, abstract: false, final false
  inline void DisableJoining();

  /// @brief Method EnableJoining, addr 0x1d361ac, size 0x1f0, virtual false, abstract: false, final false
  inline void EnableJoining();

  /// @brief Method IsDeviceUsableWithPlayerActions, addr 0x1d37064, size 0x37c, virtual false, abstract: false, final false
  inline bool IsDeviceUsableWithPlayerActions(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method JoinPlayer, addr 0x1d36c6c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method JoinPlayer, addr 0x1d36e10, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method JoinPlayerFromAction, addr 0x1d36c18, size 0x54, virtual false, abstract: false, final false
  inline void JoinPlayerFromAction(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method JoinPlayerFromActionIfNotAlreadyJoined, addr 0x1d36d28, size 0xe8, virtual false, abstract: false, final false
  inline void JoinPlayerFromActionIfNotAlreadyJoined(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method JoinPlayerFromUI, addr 0x1d368ec, size 0x54, virtual false, abstract: false, final false
  inline void JoinPlayerFromUI();

  static inline ::UnityEngine::InputSystem::PlayerInputManager* New_ctor();

  /// @brief Method NotifyPlayerJoined, addr 0x1d33c5c, size 0x128, virtual false, abstract: false, final false
  inline void NotifyPlayerJoined(::UnityEngine::InputSystem::PlayerInput* player);

  /// @brief Method NotifyPlayerLeft, addr 0x1d34614, size 0x128, virtual false, abstract: false, final false
  inline void NotifyPlayerLeft(::UnityEngine::InputSystem::PlayerInput* player);

  /// @brief Method OnDisable, addr 0x1d37720, size 0xdc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x1d373e0, size 0x340, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnUnpairedDeviceUsed, addr 0x1d36fb0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateSplitScreen, addr 0x1d359b8, size 0x640, virtual false, abstract: false, final false
  inline void UpdateSplitScreen();

  /// @brief Method ValidateInputActionAsset, addr 0x1d368e8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d377fc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onPlayerJoined, addr 0x1d365c4, size 0xa0, virtual false, abstract: false, final false
  inline void add_onPlayerJoined(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method add_onPlayerLeft, addr 0x1d36704, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_fixedNumberOfSplitScreens, addr 0x1d36000, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_fixedNumberOfSplitScreens();

  /// @brief Method get_instance, addr 0x1d36854, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInputManager> get_instance();

  /// @brief Method get_joinAction, addr 0x1d3639c, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_joinAction();

  /// @brief Method get_joinBehavior, addr 0x1d3607c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerJoinBehavior get_joinBehavior();

  /// @brief Method get_joiningEnabled, addr 0x1d36074, size 0x8, virtual false, abstract: false, final false
  inline bool get_joiningEnabled();

  /// @brief Method get_maintainAspectRatioInSplitScreen, addr 0x1d35ff8, size 0x8, virtual false, abstract: false, final false
  inline bool get_maintainAspectRatioInSplitScreen();

  /// @brief Method get_maxPlayerCount, addr 0x1d3606c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxPlayerCount();

  /// @brief Method get_messages, addr 0x1d36ecc, size 0xe4, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> get_messages();

  /// @brief Method get_notificationBehavior, addr 0x1d36454, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior();

  /// @brief Method get_playerCount, addr 0x1d36014, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_playerCount();

  /// @brief Method get_playerJoinedEvent, addr 0x1d36464, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__PlayerInputManager__PlayerJoinedEvent* get_playerJoinedEvent();

  /// @brief Method get_playerLeftEvent, addr 0x1d36514, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__PlayerInputManager__PlayerLeftEvent* get_playerLeftEvent();

  /// @brief Method get_playerPrefab, addr 0x1d36844, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_playerPrefab();

  /// @brief Method get_splitScreen, addr 0x1d35750, size 0x8, virtual false, abstract: false, final false
  inline bool get_splitScreen();

  /// @brief Method get_splitScreenArea, addr 0x1d36008, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_splitScreenArea();

  /// @brief Method remove_onPlayerJoined, addr 0x1d36664, size 0xa0, virtual false, abstract: false, final false
  inline void remove_onPlayerJoined(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method remove_onPlayerLeft, addr 0x1d367a4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_instance, addr 0x1d3689c, size 0x4c, virtual false, abstract: false, final false
  static inline void set_instance(::UnityEngine::InputSystem::PlayerInputManager* value);

  /// @brief Method set_joinAction, addr 0x1d363b0, size 0xa4, virtual false, abstract: false, final false
  inline void set_joinAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_joinBehavior, addr 0x1d36084, size 0x50, virtual false, abstract: false, final false
  inline void set_joinBehavior(::UnityEngine::InputSystem::PlayerJoinBehavior value);

  /// @brief Method set_notificationBehavior, addr 0x1d3645c, size 0x8, virtual false, abstract: false, final false
  inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications value);

  /// @brief Method set_playerPrefab, addr 0x1d3684c, size 0x8, virtual false, abstract: false, final false
  inline void set_playerPrefab(::UnityEngine::GameObject* value);

  /// @brief Method set_splitScreen, addr 0x1d35758, size 0x260, virtual false, abstract: false, final false
