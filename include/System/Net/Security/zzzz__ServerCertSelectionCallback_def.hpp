...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2c9d67c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c9d5a8, size 0xd4, virtual false, abstract: false, final false
