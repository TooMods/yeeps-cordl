...
public:
  ...
  /// @brief Method Create, addr 0x2ded19c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x2ded6ac, size 0x48, virtual false, abstract: false, final false
