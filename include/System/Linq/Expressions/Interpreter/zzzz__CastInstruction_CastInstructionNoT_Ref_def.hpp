...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x1b61eac, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b61d2c, size 0x28, virtual false, abstract: false, final false
