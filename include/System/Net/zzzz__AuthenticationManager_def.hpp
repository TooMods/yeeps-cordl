...
public:
  ...
  /// @brief Method Authenticate, addr 0x1031f4c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAuthenticate, addr 0x1032058, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureModules, addr 0x1031c34, size 0x29c, virtual false, abstract: false, final false
  static inline void EnsureModules();

  /// @brief Method PreAuthenticate, addr 0x1032540, size 0x538, virtual false, abstract: false, final false
