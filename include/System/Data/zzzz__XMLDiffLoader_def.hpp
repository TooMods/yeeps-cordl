...
public:
  ...
  /// @brief Method CreateTablesHierarchy, addr 0x1ca9314, size 0x384, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method GetTable, addr 0x1caaf4c, size 0x1cc, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTable(::StringW tableName, ::StringW ns);

  /// @brief Method LoadDiffGram, addr 0x1ca8af4, size 0x1a4, virtual false, abstract: false, final false
  inline void LoadDiffGram(::System::Data::DataSet* ds, ::System::Xml::XmlReader* dataTextReader);

  /// @brief Method LoadDiffGram, addr 0x1ca9698, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessDiffs, addr 0x1ca8c98, size 0x2dc, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessDiffs, addr 0x1ca9890, size 0x2d0, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Collections::ArrayList* tableList, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x1ca8f74, size 0x3a0, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x1ca9b60, size 0x4b0, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Collections::ArrayList* dt, ::System::Xml::XmlReader* ssync);

  /// @brief Method ReadOldRowData, addr 0x1caa070, size 0xedc, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipWhitespaces, addr 0x1caa010, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cab118, size 0x1008, virtual false, abstract: false, final false
  inline void _ctor();
