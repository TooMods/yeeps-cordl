...
public:
  ...
  /// @brief Method HashCore, addr 0x1c87854, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x1c879d4, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x1c87810, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x1c8778c, size 0x84, virtual false, abstract: false, final false
  inline void InitializeState();

  static inline ::System::Security::Cryptography::SHA1Managed* New_ctor();

  /// @brief Method SHAExpand, addr 0x1c8811c, size 0x3c, virtual false, abstract: false, final false
  static inline void SHAExpand(::cordl_internals::Ptr<uint32_t> x);

  /// @brief Method SHATransform, addr 0x1c87ba4, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method _EndHash, addr 0x1c879d8, size 0x1cc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method _HashData, addr 0x1c87858, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c876bc, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
