...
public:
  ...
  /// @brief Method Bind, addr 0x1b65b10, size 0x5fc, virtual true, abstract: false, final true
  ...
  /// @brief Method CreateArgumentMetaObjects, addr 0x1b6610c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUpdateExpression, addr 0x1b66298, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b65a4c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsStandardBinder, addr 0x1b66358, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsStandardBinder();

  /// @brief Method get_ReturnType, addr 0x1b65aa4, size 0x6c, virtual true, abstract: false, final false
