...
public:
  ...
  /// @brief Method SetUnhandledAttributes, addr 0x1ce196c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce1974, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Id, addr 0x1ce1944, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_IdAttribute, addr 0x1ce195c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IdAttribute();

  /// @brief Method get_Items, addr 0x1ce1954, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items();

  /// @brief Method set_Id, addr 0x1ce194c, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);

  /// @brief Method set_IdAttribute, addr 0x1ce1964, size 0x8, virtual true, abstract: false, final false
