...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2b0beb4, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0bd14, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b0bddc, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2b0bd70, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW paramName);

  /// @brief Method .ctor, addr 0x2b08850, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW paramName, ::System::Object* actualValue, ::StringW message);

  /// @brief Method .ctor, addr 0x2b07620, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW paramName, ::StringW message);

  /// @brief Method get_Message, addr 0x2b0bf8c, size 0xac, virtual true, abstract: false, final false
