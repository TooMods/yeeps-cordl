...
public:
  ...
  /// @brief Method Clone, addr 0x2b1262c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method Dispose, addr 0x2b12688, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x2b12634, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x2b127a8, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2b126a0, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2b127b8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b125fc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Current, addr 0x2b12704, size 0xa4, virtual true, abstract: false, final true
