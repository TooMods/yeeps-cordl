...
public:
  ...
  /// @brief Method Destroy, addr 0x27c85d0, size 0x74, virtual true, abstract: false, final true
  inline void Destroy();
  ...
  /// @brief Method .ctor, addr 0x27c8644, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
