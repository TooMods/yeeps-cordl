...
public:
  ...
  /// @brief Method CheckAuthorization, addr 0x103b0f0, size 0x318, virtual false, abstract: false, final false
  inline bool CheckAuthorization(::System::Net::WebResponse* response, ::System::Net::HttpStatusCode code);

  /// @brief Method Reset, addr 0x103ba80, size 0x84, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x103bc58, size 0x100, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1037344, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpWebRequest* request, bool isProxy);

  /// @brief Method get_IsCompleted, addr 0x103bc28, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method get_IsNtlmAuthenticated, addr 0x103bc38, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsNtlmAuthenticated();

  /// @brief Method get_NtlmAuthState, addr 0x103bc30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x103bd58, size 0xdf0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x103cb94, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x103cbec, size 0x770, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x103d648, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x103d6a0, size 0x418, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x103dab8, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Abort, addr 0x1039b48, size 0x110, virtual true, abstract: false, final false
  inline void Abort();

  /// @brief Method BeginGetRequestStream, addr 0x1039020, size 0xb8, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetRequestStream(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method BeginGetResponse, addr 0x103979c, size 0x17c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method CheckAuthorization, addr 0x103b0d8, size 0x18, virtual false, abstract: false, final false
  inline bool CheckAuthorization(::System::Net::WebResponse* response, ::System::Net::HttpStatusCode code);

  /// @brief Method CheckFinalStatus, addr 0x103b600, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckRequestStarted, addr 0x10373b0, size 0x60, virtual false, abstract: false, final false
  inline void CheckRequestStarted();

  /// @brief Method CreateRequestAbortedException, addr 0x1038f5c, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Net::WebException* CreateRequestAbortedException();

  /// @brief Method DoContinueDelegate, addr 0x1039cd8, size 0x1c, virtual false, abstract: false, final false
  inline void DoContinueDelegate(int32_t statusCode, ::System::Net::WebHeaderCollection* headers);

  /// @brief Method DoPreAuthenticate, addr 0x103a934, size 0x1fc, virtual false, abstract: false, final false
  inline void DoPreAuthenticate();

  /// @brief Method EndGetRequestStream, addr 0x10390d8, size 0x124, virtual true, abstract: false, final false
  inline ::System::IO::Stream* EndGetRequestStream(::System::IAsyncResult* asyncResult);

  /// @brief Method EndGetResponse, addr 0x1039918, size 0x124, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult* asyncResult);

  /// @brief Method FlattenException, addr 0x103952c, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::Exception* FlattenException(::System::Exception* e);

  /// @brief Method GetHeaders, addr 0x103a24c, size 0x64c, virtual false, abstract: false, final false
  inline ::StringW GetHeaders();

  /// @brief Method GetObjectData, addr 0x1039c98, size 0x40, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetRequestHeaders, addr 0x103ab30, size 0x318, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRequestHeaders();

  /// @brief Method GetRequestStreamAsync, addr 0x1039280, size 0x98, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* GetRequestStreamAsync();

  /// @brief Method GetResponse, addr 0x1039a3c, size 0x100, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* GetResponse();

  /// @brief Method GetResponseFromData, addr 0x1039424, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRewriteHandler, addr 0x103b408, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetServicePoint, addr 0x1037e9c, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* GetServicePoint();

  /// @brief Method GetWebException, addr 0x10391fc, size 0x84, virtual false, abstract: false, final false
  inline ::System::Net::WebException* GetWebException(::System::Exception* e);

  /// @brief Method GetWebException, addr 0x10395ec, size 0x1b0, virtual false, abstract: false, final false
  static inline ::System::Net::WebException* GetWebException(::System::Exception* e, bool aborted);

  /// @brief Method HandleNtlmAuth, addr 0x103ae48, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method MyGetRequestStreamAsync, addr 0x1038bbc, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method MyGetResponseAsync, addr 0x1039318, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Redirect, addr 0x1039d6c, size 0x4e0, virtual false, abstract: false, final false
  inline bool Redirect(::System::Net::HttpStatusCode code, ::System::Net::WebResponse* response);

  /// @brief Method ResetAuthorization, addr 0x10371fc, size 0x10, virtual false, abstract: false, final false
  inline void ResetAuthorization();

  /// @brief Method RewriteRedirectToGet, addr 0x1039cf4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method SendRequest, addr 0x1038808, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x1039c58, size 0x40, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method TryGetHostUri, addr 0x103794c, size 0xd0, virtual false, abstract: false, final false
  inline bool TryGetHostUri(::StringW hostName, ByRef<::System::Uri*> hostUri);

  /// @brief Method <GetRewriteHandler>b__271_0, addr 0x103bb04, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103bbf0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x103720c, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x1036fc8, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aborted, addr 0x1038f34, size 0x28, virtual false, abstract: false, final false
  inline bool get_Aborted();

  /// @brief Method get_Address, addr 0x103735c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_Address();

  /// @brief Method get_AllowWriteStreamBuffering, addr 0x1037370, size 0x8, virtual true, abstract: false, final false
  inline bool get_AllowWriteStreamBuffering();

  /// @brief Method get_AuthUri, addr 0x103815c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_AuthUri();

  /// @brief Method get_AutomaticDecompression, addr 0x1037384, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::DecompressionMethods get_AutomaticDecompression();

  /// @brief Method get_ClientCertificates, addr 0x1037530, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method get_ContentLength, addr 0x10375a4, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method get_Credentials, addr 0x1037660, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method get_DefaultMaximumErrorResponseLength, addr 0x1037670, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_DefaultMaximumErrorResponseLength();

  /// @brief Method get_DefaultMaximumResponseHeadersLength, addr 0x1037ab0, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_DefaultMaximumResponseHeadersLength();

  /// @brief Method get_ExpectContinue, addr 0x1038148, size 0x8, virtual false, abstract: false, final false
  inline bool get_ExpectContinue();

  /// @brief Method get_Headers, addr 0x10376c8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_Host, addr 0x10376d0, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_InternalAllowBuffering, addr 0x1037410, size 0x14, virtual false, abstract: false, final false
  inline bool get_InternalAllowBuffering();

  /// @brief Method get_KeepAlive, addr 0x1037a1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_KeepAlive();

  /// @brief Method get_Method, addr 0x1037b10, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method get_MethodWithBuffer, addr 0x1037424, size 0xfc, virtual false, abstract: false, final false
  inline bool get_MethodWithBuffer();

  /// @brief Method get_ProtocolVersion, addr 0x1037d50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_ProtocolVersion();

  /// @brief Method get_Proxy, addr 0x1037e68, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::IWebProxy* get_Proxy();

  /// @brief Method get_ProxyQuery, addr 0x1038164, size 0x34, virtual false, abstract: false, final false
  inline bool get_ProxyQuery();

  /// @brief Method get_ReadWriteTimeout, addr 0x1037b08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ReadWriteTimeout();

  /// @brief Method get_RequestUri, addr 0x1037fc8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_SendChunked, addr 0x1037fd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_SendChunked();

  /// @brief Method get_ServerCertValidationCallback, addr 0x1038198, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServerCertValidationCallback* get_ServerCertValidationCallback();

  /// @brief Method get_ServicePoint, addr 0x1037ffc, size 0x4, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method get_ServicePointNoLock, addr 0x1038000, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePointNoLock();

  /// @brief Method get_ThrowOnError, addr 0x1037644, size 0x8, virtual false, abstract: false, final false
  inline bool get_ThrowOnError();

  /// @brief Method get_Timeout, addr 0x1038008, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method get_TlsProvider, addr 0x1037520, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileTlsProvider* get_TlsProvider();

  /// @brief Method get_TlsSettings, addr 0x1037528, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* get_TlsSettings();

  /// @brief Method get_TransferEncoding, addr 0x1038074, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_TransferEncoding();

  /// @brief Method get_UnsafeAuthenticatedConnectionSharing, addr 0x1038140, size 0x8, virtual false, abstract: false, final false
  inline bool get_UnsafeAuthenticatedConnectionSharing();

  /// @brief Method get_UseDefaultCredentials, addr 0x10380c8, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method set_AllowAutoRedirect, addr 0x1037364, size 0xc, virtual true, abstract: false, final false
  inline void set_AllowAutoRedirect(bool value);

  /// @brief Method set_AllowWriteStreamBuffering, addr 0x1037378, size 0xc, virtual true, abstract: false, final false
  inline void set_AllowWriteStreamBuffering(bool value);

  /// @brief Method set_AutomaticDecompression, addr 0x103738c, size 0x24, virtual false, abstract: false, final false
  inline void set_AutomaticDecompression(::System::Net::DecompressionMethods value);

  /// @brief Method set_ConnectionGroupName, addr 0x103759c, size 0x8, virtual true, abstract: false, final false
  inline void set_ConnectionGroupName(::StringW value);

  /// @brief Method set_ContentLength, addr 0x10375ac, size 0x90, virtual true, abstract: false, final false
  inline void set_ContentLength(int64_t value);

  /// @brief Method set_CookieContainer, addr 0x1037658, size 0x8, virtual true, abstract: false, final false
  inline void set_CookieContainer(::System::Net::CookieContainer* value);

  /// @brief Method set_Credentials, addr 0x1037668, size 0x8, virtual true, abstract: false, final false
  inline void set_Credentials(::System::Net::ICredentials* value);

  /// @brief Method set_ExpectContinue, addr 0x1038150, size 0xc, virtual false, abstract: false, final false
  inline void set_ExpectContinue(bool value);

  /// @brief Method set_FinishedReading, addr 0x1039b3c, size 0xc, virtual false, abstract: false, final false
  inline void set_FinishedReading(bool value);

  /// @brief Method set_Host, addr 0x10377dc, size 0x170, virtual false, abstract: false, final false
  inline void set_Host(::StringW value);

  /// @brief Method set_InternalContentLength, addr 0x103763c, size 0x8, virtual false, abstract: false, final false
  inline void set_InternalContentLength(int64_t value);

  /// @brief Method set_KeepAlive, addr 0x1037a24, size 0xc, virtual false, abstract: false, final false
  inline void set_KeepAlive(bool value);

  /// @brief Method set_MaximumAutomaticRedirections, addr 0x1037a30, size 0x80, virtual false, abstract: false, final false
  inline void set_MaximumAutomaticRedirections(int32_t value);

  /// @brief Method set_Method, addr 0x1037b18, size 0x22c, virtual true, abstract: false, final false
  inline void set_Method(::StringW value);

  /// @brief Method set_PreAuthenticate, addr 0x1037d44, size 0xc, virtual true, abstract: false, final false
  inline void set_PreAuthenticate(bool value);

  /// @brief Method set_ProtocolVersion, addr 0x1037d58, size 0x110, virtual false, abstract: false, final false
  inline void set_ProtocolVersion(::System::Version* value);

  /// @brief Method set_Proxy, addr 0x1037e70, size 0x2c, virtual true, abstract: false, final false
  inline void set_Proxy(::System::Net::IWebProxy* value);

  /// @brief Method set_SendChunked, addr 0x1037fd8, size 0x24, virtual false, abstract: false, final false
  inline void set_SendChunked(bool value);

  /// @brief Method set_ThrowOnError, addr 0x103764c, size 0xc, virtual false, abstract: false, final false
  inline void set_ThrowOnError(bool value);

  /// @brief Method set_Timeout, addr 0x1038010, size 0x64, virtual true, abstract: false, final false
