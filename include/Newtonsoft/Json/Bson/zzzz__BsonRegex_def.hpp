...
public:
  ...
  /// @brief Method .ctor, addr 0x2f65044, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::StringW pattern, ::StringW options);

  /// @brief Method get_Options, addr 0x2f65034, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Options();

  /// @brief Method get_Pattern, addr 0x2f65024, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Pattern();

  /// @brief Method get_Type, addr 0x2f65100, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonType get_Type();

  /// @brief Method set_Options, addr 0x2f6503c, size 0x8, virtual false, abstract: false, final false
  inline void set_Options(::Newtonsoft::Json::Bson::BsonString* value);

  /// @brief Method set_Pattern, addr 0x2f6502c, size 0x8, virtual false, abstract: false, final false
