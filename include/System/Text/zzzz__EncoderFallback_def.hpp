...
public:
  ...
  /// @brief Method .ctor, addr 0x1e0f10c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x1e0ff10, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x1e0fe30, size 0x98, virtual false, abstract: false, final false
