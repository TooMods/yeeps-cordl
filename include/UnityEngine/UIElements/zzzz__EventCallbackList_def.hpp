...
public:
  ...
  /// @brief Method Add, addr 0x2ccaca4, size 0xdc, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::EventCallbackFunctorBase* item);

  /// @brief Method AddRange, addr 0x2cca788, size 0x190, virtual false, abstract: false, final false
  inline void AddRange(::UnityEngine::UIElements::EventCallbackList* list);

  /// @brief Method Clear, addr 0x2cca97c, size 0x6c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x2ccaa84, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(int64_t eventTypeId, ::System::Delegate* callback, ::UnityEngine::UIElements::CallbackPhase phase);

  /// @brief Method Find, addr 0x2ccaa9c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x2ccab84, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cca708, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2cca678, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::EventCallbackList* source);

  /// @brief Method get_Count, addr 0x2ccad80, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x2ccadc8, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventCallbackFunctorBase* get_Item(int32_t i);

  /// @brief Method get_bubbleUpCallbackCount, addr 0x2ccaa74, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bubbleUpCallbackCount();

  /// @brief Method get_trickleDownCallbackCount, addr 0x2ccaa64, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_trickleDownCallbackCount();

  /// @brief Method set_bubbleUpCallbackCount, addr 0x2ccaa7c, size 0x8, virtual false, abstract: false, final false
  inline void set_bubbleUpCallbackCount(int32_t value);

  /// @brief Method set_trickleDownCallbackCount, addr 0x2ccaa6c, size 0x8, virtual false, abstract: false, final false
