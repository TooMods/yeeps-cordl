...
public:
  // Declarations
  /// @brief Method get_DefaultCredentials, addr 0xf51b84, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Net::ICredentials* get_DefaultCredentials();

  /// @brief Method get_DefaultNetworkCredentials, addr 0xf51bdc, size 0x58, virtual false, abstract: false, final false
