...
#include <cstdint>
CORDL_MODULE_EXPORT(Vector3FallbackComposite)
...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::Vector3FallbackComposite);
// Type: UnityEngine.XR.Interaction.Toolkit.Inputs.Composites::Vector3FallbackComposite
// SizeInfo { instance_size: 32, native_size: -1, calculated_instance_size: 32, calculated_native_size: 28, minimum_alignment: 8, natural_alignment: 4, packing: None, specified_packing: None }
namespace UnityEngine::XR::Interaction::Toolkit::Inputs::Composites {
// Is value type: false
// CS Name: ::UnityEngine.XR.Interaction.Toolkit.Inputs.Composites::Vector3FallbackComposite*
class CORDL_TYPE Vector3FallbackComposite : public ::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::FallbackComposite_1<::UnityEngine::Vector3> {
public:
  // Declarations
  ...
  /// @brief Method Initialize, addr 0x2a2a1f0, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize();

  static inline ::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::Vector3FallbackComposite* New_ctor();

  /// @brief Method ReadValue, addr 0x2a2a138, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a2a25c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr Vector3FallbackComposite();

public:
  // Ctor Parameters [CppParam { name: "", ty: "Vector3FallbackComposite", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Vector3FallbackComposite(Vector3FallbackComposite&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Vector3FallbackComposite", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Vector3FallbackComposite(Vector3FallbackComposite const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::Vector3FallbackComposite, 0x20>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::Vector3FallbackComposite, ___first) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::Vector3FallbackComposite, ___second) == 0x14, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::XR::Interaction::Toolkit::Inputs::Composites::Vector3FallbackComposite, ___third) == 0x18, "Offset mismatch!");
