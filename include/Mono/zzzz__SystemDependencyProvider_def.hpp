...
public:
  ...
  /// @brief Method Initialize, addr 0x241f6ac, size 0x154, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method Mono.ISystemDependencyProvider.get_CertificateProvider, addr 0x241f898, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x241f800, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_CertificateProvider, addr 0x241f8a0, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::SystemCertificateProvider* get_CertificateProvider();

  /// @brief Method get_Instance, addr 0x241f650, size 0x5c, virtual false, abstract: false, final false
  static inline ::Mono::SystemDependencyProvider* get_Instance();

  /// @brief Method get_X509Pal, addr 0x241f8a8, size 0x18, virtual false, abstract: false, final false
