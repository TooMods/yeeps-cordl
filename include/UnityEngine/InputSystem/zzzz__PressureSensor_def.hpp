...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c72918, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c72840, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::PressureSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c72894, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c72990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::PressureSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_atmosphericPressure, addr 0x1c7279c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_atmosphericPressure();

  /// @brief Method get_current, addr 0x1c727ac, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atmosphericPressure, addr 0x1c727a4, size 0x8, virtual false, abstract: false, final false
  inline void set_atmosphericPressure(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_current, addr 0x1c727f4, size 0x4c, virtual false, abstract: false, final false
