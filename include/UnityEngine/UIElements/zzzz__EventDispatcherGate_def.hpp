...
public:
  ...
  /// @brief Method Dispose, addr 0x27d2874, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Equals, addr 0x27d2920, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x27d2914, size 0xc, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::EventDispatcherGate other);

  /// @brief Method GetHashCode, addr 0x27d299c, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x27d27f8, size 0x6c, virtual false, abstract: false, final false
