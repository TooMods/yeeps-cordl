...
public:
  // Declarations
  /// @brief Method ExpectAliased, addr 0x198b81c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpectNotAliased, addr 0x198b820, size 0x4, virtual false, abstract: false, final false
