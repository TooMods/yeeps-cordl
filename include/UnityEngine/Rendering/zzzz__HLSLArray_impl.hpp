...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::HLSLArray::*)(int32_t, ::System::Type*)>(
  ...
  constexpr static std::size_t addrs = 0x1a0485c;
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> const& UnityEngine::Rendering::HLSLArray::__cordl_internal_get_elementType() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___elementType;
}
