...
public:
  ...
  /// @brief Method CalcHeight, addr 0x2d0bf60, size 0x70, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x2d0bedc, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d0bd7c, size 0xdc, virtual false, abstract: false, final false
