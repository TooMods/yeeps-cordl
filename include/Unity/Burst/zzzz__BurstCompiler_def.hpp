...
public:
  ...
  /// @brief Method And, addr 0x2623e54, size 0x28, virtual false, abstract: false, final false
  inline ::Unity::Burst::__BurstCompiler__CommandBuilder* And(char16_t sep);

  /// @brief Method Begin, addr 0x26226d4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToCompiler, addr 0x2623bb0, size 0x74, virtual false, abstract: false, final false
  inline ::StringW SendToCompiler();

  /// @brief Method With, addr 0x2623b54, size 0x5c, virtual false, abstract: false, final false
  inline ::Unity::Burst::__BurstCompiler__CommandBuilder* With(::StringW arg);

  /// @brief Method With, addr 0x2623d8c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2622664, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2623e7c, size 0x28, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x26240e4, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x2624104, size 0x28, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x26240d0, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke();
  ...
  /// @brief Method .ctor, addr 0x2624014, size 0xbc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DiscardedMethod, addr 0x2623ef4, size 0x8, virtual false, abstract: false, final false
  static inline void DiscardedMethod(ByRef<bool> value);

  /// @brief Method IsBurstEnabled, addr 0x2623ea4, size 0x50, virtual false, abstract: false, final false
  static inline bool IsBurstEnabled();

  /// @brief Method IsCompiledByBurst, addr 0x2623efc, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26229b0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_Method, addr 0x262412c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Compile>b__22_0, addr 0x26241a0, size 0x6c, virtual false, abstract: false, final false
  inline bool _Compile_b__22_0(::System::Attribute* s);

  /// @brief Method <TriggerUnsafeStaticMethodRecompilation>b__29_0, addr 0x262420c, size 0x70, virtual false, abstract: false, final false
  inline bool _TriggerUnsafeStaticMethodRecompilation_b__29_0(::System::Attribute* x);

  /// @brief Method .ctor, addr 0x2624198, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AotCompilation, addr 0x2623a60, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginCompilerCommand, addr 0x2622590, size 0xd4, virtual false, abstract: false, final false
  static inline ::Unity::Burst::__BurstCompiler__CommandBuilder* BeginCompilerCommand(::StringW cmd);

  /// @brief Method Cancel, addr 0x26231c8, size 0x4, virtual false, abstract: false, final false
  static inline void Cancel();

  /// @brief Method Compile, addr 0x2622fe4, size 0x11c, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> Compile(::System::Object* delegateObj, bool isFunctionPointer);

  /// @brief Method Compile, addr 0x26229d8, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod, addr 0x26227cc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod2, addr 0x262280c, size 0x1a4, virtual false, abstract: false, final false
  static inline void* CompileILPPMethod2(::System::RuntimeMethodHandle burstMethodHandle);

  /// @brief Method CompileUnsafeStaticMethod, addr 0x2622fa4, size 0x40, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> CompileUnsafeStaticMethod(::System::RuntimeMethodHandle handle);

  /// @brief Method Disable, addr 0x26231d8, size 0x4, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method DummyMethod, addr 0x2623c24, size 0x4, virtual false, abstract: false, final false
  static inline void DummyMethod();

  /// @brief Method Enable, addr 0x26231d4, size 0x4, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method GetExecutionMode, addr 0x26227c4, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstExecutionEnvironment GetExecutionMode();

  /// @brief Method GetILPPMethodFunctionPointer, addr 0x2622e28, size 0x40, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> GetILPPMethodFunctionPointer(void* ilppMethod);

  /// @brief Method GetILPPMethodFunctionPointer2, addr 0x2622e68, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialiseDebuggerHooks, addr 0x262383c, size 0xac, virtual false, abstract: false, final false
  static inline void InitialiseDebuggerHooks();

  /// @brief Method IsApiAvailable, addr 0x2622504, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsApiAvailable(::StringW apiName);

  /// @brief Method IsCurrentCompilationDone, addr 0x26231cc, size 0x8, virtual false, abstract: false, final false
  static inline bool IsCurrentCompilationDone();

  /// @brief Method IsHostEditorArm, addr 0x26231dc, size 0x8, virtual false, abstract: false, final false
  static inline bool IsHostEditorArm();

  /// @brief Method IsLoadAdditionalLibrarySupported, addr 0x26224a0, size 0x64, virtual false, abstract: false, final false
  static inline bool IsLoadAdditionalLibrarySupported();

  /// @brief Method NotifyAssemblyCompilationFinished, addr 0x2623a58, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationFinished(::StringW assemblyName);

  /// @brief Method NotifyAssemblyCompilationNotRequired, addr 0x2623a54, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationNotRequired(::StringW assemblyName);

  /// @brief Method NotifyCompilationFinished, addr 0x2623a5c, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyCompilationFinished();

  /// @brief Method NotifyCompilationStarted, addr 0x2623a50, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyCompilationStarted();

  /// @brief Method RequestSetProtocolVersion, addr 0x26238e8, size 0x168, virtual false, abstract: false, final false
  static inline int32_t RequestSetProtocolVersion(int32_t version);

  /// @brief Method SendCommandToCompiler, addr 0x2623770, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW SendCommandToCompiler(::StringW commandName, ::StringW commandArgs);

  /// @brief Method SendRawCommandToCompiler, addr 0x2623aa4, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW SendRawCommandToCompiler(::StringW command);

  /// @brief Method SetExecutionMode, addr 0x26227bc, size 0x8, virtual false, abstract: false, final false
  static inline void SetExecutionMode(::Unity::Burst::BurstExecutionEnvironment mode);

  /// @brief Method SetProfilerCallbacks, addr 0x2623aa0, size 0x4, virtual false, abstract: false, final false
  static inline void SetProfilerCallbacks();

  /// @brief Method Shutdown, addr 0x26231c4, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method TriggerRecompilation, addr 0x2623704, size 0x4, virtual false, abstract: false, final false
  static inline void TriggerRecompilation();

  /// @brief Method TriggerUnsafeStaticMethodRecompilation, addr 0x26231e4, size 0x520, virtual false, abstract: false, final false
  static inline void TriggerUnsafeStaticMethodRecompilation();

  /// @brief Method UnloadAdditionalLibraries, addr 0x2623708, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEnabled, addr 0x2622720, size 0x9c, virtual false, abstract: false, final false
