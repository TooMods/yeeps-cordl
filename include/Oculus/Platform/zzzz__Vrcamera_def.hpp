...
public:
  // Declarations
  /// @brief Method SetGetDataChannelMessageUpdateNotificationCallback, addr 0x19c2040, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGetSurfaceUpdateNotificationCallback, addr 0x19c20b4, size 0x74, virtual false, abstract: false, final false
