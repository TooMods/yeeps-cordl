...
public:
  ...
  /// @brief Method .ctor, addr 0x1031bf0, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Callback, addr 0x10319dc, size 0xac, virtual false, abstract: false, final false
  inline void Callback(::System::Object* state);

  /// @brief Method Invoke, addr 0x1031a88, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103195c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Security::RemoteCertificateValidationCallback* validationCallback);

  /// @brief Method get_ValidationCallback, addr 0x10319d4, size 0x8, virtual false, abstract: false, final false
