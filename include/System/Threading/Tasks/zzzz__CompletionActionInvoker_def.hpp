...
public:
  ...
  /// @brief Method MarkAborted, addr 0xedc4a4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0xedc3fc, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xed96c0, size 0x2c, virtual false, abstract: false, final false
