...
public:
  ...
  /// @brief Method Add, addr 0x125661c, size 0xac, virtual false, abstract: false, final false
  inline void Add(::StringW prefix, ::StringW ns);

  /// @brief Method AddInternal, addr 0x12566c8, size 0x3c, virtual false, abstract: false, final false
  inline void AddInternal(::StringW prefix, ::StringW ns);

  static inline ::System::Xml::Serialization::XmlSerializerNamespaces* New_ctor();

  /// @brief Method ToArray, addr 0x1256770, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1256614, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x1256cb4, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_NamespaceList, addr 0x1256878, size 0x43c, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_NamespaceList();

  /// @brief Method get_Namespaces, addr 0x1256704, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_Namespaces();

  /// @brief Method set_Namespaces, addr 0x1256cd8, size 0x8, virtual false, abstract: false, final false
