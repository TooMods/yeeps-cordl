...
public:
  ...
  /// @brief Method Reset, addr 0x1e1a098, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e19964, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF32Encoding* encoding);

  /// @brief Method get_HasState, addr 0x1e1a0b8, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x1e19e18, size 0xc4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetByteCount, addr 0x1e17a54, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e17c68, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e18abc, size 0x2e8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, ::System::Text::EncoderNLS* encoder);

  /// @brief Method GetByteCount, addr 0x1e17bd8, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetBytes, addr 0x1e17fa0, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1821c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e18da4, size 0x3dc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e17d40, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x1e1831c, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e184a0, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e1919c, size 0x348, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars, addr 0x1e18578, size 0x27c, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x1e187f4, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x1e194e4, size 0x3fc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x1e19900, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x1e1996c, size 0x60, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetHashCode, addr 0x1e19edc, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHighSurrogate, addr 0x1e198e0, size 0x14, virtual false, abstract: false, final false
  inline char16_t GetHighSurrogate(uint32_t iChar);

  /// @brief Method GetLowSurrogate, addr 0x1e198f4, size 0xc, virtual false, abstract: false, final false
  inline char16_t GetLowSurrogate(uint32_t iChar);

  /// @brief Method GetMaxByteCount, addr 0x1e199cc, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x1e19ad4, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetPreamble, addr 0x1e19ba4, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  /// @brief Method GetString, addr 0x1e188f4, size 0x1c8, virtual true, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetSurrogate, addr 0x1e19180, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultFallbacks, addr 0x1e17984, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e178ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e17944, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(bool bigEndian, bool byteOrderMark);

  /// @brief Method .ctor, addr 0x1e178d4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Preamble, addr 0x1e19ca8, size 0x170, virtual true, abstract: false, final false
