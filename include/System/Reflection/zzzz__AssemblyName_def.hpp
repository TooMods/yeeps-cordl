...
public:
  ...
  /// @brief Method Clone, addr 0x261ab04, size 0xb0, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method ComputePublicKeyToken, addr 0x261a744, size 0x8c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputePublicKeyToken();

  /// @brief Method Create, addr 0x261abc0, size 0xcc, virtual false, abstract: false, final false
  static inline ::System::Reflection::AssemblyName* Create(::System::Reflection::Assembly* assembly, bool fillCodebase);

  /// @brief Method FillName, addr 0x261997c, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNativeName, addr 0x261abbc, size 0x4, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<::Mono::MonoAssemblyName> GetNativeName(void* assembly_ptr);

  /// @brief Method GetObjectData, addr 0x261a7d4, size 0x330, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetPublicKey, addr 0x261a5d0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPublicKey();

  /// @brief Method GetPublicKeyToken, addr 0x261a5d8, size 0xe8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPublicKeyToken();

  /// @brief Method InternalGetPublicKeyToken, addr 0x261a4b8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialization, addr 0x261abb4, size 0x8, virtual true, abstract: false, final true
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method ParseAssemblyName, addr 0x2619978, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKey, addr 0x2619250, size 0x20, virtual false, abstract: false, final false
  inline void SetPublicKey(::ArrayW<uint8_t, ::Array<uint8_t>*> publicKey);

  /// @brief Method ToString, addr 0x261a5a8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2619230, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x260d9c0, size 0x298, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyName);

  /// @brief Method .ctor, addr 0x2619c1c, size 0x508, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* si, ::System::Runtime::Serialization::StreamingContext sc);

  /// @brief Method get_CodeBase, addr 0x261a134, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CodeBase();

  /// @brief Method get_CultureInfo, addr 0x261a13c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_CultureInfo();

  /// @brief Method get_Flags, addr 0x261a14c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::AssemblyNameFlags get_Flags();

  /// @brief Method get_FullName, addr 0x261a15c, size 0x35c, virtual false, abstract: false, final false
  inline ::StringW get_FullName();

  /// @brief Method get_IsPublicKeyValid, addr 0x261a6c0, size 0x84, virtual false, abstract: false, final false
  inline bool get_IsPublicKeyValid();

  /// @brief Method get_Name, addr 0x261a124, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Version, addr 0x261a5a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Method get_public_token, addr 0x261a7d0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CultureInfo, addr 0x261a144, size 0x8, virtual false, abstract: false, final false
  inline void set_CultureInfo(::System::Globalization::CultureInfo* value);

  /// @brief Method set_Flags, addr 0x261a154, size 0x8, virtual false, abstract: false, final false
  inline void set_Flags(::System::Reflection::AssemblyNameFlags value);

  /// @brief Method set_Name, addr 0x261a12c, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Version, addr 0x2619270, size 0x4c, virtual false, abstract: false, final false
