...
public:
  ...
  /// @brief Method .ctor, addr 0x126c4f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x126b8f4, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AssembleSkeleton, addr 0x126bef8, size 0x5fc, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildBoneData, addr 0x126b978, size 0x580, virtual false, abstract: false, final false
  inline void BuildBoneData(::UnityEngine::Animator* animator);

  /// @brief Method BuildBoneDataSkeleton, addr 0x12691a4, size 0x8, virtual false, abstract: false, final false
  inline void BuildBoneDataSkeleton(::GlobalNamespace::OVRSkeleton* skeleton, bool useBindPose,
                                    ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId, ::UnityEngine::HumanBodyBones>* customBoneIdToHumanBodyBone);

  /// @brief Method BuildCoordinateAxesForAllBones, addr 0x12678c8, size 0x4ec, virtual false, abstract: false, final false
  inline void BuildCoordinateAxesForAllBones();

  /// @brief Method CreateQuaternionForBoneData, addr 0x126c978, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateQuaternionForBoneDataWithRightVec, addr 0x126c7b8, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method FindBoneWithBoneId, addr 0x126c4fc, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method FindFirstChild, addr 0x126c6a8, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1267758, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Animator* animator);

  /// @brief Method .ctor, addr 0x126b590, size 0x364, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* otherSkeletonMetaData);

  /// @brief Method .ctor, addr 0x126901c, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRSkeleton* skeleton, bool useBindPose,
                    ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId, ::UnityEngine::HumanBodyBones>* customBoneIdToHumanBodyBone);

  /// @brief Method get_BodyToBoneData, addr 0x126b588, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x12673fc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AdjustCustomBoneIdToHumanBodyBoneMapping, addr 0x1267f8c, size 0xc4, virtual false, abstract: false, final false
  inline void AdjustCustomBoneIdToHumanBodyBoneMapping();

  /// @brief Method AlignTargetWithSource, addr 0x1268260, size 0x6d8, virtual false, abstract: false, final false
  inline void AlignTargetWithSource();

  /// @brief Method ComputeOffsetsUsingSkeletonComponent, addr 0x1268938, size 0x6e4, virtual false, abstract: false, final false
  inline void ComputeOffsetsUsingSkeletonComponent();

  /// @brief Method CopyBoneIdToHumanBodyBoneMapping, addr 0x1267db4, size 0x1d8, virtual false, abstract: false, final false
  inline void CopyBoneIdToHumanBodyBoneMapping();

  /// @brief Method CreateCustomBoneIdToHumanBodyBoneMapping, addr 0x1267620, size 0x18, virtual false, abstract: false, final false
  inline void CreateCustomBoneIdToHumanBodyBoneMapping();

  /// @brief Method FindAdjustment, addr 0x12691f8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBodySectionInArray, addr 0x12691ac, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecomputeSkeletalOffsetsIfNecessary, addr 0x1268248, size 0x18, virtual false, abstract: false, final false
  inline void RecomputeSkeletalOffsetsIfNecessary();

  /// @brief Method RemoveMappingCorrespondingToHumanBodyBone, addr 0x1268050, size 0x1c4, virtual false, abstract: false, final false
  inline void RemoveMappingCorrespondingToHumanBodyBone(::UnityEngine::HumanBodyBones boneId);

  /// @brief Method Start, addr 0x1267474, size 0xcc, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StoreTTargetPoseRotations, addr 0x1267638, size 0x120, virtual false, abstract: false, final false
  inline void StoreTTargetPoseRotations();

  /// @brief Method Update, addr 0x1268214, size 0x34, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method ValidateGameObjectForUnityHumanoidRetargeting, addr 0x1267540, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12671f8, size 0x204, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Adjustments, addr 0x126745c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AnimatorTargetSkeleton, addr 0x12671e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> get_AnimatorTargetSkeleton();

  /// @brief Method get_BodySectionToPosition, addr 0x126746c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BodySectionsToAlign, addr 0x1267464, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,
                  ::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>
  get_BodySectionsToAlign();

  /// @brief Method get_CustomBoneIdToHumanBodyBone, addr 0x12671e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SourceSkeletonData, addr 0x12671c8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* get_SourceSkeletonData();

  /// @brief Method get_SourceSkeletonTPoseData, addr 0x12671d0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* get_SourceSkeletonTPoseData();

  /// @brief Method get_TargetSkeletonData, addr 0x12671d8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* get_TargetSkeletonData();

  /// @brief Method get_TargetTPoseRotations, addr 0x12671f0, size 0x8, virtual false, abstract: false, final false
