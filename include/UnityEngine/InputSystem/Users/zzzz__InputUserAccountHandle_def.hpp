...
public:
  ...
  /// @brief Method Equals, addr 0x1eab148, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1eab098, size 0xb0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Users::InputUserAccountHandle other);

  /// @brief Method GetHashCode, addr 0x1eab1f0, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x1eaafd4, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1eaaf54, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW apiName, uint64_t handle);

  /// @brief Method get_apiName, addr 0x1eaaf44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_apiName();

  /// @brief Method get_handle, addr 0x1eaaf4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1eaae30, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x1eab1c0, size 0x30, virtual false, abstract: false, final false
