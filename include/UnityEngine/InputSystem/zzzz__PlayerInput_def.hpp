...
public:
  ...
  /// @brief Method .ctor, addr 0x1d354b8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1d35500, size 0x1dc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor, addr 0x1d356dc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Guid actionGUID, ::StringW name);

  /// @brief Method get_actionId, addr 0x1d354a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_actionId();

  /// @brief Method get_actionName, addr 0x1d354b0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActivateInput, addr 0x1d2f804, size 0xb4, virtual false, abstract: false, final false
  inline void ActivateInput();

  /// @brief Method AssignPlayerIndex, addr 0x1d332f4, size 0x208, virtual false, abstract: false, final false
  inline void AssignPlayerIndex();

  /// @brief Method AssignUserAndDevices, addr 0x1d2f078, size 0x78c, virtual false, abstract: false, final false
  inline void AssignUserAndDevices();

  /// @brief Method CacheMessageNames, addr 0x1d31d44, size 0x3cc, virtual false, abstract: false, final false
  inline void CacheMessageNames();

  /// @brief Method ClearCaches, addr 0x1d2f074, size 0x4, virtual false, abstract: false, final false
  inline void ClearCaches();

  /// @brief Method DeactivateInput, addr 0x1d30b24, size 0x24, virtual false, abstract: false, final false
  inline void DeactivateInput();

  /// @brief Method DebugLogAction, addr 0x1d3473c, size 0x78, virtual false, abstract: false, final false
  inline void DebugLogAction(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method DoInstantiate, addr 0x1d31698, size 0x340, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInput> DoInstantiate(::UnityEngine::GameObject* prefab);

  /// @brief Method FindFirstPairedToDevice, addr 0x1d313d0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayerByIndex, addr 0x1d312d4, size 0xfc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInput> GetPlayerByIndex(int32_t playerIndex);

  /// @brief Method HandleControlsChanged, addr 0x1d33b40, size 0x11c, virtual false, abstract: false, final false
  inline void HandleControlsChanged();

  /// @brief Method HandleDeviceLost, addr 0x1d347b4, size 0x11c, virtual false, abstract: false, final false
  inline void HandleDeviceLost();

  /// @brief Method HandleDeviceRegained, addr 0x1d348d0, size 0x11c, virtual false, abstract: false, final false
  inline void HandleDeviceRegained();

  /// @brief Method HaveBindingForDevice, addr 0x1d32b20, size 0x108, virtual false, abstract: false, final false
  inline bool HaveBindingForDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InitializeActions, addr 0x1d2e89c, size 0x50c, virtual false, abstract: false, final false
  inline void InitializeActions();

  /// @brief Method InstallOnActionTriggeredHook, addr 0x1d31b6c, size 0x1d8, virtual false, abstract: false, final false
  inline void InstallOnActionTriggeredHook();

  /// @brief Method Instantiate, addr 0x1d3153c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method Instantiate, addr 0x1d319d8, size 0x194, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInput> Instantiate(::UnityEngine::GameObject* prefab, int32_t playerIndex, ::StringW controlScheme, int32_t splitScreenIndex,
  ...
  /// @brief Method OnActionTriggered, addr 0x1d3229c, size 0x1f4, virtual false, abstract: false, final false
  inline void OnActionTriggered(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnDeviceChange, addr 0x1d35264, size 0x108, virtual false, abstract: false, final false
  inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice* device, ::UnityEngine::InputSystem::InputDeviceChange change);

  /// @brief Method OnDisable, addr 0x1d34268, size 0x2f4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x1d334fc, size 0x4c8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPreFilterUnpairedDeviceUsed, addr 0x1d34b60, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnUnpairedDeviceUsed, addr 0x1d34c54, size 0x610, virtual false, abstract: false, final false
  ...
  /// @brief Method OnUserChange, addr 0x1d349ec, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method PassivateInput, addr 0x1d30b48, size 0x24, virtual false, abstract: false, final false
  inline void PassivateInput();

  /// @brief Method StartListeningForDeviceChanges, addr 0x1d33a7c, size 0xc4, virtual false, abstract: false, final false
  inline void StartListeningForDeviceChanges();

  /// @brief Method StartListeningForUnpairedDeviceActivity, addr 0x1d2fab8, size 0x138, virtual false, abstract: false, final false
  inline void StartListeningForUnpairedDeviceActivity();

  /// @brief Method StopListeningForDeviceChanges, addr 0x1d341fc, size 0x6c, virtual false, abstract: false, final false
  inline void StopListeningForDeviceChanges();

  /// @brief Method StopListeningForUnpairedDeviceActivity, addr 0x1d2fbf0, size 0x70, virtual false, abstract: false, final false
  inline void StopListeningForUnpairedDeviceActivity();

  /// @brief Method SwitchControlSchemeInternal, addr 0x1d30d44, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchCurrentActionMap, addr 0x1d309b8, size 0x16c, virtual false, abstract: false, final false
  inline void SwitchCurrentActionMap(::StringW mapNameOrId);

  /// @brief Method SwitchCurrentControlScheme, addr 0x1d30b6c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchCurrentControlScheme, addr 0x1d31138, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToActivateControlScheme, addr 0x1d328cc, size 0x1e0, virtual false, abstract: false, final false
  inline bool TryToActivateControlScheme(::UnityEngine::InputSystem::InputControlScheme controlScheme);

  /// @brief Method UnassignUserAndDevices, addr 0x1d32f60, size 0xb8, virtual false, abstract: false, final false
  inline void UnassignUserAndDevices();

  /// @brief Method UninitializeActions, addr 0x1d2eea0, size 0x1d4, virtual false, abstract: false, final false
  inline void UninitializeActions();

  /// @brief Method UninstallOnActionTriggeredHook, addr 0x1d32110, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d35448, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onActionTriggered, addr 0x1d2fff8, size 0xa0, virtual false, abstract: false, final false
  inline void add_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method add_onControlsChanged, addr 0x1d303b8, size 0xa0, virtual false, abstract: false, final false
  inline void add_onControlsChanged(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method add_onDeviceLost, addr 0x1d30138, size 0xa0, virtual false, abstract: false, final false
  inline void add_onDeviceLost(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method add_onDeviceRegained, addr 0x1d30278, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actionEvents, addr 0x1d2fd24, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x1d2e858, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_actions();

  /// @brief Method get_active, addr 0x1d2e840, size 0x8, virtual false, abstract: false, final false
  inline bool get_active();

  /// @brief Method get_all, addr 0x1d30810, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>> get_all();

  /// @brief Method get_camera, addr 0x1d304f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_camera();

  /// @brief Method get_controlsChangedEvent, addr 0x1d2ff48, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__PlayerInput__ControlsChangedEvent* get_controlsChangedEvent();

  /// @brief Method get_currentActionMap, addr 0x1d2fc60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* get_currentActionMap();

  /// @brief Method get_currentControlScheme, addr 0x1d2f8b8, size 0x80, virtual false, abstract: false, final false
  inline ::StringW get_currentControlScheme();

  /// @brief Method get_defaultActionMap, addr 0x1d2fcb4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_defaultActionMap();

  /// @brief Method get_defaultControlScheme, addr 0x1d2fa68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_defaultControlScheme();

  /// @brief Method get_deviceLostEvent, addr 0x1d2fde8, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__PlayerInput__DeviceLostEvent* get_deviceLostEvent();

  /// @brief Method get_deviceRegainedEvent, addr 0x1d2fe98, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__PlayerInput__DeviceRegainedEvent* get_deviceRegainedEvent();

  /// @brief Method get_devices, addr 0x1d30670, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_hasMissingRequiredDevices, addr 0x1d3074c, size 0x48, virtual false, abstract: false, final false
  inline bool get_hasMissingRequiredDevices();

  /// @brief Method get_inputIsActive, addr 0x1d2e838, size 0x8, virtual false, abstract: false, final false
  inline bool get_inputIsActive();

  /// @brief Method get_isSinglePlayer, addr 0x1d308a0, size 0x118, virtual false, abstract: false, final false
  static inline bool get_isSinglePlayer();

  /// @brief Method get_neverAutoSwitchControlSchemes, addr 0x1d2fa78, size 0x8, virtual false, abstract: false, final false
  inline bool get_neverAutoSwitchControlSchemes();

  /// @brief Method get_notificationBehavior, addr 0x1d2fcc4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior();

  /// @brief Method get_playerIndex, addr 0x1d2e848, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_playerIndex();

  /// @brief Method get_splitScreenIndex, addr 0x1d2e850, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_splitScreenIndex();

  /// @brief Method get_uiInputModule, addr 0x1d30508, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::UI::InputSystemUIInputModule> get_uiInputModule();

  /// @brief Method get_user, addr 0x1d30668, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Users::InputUser get_user();

  /// @brief Method remove_onActionTriggered, addr 0x1d30098, size 0xa0, virtual false, abstract: false, final false
  inline void remove_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_onControlsChanged, addr 0x1d30458, size 0xa0, virtual false, abstract: false, final false
  inline void remove_onControlsChanged(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method remove_onDeviceLost, addr 0x1d301d8, size 0xa0, virtual false, abstract: false, final false
  inline void remove_onDeviceLost(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method remove_onDeviceRegained, addr 0x1d30318, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actionEvents, addr 0x1d2fd6c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actions, addr 0x1d2eda8, size 0xf8, virtual false, abstract: false, final false
  inline void set_actions(::UnityEngine::InputSystem::InputActionAsset* value);

  /// @brief Method set_camera, addr 0x1d30500, size 0x8, virtual false, abstract: false, final false
  inline void set_camera(::UnityEngine::Camera* value);

  /// @brief Method set_currentActionMap, addr 0x1d2fc68, size 0x4c, virtual false, abstract: false, final false
  inline void set_currentActionMap(::UnityEngine::InputSystem::InputActionMap* value);

  /// @brief Method set_defaultActionMap, addr 0x1d2fcbc, size 0x8, virtual false, abstract: false, final false
  inline void set_defaultActionMap(::StringW value);

  /// @brief Method set_defaultControlScheme, addr 0x1d2fa70, size 0x8, virtual false, abstract: false, final false
  inline void set_defaultControlScheme(::StringW value);

  /// @brief Method set_neverAutoSwitchControlSchemes, addr 0x1d2fa80, size 0x38, virtual false, abstract: false, final false
  inline void set_neverAutoSwitchControlSchemes(bool value);

  /// @brief Method set_notificationBehavior, addr 0x1d2fccc, size 0x58, virtual false, abstract: false, final false
  inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications value);

  /// @brief Method set_uiInputModule, addr 0x1d30510, size 0x158, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1d2fe50, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x1d2ff00, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x1d2ffb0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
