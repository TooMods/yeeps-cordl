...
public:
  ...
  /// @brief Method CheckClear, addr 0x2a7c9a0, size 0xa0, virtual false, abstract: false, final false
  inline void CheckClear();

  /// @brief Method Clear, addr 0x2a7c97c, size 0x18, virtual false, abstract: false, final false
  inline void Clear();

  static inline ::OVR::OpenVR::__OpenVR__COpenVRContext* New_ctor();

  /// @brief Method VRApplications, addr 0x2a7c31c, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRApplications* VRApplications();

  /// @brief Method VRChaperone, addr 0x2a7bc38, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRChaperone* VRChaperone();

  /// @brief Method VRChaperoneSetup, addr 0x2a7bd34, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRChaperoneSetup* VRChaperoneSetup();

  /// @brief Method VRCompositor, addr 0x2a7be30, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRCompositor* VRCompositor();

  /// @brief Method VRExtendedDisplay, addr 0x2a7c124, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRExtendedDisplay* VRExtendedDisplay();

  /// @brief Method VRInput, addr 0x2a7c610, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRInput* VRInput();

  /// @brief Method VROverlay, addr 0x2a7bf2c, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVROverlay* VROverlay();

  /// @brief Method VRRenderModels, addr 0x2a7c028, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRRenderModels* VRRenderModels();

  /// @brief Method VRScreenshots, addr 0x2a7c418, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRScreenshots* VRScreenshots();

  /// @brief Method VRSettings, addr 0x2a7c220, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRSettings* VRSettings();

  /// @brief Method VRSpatialAnchors, addr 0x2a7c70c, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRSpatialAnchors* VRSpatialAnchors();

  /// @brief Method VRSystem, addr 0x2a7bb3c, size 0xe4, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRSystem* VRSystem();

  /// @brief Method VRTrackedCamera, addr 0x2a7c514, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a7baf8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetGenericInterface, addr 0x2a7b9b8, size 0x4, virtual false, abstract: false, final false
  static inline void* GetGenericInterface(::StringW pchInterfaceVersion, ByRef<::OVR::OpenVR::EVRInitError> peError);

  /// @brief Method GetInitToken, addr 0x2a7b9c0, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetInitToken();

  /// @brief Method GetStringForHmdError, addr 0x2a7b950, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW GetStringForHmdError(::OVR::OpenVR::EVRInitError error);

  /// @brief Method Init, addr 0x2a7c7f0, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitInternal, addr 0x2a7b93c, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t InitInternal(ByRef<::OVR::OpenVR::EVRInitError> peError, ::OVR::OpenVR::EVRApplicationType eApplicationType);

  /// @brief Method InitInternal2, addr 0x2a7b940, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHmdPresent, addr 0x2a7b948, size 0x4, virtual false, abstract: false, final false
  static inline bool IsHmdPresent();

  /// @brief Method IsInterfaceVersionValid, addr 0x2a7b9bc, size 0x4, virtual false, abstract: false, final false
  static inline bool IsInterfaceVersionValid(::StringW pchInterfaceVersion);

  /// @brief Method IsRuntimeInstalled, addr 0x2a7b94c, size 0x4, virtual false, abstract: false, final false
  static inline bool IsRuntimeInstalled();

  static inline ::OVR::OpenVR::OpenVR* New_ctor();

  /// @brief Method Shutdown, addr 0x2a7c994, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method ShutdownInternal, addr 0x2a7b944, size 0x4, virtual false, abstract: false, final false
  static inline void ShutdownInternal();

  /// @brief Method .ctor, addr 0x2a7c998, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Applications, addr 0x2a7c304, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRApplications* get_Applications();

  /// @brief Method get_Chaperone, addr 0x2a7bc20, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRChaperone* get_Chaperone();

  /// @brief Method get_ChaperoneSetup, addr 0x2a7bd1c, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRChaperoneSetup* get_ChaperoneSetup();

  /// @brief Method get_Compositor, addr 0x2a7be18, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRCompositor* get_Compositor();

  /// @brief Method get_ExtendedDisplay, addr 0x2a7c10c, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRExtendedDisplay* get_ExtendedDisplay();

  /// @brief Method get_Input, addr 0x2a7c5f8, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRInput* get_Input();

  /// @brief Method get_OpenVRInternal_ModuleContext, addr 0x2a7ba58, size 0xa0, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::__OpenVR__COpenVRContext* get_OpenVRInternal_ModuleContext();

  /// @brief Method get_Overlay, addr 0x2a7bf14, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVROverlay* get_Overlay();

  /// @brief Method get_RenderModels, addr 0x2a7c010, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRRenderModels* get_RenderModels();

  /// @brief Method get_Screenshots, addr 0x2a7c400, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRScreenshots* get_Screenshots();

  /// @brief Method get_Settings, addr 0x2a7c208, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRSettings* get_Settings();

  /// @brief Method get_SpatialAnchors, addr 0x2a7c6f4, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRSpatialAnchors* get_SpatialAnchors();

  /// @brief Method get_System, addr 0x2a7bb24, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRSystem* get_System();

  /// @brief Method get_TrackedCamera, addr 0x2a7c4fc, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRTrackedCamera* get_TrackedCamera();

  /// @brief Method get_VRToken, addr 0x2a7b9c4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_VRToken, addr 0x2a7ba0c, size 0x4c, virtual false, abstract: false, final false
