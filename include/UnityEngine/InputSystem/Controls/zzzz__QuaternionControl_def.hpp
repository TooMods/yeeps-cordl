...
public:
  ...
  /// @brief Method CalculateOptimizedControlDataType, addr 0x2265c70, size 0x1b8, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType();

  /// @brief Method FinishSetup, addr 0x2265970, size 0x114, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Controls::QuaternionControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x2265a84, size 0x100, virtual true, abstract: false, final false
  inline ::UnityEngine::Quaternion ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x2265b84, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22658e0, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_w, addr 0x22658d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_w();

  /// @brief Method get_x, addr 0x22658a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_x();

  /// @brief Method get_y, addr 0x22658b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_y();

  /// @brief Method get_z, addr 0x22658c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_z();

  /// @brief Method set_w, addr 0x22658d8, size 0x8, virtual false, abstract: false, final false
  inline void set_w(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_x, addr 0x22658a8, size 0x8, virtual false, abstract: false, final false
  inline void set_x(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_y, addr 0x22658b8, size 0x8, virtual false, abstract: false, final false
  inline void set_y(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_z, addr 0x22658c8, size 0x8, virtual false, abstract: false, final false
