...
public:
  ...
  /// @brief Method .ctor, addr 0x2f62ddc, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Value, addr 0x2f62dd4, size 0x8, virtual false, abstract: false, final false
