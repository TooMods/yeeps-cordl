...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1d3cc48, size 0x20, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::XInput::XInputController* New_ctor();

  /// @brief Method ParseCapabilities, addr 0x1d3cbb4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d3cc68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_flags, addr 0x1d3cc24, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XInput::__XInputController__DeviceFlags get_flags();

  /// @brief Method get_menu, addr 0x1d3cb70, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_menu();

  /// @brief Method get_subType, addr 0x1d3cb90, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XInput::__XInputController__DeviceSubType get_subType();

  /// @brief Method get_view, addr 0x1d3cb80, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_view();

  /// @brief Method set_menu, addr 0x1d3cb78, size 0x8, virtual false, abstract: false, final false
  inline void set_menu(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_view, addr 0x1d3cb88, size 0x8, virtual false, abstract: false, final false
