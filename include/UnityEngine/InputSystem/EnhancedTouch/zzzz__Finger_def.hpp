...
public:
  ...
  /// @brief Method FindTouch, addr 0x1dfbdd4, size 0x338, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch FindTouch(uint32_t uniqueId);

  /// @brief Method GetTouchHistory, addr 0x1dfc10c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnTouchRecorded, addr 0x1dfbafc, size 0x2ac, virtual false, abstract: false, final false
  inline void OnTouchRecorded(::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record record);

  /// @brief Method ShouldRecordTouch, addr 0x1dfba60, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1dfb6f0, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentTouch, addr 0x1dfb450, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_currentTouch();

  /// @brief Method get_index, addr 0x1dfb41c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_isActive, addr 0x1dfb424, size 0x2c, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method get_lastTouch, addr 0x1dfb5a0, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_lastTouch();

  /// @brief Method get_screen, addr 0x1dfb414, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition, addr 0x1dfb560, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_touchHistory, addr 0x1dfb680, size 0x34, virtual false, abstract: false, final false
