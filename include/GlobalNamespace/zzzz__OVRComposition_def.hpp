...
public:
  ...
  /// @brief Method ComputeCameraTrackingSpacePose, addr 0x25ae044, size 0x288, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::__OVRPlugin__CameraExtrinsics extrinsics);

  /// @brief Method ComputeCameraWorldSpacePose, addr 0x25adfdc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x25adfd8, size 0x4, virtual true, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method RefreshCameraRig, addr 0x25ade20, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25addec, size 0x34, virtual false, abstract: false, final false
