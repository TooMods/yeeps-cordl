...
public:
  ...
  /// @brief Method .ctor, addr 0x3048e08, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW xmlName, ::StringW enumName, int64_t value);

  /// @brief Method get_EnumName, addr 0x3048e4c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EnumName();

  /// @brief Method get_Value, addr 0x3048e54, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_Value();

  /// @brief Method get_XmlName, addr 0x3048e44, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumName, addr 0x3048b28, size 0x2e0, virtual false, abstract: false, final false
  inline ::StringW GetEnumName(::StringW typeName, ::StringW xmlName);

  /// @brief Method GetXmlName, addr 0x3042a14, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3048974, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EnumNames, addr 0x3048b10, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_EnumNames();

  /// @brief Method get_IsFlags, addr 0x3048b08, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsFlags();

  /// @brief Method get_Values, addr 0x3048b20, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int64_t, ::Array<int64_t>*> get_Values();

  /// @brief Method get_XmlNames, addr 0x3048b18, size 0x8, virtual false, abstract: false, final false
