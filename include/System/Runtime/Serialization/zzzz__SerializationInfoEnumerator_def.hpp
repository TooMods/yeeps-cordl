...
public:
  ...
  /// @brief Method MoveNext, addr 0x185c1d8, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x1868eb8, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1868e48, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1868df8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x1863034, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEntry get_Current();

  /// @brief Method get_Name, addr 0x185c05c, size 0x88, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ObjectType, addr 0x1868ec8, size 0x88, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_Value, addr 0x185c0e4, size 0x88, virtual false, abstract: false, final false
