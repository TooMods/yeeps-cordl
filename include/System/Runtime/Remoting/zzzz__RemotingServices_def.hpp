...
public:
  ...
  /// @brief Method .ctor, addr 0x1981078, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Connect, addr 0x197e69c, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Object* Connect(::System::Type* classToProxy, ::StringW url);

  /// @brief Method Connect, addr 0x197e7ac, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Object* Connect(::System::Type* classToProxy, ::StringW url, ::System::Object* data);

  /// @brief Method CreateClientActivatedServerIdentity, addr 0x197f6d0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientProxy, addr 0x197ff50, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientProxy, addr 0x1980268, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Object* CreateClientProxy(::System::Runtime::Remoting::WellKnownClientTypeEntry* entry);

  /// @brief Method CreateClientProxy, addr 0x198004c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientProxyForContextBound, addr 0x19802d4, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateContextBoundObjectIdentity, addr 0x1980c8c, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::ClientActivatedIdentity* CreateContextBoundObjectIdentity(::System::Type* objectType);

  /// @brief Method CreateWellKnownServerIdentity, addr 0x19770fc, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeCallData, addr 0x1981080, size 0x24c, virtual false, abstract: false, final false
  static inline ::System::Object* DeserializeCallData(::ArrayW<uint8_t, ::Array<uint8_t>*> array);

  /// @brief Method DisposeIdentity, addr 0x1980a88, size 0x204, virtual false, abstract: false, final false
  static inline void DisposeIdentity(::System::Runtime::Remoting::Identity* ident);

  /// @brief Method FindInterfaceMethod, addr 0x197fcd8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method GetClientChannelSinkChain, addr 0x1980180, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIdentityForUri, addr 0x197e908, size 0x24c, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::Identity* GetIdentityForUri(::StringW uri);

  /// @brief Method GetMessageTargetIdentity, addr 0x1981440, size 0x338, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::Identity* GetMessageTargetIdentity(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method GetMethodBaseFromMethodMessage, addr 0x197f818, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodBaseFromName, addr 0x197fb08, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNormalizedUri, addr 0x1980454, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW GetNormalizedUri(::StringW uri);

  /// @brief Method GetObjectData, addr 0x197fe08, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrCreateClientIdentity, addr 0x19805c0, size 0x4c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProxyForRemoteObject, addr 0x197eda8, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Object* GetProxyForRemoteObject(::System::Runtime::Remoting::ObjRef* objref, ::System::Type* classToProxy);

  /// @brief Method GetRealProxy, addr 0x197ef60, size 0x48, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::Proxies::RealProxy* GetRealProxy(::System::Object* proxy);

  /// @brief Method GetRemoteObject, addr 0x197e738, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Object* GetRemoteObject(::System::Runtime::Remoting::ObjRef* objRef, ::System::Type* proxyType);

  /// @brief Method GetServerTypeForUri, addr 0x197e84c, size 0xbc, virtual false, abstract: false, final false
  static inline ::System::Type* GetServerTypeForUri(::StringW URI);

  /// @brief Method GetVirtualMethod, addr 0x197dc38, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodBase* GetVirtualMethod(::System::Type* type, ::System::Reflection::MethodBase* method);

  /// @brief Method InternalExecute, addr 0x197dc34, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalExecuteMessage, addr 0x197dc7c, size 0xa20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOneWay, addr 0x197feb8, size 0x98, virtual false, abstract: false, final false
  static inline bool IsOneWay(::System::Reflection::MethodBase* method);

  /// @brief Method IsTransparentProxy, addr 0x197dc3c, size 0x40, virtual false, abstract: false, final false
  static inline bool IsTransparentProxy(::System::Object* proxy);

  /// @brief Method Marshal, addr 0x197ee9c, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::ObjRef* Marshal(::System::MarshalByRefObject* Obj);

  /// @brief Method Marshal, addr 0x197eee8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method NewUri, addr 0x197efa8, size 0x384, virtual false, abstract: false, final false
  static inline ::StringW NewUri();

  /// @brief Method RegisterInternalChannels, addr 0x197dbe4, size 0x50, virtual false, abstract: false, final false
  static inline void RegisterInternalChannels();

  /// @brief Method RegisterServerIdentity, addr 0x197f32c, size 0x210, virtual false, abstract: false, final false
  static inline void RegisterServerIdentity(::System::Runtime::Remoting::ServerIdentity* identity);

  /// @brief Method RemoveAppNameFromUri, addr 0x19804cc, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW RemoveAppNameFromUri(::StringW uri);

  /// @brief Method SerializeCallData, addr 0x1980e6c, size 0x20c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> SerializeCallData(::System::Object* obj);

  /// @brief Method SerializeExceptionData, addr 0x19812cc, size 0x174, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> SerializeExceptionData(::System::Exception* ex);

  /// @brief Method SetMessageTargetIdentity, addr 0x1981778, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Unmarshal, addr 0x1975d50, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Object* Unmarshal(::System::Runtime::Remoting::ObjRef* objectRef);

  /// @brief Method Unmarshal, addr 0x197eb54, size 0x254, virtual false, abstract: false, final false
  static inline ::System::Object* Unmarshal(::System::Runtime::Remoting::ObjRef* objectRef, bool fRefine);

  /// @brief Method UpdateOutArgObject, addr 0x198188c, size 0x190, virtual false, abstract: false, final false
