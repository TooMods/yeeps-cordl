...
public:
  ...
  /// @brief Method GetRenderFrameInterval, addr 0x2a8f540, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x2a8f4e8, size 0x58, virtual false, abstract: false, final false
