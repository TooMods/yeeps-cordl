...
public:
  ...
  /// @brief Method ComputeTextHeight, addr 0x2cc5d40, size 0x64, virtual true, abstract: false, final true
  inline float_t ComputeTextHeight(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms, float_t scaling);

  /// @brief Method ComputeTextWidth, addr 0x2cc607c, size 0x80, virtual true, abstract: false, final true
  inline float_t ComputeTextWidth(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms, float_t scaling);

  /// @brief Method GetCursorPosition, addr 0x2cc6024, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLineHeight, addr 0x2cc5cd0, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method GetVertices, addr 0x2cc5e14, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method IsElided, addr 0x2cc60fc, size 0x8, virtual true, abstract: false, final true
  inline bool IsElided();

  /// @brief Method IsLegacy, addr 0x2cc5cc8, size 0x8, virtual true, abstract: false, final true
  inline bool IsLegacy();

  /// @brief Method New, addr 0x2cc5c6c, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::ITextHandle* New();

  /// @brief Method Update, addr 0x2cc5da4, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method get_MeasuredSizes, addr 0x2cc5c4c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 get_MeasuredSizes();

  /// @brief Method get_RoundedSizes, addr 0x2cc5c5c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_MeasuredSizes, addr 0x2cc5c54, size 0x8, virtual true, abstract: false, final true
  inline void set_MeasuredSizes(::UnityEngine::Vector2 value);

  /// @brief Method set_RoundedSizes, addr 0x2cc5c64, size 0x8, virtual true, abstract: false, final true
