...
public:
  ...
  /// @brief Method Close, addr 0xecf9a0, size 0x70, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0xecfa58, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0xecfa10, size 0x48, virtual true, abstract: false, final false
  inline void Dispose(bool explicitDisposing);

  /// @brief Method Init, addr 0xece9a0, size 0x6c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalWaitOne, addr 0xecee70, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHandleInternal, addr 0xecec38, size 0x34, virtual false, abstract: false, final false
  inline void SetHandleInternal(::Microsoft::Win32::SafeHandles::SafeWaitHandle* handle);

  /// @brief Method ThrowAbandonedMutexException, addr 0xecf128, size 0x40, virtual false, abstract: false, final false
  static inline void ThrowAbandonedMutexException();

  /// @brief Method ThrowAbandonedMutexException, addr 0xecf840, size 0x54, virtual false, abstract: false, final false
  static inline void ThrowAbandonedMutexException(int32_t location, ::System::Threading::WaitHandle* handle);

  /// @brief Method WaitAny, addr 0xecf168, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitAny, addr 0xecf894, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitMultiple, addr 0xecf470, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitOne, addr 0xecee3c, size 0x14, virtual true, abstract: false, final false
  inline bool WaitOne();

  /// @brief Method WaitOne, addr 0xecee50, size 0x10, virtual true, abstract: false, final false
  inline bool WaitOne(int32_t millisecondsTimeout);

  /// @brief Method WaitOne, addr 0xecec6c, size 0x84, virtual true, abstract: false, final false
  inline bool WaitOne(int32_t millisecondsTimeout, bool exitContext);

  /// @brief Method WaitOne, addr 0xecee60, size 0x10, virtual true, abstract: false, final false
  inline bool WaitOne(::System::TimeSpan timeout);

  /// @brief Method WaitOne, addr 0xeced70, size 0xcc, virtual true, abstract: false, final false
  inline bool WaitOne(::System::TimeSpan timeout, bool exitContext);

  /// @brief Method WaitOne, addr 0xececf0, size 0x80, virtual false, abstract: false, final false
  inline bool WaitOne(int64_t timeout, bool exitContext);

  /// @brief Method WaitOneNative, addr 0xecef64, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Wait_internal, addr 0xecfac8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xece984, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline void* getStaticF_InvalidHandle();

  /// @brief Method get_SafeWaitHandle, addr 0xeceaf8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Handle, addr 0xecea0c, size 0xec, virtual true, abstract: false, final false
  inline void set_Handle(void* value);

  /// @brief Method set_SafeWaitHandle, addr 0xecebb0, size 0x88, virtual false, abstract: false, final false
