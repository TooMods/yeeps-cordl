...
public:
  ...
  /// @brief Method Close, addr 0x25821b8, size 0x20, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x25821d8, size 0xb4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::System::IO::__TextReader__SyncTextReader* New_ctor(::System::IO::TextReader* t);

  /// @brief Method Peek, addr 0x258228c, size 0x20, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x25822ac, size 0x20, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x25822cc, size 0x20, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x25823bc, size 0x1d0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x25822ec, size 0x24, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x2582310, size 0x24, virtual true, abstract: false, final false
  inline ::StringW ReadToEnd();

  /// @brief Method ReadToEndAsync, addr 0x2582334, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2582070, size 0x6c, virtual false, abstract: false, final false
