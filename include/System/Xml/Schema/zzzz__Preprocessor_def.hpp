...
public:
  ...
  /// @brief Method BuildRefNamespaces, addr 0x1e79fa4, size 0x220, virtual false, abstract: false, final false
  inline void BuildRefNamespaces(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method BuildSchemaList, addr 0x1e77948, size 0x178, virtual false, abstract: false, final false
  inline void BuildSchemaList(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method CheckRefinedAttributeGroup, addr 0x1e7d44c, size 0x158, virtual false, abstract: false, final false
  inline void CheckRefinedAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup);

  /// @brief Method CheckRefinedComplexType, addr 0x1e7d5a4, size 0x314, virtual false, abstract: false, final false
  inline void CheckRefinedComplexType(::System::Xml::Schema::XmlSchemaComplexType* ctype);

  /// @brief Method CheckRefinedGroup, addr 0x1e7d3ac, size 0xa0, virtual false, abstract: false, final false
  inline void CheckRefinedGroup(::System::Xml::Schema::XmlSchemaGroup* group);

  /// @brief Method CheckRefinedSimpleType, addr 0x1e7d8b8, size 0x10c, virtual false, abstract: false, final false
  inline void CheckRefinedSimpleType(::System::Xml::Schema::XmlSchemaSimpleType* stype);

  /// @brief Method Cleanup, addr 0x1e797d4, size 0xd4, virtual false, abstract: false, final false
  inline void Cleanup(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method CleanupRedefine, addr 0x1e79e74, size 0xa0, virtual false, abstract: false, final false
  inline void CleanupRedefine(::System::Xml::Schema::XmlSchemaExternal* include);

  /// @brief Method CopyIncludedComponents, addr 0x1e7a808, size 0x12c4, virtual false, abstract: false, final false
  inline void CopyIncludedComponents(::System::Xml::Schema::XmlSchema* includedSchema, ::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method CountGroupSelfReference, addr 0x1e7d9c4, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x1e7666c, size 0x4bc, virtual false, abstract: false, final false
  inline bool Execute(::System::Xml::Schema::XmlSchema* schema, ::StringW targetNamespace, bool loadExternals);

  /// @brief Method GetBuildInSchema, addr 0x1e798a8, size 0x5cc, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchema* GetBuildInSchema();

  /// @brief Method GetChameleonSchema, addr 0x1e76b28, size 0x134, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* GetChameleonSchema(::StringW targetNamespace, ::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method GetIncludedSet, addr 0x1e7d280, size 0x12c, virtual false, abstract: false, final false
  inline void GetIncludedSet(::System::Xml::Schema::XmlSchema* schema, ::System::Collections::ArrayList* includesList);

  /// @brief Method GetParentSchema, addr 0x1e7d1ec, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchema* GetParentSchema(::System::Xml::Schema::XmlSchemaObject* currentSchemaObject);

  /// @brief Method GetSchemaEntity, addr 0x1e79f7c, size 0x28, virtual false, abstract: false, final false
  inline ::System::Object* GetSchemaEntity(::System::Uri* ruri);

  /// @brief Method LoadExternals, addr 0x1e76c5c, size 0xcec, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseUri, addr 0x1e7a1c4, size 0x16c, virtual false, abstract: false, final false
  inline void ParseUri(::StringW uri, ::StringW code, ::System::Xml::Schema::XmlSchemaObject* sourceSchemaObject);

  /// @brief Method Preprocess, addr 0x1e77ac0, size 0x1220, virtual false, abstract: false, final false
  inline void Preprocess(::System::Xml::Schema::XmlSchema* schema, ::StringW targetNamespace, ::System::Collections::ArrayList* imports);

  /// @brief Method PreprocessAnnotation, addr 0x1e7d17c, size 0x70, virtual false, abstract: false, final false
  inline void PreprocessAnnotation(::System::Xml::Schema::XmlSchemaAnnotation* annotation);

  /// @brief Method PreprocessAnnotation, addr 0x1e7a348, size 0x8c, virtual false, abstract: false, final false
  inline void PreprocessAnnotation(::System::Xml::Schema::XmlSchemaObject* schemaObject);

  /// @brief Method PreprocessAttribute, addr 0x1e7bacc, size 0x168, virtual false, abstract: false, final false
  inline void PreprocessAttribute(::System::Xml::Schema::XmlSchemaAttribute* attribute);

  /// @brief Method PreprocessAttributeContent, addr 0x1e7df80, size 0x228, virtual false, abstract: false, final false
  inline void PreprocessAttributeContent(::System::Xml::Schema::XmlSchemaAttribute* attribute);

  /// @brief Method PreprocessAttributeGroup, addr 0x1e7bc34, size 0xfc, virtual false, abstract: false, final false
  inline void PreprocessAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup);

  /// @brief Method PreprocessAttributes, addr 0x1e7e5ac, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method PreprocessComplexType, addr 0x1e7bd30, size 0x838, virtual false, abstract: false, final false
  inline void PreprocessComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType, bool local);

  /// @brief Method PreprocessElement, addr 0x1e7caf4, size 0x24c, virtual false, abstract: false, final false
  inline void PreprocessElement(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method PreprocessElementContent, addr 0x1e7e938, size 0x324, virtual false, abstract: false, final false
  inline void PreprocessElementContent(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method PreprocessGroup, addr 0x1e7cd40, size 0x1c0, virtual false, abstract: false, final false
  inline void PreprocessGroup(::System::Xml::Schema::XmlSchemaGroup* group);

  /// @brief Method PreprocessIdentityConstraint, addr 0x1e7efc8, size 0x33c, virtual false, abstract: false, final false
  inline void PreprocessIdentityConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint* constraint);

  /// @brief Method PreprocessLocalAttribute, addr 0x1e7e1a8, size 0x1b0, virtual false, abstract: false, final false
  inline void PreprocessLocalAttribute(::System::Xml::Schema::XmlSchemaAttribute* attribute);

  /// @brief Method PreprocessLocalElement, addr 0x1e7ec5c, size 0x36c, virtual false, abstract: false, final false
  inline void PreprocessLocalElement(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method PreprocessNotation, addr 0x1e7cf00, size 0x27c, virtual false, abstract: false, final false
  inline void PreprocessNotation(::System::Xml::Schema::XmlSchemaNotation* notation);

  /// @brief Method PreprocessParticle, addr 0x1e7f304, size 0x8d4, virtual false, abstract: false, final false
  inline void PreprocessParticle(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method PreprocessRedefine, addr 0x1e78ce0, size 0xaf4, virtual false, abstract: false, final false
  inline void PreprocessRedefine(::System::Xml::Schema::RedefineEntry* redefineEntry);

  /// @brief Method PreprocessSimpleType, addr 0x1e7c568, size 0x58c, virtual false, abstract: false, final false
  inline void PreprocessSimpleType(::System::Xml::Schema::XmlSchemaSimpleType* simpleType, bool local);

  /// @brief Method ResolveSchemaLocationUri, addr 0x1e79f3c, size 0x40, virtual false, abstract: false, final false
  inline ::System::Uri* ResolveSchemaLocationUri(::System::Xml::Schema::XmlSchema* enclosingSchema, ::StringW location);

  /// @brief Method SetParent, addr 0x1e7a330, size 0x18, virtual false, abstract: false, final false
  inline void SetParent(::System::Xml::Schema::XmlSchemaObject* child, ::System::Xml::Schema::XmlSchemaObject* parent);

  /// @brief Method SetSchemaDefaults, addr 0x1e7a6fc, size 0x10c, virtual false, abstract: false, final false
  inline void SetSchemaDefaults(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method ValidateIdAttribute, addr 0x1e7a3d4, size 0x328, virtual false, abstract: false, final false
  inline void ValidateIdAttribute(::System::Xml::Schema::XmlSchemaObject* xso);

  /// @brief Method ValidateNameAttribute, addr 0x1e7dcd8, size 0x2a8, virtual false, abstract: false, final false
  inline void ValidateNameAttribute(::System::Xml::Schema::XmlSchemaObject* xso);

  /// @brief Method ValidateQNameAttribute, addr 0x1e7e358, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e76584, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_RootSchema, addr 0x1e79f34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ChameleonSchemas, addr 0x1e79f2c, size 0x8, virtual false, abstract: false, final false
  inline void set_ChameleonSchemas(::System::Collections::Hashtable* value);

  /// @brief Method set_ReaderSettings, addr 0x1e79f1c, size 0x8, virtual false, abstract: false, final false
  inline void set_ReaderSettings(::System::Xml::XmlReaderSettings* value);

  /// @brief Method set_SchemaLocations, addr 0x1e79f24, size 0x8, virtual false, abstract: false, final false
  inline void set_SchemaLocations(::System::Collections::Hashtable* value);

  /// @brief Method set_XmlResolver, addr 0x1e79f14, size 0x8, virtual false, abstract: false, final false
