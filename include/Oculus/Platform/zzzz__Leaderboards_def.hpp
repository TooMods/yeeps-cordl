...
public:
  // Declarations
  /// @brief Method Get, addr 0x19b7b88, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::LeaderboardList*>* Get(::StringW leaderboardName);

  /// @brief Method GetEntries, addr 0x19b7ce8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x19b7e70, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x19b7fe8, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x19b7890, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextLeaderboardListPage, addr 0x19b84c4, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x19b7a0c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEntry, addr 0x19b8184, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEntryWithSupplementaryMetric, addr 0x19b8320, size 0x1a4, virtual false, abstract: false, final false
