...
public:
  ...
  /// @brief Method .ctor, addr 0x2f64bbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x2f65108, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Name();

  /// @brief Method get_Value, addr 0x2f65118, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonToken* get_Value();

  /// @brief Method set_Name, addr 0x2f65110, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::Newtonsoft::Json::Bson::BsonString* value);

  /// @brief Method set_Value, addr 0x2f65120, size 0x8, virtual false, abstract: false, final false
