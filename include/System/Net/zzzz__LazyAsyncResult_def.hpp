...
public:
  ...
  /// @brief Method .ctor, addr 0xf5b3e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0xf5bc44, size 0x4, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Complete, addr 0xf5ba00, size 0x198, virtual true, abstract: false, final false
  inline void Complete(void* userToken);

  /// @brief Method InternalWaitForCompletion, addr 0xf5bc48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* InternalWaitForCompletion();

  /// @brief Method InvokeCallback, addr 0xf5b9ac, size 0x54, virtual false, abstract: false, final false
  inline void InvokeCallback();

  /// @brief Method InvokeCallback, addr 0xf5b94c, size 0x60, virtual false, abstract: false, final false
  inline void InvokeCallback(::System::Object* result);

  /// @brief Method LazilyCreateEvent, addr 0xf5b53c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProtectedInvokeCallback, addr 0xf5b774, size 0x1d8, virtual false, abstract: false, final false
  inline void ProtectedInvokeCallback(::System::Object* result, void* userToken);

  /// @brief Method WaitForCompletion, addr 0xf5bc50, size 0x2b8, virtual false, abstract: false, final false
  inline ::System::Object* WaitForCompletion(bool snap);

  /// @brief Method WorkerThreadComplete, addr 0xf5bb98, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf5b3f0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AsyncCallback, addr 0xf5b490, size 0x8, virtual false, abstract: false, final false
  inline ::System::AsyncCallback* get_AsyncCallback();

  /// @brief Method get_AsyncObject, addr 0xf5b480, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_AsyncObject();

  /// @brief Method get_AsyncState, addr 0xf5b488, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0xf5b498, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0xf5b700, size 0x30, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_CurrentThreadContext, addr 0xf5b354, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Net::__LazyAsyncResult__ThreadContext* get_CurrentThreadContext();

  /// @brief Method get_EndCalled, addr 0xf5b760, size 0x8, virtual false, abstract: false, final false
  inline bool get_EndCalled();

  /// @brief Method get_InternalPeekCompleted, addr 0xf5b6f0, size 0x10, virtual false, abstract: false, final false
  inline bool get_InternalPeekCompleted();

  /// @brief Method get_IsCompleted, addr 0xf5b730, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method set_EndCalled, addr 0xf5b768, size 0xc, virtual false, abstract: false, final false
