...
public:
  ...
  /// @brief Method <GetSerializationEventsForType>b__1_0, addr 0x1869fc8, size 0x60, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEvents* _GetSerializationEventsForType_b__1_0(::System::Type* type);

  /// @brief Method .ctor, addr 0x1869fc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSerializationEventsForType, addr 0x1869d9c, size 0x134, virtual false, abstract: false, final false
