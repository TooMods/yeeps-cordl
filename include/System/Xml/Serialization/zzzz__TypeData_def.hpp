...
public:
  ...
  /// @brief Method ConvertForAssignment, addr 0x1258908, size 0xd0, virtual false, abstract: false, final false
  inline void ConvertForAssignment(ByRef<::System::Object*> value);

  /// @brief Method CreateMissingAddMethodException, addr 0x12595f8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGenericListItemType, addr 0x12592c4, size 0x1f4, virtual false, abstract: false, final false
  static inline ::System::Type* GetGenericListItemType(::System::Type* type);

  /// @brief Method GetIndexerProperty, addr 0x12594b8, size 0x140, virtual false, abstract: false, final false
  static inline ::System::Reflection::PropertyInfo* GetIndexerProperty(::System::Type* collectionType);

  /// @brief Method LookupTypeConvertor, addr 0x1258868, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12582f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW elementName, bool isPrimitive);

  /// @brief Method .ctor, addr 0x1258308, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FullTypeName, addr 0x12589f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FullTypeName();

  /// @brief Method get_HasPublicConstructor, addr 0x1259710, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasPublicConstructor();

  /// @brief Method get_IsComplexType, addr 0x1258a00, size 0x28, virtual false, abstract: false, final false
  inline bool get_IsComplexType();

  /// @brief Method get_IsListType, addr 0x1257e90, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsListType();

  /// @brief Method get_IsNullable, addr 0x1258acc, size 0x114, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsValueType, addr 0x1258a38, size 0x94, virtual false, abstract: false, final false
  inline bool get_IsValueType();

  /// @brief Method get_IsXsdType, addr 0x1258a28, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsXsdType();

  /// @brief Method get_ListItemType, addr 0x1258bec, size 0x6d8, virtual false, abstract: false, final false
  inline ::System::Type* get_ListItemType();

  /// @brief Method get_ListItemTypeData, addr 0x12586a0, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_ListItemTypeData();

  /// @brief Method get_SchemaType, addr 0x12589f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::SchemaTypes get_SchemaType();

  /// @brief Method get_Type, addr 0x12589e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Type();

  /// @brief Method get_TypeName, addr 0x12589d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TypeName();

  /// @brief Method get_XmlType, addr 0x12589e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlType();

  static inline void setStaticF_keywords(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_IsNullable, addr 0x1258be0, size 0xc, virtual false, abstract: false, final false
