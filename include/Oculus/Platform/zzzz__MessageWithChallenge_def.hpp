...
public:
  // Declarations
  /// @brief Method GetChallenge, addr 0x19b31ac, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetDataFromMessage, addr 0x19b31e8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0a9c, size 0x58, virtual false, abstract: false, final false
