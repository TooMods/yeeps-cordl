...
public:
  ...
  /// @brief Method FindOrFetchAsUnknownV1Syntax, addr 0x1713edc, size 0x2f0, virtual false, abstract: false, final false
  static inline ::System::UriParser* FindOrFetchAsUnknownV1Syntax(::StringW lwrCaseScheme);

  /// @brief Method GetComponents, addr 0x17133d4, size 0x22c, virtual true, abstract: false, final false
  inline ::StringW GetComponents(::System::Uri* uri, ::System::UriComponents components, ::System::UriFormat format);

  /// @brief Method GetSyntax, addr 0x170fd84, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::UriParser* GetSyntax(::StringW lwrCaseScheme);

  /// @brief Method InFact, addr 0x170fe54, size 0x1c, virtual false, abstract: false, final false
  inline bool InFact(::System::UriSyntaxFlags flags);

  /// @brief Method InitializeAndValidate, addr 0x17131a8, size 0x28, virtual true, abstract: false, final false
  inline void InitializeAndValidate(::System::Uri* uri, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method InternalGetComponents, addr 0x1714240, size 0xc, virtual false, abstract: false, final false
  inline ::StringW InternalGetComponents(::System::Uri* thisUri, ::System::UriComponents uriComponents, ::System::UriFormat uriFormat);

  /// @brief Method InternalIsBaseOf, addr 0x1714234, size 0xc, virtual false, abstract: false, final false
  inline bool InternalIsBaseOf(::System::Uri* thisBaseUri, ::System::Uri* uriLink);

  /// @brief Method InternalOnNewUri, addr 0x17141d8, size 0x44, virtual false, abstract: false, final false
  inline ::System::UriParser* InternalOnNewUri();

  /// @brief Method InternalResolve, addr 0x1714228, size 0xc, virtual false, abstract: false, final false
  inline ::StringW InternalResolve(::System::Uri* thisBaseUri, ::System::Uri* uriLink, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method InternalValidate, addr 0x171421c, size 0xc, virtual false, abstract: false, final false
  inline void InternalValidate(::System::Uri* thisUri, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method IsAllSet, addr 0x1713e68, size 0x8, virtual false, abstract: false, final false
  inline bool IsAllSet(::System::UriSyntaxFlags flags);

  /// @brief Method IsBaseOf, addr 0x17133b8, size 0x1c, virtual true, abstract: false, final false
  inline bool IsBaseOf(::System::Uri* baseUri, ::System::Uri* relativeUri);

  /// @brief Method IsFullMatch, addr 0x1713e0c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method NotAny, addr 0x170fe70, size 0x8, virtual false, abstract: false, final false
  inline bool NotAny(::System::UriSyntaxFlags flags);

  /// @brief Method OnNewUri, addr 0x17131a4, size 0x4, virtual true, abstract: false, final false
  inline ::System::UriParser* OnNewUri();

  /// @brief Method Resolve, addr 0x17131d0, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1713e70, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DefaultPort, addr 0x171319c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DefaultPort();

  /// @brief Method get_Flags, addr 0x1713e04, size 0x8, virtual false, abstract: false, final false
  inline ::System::UriSyntaxFlags get_Flags();

  /// @brief Method get_IsSimple, addr 0x17141cc, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsSimple();

  /// @brief Method get_SchemeName, addr 0x1713194, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SchemeName();

  /// @brief Method get_ShouldUseLegacyV2Quirks, addr 0x1713004, size 0x60, virtual false, abstract: false, final false
