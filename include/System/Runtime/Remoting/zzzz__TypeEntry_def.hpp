...
public:
  ...
  /// @brief Method .ctor, addr 0x1974230, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AssemblyName, addr 0x198309c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AssemblyName();

  /// @brief Method get_TypeName, addr 0x19830ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TypeName();

  /// @brief Method set_AssemblyName, addr 0x19830a4, size 0x8, virtual false, abstract: false, final false
  inline void set_AssemblyName(::StringW value);

  /// @brief Method set_TypeName, addr 0x19830b4, size 0x8, virtual false, abstract: false, final false
