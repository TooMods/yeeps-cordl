...
public:
  ...
  /// @brief Method Allows, addr 0x1e7388c, size 0x84, virtual true, abstract: false, final false
  inline bool Allows(::StringW ns);

  /// @brief Method Allows, addr 0x1e73910, size 0x20, virtual false, abstract: false, final false
  inline bool Allows(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method Clone, addr 0x1e736e8, size 0x128, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* Clone();

  /// @brief Method CompareSetToOther, addr 0x1e74770, size 0x128, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* CompareSetToOther(::System::Xml::Schema::NamespaceList* other);

  /// @brief Method Intersection, addr 0x1e74898, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSubset, addr 0x1e73df8, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveNamespace, addr 0x1e74dcc, size 0x60, virtual false, abstract: false, final false
  inline void RemoveNamespace(::StringW tns);

  /// @brief Method ToString, addr 0x1e73930, size 0x4c8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Union, addr 0x1e741e4, size 0x58c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e73440, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e73448, size 0x2a0, virtual false, abstract: false, final false
  inline void _ctor(::StringW namespaces, ::StringW targetNamespace);

  /// @brief Method get_Enumerate, addr 0x1e73820, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Enumerate();

  /// @brief Method get_Excluded, addr 0x1e73818, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Excluded();

  /// @brief Method get_Type, addr 0x1e73810, size 0x8, virtual false, abstract: false, final false
