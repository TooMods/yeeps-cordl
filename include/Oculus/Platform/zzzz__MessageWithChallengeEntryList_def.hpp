...
public:
  // Declarations
  /// @brief Method GetChallengeEntryList, addr 0x19b335c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeEntryList* GetChallengeEntryList();

  /// @brief Method GetDataFromMessage, addr 0x19b3398, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0b4c, size 0x58, virtual false, abstract: false, final false
