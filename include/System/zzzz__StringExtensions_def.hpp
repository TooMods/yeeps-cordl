...
public:
  // Declarations
  /// @brief Method SubstringTrim, addr 0x170eb60, size 0x1c, virtual false, abstract: false, final false
  static inline ::StringW SubstringTrim(::StringW value, int32_t startIndex);

  /// @brief Method SubstringTrim, addr 0x170eb7c, size 0x170, virtual false, abstract: false, final false
