...
public:
  ...
  /// @brief Method SetUnhandledAttributes, addr 0x1ce7058, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce7070, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseUri, addr 0x1ce7038, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_BaseUri();

  /// @brief Method get_Compositor, addr 0x1ce7060, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::Compositor get_Compositor();

  /// @brief Method get_Id, addr 0x1ce7028, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_IdAttribute, addr 0x1ce7048, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IdAttribute();

  /// @brief Method get_Schema, addr 0x1ce7018, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_Schema();

  /// @brief Method get_SchemaLocation, addr 0x1ce7008, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SchemaLocation();

  /// @brief Method set_BaseUri, addr 0x1ce7040, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseUri(::System::Uri* value);

  /// @brief Method set_Compositor, addr 0x1ce7068, size 0x8, virtual false, abstract: false, final false
  inline void set_Compositor(::System::Xml::Schema::Compositor value);

  /// @brief Method set_Id, addr 0x1ce7030, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);

  /// @brief Method set_IdAttribute, addr 0x1ce7050, size 0x8, virtual true, abstract: false, final false
  inline void set_IdAttribute(::StringW value);

  /// @brief Method set_Schema, addr 0x1ce7020, size 0x8, virtual false, abstract: false, final false
  inline void set_Schema(::System::Xml::Schema::XmlSchema* value);

  /// @brief Method set_SchemaLocation, addr 0x1ce7010, size 0x8, virtual false, abstract: false, final false
