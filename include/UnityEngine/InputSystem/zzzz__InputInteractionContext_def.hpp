...
public:
  ...
  /// @brief Method Canceled, addr 0x186c080, size 0x40, virtual false, abstract: false, final false
  inline void Canceled();

  /// @brief Method ComputeMagnitude, addr 0x186bf74, size 0x8, virtual false, abstract: false, final false
  inline float_t ComputeMagnitude();

  /// @brief Method ControlIsActuated, addr 0x186bf7c, size 0xc, virtual false, abstract: false, final false
  inline bool ControlIsActuated(float_t threshold);

  /// @brief Method Performed, addr 0x186bfc0, size 0x40, virtual false, abstract: false, final false
  inline void Performed();

  /// @brief Method PerformedAndStayPerformed, addr 0x186c040, size 0x40, virtual false, abstract: false, final false
  inline void PerformedAndStayPerformed();

  /// @brief Method PerformedAndStayStarted, addr 0x186c000, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTimeout, addr 0x186c100, size 0x24, virtual false, abstract: false, final false
  inline void SetTimeout(float_t seconds);

  /// @brief Method SetTotalTimeoutCompletionTime, addr 0x186c124, size 0x94, virtual false, abstract: false, final false
  inline void SetTotalTimeoutCompletionTime(float_t seconds);

  /// @brief Method Started, addr 0x186bf88, size 0x38, virtual false, abstract: false, final false
  inline void Started();

  /// @brief Method Waiting, addr 0x186c0c0, size 0x40, virtual false, abstract: false, final false
  inline void Waiting();

  /// @brief Method get_action, addr 0x186becc, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_bindingIndex, addr 0x186c1cc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bindingIndex();

  /// @brief Method get_control, addr 0x186bef0, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_controlIndex, addr 0x186c1c0, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_controlIndex();

  /// @brief Method get_interactionIndex, addr 0x186c1d4, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_interactionIndex();

  /// @brief Method get_isStarted, addr 0x186bf64, size 0x10, virtual false, abstract: false, final false
  inline bool get_isStarted();

  /// @brief Method get_isWaiting, addr 0x186bf54, size 0x10, virtual false, abstract: false, final false
  inline bool get_isWaiting();

  /// @brief Method get_mapIndex, addr 0x186c1b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_mapIndex();

  /// @brief Method get_phase, addr 0x186bf14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_startTime, addr 0x186bf24, size 0x8, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_time, addr 0x186bf1c, size 0x8, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_timerHasExpired, addr 0x186bf2c, size 0xc, virtual false, abstract: false, final false
  inline bool get_timerHasExpired();

  /// @brief Method set_timerHasExpired, addr 0x186bf38, size 0x1c, virtual false, abstract: false, final false
