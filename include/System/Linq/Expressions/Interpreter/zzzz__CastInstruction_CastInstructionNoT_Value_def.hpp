...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x1b61ec8, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b61d04, size 0x28, virtual false, abstract: false, final false
