...
public:
  // Declarations
  /// @brief Method GetText, addr 0x24588b4, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW GetText(::StringW fmt, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetText, addr 0x24588b0, size 0x4, virtual false, abstract: false, final false
