...
public:
  // Declarations
  /// @brief Method CreateChainImpl, addr 0x122eacc, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::X509Certificates::X509ChainImpl* CreateChainImpl(bool useMachineContext);

  /// @brief Method GetInvalidChainContextException, addr 0x122eb84, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Exception* GetInvalidChainContextException();

  /// @brief Method GetMonoCertificate, addr 0x122e9f8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x122eb30, size 0x14, virtual false, abstract: false, final false
  static inline bool IsValid(::System::Security::Cryptography::X509Certificates::X509ChainImpl* impl);

  /// @brief Method ThrowIfContextInvalid, addr 0x122eb44, size 0x40, virtual false, abstract: false, final false
