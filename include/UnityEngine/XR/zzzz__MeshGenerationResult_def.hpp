...
public:
  ...
  /// @brief Method Equals, addr 0x18f77ec, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x18f787c, size 0x184, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::MeshGenerationResult other);

  /// @brief Method GetHashCode, addr 0x18f7a00, size 0x208, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_Attributes, addr 0x18f77c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::MeshVertexAttributes get_Attributes();

  /// @brief Method get_Mesh, addr 0x18f77a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_Mesh();

  /// @brief Method get_MeshCollider, addr 0x18f77b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::MeshCollider> get_MeshCollider();

  /// @brief Method get_MeshId, addr 0x18f779c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::MeshId get_MeshId();

  /// @brief Method get_Position, addr 0x18f77c8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Position();

  /// @brief Method get_Rotation, addr 0x18f77d4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_Rotation();

  /// @brief Method get_Scale, addr 0x18f77e0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Scale();

  /// @brief Method get_Status, addr 0x18f77b8, size 0x8, virtual false, abstract: false, final false
