...
public:
  ...
  /// @brief Method Fallback, addr 0x283679c, size 0x1f0, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknown, int32_t index);

  /// @brief Method Fallback, addr 0x283698c, size 0x280, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index);

  /// @brief Method GetNextChar, addr 0x2836c1c, size 0x58, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method MovePrevious, addr 0x2836c74, size 0x20, virtual true, abstract: false, final false
  inline bool MovePrevious();

  static inline ::System::Xml::CharEntityEncoderFallbackBuffer* New_ctor(::System::Xml::CharEntityEncoderFallback* parent);

  /// @brief Method Reset, addr 0x2836cc8, size 0xc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SurrogateCharToUtf32, addr 0x2836c0c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28366a4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::CharEntityEncoderFallback* parent);

  /// @brief Method get_Remaining, addr 0x2836c94, size 0x34, virtual true, abstract: false, final false
