...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::Utilities::Tweenables::Primitives::Vector2TweenableVariable);
// Type: UnityEngine.XR.Interaction.Toolkit.Utilities.Tweenables.Primitives::Vector2TweenableVariable
...
public:
  ...
  /// @brief Method ScheduleTweenJob, addr 0x302295c, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3022a0c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Vector2TweenableVariable", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Vector2TweenableVariable(Vector2TweenableVariable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Vector2TweenableVariable", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::XR::Interaction::Toolkit::Utilities::Tweenables::Primitives::Vector2TweenableVariable, 0xa0>, "Size mismatch!");

} // namespace UnityEngine::XR::Interaction::Toolkit::Utilities::Tweenables::Primitives
NEED_NO_BOX(::UnityEngine::XR::Interaction::Toolkit::Utilities::Tweenables::Primitives::Vector2TweenableVariable);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::Interaction::Toolkit::Utilities::Tweenables::Primitives::Vector2TweenableVariable*, "UnityEngine.XR.Interaction.Toolkit.Utilities.Tweenables.Primitives",
