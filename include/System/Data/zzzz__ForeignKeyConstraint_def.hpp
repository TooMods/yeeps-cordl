...
public:
  ...
  /// @brief Field _parentTableNamespace, offset 0x78, size 0x8
  ...
  /// @brief Method CanBeRemovedFromCollection, addr 0x1c97a1c, size 0x8, virtual true, abstract: false, final false
  inline bool CanBeRemovedFromCollection(::System::Data::ConstraintCollection* constraints, bool fThrowException);

  /// @brief Method CanEnableConstraint, addr 0x1c97f80, size 0x154, virtual true, abstract: false, final false
  inline bool CanEnableConstraint();

  /// @brief Method CascadeCommit, addr 0x1c980d4, size 0x150, virtual false, abstract: false, final false
  inline void CascadeCommit(::System::Data::DataRow* row);

  /// @brief Method CascadeDelete, addr 0x1c98234, size 0x4a4, virtual false, abstract: false, final false
  inline void CascadeDelete(::System::Data::DataRow* row);

  /// @brief Method CascadeRollback, addr 0x1c9873c, size 0x1f4, virtual false, abstract: false, final false
  inline void CascadeRollback(::System::Data::DataRow* row);

  /// @brief Method CascadeUpdate, addr 0x1c98930, size 0x460, virtual false, abstract: false, final false
  inline void CascadeUpdate(::System::Data::DataRow* row);

  /// @brief Method CheckCanAddToCollection, addr 0x1c978f4, size 0x128, virtual true, abstract: false, final false
  inline void CheckCanAddToCollection(::System::Data::ConstraintCollection* constraints);

  /// @brief Method CheckCanClearParentTable, addr 0x1c98d90, size 0xdc, virtual false, abstract: false, final false
  inline void CheckCanClearParentTable(::System::Data::DataTable* table);

  /// @brief Method CheckCanRemoveParentRow, addr 0x1c98e6c, size 0xac, virtual false, abstract: false, final false
  inline void CheckCanRemoveParentRow(::System::Data::DataRow* row);

  /// @brief Method CheckCascade, addr 0x1c98f34, size 0x100, virtual false, abstract: false, final false
  inline void CheckCascade(::System::Data::DataRow* row, ::System::Data::DataRowAction action);

  /// @brief Method CheckConstraint, addr 0x1c99034, size 0x2d4, virtual true, abstract: false, final false
  inline void CheckConstraint(::System::Data::DataRow* childRow, ::System::Data::DataRowAction action);

  /// @brief Method CheckState, addr 0x1c99554, size 0x4, virtual true, abstract: false, final false
  inline void CheckState();

  /// @brief Method Clone, addr 0x1c99610, size 0x10, virtual true, abstract: false, final false
  inline ::System::Data::Constraint* Clone(::System::Data::DataSet* destination);

  /// @brief Method Clone, addr 0x1c99620, size 0x734, virtual true, abstract: false, final false
  inline ::System::Data::Constraint* Clone(::System::Data::DataSet* destination, bool ignorNSforTableLookup);

  /// @brief Method Clone, addr 0x1c99d70, size 0x608, virtual false, abstract: false, final false
  inline ::System::Data::ForeignKeyConstraint* Clone(::System::Data::DataTable* destination);

  /// @brief Method ContainsColumn, addr 0x1c995c8, size 0x48, virtual true, abstract: false, final false
  inline bool ContainsColumn(::System::Data::DataColumn* column);

  /// @brief Method Create, addr 0x1c9769c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x1c9a3e8, size 0xf0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* key);

  /// @brief Method FindParentRelation, addr 0x1c9a500, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Data::DataRelation* FindParentRelation();

  /// @brief Method GetHashCode, addr 0x1c9a4d8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsConstraintViolated, addr 0x1c97ad8, size 0x1f8, virtual true, abstract: false, final false
  inline bool IsConstraintViolated();

  /// @brief Method IsKeyNull, addr 0x1c97a24, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method NonVirtualCheckState, addr 0x1c99308, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c97650, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::StringW constraintName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns);

  /// @brief Method .ctor, addr 0x1c97814, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c97610, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns);

  /// @brief Method get_AcceptRejectRule, addr 0x1c99558, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Data::AcceptRejectRule get_AcceptRejectRule();

  /// @brief Method get_ChildColumnNames, addr 0x1c978e8, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ChildColumnNames();

  /// @brief Method get_ChildKey, addr 0x1c97880, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ChildKey();

  /// @brief Method get_Columns, addr 0x1c9789c, size 0x20, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_Columns();

  /// @brief Method get_DeleteRule, addr 0x1c9a378, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Data::Rule get_DeleteRule();

  /// @brief Method get_ParentColumnNames, addr 0x1c978dc, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ParentColumnNames();

  /// @brief Method get_ParentKey, addr 0x1c98f18, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ParentKey();

  /// @brief Method get_RelatedColumns, addr 0x1c9a4e0, size 0x20, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_RelatedColumns();

  /// @brief Method get_RelatedColumnsReference, addr 0x1c99d54, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_RelatedColumnsReference();

  /// @brief Method get_RelatedTable, addr 0x1c9a5c8, size 0x20, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_RelatedTable();

  /// @brief Method get_Table, addr 0x1c978bc, size 0x20, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_Table();

  /// @brief Method get_UpdateRule, addr 0x1c9a5e8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Data::Rule get_UpdateRule();

  /// @brief Method set_AcceptRejectRule, addr 0x1c99574, size 0x54, virtual true, abstract: false, final false
  inline void set_AcceptRejectRule(::System::Data::AcceptRejectRule value);

  /// @brief Method set_DeleteRule, addr 0x1c9a394, size 0x54, virtual true, abstract: false, final false
  inline void set_DeleteRule(::System::Data::Rule value);

  /// @brief Method set_UpdateRule, addr 0x1c9a604, size 0x54, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Field _parentTableNamespace, offset: 0x78, size: 0x8, def value: None
  ::StringW ____parentTableNamespace;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::System::Data::ForeignKeyConstraint, 0x80>, "Size mismatch!");
...
static_assert(offsetof(::System::Data::ForeignKeyConstraint, ____parentTableNamespace) == 0x78, "Offset mismatch!");
