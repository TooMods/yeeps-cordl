...
public:
  // Declarations
  /// @brief Method Get, addr 0x19c122c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserAccountAgeCategory*>* Get();

  /// @brief Method Report, addr 0x19c1384, size 0x14c, virtual false, abstract: false, final false
