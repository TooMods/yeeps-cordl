...
public:
  ...
  /// @brief Method Create, addr 0x30aa208, size 0x3c, virtual false, abstract: false, final false
  static inline void* Create(::UnityEngine::Networking::DownloadHandlerBuffer* obj);

  /// @brief Method Dispose, addr 0x30aa290, size 0x1c, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetNativeData, addr 0x30aa288, size 0x8, virtual true, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData();

  /// @brief Method InternalCreateBuffer, addr 0x30aa244, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30a8f70, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
