...
public:
  ...
  /// @brief Method Authenticate, addr 0x242e460, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242e458, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
