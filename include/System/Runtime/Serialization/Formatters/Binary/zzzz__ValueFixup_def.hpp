...
public:
  ...
  /// @brief Method Fixup, addr 0x1b3ed04, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b3ec8c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t, ::Array<int32_t>*> indexMap);

  /// @brief Method .ctor, addr 0x1b3ecc0, size 0x44, virtual false, abstract: false, final false
