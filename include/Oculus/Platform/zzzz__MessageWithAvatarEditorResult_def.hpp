...
public:
  // Declarations
  /// @brief Method GetAvatarEditorResult, addr 0x19b2ffc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AvatarEditorResult* GetAvatarEditorResult();

  /// @brief Method GetDataFromMessage, addr 0x19b3038, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b09ec, size 0x58, virtual false, abstract: false, final false
