...
namespace Unity::Services::Core::Internal {
class __AsyncOperationBase____c__DisplayClass17_0;
}
...
MARK_REF_PTR_T(::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0);
// Type: ::<>c__DisplayClass17_0
// SizeInfo { instance_size: 24, native_size: -1, calculated_instance_size: 24, calculated_native_size: 24, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Unity::Services::Core::Internal {
// Is value type: false
// CS Name: ::AsyncOperationBase::<>c__DisplayClass17_0*
class CORDL_TYPE __AsyncOperationBase____c__DisplayClass17_0 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0* New_ctor();

  /// @brief Method <OnCompleted>b__0, addr 0x2669fd0, size 0x1c, virtual false, abstract: false, final false
  inline void _OnCompleted_b__0(::Unity::Services::Core::Internal::IAsyncOperation* op);
  ...
  /// @brief Method .ctor, addr 0x2669fc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __AsyncOperationBase____c__DisplayClass17_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__AsyncOperationBase____c__DisplayClass17_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __AsyncOperationBase____c__DisplayClass17_0(__AsyncOperationBase____c__DisplayClass17_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__AsyncOperationBase____c__DisplayClass17_0", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __AsyncOperationBase____c__DisplayClass17_0(__AsyncOperationBase____c__DisplayClass17_0 const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0, 0x18>, "Size mismatch!");

static_assert(offsetof(::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0, ___continuation) == 0x10, "Offset mismatch!");

} // namespace Unity::Services::Core::Internal
// Type: Unity.Services.Core.Internal::AsyncOperationBase
// SizeInfo { instance_size: 24, native_size: -1, calculated_instance_size: 24, calculated_native_size: 24, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Unity::Services::Core::Internal {
// Is value type: false
...
public:
  // Declarations
  using __c__DisplayClass17_0 = ::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0;
  ...
  /// @brief Method DidComplete, addr 0x2669ee4, size 0x20, virtual false, abstract: false, final false
  ...
  static inline ::Unity::Services::Core::Internal::AsyncOperationBase* New_ctor();

  /// @brief Method OnCompleted, addr 0x2669f04, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2669fc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_Completed, addr 0x2669d54, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_IsDone, addr 0x2669d44, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method get_keepWaiting, addr 0x2669d20, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method remove_Completed, addr 0x2669e3c, size 0xa8, virtual true, abstract: false, final true
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Unity::Services::Core::Internal::AsyncOperationBase, 0x18>, "Size mismatch!");

static_assert(offsetof(::Unity::Services::Core::Internal::AsyncOperationBase, ___m_CompletedCallback) == 0x10, "Offset mismatch!");
...
NEED_NO_BOX(::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0);
DEFINE_IL2CPP_ARG_TYPE(::Unity::Services::Core::Internal::__AsyncOperationBase____c__DisplayClass17_0*, "Unity.Services.Core.Internal", "AsyncOperationBase/<>c__DisplayClass17_0");
