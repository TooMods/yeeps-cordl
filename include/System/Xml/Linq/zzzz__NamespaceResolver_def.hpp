...
public:
  ...
  /// @brief Method .ctor, addr 0x1334838, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x1334724, size 0x9c, virtual false, abstract: false, final false
  inline void Add(::StringW prefix, ::System::Xml::Linq::XNamespace* ns);

  /// @brief Method AddFirst, addr 0x13345a8, size 0x98, virtual false, abstract: false, final false
  inline void AddFirst(::StringW prefix, ::System::Xml::Linq::XNamespace* ns);

  /// @brief Method GetPrefixOfNamespace, addr 0x13344cc, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace* ns, bool allowDefaultNamespace);

  /// @brief Method PopScope, addr 0x13347c0, size 0x78, virtual false, abstract: false, final false
  inline void PopScope();

  /// @brief Method PushScope, addr 0x1334714, size 0x10, virtual false, abstract: false, final false
