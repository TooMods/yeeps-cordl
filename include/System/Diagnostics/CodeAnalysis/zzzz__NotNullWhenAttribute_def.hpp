...
public:
  ...
  /// @brief Method .ctor, addr 0x25c3fcc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool returnValue);

  /// @brief Method get_ReturnValue, addr 0x25c3ff4, size 0x8, virtual false, abstract: false, final false
