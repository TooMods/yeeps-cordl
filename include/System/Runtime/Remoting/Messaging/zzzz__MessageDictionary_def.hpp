...
public:
  ...
  /// @brief Method MoveNext, addr 0x1865500, size 0x1c4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x18656c4, size 0xac, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x18651ec, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::MessageDictionary* methodDictionary);

  /// @brief Method get_Current, addr 0x1865330, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* get_Current();

  /// @brief Method get_Entry, addr 0x1865394, size 0x16c, virtual true, abstract: false, final true
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x1865770, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x1865774, size 0x14, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x18642c0, size 0x168, virtual true, abstract: false, final true
  inline void Add(::System::Object* key, ::System::Object* value);

  /// @brief Method AllocInternalProperties, addr 0x186406c, size 0x68, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* AllocInternalProperties();

  /// @brief Method Clear, addr 0x1864c7c, size 0xac, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x1864d28, size 0x148, virtual true, abstract: false, final true
  inline bool Contains(::System::Object* key);

  /// @brief Method CopyTo, addr 0x18650cc, size 0xc0, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x18652d0, size 0x60, virtual true, abstract: false, final true
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetInternalProperties, addr 0x1860a88, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetInternalProperties();

  /// @brief Method GetMethodProperty, addr 0x1861d60, size 0x540, virtual true, abstract: false, final false
  inline ::System::Object* GetMethodProperty(::StringW key);

  /// @brief Method HasUserData, addr 0x185e7d4, size 0xfc, virtual false, abstract: false, final false
  inline bool HasUserData();

  /// @brief Method IsOverridenKey, addr 0x18640d4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x1864e70, size 0x188, virtual true, abstract: false, final true
  inline void Remove(::System::Object* key);

  /// @brief Method SetMethodProperty, addr 0x186250c, size 0x2e0, virtual true, abstract: false, final false
  inline void SetMethodProperty(::StringW key, ::System::Object* value);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x186518c, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x186198c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodMessage* message);

  /// @brief Method get_Count, addr 0x1864ff8, size 0xc8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_InternalDictionary, addr 0x185e8d0, size 0x88, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* get_InternalDictionary();

  /// @brief Method get_IsFixedSize, addr 0x1864160, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x1864168, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x18650c0, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x1864170, size 0x14c, virtual true, abstract: false, final true
  inline ::System::Object* get_Item(::System::Object* key);

  /// @brief Method get_Keys, addr 0x1864428, size 0x434, virtual true, abstract: false, final true
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_SyncRoot, addr 0x18650c8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* get_SyncRoot();

  /// @brief Method get_Values, addr 0x186485c, size 0x420, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x18642bc, size 0x4, virtual true, abstract: false, final true
  inline void set_Item(::System::Object* key, ::System::Object* value);

  /// @brief Method set_MethodKeys, addr 0x1864064, size 0x8, virtual false, abstract: false, final false
