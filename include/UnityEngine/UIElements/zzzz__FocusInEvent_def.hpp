...
public:
  // Declarations
  /// @brief Method Init, addr 0x2cd1904, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd1958, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::FocusInEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2cd1964, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
