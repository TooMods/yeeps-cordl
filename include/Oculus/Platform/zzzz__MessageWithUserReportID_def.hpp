...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5e98, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetDataFromMessage(void* c_message);

  /// @brief Method GetUserReportID, addr 0x19b5e5c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b5e04, size 0x58, virtual false, abstract: false, final false
