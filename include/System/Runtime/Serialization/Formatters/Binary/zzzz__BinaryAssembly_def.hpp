...
public:
  ...
  /// @brief Method Dump, addr 0x1ab2620, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryAssembly* New_ctor();

  /// @brief Method Read, addr 0x1ab25dc, size 0x44, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x1ab2560, size 0xc, virtual false, abstract: false, final false
  inline void Set(int32_t assemId, ::StringW assemblyString);

  /// @brief Method Write, addr 0x1ab256c, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab2558, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
