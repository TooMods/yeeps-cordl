...
namespace System::IO {
struct __StreamReader___ReadToEndAsyncInternal_d__63;
}
...
MARK_VAL_T(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63);
// Type: ::<ReadToEndAsyncInternal>d__63
// SizeInfo { instance_size: 64, native_size: -1, calculated_instance_size: 64, calculated_native_size: 80, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace System::IO {
// Is value type: true
// CS Name: ::StreamReader::<ReadToEndAsyncInternal>d__63
struct CORDL_TYPE __StreamReader___ReadToEndAsyncInternal_d__63 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x257bb08, size 0x2bc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x257bdc4, size 0x58, virtual true, abstract: false, final true
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __StreamReader___ReadToEndAsyncInternal_d__63();
  ...
  constexpr __StreamReader___ReadToEndAsyncInternal_d__63(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::StringW> __t__builder,
...
static_assert(::cordl_internals::size_check_v<::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, 0x40>, "Size mismatch!");

static_assert(offsetof(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, _sb_5__2) == 0x28, "Offset mismatch!");

static_assert(offsetof(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, __u__1) == 0x30, "Offset mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x257be1c, size 0xb20, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x257c93c, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x257c994, size 0x5f8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x257cf8c, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  using _ReadToEndAsyncInternal_d__63 = ::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63;
  ...
  /// @brief Method CheckAsyncTaskInProgress, addr 0x2578fd8, size 0x64, virtual false, abstract: false, final false
  inline void CheckAsyncTaskInProgress();

  /// @brief Method Close, addr 0x2579818, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CompressBuffer, addr 0x257a744, size 0x44, virtual false, abstract: false, final false
  inline void CompressBuffer(int32_t n);

  /// @brief Method DataAvailable, addr 0x257b91c, size 0x10, virtual false, abstract: false, final false
  inline bool DataAvailable();

  /// @brief Method DetectEncoding, addr 0x257a788, size 0x2b8, virtual false, abstract: false, final false
  inline void DetectEncoding();

  /// @brief Method DiscardBufferedData, addr 0x2579918, size 0x3c, virtual false, abstract: false, final false
  inline void DiscardBufferedData();

  /// @brief Method Dispose, addr 0x2579828, size 0xd0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Init, addr 0x2579808, size 0x10, virtual false, abstract: false, final false
  inline void Init(::System::IO::Stream* stream);

  /// @brief Method Init, addr 0x2579414, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPreamble, addr 0x257aa40, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x25799f0, size 0xc8, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x2579ab8, size 0xc8, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x2579b80, size 0x1c0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Read, addr 0x2579fa8, size 0xe0, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<char16_t> buffer);

  /// @brief Method ReadAsync, addr 0x257b23c, size 0x2e4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsyncInternal, addr 0x257b728, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadBuffer, addr 0x257ab70, size 0x16c, virtual true, abstract: false, final false
  inline int32_t ReadBuffer();

  /// @brief Method ReadBuffer, addr 0x257a318, size 0x310, virtual false, abstract: false, final false
  inline int32_t ReadBuffer(::System::Span_1<char16_t> userBuffer, ByRef<bool> readToUserBuffer);

  /// @brief Method ReadBufferAsync, addr 0x257b824, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadBufferAsync();

  /// @brief Method ReadLine, addr 0x257acdc, size 0x260, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadSpan, addr 0x2579d40, size 0x268, virtual false, abstract: false, final false
  inline int32_t ReadSpan(::System::Span_1<char16_t> buffer);

  /// @brief Method ReadToEnd, addr 0x257a628, size 0x11c, virtual true, abstract: false, final false
  inline ::StringW ReadToEnd();

  /// @brief Method ReadToEndAsync, addr 0x257af3c, size 0x124, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::StringW>* ReadToEndAsync();

  /// @brief Method ReadToEndAsyncInternal, addr 0x257b150, size 0xec, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::StringW>* ReadToEndAsyncInternal();

  /// @brief Method ThrowAsyncIOInProgress, addr 0x257903c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x257908c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x257953c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW path);

  /// @brief Method .ctor, addr 0x2579574, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool detectEncodingFromByteOrderMarks);

  /// @brief Method .ctor, addr 0x25797fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::System::Text::Encoding* encoding, bool detectEncodingFromByteOrderMarks);

  /// @brief Method .ctor, addr 0x25795b0, size 0x24c, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::System::Text::Encoding* encoding, bool detectEncodingFromByteOrderMarks, int32_t bufferSize);

  /// @brief Method .ctor, addr 0x2579150, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream);

  /// @brief Method .ctor, addr 0x257918c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, bool detectEncodingFromByteOrderMarks);

  /// @brief Method .ctor, addr 0x25793f4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x2579404, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Text::Encoding* encoding, bool detectEncodingFromByteOrderMarks);

  /// @brief Method .ctor, addr 0x25791cc, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseStream, addr 0x2579910, size 0x8, virtual true, abstract: false, final false
  inline ::System::IO::Stream* get_BaseStream();

  /// @brief Method get_CurrentEncoding, addr 0x2579908, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::Encoding* get_CurrentEncoding();

  /// @brief Method get_EndOfStream, addr 0x2579954, size 0x9c, virtual false, abstract: false, final false
  inline bool get_EndOfStream();

  /// @brief Method get_LeaveOpen, addr 0x25798f8, size 0x10, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::System::IO::__StreamReader___ReadToEndAsyncInternal_d__63, "System.IO", "StreamReader/<ReadToEndAsyncInternal>d__63");
