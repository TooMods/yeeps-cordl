...
public:
  ...
  /// @brief Method .ctor, addr 0x2b0c464, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::AttributeTargets validOn);

  static inline ::System::AttributeUsageAttribute* getStaticF_Default();

  /// @brief Method get_AllowMultiple, addr 0x2b0c49c, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowMultiple();

  /// @brief Method get_Inherited, addr 0x2b0c4b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_Inherited();

  static inline void setStaticF_Default(::System::AttributeUsageAttribute* value);

  /// @brief Method set_AllowMultiple, addr 0x2b0c4a4, size 0xc, virtual false, abstract: false, final false
  inline void set_AllowMultiple(bool value);

  /// @brief Method set_Inherited, addr 0x2b0c4b8, size 0xc, virtual false, abstract: false, final false
