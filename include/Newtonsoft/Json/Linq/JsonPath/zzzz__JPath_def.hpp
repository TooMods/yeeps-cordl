...
public:
  ...
  /// @brief Method CreatePathFilter, addr 0x11a2b28, size 0x88, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* CreatePathFilter(::StringW member, bool scan);

  /// @brief Method CreateUnexpectedCharacterException, addr 0x11a4140, size 0xbc, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::JsonException* CreateUnexpectedCharacterException();

  /// @brief Method EatWhitespace, addr 0x11a24cc, size 0x54, virtual false, abstract: false, final false
  inline void EatWhitespace();

  /// @brief Method EnsureLength, addr 0x11a2ce0, size 0x74, virtual false, abstract: false, final false
  inline void EnsureLength(::StringW message);

  /// @brief Method Evaluate, addr 0x11a4eec, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method Evaluate, addr 0x11a4e6c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Match, addr 0x11a4920, size 0xa0, virtual false, abstract: false, final false
  inline bool Match(::StringW s);

  static inline ::Newtonsoft::Json::Linq::JsonPath::JPath* New_ctor(::StringW expression);

  /// @brief Method ParseArrayIndexer, addr 0x11a32ac, size 0x798, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseArrayIndexer(char16_t indexerCloseChar);

  /// @brief Method ParseExpression, addr 0x11a3a44, size 0x4b8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JsonPath::QueryExpression* ParseExpression();

  /// @brief Method ParseIndexer, addr 0x11a2bb0, size 0x108, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseIndexer(char16_t indexerOpenChar, bool scan);

  /// @brief Method ParseMain, addr 0x11a236c, size 0x160, virtual false, abstract: false, final false
  inline void ParseMain();

  /// @brief Method ParseOperator, addr 0x11a467c, size 0x268, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JsonPath::QueryOperator ParseOperator();

  /// @brief Method ParsePath, addr 0x11a2520, size 0x608, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseQuery, addr 0x11a30d8, size 0x1d4, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseQuery(char16_t indexerCloseChar, bool scan);

  /// @brief Method ParseQuotedField, addr 0x11a2d54, size 0x384, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseQuotedField(char16_t indexerCloseChar, bool scan);

  /// @brief Method ParseSide, addr 0x11a41fc, size 0x114, virtual false, abstract: false, final false
  inline ::System::Object* ParseSide();

  /// @brief Method ReadQuotedString, addr 0x11a4a50, size 0x284, virtual false, abstract: false, final false
  inline ::StringW ReadQuotedString();

  /// @brief Method ReadRegexString, addr 0x11a4cd4, size 0x170, virtual false, abstract: false, final false
  inline ::StringW ReadRegexString();

  /// @brief Method TryParseExpression, addr 0x11a3f4c, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x11a4310, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a22b4, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::StringW expression);

  static inline ::ArrayW<char16_t, ::Array<char16_t>*> getStaticF_FloatCharacters();

  /// @brief Method get_Filters, addr 0x11a22ac, size 0x8, virtual false, abstract: false, final false
