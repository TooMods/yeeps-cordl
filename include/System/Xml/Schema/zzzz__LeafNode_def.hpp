...
public:
  ...
  /// @brief Method ConstructPos, addr 0x3051394, size 0x40, virtual true, abstract: false, final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method ExpandTree, addr 0x3051390, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3051358, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t pos);

  /// @brief Method get_IsNullable, addr 0x30513d4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Pos, addr 0x3051380, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Pos();

  /// @brief Method set_Pos, addr 0x3051388, size 0x8, virtual false, abstract: false, final false
