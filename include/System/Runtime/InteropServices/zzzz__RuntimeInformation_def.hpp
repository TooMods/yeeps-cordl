...
public:
  ...
  /// @brief Method GetOSName, addr 0x1b413d8, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetOSName();

  /// @brief Method GetRuntimeArchitecture, addr 0x1b413d4, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetRuntimeArchitecture();

  /// @brief Method IsOSPlatform, addr 0x1b41454, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FrameworkDescription, addr 0x1b413dc, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW get_FrameworkDescription();

  /// @brief Method get_OSDescription, addr 0x1b414e8, size 0x20, virtual false, abstract: false, final false
  static inline ::StringW get_OSDescription();
