...
public:
  ...
  /// @brief Method CalculateLayoutInputHorizontal, addr 0x26edd50, size 0x1cc, virtual true, abstract: false, final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x26ee35c, size 0x228, virtual true, abstract: false, final false
  inline void CalculateLayoutInputVertical();

  static inline ::UnityEngine::UI::GridLayoutGroup* New_ctor();

  /// @brief Method SetCellsAlongAxis, addr 0x26ee620, size 0x5d8, virtual false, abstract: false, final false
  inline void SetCellsAlongAxis(int32_t axis);

  /// @brief Method SetLayoutHorizontal, addr 0x26ee618, size 0x8, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x26eebf8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26edbbc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cellSize, addr 0x26eda18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_cellSize();

  /// @brief Method get_constraint, addr 0x26edaf0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__GridLayoutGroup__Constraint get_constraint();

  /// @brief Method get_constraintCount, addr 0x26edb54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_constraintCount();

  /// @brief Method get_spacing, addr 0x26eda84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_spacing();

  /// @brief Method get_startAxis, addr 0x26ed9b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__GridLayoutGroup__Axis get_startAxis();

  /// @brief Method get_startCorner, addr 0x26ed950, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__GridLayoutGroup__Corner get_startCorner();

  /// @brief Method set_cellSize, addr 0x26eda20, size 0x64, virtual false, abstract: false, final false
  inline void set_cellSize(::UnityEngine::Vector2 value);

  /// @brief Method set_constraint, addr 0x26edaf8, size 0x5c, virtual false, abstract: false, final false
  inline void set_constraint(::UnityEngine::UI::__GridLayoutGroup__Constraint value);

  /// @brief Method set_constraintCount, addr 0x26edb5c, size 0x60, virtual false, abstract: false, final false
  inline void set_constraintCount(int32_t value);

  /// @brief Method set_spacing, addr 0x26eda8c, size 0x64, virtual false, abstract: false, final false
  inline void set_spacing(::UnityEngine::Vector2 value);

  /// @brief Method set_startAxis, addr 0x26ed9bc, size 0x5c, virtual false, abstract: false, final false
  inline void set_startAxis(::UnityEngine::UI::__GridLayoutGroup__Axis value);

  /// @brief Method set_startCorner, addr 0x26ed958, size 0x5c, virtual false, abstract: false, final false
