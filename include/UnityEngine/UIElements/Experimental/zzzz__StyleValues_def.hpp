...
public:
  ...
  /// @brief Method SetValue, addr 0x1f3239c, size 0x84, virtual false, abstract: false, final false
  inline void SetValue(::UnityEngine::UIElements::StyleSheets::StylePropertyId id, ::UnityEngine::Color value);

  /// @brief Method SetValue, addr 0x1f322d4, size 0x84, virtual false, abstract: false, final false
  inline void SetValue(::UnityEngine::UIElements::StyleSheets::StylePropertyId id, float_t value);

  /// @brief Method Values, addr 0x1f324b8, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueCollection* Values();

  /// @brief Method get_paddingTop, addr 0x1f3247c, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_paddingTop();

  /// @brief Method set_backgroundColor, addr 0x1f32420, size 0x8, virtual false, abstract: false, final false
  inline void set_backgroundColor(::UnityEngine::Color value);

  /// @brief Method set_borderBottomLeftRadius, addr 0x1f32590, size 0xc, virtual false, abstract: false, final false
  inline void set_borderBottomLeftRadius(float_t value);

  /// @brief Method set_borderBottomRightRadius, addr 0x1f3259c, size 0xc, virtual false, abstract: false, final false
  inline void set_borderBottomRightRadius(float_t value);

  /// @brief Method set_borderBottomWidth, addr 0x1f3256c, size 0xc, virtual false, abstract: false, final false
  inline void set_borderBottomWidth(float_t value);

  /// @brief Method set_borderColor, addr 0x1f32434, size 0xc, virtual false, abstract: false, final false
  inline void set_borderColor(::UnityEngine::Color value);

  /// @brief Method set_borderLeftWidth, addr 0x1f32548, size 0xc, virtual false, abstract: false, final false
  inline void set_borderLeftWidth(float_t value);

  /// @brief Method set_borderRightWidth, addr 0x1f32554, size 0xc, virtual false, abstract: false, final false
  inline void set_borderRightWidth(float_t value);

  /// @brief Method set_borderTopLeftRadius, addr 0x1f32578, size 0xc, virtual false, abstract: false, final false
  inline void set_borderTopLeftRadius(float_t value);

  /// @brief Method set_borderTopRightRadius, addr 0x1f32584, size 0xc, virtual false, abstract: false, final false
  inline void set_borderTopRightRadius(float_t value);

  /// @brief Method set_borderTopWidth, addr 0x1f32560, size 0xc, virtual false, abstract: false, final false
  inline void set_borderTopWidth(float_t value);

  /// @brief Method set_bottom, addr 0x1f32388, size 0xc, virtual false, abstract: false, final false
  inline void set_bottom(float_t value);

  /// @brief Method set_color, addr 0x1f32394, size 0x8, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_flexGrow, addr 0x1f325b4, size 0xc, virtual false, abstract: false, final false
  inline void set_flexGrow(float_t value);

  /// @brief Method set_flexShrink, addr 0x1f325c0, size 0xc, virtual false, abstract: false, final false
  inline void set_flexShrink(float_t value);

  /// @brief Method set_height, addr 0x1f32370, size 0xc, virtual false, abstract: false, final false
  inline void set_height(float_t value);

  /// @brief Method set_left, addr 0x1f32358, size 0xc, virtual false, abstract: false, final false
  inline void set_left(float_t value);

  /// @brief Method set_marginBottom, addr 0x1f32464, size 0xc, virtual false, abstract: false, final false
  inline void set_marginBottom(float_t value);

  /// @brief Method set_marginLeft, addr 0x1f32440, size 0xc, virtual false, abstract: false, final false
  inline void set_marginLeft(float_t value);

  /// @brief Method set_marginRight, addr 0x1f32458, size 0xc, virtual false, abstract: false, final false
  inline void set_marginRight(float_t value);

  /// @brief Method set_marginTop, addr 0x1f3244c, size 0xc, virtual false, abstract: false, final false
  inline void set_marginTop(float_t value);

  /// @brief Method set_opacity, addr 0x1f325a8, size 0xc, virtual false, abstract: false, final false
  inline void set_opacity(float_t value);

  /// @brief Method set_paddingBottom, addr 0x1f3253c, size 0xc, virtual false, abstract: false, final false
  inline void set_paddingBottom(float_t value);

  /// @brief Method set_paddingLeft, addr 0x1f32470, size 0xc, virtual false, abstract: false, final false
  inline void set_paddingLeft(float_t value);

  /// @brief Method set_paddingRight, addr 0x1f32530, size 0xc, virtual false, abstract: false, final false
  inline void set_paddingRight(float_t value);

  /// @brief Method set_paddingTop, addr 0x1f32524, size 0xc, virtual false, abstract: false, final false
  inline void set_paddingTop(float_t value);

  /// @brief Method set_right, addr 0x1f3237c, size 0xc, virtual false, abstract: false, final false
  inline void set_right(float_t value);

  /// @brief Method set_top, addr 0x1f322c8, size 0xc, virtual false, abstract: false, final false
  inline void set_top(float_t value);

  /// @brief Method set_unityBackgroundImageTintColor, addr 0x1f32428, size 0xc, virtual false, abstract: false, final false
  inline void set_unityBackgroundImageTintColor(::UnityEngine::Color value);

  /// @brief Method set_width, addr 0x1f32364, size 0xc, virtual false, abstract: false, final false
