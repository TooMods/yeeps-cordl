...
public:
  ...
  /// @brief Method AddLineInfo, addr 0x14d5e5c, size 0x258, virtual false, abstract: false, final false
  static inline ::StringW AddLineInfo(::StringW message, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method CalcBufferSize, addr 0x14d695c, size 0x84, virtual false, abstract: false, final false
  static inline int32_t CalcBufferSize(::System::IO::Stream* input);

  /// @brief Method CanReadContentAs, addr 0x14d4520, size 0x6c, virtual false, abstract: false, final false
  inline bool CanReadContentAs();

  /// @brief Method CanReadContentAs, addr 0x14d5be4, size 0x70, virtual false, abstract: false, final false
  static inline bool CanReadContentAs(::System::Xml::XmlNodeType nodeType);

  /// @brief Method Close, addr 0x14d48b4, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Create, addr 0x14d619c, size 0x90, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlReader* Create(::System::IO::Stream* input, ::System::Xml::XmlReaderSettings* settings, ::StringW baseUri);

  /// @brief Method Create, addr 0x14d63e4, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlReader* Create(::System::IO::TextReader* input, ::System::Xml::XmlReaderSettings* settings);

  /// @brief Method Create, addr 0x14d646c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReadContentAsException, addr 0x14d458c, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Exception* CreateReadContentAsException(::StringW methodName);

  /// @brief Method CreateReadContentAsException, addr 0x14d5cc4, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSqlReader, addr 0x14d6624, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWriterForInnerOuterXml, addr 0x14d54d0, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriter* CreateWriterForInnerOuterXml(::System::IO::StringWriter* sw);

  /// @brief Method Dispose, addr 0x14cd220, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x14d5b98, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method HasValueInternal, addr 0x14d5c54, size 0x70, virtual false, abstract: false, final false
  static inline bool HasValueInternal(::System::Xml::XmlNodeType nodeType);

  /// @brief Method InternalReadContentAsString, addr 0x14d462c, size 0x1b8, virtual false, abstract: false, final false
  inline ::StringW InternalReadContentAsString();

  /// @brief Method IsStartElement, addr 0x14d5190, size 0x84, virtual true, abstract: false, final false
  inline bool IsStartElement(::StringW localname, ::StringW ns);

  /// @brief Method IsTextualNode, addr 0x14d4c04, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveToAttribute, addr 0x14d47e4, size 0xd0, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToContent, addr 0x14d4c74, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadContentAsString, addr 0x14d44d0, size 0x50, virtual true, abstract: false, final false
  inline ::StringW ReadContentAsString();

  /// @brief Method ReadElementString, addr 0x14d4df0, size 0x2a8, virtual true, abstract: false, final false
  inline ::StringW ReadElementString();

  /// @brief Method ReadEndElement, addr 0x14d5098, size 0xf8, virtual true, abstract: false, final false
  inline void ReadEndElement();

  /// @brief Method ReadInnerXml, addr 0x14d5214, size 0x2bc, virtual true, abstract: false, final false
  inline ::StringW ReadInnerXml();

  /// @brief Method ReadStartElement, addr 0x14d4cf8, size 0xf8, virtual true, abstract: false, final false
  inline void ReadStartElement();

  /// @brief Method ReadString, addr 0x14d4a30, size 0x1d4, virtual true, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ReadValueChunk, addr 0x14d49d0, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method SetNamespacesFlag, addr 0x14d5a68, size 0xf0, virtual false, abstract: false, final false
  inline void SetNamespacesFlag(::System::Xml::XmlTextWriter* xtw);

  /// @brief Method Skip, addr 0x14d48b8, size 0x34, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method SkipSubtree, addr 0x14d48ec, size 0xd4, virtual false, abstract: false, final false
  inline bool SkipSubtree();

  /// @brief Method WriteAttributeValue, addr 0x14d554c, size 0xd4, virtual false, abstract: false, final false
  inline void WriteAttributeValue(::System::Xml::XmlWriter* xtw);

  /// @brief Method WriteNode, addr 0x14d5620, size 0x448, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanReadValueChunk, addr 0x14d49c8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanReadValueChunk();

  /// @brief Method get_CanResolveEntity, addr 0x14d49c0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_DtdInfo, addr 0x14d6194, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_HasAttributes, addr 0x14d5b74, size 0x24, virtual true, abstract: false, final false
  inline bool get_HasAttributes();

  /// @brief Method get_IsDefault, addr 0x14d43bc, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsDefaultInternal, addr 0x14d60b4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Name, addr 0x14d42d8, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceManager, addr 0x14d5bdc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_QuoteChar, addr 0x14d43c4, size 0x8, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_SchemaInfo, addr 0x14d441c, size 0x48, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Settings, addr 0x14d42d0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ValueType, addr 0x14d4464, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlLang, addr 0x14d43d4, size 0x48, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x14d43cc, size 0x8, virtual true, abstract: false, final false
