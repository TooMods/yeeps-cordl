...
public:
  ...
  /// @brief Method Dispose, addr 0x196ed7c, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x196ed8c, size 0x14, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Equals, addr 0x196eda0, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x196ee34, size 0xec, virtual true, abstract: false, final false
  inline bool Equals(::System::Security::Cryptography::X509Certificates::X509Certificate* other);

  /// @brief Method FormatDate, addr 0x196f654, size 0x110, virtual false, abstract: false, final false
  static inline ::StringW FormatDate(::System::DateTime date);

  /// @brief Method GetCertHash, addr 0x196ef70, size 0x24, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCertHash();

  /// @brief Method GetCertHashString, addr 0x196efe0, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetCertHashString();

  /// @brief Method GetHashCode, addr 0x196f038, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetKeyAlgorithm, addr 0x196f0b0, size 0x58, virtual true, abstract: false, final false
  inline ::StringW GetKeyAlgorithm();

  /// @brief Method GetKeyAlgorithmParameters, addr 0x196f108, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKeyAlgorithmParameters();

  /// @brief Method GetNotAfter, addr 0x196f764, size 0x9c, virtual false, abstract: false, final false
  inline ::System::DateTime GetNotAfter();

  /// @brief Method GetNotBefore, addr 0x196f5b8, size 0x9c, virtual false, abstract: false, final false
  inline ::System::DateTime GetNotBefore();

  /// @brief Method GetPublicKey, addr 0x196f164, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPublicKey();

  /// @brief Method GetRawCertData, addr 0x196f004, size 0x34, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawCertData();

  /// @brief Method GetRawCertHash, addr 0x196ef94, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawCertHash();

  /// @brief Method GetRawSerialNumber, addr 0x196ef20, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawSerialNumber();

  /// @brief Method GetSerialNumber, addr 0x196f1c0, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSerialNumber();

  /// @brief Method GetSerialNumberString, addr 0x196f228, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetSerialNumberString();

  /// @brief Method ImportHandle, addr 0x196f800, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x196e6e0, size 0xb4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x196ec8c, size 0x40, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x196ec4c, size 0x40, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ThrowIfInvalid, addr 0x196ed20, size 0x8, virtual false, abstract: false, final false
  inline void ThrowIfInvalid();

  /// @brief Method ToString, addr 0x196f24c, size 0x14, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x196f260, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x196e804, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x196ea78, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x196e878, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x196e9c0, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509CertificateImpl* impl);

  /// @brief Method .ctor, addr 0x196ec08, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_Impl, addr 0x196f830, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* get_Impl();

  /// @brief Method get_IsValid, addr 0x196f838, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_Issuer, addr 0x196eccc, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_Issuer();

  /// @brief Method get_Subject, addr 0x196ed28, size 0x54, virtual false, abstract: false, final false
