...
public:
  ...
  /// @brief Method Equals, addr 0x2a96944, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a9686c, size 0xb0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderStateBlock other);

  /// @brief Method GetHashCode, addr 0x2a969d4, size 0x8c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x2a966e0, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::RenderStateMask mask);

  /// @brief Method get_depthState, addr 0x2a96820, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DepthState get_depthState();

  /// @brief Method get_mask, addr 0x2a9685c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderStateMask get_mask();

  /// @brief Method get_stencilReference, addr 0x2a9684c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_stencilReference();

  /// @brief Method get_stencilState, addr 0x2a96830, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_blendState, addr 0x2a96800, size 0x14, virtual false, abstract: false, final false
  inline void set_blendState(::UnityEngine::Rendering::BlendState value);

  /// @brief Method set_depthState, addr 0x2a96828, size 0x8, virtual false, abstract: false, final false
  inline void set_depthState(::UnityEngine::Rendering::DepthState value);

  /// @brief Method set_mask, addr 0x2a96864, size 0x8, virtual false, abstract: false, final false
  inline void set_mask(::UnityEngine::Rendering::RenderStateMask value);

  /// @brief Method set_rasterState, addr 0x2a96814, size 0xc, virtual false, abstract: false, final false
  inline void set_rasterState(::UnityEngine::Rendering::RasterState value);

  /// @brief Method set_stencilReference, addr 0x2a96854, size 0x8, virtual false, abstract: false, final false
  inline void set_stencilReference(int32_t value);

  /// @brief Method set_stencilState, addr 0x2a96840, size 0xc, virtual false, abstract: false, final false
