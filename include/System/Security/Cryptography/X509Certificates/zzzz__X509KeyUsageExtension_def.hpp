...
public:
  ...
  /// @brief Method CopyFrom, addr 0x122f1e4, size 0x1e0, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Decode, addr 0x122ed74, size 0x1b4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> extension);

  /// @brief Method Encode, addr 0x122f010, size 0x168, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode();

  /// @brief Method GetValidFlags, addr 0x122f000, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x122f3c4, size 0x530, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122ec0c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x122eca8, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* encodedKeyUsage, bool critical);

  /// @brief Method .ctor, addr 0x122ef28, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags keyUsages, bool critical);

  /// @brief Method get_KeyUsages, addr 0x122f178, size 0x6c, virtual false, abstract: false, final false
