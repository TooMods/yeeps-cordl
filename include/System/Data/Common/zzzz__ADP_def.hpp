...
public:
  ...
  /// @brief Method Argument, addr 0x1e4227c, size 0x90, virtual false, abstract: false, final false
  static inline ::System::ArgumentException* Argument(::StringW error);

  /// @brief Method ArgumentOutOfRange, addr 0x1e4230c, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW message, ::StringW parameterName);

  /// @brief Method ArgumentOutOfRange, addr 0x1e3fa2c, size 0x90, virtual false, abstract: false, final false
  static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW parameterName);

  /// @brief Method InvalidAcceptRejectRule, addr 0x1e427ac, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::ArgumentOutOfRangeException* InvalidAcceptRejectRule(::System::Data::AcceptRejectRule value);

  /// @brief Method InvalidEnumerationValue, addr 0x1e426a0, size 0x10c, virtual false, abstract: false, final false
  static inline ::System::ArgumentOutOfRangeException* InvalidEnumerationValue(::System::Type* type, int32_t value);

  /// @brief Method InvalidMissingSchemaAction, addr 0x1e4285c, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::ArgumentOutOfRangeException* InvalidMissingSchemaAction(::System::Data::MissingSchemaAction value);

  /// @brief Method InvalidOperation, addr 0x1e423ac, size 0x90, virtual false, abstract: false, final false
  static inline ::System::InvalidOperationException* InvalidOperation(::StringW error);

  /// @brief Method InvalidRule, addr 0x1e4290c, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::ArgumentOutOfRangeException* InvalidRule(::System::Data::Rule value);

  /// @brief Method InvalidSeekOrigin, addr 0x1e41954, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Exception* InvalidSeekOrigin(::StringW parameterName);

  /// @brief Method IsCatchableExceptionType, addr 0x1e40ca8, size 0x20c, virtual false, abstract: false, final false
  static inline bool IsCatchableExceptionType(::System::Exception* e);

  /// @brief Method IsCatchableOrSecurityExceptionType, addr 0x1e424cc, size 0x1d4, virtual false, abstract: false, final false
  static inline bool IsCatchableOrSecurityExceptionType(::System::Exception* e);

  /// @brief Method NotSupported, addr 0x1e4243c, size 0x90, virtual false, abstract: false, final false
  static inline ::System::NotSupportedException* NotSupported(::StringW error);

  /// @brief Method TraceException, addr 0x1e4210c, size 0x98, virtual false, abstract: false, final false
  static inline void TraceException(::StringW trace, ::System::Exception* e);

  /// @brief Method TraceExceptionAsReturnValue, addr 0x1e421a4, size 0x6c, virtual false, abstract: false, final false
  static inline void TraceExceptionAsReturnValue(::System::Exception* e);

  /// @brief Method TraceExceptionWithoutRethrow, addr 0x1e42210, size 0x6c, virtual false, abstract: false, final false
  static inline void TraceExceptionWithoutRethrow(::System::Exception* e);

  /// @brief Method WrongType, addr 0x1e2dfe0, size 0xc4, virtual false, abstract: false, final false
