...
public:
  ...
  /// @brief Method CurrentTime, addr 0x12875e4, size 0x50, virtual false, abstract: false, final false
  static inline int64_t CurrentTime();

  /// @brief Method GetAdditionalBinding, addr 0x1287120, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IBinding* GetAdditionalBinding(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetBindingObjectFromElement, addr 0x1286fe8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method OnHierarchyChange, addr 0x12875cc, size 0x18, virtual true, abstract: false, final false
  inline void OnHierarchyChange(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::HierarchyChangeType type);

  /// @brief Method OnVersionChanged, addr 0x12874d4, size 0xf8, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method PerformTrackingOperations, addr 0x1287634, size 0x284, virtual false, abstract: false, final false
  inline void PerformTrackingOperations();

  /// @brief Method StartTracking, addr 0x12871a8, size 0x80, virtual false, abstract: false, final false
  inline void StartTracking(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StartTrackingRecursive, addr 0x12872b0, size 0x118, virtual false, abstract: false, final false
  inline void StartTrackingRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StopTracking, addr 0x1287228, size 0x80, virtual false, abstract: false, final false
  inline void StopTracking(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StopTrackingRecursive, addr 0x12873c8, size 0x10c, virtual false, abstract: false, final false
  inline void StopTrackingRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Update, addr 0x12878b8, size 0x600, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBindings, addr 0x1287eb8, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12883ec, size 0x160, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_profilerMarker, addr 0x1286f90, size 0x58, virtual true, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method get_temporaryObjectCache, addr 0x12872a8, size 0x8, virtual false, abstract: false, final false
