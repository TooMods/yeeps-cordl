...
public:
  ...
  /// @brief Method ConvertRect, addr 0x25b4da4, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect ConvertRect(::GlobalNamespace::__OVRPlugin__Rectf openXrRect);

  /// @brief Method Equals, addr 0x25b4b88, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x25b4b60, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRBounded2D other);

  /// @brief Method GetHashCode, addr 0x25b4c00, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRBounded2D>.FromAnchor, addr 0x25b4a44, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRBounded2D IOVRAnchorComponent_OVRBounded2D__FromAnchor(::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method IOVRAnchorComponent<OVRBounded2D>.SetEnabledAsync, addr 0x25b4b10, size 0x50, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded2D__SetEnabledAsync(bool enabled, double_t timeout);

  /// @brief Method IOVRAnchorComponent<OVRBounded2D>.get_Handle, addr 0x25b4a3c, size 0x8, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRBounded2D__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRBounded2D>.get_Type, addr 0x25b4a2c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRBounded2D__get_Type();

  /// @brief Method ToString, addr 0x25b4c4c, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetBoundaryPoints, addr 0x25b4e50, size 0x170, virtual false, abstract: false, final false
  inline bool TryGetBoundaryPoints(::Unity::Collections::NativeArray_1<::UnityEngine::Vector2> positions);

  /// @brief Method TryGetBoundaryPointsCount, addr 0x25b4de4, size 0x6c, virtual false, abstract: false, final false
  inline bool TryGetBoundaryPointsCount(ByRef<int32_t> count);

  /// @brief Method .ctor, addr 0x25b4a4c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  static inline ::GlobalNamespace::OVRBounded2D getStaticF_Null();

  /// @brief Method get_BoundingBox, addr 0x25b4cd8, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_BoundingBox();

  /// @brief Method get_Handle, addr 0x25b4cd0, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x25b4a68, size 0xa8, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x25b4a58, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Type, addr 0x25b4a34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x25b4b70, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRBounded2D lhs, ::GlobalNamespace::OVRBounded2D rhs);

  /// @brief Method op_Inequality, addr 0x25b4b7c, size 0xc, virtual false, abstract: false, final false
