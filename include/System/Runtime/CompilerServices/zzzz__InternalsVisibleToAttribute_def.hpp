...
public:
  ...
  /// @brief Method .ctor, addr 0x1b46d4c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyName);

  /// @brief Method set_AllInternalsVisible, addr 0x1b46d7c, size 0xc, virtual false, abstract: false, final false
