...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x18a4980, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18a4850, size 0x130, virtual false, abstract: false, final false
