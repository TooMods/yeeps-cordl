...
public:
  // Declarations
  /// @brief Method FromJson, addr 0x2474770, size 0x671b0, virtual false, abstract: false, final false
  ...
  /// @brief Method FromJsonInternal, addr 0x24745a0, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Object* FromJsonInternal(::StringW json, ::System::Object* objectToOverwrite, ::System::Type* type);

  /// @brief Method ToJson, addr 0x24745f4, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Object* obj);

  /// @brief Method ToJson, addr 0x24745fc, size 0x174, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Object* obj, bool prettyPrint);

  /// @brief Method ToJsonInternal, addr 0x247455c, size 0x44, virtual false, abstract: false, final false
