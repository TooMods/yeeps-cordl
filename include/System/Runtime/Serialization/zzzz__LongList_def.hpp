...
public:
  ...
  /// @brief Method Add, addr 0x1aacdc0, size 0x80, virtual false, abstract: false, final false
  inline void Add(int64_t value);

  /// @brief Method EnlargeArray, addr 0x1aad0ac, size 0x88, virtual false, abstract: false, final false
  inline void EnlargeArray();

  /// @brief Method MoveNext, addr 0x1aab04c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveElement, addr 0x1aacd08, size 0x90, virtual false, abstract: false, final false
  inline bool RemoveElement(int64_t value);

  /// @brief Method StartEnumeration, addr 0x1aab000, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1aacdb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1aad040, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t startingSize);

  /// @brief Method get_Count, addr 0x1aad134, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Current, addr 0x1aab00c, size 0x34, virtual false, abstract: false, final false
