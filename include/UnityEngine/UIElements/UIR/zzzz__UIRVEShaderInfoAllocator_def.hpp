...
public:
  ...
  /// @brief Method AllocClipRect, addr 0x1292ac0, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocClipRect();

  /// @brief Method AllocColor, addr 0x1292bd0, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocColor();

  /// @brief Method AllocOpacity, addr 0x1292ba8, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocOpacity();

  /// @brief Method AllocTextCoreSettings, addr 0x1292bf8, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocTextCoreSettings(::UnityEngine::UIElements::UIR::TextCoreSettings settings);

  /// @brief Method AllocToConstantBufferIndex, addr 0x12917ac, size 0x68, virtual false, abstract: false, final false
  static inline int32_t AllocToConstantBufferIndex(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method AllocToTexelCoord, addr 0x129175c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocTransform, addr 0x12929d8, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocTransform();

  /// @brief Method AtlasRectMatchesPage, addr 0x1291814, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ClipRectAllocToVertexData, addr 0x1292f84, size 0x120, virtual false, abstract: false, final false
  inline ::UnityEngine::Color32 ClipRectAllocToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method ColorAllocToVertexData, addr 0x12931a0, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color32 ColorAllocToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method Construct, addr 0x1291a2c, size 0x288, virtual false, abstract: false, final false
  inline void Construct();

  /// @brief Method Dispose, addr 0x1292884, size 0xd0, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FreeClipRect, addr 0x1292c94, size 0x74, virtual false, abstract: false, final false
  inline void FreeClipRect(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method FreeColor, addr 0x1292d7c, size 0x74, virtual false, abstract: false, final false
  inline void FreeColor(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method FreeOpacity, addr 0x1292d08, size 0x74, virtual false, abstract: false, final false
  inline void FreeOpacity(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method FreeTextCoreSettings, addr 0x1292df0, size 0x74, virtual false, abstract: false, final false
  inline void FreeTextCoreSettings(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method FreeTransform, addr 0x1292c20, size 0x74, virtual false, abstract: false, final false
  inline void FreeTransform(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method IssuePendingStorageChanges, addr 0x12929c0, size 0x18, virtual false, abstract: false, final false
  inline void IssuePendingStorageChanges();

  /// @brief Method OpacityAllocToVertexData, addr 0x12930a4, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color32 OpacityAllocToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method ReallyCreateStorage, addr 0x1291cb4, size 0x42c, virtual false, abstract: false, final false
  inline void ReallyCreateStorage();

  /// @brief Method SetClipRectValue, addr 0x129241c, size 0x138, virtual false, abstract: false, final false
  inline void SetClipRectValue(::UnityEngine::UIElements::UIR::BMPAlloc alloc, ::UnityEngine::Vector4 clipRect);

  /// @brief Method SetColorValue, addr 0x1292630, size 0xf0, virtual false, abstract: false, final false
  inline void SetColorValue(::UnityEngine::UIElements::UIR::BMPAlloc alloc, ::UnityEngine::Color color);

  /// @brief Method SetOpacityValue, addr 0x1292554, size 0xdc, virtual false, abstract: false, final false
  inline void SetOpacityValue(::UnityEngine::UIElements::UIR::BMPAlloc alloc, float_t opacity);

  /// @brief Method SetTextCoreSettingValue, addr 0x1292720, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTransformValue, addr 0x1292208, size 0x214, virtual false, abstract: false, final false
  inline void SetTransformValue(::UnityEngine::UIElements::UIR::BMPAlloc alloc, ::UnityEngine::Matrix4x4 xform);

  /// @brief Method TextCoreSettingsToVertexData, addr 0x129329c, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color32 TextCoreSettingsToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method TransformAllocToVertexData, addr 0x1292e64, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x129199c, size 0x90, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_atlas();

  /// @brief Method get_clipRectConstants, addr 0x1291954, size 0x48, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeSlice_1<::UnityEngine::Vector4> get_clipRectConstants();

  /// @brief Method get_pageHeight, addr 0x1291754, size 0x8, virtual false, abstract: false, final false
  static inline int32_t get_pageHeight();

  /// @brief Method get_pageWidth, addr 0x129174c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t get_pageWidth();

  /// @brief Method get_transformConstants, addr 0x129190c, size 0x48, virtual false, abstract: false, final false
