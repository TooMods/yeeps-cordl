...
public:
  ...
  /// @brief Method Equals, addr 0x18f4ec4, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x18f4f4c, size 0x40, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::InputFeatureUsage other);

  /// @brief Method GetHashCode, addr 0x18f4f8c, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_internalType, addr 0x18f4ebc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::InputFeatureType get_internalType();

  /// @brief Method get_name, addr 0x18f4eb4, size 0x8, virtual false, abstract: false, final false
