...
public:
  ...
  /// @brief Method MoveNext, addr 0x12c8b00, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x12c8c44, size 0xa0, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x12c8ce4, size 0xa4, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x12c8ba0, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12c88a8, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* collection);

  /// @brief Method get_Current, addr 0x12c8a10, size 0xf0, virtual false, abstract: false, final false
