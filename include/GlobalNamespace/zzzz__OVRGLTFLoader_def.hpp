...
public:
  ...
  /// @brief Method <ProcessMesh>b__0, addr 0x12643ac, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1262824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyTextureQuality, addr 0x1260b34, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUnityMaterial, addr 0x1263c84, size 0x274, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> CreateUnityMaterial(::GlobalNamespace::OVRMaterialData matData, bool loadMips);

  /// @brief Method DetectTextureQuality, addr 0x1260a74, size 0xc0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTextureQualityFiltering DetectTextureQuality(ByRef<::UnityEngine::Texture2D*> srcTexture);

  /// @brief Method FlipTraingleIndices, addr 0x126308c, size 0x6c, virtual false, abstract: false, final false
  static inline void FlipTraingleIndices(ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> indices);

  /// @brief Method GetInputNodeType, addr 0x1263fac, size 0x1c4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFInputNode GetInputNodeType(::StringW name);

  /// @brief Method LoadGLB, addr 0x125fc20, size 0x634, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFScene LoadGLB(bool supportAnimation, bool loadMips);

  /// @brief Method LoadGLTF, addr 0x1260650, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAnimations, addr 0x12615c0, size 0x518, virtual false, abstract: false, final false
  inline void ProcessAnimations();

  /// @brief Method ProcessMaterial, addr 0x126282c, size 0x388, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMaterialData ProcessMaterial(int32_t matId);

  /// @brief Method ProcessMesh, addr 0x1261ad8, size 0x938, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMeshData ProcessMesh(::OVRSimpleJSON::JSONNode* meshNode, bool loadMips);

  /// @brief Method ProcessNode, addr 0x1260ca8, size 0x918, virtual false, abstract: false, final false
  inline void ProcessNode(::OVRSimpleJSON::JSONNode* node, int32_t nodeId, bool loadMips);

  /// @brief Method ProcessSkin, addr 0x1262410, size 0x414, virtual false, abstract: false, final false
  inline void ProcessSkin(::OVRSimpleJSON::JSONNode* skinNode, ::UnityEngine::SkinnedMeshRenderer* renderer);

  /// @brief Method ProcessTexture, addr 0x1262bb4, size 0x4d8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTextureData ProcessTexture(int32_t textureId);

  /// @brief Method ReadChunk, addr 0x126045c, size 0xac, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadChunk(::System::IO::Stream* glbStream, ::GlobalNamespace::OVRChunkType type);

  /// @brief Method ReadMeshAttributes, addr 0x12630f8, size 0xb8c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMipMapBias, addr 0x1260a58, size 0x1c, virtual false, abstract: false, final false
  inline void SetMipMapBias(float_t loadedTexturesMipmapBiasing);

  /// @brief Method SetModelAlphaBlendShader, addr 0x1260a48, size 0x8, virtual false, abstract: false, final false
  inline void SetModelAlphaBlendShader(::UnityEngine::Shader* shader);

  /// @brief Method SetModelShader, addr 0x1260a40, size 0x8, virtual false, abstract: false, final false
  inline void SetModelShader(::UnityEngine::Shader* shader);

  /// @brief Method SetTextureQualityFiltering, addr 0x1260a50, size 0x8, virtual false, abstract: false, final false
  inline void SetTextureQualityFiltering(::GlobalNamespace::OVRTextureQualityFiltering loadedTexturesQuality);

  /// @brief Method TranscodeTexture, addr 0x1263ef8, size 0xb4, virtual false, abstract: false, final false
  inline void TranscodeTexture(ByRef<::GlobalNamespace::OVRTextureData> textureData);

  /// @brief Method ValidateChunk, addr 0x1260508, size 0x148, virtual false, abstract: false, final false
  inline bool ValidateChunk(::System::IO::Stream* glbStream, ::GlobalNamespace::OVRChunkType type, ByRef<uint32_t> chunkLength);

  /// @brief Method ValidateGLB, addr 0x1260254, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x125fb98, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x125fb60, size 0x38, virtual false, abstract: false, final false
