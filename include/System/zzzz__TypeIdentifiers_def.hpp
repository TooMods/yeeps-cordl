...
public:
  ...
  /// @brief Method GetInternalName, addr 0x10d9e24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d9dd0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName);

  /// @brief Method get_DisplayName, addr 0x10d9df8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_InternalName, addr 0x10d9e00, size 0x24, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method FromDisplay, addr 0x10d9d6c, size 0x64, virtual false, abstract: false, final false
