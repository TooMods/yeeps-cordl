...
public:
  ...
  __declspec(property(get = __cordl_internal_get_decalEntities,
                      put = __cordl_internal_set_decalEntities))::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::DecalEntity> decalEntities;

  /// @brief Field decalProjectors, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get_decalProjectors,
                      put = __cordl_internal_set_decalProjectors))::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>,
                                                                           ::Array<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>>*> decalProjectors;
  ...
  /// @brief Method Dispose, addr 0x2e13f4c, size 0x68, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalEntityChunk* New_ctor();

  /// @brief Method Push, addr 0x2e13df0, size 0x10, virtual true, abstract: false, final false
  inline void Push();

  /// @brief Method RemoveAtSwapBack, addr 0x2e13e00, size 0xac, virtual true, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t entityIndex);

  /// @brief Method SetCapacity, addr 0x2e13eac, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e13fb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
