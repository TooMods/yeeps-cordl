...
public:
  ...
  /// @brief Method Bind, addr 0x1940538, size 0xf0, virtual false, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table);

  /// @brief Method DependsOn, addr 0x1936158, size 0x1c, virtual false, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Evaluate, addr 0x1940688, size 0xc, virtual false, abstract: false, final false
  inline ::System::Object* Evaluate();

  /// @brief Method Evaluate, addr 0x1940694, size 0x1f0, virtual false, abstract: false, final false
  inline ::System::Object* Evaluate(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method GetDependency, addr 0x1940a80, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> GetDependency();

  /// @brief Method HasLocalAggregate, addr 0x1940af8, size 0x18, virtual false, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x1940b10, size 0x18, virtual false, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method Invoke, addr 0x1940910, size 0xdc, virtual true, abstract: false, final true
  inline bool Invoke(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method IsTableAggregate, addr 0x1940a88, size 0x18, virtual false, abstract: false, final false
  inline bool IsTableAggregate();

  /// @brief Method IsUnknown, addr 0x1940aa0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBoolean, addr 0x193d15c, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x193f480, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::StringW expression);

  /// @brief Method .ctor, addr 0x193f488, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::StringW expression, ::System::Type* type);

  /// @brief Method get_Expression, addr 0x1940628, size 0x50, virtual false, abstract: false, final false
  inline ::StringW get_Expression();

  /// @brief Method get_HasValue, addr 0x1940678, size 0x10, virtual false, abstract: false, final false
