...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2b0c2e4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0c1b4, size 0x130, virtual false, abstract: false, final false
