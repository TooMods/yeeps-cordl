...
public:
  // Declarations
  /// @brief Method GetAchievementDefinitions, addr 0x19b2504, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementDefinitionList* GetAchievementDefinitions();

  /// @brief Method GetDataFromMessage, addr 0x19b2540, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0574, size 0x58, virtual false, abstract: false, final false
