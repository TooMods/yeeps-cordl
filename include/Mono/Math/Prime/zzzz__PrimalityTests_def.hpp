...
public:
  // Declarations
  /// @brief Method GetSPPRounds, addr 0x28a6c3c, size 0x194, virtual false, abstract: false, final false
  static inline int32_t GetSPPRounds(::Mono::Math::BigInteger* bi, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method RabinMillerTest, addr 0x28a6f9c, size 0x290, virtual false, abstract: false, final false
  static inline bool RabinMillerTest(::Mono::Math::BigInteger* n, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method SmallPrimeSppTest, addr 0x28a6dd0, size 0x1cc, virtual false, abstract: false, final false
  static inline bool SmallPrimeSppTest(::Mono::Math::BigInteger* bi, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method Test, addr 0x28a5d88, size 0x4c, virtual false, abstract: false, final false
