...
public:
  ...
  /// @brief Method Dispose, addr 0x1afcba8, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1afcc14, size 0x290, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x1afc97c, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetService, addr 0x1afcf54, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Object* GetService(::System::Type* service);

  static inline ::System::ComponentModel::MarshalByValueComponent* New_ctor();

  /// @brief Method ToString, addr 0x1afd0b8, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1afc974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_Disposed, addr 0x1afca1c, size 0x88, virtual true, abstract: false, final true
  inline void add_Disposed(::System::EventHandler* value);

  static inline ::System::Object* getStaticF_s_eventDisposed();

  /// @brief Method get_Container, addr 0x1afcea4, size 0xb0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::IContainer* get_Container();

  /// @brief Method get_DesignMode, addr 0x1afd008, size 0xb0, virtual true, abstract: false, final false
  inline bool get_DesignMode();

  /// @brief Method get_Events, addr 0x1afcaa4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::ComponentModel::EventHandlerList* get_Events();

  /// @brief Method get_Site, addr 0x1afcb98, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method remove_Disposed, addr 0x1afcb10, size 0x88, virtual true, abstract: false, final true
  inline void remove_Disposed(::System::EventHandler* value);

  static inline void setStaticF_s_eventDisposed(::System::Object* value);

  /// @brief Method set_Site, addr 0x1afcba0, size 0x8, virtual true, abstract: false, final false
