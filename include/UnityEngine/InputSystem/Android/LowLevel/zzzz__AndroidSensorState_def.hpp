...
public:
  ...
  /// @brief Method WithData, addr 0x1e014c8, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x1e01598, size 0x58, virtual true, abstract: false, final true
