...
public:
  // Declarations
  /// @brief Method Init, addr 0x2ccf450, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2ccf4a0, size 0x104, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerUpEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x2ccf5f4, size 0x32c, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method .ctor, addr 0x2ccf5a4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
