...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3d10, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchReportFlowResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetLaunchReportFlowResult, addr 0x19b3cd4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b3c7c, size 0x58, virtual false, abstract: false, final false
