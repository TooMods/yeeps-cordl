...
public:
  ...
  /// @brief Method .ctor, addr 0x182e688, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, ::System::Type* type);

  /// @brief Method get_Type, addr 0x182e6ac, size 0x8, virtual true, abstract: false, final true
