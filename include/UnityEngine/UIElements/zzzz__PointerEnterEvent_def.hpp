...
public:
  // Declarations
  /// @brief Method Init, addr 0x2ccff20, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2ccff74, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerEnterEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2ccff80, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
