...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2157d38, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType t);

  /// @brief Method .ctor, addr 0x2157d58, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType type, int32_t number);

  /// @brief Method .ctor, addr 0x2157d48, size 0x10, virtual false, abstract: false, final false
