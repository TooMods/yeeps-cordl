...
public:
  ...
  /// @brief Method <Complete>b__17_0, addr 0x1231d5c, size 0x80, virtual false, abstract: false, final false
  inline void _Complete_b__17_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x1231d54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CaptureOrComplete, addr 0x123129c, size 0x3d8, virtual false, abstract: false, final false
  inline bool CaptureOrComplete(ByRef<::System::Threading::ExecutionContext*> cachedContext, bool returnContext);

  /// @brief Method Cleanup, addr 0x1231674, size 0xa0, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CleanupInternal, addr 0x1230fb0, size 0x4, virtual false, abstract: false, final false
  inline void CleanupInternal();

  /// @brief Method Complete, addr 0x1231938, size 0x2e8, virtual true, abstract: false, final false
  inline void Complete(void* userToken);

  /// @brief Method CompleteCallback, addr 0x1231c20, size 0xd0, virtual false, abstract: false, final false
  inline void CompleteCallback();

  /// @brief Method FinishPostingAsyncOp, addr 0x1231258, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeCaptureIdentity, addr 0x1230fac, size 0x4, virtual false, abstract: false, final false
  inline void SafeCaptureIdentity();

  /// @brief Method StartPostingAsyncOp, addr 0x1231084, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* StartPostingAsyncOp();

  /// @brief Method StartPostingAsyncOp, addr 0x123108c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1230fbc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x123100c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1230fb4, size 0x8, virtual false, abstract: false, final false
