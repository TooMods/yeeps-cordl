...
public:
  ...
  /// @brief Method CheckSchemaRoot, addr 0x1e759a0, size 0x108, virtual false, abstract: false, final false
  inline bool CheckSchemaRoot(::System::Xml::Schema::SchemaType rootType, ByRef<::StringW> code);

  /// @brief Method CreateXmlNsAttribute, addr 0x1e76224, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateXmlNsAttribute(::StringW prefix, ::StringW value);

  /// @brief Method FinishParsing, addr 0x1e75aa8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaType FinishParsing();

  /// @brief Method LoadAttributeNode, addr 0x1e760b0, size 0x174, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* LoadAttributeNode();

  /// @brief Method LoadElementNode, addr 0x1e75ce8, size 0x3c8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* LoadElementNode(bool root);

  /// @brief Method LoadEntityReferenceInAttribute, addr 0x1e76340, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x1e74f0c, size 0x50, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaType Parse(::System::Xml::XmlReader* reader, ::StringW targetNamespace);

  /// @brief Method ParseReaderNode, addr 0x1e75320, size 0x680, virtual false, abstract: false, final false
  inline bool ParseReaderNode();

  /// @brief Method ProcessAppInfoDocMarkup, addr 0x1e75ac8, size 0x220, virtual false, abstract: false, final false
  inline void ProcessAppInfoDocMarkup(bool root);

  /// @brief Method StartParsing, addr 0x1e74f5c, size 0x3c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e74e54, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_XdrSchema, addr 0x1e75ac0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_XdrSchema();

  /// @brief Method get_XmlSchema, addr 0x1e75ab0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_XmlSchema();

  /// @brief Method set_XmlResolver, addr 0x1e75ab8, size 0x8, virtual false, abstract: false, final false
