...
public:
  ...
  /// @brief Method Fallback, addr 0xee3e74, size 0x44, virtual true, abstract: false, final false
  inline bool Fallback(::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method GetNextChar, addr 0xee3eb8, size 0x50, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method InternalFallback, addr 0xee3f24, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xee3f14, size 0x10, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0xee3d7c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::DecoderReplacementFallback* fallback);

  /// @brief Method get_Remaining, addr 0xee3f08, size 0xc, virtual true, abstract: false, final false
