...
#include <cstdint>
CORDL_MODULE_EXPORT(QueryResponse)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::QueryResponse);
// Type: Amazon.DynamoDBv2.Model::QueryResponse
// SizeInfo { instance_size: 80, native_size: -1, calculated_instance_size: 80, calculated_native_size: 80, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::QueryResponse*
class CORDL_TYPE QueryResponse : public ::Amazon::Runtime::AmazonWebServiceResponse {
public:
  // Declarations
  ...
  /// @brief Method IsSetConsumedCapacity, addr 0x104e104, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetConsumedCapacity();

  /// @brief Method IsSetCount, addr 0x104e1b8, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetCount();

  /// @brief Method IsSetItems, addr 0x104e204, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetItems();

  /// @brief Method IsSetLastEvaluatedKey, addr 0x104e268, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetLastEvaluatedKey();

  /// @brief Method IsSetScannedCount, addr 0x104e364, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetScannedCount();

  static inline ::Amazon::DynamoDBv2::Model::QueryResponse* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x104e3a0, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConsumedCapacity, addr 0x104e0f4, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::ConsumedCapacity* get_ConsumedCapacity();

  /// @brief Method get_Count, addr 0x104e114, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Items, addr 0x104e1f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LastEvaluatedKey, addr 0x104e258, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* get_LastEvaluatedKey();

  /// @brief Method get_ScannedCount, addr 0x104e2c0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_ScannedCount();

  /// @brief Method set_ConsumedCapacity, addr 0x104e0fc, size 0x8, virtual false, abstract: false, final false
  inline void set_ConsumedCapacity(::Amazon::DynamoDBv2::Model::ConsumedCapacity* value);

  /// @brief Method set_Count, addr 0x104e150, size 0x68, virtual false, abstract: false, final false
  inline void set_Count(int32_t value);

  /// @brief Method set_Items, addr 0x104e1fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LastEvaluatedKey, addr 0x104e260, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ScannedCount, addr 0x104e2fc, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryResponse", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryResponse(QueryResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryResponse", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryResponse(QueryResponse const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::QueryResponse, 0x50>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::QueryResponse, ____consumedCapacity) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::QueryResponse, ____count) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::QueryResponse, ____items) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::QueryResponse, ____lastEvaluatedKey) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::QueryResponse, ____scannedCount) == 0x48, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::QueryResponse);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::QueryResponse*, "Amazon.DynamoDBv2.Model", "QueryResponse");
