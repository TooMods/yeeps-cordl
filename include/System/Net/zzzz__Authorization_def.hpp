...
public:
  ...
  /// @brief Method .ctor, addr 0xf51a3c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::StringW token);

  /// @brief Method .ctor, addr 0xf51ae0, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::StringW token, bool finished);

  /// @brief Method get_Complete, addr 0xf51b7c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Complete();

  /// @brief Method get_Message, addr 0xf51b74, size 0x8, virtual false, abstract: false, final false
