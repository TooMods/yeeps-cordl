...
public:
  ...
  /// @brief Method GetArgument, addr 0x1838ed0, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x1838f28, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1838ecc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* lambda, ::System::Type* returnType);

  /// @brief Method get_ArgumentCount, addr 0x1838f20, size 0x8, virtual true, abstract: false, final false
