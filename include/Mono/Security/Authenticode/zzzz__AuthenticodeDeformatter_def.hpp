...
public:
  ...
  /// @brief Method CheckSignature, addr 0x1cce330, size 0x2f4, virtual false, abstract: false, final false
  inline bool CheckSignature();

  /// @brief Method CompareIssuerSerial, addr 0x1ccf074, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1cce28c, size 0xa4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifyCounterSignature, addr 0x1ccf168, size 0xa04, virtual false, abstract: false, final false
  inline bool VerifyCounterSignature(::Mono::Security::__PKCS7__SignerInfo* cs, ::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method VerifySignature, addr 0x1cce62c, size 0xa48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cce108, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1cce194, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> rawData);

  /// @brief Method get_SigningCertificate, addr 0x1cce624, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate();

  /// @brief Method set_RawData, addr 0x1cce1bc, size 0xd0, virtual false, abstract: false, final false
