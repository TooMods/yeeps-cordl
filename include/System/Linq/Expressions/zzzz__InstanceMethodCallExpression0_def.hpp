...
public:
  ...
  /// @brief Method GetArgument, addr 0x183b4d4, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x183b52c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183b4b0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* instance);

  /// @brief Method get_ArgumentCount, addr 0x183b524, size 0x8, virtual true, abstract: false, final false
