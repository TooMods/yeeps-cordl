...
public:
  ...
  /// @brief Method OnDidApplyAnimationProperties, addr 0x2906dc4, size 0x3c, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnPopulateMesh, addr 0x2905ce4, size 0xd18, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* vh);

  /// @brief Method SetNativeSize, addr 0x2905a04, size 0x2e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x290571c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mainTexture, addr 0x290576c, size 0x158, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_mainTexture();

  /// @brief Method get_texture, addr 0x29058c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_texture();

  /// @brief Method get_uvRect, addr 0x2905978, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_uvRect();

  /// @brief Method set_texture, addr 0x29058cc, size 0xac, virtual false, abstract: false, final false
  inline void set_texture(::UnityEngine::Texture* value);

  /// @brief Method set_uvRect, addr 0x2905984, size 0x80, virtual false, abstract: false, final false
