...
public:
  ...
  /// @brief Method Create, addr 0x1c8c724, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::TripleDES* Create();

  /// @brief Method Create, addr 0x1c8c800, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::TripleDES* Create(::StringW str);

  /// @brief Method EqualBytes, addr 0x1c8c98c, size 0x1a0, virtual false, abstract: false, final false
  static inline bool EqualBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey, int32_t start1, int32_t start2, int32_t count);

  /// @brief Method IsLegalKeySize, addr 0x1c8c8a0, size 0x24, virtual false, abstract: false, final false
  static inline bool IsLegalKeySize(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method IsWeakKey, addr 0x1c8c3e0, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c8c290, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Key, addr 0x1c8c318, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Key, addr 0x1c8c540, size 0x1e4, virtual true, abstract: false, final false
