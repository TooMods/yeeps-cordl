...
public:
  ...
  /// @brief Method .ctor, addr 0x2f64fec, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value, ::Newtonsoft::Json::Bson::BsonBinaryType binaryType);

  /// @brief Method get_BinaryType, addr 0x2f64fdc, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonBinaryType get_BinaryType();

  /// @brief Method set_BinaryType, addr 0x2f64fe4, size 0x8, virtual false, abstract: false, final false
