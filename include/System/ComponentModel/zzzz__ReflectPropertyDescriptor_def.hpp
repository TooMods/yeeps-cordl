...
public:
  ...
  __declspec(property(get = get_ChangedEventValue))::System::ComponentModel::EventDescriptor* ChangedEventValue;
  ...
  __declspec(property(get = get_IPropChangedEventValue, put = set_IPropChangedEventValue))::System::ComponentModel::EventDescriptor* IPropChangedEventValue;
  ...
  /// @brief Field realIPropChangedEvent, offset 0xd8, size 0x8
  __declspec(property(get = __cordl_internal_get_realIPropChangedEvent, put = __cordl_internal_set_realIPropChangedEvent))::System::ComponentModel::EventDescriptor* realIPropChangedEvent;

  /// @brief Field receiverType, offset 0xe0, size 0x8
  ...
  /// @brief Method AddValueChanged, addr 0x1b19b74, size 0x1a8, virtual true, abstract: false, final false
  inline void AddValueChanged(::System::Object* component, ::System::EventHandler* handler);

  /// @brief Method CanResetValue, addr 0x1b1aea0, size 0x278, virtual true, abstract: false, final false
  inline bool CanResetValue(::System::Object* component);

  /// @brief Method ExtenderCanResetValue, addr 0x1b19d1c, size 0x288, virtual false, abstract: false, final false
  inline bool ExtenderCanResetValue(::System::ComponentModel::IExtenderProvider* provider, ::System::Object* component);

  /// @brief Method ExtenderGetReceiverType, addr 0x1b1a0d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* ExtenderGetReceiverType();

  /// @brief Method ExtenderGetType, addr 0x1b1a0e0, size 0x10, virtual false, abstract: false, final false
  inline ::System::Type* ExtenderGetType(::System::ComponentModel::IExtenderProvider* provider);

  /// @brief Method ExtenderGetValue, addr 0x1b19fa4, size 0x134, virtual false, abstract: false, final false
  inline ::System::Object* ExtenderGetValue(::System::ComponentModel::IExtenderProvider* provider, ::System::Object* component);

  /// @brief Method ExtenderResetValue, addr 0x1b1a0f0, size 0x518, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtenderSetValue, addr 0x1b1a608, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtenderShouldSerializeValue, addr 0x1b1aa6c, size 0x434, virtual false, abstract: false, final false
  inline bool ExtenderShouldSerializeValue(::System::ComponentModel::IExtenderProvider* provider, ::System::Object* component);

  /// @brief Method FillAttributes, addr 0x1b1b118, size 0xac4, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributes);

  /// @brief Method GetValue, addr 0x1b1bbdc, size 0x3cc, virtual true, abstract: false, final false
  ...
  static inline ::System::ComponentModel::ReflectPropertyDescriptor* New_ctor(::System::Type* componentClass, ::System::ComponentModel::PropertyDescriptor* oldReflectPropertyDescriptor,
                                                                              ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> attributes);

  /// @brief Method OnINotifyPropertyChanged, addr 0x1b1bfa8, size 0xfc, virtual false, abstract: false, final false
  inline void OnINotifyPropertyChanged(::System::Object* component, ::System::ComponentModel::PropertyChangedEventArgs* e);

  /// @brief Method OnValueChanged, addr 0x1b1c0a4, size 0xa4, virtual true, abstract: false, final false
  inline void OnValueChanged(::System::Object* component, ::System::EventArgs* e);

  /// @brief Method RemoveValueChanged, addr 0x1b1c148, size 0x1a4, virtual true, abstract: false, final false
  inline void RemoveValueChanged(::System::Object* component, ::System::EventHandler* handler);

  /// @brief Method ResetValue, addr 0x1b1c2ec, size 0x458, virtual true, abstract: false, final false
  inline void ResetValue(::System::Object* component);

  /// @brief Method SetValue, addr 0x1b1c744, size 0x5e0, virtual true, abstract: false, final false
  inline void SetValue(::System::Object* component, ::System::Object* value);

  /// @brief Method ShouldSerializeValue, addr 0x1b1cd24, size 0x32c, virtual true, abstract: false, final false
  ...
  constexpr ::System::ComponentModel::EventDescriptor*& __cordl_internal_get_realIPropChangedEvent();

  constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::EventDescriptor*> const& __cordl_internal_get_realIPropChangedEvent() const;
  ...
  constexpr void __cordl_internal_set_realIPropChangedEvent(::System::ComponentModel::EventDescriptor* value);
  ...
  /// @brief Method .ctor, addr 0x1b17c14, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b17f00, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b18020, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b180ec, size 0x400, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* componentClass, ::System::ComponentModel::PropertyDescriptor* oldReflectPropertyDescriptor,
                    ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> attributes);
  ...
  /// @brief Method get_AmbientValue, addr 0x1b184ec, size 0x17c, virtual false, abstract: false, final false
  inline ::System::Object* get_AmbientValue();

  /// @brief Method get_ChangedEventValue, addr 0x1b18668, size 0x18c, virtual false, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptor* get_ChangedEventValue();

  /// @brief Method get_ComponentType, addr 0x1b18a24, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_ComponentType();

  /// @brief Method get_DefaultValue, addr 0x1b18a2c, size 0x290, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValue();

  /// @brief Method get_GetMethodValue, addr 0x1b18cbc, size 0x43c, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_GetMethodValue();

  /// @brief Method get_IPropChangedEventValue, addr 0x1b187f4, size 0x1b4, virtual false, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptor* get_IPropChangedEventValue();

  /// @brief Method get_IsExtender, addr 0x1b190f8, size 0x60, virtual false, abstract: false, final false
  inline bool get_IsExtender();

  /// @brief Method get_IsReadOnly, addr 0x1b19158, size 0x100, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_PropertyType, addr 0x1b1975c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_PropertyType();

  /// @brief Method get_ResetMethodValue, addr 0x1b19764, size 0x208, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_ResetMethodValue();

  /// @brief Method get_SetMethodValue, addr 0x1b19258, size 0x504, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_SetMethodValue();

  /// @brief Method get_ShouldSerializeMethodValue, addr 0x1b1996c, size 0x208, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_ShouldSerializeMethodValue();

  /// @brief Method get_SupportsChangeEvents, addr 0x1b1d050, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method set_IPropChangedEventValue, addr 0x1b189a8, size 0x7c, virtual false, abstract: false, final false
  inline void set_IPropChangedEventValue(::System::ComponentModel::EventDescriptor* value);
...
public:
  ...
  /// @brief Field realIPropChangedEvent, offset: 0xd8, size: 0x8, def value: None
  ::System::ComponentModel::EventDescriptor* ___realIPropChangedEvent;

  /// @brief Field receiverType, offset: 0xe0, size: 0x8, def value: None
  ::System::Type* ___receiverType;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::System::ComponentModel::ReflectPropertyDescriptor, 0xe8>, "Size mismatch!");
...
static_assert(offsetof(::System::ComponentModel::ReflectPropertyDescriptor, ___realIPropChangedEvent) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::System::ComponentModel::ReflectPropertyDescriptor, ___receiverType) == 0xe0, "Offset mismatch!");
