...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129a60c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DataType, addr 0x129a534, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x129a588, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Form, addr 0x129a5dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x129a5ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsNullableSpecified, addr 0x129a5f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullableSpecified();

  /// @brief Method get_Namespace, addr 0x129a5e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_NestingLevel, addr 0x129a604, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NestingLevel();

  /// @brief Method get_Type, addr 0x129a5fc, size 0x8, virtual false, abstract: false, final false
