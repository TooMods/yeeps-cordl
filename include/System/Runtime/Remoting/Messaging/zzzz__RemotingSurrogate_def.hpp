...
public:
  ...
  /// @brief Method GetObjectData, addr 0x1867354, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x186746c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18674ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
