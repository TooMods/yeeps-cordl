...
public:
  ...
  /// @brief Method AddAttribute, addr 0x2f600ac, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method AddJsonArrayAttribute, addr 0x2f60c2c, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method AllSameName, addr 0x2f5c920, size 0x2ac, virtual false, abstract: false, final false
  static inline bool AllSameName(::Newtonsoft::Json::Converters::IXmlNode* node);

  /// @brief Method CanConvert, addr 0x2f61050, size 0xa8, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* valueType);

  /// @brief Method ConvertTokenToXmlValue, addr 0x2f5e7e0, size 0x614, virtual false, abstract: false, final false
  static inline ::StringW ConvertTokenToXmlValue(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CreateDocumentType, addr 0x2f5f2a8, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x2f60a70, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x2f60420, size 0x650, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInstruction, addr 0x2f5edf4, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeNode, addr 0x2f5da9c, size 0x7c4, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeValue, addr 0x2f5e260, size 0x580, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPropertyName, addr 0x2f5b544, size 0x438, virtual false, abstract: false, final false
  inline ::StringW GetPropertyName(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method IsArray, addr 0x2f5b97c, size 0x398, virtual false, abstract: false, final false
  inline bool IsArray(::Newtonsoft::Json::Converters::IXmlNode* node);

  /// @brief Method IsNamespaceAttribute, addr 0x2f60f6c, size 0xe4, virtual false, abstract: false, final false
  inline bool IsNamespaceAttribute(::StringW attributeName, ByRef<::StringW> prefix);

  /// @brief Method IsXObject, addr 0x2f610f8, size 0x94, virtual false, abstract: false, final false
  inline bool IsXObject(::System::Type* valueType);

  /// @brief Method IsXmlNode, addr 0x2f6118c, size 0x94, virtual false, abstract: false, final false
  inline bool IsXmlNode(::System::Type* valueType);

  static inline ::Newtonsoft::Json::Converters::XmlNodeConverter* New_ctor();

  /// @brief Method PushParentNamespaces, addr 0x2f5944c, size 0x668, virtual false, abstract: false, final false
  inline void PushParentNamespaces(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method ReadArrayElements, addr 0x2f5f6b0, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAttributeElements, addr 0x2f5fa94, size 0x618, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadElement, addr 0x2f5d750, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadJson, addr 0x2f5cee4, size 0x86c, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method ResolveFullName, addr 0x2f5b228, size 0x31c, virtual false, abstract: false, final false
  inline ::StringW ResolveFullName(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method SerializeGroupedNodes, addr 0x2f5bd14, size 0x9c8, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeNode, addr 0x2f59ab4, size 0x1774, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldReadInto, addr 0x2f5fa4c, size 0x48, virtual false, abstract: false, final false
  inline bool ShouldReadInto(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ValueAttributes, addr 0x2f5cbcc, size 0x318, virtual false, abstract: false, final false
  inline bool ValueAttributes(::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* c);

  /// @brief Method WrapXml, addr 0x2f59330, size 0x11c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* WrapXml(::System::Object* value);

  /// @brief Method WriteGroupedNodes, addr 0x2f5c6dc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteGroupedNodes, addr 0x2f5c848, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x2f591ec, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f61220, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* getStaticF_EmptyChildNodes();

  /// @brief Method get_DeserializeRootElementName, addr 0x2f591a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DeserializeRootElementName();

  /// @brief Method get_EncodeSpecialCharacters, addr 0x2f591d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_EncodeSpecialCharacters();

  /// @brief Method get_OmitRootObject, addr 0x2f591c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_OmitRootObject();

  /// @brief Method get_WriteArrayAttribute, addr 0x2f591b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DeserializeRootElementName, addr 0x2f591a8, size 0x8, virtual false, abstract: false, final false
  inline void set_DeserializeRootElementName(::StringW value);

  /// @brief Method set_EncodeSpecialCharacters, addr 0x2f591e0, size 0xc, virtual false, abstract: false, final false
  inline void set_EncodeSpecialCharacters(bool value);

  /// @brief Method set_OmitRootObject, addr 0x2f591cc, size 0xc, virtual false, abstract: false, final false
  inline void set_OmitRootObject(bool value);

  /// @brief Method set_WriteArrayAttribute, addr 0x2f591b8, size 0xc, virtual false, abstract: false, final false
