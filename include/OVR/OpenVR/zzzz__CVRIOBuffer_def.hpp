...
public:
  ...
  /// @brief Method Close, addr 0x2a7a858, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EIOBufferError Close(uint64_t ulBuffer);

  static inline ::OVR::OpenVR::CVRIOBuffer* New_ctor(void* pInterface);

  /// @brief Method Open, addr 0x2a7a830, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method PropertyContainer, addr 0x2a7a8c8, size 0x24, virtual false, abstract: false, final false
  inline uint64_t PropertyContainer(uint64_t ulBuffer);

  /// @brief Method Read, addr 0x2a7a87c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EIOBufferError Read(uint64_t ulBuffer, void* pDst, uint32_t unBytes, ByRef<uint32_t> punRead);

  /// @brief Method Write, addr 0x2a7a8a4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a7a71c, size 0x114, virtual false, abstract: false, final false
