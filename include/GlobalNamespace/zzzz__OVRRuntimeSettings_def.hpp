...
public:
  ...
  /// @brief Method GetRuntimeSettings, addr 0x148a070, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x148a184, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x148a1f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::GlobalNamespace::OVRRuntimeSettings> getStaticF__instance();

  /// @brief Method get_HasSetTelemetryEnabled, addr 0x148a1d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasSetTelemetryEnabled();

  /// @brief Method get_Instance, addr 0x1489fd4, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRRuntimeSettings> get_Instance();

  /// @brief Method get_TelemetryEnabled, addr 0x148a1d8, size 0x20, virtual false, abstract: false, final false
