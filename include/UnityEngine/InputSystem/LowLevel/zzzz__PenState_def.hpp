...
public:
  ...
  /// @brief Method WithButton, addr 0x1e031d4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x1e031a4, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x1e03208, size 0x30, virtual true, abstract: false, final true
