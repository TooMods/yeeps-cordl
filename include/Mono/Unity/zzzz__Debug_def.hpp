...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x242051c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x24205bc, size 0xd8, virtual false, abstract: false, final false
