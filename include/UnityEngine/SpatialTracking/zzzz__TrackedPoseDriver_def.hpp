...
public:
  ...
  /// @brief Method Awake, addr 0x2437264, size 0x4, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method CacheLocalPosition, addr 0x24371f4, size 0x50, virtual false, abstract: false, final false
  inline void CacheLocalPosition();

  /// @brief Method FixedUpdate, addr 0x243735c, size 0x1c, virtual true, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetPoseData, addr 0x24370c4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasStereoCamera, addr 0x24374fc, size 0xb8, virtual false, abstract: false, final false
  inline bool HasStereoCamera();

  static inline ::UnityEngine::SpatialTracking::TrackedPoseDriver* New_ctor();

  /// @brief Method OnBeforeRender, addr 0x2437394, size 0x20, virtual true, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method OnDestroy, addr 0x2437268, size 0x4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x24372e0, size 0x7c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x243726c, size 0x74, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PerformUpdate, addr 0x24375b4, size 0xc4, virtual true, abstract: false, final false
  inline void PerformUpdate();

  /// @brief Method ResetToCachedLocalPosition, addr 0x2437244, size 0x20, virtual false, abstract: false, final false
  inline void ResetToCachedLocalPosition();

  /// @brief Method SetLocalTransform, addr 0x24373b4, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetPoseSource, addr 0x2436f70, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformPoseByOriginIfNeeded, addr 0x2437498, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose TransformPoseByOriginIfNeeded(::UnityEngine::Pose pose);

  /// @brief Method Update, addr 0x2437378, size 0x1c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2437678, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseRelativeTransform, addr 0x24371b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseRelativeTransform();

  /// @brief Method get_deviceType, addr 0x2436f50, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__DeviceType get_deviceType();

  /// @brief Method get_originPose, addr 0x24371c4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_originPose();

  /// @brief Method get_poseProviderComponent, addr 0x24370b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Experimental::XR::Interaction::BasePoseProvider> get_poseProviderComponent();

  /// @brief Method get_poseSource, addr 0x2436f60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackedPose get_poseSource();

  /// @brief Method get_trackingType, addr 0x2437190, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackingType get_trackingType();

  /// @brief Method get_updateType, addr 0x24371a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__UpdateType get_updateType();

  /// @brief Method set_UseRelativeTransform, addr 0x24371b8, size 0xc, virtual false, abstract: false, final false
  inline void set_UseRelativeTransform(bool value);

  /// @brief Method set_deviceType, addr 0x2436f58, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceType(::UnityEngine::SpatialTracking::__TrackedPoseDriver__DeviceType value);

  /// @brief Method set_originPose, addr 0x24371d8, size 0x1c, virtual false, abstract: false, final false
  inline void set_originPose(::UnityEngine::Pose value);

  /// @brief Method set_poseProviderComponent, addr 0x24370bc, size 0x8, virtual false, abstract: false, final false
  inline void set_poseProviderComponent(::UnityEngine::Experimental::XR::Interaction::BasePoseProvider* value);

  /// @brief Method set_poseSource, addr 0x2436f68, size 0x8, virtual false, abstract: false, final false
  inline void set_poseSource(::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackedPose value);

  /// @brief Method set_trackingType, addr 0x2437198, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingType(::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackingType value);

  /// @brief Method set_updateType, addr 0x24371a8, size 0x8, virtual false, abstract: false, final false
