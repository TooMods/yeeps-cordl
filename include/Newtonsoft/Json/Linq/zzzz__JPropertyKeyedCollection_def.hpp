...
public:
  ...
  /// @brief Method AddKey, addr 0x1344d80, size 0x70, virtual false, abstract: false, final false
  inline void AddKey(::StringW key, ::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method ChangeItemKey, addr 0x1344ea0, size 0x188, virtual false, abstract: false, final false
  inline void ChangeItemKey(::Newtonsoft::Json::Linq::JToken* item, ::StringW newKey);

  /// @brief Method ClearItems, addr 0x1345194, size 0x78, virtual true, abstract: false, final false
  inline void ClearItems();

  /// @brief Method Compare, addr 0x133f11c, size 0x354, virtual false, abstract: false, final false
  inline bool Compare(::Newtonsoft::Json::Linq::JPropertyKeyedCollection* other);

  /// @brief Method Contains, addr 0x1340f2c, size 0xb0, virtual false, abstract: false, final false
  inline bool Contains(::StringW key);

  /// @brief Method ContainsItem, addr 0x1345028, size 0x8c, virtual false, abstract: false, final false
  inline bool ContainsItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method EnsureDictionary, addr 0x1344df0, size 0xb0, virtual false, abstract: false, final false
  inline void EnsureDictionary();

  /// @brief Method GetKeyForItem, addr 0x13450b4, size 0x80, virtual false, abstract: false, final false
  inline ::StringW GetKeyForItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method IndexOfReference, addr 0x133f498, size 0xa4, virtual false, abstract: false, final false
  inline int32_t IndexOfReference(::Newtonsoft::Json::Linq::JToken* t);

  /// @brief Method InsertItem, addr 0x134520c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x1345284, size 0xec, virtual false, abstract: false, final false
  inline bool Remove(::StringW key);

  /// @brief Method RemoveItem, addr 0x1345370, size 0xf4, virtual true, abstract: false, final false
  inline void RemoveItem(int32_t index);

  /// @brief Method RemoveKey, addr 0x1345134, size 0x60, virtual false, abstract: false, final false
  inline void RemoveKey(::StringW key);

  /// @brief Method SetItem, addr 0x1345464, size 0x208, virtual true, abstract: false, final false
  inline void SetItem(int32_t index, ::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method TryGetValue, addr 0x133f7c4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133eef8, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::IEqualityComparer_1<::StringW>* getStaticF_Comparer();

  /// @brief Method get_Item, addr 0x134566c, size 0xcc, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(::StringW key);

  /// @brief Method get_Keys, addr 0x1340ff4, size 0x58, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::ICollection_1<::StringW>* get_Keys();

  /// @brief Method get_Values, addr 0x1345738, size 0x58, virtual false, abstract: false, final false
