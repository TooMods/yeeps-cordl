...
public:
  ...
  /// @brief Method Interp, addr 0x17d68f4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x17d686c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector2 value, float_t min, float_t max, bool overrideState);

  /// @brief Method get_value, addr 0x17d6848, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 get_value();

  /// @brief Method set_value, addr 0x17d6850, size 0x1c, virtual true, abstract: false, final false
