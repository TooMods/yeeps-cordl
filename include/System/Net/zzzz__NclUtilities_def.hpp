...
public:
  ...
  /// @brief Method GetLocalHost, addr 0xf5257c, size 0x18, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetLocalHost();

  /// @brief Method IsAddressLocal, addr 0xf52034, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsAddressLocal(::System::Net::IPAddress* ipAddress);

  /// @brief Method IsFatal, addr 0xf51f74, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LocalAddresses, addr 0xf520c0, size 0x4bc, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> get_LocalAddresses();

  /// @brief Method get_LocalAddressesLock, addr 0xf52594, size 0xa4, virtual false, abstract: false, final false
