...
public:
  ...
  /// @brief Method Initialize, addr 0x1fcd990, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method ToFileSystemInfo, addr 0x1fcde78, size 0x6c, virtual false, abstract: false, final false
  inline ::System::IO::FileSystemInfo* ToFileSystemInfo();

  /// @brief Method ToFullPath, addr 0x1fcdee4, size 0x28, virtual false, abstract: false, final false
  inline ::StringW ToFullPath();

  /// @brief Method ToSpecifiedFullPath, addr 0x1fcdf0c, size 0x184, virtual false, abstract: false, final false
  inline ::StringW ToSpecifiedFullPath();

  /// @brief Method get_Attributes, addr 0x1fcde28, size 0x48, virtual false, abstract: false, final false
  inline ::System::IO::FileAttributes get_Attributes();

  /// @brief Method get_Directory, addr 0x1fcddd4, size 0x10, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> get_Directory();

  /// @brief Method get_FileName, addr 0x1fcdd40, size 0x94, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> get_FileName();

  /// @brief Method get_FullPath, addr 0x1fcdc10, size 0x130, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> get_FullPath();

  /// @brief Method get_IsDirectory, addr 0x1fcde70, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDirectory();

  /// @brief Method get_OriginalRootDirectory, addr 0x1fcde0c, size 0x10, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> get_OriginalRootDirectory();

  /// @brief Method get_RootDirectory, addr 0x1fcddf0, size 0x10, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> get_RootDirectory();

  /// @brief Method set_Directory, addr 0x1fcdde4, size 0xc, virtual false, abstract: false, final false
  inline void set_Directory(::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method set_OriginalRootDirectory, addr 0x1fcde1c, size 0xc, virtual false, abstract: false, final false
  inline void set_OriginalRootDirectory(::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method set_RootDirectory, addr 0x1fcde00, size 0xc, virtual false, abstract: false, final false
