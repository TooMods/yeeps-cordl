...
public:
  // Declarations
  /// @brief Method GetRelativeMousePositionForDrag, addr 0x29050a8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method RelativeMouseAtScaled, addr 0x2905118, size 0x468, virtual false, abstract: false, final false
