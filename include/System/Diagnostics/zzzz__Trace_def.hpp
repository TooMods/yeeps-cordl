...
public:
  ...
  /// @brief Method get_AutoFlush, addr 0x12b60f4, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_AutoFlush();

  /// @brief Method get_CorrelationManager, addr 0x12b61a0, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::CorrelationManager* get_CorrelationManager();

  /// @brief Method get_Listeners, addr 0x12b5e54, size 0x4c, virtual false, abstract: false, final false
