...
public:
  ...
  /// @brief Method .ctor, addr 0x12bfb70, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW description);

  /// @brief Method get_Description, addr 0x12bfbd8, size 0x8, virtual true, abstract: false, final false
