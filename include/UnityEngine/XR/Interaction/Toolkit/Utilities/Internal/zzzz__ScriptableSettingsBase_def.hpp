...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::Utilities::Internal::ScriptableSettingsBase);
// Type: UnityEngine.XR.Interaction.Toolkit.Utilities.Internal::ScriptableSettingsBase
// SizeInfo { instance_size: 24, native_size: -1, calculated_instance_size: 24, calculated_native_size: 24, minimum_alignment: 8, natural_alignment: 0, packing: None, specified_packing: None }
namespace UnityEngine::XR::Interaction::Toolkit::Utilities::Internal {
// Is value type: false
// CS Name: ::UnityEngine.XR.Interaction.Toolkit.Utilities.Internal::ScriptableSettingsBase*
...
public:
  ...
  /// @brief Method Awake, addr 0x3022d30, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetInstanceByType, addr 0x3022c70, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::Interaction::Toolkit::Utilities::Internal::ScriptableSettingsBase> GetInstanceByType(::System::Type* settingsType);

  static inline ::UnityEngine::XR::Interaction::Toolkit::Utilities::Internal::ScriptableSettingsBase* New_ctor();

  /// @brief Method OnEnable, addr 0x3022d34, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnLoaded, addr 0x3022d40, size 0x4, virtual true, abstract: false, final false
  inline void OnLoaded();

  /// @brief Method ValidatePath, addr 0x3022d44, size 0x478, virtual false, abstract: false, final false
  static inline bool ValidatePath(::StringW path, ByRef<::StringW> cleanedPath);

  /// @brief Method .ctor, addr 0x30231bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field k_PathExceptionMessage offset 0xffffffff size 0x8
  static constexpr ::ConstString k_PathExceptionMessage{ u"Exception caught trying to create path." };
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::XR::Interaction::Toolkit::Utilities::Internal::ScriptableSettingsBase, 0x18>, "Size mismatch!");
