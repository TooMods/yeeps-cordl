...
public:
  // Declarations
  /// @brief Method Box, addr 0x2f4a8e4, size 0x958, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToJNIArray, addr 0x2f4ef88, size 0x9b4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x2f4e97c, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJavaProxy, addr 0x2f4e3fc, size 0x88, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(void* player, void* delegateHandle, ::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method CreateJavaRunnable, addr 0x2f4e484, size 0x60, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method DeleteJNIArgArray, addr 0x2f4ffd8, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2f501e0, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetConstructorID, addr 0x2f50330, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldID, addr 0x2f5083c, size 0x318, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* jclass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodID, addr 0x2f502f8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodID, addr 0x2f50530, size 0x210, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodIDFallback, addr 0x2f50740, size 0xfc, virtual false, abstract: false, final false
  static inline void* GetMethodIDFallback(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetSignature, addr 0x2f50200, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x2f50b90, size 0xe74, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method InvokeJavaProxyMethod, addr 0x2f4e4e4, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method Unbox, addr 0x2f4b5f0, size 0x8f8, virtual false, abstract: false, final false
  static inline ::System::Object* Unbox(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method UnboxArray, addr 0x2f4f940, size 0x698, virtual false, abstract: false, final false
  static inline ::System::Object* UnboxArray(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method .ctor, addr 0x2f51a04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
