...
public:
  ...
  /// @brief Method Copy, addr 0x128c89c, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::LayoutData Copy();

  /// @brief Method CopyFrom, addr 0x128c8b8, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::LayoutData> other);

  /// @brief Method Equals, addr 0x128cb98, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x128cb4c, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::LayoutData other);

  /// @brief Method GetHashCode, addr 0x128cc40, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x128c8cc, size 0x280, virtual false, abstract: false, final false
