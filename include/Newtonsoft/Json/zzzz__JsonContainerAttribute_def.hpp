...
public:
  ...
  /// @brief Method .ctor, addr 0x25c4778, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c47d0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW id);

  /// @brief Method get_Description, addr 0x25c4820, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_Id, addr 0x25c4800, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_IsReference, addr 0x25c4888, size 0x3c, virtual false, abstract: false, final false
  inline bool get_IsReference();

  /// @brief Method get_ItemConverterParameters, addr 0x25c4840, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> get_ItemConverterParameters();

  /// @brief Method get_ItemConverterType, addr 0x25c4830, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ItemConverterType();

  /// @brief Method get_ItemIsReference, addr 0x25c492c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_ItemIsReference();

  /// @brief Method get_ItemReferenceLoopHandling, addr 0x25c49d0, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ReferenceLoopHandling get_ItemReferenceLoopHandling();

  /// @brief Method get_ItemTypeNameHandling, addr 0x25c4a74, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::TypeNameHandling get_ItemTypeNameHandling();

  /// @brief Method get_NamingStrategyInstance, addr 0x25c4878, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::NamingStrategy* get_NamingStrategyInstance();

  /// @brief Method get_NamingStrategyParameters, addr 0x25c4864, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> get_NamingStrategyParameters();

  /// @brief Method get_NamingStrategyType, addr 0x25c4850, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_NamingStrategyType();

  /// @brief Method get_Title, addr 0x25c4810, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Title();

  /// @brief Method set_Description, addr 0x25c4828, size 0x8, virtual false, abstract: false, final false
  inline void set_Description(::StringW value);

  /// @brief Method set_Id, addr 0x25c4808, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);

  /// @brief Method set_IsReference, addr 0x25c48c4, size 0x68, virtual false, abstract: false, final false
  inline void set_IsReference(bool value);

  /// @brief Method set_ItemConverterParameters, addr 0x25c4848, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemConverterParameters(::ArrayW<::System::Object*, ::Array<::System::Object*>*> value);

  /// @brief Method set_ItemConverterType, addr 0x25c4838, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemConverterType(::System::Type* value);

  /// @brief Method set_ItemIsReference, addr 0x25c4968, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemIsReference(bool value);

  /// @brief Method set_ItemReferenceLoopHandling, addr 0x25c4a0c, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemReferenceLoopHandling(::Newtonsoft::Json::ReferenceLoopHandling value);

  /// @brief Method set_ItemTypeNameHandling, addr 0x25c4ab0, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemTypeNameHandling(::Newtonsoft::Json::TypeNameHandling value);

  /// @brief Method set_NamingStrategyInstance, addr 0x25c4880, size 0x8, virtual false, abstract: false, final false
  inline void set_NamingStrategyInstance(::Newtonsoft::Json::Serialization::NamingStrategy* value);

  /// @brief Method set_NamingStrategyParameters, addr 0x25c486c, size 0xc, virtual false, abstract: false, final false
  inline void set_NamingStrategyParameters(::ArrayW<::System::Object*, ::Array<::System::Object*>*> value);

  /// @brief Method set_NamingStrategyType, addr 0x25c4858, size 0xc, virtual false, abstract: false, final false
  inline void set_NamingStrategyType(::System::Type* value);

  /// @brief Method set_Title, addr 0x25c4818, size 0x8, virtual false, abstract: false, final false
