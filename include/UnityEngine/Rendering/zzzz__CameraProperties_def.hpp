...
public:
  ...
  /// @brief Method Equals, addr 0x2a9a304, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a99398, size 0xf6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::CameraProperties other);

  /// @brief Method GetCameraCullingPlane, addr 0x2a992ac, size 0xec, virtual false, abstract: false, final false
  inline ::UnityEngine::Plane GetCameraCullingPlane(int32_t index);

  /// @brief Method GetHashCode, addr 0x2a9a3bc, size 0x1174, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetShadowCullingPlane, addr 0x2a991c0, size 0xec, virtual false, abstract: false, final false
