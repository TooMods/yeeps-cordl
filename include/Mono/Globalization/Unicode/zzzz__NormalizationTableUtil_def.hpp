...
public:
  ...
  /// @brief Method MapIdx, addr 0x1d08c94, size 0x68, virtual false, abstract: false, final false
  static inline int32_t MapIdx(int32_t cp);

  /// @brief Method PropIdx, addr 0x1d08c2c, size 0x68, virtual false, abstract: false, final false
