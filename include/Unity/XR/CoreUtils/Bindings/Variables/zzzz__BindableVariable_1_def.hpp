...
// Write type traits
MARK_GEN_REF_PTR_T(::Unity::XR::CoreUtils::Bindings::Variables::BindableVariable_1);
// Type: Unity.XR.CoreUtils.Bindings.Variables::BindableVariable`1
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BindableVariable_1", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BindableVariable_1(BindableVariable_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BindableVariable_1", modifiers: "const&", def_value: None }]
