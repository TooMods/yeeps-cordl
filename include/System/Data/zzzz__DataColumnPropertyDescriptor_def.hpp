...
public:
  ...
  /// @brief Method CanResetValue, addr 0x2414e60, size 0x118, virtual true, abstract: false, final false
  inline bool CanResetValue(::System::Object* component);

  /// @brief Method Equals, addr 0x2414dd0, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x2414e40, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetValue, addr 0x2414f78, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetValue, addr 0x2415004, size 0xc8, virtual true, abstract: false, final false
  inline void ResetValue(::System::Object* component);

  /// @brief Method SetValue, addr 0x24150cc, size 0xe4, virtual true, abstract: false, final false
  inline void SetValue(::System::Object* component, ::System::Object* value);

  /// @brief Method ShouldSerializeValue, addr 0x24151b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2414b24, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataColumn* dataColumn);

  /// @brief Method get_Attributes, addr 0x2414b5c, size 0x1c8, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* get_Attributes();

  /// @brief Method get_Column, addr 0x2414d24, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Column();

  /// @brief Method get_ComponentType, addr 0x2414d2c, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Type* get_ComponentType();

  /// @brief Method get_IsBrowsable, addr 0x24151b8, size 0x48, virtual true, abstract: false, final false
  inline bool get_IsBrowsable();

  /// @brief Method get_IsReadOnly, addr 0x2414d98, size 0x1c, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_PropertyType, addr 0x2414db4, size 0x1c, virtual true, abstract: false, final false
