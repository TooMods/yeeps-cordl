...
public:
  ...
  /// @brief Method Convert, addr 0x1b5c86c, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b5c83c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::TypeCode to, bool isLiftedToNull);

  /// @brief Method get_InstructionName, addr 0x1b5c7fc, size 0x40, virtual true, abstract: false, final false
