...
public:
  ...
  /// @brief Method Reset, addr 0x1e1bef4, size 0x28, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e1bcd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF7Encoding* encoding);

  /// @brief Method get_HasState, addr 0x1e1bf1c, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Reset, addr 0x1e1bf2c, size 0x24, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e1bd40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF7Encoding* encoding);

  /// @brief Method get_HasState, addr 0x1e1bf50, size 0x20, virtual true, abstract: false, final false
  inline bool get_HasState();
...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x1e1bf70, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x1e1bfec, size 0x5c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x1e1c048, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Text::__UTF7Encoding__DecoderUTF7Fallback* New_ctor();

  /// @brief Method .ctor, addr 0x1e1a458, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MaxCharCount, addr 0x1e1bfe4, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Fallback, addr 0x1e1c050, size 0x40, virtual true, abstract: false, final false
  inline bool Fallback(::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method GetNextChar, addr 0x1e1c090, size 0x20, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method InternalFallback, addr 0x1e1c0cc, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1e1c0bc, size 0x10, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e1bfd4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::__UTF7Encoding__DecoderUTF7Fallback* fallback);

  /// @brief Method get_Remaining, addr 0x1e1c0b0, size 0xc, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x1e1a460, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetByteCount, addr 0x1e1a59c, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e1a7b0, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e1b604, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, ::System::Text::EncoderNLS* baseEncoder);

  /// @brief Method GetByteCount, addr 0x1e1a720, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetBytes, addr 0x1e1aae8, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1ad64, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1b620, size 0x39c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1a888, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x1e1ae64, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e1afe8, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e1b9bc, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars, addr 0x1e1b0c0, size 0x27c, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x1e1b33c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x1e1b9d8, size 0x29c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x1e1bc74, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x1e1bce0, size 0x60, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetHashCode, addr 0x1e1a530, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMaxByteCount, addr 0x1e1bd44, size 0xc4, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x1e1be08, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetString, addr 0x1e1b43c, size 0x1c8, virtual true, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method MakeTables, addr 0x1e1a11c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultFallbacks, addr 0x1e1a3a0, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e1a0c8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e1a0ec, size 0x30, virtual false, abstract: false, final false
