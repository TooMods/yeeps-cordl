...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x1ce1934, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetUnhandledAttributes, addr 0x1ce192c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce193c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Annotation, addr 0x1ce18fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnnotation* get_Annotation();

  /// @brief Method get_Id, addr 0x1ce18ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_IdAttribute, addr 0x1ce191c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IdAttribute();

  /// @brief Method get_UnhandledAttributes, addr 0x1ce190c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::XmlAttribute*, ::Array<::System::Xml::XmlAttribute*>*> get_UnhandledAttributes();

  /// @brief Method set_Annotation, addr 0x1ce1904, size 0x8, virtual false, abstract: false, final false
  inline void set_Annotation(::System::Xml::Schema::XmlSchemaAnnotation* value);

  /// @brief Method set_Id, addr 0x1ce18f4, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);

  /// @brief Method set_IdAttribute, addr 0x1ce1924, size 0x8, virtual true, abstract: false, final false
  inline void set_IdAttribute(::StringW value);

  /// @brief Method set_UnhandledAttributes, addr 0x1ce1914, size 0x8, virtual false, abstract: false, final false
