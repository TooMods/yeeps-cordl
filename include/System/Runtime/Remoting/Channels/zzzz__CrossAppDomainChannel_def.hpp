...
public:
  ...
  /// @brief Method CreateMessageSink, addr 0x18584bc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method RegisterCrossAppDomainChannel, addr 0x18582b8, size 0x144, virtual false, abstract: false, final false
  static inline void RegisterCrossAppDomainChannel();

  /// @brief Method StartListening, addr 0x18584b8, size 0x4, virtual true, abstract: false, final false
  inline void StartListening(::System::Object* data);

  /// @brief Method .ctor, addr 0x18583fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Object* getStaticF_s_lock();

  /// @brief Method get_ChannelData, addr 0x185844c, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Object* get_ChannelData();

  /// @brief Method get_ChannelName, addr 0x1858404, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_ChannelName();

  /// @brief Method get_ChannelPriority, addr 0x1858444, size 0x8, virtual true, abstract: false, final false
