...
public:
  ...
  /// @brief Method .ctor, addr 0x283ef04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_fileName, addr 0x283eef4, size 0x8, virtual false, abstract: false, final false
  inline void set_fileName(::StringW value);

  /// @brief Method set_menuName, addr 0x283eeec, size 0x8, virtual false, abstract: false, final false
  inline void set_menuName(::StringW value);

  /// @brief Method set_order, addr 0x283eefc, size 0x8, virtual false, abstract: false, final false
