...
public:
  ...
  /// @brief Method MoveNext, addr 0x11a01dc, size 0x950, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::JsonPath::__ArraySliceFilter___ExecuteFilter_d__12* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x11a0c2c, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x11a0bdc, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x11a0ce0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x11a0be4, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x11a0c24, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x11a01c0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x11a0b2c, size 0xb0, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x11a016c, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ExecuteFilter, addr 0x11a00dc, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x11a01a0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a01b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_End, addr 0x11a00bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_End();

  /// @brief Method get_Start, addr 0x11a00ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_Start();

  /// @brief Method get_Step, addr 0x11a00cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_Step();

  /// @brief Method set_End, addr 0x11a00c4, size 0x8, virtual false, abstract: false, final false
  inline void set_End(::System::Nullable_1<int32_t> value);

  /// @brief Method set_Start, addr 0x11a00b4, size 0x8, virtual false, abstract: false, final false
  inline void set_Start(::System::Nullable_1<int32_t> value);

  /// @brief Method set_Step, addr 0x11a00d4, size 0x8, virtual false, abstract: false, final false
