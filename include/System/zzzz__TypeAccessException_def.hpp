...
public:
  ...
  /// @brief Method .ctor, addr 0x2f0a09c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f0a0f8, size 0x8, virtual false, abstract: false, final false
