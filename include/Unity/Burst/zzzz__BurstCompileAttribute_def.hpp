...
public:
  ...
  /// @brief Method .ctor, addr 0x2622444, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262244c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Burst::FloatPrecision floatPrecision, ::Unity::Burst::FloatMode floatMode);

  /// @brief Method .ctor, addr 0x2622478, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::StringW, ::Array<::StringW>*> options);

  /// @brief Method get_CompileSynchronously, addr 0x26220d4, size 0x6c, virtual false, abstract: false, final false
  inline bool get_CompileSynchronously();

  /// @brief Method get_Debug, addr 0x26221a8, size 0x6c, virtual false, abstract: false, final false
  inline bool get_Debug();

  /// @brief Method get_DisableDirectCall, addr 0x2622350, size 0x6c, virtual false, abstract: false, final false
  inline bool get_DisableDirectCall();

  /// @brief Method get_DisableSafetyChecks, addr 0x262227c, size 0x6c, virtual false, abstract: false, final false
  inline bool get_DisableSafetyChecks();

  /// @brief Method get_FloatMode, addr 0x26220b4, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Burst::FloatMode get_FloatMode();

  /// @brief Method get_FloatPrecision, addr 0x26220c4, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Burst::FloatPrecision get_FloatPrecision();

  /// @brief Method get_OptimizeFor, addr 0x2622424, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Burst::OptimizeFor get_OptimizeFor();

  /// @brief Method get_Options, addr 0x2622434, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Options();

  /// @brief Method set_CompileSynchronously, addr 0x2622140, size 0x68, virtual false, abstract: false, final false
  inline void set_CompileSynchronously(bool value);

  /// @brief Method set_Debug, addr 0x2622214, size 0x68, virtual false, abstract: false, final false
  inline void set_Debug(bool value);

  /// @brief Method set_DisableDirectCall, addr 0x26223bc, size 0x68, virtual false, abstract: false, final false
  inline void set_DisableDirectCall(bool value);

  /// @brief Method set_DisableSafetyChecks, addr 0x26222e8, size 0x68, virtual false, abstract: false, final false
  inline void set_DisableSafetyChecks(bool value);

  /// @brief Method set_FloatMode, addr 0x26220bc, size 0x8, virtual false, abstract: false, final false
  inline void set_FloatMode(::Unity::Burst::FloatMode value);

  /// @brief Method set_FloatPrecision, addr 0x26220cc, size 0x8, virtual false, abstract: false, final false
  inline void set_FloatPrecision(::Unity::Burst::FloatPrecision value);

  /// @brief Method set_OptimizeFor, addr 0x262242c, size 0x8, virtual false, abstract: false, final false
  inline void set_OptimizeFor(::Unity::Burst::OptimizeFor value);

  /// @brief Method set_Options, addr 0x262243c, size 0x8, virtual false, abstract: false, final false
