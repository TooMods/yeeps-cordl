...
public:
  ...
  /// @brief Method add_ListChanged, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method remove_ListChanged, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
