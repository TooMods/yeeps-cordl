...
public:
  ...
  /// @brief Method .ctor, addr 0x2f57c50, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XText* text);

  /// @brief Method get_ParentNode, addr 0x2f57cb8, size 0x44, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode();

  /// @brief Method get_Text, addr 0x2f57bd8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XText* get_Text();

  /// @brief Method get_Value, addr 0x2f57c78, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x2f57c94, size 0x24, virtual true, abstract: false, final false
