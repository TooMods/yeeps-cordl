...
public:
  ...
  /// @brief Method AddValue, addr 0x1cac2e0, size 0xf0, virtual false, abstract: false, final false
  inline void AddValue(::StringW value);

  /// @brief Method CheckEnumeration, addr 0x1cac44c, size 0xb8, virtual false, abstract: false, final false
  inline bool CheckEnumeration(::System::Object* pVal);

  /// @brief Method CheckValue, addr 0x1cac504, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cac1a8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1cac120, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* name, ::StringW prefix);

  /// @brief Method get_Datatype, addr 0x1cac2d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* get_Datatype();

  /// @brief Method get_DefaultValueRaw, addr 0x1cac3e0, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DefaultValueRaw();

  /// @brief Method get_DefaultValueTyped, addr 0x1cac43c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValueTyped();

  /// @brief Method get_IsDeclaredInExternal, addr 0x1cac27c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDeclaredInExternal();

  /// @brief Method get_MaxLength, addr 0x1cac2a0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxLength();

  /// @brief Method get_MinLength, addr 0x1cac2b0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MinLength();

  /// @brief Method get_Name, addr 0x1cac210, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Name();

  /// @brief Method get_Prefix, addr 0x1cac220, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Presence, addr 0x1cac290, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::__SchemaDeclBase__Use get_Presence();

  /// @brief Method get_SchemaType, addr 0x1cac2c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType();

  /// @brief Method get_Values, addr 0x1cac3d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Values();

  /// @brief Method set_Datatype, addr 0x1cac2d8, size 0x8, virtual false, abstract: false, final false
  inline void set_Datatype(::System::Xml::Schema::XmlSchemaDatatype* value);

  /// @brief Method set_DefaultValueRaw, addr 0x1cac434, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValueRaw(::StringW value);

  /// @brief Method set_DefaultValueTyped, addr 0x1cac444, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValueTyped(::System::Object* value);

  /// @brief Method set_IsDeclaredInExternal, addr 0x1cac284, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDeclaredInExternal(bool value);

  /// @brief Method set_MaxLength, addr 0x1cac2a8, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxLength(int64_t value);

  /// @brief Method set_MinLength, addr 0x1cac2b8, size 0x8, virtual false, abstract: false, final false
  inline void set_MinLength(int64_t value);

  /// @brief Method set_Name, addr 0x1cac218, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_Prefix, addr 0x1cac274, size 0x8, virtual false, abstract: false, final false
  inline void set_Prefix(::StringW value);

  /// @brief Method set_Presence, addr 0x1cac298, size 0x8, virtual false, abstract: false, final false
  inline void set_Presence(::System::Xml::Schema::__SchemaDeclBase__Use value);

  /// @brief Method set_SchemaType, addr 0x1cac2c8, size 0x8, virtual false, abstract: false, final false
  inline void set_SchemaType(::System::Xml::Schema::XmlSchemaType* value);

  /// @brief Method set_Values, addr 0x1cac3d8, size 0x8, virtual false, abstract: false, final false
