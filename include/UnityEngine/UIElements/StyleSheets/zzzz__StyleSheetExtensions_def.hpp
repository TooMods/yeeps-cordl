...
public:
  // Declarations
  /// @brief Method IsVarFunction, addr 0x1f34c24, size 0x34, virtual false, abstract: false, final false
  static inline bool IsVarFunction(::UnityEngine::UIElements::StyleValueHandle handle);

  /// @brief Method ReadAsString, addr 0x1f346b4, size 0x2dc, virtual false, abstract: false, final false
