...
public:
  ...
  /// @brief Method ArrayCountIncrement, addr 0x1ab49f4, size 0x10, virtual false, abstract: false, final false
  inline void ArrayCountIncrement(int32_t value);

  /// @brief Method GetNext, addr 0x1ab4a04, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x1ab49a4, size 0x50, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x1ab4934, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
