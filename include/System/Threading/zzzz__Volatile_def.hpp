...
public:
  ...
  /// @brief Method Write, addr 0xed1f9c, size 0x24, virtual false, abstract: false, final false
  static inline void Write(ByRef<bool> location, bool value);

  /// @brief Method Write, addr 0xed1fc0, size 0x24, virtual false, abstract: false, final false
