...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::Universal::ColorAdjustments::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2725c74;
...
constexpr UnityEngine::Rendering::Universal::ColorAdjustments::operator ::UnityEngine::Rendering::Universal::IPostProcessComponent*() noexcept {
...
constexpr ::UnityEngine::Rendering::Universal::IPostProcessComponent* UnityEngine::Rendering::Universal::ColorAdjustments::i___UnityEngine__Rendering__Universal__IPostProcessComponent() noexcept {
  return static_cast<::UnityEngine::Rendering::Universal::IPostProcessComponent*>(static_cast<void*>(this));
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::FloatParameter*> const& UnityEngine::Rendering::Universal::ColorAdjustments::__cordl_internal_get_postExposure() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___postExposure;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ClampedFloatParameter*> const& UnityEngine::Rendering::Universal::ColorAdjustments::__cordl_internal_get_contrast() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___contrast;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ColorParameter*> const& UnityEngine::Rendering::Universal::ColorAdjustments::__cordl_internal_get_colorFilter() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___colorFilter;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ClampedFloatParameter*> const& UnityEngine::Rendering::Universal::ColorAdjustments::__cordl_internal_get_hueShift() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___hueShift;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ClampedFloatParameter*> const& UnityEngine::Rendering::Universal::ColorAdjustments::__cordl_internal_get_saturation() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___saturation;
}
