...
public:
  ...
  /// @brief Method .ctor, addr 0x21c6c0c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t eventId);

  /// @brief Method set_EventId, addr 0x21c6c34, size 0x8, virtual false, abstract: false, final false
  inline void set_EventId(int32_t value);

  /// @brief Method set_Keywords, addr 0x21c6c44, size 0x8, virtual false, abstract: false, final false
  inline void set_Keywords(::System::Diagnostics::Tracing::EventKeywords value);

  /// @brief Method set_Level, addr 0x21c6c3c, size 0x8, virtual false, abstract: false, final false
  inline void set_Level(::System::Diagnostics::Tracing::EventLevel value);

  /// @brief Method set_Message, addr 0x21c6c4c, size 0x8, virtual false, abstract: false, final false
