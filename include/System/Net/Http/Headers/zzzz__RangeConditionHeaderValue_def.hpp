...
public:
  ...
  /// @brief Method Equals, addr 0x162aaa8, size 0x144, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x162abec, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x162aaa0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x162aebc, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x162ac70, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x162a960, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset date);

  /// @brief Method .ctor, addr 0x162a9f0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::EntityTagHeaderValue* entityTag);

  /// @brief Method get_Date, addr 0x162aa68, size 0x14, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::DateTimeOffset> get_Date();

  /// @brief Method get_EntityTag, addr 0x162aa90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::EntityTagHeaderValue* get_EntityTag();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Date, addr 0x162aa7c, size 0x14, virtual false, abstract: false, final false
  inline void set_Date(::System::Nullable_1<::System::DateTimeOffset> value);

  /// @brief Method set_EntityTag, addr 0x162aa98, size 0x8, virtual false, abstract: false, final false
