...
public:
  ...
  /// @brief Method Equals, addr 0x2a3873c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a387cc, size 0x80, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TextShadow other);

  /// @brief Method GetHashCode, addr 0x2a3884c, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method LerpUnclamped, addr 0x2a38a90, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2a3899c, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2a38924, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::TextShadow style1, ::UnityEngine::UIElements::TextShadow style2);

  /// @brief Method op_Inequality, addr 0x2a38954, size 0x48, virtual false, abstract: false, final false
