...
public:
  ...
  /// @brief Method ExpandTree, addr 0x3051b28, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTreeNoRecursive, addr 0x3051948, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3051b8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LeftChild, addr 0x3051928, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SyntaxTreeNode* get_LeftChild();

  /// @brief Method get_RightChild, addr 0x3051938, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SyntaxTreeNode* get_RightChild();

  /// @brief Method set_LeftChild, addr 0x3051930, size 0x8, virtual false, abstract: false, final false
  inline void set_LeftChild(::System::Xml::Schema::SyntaxTreeNode* value);

  /// @brief Method set_RightChild, addr 0x3051940, size 0x8, virtual false, abstract: false, final false
