...
public:
  ...
  /// @brief Method CharMapIdx, addr 0x1ea06e0, size 0x94, virtual false, abstract: false, final false
  static inline int32_t CharMapIdx(int32_t cp);

  /// @brief Method Combine, addr 0x1ea0b7c, size 0x13c, virtual false, abstract: false, final false
  static inline ::System::Text::StringBuilder* Combine(::StringW source, int32_t start, int32_t checkType);

  /// @brief Method Combine, addr 0x1ea0cb8, size 0x110, virtual false, abstract: false, final false
  static inline void Combine(::System::Text::StringBuilder* sb, int32_t i, int32_t checkType);

  /// @brief Method CombineHangul, addr 0x1ea0ee4, size 0x1c4, virtual false, abstract: false, final false
  static inline int32_t CombineHangul(::System::Text::StringBuilder* sb, ::StringW s, int32_t current);

  /// @brief Method Compose, addr 0x1ea096c, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW Compose(::StringW source, int32_t checkType);

  /// @brief Method Decompose, addr 0x1ea1430, size 0x8c, virtual false, abstract: false, final false
  static inline ::StringW Decompose(::StringW source, int32_t checkType);

  /// @brief Method Decompose, addr 0x1ea0a4c, size 0x130, virtual false, abstract: false, final false
  static inline void Decompose(::StringW source, ByRef<::System::Text::StringBuilder*> sb, int32_t checkType);

  /// @brief Method DecomposeChar, addr 0x1ea14bc, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method Fetch, addr 0x1ea12dc, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t Fetch(::System::Text::StringBuilder* sb, ::StringW s, int32_t i);

  /// @brief Method GetCanonical, addr 0x1ea1904, size 0x1b8, virtual false, abstract: false, final false
  static inline int32_t GetCanonical(int32_t c, ::ArrayW<int32_t, ::Array<int32_t>*> buf, int32_t bufIdx, int32_t checkType);

  /// @brief Method GetCanonicalHangul, addr 0x1ea1abc, size 0xec, virtual false, abstract: false, final false
  static inline int32_t GetCanonicalHangul(int32_t s, ::ArrayW<int32_t, ::Array<int32_t>*> buf, int32_t bufIdx);

  /// @brief Method GetCombiningClass, addr 0x1ea0774, size 0xa8, virtual false, abstract: false, final false
  static inline uint8_t GetCombiningClass(int32_t c);

  /// @brief Method GetPrimaryCompositeFromMapIndex, addr 0x1ea081c, size 0xa8, virtual false, abstract: false, final false
  static inline int32_t GetPrimaryCompositeFromMapIndex(int32_t src);

  /// @brief Method GetPrimaryCompositeHelperIndex, addr 0x1ea08c4, size 0xa8, virtual false, abstract: false, final false
  static inline int32_t GetPrimaryCompositeHelperIndex(int32_t cp);

  /// @brief Method Normalize, addr 0x1ea1ba8, size 0xbc, virtual false, abstract: false, final false
  static inline ::StringW Normalize(::StringW source, ::System::Text::NormalizationForm normalizationForm);

  /// @brief Method Normalize, addr 0x1ea1c64, size 0x98, virtual false, abstract: false, final false
  static inline ::StringW Normalize(::StringW source, int32_t type);

  /// @brief Method PropValue, addr 0x1ea064c, size 0x94, virtual false, abstract: false, final false
  static inline uint32_t PropValue(int32_t cp);

  /// @brief Method QuickCheck, addr 0x1ea0dc8, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Text::NormalizationCheck QuickCheck(char16_t c, int32_t type);

  /// @brief Method ReorderCanonical, addr 0x1ea1694, size 0x270, virtual false, abstract: false, final false
  static inline void ReorderCanonical(::StringW src, ByRef<::System::Text::StringBuilder*> sb, int32_t start);

  /// @brief Method TryCompose, addr 0x1ea1318, size 0x118, virtual false, abstract: false, final false
  static inline int32_t TryCompose(int32_t i, int32_t starter, int32_t candidate);

  /// @brief Method TryComposeWithPreviousStarter, addr 0x1ea10a8, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method load_normalization_resource, addr 0x1ea1cfc, size 0x4, virtual false, abstract: false, final false
