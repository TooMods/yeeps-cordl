...
public:
  ...
  /// @brief Method Equals, addr 0x1ff8bdc, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1ff8c6c, size 0x124, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UI::ColorBlock other);

  /// @brief Method GetHashCode, addr 0x1ff8dfc, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::UI::ColorBlock getStaticF_defaultColorBlock();

  /// @brief Method get_colorMultiplier, addr 0x1ff8b40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_colorMultiplier();

  /// @brief Method get_disabledColor, addr 0x1ff8b28, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_disabledColor();

  /// @brief Method get_fadeDuration, addr 0x1ff8b50, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fadeDuration();

  /// @brief Method get_highlightedColor, addr 0x1ff8ae0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_highlightedColor();

  /// @brief Method get_normalColor, addr 0x1ff8ac8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_normalColor();

  /// @brief Method get_pressedColor, addr 0x1ff8af8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_pressedColor();

  /// @brief Method get_selectedColor, addr 0x1ff8b10, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1ff8d90, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UI::ColorBlock point1, ::UnityEngine::UI::ColorBlock point2);

  /// @brief Method op_Inequality, addr 0x1ff8dc4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method set_colorMultiplier, addr 0x1ff8b48, size 0x8, virtual false, abstract: false, final false
  inline void set_colorMultiplier(float_t value);

  /// @brief Method set_disabledColor, addr 0x1ff8b34, size 0xc, virtual false, abstract: false, final false
  inline void set_disabledColor(::UnityEngine::Color value);

  /// @brief Method set_fadeDuration, addr 0x1ff8b58, size 0x8, virtual false, abstract: false, final false
  inline void set_fadeDuration(float_t value);

  /// @brief Method set_highlightedColor, addr 0x1ff8aec, size 0xc, virtual false, abstract: false, final false
  inline void set_highlightedColor(::UnityEngine::Color value);

  /// @brief Method set_normalColor, addr 0x1ff8ad4, size 0xc, virtual false, abstract: false, final false
  inline void set_normalColor(::UnityEngine::Color value);

  /// @brief Method set_pressedColor, addr 0x1ff8b04, size 0xc, virtual false, abstract: false, final false
  inline void set_pressedColor(::UnityEngine::Color value);

  /// @brief Method set_selectedColor, addr 0x1ff8b1c, size 0xc, virtual false, abstract: false, final false
