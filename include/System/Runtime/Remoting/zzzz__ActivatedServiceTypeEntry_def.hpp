...
public:
  ...
  /// @brief Method ToString, addr 0x197439c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x197426c, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName);

  /// @brief Method get_ObjectType, addr 0x1974394, size 0x8, virtual false, abstract: false, final false
