...
public:
  ...
  /// @brief Method AddTriangle, addr 0x2906c48, size 0x17c, virtual false, abstract: false, final false
  inline void AddTriangle(int32_t idx0, int32_t idx1, int32_t idx2);

  /// @brief Method AddUIVertexQuad, addr 0x29137e4, size 0x110, virtual false, abstract: false, final false
  inline void AddUIVertexQuad(::ArrayW<::UnityEngine::UIVertex, ::Array<::UnityEngine::UIVertex>*> verts);

  /// @brief Method AddUIVertexStream, addr 0x2917890, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method AddUIVertexTriangleStream, addr 0x291793c, size 0x50, virtual false, abstract: false, final false
  inline void AddUIVertexTriangleStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* verts);

  /// @brief Method AddVert, addr 0x2906b18, size 0x130, virtual false, abstract: false, final false
  inline void AddVert(::UnityEngine::Vector3 position, ::UnityEngine::Color32 color, ::UnityEngine::Vector4 uv0);

  /// @brief Method AddVert, addr 0x29176ec, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddVert, addr 0x29171f0, size 0x4fc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddVert, addr 0x29177fc, size 0x94, virtual false, abstract: false, final false
  inline void AddVert(::UnityEngine::UIVertex v);

  /// @brief Method Clear, addr 0x29069fc, size 0x11c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Dispose, addr 0x2916b84, size 0x1b4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FillMesh, addr 0x291708c, size 0x164, virtual false, abstract: false, final false
  inline void FillMesh(::UnityEngine::Mesh* mesh);

  /// @brief Method GetUIVertexStream, addr 0x291798c, size 0x50, virtual false, abstract: false, final false
  inline void GetUIVertexStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* stream);

  /// @brief Method InitializeListIfRequired, addr 0x29169f4, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateUIVertex, addr 0x2916dd0, size 0x160, virtual false, abstract: false, final false
  inline void PopulateUIVertex(ByRef<::UnityEngine::UIVertex> vertex, int32_t i);

  /// @brief Method SetUIVertex, addr 0x2916f30, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29167b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x29167bc, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentIndexCount, addr 0x2916d84, size 0x4c, virtual false, abstract: false, final false
  inline int32_t get_currentIndexCount();

  /// @brief Method get_currentVertCount, addr 0x2916d38, size 0x4c, virtual false, abstract: false, final false
