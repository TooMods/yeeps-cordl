...
public:
  ...
  /// @brief Method <GetRequiredProperties>b__28_0, addr 0x1456aec, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method <GetRequiredProperties>b__28_1, addr 0x1456b30, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__27_0, addr 0x1456ac4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW __ctor_b__27_0(::StringW p);

  /// @brief Method <.ctor>b__27_1, addr 0x1456acc, size 0x8, virtual false, abstract: false, final false
  inline bool __ctor_b__27_1(::StringW p);

  /// @brief Method <.ctor>b__27_2, addr 0x1456ad4, size 0x18, virtual false, abstract: false, final false
  inline bool __ctor_b__27_2(::Newtonsoft::Json::Schema::JsonSchemaModel* s);

  /// @brief Method .ctor, addr 0x1456abc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetRequiredProperties, addr 0x1456834, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x145334c, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArrayItemCount, addr 0x14567ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ArrayItemCount();

  /// @brief Method get_CurrentItemWriter, addr 0x145680c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JTokenWriter* get_CurrentItemWriter();

  /// @brief Method get_CurrentPropertyName, addr 0x14567dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrentPropertyName();

  /// @brief Method get_IsUniqueArray, addr 0x14567fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsUniqueArray();

  /// @brief Method get_RequiredProperties, addr 0x1456824, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, bool>* get_RequiredProperties();

  /// @brief Method get_Schemas, addr 0x145681c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::JsonSchemaModel*>* get_Schemas();

  /// @brief Method get_TokenType, addr 0x145682c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JTokenType get_TokenType();

  /// @brief Method get_UniqueArrayItems, addr 0x1456804, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_UniqueArrayItems();

  /// @brief Method set_ArrayItemCount, addr 0x14567f4, size 0x8, virtual false, abstract: false, final false
  inline void set_ArrayItemCount(int32_t value);

  /// @brief Method set_CurrentItemWriter, addr 0x1456814, size 0x8, virtual false, abstract: false, final false
  inline void set_CurrentItemWriter(::Newtonsoft::Json::Linq::JTokenWriter* value);

  /// @brief Method set_CurrentPropertyName, addr 0x14567e4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ValidateEndObject>b__51_0, addr 0x1456c30, size 0xc, virtual false, abstract: false, final false
  inline bool _ValidateEndObject_b__51_0(bool v);

  /// @brief Method <ValidateEndObject>b__51_1, addr 0x1456c3c, size 0x40, virtual false, abstract: false, final false
  inline bool _ValidateEndObject_b__51_1(::System::Collections::Generic::KeyValuePair_2<::StringW, bool> kv);

  /// @brief Method <ValidateEndObject>b__51_2, addr 0x1456c7c, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW _ValidateEndObject_b__51_2(::System::Collections::Generic::KeyValuePair_2<::StringW, bool> kv);

  /// @brief Method <WriteToken>b__50_0, addr 0x1456bd8, size 0x20, virtual false, abstract: false, final false
  inline bool _WriteToken_b__50_0(::Newtonsoft::Json::Schema::JsonSchemaModel* s);

  /// @brief Method <WriteToken>b__50_1, addr 0x1456bf8, size 0x18, virtual false, abstract: false, final false
  inline bool _WriteToken_b__50_1(::Newtonsoft::Json::Schema::JsonSchemaModel* s);

  /// @brief Method <WriteToken>b__50_2, addr 0x1456c10, size 0x20, virtual false, abstract: false, final false
  inline bool _WriteToken_b__50_2(::Newtonsoft::Json::Schema::JsonSchemaModel* s);

  /// @brief Method .ctor, addr 0x1456bd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Close, addr 0x1451594, size 0x3c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method FloatingPointRemainder, addr 0x145605c, size 0x6c, virtual false, abstract: false, final false
  static inline double_t FloatingPointRemainder(double_t dividend, double_t divisor);

  /// @brief Method GetCurrentNodeSchemaType, addr 0x145170c, size 0x100, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::Newtonsoft::Json::Schema::JsonSchemaType> GetCurrentNodeSchemaType();

  /// @brief Method IsPropertyDefinied, addr 0x14560c8, size 0x43c, virtual false, abstract: false, final false
  inline bool IsPropertyDefinied(::Newtonsoft::Json::Schema::JsonSchemaModel* schema, ::StringW propertyName);

  /// @brief Method IsZero, addr 0x1455ff0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Newtonsoft.Json.IJsonLineInfo.HasLineInfo, addr 0x145652c, size 0xb4, virtual true, abstract: false, final true
  inline bool Newtonsoft_Json_IJsonLineInfo_HasLineInfo();

  /// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LineNumber, addr 0x14565e0, size 0xb8, virtual true, abstract: false, final true
  inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LineNumber();

  /// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LinePosition, addr 0x1456698, size 0xb8, virtual true, abstract: false, final true
  inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LinePosition();

  /// @brief Method OnValidationEvent, addr 0x14513ac, size 0xa0, virtual false, abstract: false, final false
  inline void OnValidationEvent(::Newtonsoft::Json::Schema::JsonSchemaException* exception);

  /// @brief Method Pop, addr 0x144fe3c, size 0xa4, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::__JsonValidatingReader__SchemaScope* Pop();

  /// @brief Method ProcessValue, addr 0x14536a8, size 0x464, virtual false, abstract: false, final false
  inline void ProcessValue();

  /// @brief Method Push, addr 0x144fddc, size 0x60, virtual false, abstract: false, final false
  inline void Push(::Newtonsoft::Json::__JsonValidatingReader__SchemaScope* scope);

  /// @brief Method RaiseError, addr 0x1451058, size 0x354, virtual false, abstract: false, final false
  inline void RaiseError(::StringW message, ::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method Read, addr 0x14532e8, size 0x64, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAsBoolean, addr 0x14531b8, size 0x44, virtual true, abstract: false, final false
  inline ::System::Nullable_1<bool> ReadAsBoolean();

  /// @brief Method ReadAsBytes, addr 0x14530ac, size 0x44, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadAsBytes();

  /// @brief Method ReadAsDateTime, addr 0x1453240, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Nullable_1<::System::DateTime> ReadAsDateTime();

  /// @brief Method ReadAsDateTimeOffset, addr 0x145328c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Nullable_1<::System::DateTimeOffset> ReadAsDateTimeOffset();

  /// @brief Method ReadAsDecimal, addr 0x14530f0, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Nullable_1<::System::Decimal> ReadAsDecimal();

  /// @brief Method ReadAsDouble, addr 0x145316c, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Nullable_1<double_t> ReadAsDouble();

  /// @brief Method ReadAsInt32, addr 0x145180c, size 0x44, virtual true, abstract: false, final false
  inline ::System::Nullable_1<int32_t> ReadAsInt32();

  /// @brief Method ReadAsString, addr 0x14531fc, size 0x44, virtual true, abstract: false, final false
  inline ::StringW ReadAsString();

  /// @brief Method TestType, addr 0x1455eac, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArray, addr 0x1456504, size 0x14, virtual false, abstract: false, final false
  inline bool ValidateArray(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateBoolean, addr 0x1455868, size 0x40, virtual false, abstract: false, final false
  inline void ValidateBoolean(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateCurrentToken, addr 0x1451850, size 0x185c, virtual false, abstract: false, final false
  inline void ValidateCurrentToken();

  /// @brief Method ValidateEndArray, addr 0x1455c48, size 0x1e4, virtual false, abstract: false, final false
  inline void ValidateEndArray(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateEndObject, addr 0x14558e8, size 0x360, virtual false, abstract: false, final false
  inline void ValidateEndObject(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateFloat, addr 0x1454e74, size 0x4c8, virtual false, abstract: false, final false
  inline void ValidateFloat(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateInteger, addr 0x145486c, size 0x608, virtual false, abstract: false, final false
  inline void ValidateInteger(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateNotDisallowed, addr 0x14515d0, size 0x13c, virtual false, abstract: false, final false
  inline void ValidateNotDisallowed(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateNull, addr 0x14558a8, size 0x40, virtual false, abstract: false, final false
  inline void ValidateNull(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateObject, addr 0x1456518, size 0x14, virtual false, abstract: false, final false
  inline bool ValidateObject(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidatePropertyName, addr 0x14546c4, size 0x1a8, virtual false, abstract: false, final false
  inline void ValidatePropertyName(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method ValidateString, addr 0x145533c, size 0x52c, virtual false, abstract: false, final false
  inline void ValidateString(::Newtonsoft::Json::Schema::JsonSchemaModel* schema);

  /// @brief Method WriteToken, addr 0x1453b0c, size 0xbb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x145144c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method add_ValidationEventHandler, addr 0x144fbc8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentMemberSchemas, addr 0x144fefc, size 0x115c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::JsonSchemaModel*>* get_CurrentMemberSchemas();

  /// @brief Method get_CurrentSchemas, addr 0x144fee0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::JsonSchemaModel*>* get_CurrentSchemas();

  /// @brief Method get_Depth, addr 0x144fd24, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_Path, addr 0x144fd48, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_Path();

  /// @brief Method get_QuoteChar, addr 0x144fd6c, size 0x24, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_Reader, addr 0x145158c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::JsonReader* get_Reader();

  /// @brief Method get_Schema, addr 0x1451500, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* get_Schema();

  /// @brief Method get_TokenType, addr 0x144fd94, size 0x24, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::JsonToken get_TokenType();

  /// @brief Method get_Value, addr 0x144fd00, size 0x24, virtual true, abstract: false, final false
  inline ::System::Object* get_Value();

  /// @brief Method get_ValueType, addr 0x144fdb8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method remove_ValidationEventHandler, addr 0x144fc64, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_QuoteChar, addr 0x144fd90, size 0x4, virtual true, abstract: false, final false
  inline void set_QuoteChar(char16_t value);

  /// @brief Method set_Schema, addr 0x1451508, size 0x84, virtual false, abstract: false, final false
