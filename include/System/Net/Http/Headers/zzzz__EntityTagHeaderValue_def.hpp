...
public:
  ...
  /// @brief Method Equals, addr 0x16231a4, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1623258, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::EntityTagHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x162319c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x1623680, size 0x64, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x16235d0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x16232a8, size 0xf4, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Net::Http::Headers::EntityTagHeaderValue*> parsedValue);

  /// @brief Method TryParseElement, addr 0x162339c, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1623170, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Net::Http::Headers::EntityTagHeaderValue* getStaticF_any();

  /// @brief Method get_IsWeak, addr 0x1623178, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsWeak();

  /// @brief Method get_Tag, addr 0x162318c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsWeak, addr 0x1623180, size 0xc, virtual false, abstract: false, final false
  inline void set_IsWeak(bool value);

  /// @brief Method set_Tag, addr 0x1623194, size 0x8, virtual false, abstract: false, final false
