...
public:
  ...
  /// @brief Field DoNotIgnoreWhiteSpaces value: static_cast<int32_t>(0x1)
  static ::System::Security::Cryptography::FromBase64TransformMode const DoNotIgnoreWhiteSpaces;

  /// @brief Field IgnoreWhiteSpaces value: static_cast<int32_t>(0x0)
...
static_assert(::cordl_internals::size_check_v<::System::Security::Cryptography::FromBase64TransformMode, 0x4>, "Size mismatch!");
