...
template <typename T> inline ::cordl_internals::Ptr<T> UnityEngine::Rendering::ListBuffer_1<T>::get_BufferPtr() {
  ...
  return ::cordl_internals::RunMethodRethrow<::cordl_internals::Ptr<T>, false>(this, ___internal_method);
}
...
template <typename T> inline void UnityEngine::Rendering::ListBuffer_1<T>::_ctor(::cordl_internals::Ptr<T> bufferPtr, ::cordl_internals::Ptr<int32_t> countPtr, int32_t capacity) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ListBuffer_1<T>>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 3>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::cordl_internals::Ptr<T>>::get(),
...
template <typename T> inline void UnityEngine::Rendering::ListBuffer_1<T>::CopyTo(::cordl_internals::Ptr<T> dstBuffer, int32_t startDstIndex, int32_t copyCount) {
...
template <typename T> inline bool UnityEngine::Rendering::ListBuffer_1<T>::TryCopyFrom(::cordl_internals::Ptr<T> srcPtr, int32_t count) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ListBuffer_1<T>>::get(), "TryCopyFrom", std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::cordl_internals::Ptr<T>>::get(),
                                                                      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
  return ::cordl_internals::RunMethodRethrow<bool, false>(this, ___internal_method, srcPtr, count);
}
// Ctor Parameters [CppParam { name: "m_BufferPtr", ty: "::cordl_internals::Ptr<T>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Capacity", ty: "int32_t", modifiers: "",
// def_value: Some("{}") }, CppParam { name: "m_CountPtr", ty: "::cordl_internals::Ptr<int32_t>", modifiers: "", def_value: Some("nullptr") }]
template <typename T>
constexpr ::UnityEngine::Rendering::ListBuffer_1<T>::ListBuffer_1(::cordl_internals::Ptr<T> m_BufferPtr, int32_t m_Capacity, ::cordl_internals::Ptr<int32_t> m_CountPtr) noexcept {
