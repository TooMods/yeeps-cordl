...
public:
  ...
  /// @brief Method .ctor, addr 0x1628964, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_CharSet>b__6_0, addr 0x162896c, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x1628570, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1628638, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x16286b4, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Net::Http::Headers::MediaTypeHeaderValue* Parse(::StringW input);

  /// @brief Method System.ICloneable.Clone, addr 0x1628510, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x1628894, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x1628720, size 0x174, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Net::Http::Headers::MediaTypeHeaderValue*> parsedValue);

  /// @brief Method TryParseMediaType, addr 0x1628380, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1628370, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x161f0f4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW mediaType);

  /// @brief Method .ctor, addr 0x1628078, size 0x278, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::MediaTypeHeaderValue* source);

  /// @brief Method get_CharSet, addr 0x161dc7c, size 0x114, virtual false, abstract: false, final false
  inline ::StringW get_CharSet();

  /// @brief Method get_MediaType, addr 0x1628378, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MediaType();

  /// @brief Method get_Parameters, addr 0x16282f0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CharSet, addr 0x161f120, size 0xa0, virtual false, abstract: false, final false
  inline void set_CharSet(::StringW value);

  /// @brief Method set_MediaType, addr 0x1627f38, size 0x140, virtual false, abstract: false, final false
