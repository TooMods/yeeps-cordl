...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x27df268, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _GetValueFromBag_b__3_0(::StringW s, ::StringW t);

  /// @brief Method .ctor, addr 0x27df260, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetValueFromBag, addr 0x27df098, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27de2fc, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
