...
public:
  // Declarations
  /// @brief Method Set, addr 0x1251334, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNamespace, addr 0x12514a0, size 0x3a4, virtual true, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method GetEnumerator, addr 0x1251b0c, size 0x170, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetNamespacesInScope, addr 0x1251c7c, size 0x1b8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method LookupNamespace, addr 0x1251e34, size 0x4c, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupNamespaceDecl, addr 0x1251844, size 0x18c, virtual false, abstract: false, final false
  inline int32_t LookupNamespaceDecl(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x1251e80, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method PopScope, addr 0x12513c8, size 0xd8, virtual true, abstract: false, final false
  inline bool PopScope();

  /// @brief Method PushScope, addr 0x12513b8, size 0x10, virtual true, abstract: false, final false
  inline void PushScope();

  /// @brief Method RemoveNamespace, addr 0x12519d0, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1251170, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1251178, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nameTable);

  /// @brief Method get_DefaultNamespace, addr 0x1251348, size 0x70, virtual true, abstract: false, final false
  inline ::StringW get_DefaultNamespace();

  /// @brief Method get_NameTable, addr 0x1251340, size 0x8, virtual true, abstract: false, final false
