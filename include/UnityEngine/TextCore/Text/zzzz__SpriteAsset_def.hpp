...
public:
  ...
  /// @brief Method <SortCharacterTable>b__38_0, addr 0x23b4534, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortCharacterTable_b__38_0(::UnityEngine::TextCore::Text::SpriteCharacter* c);

  /// @brief Method <SortGlyphTable>b__37_0, addr 0x23b451c, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphTable_b__37_0(::UnityEngine::TextCore::Text::SpriteGlyph* item);

  /// @brief Method .ctor, addr 0x23b4514, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x23b3670, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetSpriteIndexFromHashcode, addr 0x23b3674, size 0x88, virtual false, abstract: false, final false
  inline int32_t GetSpriteIndexFromHashcode(int32_t hashCode);

  /// @brief Method GetSpriteIndexFromName, addr 0x23b3790, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetSpriteIndexFromName(::StringW name);

  /// @brief Method GetSpriteIndexFromUnicode, addr 0x23b36fc, size 0x94, virtual false, abstract: false, final false
  inline int32_t GetSpriteIndexFromUnicode(uint32_t unicode);

  static inline ::UnityEngine::TextCore::Text::SpriteAsset* New_ctor();

  /// @brief Method SearchForSpriteByHashCode, addr 0x23b3be4, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForSpriteByHashCodeInternal, addr 0x23b40b0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForSpriteByHashCodeInternal, addr 0x23b3f10, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForSpriteByUnicode, addr 0x23b37cc, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForSpriteByUnicodeInternal, addr 0x23b3b34, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForSpriteByUnicodeInternal, addr 0x23b3994, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset>
  ...
  /// @brief Method SortCharacterTable, addr 0x23b4298, size 0x13c, virtual false, abstract: false, final false
  inline void SortCharacterTable();

  /// @brief Method SortGlyphAndCharacterTables, addr 0x23b43d4, size 0x18, virtual false, abstract: false, final false
  inline void SortGlyphAndCharacterTables();

  /// @brief Method SortGlyphTable, addr 0x23b4160, size 0x138, virtual false, abstract: false, final false
  inline void SortGlyphTable();

  /// @brief Method UpdateLookupTables, addr 0x23b3150, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b43ec, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::HashSet_1<int32_t>* getStaticF_k_searchedSpriteAssets();

  /// @brief Method get_faceInfo, addr 0x23b30e8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::FaceInfo get_faceInfo();

  /// @brief Method get_spriteCharacterLookupTable, addr 0x23b3634, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_spriteCharacterTable, addr 0x23b312c, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>* get_spriteCharacterTable();

  /// @brief Method get_spriteGlyphTable, addr 0x23b3660, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>* get_spriteGlyphTable();

  /// @brief Method get_spriteSheet, addr 0x23b311c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_faceInfo, addr 0x23b3104, size 0x18, virtual false, abstract: false, final false
  inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo value);

  /// @brief Method set_spriteCharacterLookupTable, addr 0x23b3658, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_spriteCharacterTable, addr 0x23b362c, size 0x8, virtual false, abstract: false, final false
  inline void set_spriteCharacterTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>* value);

  /// @brief Method set_spriteGlyphTable, addr 0x23b3668, size 0x8, virtual false, abstract: false, final false
  inline void set_spriteGlyphTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>* value);

  /// @brief Method set_spriteSheet, addr 0x23b3124, size 0x8, virtual false, abstract: false, final false
