...
public:
  // Declarations
  /// @brief Method Invoke, addr 0xed1f88, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed1e5c, size 0x12c, virtual false, abstract: false, final false
