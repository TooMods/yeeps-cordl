...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4328, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x19b42ec, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b4294, size 0x58, virtual false, abstract: false, final false
