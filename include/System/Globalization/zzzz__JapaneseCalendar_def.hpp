...
public:
  ...
  /// @brief Method EnglishEraNames, addr 0x22740b0, size 0x114, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> EnglishEraNames();

  /// @brief Method EraNames, addr 0x2273f9c, size 0x114, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> EraNames();

  /// @brief Method GetDayOfMonth, addr 0x2273d4c, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetDayOfMonth(::System::DateTime time);

  /// @brief Method GetDayOfWeek, addr 0x2273d68, size 0x1c, virtual true, abstract: false, final false
  inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime time);

  /// @brief Method GetDaysInMonth, addr 0x2273d14, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method GetDaysInYear, addr 0x2273d30, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetDaysInYear(int32_t year, int32_t era);

  /// @brief Method GetDefaultInstance, addr 0x2273a7c, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Globalization::Calendar* GetDefaultInstance();

  /// @brief Method GetEra, addr 0x2273da0, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetEra(::System::DateTime time);

  /// @brief Method GetEraInfo, addr 0x227361c, size 0x458, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Globalization::EraInfo*, ::Array<::System::Globalization::EraInfo*>*> GetEraInfo();

  /// @brief Method GetErasFromRegistry, addr 0x2273a74, size 0x8, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Globalization::EraInfo*, ::Array<::System::Globalization::EraInfo*>*> GetErasFromRegistry();

  /// @brief Method GetMonth, addr 0x2273dbc, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetMonth(::System::DateTime time);

  /// @brief Method GetMonthsInYear, addr 0x2273d84, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetMonthsInYear(int32_t year, int32_t era);

  /// @brief Method GetYear, addr 0x2273dd8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetYear(::System::DateTime time);

  /// @brief Method IsLeapYear, addr 0x2273df4, size 0x1c, virtual true, abstract: false, final false
  inline bool IsLeapYear(int32_t year, int32_t era);

  /// @brief Method IsValidYear, addr 0x22741c4, size 0x1c, virtual true, abstract: false, final false
  inline bool IsValidYear(int32_t year, int32_t era);

  static inline ::System::Globalization::JapaneseCalendar* New_ctor();

  /// @brief Method ToDateTime, addr 0x2273e10, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method ToFourDigitYear, addr 0x2273e34, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2273b34, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Eras, addr 0x2273f80, size 0x1c, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_Eras();

  /// @brief Method get_ID, addr 0x2273d0c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ID();

  /// @brief Method get_MaxSupportedDateTime, addr 0x22735c4, size 0x58, virtual true, abstract: false, final false
  inline ::System::DateTime get_MaxSupportedDateTime();

  /// @brief Method get_MinSupportedDateTime, addr 0x227356c, size 0x58, virtual true, abstract: false, final false
  inline ::System::DateTime get_MinSupportedDateTime();

  /// @brief Method get_TwoDigitYearMax, addr 0x22741e0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_TwoDigitYearMax, addr 0x227421c, size 0x13c, virtual true, abstract: false, final false
