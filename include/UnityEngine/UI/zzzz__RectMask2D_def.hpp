...
public:
  ...
  /// @brief Method AddClippable, addr 0x2907ec8, size 0x114, virtual false, abstract: false, final false
  inline void AddClippable(::UnityEngine::UI::IClippable* clippable);

  /// @brief Method IsRaycastLocationValid, addr 0x29072b8, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCanvasHierarchyChanged, addr 0x29081a0, size 0x24, virtual true, abstract: false, final false
  inline void OnCanvasHierarchyChanged();

  /// @brief Method OnDestroy, addr 0x2907298, size 0x20, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x29071c8, size 0xd0, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2907194, size 0x34, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnTransformParentChanged, addr 0x290817c, size 0x24, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method PerformClipping, addr 0x29074b0, size 0x724, virtual true, abstract: false, final false
  inline void PerformClipping();

  /// @brief Method RemoveClippable, addr 0x2907fdc, size 0x1a0, virtual false, abstract: false, final false
  inline void RemoveClippable(::UnityEngine::UI::IClippable* clippable);

  /// @brief Method UpdateClipSoftness, addr 0x2907bd4, size 0x2f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x290703c, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Canvas, addr 0x2906e40, size 0x160, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_Canvas();

  /// @brief Method get_canvasRect, addr 0x2906fa0, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_canvasRect();

  /// @brief Method get_padding, addr 0x2906e00, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_padding();

  /// @brief Method get_rectTransform, addr 0x2906fe4, size 0x58, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_rootCanvasRect, addr 0x2907394, size 0x11c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rootCanvasRect();

  /// @brief Method get_softness, addr 0x2906e1c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_padding, addr 0x2906e0c, size 0x10, virtual false, abstract: false, final false
  inline void set_padding(::UnityEngine::Vector4 value);

  /// @brief Method set_softness, addr 0x2906e24, size 0x1c, virtual false, abstract: false, final false
