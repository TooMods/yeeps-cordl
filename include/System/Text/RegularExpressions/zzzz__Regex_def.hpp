...
public:
  ...
  /// @brief Method Equals, addr 0x171bca4, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x171bd34, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::System::Text::RegularExpressions::__Regex__CachedCodeEntryKey other);

  /// @brief Method GetHashCode, addr 0x171bd9c, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x171bad0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1719500, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1719c84, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Escape, addr 0x171bbe0, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW Escape(::StringW str);

  /// @brief Method FillCacheDictionary, addr 0x1719cfc, size 0x104, virtual false, abstract: false, final false
  inline void FillCacheDictionary();

  /// @brief Method GetCachedCode, addr 0x1719408, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCachedCodeEntryInternal, addr 0x1719530, size 0x4b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GroupNameFromNumber, addr 0x1716a38, size 0x148, virtual false, abstract: false, final false
  inline ::StringW GroupNameFromNumber(int32_t i);

  /// @brief Method GroupNumberFromName, addr 0x1716604, size 0x14c, virtual false, abstract: false, final false
  inline int32_t GroupNumberFromName(::StringW name);

  /// @brief Method InitDefaultMatchTimeout, addr 0x171b600, size 0x240, virtual false, abstract: false, final false
  static inline ::System::TimeSpan InitDefaultMatchTimeout();

  /// @brief Method InitializeReferences, addr 0x171badc, size 0x104, virtual false, abstract: false, final false
  inline void InitializeReferences();

  /// @brief Method IsMatch, addr 0x171a4e0, size 0x70, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW input);

  /// @brief Method IsMatch, addr 0x1719ff0, size 0x74, virtual false, abstract: false, final false
  static inline bool IsMatch(::StringW input, ::StringW pattern);

  /// @brief Method IsMatch, addr 0x171a0f0, size 0x78, virtual false, abstract: false, final false
  static inline bool IsMatch(::StringW input, ::StringW pattern, ::System::Text::RegularExpressions::RegexOptions options);

  /// @brief Method IsMatch, addr 0x171a064, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMatch, addr 0x171a55c, size 0x80, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW input, int32_t startat);

  /// @brief Method LookupCachedAndPromote, addr 0x17199e8, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method Match, addr 0x171a754, size 0x70, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* Match(::StringW input);

  /// @brief Method Match, addr 0x171a5dc, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::Match* Match(::StringW input, ::StringW pattern);

  /// @brief Method Match, addr 0x171a6dc, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::Match* Match(::StringW input, ::StringW pattern, ::System::Text::RegularExpressions::RegexOptions options);

  /// @brief Method Match, addr 0x171a650, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Match, addr 0x171a7c4, size 0x74, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* Match(::StringW input, int32_t startat);

  /// @brief Method Matches, addr 0x171a838, size 0x70, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::MatchCollection* Matches(::StringW input);

  /// @brief Method Matches, addr 0x171a8a8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x171a97c, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW Replace(::StringW input, ::StringW pattern, ::StringW replacement);

  /// @brief Method Replace, addr 0x171aa8c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x171a9f8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x171ab14, size 0x74, virtual false, abstract: false, final false
  inline ::StringW Replace(::StringW input, ::StringW replacement);

  /// @brief Method Replace, addr 0x171ab88, size 0xe0, virtual false, abstract: false, final false
  inline ::StringW Replace(::StringW input, ::StringW replacement, int32_t count, int32_t startat);

  /// @brief Method Run, addr 0x17178e4, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method Split, addr 0x171ad68, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> Split(::StringW input);

  /// @brief Method Split, addr 0x171addc, size 0xc4, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> Split(::StringW input, int32_t count, int32_t startat);

  /// @brief Method Split, addr 0x171ac68, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> Split(::StringW input, ::StringW pattern);

  /// @brief Method Split, addr 0x171acdc, size 0x8c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> Split(::StringW input, ::StringW pattern, ::System::Text::RegularExpressions::RegexOptions options, ::System::TimeSpan matchTimeout);

  /// @brief Method Split, addr 0x171aea0, size 0x61c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x171ba90, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x171bc90, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetCacheValue, addr 0x1719e00, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetCacheValueSmall, addr 0x1719f1c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method UseOptionInvariant, addr 0x171bc98, size 0xc, virtual false, abstract: false, final false
  inline bool UseOptionInvariant();

  /// @brief Method UseOptionR, addr 0x171a550, size 0xc, virtual false, abstract: false, final false
  inline bool UseOptionR();

  /// @brief Method ValidateMatchTimeout, addr 0x171b840, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x171b99c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW pattern);

  /// @brief Method .ctor, addr 0x171ba14, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW pattern, ::System::Text::RegularExpressions::RegexOptions options);

  /// @brief Method .ctor, addr 0x171a168, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Options, addr 0x171bc88, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexOptions get_Options();

  /// @brief Method get_RightToLeft, addr 0x171b4bc, size 0xc, virtual false, abstract: false, final false
