...
public:
  ...
  /// @brief Method Dispose, addr 0x2c9d14c, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c9cfac, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* innerStream, bool leaveInnerStreamOpen);

  /// @brief Method get_InnerStream, addr 0x2c9d144, size 0x8, virtual false, abstract: false, final false
