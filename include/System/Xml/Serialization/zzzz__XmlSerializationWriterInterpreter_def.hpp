...
public:
  ...
  /// @brief Method WriteEnum, addr 0x3042de8, size 0x50, virtual false, abstract: false, final false
  inline void WriteEnum(::System::Object* ob);

  /// @brief Method WriteObject, addr 0x3042d98, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x303c854, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumXmlValue, addr 0x3042950, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW GetEnumXmlValue(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method GetListCount, addr 0x3041a20, size 0x128, virtual false, abstract: false, final false
  inline int32_t GetListCount(::System::Xml::Serialization::TypeData* listType, ::System::Object* ob);

  /// @brief Method GetMemberValue, addr 0x303ee0c, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Object* GetMemberValue(::System::Xml::Serialization::XmlTypeMapMember* member, ::System::Object* ob, bool isValueList);

  /// @brief Method GetStringValue, addr 0x303f2e8, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplicitConvert, addr 0x303d2c0, size 0x2d8, virtual false, abstract: false, final false
  static inline ::System::Object* ImplicitConvert(::System::Object* obj, ::System::Type* type);

  /// @brief Method InitCallbacks, addr 0x303c418, size 0x43c, virtual true, abstract: false, final false
  inline void InitCallbacks();

  /// @brief Method MemberHasValue, addr 0x303ebe4, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAnyElementContent, addr 0x3040328, size 0x648, virtual false, abstract: false, final false
  inline void WriteAnyElementContent(::System::Xml::Serialization::XmlTypeMapMemberAnyElement* member, ::System::Object* memberValue);

  /// @brief Method WriteAttributeMembers, addr 0x303dc8c, size 0x760, virtual false, abstract: false, final false
  inline void WriteAttributeMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteElementMembers, addr 0x303e490, size 0x754, virtual false, abstract: false, final false
  inline void WriteElementMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteEnumElement, addr 0x3042920, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteListContent, addr 0x303fb1c, size 0x80c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteListElement, addr 0x3041834, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteMemberElement, addr 0x303f59c, size 0x580, virtual false, abstract: false, final false
  inline void WriteMemberElement(::System::Xml::Serialization::XmlTypeMapElementInfo* elem, ::System::Object* memberValue);

  /// @brief Method WriteMembers, addr 0x303d944, size 0x44, virtual false, abstract: false, final false
  inline void WriteMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteMessage, addr 0x303d75c, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObject, addr 0x303ca94, size 0x82c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObjectElement, addr 0x303d988, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObjectElementAttributes, addr 0x303dbe8, size 0xa4, virtual true, abstract: false, final false
  inline void WriteObjectElementAttributes(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method WriteObjectElementElements, addr 0x303e3ec, size 0xa4, virtual true, abstract: false, final false
  inline void WriteObjectElementElements(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method WritePrimitiveElement, addr 0x30428e4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method WritePrimitiveValueEncoded, addr 0x30415c0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePrimitiveValueLiteral, addr 0x30412a8, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteRoot, addr 0x303c880, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x303c3e0, size 0x38, virtual false, abstract: false, final false
