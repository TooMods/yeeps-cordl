...
public:
  ...
  /// @brief Method And, addr 0x1e95098, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlBoolean And(::System::Data::SqlTypes::SqlBoolean x, ::System::Data::SqlTypes::SqlBoolean y);

  /// @brief Method CompareTo, addr 0x1e9525c, size 0x7c, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlBoolean value);

  /// @brief Method CompareTo, addr 0x1e95170, size 0xec, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method Equals, addr 0x1e952d8, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x1e95394, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x1e955e0, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method Or, addr 0x1e95104, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlBoolean Or(::System::Data::SqlTypes::SqlBoolean x, ::System::Data::SqlTypes::SqlBoolean y);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x1e953cc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x1e953d4, size 0x124, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x1e954f8, size 0xe8, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToString, addr 0x1e94fa8, size 0x68, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1e94400, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(bool value);

  /// @brief Method .ctor, addr 0x1e94d60, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method .ctor, addr 0x1e94d74, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ByteValue, addr 0x1e94f50, size 0x58, virtual false, abstract: false, final false
  inline uint8_t get_ByteValue();

  /// @brief Method get_IsFalse, addr 0x1e94db0, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsFalse();

  /// @brief Method get_IsNull, addr 0x1e94d90, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_IsTrue, addr 0x1e94da0, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsTrue();

  /// @brief Method get_Value, addr 0x1e94880, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseAnd, addr 0x1e94dd0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseOr, addr 0x1e94e90, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1e95010, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e94dc0, size 0x10, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlBoolean op_Implicit___System__Data__SqlTypes__SqlBoolean(bool x);

  /// @brief Method op_True, addr 0x1e947b4, size 0x10, virtual false, abstract: false, final false
