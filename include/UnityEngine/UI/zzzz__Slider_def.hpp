...
public:
  ...
  /// @brief Method .ctor, addr 0x29103ec, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClampValue, addr 0x29106cc, size 0xb4, virtual false, abstract: false, final false
  inline float_t ClampValue(float_t input);

  /// @brief Method FindSelectableOnDown, addr 0x2910ffc, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown();

  /// @brief Method FindSelectableOnLeft, addr 0x2910f90, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft();

  /// @brief Method FindSelectableOnRight, addr 0x2910fb4, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight();

  /// @brief Method FindSelectableOnUp, addr 0x2910fd8, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnUp();

  /// @brief Method GraphicUpdateComplete, addr 0x291043c, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method LayoutComplete, addr 0x2910438, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  /// @brief Method MayDrag, addr 0x2910ad8, size 0x64, virtual false, abstract: false, final false
  inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  static inline ::UnityEngine::UI::Slider* New_ctor();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x29104dc, size 0x1f0, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x291047c, size 0x20, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrag, addr 0x2910cf4, size 0x50, virtual true, abstract: false, final false
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEnable, addr 0x2910440, size 0x3c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnInitializePotentialDrag, addr 0x2911020, size 0x18, virtual true, abstract: false, final false
  inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnMove, addr 0x2910d44, size 0x24c, virtual true, abstract: false, final false
  inline void OnMove(::UnityEngine::EventSystems::AxisEventData* eventData);

  /// @brief Method OnPointerDown, addr 0x2910b3c, size 0x1b8, virtual true, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnRectTransformDimensionsChange, addr 0x2910868, size 0x38, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method Rebuild, addr 0x2910434, size 0x4, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method Set, addr 0x29107a4, size 0xc4, virtual true, abstract: false, final false
  inline void Set(float_t input, bool sendCallback);

  /// @brief Method SetDirection, addr 0x2911038, size 0x178, virtual false, abstract: false, final false
  inline void SetDirection(::UnityEngine::UI::__Slider__Direction direction, bool includeRectLayouts);

  /// @brief Method SetValueWithoutNotify, addr 0x29101bc, size 0x14, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(float_t input);

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x29111b0, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform();

  /// @brief Method Update, addr 0x291049c, size 0x40, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCachedReferences, addr 0x290f8b4, size 0x2a4, virtual false, abstract: false, final false
  inline void UpdateCachedReferences();

  /// @brief Method UpdateDrag, addr 0x29108a0, size 0x238, virtual false, abstract: false, final false
  inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData* eventData, ::UnityEngine::Camera* cam);

  /// @brief Method UpdateVisuals, addr 0x290fb58, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2910328, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_axis, addr 0x2910794, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__Slider__Axis get_axis();

  /// @brief Method get_direction, addr 0x290fec4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__Slider__Direction get_direction();

  /// @brief Method get_fillRect, addr 0x290f830, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_fillRect();

  /// @brief Method get_handleRect, addr 0x290fe40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_handleRect();

  /// @brief Method get_maxValue, addr 0x290ffd8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxValue();

  /// @brief Method get_minValue, addr 0x290ff40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_minValue();

  /// @brief Method get_normalizedValue, addr 0x29101d0, size 0xe4, virtual false, abstract: false, final false
  inline float_t get_normalizedValue();

  /// @brief Method get_onValueChanged, addr 0x29102ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__Slider__SliderEvent* get_onValueChanged();

  /// @brief Method get_reverseValue, addr 0x2910780, size 0x14, virtual false, abstract: false, final false
  inline bool get_reverseValue();

  /// @brief Method get_stepSize, addr 0x29102fc, size 0x2c, virtual false, abstract: false, final false
  inline float_t get_stepSize();

  /// @brief Method get_value, addr 0x2910108, size 0xa0, virtual true, abstract: false, final false
  inline float_t get_value();

  /// @brief Method get_wholeNumbers, addr 0x2910070, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_direction, addr 0x290fecc, size 0x74, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UI::__Slider__Direction value);

  /// @brief Method set_fillRect, addr 0x290f838, size 0x7c, virtual false, abstract: false, final false
  inline void set_fillRect(::UnityEngine::RectTransform* value);

  /// @brief Method set_handleRect, addr 0x290fe48, size 0x7c, virtual false, abstract: false, final false
  inline void set_handleRect(::UnityEngine::RectTransform* value);

  /// @brief Method set_maxValue, addr 0x290ffe0, size 0x90, virtual false, abstract: false, final false
  inline void set_maxValue(float_t value);

  /// @brief Method set_minValue, addr 0x290ff48, size 0x90, virtual false, abstract: false, final false
  inline void set_minValue(float_t value);

  /// @brief Method set_normalizedValue, addr 0x29102b4, size 0x38, virtual false, abstract: false, final false
  inline void set_normalizedValue(float_t value);

  /// @brief Method set_onValueChanged, addr 0x29102f4, size 0x8, virtual false, abstract: false, final false
  inline void set_onValueChanged(::UnityEngine::UI::__Slider__SliderEvent* value);

  /// @brief Method set_value, addr 0x29101a8, size 0x14, virtual true, abstract: false, final false
  inline void set_value(float_t value);

  /// @brief Method set_wholeNumbers, addr 0x2910078, size 0x90, virtual false, abstract: false, final false
