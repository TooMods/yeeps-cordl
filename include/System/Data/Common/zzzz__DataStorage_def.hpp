...
public:
  ...
  /// @brief Method Aggregate, addr 0x2214838, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Aggregate(::ArrayW<int32_t, ::Array<int32_t>*> recordNos, ::System::Data::AggregateType kind);

  /// @brief Method AggregateCount, addr 0x22173dc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareBits, addr 0x22148c0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertObjectToXml, addr 0x221753c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertValue, addr 0x22174a8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertXmlToObject, addr 0x22174fc, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method CopyBits, addr 0x2214bf0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyValueInternal, addr 0x2219544, size 0x10, virtual false, abstract: false, final false
  inline void CopyValueInternal(int32_t record, ::System::Object* store, ::System::Collections::BitArray* nullbits, int32_t storeIndex);

  /// @brief Method CreateStorage, addr 0x2217578, size 0x7fc, virtual false, abstract: false, final false
  ...
  /// @brief Method DetermineIfValueType, addr 0x2217384, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBits, addr 0x2214ccc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEmptyStorageInternal, addr 0x2219534, size 0x10, virtual false, abstract: false, final false
  inline ::System::Object* GetEmptyStorageInternal(int32_t recordCount);

  /// @brief Method GetQualifiedName, addr 0x22197d0, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW GetQualifiedName(::System::Type* type);

  /// @brief Method GetStorageType, addr 0x2218cf4, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Data::Common::StorageType GetStorageType(::System::Type* dataType);

  /// @brief Method GetStringLength, addr 0x22174b0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetStringLength(int32_t record);

  /// @brief Method GetType, addr 0x221956c, size 0x138, virtual false, abstract: false, final false
  static inline ::System::Type* GetType(::StringW value);

  /// @brief Method GetTypeStorage, addr 0x2218e10, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Type* GetTypeStorage(::System::Data::Common::StorageType storageType);

  /// @brief Method HasValue, addr 0x22174b8, size 0x28, virtual false, abstract: false, final false
  inline bool HasValue(int32_t recordNo);

  /// @brief Method ImplementsINullableValue, addr 0x221930c, size 0xd4, virtual false, abstract: false, final false
  static inline bool ImplementsINullableValue(::System::Data::Common::StorageType typeCode, ::System::Type* dataType);

  /// @brief Method ImplementsInterfaces, addr 0x2219004, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method InspectTypeForInterfaces, addr 0x2219158, size 0x1b4, virtual false, abstract: false, final false
  static inline ::System::Tuple_4<bool, bool, bool, bool>* InspectTypeForInterfaces(::System::Type* dataType);

  /// @brief Method IsNull, addr 0x22174e0, size 0x1c, virtual true, abstract: false, final false
  inline bool IsNull(int32_t recordNo);

  /// @brief Method IsObjectNull, addr 0x22193e0, size 0xa0, virtual false, abstract: false, final false
  static inline bool IsObjectNull(::System::Object* value);

  /// @brief Method IsObjectSqlNull, addr 0x2219480, size 0xb4, virtual false, abstract: false, final false
  static inline bool IsObjectSqlNull(::System::Object* value);

  /// @brief Method IsSqlType, addr 0x2218f0c, size 0xf8, virtual false, abstract: false, final false
  static inline bool IsSqlType(::System::Type* dataType);

  /// @brief Method IsSqlType, addr 0x2218f00, size 0xc, virtual false, abstract: false, final false
  static inline bool IsSqlType(::System::Data::Common::StorageType storageType);

  /// @brief Method IsTypeCustomType, addr 0x2218e8c, size 0x74, virtual false, abstract: false, final false
  static inline bool IsTypeCustomType(::System::Type* type);

  /// @brief Method IsTypeCustomType, addr 0x2217364, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCapacity, addr 0x2214f6c, size 0x84, virtual true, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetNullBit, addr 0x2214e8c, size 0x20, virtual false, abstract: false, final false
  inline void SetNullBit(int32_t recordNo, bool flag);

  /// @brief Method SetNullStorage, addr 0x2219564, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetStorageInternal, addr 0x2219554, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2217240, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2217358, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2214410, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DateTimeMode, addr 0x22173c0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Data::DataSetDateTime get_DateTimeMode();

  /// @brief Method get_FormatProvider, addr 0x2214b80, size 0x1c, virtual false, abstract: false, final false
