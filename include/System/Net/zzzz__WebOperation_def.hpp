...
public:
  ...
  /// @brief Method MoveNext, addr 0x2de4b70, size 0x21c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2de4d8c, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2de4de4, size 0x588, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2de55a4, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Abort, addr 0x2de3dd0, size 0x40, virtual false, abstract: false, final false
  inline void Abort();

  /// @brief Method CheckDisposed, addr 0x2de4360, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckThrowDisposed, addr 0x2de43ac, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x2de3fcc, size 0xac, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method CompleteRequestWritten, addr 0x2de4acc, size 0x80, virtual false, abstract: false, final false
  inline void CompleteRequestWritten(::System::Net::WebRequestStream* stream, ::System::Exception* error);

  /// @brief Method Finish, addr 0x2de4078, size 0x244, virtual false, abstract: false, final false
  inline void Finish(bool ok, ::System::Exception* error);

  /// @brief Method GetRequestStream, addr 0x2de4888, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* GetRequestStream();

  /// @brief Method GetRequestStreamInternal, addr 0x2de4978, size 0x50, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::WebRequestStream*>* GetRequestStreamInternal();

  /// @brief Method GetResponseStream, addr 0x2de49e0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterRequest, addr 0x2de44a8, size 0x254, virtual false, abstract: false, final false
  inline void RegisterRequest(::System::Net::ServicePoint* servicePoint, ::System::Net::WebConnection* connection);

  /// @brief Method Run, addr 0x2de4a38, size 0x94, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method SetCanceled, addr 0x2de3f00, size 0xcc, virtual false, abstract: false, final false
  inline void SetCanceled();

  /// @brief Method SetDisposed, addr 0x2de3e10, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetError, addr 0x2de42bc, size 0xa4, virtual false, abstract: false, final false
  inline void SetError(::System::Exception* error);

  /// @brief Method SetPriorityRequest, addr 0x2de46fc, size 0x18c, virtual false, abstract: false, final false
  inline void SetPriorityRequest(::System::Net::WebOperation* operation);

  /// @brief Method ThrowIfClosedOrDisposed, addr 0x2de17f8, size 0x60, virtual false, abstract: false, final false
  inline void ThrowIfClosedOrDisposed();

  /// @brief Method ThrowIfClosedOrDisposed, addr 0x2de0fc8, size 0x4c, virtual false, abstract: false, final false
  inline void ThrowIfClosedOrDisposed(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ThrowIfDisposed, addr 0x2de4404, size 0x60, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method ThrowIfDisposed, addr 0x2de4464, size 0x44, virtual false, abstract: false, final false
  inline void ThrowIfDisposed(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method <RegisterRequest>b__48_0, addr 0x2de4b4c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2de3c10, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aborted, addr 0x2de1504, size 0x50, virtual false, abstract: false, final false
  inline bool get_Aborted();

  /// @brief Method get_Closed, addr 0x2de3da4, size 0x2c, virtual false, abstract: false, final false
  inline bool get_Closed();

  /// @brief Method get_Connection, addr 0x2de3be0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* get_Connection();

  /// @brief Method get_Finished, addr 0x2de4a30, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebCompletionSource_1<::System::ValueTuple_2<bool, ::System::Net::WebOperation*>>* get_Finished();

  /// @brief Method get_IsNtlmChallenge, addr 0x2de3c08, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNtlmChallenge();

  /// @brief Method get_Request, addr 0x2de3bd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Method get_ServicePoint, addr 0x2de3bf0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method get_WriteBuffer, addr 0x2de3c00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::BufferOffsetSize* get_WriteBuffer();

  /// @brief Method get_WriteStream, addr 0x2de49c8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Net::WebRequestStream* get_WriteStream();

  /// @brief Method set_Connection, addr 0x2de3be8, size 0x8, virtual false, abstract: false, final false
  inline void set_Connection(::System::Net::WebConnection* value);

  /// @brief Method set_ServicePoint, addr 0x2de3bf8, size 0x8, virtual false, abstract: false, final false
