...
public:
  ...
  /// @brief Method <MaskByGroups>b__45_0, addr 0x1ac8524, size 0x20, virtual false, abstract: false, final false
  inline bool _MaskByGroups_b__45_0(::StringW x);

  /// @brief Method .ctor, addr 0x1ac851c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x1ac7c34, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1ac7b68, size 0xcc, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::InputBinding other);

  /// @brief Method GenerateId, addr 0x1ac7934, size 0x34, virtual false, abstract: false, final false
  inline void GenerateId();

  /// @brief Method GetHashCode, addr 0x1ac7d10, size 0xfc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetNameOfComposite, addr 0x1ac78f0, size 0x44, virtual false, abstract: false, final false
  inline ::StringW GetNameOfComposite();

  /// @brief Method MaskByGroup, addr 0x1ac7974, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputBinding MaskByGroup(::StringW group);

  /// @brief Method MaskByGroups, addr 0x1ac798c, size 0x160, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputBinding MaskByGroups(::ArrayW<::StringW, ::Array<::StringW>*> groups);

  /// @brief Method Matches, addr 0x1ac83a8, size 0x8, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::InputSystem::InputBinding binding);

  /// @brief Method Matches, addr 0x1ac83b0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveOverrides, addr 0x1ac7968, size 0xc, virtual false, abstract: false, final false
  inline void RemoveOverrides();

  /// @brief Method ToDisplayString, addr 0x1ac7f3c, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDisplayString, addr 0x1ac7f10, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1ac7e0c, size 0x104, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TriggersAction, addr 0x1abf044, size 0x58, virtual false, abstract: false, final false
  inline bool TriggersAction(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor, addr 0x1ac78d0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::StringW action, ::StringW groups, ::StringW processors, ::StringW interactions, ::StringW name);

  /// @brief Method get_action, addr 0x1ac787c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_action();

  /// @brief Method get_effectiveInteractions, addr 0x1ac7aec, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_effectiveInteractions();

  /// @brief Method get_effectivePath, addr 0x1ac0a50, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_effectivePath();

  /// @brief Method get_effectiveProcessors, addr 0x1ac7b04, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_effectiveProcessors();

  /// @brief Method get_groups, addr 0x1ac786c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_groups();

  /// @brief Method get_hasOverrides, addr 0x1ac78a8, size 0x28, virtual false, abstract: false, final false
  inline bool get_hasOverrides();

  /// @brief Method get_id, addr 0x1ac7798, size 0x48, virtual false, abstract: false, final false
  inline ::System::Guid get_id();

  /// @brief Method get_interactions, addr 0x1ac782c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_interactions();

  /// @brief Method get_isComposite, addr 0x1abf09c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isComposite();

  /// @brief Method get_isEmpty, addr 0x1ac7b1c, size 0x4c, virtual false, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Method get_isPartOfComposite, addr 0x1abf0a8, size 0xc, virtual false, abstract: false, final false
  inline bool get_isPartOfComposite();

  /// @brief Method get_name, addr 0x1ac7788, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_overrideInteractions, addr 0x1ac783c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_overrideInteractions();

  /// @brief Method get_overridePath, addr 0x1ac781c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_overridePath();

  /// @brief Method get_overrideProcessors, addr 0x1ac785c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_overrideProcessors();

  /// @brief Method get_path, addr 0x1ac780c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_path();

  /// @brief Method get_processors, addr 0x1ac784c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1abfb80, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::InputSystem::InputBinding left, ::UnityEngine::InputSystem::InputBinding right);

  /// @brief Method op_Inequality, addr 0x1ac7cc4, size 0x4c, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::InputSystem::InputBinding left, ::UnityEngine::InputSystem::InputBinding right);

  /// @brief Method set_action, addr 0x1ac7884, size 0x8, virtual false, abstract: false, final false
  inline void set_action(::StringW value);

  /// @brief Method set_groups, addr 0x1ac7874, size 0x8, virtual false, abstract: false, final false
  inline void set_groups(::StringW value);

  /// @brief Method set_id, addr 0x1ac77e0, size 0x2c, virtual false, abstract: false, final false
  inline void set_id(::System::Guid value);

  /// @brief Method set_interactions, addr 0x1ac7834, size 0x8, virtual false, abstract: false, final false
  inline void set_interactions(::StringW value);

  /// @brief Method set_isComposite, addr 0x1ac788c, size 0x1c, virtual false, abstract: false, final false
  inline void set_isComposite(bool value);

  /// @brief Method set_isPartOfComposite, addr 0x1abf39c, size 0x1c, virtual false, abstract: false, final false
  inline void set_isPartOfComposite(bool value);

  /// @brief Method set_name, addr 0x1ac7790, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_overrideInteractions, addr 0x1ac7844, size 0x8, virtual false, abstract: false, final false
  inline void set_overrideInteractions(::StringW value);

  /// @brief Method set_overridePath, addr 0x1ac7824, size 0x8, virtual false, abstract: false, final false
  inline void set_overridePath(::StringW value);

  /// @brief Method set_overrideProcessors, addr 0x1ac7864, size 0x8, virtual false, abstract: false, final false
  inline void set_overrideProcessors(::StringW value);

  /// @brief Method set_path, addr 0x1ac7814, size 0x8, virtual false, abstract: false, final false
  inline void set_path(::StringW value);

  /// @brief Method set_processors, addr 0x1ac7854, size 0x8, virtual false, abstract: false, final false
