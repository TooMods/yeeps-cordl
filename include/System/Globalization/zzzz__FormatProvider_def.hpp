...
public:
  ...
  /// @brief Method get_digits, addr 0x285abe8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindSection, addr 0x2859f64, size 0x134, virtual false, abstract: false, final false
  static inline int32_t FindSection(::System::ReadOnlySpan_1<char16_t> format, int32_t section);

  /// @brief Method FormatCurrency, addr 0x285887c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatExponent, addr 0x2859c74, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatFixed, addr 0x2858adc, size 0x53c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatGeneral, addr 0x285949c, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatNumber, addr 0x2859018, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatPercent, addr 0x2859838, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatScientific, addr 0x2859260, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Int32ToDecChars, addr 0x285874c, size 0x5c, virtual false, abstract: false, final false
  static inline void Int32ToDecChars(::cordl_internals::Ptr<char16_t> buffer, ByRef<int32_t> index, uint32_t value, int32_t digits);

  /// @brief Method IsWhite, addr 0x2857e68, size 0x28, virtual false, abstract: false, final false
  static inline bool IsWhite(char16_t ch);

  /// @brief Method MatchChars, addr 0x2857e90, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchChars, addr 0x2857f54, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToString, addr 0x2856768, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToStringFormat, addr 0x2856cb0, size 0x1080, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseFormatSpecifier, addr 0x2856628, size 0x140, virtual false, abstract: false, final false
  static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t> format, ByRef<int32_t> digits);

  /// @brief Method ParseNumber, addr 0x2857fb0, size 0x720, virtual false, abstract: false, final false
  ...
  /// @brief Method RoundNumber, addr 0x28587a8, size 0xd4, virtual false, abstract: false, final false
  static inline void RoundNumber(ByRef<::GlobalNamespace::__FormatProvider__Number__NumberBuffer> number, int32_t pos);

  /// @brief Method TrailingZeros, addr 0x28586d0, size 0x7c, virtual false, abstract: false, final false
  static inline bool TrailingZeros(::System::ReadOnlySpan_1<char16_t> s, int32_t index);

  /// @brief Method TryStringToNumber, addr 0x2857d30, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method wcslen, addr 0x2859a98, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FormatBigInteger, addr 0x28564bc, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method TryStringToBigInteger, addr 0x2854848, size 0xf8, virtual false, abstract: false, final false
