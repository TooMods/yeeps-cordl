...
public:
  ...
  /// @brief Method <CreateWebRequest>b__96_0, addr 0x1617f58, size 0x4c, virtual false, abstract: false, final false
  inline bool _CreateWebRequest_b__96_0(::StringW l);

  /// @brief Method <GetConnectionKeepAlive>b__95_0, addr 0x1617f08, size 0x50, virtual false, abstract: false, final false
  inline bool _GetConnectionKeepAlive_b__95_0(::StringW l);

  /// @brief Method <SendAsync>b__99_0, addr 0x1617fa4, size 0xb0, virtual false, abstract: false, final false
  inline void _SendAsync_b__99_0(::System::Object* l);

  /// @brief Method .ctor, addr 0x1617f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1618054, size 0x1704, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1619b34, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  __declspec(property(get = get_UseProxy, put = set_UseProxy)) bool UseProxy;
  ...
  /// @brief Method CreateResponseMessage, addr 0x161769c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWebRequest, addr 0x16169f8, size 0x7bc, virtual true, abstract: false, final false
  inline ::System::Net::HttpWebRequest* CreateWebRequest(::System::Net::Http::HttpRequestMessage* request);

  /// @brief Method Dispose, addr 0x16167e8, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x16167fc, size 0x84, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureModifiability, addr 0x16165a0, size 0x60, virtual false, abstract: false, final false
  inline void EnsureModifiability();

  /// @brief Method GetConnectionKeepAlive, addr 0x1616880, size 0x110, virtual false, abstract: false, final false
  inline bool GetConnectionKeepAlive(::System::Net::Http::Headers::HttpRequestHeaders* headers);

  /// @brief Method MethodHasBody, addr 0x1617bcc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendAsync, addr 0x1617cd8, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Net.Http.IMonoHttpClientHandler.SetWebRequestTimeout, addr 0x1617e2c, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1615770, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int64_t getStaticF_groupCounter();

  /// @brief Method get_CookieContainer, addr 0x1616648, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Net::CookieContainer* get_CookieContainer();

  /// @brief Method get_MaxRequestContentBufferSize, addr 0x16166b4, size 0x8, virtual true, abstract: false, final true
  inline int64_t get_MaxRequestContentBufferSize();

  /// @brief Method get_Proxy, addr 0x16166bc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::IWebProxy* get_Proxy();

  /// @brief Method get_SslOptions, addr 0x1616758, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Net::Security::SslClientAuthenticationOptions* get_SslOptions();

  /// @brief Method get_UseProxy, addr 0x161672c, size 0x8, virtual true, abstract: false, final true
  inline bool get_UseProxy();
  ...
  /// @brief Method set_AllowAutoRedirect, addr 0x1616600, size 0x24, virtual true, abstract: false, final true
  inline void set_AllowAutoRedirect(bool value);

  /// @brief Method set_AutomaticDecompression, addr 0x1616624, size 0x24, virtual true, abstract: false, final true
  inline void set_AutomaticDecompression(::System::Net::DecompressionMethods value);

  /// @brief Method set_MaxConnectionsPerServer, addr 0x1617dec, size 0x40, virtual true, abstract: false, final true
  inline void set_MaxConnectionsPerServer(int32_t value);

  /// @brief Method set_Proxy, addr 0x16166c4, size 0x68, virtual true, abstract: false, final true
  inline void set_Proxy(::System::Net::IWebProxy* value);

  /// @brief Method set_SslOptions, addr 0x16167c4, size 0x24, virtual true, abstract: false, final true
  inline void set_SslOptions(::System::Net::Security::SslClientAuthenticationOptions* value);

  /// @brief Method set_UseProxy, addr 0x1616734, size 0x24, virtual true, abstract: false, final true
