...
public:
  ...
  /// @brief Method Activate, addr 0x185a1b4, size 0x4dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1859c0c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW activationUrl, ::System::Runtime::Remoting::Activation::IActivator* next);

  /// @brief Method get_NextActivator, addr 0x185a1ac, size 0x8, virtual true, abstract: false, final true
