...
public:
  ...
  /// @brief Method GetEnumerator, addr 0xff2340, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method Item, addr 0xff2298, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff2270, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count, addr 0xff22f4, size 0x4c, virtual true, abstract: false, final false
