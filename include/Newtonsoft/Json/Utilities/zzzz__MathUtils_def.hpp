...
public:
  // Declarations
  /// @brief Method ApproxEquals, addr 0x15388ec, size 0xa8, virtual false, abstract: false, final false
  static inline bool ApproxEquals(double_t d1, double_t d2);

  /// @brief Method IntLength, addr 0x1538454, size 0x1c4, virtual false, abstract: false, final false
  static inline int32_t IntLength(uint64_t i);

  /// @brief Method IntToHex, addr 0x1538618, size 0x18, virtual false, abstract: false, final false
  static inline char16_t IntToHex(int32_t n);

  /// @brief Method Max, addr 0x15387f0, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::Nullable_1<double_t> Max(::System::Nullable_1<double_t> val1, ::System::Nullable_1<double_t> val2);

  /// @brief Method Max, addr 0x1538710, size 0xe0, virtual false, abstract: false, final false
  static inline ::System::Nullable_1<int32_t> Max(::System::Nullable_1<int32_t> val1, ::System::Nullable_1<int32_t> val2);

  /// @brief Method Min, addr 0x1538630, size 0xe0, virtual false, abstract: false, final false
