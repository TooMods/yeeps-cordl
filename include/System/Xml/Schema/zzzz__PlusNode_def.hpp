...
public:
  ...
  /// @brief Method ConstructPos, addr 0x30522dc, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3052398, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x3052378, size 0x20, virtual true, abstract: false, final false
