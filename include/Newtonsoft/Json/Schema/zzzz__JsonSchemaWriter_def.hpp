...
public:
  ...
  /// @brief Method <WriteType>b__7_0, addr 0x10a0154, size 0xc, virtual false, abstract: false, final false
  inline bool _WriteType_b__7_0(::Newtonsoft::Json::Schema::JsonSchemaType v);

  /// @brief Method .ctor, addr 0x10a014c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ReferenceOrWriteSchema, addr 0x109f220, size 0xe4, virtual false, abstract: false, final false
  inline void ReferenceOrWriteSchema(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method WriteItems, addr 0x109fc34, size 0x4b4, virtual false, abstract: false, final false
  inline void WriteItems(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method WritePropertyIfNotNull, addr 0x109f304, size 0x64, virtual false, abstract: false, final false
  inline void WritePropertyIfNotNull(::Newtonsoft::Json::JsonWriter* writer, ::StringW propertyName, ::System::Object* value);

  /// @brief Method WriteSchema, addr 0x1095978, size 0x101c, virtual false, abstract: false, final false
  inline void WriteSchema(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method WriteSchemaDictionaryIfNotNull, addr 0x109f8a8, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteType, addr 0x109f368, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1095908, size 0x70, virtual false, abstract: false, final false
