...
public:
  // Declarations
  /// @brief Method Encode, addr 0x282af44, size 0x14c, virtual false, abstract: false, final false
  static inline ::StringW Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> inArray, int32_t offsetIn, int32_t count);

  /// @brief Method Encode, addr 0x282ae20, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x282ac78, size 0x1a8, virtual false, abstract: false, final false
