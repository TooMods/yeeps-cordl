...
public:
  // Declarations
  /// @brief Method ComputeHash128, addr 0x2a813d8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeHash128, addr 0x2a81420, size 0x80, virtual false, abstract: false, final false
