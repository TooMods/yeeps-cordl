...
public:
  ...
  /// @brief Method Dispose, addr 0x12cb5c4, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x12cc220, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x12cc224, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method ThrowIfContextInvalid, addr 0x12cc1e0, size 0x40, virtual false, abstract: false, final false
  inline void ThrowIfContextInvalid();

  /// @brief Method .ctor, addr 0x12cc2c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
