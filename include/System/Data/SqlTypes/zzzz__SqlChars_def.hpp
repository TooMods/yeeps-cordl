...
public:
  ...
  /// @brief Method CopyStreamToBuffer, addr 0x1e2ef70, size 0x140, virtual false, abstract: false, final false
  inline void CopyStreamToBuffer();

  /// @brief Method FStream, addr 0x1e2ef60, size 0x10, virtual false, abstract: false, final false
  inline bool FStream();

  /// @brief Method GetXsdType, addr 0x1e2f548, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBuffer, addr 0x1e2f2fc, size 0x28, virtual false, abstract: false, final false
  inline void SetBuffer(::ArrayW<char16_t, ::Array<char16_t>*> buffer);

  /// @brief Method SetNull, addr 0x1e2ee28, size 0x10, virtual false, abstract: false, final false
  inline void SetNull();

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x1e2f5d4, size 0x40, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x1e2f324, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x1e2f32c, size 0x11c, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* r);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x1e2f448, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1e2ee04, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e2ee38, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t, ::Array<char16_t>*> buffer);

  /// @brief Method .ctor, addr 0x1e2ee88, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::SqlTypes::SqlString value);

  /// @brief Method get_Buffer, addr 0x1e2ef38, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> get_Buffer();

  /// @brief Method get_IsNull, addr 0x1e2ef28, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Length, addr 0x1e2f0b0, size 0x74, virtual false, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Null, addr 0x1e2f614, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlChars* get_Null();

  /// @brief Method get_Value, addr 0x1e2f124, size 0x1d8, virtual false, abstract: false, final false
