...
public:
  // Declarations
  /// @brief Method Pause, addr 0x1b69324, size 0x4, virtual false, abstract: false, final false
  static inline void Pause();

  /// @brief Method umul128, addr 0x1b69328, size 0x3c, virtual false, abstract: false, final false
