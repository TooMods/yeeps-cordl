...
public:
  ...
  /// @brief Method GetFalse, addr 0x182e54c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182e390, size 0x24, virtual false, abstract: false, final false
