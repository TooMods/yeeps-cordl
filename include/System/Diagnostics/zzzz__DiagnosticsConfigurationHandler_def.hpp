...
public:
  ...
  /// @brief Method Create, addr 0x18d05ac, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18d0574, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
