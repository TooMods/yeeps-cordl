...
public:
  ...
  /// @brief Method AddDateWordOrPostfix, addr 0x203cac0, size 0x2b0, virtual false, abstract: false, final false
  inline void AddDateWordOrPostfix(::StringW formatPostfix, ::StringW str);

  /// @brief Method AddDateWords, addr 0x203cebc, size 0x1d8, virtual false, abstract: false, final false
  inline int32_t AddDateWords(::StringW pattern, int32_t index, ::StringW formatPostfix);

  /// @brief Method AddIgnorableSymbols, addr 0x203cd70, size 0x14c, virtual false, abstract: false, final false
  inline void AddIgnorableSymbols(::StringW text);

  /// @brief Method ArrayElementsBeginWithDigit, addr 0x203d3fc, size 0x25c, virtual false, abstract: false, final false
  static inline bool ArrayElementsBeginWithDigit(::ArrayW<::StringW, ::Array<::StringW>*> array);

  /// @brief Method ArrayElementsHaveSpace, addr 0x203d658, size 0xf4, virtual false, abstract: false, final false
  static inline bool ArrayElementsHaveSpace(::ArrayW<::StringW, ::Array<::StringW>*> array);

  /// @brief Method EqualStringArrays, addr 0x203d354, size 0xa8, virtual false, abstract: false, final false
  static inline bool EqualStringArrays(::ArrayW<::StringW, ::Array<::StringW>*> array1, ::ArrayW<::StringW, ::Array<::StringW>*> array2);

  /// @brief Method GetDateWordsOfDTFI, addr 0x203b3bc, size 0x2c0, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetDateWordsOfDTFI(::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method GetFormatFlagGenitiveMonth, addr 0x20397f0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFormatFlagUseHebrewCalendar, addr 0x2039904, size 0x10, virtual false, abstract: false, final false
  static inline ::System::Globalization::FORMATFLAGS GetFormatFlagUseHebrewCalendar(int32_t calID);

  /// @brief Method GetFormatFlagUseSpaceInDayNames, addr 0x20398d4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFormatFlagUseSpaceInMonthNames, addr 0x2039830, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ScanDateWord, addr 0x203d118, size 0x23c, virtual false, abstract: false, final false
  inline void ScanDateWord(::StringW pattern);

  /// @brief Method ScanRepeatChar, addr 0x203d094, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ScanRepeatChar(::StringW pattern, char16_t ch, int32_t index, ByRef<int32_t> count);

  /// @brief Method SkipWhiteSpacesAndNonLetter, addr 0x203c9c4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x203b340, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* getStaticF_s_knownWords();

  /// @brief Method get_KnownWords, addr 0x203c5c4, size 0x400, virtual false, abstract: false, final false
