...
public:
  ...
  /// @brief Method AllocateDeviceId, addr 0x1e5e7f0, size 0x28, virtual false, abstract: false, final false
  static inline int32_t AllocateDeviceId();

  /// @brief Method IOCTL, addr 0x1e5e854, size 0x5c, virtual false, abstract: false, final false
  static inline int64_t IOCTL(int32_t deviceId, int32_t code, void* data, int32_t sizeInBytes);

  /// @brief Method NotifyBeforeUpdate, addr 0x1e5e568, size 0x7c, virtual false, abstract: false, final false
  static inline void NotifyBeforeUpdate(::UnityEngineInternal::Input::NativeInputUpdateType updateType);

  /// @brief Method NotifyDeviceDiscovered, addr 0x1e5e680, size 0x90, virtual false, abstract: false, final false
  static inline void NotifyDeviceDiscovered(int32_t deviceId, ::StringW deviceDescriptor);

  /// @brief Method NotifyUpdate, addr 0x1e5e5e4, size 0x9c, virtual false, abstract: false, final false
  static inline void NotifyUpdate(::UnityEngineInternal::Input::NativeInputUpdateType updateType, void* eventBuffer);

  /// @brief Method QueueInputEvent, addr 0x1e5e818, size 0x3c, virtual false, abstract: false, final false
  static inline void QueueInputEvent(void* inputEvent);

  /// @brief Method SetPollingFrequency, addr 0x1e5e8b0, size 0x38, virtual false, abstract: false, final false
  static inline void SetPollingFrequency(float_t hertz);

  /// @brief Method ShouldRunUpdate, addr 0x1e5e710, size 0x90, virtual false, abstract: false, final false
  static inline void ShouldRunUpdate(::UnityEngineInternal::Input::NativeInputUpdateType updateType, ByRef<bool> retval);

  /// @brief Method Update, addr 0x1e5e8e8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentTime, addr 0x1e5e7a0, size 0x28, virtual false, abstract: false, final false
  static inline double_t get_currentTime();

  /// @brief Method get_currentTimeOffsetToRealtimeSinceStartup, addr 0x1e5e7c8, size 0x28, virtual false, abstract: false, final false
  static inline double_t get_currentTimeOffsetToRealtimeSinceStartup();

  /// @brief Method get_onDeviceDiscovered, addr 0x1e5e420, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_hasDeviceDiscoveredCallback, addr 0x1e5e4fc, size 0x3c, virtual false, abstract: false, final false
  static inline void set_hasDeviceDiscoveredCallback(bool value);

  /// @brief Method set_onDeviceDiscovered, addr 0x1e5e478, size 0x84, virtual false, abstract: false, final false
