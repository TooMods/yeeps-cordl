...
public:
  ...
  /// @brief Method .ctor, addr 0x28a7ad4, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(bool ownsHandle);

  /// @brief Method get_IsInvalid, addr 0x28a7b18, size 0x40, virtual true, abstract: false, final false
