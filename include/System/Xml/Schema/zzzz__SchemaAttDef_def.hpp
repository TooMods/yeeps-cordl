...
public:
  ...
  /// @brief Method CheckXmlSpace, addr 0x1e44844, size 0x26c, virtual false, abstract: false, final false
  inline void CheckXmlSpace(::System::Xml::IValidationEventHandling* validationEventHandling);

  /// @brief Method Clone, addr 0x1e44ab0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IDtdAttributeInfo.get_IsDeclaredInExternal, addr 0x1e446dc, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdAttributeInfo_get_IsDeclaredInExternal();

  /// @brief Method System.Xml.IDtdAttributeInfo.get_IsNonCDataType, addr 0x1e44690, size 0x2c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdAttributeInfo_get_IsNonCDataType();

  /// @brief Method System.Xml.IDtdAttributeInfo.get_IsXmlAttribute, addr 0x1e446e4, size 0x10, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdAttributeInfo_get_IsXmlAttribute();

  /// @brief Method System.Xml.IDtdAttributeInfo.get_LineNumber, addr 0x1e44680, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdAttributeInfo_get_LineNumber();

  /// @brief Method System.Xml.IDtdAttributeInfo.get_LinePosition, addr 0x1e44688, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdAttributeInfo_get_LinePosition();

  /// @brief Method System.Xml.IDtdAttributeInfo.get_LocalName, addr 0x1e44664, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdAttributeInfo_get_LocalName();

  /// @brief Method System.Xml.IDtdAttributeInfo.get_Prefix, addr 0x1e4465c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdAttributeInfo_get_Prefix();

  /// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_DefaultValueExpanded, addr 0x1e446f4, size 0x54, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdDefaultAttributeInfo_get_DefaultValueExpanded();

  /// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_DefaultValueTyped, addr 0x1e4479c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Xml_IDtdDefaultAttributeInfo_get_DefaultValueTyped();

  /// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_ValueLineNumber, addr 0x1e447a4, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdDefaultAttributeInfo_get_ValueLineNumber();

  /// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_ValueLinePosition, addr 0x1e447ac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1e44654, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e44648, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* name);

  /// @brief Method .ctor, addr 0x1e44640, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DefaultValueChecked, addr 0x1e4482c, size 0x8, virtual false, abstract: false, final false
  inline bool get_DefaultValueChecked();

  /// @brief Method get_DefaultValueExpanded, addr 0x1e44748, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DefaultValueExpanded();

  /// @brief Method get_LineNumber, addr 0x1e447c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x1e447b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Reserved, addr 0x1e4481c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::__SchemaAttDef__Reserve get_Reserved();

  /// @brief Method get_SchemaAttribute, addr 0x1e44834, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute();

  /// @brief Method get_TokenizedType, addr 0x1e446bc, size 0x20, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  /// @brief Method get_ValueLineNumber, addr 0x1e447e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ValueLineNumber();

  /// @brief Method get_ValueLinePosition, addr 0x1e447d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DefaultValueExpanded, addr 0x1e447f4, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValueExpanded(::StringW value);

  /// @brief Method set_LineNumber, addr 0x1e447cc, size 0x8, virtual false, abstract: false, final false
  inline void set_LineNumber(int32_t value);

  /// @brief Method set_LinePosition, addr 0x1e447bc, size 0x8, virtual false, abstract: false, final false
  inline void set_LinePosition(int32_t value);

  /// @brief Method set_Reserved, addr 0x1e44824, size 0x8, virtual false, abstract: false, final false
  inline void set_Reserved(::System::Xml::Schema::__SchemaAttDef__Reserve value);

  /// @brief Method set_SchemaAttribute, addr 0x1e4483c, size 0x8, virtual false, abstract: false, final false
  inline void set_SchemaAttribute(::System::Xml::Schema::XmlSchemaAttribute* value);

  /// @brief Method set_TokenizedType, addr 0x1e447fc, size 0x20, virtual false, abstract: false, final false
  inline void set_TokenizedType(::System::Xml::XmlTokenizedType value);

  /// @brief Method set_ValueLineNumber, addr 0x1e447ec, size 0x8, virtual false, abstract: false, final false
  inline void set_ValueLineNumber(int32_t value);

  /// @brief Method set_ValueLinePosition, addr 0x1e447dc, size 0x8, virtual false, abstract: false, final false
