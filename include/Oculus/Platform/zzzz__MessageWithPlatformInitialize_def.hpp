...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b60e0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PlatformInitialize* GetDataFromMessage(void* c_message);

  /// @brief Method GetPlatformInitialize, addr 0x19b60a4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b185c, size 0x58, virtual false, abstract: false, final false
