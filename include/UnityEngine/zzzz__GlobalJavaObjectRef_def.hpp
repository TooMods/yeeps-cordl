...
public:
  ...
  /// @brief Method Dispose, addr 0x2f49ed8, size 0x7c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x2f49e44, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f49d54, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(void* jobject);

  /// @brief Method op_Implicit, addr 0x2f49f54, size 0x18, virtual false, abstract: false, final false
