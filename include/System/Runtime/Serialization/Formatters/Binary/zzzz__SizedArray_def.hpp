...
public:
  ...
  /// @brief Method Clone, addr 0x1b3e350, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method IncreaseCapacity, addr 0x1b3e3b0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b3a234, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1b3a30c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(int32_t length);

  /// @brief Method .ctor, addr 0x1b3e29c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::Formatters::Binary::SizedArray* sizedArray);

  /// @brief Method get_Item, addr 0x1b3d044, size 0x74, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Item, addr 0x1b3cf44, size 0x100, virtual false, abstract: false, final false
