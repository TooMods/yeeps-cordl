...
public:
  ...
  /// @brief Method Acquire, addr 0x1e17720, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Text::StringBuilder* Acquire(int32_t capacity);

  /// @brief Method GetStringAndRelease, addr 0x1e17870, size 0x3c, virtual false, abstract: false, final false
  static inline ::StringW GetStringAndRelease(::System::Text::StringBuilder* sb);

  /// @brief Method Release, addr 0x1e177f0, size 0x80, virtual false, abstract: false, final false
