...
public:
  ...
  /// @brief Method .ctor, addr 0x25c400c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool parameterValue);

  /// @brief Method get_ParameterValue, addr 0x25c4034, size 0x8, virtual false, abstract: false, final false
