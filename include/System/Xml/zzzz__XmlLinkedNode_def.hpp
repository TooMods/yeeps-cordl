...
public:
  ...
  /// @brief Method .ctor, addr 0xff1f80, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDocument* doc);

  /// @brief Method get_NextSibling, addr 0xffa344, size 0x50, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* get_NextSibling();

  /// @brief Method get_PreviousSibling, addr 0xffa2dc, size 0x68, virtual true, abstract: false, final false
