...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4810, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionList* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncSessionList, addr 0x19b47d4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b477c, size 0x58, virtual false, abstract: false, final false
