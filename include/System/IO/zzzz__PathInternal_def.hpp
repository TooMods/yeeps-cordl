...
public:
  ...
  /// @brief Method EndsInDirectorySeparator, addr 0x2577ce8, size 0x88, virtual false, abstract: false, final false
  static inline bool EndsInDirectorySeparator(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method GetIsCaseSensitive, addr 0x25780e0, size 0x304, virtual false, abstract: false, final false
  static inline bool GetIsCaseSensitive();

  /// @brief Method GetRootLength, addr 0x2577c5c, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t GetRootLength(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method IsDirectorySeparator, addr 0x2577cd8, size 0x10, virtual false, abstract: false, final false
  static inline bool IsDirectorySeparator(char16_t c);

  /// @brief Method IsPartiallyQualified, addr 0x25785a0, size 0x8, virtual false, abstract: false, final false
  static inline bool IsPartiallyQualified(::StringW path);

  /// @brief Method IsRoot, addr 0x2577f2c, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsRoot(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method StartsWithDirectorySeparator, addr 0x2577d70, size 0x7c, virtual false, abstract: false, final false
  static inline bool StartsWithDirectorySeparator(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method TrimEndingDirectorySeparator, addr 0x2577dec, size 0x140, virtual false, abstract: false, final false
  static inline ::StringW TrimEndingDirectorySeparator(::StringW path);

  /// @brief Method TrimEndingDirectorySeparator, addr 0x2577fa8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCaseSensitive, addr 0x2578088, size 0x58, virtual false, abstract: false, final false
