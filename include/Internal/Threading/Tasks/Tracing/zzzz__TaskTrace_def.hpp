...
public:
  ...
  /// @brief Method TaskScheduled, addr 0x28a7d44, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method TaskWaitBegin_Asynchronous, addr 0x28a7bb8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method TaskWaitBegin_Synchronous, addr 0x28a7c3c, size 0x84, virtual false, abstract: false, final false
  static inline void TaskWaitBegin_Synchronous(int32_t OriginatingTaskSchedulerID, int32_t OriginatingTaskID, int32_t TaskID);

  /// @brief Method TaskWaitEnd, addr 0x28a7cc0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Enabled, addr 0x28a7b58, size 0x60, virtual false, abstract: false, final false
