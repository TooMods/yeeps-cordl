...
public:
  ...
  /// @brief Method DetachElement, addr 0x12907a4, size 0x8c, virtual true, abstract: false, final false
  inline void DetachElement();

  /// @brief Method Init, addr 0x128e768, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method PreAttachElement, addr 0x129065c, size 0x8c, virtual true, abstract: false, final false
  inline void PreAttachElement();

  /// @brief Method UpdateDragHandle, addr 0x128e864, size 0x13c, virtual false, abstract: false, final false
  inline void UpdateDragHandle(bool needsDragHandle);

  /// @brief Method UpdateHierarchy, addr 0x12903e8, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1290928, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rootElement, addr 0x12903c8, size 0x18, virtual true, abstract: false, final false
