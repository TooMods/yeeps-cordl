...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x12a61c8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a610c, size 0xbc, virtual false, abstract: false, final false
