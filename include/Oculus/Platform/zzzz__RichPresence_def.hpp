...
public:
  // Declarations
  /// @brief Method Clear, addr 0x19c0d28, size 0x144, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Clear();

  /// @brief Method GetDestinations, addr 0x198e1b8, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::DestinationList*>* GetDestinations();

  /// @brief Method GetNextDestinationListPage, addr 0x19c1050, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x19c0e6c, size 0x18c, virtual false, abstract: false, final false
