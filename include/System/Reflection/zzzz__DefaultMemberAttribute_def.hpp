...
public:
  ...
  /// @brief Method .ctor, addr 0x260f0c4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW memberName);

  /// @brief Method get_MemberName, addr 0x260f0ec, size 0x8, virtual false, abstract: false, final false
