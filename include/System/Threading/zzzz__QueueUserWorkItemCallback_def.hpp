...
public:
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0xece014, size 0xd8, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0xece0ec, size 0x4, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_MarkAborted(::System::Threading::ThreadAbortException* tae);

  /// @brief Method WaitCallback_Context, addr 0xece0f0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecdf5c, size 0xb8, virtual false, abstract: false, final false
