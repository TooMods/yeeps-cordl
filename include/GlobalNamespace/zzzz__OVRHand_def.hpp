...
public:
  ...
  /// @brief Method Awake, addr 0x16efa10, size 0xcc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x16efd44, size 0x74, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetFingerConfidence, addr 0x16efe20, size 0x44, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRHand__TrackingConfidence GetFingerConfidence(::GlobalNamespace::__OVRHand__HandFinger finger);

  /// @brief Method GetFingerIsPinching, addr 0x16efdb8, size 0x28, virtual false, abstract: false, final false
  inline bool GetFingerIsPinching(::GlobalNamespace::__OVRHand__HandFinger finger);

  /// @brief Method GetFingerPinchStrength, addr 0x16efde0, size 0x40, virtual false, abstract: false, final false
  inline float_t GetFingerPinchStrength(::GlobalNamespace::__OVRHand__HandFinger finger);

  /// @brief Method GetHandState, addr 0x16efadc, size 0x260, virtual false, abstract: false, final false
  inline void GetHandState(::GlobalNamespace::__OVRPlugin__Step step);

  static inline ::GlobalNamespace::OVRHand* New_ctor();

  /// @brief Method OVRMeshRenderer.IOVRMeshRendererDataProvider.GetMeshRendererData, addr 0x16eff4c, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMesh.IOVRMeshDataProvider.GetMeshType, addr 0x16eff34, size 0x18, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRMesh__MeshType OVRMesh_IOVRMeshDataProvider_GetMeshType();

  /// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x16efee8, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x16efe7c, size 0x6c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRSkeleton__SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData();

  /// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x16efe64, size 0x18, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRSkeleton__SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType();

  /// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x16effb4, size 0x8, virtual true, abstract: false, final true
  inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled();

  /// @brief Method SetHandType, addr 0x16ef960, size 0x8, virtual false, abstract: false, final false
  inline void SetHandType(::GlobalNamespace::__OVRHand__Hand type);

  /// @brief Method Update, addr 0x16efd3c, size 0x8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16eff9c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HandConfidence, addr 0x16ef9ec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRHand__TrackingConfidence get_HandConfidence();

  /// @brief Method get_HandScale, addr 0x16ef9dc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_HandScale();

  /// @brief Method get_IsDataHighConfidence, addr 0x16ef97c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x16ef968, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_IsDominantHand, addr 0x16ef9fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDominantHand();

  /// @brief Method get_IsPointerPoseValid, addr 0x16ef9b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsPointerPoseValid();

  /// @brief Method get_IsSystemGestureInProgress, addr 0x16ef9a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsSystemGestureInProgress();

  /// @brief Method get_IsTracked, addr 0x16ef990, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsTracked();

  /// @brief Method get_PointerPose, addr 0x16ef9cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_HandConfidence, addr 0x16ef9f4, size 0x8, virtual false, abstract: false, final false
  inline void set_HandConfidence(::GlobalNamespace::__OVRHand__TrackingConfidence value);

  /// @brief Method set_HandScale, addr 0x16ef9e4, size 0x8, virtual false, abstract: false, final false
  inline void set_HandScale(float_t value);

  /// @brief Method set_IsDataHighConfidence, addr 0x16ef984, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x16ef970, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_IsDominantHand, addr 0x16efa04, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDominantHand(bool value);

  /// @brief Method set_IsPointerPoseValid, addr 0x16ef9c0, size 0xc, virtual false, abstract: false, final false
  inline void set_IsPointerPoseValid(bool value);

  /// @brief Method set_IsSystemGestureInProgress, addr 0x16ef9ac, size 0xc, virtual false, abstract: false, final false
  inline void set_IsSystemGestureInProgress(bool value);

  /// @brief Method set_IsTracked, addr 0x16ef998, size 0xc, virtual false, abstract: false, final false
  inline void set_IsTracked(bool value);

  /// @brief Method set_PointerPose, addr 0x16ef9d4, size 0x8, virtual false, abstract: false, final false
