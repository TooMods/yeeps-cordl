...
public:
  ...
  /// @brief Method .ctor, addr 0x1ea51d4, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW value);

  /// @brief Method get_Name, addr 0x1ea630c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x1ea6314, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x1ea2cbc, size 0x1ac, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW name, ::StringW value);

  /// @brief Method AddChild, addr 0x1ea2e68, size 0xd0, virtual false, abstract: false, final false
  inline void AddChild(::System::Security::SecurityElement* child);

  /// @brief Method Escape, addr 0x1ea5338, size 0x1ec, virtual false, abstract: false, final false
  static inline ::StringW Escape(::StringW str);

  /// @brief Method GetAttribute, addr 0x1ea4ec4, size 0x310, virtual false, abstract: false, final false
  inline ::System::Security::__SecurityElement__SecurityAttribute* GetAttribute(::StringW name);

  /// @brief Method IsValidAttributeName, addr 0x1ea5524, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValidAttributeName(::StringW name);

  /// @brief Method IsValidAttributeValue, addr 0x1ea55a0, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValidAttributeValue(::StringW value);

  /// @brief Method IsValidTag, addr 0x1ea4ae4, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValidTag(::StringW tag);

  /// @brief Method IsValidText, addr 0x1ea4c6c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForChildByTag, addr 0x1ea561c, size 0x128, virtual false, abstract: false, final false
  inline ::System::Security::SecurityElement* SearchForChildByTag(::StringW tag);

  /// @brief Method SearchForTextOfLocalName, addr 0x1ea5f50, size 0x23c, virtual false, abstract: false, final false
  inline ::StringW SearchForTextOfLocalName(::StringW strLocalName);

  /// @brief Method SearchForTextOfTag, addr 0x1ea5744, size 0x130, virtual false, abstract: false, final false
  inline ::StringW SearchForTextOfTag(::StringW tag);

  /// @brief Method ToString, addr 0x1ea5874, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToXml, addr 0x1ea58fc, size 0x64c, virtual false, abstract: false, final false
  inline void ToXml(ByRef<::System::Text::StringBuilder*> s, int32_t level);

  /// @brief Method Unescape, addr 0x1ea4ce8, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea2cb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW tag);

  /// @brief Method .ctor, addr 0x1ea4994, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Children, addr 0x1ea4c5c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_Children();

  /// @brief Method get_Tag, addr 0x1ea4c64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Text, addr 0x1ea4b60, size 0xfc, virtual false, abstract: false, final false
  inline void set_Text(::StringW value);

  /// @brief Method set_m_strText, addr 0x1ea5f48, size 0x8, virtual false, abstract: false, final false
