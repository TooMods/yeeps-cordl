...
public:
  ...
  /// @brief Method .ctor, addr 0x109c400, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method get_Schema, addr 0x109cbf0, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* get_Schema();

  /// @brief Method get_Type, addr 0x109cbe8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GenerateInternal>b__0, addr 0x109cbf8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x109c31c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddNullType, addr 0x109c49c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x109b2a0, size 0x74, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type* type);

  /// @brief Method Generate, addr 0x109b3c8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type* type, ::Newtonsoft::Json::Schema::JsonSchemaResolver* resolver);

  /// @brief Method Generate, addr 0x109b314, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x109b3d0, size 0x78, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type* type, bool rootSchemaNullable);

  /// @brief Method GenerateISerializableContract, addr 0x109cb40, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInternal, addr 0x109b448, size 0xc4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateObjectSchema, addr 0x109c4ac, size 0x4cc, virtual false, abstract: false, final false
  inline void GenerateObjectSchema(::System::Type* type, ::Newtonsoft::Json::Serialization::JsonObjectContract* contract);

  /// @brief Method GetDescription, addr 0x109c130, size 0xf0, virtual false, abstract: false, final false
  inline ::StringW GetDescription(::System::Type* type);

  /// @brief Method GetJsonSchemaType, addr 0x109c978, size 0x1c8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaType GetJsonSchemaType(::System::Type* type, ::Newtonsoft::Json::Required valueRequired);

  /// @brief Method GetTitle, addr 0x109c094, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW GetTitle(::System::Type* type);

  /// @brief Method GetTypeId, addr 0x109c220, size 0xfc, virtual false, abstract: false, final false
  inline ::StringW GetTypeId(::System::Type* type, bool explicitOnly);

  /// @brief Method HasFlag, addr 0x109cb60, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasFlag, addr 0x109c324, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x109b080, size 0x220, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::__JsonSchemaGenerator__TypeSchema* Pop();

  /// @brief Method Push, addr 0x109af40, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x109cb6c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ContractResolver, addr 0x109ae9c, size 0x94, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::IContractResolver* get_ContractResolver();

  /// @brief Method get_CurrentSchema, addr 0x109af38, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* get_CurrentSchema();

  /// @brief Method get_UndefinedSchemaIdHandling, addr 0x109ae8c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::UndefinedSchemaIdHandling get_UndefinedSchemaIdHandling();

  /// @brief Method set_ContractResolver, addr 0x109af30, size 0x8, virtual false, abstract: false, final false
  inline void set_ContractResolver(::Newtonsoft::Json::Serialization::IContractResolver* value);

  /// @brief Method set_UndefinedSchemaIdHandling, addr 0x109ae94, size 0x8, virtual false, abstract: false, final false
