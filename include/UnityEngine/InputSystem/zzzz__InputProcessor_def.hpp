...
public:
  ...
  /// @brief Method GetValueTypeFromType, addr 0x187922c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1879328, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::Utilities::TypeTable getStaticF_s_Processors();

  /// @brief Method get_cachingPolicy, addr 0x1879320, size 0x8, virtual true, abstract: false, final false
