...
public:
  ...
  /// @brief Method .ctor, addr 0x304a210, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::DoubleLinkAxis* axis, bool isdesorself);

  /// @brief Method get_IsAttribute, addr 0x304a1f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAttribute();

  /// @brief Method get_IsDss, addr 0x304a200, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDss();

  /// @brief Method get_IsSelfAxis, addr 0x304a208, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsSelfAxis();

  /// @brief Method get_RootNode, addr 0x304a1e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::DoubleLinkAxis* get_RootNode();

  /// @brief Method get_TopNode, addr 0x304a1f0, size 0x8, virtual false, abstract: false, final false
