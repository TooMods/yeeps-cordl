...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x18cb450, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x18cba3c, size 0x28, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x18cbd7c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18cb378, size 0xd8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x18cb850, size 0xa8, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x18cbbac, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x18cbd90, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18cb778, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method BeginRead, addr 0x18cb0f8, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x18cb4f8, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x18ca8dc, size 0xb8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x18cb8f8, size 0x144, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x18cba64, size 0x148, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x18ca838, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x18cafec, size 0xb8, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x18cab58, size 0x1ec, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method ReadAsyncMemory, addr 0x18ca3e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCore, addr 0x18c9e94, size 0x11c, virtual false, abstract: false, final false
  inline int32_t ReadCore(::System::Span_1<uint8_t> destination);

  /// @brief Method ReadInternal, addr 0x18caa98, size 0x48, virtual false, abstract: false, final false
  inline int32_t ReadInternal(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method Seek, addr 0x18cbbb8, size 0x40, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x18cbbf8, size 0x40, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x18cadf4, size 0x1f8, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method WriteAsyncMemory, addr 0x18ca4e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCore, addr 0x18ca180, size 0x84, virtual false, abstract: false, final false
  inline void WriteCore(::System::ReadOnlySpan_1<uint8_t> source);

  /// @brief Method WriteInternal, addr 0x18cad44, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18ca598, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* compressedStream, ::System::IO::Compression::CompressionMode mode, bool leaveOpen, bool gzip);

  /// @brief Method .ctor, addr 0x18ca58c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionMode mode);

  /// @brief Method .ctor, addr 0x18c9a44, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionMode mode, bool leaveOpen, int32_t windowsBits);

  /// @brief Method get_CanRead, addr 0x18cbc38, size 0x3c, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x18cbc74, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x18cbc7c, size 0x40, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x18cbcbc, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x18cbcfc, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x18cbd3c, size 0x40, virtual true, abstract: false, final false
