...
public:
  ...
  /// @brief Method <BuildPermissionCallbacks>b__14_0, addr 0xfce56c, size 0xa4, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_0(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__14_1, addr 0xfce610, size 0xa4, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_1(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__14_2, addr 0xfce6b4, size 0xec, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_2(::StringW permissionId);

  /// @brief Method .ctor, addr 0xfce564, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildPermissionCallbacks, addr 0xfce2dc, size 0x224, virtual false, abstract: false, final false
  static inline ::UnityEngine::Android::PermissionCallbacks* BuildPermissionCallbacks();

  /// @brief Method GetPermissionId, addr 0xfcd954, size 0xe4, virtual false, abstract: false, final false
  static inline ::StringW GetPermissionId(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method IsPermissionGranted, addr 0xfcddd4, size 0x14, virtual false, abstract: false, final false
  static inline bool IsPermissionGranted(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method IsPermissionSupportedByPlatform, addr 0xfcda38, size 0x12c, virtual false, abstract: false, final false
  static inline bool IsPermissionSupportedByPlatform(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method Request, addr 0xfcdde8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestPermissions, addr 0xfcddec, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldRequestPermission, addr 0xfce1e0, size 0xfc, virtual false, abstract: false, final false
  static inline bool ShouldRequestPermission(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method add_PermissionGranted, addr 0xfcd7bc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_PermissionGranted, addr 0xfcd888, size 0xcc, virtual false, abstract: false, final false
