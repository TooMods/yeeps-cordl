...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129ae0c, size 0x50c, virtual false, abstract: false, final false
  inline void AddKeyHash(::System::Text::StringBuilder* sb);

  /// @brief Method GetKey, addr 0x129ad98, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129ac18, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x129ac84, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAttributes* get_Item(::System::Type* type);

  /// @brief Method get_Item, addr 0x129ace4, size 0xb4, virtual false, abstract: false, final false
