...
public:
  ...
  /// @brief Method Clone, addr 0x18b4644, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18b46f4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseType, addr 0x18b462c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseType();

  /// @brief Method get_BaseTypeName, addr 0x18b458c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_BaseTypeName();

  /// @brief Method get_Facets, addr 0x18b463c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Facets();

  /// @brief Method set_BaseType, addr 0x18b4634, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_BaseTypeName, addr 0x18b4594, size 0x98, virtual false, abstract: false, final false
