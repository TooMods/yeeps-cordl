...
public:
  ...
  /// @brief Method OnEnter, addr 0x209422c, size 0x10, virtual false, abstract: false, final false
  inline void OnEnter(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnLeave, addr 0x209423c, size 0x74, virtual false, abstract: false, final false
  inline void OnLeave(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method SendActivation, addr 0x2093ffc, size 0x118, virtual false, abstract: false, final false
  inline void SendActivation();

  /// @brief Method SendDeactivation, addr 0x2094114, size 0x118, virtual false, abstract: false, final false
  inline void SendDeactivation();

  /// @brief Method SetActive, addr 0x2092308, size 0x33c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20921f8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::IVisualElementPanelActivatable* activatable);

  /// @brief Method get_isActive, addr 0x2093fd4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method get_isDetaching, addr 0x2093fe8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isDetaching();

  /// @brief Method set_isActive, addr 0x2093fdc, size 0xc, virtual false, abstract: false, final false
  inline void set_isActive(bool value);

  /// @brief Method set_isDetaching, addr 0x2093ff0, size 0xc, virtual false, abstract: false, final false
