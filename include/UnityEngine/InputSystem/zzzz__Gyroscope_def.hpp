...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c71d30, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c71c58, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::Gyroscope* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c71cac, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c71da8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::Gyroscope* getStaticF__current_k__BackingField();

  /// @brief Method get_angularVelocity, addr 0x1c71bb4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_angularVelocity();

  /// @brief Method get_current, addr 0x1c71bc4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_angularVelocity, addr 0x1c71bbc, size 0x8, virtual false, abstract: false, final false
  inline void set_angularVelocity(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_current, addr 0x1c71c0c, size 0x4c, virtual false, abstract: false, final false
