...
public:
  ...
  /// @brief Method MoveNext, addr 0xff2154, size 0x64, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::XmlChildEnumerator* New_ctor(::System::Xml::XmlNode* container);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0xff2150, size 0x4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0xff21b8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0xff21f0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xff2100, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Current, addr 0xff21f4, size 0x7c, virtual false, abstract: false, final false
