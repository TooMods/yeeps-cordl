...
public:
  ...
  /// @brief Method CreateCustomExtensionIfAny, addr 0x12c5a10, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCertContentType, addr 0x12c60ec, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNameInfo, addr 0x12c6188, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x12c534c, size 0x58, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x12c61c4, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x12c61d0, size 0xe74, virtual true, abstract: false, final false
  inline ::StringW ToString(bool verbose);

  /// @brief Method Verify, addr 0x12c7044, size 0x2c, virtual false, abstract: false, final false
  inline bool Verify();
  ...
  /// @brief Method .ctor, addr 0x12c53a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12c5574, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate* certificate);

  /// @brief Method .ctor, addr 0x12c557c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x12c53ac, size 0x1c8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> rawData);

  /// @brief Method get_Extensions, addr 0x12c55c4, size 0x3c0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ExtensionCollection* get_Extensions();

  /// @brief Method get_HasPrivateKey, addr 0x12c5bf0, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasPrivateKey();

  /// @brief Method get_Impl, addr 0x12c5984, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* get_Impl();

  /// @brief Method get_IssuerName, addr 0x12c5d80, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName();

  /// @brief Method get_NotAfter, addr 0x12c5ddc, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x12c5de4, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_NotBefore();

  /// @brief Method get_PrivateKey, addr 0x12c5c24, size 0x15c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_PrivateKey();

  /// @brief Method get_PublicKey, addr 0x12c5dec, size 0x15c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::PublicKey* get_PublicKey();

  /// @brief Method get_RawData, addr 0x12c5f48, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x12c5fa4, size 0x10, virtual false, abstract: false, final false
  inline ::StringW get_SerialNumber();

  /// @brief Method get_SignatureAlgorithm, addr 0x12c5fb4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::Oid* get_SignatureAlgorithm();

  /// @brief Method get_SubjectName, addr 0x12c6018, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName();

  /// @brief Method get_Thumbprint, addr 0x12c6074, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Thumbprint();

  /// @brief Method get_Version, addr 0x12c6090, size 0x5c, virtual false, abstract: false, final false
