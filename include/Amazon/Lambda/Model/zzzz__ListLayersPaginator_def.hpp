...
#include <cstdint>
CORDL_MODULE_EXPORT(ListLayersPaginator)
...
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::ListLayersPaginator::<>c*
class CORDL_TYPE __ListLayersPaginator____c : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>9, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF___9, put = setStaticF___9))::Amazon::Lambda::Model::__ListLayersPaginator____c* __9;

  /// @brief Field <>9__6_0, offset 0xffffffff, size 0x8
  static __declspec(property(
      get = getStaticF___9__6_0,
      put = setStaticF___9__6_0))::System::Func_2<::Amazon::Lambda::Model::ListLayersResponse*, ::System::Collections::Generic::IEnumerable_1<::Amazon::Lambda::Model::LayersListItem*>*>* __9__6_0;

  static inline ::Amazon::Lambda::Model::__ListLayersPaginator____c* New_ctor();

  /// @brief Method .ctor, addr 0x31122cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_Layers>b__6_0, addr 0x31122d4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Amazon::Lambda::Model::LayersListItem*>* _get_Layers_b__6_0(::Amazon::Lambda::Model::ListLayersResponse* i);

  static inline ::Amazon::Lambda::Model::__ListLayersPaginator____c* getStaticF___9();

  static inline ::System::Func_2<::Amazon::Lambda::Model::ListLayersResponse*, ::System::Collections::Generic::IEnumerable_1<::Amazon::Lambda::Model::LayersListItem*>*>* getStaticF___9__6_0();

  static inline void setStaticF___9(::Amazon::Lambda::Model::__ListLayersPaginator____c* value);

  static inline void
  setStaticF___9__6_0(::System::Func_2<::Amazon::Lambda::Model::ListLayersResponse*, ::System::Collections::Generic::IEnumerable_1<::Amazon::Lambda::Model::LayersListItem*>*>* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __ListLayersPaginator____c();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__ListLayersPaginator____c", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __ListLayersPaginator____c(__ListLayersPaginator____c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__ListLayersPaginator____c", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __ListLayersPaginator____c(__ListLayersPaginator____c const&) = delete;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::__ListLayersPaginator____c, 0x10>, "Size mismatch!");

} // namespace Amazon::Lambda::Model
// Type: ::<Amazon-Runtime-IPaginator<Amazon-Lambda-Model-ListLayersResponse>-PaginateAsync>d__8
...
public:
  ...
  __declspec(property(get = __cordl_internal_get___2__current, put = __cordl_internal_set___2__current))::Amazon::Lambda::Model::ListLayersResponse* __2__current;
  ...
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this))::Amazon::Lambda::Model::ListLayersPaginator* __4__this;
  ...
  constexpr operator ::System::Collections::Generic::IAsyncEnumerable_1<::Amazon::Lambda::Model::ListLayersResponse*>*() noexcept;

  /// @brief Convert operator to "::System::Collections::Generic::IAsyncEnumerator_1<::Amazon::Lambda::Model::ListLayersResponse*>"
  constexpr operator ::System::Collections::Generic::IAsyncEnumerator_1<::Amazon::Lambda::Model::ListLayersResponse*>*() noexcept;
  ...
  /// @brief Method System.Collections.Generic.IAsyncEnumerator<Amazon.Lambda.Model.ListLayersResponse>.MoveNextAsync, addr 0x3112794, size 0x138, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask_1<bool> System_Collections_Generic_IAsyncEnumerator_Amazon_Lambda_Model_ListLayersResponse__MoveNextAsync();

  /// @brief Method System.Collections.Generic.IAsyncEnumerator<Amazon.Lambda.Model.ListLayersResponse>.get_Current, addr 0x31128cc, size 0x8, virtual true, abstract: false, final true
  inline ::Amazon::Lambda::Model::ListLayersResponse* System_Collections_Generic_IAsyncEnumerator_Amazon_Lambda_Model_ListLayersResponse__get_Current();

  /// @brief Method System.IAsyncDisposable.DisposeAsync, addr 0x3112b24, size 0xfc, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask System_IAsyncDisposable_DisposeAsync();

  /// @brief Method System.Threading.Tasks.Sources.IValueTaskSource.GetResult, addr 0x31129fc, size 0x58, virtual true, abstract: false, final true
  inline void System_Threading_Tasks_Sources_IValueTaskSource_GetResult(int16_t token);

  /// @brief Method System.Threading.Tasks.Sources.IValueTaskSource.GetStatus, addr 0x3112a54, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Threading.Tasks.Sources.IValueTaskSource<System.Boolean>.GetStatus, addr 0x311292c, size 0x58, virtual true, abstract: false, final true
  ...
  constexpr ::Amazon::Lambda::Model::ListLayersResponse*& __cordl_internal_get___2__current();

  constexpr ::cordl_internals::to_const_pointer<::Amazon::Lambda::Model::ListLayersResponse*> const& __cordl_internal_get___2__current() const;
  ...
  constexpr ::Amazon::Lambda::Model::ListLayersPaginator*& __cordl_internal_get___4__this();

  constexpr ::cordl_internals::to_const_pointer<::Amazon::Lambda::Model::ListLayersPaginator*> const& __cordl_internal_get___4__this() const;
  ...
  constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListLayersResponse*> const& __cordl_internal_get___u__1() const;

  constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListLayersResponse*>& __cordl_internal_get___u__1();
  ...
  constexpr void __cordl_internal_set___u__1(::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListLayersResponse*> value);
  ...
  /// @brief Method .ctor, addr 0x3112210, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  ::Amazon::Lambda::Model::ListLayersResponse* _____2__current;
  ...
  ::Amazon::Lambda::Model::ListLayersPaginator* _____4__this;
  ...
  ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListLayersResponse*> _____u__1;
...
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::Amazon.Lambda.Model::ListLayersPaginator*
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__request, put = __cordl_internal_set__request))::Amazon::Lambda::Model::ListLayersRequest* _request;

  /// @brief Convert operator to "::Amazon::Lambda::Model::IListLayersPaginator"
  constexpr operator ::Amazon::Lambda::Model::IListLayersPaginator*() noexcept;

  /// @brief Convert operator to "::Amazon::Runtime::IPaginator_1<::Amazon::Lambda::Model::ListLayersResponse*>"
  constexpr operator ::Amazon::Runtime::IPaginator_1<::Amazon::Lambda::Model::ListLayersResponse*>*() noexcept;

  /// @brief Method Amazon.Runtime.IPaginator<Amazon.Lambda.Model.ListLayersResponse>.PaginateAsync, addr 0x311219c, size 0x74, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IAsyncEnumerable_1<::Amazon::Lambda::Model::ListLayersResponse*>*
  Amazon_Runtime_IPaginator_Amazon_Lambda_Model_ListLayersResponse__PaginateAsync(::System::Threading::CancellationToken cancellationToken);

  static inline ::Amazon::Lambda::Model::ListLayersPaginator* New_ctor(::Amazon::Lambda::IAmazonLambda* client, ::Amazon::Lambda::Model::ListLayersRequest* request);
  ...
  constexpr ::Amazon::Lambda::Model::ListLayersRequest*& __cordl_internal_get__request();

  constexpr ::cordl_internals::to_const_pointer<::Amazon::Lambda::Model::ListLayersRequest*> const& __cordl_internal_get__request() const;
  ...
  constexpr void __cordl_internal_set__request(::Amazon::Lambda::Model::ListLayersRequest* value);

  /// @brief Method .ctor, addr 0x310d534, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Amazon::Lambda::IAmazonLambda* client, ::Amazon::Lambda::Model::ListLayersRequest* request);

  /// @brief Method get_Layers, addr 0x3112078, size 0x124, virtual true, abstract: false, final true
  inline ::Amazon::Runtime::IPaginatedEnumerable_1<::Amazon::Lambda::Model::LayersListItem*>* get_Layers();

  /// @brief Method get_Responses, addr 0x3112000, size 0x78, virtual true, abstract: false, final true
  ...
  constexpr ::Amazon::Lambda::Model::IListLayersPaginator* i___Amazon__Lambda__Model__IListLayersPaginator() noexcept;

  /// @brief Convert to "::Amazon::Runtime::IPaginator_1<::Amazon::Lambda::Model::ListLayersResponse*>"
  constexpr ::Amazon::Runtime::IPaginator_1<::Amazon::Lambda::Model::ListLayersResponse*>* i___Amazon__Runtime__IPaginator_1___Amazon__Lambda__Model__ListLayersResponse__() noexcept;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ListLayersPaginator();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ListLayersPaginator", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListLayersPaginator(ListLayersPaginator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListLayersPaginator", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListLayersPaginator(ListLayersPaginator const&) = delete;
  ...
  ::Amazon::Lambda::Model::ListLayersRequest* ____request;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::ListLayersPaginator, 0x28>, "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayersPaginator, ____client) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayersPaginator, ____request) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayersPaginator, ____isPaginatorInUse) == 0x20, "Offset mismatch!");
