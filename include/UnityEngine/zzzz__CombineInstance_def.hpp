...
public:
  ...
  /// @brief Method set_mesh, addr 0x27fa9b8, size 0x90, virtual false, abstract: false, final false
  inline void set_mesh(::UnityEngine::Mesh* value);

  /// @brief Method set_subMeshIndex, addr 0x27faa48, size 0x8, virtual false, abstract: false, final false
  inline void set_subMeshIndex(int32_t value);

  /// @brief Method set_transform, addr 0x27faa50, size 0x1c, virtual false, abstract: false, final false
