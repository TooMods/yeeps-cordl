...
public:
  ...
  /// @brief Method Update, addr 0x21ea678, size 0xa0, virtual false, abstract: false, final false
  static inline void Update();

  /// @brief Method .ctor, addr 0x21ea718, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_InputFocusAcquired, addr 0x21ea388, size 0xb8, virtual false, abstract: false, final false
  static inline void add_InputFocusAcquired(::System::Action* value);

  /// @brief Method add_InputFocusLost, addr 0x21ea4f8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hasInputFocus, addr 0x21ea670, size 0x4, virtual false, abstract: false, final false
  static inline bool get_hasInputFocus();

  /// @brief Method remove_InputFocusAcquired, addr 0x21ea440, size 0xb8, virtual false, abstract: false, final false
  static inline void remove_InputFocusAcquired(::System::Action* value);

  /// @brief Method remove_InputFocusLost, addr 0x21ea5b4, size 0xbc, virtual false, abstract: false, final false
