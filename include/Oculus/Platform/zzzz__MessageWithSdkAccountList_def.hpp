...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5540, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(void* c_message);

  /// @brief Method GetSdkAccountList, addr 0x19b5504, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b143c, size 0x58, virtual false, abstract: false, final false
