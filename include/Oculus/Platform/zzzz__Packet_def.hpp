...
public:
  ...
  /// @brief Method Dispose, addr 0x19b6924, size 0x88, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x19b6890, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::Packet* New_ctor(void* packetHandle);

  /// @brief Method ReadBytes, addr 0x19b66ec, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b663c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(void* packetHandle);

  /// @brief Method get_SenderID, addr 0x19b6830, size 0x58, virtual false, abstract: false, final false
  inline uint64_t get_SenderID();

  /// @brief Method get_Size, addr 0x19b6888, size 0x8, virtual false, abstract: false, final false
