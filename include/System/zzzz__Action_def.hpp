...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2b09fec, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::System::Action* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2b09f30, size 0xbc, virtual false, abstract: false, final false
