...
public:
  ...
  /// @brief Method Clone, addr 0x21cae60, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x21cae68, size 0xc8, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::__Queue__QueueEnumerator* New_ctor(::System::Collections::Queue* q);

  /// @brief Method Reset, addr 0x21cafc4, size 0x8c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x21cac70, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Queue* q);

  /// @brief Method get_Current, addr 0x21caf30, size 0x94, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clone, addr 0x21ca6cc, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x21ca834, size 0x1f4, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method Dequeue, addr 0x21cacc0, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Object* Dequeue();

  /// @brief Method Enqueue, addr 0x21caa28, size 0xfc, virtual true, abstract: false, final false
  inline void Enqueue(::System::Object* obj);

  /// @brief Method GetElement, addr 0x21cae20, size 0x40, virtual false, abstract: false, final false
  inline ::System::Object* GetElement(int32_t i);

  /// @brief Method GetEnumerator, addr 0x21cac10, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x21cad8c, size 0x94, virtual true, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method SetCapacity, addr 0x21cab24, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21ca284, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x21ca450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x21ca290, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, float_t growFactor);

  /// @brief Method .ctor, addr 0x21ca458, size 0x26c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ICollection* col);

  /// @brief Method get_Count, addr 0x21ca6c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x21ca7b0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x21ca7b8, size 0x7c, virtual true, abstract: false, final false
