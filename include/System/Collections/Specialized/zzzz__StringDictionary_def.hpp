...
public:
  ...
  /// @brief Method Add, addr 0x18f0900, size 0x98, virtual true, abstract: false, final false
  inline void Add(::StringW key, ::StringW value);

  /// @brief Method GetEnumerator, addr 0x18f0998, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18f0898, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
