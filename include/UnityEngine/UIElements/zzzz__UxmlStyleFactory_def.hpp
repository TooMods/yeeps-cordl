...
public:
  ...
  /// @brief Method Create, addr 0x27de46c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27de474, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_uxmlName, addr 0x27de3b8, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x27de3f8, size 0x74, virtual true, abstract: false, final false
