...
public:
  ...
  /// @brief Method CheckNamespaceValidityForNestedRelations, addr 0x241b588, size 0x3a4, virtual false, abstract: false, final false
  inline void CheckNamespaceValidityForNestedRelations(::StringW ns);

  /// @brief Method CheckNestedRelations, addr 0x241b92c, size 0x410, virtual false, abstract: false, final false
  inline void CheckNestedRelations();

  /// @brief Method CheckState, addr 0x241d3b4, size 0x21c, virtual false, abstract: false, final false
  inline void CheckState();

  /// @brief Method CheckStateForProperty, addr 0x241b0cc, size 0xe8, virtual false, abstract: false, final false
  inline void CheckStateForProperty();

  /// @brief Method Clone, addr 0x241d5d0, size 0x654, virtual false, abstract: false, final false
  inline ::System::Data::DataRelation* Clone(::System::Data::DataSet* destination);

  /// @brief Method Create, addr 0x241ab30, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildRows, addr 0x241b2c0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentRow, addr 0x241b3d0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentRows, addr 0x241b34c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAutoGenerated, addr 0x241dd00, size 0x1d8, virtual false, abstract: false, final false
  inline bool IsAutoGenerated(::System::Data::DataColumn* col);

  /// @brief Method IsKeyNull, addr 0x241b20c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPropertyChanging, addr 0x241dc24, size 0xd0, virtual false, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method RaisePropertyChanging, addr 0x241d280, size 0x74, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method SetChildKeyConstraint, addr 0x241d3ac, size 0x8, virtual false, abstract: false, final false
  inline void SetChildKeyConstraint(::System::Data::ForeignKeyConstraint* value);

  /// @brief Method SetDataSet, addr 0x241b524, size 0x14, virtual false, abstract: false, final false
  inline void SetDataSet(::System::Data::DataSet* dataSet);

  /// @brief Method SetParentKeyConstraint, addr 0x241d30c, size 0x8, virtual false, abstract: false, final false
  inline void SetParentKeyConstraint(::System::Data::UniqueConstraint* value);

  /// @brief Method ToString, addr 0x241dcf4, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateMultipleNestedRelations, addr 0x241cdc4, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241a938, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241ae24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW relationName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns);

  /// @brief Method .ctor, addr 0x241ae2c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW relationName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns, bool createConstraints);

  /// @brief Method .ctor, addr 0x241aef4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241afc8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CheckMultipleNested, addr 0x241d398, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckMultipleNested();

  /// @brief Method get_ChildColumnNames, addr 0x241b204, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ChildColumnNames();

  /// @brief Method get_ChildColumns, addr 0x241b0b4, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ChildColumns();

  /// @brief Method get_ChildColumnsReference, addr 0x241b1b4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ChildColumnsReference();

  /// @brief Method get_ChildKey, addr 0x2410b44, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ChildKey();

  /// @brief Method get_ChildKeyConstraint, addr 0x241d314, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::ForeignKeyConstraint* get_ChildKeyConstraint();

  /// @brief Method get_ChildTable, addr 0x241b1cc, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_ChildTable();

  /// @brief Method get_DataSet, addr 0x241b1e4, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* get_DataSet();

  /// @brief Method get_ExtendedProperties, addr 0x241d32c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_Nested, addr 0x241bd3c, size 0x18, virtual true, abstract: false, final false
  inline bool get_Nested();

  /// @brief Method get_ObjectID, addr 0x241ded8, size 0x1008, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_ParentColumnNames, addr 0x241b1fc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ParentColumnNames();

  /// @brief Method get_ParentColumns, addr 0x241b538, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ParentColumns();

  /// @brief Method get_ParentColumnsReference, addr 0x241b550, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ParentColumnsReference();

  /// @brief Method get_ParentKey, addr 0x2410bb8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ParentKey();

  /// @brief Method get_ParentKeyConstraint, addr 0x241d2f4, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::UniqueConstraint* get_ParentKeyConstraint();

  /// @brief Method get_ParentTable, addr 0x241b558, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_ParentTable();

  /// @brief Method get_RelationName, addr 0x241b570, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_RelationName();

  static inline void setStaticF_s_objectTypeCount(int32_t value);

  /// @brief Method set_CheckMultipleNested, addr 0x241d3a0, size 0xc, virtual false, abstract: false, final false
  inline void set_CheckMultipleNested(bool value);

  /// @brief Method set_Nested, addr 0x241bd54, size 0x1070, virtual true, abstract: false, final false
