...
public:
  ...
  /// @brief Method .ctor, addr 0x25c9d84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c9d8c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW propertyName);

  /// @brief Method get_DefaultValueHandling, addr 0x25c970c, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::DefaultValueHandling get_DefaultValueHandling();

  /// @brief Method get_IsReference, addr 0x25c999c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_IsReference();

  /// @brief Method get_ItemConverterParameters, addr 0x25c9638, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> get_ItemConverterParameters();

  /// @brief Method get_ItemConverterType, addr 0x25c9628, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ItemConverterType();

  /// @brief Method get_ItemIsReference, addr 0x25c9ce0, size 0x3c, virtual false, abstract: false, final false
  inline bool get_ItemIsReference();

  /// @brief Method get_ItemReferenceLoopHandling, addr 0x25c9b98, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ReferenceLoopHandling get_ItemReferenceLoopHandling();

  /// @brief Method get_ItemTypeNameHandling, addr 0x25c9c3c, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::TypeNameHandling get_ItemTypeNameHandling();

  /// @brief Method get_NamingStrategyParameters, addr 0x25c9658, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> get_NamingStrategyParameters();

  /// @brief Method get_NamingStrategyType, addr 0x25c9648, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_NamingStrategyType();

  /// @brief Method get_NullValueHandling, addr 0x25c9668, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::NullValueHandling get_NullValueHandling();

  /// @brief Method get_ObjectCreationHandling, addr 0x25c9854, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ObjectCreationHandling get_ObjectCreationHandling();

  /// @brief Method get_Order, addr 0x25c9a40, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method get_PropertyName, addr 0x25c9b88, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PropertyName();

  /// @brief Method get_ReferenceLoopHandling, addr 0x25c97b0, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ReferenceLoopHandling get_ReferenceLoopHandling();

  /// @brief Method get_Required, addr 0x25c9ae4, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Required get_Required();

  /// @brief Method get_TypeNameHandling, addr 0x25c98f8, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::TypeNameHandling get_TypeNameHandling();

  /// @brief Method set_DefaultValueHandling, addr 0x25c9748, size 0x68, virtual false, abstract: false, final false
  inline void set_DefaultValueHandling(::Newtonsoft::Json::DefaultValueHandling value);

  /// @brief Method set_IsReference, addr 0x25c99d8, size 0x68, virtual false, abstract: false, final false
  inline void set_IsReference(bool value);

  /// @brief Method set_ItemConverterParameters, addr 0x25c9640, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemConverterParameters(::ArrayW<::System::Object*, ::Array<::System::Object*>*> value);

  /// @brief Method set_ItemConverterType, addr 0x25c9630, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemConverterType(::System::Type* value);

  /// @brief Method set_ItemIsReference, addr 0x25c9d1c, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemIsReference(bool value);

  /// @brief Method set_ItemReferenceLoopHandling, addr 0x25c9bd4, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemReferenceLoopHandling(::Newtonsoft::Json::ReferenceLoopHandling value);

  /// @brief Method set_ItemTypeNameHandling, addr 0x25c9c78, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemTypeNameHandling(::Newtonsoft::Json::TypeNameHandling value);

  /// @brief Method set_NamingStrategyParameters, addr 0x25c9660, size 0x8, virtual false, abstract: false, final false
  inline void set_NamingStrategyParameters(::ArrayW<::System::Object*, ::Array<::System::Object*>*> value);

  /// @brief Method set_NamingStrategyType, addr 0x25c9650, size 0x8, virtual false, abstract: false, final false
  inline void set_NamingStrategyType(::System::Type* value);

  /// @brief Method set_NullValueHandling, addr 0x25c96a4, size 0x68, virtual false, abstract: false, final false
  inline void set_NullValueHandling(::Newtonsoft::Json::NullValueHandling value);

  /// @brief Method set_ObjectCreationHandling, addr 0x25c9890, size 0x68, virtual false, abstract: false, final false
  inline void set_ObjectCreationHandling(::Newtonsoft::Json::ObjectCreationHandling value);

  /// @brief Method set_Order, addr 0x25c9a7c, size 0x68, virtual false, abstract: false, final false
  inline void set_Order(int32_t value);

  /// @brief Method set_PropertyName, addr 0x25c9b90, size 0x8, virtual false, abstract: false, final false
  inline void set_PropertyName(::StringW value);

  /// @brief Method set_ReferenceLoopHandling, addr 0x25c97ec, size 0x68, virtual false, abstract: false, final false
  inline void set_ReferenceLoopHandling(::Newtonsoft::Json::ReferenceLoopHandling value);

  /// @brief Method set_Required, addr 0x25c9b20, size 0x68, virtual false, abstract: false, final false
  inline void set_Required(::Newtonsoft::Json::Required value);

  /// @brief Method set_TypeNameHandling, addr 0x25c9934, size 0x68, virtual false, abstract: false, final false
