...
public:
  // Declarations
  /// @brief Method Init, addr 0x2cd0f44, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd0f98, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::MouseEnterWindowEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x2cd0ff8, size 0x15c, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method .ctor, addr 0x2cd0fa4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
