...
CORDL_MODULE_EXPORT(ChannelTextMessage)
...
// Write type traits
MARK_REF_PTR_T(::Unity::Services::Vivox::ChannelTextMessage);
// Type: Unity.Services.Vivox::ChannelTextMessage
// SizeInfo { instance_size: 104, native_size: -1, calculated_instance_size: 104, calculated_native_size: 104, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Unity::Services::Vivox {
// Is value type: false
// CS Name: ::Unity.Services.Vivox::ChannelTextMessage*
class CORDL_TYPE ChannelTextMessage : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Convert operator to "::Unity::Services::Vivox::IChannelTextMessage"
  constexpr operator ::Unity::Services::Vivox::IChannelTextMessage*() noexcept;
  ...
  static inline ::Unity::Services::Vivox::ChannelTextMessage* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x2cac990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PropertyChanged, addr 0x2cac70c, size 0x9c, virtual true, abstract: false, final true
  inline void add_PropertyChanged(::System::ComponentModel::PropertyChangedEventHandler* value);

  /// @brief Method get_ApplicationStanzaBody, addr 0x2cac980, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_ApplicationStanzaBody();

  /// @brief Method get_ApplicationStanzaNamespace, addr 0x2cac970, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_ApplicationStanzaNamespace();

  /// @brief Method get_ChannelSession, addr 0x2cac93c, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Services::Vivox::IChannelSession* get_ChannelSession();

  /// @brief Method get_Exception, addr 0x2cac844, size 0x8, virtual false, abstract: false, final false
  inline ::System::Exception* get_Exception();

  /// @brief Method get_FromSelf, addr 0x2cac95c, size 0x8, virtual true, abstract: false, final true
  inline bool get_FromSelf();

  /// @brief Method get_Key, addr 0x2cac8fc, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_Key();

  /// @brief Method get_Language, addr 0x2cac92c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_Language();

  /// @brief Method get_Message, addr 0x2cac91c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_Message();

  /// @brief Method get_ReceivedTime, addr 0x2cac90c, size 0x8, virtual true, abstract: false, final true
  inline ::System::DateTime get_ReceivedTime();

  /// @brief Method get_Sender, addr 0x2cac94c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Convert to "::Unity::Services::Vivox::IChannelTextMessage"
  constexpr ::Unity::Services::Vivox::IChannelTextMessage* i___Unity__Services__Vivox__IChannelTextMessage() noexcept;
  ...
  /// @brief Method remove_PropertyChanged, addr 0x2cac7a8, size 0x9c, virtual true, abstract: false, final true
  inline void remove_PropertyChanged(::System::ComponentModel::PropertyChangedEventHandler* value);

  /// @brief Method set_ApplicationStanzaBody, addr 0x2cac988, size 0x8, virtual false, abstract: false, final false
  inline void set_ApplicationStanzaBody(::StringW value);

  /// @brief Method set_ApplicationStanzaNamespace, addr 0x2cac978, size 0x8, virtual false, abstract: false, final false
  inline void set_ApplicationStanzaNamespace(::StringW value);

  /// @brief Method set_ChannelSession, addr 0x2cac944, size 0x8, virtual false, abstract: false, final false
  inline void set_ChannelSession(::Unity::Services::Vivox::IChannelSession* value);

  /// @brief Method set_Exception, addr 0x2cac84c, size 0xb0, virtual false, abstract: false, final false
  inline void set_Exception(::System::Exception* value);

  /// @brief Method set_FromSelf, addr 0x2cac964, size 0xc, virtual false, abstract: false, final false
  inline void set_FromSelf(bool value);

  /// @brief Method set_Key, addr 0x2cac904, size 0x8, virtual false, abstract: false, final false
  inline void set_Key(::StringW value);

  /// @brief Method set_Language, addr 0x2cac934, size 0x8, virtual false, abstract: false, final false
  inline void set_Language(::StringW value);

  /// @brief Method set_Message, addr 0x2cac924, size 0x8, virtual false, abstract: false, final false
  inline void set_Message(::StringW value);

  /// @brief Method set_ReceivedTime, addr 0x2cac914, size 0x8, virtual false, abstract: false, final false
  inline void set_ReceivedTime(::System::DateTime value);

  /// @brief Method set_Sender, addr 0x2cac954, size 0x8, virtual false, abstract: false, final false
  inline void set_Sender(::Unity::Services::Vivox::AccountId* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ChannelTextMessage();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ChannelTextMessage", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChannelTextMessage(ChannelTextMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChannelTextMessage", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChannelTextMessage(ChannelTextMessage const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Unity::Services::Vivox::ChannelTextMessage, 0x68>, "Size mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____exception) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ___PropertyChanged) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____Key_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____ReceivedTime_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____Message_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____Language_k__BackingField) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____ChannelSession_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____Sender_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____FromSelf_k__BackingField) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____ApplicationStanzaNamespace_k__BackingField) == 0x58, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ChannelTextMessage, ____ApplicationStanzaBody_k__BackingField) == 0x60, "Offset mismatch!");

} // namespace Unity::Services::Vivox
NEED_NO_BOX(::Unity::Services::Vivox::ChannelTextMessage);
DEFINE_IL2CPP_ARG_TYPE(::Unity::Services::Vivox::ChannelTextMessage*, "Unity.Services.Vivox", "ChannelTextMessage");
