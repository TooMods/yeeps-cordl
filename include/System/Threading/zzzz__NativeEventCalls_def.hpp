...
public:
  // Declarations
  /// @brief Method CloseEvent_internal, addr 0xed013c, size 0x4, virtual false, abstract: false, final false
  static inline void CloseEvent_internal(void* handle);

  /// @brief Method CreateEvent_icall, addr 0xecff68, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEvent_internal, addr 0xecff10, size 0x58, virtual false, abstract: false, final false
  static inline void* CreateEvent_internal(bool manual, bool initial, ::StringW name, ByRef<int32_t> errorCode);

  /// @brief Method ResetEvent, addr 0xed0058, size 0xe0, virtual false, abstract: false, final false
  static inline bool ResetEvent(::Microsoft::Win32::SafeHandles::SafeWaitHandle* handle);

  /// @brief Method ResetEvent_internal, addr 0xed0138, size 0x4, virtual false, abstract: false, final false
  static inline bool ResetEvent_internal(void* handle);

  /// @brief Method SetEvent, addr 0xecff74, size 0xe0, virtual false, abstract: false, final false
  static inline bool SetEvent(::Microsoft::Win32::SafeHandles::SafeWaitHandle* handle);

  /// @brief Method SetEvent_internal, addr 0xed0054, size 0x4, virtual false, abstract: false, final false
