...
public:
  ...
  /// @brief Method .ctor, addr 0x283aba8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enabled, addr 0x283aaec, size 0x3c, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_isActiveAndEnabled, addr 0x283ab6c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_isActiveAndEnabled();

  /// @brief Method set_enabled, addr 0x283ab28, size 0x44, virtual false, abstract: false, final false
