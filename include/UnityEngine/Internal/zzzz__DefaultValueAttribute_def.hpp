...
public:
  ...
  /// @brief Method Equals, addr 0x2a8b460, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2a8b518, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a8b430, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_Value, addr 0x2a8b458, size 0x8, virtual false, abstract: false, final false
