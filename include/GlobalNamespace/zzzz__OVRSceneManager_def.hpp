...
public:
  ...
  /// @brief Method get_List, addr 0x148fdd4, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x148f128, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method Log, addr 0x148d69c, size 0xbc, virtual false, abstract: false, final false
  inline void Log(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogError, addr 0x148ca58, size 0xbc, virtual false, abstract: false, final false
  inline void LogError(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogWarning, addr 0x148f780, size 0xbc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Log, addr 0x14902ec, size 0xbc, virtual false, abstract: false, final false
  static inline void Log(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogError, addr 0x1490464, size 0xbc, virtual false, abstract: false, final false
  static inline void LogError(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogWarning, addr 0x14903a8, size 0xbc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1490520, size 0x5ec, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1490b0c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1490b18, size 0x5f8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1491110, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method <DoesRoomSetupExist>b__0, addr 0x149111c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x148df08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CheckClassificationsInRooms>b__0, addr 0x1491134, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x148e468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x148c8e0, size 0x178, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CheckClassificationsInRooms, addr 0x148dff4, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIfAnchorsContainClassifications, addr 0x148e470, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIfClassificationsAreValid, addr 0x148d88c, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method CollectLabelsFromAnchors, addr 0x148e8fc, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyExistingAnchors, addr 0x148cd60, size 0x1e4, virtual false, abstract: false, final false
  inline void DestroyExistingAnchors();

  /// @brief Method DoesRoomSetupExist, addr 0x148dca8, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRoomLayoutInformation, addr 0x148d558, size 0x144, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSceneManager__RoomLayoutInformation* GetRoomLayoutInformation();

  /// @brief Method GetUuidsToQuery, addr 0x148df10, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSceneAnchor, addr 0x148f83c, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSceneRooms, addr 0x148cfec, size 0x3b4, virtual false, abstract: false, final false
  inline void InstantiateSceneRooms(::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>* roomLayoutAnchors);

  /// @brief Method LoadSceneModel, addr 0x148cc48, size 0x118, virtual false, abstract: false, final false
  inline bool LoadSceneModel();

  static inline ::GlobalNamespace::OVRSceneManager* New_ctor();

  /// @brief Method OVRManager_SceneCaptureComplete, addr 0x148f668, size 0x118, virtual false, abstract: false, final false
  inline void OVRManager_SceneCaptureComplete(uint64_t requestId, bool result);

  /// @brief Method OnAnchorsFetchCompleted, addr 0x148cf44, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationPause, addr 0x148cb14, size 0xa8, virtual false, abstract: false, final false
  inline void OnApplicationPause(bool isPaused);

  /// @brief Method OnDisable, addr 0x148f434, size 0x234, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x148f1a4, size 0x290, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSceneRoomLoadCompleted, addr 0x148d490, size 0xc8, virtual false, abstract: false, final false
  inline void OnSceneRoomLoadCompleted();

  /// @brief Method OnTrackingSpaceChanged, addr 0x148ea2c, size 0x4, virtual false, abstract: false, final false
  static inline void OnTrackingSpaceChanged(::UnityEngine::Transform* trackingSpace);

  /// @brief Method QueryForExistingAnchorsTransform, addr 0x148cbbc, size 0x8c, virtual false, abstract: false, final false
  inline void QueryForExistingAnchorsTransform();

  /// @brief Method RequestSceneCapture, addr 0x148d758, size 0x48, virtual false, abstract: false, final false
  inline bool RequestSceneCapture();

  /// @brief Method RequestSceneCapture, addr 0x148d7a0, size 0x98, virtual false, abstract: false, final false
  inline bool RequestSceneCapture(::StringW requestString);

  /// @brief Method RequestSceneCapture, addr 0x148d838, size 0x54, virtual false, abstract: false, final false
  inline bool RequestSceneCapture(::System::Collections::Generic::IEnumerable_1<::StringW>* requestedAnchorClassifications);

  /// @brief Method Update, addr 0x148ec70, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateAllSceneAnchors, addr 0x148ea30, size 0x240, virtual false, abstract: false, final false
  static inline void UpdateAllSceneAnchors();

  /// @brief Method UpdateSomeSceneAnchors, addr 0x148ec74, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x148fd48, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InitialAnchorParent, addr 0x148c868, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_InitialAnchorParent();

  /// @brief Method get_Verbose, addr 0x148c878, size 0x68, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::GlobalNamespace::__OVRSceneManager__LogForwarder> get_Verbose();

  /// @brief Method set_InitialAnchorParent, addr 0x148c870, size 0x8, virtual false, abstract: false, final false
