...
public:
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x167a788, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x167a5bc, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x167a650, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x167a4f0, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::StringW regexInput, ::StringW regexPattern, ::System::TimeSpan matchTimeout);

  /// @brief Method get_Input, addr 0x167a85c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Input();

  /// @brief Method get_MatchTimeout, addr 0x167a86c, size 0x8, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_MatchTimeout();

  /// @brief Method get_Pattern, addr 0x167a864, size 0x8, virtual false, abstract: false, final false
