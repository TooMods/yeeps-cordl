...
public:
  ...
  /// @brief Method Dispose, addr 0x20a161c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x20a1f68, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);
  ...
  /// @brief Method .ctor, addr 0x209da5c, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(uint32_t vertexMaxCount, uint32_t indexMaxCount, uint32_t maxQueuedFrameCount, bool mockPage);

  /// @brief Method get_disposed, addr 0x20a1f54, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_isEmpty, addr 0x209dba8, size 0x48, virtual false, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x20a1f5c, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);
