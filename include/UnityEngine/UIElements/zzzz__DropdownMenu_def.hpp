...
public:
  ...
  /// @brief Method AppendAction, addr 0x27d88b8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertSeparator, addr 0x27d89bc, size 0x140, virtual false, abstract: false, final false
  inline void InsertSeparator(::StringW subMenuPath, int32_t atIndex);

  /// @brief Method MenuItems, addr 0x27d88b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::DropdownMenuItem*>* MenuItems();

  /// @brief Method PrepareForDisplay, addr 0x27d8afc, size 0x2bc, virtual false, abstract: false, final false
