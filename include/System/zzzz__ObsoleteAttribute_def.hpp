...
public:
  ...
  /// @brief Method .ctor, addr 0x2efd26c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2efd28c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2efd2b8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, bool error);

  /// @brief Method get_Message, addr 0x2efd2e8, size 0x8, virtual false, abstract: false, final false
