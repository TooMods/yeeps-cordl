...
public:
  ...
  /// @brief Method CheckValid, addr 0x1dfe094, size 0x9c, virtual false, abstract: false, final false
  inline void CheckValid();

  /// @brief Method GetEnumerator, addr 0x1dfde98, size 0x80, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::EnhancedTouch::Touch>* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1dfdf4c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x1dfb6b4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x1dfdf50, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x1dfdf58, size 0x13c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x1dfe224, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x1dfe130, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x1dfe15c, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1dfe1a8, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1dfdf18, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::EnhancedTouch::TouchHistory owner);

  /// @brief Method get_Current, addr 0x1dfe168, size 0x40, virtual true, abstract: false, final true
