...
public:
  ...
  /// @brief Method .ctor, addr 0x2d26f84, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x2d26fb8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x2d26fc0, size 0x8, virtual true, abstract: false, final true
