...
public:
  ...
  /// @brief Field Fill value: static_cast<int32_t>(0x0)
  static ::System::ComponentModel::DataObjectMethodType const Fill;

  /// @brief Field Insert value: static_cast<int32_t>(0x3)
  static ::System::ComponentModel::DataObjectMethodType const Insert;

  /// @brief Field Select value: static_cast<int32_t>(0x1)
...
static_assert(::cordl_internals::size_check_v<::System::ComponentModel::DataObjectMethodType, 0x4>, "Size mismatch!");
