...
public:
  ...
  /// @brief Method CleanUp, addr 0xecdd78, size 0xcc, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0xecde44, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecc430, size 0x118, virtual false, abstract: false, final false
