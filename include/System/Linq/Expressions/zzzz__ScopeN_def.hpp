...
public:
  ...
  /// @brief Method GetExpression, addr 0x182d49c, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182d5e4, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182d62c, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182d46c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>* variables,
                    ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* body);

  /// @brief Method get_Body, addr 0x182d494, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* get_Body();

  /// @brief Method get_ExpressionCount, addr 0x182d544, size 0xa0, virtual true, abstract: false, final false
