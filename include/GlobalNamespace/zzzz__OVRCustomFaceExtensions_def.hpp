...
public:
  // Declarations
  /// @brief Method AutoGenerateMapping, addr 0x16e9cac, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoMapBlendshapes, addr 0x16ea9a0, size 0x2f4, virtual false, abstract: false, final false
  static inline void AutoMapBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method ClearBlendshapes, addr 0x16eadfc, size 0xbc, virtual false, abstract: false, final false
  static inline void ClearBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method CustomAutoGeneratedMapping, addr 0x16eadb4, size 0x48, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression, ::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>
  ...
  /// @brief Method FindBestMatch, addr 0x16ea418, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsLipsToward, addr 0x16ea808, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsLipsToward(::StringW blendshapeName);

  /// @brief Method OculusFaceAutoGenerateMapping, addr 0x16eac94, size 0x120, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression, ::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>
  OculusFaceAutoGenerateMapping(::UnityEngine::Mesh* sharedMesh, bool allowDuplicateMapping);

  /// @brief Method SplitCamelCase, addr 0x16ea904, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW SplitCamelCase(::StringW input);

  /// @brief Method TokenizeString, addr 0x16e9f18, size 0x500, virtual false, abstract: false, final false
