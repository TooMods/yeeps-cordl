...
public:
  ...
  /// @brief Method Decode, addr 0x1cc8b90, size 0xb4, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint32_t, ::Array<uint32_t>*> output, ::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t index);

  /// @brief Method Encode, addr 0x1cc8944, size 0xf8, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> output, ::ArrayW<uint32_t, ::Array<uint32_t>*> input);

  /// @brief Method F, addr 0x1cc8ab4, size 0x10, virtual false, abstract: false, final false
  inline uint32_t F(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method FF, addr 0x1cc8af4, size 0x2c, virtual false, abstract: false, final false
  inline void FF(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method G, addr 0x1cc8ac4, size 0x14, virtual false, abstract: false, final false
  inline uint32_t G(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GG, addr 0x1cc8b20, size 0x3c, virtual false, abstract: false, final false
  inline void GG(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method H, addr 0x1cc8ad8, size 0xc, virtual false, abstract: false, final false
  inline uint32_t H(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HH, addr 0x1cc8b5c, size 0x34, virtual false, abstract: false, final false
  inline void HH(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method HashCore, addr 0x1cc80ac, size 0x124, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x1cc8848, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x1cc7ff8, size 0xb4, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method MD4Transform, addr 0x1cc81d0, size 0x678, virtual false, abstract: false, final false
  ...
  /// @brief Method Padding, addr 0x1cc8a3c, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Padding(int32_t nLength);

  /// @brief Method ROL, addr 0x1cc8ae4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cc7f28, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
