...
public:
  ...
  /// @brief Method CanConvert, addr 0x11a9244, size 0x118, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  /// @brief Method EnsureReflectionObject, addr 0x11a8a04, size 0x1a8, virtual false, abstract: false, final false
  static inline void EnsureReflectionObject(::System::Type* t);

  /// @brief Method GetByteArray, addr 0x11a8824, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadByteArray, addr 0x11a8fa4, size 0x2a0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadByteArray(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ReadJson, addr 0x11a8bac, size 0x3f8, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x11a87d0, size 0x54, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method .ctor, addr 0x11a935c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
