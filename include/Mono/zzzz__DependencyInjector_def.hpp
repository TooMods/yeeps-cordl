...
public:
  ...
  /// @brief Method ReflectionLoad, addr 0x1d0301c, size 0x14c, virtual false, abstract: false, final false
  static inline ::Mono::ISystemDependencyProvider* ReflectionLoad();

  /// @brief Method Register, addr 0x1d03168, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SystemProvider, addr 0x1d02e18, size 0x204, virtual false, abstract: false, final false
