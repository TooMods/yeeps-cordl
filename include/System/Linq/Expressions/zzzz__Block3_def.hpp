...
public:
  ...
  /// @brief Method GetExpression, addr 0x182cad8, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182cb84, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182cb8c, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182caa0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x182cb7c, size 0x8, virtual true, abstract: false, final false
