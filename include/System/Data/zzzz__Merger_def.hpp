...
public:
  ...
  /// @brief Method GetSrcKey, addr 0x1c9cb3c, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Data::DataKey GetSrcKey(::System::Data::DataTable* src, ::System::Data::DataTable* dst);

  /// @brief Method MergeConstraints, addr 0x1c9ba0c, size 0x70, virtual false, abstract: false, final false
  inline void MergeConstraints(::System::Data::DataSet* source);

  /// @brief Method MergeConstraints, addr 0x1c9d394, size 0x2b0, virtual false, abstract: false, final false
  inline void MergeConstraints(::System::Data::DataTable* table);

  /// @brief Method MergeDataSet, addr 0x1c9a8bc, size 0x10c8, virtual false, abstract: false, final false
  inline void MergeDataSet(::System::Data::DataSet* source);

  /// @brief Method MergeExtendedProperties, addr 0x1c9c218, size 0x254, virtual false, abstract: false, final false
  inline void MergeExtendedProperties(::System::Data::PropertyCollection* src, ::System::Data::PropertyCollection* dst);

  /// @brief Method MergeRelation, addr 0x1c9ba7c, size 0x79c, virtual false, abstract: false, final false
  inline void MergeRelation(::System::Data::DataRelation* relation);

  /// @brief Method MergeSchema, addr 0x1c9cc88, size 0x70c, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* MergeSchema(::System::Data::DataTable* table);

  /// @brief Method MergeTable, addr 0x1c9c46c, size 0x22c, virtual false, abstract: false, final false
  inline void MergeTable(::System::Data::DataTable* src);

  /// @brief Method MergeTable, addr 0x1c9c698, size 0x4a4, virtual false, abstract: false, final false
  inline void MergeTable(::System::Data::DataTable* src, ::System::Data::DataTable* dst);

  /// @brief Method MergeTableData, addr 0x1c9b984, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c9a814, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet, bool preserveChanges, ::System::Data::MissingSchemaAction missingSchemaAction);

  /// @brief Method .ctor, addr 0x1c9a864, size 0x58, virtual false, abstract: false, final false
