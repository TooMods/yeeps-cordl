...
public:
  // Declarations
  /// @brief Method CalculateOptimizedControlDataType, addr 0x2265650, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadUnprocessedValueFromState, addr 0x22655ec, size 0x2c, virtual true, abstract: false, final false
  inline int32_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x2265618, size 0x38, virtual true, abstract: false, final false
  inline void WriteValueIntoState(int32_t value, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method .ctor, addr 0x2265564, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
