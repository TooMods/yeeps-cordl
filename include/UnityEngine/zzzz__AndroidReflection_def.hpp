...
public:
  ...
  /// @brief Method GetConstructorMember, addr 0x2f4d9d4, size 0x18c, virtual false, abstract: false, final false
  static inline void* GetConstructorMember(void* jclass, ::StringW signature);

  /// @brief Method GetFieldClass, addr 0x2f4df60, size 0x64, virtual false, abstract: false, final false
  static inline void* GetFieldClass(void* field);

  /// @brief Method GetFieldMember, addr 0x2f4dd60, size 0x200, virtual false, abstract: false, final false
  static inline void* GetFieldMember(void* jclass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method GetFieldSignature, addr 0x2f4dfc4, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW GetFieldSignature(void* field);

  /// @brief Method GetMethodID, addr 0x2f4d938, size 0x9c, virtual false, abstract: false, final false
  static inline void* GetMethodID(::StringW clazz, ::StringW methodName, ::StringW signature);

  /// @brief Method GetMethodMember, addr 0x2f4db60, size 0x200, virtual false, abstract: false, final false
  static inline void* GetMethodMember(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetStaticMethodID, addr 0x2f4d89c, size 0x9c, virtual false, abstract: false, final false
  static inline void* GetStaticMethodID(::StringW clazz, ::StringW methodName, ::StringW signature);

  /// @brief Method IsAssignableFrom, addr 0x2f4d87c, size 0x20, virtual false, abstract: false, final false
  static inline bool IsAssignableFrom(::System::Type* t, ::System::Type* from);

  /// @brief Method IsPrimitive, addr 0x2f4d868, size 0x14, virtual false, abstract: false, final false
  static inline bool IsPrimitive(::System::Type* t);

  /// @brief Method NewProxyInstance, addr 0x2f4e06c, size 0xe4, virtual false, abstract: false, final false
  static inline void* NewProxyInstance(void* player, void* delegateHandle, void* interfaze);

  /// @brief Method SetNativeExceptionOnProxy, addr 0x2f4b380, size 0x10c, virtual false, abstract: false, final false
