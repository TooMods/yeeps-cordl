...
public:
  // Declarations
  /// @brief Method IsError, addr 0x14db018, size 0x8, virtual false, abstract: false, final false
  static inline bool IsError(::GlobalNamespace::__OVRSpatialAnchor__OperationResult res);

  /// @brief Method IsSuccess, addr 0x14db00c, size 0xc, virtual false, abstract: false, final false
  static inline bool IsSuccess(::GlobalNamespace::__OVRSpatialAnchor__OperationResult res);

  /// @brief Method IsWarning, addr 0x14db020, size 0xc, virtual false, abstract: false, final false
