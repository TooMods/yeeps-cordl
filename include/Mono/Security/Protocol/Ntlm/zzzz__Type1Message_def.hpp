...
public:
  ...
  /// @brief Method Decode, addr 0x246d350, size 0xf0, virtual true, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> message);

  /// @brief Method GetBytes, addr 0x246d440, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246d1cc, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Domain, addr 0x246d250, size 0x80, virtual false, abstract: false, final false
  inline void set_Domain(::StringW value);

  /// @brief Method set_Host, addr 0x246d2d0, size 0x80, virtual false, abstract: false, final false
