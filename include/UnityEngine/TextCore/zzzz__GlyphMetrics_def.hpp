...
public:
  ...
  /// @brief Method Equals, addr 0x2902b48, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2902bc8, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::GlyphMetrics other);

  /// @brief Method GetHashCode, addr 0x2902adc, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x2902acc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t width, float_t height, float_t bearingX, float_t bearingY, float_t advance);

  /// @brief Method get_height, addr 0x2902aac, size 0x8, virtual false, abstract: false, final false
  inline float_t get_height();

  /// @brief Method get_horizontalAdvance, addr 0x2902ac4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalAdvance();

  /// @brief Method get_horizontalBearingX, addr 0x2902ab4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalBearingX();

  /// @brief Method get_horizontalBearingY, addr 0x2902abc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalBearingY();

  /// @brief Method get_width, addr 0x2902aa4, size 0x8, virtual false, abstract: false, final false
