...
public:
  ...
  /// @brief Method Accept, addr 0x1839f60, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetMember, addr 0x1839f38, size 0x28, virtual true, abstract: false, final false
  inline ::System::Reflection::MemberInfo* GetMember();

  /// @brief Method Make, addr 0x1839e9c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Make, addr 0x1839e08, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x1837fbc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1839d9c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression);

  /// @brief Method get_Expression, addr 0x1839d94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Expression();

  /// @brief Method get_Member, addr 0x1835e78, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_Member();

  /// @brief Method get_NodeType, addr 0x1839f30, size 0x8, virtual true, abstract: false, final true
