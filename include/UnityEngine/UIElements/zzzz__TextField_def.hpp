...
public:
  ...
  /// @brief Method Init, addr 0x2cd70d0, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd71e4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnViewDataReady, addr 0x2cd6f04, size 0xb4, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method SetValueWithoutNotify, addr 0x2cd6e60, size 0xa4, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::StringW newValue);

  /// @brief Method .ctor, addr 0x2cd6b24, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2cd6b3c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW label);

  /// @brief Method .ctor, addr 0x2cd6b50, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_textInput, addr 0x2cd69b4, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__TextField__TextInput* get_textInput();

  /// @brief Method get_value, addr 0x2cd6d74, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_multiline, addr 0x2cd6a38, size 0x20, virtual false, abstract: false, final false
  inline void set_multiline(bool value);

  /// @brief Method set_value, addr 0x2cd6dbc, size 0xa4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cd7088, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ExecuteDefaultAction, addr 0x2cd7bd0, size 0x18c, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x2cd74a0, size 0x730, virtual true, abstract: false, final false
  ...
  /// @brief Method SetTextAlign, addr 0x2cd730c, size 0xa0, virtual false, abstract: false, final false
  inline void SetTextAlign();

  /// @brief Method StringToValue, addr 0x2cd7408, size 0x8, virtual true, abstract: false, final false
  inline ::StringW StringToValue(::StringW str);

  /// @brief Method SyncTextEngine, addr 0x2cd7410, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd6d2c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_multiline, addr 0x2cd7304, size 0x8, virtual false, abstract: false, final false
  inline bool get_multiline();

  /// @brief Method get_parentTextField, addr 0x2cd7284, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextField* get_parentTextField();

  /// @brief Method set_isPasswordField, addr 0x2cd73ac, size 0x5c, virtual true, abstract: false, final false
  inline void set_isPasswordField(bool value);

  /// @brief Method set_multiline, addr 0x2cd6a58, size 0xcc, virtual false, abstract: false, final false
  inline void set_multiline(bool value);
