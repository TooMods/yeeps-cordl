...
public:
  ...
  /// @brief Method RefreshStyle, addr 0x23b5458, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hashCode, addr 0x23b5440, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method get_styleClosingTagArray, addr 0x23b5450, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_styleClosingTagArray();

  /// @brief Method get_styleOpeningTagArray, addr 0x23b5448, size 0x8, virtual false, abstract: false, final false
