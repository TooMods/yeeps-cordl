...
public:
  ...
  /// @brief Method .ctor, addr 0x2b09ecc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b09f28, size 0x8, virtual false, abstract: false, final false
