...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5030, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyUpdateNotification* GetDataFromMessage(void* c_message);

  /// @brief Method GetPartyUpdateNotification, addr 0x19b4ff4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b122c, size 0x58, virtual false, abstract: false, final false
