...
public:
  ...
  /// @brief Method ToString, addr 0x1b28b84, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x1b28b8c, size 0x3fc, virtual false, abstract: false, final false
  inline ::StringW ToString(::System::Xml::Schema::__XsdDuration__DurationType durationType);

  /// @brief Method ToTimeSpan, addr 0x1b28648, size 0x8, virtual false, abstract: false, final false
  inline ::System::TimeSpan ToTimeSpan();

  /// @brief Method ToTimeSpan, addr 0x1b28650, size 0x48, virtual false, abstract: false, final false
  inline ::System::TimeSpan ToTimeSpan(::System::Xml::Schema::__XsdDuration__DurationType durationType);

  /// @brief Method TryParse, addr 0x1b27f14, size 0x6ec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x1b28f88, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Exception* TryParse(::StringW s, ByRef<::System::Xml::Schema::XsdDuration> result);

  /// @brief Method TryParseDigits, addr 0x1b28f94, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToTimeSpan, addr 0x1b28698, size 0x4e0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToTimeSpan, addr 0x1b28b78, size 0xc, virtual false, abstract: false, final false
  inline ::System::Exception* TryToTimeSpan(ByRef<::System::TimeSpan> result);

  /// @brief Method .ctor, addr 0x1b27ab0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b27e80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW s);

  /// @brief Method .ctor, addr 0x1b27e88, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW s, ::System::Xml::Schema::__XsdDuration__DurationType durationType);

  /// @brief Method .ctor, addr 0x1b27c28, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::TimeSpan timeSpan);

  /// @brief Method .ctor, addr 0x1b27d00, size 0x180, virtual false, abstract: false, final false
  inline void _ctor(::System::TimeSpan timeSpan, ::System::Xml::Schema::__XsdDuration__DurationType durationType);

  /// @brief Method get_Days, addr 0x1b28628, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Days();

  /// @brief Method get_Hours, addr 0x1b28630, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Hours();

  /// @brief Method get_IsNegative, addr 0x1b2860c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsNegative();

  /// @brief Method get_Minutes, addr 0x1b28638, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Minutes();

  /// @brief Method get_Months, addr 0x1b28620, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Months();

  /// @brief Method get_Nanoseconds, addr 0x1b28600, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_Nanoseconds();

  /// @brief Method get_Seconds, addr 0x1b28640, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Seconds();

  /// @brief Method get_Years, addr 0x1b28618, size 0x8, virtual false, abstract: false, final false
