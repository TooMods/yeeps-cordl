...
public:
  ...
  /// @brief Method CreatePrimitiveArray, addr 0x1ab53d4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method FromString, addr 0x1ab5d54, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method InitArrayTypeA, addr 0x1ab4c64, size 0x3b8, virtual false, abstract: false, final false
  static inline void InitArrayTypeA();

  /// @brief Method InitCodeA, addr 0x1ab5bac, size 0x1a8, virtual false, abstract: false, final false
  static inline void InitCodeA();

  /// @brief Method InitTypeA, addr 0x1ab501c, size 0x3b8, virtual false, abstract: false, final false
  static inline void InitTypeA();

  /// @brief Method InitTypeCodeA, addr 0x1ab5960, size 0x194, virtual false, abstract: false, final false
  static inline void InitTypeCodeA();

  /// @brief Method InitValueA, addr 0x1ab54f4, size 0x46c, virtual false, abstract: false, final false
  static inline void InitValueA();

  /// @brief Method IsPrimitiveArray, addr 0x1ab07d4, size 0x290, virtual false, abstract: false, final false
  static inline bool IsPrimitiveArray(::System::Type* type, ByRef<::System::Object*> typeInformation);

  /// @brief Method IsWriteAsByteArray, addr 0x1ab4c1c, size 0x24, virtual false, abstract: false, final false
  static inline bool IsWriteAsByteArray(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method ToArrayType, addr 0x1ab1674, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Type* ToArrayType(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method ToCode, addr 0x1ab0c84, size 0x124, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE ToCode(::System::Type* type);

  /// @brief Method ToComType, addr 0x1ab1504, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW ToComType(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method ToPrimitiveTypeEnum, addr 0x1ab4b64, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToType, addr 0x1ab15bc, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Type* ToType(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method ToTypeCode, addr 0x1ab5af4, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::TypeCode ToTypeCode(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method TypeLength, addr 0x1ab4c40, size 0x24, virtual false, abstract: false, final false
