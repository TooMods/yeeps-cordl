...
public:
  // Declarations
  /// @brief Method AppendHex, addr 0x1235f58, size 0x68, virtual false, abstract: false, final false
  static inline void AppendHex(uint16_t value, ::System::Text::StringBuilder* buffer);

  /// @brief Method AppendSections, addr 0x1235d64, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractIPv4Address, addr 0x1235f1c, size 0x3c, virtual false, abstract: false, final false
  static inline uint32_t ExtractIPv4Address(::ArrayW<uint16_t, ::Array<uint16_t>*> address);

  /// @brief Method FormatIPv4AddressNumber, addr 0x1235b8c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method IPv4AddressToString, addr 0x1234c48, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW IPv4AddressToString(uint32_t address);

  /// @brief Method IPv4AddressToString, addr 0x1235b1c, size 0x70, virtual false, abstract: false, final false
  static inline void IPv4AddressToString(uint32_t address, ::System::Text::StringBuilder* destination);

  /// @brief Method IPv4AddressToStringHelper, addr 0x1235a80, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t IPv4AddressToStringHelper(uint32_t address, ::cordl_internals::Ptr<char16_t> addressString);

  /// @brief Method IPv6AddressToString, addr 0x1234c34, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW IPv6AddressToString(::ArrayW<uint16_t, ::Array<uint16_t>*> address, uint32_t scopeId);

  /// @brief Method IPv6AddressToStringHelper, addr 0x1235c44, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Ipv4StringToAddress, addr 0x12359ac, size 0xd4, virtual false, abstract: false, final false
  static inline bool Ipv4StringToAddress(::System::ReadOnlySpan_1<char16_t> ipSpan, ByRef<int64_t> address);

  /// @brief Method Ipv6StringToAddress, addr 0x1235848, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x1234550, size 0x1fc, virtual false, abstract: false, final false
  static inline ::System::Net::IPAddress* Parse(::System::ReadOnlySpan_1<char16_t> ipSpan, bool tryParse);

  /// @brief Method Reverse, addr 0x1235fc0, size 0xc, virtual false, abstract: false, final false
