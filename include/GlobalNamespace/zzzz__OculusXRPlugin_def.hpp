...
public:
  // Declarations
  /// @brief Method SetAppSpacePosition, addr 0x14e8fc8, size 0x90, virtual false, abstract: false, final false
  static inline void SetAppSpacePosition(float_t x, float_t y, float_t z);

  /// @brief Method SetAppSpaceRotation, addr 0x14e9058, size 0x98, virtual false, abstract: false, final false
  static inline void SetAppSpaceRotation(float_t x, float_t y, float_t z, float_t w);

  /// @brief Method SetColorOffset, addr 0x14e8eb8, size 0x94, virtual false, abstract: false, final false
  static inline void SetColorOffset(float_t x, float_t y, float_t z, float_t w);

  /// @brief Method SetColorScale, addr 0x14e8e20, size 0x98, virtual false, abstract: false, final false
  static inline void SetColorScale(float_t x, float_t y, float_t z, float_t w);

  /// @brief Method SetDepthSubmission, addr 0x14e90f0, size 0x7c, virtual false, abstract: false, final false
  static inline void SetDepthSubmission(bool enable);

  /// @brief Method SetSpaceWarp, addr 0x14e8f4c, size 0x7c, virtual false, abstract: false, final false
