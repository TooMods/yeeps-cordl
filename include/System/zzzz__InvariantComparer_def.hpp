...
public:
  ...
  /// @brief Method Compare, addr 0x1710344, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x17102c8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
