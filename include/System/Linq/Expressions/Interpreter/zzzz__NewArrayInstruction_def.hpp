...
public:
  ...
  /// @brief Method Run, addr 0x18410d0, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1841058, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType);

  /// @brief Method get_ConsumedStack, addr 0x1841080, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x1841090, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1841088, size 0x8, virtual true, abstract: false, final false
