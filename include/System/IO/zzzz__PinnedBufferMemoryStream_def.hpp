...
public:
  ...
  /// @brief Method Dispose, addr 0x2578f74, size 0x50, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x2578ed0, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::System::IO::PinnedBufferMemoryStream* New_ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> array);

  /// @brief Method Read, addr 0x25789a0, size 0x4, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> buffer);

  /// @brief Method Write, addr 0x2578bd0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2578680, size 0xb4, virtual false, abstract: false, final false
