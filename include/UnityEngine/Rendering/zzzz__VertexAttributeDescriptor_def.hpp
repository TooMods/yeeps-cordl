...
public:
  ...
  /// @brief Method Equals, addr 0x2a8ff70, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x2a90018, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::VertexAttributeDescriptor other);

  /// @brief Method GetHashCode, addr 0x2a8ff48, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x2a8fd74, size 0x1d4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2a8fd68, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_attribute, addr 0x2a8fd28, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::VertexAttribute get_attribute();

  /// @brief Method get_dimension, addr 0x2a8fd48, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_dimension();

  /// @brief Method get_format, addr 0x2a8fd38, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::VertexAttributeFormat get_format();

  /// @brief Method get_stream, addr 0x2a8fd58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_attribute, addr 0x2a8fd30, size 0x8, virtual false, abstract: false, final false
  inline void set_attribute(::UnityEngine::Rendering::VertexAttribute value);

  /// @brief Method set_dimension, addr 0x2a8fd50, size 0x8, virtual false, abstract: false, final false
  inline void set_dimension(int32_t value);

  /// @brief Method set_format, addr 0x2a8fd40, size 0x8, virtual false, abstract: false, final false
  inline void set_format(::UnityEngine::Rendering::VertexAttributeFormat value);

  /// @brief Method set_stream, addr 0x2a8fd60, size 0x8, virtual false, abstract: false, final false
