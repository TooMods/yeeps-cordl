...
public:
  ...
  /// @brief Method .ctor, addr 0x2a8aba8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW userMessage);

  /// @brief Method get_Message, addr 0x2a8b2bc, size 0x74, virtual true, abstract: false, final false
