...
public:
  ...
  /// @brief Method Create, addr 0x1e04308, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x1e042fc, size 0xc, virtual true, abstract: false, final true
