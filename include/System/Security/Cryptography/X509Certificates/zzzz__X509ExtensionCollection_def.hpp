...
public:
  ...
  /// @brief Method Add, addr 0x122e434, size 0x74, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::X509Certificates::X509Extension* extension);

  /// @brief Method GetEnumerator, addr 0x122e5ac, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x122e4a8, size 0x104, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x122e654, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x122dfd0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_Empty();

  /// @brief Method get_Count, addr 0x122e03c, size 0x24, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x122e060, size 0x24, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x122e088, size 0x3ac, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Extension* get_Item(::StringW oid);

  /// @brief Method get_SyncRoot, addr 0x122e084, size 0x4, virtual true, abstract: false, final true
