...
public:
  // Declarations
  /// @brief Method AddFingers, addr 0x1dfd824, size 0x118, virtual false, abstract: false, final false
  inline void AddFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method Destroy, addr 0x1dfafe0, size 0x84, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method RemoveFingers, addr 0x1dfd93c, size 0x144, virtual false, abstract: false, final false
  inline void RemoveFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method UpdateActiveFingers, addr 0x1dfcdc0, size 0xf4, virtual false, abstract: false, final false
  inline void UpdateActiveFingers();

  /// @brief Method UpdateActiveTouches, addr 0x1dfc6d0, size 0x5c0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SaveAndResetState>b__78_0, addr 0x1dfde10, size 0x84, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__78_0(ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState> state);

  /// @brief Method <SaveAndResetState>b__78_1, addr 0x1dfde94, size 0x4, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__78_1();

  /// @brief Method .ctor, addr 0x1dfde08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddTouchscreen, addr 0x1dfb170, size 0x8c, virtual false, abstract: false, final false
  static inline void AddTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method BeginUpdate, addr 0x1dfda80, size 0x74, virtual false, abstract: false, final false
  static inline void BeginUpdate();

  /// @brief Method CreateGlobalState, addr 0x1dfdaf4, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState CreateGlobalState();

  /// @brief Method Equals, addr 0x1dfd720, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1dfd6ac, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::EnhancedTouch::Touch other);

  /// @brief Method GetHashCode, addr 0x1dfd7b0, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method RemoveTouchscreen, addr 0x1dfb1fc, size 0xe4, virtual false, abstract: false, final false
  static inline void RemoveTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method SaveAndResetState, addr 0x1dfdb20, size 0x218, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ISavedState* SaveAndResetState();

  /// @brief Method ToString, addr 0x1dfd3f0, size 0x2bc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1dfb62c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onFingerDown, addr 0x1dfcf40, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerMove, addr 0x1dfd260, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerUp, addr 0x1dfd0d0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeFingers, addr 0x1dfcd20, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeTouches, addr 0x1dfc630, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_began, addr 0x1dfc388, size 0x1c, virtual false, abstract: false, final false
  inline bool get_began();

  /// @brief Method get_delta, addr 0x1dfc4e4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_delta();

  /// @brief Method get_ended, addr 0x1dfc3f4, size 0x3c, virtual false, abstract: false, final false
  inline bool get_ended();

  /// @brief Method get_extraData, addr 0x1dfc530, size 0x48, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__ExtraDataPerTouchState> get_extraData();

  /// @brief Method get_finger, addr 0x1dfc338, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* get_finger();

  /// @brief Method get_fingers, addr 0x1dfcc90, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*> get_fingers();

  /// @brief Method get_history, addr 0x1dfc578, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::TouchHistory get_history();

  /// @brief Method get_inProgress, addr 0x1dfc3a4, size 0x50, virtual false, abstract: false, final false
  inline bool get_inProgress();

  /// @brief Method get_isInProgress, addr 0x1dfb638, size 0x34, virtual false, abstract: false, final false
  inline bool get_isInProgress();

  /// @brief Method get_isTap, addr 0x1dfc50c, size 0x18, virtual false, abstract: false, final false
  inline bool get_isTap();

  /// @brief Method get_maxHistoryLengthPerFinger, addr 0x1dfba08, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_maxHistoryLengthPerFinger();

  /// @brief Method get_phase, addr 0x1dfc324, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::TouchPhase get_phase();

  /// @brief Method get_pressure, addr 0x1dfc430, size 0x14, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x1dfc444, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_screen, addr 0x1dfc4b4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition, addr 0x1dfb618, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_screens, addr 0x1dfceb4, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Touchscreen*>* get_screens();

  /// @brief Method get_startScreenPosition, addr 0x1dfc4d0, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_startScreenPosition();

  /// @brief Method get_startTime, addr 0x1dfc458, size 0x14, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_state, addr 0x1dfc340, size 0x48, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::InputSystem::LowLevel::TouchState> get_state();

  /// @brief Method get_tapCount, addr 0x1dfc4f8, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_tapCount();

  /// @brief Method get_time, addr 0x1dfc46c, size 0x48, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_touchId, addr 0x1dfc310, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_touchId();

  /// @brief Method get_uniqueId, addr 0x1dfc2fc, size 0x14, virtual false, abstract: false, final false
  inline uint32_t get_uniqueId();

  /// @brief Method get_updateStepCount, addr 0x1dfb66c, size 0x14, virtual false, abstract: false, final false
  inline uint32_t get_updateStepCount();

  /// @brief Method get_valid, addr 0x1dfb518, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onFingerDown, addr 0x1dfd008, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerMove, addr 0x1dfd328, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerUp, addr 0x1dfd198, size 0xc8, virtual false, abstract: false, final false
