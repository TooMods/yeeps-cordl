...
public:
  ...
  /// @brief Method CBC, addr 0x28a0a10, size 0x164, virtual true, abstract: false, final false
  inline void CBC(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method CFB, addr 0x28a0b74, size 0x1c8, virtual true, abstract: false, final false
  inline void CFB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method CTS, addr 0x28a0d8c, size 0x50, virtual true, abstract: false, final false
  inline void CTS(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method CheckInput, addr 0x28a0ddc, size 0x154, virtual false, abstract: false, final false
  inline void CheckInput(::ArrayW<uint8_t, ::Array<uint8_t>*> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method Dispose, addr 0x28a0838, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method FinalDecrypt, addr 0x28a1820, size 0x2ac, virtual true, abstract: false, final false
  ...
  /// @brief Method FinalEncrypt, addr 0x28a1580, size 0x2a0, virtual true, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x28a072c, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method InternalTransformBlock, addr 0x28a116c, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method OFB, addr 0x28a0d3c, size 0x50, virtual true, abstract: false, final false
  inline void OFB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Random, addr 0x28a1328, size 0xb0, virtual false, abstract: false, final false
  inline void Random(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t start, int32_t length);

  /// @brief Method System.IDisposable.Dispose, addr 0x28a07cc, size 0x6c, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method ThrowBadPaddingException, addr 0x28a13d8, size 0x1a8, virtual false, abstract: false, final false
  inline void ThrowBadPaddingException(::System::Security::Cryptography::PaddingMode padding, int32_t length, int32_t position);

  /// @brief Method Transform, addr 0x28a08ac, size 0x164, virtual true, abstract: false, final false
  inline void Transform(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method TransformBlock, addr 0x28a0f30, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method TransformFinalBlock, addr 0x28a1acc, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a0468, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanReuseTransform, addr 0x28a0894, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanReuseTransform();

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x28a088c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x28a089c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_InputBlockSize();

  /// @brief Method get_KeepLastBlock, addr 0x28a1148, size 0x24, virtual false, abstract: false, final false
  inline bool get_KeepLastBlock();

  /// @brief Method get_OutputBlockSize, addr 0x28a08a4, size 0x8, virtual true, abstract: false, final false
