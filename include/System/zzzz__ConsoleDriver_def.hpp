...
public:
  ...
  /// @brief Method CreateNullConsoleDriver, addr 0x2e7eea8, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::IConsoleDriver* CreateNullConsoleDriver();

  /// @brief Method CreateTermInfoDriver, addr 0x2e7ef50, size 0x60, virtual false, abstract: false, final false
  static inline ::System::IConsoleDriver* CreateTermInfoDriver(::StringW term);

  /// @brief Method CreateWindowsConsoleDriver, addr 0x2e7eef4, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::IConsoleDriver* CreateWindowsConsoleDriver();

  /// @brief Method InternalKeyAvailable, addr 0x2e7f300, size 0x4, virtual false, abstract: false, final false
  static inline int32_t InternalKeyAvailable(int32_t ms_timeout);

  /// @brief Method Isatty, addr 0x2e7f2fc, size 0x4, virtual false, abstract: false, final false
  static inline bool Isatty(void* handle);

  /// @brief Method ReadKey, addr 0x2e7e86c, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::ConsoleKeyInfo ReadKey(bool intercept);

  /// @brief Method SetEcho, addr 0x2e7f308, size 0x8, virtual false, abstract: false, final false
  static inline bool SetEcho(bool wantEcho);

  /// @brief Method TtySetup, addr 0x2e7f304, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsConsole, addr 0x2e7de68, size 0x138, virtual false, abstract: false, final false
