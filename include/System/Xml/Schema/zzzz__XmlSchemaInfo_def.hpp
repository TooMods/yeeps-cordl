...
public:
  ...
  /// @brief Method Clear, addr 0x1ce7720, size 0x1c, virtual false, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method .ctor, addr 0x1ce76f0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ce773c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaValidity validity);

  /// @brief Method get_ContentType, addr 0x1ce7814, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_HasDefaultValue, addr 0x1ce7838, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasDefaultValue();

  /// @brief Method get_IsDefault, addr 0x1ce7788, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsDefault();

  /// @brief Method get_IsNil, addr 0x1ce779c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsNil();

  /// @brief Method get_IsUnionType, addr 0x1ce786c, size 0x38, virtual false, abstract: false, final false
  inline bool get_IsUnionType();

  /// @brief Method get_MemberType, addr 0x1ce77b0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType();

  /// @brief Method get_SchemaAttribute, addr 0x1ce77fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute();

  /// @brief Method get_SchemaElement, addr 0x1ce77e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement();

  /// @brief Method get_SchemaType, addr 0x1ce77c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType();

  /// @brief Method get_Validity, addr 0x1ce7778, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaValidity get_Validity();

  /// @brief Method get_XmlType, addr 0x1ce781c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDefault, addr 0x1ce7790, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDefault(bool value);

  /// @brief Method set_IsNil, addr 0x1ce77a4, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNil(bool value);

  /// @brief Method set_MemberType, addr 0x1ce77b8, size 0x8, virtual false, abstract: false, final false
  inline void set_MemberType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_SchemaAttribute, addr 0x1ce7804, size 0x10, virtual false, abstract: false, final false
  inline void set_SchemaAttribute(::System::Xml::Schema::XmlSchemaAttribute* value);

  /// @brief Method set_SchemaElement, addr 0x1ce77ec, size 0x10, virtual false, abstract: false, final false
  inline void set_SchemaElement(::System::Xml::Schema::XmlSchemaElement* value);

  /// @brief Method set_SchemaType, addr 0x1ce77c8, size 0x1c, virtual false, abstract: false, final false
  inline void set_SchemaType(::System::Xml::Schema::XmlSchemaType* value);

  /// @brief Method set_Validity, addr 0x1ce7780, size 0x8, virtual false, abstract: false, final false
