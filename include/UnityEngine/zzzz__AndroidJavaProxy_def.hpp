...
public:
  ...
  /// @brief Method Finalize, addr 0x2f4a124, size 0x98, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetProxyObject, addr 0x2f4c1c0, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::AndroidJavaObject* GetProxyObject();

  /// @brief Method GetRawProxy, addr 0x2f4b23c, size 0x144, virtual false, abstract: false, final false
  inline void* GetRawProxy();

  /// @brief Method Invoke, addr 0x2f4a1bc, size 0x728, virtual true, abstract: false, final false
  inline ::UnityEngine::AndroidJavaObject* Invoke(::StringW methodName, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method Invoke, addr 0x2f4b48c, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f49fec, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW javaInterface);

  /// @brief Method .ctor, addr 0x2f4a0b8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaClass* javaInterface);

  /// @brief Method equals, addr 0x2f4bf54, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method hashCode, addr 0x2f4c0ac, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method toString, addr 0x2f4c15c, size 0x64, virtual true, abstract: false, final false
