...
public:
  ...
  /// @brief Method CommonInit, addr 0x260e274, size 0x60, virtual false, abstract: false, final false
  inline void CommonInit();

  /// @brief Method Dispose, addr 0x260e390, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x260e2dc, size 0xb4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetCaseInsensitiveObjectInternal, addr 0x260e86c, size 0x2d0, virtual false, abstract: false, final false
  inline ::System::Object* GetCaseInsensitiveObjectInternal(::StringW name);

  /// @brief Method GetEnumerator, addr 0x260e3a0, size 0x4, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorHelper, addr 0x260e3a4, size 0x84, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper();

  /// @brief Method GetObject, addr 0x260eb3c, size 0x4, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW name);

  /// @brief Method GetObject, addr 0x260eb40, size 0x40, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW name, bool ignoreCase);

  /// @brief Method GetObjectInternal, addr 0x260e594, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Object* GetObjectInternal(::StringW name);

  /// @brief Method GetString, addr 0x260e42c, size 0x168, virtual true, abstract: false, final false
  inline ::StringW GetString(::StringW name);

  /// @brief Method GetString, addr 0x260e668, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x260e428, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x260e258, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x260e2d4, size 0x8, virtual false, abstract: false, final false
