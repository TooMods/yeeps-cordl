...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce3adc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Content, addr 0x1ce3ac4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContent* get_Content();

  /// @brief Method get_HasMixedAttribute, addr 0x1ce3ad4, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasMixedAttribute();

  /// @brief Method get_IsMixed, addr 0x1ce3aa8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method set_Content, addr 0x1ce3acc, size 0x8, virtual true, abstract: false, final false
  inline void set_Content(::System::Xml::Schema::XmlSchemaContent* value);

  /// @brief Method set_IsMixed, addr 0x1ce3ab0, size 0x14, virtual false, abstract: false, final false
