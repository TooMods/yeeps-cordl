...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3678, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetDataFromMessage(void* c_message);

  /// @brief Method GetGroupPresenceJoinIntent, addr 0x19b363c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0cac, size 0x58, virtual false, abstract: false, final false
