...
public:
  ...
  /// @brief Method CanConvert, addr 0x11b07b8, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadJson, addr 0x11b0328, size 0x490, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x11b0138, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11afe54, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11afe64, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(bool camelCaseText);

  /// @brief Method .ctor, addr 0x11afee0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Serialization::NamingStrategy* namingStrategy, bool allowIntegerValues);

  /// @brief Method .ctor, addr 0x11aff1c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* namingStrategyType);

  /// @brief Method .ctor, addr 0x11affc4, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* namingStrategyType, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> namingStrategyParameters);

  /// @brief Method .ctor, addr 0x11b0078, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllowIntegerValues, addr 0x11afe40, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowIntegerValues();

  /// @brief Method get_CamelCaseText, addr 0x11afcfc, size 0x7c, virtual false, abstract: false, final false
  inline bool get_CamelCaseText();

  /// @brief Method get_NamingStrategy, addr 0x11afe30, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::NamingStrategy* get_NamingStrategy();

  /// @brief Method set_AllowIntegerValues, addr 0x11afe48, size 0xc, virtual false, abstract: false, final false
  inline void set_AllowIntegerValues(bool value);

  /// @brief Method set_CamelCaseText, addr 0x11afd78, size 0xb8, virtual false, abstract: false, final false
  inline void set_CamelCaseText(bool value);

  /// @brief Method set_NamingStrategy, addr 0x11afe38, size 0x8, virtual false, abstract: false, final false
