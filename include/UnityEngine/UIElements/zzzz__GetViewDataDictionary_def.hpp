...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2a478d0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a47814, size 0xbc, virtual false, abstract: false, final false
