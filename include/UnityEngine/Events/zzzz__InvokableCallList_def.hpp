...
public:
  ...
  /// @brief Method AddListener, addr 0x29e34a0, size 0xac, virtual false, abstract: false, final false
  inline void AddListener(::UnityEngine::Events::BaseInvokableCall* call);

  /// @brief Method AddPersistentInvokableCall, addr 0x29e33f4, size 0xac, virtual false, abstract: false, final false
  inline void AddPersistentInvokableCall(::UnityEngine::Events::BaseInvokableCall* call);

  /// @brief Method ClearPersistent, addr 0x29e37c0, size 0xb8, virtual false, abstract: false, final false
  inline void ClearPersistent();

  static inline ::UnityEngine::Events::InvokableCallList* New_ctor();

  /// @brief Method PrepareInvoke, addr 0x29e3878, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke();

  /// @brief Method RemoveListener, addr 0x29e354c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29e392c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
