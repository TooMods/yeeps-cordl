...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2471e1c, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x24718d0, size 0x4f4, virtual false, abstract: false, final false
