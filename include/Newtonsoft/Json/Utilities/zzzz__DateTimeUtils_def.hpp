...
public:
  ...
  /// @brief Method ConvertDateTimeToJavaScriptTicks, addr 0x152d9b0, size 0x58, virtual false, abstract: false, final false
  static inline int64_t ConvertDateTimeToJavaScriptTicks(::System::DateTime dateTime);

  /// @brief Method ConvertDateTimeToJavaScriptTicks, addr 0x152da08, size 0x98, virtual false, abstract: false, final false
  static inline int64_t ConvertDateTimeToJavaScriptTicks(::System::DateTime dateTime, bool convertToUtc);

  /// @brief Method ConvertDateTimeToJavaScriptTicks, addr 0x152d8cc, size 0x68, virtual false, abstract: false, final false
  static inline int64_t ConvertDateTimeToJavaScriptTicks(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method ConvertJavaScriptTicksToDateTime, addr 0x152daa0, size 0x88, virtual false, abstract: false, final false
  static inline ::System::DateTime ConvertJavaScriptTicksToDateTime(int64_t javaScriptTicks);

  /// @brief Method CopyIntToCharArray, addr 0x152fc10, size 0x68, virtual false, abstract: false, final false
  static inline void CopyIntToCharArray(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t start, int32_t value, int32_t digits);

  /// @brief Method CreateDateTime, addr 0x152de94, size 0x80, virtual false, abstract: false, final false
  static inline ::System::DateTime CreateDateTime(::Newtonsoft::Json::Utilities::DateTimeParser dateTimeParser);

  /// @brief Method EnsureDateTime, addr 0x152d520, size 0x128, virtual false, abstract: false, final false
  static inline ::System::DateTime EnsureDateTime(::System::DateTime value, ::Newtonsoft::Json::DateTimeZoneHandling timeZone);

  /// @brief Method GetDateValues, addr 0x152fa18, size 0x1f8, virtual false, abstract: false, final false
  static inline void GetDateValues(::System::DateTime td, ByRef<int32_t> year, ByRef<int32_t> month, ByRef<int32_t> day);

  /// @brief Method GetUtcOffset, addr 0x152d334, size 0x68, virtual false, abstract: false, final false
  static inline ::System::TimeSpan GetUtcOffset(::System::DateTime d);

  /// @brief Method SwitchToLocalTime, addr 0x152d648, size 0x78, virtual false, abstract: false, final false
  static inline ::System::DateTime SwitchToLocalTime(::System::DateTime value);

  /// @brief Method SwitchToUtcTime, addr 0x152d6c0, size 0x78, virtual false, abstract: false, final false
  static inline ::System::DateTime SwitchToUtcTime(::System::DateTime value);

  /// @brief Method ToSerializationMode, addr 0x152d39c, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlDateTimeSerializationMode ToSerializationMode(::System::DateTimeKind kind);

  /// @brief Method ToUniversalTicks, addr 0x152d738, size 0x8c, virtual false, abstract: false, final false
  static inline int64_t ToUniversalTicks(::System::DateTime dateTime);

  /// @brief Method ToUniversalTicks, addr 0x152d7c4, size 0x108, virtual false, abstract: false, final false
  static inline int64_t ToUniversalTicks(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method TryParseDateTime, addr 0x152e0e0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTime, addr 0x152e548, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeExact, addr 0x152e460, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeIso, addr 0x152db28, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeMicrosoft, addr 0x152e300, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffset, addr 0x152e810, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffset, addr 0x152ec0c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffsetExact, addr 0x152eb5c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffsetIso, addr 0x152df14, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffsetMicrosoft, addr 0x152ea20, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseMicrosoftDate, addr 0x152eee0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryReadOffset, addr 0x152f05c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method UniversalTicksToJavaScriptTicks, addr 0x152d934, size 0x7c, virtual false, abstract: false, final false
  static inline int64_t UniversalTicksToJavaScriptTicks(int64_t universalTicks);

  /// @brief Method WriteDateTimeOffset, addr 0x152f608, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDateTimeOffsetString, addr 0x152fc78, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDateTimeString, addr 0x152f304, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDateTimeString, addr 0x152f1cc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDefaultIsoDate, addr 0x152f780, size 0x298, virtual false, abstract: false, final false
