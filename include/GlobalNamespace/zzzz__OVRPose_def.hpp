...
public:
  // Declarations
  /// @brief Method Equals, addr 0x25bb68c, size 0xf8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x25bb808, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Inverse, addr 0x25b1de8, size 0x84, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose Inverse();

  /// @brief Method Rotate180AlongX, addr 0x25bb97c, size 0xe0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose Rotate180AlongX();

  /// @brief Method ToPosef, addr 0x25b1e6c, size 0x28, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Posef ToPosef();

  /// @brief Method ToPosef_Legacy, addr 0x25bb960, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Posef ToPosef_Legacy();

  /// @brief Method flipZ, addr 0x25bb934, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose flipZ();

  /// @brief Method get_identity, addr 0x25b3b94, size 0x98, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRPose get_identity();

  /// @brief Method op_Equality, addr 0x25bb784, size 0x84, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRPose x, ::GlobalNamespace::OVRPose y);

  /// @brief Method op_Inequality, addr 0x25bb8b0, size 0x84, virtual false, abstract: false, final false
  static inline bool op_Inequality(::GlobalNamespace::OVRPose x, ::GlobalNamespace::OVRPose y);

  /// @brief Method op_Multiply, addr 0x25ae4ac, size 0xe4, virtual false, abstract: false, final false
