...
public:
  // Declarations
  /// @brief Method GetMessage, addr 0x28a7628, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetMessage(int32_t hr);

  /// @brief Method MakeHRFromErrorCode, addr 0x28a7684, size 0xc, virtual false, abstract: false, final false
