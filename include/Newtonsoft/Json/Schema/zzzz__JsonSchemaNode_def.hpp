...
public:
  ...
  /// @brief Method <GetId>b__26_0, addr 0x109f040, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _GetId_b__26_0(::Newtonsoft::Json::Schema::JsonSchema* s);

  /// @brief Method <GetId>b__26_1, addr 0x109f058, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _GetId_b__26_1(::StringW id);

  /// @brief Method .ctor, addr 0x109f038, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Combine, addr 0x109e678, size 0x70, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaNode* Combine(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method GetId, addr 0x109e2a0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x109e4dc, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method .ctor, addr 0x109edbc, size 0x218, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaNode* source, ::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method get_AdditionalItems, addr 0x109edac, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaNode* get_AdditionalItems();

  /// @brief Method get_AdditionalProperties, addr 0x109ed9c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaNode* get_AdditionalProperties();

  /// @brief Method get_Id, addr 0x109ed74, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_Items, addr 0x109ed94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Schema::JsonSchemaNode*>* get_Items();

  /// @brief Method get_PatternProperties, addr 0x109ed8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::Newtonsoft::Json::Schema::JsonSchemaNode*>* get_PatternProperties();

  /// @brief Method get_Properties, addr 0x109ed84, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::Newtonsoft::Json::Schema::JsonSchemaNode*>* get_Properties();

  /// @brief Method get_Schemas, addr 0x109ed7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::Newtonsoft::Json::Schema::JsonSchema*>* get_Schemas();

  /// @brief Method set_AdditionalItems, addr 0x109edb4, size 0x8, virtual false, abstract: false, final false
  inline void set_AdditionalItems(::Newtonsoft::Json::Schema::JsonSchemaNode* value);

  /// @brief Method set_AdditionalProperties, addr 0x109eda4, size 0x8, virtual false, abstract: false, final false
