...
CORDL_MODULE_EXPORT(UpdateReplicationGroupMemberAction)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction);
// Type: Amazon.DynamoDBv2.Model::UpdateReplicationGroupMemberAction
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 48, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::UpdateReplicationGroupMemberAction*
class CORDL_TYPE UpdateReplicationGroupMemberAction : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method IsSetGlobalSecondaryIndexes, addr 0x10550b4, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetGlobalSecondaryIndexes();

  /// @brief Method IsSetKMSMasterKeyId, addr 0x1055118, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetKMSMasterKeyId();

  /// @brief Method IsSetProvisionedThroughputOverride, addr 0x1055138, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetProvisionedThroughputOverride();

  /// @brief Method IsSetRegionName, addr 0x1055158, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetRegionName();

  static inline ::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x1055168, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GlobalSecondaryIndexes, addr 0x10550a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::DynamoDBv2::Model::ReplicaGlobalSecondaryIndex*>* get_GlobalSecondaryIndexes();

  /// @brief Method get_KMSMasterKeyId, addr 0x1055108, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_KMSMasterKeyId();

  /// @brief Method get_ProvisionedThroughputOverride, addr 0x1055128, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::ProvisionedThroughputOverride* get_ProvisionedThroughputOverride();

  /// @brief Method get_RegionName, addr 0x1055148, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RegionName();

  /// @brief Method set_GlobalSecondaryIndexes, addr 0x10550ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_KMSMasterKeyId, addr 0x1055110, size 0x8, virtual false, abstract: false, final false
  inline void set_KMSMasterKeyId(::StringW value);

  /// @brief Method set_ProvisionedThroughputOverride, addr 0x1055130, size 0x8, virtual false, abstract: false, final false
  inline void set_ProvisionedThroughputOverride(::Amazon::DynamoDBv2::Model::ProvisionedThroughputOverride* value);

  /// @brief Method set_RegionName, addr 0x1055150, size 0x8, virtual false, abstract: false, final false
  inline void set_RegionName(::StringW value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr UpdateReplicationGroupMemberAction();

public:
  // Ctor Parameters [CppParam { name: "", ty: "UpdateReplicationGroupMemberAction", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UpdateReplicationGroupMemberAction(UpdateReplicationGroupMemberAction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UpdateReplicationGroupMemberAction", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UpdateReplicationGroupMemberAction(UpdateReplicationGroupMemberAction const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction, 0x30>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction, ____globalSecondaryIndexes) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction, ____kmsMasterKeyId) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction, ____provisionedThroughputOverride) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction, ____regionName) == 0x28, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::UpdateReplicationGroupMemberAction*, "Amazon.DynamoDBv2.Model", "UpdateReplicationGroupMemberAction");
