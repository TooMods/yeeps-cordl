...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5108, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PidList* GetDataFromMessage(void* c_message);

  /// @brief Method GetPidList, addr 0x19b50cc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PidList* GetPidList();

  static inline ::Oculus::Platform::MessageWithPidList* New_ctor(void* c_message);

  /// @brief Method .ctor, addr 0x19b1284, size 0x58, virtual false, abstract: false, final false
