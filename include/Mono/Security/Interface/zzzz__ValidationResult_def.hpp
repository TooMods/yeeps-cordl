...
public:
  ...
  /// @brief Method .ctor, addr 0x246e81c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Trusted, addr 0x246e864, size 0x8, virtual false, abstract: false, final false
  inline bool get_Trusted();

  /// @brief Method get_UserDenied, addr 0x246e86c, size 0x8, virtual false, abstract: false, final false
