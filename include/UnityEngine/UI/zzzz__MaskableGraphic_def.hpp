...
public:
  ...
  /// @brief Method .ctor, addr 0x26f50a0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cull, addr 0x26f4494, size 0x54, virtual true, abstract: false, final false
  inline void Cull(::UnityEngine::Rect clipRect, bool validRect);

  /// @brief Method GetModifiedMaterial, addr 0x26f4394, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCanvasHierarchyChanged, addr 0x26f4af0, size 0x50, virtual true, abstract: false, final false
  inline void OnCanvasHierarchyChanged();

  /// @brief Method OnDisable, addr 0x26f49f0, size 0xac, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26f484c, size 0x50, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnTransformParentChanged, addr 0x26f4a9c, size 0x50, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method ParentMaskStateChanged, addr 0x26f4aec, size 0x4, virtual true, abstract: false, final false
  inline void ParentMaskStateChanged();

  /// @brief Method RecalculateClipping, addr 0x26f4f5c, size 0x4, virtual true, abstract: false, final false
  inline void RecalculateClipping();

  /// @brief Method RecalculateMasking, addr 0x26f4f60, size 0x7c, virtual true, abstract: false, final false
  inline void RecalculateMasking();

  /// @brief Method SetClipRect, addr 0x26f47a8, size 0x6c, virtual true, abstract: false, final false
  inline void SetClipRect(::UnityEngine::Rect clipRect, bool validRect);

  /// @brief Method SetClipSoftness, addr 0x26f4814, size 0x38, virtual true, abstract: false, final false
  inline void SetClipSoftness(::UnityEngine::Vector2 clipSoftness);

  /// @brief Method UnityEngine.UI.IClippable.get_gameObject, addr 0x26f50e8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::GameObject> UnityEngine_UI_IClippable_get_gameObject();

  /// @brief Method UpdateClipParent, addr 0x26f489c, size 0x154, virtual false, abstract: false, final false
  inline void UpdateClipParent();

  /// @brief Method UpdateCull, addr 0x26f46cc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f4fdc, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isMaskingGraphic, addr 0x26f438c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isMaskingGraphic();

  /// @brief Method get_maskable, addr 0x26f4354, size 0x8, virtual false, abstract: false, final false
  inline bool get_maskable();

  /// @brief Method get_onCullStateChanged, addr 0x26f4344, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__MaskableGraphic__CullStateChangedEvent* get_onCullStateChanged();

  /// @brief Method get_rootCanvasRect, addr 0x26f44e8, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isMaskingGraphic, addr 0x26f37a8, size 0x18, virtual false, abstract: false, final false
  inline void set_isMaskingGraphic(bool value);

  /// @brief Method set_maskable, addr 0x26f435c, size 0x30, virtual false, abstract: false, final false
  inline void set_maskable(bool value);

  /// @brief Method set_onCullStateChanged, addr 0x26f434c, size 0x8, virtual false, abstract: false, final false
