...
public:
  ...
  /// @brief Method CloneNode, addr 0xff2478, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  static inline ::System::Xml::XmlComment* New_ctor(::StringW comment, ::System::Xml::XmlDocument* doc);

  /// @brief Method WriteContentTo, addr 0xff2514, size 0x4, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* w);

  /// @brief Method WriteTo, addr 0xff24d4, size 0x40, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* w);

  /// @brief Method .ctor, addr 0xff23f4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW comment, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_LocalName, addr 0xff2448, size 0x28, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xff2420, size 0x28, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0xff2470, size 0x8, virtual true, abstract: false, final false
