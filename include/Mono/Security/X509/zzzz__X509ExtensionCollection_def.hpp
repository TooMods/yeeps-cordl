...
public:
  ...
  /// @brief Method IndexOf, addr 0x2469194, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x24692d0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x246918c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2464eb8, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_Item, addr 0x2468818, size 0xb0, virtual false, abstract: false, final false
