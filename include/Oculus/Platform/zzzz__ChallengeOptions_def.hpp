...
public:
  ...
  /// @brief Method Finalize, addr 0x19ae3b4, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::ChallengeOptions* New_ctor();

  /// @brief Method SetDescription, addr 0x19adf4c, size 0x68, virtual false, abstract: false, final false
  inline void SetDescription(::StringW value);

  /// @brief Method SetEndDate, addr 0x19adfb4, size 0x68, virtual false, abstract: false, final false
  inline void SetEndDate(::System::DateTime value);

  /// @brief Method SetIncludeActiveChallenges, addr 0x19ae01c, size 0x68, virtual false, abstract: false, final false
  inline void SetIncludeActiveChallenges(bool value);

  /// @brief Method SetIncludeFutureChallenges, addr 0x19ae084, size 0x68, virtual false, abstract: false, final false
  inline void SetIncludeFutureChallenges(bool value);

  /// @brief Method SetIncludePastChallenges, addr 0x19ae0ec, size 0x68, virtual false, abstract: false, final false
  inline void SetIncludePastChallenges(bool value);

  /// @brief Method SetLeaderboardName, addr 0x19ae154, size 0x68, virtual false, abstract: false, final false
  inline void SetLeaderboardName(::StringW value);

  /// @brief Method SetStartDate, addr 0x19ae1bc, size 0x68, virtual false, abstract: false, final false
  inline void SetStartDate(::System::DateTime value);

  /// @brief Method SetTitle, addr 0x19ae224, size 0x68, virtual false, abstract: false, final false
  inline void SetTitle(::StringW value);

  /// @brief Method SetViewerFilter, addr 0x19ae28c, size 0x68, virtual false, abstract: false, final false
  inline void SetViewerFilter(::Oculus::Platform::ChallengeViewerFilter value);

  /// @brief Method SetVisibility, addr 0x19ae2f4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19adee8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x19ae35c, size 0x58, virtual false, abstract: false, final false
