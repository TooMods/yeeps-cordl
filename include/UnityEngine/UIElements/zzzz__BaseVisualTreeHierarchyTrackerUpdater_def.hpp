...
public:
  ...
  /// @brief Method OnVersionChanged, addr 0x2a384cc, size 0x2c, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method ProcessAddOrMove, addr 0x2a385e0, size 0xbc, virtual false, abstract: false, final false
  inline void ProcessAddOrMove(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method ProcessNewChange, addr 0x2a384f8, size 0x84, virtual false, abstract: false, final false
  inline void ProcessNewChange(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method ProcessRemove, addr 0x2a3857c, size 0x64, virtual false, abstract: false, final false
  inline void ProcessRemove(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Update, addr 0x2a3869c, size 0x94, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2a38730, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
