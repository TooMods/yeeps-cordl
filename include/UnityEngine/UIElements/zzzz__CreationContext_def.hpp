...
public:
  ...
  /// @brief Method Equals, addr 0x27b5148, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x27b51d0, size 0xf0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::CreationContext other);

  /// @brief Method GetHashCode, addr 0x27b52c0, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x27b2bf0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_attributeOverrides, addr 0x27b5138, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_slotInsertionPoints, addr 0x27b5128, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityEngine::UIElements::VisualElement*>* get_slotInsertionPoints();

  /// @brief Method get_target, addr 0x27b5108, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_target();

  /// @brief Method get_visualTreeAsset, addr 0x27b5118, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_attributeOverrides, addr 0x27b5140, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_slotInsertionPoints, addr 0x27b5130, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_target, addr 0x27b5110, size 0x8, virtual false, abstract: false, final false
  inline void set_target(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_visualTreeAsset, addr 0x27b5120, size 0x8, virtual false, abstract: false, final false
