...
public:
  ...
  /// @brief Method SetItems, addr 0x18ac52c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18ac534, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x18ac4f0, size 0x3c, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Items, addr 0x18ac4e8, size 0x8, virtual true, abstract: false, final false
