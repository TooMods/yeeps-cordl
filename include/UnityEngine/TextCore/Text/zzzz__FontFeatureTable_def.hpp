...
public:
  ...
  /// @brief Method <SortGlyphPairAdjustmentRecords>b__6_0, addr 0x23b53b0, size 0x48, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_0(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord s);

  /// @brief Method <SortGlyphPairAdjustmentRecords>b__6_1, addr 0x23b53f8, size 0x48, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_1(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord s);

  /// @brief Method .ctor, addr 0x23b53a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SortGlyphPairAdjustmentRecords, addr 0x23aa1d4, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23aedd4, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_glyphPairAdjustmentRecords, addr 0x23af72c, size 0x8, virtual false, abstract: false, final false
