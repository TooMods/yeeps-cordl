...
public:
  // Declarations
  /// @brief Field <control>k__BackingField, offset 0x170, size 0x8
  ...
  /// @brief Field <device>k__BackingField, offset 0x178, size 0x8
  ...
  /// @brief Field <pointerType>k__BackingField, offset 0x184, size 0x4
  ...
  /// @brief Field <touchId>k__BackingField, offset 0x180, size 0x4
  ...
  /// @brief Field <trackedDeviceOrientation>k__BackingField, offset 0x198, size 0x10
  ...
  /// @brief Field <trackedDevicePosition>k__BackingField, offset 0x18c, size 0xc
  ...
  /// @brief Field <uiToolkitPointerId>k__BackingField, offset 0x188, size 0x4
  ...
  /// @brief Method GetPenPointerId, addr 0x1eabc54, size 0x254, virtual false, abstract: false, final false
  static inline int32_t GetPenPointerId(::UnityEngine::InputSystem::Pen* pen);

  /// @brief Method GetTouchPointerId, addr 0x1eabea8, size 0xf8, virtual false, abstract: false, final false
  static inline int32_t GetTouchPointerId(::UnityEngine::InputSystem::Controls::TouchControl* touchControl);

  /// @brief Method MakePointerIdForTouch, addr 0x1eab9e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadDeviceState, addr 0x1eab9f0, size 0x264, virtual false, abstract: false, final false
  inline void ReadDeviceState();

  /// @brief Method ToString, addr 0x1eab4a8, size 0x538, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TouchIdFromPointerId, addr 0x1eab9e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1eab408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::EventSystems::EventSystem* eventSystem);

  /// @brief Method get_control, addr 0x1eab410, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_device, addr 0x1eab420, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method get_pointerType, addr 0x1eab440, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::UI::UIPointerType get_pointerType();

  /// @brief Method get_touchId, addr 0x1eab430, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_touchId();

  /// @brief Method get_trackedDeviceOrientation, addr 0x1eab480, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_trackedDeviceOrientation();

  /// @brief Method get_trackedDevicePosition, addr 0x1eab460, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_trackedDevicePosition();

  /// @brief Method get_uiToolkitPointerId, addr 0x1eab450, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_uiToolkitPointerId();

  /// @brief Method set_control, addr 0x1eab418, size 0x8, virtual false, abstract: false, final false
  inline void set_control(::UnityEngine::InputSystem::InputControl* value);

  /// @brief Method set_device, addr 0x1eab428, size 0x8, virtual false, abstract: false, final false
  inline void set_device(::UnityEngine::InputSystem::InputDevice* value);

  /// @brief Method set_pointerType, addr 0x1eab448, size 0x8, virtual false, abstract: false, final false
  inline void set_pointerType(::UnityEngine::InputSystem::UI::UIPointerType value);

  /// @brief Method set_touchId, addr 0x1eab438, size 0x8, virtual false, abstract: false, final false
  inline void set_touchId(int32_t value);

  /// @brief Method set_trackedDeviceOrientation, addr 0x1eab494, size 0x14, virtual false, abstract: false, final false
  inline void set_trackedDeviceOrientation(::UnityEngine::Quaternion value);

  /// @brief Method set_trackedDevicePosition, addr 0x1eab470, size 0x10, virtual false, abstract: false, final false
  inline void set_trackedDevicePosition(::UnityEngine::Vector3 value);

  /// @brief Method set_uiToolkitPointerId, addr 0x1eab458, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field <control>k__BackingField, offset: 0x170, size: 0x8, def value: None
  ::UnityEngine::InputSystem::InputControl* ____control_k__BackingField;

  /// @brief Field <device>k__BackingField, offset: 0x178, size: 0x8, def value: None
  ::UnityEngine::InputSystem::InputDevice* ____device_k__BackingField;

  /// @brief Field <touchId>k__BackingField, offset: 0x180, size: 0x4, def value: None
  int32_t ____touchId_k__BackingField;

  /// @brief Field <pointerType>k__BackingField, offset: 0x184, size: 0x4, def value: None
  ::UnityEngine::InputSystem::UI::UIPointerType ____pointerType_k__BackingField;

  /// @brief Field <uiToolkitPointerId>k__BackingField, offset: 0x188, size: 0x4, def value: None
  int32_t ____uiToolkitPointerId_k__BackingField;

  /// @brief Field <trackedDevicePosition>k__BackingField, offset: 0x18c, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____trackedDevicePosition_k__BackingField;

  /// @brief Field <trackedDeviceOrientation>k__BackingField, offset: 0x198, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____trackedDeviceOrientation_k__BackingField;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::UI::ExtendedPointerEventData, 0x1a8>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____control_k__BackingField) == 0x170, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____device_k__BackingField) == 0x178, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____touchId_k__BackingField) == 0x180, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____pointerType_k__BackingField) == 0x184, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____uiToolkitPointerId_k__BackingField) == 0x188, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____trackedDevicePosition_k__BackingField) == 0x18c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::UI::ExtendedPointerEventData, ____trackedDeviceOrientation_k__BackingField) == 0x198, "Offset mismatch!");
