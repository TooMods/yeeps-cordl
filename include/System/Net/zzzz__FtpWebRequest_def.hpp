...
public:
  ...
  /// @brief Method MoveNext, addr 0x1243ef8, size 0x30c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1244204, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0xf50ddc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_ClientCertificates>b__114_0, addr 0xf50de4, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Abort, addr 0x124379c, size 0x48c, virtual true, abstract: false, final false
  inline void Abort();

  /// @brief Method AsyncRequestCallback, addr 0x124293c, size 0xa7c, virtual false, abstract: false, final false
  inline void AsyncRequestCallback(::System::Object* obj);

  /// @brief Method AttemptedRecovery, addr 0x124244c, size 0x284, virtual false, abstract: false, final false
  inline bool AttemptedRecovery(::System::Exception* e);

  /// @brief Method BeginGetRequestStream, addr 0x1241480, size 0x53c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetRequestStream(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method BeginGetResponse, addr 0x12409b4, size 0x6c0, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method CheckError, addr 0x123f79c, size 0x14, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method CreateConnection, addr 0x1241ec0, size 0x164, virtual false, abstract: false, final false
  inline ::System::Net::FtpControlStream* CreateConnection();

  /// @brief Method CreateConnectionAsync, addr 0x1241e2c, size 0x94, virtual false, abstract: false, final false
  inline void CreateConnectionAsync();

  /// @brief Method DataStreamClosed, addr 0x1243d64, size 0x80, virtual false, abstract: false, final false
  inline void DataStreamClosed(::System::Net::CloseExState closeState);

  /// @brief Method EndGetRequestStream, addr 0x12419bc, size 0x470, virtual true, abstract: false, final false
  inline ::System::IO::Stream* EndGetRequestStream(::System::IAsyncResult* asyncResult);

  /// @brief Method EndGetResponse, addr 0x1241074, size 0x40c, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult* asyncResult);

  /// @brief Method EnsureFtpWebResponse, addr 0x1240150, size 0x4fc, virtual false, abstract: false, final false
  inline void EnsureFtpWebResponse(::System::Exception* exception);

  /// @brief Method FinishRequestStage, addr 0x123f7b0, size 0x434, virtual false, abstract: false, final false
  inline ::System::Net::__FtpWebRequest__RequestStage FinishRequestStage(::System::Net::__FtpWebRequest__RequestStage stage);

  /// @brief Method GetResponse, addr 0x123eff0, size 0x7ac, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* GetResponse();

  static inline ::System::Net::FtpWebRequest* New_ctor(::System::Uri* uri);

  /// @brief Method RequestCallback, addr 0x123693c, size 0x10, virtual false, abstract: false, final false
  inline void RequestCallback(::System::Object* obj);

  /// @brief Method SetException, addr 0x124064c, size 0x368, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SubmitRequest, addr 0x123fbe4, size 0x56c, virtual false, abstract: false, final false
  inline void SubmitRequest(bool isAsync);

  /// @brief Method SyncRequestCallback, addr 0x12433b8, size 0x3e4, virtual false, abstract: false, final false
  inline void SyncRequestCallback(::System::Object* obj);

  /// @brief Method TimedSubmitRequestHelper, addr 0x1242024, size 0x428, virtual false, abstract: false, final false
  inline ::System::IO::Stream* TimedSubmitRequestHelper(bool isAsync);

  /// @brief Method TimerCallback, addr 0x1242840, size 0xfc, virtual false, abstract: false, final false
  inline void TimerCallback(::System::Net::__TimerThread__Timer* timer, int32_t timeNoticed, ::System::Object* context);

  /// @brief Method TranslateConnectException, addr 0x12426d0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x123ec30, size 0x3c0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aborted, addr 0x123ec28, size 0x8, virtual false, abstract: false, final false
  inline bool get_Aborted();

  /// @brief Method get_ClientCertificates, addr 0x12392f0, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method get_ContentLength, addr 0x123eb3c, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method get_ContentOffset, addr 0x123eb34, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ContentOffset();

  /// @brief Method get_Credentials, addr 0x123e8e4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method get_EnableSsl, addr 0x1243ca0, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableSsl();

  /// @brief Method get_Headers, addr 0x1243ca8, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_InUse, addr 0x123e8c4, size 0x18, virtual false, abstract: false, final false
  inline bool get_InUse();

  /// @brief Method get_Method, addr 0x123e6fc, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method get_MethodInfo, addr 0x123e6f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::FtpMethodInfo* get_MethodInfo();

  /// @brief Method get_Proxy, addr 0x123eb4c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::IWebProxy* get_Proxy();

  /// @brief Method get_ReadWriteTimeout, addr 0x123eb2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ReadWriteTimeout();

  /// @brief Method get_RemainingTimeout, addr 0x123eb24, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RemainingTimeout();

  /// @brief Method get_RenameTo, addr 0x123e8dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RenameTo();

  /// @brief Method get_RequestUri, addr 0x123ea3c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_Timeout, addr 0x123ea44, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method get_TimerQueue, addr 0x12427d4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Net::__TimerThread__Queue* get_TimerQueue();

  /// @brief Method get_UseBinary, addr 0x1243c90, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseBinary();

  /// @brief Method get_UseDefaultCredentials, addr 0x1243d14, size 0x28, virtual true, abstract: false, final false
  inline bool get_UseDefaultCredentials();

  /// @brief Method get_UsePassive, addr 0x1243c98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CachePolicy, addr 0x1243c28, size 0x68, virtual true, abstract: false, final false
  inline void set_CachePolicy(::System::Net::Cache::RequestCachePolicy* value);

  /// @brief Method set_ConnectionGroupName, addr 0x123ebbc, size 0x6c, virtual true, abstract: false, final false
  inline void set_ConnectionGroupName(::StringW value);

  /// @brief Method set_ContentLength, addr 0x123eb44, size 0x8, virtual true, abstract: false, final false
  inline void set_ContentLength(int64_t value);

  /// @brief Method set_Credentials, addr 0x123e8ec, size 0x150, virtual true, abstract: false, final false
  inline void set_Credentials(::System::Net::ICredentials* value);

  /// @brief Method set_Method, addr 0x123e718, size 0x1ac, virtual true, abstract: false, final false
  inline void set_Method(::StringW value);

  /// @brief Method set_PreAuthenticate, addr 0x1243d3c, size 0x28, virtual true, abstract: false, final false
  inline void set_PreAuthenticate(bool value);

  /// @brief Method set_Proxy, addr 0x123eb54, size 0x68, virtual true, abstract: false, final false
  inline void set_Proxy(::System::Net::IWebProxy* value);

  /// @brief Method set_Timeout, addr 0x123ea4c, size 0xd8, virtual true, abstract: false, final false
