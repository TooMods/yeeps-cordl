...
public:
  ...
  /// @brief Method Compare, addr 0x21c93a4, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x21c92a0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x21c931c, size 0x88, virtual false, abstract: false, final false
