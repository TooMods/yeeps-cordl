...
public:
  ...
  /// @brief Method Close, addr 0x1b40a24, size 0x10, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method DangerousAddRef, addr 0x1b40028, size 0xd0, virtual false, abstract: false, final false
  inline void DangerousAddRef(ByRef<bool> success);

  /// @brief Method DangerousGetHandle, addr 0x1b40a10, size 0x8, virtual false, abstract: false, final false
  inline void* DangerousGetHandle();

  /// @brief Method DangerousRelease, addr 0x1b401d4, size 0x8, virtual false, abstract: false, final false
  inline void DangerousRelease();

  /// @brief Method DangerousReleaseInternal, addr 0x1b40ba0, size 0x170, virtual false, abstract: false, final false
  inline void DangerousReleaseInternal(bool dispose);

  /// @brief Method Dispose, addr 0x1b40a34, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1b40a44, size 0x1c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x1b40968, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method InternalDispose, addr 0x1b40a60, size 0xa8, virtual false, abstract: false, final false
  inline void InternalDispose();

  /// @brief Method InternalFinalize, addr 0x1b40b08, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHandle, addr 0x1b40a08, size 0x8, virtual false, abstract: false, final false
  inline void SetHandle(void* handle);

  /// @brief Method SetHandleAsInvalid, addr 0x1b40b1c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b408c8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(void* invalidHandleValue, bool ownsHandle);

  /// @brief Method get_IsClosed, addr 0x1b40a18, size 0xc, virtual false, abstract: false, final false
