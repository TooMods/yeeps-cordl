...
public:
  ...
  /// @brief Method MoveNext, addr 0x18aa35c, size 0xa0, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::Schema::XmlSchemaObjectEnumerator* New_ctor(::System::Collections::IEnumerator* enumerator);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x18aa590, size 0xa0, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x18aa4ec, size 0xa4, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x18aa630, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18aa334, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerator* enumerator);

  /// @brief Method get_Current, addr 0x18aa3fc, size 0xf0, virtual false, abstract: false, final false
