...
public:
  ...
  /// @brief Method .ctor, addr 0xfa1ca4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Action, addr 0xfa1d40, size 0x8, virtual false, abstract: false, final false
