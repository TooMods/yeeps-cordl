...
public:
  // Declarations
  /// @brief Method GetAttributes, addr 0x261e4c0, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodAttributes GetAttributes(void* handle);

  /// @brief Method GetCallingConvention, addr 0x261e4c4, size 0x28, virtual false, abstract: false, final false
  static inline ::System::Reflection::CallingConventions GetCallingConvention(void* handle);

  /// @brief Method GetDeclaringType, addr 0x261e470, size 0x28, virtual false, abstract: false, final false
  static inline ::System::Type* GetDeclaringType(void* handle);

  /// @brief Method GetMethodImplementationFlags, addr 0x261e4ec, size 0x28, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodImplAttributes GetMethodImplementationFlags(void* handle);

  /// @brief Method GetMethodInfo, addr 0x261e440, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Reflection::MonoMethodInfo GetMethodInfo(void* handle);

  /// @brief Method GetParametersInfo, addr 0x261e518, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReturnParameterInfo, addr 0x261e520, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Reflection::ParameterInfo* GetReturnParameterInfo(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method GetReturnType, addr 0x261e498, size 0x28, virtual false, abstract: false, final false
  static inline ::System::Type* GetReturnType(void* handle);

  /// @brief Method get_method_attributes, addr 0x261e43c, size 0x4, virtual false, abstract: false, final false
  static inline int32_t get_method_attributes(void* handle);

  /// @brief Method get_method_info, addr 0x261e438, size 0x4, virtual false, abstract: false, final false
  static inline void get_method_info(void* handle, ByRef<::System::Reflection::MonoMethodInfo> info);

  /// @brief Method get_parameter_info, addr 0x261e514, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_retval_marshal, addr 0x261e51c, size 0x4, virtual false, abstract: false, final false
