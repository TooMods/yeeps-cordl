...
public:
  ...
  /// @brief Method .ctor, addr 0x1c719b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_samplingFrequency, addr 0x1c7181c, size 0xf4, virtual false, abstract: false, final false
  inline float_t get_samplingFrequency();

  /// @brief Method set_samplingFrequency, addr 0x1c71910, size 0xa0, virtual false, abstract: false, final false
