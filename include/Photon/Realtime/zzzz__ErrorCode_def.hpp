...
// Write type traits
MARK_REF_PTR_T(::Photon::Realtime::ErrorCode);
// Type: Photon.Realtime::ErrorCode
// SizeInfo { instance_size: 16, native_size: -1, calculated_instance_size: 16, calculated_native_size: 16, minimum_alignment: 8, natural_alignment: 0, packing: None, specified_packing: None }
namespace Photon::Realtime {
// Is value type: false
// CS Name: ::Photon.Realtime::ErrorCode*
class CORDL_TYPE ErrorCode : public ::System::Object {
public:
  // Declarations
  static inline ::Photon::Realtime::ErrorCode* New_ctor();

  /// @brief Method .ctor, addr 0x2247c2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::Photon::Realtime::ErrorCode, 0x10>, "Size mismatch!");
