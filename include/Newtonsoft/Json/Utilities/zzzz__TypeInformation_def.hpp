...
public:
  ...
  /// @brief Method .ctor, addr 0x152849c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::Newtonsoft::Json::Utilities::PrimitiveTypeCode typeCode);

  /// @brief Method get_Type, addr 0x152848c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Type();

  /// @brief Method get_TypeCode, addr 0x1528494, size 0x8, virtual false, abstract: false, final false
