...
public:
  ...
  /// @brief Method AddValue, addr 0x30299c0, size 0xac, virtual false, abstract: false, final false
  inline void AddValue(::UnityEngine::UIElements::StyleValueHandle handle);

  /// @brief Method Init, addr 0x3029828, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseVarFunction, addr 0x3029b38, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method PopContext, addr 0x3029944, size 0x7c, virtual false, abstract: false, final false
  inline void PopContext();

  /// @brief Method PushContext, addr 0x30298d8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveFallback, addr 0x3029fc4, size 0x284, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__StyleVariableResolver__Result ResolveFallback(ByRef<int32_t> index);

  /// @brief Method ResolveVarFunction, addr 0x3029be8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveVarFunction, addr 0x3029a6c, size 0xcc, virtual false, abstract: false, final false
  inline bool ResolveVarFunction(ByRef<int32_t> index);

  /// @brief Method ResolveVariable, addr 0x3029d44, size 0x278, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__StyleVariableResolver__Result ResolveVariable(::StringW variableName);

  /// @brief Method ValidateResolvedValues, addr 0x302a248, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x302a510, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxParser* getStaticF_s_SyntaxParser();

  /// @brief Method get_currentHandles, addr 0x3029808, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::UIElements::StyleValueHandle, ::Array<::UnityEngine::UIElements::StyleValueHandle>*> get_currentHandles();

  /// @brief Method get_currentSheet, addr 0x3029800, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UIElements::StyleSheet> get_currentSheet();

  /// @brief Method get_resolvedValues, addr 0x3029810, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StylePropertyValue>* get_resolvedValues();

  /// @brief Method get_variableContext, addr 0x3029818, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_variableContext, addr 0x3029820, size 0x8, virtual false, abstract: false, final false
