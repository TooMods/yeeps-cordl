...
public:
  ...
  /// @brief Method GetByteCount, addr 0xedf5d0, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0xedf754, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW chars);

  /// @brief Method GetByteCount, addr 0xee0638, size 0x2fc, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t charCount, ::System::Text::EncoderNLS* encoder);

  /// @brief Method GetByteCount, addr 0xedf7e4, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetBytes, addr 0xedfb1c, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0xedf8bc, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0xedfd98, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0xee0980, size 0x41c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0xedfe98, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0xee001c, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetCharCount, addr 0xee0d9c, size 0x150, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* decoder);

  /// @brief Method GetChars, addr 0xee00f4, size 0x27c, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0xee0370, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0xee0f30, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0xee13d4, size 0x60, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0xee1478, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetMaxByteCount, addr 0xee11c8, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0xee12d0, size 0x104, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetString, addr 0xee0470, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetDefaultFallbacks, addr 0xedf510, size 0x24, virtual true, abstract: false, final false
  inline void SetDefaultFallbacks();

  /// @brief Method .ctor, addr 0xedf504, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
