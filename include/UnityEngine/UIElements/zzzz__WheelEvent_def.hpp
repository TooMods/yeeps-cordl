...
public:
  ...
  /// @brief Method GetPooled, addr 0x2cd0c64, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPooled, addr 0x2cd0be8, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::WheelEvent* GetPooled(::UnityEngine::Event* systemEvent);

  /// @brief Method Init, addr 0x2cd0cdc, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd0d2c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd0d8c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_delta, addr 0x2cd0bd0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_delta();

  /// @brief Method set_delta, addr 0x2cd0bdc, size 0xc, virtual false, abstract: false, final false
