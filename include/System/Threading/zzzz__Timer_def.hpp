...
public:
  ...
  /// @brief Method Compare, addr 0xed14e0, size 0x70, virtual true, abstract: false, final true
  inline int32_t Compare(::System::Threading::Timer* tx, ::System::Threading::Timer* ty);

  /// @brief Method System.Collections.IComparer.Compare, addr 0xed1448, size 0x98, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0xed1bd0, size 0xf0, virtual false, abstract: false, final false
  inline void Add(::System::Threading::Timer* timer);

  /// @brief Method Change, addr 0xed12b4, size 0x190, virtual false, abstract: false, final false
  inline void Change(::System::Threading::Timer* timer, int64_t new_next_run);

  /// @brief Method FireTimer, addr 0xed1d38, size 0xc4, virtual false, abstract: false, final false
  inline void FireTimer(::System::Threading::Timer* timer);

  /// @brief Method InitScheduler, addr 0xed1550, size 0xf4, virtual false, abstract: false, final false
  inline void InitScheduler();

  /// @brief Method InternalRemove, addr 0xed1ba0, size 0x30, virtual false, abstract: false, final false
  inline void InternalRemove(::System::Threading::Timer* timer);

  static inline ::System::Threading::__Timer__Scheduler* New_ctor();

  /// @brief Method Remove, addr 0xed11e4, size 0xcc, virtual false, abstract: false, final false
  inline void Remove(::System::Threading::Timer* timer);

  /// @brief Method RunSchedulerLoop, addr 0xed1798, size 0x314, virtual false, abstract: false, final false
  inline int32_t RunSchedulerLoop();

  /// @brief Method SchedulerThread, addr 0xed1660, size 0x138, virtual false, abstract: false, final false
  inline void SchedulerThread();

  /// @brief Method TimerCB, addr 0xed1cc0, size 0x78, virtual false, abstract: false, final false
  static inline void TimerCB(::System::Object* o);

  /// @brief Method WakeupScheduler, addr 0xed1644, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed1b04, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Threading::__Timer__Scheduler* getStaticF_instance();

  /// @brief Method get_Instance, addr 0xed1aac, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Change, addr 0xed1134, size 0x78, virtual false, abstract: false, final false
  inline bool Change(::System::TimeSpan dueTime, ::System::TimeSpan period);

  /// @brief Method Change, addr 0xed1114, size 0x20, virtual false, abstract: false, final false
  inline bool Change(int32_t dueTime, int32_t period);

  /// @brief Method Change, addr 0xed0f34, size 0x1e0, virtual false, abstract: false, final false
  inline bool Change(int64_t dueTime, int64_t period, bool first);

  /// @brief Method Dispose, addr 0xed11ac, size 0x38, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetTimeMonotonic, addr 0xed12b0, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetTimeMonotonic();

  /// @brief Method Init, addr 0xed0e30, size 0x74, virtual false, abstract: false, final false
  inline void Init(::System::Threading::TimerCallback* callback, ::System::Object* state, int64_t dueTime, int64_t period);

  /// @brief Method KeepRootedWhileScheduled, addr 0xed1444, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed0ea4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed0de4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::TimerCallback* callback, ::System::Object* state, int32_t dueTime, int32_t period);

  /// @brief Method get_scheduler, addr 0xed0d5c, size 0x88, virtual false, abstract: false, final false
