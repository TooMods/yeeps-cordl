...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x27df9a0, size 0x40, virtual false, abstract: false, final false
  inline int32_t _GetValueFromBag_b__3_0(::StringW s, int32_t i);

  /// @brief Method <TryGetValueFromBag>b__4_0, addr 0x27df9e0, size 0x40, virtual false, abstract: false, final false
  inline int32_t _TryGetValueFromBag_b__4_0(::StringW s, int32_t i);

  /// @brief Method .ctor, addr 0x27df998, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToInt, addr 0x27df8f8, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t ConvertValueToInt(::StringW v, int32_t defaultValue);

  /// @brief Method GetValueFromBag, addr 0x27df61c, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetValueFromBag, addr 0x27df780, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27df580, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
