...
public:
  ...
  /// @brief Method HexToColor32, addr 0x1f390ec, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 HexToColor32(uint32_t color);

  /// @brief Method TryGetColor, addr 0x1f361e4, size 0xf4, virtual false, abstract: false, final false
