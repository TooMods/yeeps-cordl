...
public:
  ...
  /// @brief Method .ctor, addr 0x1718444, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x17184f4, size 0x74, virtual true, abstract: false, final false
