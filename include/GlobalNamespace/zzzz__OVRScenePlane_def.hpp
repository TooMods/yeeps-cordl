...
public:
  ...
  /// @brief Method Execute, addr 0x14927b4, size 0x84, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x14928fc, size 0xa8, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method HasBoundaryChanged, addr 0x1492838, size 0xb0, virtual false, abstract: false, final false
  inline bool HasBoundaryChanged();

  /// @brief Method SetNaN, addr 0x14928e8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x1491cec, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x1491dc4, size 0x4, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  static inline ::GlobalNamespace::OVRScenePlane* New_ctor();

  /// @brief Method OnDisable, addr 0x1492624, size 0x10c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method RequestBoundary, addr 0x148ef20, size 0x30, virtual false, abstract: false, final false
  inline void RequestBoundary();

  /// @brief Method ScheduleGetLengthJob, addr 0x1491dc8, size 0x188, virtual false, abstract: false, final false
  inline void ScheduleGetLengthJob();

  /// @brief Method SetChildOffset, addr 0x1491bc0, size 0x12c, virtual false, abstract: false, final false
  inline void SetChildOffset();

  /// @brief Method SetChildScale, addr 0x1491a40, size 0x144, virtual false, abstract: false, final false
  inline void SetChildScale();

  /// @brief Method Start, addr 0x1491dc0, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x1491f50, size 0x6a4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateTransform, addr 0x148eda4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1492730, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Boundary, addr 0x14919fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::Vector2>* get_Boundary();

  /// @brief Method get_Dimensions, addr 0x14919f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_Dimensions();

  /// @brief Method get_Height, addr 0x14919d4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method get_Offset, addr 0x14919e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_Offset();

  /// @brief Method get_OffsetChildren, addr 0x1491b84, size 0x8, virtual false, abstract: false, final false
  inline bool get_OffsetChildren();

  /// @brief Method get_ScaleChildren, addr 0x1491a04, size 0x8, virtual false, abstract: false, final false
  inline bool get_ScaleChildren();

  /// @brief Method get_Width, addr 0x14919c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Height, addr 0x14919dc, size 0x8, virtual false, abstract: false, final false
  inline void set_Height(float_t value);

  /// @brief Method set_Offset, addr 0x14919ec, size 0x8, virtual false, abstract: false, final false
  inline void set_Offset(::UnityEngine::Vector2 value);

  /// @brief Method set_OffsetChildren, addr 0x1491b8c, size 0x34, virtual false, abstract: false, final false
  inline void set_OffsetChildren(bool value);

  /// @brief Method set_ScaleChildren, addr 0x1491a0c, size 0x34, virtual false, abstract: false, final false
  inline void set_ScaleChildren(bool value);

  /// @brief Method set_Width, addr 0x14919cc, size 0x8, virtual false, abstract: false, final false
