...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129aae4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129a9fc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW attributeName);

  /// @brief Method get_AttributeName, addr 0x129aa24, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_AttributeName();

  /// @brief Method get_DataType, addr 0x129aa78, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_Form, addr 0x129aad4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_Namespace, addr 0x129aadc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_DataType, addr 0x129aacc, size 0x8, virtual false, abstract: false, final false
