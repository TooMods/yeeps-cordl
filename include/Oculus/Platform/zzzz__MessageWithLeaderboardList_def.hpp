...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3ec0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(void* c_message);

  /// @brief Method GetLeaderboardList, addr 0x19b3e84, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0f14, size 0x58, virtual false, abstract: false, final false
