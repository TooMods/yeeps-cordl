...
public:
  ...
  /// @brief Method ExecuteDefaultAction, addr 0x2cd0448, size 0x4, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x2cd0444, size 0x4, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionDisabled, addr 0x2cd0450, size 0x4, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionDisabled(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionDisabledAtTarget, addr 0x2cd044c, size 0x4, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionDisabledAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method HandleEvent, addr 0x2cd0184, size 0x2c0, virtual true, abstract: false, final false
  inline void HandleEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method HandleEventAtTargetPhase, addr 0x2ccd0f4, size 0x6c, virtual false, abstract: false, final false
  inline void HandleEventAtTargetPhase(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method HasBubbleUpHandlers, addr 0x2ccc3b4, size 0x28, virtual true, abstract: false, final true
  inline bool HasBubbleUpHandlers();

  /// @brief Method HasTrickleDownHandlers, addr 0x2ccc38c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2cd0454, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
