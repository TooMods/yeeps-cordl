...
public:
  ...
  /// @brief Method FindPrimitiveTypeData, addr 0x125dec0, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::Xml::Serialization::TypeData* FindPrimitiveTypeData(::StringW typeName);

  /// @brief Method GetArrayName, addr 0x1258758, size 0x110, virtual false, abstract: false, final false
  static inline ::StringW GetArrayName(::StringW elemName);

  /// @brief Method GetPrimitiveTypeData, addr 0x125dc60, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Serialization::TypeData* GetPrimitiveTypeData(::StringW typeName);

  /// @brief Method GetPrimitiveTypeData, addr 0x125dcb8, size 0x208, virtual false, abstract: false, final false
  static inline ::System::Xml::Serialization::TypeData* GetPrimitiveTypeData(::StringW typeName, bool nullable);

  /// @brief Method GetTypeData, addr 0x125d29c, size 0x9c4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeData, addr 0x1257e34, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::Serialization::TypeData* GetTypeData(::System::Type* type);

  /// @brief Method ParseArrayType, addr 0x125df80, size 0x17c, virtual false, abstract: false, final false
