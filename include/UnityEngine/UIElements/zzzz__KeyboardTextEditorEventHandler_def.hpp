...
public:
  ...
  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x27bef8c, size 0x5bc, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method MoveDistanceQualifiesForDrag, addr 0x27c0cec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBlur, addr 0x27bf6d8, size 0xc, virtual false, abstract: false, final false
  inline void OnBlur(::UnityEngine::UIElements::BlurEvent* _);

  /// @brief Method OnExecuteCommandEvent, addr 0x27c06f4, size 0x5f8, virtual false, abstract: false, final false
  inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent* evt);

  /// @brief Method OnFocus, addr 0x27bf548, size 0x190, virtual false, abstract: false, final false
  inline void OnFocus(::UnityEngine::UIElements::FocusEvent* _);

  /// @brief Method OnKeyDown, addr 0x27bfd88, size 0x608, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnMouseDown, addr 0x27bf6e4, size 0x3f4, virtual false, abstract: false, final false
  inline void OnMouseDown(::UnityEngine::UIElements::MouseDownEvent* evt);

  /// @brief Method OnMouseMove, addr 0x27bfc40, size 0x148, virtual false, abstract: false, final false
  inline void OnMouseMove(::UnityEngine::UIElements::MouseMoveEvent* evt);

  /// @brief Method OnMouseUp, addr 0x27bfad8, size 0x168, virtual false, abstract: false, final false
  inline void OnMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnValidateCommandEvent, addr 0x27c0390, size 0x364, virtual false, abstract: false, final false
  inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent* evt);

  /// @brief Method PostDrawCursor, addr 0x27c1184, size 0x24, virtual false, abstract: false, final false
  inline void PostDrawCursor();

  /// @brief Method PreDrawCursor, addr 0x27c0e44, size 0x340, virtual false, abstract: false, final false
  inline void PreDrawCursor(::StringW newText);

  /// @brief Method ProcessDragMove, addr 0x27c0d10, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27bef0c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isClicking, addr 0x27beed0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isClicking();

  /// @brief Method set_isClicking, addr 0x27beed8, size 0x34, virtual false, abstract: false, final false
