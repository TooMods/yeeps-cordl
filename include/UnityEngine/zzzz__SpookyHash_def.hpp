...
public:
  ...
  /// @brief Method .ctor, addr 0x2a81108, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AttemptDetectAllowUnalignedRead, addr 0x284b184, size 0x88, virtual false, abstract: false, final false
  static inline bool AttemptDetectAllowUnalignedRead();

  /// @brief Method End, addr 0x284be64, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndPartial, addr 0x284c0d0, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash, addr 0x284b20c, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method Mix, addr 0x284b980, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rot64, addr 0x284c368, size 0x14, virtual false, abstract: false, final false
  static inline void Rot64(ByRef<uint64_t> x, int32_t k);

  /// @brief Method Short, addr 0x284b570, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method ShortEnd, addr 0x284c598, size 0x1fc, virtual false, abstract: false, final false
  static inline void ShortEnd(ByRef<uint64_t> h0, ByRef<uint64_t> h1, ByRef<uint64_t> h2, ByRef<uint64_t> h3);

  /// @brief Method ShortMix, addr 0x284c37c, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method memset, addr 0x284bdcc, size 0x98, virtual false, abstract: false, final false
