...
public:
  // Declarations
  /// @brief Method ComputeTextHeight, addr 0x264f2a8, size 0x108, virtual false, abstract: false, final false
  static inline float_t ComputeTextHeight(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method ComputeTextScaling, addr 0x264f7c4, size 0xfc, virtual false, abstract: false, final false
  static inline float_t ComputeTextScaling(::UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint);

  /// @brief Method ComputeTextWidth, addr 0x264f164, size 0x108, virtual false, abstract: false, final false
  static inline float_t ComputeTextWidth(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoComputeTextHeight, addr 0x264f3b0, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextHeight(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoComputeTextHeight_Injected, addr 0x264f8fc, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextHeight_Injected(ByRef<::UnityEngine::UIElements::TextNativeSettings> settings);

  /// @brief Method DoComputeTextWidth, addr 0x264f26c, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextWidth(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoComputeTextWidth_Injected, addr 0x264f8c0, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextWidth_Injected(ByRef<::UnityEngine::UIElements::TextNativeSettings> settings);

  /// @brief Method DoGetCursorPosition, addr 0x264f0fc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetCursorPosition_Injected, addr 0x264f938, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetOffset, addr 0x264f768, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 DoGetOffset(::UnityEngine::UIElements::TextNativeSettings settings, ::UnityEngine::Rect rect);

  /// @brief Method DoGetOffset_Injected, addr 0x264f9f0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorPosition, addr 0x264efb8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOffset, addr 0x264f638, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices, addr 0x264f3ec, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices, addr 0x264f5dc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices_Injected, addr 0x264f994, size 0x5c, virtual false, abstract: false, final false
