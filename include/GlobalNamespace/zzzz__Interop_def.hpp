...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x1d01fec, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetErrorMessage();

  /// @brief Method ToString, addr 0x1d022b0, size 0xd4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1d020b8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t _cordl_errno);

  /// @brief Method .ctor, addr 0x1d02124, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::__Interop__Error error);

  /// @brief Method get_Error, addr 0x1d02130, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__Interop__Error get_Error();

  /// @brief Method get_RawErrno, addr 0x1d01f80, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetName, addr 0x1d02aa4, size 0x164, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseDir, addr 0x1d0242c, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t CloseDir(void* dir);

  /// @brief Method ConvertErrorPalToPlatform, addr 0x1d02138, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::__Interop__Error error);

  /// @brief Method ConvertErrorPlatformToPal, addr 0x1d02120, size 0x4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__Interop__Error ConvertErrorPlatformToPal(int32_t platformErrno);

  /// @brief Method DoubleToString, addr 0x1d02a4c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEGid, addr 0x1d026e8, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEGid();

  /// @brief Method GetEUid, addr 0x1d026ec, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEUid();

  /// @brief Method GetLastErrorInfo, addr 0x1d02384, size 0x68, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__Interop__ErrorInfo GetLastErrorInfo();

  /// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x1d020b4, size 0x4, virtual false, abstract: false, final false
  static inline void GetNonCryptographicallySecureRandomBytes(::cordl_internals::Ptr<uint8_t> buffer, int32_t length);

  /// @brief Method GetReadDirRBufferSize, addr 0x1d02424, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetReadDirRBufferSize();

  /// @brief Method LChflagsCanSetHiddenFlag, addr 0x1d026f0, size 0x4, virtual false, abstract: false, final false
  static inline int32_t LChflagsCanSetHiddenFlag();

  /// @brief Method LStat, addr 0x1d028c0, size 0x158, virtual false, abstract: false, final false
  static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method LStat, addr 0x1d028a4, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t LStat(ByRef<uint8_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method MkDir, addr 0x1d026f4, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t MkDir(::StringW path, int32_t mode);

  /// @brief Method OpenDir, addr 0x1d023f0, size 0x34, virtual false, abstract: false, final false
  static inline void* OpenDir(::StringW path);

  /// @brief Method ReadDirR, addr 0x1d02428, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadLink, addr 0x1d02494, size 0x218, virtual false, abstract: false, final false
  static inline ::StringW ReadLink(::StringW path);

  /// @brief Method ReadLink, addr 0x1d02448, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t ReadLink(::StringW path, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t bufferSize);

  /// @brief Method Stat, addr 0x1d026ac, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t Stat(::StringW path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method Stat, addr 0x1d0274c, size 0x158, virtual false, abstract: false, final false
  static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method Stat, addr 0x1d02730, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t Stat(ByRef<uint8_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method StrError, addr 0x1d021b4, size 0xfc, virtual false, abstract: false, final false
  static inline ::StringW StrError(int32_t platformErrno);

  /// @brief Method StrErrorR, addr 0x1d023ec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Unlink, addr 0x1d02a18, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetExceptionForIoErrno, addr 0x1d0198c, size 0x4f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIOException, addr 0x1d01ef4, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetIOException(::GlobalNamespace::__Interop__ErrorInfo errorInfo);

  /// @brief Method GetRandomBytes, addr 0x1d02050, size 0x64, virtual false, abstract: false, final false
