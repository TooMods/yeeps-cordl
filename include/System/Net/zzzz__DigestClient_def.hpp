...
public:
  ...
  /// @brief Method Authenticate, addr 0x10357a8, size 0x2a8, virtual true, abstract: false, final true
  ...
  /// @brief Method CheckExpired, addr 0x1034f60, size 0x848, virtual false, abstract: false, final false
  static inline void CheckExpired(int32_t count);

  static inline ::System::Net::DigestClient* New_ctor();

  /// @brief Method PreAuthenticate, addr 0x1035a50, size 0x194, virtual true, abstract: false, final true
  inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest* webRequest, ::System::Net::ICredentials* credentials);

  /// @brief Method .ctor, addr 0x1031f3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Hashtable* getStaticF_cache();

  /// @brief Method get_AuthenticationType, addr 0x1035be4, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_AuthenticationType();

  /// @brief Method get_Cache, addr 0x1034df8, size 0x168, virtual false, abstract: false, final false
