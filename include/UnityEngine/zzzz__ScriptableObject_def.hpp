...
public:
  // Declarations
  /// @brief Method CreateInstance, addr 0x283dfb4, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::ScriptableObject> CreateInstance(::StringW className);

  /// @brief Method CreateInstance, addr 0x283e02c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateScriptableObject, addr 0x283df78, size 0x3c, virtual false, abstract: false, final false
  static inline void CreateScriptableObject(::UnityEngine::ScriptableObject* self);

  /// @brief Method CreateScriptableObjectInstanceFromName, addr 0x283dff0, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::ScriptableObject> CreateScriptableObjectInstanceFromName(::StringW className);

  /// @brief Method CreateScriptableObjectInstanceFromType, addr 0x283e06c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x283def8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
