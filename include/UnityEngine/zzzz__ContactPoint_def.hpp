...
public:
  ...
  /// @brief Method get_normal, addr 0x28f9730, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_point, addr 0x28f9724, size 0xc, virtual false, abstract: false, final false
