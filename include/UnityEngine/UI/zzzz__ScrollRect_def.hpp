...
public:
  ...
  /// @brief Method .ctor, addr 0x290aa94, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AdjustBounds, addr 0x290d994, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateLayoutInputHorizontal, addr 0x290cedc, size 0x4, virtual true, abstract: false, final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x290cee0, size 0x4, virtual true, abstract: false, final false
  inline void CalculateLayoutInputVertical();

  /// @brief Method CalculateOffset, addr 0x290bce4, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalculateOffset(::UnityEngine::Vector2 delta);

  /// @brief Method EnsureLayoutHasRebuilt, addr 0x290baa8, size 0x74, virtual false, abstract: false, final false
  inline void EnsureLayoutHasRebuilt();

  /// @brief Method GetBounds, addr 0x290d474, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds GetBounds();

  /// @brief Method GraphicUpdateComplete, addr 0x290b648, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method InternalCalculateOffset, addr 0x290db98, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalGetBounds, addr 0x290da40, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method IsActive, addr 0x290ba28, size 0x80, virtual true, abstract: false, final false
  inline bool IsActive();

  /// @brief Method LateUpdate, addr 0x290c1d4, size 0x594, virtual true, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LayoutComplete, addr 0x290b644, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  static inline ::UnityEngine::UI::ScrollRect* New_ctor();

  /// @brief Method OnBeginDrag, addr 0x290bd74, size 0x12c, virtual true, abstract: false, final false
  inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnDisable, addr 0x290b7f8, size 0x230, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrag, addr 0x290bec0, size 0x224, virtual true, abstract: false, final false
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEnable, addr 0x290b64c, size 0x1ac, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEndDrag, addr 0x290bea0, size 0x20, virtual true, abstract: false, final false
  inline void OnEndDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnInitializePotentialDrag, addr 0x290bd14, size 0x60, virtual true, abstract: false, final false
  inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnRectTransformDimensionsChange, addr 0x290ce20, size 0x4, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method OnScroll, addr 0x290bb6c, size 0x178, virtual true, abstract: false, final false
  inline void OnScroll(::UnityEngine::EventSystems::PointerEventData* data);

  /// @brief Method Rebuild, addr 0x290aadc, size 0x88, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method RubberDelta, addr 0x290c0e4, size 0x3c, virtual false, abstract: false, final false
  static inline float_t RubberDelta(float_t overStretching, float_t viewSize);

  /// @brief Method SetContentAnchoredPosition, addr 0x290c120, size 0xb4, virtual true, abstract: false, final false
  inline void SetContentAnchoredPosition(::UnityEngine::Vector2 position);

  /// @brief Method SetDirty, addr 0x290a754, size 0x88, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method SetDirtyCaching, addr 0x290a378, size 0xb4, virtual false, abstract: false, final false
  inline void SetDirtyCaching();

  /// @brief Method SetHorizontalNormalizedPosition, addr 0x290cb00, size 0x14, virtual false, abstract: false, final false
  inline void SetHorizontalNormalizedPosition(float_t value);

  /// @brief Method SetLayoutHorizontal, addr 0x290cf1c, size 0x558, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x290d570, size 0xdc, virtual true, abstract: false, final false
  inline void SetLayoutVertical();

  /// @brief Method SetNormalizedPosition, addr 0x290cb28, size 0x2f8, virtual true, abstract: false, final false
  inline void SetNormalizedPosition(float_t value, int32_t axis);

  /// @brief Method SetVerticalNormalizedPosition, addr 0x290cb14, size 0x14, virtual false, abstract: false, final false
  inline void SetVerticalNormalizedPosition(float_t value);

  /// @brief Method StopMovement, addr 0x290bb1c, size 0x50, virtual true, abstract: false, final false
  inline void StopMovement();

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x290dd1c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform();

  /// @brief Method UpdateBounds, addr 0x290aedc, size 0x4b4, virtual false, abstract: false, final false
  inline void UpdateBounds();

  /// @brief Method UpdateCachedData, addr 0x290ab64, size 0x378, virtual false, abstract: false, final false
  inline void UpdateCachedData();

  /// @brief Method UpdateOneScrollbarVisibility, addr 0x290d8a0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdatePrevData, addr 0x290b568, size 0xdc, virtual false, abstract: false, final false
  inline void UpdatePrevData();

  /// @brief Method UpdateScrollbarLayout, addr 0x290d64c, size 0x254, virtual false, abstract: false, final false
  inline void UpdateScrollbarLayout();

  /// @brief Method UpdateScrollbarVisibility, addr 0x290c798, size 0x40, virtual false, abstract: false, final false
  inline void UpdateScrollbarVisibility();

  /// @brief Method UpdateScrollbars, addr 0x290b390, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x290a990, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_content, addr 0x290a2dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_content();

  /// @brief Method get_decelerationRate, addr 0x290a348, size 0x8, virtual false, abstract: false, final false
  inline float_t get_decelerationRate();

  /// @brief Method get_elasticity, addr 0x290a324, size 0x8, virtual false, abstract: false, final false
  inline float_t get_elasticity();

  /// @brief Method get_flexibleHeight, addr 0x290cf0c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleHeight();

  /// @brief Method get_flexibleWidth, addr 0x290cef4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleWidth();

  /// @brief Method get_hScrollingNeeded, addr 0x290ce24, size 0x5c, virtual false, abstract: false, final false
  inline bool get_hScrollingNeeded();

  /// @brief Method get_horizontal, addr 0x290a2ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_horizontal();

  /// @brief Method get_horizontalNormalizedPosition, addr 0x290c7d8, size 0x15c, virtual false, abstract: false, final false
  inline float_t get_horizontalNormalizedPosition();

  /// @brief Method get_horizontalScrollbar, addr 0x290a42c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Scrollbar> get_horizontalScrollbar();

  /// @brief Method get_horizontalScrollbarSpacing, addr 0x290a744, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalScrollbarSpacing();

  /// @brief Method get_horizontalScrollbarVisibility, addr 0x290a724, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__ScrollRect__ScrollbarVisibility get_horizontalScrollbarVisibility();

  /// @brief Method get_inertia, addr 0x290a334, size 0x8, virtual false, abstract: false, final false
  inline bool get_inertia();

  /// @brief Method get_layoutPriority, addr 0x290cf14, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_layoutPriority();

  /// @brief Method get_minHeight, addr 0x290cefc, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minHeight();

  /// @brief Method get_minWidth, addr 0x290cee4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minWidth();

  /// @brief Method get_movementType, addr 0x290a314, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__ScrollRect__MovementType get_movementType();

  /// @brief Method get_normalizedPosition, addr 0x290c768, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_normalizedPosition();

  /// @brief Method get_onValueChanged, addr 0x290a7ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__ScrollRect__ScrollRectEvent* get_onValueChanged();

  /// @brief Method get_preferredHeight, addr 0x290cf04, size 0x8, virtual true, abstract: false, final false
  inline float_t get_preferredHeight();

  /// @brief Method get_preferredWidth, addr 0x290ceec, size 0x8, virtual true, abstract: false, final false
  inline float_t get_preferredWidth();

  /// @brief Method get_rectTransform, addr 0x290a8fc, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_scrollSensitivity, addr 0x290a358, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scrollSensitivity();

  /// @brief Method get_vScrollingNeeded, addr 0x290ce80, size 0x5c, virtual false, abstract: false, final false
  inline bool get_vScrollingNeeded();

  /// @brief Method get_velocity, addr 0x290a8ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_velocity();

  /// @brief Method get_vertical, addr 0x290a300, size 0x8, virtual false, abstract: false, final false
  inline bool get_vertical();

  /// @brief Method get_verticalNormalizedPosition, addr 0x290c934, size 0x15c, virtual false, abstract: false, final false
  inline float_t get_verticalNormalizedPosition();

  /// @brief Method get_verticalScrollbar, addr 0x290a5a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Scrollbar> get_verticalScrollbar();

  /// @brief Method get_verticalScrollbarSpacing, addr 0x290a7dc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_verticalScrollbarSpacing();

  /// @brief Method get_verticalScrollbarVisibility, addr 0x290a734, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__ScrollRect__ScrollbarVisibility get_verticalScrollbarVisibility();

  /// @brief Method get_viewRect, addr 0x290a7fc, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_viewRect();

  /// @brief Method get_viewport, addr 0x290a368, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_content, addr 0x290a2e4, size 0x8, virtual false, abstract: false, final false
  inline void set_content(::UnityEngine::RectTransform* value);

  /// @brief Method set_decelerationRate, addr 0x290a350, size 0x8, virtual false, abstract: false, final false
  inline void set_decelerationRate(float_t value);

  /// @brief Method set_elasticity, addr 0x290a32c, size 0x8, virtual false, abstract: false, final false
  inline void set_elasticity(float_t value);

  /// @brief Method set_horizontal, addr 0x290a2f4, size 0xc, virtual false, abstract: false, final false
  inline void set_horizontal(bool value);

  /// @brief Method set_horizontalNormalizedPosition, addr 0x290cad8, size 0x14, virtual false, abstract: false, final false
  inline void set_horizontalNormalizedPosition(float_t value);

  /// @brief Method set_horizontalScrollbar, addr 0x290a434, size 0x174, virtual false, abstract: false, final false
  inline void set_horizontalScrollbar(::UnityEngine::UI::Scrollbar* value);

  /// @brief Method set_horizontalScrollbarSpacing, addr 0x290a74c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScrollbarSpacing(float_t value);

  /// @brief Method set_horizontalScrollbarVisibility, addr 0x290a72c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScrollbarVisibility(::UnityEngine::UI::__ScrollRect__ScrollbarVisibility value);

  /// @brief Method set_inertia, addr 0x290a33c, size 0xc, virtual false, abstract: false, final false
  inline void set_inertia(bool value);

  /// @brief Method set_movementType, addr 0x290a31c, size 0x8, virtual false, abstract: false, final false
  inline void set_movementType(::UnityEngine::UI::__ScrollRect__MovementType value);

  /// @brief Method set_normalizedPosition, addr 0x290ca90, size 0x48, virtual false, abstract: false, final false
  inline void set_normalizedPosition(::UnityEngine::Vector2 value);

  /// @brief Method set_onValueChanged, addr 0x290a7f4, size 0x8, virtual false, abstract: false, final false
  inline void set_onValueChanged(::UnityEngine::UI::__ScrollRect__ScrollRectEvent* value);

  /// @brief Method set_scrollSensitivity, addr 0x290a360, size 0x8, virtual false, abstract: false, final false
  inline void set_scrollSensitivity(float_t value);

  /// @brief Method set_velocity, addr 0x290a8f4, size 0x8, virtual false, abstract: false, final false
  inline void set_velocity(::UnityEngine::Vector2 value);

  /// @brief Method set_vertical, addr 0x290a308, size 0xc, virtual false, abstract: false, final false
  inline void set_vertical(bool value);

  /// @brief Method set_verticalNormalizedPosition, addr 0x290caec, size 0x14, virtual false, abstract: false, final false
  inline void set_verticalNormalizedPosition(float_t value);

  /// @brief Method set_verticalScrollbar, addr 0x290a5b0, size 0x174, virtual false, abstract: false, final false
  inline void set_verticalScrollbar(::UnityEngine::UI::Scrollbar* value);

  /// @brief Method set_verticalScrollbarSpacing, addr 0x290a7e4, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScrollbarSpacing(float_t value);

  /// @brief Method set_verticalScrollbarVisibility, addr 0x290a73c, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScrollbarVisibility(::UnityEngine::UI::__ScrollRect__ScrollbarVisibility value);

  /// @brief Method set_viewport, addr 0x290a370, size 0x8, virtual false, abstract: false, final false
