...
public:
  // Declarations
  /// @brief Method GetMovedFromAttributeDataForType, addr 0x2a86b30, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObsoleteTypeRedirection, addr 0x2a86c70, size 0x2bc, virtual false, abstract: false, final false
