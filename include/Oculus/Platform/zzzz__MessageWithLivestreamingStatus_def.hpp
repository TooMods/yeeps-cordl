...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4400, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingStatus, addr 0x19b43c4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b101c, size 0x58, virtual false, abstract: false, final false
