...
public:
  ...
  /// @brief Method MoveNext, addr 0x24270d0, size 0x358, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2427468, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x24274c0, size 0x494, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2427bcc, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2427bd8, size 0x350, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2428044, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method InnerRead, addr 0x2426f74, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessOperation, addr 0x2426e94, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ProcessOperation(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method RequestRead, addr 0x2426ccc, size 0xc4, virtual false, abstract: false, final false
  inline void RequestRead(int32_t size);

  /// @brief Method RequestWrite, addr 0x2426d90, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method StartOperation, addr 0x2426d9c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2427078, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2426c44, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Net::Security::MobileAuthenticatedStream* parent, bool sync);

  /// @brief Method get_Name, addr 0x2426c10, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Parent, addr 0x2426c00, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Parent();

  /// @brief Method get_RunSynchronously, addr 0x2426c08, size 0x8, virtual false, abstract: false, final false
  inline bool get_RunSynchronously();

  /// @brief Method get_UserResult, addr 0x2426c34, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_UserResult();

  /// @brief Method set_UserResult, addr 0x2426c3c, size 0x8, virtual false, abstract: false, final false
