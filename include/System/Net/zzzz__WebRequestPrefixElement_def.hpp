...
public:
  ...
  /// @brief Method .ctor, addr 0xf52be8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW P, ::System::Net::IWebRequestCreate* C);

  /// @brief Method get_Creator, addr 0xf529e4, size 0x1fc, virtual false, abstract: false, final false
  inline ::System::Net::IWebRequestCreate* get_Creator();

  /// @brief Method set_Creator, addr 0xf52be0, size 0x8, virtual false, abstract: false, final false
