...
public:
  ...
  /// @brief Method AddNonLetter, addr 0x2277c90, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTitlecaseLetter, addr 0x2277b0c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ChangeCase, addr 0x2277dc0, size 0x140, virtual false, abstract: false, final false
  inline void ChangeCase(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination, bool toUpper);

  /// @brief Method Clone, addr 0x2276800, size 0x88, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Equals, addr 0x22776b8, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2277758, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsAscii, addr 0x22769e8, size 0x10, virtual false, abstract: false, final false
  static inline bool IsAscii(char16_t c);

  /// @brief Method IsLetterCategory, addr 0x2277c58, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsLetterCategory(::System::Globalization::UnicodeCategory uc);

  /// @brief Method IsWordSeparator, addr 0x2277c74, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x2276224, size 0xdc, virtual false, abstract: false, final false
  inline void OnDeserialized();

  /// @brief Method OnDeserialized, addr 0x2276770, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x227621c, size 0x8, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x2276774, size 0x7c, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method ReadOnly, addr 0x2276888, size 0xf0, virtual false, abstract: false, final false
  static inline ::System::Globalization::TextInfo* ReadOnly(::System::Globalization::TextInfo* textInfo);

  /// @brief Method SetReadOnlyState, addr 0x2276978, size 0xc, virtual false, abstract: false, final false
  inline void SetReadOnlyState(bool readOnly);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x2277d2c, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method ToLower, addr 0x2276f5c, size 0x58, virtual true, abstract: false, final false
  inline ::StringW ToLower(::StringW str);

  /// @brief Method ToLower, addr 0x2276984, size 0x64, virtual true, abstract: false, final false
  inline char16_t ToLower(char16_t c);

  /// @brief Method ToLowerAsciiInvariant, addr 0x2276afc, size 0x1c, virtual false, abstract: false, final false
  static inline char16_t ToLowerAsciiInvariant(char16_t c);

  /// @brief Method ToLowerInternal, addr 0x2276fb4, size 0xe4, virtual false, abstract: false, final false
  inline ::StringW ToLowerInternal(::StringW str);

  /// @brief Method ToLowerInternal, addr 0x2276b18, size 0x444, virtual false, abstract: false, final false
  inline char16_t ToLowerInternal(char16_t c);

  /// @brief Method ToString, addr 0x2277778, size 0x58, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTitleCase, addr 0x22777d0, size 0x33c, virtual false, abstract: false, final false
  inline ::StringW ToTitleCase(::StringW str);

  /// @brief Method ToUpper, addr 0x227757c, size 0x58, virtual true, abstract: false, final false
  inline ::StringW ToUpper(::StringW str);

  /// @brief Method ToUpper, addr 0x2277098, size 0x64, virtual true, abstract: false, final false
  inline char16_t ToUpper(char16_t c);

  /// @brief Method ToUpperAsciiInvariant, addr 0x22770fc, size 0x1c, virtual false, abstract: false, final false
  static inline char16_t ToUpperAsciiInvariant(char16_t c);

  /// @brief Method ToUpperAsciiInvariant, addr 0x2277d30, size 0x90, virtual false, abstract: false, final false
  inline void ToUpperAsciiInvariant(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination);

  /// @brief Method ToUpperInternal, addr 0x22775d4, size 0xe4, virtual false, abstract: false, final false
  inline ::StringW ToUpperInternal(::StringW str);

  /// @brief Method ToUpperInternal, addr 0x2277118, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2277f00, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x22761e0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CultureName, addr 0x22767f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_Invariant, addr 0x2275da0, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Globalization::TextInfo* get_Invariant();

  /// @brief Method get_IsAsciiCasingSameAsInvariant, addr 0x22769f8, size 0x104, virtual false, abstract: false, final false
  inline bool get_IsAsciiCasingSameAsInvariant();

  /// @brief Method get_IsReadOnly, addr 0x22767f8, size 0x8, virtual false, abstract: false, final false
