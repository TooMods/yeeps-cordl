...
public:
  ...
  /// @brief Method .ctor, addr 0x2f64dbc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x2f64de4, size 0x8, virtual true, abstract: false, final false
