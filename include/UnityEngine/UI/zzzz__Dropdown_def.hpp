...
public:
  ...
  /// @brief Method OnCancel, addr 0x2000b18, size 0xac, virtual true, abstract: false, final false
  inline void OnCancel(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x2000a9c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2000bc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_image, addr 0x2000a6c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Image> get_image();

  /// @brief Method get_rectTransform, addr 0x2000a7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_text, addr 0x2000a5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Text> get_text();

  /// @brief Method get_toggle, addr 0x2000a8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_image, addr 0x2000a74, size 0x8, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::UI::Image* value);

  /// @brief Method set_rectTransform, addr 0x2000a84, size 0x8, virtual false, abstract: false, final false
  inline void set_rectTransform(::UnityEngine::RectTransform* value);

  /// @brief Method set_text, addr 0x2000a64, size 0x8, virtual false, abstract: false, final false
  inline void set_text(::UnityEngine::UI::Text* value);

  /// @brief Method set_toggle, addr 0x2000a94, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1ffd168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ffe830, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Sprite* image);

  /// @brief Method .ctor, addr 0x1ffe6ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x2000bec, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW text, ::UnityEngine::Sprite* image);

  /// @brief Method get_image, addr 0x2000bdc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_image();

  /// @brief Method get_text, addr 0x2000bcc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_image, addr 0x2000be4, size 0x8, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::Sprite* value);

  /// @brief Method set_text, addr 0x2000bd4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1ffe08c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_options, addr 0x2000c18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__OptionData*>* get_options();

  /// @brief Method set_options, addr 0x2000c20, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1ffe10c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Show>b__0, addr 0x2000c28, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fffc68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2000c50, size 0xac, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::__Dropdown___DelayedDestroyDropdownList_d__75* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2000cfc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2000d04, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2000d44, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2000c4c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2000888, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddItem, addr 0x1fffc70, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOptions, addr 0x1ffe550, size 0x15c, virtual false, abstract: false, final false
  inline void AddOptions(::System::Collections::Generic::List_1<::StringW>* options);

  /// @brief Method AddOptions, addr 0x1ffe4e8, size 0x68, virtual false, abstract: false, final false
  inline void AddOptions(::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__OptionData*>* options);

  /// @brief Method AddOptions, addr 0x1ffe6d4, size 0x15c, virtual false, abstract: false, final false
  inline void AddOptions(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Sprite>>* options);

  /// @brief Method AlphaFadeList, addr 0x20006dc, size 0x80, virtual false, abstract: false, final false
  inline void AlphaFadeList(float_t duration, float_t alpha);

  /// @brief Method AlphaFadeList, addr 0x1ffff5c, size 0x128, virtual false, abstract: false, final false
  inline void AlphaFadeList(float_t duration, float_t start, float_t end);

  /// @brief Method Awake, addr 0x1ffe154, size 0xfc, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ClearOptions, addr 0x1ffe858, size 0x78, virtual false, abstract: false, final false
  inline void ClearOptions();

  /// @brief Method CreateBlocker, addr 0x2000084, size 0x4cc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> CreateBlocker(::UnityEngine::Canvas* rootCanvas);

  /// @brief Method CreateDropdownList, addr 0x20005a8, size 0x6c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> CreateDropdownList(::UnityEngine::GameObject* _cordl_template);

  /// @brief Method CreateItem, addr 0x200066c, size 0x6c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::__Dropdown__DropdownItem> CreateItem(::UnityEngine::UI::__Dropdown__DropdownItem* itemTemplate);

  /// @brief Method DelayedDestroyDropdownList, addr 0x2000810, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DelayedDestroyDropdownList(float_t delay);

  /// @brief Method DestroyBlocker, addr 0x2000550, size 0x58, virtual true, abstract: false, final false
  inline void DestroyBlocker(::UnityEngine::GameObject* blocker);

  /// @brief Method DestroyDropdownList, addr 0x2000614, size 0x58, virtual true, abstract: false, final false
  inline void DestroyDropdownList(::UnityEngine::GameObject* dropdownList);

  /// @brief Method DestroyItem, addr 0x20006d8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Hide, addr 0x1fffb6c, size 0xfc, virtual false, abstract: false, final false
  inline void Hide();

  /// @brief Method ImmediateDestroyDropdownList, addr 0x1ffe378, size 0x170, virtual false, abstract: false, final false
  inline void ImmediateDestroyDropdownList();

  static inline ::UnityEngine::UI::Dropdown* New_ctor();

  /// @brief Method OnCancel, addr 0x1fffb68, size 0x4, virtual true, abstract: false, final false
  inline void OnCancel(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnDisable, addr 0x1ffe2e4, size 0x94, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerClick, addr 0x1ffef48, size 0x4, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSelectItem, addr 0x20008b0, size 0x134, virtual false, abstract: false, final false
  inline void OnSelectItem(::UnityEngine::UI::Toggle* toggle);

  /// @brief Method OnSubmit, addr 0x1fffb64, size 0x4, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method RefreshShownValue, addr 0x1ffd170, size 0x1dc, virtual false, abstract: false, final false
  inline void RefreshShownValue();

  /// @brief Method Set, addr 0x1ffde70, size 0x110, virtual false, abstract: false, final false
  inline void Set(int32_t value, bool sendCallback);

  /// @brief Method SetAlpha, addr 0x200075c, size 0xb4, virtual false, abstract: false, final false
  inline void SetAlpha(float_t alpha);

  /// @brief Method SetValueWithoutNotify, addr 0x1ffdf80, size 0x8, virtual false, abstract: false, final false
  inline void SetValueWithoutNotify(int32_t input);

  /// @brief Method SetupTemplate, addr 0x1ffe8d0, size 0x678, virtual false, abstract: false, final false
  inline void SetupTemplate(::UnityEngine::Canvas* rootCanvas);

  /// @brief Method Show, addr 0x1ffef4c, size 0xc18, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method Start, addr 0x1ffe250, size 0x94, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x1ffdf88, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UI::__Dropdown__OptionData* getStaticF_s_NoOptionData();

  /// @brief Method get_alphaFadeSpeed, addr 0x1ffde50, size 0x8, virtual false, abstract: false, final false
  inline float_t get_alphaFadeSpeed();

  /// @brief Method get_captionImage, addr 0x1ffddfc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Image> get_captionImage();

  /// @brief Method get_captionText, addr 0x1ffddf4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Text> get_captionText();

  /// @brief Method get_itemImage, addr 0x1ffde14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Image> get_itemImage();

  /// @brief Method get_itemText, addr 0x1ffde0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Text> get_itemText();

  /// @brief Method get_onValueChanged, addr 0x1ffde40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__Dropdown__DropdownEvent* get_onValueChanged();

  /// @brief Method get_options, addr 0x1ffd14c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__OptionData*>* get_options();

  /// @brief Method get_template, addr 0x1ffddec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_template();

  /// @brief Method get_value, addr 0x1ffde60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_alphaFadeSpeed, addr 0x1ffde58, size 0x8, virtual false, abstract: false, final false
  inline void set_alphaFadeSpeed(float_t value);

  /// @brief Method set_captionImage, addr 0x1ffde04, size 0x8, virtual false, abstract: false, final false
  inline void set_captionImage(::UnityEngine::UI::Image* value);

  /// @brief Method set_captionText, addr 0x1ffd13c, size 0x8, virtual false, abstract: false, final false
  inline void set_captionText(::UnityEngine::UI::Text* value);

  /// @brief Method set_itemImage, addr 0x1ffde1c, size 0x8, virtual false, abstract: false, final false
  inline void set_itemImage(::UnityEngine::UI::Image* value);

  /// @brief Method set_itemText, addr 0x1ffd144, size 0x8, virtual false, abstract: false, final false
  inline void set_itemText(::UnityEngine::UI::Text* value);

  /// @brief Method set_onValueChanged, addr 0x1ffde48, size 0x8, virtual false, abstract: false, final false
  inline void set_onValueChanged(::UnityEngine::UI::__Dropdown__DropdownEvent* value);

  /// @brief Method set_options, addr 0x1ffde24, size 0x1c, virtual false, abstract: false, final false
  inline void set_options(::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__OptionData*>* value);

  /// @brief Method set_template, addr 0x1ffd134, size 0x8, virtual false, abstract: false, final false
  inline void set_template(::UnityEngine::RectTransform* value);

  /// @brief Method set_value, addr 0x1ffde68, size 0x8, virtual false, abstract: false, final false
