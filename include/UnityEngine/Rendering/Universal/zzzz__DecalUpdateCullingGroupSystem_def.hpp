...
public:
  ...
  /// @brief Method Execute, addr 0x2e18934, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x2e1876c, size 0x1c8, virtual false, abstract: false, final false
  inline void Execute(::UnityEngine::Camera* camera);

  /// @brief Method GetSceneCullingMaskFromCamera, addr 0x2e18a74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e18690, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::Universal::DecalEntityManager* entityManager, float_t drawDistance);

  /// @brief Method get_boundingDistance, addr 0x2e18640, size 0x28, virtual false, abstract: false, final false
  inline float_t get_boundingDistance();

  /// @brief Method set_boundingDistance, addr 0x2e18668, size 0x28, virtual false, abstract: false, final false
