...
public:
  ...
  /// @brief Method .ctor, addr 0x1b470b8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW cultureName);

  /// @brief Method get_CultureName, addr 0x1b47134, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_Location, addr 0x1b4713c, size 0x8, virtual false, abstract: false, final false
