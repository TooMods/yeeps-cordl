...
public:
  ...
  __declspec(property(get = get_CreateNoWindow, put = set_CreateNoWindow)) bool CreateNoWindow;
  ...
  /// @brief Method .ctor, addr 0x12bf0b4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12bb890, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Diagnostics::Process* parent);

  static inline ::ArrayW<::StringW, ::Array<::StringW>*> getStaticF_empty();

  /// @brief Method get_ArgumentList, addr 0x12bef38, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::Collection_1<::StringW>* get_ArgumentList();

  /// @brief Method get_Arguments, addr 0x12befb8, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_Arguments();

  /// @brief Method get_CreateNoWindow, addr 0x12bf0cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_CreateNoWindow();

  /// @brief Method get_Domain, addr 0x12bf060, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_Domain();

  /// @brief Method get_EnvironmentVariables, addr 0x12be9c8, size 0x570, virtual false, abstract: false, final false
  inline ::System::Collections::Specialized::StringDictionary* get_EnvironmentVariables();

  /// @brief Method get_FileName, addr 0x12bc894, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_HaveEnvVars, addr 0x12be9b8, size 0x10, virtual false, abstract: false, final false
  inline bool get_HaveEnvVars();

  /// @brief Method get_LoadUserProfile, addr 0x12bf148, size 0x8, virtual false, abstract: false, final false
  inline bool get_LoadUserProfile();

  /// @brief Method get_Password, addr 0x12bf140, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::SecureString* get_Password();

  /// @brief Method get_RedirectStandardError, addr 0x12bf108, size 0x8, virtual false, abstract: false, final false
  inline bool get_RedirectStandardError();

  /// @brief Method get_RedirectStandardInput, addr 0x12bf0e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_RedirectStandardInput();

  /// @brief Method get_RedirectStandardOutput, addr 0x12bf0f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_RedirectStandardOutput();

  /// @brief Method get_StandardErrorEncoding, addr 0x12bf11c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_StandardErrorEncoding();

  /// @brief Method get_StandardInputEncoding, addr 0x12bf2d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_StandardInputEncoding();

  /// @brief Method get_StandardOutputEncoding, addr 0x12bf124, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_StandardOutputEncoding();

  /// @brief Method get_UseShellExecute, addr 0x12bf12c, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseShellExecute();

  /// @brief Method get_UserName, addr 0x12be654, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_UserName();

  /// @brief Method get_WorkingDirectory, addr 0x12bf00c, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_WorkingDirectory();

  static inline void setStaticF_empty(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_Arguments, addr 0x12bf0c4, size 0x8, virtual false, abstract: false, final false
  inline void set_Arguments(::StringW value);

  /// @brief Method set_CreateNoWindow, addr 0x12bf0d4, size 0xc, virtual false, abstract: false, final false
  inline void set_CreateNoWindow(bool value);

  /// @brief Method set_FileName, addr 0x12bf150, size 0x8, virtual false, abstract: false, final false
  inline void set_FileName(::StringW value);

  /// @brief Method set_RedirectStandardError, addr 0x12bf110, size 0xc, virtual false, abstract: false, final false
  inline void set_RedirectStandardError(bool value);

  /// @brief Method set_RedirectStandardInput, addr 0x12bf0e8, size 0xc, virtual false, abstract: false, final false
  inline void set_RedirectStandardInput(bool value);

  /// @brief Method set_RedirectStandardOutput, addr 0x12bf0fc, size 0xc, virtual false, abstract: false, final false
  inline void set_RedirectStandardOutput(bool value);

  /// @brief Method set_UseShellExecute, addr 0x12bf134, size 0xc, virtual false, abstract: false, final false
  inline void set_UseShellExecute(bool value);

  /// @brief Method set_WindowStyle, addr 0x12bf158, size 0x178, virtual false, abstract: false, final false
