...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x1ce79c0, size 0x4, virtual true, abstract: false, final false
  inline void AddAnnotation(::System::Xml::Schema::XmlSchemaAnnotation* annotation);

  /// @brief Method Clone, addr 0x1ce79e4, size 0x80, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  static inline ::System::Xml::Schema::XmlSchemaObject* New_ctor();

  /// @brief Method OnAdd, addr 0x1ce79a4, size 0x4, virtual true, abstract: false, final false
  inline void OnAdd(::System::Xml::Schema::XmlSchemaObjectCollection* container, ::System::Object* item);

  /// @brief Method OnClear, addr 0x1ce79ac, size 0x4, virtual true, abstract: false, final false
  inline void OnClear(::System::Xml::Schema::XmlSchemaObjectCollection* container);

  /// @brief Method OnRemove, addr 0x1ce79a8, size 0x4, virtual true, abstract: false, final false
  inline void OnRemove(::System::Xml::Schema::XmlSchemaObjectCollection* container, ::System::Object* item);

  /// @brief Method SetUnhandledAttributes, addr 0x1ce79bc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cdfe6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IdAttribute, addr 0x1ce79b0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IdAttribute();

  /// @brief Method get_IsProcessing, addr 0x1ce79d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsProcessing();

  /// @brief Method get_LineNumber, addr 0x1ce795c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x1ce796c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_NameAttribute, addr 0x1ce79c4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_Namespaces, addr 0x1ce06e4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializerNamespaces* get_Namespaces();

  /// @brief Method get_Parent, addr 0x1ce798c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* get_Parent();

  /// @brief Method get_SourceUri, addr 0x1ce797c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SourceUri();

  /// @brief Method set_IdAttribute, addr 0x1ce79b8, size 0x4, virtual true, abstract: false, final false
  inline void set_IdAttribute(::StringW value);

  /// @brief Method set_IsProcessing, addr 0x1ce79d8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsProcessing(bool value);

  /// @brief Method set_LineNumber, addr 0x1ce7964, size 0x8, virtual false, abstract: false, final false
  inline void set_LineNumber(int32_t value);

  /// @brief Method set_LinePosition, addr 0x1ce7974, size 0x8, virtual false, abstract: false, final false
  inline void set_LinePosition(int32_t value);

  /// @brief Method set_NameAttribute, addr 0x1ce79cc, size 0x4, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Namespaces, addr 0x1ce799c, size 0x8, virtual false, abstract: false, final false
  inline void set_Namespaces(::System::Xml::Serialization::XmlSerializerNamespaces* value);

  /// @brief Method set_Parent, addr 0x1ce7994, size 0x8, virtual false, abstract: false, final false
  inline void set_Parent(::System::Xml::Schema::XmlSchemaObject* value);

  /// @brief Method set_SourceUri, addr 0x1ce7984, size 0x8, virtual false, abstract: false, final false
