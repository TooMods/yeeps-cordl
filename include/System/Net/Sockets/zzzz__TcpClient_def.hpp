...
public:
  ...
  /// @brief Method BeginConnect, addr 0x2c8e014, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x2c8e380, size 0xa4, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Connect, addr 0x2c8d838, size 0x6d0, virtual false, abstract: false, final false
  inline void Connect(::StringW hostname, int32_t port);

  /// @brief Method Connect, addr 0x2c8df08, size 0x10c, virtual false, abstract: false, final false
  inline void Connect(::System::Net::IPEndPoint* remoteEP);

  /// @brief Method ConnectAsync, addr 0x2c8e0c8, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ConnectAsync(::StringW host, int32_t port);

  /// @brief Method Dispose, addr 0x2c8e5b8, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2c8e424, size 0x194, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndConnect, addr 0x2c8e080, size 0x48, virtual false, abstract: false, final false
  inline void EndConnect(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x2c8e5c8, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetStream, addr 0x2c8e234, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c8d624, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2c8d7c8, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* acceptedSocket);

  /// @brief Method .ctor, addr 0x2c8d644, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::AddressFamily family);

  /// @brief Method get_Client, addr 0x2c8d80c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_Client();

  /// @brief Method get_Connected, addr 0x2c8d81c, size 0x1c, virtual false, abstract: false, final false
  inline bool get_Connected();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method initialize, addr 0x2c8d754, size 0x74, virtual false, abstract: false, final false
  inline void initialize();

  /// @brief Method set_Client, addr 0x2c8d814, size 0x8, virtual false, abstract: false, final false
