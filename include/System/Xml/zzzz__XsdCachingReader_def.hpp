...
public:
  ...
  /// @brief Method AddAttribute, addr 0xfeab68, size 0x15c, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* AddAttribute(int32_t attIndex);

  /// @brief Method AddContent, addr 0xfe983c, size 0x174, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* AddContent(::System::Xml::XmlNodeType nodeType);

  /// @brief Method ClearAttributesInfo, addr 0xfea538, size 0x10, virtual false, abstract: false, final false
  inline void ClearAttributesInfo();

  /// @brief Method Close, addr 0xfea850, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CreateDummyTextNode, addr 0xfeaa70, size 0x88, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* CreateDummyTextNode(::StringW attributeValue, int32_t depth);

  /// @brief Method GetAttribute, addr 0xfe9fcc, size 0x94, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0xfe9cd8, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0xfe9eb4, size 0x118, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW namespaceURI);

  /// @brief Method GetAttributeIndexWithPrefix, addr 0xfe9e14, size 0xa0, virtual false, abstract: false, final false
  inline int32_t GetAttributeIndexWithPrefix(::StringW name);

  /// @brief Method GetAttributeIndexWithoutPrefix, addr 0xfe9d64, size 0xb0, virtual false, abstract: false, final false
  inline int32_t GetAttributeIndexWithoutPrefix(::StringW name);

  /// @brief Method GetCoreReader, addr 0xfeab58, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReader* GetCoreReader();

  /// @brief Method GetLineInfo, addr 0xfeab60, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::IXmlLineInfo* GetLineInfo();

  /// @brief Method Init, addr 0xfe96ec, size 0x150, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method LookupNamespace, addr 0xfea9c4, size 0x24, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0xfea060, size 0x90, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0xfea0f0, size 0x94, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0xfea220, size 0x54, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0xfea184, size 0x44, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0xfea1c8, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0xfea274, size 0x2c4, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeValue, addr 0xfeaa28, size 0x48, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadOriginalContentAsString, addr 0xfea7f0, size 0x24, virtual false, abstract: false, final false
  inline ::StringW ReadOriginalContentAsString();

  /// @brief Method RecordAttributes, addr 0xfe99b0, size 0x178, virtual false, abstract: false, final false
  inline void RecordAttributes();

  /// @brief Method RecordEndElementNode, addr 0xfea6c0, size 0x130, virtual false, abstract: false, final false
  inline void RecordEndElementNode();

  /// @brief Method RecordTextNode, addr 0xfea548, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfe9b28, size 0x8, virtual false, abstract: false, final false
  inline void Reset(::System::Xml::XmlReader* reader);

  /// @brief Method ResolveEntity, addr 0xfea9e8, size 0x40, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method SetToReplayMode, addr 0xfeab38, size 0x20, virtual false, abstract: false, final false
  inline void SetToReplayMode();

  /// @brief Method Skip, addr 0xfea8a8, size 0x114, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method SwitchTextNodeAndEndElement, addr 0xfea5c0, size 0x100, virtual false, abstract: false, final false
  inline void SwitchTextNodeAndEndElement(::StringW textValue, ::StringW originalStringValue);

  /// @brief Method System.Xml.IXmlLineInfo.HasLineInfo, addr 0xfeaaf8, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IXmlLineInfo_HasLineInfo();

  /// @brief Method System.Xml.IXmlLineInfo.get_LineNumber, addr 0xfeab00, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IXmlLineInfo_get_LineNumber();

  /// @brief Method System.Xml.IXmlLineInfo.get_LinePosition, addr 0xfeab1c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfe9630, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeCount, addr 0xfe9cd0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0xfe9c30, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_Depth, addr 0xfe9c14, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_EOF, addr 0xfea814, size 0x3c, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_IsDefault, addr 0xfe9c5c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0xfe9c54, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LocalName, addr 0xfe9b90, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xfe9b6c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0xfea9bc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0xfe9bac, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0xfe9b50, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0xfe9bc8, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0xfe9c64, size 0x24, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0xfea884, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_Settings, addr 0xfe9b30, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_Value, addr 0xfe9be4, size 0x30, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XmlLang, addr 0xfe9cac, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0xfe9c88, size 0x24, virtual true, abstract: false, final false
