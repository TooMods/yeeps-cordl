...
public:
  ...
  /// @brief Method .ctor, addr 0x1238534, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InvalidStatusCode, addr 0x1238520, size 0x14, virtual false, abstract: false, final false
  inline bool get_InvalidStatusCode();

  /// @brief Method get_PermanentFailure, addr 0x123850c, size 0x14, virtual false, abstract: false, final false
  inline bool get_PermanentFailure();

  /// @brief Method get_PositiveCompletion, addr 0x12384e4, size 0x14, virtual false, abstract: false, final false
  inline bool get_PositiveCompletion();

  /// @brief Method get_PositiveIntermediate, addr 0x12384d0, size 0x14, virtual false, abstract: false, final false
  inline bool get_PositiveIntermediate();

  /// @brief Method get_TransientFailure, addr 0x12384f8, size 0x14, virtual false, abstract: false, final false
