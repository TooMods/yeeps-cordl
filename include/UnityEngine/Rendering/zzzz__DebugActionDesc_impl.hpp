...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::DebugActionDesc::*)()>(&::UnityEngine::Rendering::DebugActionDesc::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1bd2cc4;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> const& UnityEngine::Rendering::DebugActionDesc::__cordl_internal_get_buttonAction() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___buttonAction;
}
