...
public:
  ...
  /// @brief Method CreateCopy, addr 0x10ed598, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Threading::SynchronizationContext* CreateCopy();

  /// @brief Method GetThreadLocalContext, addr 0x10ed3c0, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Threading::SynchronizationContext* GetThreadLocalContext();

  /// @brief Method IsWaitNotificationRequired, addr 0x10ed150, size 0xc, virtual false, abstract: false, final false
  inline bool IsWaitNotificationRequired();

  static inline ::System::Threading::SynchronizationContext* New_ctor();

  /// @brief Method OperationCompleted, addr 0x10ed218, size 0x4, virtual true, abstract: false, final false
  inline void OperationCompleted();

  /// @brief Method OperationStarted, addr 0x10ed214, size 0x4, virtual true, abstract: false, final false
  inline void OperationStarted();

  /// @brief Method Post, addr 0x10ed184, size 0x90, virtual true, abstract: false, final false
  inline void Post(::System::Threading::SendOrPostCallback* d, ::System::Object* state);

  /// @brief Method Send, addr 0x10ed15c, size 0x28, virtual true, abstract: false, final false
  inline void Send(::System::Threading::SendOrPostCallback* d, ::System::Object* state);

  /// @brief Method SetSynchronizationContext, addr 0x10ed30c, size 0x28, virtual false, abstract: false, final false
  static inline void SetSynchronizationContext(::System::Threading::SynchronizationContext* syncContext);

  /// @brief Method Wait, addr 0x10ed21c, size 0x64, virtual true, abstract: false, final false
  inline int32_t Wait(::ArrayW<void*, ::Array<void*>*> waitHandles, bool waitAll, int32_t millisecondsTimeout);

  /// @brief Method WaitHelper, addr 0x10ed280, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10ed148, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Current, addr 0x10e552c, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Threading::SynchronizationContext* get_Current();

  /// @brief Method get_CurrentExplicit, addr 0x10ed5f4, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Threading::SynchronizationContext* get_CurrentExplicit();

  /// @brief Method get_CurrentNoFlow, addr 0x10ed40c, size 0x30, virtual false, abstract: false, final false
