...
public:
  // Declarations
  /// @brief Method AppendArgument, addr 0x170e8c4, size 0x1dc, virtual false, abstract: false, final false
  static inline void AppendArgument(::System::Text::StringBuilder* stringBuilder, ::StringW argument);

  /// @brief Method ContainsNoWhitespaceOrQuotes, addr 0x170eaa0, size 0xc0, virtual false, abstract: false, final false
