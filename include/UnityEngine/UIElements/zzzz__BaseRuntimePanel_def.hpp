...
public:
  ...
  /// @brief Method <.cctor>b__44_0, addr 0x27c9c3c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 __cctor_b__44_0(::UnityEngine::Vector2 p);

  /// @brief Method .ctor, addr 0x27c9c34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AssignPanelToComponents, addr 0x27c8c40, size 0x32c, virtual false, abstract: false, final false
  inline void AssignPanelToComponents(::UnityEngine::UIElements::BaseRuntimePanel* panel);

  /// @brief Method Dispose, addr 0x27c9318, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method PointerEntersPanel, addr 0x27c9a58, size 0xa0, virtual false, abstract: false, final false
  inline void PointerEntersPanel(int32_t pointerId, ::UnityEngine::Vector2 position);

  /// @brief Method PointerLeavesPanel, addr 0x27c9998, size 0xc0, virtual false, abstract: false, final false
  inline void PointerLeavesPanel(int32_t pointerId, ::UnityEngine::Vector2 position);

  /// @brief Method Repaint, addr 0x27c95d8, size 0x1e8, virtual true, abstract: false, final false
  inline void Repaint(::UnityEngine::Event* e);

  /// @brief Method ScreenToPanel, addr 0x27c9840, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 ScreenToPanel(::UnityEngine::Vector2 screen);

  /// @brief Method ScreenToPanel, addr 0x27c9894, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27c9208, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ScriptableObject* ownerObject, ::UnityEngine::UIElements::EventDispatcher* dispatcher);

  /// @brief Method add_destroyed, addr 0x27c90c8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_drawToCameras, addr 0x27c9378, size 0x8, virtual false, abstract: false, final false
  inline bool get_drawToCameras();

  /// @brief Method get_screenRenderingHeight, addr 0x27c950c, size 0xcc, virtual false, abstract: false, final false
  inline int32_t get_screenRenderingHeight();

  /// @brief Method get_screenRenderingWidth, addr 0x27c9440, size 0xcc, virtual false, abstract: false, final false
  inline int32_t get_screenRenderingWidth();

  /// @brief Method get_screenToPanelSpace, addr 0x27c97c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::UnityEngine::Vector2, ::UnityEngine::Vector2>* get_screenToPanelSpace();

  /// @brief Method get_selectableGameObject, addr 0x27c8b9c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::GameObject> get_selectableGameObject();

  /// @brief Method get_sortingPriority, addr 0x27c8f6c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sortingPriority();

  /// @brief Method get_standardWorldSpaceShader, addr 0x27c9370, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_standardWorldSpaceShader();

  /// @brief Method get_targetDisplay, addr 0x27c9430, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_targetDisplay();

  /// @brief Method remove_destroyed, addr 0x27c9168, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_drawToCameras, addr 0x27c9380, size 0xb0, virtual false, abstract: false, final false
  inline void set_drawToCameras(bool value);

  /// @brief Method set_screenToPanelSpace, addr 0x27c97c8, size 0x78, virtual false, abstract: false, final false
  inline void set_screenToPanelSpace(::System::Func_2<::UnityEngine::Vector2, ::UnityEngine::Vector2>* value);

  /// @brief Method set_selectableGameObject, addr 0x27c8ba4, size 0x9c, virtual true, abstract: false, final true
  inline void set_selectableGameObject(::UnityEngine::GameObject* value);

  /// @brief Method set_sortingPriority, addr 0x27c8f74, size 0xf8, virtual false, abstract: false, final false
  inline void set_sortingPriority(float_t value);

  /// @brief Method set_targetDisplay, addr 0x27c9438, size 0x8, virtual false, abstract: false, final false
