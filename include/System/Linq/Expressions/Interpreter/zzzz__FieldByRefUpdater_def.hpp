...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x1b4e49c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x1b4e3f8, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b4e3b0, size 0x48, virtual false, abstract: false, final false
