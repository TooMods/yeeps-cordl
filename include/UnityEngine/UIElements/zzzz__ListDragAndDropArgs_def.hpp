...
public:
  ...
  /// @brief Method get_dragAndDropData, addr 0x27d9c20, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IDragAndDropData* get_dragAndDropData();

  /// @brief Method get_dragAndDropPosition, addr 0x27d9c10, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::DragAndDropPosition get_dragAndDropPosition();

  /// @brief Method get_insertAtIndex, addr 0x27d9c00, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_dragAndDropData, addr 0x27d9c28, size 0x8, virtual false, abstract: false, final false
  inline void set_dragAndDropData(::UnityEngine::UIElements::IDragAndDropData* value);

  /// @brief Method set_dragAndDropPosition, addr 0x27d9c18, size 0x8, virtual false, abstract: false, final false
  inline void set_dragAndDropPosition(::UnityEngine::UIElements::DragAndDropPosition value);

  /// @brief Method set_insertAtIndex, addr 0x27d9c08, size 0x8, virtual false, abstract: false, final false
  inline void set_insertAtIndex(int32_t value);

  /// @brief Method set_target, addr 0x27d9bf8, size 0x8, virtual false, abstract: false, final false
