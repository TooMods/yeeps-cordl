...
public:
  ...
  /// @brief Method Dispose, addr 0x2094b58, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2094bc4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2094bc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_panelChanged, addr 0x20949ac, size 0xb0, virtual false, abstract: false, final false
  inline void add_panelChanged(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>* value);

  /// @brief Method get_panel, addr 0x2094b0c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_visualTree, addr 0x2094b34, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_panelChanged, addr 0x2094a5c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_panelChanged(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>* value);

  /// @brief Method set_panel, addr 0x2094b14, size 0x20, virtual true, abstract: false, final true
