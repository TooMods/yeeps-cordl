...
public:
  ...
  /// @brief Method Awake, addr 0x16ecce0, size 0x170, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Hide, addr 0x16ecfe4, size 0x11c, virtual false, abstract: false, final false
  inline void Hide();

  /// @brief Method LateUpdate, addr 0x16ed41c, size 0x178, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OVRGazePointer* New_ctor();

  /// @brief Method RequestHide, addr 0x16ed594, size 0x2c, virtual false, abstract: false, final false
  inline void RequestHide();

  /// @brief Method RequestShow, addr 0x16ed3f8, size 0x20, virtual false, abstract: false, final false
  inline void RequestShow();

  /// @brief Method SetCursorRay, addr 0x16ed418, size 0x4, virtual true, abstract: false, final false
  inline void SetCursorRay(::UnityEngine::Transform* ray);

  /// @brief Method SetCursorStartDest, addr 0x16ed218, size 0x1e0, virtual true, abstract: false, final false
  inline void SetCursorStartDest(::UnityEngine::Vector3 _, ::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method Show, addr 0x16ed100, size 0x118, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method Update, addr 0x16ece50, size 0x194, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16ed5c0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::GlobalNamespace::OVRGazePointer> getStaticF__instance();

  /// @brief Method get_SelectionProgress, addr 0x16ecbe8, size 0x78, virtual false, abstract: false, final false
  inline float_t get_SelectionProgress();

  /// @brief Method get_currentScale, addr 0x16ec928, size 0x8, virtual false, abstract: false, final false
  inline float_t get_currentScale();

  /// @brief Method get_hidden, addr 0x16ec914, size 0x8, virtual false, abstract: false, final false
  inline bool get_hidden();

  /// @brief Method get_instance, addr 0x16ec938, size 0x214, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRGazePointer> get_instance();

  /// @brief Method get_visibilityStrength, addr 0x16ecb4c, size 0x9c, virtual false, abstract: false, final false
  inline float_t get_visibilityStrength();

  static inline void setStaticF__instance(::UnityW<::GlobalNamespace::OVRGazePointer> value);

  /// @brief Method set_SelectionProgress, addr 0x16ecc60, size 0x80, virtual false, abstract: false, final false
  inline void set_SelectionProgress(float_t value);

  /// @brief Method set_currentScale, addr 0x16ec930, size 0x8, virtual false, abstract: false, final false
  inline void set_currentScale(float_t value);

  /// @brief Method set_hidden, addr 0x16ec91c, size 0xc, virtual false, abstract: false, final false
