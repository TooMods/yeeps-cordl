...
public:
  ...
  /// @brief Method Run, addr 0x1b57c44, size 0x20c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1b57bc4, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::ConstructorInfo* target, int32_t argumentCount,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*, ::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*> byrefArgs);

  /// @brief Method get_InstructionName, addr 0x1b57c04, size 0x40, virtual true, abstract: false, final false
