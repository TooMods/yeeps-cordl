...
public:
  ...
  /// @brief Method CheckUnityVersionCompatibility, addr 0x21eb104, size 0x2dc, virtual false, abstract: false, final false
  inline bool CheckUnityVersionCompatibility();

  /// @brief Method Deinitialize, addr 0x21eb588, size 0x7c, virtual true, abstract: false, final false
  inline bool Deinitialize();

  /// @brief Method GetSettings, addr 0x21eb7fc, size 0x48, virtual false, abstract: false, final false
  inline ::UnityW<::Unity::XR::Oculus::OculusSettings> GetSettings();

  /// @brief Method Initialize, addr 0x21eadb8, size 0x34c, virtual true, abstract: false, final false
  inline bool Initialize();

  /// @brief Method IsDeviceSupported, addr 0x21eac44, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method RuntimeLoadOVRPlugin, addr 0x21eb680, size 0x178, virtual false, abstract: false, final false
  static inline void RuntimeLoadOVRPlugin();

  /// @brief Method Start, addr 0x21eb490, size 0x7c, virtual true, abstract: false, final false
  inline bool Start();

  /// @brief Method Stop, addr 0x21eb50c, size 0x7c, virtual true, abstract: false, final false
  inline bool Stop();

  /// @brief Method .ctor, addr 0x21eb844, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_displaySubsystem, addr 0x21eacd8, size 0x70, virtual false, abstract: false, final false
  inline Il2CppObject* get_displaySubsystem();

  /// @brief Method get_inputSubsystem, addr 0x21ead48, size 0x70, virtual false, abstract: false, final false
