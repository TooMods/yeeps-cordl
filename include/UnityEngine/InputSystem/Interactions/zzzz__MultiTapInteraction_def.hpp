...
public:
  ...
  /// @brief Method Process, addr 0x22675b0, size 0x280, virtual true, abstract: false, final true
  inline void Process(ByRef<::UnityEngine::InputSystem::InputInteractionContext> context);

  /// @brief Method Reset, addr 0x2267830, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x226783c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pressPointOrDefault, addr 0x22674d0, size 0x58, virtual false, abstract: false, final false
  inline float_t get_pressPointOrDefault();

  /// @brief Method get_releasePointOrDefault, addr 0x2267528, size 0x88, virtual false, abstract: false, final false
  inline float_t get_releasePointOrDefault();

  /// @brief Method get_tapDelayOrDefault, addr 0x2267460, size 0x70, virtual false, abstract: false, final false
  inline float_t get_tapDelayOrDefault();

  /// @brief Method get_tapTimeOrDefault, addr 0x22673f0, size 0x70, virtual false, abstract: false, final false
