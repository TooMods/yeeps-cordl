...
public:
  ...
  /// @brief Method Authenticate, addr 0x1034810, size 0x5e0, virtual false, abstract: false, final false
  inline ::System::Net::Authorization* Authenticate(::System::Net::WebRequest* webRequest, ::System::Net::ICredentials* credentials);

  /// @brief Method HA1, addr 0x10344bc, size 0x124, virtual false, abstract: false, final false
  inline ::StringW HA1(::StringW username, ::StringW password);

  /// @brief Method HA2, addr 0x10345e0, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW HA2(::System::Net::HttpWebRequest* webRequest);

  /// @brief Method HashToHexString, addr 0x103436c, size 0x150, virtual false, abstract: false, final false
  inline ::StringW HashToHexString(::StringW toBeHashed);

  static inline ::System::Net::DigestSession* New_ctor();

  /// @brief Method Parse, addr 0x103428c, size 0xe0, virtual false, abstract: false, final false
  inline bool Parse(::StringW challenge);

  /// @brief Method Response, addr 0x10346b0, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10340b0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Security::Cryptography::RandomNumberGenerator* getStaticF_rng();

  /// @brief Method get_Algorithm, addr 0x1034120, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Algorithm();

  /// @brief Method get_CNonce, addr 0x1034198, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW get_CNonce();

  /// @brief Method get_LastUse, addr 0x1034df0, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_LastUse();

  /// @brief Method get_Nonce, addr 0x1034150, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Nonce();

  /// @brief Method get_Opaque, addr 0x1034168, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Opaque();

  /// @brief Method get_QOP, addr 0x1034180, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_QOP();

  /// @brief Method get_Realm, addr 0x1034138, size 0x18, virtual false, abstract: false, final false
