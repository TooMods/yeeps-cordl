...
public:
  ...
  /// @brief Method FromEnum, addr 0x129d19c, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method FromXmlNCName, addr 0x129d47c, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW FromXmlNCName(::StringW ncName);

  /// @brief Method FromXmlName, addr 0x129d424, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW FromXmlName(::StringW name);

  /// @brief Method FromXmlString, addr 0x129d4d4, size 0xa78, virtual false, abstract: false, final false
  static inline ::System::Object* FromXmlString(::System::Xml::Serialization::TypeData* type, ::StringW value);

  /// @brief Method ToXmlString, addr 0x129beb8, size 0xcc4, virtual false, abstract: false, final false
