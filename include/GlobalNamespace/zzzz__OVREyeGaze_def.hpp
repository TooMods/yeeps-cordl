...
public:
  ...
  /// @brief Method Awake, addr 0x25bd808, size 0x7c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculateEyeRotation, addr 0x25bdf50, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25bdd44, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x25bdcbc, size 0x88, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x25bdb0c, size 0x78, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPermissionGranted, addr 0x25bdc5c, size 0x60, virtual false, abstract: false, final false
  inline void OnPermissionGranted(::StringW permissionId);

  /// @brief Method PrepareHeadDirection, addr 0x25bd888, size 0x284, virtual false, abstract: false, final false
  inline void PrepareHeadDirection();

  /// @brief Method Start, addr 0x25bd884, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartEyeTracking, addr 0x25bdb84, size 0xd8, virtual false, abstract: false, final false
  inline bool StartEyeTracking();

  /// @brief Method Update, addr 0x25bdd50, size 0x200, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25be110, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF__trackingInstanceCount();

  /// @brief Method get_Confidence, addr 0x25bd7f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Confidence();

  /// @brief Method get_EyeTrackingEnabled, addr 0x25bd7a8, size 0x50, virtual false, abstract: false, final false
  inline bool get_EyeTrackingEnabled();

  static inline void setStaticF__trackingInstanceCount(int32_t value);

  /// @brief Method set_Confidence, addr 0x25bd800, size 0x8, virtual false, abstract: false, final false
