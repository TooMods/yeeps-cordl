...
public:
  ...
  /// @brief Method GetConstraint, addr 0x240a084, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::Constraint* GetConstraint();

  /// @brief Method GetNext, addr 0x2409da4, size 0x2e0, virtual false, abstract: false, final false
  inline bool GetNext();

  /// @brief Method IsValidCandidate, addr 0x240a08c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2409d50, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet);

  /// @brief Method get_CurrentObject, addr 0x240a094, size 0x8, virtual false, abstract: false, final false
