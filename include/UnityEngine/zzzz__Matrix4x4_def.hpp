...
public:
  ...
  /// @brief Method DecomposeProjection, addr 0x2843850, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::FrustumPlanes DecomposeProjection();

  /// @brief Method DecomposeProjection_Injected, addr 0x28438b8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2842904, size 0x174, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x2842a78, size 0x108, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Matrix4x4 other);

  /// @brief Method GetColumn, addr 0x284282c, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetColumn(int32_t index);

  /// @brief Method GetHashCode, addr 0x2842698, size 0x194, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetRotation, addr 0x28437b4, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetRotation();

  /// @brief Method GetRotation_Injected, addr 0x284380c, size 0x44, virtual false, abstract: false, final false
  static inline void GetRotation_Injected(ByRef<::UnityEngine::Matrix4x4> _unity_self, ByRef<::UnityEngine::Quaternion> ret);

  /// @brief Method GetRow, addr 0x2842e88, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetRow(int32_t index);

  /// @brief Method Inverse, addr 0x2843aec, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Inverse(::UnityEngine::Matrix4x4 m);

  /// @brief Method Inverse3DAffine, addr 0x2843a64, size 0x44, virtual false, abstract: false, final false
  static inline bool Inverse3DAffine(::UnityEngine::Matrix4x4 input, ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method Inverse3DAffine_Injected, addr 0x2843aa8, size 0x44, virtual false, abstract: false, final false
  static inline bool Inverse3DAffine_Injected(ByRef<::UnityEngine::Matrix4x4> input, ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method Inverse_Injected, addr 0x2843b58, size 0x44, virtual false, abstract: false, final false
  static inline void Inverse_Injected(ByRef<::UnityEngine::Matrix4x4> m, ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method LookAt, addr 0x2843f8c, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 LookAt(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 to, ::UnityEngine::Vector3 up);

  /// @brief Method LookAt_Injected, addr 0x284401c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyPoint, addr 0x2842fd8, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 MultiplyPoint(::UnityEngine::Vector3 point);

  /// @brief Method MultiplyPoint3x4, addr 0x2843058, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 MultiplyPoint3x4(::UnityEngine::Vector3 point);

  /// @brief Method MultiplyVector, addr 0x28430b0, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 MultiplyVector(::UnityEngine::Vector3 vector);

  /// @brief Method Ortho, addr 0x2843d5c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Ortho_Injected, addr 0x2843e08, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Perspective, addr 0x2843e8c, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Perspective(float_t fov, float_t aspect, float_t zNear, float_t zFar);

  /// @brief Method Perspective_Injected, addr 0x2843f20, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rotate, addr 0x2843158, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Rotate(::UnityEngine::Quaternion q);

  /// @brief Method Scale, addr 0x28430f8, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Scale(::UnityEngine::Vector3 vector);

  /// @brief Method SetColumn, addr 0x2842f60, size 0x78, virtual false, abstract: false, final false
  inline void SetColumn(int32_t index, ::UnityEngine::Vector4 column);

  /// @brief Method TRS, addr 0x2843978, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 TRS(::UnityEngine::Vector3 pos, ::UnityEngine::Quaternion q, ::UnityEngine::Vector3 s);

  /// @brief Method TRS_Injected, addr 0x2843a08, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x28432a0, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x28432ac, size 0x508, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method Translate, addr 0x2843124, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Translate(::UnityEngine::Vector3 vector);

  /// @brief Method Transpose, addr 0x2843c24, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Transpose(::UnityEngine::Matrix4x4 m);

  /// @brief Method Transpose_Injected, addr 0x2843c90, size 0x44, virtual false, abstract: false, final false
  static inline void Transpose_Injected(ByRef<::UnityEngine::Matrix4x4> m, ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method .ctor, addr 0x2842484, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x28424a8, size 0xf4, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x28424a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t row, int32_t column);

  /// @brief Method get_decomposeProjection, addr 0x2843900, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::FrustumPlanes get_decomposeProjection();

  /// @brief Method get_identity, addr 0x2843248, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 get_identity();

  /// @brief Method get_inverse, addr 0x2843b9c, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_inverse();

  /// @brief Method get_rotation, addr 0x28438fc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method get_transpose, addr 0x2843cd4, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_transpose();

  /// @brief Method get_zero, addr 0x28431f0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2842d5c, size 0xe4, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Matrix4x4 lhs, ::UnityEngine::Matrix4x4 rhs);

  /// @brief Method op_Inequality, addr 0x2842e40, size 0x48, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::Matrix4x4 lhs, ::UnityEngine::Matrix4x4 rhs);

  /// @brief Method op_Multiply, addr 0x2842b80, size 0x1a8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 op_Multiply(::UnityEngine::Matrix4x4 lhs, ::UnityEngine::Matrix4x4 rhs);

  /// @brief Method op_Multiply, addr 0x2842d28, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x28425a4, size 0xf4, virtual false, abstract: false, final false
  inline void set_Item(int32_t index, float_t value);

  /// @brief Method set_Item, addr 0x284259c, size 0x8, virtual false, abstract: false, final false
