...
public:
  ...
  /// @brief Method .ctor, addr 0x1ab7e1c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method isCompatible, addr 0x1ab7ce0, size 0x13c, virtual false, abstract: false, final false
