...
public:
  ...
  /// @brief Method Add, addr 0x1aad1a8, size 0xa8, virtual true, abstract: false, final false
  inline void Add(::System::Runtime::Serialization::ObjectHolder* value);

  /// @brief Method EnlargeArray, addr 0x1aad250, size 0x88, virtual false, abstract: false, final false
  inline void EnlargeArray();

  /// @brief Method GetFixupEnumerator, addr 0x1aac0e4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1aa92b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1aad13c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t startingSize);

  /// @brief Method get_Count, addr 0x1aad328, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Version, addr 0x1aad320, size 0x8, virtual false, abstract: false, final false
