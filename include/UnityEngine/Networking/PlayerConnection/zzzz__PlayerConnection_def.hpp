...
public:
  ...
  /// @brief Method <Register>b__0, addr 0x2a8a508, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a89804, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Unregister>b__0, addr 0x2a8a550, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a899b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BlockUntilRecvMsg>b__0, addr 0x2a8a598, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a8a134, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUntilRecvMsg, addr 0x2a89f34, size 0x200, virtual false, abstract: false, final false
  inline bool BlockUntilRecvMsg(::System::Guid messageId, int32_t timeout);

  /// @brief Method ConnectedCallbackInternal, addr 0x2a8a2f0, size 0xdc, virtual false, abstract: false, final false
  static inline void ConnectedCallbackInternal(int32_t playerId);

  /// @brief Method CreateInstance, addr 0x2a89360, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> CreateInstance();

  /// @brief Method DisconnectAll, addr 0x2a8a13c, size 0x9c, virtual true, abstract: false, final true
  inline void DisconnectAll();

  /// @brief Method DisconnectedCallback, addr 0x2a8a3cc, size 0x94, virtual false, abstract: false, final false
  static inline void DisconnectedCallback(int32_t playerId);

  /// @brief Method GetConnectionNativeApi, addr 0x2a89480, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::IPlayerEditorConnectionNative* GetConnectionNativeApi();

  /// @brief Method MessageCallbackInternal, addr 0x2a8a1d8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x2a89500, size 0xc0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Register, addr 0x2a895c0, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method RegisterConnection, addr 0x2a899bc, size 0x1a0, virtual true, abstract: false, final true
  inline void RegisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method RegisterDisconnection, addr 0x2a89b5c, size 0x60, virtual true, abstract: false, final true
  inline void RegisterDisconnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method Send, addr 0x2a89c7c, size 0x15c, virtual true, abstract: false, final true
  inline void Send(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method TrySend, addr 0x2a89dd8, size 0x15c, virtual true, abstract: false, final true
  inline bool TrySend(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Unregister, addr 0x2a8980c, size 0x1a8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnregisterConnection, addr 0x2a89bbc, size 0x60, virtual true, abstract: false, final true
  inline void UnregisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method UnregisterDisconnection, addr 0x2a89c1c, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a8a460, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x2a892c8, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> get_instance();

  /// @brief Method get_isConnected, addr 0x2a893e4, size 0x9c, virtual false, abstract: false, final false
