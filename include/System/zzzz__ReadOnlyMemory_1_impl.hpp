...
template <typename T> inline ::System::ReadOnlyMemory_1<T> System::ReadOnlyMemory_1<T>::op_Implicit___System__ReadOnlyMemory_1_T_(::System::ArraySegment_1<T> segment) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::ReadOnlyMemory_1<T>>::get(), "op_Implicit", std::span<Il2CppClass const* const, 0>(),
                                               ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::ArraySegment_1<T>>::get() })));
  return ::cordl_internals::RunMethodRethrow<::System::ReadOnlyMemory_1<T>, false>(nullptr, ___internal_method, segment);
}
