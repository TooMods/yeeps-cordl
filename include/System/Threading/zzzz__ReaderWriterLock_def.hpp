...
public:
  ...
  /// @brief Method AcquireWriterLock, addr 0xed021c, size 0x8, virtual false, abstract: false, final false
  inline void AcquireWriterLock(int32_t millisecondsTimeout);

  /// @brief Method AcquireWriterLock, addr 0xed0224, size 0x1a8, virtual false, abstract: false, final false
  inline void AcquireWriterLock(int32_t millisecondsTimeout, int32_t initialLockCount);

  /// @brief Method Finalize, addr 0xed0214, size 0x8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HasWriterLock, addr 0xed03cc, size 0x34, virtual false, abstract: false, final false
  inline bool HasWriterLock();

  static inline ::System::Threading::ReaderWriterLock* New_ctor();

  /// @brief Method ReleaseWriterLock, addr 0xed0400, size 0x130, virtual false, abstract: false, final false
  inline void ReleaseWriterLock();

  /// @brief Method ReleaseWriterLock, addr 0xed0530, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed0140, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
