...
public:
  ...
  /// @brief Method Activate, addr 0x185a69c, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1859a34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NextActivator, addr 0x185a694, size 0x8, virtual true, abstract: false, final true
