...
public:
  ...
  /// @brief Method Append, addr 0x10d9fa8, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x10d9f44, size 0x64, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x10da048, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d9f14, size 0x30, virtual false, abstract: false, final false
