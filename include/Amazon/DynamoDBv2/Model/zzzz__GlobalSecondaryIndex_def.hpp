...
CORDL_MODULE_EXPORT(GlobalSecondaryIndex)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex);
// Type: Amazon.DynamoDBv2.Model::GlobalSecondaryIndex
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 48, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::GlobalSecondaryIndex*
class CORDL_TYPE GlobalSecondaryIndex : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method IsSetIndexName, addr 0x10490ec, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetIndexName();

  /// @brief Method IsSetKeySchema, addr 0x104910c, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetKeySchema();

  /// @brief Method IsSetProjection, addr 0x1049170, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetProjection();

  /// @brief Method IsSetProvisionedThroughput, addr 0x1049190, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetProvisionedThroughput();

  static inline ::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x10491a0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IndexName, addr 0x10490dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IndexName();

  /// @brief Method get_KeySchema, addr 0x10490fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::DynamoDBv2::Model::KeySchemaElement*>* get_KeySchema();

  /// @brief Method get_Projection, addr 0x1049160, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::Projection* get_Projection();

  /// @brief Method get_ProvisionedThroughput, addr 0x1049180, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::ProvisionedThroughput* get_ProvisionedThroughput();

  /// @brief Method set_IndexName, addr 0x10490e4, size 0x8, virtual false, abstract: false, final false
  inline void set_IndexName(::StringW value);

  /// @brief Method set_KeySchema, addr 0x1049104, size 0x8, virtual false, abstract: false, final false
  inline void set_KeySchema(::System::Collections::Generic::List_1<::Amazon::DynamoDBv2::Model::KeySchemaElement*>* value);

  /// @brief Method set_Projection, addr 0x1049168, size 0x8, virtual false, abstract: false, final false
  inline void set_Projection(::Amazon::DynamoDBv2::Model::Projection* value);

  /// @brief Method set_ProvisionedThroughput, addr 0x1049188, size 0x8, virtual false, abstract: false, final false
  inline void set_ProvisionedThroughput(::Amazon::DynamoDBv2::Model::ProvisionedThroughput* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr GlobalSecondaryIndex();

public:
  // Ctor Parameters [CppParam { name: "", ty: "GlobalSecondaryIndex", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GlobalSecondaryIndex(GlobalSecondaryIndex&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GlobalSecondaryIndex", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GlobalSecondaryIndex(GlobalSecondaryIndex const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex, 0x30>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex, ____indexName) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex, ____keySchema) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex, ____projection) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex, ____provisionedThroughput) == 0x28, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::GlobalSecondaryIndex*, "Amazon.DynamoDBv2.Model", "GlobalSecondaryIndex");
