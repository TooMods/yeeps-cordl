...
public:
  ...
  /// @brief Method .ctor, addr 0x24722a4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x247229c, size 0x8, virtual false, abstract: false, final false
