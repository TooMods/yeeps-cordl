...
public:
  ...
  /// @brief Method Cleanup, addr 0x284a2fc, size 0x3c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Equals, addr 0x284a68c, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x284a754, size 0xc8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Gradient* other);

  /// @brief Method Evaluate, addr 0x284a47c, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::Color Evaluate(float_t time);

  /// @brief Method Evaluate_Injected, addr 0x284a4e4, size 0x54, virtual false, abstract: false, final false
  inline void Evaluate_Injected(float_t time, ByRef<::UnityEngine::Color> ret);

  /// @brief Method Finalize, addr 0x284a3c4, size 0xb8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetHashCode, addr 0x284a81c, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Init, addr 0x284a2d4, size 0x28, virtual false, abstract: false, final false
  static inline void* Init();

  /// @brief Method Internal_Equals, addr 0x284a338, size 0x44, virtual false, abstract: false, final false
  inline bool Internal_Equals(void* other);

  static inline ::UnityEngine::Gradient* New_ctor();

  /// @brief Method SetKeys, addr 0x284a638, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x284a37c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alphaKeys, addr 0x284a5b8, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::GradientAlphaKey, ::Array<::UnityEngine::GradientAlphaKey>*> get_alphaKeys();

  /// @brief Method get_colorKeys, addr 0x284a538, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_alphaKeys, addr 0x284a5f4, size 0x44, virtual false, abstract: false, final false
  inline void set_alphaKeys(::ArrayW<::UnityEngine::GradientAlphaKey, ::Array<::UnityEngine::GradientAlphaKey>*> value);

  /// @brief Method set_colorKeys, addr 0x284a574, size 0x44, virtual false, abstract: false, final false
