...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2a47800, size 0x14, virtual true, abstract: false, final false
  inline int64_t Invoke();

  static inline ::UnityEngine::UIElements::TimeMsFunction* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2a47744, size 0xbc, virtual false, abstract: false, final false
