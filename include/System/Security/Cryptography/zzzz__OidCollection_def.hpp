...
public:
  ...
  /// @brief Method Add, addr 0x12c1bf8, size 0xb4, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::Oid* oid);

  /// @brief Method GetEnumerator, addr 0x12c1d4c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x12c1dec, size 0x1bc, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x12c1de8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12c1b78, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x12c1d04, size 0x48, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x12c1fa8, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x12c1cac, size 0x58, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::Oid* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x12c1fb0, size 0x4, virtual true, abstract: false, final true
