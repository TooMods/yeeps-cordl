...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::Filtering::IXRHoverFilter);
// Type: UnityEngine.XR.Interaction.Toolkit.Filtering::IXRHoverFilter
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IXRHoverFilter", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IXRHoverFilter(IXRHoverFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IXRHoverFilter", modifiers: "const&", def_value: None }]
