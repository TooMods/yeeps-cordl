...
public:
  ...
  /// @brief Method OnStateEnter, addr 0x19fa3e8, size 0x4, virtual true, abstract: false, final false
  inline void OnStateEnter(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateEnter, addr 0x19fa404, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateExit, addr 0x19fa3f0, size 0x4, virtual true, abstract: false, final false
  inline void OnStateExit(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateExit, addr 0x19fa40c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateIK, addr 0x19fa3f8, size 0x4, virtual true, abstract: false, final false
  inline void OnStateIK(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateIK, addr 0x19fa414, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateMachineEnter, addr 0x19fa3fc, size 0x4, virtual true, abstract: false, final false
  inline void OnStateMachineEnter(::UnityEngine::Animator* animator, int32_t stateMachinePathHash);

  /// @brief Method OnStateMachineEnter, addr 0x19fa418, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateMachineExit, addr 0x19fa400, size 0x4, virtual true, abstract: false, final false
  inline void OnStateMachineExit(::UnityEngine::Animator* animator, int32_t stateMachinePathHash);

  /// @brief Method OnStateMachineExit, addr 0x19fa41c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateMove, addr 0x19fa3f4, size 0x4, virtual true, abstract: false, final false
  inline void OnStateMove(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateMove, addr 0x19fa410, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateUpdate, addr 0x19fa3ec, size 0x4, virtual true, abstract: false, final false
  inline void OnStateUpdate(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateUpdate, addr 0x19fa408, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19fa420, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
