...
public:
  ...
  /// @brief Method BeginInteraction, addr 0x1eb58e8, size 0x238, virtual false, abstract: false, final false
  inline void BeginInteraction(::UnityEngine::Vector2 pointerPosition, ::UnityEngine::Camera* uiCamera);

  /// @brief Method DrawGizmoCircle, addr 0x1eb6e5c, size 0xe4, virtual false, abstract: false, final false
  inline void DrawGizmoCircle(::UnityEngine::Vector2 center, float_t radius);

  /// @brief Method EndInteraction, addr 0x1eb5fa8, size 0xc8, virtual false, abstract: false, final false
  inline void EndInteraction();

  /// @brief Method GetCameraFromCanvas, addr 0x1eb6a18, size 0x134, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> GetCameraFromCanvas();

  /// @brief Method MoveStick, addr 0x1eb5bc0, size 0x3d8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDrag, addr 0x1eb5b20, size 0xa0, virtual true, abstract: false, final true
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnDrawGizmosSelected, addr 0x1eb6cc8, size 0x194, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  /// @brief Method OnPointerDown, addr 0x1eb66c8, size 0x350, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::InputSystem::__InputAction__CallbackContext ctx);

  /// @brief Method OnPointerDown, addr 0x1eb5848, size 0xa0, virtual true, abstract: false, final true
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerMove, addr 0x1eb6b4c, size 0xe8, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::InputSystem::__InputAction__CallbackContext ctx);

  /// @brief Method OnPointerUp, addr 0x1eb6c34, size 0x94, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::InputSystem::__InputAction__CallbackContext ctx);

  /// @brief Method OnPointerUp, addr 0x1eb5f98, size 0x10, virtual true, abstract: false, final true
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method Start, addr 0x1eb6070, size 0x658, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateDynamicOriginClickableArea, addr 0x1eb6f40, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1eb7090, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_behaviour, addr 0x1eb7080, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::OnScreen::__OnScreenStick__Behaviour get_behaviour();

  /// @brief Method get_controlPathInternal, addr 0x1eb7070, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_controlPathInternal();

  /// @brief Method get_dynamicOriginRange, addr 0x1eb703c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_dynamicOriginRange();

  /// @brief Method get_movementRange, addr 0x1eb702c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_movementRange();

  /// @brief Method get_useIsolatedInputActions, addr 0x1eb705c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_behaviour, addr 0x1eb7088, size 0x8, virtual false, abstract: false, final false
  inline void set_behaviour(::UnityEngine::InputSystem::OnScreen::__OnScreenStick__Behaviour value);

  /// @brief Method set_controlPathInternal, addr 0x1eb7078, size 0x8, virtual true, abstract: false, final false
  inline void set_controlPathInternal(::StringW value);

  /// @brief Method set_dynamicOriginRange, addr 0x1eb7044, size 0x18, virtual false, abstract: false, final false
  inline void set_dynamicOriginRange(float_t value);

  /// @brief Method set_movementRange, addr 0x1eb7034, size 0x8, virtual false, abstract: false, final false
  inline void set_movementRange(float_t value);

  /// @brief Method set_useIsolatedInputActions, addr 0x1eb7064, size 0xc, virtual false, abstract: false, final false
