...
public:
  ...
  /// @brief Method GetCredential, addr 0xf532a4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Net::NetworkCredential* GetCredential(::System::Uri* uri, ::StringW authType);

  /// @brief Method InternalGetDomain, addr 0xf5329c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW InternalGetDomain();

  /// @brief Method InternalGetPassword, addr 0xf53280, size 0xc, virtual false, abstract: false, final false
  inline ::StringW InternalGetPassword();

  /// @brief Method InternalGetUserName, addr 0xf53294, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf53124, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW userName, ::StringW password);

  /// @brief Method .ctor, addr 0xf51c8c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::StringW userName, ::StringW password, ::StringW domain);

  /// @brief Method get_Domain, addr 0xf5328c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Domain();

  /// @brief Method get_Password, addr 0xf53274, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_Password();

  /// @brief Method get_UserName, addr 0xf5326c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_UserName();

  /// @brief Convert to "::System::Net::ICredentials"
  constexpr ::System::Net::ICredentials* i___System__Net__ICredentials() noexcept;

  /// @brief Method set_Domain, addr 0xf5320c, size 0x60, virtual false, abstract: false, final false
  inline void set_Domain(::StringW value);

  /// @brief Method set_Password, addr 0xf531ec, size 0x20, virtual false, abstract: false, final false
  inline void set_Password(::StringW value);

  /// @brief Method set_UserName, addr 0xf5318c, size 0x60, virtual false, abstract: false, final false
