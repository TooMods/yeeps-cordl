...
public:
  ...
  /// @brief Method .ctor, addr 0x27e21a0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t time, float_t value);

  /// @brief Method .ctor, addr 0x27e21b0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t time, float_t value, float_t inTangent, float_t outTangent);

  /// @brief Method get_time, addr 0x27e21c4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method set_time, addr 0x27e21cc, size 0x8, virtual false, abstract: false, final false
