...
public:
  ...
  /// @brief Method .ctor, addr 0x2f55510, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDeclaration* declaration);

  /// @brief Method get_Encoding, addr 0x2f55b54, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_Encoding();

  /// @brief Method get_Standalone, addr 0x2f55b8c, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x2f55b38, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Encoding, addr 0x2f55b70, size 0x1c, virtual true, abstract: false, final true
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x2f55ba8, size 0x1c, virtual true, abstract: false, final true
