...
public:
  ...
  /// @brief Method CheckReadOnly, addr 0xfe91b8, size 0xb8, virtual false, abstract: false, final false
  inline void CheckReadOnly(::StringW propertyName);

  /// @brief Method Clone, addr 0xfe94a0, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriterSettings* Clone();

  /// @brief Method CreateWriter, addr 0xfe8820, size 0x4b4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::Stream* output);

  /// @brief Method CreateWriter, addr 0xfe8d3c, size 0x320, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::TextWriter* output);

  /// @brief Method Initialize, addr 0xfe9064, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe879c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Async, addr 0xfe9144, size 0x8, virtual false, abstract: false, final false
  inline bool get_Async();

  /// @brief Method get_AutoXmlDeclaration, addr 0xfe95a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_AutoXmlDeclaration();

  /// @brief Method get_CDataSectionElements, addr 0xfe956c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Xml::XmlQualifiedName*>* get_CDataSectionElements();

  /// @brief Method get_CheckCharacters, addr 0xfe93c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckCharacters();

  /// @brief Method get_CloseOutput, addr 0xfe9308, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseOutput();

  /// @brief Method get_ConformanceLevel, addr 0xfe9310, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ConformanceLevel get_ConformanceLevel();

  /// @brief Method get_DoNotEscapeUriAttributes, addr 0xfe9574, size 0x8, virtual false, abstract: false, final false
  inline bool get_DoNotEscapeUriAttributes();

  /// @brief Method get_DocTypePublic, addr 0xfe9594, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DocTypePublic();

  /// @brief Method get_DocTypeSystem, addr 0xfe958c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DocTypeSystem();

  /// @brief Method get_Encoding, addr 0xfe914c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_Indent, addr 0xfe9280, size 0x10, virtual false, abstract: false, final false
  inline bool get_Indent();

  /// @brief Method get_IndentChars, addr 0xfe92f8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IndentChars();

  /// @brief Method get_IndentInternal, addr 0xfe95ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::TriState get_IndentInternal();

  /// @brief Method get_IsQuerySpecific, addr 0xfe95b4, size 0x70, virtual false, abstract: false, final false
  inline bool get_IsQuerySpecific();

  /// @brief Method get_MediaType, addr 0xfe9584, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MediaType();

  /// @brief Method get_MergeCDataSections, addr 0xfe957c, size 0x8, virtual false, abstract: false, final false
  inline bool get_MergeCDataSections();

  /// @brief Method get_NamespaceHandling, addr 0xfe93d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::NamespaceHandling get_NamespaceHandling();

  /// @brief Method get_NewLineChars, addr 0xfe9278, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NewLineChars();

  /// @brief Method get_NewLineHandling, addr 0xfe9270, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::NewLineHandling get_NewLineHandling();

  /// @brief Method get_NewLineOnAttributes, addr 0xfe9300, size 0x8, virtual false, abstract: false, final false
  inline bool get_NewLineOnAttributes();

  /// @brief Method get_OmitXmlDeclaration, addr 0xfe9154, size 0x8, virtual false, abstract: false, final false
  inline bool get_OmitXmlDeclaration();

  /// @brief Method get_OutputMethod, addr 0xfe9490, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlOutputMethod get_OutputMethod();

  /// @brief Method get_Standalone, addr 0xfe959c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlStandalone get_Standalone();

  /// @brief Method get_WriteEndDocumentOnClose, addr 0xfe9488, size 0x8, virtual false, abstract: false, final false
  inline bool get_WriteEndDocumentOnClose();

  /// @brief Method set_ConformanceLevel, addr 0xfe9318, size 0xb0, virtual false, abstract: false, final false
  inline void set_ConformanceLevel(::System::Xml::ConformanceLevel value);

  /// @brief Method set_Indent, addr 0xfe9290, size 0x68, virtual false, abstract: false, final false
  inline void set_Indent(bool value);

  /// @brief Method set_NamespaceHandling, addr 0xfe93d8, size 0xb0, virtual false, abstract: false, final false
  inline void set_NamespaceHandling(::System::Xml::NamespaceHandling value);

  /// @brief Method set_OmitXmlDeclaration, addr 0xfe915c, size 0x5c, virtual false, abstract: false, final false
  inline void set_OmitXmlDeclaration(bool value);

  /// @brief Method set_OutputMethod, addr 0xfe9498, size 0x8, virtual false, abstract: false, final false
  inline void set_OutputMethod(::System::Xml::XmlOutputMethod value);

  /// @brief Method set_ReadOnly, addr 0xfe9624, size 0xc, virtual false, abstract: false, final false
