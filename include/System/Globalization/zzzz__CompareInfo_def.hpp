...
public:
  ...
  /// @brief Method Compare, addr 0x1fd1fa4, size 0x560, virtual true, abstract: false, final false
  ...
  /// @brief Method Compare, addr 0x1fd13cc, size 0x10, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW string1, ::StringW string2);

  /// @brief Method Compare, addr 0x1fd13dc, size 0x2a8, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW string1, ::StringW string2, ::System::Globalization::CompareOptions options);

  /// @brief Method Compare, addr 0x1fd1974, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareOptionIgnoreCase, addr 0x1fd1d78, size 0x13c, virtual false, abstract: false, final false
  inline int32_t CompareOptionIgnoreCase(::System::ReadOnlySpan_1<char16_t> string1, ::System::ReadOnlySpan_1<char16_t> string2);

  /// @brief Method CompareOrdinalIgnoreCase, addr 0x1fd2504, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareOrdinalIgnoreCase, addr 0x1fd1684, size 0x1f4, virtual false, abstract: false, final false
  static inline int32_t CompareOrdinalIgnoreCase(::System::ReadOnlySpan_1<char16_t> strA, ::System::ReadOnlySpan_1<char16_t> strB);

  /// @brief Method CompareString, addr 0x1fd1d14, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareString, addr 0x1fd1eb4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareStringOrdinalIgnoreCase, addr 0x1fd2678, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSortKey, addr 0x1fd3974, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* CreateSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method CreateSortKeyCore, addr 0x1fd4748, size 0x13c, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* CreateSortKeyCore(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method EndsWith, addr 0x1fd2d94, size 0x170, virtual false, abstract: false, final false
  inline bool EndsWith(::StringW source, ::StringW suffix, ::System::Globalization::CompareOptions options);

  /// @brief Method EndsWith, addr 0x1fd2f08, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x1fd3a34, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetCollator, addr 0x1fd4414, size 0x334, virtual false, abstract: false, final false
  inline ::System::Globalization::ISimpleCollator* GetCollator();

  /// @brief Method GetCompareInfo, addr 0x1fd1144, size 0xbc, virtual false, abstract: false, final false
  static inline ::System::Globalization::CompareInfo* GetCompareInfo(::StringW name);

  /// @brief Method GetHashCode, addr 0x1fd3af4, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x1fd416c, size 0x104, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetHashCodeOfString, addr 0x1fd3f98, size 0x1a8, virtual false, abstract: false, final false
  inline int32_t GetHashCodeOfString(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetHashCodeOfStringCore, addr 0x1fd4140, size 0x2c, virtual false, abstract: false, final false
  inline int32_t GetHashCodeOfStringCore(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetIgnoreCaseHash, addr 0x1fd3b1c, size 0x47c, virtual false, abstract: false, final false
  static inline int32_t GetIgnoreCaseHash(::StringW source);

  /// @brief Method GetSortKey, addr 0x1fd38ac, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Globalization::SortKey* GetSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method IndexOf, addr 0x1fd2f68, size 0x70, virtual true, abstract: false, final false
  inline int32_t IndexOf(::StringW source, ::StringW value, ::System::Globalization::CompareOptions options);

  /// @brief Method IndexOf, addr 0x1fd2fd8, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method IndexOfCore, addr 0x1fd339c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfOrdinal, addr 0x1fd329c, size 0x100, virtual false, abstract: false, final false
  inline int32_t IndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method IndexOfOrdinalCore, addr 0x1fd33f8, size 0x20, virtual false, abstract: false, final false
  static inline int32_t IndexOfOrdinalCore(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InitSort, addr 0x1fd1128, size 0x1c, virtual false, abstract: false, final false
  inline void InitSort(::System::Globalization::CultureInfo* culture);

  /// @brief Method InvariantCreateSortKey, addr 0x1fd0e58, size 0x29c, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* InvariantCreateSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method InvariantFindString, addr 0x1fd0a48, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvariantIndexOf, addr 0x1fd0984, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t InvariantIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InvariantLastIndexOf, addr 0x1fd0d74, size 0xcc, virtual false, abstract: false, final false
  static inline int32_t InvariantLastIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InvariantToUpper, addr 0x1fd0e40, size 0x18, virtual false, abstract: false, final false
  static inline char16_t InvariantToUpper(char16_t c);

  /// @brief Method IsPrefix, addr 0x1fd27d8, size 0x224, virtual true, abstract: false, final false
  inline bool IsPrefix(::StringW source, ::StringW prefix, ::System::Globalization::CompareOptions options);

  /// @brief Method IsSuffix, addr 0x1fd2b70, size 0x224, virtual true, abstract: false, final false
  inline bool IsSuffix(::StringW source, ::StringW suffix, ::System::Globalization::CompareOptions options);

  /// @brief Method IsSuffix, addr 0x1fd2f04, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x1fd3418, size 0x35c, virtual true, abstract: false, final false
  ...
  /// @brief Method LastIndexOfCore, addr 0x1fd3874, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOfOrdinal, addr 0x1fd3774, size 0x100, virtual false, abstract: false, final false
  inline int32_t LastIndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method LastIndexOfOrdinalCore, addr 0x1fd388c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x1fd120c, size 0xa4, virtual false, abstract: false, final false
  inline void OnDeserialized();

  /// @brief Method OnDeserialized, addr 0x1fd12b0, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x1fd1200, size 0x8, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x1fd12b4, size 0x8c, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method StartsWith, addr 0x1fd29fc, size 0x174, virtual false, abstract: false, final false
  inline bool StartsWith(::StringW source, ::StringW prefix, ::System::Globalization::CompareOptions options);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x1fd1208, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method ToString, addr 0x1fd4270, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fd4de8, size 0x1038, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1fd10f4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Name, addr 0x1fd1340, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_UseManagedCollation, addr 0x1fd42d0, size 0x144, virtual false, abstract: false, final false
  static inline bool get_UseManagedCollation();

  /// @brief Convert to "::System::Runtime::Serialization::IDeserializationCallback"
  constexpr ::System::Runtime::Serialization::IDeserializationCallback* i___System__Runtime__Serialization__IDeserializationCallback() noexcept;

  /// @brief Method internal_compare, addr 0x1fd4ba0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_compare_icall, addr 0x1fd4d54, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_compare_managed, addr 0x1fd4c54, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_compare_switch, addr 0x1fd1878, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_index, addr 0x1fd49c0, size 0xb4, virtual false, abstract: false, final false
  static inline int32_t internal_index(::StringW source, int32_t sindex, int32_t count, ::StringW value, bool first);

  /// @brief Method internal_index_icall, addr 0x1fd4d58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_index_managed, addr 0x1fd4a74, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_index_switch, addr 0x1fd4884, size 0x13c, virtual false, abstract: false, final false
