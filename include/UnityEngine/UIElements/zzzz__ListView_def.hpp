...
public:
  ...
  /// @brief Method Init, addr 0x2cdb8b0, size 0x3d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cdbc84, size 0x51c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddItems, addr 0x2cdaa54, size 0x24, virtual false, abstract: false, final false
  inline void AddItems(int32_t itemCount);

  /// @brief Method CreateDragAndDropController, addr 0x2cdb328, size 0x64, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ICollectionDragAndDropController* CreateDragAndDropController();

  /// @brief Method CreateDragger, addr 0x2cdb288, size 0xa0, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ListViewDragger* CreateDragger();

  /// @brief Method CreateViewController, addr 0x2cdafe8, size 0x64, virtual true, abstract: false, final false
  inline void CreateViewController();

  /// @brief Method CreateVirtualizationController, addr 0x2cdafa0, size 0x48, virtual true, abstract: false, final false
  inline void CreateVirtualizationController();

  /// @brief Method EnableFooter, addr 0x2cda4d0, size 0x32c, virtual false, abstract: false, final false
  inline void EnableFooter(bool enabled);

  static inline ::UnityEngine::UIElements::ListView* New_ctor();

  /// @brief Method OnAddClicked, addr 0x2cdab80, size 0x24c, virtual false, abstract: false, final false
  inline void OnAddClicked();

  /// @brief Method OnArraySizeFieldChanged, addr 0x2cdaa78, size 0x108, virtual false, abstract: false, final false
  inline void OnArraySizeFieldChanged(::UnityEngine::UIElements::ChangeEvent_1<::StringW>* evt);

  /// @brief Method OnItemAdded, addr 0x2cdb208, size 0x1c, virtual false, abstract: false, final false
  inline void OnItemAdded(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method OnItemsRemoved, addr 0x2cdb224, size 0x1c, virtual false, abstract: false, final false
  inline void OnItemsRemoved(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method OnItemsSourceSizeChanged, addr 0x2cdb240, size 0x8, virtual false, abstract: false, final false
  inline void OnItemsSourceSizeChanged();

  /// @brief Method OnRemoveClicked, addr 0x2cdadcc, size 0x1cc, virtual false, abstract: false, final false
  inline void OnRemoveClicked();

  /// @brief Method PostRefresh, addr 0x2cdb428, size 0x24, virtual true, abstract: false, final false
  inline void PostRefresh();

  /// @brief Method SetViewController, addr 0x2cdb04c, size 0x1bc, virtual false, abstract: false, final false
  inline void SetViewController(::UnityEngine::UIElements::ListViewController* controller);

  /// @brief Method SetupArraySizeField, addr 0x2cd9b08, size 0x1d4, virtual false, abstract: false, final false
  inline void SetupArraySizeField();

  /// @brief Method UpdateArraySizeField, addr 0x2cda7fc, size 0x70, virtual false, abstract: false, final false
  inline void UpdateArraySizeField();

  /// @brief Method UpdateEmpty, addr 0x2cda304, size 0x1bc, virtual false, abstract: false, final false
  inline void UpdateEmpty();

  /// @brief Method <OnAddClicked>b__35_0, addr 0x2cdb798, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cdb38c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_reorderMode, addr 0x2cdb248, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ListViewReorderMode get_reorderMode();

  /// @brief Method get_showAddRemoveFooter, addr 0x2cda4c0, size 0x10, virtual false, abstract: false, final false
  inline bool get_showAddRemoveFooter();

  /// @brief Method get_showBoundCollectionSize, addr 0x2cd9ae4, size 0x8, virtual false, abstract: false, final false
  inline bool get_showBoundCollectionSize();

  /// @brief Method get_showFoldoutHeader, addr 0x2cd9d04, size 0x8, virtual false, abstract: false, final false
  inline bool get_showFoldoutHeader();

  /// @brief Method get_sourceIncludesArraySize, addr 0x2cd9cdc, size 0x28, virtual true, abstract: false, final false
  inline bool get_sourceIncludesArraySize();

  /// @brief Method get_viewController, addr 0x2cdaf98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_headerTitle, addr 0x2cda86c, size 0x18, virtual false, abstract: false, final false
  inline void set_headerTitle(::StringW value);

  /// @brief Method set_reorderMode, addr 0x2cdb250, size 0x38, virtual false, abstract: false, final false
  inline void set_reorderMode(::UnityEngine::UIElements::ListViewReorderMode value);

  /// @brief Method set_showAddRemoveFooter, addr 0x2cda884, size 0x8, virtual false, abstract: false, final false
  inline void set_showAddRemoveFooter(bool value);

  /// @brief Method set_showBoundCollectionSize, addr 0x2cd9aec, size 0x1c, virtual false, abstract: false, final false
  inline void set_showBoundCollectionSize(bool value);

  /// @brief Method set_showFoldoutHeader, addr 0x2cd9d0c, size 0x1a4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cdb868, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
