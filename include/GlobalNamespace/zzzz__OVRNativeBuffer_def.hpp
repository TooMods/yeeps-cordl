...
public:
  ...
  /// @brief Method Dispose, addr 0x25bbbd0, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x25bbba4, size 0x24, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x25bbafc, size 0xa8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCapacity, addr 0x25bbbc8, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetCapacity();

  /// @brief Method GetPointer, addr 0x25b718c, size 0x9c, virtual false, abstract: false, final false
  inline void* GetPointer(int32_t byteOffset);

  static inline ::GlobalNamespace::OVRNativeBuffer* New_ctor(int32_t numBytes);

  /// @brief Method Reallocate, addr 0x25bba5c, size 0xa0, virtual false, abstract: false, final false
  inline void Reallocate(int32_t numBytes);

  /// @brief Method Release, addr 0x25bbc40, size 0xa4, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method Reset, addr 0x25b7188, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b75e4, size 0x70, virtual false, abstract: false, final false
