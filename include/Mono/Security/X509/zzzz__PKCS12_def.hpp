...
public:
  ...
  /// @brief Method Adjust, addr 0x246327c, size 0xdc, virtual false, abstract: false, final false
  inline void Adjust(::ArrayW<uint8_t, ::Array<uint8_t>*> a, int32_t aOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method Derive, addr 0x2463358, size 0x430, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Derive(::ArrayW<uint8_t, ::Array<uint8_t>*> diversifier, int32_t n);

  /// @brief Method DeriveIV, addr 0x245eb70, size 0x70, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DeriveIV(int32_t size);

  /// @brief Method DeriveKey, addr 0x245eb00, size 0x70, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DeriveKey(int32_t size);

  /// @brief Method DeriveMAC, addr 0x24603c8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245e994, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_HashName, addr 0x246326c, size 0x8, virtual false, abstract: false, final false
  inline void set_HashName(::StringW value);

  /// @brief Method set_IterationCount, addr 0x2463274, size 0x8, virtual false, abstract: false, final false
  inline void set_IterationCount(int32_t value);

  /// @brief Method set_Password, addr 0x245e99c, size 0xbc, virtual false, abstract: false, final false
  inline void set_Password(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_Salt, addr 0x245ea58, size 0xa8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddCertificate, addr 0x2462680, size 0x8, virtual false, abstract: false, final false
  inline void AddCertificate(::Mono::Security::X509::X509Certificate* cert);

  /// @brief Method AddCertificate, addr 0x2462998, size 0x250, virtual false, abstract: false, final false
  inline void AddCertificate(::Mono::Security::X509::X509Certificate* cert, ::System::Collections::IDictionary* attributes);

  /// @brief Method AddPrivateKey, addr 0x245f554, size 0x27c, virtual false, abstract: false, final false
  inline void AddPrivateKey(::Mono::Security::Cryptography::__PKCS8__PrivateKeyInfo* pki);

  /// @brief Method CertificateSafeBag, addr 0x245f7d0, size 0xbf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Clone, addr 0x24630f4, size 0xd4, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method Compare, addr 0x245ce20, size 0x74, virtual false, abstract: false, final false
  inline bool Compare(::ArrayW<uint8_t, ::Array<uint8_t>*> expected, ::ArrayW<uint8_t, ::Array<uint8_t>*> actual);

  /// @brief Method Decode, addr 0x245c5e4, size 0x6b0, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Decrypt, addr 0x245dde0, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Decrypt, addr 0x245d594, size 0x90, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decrypt(::Mono::Security::__PKCS7__EncryptedData* ed);

  /// @brief Method Encrypt, addr 0x245ebe0, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptedContentInfo, addr 0x2462688, size 0x310, virtual false, abstract: false, final false
  inline ::Mono::Security::__PKCS7__ContentInfo* EncryptedContentInfo(::Mono::Security::ASN1* safeBags, ::StringW algorithmOid);

  /// @brief Method Finalize, addr 0x245d624, size 0xac, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x2460438, size 0x2240, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes();

  /// @brief Method GetExistingParameters, addr 0x245ee34, size 0x294, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DSAParameters GetExistingParameters(ByRef<bool> found);

  /// @brief Method GetSymmetricAlgorithm, addr 0x245e404, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method MAC, addr 0x245cccc, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadSafeBag, addr 0x245ce94, size 0x700, virtual false, abstract: false, final false
  inline void ReadSafeBag(::Mono::Security::ASN1* safeBag);

  /// @brief Method RemoveCertificate, addr 0x2462678, size 0x8, virtual false, abstract: false, final false
  inline void RemoveCertificate(::Mono::Security::X509::X509Certificate* cert);

  /// @brief Method RemoveCertificate, addr 0x2462be8, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245c310, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x245c3fc, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x245cc94, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::StringW password);

  static inline int32_t getStaticF_password_max_length();

  /// @brief Method get_Certificates, addr 0x245df94, size 0x450, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates();

  /// @brief Method get_IterationCount, addr 0x245d6d0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_IterationCount();

  /// @brief Method get_Keys, addr 0x245d6e0, size 0x700, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_Keys();

  /// @brief Method get_MaximumPasswordLength, addr 0x24631c8, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_MaximumPasswordLength();

  /// @brief Method get_RNG, addr 0x245e3e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IterationCount, addr 0x245d6d8, size 0x8, virtual false, abstract: false, final false
  inline void set_IterationCount(int32_t value);

  /// @brief Method set_Password, addr 0x245c430, size 0x1b4, virtual false, abstract: false, final false
