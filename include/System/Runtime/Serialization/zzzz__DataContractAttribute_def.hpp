...
public:
  ...
  /// @brief Method .ctor, addr 0x1a54ea0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReference, addr 0x1a54ea8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReference();

  /// @brief Method set_Name, addr 0x1a54eb0, size 0x10, virtual false, abstract: false, final false
