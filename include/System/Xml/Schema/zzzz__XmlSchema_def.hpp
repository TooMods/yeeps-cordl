...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x1ce14e4, size 0x18, virtual true, abstract: false, final false
  inline void AddAnnotation(::System::Xml::Schema::XmlSchemaAnnotation* annotation);

  /// @brief Method Clone, addr 0x1ce0648, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* Clone();

  /// @brief Method CompileSchema, addr 0x1ce0020, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileSchemaInSet, addr 0x1ce01fc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeepClone, addr 0x1ce0750, size 0x300, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* DeepClone();

  /// @brief Method GetExternalSchemasList, addr 0x1ce15d4, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x1cdfe74, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIsCompiled, addr 0x1ce14d0, size 0xc, virtual false, abstract: false, final false
  inline void SetIsCompiled(bool isCompiled);

  /// @brief Method SetUnhandledAttributes, addr 0x1ce14dc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cdfce4, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF_globalIdCounter();

  /// @brief Method get_AttributeFormDefault, addr 0x1ce02ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_AttributeFormDefault();

  /// @brief Method get_AttributeGroups, addr 0x1ce03c4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeGroups();

  /// @brief Method get_Attributes, addr 0x1ce0358, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Attributes();

  /// @brief Method get_BaseUri, addr 0x1ce0530, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_BaseUri();

  /// @brief Method get_BlockDefault, addr 0x1ce02bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_BlockDefault();

  /// @brief Method get_Document, addr 0x1ce05cc, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_Document();

  /// @brief Method get_ElementFormDefault, addr 0x1ce02dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_ElementFormDefault();

  /// @brief Method get_Elements, addr 0x1ce049c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Elements();

  /// @brief Method get_ErrorCount, addr 0x1ce0638, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ErrorCount();

  /// @brief Method get_FinalDefault, addr 0x1ce02cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_FinalDefault();

  /// @brief Method get_Groups, addr 0x1ce0518, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Groups();

  /// @brief Method get_Id, addr 0x1ce0508, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_IdAttribute, addr 0x1ce14c0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IdAttribute();

  /// @brief Method get_IdentityConstraints, addr 0x1ce0528, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_IdentityConstraints();

  /// @brief Method get_Ids, addr 0x1ce05c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_Ids();

  /// @brief Method get_ImportedNamespaces, addr 0x1ce1568, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_ImportedNamespaces();

  /// @brief Method get_ImportedSchemas, addr 0x1ce14fc, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_ImportedSchemas();

  /// @brief Method get_Includes, addr 0x1ce030c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Includes();

  /// @brief Method get_IsChameleon, addr 0x1ce05b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsChameleon();

  /// @brief Method get_IsCompiledBySet, addr 0x1ce031c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompiledBySet();

  /// @brief Method get_IsPreprocessed, addr 0x1ce0330, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsPreprocessed();

  /// @brief Method get_IsRedefined, addr 0x1ce0344, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsRedefined();

  /// @brief Method get_Items, addr 0x1ce0314, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items();

  /// @brief Method get_Notations, addr 0x1ce0520, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Notations();

  /// @brief Method get_SchemaId, addr 0x1ce0540, size 0x70, virtual false, abstract: false, final false
  inline int32_t get_SchemaId();

  /// @brief Method get_SchemaTypes, addr 0x1ce0430, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_SchemaTypes();

  /// @brief Method get_TargetNamespace, addr 0x1ce02ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TargetNamespace();

  /// @brief Method get_Version, addr 0x1ce02fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  static inline void setStaticF_globalIdCounter(int32_t value);

  /// @brief Method set_AttributeFormDefault, addr 0x1ce02b4, size 0x8, virtual false, abstract: false, final false
  inline void set_AttributeFormDefault(::System::Xml::Schema::XmlSchemaForm value);

  /// @brief Method set_BaseUri, addr 0x1ce0538, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseUri(::System::Uri* value);

  /// @brief Method set_BlockDefault, addr 0x1ce02c4, size 0x8, virtual false, abstract: false, final false
  inline void set_BlockDefault(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_ElementFormDefault, addr 0x1ce02e4, size 0x8, virtual false, abstract: false, final false
  inline void set_ElementFormDefault(::System::Xml::Schema::XmlSchemaForm value);

  /// @brief Method set_ErrorCount, addr 0x1ce0640, size 0x8, virtual false, abstract: false, final false
  inline void set_ErrorCount(int32_t value);

  /// @brief Method set_FinalDefault, addr 0x1ce02d4, size 0x8, virtual false, abstract: false, final false
  inline void set_FinalDefault(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_Id, addr 0x1ce0510, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);

  /// @brief Method set_IdAttribute, addr 0x1ce14c8, size 0x8, virtual true, abstract: false, final false
  inline void set_IdAttribute(::StringW value);

  /// @brief Method set_IsChameleon, addr 0x1ce05b8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsChameleon(bool value);

  /// @brief Method set_IsCompiledBySet, addr 0x1ce0324, size 0xc, virtual false, abstract: false, final false
  inline void set_IsCompiledBySet(bool value);

  /// @brief Method set_IsPreprocessed, addr 0x1ce0338, size 0xc, virtual false, abstract: false, final false
  inline void set_IsPreprocessed(bool value);

  /// @brief Method set_IsRedefined, addr 0x1ce034c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsRedefined(bool value);

  /// @brief Method set_TargetNamespace, addr 0x1ce02f4, size 0x8, virtual false, abstract: false, final false
  inline void set_TargetNamespace(::StringW value);

  /// @brief Method set_Version, addr 0x1ce0304, size 0x8, virtual false, abstract: false, final false
