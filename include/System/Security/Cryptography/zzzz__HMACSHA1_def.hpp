...
public:
  ...
  /// @brief Method .ctor, addr 0x1d1e80c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1d1f1a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor, addr 0x1d1f1b0, size 0xc8, virtual false, abstract: false, final false
