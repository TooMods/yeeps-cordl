...
// Type: UnityEngine.Rendering::SerializedDictionary`4
...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<SK>*> const& __cordl_internal_get_m_Keys() const;

  constexpr ::System::Collections::Generic::List_1<SV>*& __cordl_internal_get_m_Values();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<SV>*> const& __cordl_internal_get_m_Values() const;
