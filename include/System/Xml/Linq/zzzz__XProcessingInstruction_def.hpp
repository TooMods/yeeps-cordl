...
public:
  ...
  /// @brief Method CloneNode, addr 0x1336018, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateName, addr 0x1335d3c, size 0xe0, virtual false, abstract: false, final false
  static inline void ValidateName(::StringW name);

  /// @brief Method WriteTo, addr 0x1335fa4, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1335e1c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XProcessingInstruction* other);

  /// @brief Method .ctor, addr 0x1331a04, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW target, ::StringW data);

  /// @brief Method get_Data, addr 0x1335e98, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Data();

  /// @brief Method get_NodeType, addr 0x1335f94, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Target, addr 0x1335f9c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Target();

  /// @brief Method set_Data, addr 0x1335ea0, size 0xf4, virtual false, abstract: false, final false
