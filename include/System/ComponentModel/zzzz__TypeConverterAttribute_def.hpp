...
public:
  ...
  /// @brief Method Equals, addr 0x1b0ddc4, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1b0de44, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b0dcf4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1b0dd50, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x1b0dd94, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName);

  static inline ::System::ComponentModel::TypeConverterAttribute* getStaticF_Default();

  /// @brief Method get_ConverterTypeName, addr 0x1b0ddbc, size 0x8, virtual false, abstract: false, final false
