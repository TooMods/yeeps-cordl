...
public:
  ...
  /// @brief Method Add, addr 0x1d05ee8, size 0x114, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::StringW value);

  /// @brief Method Clear, addr 0x1d059a0, size 0x9c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetName, addr 0x1d06044, size 0x58, virtual true, abstract: false, final true
  inline ::StringW GetName(int32_t i);

  /// @brief Method GetValue, addr 0x1d0609c, size 0x58, virtual true, abstract: false, final true
  inline ::StringW GetValue(int32_t i);

  /// @brief Method GetValue, addr 0x1d060f4, size 0xc0, virtual true, abstract: false, final true
  inline ::StringW GetValue(::StringW name);
  ...
  /// @brief Method .ctor, addr 0x1d04628, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Length, addr 0x1d05ffc, size 0x48, virtual true, abstract: false, final true
  inline int32_t get_Length();

  /// @brief Method get_Names, addr 0x1d061b4, size 0x50, virtual true, abstract: false, final true
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Names();

  /// @brief Method get_Values, addr 0x1d06204, size 0x50, virtual true, abstract: false, final true
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Values();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x1d05924, size 0x7c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Error, addr 0x1d046c8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Exception* Error(::StringW msg);

  /// @brief Method Expect, addr 0x1d04c20, size 0xc0, virtual false, abstract: false, final false
  inline void Expect(int32_t c);

  /// @brief Method HandleBufferedContent, addr 0x1d057ec, size 0x138, virtual false, abstract: false, final false
  inline void HandleBufferedContent();

  /// @brief Method HandleWhitespaces, addr 0x1d04ad8, size 0xc0, virtual false, abstract: false, final false
  inline void HandleWhitespaces();

  /// @brief Method IsNameChar, addr 0x1d048f8, size 0xfc, virtual false, abstract: false, final false
  inline bool IsNameChar(char16_t c, bool start);

  /// @brief Method IsWhitespace, addr 0x1d049f4, size 0x30, virtual false, abstract: false, final false
  inline bool IsWhitespace(int32_t c);

  static inline ::Mono::Xml::SmallXmlParser* New_ctor();

  /// @brief Method Parse, addr 0x1d040c4, size 0x1c8, virtual false, abstract: false, final false
  inline void Parse(::System::IO::TextReader* input, ::Mono::Xml::__SmallXmlParser__IContentHandler* handler);

  /// @brief Method Peek, addr 0x1d04c00, size 0x20, virtual false, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x1d04b98, size 0x68, virtual false, abstract: false, final false
  inline int32_t Read();

  /// @brief Method ReadAttribute, addr 0x1d05bc4, size 0x164, virtual false, abstract: false, final false
  inline void ReadAttribute(::Mono::Xml::__SmallXmlParser__AttrListImpl* a);

  /// @brief Method ReadCDATASection, addr 0x1d05a3c, size 0x100, virtual false, abstract: false, final false
  inline void ReadCDATASection();

  /// @brief Method ReadCharacterReference, addr 0x1d05db0, size 0x138, virtual false, abstract: false, final false
  inline int32_t ReadCharacterReference();

  /// @brief Method ReadCharacters, addr 0x1d05d28, size 0x88, virtual false, abstract: false, final false
  inline void ReadCharacters();

  /// @brief Method ReadComment, addr 0x1d05b3c, size 0x88, virtual false, abstract: false, final false
  inline void ReadComment();

  /// @brief Method ReadContent, addr 0x1d05128, size 0x6c4, virtual false, abstract: false, final false
  inline void ReadContent();

  /// @brief Method ReadName, addr 0x1d04f84, size 0x1a4, virtual false, abstract: false, final false
  inline ::StringW ReadName();

  /// @brief Method ReadReference, addr 0x1d04dbc, size 0x1c8, virtual false, abstract: false, final false
  inline void ReadReference();

  /// @brief Method ReadUntil, addr 0x1d04ce0, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW ReadUntil(char16_t until, bool handleReferences);

  /// @brief Method SkipWhitespaces, addr 0x1d04a24, size 0x8, virtual false, abstract: false, final false
  inline void SkipWhitespaces();

  /// @brief Method SkipWhitespaces, addr 0x1d04a2c, size 0xac, virtual false, abstract: false, final false
  inline void SkipWhitespaces(bool expected);

  /// @brief Method UnexpectedEndError, addr 0x1d0480c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d03f20, size 0x118, virtual false, abstract: false, final false
  inline void _ctor();
