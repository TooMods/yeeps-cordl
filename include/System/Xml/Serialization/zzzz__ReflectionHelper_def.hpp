...
public:
  ...
  /// @brief Method CheckSerializableType, addr 0x1257b50, size 0x2e4, virtual false, abstract: false, final false
  static inline void CheckSerializableType(::System::Type* type, bool allowPrivateConstructors);

  /// @brief Method GetRegisteredClrType, addr 0x12579e8, size 0x168, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* GetRegisteredClrType(::System::Type* type, ::StringW ns);

  /// @brief Method GetRegisteredSchemaType, addr 0x12577bc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterClrType, addr 0x1257890, size 0x158, virtual false, abstract: false, final false
  inline void RegisterClrType(::System::Xml::Serialization::XmlTypeMapping* map, ::System::Type* type, ::StringW ns);

  /// @brief Method RegisterSchemaType, addr 0x12576f0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1257ea0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
