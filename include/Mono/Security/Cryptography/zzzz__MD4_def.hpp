...
public:
  // Declarations
  /// @brief Method Create, addr 0x1cc7ed0, size 0x58, virtual false, abstract: false, final false
  static inline ::Mono::Security::Cryptography::MD4* Create();

  static inline ::Mono::Security::Cryptography::MD4* New_ctor();

  /// @brief Method .ctor, addr 0x1cc7eb0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
