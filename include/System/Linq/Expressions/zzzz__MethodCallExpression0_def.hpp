...
public:
  ...
  /// @brief Method GetArgument, addr 0x183a544, size 0x50, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetArgument(int32_t index);

  static inline ::System::Linq::Expressions::MethodCallExpression0* New_ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method Rewrite, addr 0x183a59c, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183a540, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_ArgumentCount, addr 0x183a594, size 0x8, virtual true, abstract: false, final false
