...
public:
  // Declarations
  /// @brief Method IdnEquivalent, addr 0x1714800, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW IdnEquivalent(::StringW hostname);

  /// @brief Method IdnEquivalent, addr 0x171484c, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method IdnEquivalent, addr 0x1714ac8, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsASCIILetterOrDigit, addr 0x1714568, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsASCIILetterOrDigit(char16_t character, ByRef<bool> notCanonical);

  /// @brief Method IsIdnAce, addr 0x1714d08, size 0x98, virtual false, abstract: false, final false
  static inline bool IsIdnAce(::StringW input, int32_t index);

  /// @brief Method IsIdnAce, addr 0x1714cbc, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsIdnAce(::cordl_internals::Ptr<char16_t> input, int32_t index);

  /// @brief Method IsValid, addr 0x17143ec, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidByIri, addr 0x1714618, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidDomainLabelCharacter, addr 0x17145b4, size 0x64, virtual false, abstract: false, final false
  static inline bool IsValidDomainLabelCharacter(char16_t character, ByRef<bool> notCanonical);

  /// @brief Method ParseCanonicalName, addr 0x171424c, size 0x1a0, virtual false, abstract: false, final false
  static inline ::StringW ParseCanonicalName(::StringW str, int32_t start, int32_t end, ByRef<bool> loopback);

  /// @brief Method UnicodeEquivalent, addr 0x1714ebc, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method UnicodeEquivalent, addr 0x1714da0, size 0x11c, virtual false, abstract: false, final false
