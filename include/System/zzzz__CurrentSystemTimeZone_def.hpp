...
public:
  ...
  /// @brief Method GetTimeZoneData, addr 0x2998880, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29987bc, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
