...
public:
  ...
  /// @brief Method MoveNext, addr 0x2de25c4, size 0xdd8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2de339c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2de33a8, size 0x7d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2de3b80, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method FlushContents, addr 0x2de2530, size 0x94, virtual false, abstract: false, final false
  inline void FlushContents(::System::IO::Stream* stream, int32_t contentLength);

  /// @brief Method Initialize, addr 0x2de2344, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadHeaders, addr 0x2de2428, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2de2298, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpWebRequest* request, ::System::Uri* connectUri);

  /// @brief Method get_Challenge, addr 0x2de2304, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Challenge();

  /// @brief Method get_CloseConnection, addr 0x2de22d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseConnection();

  /// @brief Method get_ConnectUri, addr 0x2de2290, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_ConnectUri();

  /// @brief Method get_Data, addr 0x2de2334, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Data();

  /// @brief Method get_Headers, addr 0x2de2314, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_ProxyVersion, addr 0x2de2324, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_ProxyVersion();

  /// @brief Method get_Request, addr 0x2de2288, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Method get_StatusCode, addr 0x2de22ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_StatusCode();

  /// @brief Method get_Success, addr 0x2de22c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Success();

  /// @brief Method set_Challenge, addr 0x2de230c, size 0x8, virtual false, abstract: false, final false
  inline void set_Challenge(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_CloseConnection, addr 0x2de22e0, size 0xc, virtual false, abstract: false, final false
  inline void set_CloseConnection(bool value);

  /// @brief Method set_Data, addr 0x2de233c, size 0x8, virtual false, abstract: false, final false
  inline void set_Data(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_Headers, addr 0x2de231c, size 0x8, virtual false, abstract: false, final false
  inline void set_Headers(::System::Net::WebHeaderCollection* value);

  /// @brief Method set_ProxyVersion, addr 0x2de232c, size 0x8, virtual false, abstract: false, final false
  inline void set_ProxyVersion(::System::Version* value);

  /// @brief Method set_StatusCode, addr 0x2de22f4, size 0x8, virtual false, abstract: false, final false
  inline void set_StatusCode(int32_t value);

  /// @brief Method set_StatusDescription, addr 0x2de22fc, size 0x8, virtual false, abstract: false, final false
  inline void set_StatusDescription(::StringW value);

  /// @brief Method set_Success, addr 0x2de22cc, size 0xc, virtual false, abstract: false, final false
