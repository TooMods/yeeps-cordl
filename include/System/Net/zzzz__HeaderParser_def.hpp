...
public:
  // Declarations
  /// @brief Method Invoke, addr 0xf59780, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf596ac, size 0xd4, virtual false, abstract: false, final false
