...
public:
  ...
  /// @brief Method GetRealElementMap, addr 0x30458dc, size 0x3dc, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* GetRealElementMap(::StringW name, ::StringW ens);

  /// @brief Method GetRealTypeMap, addr 0x303d598, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateRoot, addr 0x3045cb8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30457a8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseMap, addr 0x3045898, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* get_BaseMap();

  /// @brief Method get_DerivedTypes, addr 0x3045888, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_DerivedTypes();

  /// @brief Method get_HasXmlTypeNamespace, addr 0x3045878, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasXmlTypeNamespace();

  /// @brief Method get_IsAny, addr 0x30458c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAny();

  /// @brief Method get_IsNullable, addr 0x30458b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_MultiReferenceType, addr 0x3045890, size 0x8, virtual false, abstract: false, final false
  inline bool get_MultiReferenceType();

  /// @brief Method get_TypeData, addr 0x3045858, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_TypeData();

  /// @brief Method get_TypeFullName, addr 0x30429f8, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_TypeFullName();

  /// @brief Method get_XmlType, addr 0x3045860, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlType();

  /// @brief Method get_XmlTypeNamespace, addr 0x303d708, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_XmlTypeNamespace();

  /// @brief Method set_BaseMap, addr 0x30458a0, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseMap(::System::Xml::Serialization::XmlTypeMapping* value);

  /// @brief Method set_IncludeInSchema, addr 0x30458a8, size 0xc, virtual false, abstract: false, final false
  inline void set_IncludeInSchema(bool value);

  /// @brief Method set_IsAny, addr 0x30458d0, size 0xc, virtual false, abstract: false, final false
  inline void set_IsAny(bool value);

  /// @brief Method set_IsNullable, addr 0x30458bc, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_XmlType, addr 0x3045868, size 0x8, virtual false, abstract: false, final false
  inline void set_XmlType(::StringW value);

  /// @brief Method set_XmlTypeNamespace, addr 0x3045870, size 0x8, virtual false, abstract: false, final false
