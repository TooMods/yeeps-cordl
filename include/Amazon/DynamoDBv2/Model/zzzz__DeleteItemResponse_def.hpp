...
CORDL_MODULE_EXPORT(DeleteItemResponse)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::DeleteItemResponse);
// Type: Amazon.DynamoDBv2.Model::DeleteItemResponse
// SizeInfo { instance_size: 64, native_size: -1, calculated_instance_size: 64, calculated_native_size: 64, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::DeleteItemResponse*
class CORDL_TYPE DeleteItemResponse : public ::Amazon::Runtime::AmazonWebServiceResponse {
public:
  // Declarations
  ...
  /// @brief Method IsSetAttributes, addr 0x1229880, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetAttributes();

  /// @brief Method IsSetConsumedCapacity, addr 0x12298e8, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetConsumedCapacity();

  /// @brief Method IsSetItemCollectionMetrics, addr 0x1229908, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetItemCollectionMetrics();

  static inline ::Amazon::DynamoDBv2::Model::DeleteItemResponse* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x1229918, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Attributes, addr 0x1229870, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* get_Attributes();

  /// @brief Method get_ConsumedCapacity, addr 0x12298d8, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::ConsumedCapacity* get_ConsumedCapacity();

  /// @brief Method get_ItemCollectionMetrics, addr 0x12298f8, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::ItemCollectionMetrics* get_ItemCollectionMetrics();

  /// @brief Method set_Attributes, addr 0x1229878, size 0x8, virtual false, abstract: false, final false
  inline void set_Attributes(::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* value);

  /// @brief Method set_ConsumedCapacity, addr 0x12298e0, size 0x8, virtual false, abstract: false, final false
  inline void set_ConsumedCapacity(::Amazon::DynamoDBv2::Model::ConsumedCapacity* value);

  /// @brief Method set_ItemCollectionMetrics, addr 0x1229900, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemCollectionMetrics(::Amazon::DynamoDBv2::Model::ItemCollectionMetrics* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr DeleteItemResponse();

public:
  // Ctor Parameters [CppParam { name: "", ty: "DeleteItemResponse", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeleteItemResponse(DeleteItemResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeleteItemResponse", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeleteItemResponse(DeleteItemResponse const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::DeleteItemResponse, 0x40>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::DeleteItemResponse, ____attributes) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::DeleteItemResponse, ____consumedCapacity) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::DeleteItemResponse, ____itemCollectionMetrics) == 0x38, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::DeleteItemResponse);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::DeleteItemResponse*, "Amazon.DynamoDBv2.Model", "DeleteItemResponse");
