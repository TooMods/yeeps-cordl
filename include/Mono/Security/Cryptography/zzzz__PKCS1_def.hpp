...
public:
  ...
  /// @brief Method Compare, addr 0x1cc8c44, size 0x74, virtual false, abstract: false, final false
  static inline bool Compare(::ArrayW<uint8_t, ::Array<uint8_t>*> array1, ::ArrayW<uint8_t, ::Array<uint8_t>*> array2);

  /// @brief Method CreateFromName, addr 0x1cc97b8, size 0x40c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromName(::StringW name);

  /// @brief Method CreateFromOid, addr 0x1cc975c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromOid(::StringW oid);

  /// @brief Method Encode_v15, addr 0x1cc9004, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method HashNameFromOid, addr 0x1cc934c, size 0x394, virtual false, abstract: false, final false
  static inline ::StringW HashNameFromOid(::StringW oid, bool throwOnError);

  /// @brief Method I2OSP, addr 0x1cc8cb8, size 0x8c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> I2OSP(::ArrayW<uint8_t, ::Array<uint8_t>*> x, int32_t size);

  /// @brief Method OS2IP, addr 0x1cc8d44, size 0xbc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> OS2IP(::ArrayW<uint8_t, ::Array<uint8_t>*> x);

  /// @brief Method RSAVP1, addr 0x1cc8e00, size 0x20, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> RSAVP1(::System::Security::Cryptography::RSA* rsa, ::ArrayW<uint8_t, ::Array<uint8_t>*> s);

  /// @brief Method Verify_v15, addr 0x1cc8e20, size 0x1e4, virtual false, abstract: false, final false
