...
public:
  ...
  /// @brief Method LocalFindAndPop, addr 0xeccccc, size 0x2c8, virtual false, abstract: false, final false
  inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem* obj);

  /// @brief Method LocalPop, addr 0xecd15c, size 0x27c, virtual false, abstract: false, final false
  inline bool LocalPop(ByRef<::System::Threading::IThreadPoolWorkItem*> obj);

  /// @brief Method LocalPush, addr 0xecc760, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method TrySteal, addr 0xecd508, size 0x8, virtual false, abstract: false, final false
  inline bool TrySteal(ByRef<::System::Threading::IThreadPoolWorkItem*> obj, ByRef<bool> missedSteal);

  /// @brief Method TrySteal, addr 0xecd9fc, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecdc48, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CompareExchangeIndexes, addr 0xecdd10, size 0x68, virtual false, abstract: false, final false
  inline bool CompareExchangeIndexes(ByRef<int32_t> prevUpper, int32_t newUpper, ByRef<int32_t> prevLower, int32_t newLower);

  /// @brief Method GetIndexes, addr 0xecdcdc, size 0x34, virtual false, abstract: false, final false
  inline void GetIndexes(ByRef<int32_t> upper, ByRef<int32_t> lower);

  /// @brief Method IsUsedUp, addr 0xecd4c4, size 0x44, virtual false, abstract: false, final false
  inline bool IsUsedUp();

  static inline ::System::Threading::__ThreadPoolWorkQueue__QueueSegment* New_ctor();

  /// @brief Method TryDequeue, addr 0xecd3d8, size 0xec, virtual false, abstract: false, final false
  inline bool TryDequeue(ByRef<::System::Threading::IThreadPoolWorkItem*> node);

  /// @brief Method TryEnqueue, addr 0xeccbac, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecc348, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dequeue, addr 0xeccf94, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispatch, addr 0xecd510, size 0x454, virtual false, abstract: false, final false
  static inline bool Dispatch();

  /// @brief Method Enqueue, addr 0xecc630, size 0x130, virtual false, abstract: false, final false
  inline void Enqueue(::System::Threading::IThreadPoolWorkItem* callback, bool forceGlobal);

  /// @brief Method EnsureCurrentThreadHasQueue, addr 0xecc3a4, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Threading::ThreadPoolWorkQueueThreadLocals* EnsureCurrentThreadHasQueue();

  /// @brief Method EnsureThreadRequested, addr 0xecc548, size 0x98, virtual false, abstract: false, final false
  inline void EnsureThreadRequested();

  /// @brief Method LocalFindAndPop, addr 0xeccc5c, size 0x70, virtual false, abstract: false, final false
  inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem* callback);

  /// @brief Method MarkThreadRequestSatisfied, addr 0xecc5e8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecc2d4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
