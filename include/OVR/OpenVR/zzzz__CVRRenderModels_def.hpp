...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2a79884, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2a79984, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x2a79870, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a79798, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FreeRenderModel, addr 0x2a7939c, size 0x24, virtual false, abstract: false, final false
  inline void FreeRenderModel(void* pRenderModel);

  /// @brief Method FreeTexture, addr 0x2a793e4, size 0x24, virtual false, abstract: false, final false
  inline void FreeTexture(void* pTexture);

  /// @brief Method FreeTextureD3D11, addr 0x2a79450, size 0x24, virtual false, abstract: false, final false
  inline void FreeTextureD3D11(void* pD3D11Texture2D);

  /// @brief Method GetComponentButtonMask, addr 0x2a79504, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetComponentCount, addr 0x2a794bc, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetComponentCount(::StringW pchRenderModelName);

  /// @brief Method GetComponentName, addr 0x2a794e0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentRenderModelName, addr 0x2a79528, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentState, addr 0x2a79570, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentStateForDevicePath, addr 0x2a7954c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelCount, addr 0x2a79498, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetRenderModelCount();

  /// @brief Method GetRenderModelErrorNameFromEnum, addr 0x2a79714, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError error);

  /// @brief Method GetRenderModelName, addr 0x2a79474, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelOriginalPath, addr 0x2a796f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelThumbnailURL, addr 0x2a796cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadIntoTextureD3D11_Async, addr 0x2a7942c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, void* pDstTexture);

  /// @brief Method LoadRenderModel_Async, addr 0x2a79378, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW pchRenderModelName, ByRef<void*> ppRenderModel);

  /// @brief Method LoadTextureD3D11_Async, addr 0x2a79408, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadTexture_Async, addr 0x2a793c0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderModelHasComponent, addr 0x2a796a8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a79264, size 0x114, virtual false, abstract: false, final false
