...
public:
  // Declarations
  /// @brief Method GetPrimitiveDefaultValue, addr 0x1b62bc0, size 0x2d8, virtual false, abstract: false, final false
  static inline ::System::Object* GetPrimitiveDefaultValue(::System::Type* type);

  /// @brief Method Int32ToObject, addr 0x1b54414, size 0x128, virtual false, abstract: false, final false
