...
public:
  ...
  template <typename T> static inline int32_t Partition(::ArrayW<T, ::Array<T>*> data, int32_t left, int32_t right);
  ...
  /// @brief Method QuickSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline void QuickSort(::ArrayW<T, ::Array<T>*> data, int32_t left, int32_t right);
