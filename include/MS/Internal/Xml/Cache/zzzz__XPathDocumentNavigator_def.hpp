...
public:
  ...
  /// @brief Method Clone, addr 0x1b32370, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNavigator* Clone();

  /// @brief Method GetPositionHashCode, addr 0x1b32ca4, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetPositionHashCode();

  /// @brief Method HasLineInfo, addr 0x1b32ac0, size 0x44, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method IsSamePosition, addr 0x1b32a04, size 0xac, virtual true, abstract: false, final false
  inline bool IsSamePosition(::System::Xml::XPath::XPathNavigator* other);

  /// @brief Method MoveToFirstNamespace, addr 0x1b32598, size 0xf4, virtual true, abstract: false, final false
  inline bool MoveToFirstNamespace(::System::Xml::XPath::XPathNamespaceScope namespaceScope);

  /// @brief Method MoveToNextNamespace, addr 0x1b32854, size 0x108, virtual true, abstract: false, final false
  inline bool MoveToNextNamespace(::System::Xml::XPath::XPathNamespaceScope scope);

  /// @brief Method MoveToParent, addr 0x1b32980, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b31f10, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LineNumber, addr 0x1b32b04, size 0x84, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x1b32bb0, size 0xa4, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x1b32430, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NameTable, addr 0x1b32538, size 0x44, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x1b32488, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x1b323ec, size 0x38, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x1b324e0, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_UnderlyingObject, addr 0x1b32ab0, size 0x10, virtual true, abstract: false, final false
  inline ::System::Object* get_UnderlyingObject();

  /// @brief Method get_Value, addr 0x1b31f94, size 0x1fc, virtual true, abstract: false, final false
