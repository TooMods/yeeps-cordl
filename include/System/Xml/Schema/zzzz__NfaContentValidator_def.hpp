...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x2fabf9c, size 0x48, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x2fabfe4, size 0x1e8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x2fac1cc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x2fabcf0, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x2fabdec, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fabc3c, size 0xb4, virtual false, abstract: false, final false
