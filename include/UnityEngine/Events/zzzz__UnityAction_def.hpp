...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x29e409c, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Events::UnityAction* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x29e3fe0, size 0xbc, virtual false, abstract: false, final false
