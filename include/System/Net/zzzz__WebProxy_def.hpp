...
public:
  ...
  /// @brief Method AreAllBypassed, addr 0xf6b558, size 0x308, virtual false, abstract: false, final false
  static inline bool AreAllBypassed(::System::Collections::Generic::IEnumerable_1<::StringW>* proxies, bool checkFirstOnly);

  /// @brief Method CreateDefaultProxy, addr 0xf6b4c0, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Net::IWebProxy* CreateDefaultProxy();

  /// @brief Method GetObjectData, addr 0xf6b394, size 0x124, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetProxy, addr 0xf6a658, size 0x190, virtual true, abstract: false, final true
  inline ::System::Uri* GetProxy(::System::Uri* destination);

  /// @brief Method GetProxyAuto, addr 0xf6a7e8, size 0x188, virtual false, abstract: false, final false
  inline bool GetProxyAuto(::System::Uri* destination, ByRef<::System::Uri*> proxyUri);

  /// @brief Method IsBypassed, addr 0xf6ae20, size 0xf4, virtual true, abstract: false, final true
  inline bool IsBypassed(::System::Uri* host);

  /// @brief Method IsBypassedAuto, addr 0xf6af14, size 0x108, virtual false, abstract: false, final false
  inline bool IsBypassedAuto(::System::Uri* destination, ByRef<bool> isBypassed);

  /// @brief Method IsBypassedManual, addr 0xf6a970, size 0xc8, virtual false, abstract: false, final false
  inline bool IsBypassedManual(::System::Uri* host);

  /// @brief Method IsLocal, addr 0xf6abd0, size 0x160, virtual false, abstract: false, final false
  inline bool IsLocal(::System::Uri* host);

  /// @brief Method IsLocalInProxyHash, addr 0xf6ad30, size 0xf0, virtual false, abstract: false, final false
  inline bool IsLocalInProxyHash(::System::Uri* host);

  /// @brief Method IsMatchInBypassList, addr 0xf6aa38, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ProxyUri, addr 0xf6b860, size 0x31bc4, virtual false, abstract: false, final false
  static inline ::System::Uri* ProxyUri(::StringW proxyName);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0xf6b388, size 0xc, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method UnsafeUpdateFromRegistry, addr 0xf6b37c, size 0xc, virtual false, abstract: false, final false
  inline void UnsafeUpdateFromRegistry();

  /// @brief Method UpdateRegExList, addr 0xf6a31c, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf6a254, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xf6a268, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf6b528, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool enableAutoproxy);

  /// @brief Method .ctor, addr 0xf6b01c, size 0x360, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Credentials, addr 0xf6a554, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method get_ScriptEngine, addr 0xf6b4b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::AutoWebProxyScriptEngine* get_ScriptEngine();

  /// @brief Method get_UseDefaultCredentials, addr 0xf6a564, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Credentials, addr 0xf6a55c, size 0x8, virtual true, abstract: false, final true
  inline void set_Credentials(::System::Net::ICredentials* value);

  /// @brief Method set_UseDefaultCredentials, addr 0xf6a5e0, size 0x78, virtual false, abstract: false, final false
