...
public:
  ...
  /// @brief Method PrivateDisposeNodeList, addr 0xfa1ea4, size 0x4, virtual true, abstract: false, final false
  inline void PrivateDisposeNodeList();

  /// @brief Method System.IDisposable.Dispose, addr 0xfa1e98, size 0xc, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method .ctor, addr 0xfa1ea8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline int32_t get_Count();

  /// @brief Method get_ItemOf, addr 0xfa1e8c, size 0xc, virtual true, abstract: false, final false
