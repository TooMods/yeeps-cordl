...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x185d1f4, size 0x40, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageCtrl* AsyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg,
                                                                                   ::System::Runtime::Remoting::Messaging::IMessageSink* replySink);

  /// @brief Method EndInvoke, addr 0x184cb08, size 0x110, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessage* EndInvoke();

  /// @brief Method GetReplyMessage, addr 0x185d234, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessage* GetReplyMessage();

  /// @brief Method Invoke, addr 0x185d3f4, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* Invoke();

  static inline ::System::Runtime::Remoting::Messaging::AsyncResult* New_ctor();

  /// @brief Method SetCompletedSynchronously, addr 0x185d244, size 0xc, virtual false, abstract: false, final false
  inline void SetCompletedSynchronously(bool completed);

  /// @brief Method SetMessageCtrl, addr 0x185d23c, size 0x8, virtual true, abstract: false, final false
  inline void SetMessageCtrl(::System::Runtime::Remoting::Messaging::IMessageCtrl* mc);

  /// @brief Method SyncProcessMessage, addr 0x185d250, size 0x190, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x185d3f0, size 0x4, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x185d3f8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x185d08c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AsyncDelegate, addr 0x185d1e4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_AsyncDelegate();

  /// @brief Method get_AsyncState, addr 0x185d094, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x185d09c, size 0x124, virtual true, abstract: false, final false
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CallMessage, addr 0x185d3e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::MonoMethodMessage* get_CallMessage();

  /// @brief Method get_CompletedSynchronously, addr 0x185d1c0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CompletedSynchronously();

  /// @brief Method get_EndInvokeCalled, addr 0x185d1d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_EndInvokeCalled();

  /// @brief Method get_IsCompleted, addr 0x185d1c8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method get_NextSink, addr 0x185d1ec, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_CallMessage, addr 0x185d3e8, size 0x8, virtual false, abstract: false, final false
  inline void set_CallMessage(::System::Runtime::Remoting::Messaging::MonoMethodMessage* value);

  /// @brief Method set_EndInvokeCalled, addr 0x185d1d8, size 0xc, virtual false, abstract: false, final false
