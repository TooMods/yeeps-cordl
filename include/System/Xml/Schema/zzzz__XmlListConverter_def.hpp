...
public:
  ...
  /// @brief Method ChangeListType, addr 0x191ffe4, size 0xdf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ChangeType, addr 0x1924958, size 0x108, virtual true, abstract: false, final false
  inline ::System::Object* ChangeType(::System::Object* value, ::System::Type* destinationType, ::System::Xml::IXmlNamespaceResolver* nsResolver);

  /// @brief Method Create, addr 0x19247ac, size 0x1ac, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlValueConverter* Create(::System::Xml::Schema::XmlValueConverter* atomicConverter);

  /// @brief Method CreateInvalidClrMappingException, addr 0x1924bf0, size 0x26c, virtual false, abstract: false, final false
  inline ::System::Exception* CreateInvalidClrMappingException(::System::Type* sourceType, ::System::Type* destinationType);

  /// @brief Method IsListType, addr 0x1924a60, size 0x190, virtual false, abstract: false, final false
  inline bool IsListType(::System::Type* type);

  /// @brief Method ListAsString, addr 0x1924e5c, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method StringAsList, addr 0x1925208, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToList, addr 0x19252b8, size 0x644, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1924394, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlBaseConverter* atomicConverter);

  /// @brief Method .ctor, addr 0x191a3d8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlBaseConverter* atomicConverter, ::System::Type* clrTypeDefault);

  /// @brief Method .ctor, addr 0x191a2d8, size 0x68, virtual false, abstract: false, final false
