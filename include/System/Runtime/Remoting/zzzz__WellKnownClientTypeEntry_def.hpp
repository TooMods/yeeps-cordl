...
public:
  ...
  /// @brief Method ToString, addr 0x184a7cc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x184a680, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW objectUrl);

  /// @brief Method get_ApplicationUrl, addr 0x184a7b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ObjectType, addr 0x184a7bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUrl, addr 0x184a7c4, size 0x8, virtual false, abstract: false, final false
