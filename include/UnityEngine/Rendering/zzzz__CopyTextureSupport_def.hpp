...
public:
  ...
  /// @brief Field Copy3D value: static_cast<int32_t>(0x2)
  static ::UnityEngine::Rendering::CopyTextureSupport const Copy3D;

  /// @brief Field DifferentTypes value: static_cast<int32_t>(0x4)
  ...
  /// @brief Field RTToTexture value: static_cast<int32_t>(0x10)
  static ::UnityEngine::Rendering::CopyTextureSupport const RTToTexture;

  /// @brief Field TextureToRT value: static_cast<int32_t>(0x8)
