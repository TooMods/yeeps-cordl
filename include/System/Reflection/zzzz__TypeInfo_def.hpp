...
public:
  // Declarations
  __declspec(property(get = get_DeclaredMembers))::System::Collections::Generic::IEnumerable_1<::System::Reflection::MemberInfo*>* DeclaredMembers;
  ...
  /// @brief Method AsType, addr 0x2616070, size 0x4, virtual true, abstract: false, final false
  inline ::System::Type* AsType();

  /// @brief Method IsAssignableFrom, addr 0x2616098, size 0x17c, virtual true, abstract: false, final false
  inline bool IsAssignableFrom(::System::Reflection::TypeInfo* typeInfo);

  static inline ::System::Reflection::TypeInfo* New_ctor();

  /// @brief Method System.Reflection.IReflectableType.GetTypeInfo, addr 0x261606c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Reflection::TypeInfo* System_Reflection_IReflectableType_GetTypeInfo();

  /// @brief Method .ctor, addr 0x26159a4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DeclaredMembers, addr 0x2616074, size 0x14, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Reflection::MemberInfo*>* get_DeclaredMembers();

  /// @brief Method get_ImplementedInterfaces, addr 0x2616088, size 0x10, virtual true, abstract: false, final false
