...
public:
  ...
  /// @brief Method Open, addr 0x2469f7c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2469dd0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool newFormat);

  /// @brief Method get_TrustedRoot, addr 0x2469ea0, size 0xdc, virtual false, abstract: false, final false
