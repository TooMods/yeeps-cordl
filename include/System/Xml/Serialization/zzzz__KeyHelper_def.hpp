...
public:
  // Declarations
  /// @brief Method AddField, addr 0x125740c, size 0x8, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, ::StringW val);

  /// @brief Method AddField, addr 0x1257414, size 0xe4, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, ::StringW val, ::StringW def);

  /// @brief Method AddField, addr 0x1257604, size 0xec, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, ::System::Type* val);

  /// @brief Method AddField, addr 0x12574f8, size 0xc, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, bool val);

  /// @brief Method AddField, addr 0x1257504, size 0x48, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, bool val, bool def);

  /// @brief Method AddField, addr 0x125754c, size 0xb8, virtual false, abstract: false, final false
