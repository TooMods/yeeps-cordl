...
template <typename T> inline ::UnityEngine::Rendering::ListChangedEventHandler_1<T>* UnityEngine::Rendering::ListChangedEventHandler_1<T>::New_ctor(::System::Object* object, void* method) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*>(object, method));
}
template <typename T> inline void UnityEngine::Rendering::ListChangedEventHandler_1<T>::_ctor(::System::Object* object, void* method) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
