...
public:
  ...
  /// @brief Method .ctor, addr 0x2fb1a6c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x2fb8a88, size 0x8, virtual true, abstract: false, final false
