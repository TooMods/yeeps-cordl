...
public:
  ...
  /// @brief Method ToString, addr 0x261c2a8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x261c2a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
