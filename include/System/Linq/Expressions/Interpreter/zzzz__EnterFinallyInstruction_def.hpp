...
public:
  ...
  /// @brief Method Create, addr 0x18447e8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x1844904, size 0x6c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x1844770, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedContinuations, addr 0x18447e0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedContinuations();

  /// @brief Method get_InstructionName, addr 0x1844798, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x18447d8, size 0x8, virtual true, abstract: false, final false
