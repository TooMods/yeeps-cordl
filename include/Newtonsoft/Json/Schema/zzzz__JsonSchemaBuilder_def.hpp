...
public:
  ...
  /// @brief Method <MapType>b__0, addr 0x109abd0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x109abc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildSchema, addr 0x1096d90, size 0x3ac, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* BuildSchema(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method MapType, addr 0x109a950, size 0x16c, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Schema::JsonSchemaType MapType(::StringW type);

  /// @brief Method MapType, addr 0x109aabc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x1096c38, size 0x150, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Pop();

  /// @brief Method ProcessAdditionalItems, addr 0x1099f4c, size 0xac, virtual false, abstract: false, final false
  inline void ProcessAdditionalItems(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessAdditionalProperties, addr 0x1099ea0, size 0xac, virtual false, abstract: false, final false
  inline void ProcessAdditionalProperties(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessEnum, addr 0x1099ff8, size 0x4a8, virtual false, abstract: false, final false
  inline void ProcessEnum(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessExtends, addr 0x109a4a0, size 0x4b0, virtual false, abstract: false, final false
  inline void ProcessExtends(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessItems, addr 0x1099944, size 0x55c, virtual false, abstract: false, final false
  inline void ProcessItems(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessProperties, addr 0x1099358, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSchemaProperties, addr 0x1097b3c, size 0x1248, virtual false, abstract: false, final false
  inline void ProcessSchemaProperties(::Newtonsoft::Json::Linq::JObject* schemaObject);

  /// @brief Method ProcessType, addr 0x1098d84, size 0x5d4, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::Newtonsoft::Json::Schema::JsonSchemaType> ProcessType(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method Push, addr 0x1096a88, size 0x1b0, virtual false, abstract: false, final false
  inline void Push(::Newtonsoft::Json::Schema::JsonSchema* value);

  /// @brief Method Read, addr 0x10954a8, size 0xd8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Read(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ResolveReferences, addr 0x109713c, size 0x92c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* ResolveReferences(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method UnescapeReference, addr 0x1097a68, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10953d8, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaResolver* resolver);

  /// @brief Method get_CurrentSchema, addr 0x1096d88, size 0x8, virtual false, abstract: false, final false
