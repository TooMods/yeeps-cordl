...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce3a80, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EnableUpaCheck, addr 0x1ce3aa0, size 0x8, virtual false, abstract: false, final false
