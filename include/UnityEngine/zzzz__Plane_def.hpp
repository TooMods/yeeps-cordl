...
public:
  ...
  /// @brief Method ClosestPointOnPlane, addr 0x27ff2b4, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ClosestPointOnPlane(::UnityEngine::Vector3 point);

  /// @brief Method Raycast, addr 0x27ff2f0, size 0x100, virtual false, abstract: false, final false
  inline bool Raycast(::UnityEngine::Ray ray, ByRef<float_t> enter);

  /// @brief Method ToString, addr 0x27ff408, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x27ff414, size 0x188, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x27ff13c, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ::UnityEngine::Vector3 c);

  /// @brief Method .ctor, addr 0x27ff02c, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 inNormal, ::UnityEngine::Vector3 inPoint);

  /// @brief Method get_distance, addr 0x27ff024, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_normal, addr 0x27ff018, size 0xc, virtual false, abstract: false, final false
