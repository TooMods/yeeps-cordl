...
public:
  ...
  /// @brief Method ReadValue, addr 0x18fc35c, size 0x1c8, virtual false, abstract: false, final false
  inline void ReadValue(::cordl_internals::Ptr<void> buffer, int32_t bufferSize);

  /// @brief Method ReadValueAsButton, addr 0x18fc524, size 0x84, virtual false, abstract: false, final false
  inline bool ReadValueAsButton();

  /// @brief Method ReadValueAsObject, addr 0x18fc5a8, size 0x88, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method ToString, addr 0x18fc630, size 0x250, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_action, addr 0x18fc118, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_actionIndex, addr 0x18fbf9c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_actionIndex();

  /// @brief Method get_bindingIndex, addr 0x18fbfa4, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_bindingIndex();

  /// @brief Method get_canceled, addr 0x18fc0e0, size 0x38, virtual false, abstract: false, final false
  inline bool get_canceled();

  /// @brief Method get_control, addr 0x18fc148, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_controlIndex, addr 0x18fbfd8, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_controlIndex();

  /// @brief Method get_duration, addr 0x18fc254, size 0x68, virtual false, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_interaction, addr 0x18fc18c, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::IInputInteraction* get_interaction();

  /// @brief Method get_interactionIndex, addr 0x18fc00c, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_interactionIndex();

  /// @brief Method get_performed, addr 0x18fc0a8, size 0x38, virtual false, abstract: false, final false
  inline bool get_performed();

  /// @brief Method get_phase, addr 0x18fc040, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_startTime, addr 0x18fc21c, size 0x38, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_started, addr 0x18fc070, size 0x38, virtual false, abstract: false, final false
  inline bool get_started();

  /// @brief Method get_time, addr 0x18fc1e4, size 0x38, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_valueSizeInBytes, addr 0x18fc30c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method get_valueType, addr 0x18fc2bc, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActiveControlIsValid, addr 0x18fbad0, size 0xf4, virtual false, abstract: false, final false
  inline bool ActiveControlIsValid(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method BindingIndexOnActionToBindingIndexOnMap, addr 0x18fbd34, size 0x1a0, virtual false, abstract: false, final false
  inline int32_t BindingIndexOnActionToBindingIndexOnMap(int32_t indexOfBindingOnAction);

  /// @brief Method BindingIndexOnMapToBindingIndexOnAction, addr 0x18fbed4, size 0xc8, virtual false, abstract: false, final false
  inline int32_t BindingIndexOnMapToBindingIndexOnAction(int32_t indexOfBindingOnMap);

  /// @brief Method Clone, addr 0x18fb440, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* Clone();

  /// @brief Method CreateInternalActionMapForSingletonAction, addr 0x18fb9ac, size 0xd4, virtual false, abstract: false, final false
  inline void CreateInternalActionMapForSingletonAction();

  /// @brief Method Disable, addr 0x18fb3d0, size 0x70, virtual false, abstract: false, final false
  inline void Disable();

  /// @brief Method Dispose, addr 0x18fb05c, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Enable, addr 0x18fb348, size 0x88, virtual false, abstract: false, final false
  inline void Enable();

  /// @brief Method FindEffectiveBindingMask, addr 0x18fbca4, size 0x90, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> FindEffectiveBindingMask();

  /// @brief Method GenerateId, addr 0x18fb978, size 0x34, virtual false, abstract: false, final false
  inline void GenerateId();

  /// @brief Method GetOrCreateActionMap, addr 0x18fa814, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* GetOrCreateActionMap();

  /// @brief Method GetTimeoutCompletionPercentage, addr 0x18fb844, size 0x134, virtual false, abstract: false, final false
  inline float_t GetTimeoutCompletionPercentage();

  /// @brief Method IsInProgress, addr 0x18fb6ac, size 0x58, virtual false, abstract: false, final false
  inline bool IsInProgress();

  /// @brief Method IsPressed, addr 0x18fb658, size 0x54, virtual false, abstract: false, final false
  inline bool IsPressed();

  /// @brief Method MakeSureIdIsInPlace, addr 0x18fa51c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x18fb520, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method RequestInitialStateCheckOnEnabledAction, addr 0x18fba90, size 0x40, virtual false, abstract: false, final false
  inline void RequestInitialStateCheckOnEnabledAction();

  /// @brief Method Reset, addr 0x18fb5bc, size 0x9c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method System.ICloneable.Clone, addr 0x18fb51c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x18fb078, size 0x2d0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WasPerformedThisFrame, addr 0x18fadc8, size 0xa0, virtual false, abstract: false, final false
  inline bool WasPerformedThisFrame();

  /// @brief Method WasPressedThisFrame, addr 0x18fb704, size 0xa0, virtual false, abstract: false, final false
  inline bool WasPressedThisFrame();

  /// @brief Method WasReleasedThisFrame, addr 0x18fb7a4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18faf2c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x18faf3c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method add_canceled, addr 0x18fac64, size 0x58, virtual false, abstract: false, final false
  inline void add_canceled(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method add_performed, addr 0x18fad14, size 0x58, virtual false, abstract: false, final false
  inline void add_performed(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method add_started, addr 0x18fabb4, size 0x58, virtual false, abstract: false, final false
  inline void add_started(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method get_actionMap, addr 0x18fa5d0, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* get_actionMap();

  /// @brief Method get_activeControl, addr 0x18fae68, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_activeControl();

  /// @brief Method get_bindingMask, addr 0x18fa610, size 0x10, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> get_bindingMask();

  /// @brief Method get_bindings, addr 0x18fa8dc, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputBinding> get_bindings();

  /// @brief Method get_controls, addr 0x18fa98c, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_controls();

  /// @brief Method get_currentState, addr 0x18faac4, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputActionState__TriggerState get_currentState();

  /// @brief Method get_enabled, addr 0x18fab6c, size 0x48, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_expectedControlType, addr 0x18fa5b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_expectedControlType();

  /// @brief Method get_id, addr 0x18fa4e8, size 0x34, virtual false, abstract: false, final false
  inline ::System::Guid get_id();

  /// @brief Method get_idDontGenerate, addr 0x18fa568, size 0x48, virtual false, abstract: false, final false
  inline ::System::Guid get_idDontGenerate();

  /// @brief Method get_inProgress, addr 0x18fab20, size 0x4c, virtual false, abstract: false, final false
  inline bool get_inProgress();

  /// @brief Method get_interactions, addr 0x18fa5c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_interactions();

  /// @brief Method get_isSingletonAction, addr 0x18fa5f0, size 0x20, virtual false, abstract: false, final false
  inline bool get_isSingletonAction();

  /// @brief Method get_name, addr 0x18fa4d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_phase, addr 0x18faa84, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_processors, addr 0x18fa5c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processors();

  /// @brief Method get_triggered, addr 0x18fadc4, size 0x4, virtual false, abstract: false, final false
  inline bool get_triggered();

  /// @brief Method get_type, addr 0x18fa4e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionType get_type();

  /// @brief Method get_wantsInitialStateCheck, addr 0x18faef4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_canceled, addr 0x18facbc, size 0x58, virtual false, abstract: false, final false
  inline void remove_canceled(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_performed, addr 0x18fad6c, size 0x58, virtual false, abstract: false, final false
  inline void remove_performed(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_started, addr 0x18fac0c, size 0x58, virtual false, abstract: false, final false
  inline void remove_started(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method set_bindingMask, addr 0x18fa620, size 0x1f4, virtual false, abstract: false, final false
  inline void set_bindingMask(::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> value);

  /// @brief Method set_expectedControlType, addr 0x18fa5b8, size 0x8, virtual false, abstract: false, final false
  inline void set_expectedControlType(::StringW value);

  /// @brief Method set_wantsInitialStateCheck, addr 0x18faf10, size 0x1c, virtual false, abstract: false, final false
