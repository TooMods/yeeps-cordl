...
public:
  ...
  /// @brief Method Create, addr 0x1d22960, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RC2* Create();

  /// @brief Method Create, addr 0x1d22b4c, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RC2* Create(::StringW AlgName);
  ...
  /// @brief Method .ctor, addr 0x1d22790, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_EffectiveKeySize, addr 0x1d2280c, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_EffectiveKeySize();

  /// @brief Method get_KeySize, addr 0x1d228e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_EffectiveKeySize, addr 0x1d22828, size 0xb8, virtual true, abstract: false, final false
  inline void set_EffectiveKeySize(int32_t value);

  /// @brief Method set_KeySize, addr 0x1d228e8, size 0x78, virtual true, abstract: false, final false
