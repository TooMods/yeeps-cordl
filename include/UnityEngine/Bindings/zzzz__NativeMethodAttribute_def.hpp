...
public:
  ...
  /// @brief Method .ctor, addr 0x23a79d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a79dc, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x23a7ae0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFreeFunction);

  /// @brief Method .ctor, addr 0x23a7b08, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFreeFunction, bool isThreadSafe);

  /// @brief Method set_HasExplicitThis, addr 0x23a79c8, size 0xc, virtual true, abstract: false, final true
  inline void set_HasExplicitThis(bool value);

  /// @brief Method set_IsFreeFunction, addr 0x23a79b0, size 0xc, virtual true, abstract: false, final true
  inline void set_IsFreeFunction(bool value);

  /// @brief Method set_IsThreadSafe, addr 0x23a79a4, size 0xc, virtual true, abstract: false, final true
  inline void set_IsThreadSafe(bool value);

  /// @brief Method set_Name, addr 0x23a799c, size 0x8, virtual true, abstract: false, final true
  inline void set_Name(::StringW value);

  /// @brief Method set_ThrowsException, addr 0x23a79bc, size 0xc, virtual true, abstract: false, final true
