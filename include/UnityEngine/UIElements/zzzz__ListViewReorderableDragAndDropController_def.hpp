...
public:
  ...
  /// @brief Method HandleDragAndDrop, addr 0x27d8e1c, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDrop, addr 0x27d8fb8, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27d8db8, size 0x34, virtual false, abstract: false, final false
