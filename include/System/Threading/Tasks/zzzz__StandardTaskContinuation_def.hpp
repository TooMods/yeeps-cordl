...
public:
  ...
  /// @brief Method Run, addr 0xedc718, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed9eb0, size 0x120, virtual false, abstract: false, final false
