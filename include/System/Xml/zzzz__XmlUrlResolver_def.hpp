...
public:
  ...
  /// @brief Method MoveNext, addr 0x1253150, size 0x37c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x12534cc, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetEntity, addr 0x1252ec4, size 0x17c, virtual true, abstract: false, final false
  inline ::System::Object* GetEntity(::System::Uri* absoluteUri, ::StringW role, ::System::Type* ofObjectToReturn);

  /// @brief Method GetEntityAsync, addr 0x1253044, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveUri, addr 0x1253040, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1252ebc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Object* getStaticF_s_DownloadManager();

  /// @brief Method get_DownloadManager, addr 0x1252de8, size 0xd4, virtual false, abstract: false, final false
