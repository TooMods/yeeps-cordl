...
public:
  ...
  /// @brief Method Equals, addr 0x162b2c4, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x162b38c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x162b264, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x162baa8, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x162b408, size 0x544, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x162afa0, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x162aff4, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::RangeHeaderValue* source);

  /// @brief Method get_Ranges, addr 0x162b1dc, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::ICollection_1<::System::Net::Http::Headers::RangeItemHeaderValue*>* get_Ranges();

  /// @brief Method get_Unit, addr 0x162b25c, size 0x8, virtual false, abstract: false, final false
