...
public:
  ...
  /// @brief Method Finalize, addr 0x198f6bc, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::AbuseReportOptions* New_ctor();

  /// @brief Method SetPreventPeopleChooser, addr 0x198f48c, size 0x68, virtual false, abstract: false, final false
  inline void SetPreventPeopleChooser(bool value);

  /// @brief Method SetReportType, addr 0x198f578, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x198f3c0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x198f664, size 0x58, virtual false, abstract: false, final false
