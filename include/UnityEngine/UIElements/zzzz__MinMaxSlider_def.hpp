...
public:
  ...
  /// @brief Method Init, addr 0x2ce4964, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ce4b20, size 0x170, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClampValues, addr 0x2ce1e50, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 ClampValues(::UnityEngine::Vector2 valueToClamp);

  /// @brief Method ComputeValueDragStateNoThumb, addr 0x2ce46d8, size 0xa0, virtual false, abstract: false, final false
  inline void ComputeValueDragStateNoThumb(float_t lowLimitPosition, float_t highLimitPosition, float_t dragElementPos);

  /// @brief Method ComputeValueFromDraggingThumb, addr 0x2ce41e0, size 0x1a4, virtual false, abstract: false, final false
  inline void ComputeValueFromDraggingThumb(float_t dragElementStartPos, float_t dragElementEndPos);

  /// @brief Method ComputeValueFromPosition, addr 0x2ce3e80, size 0x1c0, virtual false, abstract: false, final false
  inline float_t ComputeValueFromPosition(float_t positionToConvert);

  /// @brief Method ExecuteDefaultAction, addr 0x2ce4040, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSliderValueFromClick, addr 0x2ce4384, size 0x354, virtual false, abstract: false, final false
  inline void SetSliderValueFromClick();

  /// @brief Method SetSliderValueFromDrag, addr 0x2ce414c, size 0x94, virtual false, abstract: false, final false
  inline void SetSliderValueFromDrag();

  /// @brief Method SetValueWithoutNotify, addr 0x2ce2024, size 0x94, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::UnityEngine::Vector2 newValue);

  /// @brief Method SliderLerpUnclamped, addr 0x2ce3e70, size 0x10, virtual false, abstract: false, final false
  inline float_t SliderLerpUnclamped(float_t a, float_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x2ce3e60, size 0x10, virtual false, abstract: false, final false
  inline float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue);

  /// @brief Method UpdateDragElementPosition, addr 0x2ce20b8, size 0x14dc, virtual false, abstract: false, final false
  inline void UpdateDragElementPosition();

  /// @brief Method UpdateDragElementPosition, addr 0x2ce3dcc, size 0x94, virtual false, abstract: false, final false
  inline void UpdateDragElementPosition(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method UpdateMixedValueContent, addr 0x2ce4778, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ce3884, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2ce38a4, size 0x528, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clampedDragger, addr 0x2ce1d88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ClampedDragger_1<float_t>* get_clampedDragger();

  /// @brief Method get_dragElement, addr 0x2ce1d58, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_dragElement();

  /// @brief Method get_dragMaxThumb, addr 0x2ce1d78, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_dragMaxThumb();

  /// @brief Method get_dragMinThumb, addr 0x2ce1d68, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_dragMinThumb();

  /// @brief Method get_highLimit, addr 0x2ce370c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_highLimit();

  /// @brief Method get_lowLimit, addr 0x2ce3594, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lowLimit();

  /// @brief Method get_maxValue, addr 0x2ce1e88, size 0x20, virtual false, abstract: false, final false
  inline float_t get_maxValue();

  /// @brief Method get_minValue, addr 0x2ce1d98, size 0x10, virtual false, abstract: false, final false
  inline float_t get_minValue();

  /// @brief Method get_value, addr 0x2ce1f50, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_clampedDragger, addr 0x2ce1d90, size 0x8, virtual false, abstract: false, final false
  inline void set_clampedDragger(::UnityEngine::UIElements::ClampedDragger_1<float_t>* value);

  /// @brief Method set_dragElement, addr 0x2ce1d60, size 0x8, virtual false, abstract: false, final false
  inline void set_dragElement(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_dragMaxThumb, addr 0x2ce1d80, size 0x8, virtual false, abstract: false, final false
  inline void set_dragMaxThumb(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_dragMinThumb, addr 0x2ce1d70, size 0x8, virtual false, abstract: false, final false
  inline void set_dragMinThumb(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_highLimit, addr 0x2ce3714, size 0x170, virtual false, abstract: false, final false
  inline void set_highLimit(float_t value);

  /// @brief Method set_lowLimit, addr 0x2ce359c, size 0x170, virtual false, abstract: false, final false
  inline void set_lowLimit(float_t value);

  /// @brief Method set_maxValue, addr 0x2ce1ea8, size 0xa8, virtual false, abstract: false, final false
  inline void set_maxValue(float_t value);

  /// @brief Method set_minValue, addr 0x2ce1da8, size 0xa8, virtual false, abstract: false, final false
  inline void set_minValue(float_t value);

  /// @brief Method set_value, addr 0x2ce1f98, size 0x8c, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ce491c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
