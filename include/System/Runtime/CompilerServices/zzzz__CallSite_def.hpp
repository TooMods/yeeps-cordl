...
public:
  ...
  /// @brief Method .ctor, addr 0x1b638fc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::CompilerServices::CallSiteBinder* binder);

  /// @brief Method get_Binder, addr 0x1b63924, size 0x8, virtual false, abstract: false, final false
