...
public:
  ...
  /// @brief Method Run, addr 0x18435d0, size 0x34, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x1843604, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Cache, addr 0x18434fc, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x18435c0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x1843580, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x18435c8, size 0x8, virtual true, abstract: false, final false
