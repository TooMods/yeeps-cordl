...
public:
  // Declarations
  /// @brief Method ManagedStreamLength, addr 0x28401b8, size 0xfc, virtual false, abstract: false, final false
  static inline void ManagedStreamLength(::System::IO::Stream* stream, void* returnValueAddress);

  /// @brief Method ManagedStreamRead, addr 0x283ff80, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ManagedStreamSeek, addr 0x28400a0, size 0x118, virtual false, abstract: false, final false
  static inline void ManagedStreamSeek(int64_t offset, uint32_t origin, ::System::IO::Stream* stream, void* returnValueAddress);

  /// @brief Method ValidateLoadFromStream, addr 0x283fe70, size 0x110, virtual false, abstract: false, final false
