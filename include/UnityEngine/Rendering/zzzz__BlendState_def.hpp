...
// SizeInfo { instance_size: 68, native_size: 68, calculated_instance_size: 68, calculated_native_size: 84, minimum_alignment: 2, natural_alignment: 2, packing: None, specified_packing: None }
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
  ...
  /// @brief Method Equals, addr 0x2a94d44, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a94c84, size 0xc0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::BlendState other);

  /// @brief Method GetHashCode, addr 0x2a94dd4, size 0xbc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x2a94be4, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(bool separateMRTBlend, bool alphaToMask);

  /// @brief Method get_defaultValue, addr 0x2a94b80, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method set_blendState0, addr 0x2a94c7c, size 0x8, virtual false, abstract: false, final false
