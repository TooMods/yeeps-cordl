...
public:
  ...
  /// @brief Method .ctor, addr 0x23a797c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_WritableSelf, addr 0x23a7970, size 0xc, virtual true, abstract: false, final true
