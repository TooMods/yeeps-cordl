...
public:
  ...
  /// @brief Method MoveNext, addr 0x133897c, size 0x3a4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1338d20, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CloneToken, addr 0x1337d70, size 0x60, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken();

  /// @brief Method DeepEquals, addr 0x1337a08, size 0xac, virtual true, abstract: false, final false
  inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken* node);

  /// @brief Method GetDeepHashCode, addr 0x1338118, size 0x44, virtual true, abstract: false, final false
  inline int32_t GetDeepHashCode();

  /// @brief Method IndexOfItem, addr 0x13364c8, size 0x64, virtual true, abstract: false, final false
  inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Load, addr 0x1338460, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JConstructor* Load(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method Load, addr 0x1338468, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x13363ac, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x13363b8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeItem, addr 0x133652c, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x1337dd0, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x13362b8, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13373c8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13378d8, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x1337870, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> content);

  /// @brief Method .ctor, addr 0x13378a4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Object* content);

  /// @brief Method .ctor, addr 0x1337498, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JConstructor* other);

  /// @brief Method get_ChildrenTokens, addr 0x13364c0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_ChildrenTokens();

  /// @brief Method get_Item, addr 0x1337eb8, size 0x12c, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(::System::Object* key);

  /// @brief Method get_Name, addr 0x13373b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Type, addr 0x13373c0, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JTokenType get_Type();

  /// @brief Method set_Item, addr 0x1337fe4, size 0x134, virtual true, abstract: false, final false
  inline void set_Item(::System::Object* key, ::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method set_Name, addr 0x13373b8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1338d2c, size 0x5ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x13393cc, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
