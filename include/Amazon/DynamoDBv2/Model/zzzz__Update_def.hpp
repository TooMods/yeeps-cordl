...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::Update);
// Type: Amazon.DynamoDBv2.Model::Update
// SizeInfo { instance_size: 72, native_size: -1, calculated_instance_size: 72, calculated_native_size: 72, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::Update*
class CORDL_TYPE Update : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Field _updateExpression, offset 0x40, size 0x8
  ...
  /// @brief Method IsSetConditionExpression, addr 0x1053c74, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetConditionExpression();

  /// @brief Method IsSetExpressionAttributeNames, addr 0x1053c94, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetExpressionAttributeNames();

  /// @brief Method IsSetExpressionAttributeValues, addr 0x1053cfc, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetExpressionAttributeValues();

  /// @brief Method IsSetKey, addr 0x1053d64, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetKey();

  /// @brief Method IsSetReturnValuesOnConditionCheckFailure, addr 0x1053dcc, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetReturnValuesOnConditionCheckFailure();

  /// @brief Method IsSetTableName, addr 0x1053e3c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetTableName();

  /// @brief Method IsSetUpdateExpression, addr 0x1053e5c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetUpdateExpression();

  static inline ::Amazon::DynamoDBv2::Model::Update* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x1053e6c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConditionExpression, addr 0x1053c64, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ConditionExpression();

  /// @brief Method get_ExpressionAttributeNames, addr 0x1053c84, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* get_ExpressionAttributeNames();

  /// @brief Method get_ExpressionAttributeValues, addr 0x1053cec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Key, addr 0x1053d54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* get_Key();

  /// @brief Method get_ReturnValuesOnConditionCheckFailure, addr 0x1053dbc, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::ReturnValuesOnConditionCheckFailure* get_ReturnValuesOnConditionCheckFailure();

  /// @brief Method get_TableName, addr 0x1053e2c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TableName();

  /// @brief Method get_UpdateExpression, addr 0x1053e4c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_UpdateExpression();

  /// @brief Method set_ConditionExpression, addr 0x1053c6c, size 0x8, virtual false, abstract: false, final false
  inline void set_ConditionExpression(::StringW value);

  /// @brief Method set_ExpressionAttributeNames, addr 0x1053c8c, size 0x8, virtual false, abstract: false, final false
  inline void set_ExpressionAttributeNames(::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* value);

  /// @brief Method set_ExpressionAttributeValues, addr 0x1053cf4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Key, addr 0x1053d5c, size 0x8, virtual false, abstract: false, final false
  inline void set_Key(::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* value);

  /// @brief Method set_ReturnValuesOnConditionCheckFailure, addr 0x1053dc4, size 0x8, virtual false, abstract: false, final false
  inline void set_ReturnValuesOnConditionCheckFailure(::Amazon::DynamoDBv2::ReturnValuesOnConditionCheckFailure* value);

  /// @brief Method set_TableName, addr 0x1053e34, size 0x8, virtual false, abstract: false, final false
  inline void set_TableName(::StringW value);

  /// @brief Method set_UpdateExpression, addr 0x1053e54, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Update", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Update(Update&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Update", modifiers: "const&", def_value: None }]
  ...
  /// @brief Field _updateExpression, offset: 0x40, size: 0x8, def value: None
  ::StringW ____updateExpression;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::Update, 0x48>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____conditionExpression) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____expressionAttributeNames) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____expressionAttributeValues) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____key) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____returnValuesOnConditionCheckFailure) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____tableName) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::Update, ____updateExpression) == 0x40, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::Update);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::Update*, "Amazon.DynamoDBv2.Model", "Update");
