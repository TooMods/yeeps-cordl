...
UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_get_m_GlobalBindings() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_GlobalBindings;
}
template <typename CBType> constexpr void UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_set_m_GlobalBindings(::System::Collections::Generic::HashSet_1<int32_t>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___m_GlobalBindings)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
template <typename CBType>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ComputeBuffer*> const& UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_get_m_GPUConstantBuffer() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_GPUConstantBuffer;
}
template <typename CBType> constexpr void UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_set_m_GPUConstantBuffer(::UnityEngine::ComputeBuffer* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___m_GPUConstantBuffer)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
