...
public:
  ...
  /// @brief Method InitializePlayerRoot, addr 0x1eb236c, size 0xc4, virtual false, abstract: false, final false
  inline void InitializePlayerRoot();

  static inline ::UnityEngine::InputSystem::UI::MultiplayerEventSystem* New_ctor();

  /// @brief Method OnDisable, addr 0x1eb244c, size 0x8, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x1eb2430, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x1eb2454, size 0x108, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x1eb255c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playerRoot, addr 0x1eb235c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_playerRoot();

  /// @brief Method set_playerRoot, addr 0x1eb2364, size 0x8, virtual false, abstract: false, final false
