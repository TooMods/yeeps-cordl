...
public:
  ...
  /// @brief Method .ctor, addr 0x1ab9d84, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x1ab9e0c, size 0x3c, virtual false, abstract: false, final false
