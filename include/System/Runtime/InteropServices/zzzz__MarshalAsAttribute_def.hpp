...
public:
  ...
  /// @brief Method Copy, addr 0x1b43b7c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b43b4c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::UnmanagedType unmanagedType);

  /// @brief Method get_Value, addr 0x1b43b74, size 0x8, virtual false, abstract: false, final false
