...
public:
  ...
  /// @brief Method CompareTo, addr 0x1ca8a84, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ca8a58, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindNameType, addr 0x1ca674c, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Data::__XDRSchema__NameType* FindNameType(::StringW name);

  /// @brief Method FindTypeNode, addr 0x1ca57f0, size 0x340, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* FindTypeNode(::System::Xml::XmlElement* node);

  /// @brief Method GetInstanceName, addr 0x1ca695c, size 0x180, virtual false, abstract: false, final false
  inline ::StringW GetInstanceName(::System::Xml::XmlElement* node);

  /// @brief Method GetMinMax, addr 0x1ca7350, size 0x348, virtual false, abstract: false, final false
  inline void GetMinMax(::System::Xml::XmlElement* elNode, bool isAttribute, ByRef<int32_t> minOccurs, ByRef<int32_t> maxOccurs);

  /// @brief Method GetMinMax, addr 0x1ca5e50, size 0x10, virtual false, abstract: false, final false
  inline void GetMinMax(::System::Xml::XmlElement* elNode, ByRef<int32_t> minOccurs, ByRef<int32_t> maxOccurs);

  /// @brief Method HandleColumn, addr 0x1ca6adc, size 0x874, virtual false, abstract: false, final false
  inline void HandleColumn(::System::Xml::XmlElement* node, ::System::Data::DataTable* table);

  /// @brief Method HandleTable, addr 0x1ca5630, size 0x1c0, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* HandleTable(::System::Xml::XmlElement* node);

  /// @brief Method HandleTypeNode, addr 0x1ca7698, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSimpleTable, addr 0x1ca5e60, size 0x230, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* InstantiateSimpleTable(::System::Data::DataSet* dataSet, ::System::Xml::XmlElement* node);

  /// @brief Method InstantiateTable, addr 0x1ca6090, size 0x6bc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTextOnlyContent, addr 0x1ca5b30, size 0x1d0, virtual false, abstract: false, final false
  inline bool IsTextOnlyContent(::System::Xml::XmlElement* node);

  /// @brief Method IsXDRField, addr 0x1ca5d00, size 0x150, virtual false, abstract: false, final false
  inline bool IsXDRField(::System::Xml::XmlElement* node, ::System::Xml::XmlElement* typeNode);

  /// @brief Method LoadSchema, addr 0x1ca5420, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDataType, addr 0x1ca6820, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ca53b0, size 0x70, virtual false, abstract: false, final false
