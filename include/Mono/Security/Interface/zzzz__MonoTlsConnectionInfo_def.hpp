...
public:
  ...
  /// @brief Method ToString, addr 0x246e89c, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246e958, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CipherSuiteCode, addr 0x246e874, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::CipherSuiteCode get_CipherSuiteCode();

  /// @brief Method get_ProtocolVersion, addr 0x246e884, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::TlsProtocols get_ProtocolVersion();

  /// @brief Method set_CipherSuiteCode, addr 0x246e87c, size 0x8, virtual false, abstract: false, final false
  inline void set_CipherSuiteCode(::Mono::Security::Interface::CipherSuiteCode value);

  /// @brief Method set_PeerDomainName, addr 0x246e894, size 0x8, virtual false, abstract: false, final false
  inline void set_PeerDomainName(::StringW value);

  /// @brief Method set_ProtocolVersion, addr 0x246e88c, size 0x8, virtual false, abstract: false, final false
