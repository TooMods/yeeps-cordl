...
public:
  ...
  /// @brief Method GetExpression, addr 0x182d2fc, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182d380, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182d388, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182d2ac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182d2d4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x182d378, size 0x8, virtual true, abstract: false, final false
