...
public:
  ...
  /// @brief Method .ctor, addr 0x1b6938c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Burst::Intrinsics::v64 value);

  /// @brief Method get_Byte, addr 0x1b693b4, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Byte();

  /// @brief Method get_Double, addr 0x1b698cc, size 0x68, virtual false, abstract: false, final false
  inline ::ArrayW<double_t, ::Array<double_t>*> get_Double();

  /// @brief Method get_Float, addr 0x1b69784, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_Float();

  /// @brief Method get_SByte, addr 0x1b6948c, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<int8_t, ::Array<int8_t>*> get_SByte();

  /// @brief Method get_SInt, addr 0x1b6970c, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_SInt();

  /// @brief Method get_SLong, addr 0x1b697fc, size 0x68, virtual false, abstract: false, final false
  inline ::ArrayW<int64_t, ::Array<int64_t>*> get_SLong();

  /// @brief Method get_SShort, addr 0x1b695fc, size 0x98, virtual false, abstract: false, final false
  inline ::ArrayW<int16_t, ::Array<int16_t>*> get_SShort();

  /// @brief Method get_UInt, addr 0x1b69694, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t, ::Array<uint32_t>*> get_UInt();

  /// @brief Method get_ULong, addr 0x1b69864, size 0x68, virtual false, abstract: false, final false
  inline ::ArrayW<uint64_t, ::Array<uint64_t>*> get_ULong();

  /// @brief Method get_UShort, addr 0x1b69564, size 0x98, virtual false, abstract: false, final false
