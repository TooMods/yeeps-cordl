...
public:
  ...
  /// @brief Method ConstructPos, addr 0x30518a8, size 0x40, virtual true, abstract: false, final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method ExpandTree, addr 0x3051428, size 0x478, virtual true, abstract: false, final false
  ...
  /// @brief Method GetResolvedSymbols, addr 0x3051408, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30513dc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method get_IsNullable, addr 0x30518e8, size 0x40, virtual true, abstract: false, final false
