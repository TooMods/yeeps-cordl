...
public:
  ...
  /// @brief Method CreateTemporaryCollection, addr 0xf0d0c0, size 0x250, virtual false, abstract: false, final false
  inline ::System::Collections::IList* CreateTemporaryCollection();

  /// @brief Method CreateWrapper, addr 0xf0ccf4, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreFSharpListCreatorIfNecessary, addr 0xf0cbe0, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf079d4, size 0xd1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* underlyingType);

  /// @brief Method get_CanDeserialize, addr 0xf0c8b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CanDeserialize();

  /// @brief Method get_CollectionItemType, addr 0xf0c890, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_CollectionItemType();

  /// @brief Method get_HasParameterizedCreator, addr 0xf0c98c, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasParameterizedCreator();

  /// @brief Method get_HasParameterizedCreatorInternal, addr 0xf0c9a0, size 0x80, virtual false, abstract: false, final false
  inline bool get_HasParameterizedCreatorInternal();

  /// @brief Method get_IsArray, addr 0xf0c8a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsArray();

  /// @brief Method get_IsMultidimensionalArray, addr 0xf0c898, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsMultidimensionalArray();

  /// @brief Method get_OverrideCreator, addr 0xf0c984, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator();

  /// @brief Method get_ParameterizedCreator, addr 0xf0c8c4, size 0xc0, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator();

  /// @brief Method get_ShouldCreateWrapper, addr 0xf0c8a8, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldCreateWrapper();

  /// @brief Method set_CanDeserialize, addr 0xf0c8b8, size 0xc, virtual false, abstract: false, final false
  inline void set_CanDeserialize(bool value);

  /// @brief Method set_HasParameterizedCreator, addr 0xf0c994, size 0xc, virtual false, abstract: false, final false
  inline void set_HasParameterizedCreator(bool value);

  /// @brief Method set_OverrideCreator, addr 0xf086f0, size 0x10, virtual false, abstract: false, final false
