...
public:
  ...
  static __declspec(property(get = getStaticF_defaultValue, put = setStaticF_defaultValue))::UnityEngine::Rendering::RasterState defaultValue;
  ...
  /// @brief Method Equals, addr 0x2a92efc, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a92e88, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RasterState other);

  /// @brief Method GetHashCode, addr 0x2a92f74, size 0x60, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x2a92de4, size 0xa4, virtual false, abstract: false, final false
