...
public:
  ...
  /// @brief Method ECB, addr 0x196dfec, size 0x13c, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method GetStrongKey, addr 0x196df44, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x196dc08, size 0x33c, virtual false, abstract: false, final false
