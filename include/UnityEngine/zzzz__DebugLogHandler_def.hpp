...
public:
  ...
  /// @brief Method Internal_Log, addr 0x27e2dd8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_LogException, addr 0x27e2e34, size 0x44, virtual false, abstract: false, final false
  static inline void Internal_LogException(::System::Exception* ex, ::UnityEngine::Object* obj);

  /// @brief Method LogException, addr 0x27e2ee0, size 0x94, virtual true, abstract: false, final true
  inline void LogException(::System::Exception* exception, ::UnityEngine::Object* context);

  /// @brief Method LogFormat, addr 0x27e2e78, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27e2f74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
