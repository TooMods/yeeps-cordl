...
public:
  // Declarations
  /// @brief Method InlineIfPossibleOrElseQueue, addr 0xedc5cc, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedc710, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
