...
public:
  ...
  /// @brief Method Equals, addr 0x2232b88, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x2232c00, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::PhysicsScene2D other);

  /// @brief Method GetHashCode, addr 0x2232b80, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetRayIntersection, addr 0x223324c, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityEngine::RaycastHit2D GetRayIntersection(::UnityEngine::Ray ray, float_t distance, int32_t layerMask);

  /// @brief Method GetRayIntersection, addr 0x2233418, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionArray_Internal, addr 0x22334a4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionArray_Internal_Injected, addr 0x2233524, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersection_Internal, addr 0x2233300, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersection_Internal_Injected, addr 0x223339c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x2232c10, size 0x48, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method IsValid_Internal, addr 0x2232c58, size 0x44, virtual false, abstract: false, final false
  static inline bool IsValid_Internal(::UnityEngine::PhysicsScene2D physicsScene);

  /// @brief Method IsValid_Internal_Injected, addr 0x2232c9c, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsValid_Internal_Injected(ByRef<::UnityEngine::PhysicsScene2D> physicsScene);

  /// @brief Method Raycast, addr 0x2232f34, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x2232cd8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x2233004, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x2233128, size 0x30, virtual false, abstract: false, final false
  inline int32_t Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, float_t distance, ::UnityEngine::ContactFilter2D contactFilter,
                         ::System::Collections::Generic::List_1<::UnityEngine::RaycastHit2D>* results);

  /// @brief Method RaycastArray_Internal, addr 0x2233034, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastArray_Internal_Injected, addr 0x22330ac, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastList_Internal, addr 0x2233158, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastList_Internal_Injected, addr 0x22331d0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast_Internal, addr 0x2232ea0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast_Internal_Injected, addr 0x2232f88, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2232a9c, size 0xe4, virtual true, abstract: false, final false
