...
public:
  ...
  /// @brief Method ClearCompiledState, addr 0x1ce4f30, size 0x70, virtual false, abstract: false, final false
  inline void ClearCompiledState();

  /// @brief Method Clone, addr 0x1ce4a08, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  /// @brief Method Clone, addr 0x1ce0a50, size 0x66c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone(::System::Xml::Schema::XmlSchema* parentSchema);

  /// @brief Method CloneAttributes, addr 0x1ce2adc, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneGroupBaseParticles, addr 0x1ce5020, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneParticle, addr 0x1ce4c8c, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsIdAttribute, addr 0x1ce4664, size 0x3a4, virtual false, abstract: false, final false
  inline bool ContainsIdAttribute(bool findAll);

  /// @brief Method CreateAnyType, addr 0x1ce3f94, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResolvedElementForm, addr 0x1ce51f8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttributeQNameRef, addr 0x1ce2980, size 0x15c, virtual false, abstract: false, final false
  static inline bool HasAttributeQNameRef(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method HasParticleRef, addr 0x1ce4a10, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeWildcard, addr 0x1ce4638, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributeWildcard(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method SetAttributes, addr 0x1ce465c, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* newAttributes);

  /// @brief Method SetBlockResolved, addr 0x1ce4630, size 0x8, virtual false, abstract: false, final false
  inline void SetBlockResolved(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetContentTypeParticle, addr 0x1ce4628, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce42a4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AnyAttribute, addr 0x1ce4520, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AnyType, addr 0x1ce4384, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* get_AnyType();

  /// @brief Method get_AnyTypeContentValidator, addr 0x1ce4314, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::ContentValidator* get_AnyTypeContentValidator();

  /// @brief Method get_AttributeUses, addr 0x1ce4548, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeUses();

  /// @brief Method get_AttributeWildcard, addr 0x1ce45b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AttributeWildcard();

  /// @brief Method get_Attributes, addr 0x1ce44b4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes();

  /// @brief Method get_Block, addr 0x1ce445c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block();

  /// @brief Method get_BlockResolved, addr 0x1ce4540, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_BlockResolved();

  /// @brief Method get_ContentModel, addr 0x1ce4494, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentModel* get_ContentModel();

  /// @brief Method get_ContentType, addr 0x1ce4530, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_ContentTypeParticle, addr 0x1ce4538, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_ContentTypeParticle();

  /// @brief Method get_IsAbstract, addr 0x1ce4434, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsAbstract();

  /// @brief Method get_IsMixed, addr 0x1ce446c, size 0xc, virtual true, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method get_LocalElements, addr 0x1ce45bc, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_LocalElements();

  /// @brief Method get_Particle, addr 0x1ce44a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_Particle();

  /// @brief Method get_UntypedAnyType, addr 0x1ce43dc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AnyAttribute, addr 0x1ce4528, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Block, addr 0x1ce4464, size 0x8, virtual false, abstract: false, final false
  inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_ContentModel, addr 0x1ce449c, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentModel(::System::Xml::Schema::XmlSchemaContentModel* value);

  /// @brief Method set_HasWildCard, addr 0x1ce4640, size 0x1c, virtual false, abstract: false, final false
  inline void set_HasWildCard(bool value);

  /// @brief Method set_IsAbstract, addr 0x1ce4440, size 0x1c, virtual false, abstract: false, final false
  inline void set_IsAbstract(bool value);

  /// @brief Method set_IsMixed, addr 0x1ce4478, size 0x1c, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method set_Particle, addr 0x1ce44ac, size 0x8, virtual false, abstract: false, final false
