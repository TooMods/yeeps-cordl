...
public:
  ...
  /// @brief Method BeginCameraRendering, addr 0x2a93c30, size 0x64, virtual false, abstract: false, final false
  static inline void BeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method BeginContextRendering, addr 0x2a93bcc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2a91694, size 0x78, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2a93de8, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndCameraRendering, addr 0x2a93cf8, size 0x64, virtual false, abstract: false, final false
  static inline void EndCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method EndContextRendering, addr 0x2a93c94, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalRender, addr 0x2a91c18, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalRenderWithRequests, addr 0x2a91ca0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessRenderRequests, addr 0x2a93bc8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x2a93d5c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a93df4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_defaultSettings, addr 0x2a93dec, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::RenderPipelineGlobalSettings> get_defaultSettings();

  /// @brief Method get_disposed, addr 0x2a93dd4, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method set_disposed, addr 0x2a93ddc, size 0xc, virtual false, abstract: false, final false
