...
public:
  ...
  /// @brief Method .ctor, addr 0x30a7768, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_webRequest, addr 0x30a7758, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest* get_webRequest();

  /// @brief Method set_webRequest, addr 0x30a7760, size 0x8, virtual false, abstract: false, final false
