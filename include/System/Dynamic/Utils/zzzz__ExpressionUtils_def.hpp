...
public:
  // Declarations
  /// @brief Method GetParametersForValidation, addr 0x1def7dc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresCanRead, addr 0x1deffbc, size 0x8, virtual false, abstract: false, final false
  static inline void RequiresCanRead(::System::Linq::Expressions::Expression* expression, ::StringW paramName);

  /// @brief Method RequiresCanRead, addr 0x1defb2c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryQuote, addr 0x1defe98, size 0x124, virtual false, abstract: false, final false
  static inline bool TryQuote(::System::Type* parameterType, ByRef<::System::Linq::Expressions::Expression*> argument);

  /// @brief Method ValidateArgumentCount, addr 0x1df016c, size 0xd4, virtual false, abstract: false, final false
  static inline void ValidateArgumentCount(::System::Linq::Expressions::LambdaExpression* lambda);

  /// @brief Method ValidateArgumentCount, addr 0x1def870, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArgumentTypes, addr 0x1def51c, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateOneArgument, addr 0x1def91c, size 0x210, virtual false, abstract: false, final false
