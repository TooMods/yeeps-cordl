...
// Type: Unity.Services.Core.Telemetry.Internal::IDiagnosticsFactory
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDiagnosticsFactory", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IDiagnosticsFactory(IDiagnosticsFactory&&) = delete;
