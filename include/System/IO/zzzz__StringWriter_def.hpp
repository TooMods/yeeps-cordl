...
public:
  ...
  /// @brief Method Close, addr 0x1fc36d0, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x1fc36e0, size 0x10, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FlushAsync, addr 0x1fc3bb0, size 0x88, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync();

  /// @brief Method GetStringBuilder, addr 0x1fc379c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::StringBuilder* GetStringBuilder();
  ...
  /// @brief Method ToString, addr 0x1fc3c38, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Write, addr 0x1fc37cc, size 0x188, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x1fc3954, size 0x34, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x1fc37a4, size 0x28, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method WriteAsync, addr 0x1fc3ae8, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteAsync, addr 0x1fc3a38, size 0xb0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::StringW value);

  /// @brief Method WriteAsync, addr 0x1fc3988, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc3470, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1fc35ec, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x1fc3660, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::StringBuilder* sb);

  /// @brief Method .ctor, addr 0x1fc3504, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Encoding, addr 0x1fc36f0, size 0xac, virtual true, abstract: false, final false
