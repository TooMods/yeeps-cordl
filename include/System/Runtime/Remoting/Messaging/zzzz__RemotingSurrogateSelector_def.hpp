...
public:
  ...
  /// @brief Method GetSurrogate, addr 0x1867618, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18596c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
