...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129b318, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129b588, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x129b694, size 0x638, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::ICustomAttributeProvider* provider);

  /// @brief Method get_Order, addr 0x129cd2c, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_Order();

  /// @brief Method get_SortableOrder, addr 0x129d0c8, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_SortableOrder();

  /// @brief Method get_XmlAnyAttribute, addr 0x129bd84, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAnyAttributeAttribute* get_XmlAnyAttribute();

  /// @brief Method get_XmlAnyElements, addr 0x129bd8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAnyElementAttributes* get_XmlAnyElements();

  /// @brief Method get_XmlArray, addr 0x129bd94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlArrayAttribute* get_XmlArray();

  /// @brief Method get_XmlArrayItems, addr 0x129bd9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlArrayItemAttributes* get_XmlArrayItems();

  /// @brief Method get_XmlAttribute, addr 0x129bda4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAttributeAttribute* get_XmlAttribute();

  /// @brief Method get_XmlChoiceIdentifier, addr 0x129bdac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlChoiceIdentifierAttribute* get_XmlChoiceIdentifier();

  /// @brief Method get_XmlDefaultValue, addr 0x129bdb4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_XmlDefaultValue();

  /// @brief Method get_XmlElements, addr 0x129bdbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlElementAttributes* get_XmlElements();

  /// @brief Method get_XmlIgnore, addr 0x129bdc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_XmlIgnore();

  /// @brief Method get_XmlRoot, addr 0x129bdd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlRootAttribute* get_XmlRoot();

  /// @brief Method get_XmlText, addr 0x129bddc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTextAttribute* get_XmlText();

  /// @brief Method get_XmlType, addr 0x129bde4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeAttribute* get_XmlType();

  /// @brief Method get_Xmlns, addr 0x129bdcc, size 0x8, virtual false, abstract: false, final false
