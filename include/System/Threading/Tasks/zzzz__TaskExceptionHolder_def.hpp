...
public:
  ...
  /// @brief Method Add, addr 0xed6978, size 0xc, virtual false, abstract: false, final false
  inline void Add(::System::Object* exceptionObject, bool representsCancellation);

  /// @brief Method AddFaultException, addr 0xeddd10, size 0x50c, virtual false, abstract: false, final false
  inline void AddFaultException(::System::Object* exceptionObject);

  /// @brief Method CreateExceptionObject, addr 0xed6984, size 0x1b4, virtual false, abstract: false, final false
  inline ::System::AggregateException* CreateExceptionObject(bool calledFromFinalizer, ::System::Exception* includeThisException);

  /// @brief Method Finalize, addr 0xedd8b0, size 0x204, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCancellationExceptionDispatchInfo, addr 0xede28c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo();

  /// @brief Method GetExceptionDispatchInfos, addr 0xed6c44, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkAsHandled, addr 0xed5ca8, size 0x7c, virtual false, abstract: false, final false
  inline void MarkAsHandled(bool calledFromFinalizer);

  /// @brief Method MarkAsUnhandled, addr 0xede21c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCancellationException, addr 0xeddc54, size 0xbc, virtual false, abstract: false, final false
  inline void SetCancellationException(::System::Object* exceptionObject);

  /// @brief Method ShouldFailFastOnUnobservedException, addr 0xedd8a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed6950, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  static inline bool getStaticF_s_failFastOnUnobservedException();

  /// @brief Method get_ContainsFaultList, addr 0xed65e0, size 0x1c, virtual false, abstract: false, final false
