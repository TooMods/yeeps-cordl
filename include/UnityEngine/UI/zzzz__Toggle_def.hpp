...
public:
  ...
  /// @brief Method .ctor, addr 0x2913d7c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GraphicUpdateComplete, addr 0x2913dcc, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method InternalToggle, addr 0x29148f4, size 0x54, virtual false, abstract: false, final false
  inline void InternalToggle();

  /// @brief Method LayoutComplete, addr 0x2913dc8, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  static inline ::UnityEngine::UI::Toggle* New_ctor();

  /// @brief Method OnDestroy, addr 0x2913dd0, size 0x80, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x2914288, size 0x124, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x2914268, size 0x20, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x291423c, size 0x2c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPointerClick, addr 0x2914948, size 0x24, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x291496c, size 0x4, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method PlayEffect, addr 0x2913c2c, size 0xc4, virtual false, abstract: false, final false
  inline void PlayEffect(bool instant);

  /// @brief Method Rebuild, addr 0x2913dc4, size 0x4, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method Set, addr 0x29143ac, size 0x174, virtual false, abstract: false, final false
  inline void Set(bool value, bool sendCallback);

  /// @brief Method SetIsOnWithoutNotify, addr 0x29147a4, size 0xc, virtual false, abstract: false, final false
  inline void SetIsOnWithoutNotify(bool value);

  /// @brief Method SetToggleGroup, addr 0x2913af0, size 0x13c, virtual false, abstract: false, final false
  inline void SetToggleGroup(::UnityEngine::UI::ToggleGroup* newGroup, bool setMemberValue);

  /// @brief Method Start, addr 0x29148ec, size 0x8, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x2914970, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2913cf0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_group, addr 0x2913ac8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::ToggleGroup> get_group();

  /// @brief Method get_isOn, addr 0x2914790, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_group, addr 0x2913ad0, size 0x20, virtual false, abstract: false, final false
  inline void set_group(::UnityEngine::UI::ToggleGroup* value);

  /// @brief Method set_isOn, addr 0x2914798, size 0xc, virtual false, abstract: false, final false
