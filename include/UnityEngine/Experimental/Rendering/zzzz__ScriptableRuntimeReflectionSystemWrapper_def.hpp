...
public:
  ...
  /// @brief Method Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes, addr 0x29e10e8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29e10d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_implementation, addr 0x29e10d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem* get_implementation();

  /// @brief Method set_implementation, addr 0x29e10e0, size 0x8, virtual false, abstract: false, final false
