...
public:
  ...
  /// @brief Method Deinitialize, addr 0x22a9a78, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22a9ad0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
