...
public:
  ...
  /// @brief Method .ctor, addr 0x1eb31f8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distance, addr 0x1eb3338, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_graphic, addr 0x1eb331c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Graphic> get_graphic();

  /// @brief Method get_screenPosition, addr 0x1eb3330, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_worldHitPosition, addr 0x1eb3324, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SortedRaycastGraphics>b__25_0, addr 0x1eb33ac, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1eb33a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnDisable, addr 0x1eb2920, size 0xf4, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x1eb289c, size 0x84, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PerformRaycast, addr 0x1eac640, size 0x5f4, virtual false, abstract: false, final false
  ...
  /// @brief Method RayIntersectsRectTransform, addr 0x1eb2fa0, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x1eb2a14, size 0xb0, virtual true, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList);

  /// @brief Method SortedRaycastGraphics, addr 0x1eb2ac4, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1eb320c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_blockingMask, addr 0x1eb2840, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_blockingMask();

  /// @brief Method get_canvas, addr 0x1eb27ac, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_canvas();

  /// @brief Method get_checkFor2DOcclusion, addr 0x1eb2864, size 0x8, virtual false, abstract: false, final false
  inline bool get_checkFor2DOcclusion();

  /// @brief Method get_checkFor3DOcclusion, addr 0x1eb2850, size 0x8, virtual false, abstract: false, final false
  inline bool get_checkFor3DOcclusion();

  /// @brief Method get_eventCamera, addr 0x1eb2718, size 0x94, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_ignoreReversedGraphics, addr 0x1eb2878, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreReversedGraphics();

  /// @brief Method get_maxDistance, addr 0x1eb288c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_blockingMask, addr 0x1eb2848, size 0x8, virtual false, abstract: false, final false
  inline void set_blockingMask(::UnityEngine::LayerMask value);

  /// @brief Method set_checkFor2DOcclusion, addr 0x1eb286c, size 0xc, virtual false, abstract: false, final false
  inline void set_checkFor2DOcclusion(bool value);

  /// @brief Method set_checkFor3DOcclusion, addr 0x1eb2858, size 0xc, virtual false, abstract: false, final false
  inline void set_checkFor3DOcclusion(bool value);

  /// @brief Method set_ignoreReversedGraphics, addr 0x1eb2880, size 0xc, virtual false, abstract: false, final false
  inline void set_ignoreReversedGraphics(bool value);

  /// @brief Method set_maxDistance, addr 0x1eb2894, size 0x8, virtual false, abstract: false, final false
