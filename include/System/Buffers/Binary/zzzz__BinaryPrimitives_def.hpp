...
public:
  // Declarations
  /// @brief Method ReverseEndianness, addr 0x2609ab0, size 0xc, virtual false, abstract: false, final false
  static inline int16_t ReverseEndianness(int16_t value);

  /// @brief Method ReverseEndianness, addr 0x2609abc, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ReverseEndianness(int32_t value);

  /// @brief Method ReverseEndianness, addr 0x2609ac4, size 0x14, virtual false, abstract: false, final false
  static inline int64_t ReverseEndianness(int64_t value);

  /// @brief Method ReverseEndianness, addr 0x2609ad8, size 0xc, virtual false, abstract: false, final false
  static inline uint16_t ReverseEndianness(uint16_t value);

  /// @brief Method ReverseEndianness, addr 0x2609ae4, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t ReverseEndianness(uint32_t value);

  /// @brief Method ReverseEndianness, addr 0x2609aec, size 0x14, virtual false, abstract: false, final false
