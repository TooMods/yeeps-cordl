...
public:
  ...
  /// @brief Method AddColumnProperties, addr 0x1e8bbc4, size 0x60c, virtual false, abstract: false, final false
  inline void AddColumnProperties(::System::Data::DataColumn* col, ::System::Xml::XmlElement* root);

  /// @brief Method AddExtendedProperties, addr 0x1e80054, size 0x8, virtual false, abstract: false, final false
  static inline void AddExtendedProperties(::System::Data::PropertyCollection* props, ::System::Xml::XmlElement* node);

  /// @brief Method AddExtendedProperties, addr 0x1e8005c, size 0x764, virtual false, abstract: false, final false
  ...
  /// @brief Method AddXdoProperties, addr 0x1e807c0, size 0x1b0, virtual false, abstract: false, final false
  inline void AddXdoProperties(::System::Object* instance, ::System::Xml::XmlElement* root, ::System::Xml::XmlDocument* xd);

  /// @brief Method AddXdoProperty, addr 0x1e80970, size 0x924, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendChildWithoutRef, addr 0x1e87a60, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoGenerated, addr 0x1e83d0c, size 0x57c, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::DataColumn* col);

  /// @brief Method AutoGenerated, addr 0x1e84288, size 0xc, virtual false, abstract: false, final false
  inline bool AutoGenerated(::System::Data::ForeignKeyConstraint* fk);

  /// @brief Method AutoGenerated, addr 0x1e8d5b0, size 0x140, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::ForeignKeyConstraint* fk, bool checkRelation);

  /// @brief Method AutoGenerated, addr 0x1e8d4cc, size 0xe4, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::DataRelation* rel);

  /// @brief Method AutoGenerated, addr 0x1e84294, size 0xd4, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::UniqueConstraint* unique);

  /// @brief Method CreateRelations, addr 0x1e846ec, size 0x358, virtual false, abstract: false, final false
  inline void CreateRelations(::System::Data::DataTable* dt);

  /// @brief Method CreateTablesHierarchy, addr 0x1e84368, size 0x384, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method CreateToplevelTables, addr 0x1e84a44, size 0x2d4, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*, ::Array<::System::Data::DataTable*>*> CreateToplevelTables();

  /// @brief Method FillDataSetElement, addr 0x1e87438, size 0x620, virtual false, abstract: false, final false
  ...
  /// @brief Method FindSimpleType, addr 0x1e8b3bc, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlElement* FindSimpleType(::System::Xml::XmlElement* schema, ::StringW name);

  /// @brief Method FindTargetNamespace, addr 0x1e8c1d0, size 0x110, virtual false, abstract: false, final false
  inline ::StringW FindTargetNamespace(::System::Data::DataTable* table);

  /// @brief Method FindTypeNode, addr 0x1e8ce30, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* FindTypeNode(::System::Xml::XmlElement* node, ::StringW strType);

  /// @brief Method GenerateConstraintNames, addr 0x1e82778, size 0x2e4, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Data::DataSet* ds);

  /// @brief Method GenerateConstraintNames, addr 0x1e82158, size 0x528, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Data::DataTable* table, bool fromTable);

  /// @brief Method GenerateConstraintNames, addr 0x1e82680, size 0xf8, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Collections::ArrayList* tables);

  /// @brief Method GetSchema, addr 0x1e8b4b0, size 0x294, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* GetSchema(::StringW NamespaceURI);

  /// @brief Method HandleColumn, addr 0x1e8c2e0, size 0xb50, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColumnType, addr 0x1e8b744, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleRelation, addr 0x1e87b18, size 0x5bc, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* HandleRelation(::System::Data::DataRelation* rel, ::System::Xml::XmlDocument* dc);

  /// @brief Method HandleTable, addr 0x1e87a58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleTable, addr 0x1e88518, size 0x29c8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasMixedColumns, addr 0x1e8d11c, size 0x3b0, virtual false, abstract: false, final false
  inline bool HasMixedColumns(::System::Data::DataTable* table);

  /// @brief Method HaveExtendedProperties, addr 0x1e82a84, size 0x184, virtual false, abstract: false, final false
  inline bool HaveExtendedProperties(::System::Data::DataSet* ds);

  /// @brief Method IsAutoGenerated, addr 0x1e8d6f0, size 0x44, virtual false, abstract: false, final false
  inline bool IsAutoGenerated(::System::Object* o);

  static inline ::System::Data::XmlTreeGen* New_ctor(::System::Data::SchemaFormat format);

  /// @brief Method Save, addr 0x1e8b190, size 0xc, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw);

  /// @brief Method Save, addr 0x1e8b25c, size 0xc, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw, bool writeHierarchy);

  /// @brief Method Save, addr 0x1e8b268, size 0x154, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw, bool writeHierarchy,
                   ::System::Converter_2<::System::Type*, ::StringW>* multipleTargetConverter);

  /// @brief Method Save, addr 0x1e8b17c, size 0x14, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Xml::XmlWriter* xw);

  /// @brief Method Save, addr 0x1e8b19c, size 0xc0, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw);

  /// @brief Method SchemaTree, addr 0x1e880d4, size 0x444, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* SchemaTree(::System::Xml::XmlDocument* xd, ::System::Data::DataTable* dt);

  /// @brief Method SchemaTree, addr 0x1e84d18, size 0x2720, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMSDataAttribute, addr 0x1e81f78, size 0x1e0, virtual false, abstract: false, final false
  inline void SetMSDataAttribute(::System::Xml::XmlElement* root, ::System::Type* type);

  /// @brief Method SetPath, addr 0x1e8aee0, size 0x208, virtual false, abstract: false, final false
  inline void SetPath(::System::Xml::XmlWriter* xw);

  /// @brief Method SetupAutoGenerated, addr 0x1e82ef4, size 0x2e0, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Data::DataSet* ds);

  /// @brief Method SetupAutoGenerated, addr 0x1e83c18, size 0xf4, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Collections::ArrayList* dt);

  /// @brief Method SetupAutoGenerated, addr 0x1e831d4, size 0xa44, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Data::DataTable* dt);

  /// @brief Method TranslateAcceptRejectRule, addr 0x1e8cff8, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW TranslateAcceptRejectRule(::System::Data::AcceptRejectRule rule);

  /// @brief Method TranslateRule, addr 0x1e8d064, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW TranslateRule(::System::Data::Rule rule);

  /// @brief Method ValidateColumnMapping, addr 0x1e82e6c, size 0x88, virtual false, abstract: false, final false
  static inline void ValidateColumnMapping(::System::Type* columnType);

  /// @brief Method WriteSchemaRoot, addr 0x1e82c08, size 0x264, virtual false, abstract: false, final false
  inline void WriteSchemaRoot(::System::Xml::XmlDocument* xd, ::System::Xml::XmlElement* rootSchema, ::StringW targetNamespace);

  /// @brief Method XmlDataTypeName, addr 0x1e81294, size 0xce4, virtual false, abstract: false, final false
  static inline ::StringW XmlDataTypeName(::System::Type* type);

  /// @brief Method _PropsNotEmpty, addr 0x1e82a5c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e7ffb4, size 0xa0, virtual false, abstract: false, final false
