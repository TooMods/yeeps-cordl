...
public:
  ...
  /// @brief Method get_control, addr 0x186b558, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_device, addr 0x186b5a4, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method get_isOptional, addr 0x186b5f8, size 0x14, virtual false, abstract: false, final false
  inline bool get_isOptional();

  /// @brief Method get_requirement, addr 0x186b5c4, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlScheme__DeviceRequirement get_requirement();

  /// @brief Method get_requirementIndex, addr 0x186b5bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x186b744, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x186b618, size 0x2c, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x186b644, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x186b6d4, size 0x70, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method get_Current, addr 0x186b650, size 0x84, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x186b4e8, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetEnumerator, addr 0x186b474, size 0x70, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::__InputControlScheme__MatchResult__Match>* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x186b4e4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method get_Item, addr 0x186b3f0, size 0x84, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__InputControlScheme__MatchResult__Match get_Item(int32_t index);

  /// @brief Method get_devices, addr 0x186b2b4, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlList_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_hasMissingOptionalDevices, addr 0x186b2a4, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasMissingOptionalDevices();

  /// @brief Method get_hasMissingRequiredDevices, addr 0x186b294, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasMissingRequiredDevices();

  /// @brief Method get_isSuccessfulMatch, addr 0x186b284, size 0x10, virtual false, abstract: false, final false
  inline bool get_isSuccessfulMatch();

  /// @brief Method get_score, addr 0x186b27c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x186b8f8, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x186b88c, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::__InputControlScheme__DeviceRequirement other);

  /// @brief Method GetHashCode, addr 0x186b970, size 0xac, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x186b7c8, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_controlPath, addr 0x186b748, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_controlPath();

  /// @brief Method get_isAND, addr 0x186b774, size 0x10, virtual false, abstract: false, final false
  inline bool get_isAND();

  /// @brief Method get_isOR, addr 0x186b784, size 0xc, virtual false, abstract: false, final false
  inline bool get_isOR();

  /// @brief Method get_isOptional, addr 0x186b60c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isOptional();
  ...
  /// @brief Method op_Equality, addr 0x186ba1c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x186ba48, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method set_controlPath, addr 0x186b750, size 0x8, virtual false, abstract: false, final false
  inline void set_controlPath(::StringW value);

  /// @brief Method set_isAND, addr 0x186b790, size 0x1c, virtual false, abstract: false, final false
  inline void set_isAND(bool value);

  /// @brief Method set_isOR, addr 0x186b7ac, size 0x1c, virtual false, abstract: false, final false
  inline void set_isOR(bool value);

  /// @brief Method set_isOptional, addr 0x186b758, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method From, addr 0x186bcb8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDeviceEntry, addr 0x186bbbc, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ToJson, addr 0x186bccc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ToJson, addr 0x186bbd8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToScheme, addr 0x186ba78, size 0x144, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme ToScheme();

  /// @brief Method ToSchemes, addr 0x186bdd4, size 0xf8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x1acb85c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1acb720, size 0x13c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x1acb8ec, size 0x80, virtual true, abstract: false, final false
  inline int32_t GetHashCode();
  ...
  /// @brief Method SetNameAndBindingGroup, addr 0x1acb594, size 0xb8, virtual false, abstract: false, final false
  inline void SetNameAndBindingGroup(::StringW name, ::StringW bindingGroup);

  /// @brief Method SupportsDevice, addr 0x1acb64c, size 0xd4, virtual false, abstract: false, final false
  inline bool SupportsDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ToString, addr 0x1acb96c, size 0x184, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1acb4a0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_bindingGroup, addr 0x1acb430, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_bindingGroup();

  /// @brief Method get_deviceRequirements, addr 0x1acb440, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_name, addr 0x1acb428, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1acbaf0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x1acbb20, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bindingGroup, addr 0x1acb438, size 0x8, virtual false, abstract: false, final false
