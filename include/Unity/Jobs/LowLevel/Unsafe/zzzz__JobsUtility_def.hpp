...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x27e13c8, size 0x38, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x27e14bc, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__PanicFunction_* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x27e1400, size 0xbc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateJobReflectionData, addr 0x27e12c8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x27e125c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetJobRange, addr 0x27e0fa8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorkStealingRange, addr 0x27e0ff0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokePanicFunction, addr 0x27e1364, size 0x64, virtual false, abstract: false, final false
  static inline void InvokePanicFunction();

  /// @brief Method Schedule, addr 0x27e104c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor, addr 0x27e10e4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForTransform, addr 0x27e11ac, size 0x5c, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle ScheduleParallelForTransform(ByRef<::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__JobScheduleParameters> parameters, void* transfromAccesssArray);

  /// @brief Method ScheduleParallelForTransform_Injected, addr 0x27e1208, size 0x54, virtual false, abstract: false, final false
  static inline void ScheduleParallelForTransform_Injected(ByRef<::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__JobScheduleParameters> parameters, void* transfromAccesssArray,
                                                           ByRef<::Unity::Jobs::JobHandle> ret);

  /// @brief Method ScheduleParallelFor_Injected, addr 0x27e1150, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Schedule_Injected, addr 0x27e10a0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_JobCompilerEnabled, addr 0x27e1328, size 0x3c, virtual false, abstract: false, final false
