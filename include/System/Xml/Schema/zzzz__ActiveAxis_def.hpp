...
public:
  ...
  /// @brief Method EndElement, addr 0x3049e9c, size 0x110, virtual true, abstract: false, final false
  inline bool EndElement(::StringW localname, ::StringW URN);

  /// @brief Method MoveToAttribute, addr 0x3049fac, size 0x10c, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW localname, ::StringW URN);

  /// @brief Method MoveToStartElement, addr 0x3049d5c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Reactivate, addr 0x3049b9c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3049bb0, size 0x1ac, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree);

  /// @brief Method get_CurrentDepth, addr 0x3049b94, size 0x8, virtual false, abstract: false, final false
