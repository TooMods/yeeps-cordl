...
public:
  ...
  /// @brief Method Clone, addr 0x12c9028, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone();

  /// @brief Method GetDSAPrivateKey, addr 0x12c9764, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey();

  /// @brief Method GetRSAPrivateKey, addr 0x12c96d8, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey();

  /// @brief Method GetRawCertData, addr 0x12c90b0, size 0x38, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawCertData();

  /// @brief Method ImportPkcs12, addr 0x12c8fd0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportPkcs12, addr 0x12c97f0, size 0x7c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Verify, addr 0x12ca108, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c8da0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x12c8dd0, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono* other);

  /// @brief Method .ctor, addr 0x12c8e74, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Cert, addr 0x12c9094, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_Cert();

  /// @brief Method get_HasPrivateKey, addr 0x12c90e8, size 0x24, virtual true, abstract: false, final false
  inline bool get_HasPrivateKey();

  /// @brief Method get_IntermediateCertificates, addr 0x12ca248, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates();

  /// @brief Method get_IsValid, addr 0x12c8d90, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_MonoCertificate, addr 0x12ca250, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate();

  /// @brief Method get_PrivateKey, addr 0x12c910c, size 0x434, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PrivateKey, addr 0x12c9540, size 0x198, virtual true, abstract: false, final false
