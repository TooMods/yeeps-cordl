...
public:
  ...
  /// @brief Method Create, addr 0x1d3c7d0, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1d3cab0, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1d3cae0, size 0x30, virtual true, abstract: false, final true
