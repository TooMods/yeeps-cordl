...
public:
  ...
  /// @brief Method ToString, addr 0x246e760, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246e6b4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::Interface::AlertDescription description);

  /// @brief Method get_Description, addr 0x246e6ac, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::AlertDescription get_Description();

  /// @brief Method get_Level, addr 0x246e6a4, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::AlertLevel get_Level();

  /// @brief Method inferAlertLevel, addr 0x246e720, size 0x40, virtual false, abstract: false, final false
