...
public:
  // Declarations
  /// @brief Method Equals, addr 0x21d7e74, size 0x30, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x21d7e54, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method IndexOf, addr 0x21d7ea4, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21d7f10, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
