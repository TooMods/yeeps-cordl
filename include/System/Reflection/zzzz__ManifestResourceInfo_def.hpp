...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Reflection::Assembly*> const& __cordl_internal_get__ReferencedAssembly_k__BackingField() const;
  ...
  /// @brief Method .ctor, addr 0x2610800, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileName, addr 0x2610844, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_ReferencedAssembly, addr 0x261083c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::Assembly* get_ReferencedAssembly();

  /// @brief Method get_ResourceLocation, addr 0x261084c, size 0x8, virtual true, abstract: false, final false
