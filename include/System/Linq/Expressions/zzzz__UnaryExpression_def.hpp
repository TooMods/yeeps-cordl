...
public:
  ...
  /// @brief Method Accept, addr 0x183ce0c, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method FunctionalOp, addr 0x183dcbc, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x183ce5c, size 0x70, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Reduce();

  /// @brief Method ReduceIndex, addr 0x183cecc, size 0x5dc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceIndex();

  /// @brief Method ReduceMember, addr 0x183d4a8, size 0x500, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceMember();

  /// @brief Method ReduceVariable, addr 0x183d9a8, size 0x2d0, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceVariable();

  /// @brief Method Update, addr 0x1838718, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183cab4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanReduce, addr 0x183ce38, size 0x24, virtual true, abstract: false, final false
  inline bool get_CanReduce();

  /// @brief Method get_IsLifted, addr 0x183cb5c, size 0x224, virtual false, abstract: false, final false
  inline bool get_IsLifted();

  /// @brief Method get_IsLiftedToNull, addr 0x183cd80, size 0x8c, virtual false, abstract: false, final false
  inline bool get_IsLiftedToNull();

  /// @brief Method get_IsPrefix, addr 0x183dc78, size 0x44, virtual false, abstract: false, final false
  inline bool get_IsPrefix();

  /// @brief Method get_Method, addr 0x183cb54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Method();

  /// @brief Method get_NodeType, addr 0x183cb44, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Operand, addr 0x183cb4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Operand();

  /// @brief Method get_Type, addr 0x183cb3c, size 0x8, virtual true, abstract: false, final true
