...
public:
  ...
  template <typename T> static inline void CopyPtrToStructure(::cordl_internals::Ptr<void> ptr, ByRef<T> output);
  ...
  /// @brief Method Free, addr 0x27e1794, size 0x44, virtual false, abstract: false, final false
  static inline void Free(::cordl_internals::Ptr<void> memory, ::Unity::Collections::Allocator allocator);

  /// @brief Method GetReasonForArrayNonBlittable, addr 0x27e1abc, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW GetReasonForArrayNonBlittable(::System::Array* arr);

  /// @brief Method GetReasonForTypeNonBlittableImpl, addr 0x27e18d0, size 0x1bc, virtual false, abstract: false, final false
  ...
  template <typename T> static inline void InternalCopyPtrToStructure(::cordl_internals::Ptr<void> ptr, ByRef<T> output);
  ...
  /// @brief Method IsArrayBlittable, addr 0x27e1a8c, size 0x30, virtual false, abstract: false, final false
  static inline bool IsArrayBlittable(::System::Array* arr);

  /// @brief Method IsBlittable, addr 0x27e1894, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsBlittable(::System::Type* type);

  /// @brief Method IsBlittableValueType, addr 0x27e1834, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method IsUnmanaged, addr 0x27e1da4, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsUnmanaged(::System::Type* type);

  /// @brief Method Malloc, addr 0x27e1b08, size 0x54, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> Malloc(int64_t size, int32_t alignment, ::Unity::Collections::Allocator allocator);

  /// @brief Method MemClear, addr 0x27e1ccc, size 0x48, virtual false, abstract: false, final false
  static inline void MemClear(::cordl_internals::Ptr<void> destination, int64_t size);

  /// @brief Method MemCmp, addr 0x27e1d14, size 0x54, virtual false, abstract: false, final false
  static inline int32_t MemCmp(::cordl_internals::Ptr<void> ptr1, ::cordl_internals::Ptr<void> ptr2, int64_t size);

  /// @brief Method MemCpy, addr 0x27e1b5c, size 0x54, virtual false, abstract: false, final false
  static inline void MemCpy(::cordl_internals::Ptr<void> destination, ::cordl_internals::Ptr<void> source, int64_t size);

  /// @brief Method MemCpyStride, addr 0x27e1bb0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method MemMove, addr 0x27e1c24, size 0x54, virtual false, abstract: false, final false
  static inline void MemMove(::cordl_internals::Ptr<void> destination, ::cordl_internals::Ptr<void> source, int64_t size);

  /// @brief Method MemSet, addr 0x27e1c78, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SizeOf, addr 0x27e1d68, size 0x3c, virtual false, abstract: false, final false
