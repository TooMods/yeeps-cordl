...
public:
  ...
  /// @brief Method Create, addr 0x1e0ae3c, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::TextEvent Create(int32_t deviceId, char16_t character, double_t time);

  /// @brief Method Create, addr 0x1e0aeb4, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::TextEvent Create(int32_t deviceId, int32_t character, double_t time);

  /// @brief Method From, addr 0x1e0ad10, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x1e0ad04, size 0xc, virtual true, abstract: false, final true
