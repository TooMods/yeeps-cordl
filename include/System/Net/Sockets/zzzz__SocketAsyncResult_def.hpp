...
public:
  ...
  /// @brief Method <Complete>b__27_0, addr 0x2c90768, size 0x78, virtual false, abstract: false, final false
  inline void _Complete_b__27_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x2c90760, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckIfThrowDelayedException, addr 0x2c90634, size 0xa8, virtual false, abstract: false, final false
  inline void CheckIfThrowDelayedException();

  /// @brief Method Complete, addr 0x2c8bb2c, size 0x1f0, virtual false, abstract: false, final false
  inline void Complete();

  /// @brief Method Complete, addr 0x2c8b3ac, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* e);

  /// @brief Method Complete, addr 0x2c906ec, size 0x10, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* e, bool synch);

  /// @brief Method Complete, addr 0x2c8b3b4, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Net::Sockets::Socket* s);

  /// @brief Method Complete, addr 0x2c8b5f4, size 0xc, virtual false, abstract: false, final false
  inline void Complete(::System::Net::Sockets::Socket* s, int32_t total);

  /// @brief Method Complete, addr 0x2c906e0, size 0xc, virtual false, abstract: false, final false
  inline void Complete(bool synch);

  /// @brief Method Complete, addr 0x2c8c5ec, size 0x8, virtual false, abstract: false, final false
  inline void Complete(int32_t total);

  /// @brief Method CompleteDisposed, addr 0x2c906dc, size 0x4, virtual true, abstract: false, final false
  inline void CompleteDisposed();

  /// @brief Method Init, addr 0x2c904c8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c90194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2c9057c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ErrorCode, addr 0x2c905b4, size 0x80, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::SocketError get_ErrorCode();

  /// @brief Method get_Handle, addr 0x2c90464, size 0x64, virtual false, abstract: false, final false
