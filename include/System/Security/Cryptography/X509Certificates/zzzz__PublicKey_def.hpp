...
public:
  ...
  /// @brief Method DecodeDSA, addr 0x12c3ae8, size 0x4ac, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeRSA, addr 0x12c3730, size 0x3b8, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* DecodeRSA(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPublicKey);

  /// @brief Method GetUnsignedBigInteger, addr 0x12c3f9c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c3408, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncodedKeyValue, addr 0x12c357c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedKeyValue();

  /// @brief Method get_EncodedParameters, addr 0x12c3584, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedParameters();

  /// @brief Method get_Key, addr 0x12c358c, size 0x1a4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_Key();

  /// @brief Method get_Oid, addr 0x12c3f94, size 0x8, virtual false, abstract: false, final false
