...
public:
  ...
  /// @brief Method ClearCachedData, addr 0x21c4e9c, size 0x48, virtual false, abstract: false, final false
  static inline void ClearCachedData();

  /// @brief Method Equals, addr 0x21c4d98, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetByTerritory, addr 0x21c4ab8, size 0xac, virtual false, abstract: false, final false
  inline bool GetByTerritory(::System::Globalization::CultureInfo* ci);

  /// @brief Method GetHashCode, addr 0x21c4e60, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x21c4e8c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c4814, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CultureInfo* ci);

  /// @brief Method .ctor, addr 0x21c49ac, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(int32_t culture);

  /// @brief Method .ctor, addr 0x21c4b64, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method construct_internal_region_from_name, addr 0x21c4ca8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrencyEnglishName, addr 0x21c4cac, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencyEnglishName();

  /// @brief Method get_CurrencyNativeName, addr 0x21c4d70, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencyNativeName();

  /// @brief Method get_CurrencySymbol, addr 0x21c4cb4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencySymbol();

  /// @brief Method get_CurrentRegion, addr 0x21c4748, size 0xcc, virtual false, abstract: false, final false
  static inline ::System::Globalization::RegionInfo* get_CurrentRegion();

  /// @brief Method get_DisplayName, addr 0x21c4cbc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_EnglishName, addr 0x21c4cc4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_EnglishName();

  /// @brief Method get_GeoId, addr 0x21c4ccc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_GeoId();

  /// @brief Method get_ISOCurrencySymbol, addr 0x21c4d60, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ISOCurrencySymbol();

  /// @brief Method get_IsMetric, addr 0x21c4cd4, size 0x8c, virtual true, abstract: false, final false
  inline bool get_IsMetric();

  /// @brief Method get_Name, addr 0x21c4d78, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NativeName, addr 0x21c4d68, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NativeName();

  /// @brief Method get_ThreeLetterISORegionName, addr 0x21c4d80, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ThreeLetterISORegionName();

  /// @brief Method get_ThreeLetterWindowsRegionName, addr 0x21c4d88, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ThreeLetterWindowsRegionName();

  /// @brief Method get_TwoLetterISORegionName, addr 0x21c4d90, size 0x8, virtual true, abstract: false, final false
