...
public:
  ...
  /// @brief Method BuildCharExceptionArgs, addr 0x12510e4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildCharExceptionArgs, addr 0x1244c7c, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> BuildCharExceptionArgs(::StringW data, int32_t invCharIndex);

  /// @brief Method BuildCharExceptionArgs, addr 0x1245040, size 0x2a8, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> BuildCharExceptionArgs(char16_t invChar, char16_t nextChar);

  /// @brief Method CreateMessage, addr 0x125031c, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatUserMessage, addr 0x125089c, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW FormatUserMessage(::StringW message, int32_t lineNumber, int32_t linePosition);

  /// @brief Method GetObjectData, addr 0x12505c0, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1250730, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x124ff44, size 0x3d8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x1250748, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1250764, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x125075c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x1250774, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1244ad4, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x1250d20, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::System::Exception* innerException, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method .ctor, addr 0x1250af8, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method .ctor, addr 0x124c480, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x1250ef4, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, int32_t lineNumber, int32_t linePosition, ::StringW sourceUri);

  /// @brief Method .ctor, addr 0x1250a14, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::StringW sourceUri);

  /// @brief Method .ctor, addr 0x1244cd8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x1251068, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1250994, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1250eec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method .ctor, addr 0x1250bb4, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Xml::IXmlLineInfo* lineInfo, ::StringW sourceUri);

  /// @brief Method .ctor, addr 0x124c718, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x1250fec, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LineNumber, addr 0x1251138, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x1251140, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Message, addr 0x1251148, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_ResString, addr 0x1251160, size 0x8, virtual false, abstract: false, final false
