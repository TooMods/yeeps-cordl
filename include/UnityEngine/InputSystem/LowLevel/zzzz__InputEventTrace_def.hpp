...
public:
  ...
  /// @brief Method Dispose, addr 0x1e0905c, size 0xc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x1e09068, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x1e09138, size 0x24, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1e09164, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1e088ec, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputEventTrace* trace);

  /// @brief Method get_Current, addr 0x1e0915c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method <PlayAllEventsAccordingToTimestamps>b__38_0, addr 0x1e0a8a8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e0a8a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ApplyDeviceMapping>b__0, addr 0x1e0a970, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e0a834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyDeviceMapping, addr 0x1e0a498, size 0x39c, virtual false, abstract: false, final false
  inline int32_t ApplyDeviceMapping(int32_t originalDeviceId);

  /// @brief Method Dispose, addr 0x1e09264, size 0x320, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finished, addr 0x1e0a3c8, size 0xd0, virtual false, abstract: false, final false
  inline void Finished();

  /// @brief Method MoveNext, addr 0x1e09838, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeginFrame, addr 0x1e0a194, size 0x234, virtual false, abstract: false, final false
  inline void OnBeginFrame();

  /// @brief Method OnEvent, addr 0x1e097a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnFinished, addr 0x1e097a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* OnFinished(::System::Action* action);

  /// @brief Method PlayAllEvents, addr 0x1e09e54, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* PlayAllEvents();

  /// @brief Method PlayAllEventsAccordingToTimestamps, addr 0x1e09f0c, size 0x288, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* PlayAllEventsAccordingToTimestamps();

  /// @brief Method PlayAllFramesOneByOne, addr 0x1e09da4, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* PlayAllFramesOneByOne();

  /// @brief Method PlayOneEvent, addr 0x1e097b0, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* PlayOneEvent();

  /// @brief Method QueueEvent, addr 0x1e09b50, size 0x23c, virtual false, abstract: false, final false
  inline void QueueEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr);

  /// @brief Method Rewind, addr 0x1e09d8c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* Rewind();

  /// @brief Method WithAllDevicesMappedToNewInstances, addr 0x1e09794, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* WithAllDevicesMappedToNewInstances();

  /// @brief Method WithDeviceMappedFromTo, addr 0x1e09584, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDeviceMappedFromTo, addr 0x1e09610, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e08450, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputEventTrace* trace);

  /// @brief Method get_createdDevices, addr 0x1e09200, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::InputDevice*>* get_createdDevices();

  /// @brief Method get_finished, addr 0x1e091c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_finished();

  /// @brief Method get_paused, addr 0x1e091dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_paused();

  /// @brief Method get_position, addr 0x1e091f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_position();

  /// @brief Method get_trace, addr 0x1e091c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace* get_trace();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_finished, addr 0x1e091d0, size 0xc, virtual false, abstract: false, final false
  inline void set_finished(bool value);

  /// @brief Method set_paused, addr 0x1e091e4, size 0xc, virtual false, abstract: false, final false
  inline void set_paused(bool value);

  /// @brief Method set_position, addr 0x1e091f8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_deviceId, addr 0x1e0a984, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_deviceId();

  /// @brief Method get_layout, addr 0x1e0a994, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_layout();

  /// @brief Method get_stateFormat, addr 0x1e0a9a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_stateFormat();

  /// @brief Method get_stateSizeInBytes, addr 0x1e0a9b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_stateSizeInBytes();

  /// @brief Method set_deviceId, addr 0x1e0a98c, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceId(int32_t value);

  /// @brief Method set_layout, addr 0x1e0a99c, size 0x8, virtual false, abstract: false, final false
  inline void set_layout(::StringW value);

  /// @brief Method set_stateFormat, addr 0x1e0a9ac, size 0x8, virtual false, abstract: false, final false
  inline void set_stateFormat(::UnityEngine::InputSystem::Utilities::FourCC value);

  /// @brief Method set_stateSizeInBytes, addr 0x1e0a9bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Allocate, addr 0x1e088bc, size 0x28, virtual false, abstract: false, final false
  inline void Allocate();

  /// @brief Method Clear, addr 0x1e0874c, size 0x1c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Disable, addr 0x1e08338, size 0x118, virtual false, abstract: false, final false
  inline void Disable();

  /// @brief Method Dispose, addr 0x1e08928, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Enable, addr 0x1e08768, size 0x154, virtual false, abstract: false, final false
  inline void Enable();

  /// @brief Method GetEnumerator, addr 0x1e0768c, size 0x60, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* GetEnumerator();

  /// @brief Method GetNextEvent, addr 0x1e086d0, size 0x7c, virtual false, abstract: false, final false
  inline bool GetNextEvent(ByRef<::UnityEngine::InputSystem::LowLevel::InputEventPtr> current);

  /// @brief Method LoadFrom, addr 0x1e07fa0, size 0x208, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace* LoadFrom(::StringW filePath);

  /// @brief Method LoadFrom, addr 0x1e081a8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeforeUpdate, addr 0x1e08980, size 0x1ac, virtual false, abstract: false, final false
  inline void OnBeforeUpdate();

  /// @brief Method OnInputEvent, addr 0x1e08b2c, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x1e076ec, size 0x1d4, virtual false, abstract: false, final false
  inline void ReadFrom(::StringW filePath);

  /// @brief Method ReadFrom, addr 0x1e078c0, size 0x6c8, virtual false, abstract: false, final false
  inline void ReadFrom(::System::IO::Stream* stream);

  /// @brief Method Release, addr 0x1e08940, size 0x40, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method Replay, addr 0x1e082d0, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::__InputEventTrace__ReplayController* Replay();

  /// @brief Method Resize, addr 0x1e084c8, size 0x200, virtual false, abstract: false, final false
  inline bool Resize(int64_t newBufferSize, int64_t newMaxBufferSize);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1e08924, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method WriteTo, addr 0x1e06dcc, size 0x1d4, virtual false, abstract: false, final false
  inline void WriteTo(::StringW filePath);

  /// @brief Method WriteTo, addr 0x1e06fa0, size 0x6bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e06d5c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e06c84, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onEvent, addr 0x1e06bd4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FrameMarkerEvent, addr 0x1e06a04, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_FrameMarkerEvent();

  /// @brief Method get_allocatedSizeInBytes, addr 0x1e06b54, size 0x18, virtual false, abstract: false, final false
  inline int64_t get_allocatedSizeInBytes();

  /// @brief Method get_deviceId, addr 0x1e06a34, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_deviceId();

  /// @brief Method get_deviceInfos, addr 0x1e06b7c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_enabled, addr 0x1e06a44, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_eventCount, addr 0x1e06b44, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_eventCount();

  /// @brief Method get_kFileFormat, addr 0x1e0765c, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_kFileFormat();

  /// @brief Method get_m_EventBuffer, addr 0x1e06b6c, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> get_m_EventBuffer();

  /// @brief Method get_m_EventBufferHead, addr 0x1e086c8, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> get_m_EventBufferHead();

  /// @brief Method get_m_EventBufferTail, addr 0x1e088e4, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> get_m_EventBufferTail();

  /// @brief Method get_maxSizeInBytes, addr 0x1e06b74, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_maxSizeInBytes();

  /// @brief Method get_onFilterEvent, addr 0x1e06bc4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_recordFrameMarkers, addr 0x1e06a4c, size 0x8, virtual false, abstract: false, final false
  inline bool get_recordFrameMarkers();

  /// @brief Method get_totalEventSizeInBytes, addr 0x1e06b4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onEvent, addr 0x1e06c2c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_deviceId, addr 0x1e06a3c, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceId(int32_t value);

  /// @brief Method set_m_EventBuffer, addr 0x1e07f88, size 0x8, virtual false, abstract: false, final false
  inline void set_m_EventBuffer(::cordl_internals::Ptr<uint8_t> value);

  /// @brief Method set_m_EventBufferHead, addr 0x1e07f90, size 0x8, virtual false, abstract: false, final false
  inline void set_m_EventBufferHead(::cordl_internals::Ptr<uint8_t> value);

  /// @brief Method set_m_EventBufferTail, addr 0x1e07f98, size 0x8, virtual false, abstract: false, final false
  inline void set_m_EventBufferTail(::cordl_internals::Ptr<uint8_t> value);

  /// @brief Method set_onFilterEvent, addr 0x1e06bcc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_recordFrameMarkers, addr 0x1e06a54, size 0xf0, virtual false, abstract: false, final false
