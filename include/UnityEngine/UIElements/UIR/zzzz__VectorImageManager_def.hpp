...
public:
  ...
  /// @brief Method AddUser, addr 0x2099f6c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Commit, addr 0x2099f3c, size 0x30, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method Dispose, addr 0x2099db8, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2099e24, size 0x118, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::UIR::VectorImageManager* New_ctor(::UnityEngine::UIElements::AtlasBase* atlas);

  /// @brief Method Register, addr 0x209a070, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2099be8, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x2099bd4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_atlas();

  /// @brief Method get_disposed, addr 0x2099da4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x2099dac, size 0xc, virtual false, abstract: false, final false
