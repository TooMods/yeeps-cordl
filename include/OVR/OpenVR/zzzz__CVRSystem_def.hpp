...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2a761b0, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2a76268, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2a7619c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a760c4, size 0xd8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2a7636c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2a76438, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(ByRef<::OVR::OpenVR::VRControllerState_t_Packed> pControllerState, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2a76358, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a76294, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2a7653c, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2a76670, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x2a76528, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a76464, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method AcknowledgeQuit_Exiting, addr 0x2a7607c, size 0x24, virtual false, abstract: false, final false
  inline void AcknowledgeQuit_Exiting();

  /// @brief Method AcknowledgeQuit_UserPrompt, addr 0x2a760a0, size 0x24, virtual false, abstract: false, final false
  inline void AcknowledgeQuit_UserPrompt();

  /// @brief Method ApplyTransform, addr 0x2a755c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeDistortion, addr 0x2a7533c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DriverDebugRequest, addr 0x2a76034, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArrayTrackedDeviceProperty, addr 0x2a75754, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBoolTrackedDeviceProperty, addr 0x2a7567c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetButtonIdNameFromEnum, addr 0x2a75e9c, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetButtonIdNameFromEnum(::OVR::OpenVR::EVRButtonId eButtonId);

  /// @brief Method GetControllerAxisTypeNameFromEnum, addr 0x2a75f20, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetControllerAxisTypeNameFromEnum(::OVR::OpenVR::EVRControllerAxisType eAxisType);

  /// @brief Method GetControllerRoleForTrackedDeviceIndex, addr 0x2a75610, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex(uint32_t unDeviceIndex);

  /// @brief Method GetControllerState, addr 0x2a75a80, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetControllerStateWithPose, addr 0x2a75cac, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetD3D9AdapterIndex, addr 0x2a753d4, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetD3D9AdapterIndex();

  /// @brief Method GetDXGIOutputInfo, addr 0x2a753f8, size 0x28, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(ByRef<int32_t> pnAdapterIndex);

  /// @brief Method GetDeviceToAbsoluteTrackingPose, addr 0x2a75494, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEventTypeNameFromEnum, addr 0x2a759d8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetEventTypeNameFromEnum(::OVR::OpenVR::EVREventType eType);

  /// @brief Method GetEyeToHeadTransform, addr 0x2a75360, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetEyeToHeadTransform(::OVR::OpenVR::EVREye eEye);

  /// @brief Method GetFloatTrackedDeviceProperty, addr 0x2a756a0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHiddenAreaMesh, addr 0x2a75a5c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HiddenAreaMesh_t GetHiddenAreaMesh(::OVR::OpenVR::EVREye eEye, ::OVR::OpenVR::EHiddenAreaMeshType type);

  /// @brief Method GetInt32TrackedDeviceProperty, addr 0x2a756c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatrix34TrackedDeviceProperty, addr 0x2a7570c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOutputDevice, addr 0x2a75420, size 0x28, virtual false, abstract: false, final false
  inline void GetOutputDevice(ByRef<uint64_t> pnDevice, ::OVR::OpenVR::ETextureType textureType, void* pInstance);

  /// @brief Method GetProjectionMatrix, addr 0x2a752c0, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix44_t GetProjectionMatrix(::OVR::OpenVR::EVREye eEye, float_t fNearZ, float_t fFarZ);

  /// @brief Method GetProjectionRaw, addr 0x2a75308, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPropErrorNameFromEnum, addr 0x2a7579c, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetPropErrorNameFromEnum(::OVR::OpenVR::ETrackedPropertyError error);

  /// @brief Method GetRawZeroPoseToStandingAbsoluteTrackingPose, addr 0x2a7552c, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetRawZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetRecommendedRenderTargetSize, addr 0x2a75294, size 0x2c, virtual false, abstract: false, final false
  inline void GetRecommendedRenderTargetSize(ByRef<uint32_t> pnWidth, ByRef<uint32_t> pnHeight);

  /// @brief Method GetSeatedZeroPoseToStandingAbsoluteTrackingPose, addr 0x2a754e4, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetSeatedZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetSortedTrackedDeviceIndicesOfClass, addr 0x2a75574, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStringTrackedDeviceProperty, addr 0x2a75778, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTimeSinceLastVsync, addr 0x2a753a8, size 0x2c, virtual false, abstract: false, final false
  inline bool GetTimeSinceLastVsync(ByRef<float_t> pfSecondsSinceLastVsync, ByRef<uint64_t> pulFrameCounter);

  /// @brief Method GetTrackedDeviceActivityLevel, addr 0x2a755a4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EDeviceActivityLevel GetTrackedDeviceActivityLevel(uint32_t unDeviceId);

  /// @brief Method GetTrackedDeviceClass, addr 0x2a75634, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ETrackedDeviceClass GetTrackedDeviceClass(uint32_t unDeviceIndex);

  /// @brief Method GetTrackedDeviceIndexForControllerRole, addr 0x2a755ec, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetTrackedDeviceIndexForControllerRole(::OVR::OpenVR::ETrackedControllerRole unDeviceType);

  /// @brief Method GetUint64TrackedDeviceProperty, addr 0x2a756e8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDisplayOnDesktop, addr 0x2a75448, size 0x24, virtual false, abstract: false, final false
  inline bool IsDisplayOnDesktop();

  /// @brief Method IsInputAvailable, addr 0x2a75fa4, size 0x24, virtual false, abstract: false, final false
  inline bool IsInputAvailable();

  /// @brief Method IsSteamVRDrawingControllers, addr 0x2a75fc8, size 0x24, virtual false, abstract: false, final false
  inline bool IsSteamVRDrawingControllers();

  /// @brief Method IsTrackedDeviceConnected, addr 0x2a75658, size 0x24, virtual false, abstract: false, final false
  inline bool IsTrackedDeviceConnected(uint32_t unDeviceIndex);

  static inline ::OVR::OpenVR::CVRSystem* New_ctor(void* pInterface);

  /// @brief Method PerformFirmwareUpdate, addr 0x2a76058, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRFirmwareError PerformFirmwareUpdate(uint32_t unDeviceIndex);

  /// @brief Method PollNextEvent, addr 0x2a75820, size 0x174, virtual false, abstract: false, final false
  inline bool PollNextEvent(ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method PollNextEventWithPose, addr 0x2a759b4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetSeatedZeroPose, addr 0x2a754c0, size 0x24, virtual false, abstract: false, final false
  inline void ResetSeatedZeroPose();

  /// @brief Method SetDisplayVisibility, addr 0x2a7546c, size 0x28, virtual false, abstract: false, final false
  inline bool SetDisplayVisibility(bool bIsVisibleOnDesktop);

  /// @brief Method ShouldApplicationPause, addr 0x2a75fec, size 0x24, virtual false, abstract: false, final false
  inline bool ShouldApplicationPause();

  /// @brief Method ShouldApplicationReduceRenderingWork, addr 0x2a76010, size 0x24, virtual false, abstract: false, final false
  inline bool ShouldApplicationReduceRenderingWork();

  /// @brief Method TriggerHapticPulse, addr 0x2a75e78, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a75180, size 0x114, virtual false, abstract: false, final false
