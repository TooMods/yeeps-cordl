...
public:
  ...
  /// @brief Method Create, addr 0x25cfb1c, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x25cb378, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::JsonReaderException* Create(::Newtonsoft::Json::JsonReader* reader, ::StringW message);

  /// @brief Method Create, addr 0x25cb8dc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25cfad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25cfadc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x25cfad4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25cfad8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x25cfae0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW path, int32_t lineNumber, int32_t linePosition, ::System::Exception* innerException);

  /// @brief Method get_LineNumber, addr 0x25cfab8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x25cfac0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Path, addr 0x25cfac8, size 0x8, virtual false, abstract: false, final false
