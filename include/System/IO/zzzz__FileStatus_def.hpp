...
public:
  ...
  /// @brief Method EnsureStatInitialized, addr 0x25888c0, size 0xbc, virtual false, abstract: false, final false
  inline void EnsureStatInitialized(::System::ReadOnlySpan_1<char16_t> path, bool continueOnError);

  /// @brief Method GetExists, addr 0x258897c, size 0x44, virtual false, abstract: false, final false
  inline bool GetExists(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method Initialize, addr 0x25887bc, size 0x14, virtual false, abstract: false, final false
  static inline void Initialize(ByRef<::System::IO::FileStatus> status, bool isDirectory);

  /// @brief Method IsReadOnly, addr 0x25887d0, size 0xf0, virtual false, abstract: false, final false
  inline bool IsReadOnly(::System::ReadOnlySpan_1<char16_t> path, bool continueOnError);

  /// @brief Method Refresh, addr 0x25889c0, size 0x194, virtual false, abstract: false, final false
  inline void Refresh(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method get_InitiallyDirectory, addr 0x25887a8, size 0x8, virtual false, abstract: false, final false
  inline bool get_InitiallyDirectory();

  /// @brief Method set_InitiallyDirectory, addr 0x25887b0, size 0xc, virtual false, abstract: false, final false
