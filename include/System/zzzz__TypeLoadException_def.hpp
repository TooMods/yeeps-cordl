...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2e79678, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetMessageField, addr 0x2e793d4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e79334, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2e794c4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW assemblyName);

  /// @brief Method .ctor, addr 0x2e794d0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW assemblyName, ::StringW messageArg, int32_t resourceId);

  /// @brief Method .ctor, addr 0x2e79530, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2e79394, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x2e793bc, size 0x18, virtual true, abstract: false, final false
