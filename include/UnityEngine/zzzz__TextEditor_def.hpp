...
public:
  ...
  /// @brief Method Backspace, addr 0x2d19b94, size 0xa0, virtual false, abstract: false, final false
  inline bool Backspace();

  /// @brief Method CanPaste, addr 0x2d19b50, size 0x44, virtual false, abstract: false, final false
  inline bool CanPaste();

  /// @brief Method ClampTextIndex, addr 0x2d1b754, size 0x3c, virtual false, abstract: false, final false
  inline void ClampTextIndex(ByRef<int32_t> index);

  /// @brief Method ClassifyChar, addr 0x2d1acb0, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::__TextEditor__CharacterType ClassifyChar(int32_t index);

  /// @brief Method ClearCursorPos, addr 0x2d18250, size 0x10, virtual false, abstract: false, final false
  inline void ClearCursorPos();

  /// @brief Method Copy, addr 0x2d1b438, size 0x90, virtual false, abstract: false, final false
  inline void Copy();

  /// @brief Method Cut, addr 0x2d1b40c, size 0x2c, virtual false, abstract: false, final false
  inline bool Cut();

  /// @brief Method DblClickSnap, addr 0x2d1ac10, size 0x8, virtual false, abstract: false, final false
  inline void DblClickSnap(::UnityEngine::__TextEditor__DblClickSnapping snapping);

  /// @brief Method Delete, addr 0x2d19a00, size 0x8c, virtual false, abstract: false, final false
  inline bool Delete();

  /// @brief Method DeleteLineBack, addr 0x2d194a8, size 0xb8, virtual false, abstract: false, final false
  inline bool DeleteLineBack();

  /// @brief Method DeleteSelection, addr 0x2d19570, size 0x10c, virtual false, abstract: false, final false
  inline bool DeleteSelection();

  /// @brief Method DeleteWordBack, addr 0x2d1967c, size 0x90, virtual false, abstract: false, final false
  inline bool DeleteWordBack();

  /// @brief Method DeleteWordForward, addr 0x2d197d4, size 0x7c, virtual false, abstract: false, final false
  inline bool DeleteWordForward();

  /// @brief Method DetectFocusChange, addr 0x2d19f7c, size 0xc, virtual false, abstract: false, final false
  inline void DetectFocusChange();

  /// @brief Method EnsureValidCodePointIndex, addr 0x2d17ce4, size 0x40, virtual false, abstract: false, final false
  inline void EnsureValidCodePointIndex(ByRef<int32_t> index);

  /// @brief Method ExpandSelectGraphicalLineEnd, addr 0x2d1b12c, size 0x64, virtual false, abstract: false, final false
  inline void ExpandSelectGraphicalLineEnd();

  /// @brief Method ExpandSelectGraphicalLineStart, addr 0x2d1b0c8, size 0x64, virtual false, abstract: false, final false
  inline void ExpandSelectGraphicalLineStart();

  /// @brief Method FindEndOfClassification, addr 0x2d1a928, size 0x114, virtual false, abstract: false, final false
  inline int32_t FindEndOfClassification(int32_t p, ::UnityEngine::__TextEditor__Direction dir);

  /// @brief Method FindEndOfPreviousWord, addr 0x2d1970c, size 0xc8, virtual false, abstract: false, final false
  inline int32_t FindEndOfPreviousWord(int32_t p);

  /// @brief Method FindNextSeperator, addr 0x2d1ac18, size 0x98, virtual false, abstract: false, final false
  inline int32_t FindNextSeperator(int32_t startPos);

  /// @brief Method FindPrevSeperator, addr 0x2d1ad98, size 0x9c, virtual false, abstract: false, final false
  inline int32_t FindPrevSeperator(int32_t startPos);

  /// @brief Method FindStartOfNextWord, addr 0x2d19850, size 0x1b0, virtual false, abstract: false, final false
  inline int32_t FindStartOfNextWord(int32_t p);

  /// @brief Method GetGraphicalLineEnd, addr 0x2d1a3b4, size 0xc4, virtual false, abstract: false, final false
  inline int32_t GetGraphicalLineEnd(int32_t p);

  /// @brief Method GetGraphicalLineStart, addr 0x2d1a2bc, size 0xb0, virtual false, abstract: false, final false
  inline int32_t GetGraphicalLineStart(int32_t p);

  /// @brief Method GrabGraphicalCursorPos, addr 0x2d1843c, size 0x84, virtual false, abstract: false, final false
  inline void GrabGraphicalCursorPos();

  /// @brief Method HandleKeyEvent, addr 0x2d184c0, size 0x1b4, virtual false, abstract: false, final false
  inline bool HandleKeyEvent(::UnityEngine::Event* e, bool textIsReadOnly);

  /// @brief Method IndexOfEndOfLine, addr 0x2d1a4d8, size 0x50, virtual false, abstract: false, final false
  inline int32_t IndexOfEndOfLine(int32_t startIndex);

  /// @brief Method InitKeyActions, addr 0x2d18674, size 0xa5c, virtual false, abstract: false, final false
  inline void InitKeyActions();

  /// @brief Method Insert, addr 0x2d19e20, size 0x34, virtual false, abstract: false, final false
  inline void Insert(char16_t c);

  /// @brief Method IsValidCodePointIndex, addr 0x2d1b790, size 0xb8, virtual false, abstract: false, final false
  inline bool IsValidCodePointIndex(int32_t index);

  /// @brief Method MapKey, addr 0x2d1b624, size 0x8c, virtual false, abstract: false, final false
  static inline void MapKey(::StringW key, ::UnityEngine::__TextEditor__TextEditOp action);

  /// @brief Method MouseDragSelectsWholeWords, addr 0x2d1abfc, size 0x14, virtual false, abstract: false, final false
  inline void MouseDragSelectsWholeWords(bool on);

  /// @brief Method MoveAltCursorToPosition, addr 0x2d1a6a8, size 0x88, virtual false, abstract: false, final false
  inline void MoveAltCursorToPosition(::UnityEngine::Vector2 cursorPosition);

  /// @brief Method MoveCursorToPosition_Internal, addr 0x2d1a620, size 0x88, virtual false, abstract: false, final false
  inline void MoveCursorToPosition_Internal(::UnityEngine::Vector2 cursorPosition, bool shift);

  /// @brief Method MoveDown, addr 0x2d1a090, size 0xe0, virtual false, abstract: false, final false
  inline void MoveDown();

  /// @brief Method MoveGraphicalLineEnd, addr 0x2d1a36c, size 0x48, virtual false, abstract: false, final false
  inline void MoveGraphicalLineEnd();

  /// @brief Method MoveGraphicalLineStart, addr 0x2d1a274, size 0x48, virtual false, abstract: false, final false
  inline void MoveGraphicalLineStart();

  /// @brief Method MoveLeft, addr 0x2d19f88, size 0x58, virtual false, abstract: false, final false
  inline void MoveLeft();

  /// @brief Method MoveLineEnd, addr 0x2d1a1e4, size 0x90, virtual false, abstract: false, final false
  inline void MoveLineEnd();

  /// @brief Method MoveLineStart, addr 0x2d1a170, size 0x74, virtual false, abstract: false, final false
  inline void MoveLineStart();

  /// @brief Method MoveParagraphBackward, addr 0x2d1a5a8, size 0x78, virtual false, abstract: false, final false
  inline void MoveParagraphBackward();

  /// @brief Method MoveParagraphForward, addr 0x2d1a528, size 0x80, virtual false, abstract: false, final false
  inline void MoveParagraphForward();

  /// @brief Method MoveRight, addr 0x2d19f10, size 0x6c, virtual false, abstract: false, final false
  inline void MoveRight();

  /// @brief Method MoveSelectionToAltCursor, addr 0x2d19e54, size 0xbc, virtual false, abstract: false, final false
  inline void MoveSelectionToAltCursor();

  /// @brief Method MoveTextEnd, addr 0x2d1a498, size 0x40, virtual false, abstract: false, final false
  inline void MoveTextEnd();

  /// @brief Method MoveTextStart, addr 0x2d1a478, size 0x20, virtual false, abstract: false, final false
  inline void MoveTextStart();

  /// @brief Method MoveToEndOfPreviousWord, addr 0x2d1aef8, size 0x60, virtual false, abstract: false, final false
  inline void MoveToEndOfPreviousWord();

  /// @brief Method MoveToStartOfNextWord, addr 0x2d1ae98, size 0x60, virtual false, abstract: false, final false
  inline void MoveToStartOfNextWord();

  /// @brief Method MoveUp, addr 0x2d19fe0, size 0xb0, virtual false, abstract: false, final false
  inline void MoveUp();

  /// @brief Method MoveWordLeft, addr 0x2d1afb0, size 0x48, virtual false, abstract: false, final false
  inline void MoveWordLeft();

  /// @brief Method MoveWordRight, addr 0x2d1ae34, size 0x64, virtual false, abstract: false, final false
  inline void MoveWordRight();

  static inline ::UnityEngine::TextEditor* New_ctor();

  /// @brief Method NextCodePointIndex, addr 0x2d19a8c, size 0xc4, virtual false, abstract: false, final false
  inline int32_t NextCodePointIndex(int32_t index);

  /// @brief Method OnCursorIndexChange, addr 0x2d1b74c, size 0x4, virtual true, abstract: false, final false
  inline void OnCursorIndexChange();

  /// @brief Method OnDetectFocusChange, addr 0x2d1b6b0, size 0x9c, virtual true, abstract: false, final false
  inline void OnDetectFocusChange();

  /// @brief Method OnFocus, addr 0x2d18360, size 0x44, virtual false, abstract: false, final false
  inline void OnFocus();

  /// @brief Method OnLostFocus, addr 0x2d183e8, size 0x54, virtual false, abstract: false, final false
  inline void OnLostFocus();

  /// @brief Method OnSelectIndexChange, addr 0x2d1b750, size 0x4, virtual true, abstract: false, final false
  inline void OnSelectIndexChange();

  /// @brief Method Paste, addr 0x2d1b4c8, size 0xa4, virtual false, abstract: false, final false
  inline bool Paste();

  /// @brief Method PerformOperation, addr 0x2d190d0, size 0x3d8, virtual false, abstract: false, final false
  inline bool PerformOperation(::UnityEngine::__TextEditor__TextEditOp operation, bool textIsReadOnly);

  /// @brief Method PreviousCodePointIndex, addr 0x2d19c34, size 0xc0, virtual false, abstract: false, final false
  inline int32_t PreviousCodePointIndex(int32_t index);

  /// @brief Method ReplaceNewlinesWithSpaces, addr 0x2d1b590, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ReplaceNewlinesWithSpaces(::StringW value);

  /// @brief Method ReplaceSelection, addr 0x2d19da4, size 0x7c, virtual false, abstract: false, final false
  inline void ReplaceSelection(::StringW replace);

  /// @brief Method SaveBackup, addr 0x2d1b56c, size 0x24, virtual false, abstract: false, final false
  inline void SaveBackup();

  /// @brief Method SelectAll, addr 0x2d183a4, size 0x44, virtual false, abstract: false, final false
  inline void SelectAll();

  /// @brief Method SelectCurrentParagraph, addr 0x2d1b380, size 0x8c, virtual false, abstract: false, final false
  inline void SelectCurrentParagraph();

  /// @brief Method SelectCurrentWord, addr 0x2d1b314, size 0x6c, virtual false, abstract: false, final false
  inline void SelectCurrentWord();

  /// @brief Method SelectDown, addr 0x2d1ab50, size 0x80, virtual false, abstract: false, final false
  inline void SelectDown();

  /// @brief Method SelectGraphicalLineEnd, addr 0x2d1b1bc, size 0x2c, virtual false, abstract: false, final false
  inline void SelectGraphicalLineEnd();

  /// @brief Method SelectGraphicalLineStart, addr 0x2d1b190, size 0x2c, virtual false, abstract: false, final false
  inline void SelectGraphicalLineStart();

  /// @brief Method SelectLeft, addr 0x2d1aa3c, size 0x58, virtual false, abstract: false, final false
  inline void SelectLeft();

  /// @brief Method SelectNone, addr 0x2d19cf4, size 0x24, virtual false, abstract: false, final false
  inline void SelectNone();

  /// @brief Method SelectParagraphBackward, addr 0x2d1b270, size 0xa4, virtual false, abstract: false, final false
  inline void SelectParagraphBackward();

  /// @brief Method SelectParagraphForward, addr 0x2d1b1e8, size 0x88, virtual false, abstract: false, final false
  inline void SelectParagraphForward();

  /// @brief Method SelectRight, addr 0x2d1aa94, size 0x58, virtual false, abstract: false, final false
  inline void SelectRight();

  /// @brief Method SelectTextEnd, addr 0x2d1abd0, size 0x24, virtual false, abstract: false, final false
  inline void SelectTextEnd();

  /// @brief Method SelectTextStart, addr 0x2d1abf4, size 0x8, virtual false, abstract: false, final false
  inline void SelectTextStart();

  /// @brief Method SelectToEndOfPreviousWord, addr 0x2d1af84, size 0x2c, virtual false, abstract: false, final false
  inline void SelectToEndOfPreviousWord();

  /// @brief Method SelectToPosition, addr 0x2d1a730, size 0x1f8, virtual false, abstract: false, final false
  inline void SelectToPosition(::UnityEngine::Vector2 cursorPosition);

  /// @brief Method SelectToStartOfNextWord, addr 0x2d1af58, size 0x2c, virtual false, abstract: false, final false
  inline void SelectToStartOfNextWord();

  /// @brief Method SelectUp, addr 0x2d1aaec, size 0x64, virtual false, abstract: false, final false
  inline void SelectUp();

  /// @brief Method SelectWordLeft, addr 0x2d1b060, size 0x68, virtual false, abstract: false, final false
  inline void SelectWordLeft();

  /// @brief Method SelectWordRight, addr 0x2d1aff8, size 0x68, virtual false, abstract: false, final false
  inline void SelectWordRight();

  /// @brief Method UpdateScrollOffset, addr 0x2d17de8, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d18268, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_SelectedText, addr 0x2d19d18, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW get_SelectedText();

  /// @brief Method get_altCursorPosition, addr 0x2d18260, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_altCursorPosition();

  /// @brief Method get_cursorIndex, addr 0x2d18198, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cursorIndex();

  /// @brief Method get_hasSelection, addr 0x2d19560, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasSelection();

  /// @brief Method get_localPosition, addr 0x2d1818c, size 0xc, virtual true, abstract: false, final false
  inline ::UnityEngine::Rect get_localPosition();

  /// @brief Method get_position, addr 0x2d17d24, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_position();

  /// @brief Method get_selectIndex, addr 0x2d181f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_selectIndex();

  /// @brief Method get_text, addr 0x2d17c50, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_cursorIndex, addr 0x2d181a0, size 0x58, virtual false, abstract: false, final false
  inline void set_cursorIndex(int32_t value);

  /// @brief Method set_position, addr 0x2d17d30, size 0xb8, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Rect value);

  /// @brief Method set_selectIndex, addr 0x2d18200, size 0x50, virtual false, abstract: false, final false
  inline void set_selectIndex(int32_t value);

  /// @brief Method set_text, addr 0x2d17c6c, size 0x78, virtual false, abstract: false, final false
