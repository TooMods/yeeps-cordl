...
public:
  ...
  /// @brief Method Destroy, addr 0x2800cf4, size 0xcc, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Finalize, addr 0x2800dc0, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetSelection, addr 0x2801508, size 0x44, virtual false, abstract: false, final false
  static inline void GetSelection(ByRef<int32_t> start, ByRef<int32_t> length);

  /// @brief Method Internal_Destroy, addr 0x2800cb8, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(void* ptr);

  /// @brief Method IsInPlaceEditingAllowed, addr 0x2801110, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x28011f8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x2801138, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSelection, addr 0x2801644, size 0x44, virtual false, abstract: false, final false
  static inline void SetSelection(int32_t start, int32_t length);

  /// @brief Method TouchScreenKeyboard_InternalConstructorHelper, addr 0x2800fb0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2800e54, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_active, addr 0x2801340, size 0x3c, virtual false, abstract: false, final false
  inline bool get_active();

  /// @brief Method get_canGetSelection, addr 0x2801440, size 0x3c, virtual false, abstract: false, final false
  inline bool get_canGetSelection();

  /// @brief Method get_canSetSelection, addr 0x280147c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_canSetSelection();

  /// @brief Method get_disableInPlaceEditing, addr 0x280105c, size 0x48, virtual false, abstract: false, final false
  static inline bool get_disableInPlaceEditing();

  /// @brief Method get_isInPlaceEditingAllowed, addr 0x28010a4, size 0x6c, virtual false, abstract: false, final false
  static inline bool get_isInPlaceEditingAllowed();

  /// @brief Method get_isSupported, addr 0x2801004, size 0x58, virtual false, abstract: false, final false
  static inline bool get_isSupported();

  /// @brief Method get_selection, addr 0x28014b8, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::RangeInt get_selection();

  /// @brief Method get_status, addr 0x28013c0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::__TouchScreenKeyboard__Status get_status();

  /// @brief Method get_text, addr 0x2801284, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_text();

  static inline void setStaticF__disableInPlaceEditing_k__BackingField(bool value);

  /// @brief Method set_active, addr 0x280137c, size 0x44, virtual false, abstract: false, final false
  inline void set_active(bool value);

  /// @brief Method set_characterLimit, addr 0x28013fc, size 0x44, virtual false, abstract: false, final false
  inline void set_characterLimit(int32_t value);

  /// @brief Method set_hideInput, addr 0x2801304, size 0x3c, virtual false, abstract: false, final false
  static inline void set_hideInput(bool value);

  /// @brief Method set_selection, addr 0x280154c, size 0xf8, virtual false, abstract: false, final false
  inline void set_selection(::UnityEngine::RangeInt value);

  /// @brief Method set_text, addr 0x28012c0, size 0x44, virtual false, abstract: false, final false
