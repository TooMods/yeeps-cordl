...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0xf0d514, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0xf0d5a8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0xf0d500, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf037e0, size 0x130, virtual false, abstract: false, final false
