...
public:
  ...
  /// @brief Method <.ctor>b__0_0, addr 0x20997f4, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::VectorImageRenderInfo* __ctor_b__0_0();

  /// @brief Method <.ctor>b__0_1, addr 0x2099894, size 0x20, virtual false, abstract: false, final false
  inline void __ctor_b__0_1(::UnityEngine::UIElements::UIR::VectorImageRenderInfo* vectorImageInfo);

  /// @brief Method .ctor, addr 0x20997ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2099600, size 0x188, virtual false, abstract: false, final false
  inline void _ctor();
