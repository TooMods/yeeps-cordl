...
public:
  ...
  /// @brief Method .ctor, addr 0x2cd0118, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customStyle, addr 0x2cc4d00, size 0x88, virtual false, abstract: false, final false
