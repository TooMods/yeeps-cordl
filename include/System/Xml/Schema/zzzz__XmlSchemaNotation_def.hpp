...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce78f4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x1ce78a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x1ce78e4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_Public, addr 0x1ce78b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Public();

  /// @brief Method get_QualifiedName, addr 0x1ce78d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_System, addr 0x1ce78c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_System();

  /// @brief Method set_Name, addr 0x1ce78ac, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x1ce78ec, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Public, addr 0x1ce78bc, size 0x8, virtual false, abstract: false, final false
  inline void set_Public(::StringW value);

  /// @brief Method set_QualifiedName, addr 0x1ce78dc, size 0x8, virtual false, abstract: false, final false
  inline void set_QualifiedName(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_System, addr 0x1ce78cc, size 0x8, virtual false, abstract: false, final false
