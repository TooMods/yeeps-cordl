...
public:
  ...
  /// @brief Method Accept, addr 0x183c6fc, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetIsByRef, addr 0x183c6f4, size 0x8, virtual true, abstract: false, final false
  inline bool GetIsByRef();

  /// @brief Method Make, addr 0x183bf60, size 0x6c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183bef4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_IsByRef, addr 0x1835af8, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsByRef();

  /// @brief Method get_Name, addr 0x183c6ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x183c6e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x183c678, size 0x6c, virtual true, abstract: false, final false
