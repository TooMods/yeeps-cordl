...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::GenerateHLSL::*)(
  ...
  constexpr static std::size_t addrs = 0x1a0467c;
...
/// @param rules: ::UnityEngine::Rendering::PackingRules (default: static_cast<int32_t>(0x0))
/// @param needAccessors: bool (default: true)
/// @param needSetters: bool (default: false)
/// @param needParamDebug: bool (default: false)
/// @param paramDefinesStart: int32_t (default: static_cast<int32_t>(0x1))
/// @param omitStructDeclaration: bool (default: false)
/// @param containsPackedFields: bool (default: false)
/// @param generateCBuffer: bool (default: false)
/// @param constantRegister: int32_t (default: static_cast<int32_t>(0xffffffff))
/// @param sourcePath: ::StringW (default: nullptr)
