...
public:
  ...
  /// @brief Method CreateDocument, addr 0xffa274, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff2f6c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xff3414, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nt);

  /// @brief Method get_NameTable, addr 0xffa2d4, size 0x8, virtual false, abstract: false, final false
