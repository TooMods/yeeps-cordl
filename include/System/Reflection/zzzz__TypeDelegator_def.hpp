...
public:
  ...
  /// @brief Method GetAttributeFlagsImpl, addr 0x2615e2c, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Reflection::TypeAttributes GetAttributeFlagsImpl();

  /// @brief Method GetConstructorImpl, addr 0x2615b68, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetConstructors, addr 0x2615b84, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x261600c, size 0x28, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCustomAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetCustomAttributes, addr 0x2615fe4, size 0x28, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCustomAttributes(bool inherit);

  /// @brief Method GetElementType, addr 0x2615f80, size 0x24, virtual true, abstract: false, final false
  inline ::System::Type* GetElementType();

  /// @brief Method GetEvent, addr 0x2615c64, size 0x24, virtual true, abstract: false, final false
  inline ::System::Reflection::EventInfo* GetEvent(::StringW name, ::System::Reflection::BindingFlags bindingAttr);

  /// @brief Method GetEvents, addr 0x2615d9c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetField, addr 0x2615bf8, size 0x24, virtual true, abstract: false, final false
  inline ::System::Reflection::FieldInfo* GetField(::StringW name, ::System::Reflection::BindingFlags bindingAttr);

  /// @brief Method GetFields, addr 0x2615c1c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInterfaces, addr 0x2615c40, size 0x24, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetInterfaces();

  /// @brief Method GetMember, addr 0x2615de4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMembers, addr 0x2615e08, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMethodImpl, addr 0x2615ba8, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMethods, addr 0x2615bd4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetNestedType, addr 0x2615dc0, size 0x24, virtual true, abstract: false, final false
  inline ::System::Type* GetNestedType(::StringW name, ::System::Reflection::BindingFlags bindingAttr);

  /// @brief Method GetProperties, addr 0x2615d78, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertyImpl, addr 0x2615c88, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method HasElementTypeImpl, addr 0x2615fa4, size 0x1c, virtual true, abstract: false, final false
  inline bool HasElementTypeImpl();

  /// @brief Method InvokeMember, addr 0x2615a20, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method IsArrayImpl, addr 0x2615e6c, size 0x1c, virtual true, abstract: false, final false
  inline bool IsArrayImpl();

  /// @brief Method IsAssignableFrom, addr 0x26158f0, size 0xb4, virtual true, abstract: false, final false
  inline bool IsAssignableFrom(::System::Reflection::TypeInfo* typeInfo);

  /// @brief Method IsByRefImpl, addr 0x2615ea4, size 0x1c, virtual true, abstract: false, final false
  inline bool IsByRefImpl();

  /// @brief Method IsCOMObjectImpl, addr 0x2615f1c, size 0x1c, virtual true, abstract: false, final false
  inline bool IsCOMObjectImpl();

  /// @brief Method IsDefined, addr 0x2616034, size 0x24, virtual true, abstract: false, final false
  inline bool IsDefined(::System::Type* attributeType, bool inherit);

  /// @brief Method IsPointerImpl, addr 0x2615ee4, size 0x1c, virtual true, abstract: false, final false
  inline bool IsPointerImpl();

  /// @brief Method IsPrimitiveImpl, addr 0x2615e88, size 0x1c, virtual true, abstract: false, final false
  inline bool IsPrimitiveImpl();

  /// @brief Method IsValueTypeImpl, addr 0x2615f00, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2610684, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* delegatingType);

  /// @brief Method get_Assembly, addr 0x2615a70, size 0x24, virtual true, abstract: false, final false
  inline ::System::Reflection::Assembly* get_Assembly();

  /// @brief Method get_AssemblyQualifiedName, addr 0x2615b20, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_AssemblyQualifiedName();

  /// @brief Method get_BaseType, addr 0x2615b44, size 0x24, virtual true, abstract: false, final false
  inline ::System::Type* get_BaseType();

  /// @brief Method get_FullName, addr 0x2615ad8, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_FullName();

  /// @brief Method get_IsCollectible, addr 0x2615f5c, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsCollectible();

  /// @brief Method get_IsConstructedGenericType, addr 0x2615f38, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsConstructedGenericType();

  /// @brief Method get_IsGenericMethodParameter, addr 0x2615ec0, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsGenericMethodParameter();

  /// @brief Method get_IsSZArray, addr 0x2615e48, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsSZArray();

  /// @brief Method get_MetadataToken, addr 0x26159fc, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_MetadataToken();

  /// @brief Method get_Module, addr 0x2615a4c, size 0x24, virtual true, abstract: false, final false
  inline ::System::Reflection::Module* get_Module();

  /// @brief Method get_Name, addr 0x2615ab8, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x2615afc, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_TypeHandle, addr 0x2615a94, size 0x24, virtual true, abstract: false, final false
  inline ::System::RuntimeTypeHandle get_TypeHandle();

  /// @brief Method get_UnderlyingSystemType, addr 0x2615fc0, size 0x24, virtual true, abstract: false, final false
