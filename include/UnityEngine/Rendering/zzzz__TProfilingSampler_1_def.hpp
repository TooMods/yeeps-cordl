...
// Type: UnityEngine.Rendering::TProfilingSampler`1
...
public:
  ...
  static __declspec(property(get = getStaticF_samples, put = setStaticF_samples))::System::Collections::Generic::Dictionary_2<TEnum, ::UnityEngine::Rendering::TProfilingSampler_1<TEnum>*>* samples;
