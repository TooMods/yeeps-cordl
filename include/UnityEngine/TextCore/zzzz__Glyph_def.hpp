...
public:
  ...
  __declspec(property(get = get_glyphRect))::UnityEngine::TextCore::GlyphRect glyphRect;

  __declspec(property(get = get_index)) uint32_t index;
  ...
  __declspec(property(get = get_metrics))::UnityEngine::TextCore::GlyphMetrics metrics;
  ...
  /// @brief Method .ctor, addr 0x2902ca4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2902ccc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct glyphStruct);

  /// @brief Method .ctor, addr 0x2902d58, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlasIndex, addr 0x2902c94, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasIndex();

  /// @brief Method get_glyphRect, addr 0x2902c88, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::GlyphRect get_glyphRect();

  /// @brief Method get_index, addr 0x2902c6c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_index();

  /// @brief Method get_metrics, addr 0x2902c74, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::GlyphMetrics get_metrics();

  /// @brief Method set_atlasIndex, addr 0x2902c9c, size 0x8, virtual false, abstract: false, final false
