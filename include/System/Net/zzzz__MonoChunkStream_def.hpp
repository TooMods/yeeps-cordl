...
public:
  ...
  /// @brief Method MoveNext, addr 0x103f798, size 0x36c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x103fb04, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x103fb5c, size 0x3d4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x103ff30, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method FinishReading, addr 0x103f654, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessReadAsync, addr 0x103f530, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method ThrowExpectingChunkTrailer, addr 0x103f734, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method <>n__0, addr 0x103f790, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* __n__0(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method .ctor, addr 0x103f49c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* innerStream, ::System::Net::WebHeaderCollection* headers);

  /// @brief Method get_Decoder, addr 0x103f494, size 0x8, virtual false, abstract: false, final false
