...
public:
  ...
  /// @brief Method .ctor, addr 0x2dedf8c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Cache, addr 0x2dee008, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCache* get_Cache();

  /// @brief Method get_Policy, addr 0x2dee018, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCachePolicy* get_Policy();

  /// @brief Method get_Validator, addr 0x2dee010, size 0x8, virtual false, abstract: false, final false
