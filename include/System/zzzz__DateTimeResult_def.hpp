...
public:
  // Declarations
  /// @brief Method Init, addr 0x30cfd74, size 0x24, virtual false, abstract: false, final false
  inline void Init(::System::ReadOnlySpan_1<char16_t> originalDateTimeString);

  /// @brief Method SetBadDateTimeFailure, addr 0x30cfe9c, size 0x50, virtual false, abstract: false, final false
  inline void SetBadDateTimeFailure();

  /// @brief Method SetBadFormatSpecifierFailure, addr 0x30cfda4, size 0x94, virtual false, abstract: false, final false
  inline void SetBadFormatSpecifierFailure();

  /// @brief Method SetBadFormatSpecifierFailure, addr 0x30cfe38, size 0x64, virtual false, abstract: false, final false
  inline void SetBadFormatSpecifierFailure(::System::ReadOnlySpan_1<char16_t> failedFormatSpecifier);

  /// @brief Method SetDate, addr 0x30cfd98, size 0xc, virtual false, abstract: false, final false
  inline void SetDate(int32_t year, int32_t month, int32_t day);

  /// @brief Method SetFailure, addr 0x30cfeec, size 0xc, virtual false, abstract: false, final false
  inline void SetFailure(::System::ParseFailureKind failure, ::StringW failureMessageID);

  /// @brief Method SetFailure, addr 0x30cfef8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x30cff04, size 0x10, virtual false, abstract: false, final false
