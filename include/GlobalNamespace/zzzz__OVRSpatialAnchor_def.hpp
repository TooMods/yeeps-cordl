...
public:
  ...
  /// @brief Method ToQueryOptions, addr 0x14da240, size 0x114, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSpaceQuery__Options ToQueryOptions();

  /// @brief Method get_MaxAnchorCount, addr 0x14da094, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxAnchorCount();

  /// @brief Method get_StorageLocation, addr 0x14da084, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSpace__StorageLocation get_StorageLocation();

  /// @brief Method get_Timeout, addr 0x14da0a4, size 0x8, virtual false, abstract: false, final false
  inline double_t get_Timeout();

  /// @brief Method get_Uuids, addr 0x14da0b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::System::Guid>* get_Uuids();

  /// @brief Method set_MaxAnchorCount, addr 0x14da09c, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxAnchorCount(int32_t value);

  /// @brief Method set_StorageLocation, addr 0x14da08c, size 0x8, virtual false, abstract: false, final false
  inline void set_StorageLocation(::GlobalNamespace::__OVRSpace__StorageLocation value);

  /// @brief Method set_Timeout, addr 0x14da0ac, size 0x8, virtual false, abstract: false, final false
  inline void set_Timeout(double_t value);

  /// @brief Method set_Uuids, addr 0x14da0bc, size 0x184, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddStorableAndShareableComponents, addr 0x14da920, size 0xb0, virtual false, abstract: false, final false
  inline void AddStorableAndShareableComponents();

  /// @brief Method BindTo, addr 0x14da9d0, size 0x360, virtual false, abstract: false, final false
  inline void BindTo(::GlobalNamespace::OVRSpatialAnchor* spatialAnchor);

  /// @brief Method Localize, addr 0x14da5c8, size 0xd4, virtual false, abstract: false, final false
  inline void Localize(::System::Action_2<::GlobalNamespace::__OVRSpatialAnchor__UnboundAnchor, bool>* onComplete, double_t timeout);

  /// @brief Method LocalizeAsync, addr 0x14da69c, size 0xe8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> LocalizeAsync(double_t timeout);

  /// @brief Method ValidateLocalization, addr 0x14da784, size 0x19c, virtual false, abstract: false, final false
  inline void ValidateLocalization();

  /// @brief Method .ctor, addr 0x14dad30, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method get_Localized, addr 0x14da360, size 0x98, virtual false, abstract: false, final false
  inline bool get_Localized();

  /// @brief Method get_Localizing, addr 0x14da3f8, size 0xa4, virtual false, abstract: false, final false
  inline bool get_Localizing();

  /// @brief Method get_Pose, addr 0x14da49c, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_Pose();

  /// @brief Method get_Uuid, addr 0x14da354, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Log, addr 0x14dad3c, size 0x8c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x14dae54, size 0x8c, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogRequest, addr 0x14daee0, size 0x4, virtual false, abstract: false, final false
  static inline void LogRequest(uint64_t requestId, ::StringW message);

  /// @brief Method LogRequestResult, addr 0x14daee4, size 0x4, virtual false, abstract: false, final false
  static inline void LogRequestResult(uint64_t requestId, bool result, ::StringW successMessage, ::StringW failureMessage);

  /// @brief Method LogWarning, addr 0x14dadc8, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetListToStoreTheShareRequest>b__41_0, addr 0x14daf54, size 0x3c, virtual false, abstract: false, final false
  inline int32_t _GetListToStoreTheShareRequest_b__41_0(::GlobalNamespace::OVRSpaceUser x, ::GlobalNamespace::OVRSpaceUser y);

  /// @brief Method .ctor, addr 0x14daf4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AreSortedUserListsEqual, addr 0x149a030, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyAnchorListIntoListFromPool, addr 0x1498c40, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchor, addr 0x149a514, size 0x230, virtual false, abstract: false, final false
  inline void CreateSpatialAnchor();

  /// @brief Method Erase, addr 0x149a2cc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Erase, addr 0x149a2bc, size 0x10, virtual false, abstract: false, final false
  inline void Erase(::System::Action_2<::UnityW<::GlobalNamespace::OVRSpatialAnchor>, bool>* onComplete);

  /// @brief Method EraseAsync, addr 0x149a450, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync();

  /// @brief Method EraseAsync, addr 0x149a37c, size 0xd4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync(::GlobalNamespace::__OVRSpatialAnchor__EraseOptions eraseOptions);

  /// @brief Method GetListToStoreTheShareRequest, addr 0x1499ce4, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTrackingSpacePose, addr 0x149acb4, size 0xc8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose GetTrackingSpacePose();

  /// @brief Method InitializeFromExisting, addr 0x1498038, size 0x20c, virtual false, abstract: false, final false
  inline void InitializeFromExisting(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method InitializeOnLoad, addr 0x149af5c, size 0xf0, virtual false, abstract: false, final false
  static inline void InitializeOnLoad();

  /// @brief Method InitializeUnchecked, addr 0x1498374, size 0x138, virtual false, abstract: false, final false
  inline void InitializeUnchecked(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method InvokeMultiAnchorDelegate, addr 0x149b5c8, size 0x550, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x149a754, size 0x50, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadUnboundAnchors, addr 0x149bd2c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadUnboundAnchorsAsync, addr 0x149be08, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x149abfc, size 0xb8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnShareSpacesComplete, addr 0x149c8d8, size 0x68, virtual false, abstract: false, final false
  static inline void OnShareSpacesComplete(uint64_t requestId, ::GlobalNamespace::__OVRSpatialAnchor__OperationResult result);

  /// @brief Method OnSpaceEraseComplete, addr 0x149bd28, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpaceListSaveComplete, addr 0x149c870, size 0x68, virtual false, abstract: false, final false
  static inline void OnSpaceListSaveComplete(uint64_t requestId, ::GlobalNamespace::__OVRSpatialAnchor__OperationResult result);

  /// @brief Method OnSpaceQueryComplete, addr 0x149bf18, size 0x504, virtual false, abstract: false, final false
  static inline void OnSpaceQueryComplete(uint64_t requestId, bool queryResult);

  /// @brief Method OnSpaceSaveComplete, addr 0x149bd24, size 0x4, virtual false, abstract: false, final false
  static inline void OnSpaceSaveComplete(uint64_t requestId, ::GlobalNamespace::OVRSpace space, bool result, ::System::Guid uuid);

  /// @brief Method OnSpaceSetComponentStatusComplete, addr 0x149c790, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpatialAnchorCreateComplete, addr 0x149bb18, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateUnbound, addr 0x149c41c, size 0x374, virtual false, abstract: false, final false
  static inline void PopulateUnbound(::System::Guid uuid, uint64_t space);

  /// @brief Method Save, addr 0x1498980, size 0x2c0, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method Save, addr 0x14984ac, size 0x10, virtual false, abstract: false, final false
  inline void Save(::System::Action_2<::UnityW<::GlobalNamespace::OVRSpatialAnchor>, bool>* onComplete);

  /// @brief Method Save, addr 0x14984bc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAsync, addr 0x1498978, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync();

  /// @brief Method SaveAsync, addr 0x1498814, size 0x164, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync(::GlobalNamespace::__OVRSpatialAnchor__SaveOptions saveOptions);

  /// @brief Method SaveBatchAnchors, addr 0x149a7a4, size 0x1ec, virtual false, abstract: false, final false
  static inline void SaveBatchAnchors();

  /// @brief Method Share, addr 0x14996b0, size 0x634, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method Share, addr 0x1498cb8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x1498f44, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x14990f8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x1499320, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x14995ac, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x1498d34, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x1498fc8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x149918c, size 0x194, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::__OVRSpatialAnchor__OperationResult> ShareAsync(::GlobalNamespace::OVRSpaceUser user1, ::GlobalNamespace::OVRSpaceUser user2,
                                                                                                         ::GlobalNamespace::OVRSpaceUser user3);

  /// @brief Method ShareAsync, addr 0x14993bc, size 0x1f0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::__OVRSpatialAnchor__OperationResult> ShareAsync(::GlobalNamespace::OVRSpaceUser user1, ::GlobalNamespace::OVRSpaceUser user2,
                                                                                                         ::GlobalNamespace::OVRSpaceUser user3, ::GlobalNamespace::OVRSpaceUser user4);

  /// @brief Method ShareAsync, addr 0x1499628, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsyncInternal, addr 0x1498e08, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareBatchAnchors, addr 0x149a990, size 0x26c, virtual false, abstract: false, final false
  static inline void ShareBatchAnchors();

  /// @brief Method Start, addr 0x149a4fc, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ThrowIfBound, addr 0x1498244, size 0x130, virtual false, abstract: false, final false
  static inline void ThrowIfBound(::System::Guid uuid);

  /// @brief Method ToNativeArray, addr 0x149856c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetPose, addr 0x149ad7c, size 0x1e0, virtual false, abstract: false, final false
  static inline bool TryGetPose(::GlobalNamespace::OVRSpace space, ByRef<::GlobalNamespace::OVRPose> pose);

  /// @brief Method Update, addr 0x149a744, size 0x10, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateTransform, addr 0x149a458, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x149c940, size 0x100c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnLocalize, addr 0x1497e04, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Created, addr 0x1497f88, size 0x10, virtual false, abstract: false, final false
  inline bool get_Created();

  /// @brief Method get_Localized, addr 0x1497fa8, size 0x90, virtual false, abstract: false, final false
  inline bool get_Localized();

  /// @brief Method get_PendingCreation, addr 0x1497f98, size 0x10, virtual false, abstract: false, final false
  inline bool get_PendingCreation();

  /// @brief Method get_Space, addr 0x1497f64, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpace get_Space();

  /// @brief Method get_Uuid, addr 0x1497f74, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_Uuid();

  /// @brief Method remove_OnLocalize, addr 0x1497eb4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Space, addr 0x1497f6c, size 0x8, virtual false, abstract: false, final false
  inline void set_Space(::GlobalNamespace::OVRSpace value);

  /// @brief Method set_Uuid, addr 0x1497f80, size 0x8, virtual false, abstract: false, final false
