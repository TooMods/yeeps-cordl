...
public:
  ...
  /// @brief Method Equals, addr 0x25b5f44, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x25b5f1c, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRAnchorContainer other);

  /// @brief Method FetchChildrenAsync, addr 0x25b6158, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x25b5fbc, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.FromAnchor, addr 0x25b5e00, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.SetEnabledAsync, addr 0x25b5ecc, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.get_Handle, addr 0x25b5df8, size 0x8, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRAnchorContainer__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.get_Type, addr 0x25b5de8, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRAnchorContainer__get_Type();

  /// @brief Method ToString, addr 0x25b6008, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x25b5e08, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  static inline ::GlobalNamespace::OVRAnchorContainer getStaticF_Null();

  /// @brief Method get_Handle, addr 0x25b608c, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x25b5e24, size 0xa8, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x25b5e14, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Type, addr 0x25b5df0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType get_Type();

  /// @brief Method get_Uuids, addr 0x25b6094, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x25b5f2c, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRAnchorContainer lhs, ::GlobalNamespace::OVRAnchorContainer rhs);

  /// @brief Method op_Inequality, addr 0x25b5f38, size 0xc, virtual false, abstract: false, final false
