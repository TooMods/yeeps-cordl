...
public:
  ...
  /// @brief Method DeserializeSection, addr 0x16d4944, size 0x38, virtual true, abstract: false, final false
  inline void DeserializeSection(::System::Xml::XmlReader* xmlReader);

  /// @brief Method IsModified, addr 0x16d497c, size 0x38, virtual true, abstract: false, final false
  inline bool IsModified();

  static inline ::System::Configuration::IgnoreSection* New_ctor();

  /// @brief Method Reset, addr 0x16d49b4, size 0x38, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentSection);

  /// @brief Method ResetModified, addr 0x16d49ec, size 0x38, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method SerializeSection, addr 0x16d4a24, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16d48d4, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x16d490c, size 0x38, virtual true, abstract: false, final false
