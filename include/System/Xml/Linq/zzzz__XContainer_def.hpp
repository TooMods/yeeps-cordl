...
public:
  ...
  /// @brief Method ReadContentFrom, addr 0x1330188, size 0x5fc, virtual false, abstract: false, final false
  inline bool ReadContentFrom(::System::Xml::Linq::XContainer* rootContainer, ::System::Xml::XmlReader* r);

  /// @brief Method ReadContentFrom, addr 0x1330958, size 0xc6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1330160, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* rootContainer);

  /// @brief Method .ctor, addr 0x13308b0, size 0xa8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1331d60, size 0x90, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Xml::Linq::__XContainer___Nodes_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Xml.Linq.XNode>.GetEnumerator, addr 0x1331e40, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Xml.Linq.XNode>.get_Current, addr 0x1331df0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Linq::XNode* System_Collections_Generic_IEnumerator_System_Xml_Linq_XNode__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1331ee4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1331df8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1331e38, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1331d5c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x132f778, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x132e978, size 0x4f0, virtual false, abstract: false, final false
  inline void Add(::System::Object* content);

  /// @brief Method AddAttribute, addr 0x132fb90, size 0x4, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x132fb94, size 0x4, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddContentSkipNotify, addr 0x132eed8, size 0x4cc, virtual false, abstract: false, final false
  inline void AddContentSkipNotify(::System::Object* content);

  /// @brief Method AddNode, addr 0x132f3a4, size 0x80, virtual false, abstract: false, final false
  inline void AddNode(::System::Xml::Linq::XNode* n);

  /// @brief Method AddNodeSkipNotify, addr 0x132fb98, size 0x80, virtual false, abstract: false, final false
  inline void AddNodeSkipNotify(::System::Xml::Linq::XNode* n);

  /// @brief Method AddString, addr 0x132f424, size 0x258, virtual false, abstract: false, final false
  inline void AddString(::StringW s);

  /// @brief Method AddStringSkipNotify, addr 0x132fc18, size 0x154, virtual false, abstract: false, final false
  inline void AddStringSkipNotify(::StringW s);

  /// @brief Method AppendNode, addr 0x132fd6c, size 0x118, virtual false, abstract: false, final false
  inline void AppendNode(::System::Xml::Linq::XNode* n);

  /// @brief Method AppendNodeSkipNotify, addr 0x132e77c, size 0xc0, virtual false, abstract: false, final false
  inline void AppendNodeSkipNotify(::System::Xml::Linq::XNode* n);

  /// @brief Method AppendText, addr 0x132ff78, size 0xec, virtual true, abstract: false, final false
  inline void AppendText(::System::Text::StringBuilder* sb);

  /// @brief Method ConvertTextToNode, addr 0x132fae4, size 0xac, virtual false, abstract: false, final false
  inline void ConvertTextToNode();

  /// @brief Method GetStringValue, addr 0x132d090, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method Nodes, addr 0x132f700, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Xml::Linq::XNode*>* Nodes();

  /// @brief Method ReadContentFrom, addr 0x1330064, size 0xfc, virtual false, abstract: false, final false
  inline void ReadContentFrom(::System::Xml::XmlReader* r);

  /// @brief Method ReadContentFrom, addr 0x1330784, size 0x12c, virtual false, abstract: false, final false
  inline void ReadContentFrom(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);

  /// @brief Method RemoveNode, addr 0x13315c4, size 0x1a0, virtual false, abstract: false, final false
  inline void RemoveNode(::System::Xml::Linq::XNode* n);

  /// @brief Method RemoveNodes, addr 0x132f7ac, size 0x29c, virtual false, abstract: false, final false
  inline void RemoveNodes();

  /// @brief Method RemoveNodesSkipNotify, addr 0x132fa48, size 0x9c, virtual false, abstract: false, final false
  inline void RemoveNodesSkipNotify();

  /// @brief Method ValidateNode, addr 0x1331764, size 0x4, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method ValidateString, addr 0x1331768, size 0x4, virtual true, abstract: false, final false
  inline void ValidateString(::StringW s);

  /// @brief Method WriteContentTo, addr 0x133176c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x132e638, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x132e640, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* other);

  /// @brief Method get_LastNode, addr 0x132e83c, size 0x13c, virtual false, abstract: false, final false
