...
public:
  ...
  /// @brief Method .ctor, addr 0x3028fc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x3028fb8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_values, addr 0x3028fc0, size 0x8, virtual false, abstract: false, final false
