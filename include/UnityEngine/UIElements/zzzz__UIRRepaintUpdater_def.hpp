...
public:
  ...
  /// @brief Method AttachToPanel, addr 0x30374f8, size 0x1f4, virtual false, abstract: false, final false
  inline void AttachToPanel();

  /// @brief Method CreateRenderChain, addr 0x3036f98, size 0x78, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::RenderChain* CreateRenderChain();

  /// @brief Method DestroyRenderChain, addr 0x30372ec, size 0x50, virtual false, abstract: false, final false
  inline void DestroyRenderChain();

  /// @brief Method DetachFromPanel, addr 0x3037354, size 0x1a4, virtual false, abstract: false, final false
  inline void DetachFromPanel();

  /// @brief Method Dispose, addr 0x3037b14, size 0x2c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method InitRenderChain, addr 0x3036edc, size 0xbc, virtual false, abstract: false, final false
  inline void InitRenderChain();

  static inline ::UnityEngine::UIElements::UIRRepaintUpdater* New_ctor();

  /// @brief Method OnGraphicsResourcesRecreate, addr 0x303711c, size 0x1d0, virtual false, abstract: false, final false
  static inline void OnGraphicsResourcesRecreate(bool recreate);

  /// @brief Method OnPanelAtlasChanged, addr 0x3037ac4, size 0x4, virtual false, abstract: false, final false
  inline void OnPanelAtlasChanged();

  /// @brief Method OnPanelChanged, addr 0x303733c, size 0x18, virtual false, abstract: false, final false
  inline void OnPanelChanged(::UnityEngine::UIElements::BaseVisualElementPanel* obj);

  /// @brief Method OnPanelHierarchyChanged, addr 0x3037ac8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelStandardShaderChanged, addr 0x30376ec, size 0x1a4, virtual false, abstract: false, final false
  inline void OnPanelStandardShaderChanged();

  /// @brief Method OnPanelStandardWorldSpaceShaderChanged, addr 0x3037890, size 0x1a4, virtual false, abstract: false, final false
  inline void OnPanelStandardWorldSpaceShaderChanged();

  /// @brief Method OnVersionChanged, addr 0x3036d28, size 0xf8, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method ResetAllElementsDataRecursive, addr 0x3037a34, size 0x90, virtual false, abstract: false, final false
  inline void ResetAllElementsDataRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Update, addr 0x3036e20, size 0xbc, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3036c30, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_breakBatches, addr 0x3036d20, size 0x8, virtual false, abstract: false, final false
  inline bool get_breakBatches();

  /// @brief Method get_disposed, addr 0x3037b00, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_drawStats, addr 0x3036d18, size 0x8, virtual false, abstract: false, final false
  inline bool get_drawStats();

  /// @brief Method get_profilerMarker, addr 0x3036cc0, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x3037b08, size 0xc, virtual false, abstract: false, final false
