...
public:
  ...
  /// @brief Method From, addr 0x1e03b60, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEventSizeWithValueSize, addr 0x1e03b58, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetEventSizeWithValueSize(int32_t valueSizeInBytes);

  /// @brief Method ToEventPtr, addr 0x1e03b24, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1e038ec, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_bindingIndex, addr 0x1e03a30, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bindingIndex();

  /// @brief Method get_controlIndex, addr 0x1e039c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_controlIndex();

  /// @brief Method get_interactionIndex, addr 0x1e03a9c, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_interactionIndex();

  /// @brief Method get_phase, addr 0x1e0392c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_startTime, addr 0x1e0391c, size 0x8, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_stateIndex, addr 0x1e03958, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_stateIndex();

  /// @brief Method get_typeStatic, addr 0x1e03b28, size 0x30, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_typeStatic();

  /// @brief Method get_valueData, addr 0x1e0393c, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> get_valueData();

  /// @brief Method get_valueSizeInBytes, addr 0x1e03944, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bindingIndex, addr 0x1e03a38, size 0x64, virtual false, abstract: false, final false
  inline void set_bindingIndex(int32_t value);

  /// @brief Method set_controlIndex, addr 0x1e039cc, size 0x64, virtual false, abstract: false, final false
  inline void set_controlIndex(int32_t value);

  /// @brief Method set_interactionIndex, addr 0x1e03ab0, size 0x74, virtual false, abstract: false, final false
  inline void set_interactionIndex(int32_t value);

  /// @brief Method set_phase, addr 0x1e03934, size 0x8, virtual false, abstract: false, final false
  inline void set_phase(::UnityEngine::InputSystem::InputActionPhase value);

  /// @brief Method set_startTime, addr 0x1e03924, size 0x8, virtual false, abstract: false, final false
  inline void set_startTime(double_t value);

  /// @brief Method set_stateIndex, addr 0x1e03960, size 0x64, virtual false, abstract: false, final false
