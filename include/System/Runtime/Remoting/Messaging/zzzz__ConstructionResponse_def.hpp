...
public:
  ...
  /// @brief Method .ctor, addr 0x185a690, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, ::System::Runtime::Remoting::Messaging::IMethodCallMessage* msg);

  /// @brief Method .ctor, addr 0x1862b2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x184f27c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Properties, addr 0x1862bbc, size 0x4, virtual true, abstract: false, final false
