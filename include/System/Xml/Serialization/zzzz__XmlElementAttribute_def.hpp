...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129e708, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129e5d0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName);

  /// @brief Method .ctor, addr 0x129e600, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName, ::System::Type* type);

  /// @brief Method get_DataType, addr 0x129e638, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x129e68c, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Form, addr 0x129e6e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x129e6f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Namespace, addr 0x129e6e8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_Order, addr 0x129e6f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method get_Type, addr 0x129e700, size 0x8, virtual false, abstract: false, final false
