...
public:
  ...
  /// @brief Method .ctor, addr 0x18c8960, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x18c9398, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x18c9478, size 0x90, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x18c8df8, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Specialized::NameObjectCollectionBase* coll);

  /// @brief Method get_Current, addr 0x18c9508, size 0xa8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BaseAdd, addr 0x18c873c, size 0x164, virtual false, abstract: false, final false
  inline void BaseAdd(::StringW name, ::System::Object* value);

  /// @brief Method BaseGet, addr 0x18c8cfc, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Object* BaseGet(int32_t index);

  /// @brief Method BaseGet, addr 0x18c8c34, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* BaseGet(::StringW name);

  /// @brief Method BaseGetAllKeys, addr 0x18c91fc, size 0xf4, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> BaseGetAllKeys();

  /// @brief Method BaseGetKey, addr 0x18c8b98, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW BaseGetKey(int32_t index);

  /// @brief Method BaseRemove, addr 0x18c898c, size 0x20c, virtual false, abstract: false, final false
  inline void BaseRemove(::StringW name);

  /// @brief Method BaseSet, addr 0x18c8c4c, size 0xb0, virtual false, abstract: false, final false
  inline void BaseSet(::StringW name, ::System::Object* value);

  /// @brief Method FindEntry, addr 0x18c88a0, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Collections::Specialized::__NameObjectCollectionBase__NameObjectEntry* FindEntry(::StringW key);

  /// @brief Method GetEnumerator, addr 0x18c8d98, size 0x60, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetObjectData, addr 0x18c77f0, size 0x580, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDeserialization, addr 0x18c7f2c, size 0x768, virtual true, abstract: false, final false
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method Reset, addr 0x18c7618, size 0xb8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x18c76fc, size 0xc4, virtual false, abstract: false, final false
  inline void Reset(int32_t capacity);

  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x18c8e5c, size 0x31c, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x18c91f4, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x18c9178, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18c7538, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x18c76d0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, ::System::Collections::IEqualityComparer* equalityComparer);

  /// @brief Method .ctor, addr 0x18c77c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::DBNull* dummy);

  /// @brief Method .ctor, addr 0x18c7598, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEqualityComparer* equalityComparer);

  /// @brief Method .ctor, addr 0x18c77c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::StringComparer* getStaticF_defaultComparer();

  /// @brief Method get_Count, addr 0x18c8e38, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x18c8958, size 0x8, virtual false, abstract: false, final false
