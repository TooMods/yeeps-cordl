...
public:
  ...
  /// @brief Method Run, addr 0x1b5e494, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x1b5e508, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b5e424, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value);

  /// @brief Method get_InstructionName, addr 0x1b5e454, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1b5e44c, size 0x8, virtual true, abstract: false, final false
