...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x171571c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x17155f0, size 0x12c, virtual false, abstract: false, final false
