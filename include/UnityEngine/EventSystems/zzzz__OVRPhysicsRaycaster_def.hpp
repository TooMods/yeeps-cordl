...
public:
  ...
  /// @brief Method <Raycast>b__15_0, addr 0x2a80b78, size 0x40, virtual false, abstract: false, final false
  inline int32_t _Raycast_b__15_0(::UnityEngine::RaycastHit r1, ::UnityEngine::RaycastHit r2);

  /// @brief Method <Spherecast>b__16_0, addr 0x2a80bb8, size 0x40, virtual false, abstract: false, final false
  inline int32_t _Spherecast_b__16_0(::UnityEngine::RaycastHit r1, ::UnityEngine::RaycastHit r2);

  /// @brief Method .ctor, addr 0x2a80b70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetScreenPos, addr 0x2a7f800, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x2a80654, size 0x430, virtual true, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList);

  /// @brief Method Spherecast, addr 0x2a7f3c8, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a80434, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_depth, addr 0x2a804b4, size 0xc4, virtual true, abstract: false, final false
  inline int32_t get_depth();

  /// @brief Method get_eventCamera, addr 0x2a8045c, size 0x58, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_eventMask, addr 0x2a80644, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_eventMask();

  /// @brief Method get_finalEventMask, addr 0x2a80580, size 0xc4, virtual false, abstract: false, final false
  inline int32_t get_finalEventMask();

  /// @brief Method get_sortOrderPriority, addr 0x2a80578, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_sortOrderPriority();

  /// @brief Method set_eventMask, addr 0x2a8064c, size 0x8, virtual false, abstract: false, final false
