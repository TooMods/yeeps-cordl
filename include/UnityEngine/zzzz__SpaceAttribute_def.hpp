...
public:
  ...
  /// @brief Method .ctor, addr 0x2800884, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x28008a4, size 0x28, virtual false, abstract: false, final false
