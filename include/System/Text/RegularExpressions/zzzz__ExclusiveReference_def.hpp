...
public:
  ...
  /// @brief Method Get, addr 0x17192ec, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x1719344, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1719400, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
