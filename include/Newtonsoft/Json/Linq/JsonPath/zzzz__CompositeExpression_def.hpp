...
public:
  ...
  /// @brief Method IsMatch, addr 0x11a5240, size 0x29c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a49c0, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator _cordl_operator);

  /// @brief Method get_Expressions, addr 0x11a5230, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>* get_Expressions();

  /// @brief Method set_Expressions, addr 0x11a5238, size 0x8, virtual false, abstract: false, final false
