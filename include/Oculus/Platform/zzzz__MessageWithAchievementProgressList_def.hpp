...
public:
  // Declarations
  /// @brief Method GetAchievementProgressList, addr 0x19b25dc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementProgressList* GetAchievementProgressList();

  /// @brief Method GetDataFromMessage, addr 0x19b2618, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b05cc, size 0x58, virtual false, abstract: false, final false
