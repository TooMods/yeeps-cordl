...
public:
  // Declarations
  /// @brief Method GetPrefixOfNamespace, addr 0x13343d0, size 0xfc, virtual false, abstract: false, final false
  inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace* ns, bool allowDefaultNamespace);

  /// @brief Method PushAncestors, addr 0x13340f0, size 0x128, virtual false, abstract: false, final false
  inline void PushAncestors(::System::Xml::Linq::XElement* e);

  /// @brief Method PushElement, addr 0x1334640, size 0xd4, virtual false, abstract: false, final false
  inline void PushElement(::System::Xml::Linq::XElement* e);

  /// @brief Method WriteElement, addr 0x1332ef4, size 0x1a8, virtual false, abstract: false, final false
  inline void WriteElement(::System::Xml::Linq::XElement* e);

  /// @brief Method WriteEndElement, addr 0x1334378, size 0x2c, virtual false, abstract: false, final false
  inline void WriteEndElement();

  /// @brief Method WriteFullEndElement, addr 0x13343a4, size 0x2c, virtual false, abstract: false, final false
  inline void WriteFullEndElement();

  /// @brief Method WriteStartElement, addr 0x1334218, size 0x160, virtual false, abstract: false, final false
  inline void WriteStartElement(::System::Xml::Linq::XElement* e);

  /// @brief Method .ctor, addr 0x1332ee8, size 0xc, virtual false, abstract: false, final false
