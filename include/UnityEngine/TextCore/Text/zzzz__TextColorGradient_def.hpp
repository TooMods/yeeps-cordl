...
public:
  ...
  /// @brief Method .ctor, addr 0x2471fd4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2472070, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x24720dc, size 0xa4, virtual false, abstract: false, final false
