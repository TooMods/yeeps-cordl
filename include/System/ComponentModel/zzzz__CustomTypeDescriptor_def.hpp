...
public:
  ...
  /// @brief Method GetAttributes, addr 0x1af2e1c, size 0xd8, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* GetAttributes();

  /// @brief Method GetClassName, addr 0x1af2ef4, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW GetClassName();

  /// @brief Method GetComponentName, addr 0x1af2fa4, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW GetComponentName();

  /// @brief Method GetConverter, addr 0x1af3054, size 0xe0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::TypeConverter* GetConverter();

  /// @brief Method GetDefaultEvent, addr 0x1af3134, size 0xb0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptor* GetDefaultEvent();

  /// @brief Method GetDefaultProperty, addr 0x1af31e4, size 0xb0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::PropertyDescriptor* GetDefaultProperty();

  /// @brief Method GetEditor, addr 0x1af3294, size 0xb8, virtual true, abstract: false, final false
  inline ::System::Object* GetEditor(::System::Type* editorBaseType);

  /// @brief Method GetEvents, addr 0x1af334c, size 0xdc, virtual true, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptorCollection* GetEvents();

  /// @brief Method GetEvents, addr 0x1af3428, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetProperties, addr 0x1af350c, size 0xdc, virtual true, abstract: false, final false
  inline ::System::ComponentModel::PropertyDescriptorCollection* GetProperties();

  /// @brief Method GetProperties, addr 0x1af35e8, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertyOwner, addr 0x1af36cc, size 0xb8, virtual true, abstract: false, final false
  ...
  static inline ::System::ComponentModel::CustomTypeDescriptor* New_ctor(::System::ComponentModel::ICustomTypeDescriptor* parent);
  ...
  /// @brief Method .ctor, addr 0x1af2dec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1af2df4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::ICustomTypeDescriptor* parent);
