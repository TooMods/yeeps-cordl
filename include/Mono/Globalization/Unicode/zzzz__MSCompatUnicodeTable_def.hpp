...
public:
  ...
  /// @brief Method <BuildTailoringTables>b__17_0, addr 0x1d08454, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d0844c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildTailoringTables, addr 0x1d06708, size 0x750, virtual false, abstract: false, final false
  ...
  /// @brief Method Category, addr 0x1d07090, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Category(int32_t cp);

  /// @brief Method FillCJK, addr 0x1d07dbc, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method FillCJKCore, addr 0x1d07f20, size 0x4c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResource, addr 0x1d07828, size 0xb8, virtual false, abstract: false, final false
  static inline void* GetResource(::StringW name);

  /// @brief Method GetTailoringInfo, addr 0x1d06604, size 0x104, virtual false, abstract: false, final false
  static inline ::Mono::Globalization::Unicode::TailoringInfo* GetTailoringInfo(int32_t lcid);

  /// @brief Method HasSpecialWeight, addr 0x1d0763c, size 0x80, virtual false, abstract: false, final false
  static inline bool HasSpecialWeight(char16_t c);

  /// @brief Method IsHalfWidthKana, addr 0x1d076bc, size 0x14, virtual false, abstract: false, final false
  static inline bool IsHalfWidthKana(char16_t c);

  /// @brief Method IsHiragana, addr 0x1d076d0, size 0x18, virtual false, abstract: false, final false
  static inline bool IsHiragana(char16_t c);

  /// @brief Method IsIgnorable, addr 0x1d07320, size 0x118, virtual false, abstract: false, final false
  static inline bool IsIgnorable(int32_t cp, uint8_t flag);

  /// @brief Method IsIgnorableNonSpacing, addr 0x1d07438, size 0x58, virtual false, abstract: false, final false
  static inline bool IsIgnorableNonSpacing(int32_t cp);

  /// @brief Method IsJapaneseSmallLetter, addr 0x1d076e8, size 0xe8, virtual false, abstract: false, final false
  static inline bool IsJapaneseSmallLetter(char16_t c);

  /// @brief Method Level1, addr 0x1d07134, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Level1(int32_t cp);

  /// @brief Method Level2, addr 0x1d071d8, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Level2(int32_t cp);

  /// @brief Method Level3, addr 0x1d0727c, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Level3(int32_t cp);

  /// @brief Method SetCJKReferences, addr 0x1d06e58, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method ToKanaTypeInsensitive, addr 0x1d07490, size 0x20, virtual false, abstract: false, final false
  static inline int32_t ToKanaTypeInsensitive(int32_t i);

  /// @brief Method ToWidthCompat, addr 0x1d074b0, size 0x18c, virtual false, abstract: false, final false
  static inline int32_t ToWidthCompat(int32_t i);

  /// @brief Method UInt32FromBytePtr, addr 0x1d078e0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReady, addr 0x1d077d0, size 0x58, virtual false, abstract: false, final false
