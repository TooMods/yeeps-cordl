...
public:
  ...
  /// @brief Method Write, addr 0x25835c8, size 0x4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x25835cc, size 0x4, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x25835dc, size 0x4, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method WriteLine, addr 0x25835d0, size 0x4, virtual true, abstract: false, final false
  inline void WriteLine();

  /// @brief Method WriteLine, addr 0x25835d4, size 0x4, virtual true, abstract: false, final false
  inline void WriteLine(::StringW value);

  /// @brief Method WriteLine, addr 0x25835d8, size 0x4, virtual true, abstract: false, final false
  inline void WriteLine(::System::Object* value);

  /// @brief Method .ctor, addr 0x2583534, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Encoding, addr 0x25835c0, size 0x8, virtual true, abstract: false, final false
