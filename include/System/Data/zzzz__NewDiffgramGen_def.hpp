...
public:
  ...
  /// @brief Method CreateTableHierarchy, addr 0x1e8dc08, size 0x384, virtual false, abstract: false, final false
  inline void CreateTableHierarchy(::System::Data::DataTable* dt);

  /// @brief Method DoAssignments, addr 0x1e8d8b4, size 0x268, virtual false, abstract: false, final false
  inline void DoAssignments(::System::Collections::ArrayList* tables);

  /// @brief Method EmptyData, addr 0x1e8df8c, size 0xec, virtual false, abstract: false, final false
  inline bool EmptyData();

  /// @brief Method GenerateColumn, addr 0x1e8fc34, size 0xa14, virtual false, abstract: false, final false
  inline void GenerateColumn(::System::Data::DataRow* row, ::System::Data::DataColumn* col, ::System::Data::DataRowVersion version);

  /// @brief Method GenerateRow, addr 0x1e8f5c8, size 0x5a4, virtual false, abstract: false, final false
  inline void GenerateRow(::System::Data::DataRow* row);

  /// @brief Method GenerateTable, addr 0x1e8f00c, size 0x7c, virtual false, abstract: false, final false
  inline void GenerateTable(::System::Data::DataTable* table);

  /// @brief Method GenerateTableErrors, addr 0x1e8f088, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method QualifiedName, addr 0x1e8d734, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW QualifiedName(::StringW prefix, ::StringW name);

  /// @brief Method Save, addr 0x1e8e078, size 0x8, virtual false, abstract: false, final false
  inline void Save(::System::Xml::XmlWriter* xmlw);

  /// @brief Method Save, addr 0x1e8e080, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e8d79c, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* ds);

  /// @brief Method .ctor, addr 0x1e8db1c, size 0xec, virtual false, abstract: false, final false
