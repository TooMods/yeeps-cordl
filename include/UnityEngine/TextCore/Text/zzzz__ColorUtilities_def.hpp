...
public:
  // Declarations
  /// @brief Method CompareColors, addr 0x2473b9c, size 0x10, virtual false, abstract: false, final false
  static inline bool CompareColors(::UnityEngine::Color32 a, ::UnityEngine::Color32 b);

  /// @brief Method MultiplyColors, addr 0x2473bac, size 0xc0, virtual false, abstract: false, final false
