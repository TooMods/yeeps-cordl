...
public:
  ...
  /// @brief Method Add, addr 0x18f165c, size 0x50, virtual true, abstract: false, final true
  inline int32_t Add(::System::Object* value);

  /// @brief Method Clear, addr 0x18f16ac, size 0x50, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x18f16fc, size 0xac, virtual true, abstract: false, final true
  inline bool Contains(::System::Object* value);

  /// @brief Method CopyTo, addr 0x18f17a8, size 0xb8, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x18f1860, size 0xa0, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x18f1900, size 0xac, virtual true, abstract: false, final true
  inline int32_t IndexOf(::System::Object* value);

  /// @brief Method Insert, addr 0x18f19ac, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x18f19fc, size 0x50, virtual true, abstract: false, final true
  inline void Remove(::System::Object* value);

  /// @brief Method RemoveAt, addr 0x18f1a4c, size 0x1050, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18f11fc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* list);

  /// @brief Method get_Count, addr 0x18f1368, size 0xa4, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x18f1414, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x18f140c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x18f141c, size 0xa4, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x18f14c0, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x18f15b8, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x18f1568, size 0x50, virtual true, abstract: false, final true
