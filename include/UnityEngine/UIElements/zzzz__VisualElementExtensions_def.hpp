...
public:
  // Declarations
  /// @brief Method AddManipulator, addr 0x2a41460, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method LocalToWorld, addr 0x2a41288, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 LocalToWorld(::UnityEngine::UIElements::VisualElement* ele, ::UnityEngine::Vector2 p);

  /// @brief Method RemoveManipulator, addr 0x2a4150c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method WorldToLocal, addr 0x2a41374, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect WorldToLocal(::UnityEngine::UIElements::VisualElement* ele, ::UnityEngine::Rect r);

  /// @brief Method WorldToLocal, addr 0x2a4119c, size 0xec, virtual false, abstract: false, final false
