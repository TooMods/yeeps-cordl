...
public:
  // Declarations
  /// @brief Method IsInvalidFraction, addr 0x203f6f4, size 0x5c, virtual false, abstract: false, final false
  inline bool IsInvalidFraction();

  /// @brief Method .ctor, addr 0x2042da4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t number);

  /// @brief Method .ctor, addr 0x204616c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t number, int32_t leadingZeroes);

  /// @brief Method .ctor, addr 0x2046380, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::__TimeSpanParse__TTT type);

  /// @brief Method .ctor, addr 0x2046390, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BackOne, addr 0x2046180, size 0x14, virtual false, abstract: false, final false
  inline void BackOne();

  /// @brief Method GetNextToken, addr 0x203fc7c, size 0x240, virtual false, abstract: false, final false
  inline ::System::Globalization::__TimeSpanParse__TimeSpanToken GetNextToken();

  /// @brief Method .ctor, addr 0x203fc24, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> input);

  /// @brief Method .ctor, addr 0x2045f34, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> input, int32_t startPosition);

  /// @brief Method get_EOL, addr 0x2046120, size 0x4c, virtual false, abstract: false, final false
  inline bool get_EOL();

  /// @brief Method get_NextChar, addr 0x20460c0, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNum, addr 0x2046580, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSep, addr 0x2046474, size 0x10c, virtual false, abstract: false, final false
  inline bool AddSep(::System::ReadOnlySpan_1<char16_t> sep, ByRef<::System::Globalization::__TimeSpanParse__TimeSpanResult> result);

  /// @brief Method FullAppCompatMatch, addr 0x2043ab8, size 0x678, virtual false, abstract: false, final false
  inline bool FullAppCompatMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullDHMMatch, addr 0x204467c, size 0x54c, virtual false, abstract: false, final false
  inline bool FullDHMMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullDHMSMatch, addr 0x2043438, size 0x680, virtual false, abstract: false, final false
  inline bool FullDHMSMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullDMatch, addr 0x2045524, size 0x2e4, virtual false, abstract: false, final false
  inline bool FullDMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullHMMatch, addr 0x204510c, size 0x418, virtual false, abstract: false, final false
  inline bool FullHMMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullHMSFMatch, addr 0x2042db8, size 0x680, virtual false, abstract: false, final false
  inline bool FullHMSFMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullHMSMatch, addr 0x2044130, size 0x54c, virtual false, abstract: false, final false
  inline bool FullHMSMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method FullMatch, addr 0x204248c, size 0x7b4, virtual false, abstract: false, final false
  inline bool FullMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method Init, addr 0x203fc30, size 0x4c, virtual false, abstract: false, final false
  inline void Init(::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method PartialAppCompatMatch, addr 0x2044bc8, size 0x544, virtual false, abstract: false, final false
  inline bool PartialAppCompatMatch(::System::Globalization::__TimeSpanFormat__FormatLiterals pattern);

  /// @brief Method ProcessToken, addr 0x203febc, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NegativeInvariant, addr 0x2046408, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Globalization::__TimeSpanFormat__FormatLiterals get_NegativeInvariant();

  /// @brief Method get_NegativeLocalized, addr 0x2042cf0, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Globalization::__TimeSpanFormat__FormatLiterals get_NegativeLocalized();

  /// @brief Method get_PositiveInvariant, addr 0x20463a0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Globalization::__TimeSpanFormat__FormatLiterals get_PositiveInvariant();

  /// @brief Method get_PositiveLocalized, addr 0x2042c40, size 0xb0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method SetFailure, addr 0x203fadc, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x203f780, size 0x10, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method NextChar, addr 0x2046690, size 0x4c, virtual false, abstract: false, final false
  inline void NextChar();

  /// @brief Method NextNonDigit, addr 0x20466dc, size 0x5c, virtual false, abstract: false, final false
  inline char16_t NextNonDigit();

  /// @brief Method ParseInt, addr 0x2046928, size 0x118, virtual false, abstract: false, final false
  inline bool ParseInt(int32_t max, ByRef<int32_t> i, ByRef<::System::Globalization::__TimeSpanParse__TimeSpanResult> result);

  /// @brief Method ParseTime, addr 0x2046768, size 0x1c0, virtual false, abstract: false, final false
  inline bool ParseTime(ByRef<int64_t> time, ByRef<::System::Globalization::__TimeSpanParse__TimeSpanResult> result);

  /// @brief Method SkipBlanks, addr 0x2046738, size 0x30, virtual false, abstract: false, final false
  inline void SkipBlanks();

  /// @brief Method TryParse, addr 0x2046194, size 0x1ec, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Parse, addr 0x203f750, size 0x30, virtual false, abstract: false, final false
  static inline ::System::TimeSpan Parse(::System::ReadOnlySpan_1<char16_t> input, ::System::IFormatProvider* formatProvider);

  /// @brief Method ParseExactDigits, addr 0x2045f70, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExactDigits, addr 0x2045f40, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExactLiteral, addr 0x2046034, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Pow10, addr 0x203f15c, size 0x90, virtual false, abstract: false, final false
  static inline int64_t Pow10(int32_t pow);

  /// @brief Method ProcessTerminalState, addr 0x203ffcc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_D, addr 0x2040104, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_DHMSF, addr 0x2042220, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HM, addr 0x2040490, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HMS_F_D, addr 0x2041648, size 0xbd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HM_S_D, addr 0x20407e4, size 0xe64, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseByFormat, addr 0x204583c, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x203f928, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExactTimeSpan, addr 0x203f968, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseTimeSpan, addr 0x203f790, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseTimeSpanConstant, addr 0x2045808, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method TryTimeToTicks, addr 0x203f594, size 0x160, virtual false, abstract: false, final false
