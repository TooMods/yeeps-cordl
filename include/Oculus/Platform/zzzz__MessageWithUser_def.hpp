...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5930, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetDataFromMessage(void* c_message);

  /// @brief Method GetUser, addr 0x19b58f4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetUser();

  static inline ::Oculus::Platform::MessageWithUser* New_ctor(void* c_message);

  /// @brief Method .ctor, addr 0x19b15f4, size 0x58, virtual false, abstract: false, final false
