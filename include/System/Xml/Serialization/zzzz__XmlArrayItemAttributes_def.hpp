...
public:
  ...
  /// @brief Method Add, addr 0x129a870, size 0xb8, virtual false, abstract: false, final false
  inline int32_t Add(::System::Xml::Serialization::XmlArrayItemAttribute* attribute);

  /// @brief Method AddKeyHash, addr 0x129a928, size 0xcc, virtual false, abstract: false, final false
  inline void AddKeyHash(::System::Text::StringBuilder* sb);

  static inline ::System::Xml::Serialization::XmlArrayItemAttributes* New_ctor();

  /// @brief Method .ctor, addr 0x129a9f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x129a770, size 0x100, virtual false, abstract: false, final false
