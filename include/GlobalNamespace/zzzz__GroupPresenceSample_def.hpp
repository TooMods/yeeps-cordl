...
public:
  ...
  /// @brief Method ClearPresence, addr 0x198c384, size 0xb4, virtual false, abstract: false, final false
  inline void ClearPresence();

  /// @brief Method LaunchInvitePanel, addr 0x198c57c, size 0x10c, virtual false, abstract: false, final false
  inline void LaunchInvitePanel();

  /// @brief Method LaunchRosterPanel, addr 0x198c8f4, size 0xf0, virtual false, abstract: false, final false
  inline void LaunchRosterPanel();

  static inline ::GlobalNamespace::GroupPresenceSample* New_ctor();

  /// @brief Method OnGetDestinations, addr 0x198d5ec, size 0x360, virtual false, abstract: false, final false
  inline void OnGetDestinations(::Oculus::Platform::Message_1<::Oculus::Platform::Models::DestinationList*>* message);

  /// @brief Method OnInviteSentNotif, addr 0x198d210, size 0x3dc, virtual false, abstract: false, final false
  inline void OnInviteSentNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LaunchInvitePanelFlowResult*>* message);

  /// @brief Method OnJoinIntentChangeNotif, addr 0x198cc3c, size 0x35c, virtual false, abstract: false, final false
  inline void OnJoinIntentChangeNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceJoinIntent*>* message);

  /// @brief Method OnLeaveIntentChangeNotif, addr 0x198cfa8, size 0x268, virtual false, abstract: false, final false
  inline void OnLeaveIntentChangeNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceLeaveIntent*>* message);

  /// @brief Method OnLoggedInUser, addr 0x198dcbc, size 0xa8, virtual false, abstract: false, final false
  inline void OnLoggedInUser(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>* message);

  /// @brief Method PressAButton, addr 0x198dba0, size 0xc, virtual false, abstract: false, final false
  inline bool PressAButton();

  /// @brief Method PressBButton, addr 0x198dbac, size 0xc, virtual false, abstract: false, final false
  inline bool PressBButton();

  /// @brief Method PressDown, addr 0x198dcb0, size 0xc, virtual false, abstract: false, final false
  inline bool PressDown();

  /// @brief Method PressUp, addr 0x198dca4, size 0xc, virtual false, abstract: false, final false
  inline bool PressUp();

  /// @brief Method PressXButton, addr 0x198dbb8, size 0xc, virtual false, abstract: false, final false
  inline bool PressXButton();

  /// @brief Method PressYButton, addr 0x198dbc4, size 0xc, virtual false, abstract: false, final false
  inline bool PressYButton();

  /// @brief Method ScrollThroughDestinations, addr 0x198dbd0, size 0xd4, virtual false, abstract: false, final false
  inline void ScrollThroughDestinations();

  /// @brief Method SetPresence, addr 0x198bcc4, size 0x198, virtual false, abstract: false, final false
  inline void SetPresence();

  /// @brief Method Start, addr 0x198b860, size 0xf8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x198dab8, size 0xe8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateConsole, addr 0x198b958, size 0xac, virtual false, abstract: false, final false
  inline void UpdateConsole(::StringW value);

  /// @brief Method UpdateDestinationsConsole, addr 0x198d94c, size 0x16c, virtual false, abstract: false, final false
  inline void UpdateDestinationsConsole();

  /// @brief Method <ClearPresence>b__10_0, addr 0x198e8b0, size 0xe4, virtual false, abstract: false, final false
  inline void _ClearPresence_b__10_0(::Oculus::Platform::Message* message);

  /// @brief Method <ClearPresence>b__10_1, addr 0x198e994, size 0xb4, virtual false, abstract: false, final false
  inline void _ClearPresence_b__10_1(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>* message2);

  /// @brief Method <LaunchInvitePanel>b__11_0, addr 0x198ea48, size 0x48, virtual false, abstract: false, final false
  inline void _LaunchInvitePanel_b__11_0(::Oculus::Platform::Message_1<::Oculus::Platform::Models::InvitePanelResultInfo*>* message);

  /// @brief Method <LaunchRosterPanel>b__12_0, addr 0x198ea90, size 0x48, virtual false, abstract: false, final false
  inline void _LaunchRosterPanel_b__12_0(::Oculus::Platform::Message* message);

  /// @brief Method <SetPresence>b__9_0, addr 0x198e46c, size 0xe4, virtual false, abstract: false, final false
  inline void _SetPresence_b__9_0(::Oculus::Platform::Message* message);

  /// @brief Method <SetPresence>b__9_1, addr 0x198e6b0, size 0x200, virtual false, abstract: false, final false
  inline void _SetPresence_b__9_1(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>* message2);

  /// @brief Method <Start>b__8_0, addr 0x198dde8, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x198dd64, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
