...
public:
  // Declarations
  /// @brief Method AddMaterialReference, addr 0x23b4e30, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMaterialReference, addr 0x23b503c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b4db4, size 0x7c, virtual false, abstract: false, final false
