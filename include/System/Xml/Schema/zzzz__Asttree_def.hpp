...
public:
  ...
  /// @brief Method CompileXPath, addr 0x304a3c0, size 0x7c4, virtual false, abstract: false, final false
  inline void CompileXPath(::StringW xPath, bool isField, ::System::Xml::XmlNamespaceManager* nsmgr);

  /// @brief Method IsAttribute, addr 0x304953c, size 0x34, virtual false, abstract: false, final false
  static inline bool IsAttribute(::MS::Internal::Xml::XPath::Axis* ast);

  /// @brief Method IsDescendantOrSelf, addr 0x304abb8, size 0x40, virtual false, abstract: false, final false
  static inline bool IsDescendantOrSelf(::MS::Internal::Xml::XPath::Axis* ast);

  /// @brief Method IsNameTest, addr 0x304ab84, size 0x34, virtual false, abstract: false, final false
  static inline bool IsNameTest(::MS::Internal::Xml::XPath::Axis* ast);

  /// @brief Method IsSelf, addr 0x304a328, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetURN, addr 0x304abf8, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304a370, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::StringW xPath, bool isField, ::System::Xml::XmlNamespaceManager* nsmgr);

  /// @brief Method get_SubtreeArray, addr 0x304a368, size 0x8, virtual false, abstract: false, final false
