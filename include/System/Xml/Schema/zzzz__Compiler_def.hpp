...
public:
  ...
  /// @brief Method BuildParticleContentModel, addr 0x1cc693c, size 0x504, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateEffectiveTotalRange, addr 0x1cc5ca4, size 0x6e8, virtual false, abstract: false, final false
  ...
  /// @brief Method CannonicalizeAll, addr 0x1cc3104, size 0x284, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeAll(::System::Xml::Schema::XmlSchemaAll* all, bool root);

  /// @brief Method CannonicalizeChoice, addr 0x1cc3388, size 0x4f8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeChoice(::System::Xml::Schema::XmlSchemaChoice* choice, bool root);

  /// @brief Method CannonicalizeElement, addr 0x1cc3d34, size 0x200, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeElement(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method CannonicalizeGroupRef, addr 0x1cc2bec, size 0x518, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeGroupRef(::System::Xml::Schema::XmlSchemaGroupRef* groupRef, bool root);

  /// @brief Method CannonicalizeParticle, addr 0x1cbdb94, size 0x21c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeParticle(::System::Xml::Schema::XmlSchemaParticle* particle, bool root);

  /// @brief Method CannonicalizePointlessRoot, addr 0x1cc1f34, size 0x2d4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizePointlessRoot(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CannonicalizeSequence, addr 0x1cc3880, size 0x4b4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeSequence(::System::Xml::Schema::XmlSchemaSequence* sequence, bool root);

  /// @brief Method CheckAtrributeGroupRestriction, addr 0x1cbe010, size 0x998, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckParticleDerivation, addr 0x1cbccec, size 0x5e8, virtual false, abstract: false, final false
  inline void CheckParticleDerivation(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CheckParticleDerivation, addr 0x1cbdf38, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckUnionType, addr 0x1cbee24, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupAttribute, addr 0x1cb7fcc, size 0x28, virtual false, abstract: false, final false
  inline void CleanupAttribute(::System::Xml::Schema::XmlSchemaAttribute* attribute);

  /// @brief Method CleanupAttributeGroup, addr 0x1cb8030, size 0x54, virtual false, abstract: false, final false
  inline void CleanupAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup);

  /// @brief Method CleanupAttributes, addr 0x1cbd3fc, size 0xd8, virtual false, abstract: false, final false
  inline void CleanupAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method CleanupComplexType, addr 0x1cb8084, size 0x420, virtual false, abstract: false, final false
  inline void CleanupComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CleanupElement, addr 0x1cb7e48, size 0x184, virtual false, abstract: false, final false
  inline void CleanupElement(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method CleanupGroup, addr 0x1cb7ff4, size 0x3c, virtual false, abstract: false, final false
  inline void CleanupGroup(::System::Xml::Schema::XmlSchemaGroup* group);

  /// @brief Method CleanupParticle, addr 0x1cbd4d4, size 0x1a8, virtual false, abstract: false, final false
  inline void CleanupParticle(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CleanupSimpleType, addr 0x1cb84a4, size 0xb4, virtual false, abstract: false, final false
  inline void CleanupSimpleType(::System::Xml::Schema::XmlSchemaSimpleType* simpleType);

  /// @brief Method Compile, addr 0x1cb36c4, size 0x200c, virtual false, abstract: false, final false
  inline bool Compile();

  /// @brief Method CompileAnyAttributeIntersection, addr 0x1cc658c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileAnyAttributeUnion, addr 0x1cc6620, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileAttribute, addr 0x1cbb394, size 0x92c, virtual false, abstract: false, final false
  inline void CompileAttribute(::System::Xml::Schema::XmlSchemaAttribute* xa);

  /// @brief Method CompileAttributeGroup, addr 0x1cb8878, size 0x884, virtual false, abstract: false, final false
  inline void CompileAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup);

  /// @brief Method CompileBaseMemberTypes, addr 0x1cbea80, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileComplexContent, addr 0x1cc12f4, size 0xa40, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* CompileComplexContent(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CompileComplexContentExtension, addr 0x1cbf5a4, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileComplexContentRestriction, addr 0x1cbf918, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileComplexType, addr 0x1cb90fc, size 0xab8, virtual false, abstract: false, final false
  inline void CompileComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CompileComplexTypeElements, addr 0x1cbc360, size 0x11c, virtual false, abstract: false, final false
  inline void CompileComplexTypeElements(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CompileContentTypeParticle, addr 0x1cc111c, size 0x168, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CompileContentTypeParticle(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CompileElement, addr 0x1cba4b0, size 0xee4, virtual false, abstract: false, final false
  inline void CompileElement(::System::Xml::Schema::XmlSchemaElement* xe);

  /// @brief Method CompileGroup, addr 0x1cb87b0, size 0xc8, virtual false, abstract: false, final false
  inline void CompileGroup(::System::Xml::Schema::XmlSchemaGroup* group);

  /// @brief Method CompileIdentityConstraint, addr 0x1cbbcc0, size 0x6a0, virtual false, abstract: false, final false
  inline void CompileIdentityConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint* xi);

  /// @brief Method CompileLocalAttributes, addr 0x1cbfbc8, size 0x1554, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileParticleElements, addr 0x1cc6e40, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileParticleElements, addr 0x1cbddb0, size 0x188, virtual false, abstract: false, final false
  inline void CompileParticleElements(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CompileSimpleContentExtension, addr 0x1cbef3c, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileSimpleContentRestriction, addr 0x1cbf17c, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileSimpleType, addr 0x1cb9bb4, size 0x8fc, virtual false, abstract: false, final false
  inline void CompileSimpleType(::System::Xml::Schema::XmlSchemaSimpleType* simpleType);

  /// @brief Method CompileSubstitutionGroup, addr 0x1cbd67c, size 0x518, virtual false, abstract: false, final false
  inline void CompileSubstitutionGroup(::System::Xml::Schema::XmlSchemaSubstitutionGroup* substitutionGroup);

  /// @brief Method CopyPosition, addr 0x1cc3f34, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x1cb3648, size 0x7c, virtual false, abstract: false, final false
  inline bool Execute(::System::Xml::Schema::XmlSchemaSet* schemaSet, ::System::Xml::Schema::SchemaInfo* schemaCompiledInfo);

  /// @brief Method GetAnySchemaType, addr 0x1cc1d34, size 0x158, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* GetAnySchemaType(::System::Xml::XmlQualifiedName* name);

  /// @brief Method GetComplexType, addr 0x1cc1e8c, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaComplexType* GetComplexType(::System::Xml::XmlQualifiedName* name);

  /// @brief Method GetMappingParticle, addr 0x1cc6474, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSchemaContentType, addr 0x1cc1284, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSimpleType, addr 0x1cbe9a8, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* GetSimpleType(::System::Xml::XmlQualifiedName* name);

  /// @brief Method ImportAllCompiledSchemas, addr 0x1cb86a8, size 0x108, virtual false, abstract: false, final false
  inline void ImportAllCompiledSchemas(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method IsAnyFromAny, addr 0x1cc43c8, size 0xf8, virtual false, abstract: false, final false
  inline bool IsAnyFromAny(::System::Xml::Schema::XmlSchemaAny* derivedAny, ::System::Xml::Schema::XmlSchemaAny* baseAny);

  /// @brief Method IsChoiceFromChoiceSubstGroup, addr 0x1cc5648, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsElementFromAny, addr 0x1cc4240, size 0x188, virtual false, abstract: false, final false
  inline bool IsElementFromAny(::System::Xml::Schema::XmlSchemaElement* derivedElement, ::System::Xml::Schema::XmlSchemaAny* baseAny);

  /// @brief Method IsElementFromElement, addr 0x1cc4054, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsElementFromGroupBase, addr 0x1cc4890, size 0x7e4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFixedEqual, addr 0x1cc5b48, size 0x15c, virtual false, abstract: false, final false
  inline bool IsFixedEqual(::System::Xml::Schema::SchemaDeclBase* baseDecl, ::System::Xml::Schema::SchemaDeclBase* derivedDecl);

  /// @brief Method IsGroupBaseFromAny, addr 0x1cc44c0, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsGroupBaseFromGroupBase, addr 0x1cc5074, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsParticleEmptiable, addr 0x1cc3f90, size 0xc4, virtual false, abstract: false, final false
  inline bool IsParticleEmptiable(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method IsProcessContentsRestricted, addr 0x1cc66b4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSequenceFromAll, addr 0x1cc5348, size 0x300, virtual false, abstract: false, final false
  inline bool IsSequenceFromAll(::System::Xml::Schema::XmlSchemaSequence* derivedSequence, ::System::Xml::Schema::XmlSchemaAll* baseAll);

  /// @brief Method IsSequenceFromChoice, addr 0x1cc57d4, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidOccurrenceRangeRestriction, addr 0x1cc5b04, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidOccurrenceRangeRestriction, addr 0x1cc638c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidRestriction, addr 0x1cc2208, size 0x9e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Output, addr 0x1cb56d0, size 0x10d4, virtual false, abstract: false, final false
  inline void Output(::System::Xml::Schema::SchemaInfo* schemaInfo);

  /// @brief Method Prepare, addr 0x1cb67a4, size 0x16a4, virtual false, abstract: false, final false
  inline void Prepare(::System::Xml::Schema::XmlSchema* schema, bool cleanup);

  /// @brief Method ProcessSubstitutionGroups, addr 0x1cbc47c, size 0x870, virtual false, abstract: false, final false
  inline void ProcessSubstitutionGroups();

  /// @brief Method PushComplexType, addr 0x1cc6568, size 0x24, virtual false, abstract: false, final false
  inline void PushComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method RecursivelyCheckRedefinedAttributeGroups, addr 0x1cbd384, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RecursivelyCheckRedefinedGroups, addr 0x1cbd2d4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultFixed, addr 0x1cc6790, size 0x1ac, virtual false, abstract: false, final false
  inline void SetDefaultFixed(::System::Xml::Schema::XmlSchemaAttribute* xa, ::System::Xml::Schema::SchemaAttDef* decl);

  /// @brief Method UpdateSForSSimpleTypes, addr 0x1cb8558, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cb3468, size 0x1e0, virtual false, abstract: false, final false
