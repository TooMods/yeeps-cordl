...
public:
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x16f9f00, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method .ctor, addr 0x16f9efc, size 0x4, virtual false, abstract: false, final false
