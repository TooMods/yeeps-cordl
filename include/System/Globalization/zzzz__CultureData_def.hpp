...
public:
  ...
  /// @brief Method AbbrevEraNames, addr 0x227a848, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> AbbrevEraNames(int32_t calendarId);

  /// @brief Method AbbreviatedDayNames, addr 0x227a8f0, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> AbbreviatedDayNames(int32_t calendarId);

  /// @brief Method AbbreviatedEnglishEraNames, addr 0x227a864, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> AbbreviatedEnglishEraNames(int32_t calendarId);

  /// @brief Method AbbreviatedGenitiveMonthNames, addr 0x227a960, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> AbbreviatedGenitiveMonthNames(int32_t calendarId);

  /// @brief Method AbbreviatedMonthNames, addr 0x227a944, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> AbbreviatedMonthNames(int32_t calendarId);

  /// @brief Method DateSeparator, addr 0x227a9b4, size 0xac, virtual false, abstract: false, final false
  inline ::StringW DateSeparator(int32_t calendarId);

  /// @brief Method DayNames, addr 0x227a8d4, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> DayNames(int32_t calendarId);

  /// @brief Method EraNames, addr 0x227a82c, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> EraNames(int32_t calendarId);

  /// @brief Method GenitiveMonthNames, addr 0x227a928, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GenitiveMonthNames(int32_t calendarId);

  /// @brief Method GetCalendar, addr 0x227a3d0, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Globalization::CalendarData* GetCalendar(int32_t calendarId);

  /// @brief Method GetCalendarIds, addr 0x227a6fc, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Globalization::CalendarId, ::Array<::System::Globalization::CalendarId>*> GetCalendarIds();

  /// @brief Method GetCultureData, addr 0x227a1b4, size 0xec, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureData* GetCultureData(::StringW cultureName, bool useUserOverride);

  /// @brief Method GetCultureData, addr 0x227a2ac, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDateSeparator, addr 0x227aa60, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW GetDateSeparator(::StringW format);

  /// @brief Method GetNFIValues, addr 0x22749a8, size 0x198, virtual false, abstract: false, final false
  inline void GetNFIValues(::System::Globalization::NumberFormatInfo* nfi);

  /// @brief Method GetSeparator, addr 0x227aaa8, size 0x104, virtual false, abstract: false, final false
  static inline ::StringW GetSeparator(::StringW format, ::StringW timeParts);

  /// @brief Method IndexOfTimePart, addr 0x227abac, size 0xec, virtual false, abstract: false, final false
  static inline int32_t IndexOfTimePart(::StringW format, int32_t startIndex, ::StringW timeParts);

  /// @brief Method LeapYearMonthNames, addr 0x227a97c, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> LeapYearMonthNames(int32_t calendarId);

  /// @brief Method LongDates, addr 0x227a89c, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> LongDates(int32_t calendarId);

  /// @brief Method MonthDay, addr 0x227a998, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW MonthDay(int32_t calendarId);

  /// @brief Method MonthNames, addr 0x227a90c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReescapeWin32String, addr 0x227ae40, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW ReescapeWin32String(::StringW str);

  /// @brief Method ReescapeWin32Strings, addr 0x227ae3c, size 0x4, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> ReescapeWin32Strings(::ArrayW<::StringW, ::Array<::StringW>*> array);

  /// @brief Method ShortDates, addr 0x227a880, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> ShortDates(int32_t calendarId);

  /// @brief Method UnescapeNlsString, addr 0x227ac98, size 0x1a4, virtual false, abstract: false, final false
  static inline ::StringW UnescapeNlsString(::StringW str, int32_t start, int32_t end);

  /// @brief Method YearMonths, addr 0x227a8b8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227a18c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method create_group_sizes_array, addr 0x227aea0, size 0xb4, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> create_group_sizes_array(int32_t gs0, int32_t gs1);

  /// @brief Method fill_culture_data, addr 0x227a3cc, size 0x4, virtual false, abstract: false, final false
  inline void fill_culture_data(int32_t datetimeIndex);

  /// @brief Method fill_number_data, addr 0x227af54, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CalendarIds, addr 0x227a54c, size 0x1b0, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_CalendarIds();

  /// @brief Method get_CultureName, addr 0x227a7d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_IFIRSTDAYOFWEEK, addr 0x227a524, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_IFIRSTDAYOFWEEK();

  /// @brief Method get_IFIRSTWEEKOFYEAR, addr 0x227a52c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_IFIRSTWEEKOFYEAR();

  /// @brief Method get_Invariant, addr 0x2275e3c, size 0x3a4, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureData* get_Invariant();

  /// @brief Method get_IsInvariantCulture, addr 0x2274b40, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsInvariantCulture();

  /// @brief Method get_LongTimes, addr 0x227a4ec, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_LongTimes();

  /// @brief Method get_SAM1159, addr 0x227a534, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SAM1159();

  /// @brief Method get_SCOMPAREINFO, addr 0x227a7dc, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_SCOMPAREINFO();

  /// @brief Method get_SISO639LANGNAME, addr 0x227a51c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SISO639LANGNAME();

  /// @brief Method get_SPM2359, addr 0x227a53c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SPM2359();

  /// @brief Method get_STEXTINFO, addr 0x227a81c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_STEXTINFO();

  /// @brief Method get_ShortTimes, addr 0x227a504, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ShortTimes();

  /// @brief Method get_TimeSeparator, addr 0x227a544, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TimeSeparator();

  /// @brief Method get_UseUserOverride, addr 0x227a824, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseUserOverride();

  /// @brief Method idx2string, addr 0x227ae5c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method strlen, addr 0x227ae44, size 0x18, virtual false, abstract: false, final false
