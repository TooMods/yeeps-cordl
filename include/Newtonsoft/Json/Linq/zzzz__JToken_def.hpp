...
namespace Newtonsoft::Json::Linq {
template <typename T> class __JToken___Annotations_d__184_1;
}
namespace Newtonsoft::Json::Linq {
class __JToken___Annotations_d__185;
}
namespace Newtonsoft::Json::Linq {
...
MARK_GEN_REF_PTR_T(::Newtonsoft::Json::Linq::__JToken___Annotations_d__184_1);
MARK_REF_PTR_T(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185);
...
public:
  ...
  /// @brief Method .ctor, addr 0x134f1dc, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  template <typename T> using _Annotations_d__184_1 = ::Newtonsoft::Json::Linq::__JToken___Annotations_d__184_1<T>;

  using _Annotations_d__185 = ::Newtonsoft::Json::Linq::__JToken___Annotations_d__185;
  ...
  /// @brief Method AddAfterSelf, addr 0x1346c50, size 0xa0, virtual false, abstract: false, final false
  inline void AddAfterSelf(::System::Object* content);

  /// @brief Method AddAnnotation, addr 0x134f208, size 0x21c, virtual false, abstract: false, final false
  inline void AddAnnotation(::System::Object* annotation);

  /// @brief Method AddBeforeSelf, addr 0x1346cf0, size 0xa0, virtual false, abstract: false, final false
  inline void AddBeforeSelf(::System::Object* content);

  /// @brief Method AfterSelf, addr 0x1346e60, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* AfterSelf();

  /// @brief Method Ancestors, addr 0x1346d90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* Ancestors();

  /// @brief Method AncestorsAndSelf, addr 0x1346e24, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* AncestorsAndSelf();

  /// @brief Method Annotation, addr 0x134fb44, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Annotations, addr 0x134fcbc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method BeforeSelf, addr 0x1346f0c, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* BeforeSelf();

  /// @brief Method Children, addr 0x1347218, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method CopyAnnotations, addr 0x1339bac, size 0x90, virtual false, abstract: false, final false
  inline void CopyAnnotations(::Newtonsoft::Json::Linq::JToken* target, ::Newtonsoft::Json::Linq::JToken* source);

  /// @brief Method CreateReader, addr 0x134dc2c, size 0x60, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::JsonReader* CreateReader();

  /// @brief Method DeepClone, addr 0x134fb34, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method DeepEquals, addr 0x13468b8, size 0x30, virtual false, abstract: false, final false
  static inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken* t1, ::Newtonsoft::Json::Linq::JToken* t2);

  /// @brief Method EnsureValue, addr 0x1347548, size 0x118, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JValue* EnsureValue(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method FromObject, addr 0x134dcf8, size 0x68, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* FromObject(::System::Object* o);

  /// @brief Method FromObject, addr 0x134dd60, size 0x64, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* FromObject(::System::Object* o, ::Newtonsoft::Json::JsonSerializer* jsonSerializer);

  /// @brief Method FromObjectInternal, addr 0x1340a78, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAncestors, addr 0x1346d98, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMetaObject, addr 0x134fa48, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* GetMetaObject(::System::Linq::Expressions::Expression* parameter);

  /// @brief Method GetType, addr 0x1347660, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW GetType(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method Load, addr 0x134f10c, size 0x58, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* Load(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method Load, addr 0x134f0a8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x13467cc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x1346834, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Newtonsoft.Json.IJsonLineInfo.HasLineInfo, addr 0x134f424, size 0x54, virtual true, abstract: false, final true
  inline bool Newtonsoft_Json_IJsonLineInfo_HasLineInfo();

  /// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LineNumber, addr 0x134f478, size 0x54, virtual true, abstract: false, final true
  inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LineNumber();

  /// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LinePosition, addr 0x134f4cc, size 0x54, virtual true, abstract: false, final true
  inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LinePosition();

  /// @brief Method Newtonsoft.Json.Linq.IJEnumerable<Newtonsoft.Json.Linq.JToken>.get_Item, addr 0x134dc1c, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method Parse, addr 0x134ee40, size 0x58, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* Parse(::StringW json);

  /// @brief Method Parse, addr 0x134ee98, size 0x210, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* Parse(::StringW json, ::Newtonsoft::Json::Linq::JsonLoadSettings* settings);

  /// @brief Method ReadFrom, addr 0x134eae8, size 0x58, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* ReadFrom(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ReadFrom, addr 0x134eb40, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFromAsync, addr 0x1346654, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFromAsync, addr 0x13466bc, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x134106c, size 0x70, virtual false, abstract: false, final false
  inline void Remove();
  ...
  /// @brief Method RemoveAnnotations, addr 0x134fd74, size 0x1e8, virtual false, abstract: false, final false
  inline void RemoveAnnotations(::System::Type* type);

  /// @brief Method Replace, addr 0x133cafc, size 0x78, virtual false, abstract: false, final false
  inline void Replace(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method SelectToken, addr 0x134f520, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* SelectToken(::StringW path);

  /// @brief Method SelectToken, addr 0x134f8a4, size 0x8c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* SelectToken(::StringW path, bool errorWhenNoMatch);

  /// @brief Method SelectToken, addr 0x134f528, size 0x37c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* SelectToken(::StringW path, ::Newtonsoft::Json::Linq::JsonSelectSettings* settings);

  /// @brief Method SelectTokens, addr 0x134f930, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* SelectTokens(::StringW path);

  /// @brief Method SelectTokens, addr 0x134f9bc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectTokens, addr 0x134f938, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLineInfo, addr 0x1338674, size 0x1a0, virtual false, abstract: false, final false
  inline void SetLineInfo(::Newtonsoft::Json::IJsonLineInfo* lineInfo, ::Newtonsoft::Json::Linq::JsonLoadSettings* settings);

  /// @brief Method SetLineInfo, addr 0x134f164, size 0x78, virtual false, abstract: false, final false
  inline void SetLineInfo(int32_t lineNumber, int32_t linePosition);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x134dbac, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x134db18, size 0x94, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Dynamic.IDynamicMetaObjectProvider.GetMetaObject, addr 0x134fb14, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x134fb24, size 0x10, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToBigInteger, addr 0x134c64c, size 0x154, virtual false, abstract: false, final false
  static inline ::System::Numerics::BigInteger ToBigInteger(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method ToBigIntegerNullable, addr 0x134c7a0, size 0x1b4, virtual false, abstract: false, final false
  static inline ::System::Nullable_1<::System::Numerics::BigInteger> ToBigIntegerNullable(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method ToObject, addr 0x134ddc4, size 0xb48, virtual false, abstract: false, final false
  inline ::System::Object* ToObject(::System::Type* objectType);

  /// @brief Method ToObject, addr 0x134e90c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1347270, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x13472f8, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateToken, addr 0x1347754, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x1346600, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x1346640, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133981c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_EqualityComparer, addr 0x133d2c8, size 0xc4, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JTokenEqualityComparer* get_EqualityComparer();

  /// @brief Method get_First, addr 0x13470e8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x1346fb8, size 0x98, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(::System::Object* key);

  /// @brief Method get_Last, addr 0x1347180, size 0x98, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Last();

  /// @brief Method get_Next, addr 0x13468e8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Next();

  /// @brief Method get_Parent, addr 0x13468a8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JContainer* get_Parent();

  /// @brief Method get_Path, addr 0x1346908, size 0x348, virtual false, abstract: false, final false
  inline ::StringW get_Path();

  /// @brief Method get_Previous, addr 0x13468f8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Previous();

  /// @brief Method get_Root, addr 0x133a490, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x134b92c, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x134b2fc, size 0x258, virtual false, abstract: false, final false
  static inline ::StringW op_Explicit___StringW(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method op_Explicit, addr 0x134a2a8, size 0x1e4, virtual false, abstract: false, final false
  static inline ::System::DateTime op_Explicit___System__DateTime(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method op_Explicit, addr 0x1347a30, size 0x254, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset op_Explicit___System__DateTimeOffset(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method op_Explicit, addr 0x134a8e0, size 0x1ec, virtual false, abstract: false, final false
  static inline ::System::Decimal op_Explicit___System__Decimal(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method op_Explicit, addr 0x134bb68, size 0x228, virtual false, abstract: false, final false
  static inline ::System::Guid op_Explicit___System__Guid(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method op_Explicit, addr 0x13482dc, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x13480c0, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x13485a8, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x134bd90, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x134c200, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x134d6fc, size 0x64, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* op_Implicit___Newtonsoft__Json__Linq__JToken_(::StringW value);

  /// @brief Method op_Implicit, addr 0x134d1a4, size 0x64, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* op_Implicit___Newtonsoft__Json__Linq__JToken_(::System::DateTime value);

  /// @brief Method op_Implicit, addr 0x134c9b8, size 0x74, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* op_Implicit___Newtonsoft__Json__Linq__JToken_(::System::DateTimeOffset value);

  /// @brief Method op_Implicit, addr 0x134d344, size 0x74, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* op_Implicit___Newtonsoft__Json__Linq__JToken_(::System::Decimal value);

  /// @brief Method op_Implicit, addr 0x134d9f8, size 0x74, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JToken* op_Implicit___Newtonsoft__Json__Linq__JToken_(::System::Guid value);

  /// @brief Method op_Implicit, addr 0x134cd20, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x134cdc4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x134ce70, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x134da6c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x134d954, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x1347050, size 0x98, virtual true, abstract: false, final false
  inline void set_Item(::System::Object* key, ::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method set_Next, addr 0x13468f0, size 0x8, virtual false, abstract: false, final false
  inline void set_Next(::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method set_Parent, addr 0x13468b0, size 0x8, virtual false, abstract: false, final false
  inline void set_Parent(::Newtonsoft::Json::Linq::JContainer* value);

  /// @brief Method set_Previous, addr 0x1346900, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1350210, size 0x94c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1350b5c, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1350bb8, size 0x74, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::__JToken___GetAncestors_d__48* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x1350c7c, size 0xac, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* System_Collections_Generic_IEnumerable_Newtonsoft_Json_Linq_JToken__GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x1350c2c, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1350d28, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1350c34, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1350c74, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1350bb4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1346e2c, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1350d30, size 0x80, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::__JToken___AfterSelf_d__49* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x1350e00, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* System_Collections_Generic_IEnumerable_Newtonsoft_Json_Linq_JToken__GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x1350db0, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1350ea4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1350db8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1350df8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1350d2c, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x1346ed8, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1350eac, size 0x9c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::__JToken___BeforeSelf_d__50* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x1350f98, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* System_Collections_Generic_IEnumerable_Newtonsoft_Json_Linq_JToken__GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x1350f48, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x135103c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1350f50, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1350f90, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1350ea8, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x1346f84, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
template <typename T>
// Is value type: false
// CS Name: ::JToken::<Annotations>d__184`1<T>*
class CORDL_TYPE __JToken___Annotations_d__184_1 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Newtonsoft::Json::Linq::__JToken___Annotations_d__184_1<T>* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __JToken___Annotations_d__184_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__JToken___Annotations_d__184_1", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __JToken___Annotations_d__184_1(__JToken___Annotations_d__184_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__JToken___Annotations_d__184_1", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __JToken___Annotations_d__184_1(__JToken___Annotations_d__184_1 const&) = delete;
...
// Type: ::<Annotations>d__185
// SizeInfo { instance_size: 80, native_size: -1, calculated_instance_size: 80, calculated_native_size: 76, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Newtonsoft::Json::Linq {
// Is value type: false
// CS Name: ::JToken::<Annotations>d__185*
class CORDL_TYPE __JToken___Annotations_d__185 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x1351044, size 0x1f8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::__JToken___Annotations_d__185* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Object>.GetEnumerator, addr 0x135128c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x135123c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1351338, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1351244, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1351284, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1351040, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x134fd40, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __JToken___Annotations_d__185();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__JToken___Annotations_d__185", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __JToken___Annotations_d__185(__JToken___Annotations_d__185&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__JToken___Annotations_d__185", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __JToken___Annotations_d__185(__JToken___Annotations_d__185 const&) = delete;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, 0x50>, "Size mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, _____l__initialThreadId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, ___type) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, _____3__type) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, _____4__this) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, ____annotations_5__2) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185, ____i_5__3) == 0x48, "Offset mismatch!");
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Newtonsoft::Json::Linq::__JToken___Annotations_d__184_1, "Newtonsoft.Json.Linq", "JToken/<Annotations>d__184`1");
NEED_NO_BOX(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Linq::__JToken___Annotations_d__185*, "Newtonsoft.Json.Linq", "JToken/<Annotations>d__185");
