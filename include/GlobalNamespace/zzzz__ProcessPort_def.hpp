...
public:
  ...
  /// @brief Method GetProcessesByPort, addr 0x14e93e0, size 0xbdc, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::GlobalNamespace::ProcessPort*>* GetProcessesByPort(::StringW targetPort);

  /// @brief Method LookupProcess, addr 0x14e9314, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW LookupProcess(int32_t pid);

  static inline ::GlobalNamespace::ProcessPort* New_ctor();

  /// @brief Method ToString, addr 0x14e916c, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14e9fbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_portNumber, addr 0x14e92f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_portNumber();

  /// @brief Method get_processId, addr 0x14e92e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_processId();

  /// @brief Method get_processName, addr 0x14e92d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processName();

  /// @brief Method get_protocol, addr 0x14e9304, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_protocol();

  /// @brief Method set_portNumber, addr 0x14e92fc, size 0x8, virtual false, abstract: false, final false
  inline void set_portNumber(::StringW value);

  /// @brief Method set_processId, addr 0x14e92ec, size 0x8, virtual false, abstract: false, final false
  inline void set_processId(int32_t value);

  /// @brief Method set_processName, addr 0x14e92dc, size 0x8, virtual false, abstract: false, final false
  inline void set_processName(::StringW value);

  /// @brief Method set_protocol, addr 0x14e930c, size 0x8, virtual false, abstract: false, final false
