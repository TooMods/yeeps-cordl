...
public:
  ...
  /// @brief Method Compute, addr 0x246c7ec, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Compute_LM, addr 0x246b7f0, size 0x334, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_LM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM, addr 0x246c090, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM_Password, addr 0x246bf8c, size 0x104, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM_Password(::StringW password);

  /// @brief Method Compute_NTLMv2, addr 0x246c2c8, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method Compute_NTLMv2_Session, addr 0x246c0fc, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResponse, addr 0x246bc8c, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method PasswordToKey, addr 0x246bb24, size 0x168, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PasswordToKey(::StringW password, int32_t position);

  /// @brief Method PrepareDESKey, addr 0x246c9d4, size 0x1f8, virtual false, abstract: false, final false
