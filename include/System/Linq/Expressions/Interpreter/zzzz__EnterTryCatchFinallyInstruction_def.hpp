...
public:
  ...
  /// @brief Method CreateTryCatch, addr 0x1843ed8, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Linq::Expressions::Interpreter::EnterTryCatchFinallyInstruction* CreateTryCatch();

  /// @brief Method CreateTryFinally, addr 0x1843e6c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x1843f40, size 0x4a4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method SetTryHandler, addr 0x1843e24, size 0x8, virtual false, abstract: false, final false
  inline void SetTryHandler(::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* tryHandler);

  /// @brief Method ToString, addr 0x1844450, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1843e3c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t targetIndex, bool hasFinally);

  /// @brief Method get_Handler, addr 0x1843e2c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* get_Handler();

  /// @brief Method get_InstructionName, addr 0x18443e4, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedContinuations, addr 0x1843e34, size 0x8, virtual true, abstract: false, final false
