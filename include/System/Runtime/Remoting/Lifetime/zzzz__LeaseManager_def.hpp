...
public:
  ...
  /// @brief Method ManageLeases, addr 0x1850c14, size 0x264, virtual false, abstract: false, final false
  inline void ManageLeases(::System::Object* state);

  static inline ::System::Runtime::Remoting::Lifetime::LeaseManager* New_ctor();

  /// @brief Method SetPollTime, addr 0x185086c, size 0xf8, virtual false, abstract: false, final false
  inline void SetPollTime(::System::TimeSpan timeSpan);

  /// @brief Method StartManager, addr 0x1850a98, size 0x160, virtual false, abstract: false, final false
  inline void StartManager();

  /// @brief Method StopManager, addr 0x1850bf8, size 0x1c, virtual false, abstract: false, final false
  inline void StopManager();

  /// @brief Method TrackLifetime, addr 0x1850964, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1850e78, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
