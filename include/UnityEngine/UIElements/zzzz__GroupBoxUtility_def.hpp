...
public:
  ...
  /// @brief Method FindOrCreateGroupManager, addr 0x27d40d8, size 0x3e0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox* groupBox);

  /// @brief Method OnGroupBoxDetachedFromPanel, addr 0x27d466c, size 0xb4, virtual false, abstract: false, final false
  static inline void OnGroupBoxDetachedFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnOptionAttachToPanel, addr 0x27d3e8c, size 0x24c, virtual false, abstract: false, final false
  static inline void OnOptionAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnOptionDetachFromPanel, addr 0x27d44b8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelDestroyed, addr 0x27d4720, size 0xdc, virtual false, abstract: false, final false
