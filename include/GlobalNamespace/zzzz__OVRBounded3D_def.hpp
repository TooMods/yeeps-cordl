...
public:
  ...
  /// @brief Method ConvertBounds, addr 0x25b536c, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds ConvertBounds(::GlobalNamespace::__OVRPlugin__Boundsf openXrBounds);

  /// @brief Method Equals, addr 0x25b5120, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x25b50f8, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRBounded3D other);

  /// @brief Method GetHashCode, addr 0x25b5198, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.FromAnchor, addr 0x25b4fdc, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRBounded3D IOVRAnchorComponent_OVRBounded3D__FromAnchor(::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.SetEnabledAsync, addr 0x25b50a8, size 0x50, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded3D__SetEnabledAsync(bool enabled, double_t timeout);

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Handle, addr 0x25b4fd4, size 0x8, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRBounded3D__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Type, addr 0x25b4fc4, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRBounded3D__get_Type();

  /// @brief Method ToString, addr 0x25b51e4, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x25b4fe4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  static inline ::GlobalNamespace::OVRBounded3D getStaticF_Null();

  /// @brief Method get_BoundingBox, addr 0x25b5270, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_BoundingBox();

  /// @brief Method get_Handle, addr 0x25b5268, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x25b5000, size 0xa8, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x25b4ff0, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Type, addr 0x25b4fcc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x25b5108, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRBounded3D lhs, ::GlobalNamespace::OVRBounded3D rhs);

  /// @brief Method op_Inequality, addr 0x25b5114, size 0xc, virtual false, abstract: false, final false
