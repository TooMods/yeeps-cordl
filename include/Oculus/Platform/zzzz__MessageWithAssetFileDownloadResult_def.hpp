...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadResult, addr 0x19b2e4c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult();

  /// @brief Method GetDataFromMessage, addr 0x19b2e88, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b093c, size 0x58, virtual false, abstract: false, final false
