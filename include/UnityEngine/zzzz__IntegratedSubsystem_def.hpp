...
public:
  ...
  /// @brief Method Destroy, addr 0x27c794c, size 0xb0, virtual true, abstract: false, final true
  inline void Destroy();

  /// @brief Method IsRunning, addr 0x27c7c64, size 0x3c, virtual false, abstract: false, final false
  inline bool IsRunning();

  static inline ::UnityEngine::IntegratedSubsystem* New_ctor();

  /// @brief Method SetHandle, addr 0x27c7890, size 0x44, virtual false, abstract: false, final false
  inline void SetHandle(::UnityEngine::IntegratedSubsystem* subsystem);

  /// @brief Method Start, addr 0x27c78d4, size 0x3c, virtual true, abstract: false, final true
  inline void Start();

  /// @brief Method Stop, addr 0x27c7910, size 0x3c, virtual true, abstract: false, final true
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x27c7ca0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_running, addr 0x27c7bbc, size 0x54, virtual true, abstract: false, final true
  inline bool get_running();

  /// @brief Method get_valid, addr 0x27c7c10, size 0x54, virtual false, abstract: false, final false
