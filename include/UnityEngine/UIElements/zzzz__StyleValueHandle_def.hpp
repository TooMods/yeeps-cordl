...
public:
  ...
  /// @brief Method get_valueType, addr 0x3029fbc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueType get_valueType();

  /// @brief Method set_valueType, addr 0x302ab84, size 0x8, virtual false, abstract: false, final false
