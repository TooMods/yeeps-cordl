...
public:
  ...
  /// @brief Method SetHashAlgorithm, addr 0x1d1de20, size 0xcc, virtual true, abstract: false, final false
  inline void SetHashAlgorithm(::StringW strName);

  /// @brief Method SetKey, addr 0x1d1dd34, size 0xec, virtual true, abstract: false, final false
  inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm* key);

  /// @brief Method VerifySignature, addr 0x1d1deec, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d1dbc0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1d1dc40, size 0xf4, virtual false, abstract: false, final false
