...
public:
  ...
  /// @brief Method .ctor, addr 0x1868ddc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW entryName, ::System::Object* entryValue, ::System::Type* entryType);

  /// @brief Method get_Name, addr 0x1868df0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x1868de8, size 0x8, virtual false, abstract: false, final false
