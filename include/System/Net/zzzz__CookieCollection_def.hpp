...
public:
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0xf623ec, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0xf62490, size 0xc, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0xf62340, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf622e4, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0xf61504, size 0xc4, virtual false, abstract: false, final false
  inline void Add(::System::Net::Cookie* cookie);

  /// @brief Method Add, addr 0xf6198c, size 0x300, virtual false, abstract: false, final false
  inline void Add(::System::Net::CookieCollection* cookies);

  /// @brief Method CopyTo, addr 0xf61d1c, size 0x24, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0xf61c8c, size 0x60, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0xf615c8, size 0x3c4, virtual false, abstract: false, final false
  inline int32_t IndexOf(::System::Net::Cookie* cookie);

  /// @brief Method InternalAdd, addr 0xf61e08, size 0x4b8, virtual false, abstract: false, final false
  inline int32_t InternalAdd(::System::Net::Cookie* cookie, bool isStrict);

  static inline ::System::Net::CookieCollection* New_ctor();

  /// @brief Method RemoveAt, addr 0xf622c0, size 0x24, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t idx);

  /// @brief Method TimeStamp, addr 0xf61d40, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf61370, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0xf61cec, size 0x24, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsOtherVersionSeen, addr 0xf61e00, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsOtherVersionSeen();

  /// @brief Method get_IsSynchronized, addr 0xf61d10, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0xf61418, size 0xec, virtual false, abstract: false, final false
  inline ::System::Net::Cookie* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0xf61d18, size 0x4, virtual true, abstract: false, final true
