...
public:
  ...
  /// @brief Method Convert, addr 0xee43b8, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0xee46b0, size 0x19e1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0xee4034, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0xee41a0, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xee3f50, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0xee3f40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0xee3f48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0xee0944, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0xee0934, size 0x10, virtual false, abstract: false, final false
