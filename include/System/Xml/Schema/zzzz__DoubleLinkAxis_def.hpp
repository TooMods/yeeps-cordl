...
public:
  ...
  /// @brief Method ConvertTree, addr 0x304a120, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304a0c8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::Axis* axis, ::System::Xml::Schema::DoubleLinkAxis* inputaxis);

  /// @brief Method get_Next, addr 0x304a0b8, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::Axis* get_Next();

  /// @brief Method set_Next, addr 0x304a0c0, size 0x8, virtual false, abstract: false, final false
