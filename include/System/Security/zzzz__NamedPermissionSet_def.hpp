...
public:
  ...
  /// @brief Method Equals, addr 0x1ea3974, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1ea3ba0, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXml, addr 0x1ea3480, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea3240, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ea3470, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x1ea3300, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Security::Permissions::PermissionState state);

  /// @brief Method get_Name, addr 0x1ea3478, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x1ea33b0, size 0xc0, virtual false, abstract: false, final false
