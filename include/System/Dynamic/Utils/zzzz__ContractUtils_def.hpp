...
public:
  // Declarations
  /// @brief Method GetParamName, addr 0x1def488, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW GetParamName(::StringW paramName, int32_t index);

  /// @brief Method Requires, addr 0x1deee18, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresNotNull, addr 0x1decb48, size 0x54, virtual false, abstract: false, final false
  static inline void RequiresNotNull(::System::Object* value, ::StringW paramName);

  /// @brief Method RequiresNotNull, addr 0x1def428, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Unreachable, addr 0x1def3b4, size 0x74, virtual false, abstract: false, final false
