...
public:
  ...
  /// @brief Method CatchBlockToString, addr 0x182ddf0, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW CatchBlockToString(::System::Linq::Expressions::CatchBlock* node);

  /// @brief Method DumpLabel, addr 0x1836cb4, size 0xc0, virtual false, abstract: false, final false
  inline void DumpLabel(::System::Linq::Expressions::LabelTarget* target);

  /// @brief Method ExpressionToString, addr 0x1835360, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW ExpressionToString(::System::Linq::Expressions::Expression* node);

  /// @brief Method GetId, addr 0x1835214, size 0x110, virtual false, abstract: false, final false
  inline int32_t GetId(::System::Object* o);

  /// @brief Method GetLabelId, addr 0x1835210, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetLabelId(::System::Linq::Expressions::LabelTarget* label);

  /// @brief Method GetParamId, addr 0x1835324, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetParamId(::System::Linq::Expressions::ParameterExpression* p);

  /// @brief Method IsBool, addr 0x18358d8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Out, addr 0x1835344, size 0x1c, virtual false, abstract: false, final false
  inline void Out(char16_t c);

  /// @brief Method Out, addr 0x1835328, size 0x1c, virtual false, abstract: false, final false
  inline void Out(::StringW s);

  /// @brief Method OutMember, addr 0x1835d7c, size 0xb0, virtual false, abstract: false, final false
  inline void OutMember(::System::Linq::Expressions::Expression* instance, ::System::Reflection::MemberInfo* member);

  /// @brief Method ToString, addr 0x18351f0, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method VisitBinary, addr 0x18353d8, size 0x500, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitBinary(::System::Linq::Expressions::BinaryExpression* node);

  /// @brief Method VisitBlock, addr 0x1836840, size 0x340, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitBlock(::System::Linq::Expressions::BlockExpression* node);

  /// @brief Method VisitCatchBlock, addr 0x1836f34, size 0x108, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::CatchBlock* VisitCatchBlock(::System::Linq::Expressions::CatchBlock* node);

  /// @brief Method VisitConditional, addr 0x1835b04, size 0x100, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitConditional(::System::Linq::Expressions::ConditionalExpression* node);

  /// @brief Method VisitConstant, addr 0x1835c04, size 0x178, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitConstant(::System::Linq::Expressions::ConstantExpression* node);

  /// @brief Method VisitDefault, addr 0x1836b80, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitExtension, addr 0x183736c, size 0x1fc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitExtension(::System::Linq::Expressions::Expression* node);

  /// @brief Method VisitGoto, addr 0x1836d74, size 0x160, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitGoto(::System::Linq::Expressions::GotoExpression* node);

  /// @brief Method VisitIndex, addr 0x183709c, size 0x188, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitIndex(::System::Linq::Expressions::IndexExpression* node);

  /// @brief Method VisitInvocation, addr 0x1835e84, size 0x128, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitInvocation(::System::Linq::Expressions::InvocationExpression* node);

  /// @brief Method VisitLabel, addr 0x1836c30, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitLoop, addr 0x1836ed4, size 0x60, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitLoop(::System::Linq::Expressions::LoopExpression* node);

  /// @brief Method VisitMember, addr 0x1835e2c, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMember(::System::Linq::Expressions::MemberExpression* node);

  /// @brief Method VisitMethodCall, addr 0x1835fac, size 0x1fc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMethodCall(::System::Linq::Expressions::MethodCallExpression* node);

  /// @brief Method VisitNewArray, addr 0x18361b4, size 0x124, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitNewArray(::System::Linq::Expressions::NewArrayExpression* node);

  /// @brief Method VisitParameter, addr 0x18359f4, size 0x104, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitParameter(::System::Linq::Expressions::ParameterExpression* node);

  /// @brief Method VisitTry, addr 0x183703c, size 0x60, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTry(::System::Linq::Expressions::TryExpression* node);

  /// @brief Method VisitTypeBinary, addr 0x18362d8, size 0x10c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTypeBinary(::System::Linq::Expressions::TypeBinaryExpression* node);

  /// @brief Method VisitUnary, addr 0x18363e4, size 0x45c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183517c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
