...
public:
  ...
  /// @brief Method MoveNext, addr 0x260dc58, size 0x5c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Resources::__ResourceReader__ResourceEnumerator* New_ctor(::System::Resources::ResourceReader* reader);

  /// @brief Method Reset, addr 0x260e1cc, size 0x8c, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x260a640, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Resources::ResourceReader* reader);

  /// @brief Method get_Current, addr 0x260dd6c, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* get_Current();

  /// @brief Method get_DataPosition, addr 0x260e114, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DataPosition();

  /// @brief Method get_Entry, addr 0x260ddd0, size 0x344, virtual true, abstract: false, final true
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x260dcb4, size 0xb8, virtual true, abstract: false, final true
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x260e11c, size 0xb0, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AllocateStringForNameIndex, addr 0x260acd0, size 0x8ec, virtual false, abstract: false, final false
  inline ::StringW AllocateStringForNameIndex(int32_t index, ByRef<int32_t> dataOffset);

  /// @brief Method Close, addr 0x260a290, size 0x3c, virtual true, abstract: false, final true
  inline void Close();

  /// @brief Method CompareStringEqualsName, addr 0x260aabc, size 0x214, virtual false, abstract: false, final false
  inline bool CompareStringEqualsName(::StringW name);

  /// @brief Method DeserializeObject, addr 0x260c9d4, size 0x1d8, virtual false, abstract: false, final false
  inline ::System::Object* DeserializeObject(int32_t typeIndex);

  /// @brief Method Dispose, addr 0x260a30c, size 0x3c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x260a2cc, size 0x40, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FindPosForResource, addr 0x260a6e4, size 0x3d8, virtual false, abstract: false, final false
  inline int32_t FindPosForResource(::StringW name);

  /// @brief Method FindType, addr 0x260bd14, size 0x3c4, virtual false, abstract: false, final false
  inline ::System::RuntimeType* FindType(int32_t typeIndex);

  /// @brief Method GetEnumerator, addr 0x260a570, size 0xd0, virtual true, abstract: false, final true
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorInternal, addr 0x260a674, size 0x70, virtual false, abstract: false, final false
  inline ::System::Resources::__ResourceReader__ResourceEnumerator* GetEnumeratorInternal();

  /// @brief Method GetNameHash, addr 0x260a408, size 0x44, virtual false, abstract: false, final false
  inline int32_t GetNameHash(int32_t index);

  /// @brief Method GetNamePosition, addr 0x260a44c, size 0x120, virtual false, abstract: false, final false
  inline int32_t GetNamePosition(int32_t index);

  /// @brief Method GetValueForNameIndex, addr 0x260b5bc, size 0x2a8, virtual false, abstract: false, final false
  inline ::System::Object* GetValueForNameIndex(int32_t index);

  /// @brief Method LoadObject, addr 0x260c0d8, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Object* LoadObject(int32_t pos);

  /// @brief Method LoadObject, addr 0x260c104, size 0x98, virtual false, abstract: false, final false
  inline ::System::Object* LoadObject(int32_t pos, ByRef<::System::Resources::ResourceTypeCode> typeCode);

  /// @brief Method LoadObjectV1, addr 0x260b864, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* LoadObjectV1(int32_t pos);

  /// @brief Method LoadObjectV2, addr 0x260b964, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* LoadObjectV2(int32_t pos, ByRef<::System::Resources::ResourceTypeCode> typeCode);

  /// @brief Method LoadString, addr 0x260ba64, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadResources, addr 0x260a11c, size 0x174, virtual false, abstract: false, final false
  inline void ReadResources();

  /// @brief Method ReadUnalignedI4, addr 0x260a348, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ReadUnalignedI4(::cordl_internals::Ptr<int32_t> p);

  /// @brief Method SkipString, addr 0x260a350, size 0xb8, virtual false, abstract: false, final false
  inline void SkipString();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x260a56c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method _LoadObjectV1, addr 0x260c19c, size 0x838, virtual false, abstract: false, final false
  inline ::System::Object* _LoadObjectV1(int32_t pos);

  /// @brief Method _LoadObjectV2, addr 0x260cbac, size 0x738, virtual false, abstract: false, final false
  inline ::System::Object* _LoadObjectV2(int32_t pos, ByRef<::System::Resources::ResourceTypeCode> typeCode);

  /// @brief Method _ReadResources, addr 0x260d2e4, size 0x6dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a030, size 0xec, virtual false, abstract: false, final false
