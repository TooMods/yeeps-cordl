...
public:
  ...
  /// @brief Method Equals, addr 0x170f834, size 0x5c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* rparam);

  /// @brief Method GetHashCode, addr 0x170f890, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Init, addr 0x170ee94, size 0x174, virtual false, abstract: false, final false
  inline void Init(::System::Uri* uri);

  static inline ::System::UriBuilder* New_ctor(::StringW scheme, ::StringW host, int32_t portNumber);

  static inline ::System::UriBuilder* New_ctor(::StringW schemeName, ::StringW hostName);

  static inline ::System::UriBuilder* New_ctor(::StringW uri);

  static inline ::System::UriBuilder* New_ctor(::System::Uri* uri);

  /// @brief Method SetFieldsFromUri, addr 0x170f17c, size 0x164, virtual false, abstract: false, final false
  inline void SetFieldsFromUri(::System::Uri* uri);

  /// @brief Method ToString, addr 0x170f8b0, size 0x4cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x170f648, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW scheme, ::StringW host, int32_t portNumber);

  /// @brief Method .ctor, addr 0x170f2e0, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::StringW schemeName, ::StringW hostName);

  /// @brief Method .ctor, addr 0x170ecec, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor(::StringW uri);

  /// @brief Method .ctor, addr 0x170f008, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri);

  /// @brief Method get_Host, addr 0x170f6e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_Uri, addr 0x170f79c, size 0x98, virtual false, abstract: false, final false
  inline ::System::Uri* get_Uri();

  /// @brief Method set_Host, addr 0x170f55c, size 0xec, virtual false, abstract: false, final false
  inline void set_Host(::StringW value);

  /// @brief Method set_Path, addr 0x170f6e8, size 0xb4, virtual false, abstract: false, final false
  inline void set_Path(::StringW value);

  /// @brief Method set_Port, addr 0x170f670, size 0x70, virtual false, abstract: false, final false
  inline void set_Port(int32_t value);

  /// @brief Method set_Scheme, addr 0x170f414, size 0x148, virtual false, abstract: false, final false
