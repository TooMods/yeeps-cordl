...
public:
  ...
  /// @brief Method ToString, addr 0x182ddec, size 0x4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Update, addr 0x182de6c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182dd8c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Body, addr 0x182dddc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_Filter, addr 0x182dde4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Filter();

  /// @brief Method get_Test, addr 0x182ddd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Test();

  /// @brief Method get_Variable, addr 0x182ddcc, size 0x8, virtual false, abstract: false, final false
