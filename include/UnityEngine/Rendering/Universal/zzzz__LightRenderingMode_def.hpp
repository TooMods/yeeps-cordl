...
// Type: UnityEngine.Rendering.Universal::LightRenderingMode
...
public:
  ...
  /// @brief Field PerPixel value: static_cast<int32_t>(0x1)
  static ::UnityEngine::Rendering::Universal::LightRenderingMode const PerPixel;

  /// @brief Field PerVertex value: static_cast<int32_t>(0x2)
