...
public:
  ...
  /// @brief Method WriteChars, addr 0x282a6f8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x282a6d4, size 0x24, virtual false, abstract: false, final false
