...
public:
  ...
  /// @brief Method .ctor, addr 0x3045488, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FlatArrayIndex, addr 0x3045478, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_FlatArrayIndex();

  /// @brief Method set_FlatArrayIndex, addr 0x3045480, size 0x8, virtual false, abstract: false, final false
