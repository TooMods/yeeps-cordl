...
public:
  ...
  /// @brief Method Equals, addr 0x19fabbc, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationScriptPlayable other);

  /// @brief Method GetHandle, addr 0x19fabb0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x19faaf0, size 0xc0, virtual false, abstract: false, final false
