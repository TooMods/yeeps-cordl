...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x18e89f8, size 0x8f4, virtual false, abstract: false, final false
  static inline ::StringW GetErrorMessage(int32_t error);

  /// @brief Method GetObjectData, addr 0x18e94a4, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18e894c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x18e89c0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(int32_t error);

  /// @brief Method .ctor, addr 0x18e92ec, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x18e9414, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x18e9318, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x18e9394, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method get_NativeErrorCode, addr 0x18e949c, size 0x8, virtual false, abstract: false, final false
