...
public:
  ...
  /// @brief Method Process, addr 0x226723c, size 0x1a4, virtual true, abstract: false, final true
  inline void Process(ByRef<::UnityEngine::InputSystem::InputInteractionContext> context);

  /// @brief Method Reset, addr 0x22673e0, size 0x8, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x22673e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_durationOrDefault, addr 0x2267174, size 0x70, virtual false, abstract: false, final false
  inline float_t get_durationOrDefault();

  /// @brief Method get_pressPointOrDefault, addr 0x22671e4, size 0x58, virtual false, abstract: false, final false
