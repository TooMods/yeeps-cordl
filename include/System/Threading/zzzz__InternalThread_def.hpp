...
public:
  ...
  /// @brief Method Finalize, addr 0xed0cb8, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::System::Threading::InternalThread* New_ctor();

  /// @brief Method Thread_free_internal, addr 0xed0cb4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed0d4c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
