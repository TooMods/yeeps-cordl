...
public:
  ...
  /// @brief Method OnBeforeUpdate, addr 0x1e0b244, size 0x18, virtual false, abstract: false, final false
  inline void OnBeforeUpdate();

  /// @brief Method OnUpdate, addr 0x1e0b2e4, size 0x1c, virtual false, abstract: false, final false
  inline void OnUpdate();

  /// @brief Method get_value, addr 0x1e0b424, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_value();

  /// @brief Method set_value, addr 0x1e0b42c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetUpdateTypeForPlayer, addr 0x1e0b3f8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPlayerUpdate, addr 0x1e0b418, size 0xc, virtual false, abstract: false, final false
  static inline bool IsPlayerUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method OnBeforeUpdate, addr 0x1e0b1c4, size 0x80, virtual false, abstract: false, final false
  static inline void OnBeforeUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType type);

  /// @brief Method OnUpdate, addr 0x1e0b25c, size 0x88, virtual false, abstract: false, final false
  static inline void OnUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType type);

  /// @brief Method Restore, addr 0x1e0b364, size 0x94, virtual false, abstract: false, final false
  static inline void Restore(::UnityEngine::InputSystem::LowLevel::__InputUpdate__SerializedState state);

  /// @brief Method Save, addr 0x1e0b300, size 0x64, virtual false, abstract: false, final false
