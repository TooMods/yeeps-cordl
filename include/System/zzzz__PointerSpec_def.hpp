...
public:
  ...
  /// @brief Method Append, addr 0x10da138, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x10da0e4, size 0x54, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x10da160, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10da0bc, size 0x28, virtual false, abstract: false, final false
