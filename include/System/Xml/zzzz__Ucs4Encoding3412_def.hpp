...
public:
  ...
  /// @brief Method GetPreamble, addr 0x124f248, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  static inline ::System::Xml::Ucs4Encoding3412* New_ctor();

  /// @brief Method .ctor, addr 0x124ef64, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EncodingName, addr 0x124f208, size 0x40, virtual true, abstract: false, final false
