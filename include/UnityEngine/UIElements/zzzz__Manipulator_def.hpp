...
public:
  ...
  /// @brief Method .ctor, addr 0x27cf228, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_target, addr 0x27cf1cc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_target, addr 0x27cf1d4, size 0x54, virtual true, abstract: false, final true
