...
public:
  ...
  /// @brief Method AttachRows, addr 0x1cf93d8, size 0x15c, virtual false, abstract: false, final false
  inline void AttachRows(::System::Data::DataRow* parentRow, ::System::Xml::XmlNode* parentElement);

  /// @brief Method CountNonNSAttributes, addr 0x1cf95cc, size 0xf4, virtual false, abstract: false, final false
  inline int32_t CountNonNSAttributes(::System::Xml::XmlNode* node);

  /// @brief Method FColumnElement, addr 0x1cf9c04, size 0xe8, virtual false, abstract: false, final false
  inline bool FColumnElement(::System::Xml::XmlElement* e);

  /// @brief Method FExcludedNamespace, addr 0x1cf96c0, size 0x8c, virtual false, abstract: false, final false
  inline bool FExcludedNamespace(::StringW ns);

  /// @brief Method FIgnoreNamespace, addr 0x1cf9cec, size 0xe0, virtual false, abstract: false, final false
  inline bool FIgnoreNamespace(::System::Xml::XmlNode* node);

  /// @brief Method FIgnoreNamespace, addr 0x1cf9fb0, size 0x88, virtual false, abstract: false, final false
  inline bool FIgnoreNamespace(::System::Xml::XmlReader* node);

  /// @brief Method GetInitialTextFromNodes, addr 0x1cf9968, size 0x1d4, virtual false, abstract: false, final false
  inline ::StringW GetInitialTextFromNodes(ByRef<::System::Xml::XmlNode*> n);

  /// @brief Method GetRowFromElement, addr 0x1cf9534, size 0x98, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* GetRowFromElement(::System::Xml::XmlElement* e);

  /// @brief Method GetTextOnlyColumn, addr 0x1cf9b3c, size 0x98, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* GetTextOnlyColumn(::System::Data::DataRow* row);

  /// @brief Method GetValueForTextOnlyColums, addr 0x1cf974c, size 0x1c8, virtual false, abstract: false, final false
  inline ::StringW GetValueForTextOnlyColums(::System::Xml::XmlNode* n);

  /// @brief Method InitNameTable, addr 0x1cfb4b4, size 0x27c, virtual false, abstract: false, final false
  inline void InitNameTable();

  /// @brief Method IsTextLikeNode, addr 0x1cf9914, size 0x54, virtual false, abstract: false, final false
  inline bool IsTextLikeNode(::System::Xml::XmlNodeType n);

  /// @brief Method IsTextOnly, addr 0x1cf9bd4, size 0x30, virtual false, abstract: false, final false
  inline bool IsTextOnly(::System::Data::DataColumn* c);

  /// @brief Method LoadColumn, addr 0x1cfd520, size 0x918, virtual false, abstract: false, final false
  inline void LoadColumn(::System::Data::DataColumn* column, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> foundColumns);

  /// @brief Method LoadData, addr 0x1cfb730, size 0x318, virtual false, abstract: false, final false
  inline void LoadData(::System::Xml::XmlReader* reader);

  /// @brief Method LoadData, addr 0x1cfa038, size 0x2ec, virtual false, abstract: false, final false
  inline void LoadData(::System::Xml::XmlDocument* xdoc);

  /// @brief Method LoadRowData, addr 0x1cfa47c, size 0xc84, virtual false, abstract: false, final false
  inline void LoadRowData(::System::Data::DataRow* row, ::System::Xml::XmlElement* rowElement);

  /// @brief Method LoadRows, addr 0x1cfb100, size 0x340, virtual false, abstract: false, final false
  inline void LoadRows(::System::Data::DataRow* parentRow, ::System::Xml::XmlNode* parentElement);

  /// @brief Method LoadTable, addr 0x1cfc6d0, size 0xd20, virtual false, abstract: false, final false
  inline void LoadTable(::System::Data::DataTable* table, bool isNested);

  /// @brief Method LoadTopMostTable, addr 0x1cfbab0, size 0x94c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessXsdSchema, addr 0x1cfc4bc, size 0x214, virtual false, abstract: false, final false
  inline bool ProcessXsdSchema();

  /// @brief Method SetRowValueFromXmlText, addr 0x1cfb440, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cf90c4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataset, bool IsXdr, bool ignoreSchema);

  /// @brief Method .ctor, addr 0x1cf9160, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataset, bool IsXdr, ::System::Xml::XmlElement* topNode, bool ignoreSchema);

  /// @brief Method .ctor, addr 0x1cf9238, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* datatable, bool IsXdr, bool ignoreSchema);

  /// @brief Method .ctor, addr 0x1cf92e0, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* datatable, bool IsXdr, ::System::Xml::XmlElement* topNode, bool ignoreSchema);

  /// @brief Method get_FromInference, addr 0x1cf93c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_FromInference();

  /// @brief Method set_FromInference, addr 0x1cf93cc, size 0xc, virtual false, abstract: false, final false
