...
public:
  ...
  /// @brief Method get_control, addr 0x1ac8ea8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_part, addr 0x1ac8e98, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_part();

  /// @brief Method set_control, addr 0x1ac8eb0, size 0x8, virtual false, abstract: false, final false
  inline void set_control(::UnityEngine::InputSystem::InputControl* value);

  /// @brief Method set_part, addr 0x1ac8ea0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method EvaluateMagnitude, addr 0x1ac8d80, size 0x24, virtual false, abstract: false, final false
  inline float_t EvaluateMagnitude(int32_t partNumber);

  /// @brief Method GetPressTime, addr 0x1ac8e74, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x1ac8e2c, size 0x24, virtual false, abstract: false, final false
  inline void ReadValue(int32_t partNumber, ::cordl_internals::Ptr<void> buffer, int32_t bufferSize);

  /// @brief Method ReadValueAsButton, addr 0x1ac8da4, size 0x88, virtual false, abstract: false, final false
  inline bool ReadValueAsButton(int32_t partNumber);

  /// @brief Method ReadValueAsObject, addr 0x1ac8e50, size 0x24, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject(int32_t partNumber);

  /// @brief Method get_controls, addr 0x1ac8cd0, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1ac8ebc, size 0x100, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::__InputBindingCompositeContext___get_controls_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputBindingCompositeContext.PartBinding>.GetEnumerator, addr 0x1ac9064, size 0xb0, virtual true, abstract: false,
  /// final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputBindingCompositeContext.PartBinding>.get_Current, addr 0x1ac8fbc, size 0xc, virtual true, abstract: false, final
  /// true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1ac9114, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1ac8fc8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1ac9008, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1ac8eb8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ac8d4c, size 0x34, virtual false, abstract: false, final false
