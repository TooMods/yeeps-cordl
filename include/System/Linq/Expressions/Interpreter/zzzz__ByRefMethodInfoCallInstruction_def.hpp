...
public:
  ...
  /// @brief Method Run, addr 0x1842b48, size 0x4a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1842a58, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* target, int32_t argumentCount,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*, ::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*> byrefArgs);

  /// @brief Method get_ProducedStack, addr 0x1842a98, size 0xb0, virtual true, abstract: false, final false
