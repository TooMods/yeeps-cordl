...
public:
  ...
  /// @brief Method WriteChars, addr 0x282a740, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x282a71c, size 0x24, virtual false, abstract: false, final false
