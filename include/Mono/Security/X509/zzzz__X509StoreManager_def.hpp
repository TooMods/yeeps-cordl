...
public:
  ...
  /// @brief Method get_CurrentUser, addr 0x2469d30, size 0xa0, virtual false, abstract: false, final false
  static inline ::Mono::Security::X509::X509Stores* get_CurrentUser();

  /// @brief Method get_CurrentUserPath, addr 0x2469b48, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW get_CurrentUserPath();

  /// @brief Method get_LocalMachine, addr 0x2469e00, size 0xa0, virtual false, abstract: false, final false
  static inline ::Mono::Security::X509::X509Stores* get_LocalMachine();

  /// @brief Method get_LocalMachinePath, addr 0x2469c48, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW get_LocalMachinePath();

  /// @brief Method get_TrustedRootCertificates, addr 0x2467d00, size 0xcc, virtual false, abstract: false, final false
