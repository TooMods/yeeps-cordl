...
public:
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x10ea348, size 0x4c, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x10ea394, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x10e9c28, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x10ea398, size 0x76c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x10eab04, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CancellationTokenCanceledEventHandler, addr 0x10ea108, size 0x114, virtual false, abstract: false, final false
  static inline void CancellationTokenCanceledEventHandler(::System::Object* obj);

  /// @brief Method CheckDispose, addr 0x10e9618, size 0x84, virtual false, abstract: false, final false
  inline void CheckDispose();

  /// @brief Method CreateAndAddAsyncWaiter, addr 0x10e9a80, size 0x84, virtual false, abstract: false, final false
  inline ::System::Threading::__SemaphoreSlim__TaskNode* CreateAndAddAsyncWaiter();

  /// @brief Method Dispose, addr 0x10ea040, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x10ea0ac, size 0x5c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetResourceString, addr 0x10e9124, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueWaiterTask, addr 0x10ea034, size 0xc, virtual false, abstract: false, final false
  static inline void QueueWaiterTask(::System::Threading::__SemaphoreSlim__TaskNode* waiterTask);

  /// @brief Method Release, addr 0x10e9cf0, size 0x8, virtual false, abstract: false, final false
  inline int32_t Release();

  /// @brief Method Release, addr 0x10e9cf8, size 0x2e4, virtual false, abstract: false, final false
  inline int32_t Release(int32_t releaseCount);

  /// @brief Method RemoveAsyncWaiter, addr 0x10e9c70, size 0x80, virtual false, abstract: false, final false
  inline bool RemoveAsyncWaiter(::System::Threading::__SemaphoreSlim__TaskNode* task);

  /// @brief Method Wait, addr 0x10e9610, size 0x8, virtual false, abstract: false, final false
  inline bool Wait(int32_t millisecondsTimeout);

  /// @brief Method Wait, addr 0x10e9138, size 0x4d8, virtual false, abstract: false, final false
  inline bool Wait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Wait, addr 0x10e912c, size 0xc, virtual false, abstract: false, final false
  inline void Wait();

  /// @brief Method WaitAsync, addr 0x10e9a74, size 0xc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WaitAsync();

  /// @brief Method WaitAsync, addr 0x10e969c, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitUntilCountOrTimeout, addr 0x10e9980, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitUntilCountOrTimeoutAsync, addr 0x10e9b04, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e8f88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCount);

  /// @brief Method .ctor, addr 0x10e8f90, size 0x194, virtual false, abstract: false, final false
