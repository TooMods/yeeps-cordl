...
public:
  ...
  /// @brief Method IsPredefinedEntity, addr 0x1cad1e8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IDtdEntityInfo.get_BaseUriString, addr 0x1cad070, size 0x54, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_BaseUriString();

  /// @brief Method System.Xml.IDtdEntityInfo.get_DeclaredUriString, addr 0x1cad118, size 0x54, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_DeclaredUriString();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsDeclaredInExternal, addr 0x1cad038, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsDeclaredInExternal();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsExternal, addr 0x1cad030, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsExternal();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsParameterEntity, addr 0x1cad068, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsParameterEntity();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsUnparsedEntity, addr 0x1cad040, size 0x28, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsUnparsedEntity();

  /// @brief Method System.Xml.IDtdEntityInfo.get_LineNumber, addr 0x1cad1d8, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdEntityInfo_get_LineNumber();

  /// @brief Method System.Xml.IDtdEntityInfo.get_LinePosition, addr 0x1cad1e0, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdEntityInfo_get_LinePosition();

  /// @brief Method System.Xml.IDtdEntityInfo.get_Name, addr 0x1cad014, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_Name();

  /// @brief Method System.Xml.IDtdEntityInfo.get_PublicId, addr 0x1cad1c8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_PublicId();

  /// @brief Method System.Xml.IDtdEntityInfo.get_SystemId, addr 0x1cad1c0, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_SystemId();

  /// @brief Method System.Xml.IDtdEntityInfo.get_Text, addr 0x1cad1d0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1cacf90, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* qname, bool isParameter);

  /// @brief Method get_BaseURI, addr 0x1cad0c4, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_DeclaredInExternal, addr 0x1cad328, size 0x8, virtual false, abstract: false, final false
  inline bool get_DeclaredInExternal();

  /// @brief Method get_DeclaredURI, addr 0x1cad16c, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DeclaredURI();

  /// @brief Method get_IsExternal, addr 0x1cad314, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsExternal();

  /// @brief Method get_Line, addr 0x1cad360, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Line();

  /// @brief Method get_NData, addr 0x1cad33c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_NData();

  /// @brief Method get_Name, addr 0x1cad2e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Name();

  /// @brief Method get_ParsingInProgress, addr 0x1cad388, size 0x8, virtual false, abstract: false, final false
  inline bool get_ParsingInProgress();

  /// @brief Method get_Pos, addr 0x1cad370, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Pos();

  /// @brief Method get_Pubid, addr 0x1cad304, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Pubid();

  /// @brief Method get_Text, addr 0x1cad34c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Text();

  /// @brief Method get_Url, addr 0x1cad2ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_BaseURI, addr 0x1cad380, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseURI(::StringW value);

  /// @brief Method set_DeclaredInExternal, addr 0x1cad330, size 0xc, virtual false, abstract: false, final false
  inline void set_DeclaredInExternal(bool value);

  /// @brief Method set_DeclaredURI, addr 0x1cad39c, size 0x8, virtual false, abstract: false, final false
  inline void set_DeclaredURI(::StringW value);

  /// @brief Method set_IsExternal, addr 0x1cad31c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsExternal(bool value);

  /// @brief Method set_Line, addr 0x1cad368, size 0x8, virtual false, abstract: false, final false
  inline void set_Line(int32_t value);

  /// @brief Method set_NData, addr 0x1cad344, size 0x8, virtual false, abstract: false, final false
  inline void set_NData(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_ParsingInProgress, addr 0x1cad390, size 0xc, virtual false, abstract: false, final false
  inline void set_ParsingInProgress(bool value);

  /// @brief Method set_Pos, addr 0x1cad378, size 0x8, virtual false, abstract: false, final false
  inline void set_Pos(int32_t value);

  /// @brief Method set_Pubid, addr 0x1cad30c, size 0x8, virtual false, abstract: false, final false
  inline void set_Pubid(::StringW value);

  /// @brief Method set_Text, addr 0x1cad354, size 0xc, virtual false, abstract: false, final false
  inline void set_Text(::StringW value);

  /// @brief Method set_Url, addr 0x1cad2f4, size 0x10, virtual false, abstract: false, final false
