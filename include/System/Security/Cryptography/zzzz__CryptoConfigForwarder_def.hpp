...
public:
  // Declarations
  /// @brief Method CreateDefaultHashAlgorithm, addr 0x196e5a8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* CreateDefaultHashAlgorithm();

  /// @brief Method CreateFromName, addr 0x196e550, size 0x58, virtual false, abstract: false, final false
