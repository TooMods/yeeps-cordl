...
public:
  // Declarations
  /// @brief Method GetProxies, addr 0x103039c, size 0xc, virtual false, abstract: false, final false
  inline bool GetProxies(::System::Uri* destination, ByRef<::System::Collections::Generic::IList_1<::StringW>*> proxyList);

  /// @brief Method GetProxies, addr 0x10303a8, size 0xc, virtual false, abstract: false, final false
