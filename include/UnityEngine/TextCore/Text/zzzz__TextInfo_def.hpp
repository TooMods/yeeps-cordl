...
public:
  ...
  /// @brief Method Clear, addr 0x246fb80, size 0x5c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearLineInfo, addr 0x246fc88, size 0x16c, virtual false, abstract: false, final false
  inline void ClearLineInfo();

  /// @brief Method ClearMeshInfo, addr 0x246fbdc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246fa4c, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();
