...
public:
  // Declarations
  /// @brief Method Undo, addr 0x10eba1c, size 0x88, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x10eb994, size 0x88, virtual false, abstract: false, final false
