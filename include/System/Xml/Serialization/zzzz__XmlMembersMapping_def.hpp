...
public:
  ...
  /// @brief Method get_Count, addr 0x129ea14, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_HasWrapperElement, addr 0x129ea30, size 0x8, virtual false, abstract: false, final false
