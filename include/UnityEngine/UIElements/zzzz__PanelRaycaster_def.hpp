...
public:
  ...
  /// @brief Method ConvertFloatBitsToInt, addr 0x2b64e60, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ConvertFloatBitsToInt(float_t f);

  static inline ::UnityEngine::UIElements::PanelRaycaster* New_ctor();

  /// @brief Method OnPanelDestroyed, addr 0x2b64df4, size 0x8, virtual false, abstract: false, final false
  inline void OnPanelDestroyed();

  /// @brief Method Raycast, addr 0x2b64e68, size 0x52c, virtual true, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList);

  /// @brief Method RegisterCallbacks, addr 0x2b64d5c, size 0x98, virtual false, abstract: false, final false
  inline void RegisterCallbacks();

  /// @brief Method UnregisterCallbacks, addr 0x2b64cc4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6539c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_eventCamera, addr 0x2b65394, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_panel, addr 0x2b64c18, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IPanel* get_panel();

  /// @brief Method get_renderOrderPriority, addr 0x2b64e48, size 0x18, virtual true, abstract: false, final false
  inline int32_t get_renderOrderPriority();

  /// @brief Method get_selectableGameObject, addr 0x2b64dfc, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_selectableGameObject();

  /// @brief Method get_sortOrderPriority, addr 0x2b64e14, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method set_panel, addr 0x2b64c20, size 0xa4, virtual true, abstract: false, final true
