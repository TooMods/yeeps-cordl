...
public:
  ...
  /// @brief Method Run, addr 0x1b5e624, size 0x98, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToDebugString, addr 0x1b5e6bc, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1b5e800, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b5e5b4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(uint32_t index);

  /// @brief Method get_InstructionName, addr 0x1b5e5e4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1b5e5dc, size 0x8, virtual true, abstract: false, final false
