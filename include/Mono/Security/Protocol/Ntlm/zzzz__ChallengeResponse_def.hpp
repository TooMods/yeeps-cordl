...
public:
  ...
  /// @brief Method Dispose, addr 0x246af64, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x246b4bc, size 0x6c, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x246aec4, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetResponse, addr 0x246b170, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method PasswordToKey, addr 0x246afc8, size 0x144, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PasswordToKey(::StringW password, int32_t position);

  /// @brief Method PrepareDESKey, addr 0x246b528, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246a8d4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x246a944, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LM, addr 0x246b10c, size 0x64, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_LM();

  /// @brief Method get_NT, addr 0x246b458, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Challenge, addr 0x246ad90, size 0x134, virtual false, abstract: false, final false
  inline void set_Challenge(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_Password, addr 0x246a97c, size 0x414, virtual false, abstract: false, final false
