...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x27df578, size 0x8, virtual false, abstract: false, final false
  inline float_t _GetValueFromBag_b__3_0(::StringW s, float_t f);

  /// @brief Method .ctor, addr 0x27df570, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToFloat, addr 0x27df470, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ConvertValueToFloat(::StringW v, float_t defaultValue);

  /// @brief Method GetValueFromBag, addr 0x27df30c, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27df270, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
