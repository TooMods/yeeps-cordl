...
public:
  ...
  /// @brief Method AttachServerObject, addr 0x1980d90, size 0x5c, virtual false, abstract: false, final false
  inline void AttachServerObject(::System::MarshalByRefObject* serverObject, ::System::Runtime::Remoting::Contexts::Context* context);

  /// @brief Method CreateObjRef, addr 0x1981ae8, size 0x1b0, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type* requestedType);

  /// @brief Method DisposeServerObject, addr 0x1981a68, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method OnLifetimeExpired, addr 0x1981a64, size 0x4, virtual true, abstract: false, final false
  inline void OnLifetimeExpired();

  /// @brief Method StartTrackingLifetime, addr 0x197f53c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1981a1c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri, ::System::Runtime::Remoting::Contexts::Context* context, ::System::Type* objectType);

  /// @brief Method get_Context, addr 0x1981ca0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Contexts::Context* get_Context();

  /// @brief Method get_Lease, addr 0x1981c98, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Lifetime::Lease* get_Lease();

  /// @brief Method get_ObjectType, addr 0x1981a5c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method set_Context, addr 0x1981ca8, size 0x8, virtual false, abstract: false, final false
