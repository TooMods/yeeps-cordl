...
public:
  ...
  /// @brief Method Init, addr 0x2cd8b20, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd8d0c, size 0x25c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Adjust, addr 0x2cd8654, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSliderValueChange, addr 0x2cd86cc, size 0x9c, virtual false, abstract: false, final false
  inline void OnSliderValueChange(::UnityEngine::UIElements::ChangeEvent_1<float_t>* evt);

  /// @brief Method ScrollPageDown, addr 0x2cd8868, size 0x8, virtual false, abstract: false, final false
  inline void ScrollPageDown();

  /// @brief Method ScrollPageDown, addr 0x2cd8870, size 0xf8, virtual false, abstract: false, final false
  inline void ScrollPageDown(float_t factor);

  /// @brief Method ScrollPageUp, addr 0x2cd8768, size 0x8, virtual false, abstract: false, final false
  inline void ScrollPageUp();

  /// @brief Method ScrollPageUp, addr 0x2cd8770, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd8298, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2cd82ac, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method add_valueChanged, addr 0x2cd7d5c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_highButton, addr 0x2cd7ee4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RepeatButton* get_highButton();

  /// @brief Method get_highValue, addr 0x2cd7fec, size 0x50, virtual false, abstract: false, final false
  inline float_t get_highValue();

  /// @brief Method get_lowButton, addr 0x2cd7ed4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RepeatButton* get_lowButton();

  /// @brief Method get_lowValue, addr 0x2cd7f3c, size 0x50, virtual false, abstract: false, final false
  inline float_t get_lowValue();

  /// @brief Method get_slider, addr 0x2cd7ec4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Slider* get_slider();

  /// @brief Method get_value, addr 0x2cd7ef4, size 0x24, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method remove_valueChanged, addr 0x2cd7e10, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_direction, addr 0x2cd809c, size 0x1fc, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UIElements::SliderDirection value);

  /// @brief Method set_highButton, addr 0x2cd7eec, size 0x8, virtual false, abstract: false, final false
  inline void set_highButton(::UnityEngine::UIElements::RepeatButton* value);

  /// @brief Method set_highValue, addr 0x2cd803c, size 0x60, virtual false, abstract: false, final false
  inline void set_highValue(float_t value);

  /// @brief Method set_lowButton, addr 0x2cd7edc, size 0x8, virtual false, abstract: false, final false
  inline void set_lowButton(::UnityEngine::UIElements::RepeatButton* value);

  /// @brief Method set_lowValue, addr 0x2cd7f8c, size 0x60, virtual false, abstract: false, final false
  inline void set_lowValue(float_t value);

  /// @brief Method set_slider, addr 0x2cd7ecc, size 0x8, virtual false, abstract: false, final false
  inline void set_slider(::UnityEngine::UIElements::Slider* value);

  /// @brief Method set_value, addr 0x2cd7f18, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cd8ad8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
