...
public:
  ...
  /// @brief Method CreateObjRef, addr 0x19747b8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19745b8, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri, ::System::Runtime::Remoting::ObjRef* objRef);

  /// @brief Method get_ClientProxy, addr 0x19746c0, size 0x88, virtual false, abstract: false, final false
  inline ::System::MarshalByRefObject* get_ClientProxy();

  /// @brief Method get_TargetUri, addr 0x19747c0, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_TargetUri();

  /// @brief Method set_ClientProxy, addr 0x1974748, size 0x70, virtual false, abstract: false, final false
