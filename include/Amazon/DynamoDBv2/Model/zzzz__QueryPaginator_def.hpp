...
namespace Amazon::DynamoDBv2::Model {
class __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6;
}
...
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6);
...
class CORDL_TYPE __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IAsyncEnumerator_Amazon_DynamoDBv2_Model_QueryResponse__get_Current))::Amazon::DynamoDBv2::Model::
      QueryResponse* System_Collections_Generic_IAsyncEnumerator_Amazon_DynamoDBv2_Model_QueryResponse__Current;
  ...
  __declspec(property(get = __cordl_internal_get___u__1,
                      put = __cordl_internal_set___u__1))::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::DynamoDBv2::Model::QueryResponse*> __u__1;
  ...
  static inline ::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6(
      __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6(
      __QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6 const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, 0xb0>,
              "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____t__builder) == 0x18,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____v__promiseOfValueOrEnd) == 0x38,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____2__current) == 0x70,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____w__disposeMode) == 0x78,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____l__initialThreadId) == 0x7c,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____4__this) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, ___cancellationToken) == 0x88,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____3__cancellationToken) == 0x90,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, ____exclusiveStartKey_5__2) == 0x98,
              "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6, _____u__1) == 0xa0, "Offset mismatch!");
...
public:
  // Declarations
  using _Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6 =
...
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::__QueryPaginator___Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_QueryResponse__PaginateAsync_d__6*, "Amazon.DynamoDBv2.Model",
