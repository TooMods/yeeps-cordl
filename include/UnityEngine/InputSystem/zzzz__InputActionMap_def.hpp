...
public:
  // Declarations
  /// @brief Method Get, addr 0x18fcd54, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*>> Get();

  /// @brief Method IndexOf, addr 0x19027b8, size 0x5c, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Remove, addr 0x1902814, size 0x74, virtual false, abstract: false, final false
  inline bool Remove(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Set, addr 0x18fce40, size 0x17c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method FromBinding, addr 0x1902888, size 0x20, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method FromBinding, addr 0x19029c0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBinding, addr 0x19028a8, size 0x118, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ToAction, addr 0x1902a50, size 0x25c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method FromAction, addr 0x1902cac, size 0xbc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method FromMap, addr 0x1902d68, size 0x1f0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method FromMap, addr 0x19026c4, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::__InputActionMap__WriteFileJson FromMap(::UnityEngine::InputSystem::InputActionMap* map);

  /// @brief Method FromMaps, addr 0x18fd410, size 0x388, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ToMaps, addr 0x18fef64, size 0xfb0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearActionLookupTable, addr 0x1900c10, size 0x58, virtual false, abstract: false, final false
  inline void ClearActionLookupTable();

  /// @brief Method ClearCachedActionData, addr 0x1901744, size 0x28, virtual false, abstract: false, final false
  inline void ClearCachedActionData(bool onlyControls);

  /// @brief Method Clone, addr 0x1900cfc, size 0x21c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* Clone();

  /// @brief Method Contains, addr 0x1900f1c, size 0x2c, virtual true, abstract: false, final true
  inline bool Contains(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method Disable, addr 0x18fe7c4, size 0x34, virtual true, abstract: false, final true
  inline void Disable();

  /// @brief Method Dispose, addr 0x19008d8, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Enable, addr 0x18fe618, size 0x4c, virtual true, abstract: false, final true
  inline void Enable();

  /// @brief Method FindAction, addr 0x18fd9d4, size 0x11c, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::InputAction* FindAction(::StringW actionNameOrId, bool throwIfNotFound);

  /// @brief Method FindAction, addr 0x18fdfd8, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* FindAction(::System::Guid id);

  /// @brief Method FindActionIndex, addr 0x1900c68, size 0x94, virtual false, abstract: false, final false
  inline int32_t FindActionIndex(::System::Guid id);

  /// @brief Method FindActionIndex, addr 0x19008ec, size 0x204, virtual false, abstract: false, final false
  inline int32_t FindActionIndex(::StringW nameOrId);

  /// @brief Method FindBinding, addr 0x18fdbdc, size 0xe0, virtual true, abstract: false, final true
  inline int32_t FindBinding(::UnityEngine::InputSystem::InputBinding mask, ByRef<::UnityEngine::InputSystem::InputAction*> action);

  /// @brief Method FindBindingRelativeToMap, addr 0x1902430, size 0xb8, virtual false, abstract: false, final false
  inline int32_t FindBindingRelativeToMap(::UnityEngine::InputSystem::InputBinding mask);

  /// @brief Method FromJson, addr 0x19024e8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateId, addr 0x1900404, size 0x34, virtual false, abstract: false, final false
  inline void GenerateId();

  /// @brief Method GetBindingsForSingleAction, addr 0x18fa90c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetControlsForSingleAction, addr 0x18faa04, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x1901010, size 0xa0, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::InputAction*>* GetEnumerator();

  /// @brief Method IsUsableWithDevice, addr 0x18fe3a0, size 0x118, virtual false, abstract: false, final false
  inline bool IsUsableWithDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method LazyResolveBindings, addr 0x18fa838, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAfterDeserialize, addr 0x1902754, size 0x64, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x1902750, size 0x4, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method OnBindingModified, addr 0x190176c, size 0x1c, virtual false, abstract: false, final false
  inline void OnBindingModified();

  /// @brief Method OnSetupChanged, addr 0x18fecbc, size 0x1d8, virtual false, abstract: false, final false
  inline void OnSetupChanged();

  /// @brief Method OnWantToChangeSetup, addr 0x18fe99c, size 0x29c, virtual false, abstract: false, final false
  inline void OnWantToChangeSetup();

  /// @brief Method ResolveBindings, addr 0x1901788, size 0xbc8, virtual false, abstract: false, final false
  inline void ResolveBindings();

  /// @brief Method ResolveBindingsIfNecessary, addr 0x18fa9d0, size 0x34, virtual false, abstract: false, final false
  inline bool ResolveBindingsIfNecessary();

  /// @brief Method SetUpActionLookupTable, addr 0x1900af0, size 0x120, virtual false, abstract: false, final false
  inline void SetUpActionLookupTable();

  /// @brief Method SetUpPerActionControlAndBindingArrays, addr 0x1901154, size 0x5f0, virtual false, abstract: false, final false
  inline void SetUpPerActionControlAndBindingArrays();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x19010b0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.ICloneable.Clone, addr 0x1900f18, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToJson, addr 0x1902654, size 0x70, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method ToJson, addr 0x190259c, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::InputActionMap*>* maps);

  /// @brief Method ToString, addr 0x1900f48, size 0xc8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.InputSystem.IInputActionCollection2.get_bindings, addr 0x1900498, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18fba80, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x19008a8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method add_actionTriggered, addr 0x19007f8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x1900710, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Item(::StringW actionNameOrId);

  /// @brief Method get_actions, addr 0x19002e0, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputAction*> get_actions();

  /// @brief Method get_asset, addr 0x1900398, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_asset();

  /// @brief Method get_bindingMask, addr 0x1900580, size 0x10, virtual true, abstract: false, final true
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> get_bindingMask();

  /// @brief Method get_bindingResolutionNeedsFullReResolve, addr 0x19010dc, size 0xc, virtual false, abstract: false, final false
  inline bool get_bindingResolutionNeedsFullReResolve();

  /// @brief Method get_bindings, addr 0x1900438, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputBinding> get_bindings();

  /// @brief Method get_bindingsForEachActionInitialized, addr 0x190112c, size 0xc, virtual false, abstract: false, final false
  inline bool get_bindingsForEachActionInitialized();

  /// @brief Method get_controlSchemes, addr 0x19004fc, size 0x84, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControlScheme> get_controlSchemes();

  /// @brief Method get_controlsForEachActionInitialized, addr 0x1901104, size 0xc, virtual false, abstract: false, final false
  inline bool get_controlsForEachActionInitialized();

  /// @brief Method get_devices, addr 0x18fbbc4, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_enabled, addr 0x18fca78, size 0x10, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_id, addr 0x19003a0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Guid get_id();

  /// @brief Method get_idDontGenerate, addr 0x18fde88, size 0x48, virtual false, abstract: false, final false
  inline ::System::Guid get_idDontGenerate();

  /// @brief Method get_name, addr 0x1900390, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_needToResolveBindings, addr 0x19010b4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_actionTriggered, addr 0x1900850, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bindingMask, addr 0x1900590, size 0x13c, virtual true, abstract: false, final true
  inline void set_bindingMask(::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> value);

  /// @brief Method set_bindingResolutionNeedsFullReResolve, addr 0x19010e8, size 0x1c, virtual false, abstract: false, final false
  inline void set_bindingResolutionNeedsFullReResolve(bool value);

  /// @brief Method set_bindingsForEachActionInitialized, addr 0x1901138, size 0x1c, virtual false, abstract: false, final false
  inline void set_bindingsForEachActionInitialized(bool value);

  /// @brief Method set_controlsForEachActionInitialized, addr 0x1901110, size 0x1c, virtual false, abstract: false, final false
  inline void set_controlsForEachActionInitialized(bool value);

  /// @brief Method set_devices, addr 0x19006cc, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method set_needToResolveBindings, addr 0x19010c0, size 0x1c, virtual false, abstract: false, final false
