...
public:
  ...
  /// @brief Method .ctor, addr 0x19c2e60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_OculusPlatformTestUserAccessToken, addr 0x19c2e14, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW get_OculusPlatformTestUserAccessToken();

  /// @brief Method get_OculusPlatformTestUserEmail, addr 0x19c2d7c, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW get_OculusPlatformTestUserEmail();

  /// @brief Method get_OculusPlatformTestUserPassword, addr 0x19c2dc8, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW get_OculusPlatformTestUserPassword();

  /// @brief Method set_OculusPlatformTestUserAccessToken, addr 0x19c2e5c, size 0x4, virtual false, abstract: false, final false
  static inline void set_OculusPlatformTestUserAccessToken(::StringW value);

  /// @brief Method set_OculusPlatformTestUserEmail, addr 0x19c2dc4, size 0x4, virtual false, abstract: false, final false
  static inline void set_OculusPlatformTestUserEmail(::StringW value);

  /// @brief Method set_OculusPlatformTestUserPassword, addr 0x19c2e10, size 0x4, virtual false, abstract: false, final false
