...
public:
  ...
  /// @brief Method AddDependentColumn, addr 0x24115a0, size 0xfc, virtual false, abstract: false, final false
  inline void AddDependentColumn(::System::Data::DataColumn* expressionColumn);

  /// @brief Method BindExpression, addr 0x240def4, size 0x24, virtual false, abstract: false, final false
  inline void BindExpression();

  /// @brief Method CheckColumnConstraint, addr 0x240fdc4, size 0x54, virtual false, abstract: false, final false
  inline void CheckColumnConstraint(::System::Data::DataRow* row, ::System::Data::DataRowAction action);

  /// @brief Method CheckMaxLength, addr 0x240e8e4, size 0x380, virtual false, abstract: false, final false
  inline bool CheckMaxLength();

  /// @brief Method CheckMaxLength, addr 0x240fe90, size 0x7c, virtual false, abstract: false, final false
  inline void CheckMaxLength(::System::Data::DataRow* dr);

  /// @brief Method CheckNotAllowNull, addr 0x240b19c, size 0x438, virtual false, abstract: false, final false
  inline void CheckNotAllowNull();

  /// @brief Method CheckNullable, addr 0x240fe18, size 0x78, virtual false, abstract: false, final false
  inline void CheckNullable(::System::Data::DataRow* row);

  /// @brief Method CheckUnique, addr 0x240fa4c, size 0x4c, virtual false, abstract: false, final false
  inline void CheckUnique();

  /// @brief Method Clone, addr 0x24102c4, size 0x4c8, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* Clone();

  /// @brief Method Compare, addr 0x2410064, size 0x20, virtual false, abstract: false, final false
  inline int32_t Compare(int32_t record1, int32_t record2);

  /// @brief Method CompareValueTo, addr 0x2410084, size 0x1e0, virtual false, abstract: false, final false
  inline bool CompareValueTo(int32_t record1, ::System::Object* value, bool checkType);

  /// @brief Method CompareValueTo, addr 0x2410264, size 0x20, virtual false, abstract: false, final false
  inline int32_t CompareValueTo(int32_t record1, ::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x240d3e8, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW ConvertObjectToXml(::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x24114c0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertValue, addr 0x2410284, size 0x20, virtual false, abstract: false, final false
  inline ::System::Object* ConvertValue(::System::Object* value);

  /// @brief Method ConvertXmlToObject, addr 0x2411440, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Object* ConvertXmlToObject(::StringW s);

  /// @brief Method ConvertXmlToObject, addr 0x241147c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x24102a4, size 0x20, virtual false, abstract: false, final false
  inline void Copy(int32_t srcRecordNo, int32_t dstRecordNo);

  /// @brief Method CopyValueIntoStore, addr 0x2411548, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishInitInProgress, addr 0x24112dc, size 0x10, virtual false, abstract: false, final false
  inline void FinishInitInProgress();

  /// @brief Method FreeRecord, addr 0x240f578, size 0x24, virtual false, abstract: false, final false
  inline void FreeRecord(int32_t record);

  /// @brief Method GetAggregateValue, addr 0x24108ac, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Object* GetAggregateValue(::ArrayW<int32_t, ::Array<int32_t>*> records, ::System::Data::AggregateType kind);

  /// @brief Method GetColumnValueAsString, addr 0x240d300, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW GetColumnValueAsString(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method GetDataRow, addr 0x240f1f4, size 0x24, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* GetDataRow(int32_t index);

  /// @brief Method GetEmptyColumnStore, addr 0x2411514, size 0x34, virtual false, abstract: false, final false
  inline ::System::Object* GetEmptyColumnStore(int32_t recordCount);

  /// @brief Method GetStringLength, addr 0x240ff0c, size 0x20, virtual false, abstract: false, final false
  inline int32_t GetStringLength(int32_t record);

  /// @brief Method HandleDependentColumnList, addr 0x240e1ec, size 0x138, virtual false, abstract: false, final false
  inline void HandleDependentColumnList(::System::Data::DataExpression* oldExpression, ::System::Data::DataExpression* newExpression);

  /// @brief Method Init, addr 0x2410970, size 0x8c, virtual false, abstract: false, final false
  inline void Init(int32_t record);

  /// @brief Method InitializeRecord, addr 0x240e324, size 0x3c, virtual false, abstract: false, final false
  inline void InitializeRecord(int32_t record);

  /// @brief Method InsureStorage, addr 0x2411314, size 0x78, virtual false, abstract: false, final false
  inline void InsureStorage();

  /// @brief Method InternalUnique, addr 0x240fa98, size 0xc, virtual false, abstract: false, final false
  inline void InternalUnique(bool value);

  /// @brief Method IsAutoIncrementType, addr 0x240b820, size 0x2dc, virtual false, abstract: false, final false
  static inline bool IsAutoIncrementType(::System::Type* dataType);

  /// @brief Method IsInRelation, addr 0x240d4c4, size 0x144, virtual false, abstract: false, final false
  inline bool IsInRelation();

  /// @brief Method IsMaxLengthViolated, addr 0x2410bd0, size 0x554, virtual false, abstract: false, final false
  inline bool IsMaxLengthViolated();

  /// @brief Method IsNotAllowDBNullViolated, addr 0x241116c, size 0x128, virtual false, abstract: false, final false
  inline bool IsNotAllowDBNullViolated();

  /// @brief Method IsValueCustomTypeInstance, addr 0x2410a70, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPropertyChanging, addr 0x24112ec, size 0x28, virtual true, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method OnSetDataSet, addr 0x24113c8, size 0x4, virtual false, abstract: false, final false
  inline void OnSetDataSet();

  /// @brief Method RaisePropertyChanging, addr 0x240d004, size 0x80, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method RemoveDependentColumn, addr 0x241169c, size 0x98, virtual false, abstract: false, final false
  inline void RemoveDependentColumn(::System::Data::DataColumn* expressionColumn);

  /// @brief Method SetCapacity, addr 0x241138c, size 0x3c, virtual false, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetMaxLengthSimpleType, addr 0x240e458, size 0x7c, virtual false, abstract: false, final false
  inline void SetMaxLengthSimpleType();

  /// @brief Method SetOrdinalInternal, addr 0x240ef04, size 0x12c, virtual false, abstract: false, final false
  inline void SetOrdinalInternal(int32_t ordinal);

  /// @brief Method SetStorage, addr 0x2411564, size 0x3c, virtual false, abstract: false, final false
  inline void SetStorage(::System::Object* store, ::System::Collections::BitArray* nullbits);

  /// @brief Method SetTable, addr 0x240f144, size 0xb0, virtual false, abstract: false, final false
  inline void SetTable(::System::Data::DataTable* table);

  /// @brief Method SetValue, addr 0x240f470, size 0x108, virtual false, abstract: false, final false
  inline void SetValue(int32_t record, ::System::Object* value);

  /// @brief Method ToString, addr 0x24113cc, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateColumnType, addr 0x240a740, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240a304, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x240a690, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW columnName, ::System::Type* dataType);

  /// @brief Method .ctor, addr 0x240a394, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllowDBNull, addr 0x240afe8, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowDBNull();

  /// @brief Method get_AutoInc, addr 0x240c368, size 0x100, virtual false, abstract: false, final false
  inline ::System::Data::AutoIncrementValue* get_AutoInc();

  /// @brief Method get_AutoIncrement, addr 0x240b5d4, size 0x20, virtual false, abstract: false, final false
  inline bool get_AutoIncrement();

  /// @brief Method get_AutoIncrementCurrent, addr 0x240c468, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Object* get_AutoIncrementCurrent();

  /// @brief Method get_AutoIncrementSeed, addr 0x240c4d4, size 0x18, virtual false, abstract: false, final false
  inline int64_t get_AutoIncrementSeed();

  /// @brief Method get_AutoIncrementStep, addr 0x240c7c4, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_AutoIncrementStep();

  /// @brief Method get_Caption, addr 0x240c8d8, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Caption();

  /// @brief Method get_ColumnMapping, addr 0x240fabc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Data::MappingType get_ColumnMapping();

  /// @brief Method get_ColumnName, addr 0x240c9e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ColumnName();

  /// @brief Method get_Computed, addr 0x240d424, size 0x10, virtual false, abstract: false, final false
  inline bool get_Computed();

  /// @brief Method get_DataExpression, addr 0x240d434, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataExpression* get_DataExpression();

  /// @brief Method get_DataType, addr 0x240d43c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_DataType();

  /// @brief Method get_DateTimeMode, addr 0x240db90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataSetDateTime get_DateTimeMode();

  /// @brief Method get_DefaultValue, addr 0x240d648, size 0x124, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValue();

  /// @brief Method get_DefaultValueIsNull, addr 0x240deec, size 0x8, virtual false, abstract: false, final false
  inline bool get_DefaultValueIsNull();

  /// @brief Method get_EncodedColumnName, addr 0x240d0dc, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW get_EncodedColumnName();

  /// @brief Method get_Expression, addr 0x240df18, size 0x5c, virtual false, abstract: false, final false
  inline ::StringW get_Expression();

  /// @brief Method get_ExtendedProperties, addr 0x240e3b0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_FormatProvider, addr 0x240c5f0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::IFormatProvider* get_FormatProvider();

  /// @brief Method get_HasData, addr 0x240bafc, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasData();

  /// @brief Method get_ImplementsIChangeTracking, addr 0x240e424, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsIChangeTracking();

  /// @brief Method get_ImplementsINullable, addr 0x240e41c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsINullable();

  /// @brief Method get_ImplementsIRevertibleChangeTracking, addr 0x240e42c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsIRevertibleChangeTracking();

  /// @brief Method get_ImplementsIXMLSerializable, addr 0x2410b3c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsIXMLSerializable();

  /// @brief Method get_IsCustomType, addr 0x24109fc, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsCustomType();

  /// @brief Method get_IsSqlType, addr 0x240e450, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsSqlType();

  /// @brief Method get_IsValueType, addr 0x240e434, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsValueType();

  /// @brief Method get_Item, addr 0x240d3c8, size 0x20, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(int32_t record);

  /// @brief Method get_Locale, addr 0x240c978, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Locale();

  /// @brief Method get_MaxLength, addr 0x240e4d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxLength();

  /// @brief Method get_Namespace, addr 0x240ed08, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ObjectID, addr 0x240d148, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_Ordinal, addr 0x240eefc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Ordinal();

  /// @brief Method get_Prefix, addr 0x240d150, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_ReadOnly, addr 0x240f030, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadOnly();

  /// @brief Method get_SimpleType, addr 0x240fab4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::SimpleType* get_SimpleType();

  /// @brief Method get_SortIndex, addr 0x240f078, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Data::Index* get_SortIndex();

  /// @brief Method get_Table, addr 0x240f13c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* get_Table();

  /// @brief Method get_Unique, addr 0x240f59c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Unique();

  /// @brief Method get_XmlDataType, addr 0x240faa4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlDataType();

  static inline void setStaticF_s_objectTypeCount(int32_t value);

  /// @brief Method set_AllowDBNull, addr 0x240aff0, size 0x1ac, virtual false, abstract: false, final false
  inline void set_AllowDBNull(bool value);

  /// @brief Method set_AutoIncrement, addr 0x240b5f4, size 0x1ac, virtual false, abstract: false, final false
  inline void set_AutoIncrement(bool value);

  /// @brief Method set_AutoIncrementCurrent, addr 0x240c4ec, size 0x104, virtual false, abstract: false, final false
  inline void set_AutoIncrementCurrent(::System::Object* value);

  /// @brief Method set_AutoIncrementSeed, addr 0x240c6d4, size 0xf0, virtual false, abstract: false, final false
  inline void set_AutoIncrementSeed(int64_t value);

  /// @brief Method set_AutoIncrementStep, addr 0x240c7e0, size 0xf8, virtual false, abstract: false, final false
  inline void set_AutoIncrementStep(int64_t value);

  /// @brief Method set_Caption, addr 0x240c8f4, size 0x84, virtual false, abstract: false, final false
  inline void set_Caption(::StringW value);

  /// @brief Method set_ColumnMapping, addr 0x240fac4, size 0x218, virtual true, abstract: false, final false
  inline void set_ColumnMapping(::System::Data::MappingType value);

  /// @brief Method set_ColumnName, addr 0x240c9ec, size 0x364, virtual false, abstract: false, final false
  inline void set_ColumnName(::StringW value);

  /// @brief Method set_DataType, addr 0x240bb58, size 0x810, virtual false, abstract: false, final false
  inline void set_DataType(::System::Type* value);

  /// @brief Method set_DateTimeMode, addr 0x240db98, size 0x12c, virtual false, abstract: false, final false
  inline void set_DateTimeMode(::System::Data::DataSetDateTime value);

  /// @brief Method set_DefaultValue, addr 0x240d76c, size 0x2f0, virtual false, abstract: false, final false
  inline void set_DefaultValue(::System::Object* value);

  /// @brief Method set_Expression, addr 0x240a848, size 0x7a0, virtual false, abstract: false, final false
  inline void set_Expression(::StringW value);

  /// @brief Method set_Item, addr 0x240f218, size 0x180, virtual false, abstract: false, final false
  inline void set_Item(int32_t record, ::System::Object* value);

  /// @brief Method set_MaxLength, addr 0x240e4dc, size 0x360, virtual false, abstract: false, final false
  inline void set_MaxLength(int32_t value);

  /// @brief Method set_Namespace, addr 0x240ed80, size 0x130, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_Prefix, addr 0x240d158, size 0x15c, virtual false, abstract: false, final false
  inline void set_Prefix(::StringW value);

  /// @brief Method set_ReadOnly, addr 0x240e02c, size 0xf0, virtual false, abstract: false, final false
  inline void set_ReadOnly(bool value);

  /// @brief Method set_SimpleType, addr 0x240a704, size 0x3c, virtual false, abstract: false, final false
  inline void set_SimpleType(::System::Data::SimpleType* value);

  /// @brief Method set_Unique, addr 0x240f5a4, size 0x468, virtual false, abstract: false, final false
  inline void set_Unique(bool value);

  /// @brief Method set_XmlDataType, addr 0x240faac, size 0x8, virtual false, abstract: false, final false
