...
public:
  ...
  /// @brief Method AsyncReadCallback, addr 0x123d678, size 0x2b0, virtual false, abstract: false, final false
  inline void AsyncReadCallback(::System::IAsyncResult* ar);

  /// @brief Method BeginRead, addr 0x123d928, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x123dc74, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckError, addr 0x123d2f8, size 0x44, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method Dispose, addr 0x123cd8c, size 0x188, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x123dad4, size 0x1a0, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ar);

  /// @brief Method EndWrite, addr 0x123dd68, size 0xa0, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Flush, addr 0x123de08, size 0x24, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x123d49c, size 0x104, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Seek, addr 0x123d3d0, size 0xcc, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x123de2c, size 0x24, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method SetSocketTimeoutOption, addr 0x123df00, size 0x50, virtual false, abstract: false, final false
  inline void SetSocketTimeoutOption(int32_t timeout);

  /// @brief Method System.Net.ICloseEx.CloseEx, addr 0x123cf14, size 0x3e4, virtual true, abstract: false, final true
  inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState closeState);

  /// @brief Method Write, addr 0x123d5a0, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12391f4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x123d33c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x123d344, size 0x20, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x123de50, size 0x20, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x123d364, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x123d36c, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x123d38c, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_ReadTimeout, addr 0x123de70, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_WriteTimeout, addr 0x123deb8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Position, addr 0x123d3ac, size 0x24, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x123de94, size 0x24, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_WriteTimeout, addr 0x123dedc, size 0x24, virtual true, abstract: false, final false
