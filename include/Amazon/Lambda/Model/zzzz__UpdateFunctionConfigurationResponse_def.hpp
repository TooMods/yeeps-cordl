...
#include <cstdint>
CORDL_MODULE_EXPORT(UpdateFunctionConfigurationResponse)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse);
// Type: Amazon.Lambda.Model::UpdateFunctionConfigurationResponse
...
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::Amazon.Lambda.Model::UpdateFunctionConfigurationResponse*
class CORDL_TYPE UpdateFunctionConfigurationResponse : public ::Amazon::Runtime::AmazonWebServiceResponse {
public:
  // Declarations
  ...
  /// @brief Method IsSetCodeSha256, addr 0x310bf90, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetCodeSha256();

  /// @brief Method IsSetCodeSize, addr 0x310c04c, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetCodeSize();

  /// @brief Method IsSetDeadLetterConfig, addr 0x310c098, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetDeadLetterConfig();

  /// @brief Method IsSetDescription, addr 0x310c0b8, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetDescription();

  /// @brief Method IsSetEnvironment, addr 0x310c0d8, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetEnvironment();

  /// @brief Method IsSetFileSystemConfigs, addr 0x310c0f8, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetFileSystemConfigs();

  /// @brief Method IsSetFunctionArn, addr 0x310c15c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetFunctionArn();

  /// @brief Method IsSetFunctionName, addr 0x310c17c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetFunctionName();

  /// @brief Method IsSetHandler, addr 0x310c19c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetHandler();

  /// @brief Method IsSetImageConfigResponse, addr 0x310c1bc, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetImageConfigResponse();

  /// @brief Method IsSetKMSKeyArn, addr 0x310c1dc, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetKMSKeyArn();

  /// @brief Method IsSetLastModified, addr 0x310c1fc, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetLastModified();

  /// @brief Method IsSetLastUpdateStatus, addr 0x310c21c, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetLastUpdateStatus();

  /// @brief Method IsSetLastUpdateStatusReason, addr 0x310c28c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetLastUpdateStatusReason();

  /// @brief Method IsSetLastUpdateStatusReasonCode, addr 0x310c2ac, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetLastUpdateStatusReasonCode();

  /// @brief Method IsSetLayers, addr 0x310c31c, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetLayers();

  /// @brief Method IsSetMasterArn, addr 0x310c380, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetMasterArn();

  /// @brief Method IsSetMemorySize, addr 0x310c434, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMemorySize();

  /// @brief Method IsSetPackageType, addr 0x310c480, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetPackageType();

  /// @brief Method IsSetRevisionId, addr 0x310c4f0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetRevisionId();

  /// @brief Method IsSetRole, addr 0x310c510, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetRole();

  /// @brief Method IsSetRuntime, addr 0x310c530, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetRuntime();

  /// @brief Method IsSetSigningJobArn, addr 0x310c5a0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetSigningJobArn();

  /// @brief Method IsSetSigningProfileVersionArn, addr 0x310c5c0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetSigningProfileVersionArn();

  /// @brief Method IsSetState, addr 0x310c5e0, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetState();

  /// @brief Method IsSetStateReason, addr 0x310c650, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetStateReason();

  /// @brief Method IsSetStateReasonCode, addr 0x310c670, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetStateReasonCode();

  /// @brief Method IsSetTimeout, addr 0x310c774, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetTimeout();

  /// @brief Method IsSetTracingConfig, addr 0x310c7c0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetTracingConfig();

  /// @brief Method IsSetVersion, addr 0x310c7e0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetVersion();

  /// @brief Method IsSetVpcConfig, addr 0x310c800, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetVpcConfig();

  static inline ::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x310c810, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CodeSha256, addr 0x310bf80, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CodeSha256();

  /// @brief Method get_CodeSize, addr 0x310bfa0, size 0x3c, virtual false, abstract: false, final false
  inline int64_t get_CodeSize();

  /// @brief Method get_DeadLetterConfig, addr 0x310c088, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::DeadLetterConfig* get_DeadLetterConfig();

  /// @brief Method get_Description, addr 0x310c0a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_Environment, addr 0x310c0c8, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::EnvironmentResponse* get_Environment();

  /// @brief Method get_FileSystemConfigs, addr 0x310c0e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::Lambda::Model::FileSystemConfig*>* get_FileSystemConfigs();

  /// @brief Method get_FunctionArn, addr 0x310c14c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FunctionArn();

  /// @brief Method get_FunctionName, addr 0x310c16c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FunctionName();

  /// @brief Method get_Handler, addr 0x310c18c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Handler();

  /// @brief Method get_ImageConfigResponse, addr 0x310c1ac, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::ImageConfigResponse* get_ImageConfigResponse();

  /// @brief Method get_KMSKeyArn, addr 0x310c1cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_KMSKeyArn();

  /// @brief Method get_LastModified, addr 0x310c1ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LastModified();

  /// @brief Method get_LastUpdateStatus, addr 0x310c20c, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::LastUpdateStatus* get_LastUpdateStatus();

  /// @brief Method get_LastUpdateStatusReason, addr 0x310c27c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LastUpdateStatusReason();

  /// @brief Method get_LastUpdateStatusReasonCode, addr 0x310c29c, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::LastUpdateStatusReasonCode* get_LastUpdateStatusReasonCode();

  /// @brief Method get_Layers, addr 0x310c30c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::Lambda::Model::Layer*>* get_Layers();

  /// @brief Method get_MasterArn, addr 0x310c370, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MasterArn();

  /// @brief Method get_MemorySize, addr 0x310c390, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MemorySize();

  /// @brief Method get_PackageType, addr 0x310c470, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::PackageType* get_PackageType();

  /// @brief Method get_RevisionId, addr 0x310c4e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RevisionId();

  /// @brief Method get_Role, addr 0x310c500, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Role();

  /// @brief Method get_Runtime, addr 0x310c520, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Runtime* get_Runtime();

  /// @brief Method get_SigningJobArn, addr 0x310c590, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SigningJobArn();

  /// @brief Method get_SigningProfileVersionArn, addr 0x310c5b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SigningProfileVersionArn();

  /// @brief Method get_State, addr 0x310c5d0, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::State* get_State();

  /// @brief Method get_StateReason, addr 0x310c640, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_StateReason();

  /// @brief Method get_StateReasonCode, addr 0x310c660, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::StateReasonCode* get_StateReasonCode();

  /// @brief Method get_Timeout, addr 0x310c6d0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method get_TracingConfig, addr 0x310c7b0, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::TracingConfigResponse* get_TracingConfig();

  /// @brief Method get_Version, addr 0x310c7d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  /// @brief Method get_VpcConfig, addr 0x310c7f0, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::VpcConfigDetail* get_VpcConfig();

  /// @brief Method set_CodeSha256, addr 0x310bf88, size 0x8, virtual false, abstract: false, final false
  inline void set_CodeSha256(::StringW value);

  /// @brief Method set_CodeSize, addr 0x310bfdc, size 0x70, virtual false, abstract: false, final false
  inline void set_CodeSize(int64_t value);

  /// @brief Method set_DeadLetterConfig, addr 0x310c090, size 0x8, virtual false, abstract: false, final false
  inline void set_DeadLetterConfig(::Amazon::Lambda::Model::DeadLetterConfig* value);

  /// @brief Method set_Description, addr 0x310c0b0, size 0x8, virtual false, abstract: false, final false
  inline void set_Description(::StringW value);

  /// @brief Method set_Environment, addr 0x310c0d0, size 0x8, virtual false, abstract: false, final false
  inline void set_Environment(::Amazon::Lambda::Model::EnvironmentResponse* value);

  /// @brief Method set_FileSystemConfigs, addr 0x310c0f0, size 0x8, virtual false, abstract: false, final false
  inline void set_FileSystemConfigs(::System::Collections::Generic::List_1<::Amazon::Lambda::Model::FileSystemConfig*>* value);

  /// @brief Method set_FunctionArn, addr 0x310c154, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionArn(::StringW value);

  /// @brief Method set_FunctionName, addr 0x310c174, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionName(::StringW value);

  /// @brief Method set_Handler, addr 0x310c194, size 0x8, virtual false, abstract: false, final false
  inline void set_Handler(::StringW value);

  /// @brief Method set_ImageConfigResponse, addr 0x310c1b4, size 0x8, virtual false, abstract: false, final false
  inline void set_ImageConfigResponse(::Amazon::Lambda::Model::ImageConfigResponse* value);

  /// @brief Method set_KMSKeyArn, addr 0x310c1d4, size 0x8, virtual false, abstract: false, final false
  inline void set_KMSKeyArn(::StringW value);

  /// @brief Method set_LastModified, addr 0x310c1f4, size 0x8, virtual false, abstract: false, final false
  inline void set_LastModified(::StringW value);

  /// @brief Method set_LastUpdateStatus, addr 0x310c214, size 0x8, virtual false, abstract: false, final false
  inline void set_LastUpdateStatus(::Amazon::Lambda::LastUpdateStatus* value);

  /// @brief Method set_LastUpdateStatusReason, addr 0x310c284, size 0x8, virtual false, abstract: false, final false
  inline void set_LastUpdateStatusReason(::StringW value);

  /// @brief Method set_LastUpdateStatusReasonCode, addr 0x310c2a4, size 0x8, virtual false, abstract: false, final false
  inline void set_LastUpdateStatusReasonCode(::Amazon::Lambda::LastUpdateStatusReasonCode* value);

  /// @brief Method set_Layers, addr 0x310c314, size 0x8, virtual false, abstract: false, final false
  inline void set_Layers(::System::Collections::Generic::List_1<::Amazon::Lambda::Model::Layer*>* value);

  /// @brief Method set_MasterArn, addr 0x310c378, size 0x8, virtual false, abstract: false, final false
  inline void set_MasterArn(::StringW value);

  /// @brief Method set_MemorySize, addr 0x310c3cc, size 0x68, virtual false, abstract: false, final false
  inline void set_MemorySize(int32_t value);

  /// @brief Method set_PackageType, addr 0x310c478, size 0x8, virtual false, abstract: false, final false
  inline void set_PackageType(::Amazon::Lambda::PackageType* value);

  /// @brief Method set_RevisionId, addr 0x310c4e8, size 0x8, virtual false, abstract: false, final false
  inline void set_RevisionId(::StringW value);

  /// @brief Method set_Role, addr 0x310c508, size 0x8, virtual false, abstract: false, final false
  inline void set_Role(::StringW value);

  /// @brief Method set_Runtime, addr 0x310c528, size 0x8, virtual false, abstract: false, final false
  inline void set_Runtime(::Amazon::Lambda::Runtime* value);

  /// @brief Method set_SigningJobArn, addr 0x310c598, size 0x8, virtual false, abstract: false, final false
  inline void set_SigningJobArn(::StringW value);

  /// @brief Method set_SigningProfileVersionArn, addr 0x310c5b8, size 0x8, virtual false, abstract: false, final false
  inline void set_SigningProfileVersionArn(::StringW value);

  /// @brief Method set_State, addr 0x310c5d8, size 0x8, virtual false, abstract: false, final false
  inline void set_State(::Amazon::Lambda::State* value);

  /// @brief Method set_StateReason, addr 0x310c648, size 0x8, virtual false, abstract: false, final false
  inline void set_StateReason(::StringW value);

  /// @brief Method set_StateReasonCode, addr 0x310c668, size 0x8, virtual false, abstract: false, final false
  inline void set_StateReasonCode(::Amazon::Lambda::StateReasonCode* value);

  /// @brief Method set_Timeout, addr 0x310c70c, size 0x68, virtual false, abstract: false, final false
  inline void set_Timeout(int32_t value);

  /// @brief Method set_TracingConfig, addr 0x310c7b8, size 0x8, virtual false, abstract: false, final false
  inline void set_TracingConfig(::Amazon::Lambda::Model::TracingConfigResponse* value);

  /// @brief Method set_Version, addr 0x310c7d8, size 0x8, virtual false, abstract: false, final false
  inline void set_Version(::StringW value);

  /// @brief Method set_VpcConfig, addr 0x310c7f8, size 0x8, virtual false, abstract: false, final false
  inline void set_VpcConfig(::Amazon::Lambda::Model::VpcConfigDetail* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr UpdateFunctionConfigurationResponse();

public:
  // Ctor Parameters [CppParam { name: "", ty: "UpdateFunctionConfigurationResponse", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UpdateFunctionConfigurationResponse(UpdateFunctionConfigurationResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UpdateFunctionConfigurationResponse", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UpdateFunctionConfigurationResponse(UpdateFunctionConfigurationResponse const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, 0x128>, "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____codeSha256) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____codeSize) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____deadLetterConfig) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____description) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____environment) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____fileSystemConfigs) == 0x58, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____functionArn) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____functionName) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____handler) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____imageConfigResponse) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____kmsKeyArn) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____lastModified) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____lastUpdateStatus) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____lastUpdateStatusReason) == 0x98, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____lastUpdateStatusReasonCode) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____layers) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____masterArn) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____memorySize) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____packageType) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____revisionId) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____role) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____runtime) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____signingJobArn) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____signingProfileVersionArn) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____state) == 0xf0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____stateReason) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____stateReasonCode) == 0x100, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____timeout) == 0x108, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____tracingConfig) == 0x110, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____version) == 0x118, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse, ____vpcConfig) == 0x120, "Offset mismatch!");

} // namespace Amazon::Lambda::Model
NEED_NO_BOX(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::UpdateFunctionConfigurationResponse*, "Amazon.Lambda.Model", "UpdateFunctionConfigurationResponse");
