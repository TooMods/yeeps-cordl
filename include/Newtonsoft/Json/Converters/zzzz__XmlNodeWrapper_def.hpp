...
public:
  ...
  /// @brief Method AppendChild, addr 0x2f56838, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method WrapNode, addr 0x2f560f4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f55184, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* node);

  /// @brief Method get_Attributes, addr 0x2f5629c, size 0x428, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes();

  /// @brief Method get_ChildNodes, addr 0x2f55cc4, size 0x430, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_HasAttributes, addr 0x2f566c4, size 0xb4, virtual false, abstract: false, final false
  inline bool get_HasAttributes();

  /// @brief Method get_HasChildNodes, addr 0x2f56278, size 0x24, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_LocalName, addr 0x2f55ca0, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x2f568dc, size 0x24, virtual true, abstract: false, final true
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_NodeType, addr 0x2f55c80, size 0x20, virtual true, abstract: false, final true
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_ParentNode, addr 0x2f56778, size 0xa0, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode();

  /// @brief Method get_Value, addr 0x2f56818, size 0x20, virtual true, abstract: false, final true
  inline ::StringW get_Value();

  /// @brief Method get_WrappedNode, addr 0x2f55c78, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_WrappedNode();

  /// @brief Convert to "::Newtonsoft::Json::Converters::IXmlNode"
  constexpr ::Newtonsoft::Json::Converters::IXmlNode* i___Newtonsoft__Json__Converters__IXmlNode() noexcept;

  /// @brief Method set_Value, addr 0x2f558a4, size 0x20, virtual true, abstract: false, final true
