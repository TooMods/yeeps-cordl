...
// SizeInfo { instance_size: 2, native_size: 2, calculated_instance_size: 2, calculated_native_size: 18, minimum_alignment: 1, natural_alignment: 2, packing: Some(1), specified_packing: Some(0) }
namespace Unity::Profiling {
// Is value type: true
...
public:
  ...
  /// @brief Method ToString, addr 0x27e0a74, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Name, addr 0x27e0878, size 0x80, virtual false, abstract: false, final false
