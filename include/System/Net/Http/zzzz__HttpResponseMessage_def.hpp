...
public:
  ...
  /// @brief Method Dispose, addr 0x161ea38, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x161ea48, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureSuccessStatusCode, addr 0x161be78, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x161ea7c, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1617864, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpStatusCode statusCode);

  /// @brief Method get_Content, addr 0x161e91c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpContent* get_Content();

  /// @brief Method get_Headers, addr 0x16179d0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpResponseHeaders* get_Headers();

  /// @brief Method get_IsSuccessStatusCode, addr 0x161e98c, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsSuccessStatusCode();

  /// @brief Method get_ReasonPhrase, addr 0x161e9a0, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_ReasonPhrase();

  /// @brief Method get_StatusCode, addr 0x161e9cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpStatusCode get_StatusCode();

  /// @brief Method get_Version, addr 0x161e9d4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Content, addr 0x161e924, size 0x8, virtual false, abstract: false, final false
  inline void set_Content(::System::Net::Http::HttpContent* value);

  /// @brief Method set_ReasonPhrase, addr 0x161e9bc, size 0x8, virtual false, abstract: false, final false
  inline void set_ReasonPhrase(::StringW value);

  /// @brief Method set_RequestMessage, addr 0x161e9c4, size 0x8, virtual false, abstract: false, final false
  inline void set_RequestMessage(::System::Net::Http::HttpRequestMessage* value);

  /// @brief Method set_StatusCode, addr 0x161e8cc, size 0x50, virtual false, abstract: false, final false
