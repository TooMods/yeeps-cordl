...
public:
  ...
  /// @brief Method GetPointerType, addr 0x2cce3e8, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW GetPointerType(int32_t pointerId);

  /// @brief Method IsDirectManipulationDevice, addr 0x2cce484, size 0x8c, virtual false, abstract: false, final false
