...
public:
  ...
  /// @brief Method Create, addr 0x12361f8, size 0x1f4, virtual true, abstract: false, final false
  inline ::System::Net::EndPoint* Create(::System::Net::SocketAddress* socketAddress);

  /// @brief Method Equals, addr 0x12363ec, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0x12364a0, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::IPEndPoint* New_ctor(::System::Net::IPAddress* address, int32_t port);

  /// @brief Method Serialize, addr 0x1236188, size 0x70, virtual true, abstract: false, final false
  inline ::System::Net::SocketAddress* Serialize();

  /// @brief Method ToString, addr 0x12360c8, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1235ff8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Address, addr 0x12360b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::IPAddress* get_Address();

  /// @brief Method get_AddressFamily, addr 0x1235fcc, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Net::Sockets::AddressFamily get_AddressFamily();

  /// @brief Method get_Port, addr 0x12360c0, size 0x8, virtual false, abstract: false, final false
