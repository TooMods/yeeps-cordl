...
public:
  ...
  /// @brief Method .ctor, addr 0x21dc834, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alias, addr 0x21dc738, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_alias();

  /// @brief Method get_aliases, addr 0x21dc748, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_aliases();

  /// @brief Method get_arraySize, addr 0x21dc798, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_arraySize();

  /// @brief Method get_bit, addr 0x21dc768, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_bit();

  /// @brief Method get_defaultState, addr 0x21dc804, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_defaultState();

  /// @brief Method get_displayName, addr 0x21dc7a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_dontReset, addr 0x21dc7f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_dontReset();

  /// @brief Method get_format, addr 0x21dc6e8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_format();

  /// @brief Method get_layout, addr 0x21dc6b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_layout();

  /// @brief Method get_maxValue, addr 0x21dc824, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_maxValue();

  /// @brief Method get_minValue, addr 0x21dc814, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_minValue();

  /// @brief Method get_name, addr 0x21dc6d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_noisy, addr 0x21dc7c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_noisy();

  /// @brief Method get_offset, addr 0x21dc778, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_offset();

  /// @brief Method get_parameters, addr 0x21dc718, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_parameters();

  /// @brief Method get_processors, addr 0x21dc728, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processors();

  /// @brief Method get_shortDisplayName, addr 0x21dc7b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shortDisplayName();

  /// @brief Method get_sizeInBits, addr 0x21dc788, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_sizeInBits();

  /// @brief Method get_synthetic, addr 0x21dc7dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_synthetic();

  /// @brief Method get_usage, addr 0x21dc6f8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_usage();

  /// @brief Method get_usages, addr 0x21dc708, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_usages();

  /// @brief Method get_useStateFrom, addr 0x21dc758, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_useStateFrom();

  /// @brief Method get_variants, addr 0x21dc6c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_variants();

  /// @brief Method set_alias, addr 0x21dc740, size 0x8, virtual false, abstract: false, final false
  inline void set_alias(::StringW value);

  /// @brief Method set_aliases, addr 0x21dc750, size 0x8, virtual false, abstract: false, final false
  inline void set_aliases(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_arraySize, addr 0x21dc7a0, size 0x8, virtual false, abstract: false, final false
  inline void set_arraySize(int32_t value);

  /// @brief Method set_bit, addr 0x21dc770, size 0x8, virtual false, abstract: false, final false
  inline void set_bit(uint32_t value);

  /// @brief Method set_defaultState, addr 0x21dc80c, size 0x8, virtual false, abstract: false, final false
  inline void set_defaultState(::System::Object* value);

  /// @brief Method set_displayName, addr 0x21dc7b0, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method set_dontReset, addr 0x21dc7f8, size 0xc, virtual false, abstract: false, final false
  inline void set_dontReset(bool value);

  /// @brief Method set_format, addr 0x21dc6f0, size 0x8, virtual false, abstract: false, final false
  inline void set_format(::StringW value);

  /// @brief Method set_layout, addr 0x21dc6c0, size 0x8, virtual false, abstract: false, final false
  inline void set_layout(::StringW value);

  /// @brief Method set_maxValue, addr 0x21dc82c, size 0x8, virtual false, abstract: false, final false
  inline void set_maxValue(::System::Object* value);

  /// @brief Method set_minValue, addr 0x21dc81c, size 0x8, virtual false, abstract: false, final false
  inline void set_minValue(::System::Object* value);

  /// @brief Method set_name, addr 0x21dc6e0, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_noisy, addr 0x21dc7d0, size 0xc, virtual false, abstract: false, final false
  inline void set_noisy(bool value);

  /// @brief Method set_offset, addr 0x21dc780, size 0x8, virtual false, abstract: false, final false
  inline void set_offset(uint32_t value);

  /// @brief Method set_parameters, addr 0x21dc720, size 0x8, virtual false, abstract: false, final false
  inline void set_parameters(::StringW value);

  /// @brief Method set_processors, addr 0x21dc730, size 0x8, virtual false, abstract: false, final false
  inline void set_processors(::StringW value);

  /// @brief Method set_shortDisplayName, addr 0x21dc7c0, size 0x8, virtual false, abstract: false, final false
  inline void set_shortDisplayName(::StringW value);

  /// @brief Method set_sizeInBits, addr 0x21dc790, size 0x8, virtual false, abstract: false, final false
  inline void set_sizeInBits(uint32_t value);

  /// @brief Method set_synthetic, addr 0x21dc7e4, size 0xc, virtual false, abstract: false, final false
  inline void set_synthetic(bool value);

  /// @brief Method set_usage, addr 0x21dc700, size 0x8, virtual false, abstract: false, final false
  inline void set_usage(::StringW value);

  /// @brief Method set_usages, addr 0x21dc710, size 0x8, virtual false, abstract: false, final false
  inline void set_usages(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_useStateFrom, addr 0x21dc760, size 0x8, virtual false, abstract: false, final false
  inline void set_useStateFrom(::StringW value);

  /// @brief Method set_variants, addr 0x21dc6d0, size 0x8, virtual false, abstract: false, final false
