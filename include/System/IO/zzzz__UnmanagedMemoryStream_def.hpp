...
public:
  ...
  /// @brief Method Dispose, addr 0x2578fc4, size 0x14, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureNotClosed, addr 0x2584054, size 0x34, virtual false, abstract: false, final false
  inline void EnsureNotClosed();

  /// @brief Method EnsureReadable, addr 0x2584088, size 0x3c, virtual false, abstract: false, final false
  inline void EnsureReadable();

  /// @brief Method EnsureWriteable, addr 0x25840c4, size 0x3c, virtual false, abstract: false, final false
  inline void EnsureWriteable();

  /// @brief Method Flush, addr 0x2584100, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x2584104, size 0x174, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Initialize, addr 0x2578798, size 0x208, virtual false, abstract: false, final false
  ...
  static inline ::System::IO::UnmanagedMemoryStream* New_ctor(::cordl_internals::Ptr<uint8_t> pointer, int64_t length);
  ...
  /// @brief Method Read, addr 0x2584444, size 0x1c0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Read, addr 0x2584604, size 0xe4, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> buffer);

  /// @brief Method ReadAsync, addr 0x25846e8, size 0x310, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ReadAsync, addr 0x25849f8, size 0x294, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x2584c8c, size 0x160, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ReadCore, addr 0x25789a4, size 0x22c, virtual false, abstract: false, final false
  inline int32_t ReadCore(::System::Span_1<uint8_t> buffer);

  /// @brief Method Seek, addr 0x2584dec, size 0x110, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin loc);

  /// @brief Method SetLength, addr 0x2584efc, size 0x190, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x258508c, size 0x1ec, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Write, addr 0x2585278, size 0xe4, virtual true, abstract: false, final false
  inline void Write(::System::ReadOnlySpan_1<uint8_t> buffer);

  /// @brief Method WriteAsync, addr 0x258535c, size 0x2c0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method WriteAsync, addr 0x258561c, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteByte, addr 0x2585830, size 0x228, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t value);

  /// @brief Method WriteCore, addr 0x2578bd4, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2578734, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2583f04, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::cordl_internals::Ptr<uint8_t> pointer, int64_t length);

  /// @brief Method .ctor, addr 0x2583f84, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::cordl_internals::Ptr<uint8_t> pointer, int64_t length, int64_t capacity, ::System::IO::FileAccess access);

  /// @brief Method get_CanRead, addr 0x2584014, size 0x1c, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x2584030, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x2584038, size 0x1c, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x2584278, size 0x1c, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x2584294, size 0x48, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_PositionPointer, addr 0x2584384, size 0xc0, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> get_PositionPointer();

  /// @brief Method set_Position, addr 0x25842dc, size 0xa8, virtual true, abstract: false, final false
