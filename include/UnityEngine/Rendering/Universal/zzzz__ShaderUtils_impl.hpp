...
//  Writing Method size for method: ::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::*)()>(
    &::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2730f34;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0*>::get(), ".ctor",
                                                 std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0._GetEnumFromPath_b__0
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::*)(::StringW)>(
    &::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::_GetEnumFromPath_b__0)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x273130c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0*>::get(), "<GetEnumFromPath>b__0",
                                    std::span<Il2CppClass const* const, 0>(), ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get() })));
    return ___internal_method;
  }
};
constexpr ::StringW& UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::__cordl_internal_get_path() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___path;
}
constexpr ::StringW const& UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::__cordl_internal_get_path() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___path;
}
constexpr void UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::__cordl_internal_set_path(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0* UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0*>());
}
inline void UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0*>::get(), ".ctor",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
inline bool UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::_GetEnumFromPath_b__0(::StringW m) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0*>::get(), "<GetEnumFromPath>b__0",
                                  std::span<Il2CppClass const* const, 0>(), ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get() })));
...
// Ctor Parameters []
constexpr ::UnityEngine::Rendering::Universal::__ShaderUtils____c__DisplayClass2_0::__ShaderUtils____c__DisplayClass2_0() {}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::UnityEngine::Rendering::Universal::ShaderPathID)>(
  ...
  constexpr static std::size_t addrs = 0x2730b94;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::Universal::ShaderPathID (*)(::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x2730e34;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::Shader*)>(&::UnityEngine::Rendering::Universal::ShaderUtils::IsLWShader)> {
  ...
  constexpr static std::size_t addrs = 0x2730f3c;
