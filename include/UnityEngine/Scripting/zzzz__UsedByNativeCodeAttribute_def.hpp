...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7640, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a7648, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x23a7670, size 0x8, virtual false, abstract: false, final false
