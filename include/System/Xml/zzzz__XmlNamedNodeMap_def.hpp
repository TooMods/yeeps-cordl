...
public:
  ...
  /// @brief Method MoveNext, addr 0xf9f0c4, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xf9f0e0, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0xf9f040, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value);

  /// @brief Method get_Current, addr 0xf9f070, size 0x54, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0xf9e90c, size 0x11c, virtual false, abstract: false, final false
  inline void Add(::System::Object* value);

  /// @brief Method GetEnumerator, addr 0xf9e694, size 0x100, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method Insert, addr 0xf9ee9c, size 0x1a4, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::System::Object* value);

  /// @brief Method RemoveAt, addr 0xf9ec38, size 0xe4, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method get_Count, addr 0xf9e5e8, size 0xa4, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0xf9e2cc, size 0xe0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNode, addr 0xf9e794, size 0x178, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* AddNode(::System::Xml::XmlNode* node);

  /// @brief Method AddNodeForLoad, addr 0xf9ea28, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* AddNodeForLoad(::System::Xml::XmlNode* node, ::System::Xml::XmlDocument* doc);

  /// @brief Method FindNodeOffset, addr 0xf9e468, size 0x124, virtual false, abstract: false, final false
  inline int32_t FindNodeOffset(::StringW localName, ::StringW namespaceURI);

  /// @brief Method FindNodeOffset, addr 0xf9e1e8, size 0xe4, virtual false, abstract: false, final false
  inline int32_t FindNodeOffset(::StringW name);

  /// @brief Method GetEnumerator, addr 0xf9e68c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetNamedItem, addr 0xf9e150, size 0x98, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* GetNamedItem(::StringW name);

  /// @brief Method InsertNodeAt, addr 0xf9ed1c, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveNodeAt, addr 0xf9ead0, size 0x168, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* RemoveNodeAt(int32_t i);

  /// @brief Method ReplaceNodeAt, addr 0xf9e58c, size 0x54, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ReplaceNodeAt(int32_t i, ::System::Xml::XmlNode* node);

  /// @brief Method SetNamedItem, addr 0xf9e3ac, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf9e128, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* parent);

  /// @brief Method get_Count, addr 0xf9e5e0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();
