...
public:
  ...
  /// @brief Method <Run>b__2_0, addr 0xedd3ec, size 0xf0, virtual false, abstract: false, final false
  inline void _Run_b__2_0(::System::Object* state);

  /// @brief Method .ctor, addr 0xedd3e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Run, addr 0xedcf90, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xed87cc, size 0x30, virtual false, abstract: false, final false
