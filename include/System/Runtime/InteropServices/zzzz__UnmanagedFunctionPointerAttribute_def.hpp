...
public:
  ...
  /// @brief Method .ctor, addr 0x1b4047c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::CallingConvention callingConvention);

  /// @brief Method get_CallingConvention, addr 0x1b404a4, size 0x8, virtual false, abstract: false, final false
