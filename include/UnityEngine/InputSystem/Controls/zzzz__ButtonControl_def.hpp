...
public:
  ...
  /// @brief Method IsValueConsideredPressed, addr 0x226445c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2263bec, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_isPressed, addr 0x22644c8, size 0xa0, virtual false, abstract: false, final false
  inline bool get_isPressed();

  /// @brief Method get_pressPointOrDefault, addr 0x22643f0, size 0x58, virtual false, abstract: false, final false
  inline float_t get_pressPointOrDefault();

  /// @brief Method get_wasPressedThisFrame, addr 0x2264568, size 0x120, virtual false, abstract: false, final false
  inline bool get_wasPressedThisFrame();

  /// @brief Method get_wasReleasedThisFrame, addr 0x2264688, size 0x120, virtual false, abstract: false, final false
