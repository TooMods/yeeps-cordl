...
public:
  ...
  /// @brief Method GetConversion, addr 0x2d26f7c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d26ef4, size 0x48, virtual false, abstract: false, final false
