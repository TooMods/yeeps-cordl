...
public:
  ...
  /// @brief Method AddLabelInfo, addr 0x1a96988, size 0xb0, virtual false, abstract: false, final false
  inline void AddLabelInfo(::System::Linq::Expressions::LabelTarget* target, ::System::Linq::Expressions::Interpreter::LabelInfo* info);

  /// @brief Method ContainsTarget, addr 0x1a96800, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetLabelInfo, addr 0x1a96ec8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1a96e98, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanJumpInto, addr 0x1a96d78, size 0x10, virtual false, abstract: false, final false
