...
public:
  ...
  /// @brief Method AllocateBones, addr 0x16eaf20, size 0xc8, virtual false, abstract: false, final false
  inline void AllocateBones();

  /// @brief Method GetBoneTransform, addr 0x16eaec0, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSkeletonType, addr 0x16eafe8, size 0x88, virtual true, abstract: false, final false
  inline void SetSkeletonType(::GlobalNamespace::__OVRSkeleton__SkeletonType skeletonType);

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x16eaf1c, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x16eaf18, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x16eb070, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CustomBones, addr 0x16eaeb8, size 0x8, virtual false, abstract: false, final false
