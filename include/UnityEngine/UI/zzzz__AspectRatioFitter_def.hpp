...
public:
  ...
  /// @brief Method DoesParentExists, addr 0x26ece34, size 0x8, virtual false, abstract: false, final false
  inline bool DoesParentExists();

  /// @brief Method GetParentSize, addr 0x26ecc24, size 0x110, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetParentSize();

  /// @brief Method GetSizeDeltaToProduceSize, addr 0x26ecd34, size 0xf8, virtual false, abstract: false, final false
  inline float_t GetSizeDeltaToProduceSize(float_t size, int32_t axis);

  /// @brief Method IsAspectModeValid, addr 0x26ec3e0, size 0x28, virtual false, abstract: false, final false
  inline bool IsAspectModeValid();

  /// @brief Method IsComponentValidOnObject, addr 0x26ec314, size 0xcc, virtual false, abstract: false, final false
  inline bool IsComponentValidOnObject();

  static inline ::UnityEngine::UI::AspectRatioFitter* New_ctor();

  /// @brief Method OnDisable, addr 0x26ec408, size 0x7c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26ec22c, size 0x98, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnRectTransformDimensionsChange, addr 0x26ec91c, size 0x4, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method OnTransformParentChanged, addr 0x26ec870, size 0x98, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method SetDirty, addr 0x26ec108, size 0x4, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method SetLayoutHorizontal, addr 0x26ece2c, size 0x4, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x26ece30, size 0x4, virtual true, abstract: false, final false
  inline void SetLayoutVertical();

  /// @brief Method Start, addr 0x26ec2c4, size 0x50, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x26ec908, size 0x14, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateRect, addr 0x26ec920, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ec21c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_aspectMode, addr 0x26ec08c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__AspectRatioFitter__AspectMode get_aspectMode();

  /// @brief Method get_aspectRatio, addr 0x26ec10c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_aspectRatio();

  /// @brief Method get_rectTransform, addr 0x26ec188, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method set_aspectMode, addr 0x26ec094, size 0x74, virtual false, abstract: false, final false
  inline void set_aspectMode(::UnityEngine::UI::__AspectRatioFitter__AspectMode value);

  /// @brief Method set_aspectRatio, addr 0x26ec114, size 0x74, virtual false, abstract: false, final false
