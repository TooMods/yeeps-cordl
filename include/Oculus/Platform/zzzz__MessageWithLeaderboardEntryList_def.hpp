...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3f98, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardEntryList* GetDataFromMessage(void* c_message);

  /// @brief Method GetLeaderboardEntryList, addr 0x19b3f5c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0f6c, size 0x58, virtual false, abstract: false, final false
