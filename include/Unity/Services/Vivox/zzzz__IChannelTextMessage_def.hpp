...
CORDL_MODULE_EXPORT(IChannelTextMessage)
...
// Write type traits
MARK_REF_PTR_T(::Unity::Services::Vivox::IChannelTextMessage);
// Type: Unity.Services.Vivox::IChannelTextMessage
// SizeInfo { instance_size: 0, native_size: -1, calculated_instance_size: 16, calculated_native_size: 16, minimum_alignment: 8, natural_alignment: 0, packing: None, specified_packing: None }
namespace Unity::Services::Vivox {
// Is value type: false
// CS Name: ::Unity.Services.Vivox::IChannelTextMessage*
class CORDL_TYPE IChannelTextMessage {
public:
  // Declarations
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IChannelTextMessage", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IChannelTextMessage(IChannelTextMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IChannelTextMessage", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IChannelTextMessage(IChannelTextMessage const&) = delete;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
} // namespace Unity::Services::Vivox
NEED_NO_BOX(::Unity::Services::Vivox::IChannelTextMessage);
DEFINE_IL2CPP_ARG_TYPE(::Unity::Services::Vivox::IChannelTextMessage*, "Unity.Services.Vivox", "IChannelTextMessage");
