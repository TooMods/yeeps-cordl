...
public:
  ...
  /// @brief Method Apply, addr 0x1eab328, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1eab32c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customBindings, addr 0x1eab248, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_customBindings();

  /// @brief Method get_invertMouseX, addr 0x1eab258, size 0x8, virtual false, abstract: false, final false
  inline bool get_invertMouseX();

  /// @brief Method get_invertMouseY, addr 0x1eab26c, size 0x8, virtual false, abstract: false, final false
  inline bool get_invertMouseY();

  /// @brief Method get_invertStickX, addr 0x1eab2a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_invertStickX();

  /// @brief Method get_invertStickY, addr 0x1eab2b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_invertStickY();

  /// @brief Method get_mouseSensitivity, addr 0x1eab290, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<float_t> get_mouseSensitivity();

  /// @brief Method get_mouseSmoothing, addr 0x1eab280, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<float_t> get_mouseSmoothing();

  /// @brief Method get_swapBumpers, addr 0x1eab2dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_swapBumpers();

  /// @brief Method get_swapDpadAndLeftStick, addr 0x1eab304, size 0x8, virtual false, abstract: false, final false
  inline bool get_swapDpadAndLeftStick();

  /// @brief Method get_swapSticks, addr 0x1eab2c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_swapSticks();

  /// @brief Method get_swapTriggers, addr 0x1eab2f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_swapTriggers();

  /// @brief Method get_vibrationStrength, addr 0x1eab318, size 0x8, virtual false, abstract: false, final false
  inline float_t get_vibrationStrength();

  /// @brief Method set_customBindings, addr 0x1eab250, size 0x8, virtual false, abstract: false, final false
  inline void set_customBindings(::StringW value);

  /// @brief Method set_invertMouseX, addr 0x1eab260, size 0xc, virtual false, abstract: false, final false
  inline void set_invertMouseX(bool value);

  /// @brief Method set_invertMouseY, addr 0x1eab274, size 0xc, virtual false, abstract: false, final false
  inline void set_invertMouseY(bool value);

  /// @brief Method set_invertStickX, addr 0x1eab2a8, size 0xc, virtual false, abstract: false, final false
  inline void set_invertStickX(bool value);

  /// @brief Method set_invertStickY, addr 0x1eab2bc, size 0xc, virtual false, abstract: false, final false
  inline void set_invertStickY(bool value);

  /// @brief Method set_mouseSensitivity, addr 0x1eab298, size 0x8, virtual false, abstract: false, final false
  inline void set_mouseSensitivity(::System::Nullable_1<float_t> value);

  /// @brief Method set_mouseSmoothing, addr 0x1eab288, size 0x8, virtual false, abstract: false, final false
  inline void set_mouseSmoothing(::System::Nullable_1<float_t> value);

  /// @brief Method set_swapBumpers, addr 0x1eab2e4, size 0xc, virtual false, abstract: false, final false
  inline void set_swapBumpers(bool value);

  /// @brief Method set_swapDpadAndLeftStick, addr 0x1eab30c, size 0xc, virtual false, abstract: false, final false
  inline void set_swapDpadAndLeftStick(bool value);

  /// @brief Method set_swapSticks, addr 0x1eab2d0, size 0xc, virtual false, abstract: false, final false
  inline void set_swapSticks(bool value);

  /// @brief Method set_swapTriggers, addr 0x1eab2f8, size 0xc, virtual false, abstract: false, final false
  inline void set_swapTriggers(bool value);

  /// @brief Method set_vibrationStrength, addr 0x1eab320, size 0x8, virtual false, abstract: false, final false
