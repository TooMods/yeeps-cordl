...
public:
  ...
  /// @brief Method Update, addr 0x16a2a08, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16a2a64, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
