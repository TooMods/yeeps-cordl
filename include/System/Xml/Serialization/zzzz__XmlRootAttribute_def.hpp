...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129cbf8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a5d74, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12a5d84, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName);

  /// @brief Method get_DataType, addr 0x12a5db4, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x12a1ce0, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_IsNullable, addr 0x12a5e18, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Namespace, addr 0x12a5e2c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_DataType, addr 0x12a5e08, size 0x8, virtual false, abstract: false, final false
  inline void set_DataType(::StringW value);

  /// @brief Method set_ElementName, addr 0x12a5e10, size 0x8, virtual false, abstract: false, final false
  inline void set_ElementName(::StringW value);

  /// @brief Method set_IsNullable, addr 0x12a5e20, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_Namespace, addr 0x12a5e34, size 0x8, virtual false, abstract: false, final false
