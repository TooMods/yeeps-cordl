...
public:
  ...
  /// @brief Method CreateDefaultProviderImpl, addr 0x242ceb4, size 0x194, virtual false, abstract: false, final false
  static inline ::Mono::Net::Security::MobileTlsProvider* CreateDefaultProviderImpl();

  /// @brief Method GetProvider, addr 0x242d768, size 0x4c, virtual false, abstract: false, final false
  static inline ::Mono::Net::Security::MobileTlsProvider* GetProvider();

  /// @brief Method GetProviderInternal, addr 0x2428d40, size 0x11c, virtual false, abstract: false, final false
  static inline ::Mono::Net::Security::MobileTlsProvider* GetProviderInternal();

  /// @brief Method InitializeInternal, addr 0x242c8fc, size 0x3ac, virtual false, abstract: false, final false
  static inline void InitializeInternal();

  /// @brief Method InitializeProviderRegistration, addr 0x242cca8, size 0x20c, virtual false, abstract: false, final false
  static inline void InitializeProviderRegistration();

  /// @brief Method LookupProvider, addr 0x242d048, size 0x594, virtual false, abstract: false, final false
  static inline ::Mono::Net::Security::MobileTlsProvider* LookupProvider(::StringW name, bool throwOnError);

  /// @brief Method PopulateProviders, addr 0x242d718, size 0x50, virtual false, abstract: false, final false
  static inline void PopulateProviders();

  /// @brief Method PopulateUnityProviders, addr 0x242d5dc, size 0x13c, virtual false, abstract: false, final false
