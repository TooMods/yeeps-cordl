...
public:
  ...
  /// @brief Method GetQualifiedName, addr 0x18ac10c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18ac298, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Xml::Schema::XmlSchemaParticle* getStaticF_Empty();

  /// @brief Method get_IsEmpty, addr 0x18ac058, size 0x6c, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_MaxOccurs, addr 0x18abee4, size 0xc, virtual false, abstract: false, final false
  inline ::System::Decimal get_MaxOccurs();

  /// @brief Method get_MaxOccursString, addr 0x18aba6c, size 0x124, virtual false, abstract: false, final false
  inline ::StringW get_MaxOccursString();

  /// @brief Method get_MinOccurs, addr 0x18abda8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Decimal get_MinOccurs();

  /// @brief Method get_MinOccursString, addr 0x18ab89c, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_MinOccursString();

  /// @brief Method get_NameString, addr 0x18ac0c4, size 0x48, virtual true, abstract: false, final false
  inline ::StringW get_NameString();

  static inline void setStaticF_Empty(::System::Xml::Schema::XmlSchemaParticle* value);

  /// @brief Method set_MaxOccurs, addr 0x18abef0, size 0x168, virtual false, abstract: false, final false
  inline void set_MaxOccurs(::System::Decimal value);

  /// @brief Method set_MaxOccursString, addr 0x18abb90, size 0x218, virtual false, abstract: false, final false
  inline void set_MaxOccursString(::StringW value);

  /// @brief Method set_MinOccurs, addr 0x18abdb4, size 0x130, virtual false, abstract: false, final false
  inline void set_MinOccurs(::System::Decimal value);

  /// @brief Method set_MinOccursString, addr 0x18ab914, size 0x158, virtual false, abstract: false, final false
