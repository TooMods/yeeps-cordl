...
public:
  ...
  /// @brief Method Clone, addr 0x2274fe8, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetFormat, addr 0x2275304, size 0x98, virtual true, abstract: false, final true
  inline ::System::Object* GetFormat(::System::Type* formatType);

  /// @brief Method GetInstance, addr 0x2274d38, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x22749a4, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x22749a0, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x227491c, size 0x84, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method ReadOnly, addr 0x2274c64, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Globalization::NumberFormatInfo* ReadOnly(::System::Globalization::NumberFormatInfo* nfi);

  /// @brief Method ValidateParseStyleFloatingPoint, addr 0x2275474, size 0xcc, virtual false, abstract: false, final false
  static inline void ValidateParseStyleFloatingPoint(::System::Globalization::NumberStyles style);

  /// @brief Method ValidateParseStyleInteger, addr 0x227539c, size 0xd8, virtual false, abstract: false, final false
  static inline void ValidateParseStyleInteger(::System::Globalization::NumberStyles style);

  /// @brief Method VerifyWritable, addr 0x2274b4c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22743c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x22743c8, size 0x554, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrencyDecimalDigits, addr 0x2275054, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrencyDecimalDigits();

  /// @brief Method get_CurrencyDecimalSeparator, addr 0x227505c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrencyDecimalSeparator();

  /// @brief Method get_CurrencyGroupSeparator, addr 0x22751d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrencyGroupSeparator();

  /// @brief Method get_CurrencyGroupSizes, addr 0x227506c, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_CurrencyGroupSizes();

  /// @brief Method get_CurrencyNegativePattern, addr 0x227527c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrencyNegativePattern();

  /// @brief Method get_CurrencyPositivePattern, addr 0x22752c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrencyPositivePattern();

  /// @brief Method get_CurrencySymbol, addr 0x22751dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrencySymbol();

  /// @brief Method get_CurrentInfo, addr 0x2274ef4, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Globalization::NumberFormatInfo* get_CurrentInfo();

  /// @brief Method get_InvariantInfo, addr 0x2274bc0, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Globalization::NumberFormatInfo* get_InvariantInfo();

  /// @brief Method get_IsReadOnly, addr 0x2275064, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_NaNSymbol, addr 0x22751e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NaNSymbol();

  /// @brief Method get_NegativeInfinitySymbol, addr 0x227529c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NegativeInfinitySymbol();

  /// @brief Method get_NegativeSign, addr 0x22752a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NegativeSign();

  /// @brief Method get_NumberDecimalDigits, addr 0x22752ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NumberDecimalDigits();

  /// @brief Method get_NumberDecimalSeparator, addr 0x22752b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NumberDecimalSeparator();

  /// @brief Method get_NumberGroupSeparator, addr 0x22752bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NumberGroupSeparator();

  /// @brief Method get_NumberGroupSizes, addr 0x22750e4, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_NumberGroupSizes();

  /// @brief Method get_NumberNegativePattern, addr 0x2275284, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NumberNegativePattern();

  /// @brief Method get_PerMilleSymbol, addr 0x22752fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PerMilleSymbol();

  /// @brief Method get_PercentDecimalDigits, addr 0x22752dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PercentDecimalDigits();

  /// @brief Method get_PercentDecimalSeparator, addr 0x22752e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PercentDecimalSeparator();

  /// @brief Method get_PercentGroupSeparator, addr 0x22752ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PercentGroupSeparator();

  /// @brief Method get_PercentGroupSizes, addr 0x227515c, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_PercentGroupSizes();

  /// @brief Method get_PercentNegativePattern, addr 0x2275294, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PercentNegativePattern();

  /// @brief Method get_PercentPositivePattern, addr 0x227528c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PercentPositivePattern();

  /// @brief Method get_PercentSymbol, addr 0x22752f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PercentSymbol();

  /// @brief Method get_PositiveInfinitySymbol, addr 0x22752cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PositiveInfinitySymbol();

  /// @brief Method get_PositiveSign, addr 0x22752d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_NaNSymbol, addr 0x22751ec, size 0x90, virtual false, abstract: false, final false
