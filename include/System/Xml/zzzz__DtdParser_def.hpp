...
public:
  ...
  /// @brief Method .ctor, addr 0x1244210, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1244250, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddUndeclaredNotation, addr 0xfac6d8, size 0x160, virtual false, abstract: false, final false
  inline void AddUndeclaredNotation(::StringW notationName);

  /// @brief Method Create, addr 0xfa7e50, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::IDtdParser* Create();

  /// @brief Method EatPublicKeyword, addr 0xfb05b4, size 0xe4, virtual false, abstract: false, final false
  inline bool EatPublicKeyword();

  /// @brief Method EatSystemKeyword, addr 0xfb0698, size 0xe4, virtual false, abstract: false, final false
  inline bool EatSystemKeyword();

  /// @brief Method GetNameQualified, addr 0xfa9914, size 0x170, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* GetNameQualified(bool canHavePrefix);

  /// @brief Method GetNameString, addr 0xfac6bc, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW GetNameString();

  /// @brief Method GetNmtokenString, addr 0xfac838, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW GetNmtokenString();

  /// @brief Method GetToken, addr 0xfa901c, size 0x8ac, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token GetToken(bool needWhiteSpace);

  /// @brief Method GetValue, addr 0xfac8b4, size 0x5c, virtual false, abstract: false, final false
  inline ::StringW GetValue();

  /// @brief Method GetValueWithStrippedSpaces, addr 0xfac854, size 0x60, virtual false, abstract: false, final false
  inline ::StringW GetValueWithStrippedSpaces();

  /// @brief Method HandleEntityEnd, addr 0xfb0290, size 0x1a8, virtual false, abstract: false, final false
  inline bool HandleEntityEnd(bool inLiteral);

  /// @brief Method HandleEntityReference, addr 0xfb1a50, size 0x1298, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEntityReference, addr 0xfad570, size 0x50, virtual false, abstract: false, final false
  inline bool HandleEntityReference(bool paramEntity, bool inLiteral, bool inAttribute);

  /// @brief Method Initialize, addr 0xfa7ea8, size 0x3d0, virtual false, abstract: false, final false
  inline void Initialize(::System::Xml::IDtdParserAdapter* readerAdapter);

  /// @brief Method InitializeFreeFloatingDtd, addr 0xfa8278, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAttributeValueType, addr 0xfac5e8, size 0xc, virtual false, abstract: false, final false
  inline bool IsAttributeValueType(::System::Xml::__DtdParser__Token token);

  /// @brief Method LoadParsingBuffer, addr 0xfa8ea0, size 0x17c, virtual false, abstract: false, final false
  inline void LoadParsingBuffer();

  static inline ::System::Xml::DtdParser* New_ctor();

  /// @brief Method OnUnexpectedError, addr 0xfa98c8, size 0x4c, virtual false, abstract: false, final false
  inline void OnUnexpectedError();

  /// @brief Method Parse, addr 0xfa86f4, size 0x25c, virtual false, abstract: false, final false
  inline void Parse(bool saveInternalSubset);

  /// @brief Method ParseAttlistDecl, addr 0xfaa4a4, size 0x5c8, virtual false, abstract: false, final false
  inline void ParseAttlistDecl();

  /// @brief Method ParseAttlistDefault, addr 0xfac434, size 0x1b4, virtual false, abstract: false, final false
  inline void ParseAttlistDefault(::System::Xml::Schema::SchemaAttDef* attrDef, bool ignoreErrors);

  /// @brief Method ParseAttlistType, addr 0xfabed8, size 0x55c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseComment, addr 0xfab350, size 0x244, virtual false, abstract: false, final false
  inline void ParseComment();

  /// @brief Method ParseCondSection, addr 0xfab760, size 0x224, virtual false, abstract: false, final false
  inline void ParseCondSection();

  /// @brief Method ParseElementDecl, addr 0xfaaa6c, size 0x394, virtual false, abstract: false, final false
  inline void ParseElementDecl();

  /// @brief Method ParseElementMixedContent, addr 0xfac910, size 0x2a4, virtual false, abstract: false, final false
  inline void ParseElementMixedContent(::System::Xml::Schema::ParticleContentValidator* pcv, int32_t startParenEntityId);

  /// @brief Method ParseElementOnlyContent, addr 0xfacbb4, size 0x350, virtual false, abstract: false, final false
  inline void ParseElementOnlyContent(::System::Xml::Schema::ParticleContentValidator* pcv, int32_t startParenEntityId);

  /// @brief Method ParseEntityDecl, addr 0xfaae00, size 0x35c, virtual false, abstract: false, final false
  inline void ParseEntityDecl();

  /// @brief Method ParseExternalId, addr 0xfa9a84, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExternalSubset, addr 0xfa9fa4, size 0x1a4, virtual false, abstract: false, final false
  inline void ParseExternalSubset();

  /// @brief Method ParseFreeFloatingDtd, addr 0xfa8a94, size 0x54, virtual false, abstract: false, final false
  inline void ParseFreeFloatingDtd();

  /// @brief Method ParseHowMany, addr 0xfacf04, size 0x70, virtual false, abstract: false, final false
  inline void ParseHowMany(::System::Xml::Schema::ParticleContentValidator* pcv);

  /// @brief Method ParseInDocumentDtd, addr 0xfa8ae8, size 0x150, virtual false, abstract: false, final false
  inline void ParseInDocumentDtd(bool saveInternalSubset);

  /// @brief Method ParseInternalSubset, addr 0xfa9fa0, size 0x4, virtual false, abstract: false, final false
  inline void ParseInternalSubset();

  /// @brief Method ParseNotationDecl, addr 0xfab15c, size 0x1f4, virtual false, abstract: false, final false
  inline void ParseNotationDecl();

  /// @brief Method ParsePI, addr 0xfab594, size 0x164, virtual false, abstract: false, final false
  inline void ParsePI();

  /// @brief Method ParseSubset, addr 0xfaa148, size 0x35c, virtual false, abstract: false, final false
  inline void ParseSubset();

  /// @brief Method ParseUnexpectedToken, addr 0xfad5c0, size 0xbc, virtual false, abstract: false, final false
  inline ::StringW ParseUnexpectedToken(int32_t startPos);

  /// @brief Method ReadData, addr 0xfb01cc, size 0xc4, virtual false, abstract: false, final false
  inline int32_t ReadData();

  /// @brief Method ReadDataInName, addr 0xfb17e4, size 0x44, virtual false, abstract: false, final false
  inline bool ReadDataInName();

  /// @brief Method SaveParsingBuffer, addr 0xfa9f98, size 0x8, virtual false, abstract: false, final false
  inline void SaveParsingBuffer();

  /// @brief Method SaveParsingBuffer, addr 0xfaba60, size 0x14c, virtual false, abstract: false, final false
  inline void SaveParsingBuffer(int32_t internalSubsetValueEndPos);

  /// @brief Method ScanAttlist1, addr 0xfae688, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist1();

  /// @brief Method ScanAttlist2, addr 0xfae74c, size 0x680, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist2();

  /// @brief Method ScanAttlist3, addr 0xfaedcc, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist3();

  /// @brief Method ScanAttlist4, addr 0xfaee6c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist4();

  /// @brief Method ScanAttlist5, addr 0xfaef3c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist5();

  /// @brief Method ScanAttlist6, addr 0xfaf00c, size 0x374, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist6();

  /// @brief Method ScanAttlist7, addr 0xfaf380, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanAttlist7();

  /// @brief Method ScanClosingTag, addr 0xfb0138, size 0x94, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanClosingTag();

  /// @brief Method ScanCondSection1, addr 0xfaf9b8, size 0x29c, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanCondSection1();

  /// @brief Method ScanCondSection2, addr 0xfafc54, size 0x98, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanCondSection2();

  /// @brief Method ScanCondSection3, addr 0xfafcec, size 0x44c, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanCondSection3();

  /// @brief Method ScanDoctype1, addr 0xfadde8, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanDoctype1();

  /// @brief Method ScanDoctype2, addr 0xfadf04, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanDoctype2();

  /// @brief Method ScanElement1, addr 0xfadfac, size 0x1d0, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement1();

  /// @brief Method ScanElement2, addr 0xfae17c, size 0x1a4, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement2();

  /// @brief Method ScanElement3, addr 0xfae320, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement3();

  /// @brief Method ScanElement4, addr 0xfae3a0, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement4();

  /// @brief Method ScanElement5, addr 0xfae46c, size 0xec, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement5();

  /// @brief Method ScanElement6, addr 0xfae558, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement6();

  /// @brief Method ScanElement7, addr 0xfae628, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanElement7();

  /// @brief Method ScanEntity1, addr 0xfaf704, size 0x74, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanEntity1();

  /// @brief Method ScanEntity2, addr 0xfaf778, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanEntity2();

  /// @brief Method ScanEntity3, addr 0xfaf8a4, size 0x114, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanEntity3();

  /// @brief Method ScanEntityName, addr 0xfb1204, size 0x160, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ScanEntityName();

  /// @brief Method ScanLiteral, addr 0xfb077c, size 0xa88, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanLiteral(::System::Xml::__DtdParser__LiteralType literalType);

  /// @brief Method ScanName, addr 0xfb0438, size 0x8, virtual false, abstract: false, final false
  inline void ScanName();

  /// @brief Method ScanNameExpected, addr 0xfad67c, size 0x24, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanNameExpected();

  /// @brief Method ScanNmtoken, addr 0xfb0448, size 0x16c, virtual false, abstract: false, final false
  inline void ScanNmtoken();

  /// @brief Method ScanNmtokenExpected, addr 0xfad6c4, size 0x20, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanNmtokenExpected();

  /// @brief Method ScanNotation1, addr 0xfaf43c, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanNotation1();

  /// @brief Method ScanPublicId1, addr 0xfaf5e8, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanPublicId1();

  /// @brief Method ScanPublicId2, addr 0xfaf69c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanPublicId2();

  /// @brief Method ScanQName, addr 0xfb0440, size 0x8, virtual false, abstract: false, final false
  inline void ScanQName();

  /// @brief Method ScanQName, addr 0xfb1564, size 0x280, virtual false, abstract: false, final false
  inline void ScanQName(bool isQName);

  /// @brief Method ScanQNameExpected, addr 0xfad6a0, size 0x24, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanQNameExpected();

  /// @brief Method ScanSubsetContent, addr 0xfad6e4, size 0x704, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanSubsetContent();

  /// @brief Method ScanSystemId, addr 0xfaf534, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Xml::__DtdParser__Token ScanSystemId();

  /// @brief Method SendValidationEvent, addr 0xfab984, size 0xdc, virtual false, abstract: false, final false
  inline void SendValidationEvent(int32_t pos, ::System::Xml::Schema::XmlSeverityType severity, ::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0xfac5f4, size 0xc8, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSeverityType severity, ::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0xfa8d5c, size 0x144, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSeverityType severity, ::System::Xml::Schema::XmlSchemaException* e);

  /// @brief Method StripSpaces, addr 0xfb1828, size 0x228, virtual false, abstract: false, final false
  static inline ::StringW StripSpaces(::StringW value);

  /// @brief Method System.Xml.IDtdParser.ParseFreeFloatingDtd, addr 0xfa8950, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdParser.ParseInternalDtd, addr 0xfa86c4, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method Throw, addr 0xfab6f8, size 0x68, virtual false, abstract: false, final false
  inline void Throw(int32_t curPos, ::StringW res);

  /// @brief Method Throw, addr 0xfacf74, size 0x1e8, virtual false, abstract: false, final false
  inline void Throw(int32_t curPos, ::StringW res, ::StringW arg);

  /// @brief Method Throw, addr 0xfad308, size 0x1e8, virtual false, abstract: false, final false
  inline void Throw(int32_t curPos, ::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method Throw, addr 0xfabd08, size 0x1d0, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::StringW arg, int32_t lineNo, int32_t linePos);

  /// @brief Method ThrowInvalidChar, addr 0xfad4f0, size 0x80, virtual false, abstract: false, final false
  inline void ThrowInvalidChar(::ArrayW<char16_t, ::Array<char16_t>*> data, int32_t length, int32_t invCharPos);

  /// @brief Method ThrowInvalidChar, addr 0xfa8648, size 0x7c, virtual false, abstract: false, final false
  inline void ThrowInvalidChar(int32_t pos, ::StringW data, int32_t invCharPos);

  /// @brief Method ThrowUnexpectedToken, addr 0xfabbac, size 0x8, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken);

  /// @brief Method ThrowUnexpectedToken, addr 0xfad15c, size 0x1ac, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken1, ::StringW expectedToken2);

  /// @brief Method VerifyEntityReference, addr 0xfb1364, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa7dc8, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseUriStr, addr 0xfa8c38, size 0x124, virtual false, abstract: false, final false
  inline ::StringW get_BaseUriStr();

  /// @brief Method get_IgnoreEntityReferences, addr 0xfa8984, size 0x10, virtual false, abstract: false, final false
  inline bool get_IgnoreEntityReferences();

  /// @brief Method get_LineNo, addr 0xfabbb4, size 0xa4, virtual false, abstract: false, final false
  inline int32_t get_LineNo();

  /// @brief Method get_LinePos, addr 0xfabc58, size 0xb0, virtual false, abstract: false, final false
  inline int32_t get_LinePos();

  /// @brief Method get_Normalize, addr 0xfa8a8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Normalize();

  /// @brief Method get_ParsingInternalSubset, addr 0xfa8974, size 0x10, virtual false, abstract: false, final false
  inline bool get_ParsingInternalSubset();

  /// @brief Method get_ParsingTopLevelMarkup, addr 0xfa8a54, size 0x30, virtual false, abstract: false, final false
  inline bool get_ParsingTopLevelMarkup();

  /// @brief Method get_SaveInternalSubsetValue, addr 0xfa8994, size 0xc0, virtual false, abstract: false, final false
  inline bool get_SaveInternalSubsetValue();

  /// @brief Method get_SupportNamespaces, addr 0xfa8a84, size 0x8, virtual false, abstract: false, final false
