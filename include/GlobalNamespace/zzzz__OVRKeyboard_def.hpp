...
public:
  ...
  /// @brief Method GetKeyboardState, addr 0x14db9b0, size 0x154, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRKeyboard__TrackedKeyboardState GetKeyboardState();

  /// @brief Method GetSystemKeyboardInfo, addr 0x14dbb04, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method StopKeyboardTracking, addr 0x14dbbe8, size 0x50, virtual false, abstract: false, final false
