...
public:
  // Declarations
  /// @brief Method IsActive, addr 0x1c74380, size 0x20, virtual false, abstract: false, final false
  static inline bool IsActive(::UnityEngine::InputSystem::TouchPhase phase);

  /// @brief Method IsEndedOrCanceled, addr 0x1c74a4c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsEndedOrCanceled(::UnityEngine::InputSystem::TouchPhase phase);

  /// @brief Method IsInProgress, addr 0x1c74a3c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsInProgress(::UnityEngine::InputSystem::InputActionPhase phase);

  /// @brief Method IsModifierKey, addr 0x1c74a5c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsModifierKey(::UnityEngine::InputSystem::Key key);

  /// @brief Method IsTextInputKey, addr 0x1c74a6c, size 0x2c, virtual false, abstract: false, final false
