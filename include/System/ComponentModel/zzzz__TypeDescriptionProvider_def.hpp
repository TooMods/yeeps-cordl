...
public:
  ...
  /// @brief Method .ctor, addr 0x1b0e0ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateInstance, addr 0x1b0def4, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCache, addr 0x1b0e004, size 0x18, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* GetCache(::System::Object* instance);

  /// @brief Method GetExtendedTypeDescriptor, addr 0x1b0e01c, size 0x90, virtual true, abstract: false, final false
  inline ::System::ComponentModel::ICustomTypeDescriptor* GetExtendedTypeDescriptor(::System::Object* instance);

  /// @brief Method GetExtenderProviders, addr 0x1b0e0b4, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetFullComponentName, addr 0x1b0e1a8, size 0xd4, virtual true, abstract: false, final false
  inline ::StringW GetFullComponentName(::System::Object* component);

  /// @brief Method GetReflectionType, addr 0x1b0e318, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Type* GetReflectionType(::System::Object* instance);

  /// @brief Method GetReflectionType, addr 0x1b0e308, size 0x10, virtual false, abstract: false, final false
  inline ::System::Type* GetReflectionType(::System::Type* objectType);

  /// @brief Method GetReflectionType, addr 0x1b0e3a4, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Type* GetReflectionType(::System::Type* objectType, ::System::Object* instance);

  /// @brief Method GetRuntimeType, addr 0x1b0e3c0, size 0x180, virtual true, abstract: false, final false
  inline ::System::Type* GetRuntimeType(::System::Type* reflectionType);

  /// @brief Method GetTypeDescriptor, addr 0x1b0e27c, size 0x8c, virtual false, abstract: false, final false
  inline ::System::ComponentModel::ICustomTypeDescriptor* GetTypeDescriptor(::System::Object* instance);

  /// @brief Method GetTypeDescriptor, addr 0x1b0e540, size 0x10, virtual false, abstract: false, final false
  inline ::System::ComponentModel::ICustomTypeDescriptor* GetTypeDescriptor(::System::Type* objectType);

  /// @brief Method GetTypeDescriptor, addr 0x1b0e550, size 0xa4, virtual true, abstract: false, final false
  inline ::System::ComponentModel::ICustomTypeDescriptor* GetTypeDescriptor(::System::Type* objectType, ::System::Object* instance);

  /// @brief Method IsSupportedType, addr 0x1b0e5f4, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b0dec4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1b0decc, size 0x28, virtual false, abstract: false, final false
