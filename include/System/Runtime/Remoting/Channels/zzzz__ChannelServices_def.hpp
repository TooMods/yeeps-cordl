...
public:
  ...
  /// @brief Method CheckIncomingMessage, addr 0x18575b8, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckReturnMessage, addr 0x1857860, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientChannelSinkChain, addr 0x1855b34, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientChannelSinkChain, addr 0x18552b8, size 0x87c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateProvider, addr 0x18571f8, size 0x318, virtual false, abstract: false, final false
  static inline ::System::Object* CreateProvider(::System::Runtime::Remoting::ProviderData* prov);

  /// @brief Method GetCurrentChannelInfo, addr 0x1857b4c, size 0x500, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCurrentChannelInfo();

  /// @brief Method IsLocalCall, addr 0x1857a30, size 0x8, virtual false, abstract: false, final false
  static inline bool IsLocalCall(::System::Runtime::Remoting::Messaging::IMessage* callMsg);

  /// @brief Method RegisterChannel, addr 0x1855d3c, size 0x58, virtual false, abstract: false, final false
  static inline void RegisterChannel(::System::Runtime::Remoting::Channels::IChannel* chnl);

  /// @brief Method RegisterChannel, addr 0x1855d94, size 0x87c, virtual false, abstract: false, final false
  static inline void RegisterChannel(::System::Runtime::Remoting::Channels::IChannel* chnl, bool ensureSecurity);

  /// @brief Method RegisterChannelConfig, addr 0x1856610, size 0xbe8, virtual false, abstract: false, final false
  static inline void RegisterChannelConfig(::System::Runtime::Remoting::ChannelData* channel);

  /// @brief Method SyncDispatchMessage, addr 0x1857510, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CrossContextChannel, addr 0x1855260, size 0x58, virtual false, abstract: false, final false
