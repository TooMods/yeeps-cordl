...
public:
  ...
  /// @brief Method Awake, addr 0x16fc5f8, size 0x194, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRSceneSampleController* New_ctor();

  /// @brief Method Start, addr 0x16fc78c, size 0xcc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x16fc858, size 0xd4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateRecenterPose, addr 0x16fc92c, size 0xb0, virtual false, abstract: false, final false
  inline void UpdateRecenterPose();

  /// @brief Method UpdateSpeedAndRotationScaleMultiplier, addr 0x16fca98, size 0xc4, virtual false, abstract: false, final false
  inline void UpdateSpeedAndRotationScaleMultiplier();

  /// @brief Method UpdateVisionMode, addr 0x16fc9dc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16fcb5c, size 0x106c, virtual false, abstract: false, final false
  inline void _ctor();
