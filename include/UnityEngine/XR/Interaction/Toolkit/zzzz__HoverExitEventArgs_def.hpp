...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::HoverExitEventArgs);
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cfe98c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_interactableObject, addr 0x2cec864, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::Interaction::Toolkit::IXRHoverInteractable* get_interactableObject();

  /// @brief Method get_interactorObject, addr 0x2cfe8ec, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::Interaction::Toolkit::IXRHoverInteractor* get_interactorObject();

  /// @brief Method get_isCanceled, addr 0x2cfe978, size 0x8, virtual false, abstract: false, final false
  inline bool get_isCanceled();

  /// @brief Method get_manager, addr 0x2cfe968, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::XR::Interaction::Toolkit::XRInteractionManager> get_manager();

  /// @brief Method set_interactableObject, addr 0x2cfe960, size 0x8, virtual false, abstract: false, final false
  inline void set_interactableObject(::UnityEngine::XR::Interaction::Toolkit::IXRHoverInteractable* value);

  /// @brief Method set_interactorObject, addr 0x2cfe958, size 0x8, virtual false, abstract: false, final false
  inline void set_interactorObject(::UnityEngine::XR::Interaction::Toolkit::IXRHoverInteractor* value);

  /// @brief Method set_isCanceled, addr 0x2cfe980, size 0xc, virtual false, abstract: false, final false
  inline void set_isCanceled(bool value);

  /// @brief Method set_manager, addr 0x2cfe970, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HoverExitEventArgs", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HoverExitEventArgs(HoverExitEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HoverExitEventArgs", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::XR::Interaction::Toolkit::HoverExitEventArgs, 0x30>, "Size mismatch!");
