...
public:
  // Declarations
  /// @brief Method GetByteCount, addr 0x1e11674, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e11888, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e117f8, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetBytes, addr 0x1e11bc0, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e11e3c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e11960, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x1e11f3c, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e120c0, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars, addr 0x1e12198, size 0x27c, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x1e12414, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x1e126dc, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x1e12740, size 0x60, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetString, addr 0x1e12514, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e1166c, size 0x8, virtual false, abstract: false, final false
