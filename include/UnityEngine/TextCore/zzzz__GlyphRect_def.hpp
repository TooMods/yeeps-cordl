...
public:
  ...
  /// @brief Method Equals, addr 0x2902950, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x29029c8, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::GlyphRect other);

  /// @brief Method GetHashCode, addr 0x29028ec, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x29028e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_height, addr 0x2902880, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method get_width, addr 0x2902878, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method get_x, addr 0x2902868, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_x();

  /// @brief Method get_y, addr 0x2902870, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_y();

  /// @brief Method get_zero, addr 0x2902888, size 0x58, virtual false, abstract: false, final false
