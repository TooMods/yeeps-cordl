...
public:
  ...
  /// @brief Method GenerateGlobalSeed, addr 0x2eff358, size 0x24, virtual false, abstract: false, final false
  static inline int32_t GenerateGlobalSeed();

  /// @brief Method GenerateSeed, addr 0x2efef38, size 0x1c0, virtual false, abstract: false, final false
  static inline int32_t GenerateSeed();

  /// @brief Method GetSampleForLargeRange, addr 0x2eff380, size 0x4c, virtual false, abstract: false, final false
  inline double_t GetSampleForLargeRange();

  /// @brief Method InternalSample, addr 0x2eff2c8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x2eff37c, size 0x4, virtual true, abstract: false, final false
  inline int32_t Next();

  /// @brief Method Next, addr 0x2eff4e8, size 0xc8, virtual true, abstract: false, final false
  inline int32_t Next(int32_t maxValue);

  /// @brief Method Next, addr 0x2eff3cc, size 0x11c, virtual true, abstract: false, final false
  inline int32_t Next(int32_t minValue, int32_t maxValue);

  /// @brief Method NextDouble, addr 0x2eff5b0, size 0xc, virtual true, abstract: false, final false
  inline double_t NextDouble();

  /// @brief Method Sample, addr 0x2eff2a8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2efeedc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2eff0f8, size 0x1b0, virtual false, abstract: false, final false
