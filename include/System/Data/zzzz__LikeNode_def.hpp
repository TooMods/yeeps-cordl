...
public:
  ...
  /// @brief Method AnalyzePattern, addr 0x193e674, size 0x2c4, virtual false, abstract: false, final false
  inline ::StringW AnalyzePattern(::StringW pat);

  /// @brief Method Eval, addr 0x193e158, size 0x51c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x193e114, size 0x44, virtual false, abstract: false, final false
