...
public:
  ...
  /// @brief Method AppendEntry, addr 0x246389c, size 0x7c4, virtual false, abstract: false, final false
  static inline void AppendEntry(::System::Text::StringBuilder* sb, ::Mono::Security::ASN1* entry, bool quotes);

  /// @brief Method ToString, addr 0x245c084, size 0x138, virtual false, abstract: false, final false
  static inline ::StringW ToString(::Mono::Security::ASN1* seq);

  /// @brief Method ToString, addr 0x2464060, size 0x1a8, virtual false, abstract: false, final false
