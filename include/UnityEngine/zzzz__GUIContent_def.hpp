...
public:
  ...
  /// @brief Method ClearStaticCache, addr 0x2d174cc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Temp, addr 0x2d0c87c, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIContent* Temp(::StringW t);

  /// @brief Method ToString, addr 0x2d17b60, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d17a1c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d0be58, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GUIContent* src);

  /// @brief Method .ctor, addr 0x2d17a78, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x2d17adc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_text, addr 0x2d179fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_tooltip, addr 0x2d0ddb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_image, addr 0x2d17a0c, size 0x8, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::Texture* value);

  /// @brief Method set_text, addr 0x2d17a04, size 0x8, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_tooltip, addr 0x2d17a14, size 0x8, virtual false, abstract: false, final false
