...
public:
  ...
  /// @brief Method Black, addr 0x29dec34, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Black();

  /// @brief Method Convert, addr 0x29de8fc, size 0x338, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Convert(::UnityEngine::Color color, float_t intensity);

  /// @brief Method get_blue, addr 0x29de840, size 0x8, virtual false, abstract: false, final false
  inline float_t get_blue();

  /// @brief Method get_green, addr 0x29de784, size 0x8, virtual false, abstract: false, final false
  inline float_t get_green();

  /// @brief Method get_red, addr 0x29de6c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_red();

  /// @brief Method set_blue, addr 0x29de848, size 0xb4, virtual false, abstract: false, final false
  inline void set_blue(float_t value);

  /// @brief Method set_green, addr 0x29de78c, size 0xb4, virtual false, abstract: false, final false
  inline void set_green(float_t value);

  /// @brief Method set_red, addr 0x29de6d0, size 0xb4, virtual false, abstract: false, final false
