...
public:
  ...
  /// @brief Method EndInliningScope, addr 0xedc4e8, size 0x14, virtual false, abstract: false, final false
  inline void EndInliningScope();

  static inline ::System::Threading::Tasks::StackGuard* New_ctor();

  /// @brief Method TryBeginInliningScope, addr 0xedc4a8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed5fd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
