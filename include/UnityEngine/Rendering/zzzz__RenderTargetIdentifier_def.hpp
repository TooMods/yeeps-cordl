...
public:
  ...
  /// @brief Method Equals, addr 0x2a909c4, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a9092c, size 0x98, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderTargetIdentifier rhs);

  /// @brief Method GetHashCode, addr 0x2a908e0, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x2a90638, size 0x2a8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2a904e0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::RenderBuffer buf, int32_t mipLevel, ::UnityEngine::CubemapFace cubeFace, int32_t depthSlice);

  /// @brief Method .ctor, addr 0x2a900d0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x2a90150, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(int32_t nameID);

  /// @brief Method .ctor, addr 0x2a901c4, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(int32_t nameID, int32_t mipLevel, ::UnityEngine::CubemapFace cubeFace, int32_t depthSlice);

  /// @brief Method .ctor, addr 0x2a8d27c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a90248, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture* tex);

  /// @brief Method .ctor, addr 0x2a9038c, size 0x154, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture* tex, int32_t mipLevel, ::UnityEngine::CubemapFace cubeFace, int32_t depthSlice);

  /// @brief Method .ctor, addr 0x2a9005c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2a90a54, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2a90578, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2a905e8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2a90500, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x2a90a84, size 0x34, virtual false, abstract: false, final false
