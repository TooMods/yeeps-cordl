...
public:
  ...
  /// @brief Method Acquire, addr 0x30368d4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x3035d2c, size 0x90, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x3036b00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::__UIRAtlasAllocator__Row*>* getStaticF_s_Pool();

  /// @brief Method get_offsetX, addr 0x3036ac8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetX();

  /// @brief Method get_offsetY, addr 0x3036ad8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetY();

  /// @brief Method get_width, addr 0x3036ae8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_height, addr 0x3036af8, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_offsetX, addr 0x3036ad0, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetX(int32_t value);

  /// @brief Method set_offsetY, addr 0x3036ae0, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetY(int32_t value);

  /// @brief Method set_width, addr 0x3036af0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Acquire, addr 0x3036138, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::__UIRAtlasAllocator__AreaNode* Acquire(::UnityEngine::RectInt rect);

  /// @brief Method AddAfter, addr 0x30369a8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x3035dbc, size 0x80, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method RemoveFromChain, addr 0x3036980, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3036b98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildAreas, addr 0x30361d0, size 0x10c, virtual false, abstract: false, final false
  inline void BuildAreas();

  /// @brief Method Dispose, addr 0x3035c30, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x3035c9c, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetLog2OfNextPower, addr 0x3035e3c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAllocate, addr 0x30362dc, size 0x3e0, virtual false, abstract: false, final false
  inline bool TryAllocate(int32_t width, int32_t height, ByRef<::UnityEngine::RectInt> location);

  /// @brief Method TryPartitionArea, addr 0x30366bc, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3035f6c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x3035c1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_maxAtlasSize, addr 0x3035bc4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxAtlasSize();

  /// @brief Method get_maxImageHeight, addr 0x3035bd4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageHeight();

  /// @brief Method get_maxImageWidth, addr 0x3035bcc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageWidth();

  /// @brief Method get_physicalHeight, addr 0x3035c0c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalHeight();

  /// @brief Method get_physicalWidth, addr 0x3035bfc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalWidth();

  /// @brief Method get_virtualHeight, addr 0x3035bec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_virtualHeight();

  /// @brief Method get_virtualWidth, addr 0x3035bdc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x3035c24, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_physicalHeight, addr 0x3035c14, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalHeight(int32_t value);

  /// @brief Method set_physicalWidth, addr 0x3035c04, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalWidth(int32_t value);

  /// @brief Method set_virtualHeight, addr 0x3035bf4, size 0x8, virtual false, abstract: false, final false
  inline void set_virtualHeight(int32_t value);

  /// @brief Method set_virtualWidth, addr 0x3035be4, size 0x8, virtual false, abstract: false, final false
