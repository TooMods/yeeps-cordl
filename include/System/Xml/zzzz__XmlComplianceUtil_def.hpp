...
public:
  // Declarations
  /// @brief Method CDataNormalize, addr 0x1245e78, size 0x1e4, virtual false, abstract: false, final false
  static inline ::StringW CDataNormalize(::StringW value);

  /// @brief Method NonCDataNormalize, addr 0x1245bec, size 0x28c, virtual false, abstract: false, final false
