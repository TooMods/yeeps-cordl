...
public:
  ...
  /// @brief Method Equals, addr 0x1d03434, size 0x104, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1d03538, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTypeFromClass, addr 0x1d03560, size 0x4, virtual false, abstract: false, final false
  static inline void* GetTypeFromClass(::cordl_internals::Ptr<::Mono::__RuntimeStructs__MonoClass> klass);

  /// @brief Method GetTypeHandle, addr 0x1d03564, size 0x8, virtual false, abstract: false, final false
  inline ::System::RuntimeTypeHandle GetTypeHandle();

  /// @brief Method .ctor, addr 0x1d0340c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(void* ptr);

  /// @brief Method .ctor, addr 0x1d03404, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::cordl_internals::Ptr<::Mono::__RuntimeStructs__MonoClass> value);

  /// @brief Method get_Value, addr 0x1d0342c, size 0x8, virtual false, abstract: false, final false
