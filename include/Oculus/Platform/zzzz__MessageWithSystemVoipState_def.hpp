...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5858, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SystemVoipState* GetDataFromMessage(void* c_message);

  /// @brief Method GetSystemVoipState, addr 0x19b581c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b159c, size 0x58, virtual false, abstract: false, final false
