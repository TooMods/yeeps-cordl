...
public:
  ...
  /// @brief Method Equals, addr 0x29e13ec, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Playables::TextureMixerPlayable other);

  /// @brief Method GetHandle, addr 0x29e13e0, size 0xc, virtual true, abstract: false, final true
