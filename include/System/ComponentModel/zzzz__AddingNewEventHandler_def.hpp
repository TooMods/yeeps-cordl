...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x1ae8e64, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x1ae8e8c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x1ae8e50, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ae8d20, size 0x130, virtual false, abstract: false, final false
