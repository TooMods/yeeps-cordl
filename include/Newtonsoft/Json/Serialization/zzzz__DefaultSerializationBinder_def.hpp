...
public:
  ...
  /// @brief Method BindToName, addr 0xf0c1a8, size 0x68, virtual true, abstract: false, final false
  inline void BindToName(::System::Type* serializedType, ByRef<::StringW> assemblyName, ByRef<::StringW> typeName);

  /// @brief Method BindToType, addr 0xf0c12c, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Type* BindToType(::StringW assemblyName, ::StringW typeName);

  /// @brief Method GetGenericTypeFromTypeName, addr 0xf0be04, size 0x2c0, virtual false, abstract: false, final false
  inline ::System::Type* GetGenericTypeFromTypeName(::StringW typeName, ::System::Reflection::Assembly* assembly);

  /// @brief Method GetTypeByName, addr 0xf0c0c4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Type* GetTypeByName(::Newtonsoft::Json::Utilities::StructMultiKey_2<::StringW, ::StringW> typeNameKey);

  /// @brief Method GetTypeFromTypeNameKey, addr 0xf0ba04, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0b938, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
