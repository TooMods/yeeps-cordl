...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b41f8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingApplicationStatus* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingApplicationStatus, addr 0x19b41bc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b4164, size 0x58, virtual false, abstract: false, final false
