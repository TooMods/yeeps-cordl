...
public:
  ...
  /// @brief Method .ctor, addr 0x2e8db24, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t intValue, ::StringW stringValue);

  /// @brief Method .ctor, addr 0x2e8db18, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method get_Int32, addr 0x2e8db30, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Int32();

  /// @brief Method get_Object, addr 0x2e8d3f8, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Object* get_Object();

  /// @brief Method get_String, addr 0x2e8d3a4, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_String();

  /// @brief Method op_Implicit, addr 0x2e8a5e0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x2e8ca8c, size 0x28, virtual false, abstract: false, final false
  inline void Clear();

  static inline ::System::__ParameterizedStrings__LowLevelStack* New_ctor();

  /// @brief Method Pop, addr 0x2e8d310, size 0x94, virtual false, abstract: false, final false
  inline ::System::__ParameterizedStrings__FormatParam Pop();

  /// @brief Method Push, addr 0x2e8d6a8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e8ca3c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AsBool, addr 0x2e8d890, size 0xc, virtual false, abstract: false, final false
  static inline bool AsBool(int32_t i);

  /// @brief Method AsInt, addr 0x2e8d888, size 0x8, virtual false, abstract: false, final false
  static inline int32_t AsInt(bool b);

  /// @brief Method Evaluate, addr 0x2e8a5ec, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateInternal, addr 0x2e8cab4, size 0x85c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatPrintF, addr 0x2e8d454, size 0x254, virtual false, abstract: false, final false
  static inline ::StringW FormatPrintF(::StringW format, ::System::Object* arg);

  /// @brief Method GetDynamicOrStaticVariables, addr 0x2e8d780, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method StringFromAsciiBytes, addr 0x2e8d89c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method snprintf, addr 0x2e8d994, size 0xcc, virtual false, abstract: false, final false
  static inline int32_t snprintf(::cordl_internals::Ptr<uint8_t> str, void* size, ::StringW format, ::StringW arg1);

  /// @brief Method snprintf, addr 0x2e8da60, size 0xb8, virtual false, abstract: false, final false
