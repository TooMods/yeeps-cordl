...
public:
  ...
  /// @brief Method GetObjectData, addr 0x1aa88c8, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x1aa8998, size 0xdc, virtual true, abstract: false, final true
