...
public:
  ...
  /// @brief Method GetArgument, addr 0x182e7e8, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method get_AddMethod, addr 0x182e7d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_AddMethod();

  /// @brief Method get_ArgumentCount, addr 0x182e840, size 0x50, virtual true, abstract: false, final true
  inline int32_t get_ArgumentCount();

  /// @brief Method get_Arguments, addr 0x182e7e0, size 0x8, virtual false, abstract: false, final false
