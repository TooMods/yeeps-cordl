...
public:
  ...
  /// @brief Method BeginRead, addr 0x2de1858, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x2de1b4c, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x2de20dc, size 0x14, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method EndRead, addr 0x2de1a28, size 0x124, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* r);

  /// @brief Method EndWrite, addr 0x2de1d1c, size 0xf8, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* r);

  /// @brief Method Flush, addr 0x2de200c, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x2de2010, size 0xc0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method GetException, addr 0x2de139c, size 0x168, virtual false, abstract: false, final false
  inline ::System::Exception* GetException(::System::Exception* e);

  /// @brief Method InternalClose, addr 0x2de20d0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2de1554, size 0x2a4, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Seek, addr 0x2de20f0, size 0x50, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t a, ::System::IO::SeekOrigin b);

  /// @brief Method SetLength, addr 0x2de2140, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x2de1e14, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2de11cc, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebConnection* cnc, ::System::Net::WebOperation* operation);

  /// @brief Method get_CanSeek, addr 0x2de2190, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x2de12bc, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_Connection, addr 0x2de1290, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* get_Connection();

  /// @brief Method get_Length, addr 0x2de2198, size 0x50, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Operation, addr 0x2de1298, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* get_Operation();

  /// @brief Method get_Position, addr 0x2de21e8, size 0x50, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_ReadTimeout, addr 0x2de12c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_Request, addr 0x2de1288, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Method get_ServicePoint, addr 0x2de12a0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method get_WriteTimeout, addr 0x2de1330, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_Position, addr 0x2de2238, size 0x50, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x2de12cc, size 0x64, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_WriteTimeout, addr 0x2de1338, size 0x64, virtual true, abstract: false, final false
