...
public:
  ...
  /// @brief Method ExpandTree, addr 0x3052544, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x305247c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Decimal min, ::System::Decimal max);

  /// @brief Method .ctor, addr 0x30524c4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(int32_t pos, ::System::Decimal min, ::System::Decimal max);

  /// @brief Method get_IsRangeNode, addr 0x305253c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsRangeNode();

  /// @brief Method get_Max, addr 0x3052514, size 0xc, virtual false, abstract: false, final false
  inline ::System::Decimal get_Max();

  /// @brief Method get_Min, addr 0x3052520, size 0xc, virtual false, abstract: false, final false
  inline ::System::Decimal get_Min();

  /// @brief Method get_NextIteration, addr 0x305252c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BitSet* get_NextIteration();

  /// @brief Method set_NextIteration, addr 0x3052534, size 0x8, virtual false, abstract: false, final false
