...
public:
  ...
  /// @brief Method .ctor, addr 0x30453a0, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AttributeName, addr 0x30453ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AttributeName();

  /// @brief Method get_MappedType, addr 0x3045414, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* get_MappedType();

  /// @brief Method get_Namespace, addr 0x30453fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_AttributeName, addr 0x30453f4, size 0x8, virtual false, abstract: false, final false
  inline void set_AttributeName(::StringW value);

  /// @brief Method set_Form, addr 0x304540c, size 0x8, virtual false, abstract: false, final false
  inline void set_Form(::System::Xml::Schema::XmlSchemaForm value);

  /// @brief Method set_MappedType, addr 0x304541c, size 0x8, virtual false, abstract: false, final false
  inline void set_MappedType(::System::Xml::Serialization::XmlTypeMapping* value);

  /// @brief Method set_Namespace, addr 0x3045404, size 0x8, virtual false, abstract: false, final false
