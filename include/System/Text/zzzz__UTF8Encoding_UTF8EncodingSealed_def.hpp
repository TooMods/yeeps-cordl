...
public:
  ...
  /// @brief Method .ctor, addr 0x1e971c4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(bool encoderShouldEmitUTF8Identifier);

  /// @brief Method get_Preamble, addr 0x1e9722c, size 0xd4, virtual true, abstract: false, final false
