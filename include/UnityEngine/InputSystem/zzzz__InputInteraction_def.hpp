...
public:
  ...
  /// @brief Method GetDisplayName, addr 0x18fa23c, size 0x104, virtual false, abstract: false, final false
  static inline ::StringW GetDisplayName(::StringW interaction);

  /// @brief Method GetDisplayName, addr 0x18fa340, size 0x198, virtual false, abstract: false, final false
  static inline ::StringW GetDisplayName(::System::Type* interactionType);

  /// @brief Method GetValueType, addr 0x18fa148, size 0xf4, virtual false, abstract: false, final false
