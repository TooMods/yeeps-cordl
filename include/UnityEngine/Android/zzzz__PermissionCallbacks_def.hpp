...
public:
  ...
  /// @brief Method .ctor, addr 0x2f53c3c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PermissionDenied, addr 0x2f5397c, size 0xb0, virtual false, abstract: false, final false
  inline void add_PermissionDenied(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionDeniedAndDontAskAgain, addr 0x2f53adc, size 0xb0, virtual false, abstract: false, final false
  inline void add_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionGranted, addr 0x2f5381c, size 0xb0, virtual false, abstract: false, final false
  inline void add_PermissionGranted(::System::Action_1<::StringW>* value);

  /// @brief Method onPermissionDenied, addr 0x2f53cc4, size 0x1c, virtual false, abstract: false, final false
  inline void onPermissionDenied(::StringW permissionName);

  /// @brief Method onPermissionDeniedAndDontAskAgain, addr 0x2f53ce0, size 0x24, virtual false, abstract: false, final false
  inline void onPermissionDeniedAndDontAskAgain(::StringW permissionName);

  /// @brief Method onPermissionGranted, addr 0x2f53ca8, size 0x1c, virtual false, abstract: false, final false
  inline void onPermissionGranted(::StringW permissionName);

  /// @brief Method remove_PermissionDenied, addr 0x2f53a2c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_PermissionDenied(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionDeniedAndDontAskAgain, addr 0x2f53b8c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionGranted, addr 0x2f538cc, size 0xb0, virtual false, abstract: false, final false
