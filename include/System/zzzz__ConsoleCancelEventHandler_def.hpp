...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2f0edbc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f0ec8c, size 0x130, virtual false, abstract: false, final false
