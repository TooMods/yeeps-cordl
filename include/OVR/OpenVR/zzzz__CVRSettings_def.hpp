...
public:
  ...
  /// @brief Method GetBool, addr 0x2a79d68, size 0x24, virtual false, abstract: false, final false
  inline bool GetBool(::StringW pchSection, ::StringW pchSettingsKey, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetFloat, addr 0x2a79db0, size 0x24, virtual false, abstract: false, final false
  inline float_t GetFloat(::StringW pchSection, ::StringW pchSettingsKey, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetInt32, addr 0x2a79d8c, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetInt32(::StringW pchSection, ::StringW pchSettingsKey, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetSettingsErrorNameFromEnum, addr 0x2a79c28, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetSettingsErrorNameFromEnum(::OVR::OpenVR::EVRSettingsError eError);

  /// @brief Method GetString, addr 0x2a79dd4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Sync, addr 0x2a79cac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a79b14, size 0x114, virtual false, abstract: false, final false
