...
public:
  ...
  /// @brief Method <GetFlexibleHeight>b__8_0, addr 0x26f334c, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetFlexibleHeight_b__8_0(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetFlexibleWidth>b__5_0, addr 0x26f30cc, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetFlexibleWidth_b__5_0(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetMinHeight>b__6_0, addr 0x26f316c, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetMinHeight_b__6_0(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetMinWidth>b__3_0, addr 0x26f2eec, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetMinWidth_b__3_0(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetPreferredHeight>b__7_0, addr 0x26f320c, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetPreferredHeight_b__7_0(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetPreferredHeight>b__7_1, addr 0x26f32ac, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetPreferredHeight_b__7_1(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetPreferredWidth>b__4_0, addr 0x26f2f8c, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetPreferredWidth_b__4_0(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method <GetPreferredWidth>b__4_1, addr 0x26f302c, size 0xa0, virtual false, abstract: false, final false
  inline float_t _GetPreferredWidth_b__4_1(::UnityEngine::UI::ILayoutElement* e);

  /// @brief Method .ctor, addr 0x26f2ee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetFlexibleHeight, addr 0x26f2978, size 0xf0, virtual false, abstract: false, final false
  static inline float_t GetFlexibleHeight(::UnityEngine::RectTransform* rect);

  /// @brief Method GetFlexibleSize, addr 0x26f0224, size 0xc, virtual false, abstract: false, final false
  static inline float_t GetFlexibleSize(::UnityEngine::RectTransform* rect, int32_t axis);

  /// @brief Method GetFlexibleWidth, addr 0x26f2a68, size 0xf0, virtual false, abstract: false, final false
  static inline float_t GetFlexibleWidth(::UnityEngine::RectTransform* rect);

  /// @brief Method GetLayoutProperty, addr 0x26f2b58, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLayoutProperty, addr 0x26f2b70, size 0x310, virtual false, abstract: false, final false
  static inline float_t GetLayoutProperty(::UnityEngine::RectTransform* rect, ::System::Func_2<::UnityEngine::UI::ILayoutElement*, float_t>* property, float_t defaultValue,
                                          ByRef<::UnityEngine::UI::ILayoutElement*> source);

  /// @brief Method GetMinHeight, addr 0x26f2470, size 0xf0, virtual false, abstract: false, final false
  static inline float_t GetMinHeight(::UnityEngine::RectTransform* rect);

  /// @brief Method GetMinSize, addr 0x26ed90c, size 0xc, virtual false, abstract: false, final false
  static inline float_t GetMinSize(::UnityEngine::RectTransform* rect, int32_t axis);

  /// @brief Method GetMinWidth, addr 0x26f2560, size 0xf0, virtual false, abstract: false, final false
  static inline float_t GetMinWidth(::UnityEngine::RectTransform* rect);

  /// @brief Method GetPreferredHeight, addr 0x26f2650, size 0x194, virtual false, abstract: false, final false
  static inline float_t GetPreferredHeight(::UnityEngine::RectTransform* rect);

  /// @brief Method GetPreferredSize, addr 0x26ed918, size 0xc, virtual false, abstract: false, final false
  static inline float_t GetPreferredSize(::UnityEngine::RectTransform* rect, int32_t axis);

  /// @brief Method GetPreferredWidth, addr 0x26f27e4, size 0x194, virtual false, abstract: false, final false
