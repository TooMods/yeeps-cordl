...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x1252a6c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12525b8, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Atomize, addr 0x1252750, size 0x54, virtual false, abstract: false, final false
  inline void Atomize(::System::Xml::XmlNameTable* nameTable);

  /// @brief Method Clone, addr 0x125295c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* Clone();

  /// @brief Method Equals, addr 0x1252388, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x1252094, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCodeDelegate, addr 0x1252160, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::Xml::__XmlQualifiedName__HashCodeOfStringDelegate* GetHashCodeDelegate();

  /// @brief Method GetHashCodeOfString, addr 0x1252690, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetHashCodeOfString(::StringW s, int32_t length, int64_t additionalEntropy);

  /// @brief Method Init, addr 0x12526ac, size 0xc, virtual false, abstract: false, final false
  inline void Init(::StringW name, ::StringW ns);

  /// @brief Method IsRandomizedHashingDisabled, addr 0x12525b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x12527a4, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* Parse(::StringW s, ::System::Xml::IXmlNamespaceResolver* nsmgr, ByRef<::StringW> prefix);

  /// @brief Method SetNamespace, addr 0x12526b8, size 0x8, virtual false, abstract: false, final false
  inline void SetNamespace(::StringW ns);

  /// @brief Method ToString, addr 0x1252318, size 0x70, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x1252540, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW ToString(::StringW name, ::StringW ns);

  /// @brief Method Verify, addr 0x12526c0, size 0x90, virtual false, abstract: false, final false
  inline void Verify();
  ...
  /// @brief Method .ctor, addr 0x1251f44, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1252024, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x1251f98, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x12522dc, size 0x3c, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Name, addr 0x125208c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x1252084, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method op_Equality, addr 0x12524d8, size 0x68, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::XmlQualifiedName* a, ::System::Xml::XmlQualifiedName* b);

  /// @brief Method op_Inequality, addr 0x1252468, size 0x70, virtual false, abstract: false, final false
