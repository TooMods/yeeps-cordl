...
public:
  ...
  /// @brief Method Bind, addr 0x1c959e4, size 0x238, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method DependsOn, addr 0x1c95df4, size 0x6c, virtual true, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Eval, addr 0x1c95c1c, size 0x28, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x1c95ce0, size 0x34, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t, ::Array<int32_t>*> records);

  /// @brief Method Eval, addr 0x1c95c44, size 0x9c, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method HasLocalAggregate, addr 0x1c95d64, size 0x48, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x1c95dac, size 0x48, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x1c95d14, size 0x8, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x1c95d1c, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method Optimize, addr 0x1c95e60, size 0x4, virtual true, abstract: false, final false
  inline ::System::Data::ExpressionNode* Optimize();

  /// @brief Method ParseName, addr 0x1c957a8, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c959a0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::StringW name);

  /// @brief Method .ctor, addr 0x1c95760, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t pos);

  /// @brief Method get_IsSqlColumn, addr 0x1c959c8, size 0x1c, virtual true, abstract: false, final false
