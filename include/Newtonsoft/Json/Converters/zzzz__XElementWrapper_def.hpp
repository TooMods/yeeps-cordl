...
public:
  ...
  /// @brief Method AppendChild, addr 0x2f590e4, size 0x18, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* AppendChild(::Newtonsoft::Json::Converters::IXmlNode* newChild);

  /// @brief Method GetPrefixOfNamespace, addr 0x2f590a4, size 0x40, virtual true, abstract: false, final true
  inline ::StringW GetPrefixOfNamespace(::StringW namespaceUri);

  /// @brief Method HasImplicitNamespaceAttribute, addr 0x2f58bf4, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeNode, addr 0x2f585f0, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f57734, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XElement* element);

  /// @brief Method get_Attributes, addr 0x2f58694, size 0x560, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes();

  /// @brief Method get_Element, addr 0x2f58578, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XElement* get_Element();

  /// @brief Method get_IsEmpty, addr 0x2f59184, size 0x1c, virtual true, abstract: false, final true
  inline bool get_IsEmpty();

  /// @brief Method get_LocalName, addr 0x2f5913c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x2f59160, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_Value, addr 0x2f590fc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Value, addr 0x2f59118, size 0x24, virtual true, abstract: false, final false
