...
template <typename T> inline void UnityEngine::Rendering::__ListPool_1____c<T>::setStaticF___9(::UnityEngine::Rendering::__ListPool_1____c<T>* value) {
  ::cordl_internals::setStaticField<::UnityEngine::Rendering::__ListPool_1____c<T>*, "<>9",
                                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::__ListPool_1____c<T>*>::get>(
      std::forward<::UnityEngine::Rendering::__ListPool_1____c<T>*>(value));
}
template <typename T> inline ::UnityEngine::Rendering::__ListPool_1____c<T>* UnityEngine::Rendering::__ListPool_1____c<T>::getStaticF___9() {
  return ::cordl_internals::getStaticField<::UnityEngine::Rendering::__ListPool_1____c<T>*, "<>9",
                                           ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::__ListPool_1____c<T>*>::get>();
}
template <typename T> inline ::UnityEngine::Rendering::__ListPool_1____c<T>* UnityEngine::Rendering::__ListPool_1____c<T>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::__ListPool_1____c<T>*>());
}
template <typename T> inline void UnityEngine::Rendering::__ListPool_1____c<T>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::__ListPool_1____c<T>*>::get(), ".ctor",
                                                                             std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
template <typename T> inline void UnityEngine::Rendering::__ListPool_1____c<T>::__cctor_b__4_0(::System::Collections::Generic::List_1<T>* l) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::__ListPool_1____c<T>*>::get(), "<.cctor>b__4_0", std::span<Il2CppClass const* const, 0>(),
...
// Ctor Parameters []
template <typename T> constexpr ::UnityEngine::Rendering::__ListPool_1____c<T>::__ListPool_1____c() {}
...
template <typename T>
inline ::UnityEngine::Rendering::__ObjectPool_1__PooledObject<::System::Collections::Generic::List_1<T>*>
UnityEngine::Rendering::ListPool_1<T>::Get(ByRef<::System::Collections::Generic::List_1<T>*> value) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ListPool_1<T>*>::get(), "Get", std::span<Il2CppClass const* const, 0>(),
  ...
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::Rendering::__ObjectPool_1__PooledObject<::System::Collections::Generic::List_1<T>*>, false>(nullptr, ___internal_method, value);
}
