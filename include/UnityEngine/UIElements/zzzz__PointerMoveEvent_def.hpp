...
public:
  ...
  /// @brief Method Init, addr 0x2cceaa8, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cceaf8, size 0x10c, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerMoveEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x2ccec54, size 0x608, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ccec04, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isHandledByDraggable, addr 0x2ccea94, size 0x8, virtual false, abstract: false, final false
  inline bool get_isHandledByDraggable();

  /// @brief Method set_isHandledByDraggable, addr 0x2ccea9c, size 0xc, virtual false, abstract: false, final false
