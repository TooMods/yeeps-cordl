...
public:
  ...
  /// @brief Method GetKey, addr 0x1033e10, size 0x90, virtual false, abstract: false, final false
  inline ::StringW GetKey();

  /// @brief Method GetKeywordAndValue, addr 0x1033c00, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x1033a24, size 0x1dc, virtual false, abstract: false, final false
  inline bool Parse();

  /// @brief Method SkipWhitespace, addr 0x1033d90, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1033898, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  static inline ::ArrayW<::StringW, ::Array<::StringW>*> getStaticF_keywords();

  /// @brief Method get_Algorithm, addr 0x10339cc, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Algorithm();

  /// @brief Method get_Nonce, addr 0x10339a0, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Nonce();

  /// @brief Method get_Opaque, addr 0x1033974, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Opaque();

  /// @brief Method get_QOP, addr 0x10339f8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_QOP();

  /// @brief Method get_Realm, addr 0x103394c, size 0x28, virtual false, abstract: false, final false
