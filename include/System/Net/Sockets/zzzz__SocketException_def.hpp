...
public:
  ...
  /// @brief Method WSAGetLastError_icall, addr 0x2c8d430, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c8d434, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2c8d454, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x2c89824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t errorCode);

  /// @brief Method .ctor, addr 0x2c8d45c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x2c8cb30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::SocketError socketError);

  /// @brief Method get_ErrorCode, addr 0x2c8d464, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ErrorCode();

  /// @brief Method get_Message, addr 0x2c8d46c, size 0x90, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_SocketErrorCode, addr 0x2c8b278, size 0x8, virtual false, abstract: false, final false
