...
public:
  ...
  /// @brief Method CancelOperation, addr 0x12ba8d8, size 0xc, virtual false, abstract: false, final false
  inline void CancelOperation();

  /// @brief Method Close, addr 0x12ba558, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x12ba568, size 0x370, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method WaitUtilEOF, addr 0x12ba8e4, size 0x44, virtual false, abstract: false, final false
