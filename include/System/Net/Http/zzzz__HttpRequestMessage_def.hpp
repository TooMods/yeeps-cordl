...
public:
  ...
  /// @brief Method Dispose, addr 0x161e60c, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x161e61c, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method IsAllowedAbsoluteUri, addr 0x161e4c0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIsUsed, addr 0x161ad60, size 0x20, virtual false, abstract: false, final false
  inline bool SetIsUsed();

  /// @brief Method ToString, addr 0x161e650, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x161e354, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x161a82c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::HttpMethod* method, ::StringW requestUri);

  /// @brief Method .ctor, addr 0x161aa14, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::HttpMethod* method, ::System::Uri* requestUri);

  /// @brief Method get_Content, addr 0x161e4a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpContent* get_Content();

  /// @brief Method get_Headers, addr 0x1617218, size 0x68, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpRequestHeaders* get_Headers();

  /// @brief Method get_Method, addr 0x161e4b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpMethod* get_Method();

  /// @brief Method get_RequestUri, addr 0x161e4b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_Version, addr 0x16171b4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Content, addr 0x161e4a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Content(::System::Net::Http::HttpContent* value);

  /// @brief Method set_Method, addr 0x161e3f0, size 0xb0, virtual false, abstract: false, final false
  inline void set_Method(::System::Net::Http::HttpMethod* value);

  /// @brief Method set_RequestUri, addr 0x1617ae8, size 0xe4, virtual false, abstract: false, final false
