...
public:
  ...
  /// @brief Method .ctor, addr 0x185460c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FindProperty, addr 0x18544a8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyMessage, addr 0x1852300, size 0x65c, virtual false, abstract: false, final false
  inline void NotifyMessage(bool start, ::System::Runtime::Remoting::Messaging::IMessage* msg, bool client_site, bool async);

  /// @brief Method RegisterDynamicProperty, addr 0x1851cbc, size 0x2ec, virtual false, abstract: false, final false
  inline bool RegisterDynamicProperty(::System::Runtime::Remoting::Contexts::IDynamicProperty* prop);

  /// @brief Method UnregisterDynamicProperty, addr 0x1852020, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1852198, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasProperties, addr 0x1851a30, size 0x30, virtual false, abstract: false, final false
