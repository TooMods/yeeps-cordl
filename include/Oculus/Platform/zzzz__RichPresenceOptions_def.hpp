...
public:
  ...
  /// @brief Method Finalize, addr 0x19c2a00, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19c299c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x19c0ff8, size 0x58, virtual false, abstract: false, final false
