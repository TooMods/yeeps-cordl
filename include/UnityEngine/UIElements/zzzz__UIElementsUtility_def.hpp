...
public:
  ...
  /// @brief Method BeginContainerGUI, addr 0x27ce020, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEvent, addr 0x27ce4b4, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event* systemEvent);

  /// @brief Method CreateEvent, addr 0x27ce528, size 0x29c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event* systemEvent, ::UnityEngine::EventType eventType);

  /// @brief Method DoDispatch, addr 0x27cd6d0, size 0x690, virtual false, abstract: false, final false
  static inline bool DoDispatch(::UnityEngine::UIElements::BaseVisualElementPanel* panel);

  /// @brief Method EndContainerGUI, addr 0x27ce290, size 0x224, virtual false, abstract: false, final false
  static inline void EndContainerGUI(::UnityEngine::Event* evt, ::UnityEngine::Rect layoutSize);

  /// @brief Method GetAllPanels, addr 0x27ce7c4, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPanelsIterator, addr 0x27ce91c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method PixelsPerUnitScaleForElement, addr 0x27ce9c4, size 0xa8, virtual false, abstract: false, final false
  static inline float_t PixelsPerUnitScaleForElement(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::Sprite* sprite);

  /// @brief Method RegisterCachedPanel, addr 0x27cde80, size 0x90, virtual false, abstract: false, final false
  static inline void RegisterCachedPanel(int32_t instanceID, ::UnityEngine::UIElements::Panel* panel);

  /// @brief Method RemoveCachedPanel, addr 0x27cdf10, size 0x80, virtual false, abstract: false, final false
  static inline void RemoveCachedPanel(int32_t instanceID);

  /// @brief Method TryGetPanel, addr 0x27cdf90, size 0x90, virtual false, abstract: false, final false
  static inline bool TryGetPanel(int32_t instanceID, ByRef<::UnityEngine::UIElements::Panel*> panel);

  /// @brief Method UnityEngine.UIElements.IUIElementsUtility.CleanupRoots, addr 0x27cdd60, size 0x60, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_IUIElementsUtility_CleanupRoots();

  /// @brief Method UnityEngine.UIElements.IUIElementsUtility.EndContainerGUIFromException, addr 0x27cddc0, size 0xc0, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_IUIElementsUtility_EndContainerGUIFromException(::System::Exception* exception);

  /// @brief Method UnityEngine.UIElements.IUIElementsUtility.MakeCurrentIMGUIContainerDirty, addr 0x27cd250, size 0xd8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_IUIElementsUtility_MakeCurrentIMGUIContainerDirty();

  /// @brief Method UnityEngine.UIElements.IUIElementsUtility.ProcessEvent, addr 0x27cd590, size 0x140, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IUIElementsUtility.ReleaseCapture, addr 0x27cd588, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_IUIElementsUtility_ReleaseCapture();

  /// @brief Method UnityEngine.UIElements.IUIElementsUtility.TakeCapture, addr 0x27cd33c, size 0x16c, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_IUIElementsUtility_TakeCapture();

  /// @brief Method .ctor, addr 0x27cd1f0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
