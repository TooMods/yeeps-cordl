...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0xf0d7b0, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0xf0d7dc, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0xf0d79c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf03b70, size 0x130, virtual false, abstract: false, final false
