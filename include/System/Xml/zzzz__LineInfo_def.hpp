...
public:
  // Declarations
  /// @brief Method Set, addr 0xfa75d8, size 0x8, virtual false, abstract: false, final false
  inline void Set(int32_t lineNo, int32_t linePos);

  /// @brief Method .ctor, addr 0xfa75d0, size 0x8, virtual false, abstract: false, final false
