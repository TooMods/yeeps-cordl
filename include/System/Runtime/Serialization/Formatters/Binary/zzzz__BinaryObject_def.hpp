...
public:
  ...
  /// @brief Method Dump, addr 0x1ab2738, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryObject* New_ctor();

  /// @brief Method Read, addr 0x1ab26f4, size 0x44, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x1ab267c, size 0x8, virtual false, abstract: false, final false
  inline void Set(int32_t objectId, int32_t mapId);

  /// @brief Method Write, addr 0x1ab2684, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab2674, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
