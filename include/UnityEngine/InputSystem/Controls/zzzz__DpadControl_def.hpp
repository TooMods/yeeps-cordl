...
public:
  ...
  /// @brief Method FinishSetup, addr 0x22653c4, size 0x84, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Controls::__DpadControl__DpadAxisControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x2265448, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2265560, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_component, addr 0x22653b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_component();

  /// @brief Method set_component, addr 0x22653bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FinishSetup, addr 0x2264e70, size 0xf4, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeDpadVector, addr 0x226519c, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 MakeDpadVector(bool up, bool down, bool left, bool right, bool normalize);

  /// @brief Method MakeDpadVector, addr 0x22653a4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadUnprocessedValueFromState, addr 0x2264f64, size 0x238, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x22651f8, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2264e00, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_down, addr 0x2264dd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_down();

  /// @brief Method get_left, addr 0x2264de0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_left();

  /// @brief Method get_right, addr 0x2264df0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_right();

  /// @brief Method get_up, addr 0x2264dc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_up();

  /// @brief Method set_down, addr 0x2264dd8, size 0x8, virtual false, abstract: false, final false
  inline void set_down(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_left, addr 0x2264de8, size 0x8, virtual false, abstract: false, final false
  inline void set_left(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_right, addr 0x2264df8, size 0x8, virtual false, abstract: false, final false
  inline void set_right(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_up, addr 0x2264dc8, size 0x8, virtual false, abstract: false, final false
