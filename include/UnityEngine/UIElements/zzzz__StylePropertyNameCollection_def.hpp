...
public:
  ...
  /// @brief Method Dispose, addr 0x2cce0e0, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x2ccdfdc, size 0x48, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x2cce0dc, size 0x4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2cce060, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x2ccdf00, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName> enumerator);

  /// @brief Method get_Current, addr 0x2cce024, size 0x3c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x2ccde90, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__StylePropertyNameCollection__Enumerator GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.StylePropertyName>.GetEnumerator, addr 0x2ccdf0c, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2ccdf74, size 0x68, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x2ccde88, size 0x8, virtual false, abstract: false, final false
