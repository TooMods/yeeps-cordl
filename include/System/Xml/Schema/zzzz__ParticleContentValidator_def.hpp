...
public:
  ...
  /// @brief Method AddChoice, addr 0x3052fec, size 0xe0, virtual false, abstract: false, final false
  inline void AddChoice();

  /// @brief Method AddLeafNode, addr 0x3052e80, size 0xdc, virtual false, abstract: false, final false
  inline void AddLeafNode(::System::Xml::Schema::SyntaxTreeNode* node);

  /// @brief Method AddLeafRange, addr 0x3053428, size 0xec, virtual false, abstract: false, final false
  inline void AddLeafRange(::System::Decimal min, ::System::Decimal max);

  /// @brief Method AddName, addr 0x3052dd4, size 0xac, virtual false, abstract: false, final false
  inline void AddName(::System::Xml::XmlQualifiedName* name, ::System::Object* particle);

  /// @brief Method AddNamespaceList, addr 0x3052f5c, size 0x90, virtual false, abstract: false, final false
  inline void AddNamespaceList(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method AddPlus, addr 0x3053360, size 0x64, virtual false, abstract: false, final false
  inline void AddPlus();

  /// @brief Method AddQMark, addr 0x30533c4, size 0x64, virtual false, abstract: false, final false
  inline void AddQMark();

  /// @brief Method AddSequence, addr 0x30530cc, size 0xe0, virtual false, abstract: false, final false
  inline void AddSequence();

  /// @brief Method AddStar, addr 0x30531ac, size 0x64, virtual false, abstract: false, final false
  inline void AddStar();

  /// @brief Method BuildTransitionTable, addr 0x30540d8, size 0x598, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateTotalFollowposForRangeNodes, addr 0x3053a84, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCMUPAWithLeafRangeNodes, addr 0x3053ed8, size 0x178, virtual false, abstract: false, final false
  inline void CheckCMUPAWithLeafRangeNodes(::System::Xml::Schema::BitSet* curpos);

  /// @brief Method CheckUniqueParticleAttribution, addr 0x3054710, size 0x1bc, virtual false, abstract: false, final false
  inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet* curpos);

  /// @brief Method CheckUniqueParticleAttribution, addr 0x3054050, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseGroup, addr 0x3052c4c, size 0x150, virtual false, abstract: false, final false
  inline void CloseGroup();

  /// @brief Method Closure, addr 0x3053210, size 0x150, virtual false, abstract: false, final false
  inline void Closure(::System::Xml::Schema::InteriorNode* node);

  /// @brief Method CompleteValidation, addr 0x3052b2c, size 0x40, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method Exists, addr 0x3052d9c, size 0x38, virtual false, abstract: false, final false
  inline bool Exists(::System::Xml::XmlQualifiedName* name);

  /// @brief Method Finish, addr 0x3053514, size 0x570, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* Finish(bool useDFA);

  /// @brief Method GetApplicableMinMaxFollowPos, addr 0x3053d68, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x3052aac, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method OpenGroup, addr 0x3052c24, size 0x28, virtual false, abstract: false, final false
  inline void OpenGroup();

  /// @brief Method Start, addr 0x3052b6c, size 0xb8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ValidateElement, addr 0x3052aec, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3052a28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType);

  /// @brief Method .ctor, addr 0x3052a30, size 0x7c, virtual false, abstract: false, final false
