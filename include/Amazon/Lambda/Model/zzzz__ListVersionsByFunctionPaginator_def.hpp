...
namespace Amazon::Lambda::Model {
class __ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8;
}
namespace Amazon::Lambda::Model {
...
MARK_REF_PTR_T(::Amazon::Lambda::Model::__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8);
...
class CORDL_TYPE __ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IAsyncEnumerator_Amazon_Lambda_Model_ListVersionsByFunctionResponse__get_Current))::Amazon::Lambda::Model::ListVersionsByFunctionResponse*
      System_Collections_Generic_IAsyncEnumerator_Amazon_Lambda_Model_ListVersionsByFunctionResponse__Current;
  ...
  __declspec(
      property(get = __cordl_internal_get___u__1,
               put = __cordl_internal_set___u__1))::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListVersionsByFunctionResponse*>
      __u__1;
  ...
  static inline ::Amazon::Lambda::Model::__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ -
  ...
  constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListVersionsByFunctionResponse*> const& __cordl_internal_get___u__1()
      const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__ListVersionsByFunctionPaginator___Amazon-Runtime-IPaginator_Amazon-Lambda-Model-ListVersionsByFunctionResponse_-PaginateAsync_d__8", modifiers: "&&",
  // def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ -
      PaginateAsync_d__8(__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__ListVersionsByFunctionPaginator___Amazon-Runtime-IPaginator_Amazon-Lambda-Model-ListVersionsByFunctionResponse_-PaginateAsync_d__8", modifiers:
  // "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ -
      PaginateAsync_d__8(__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8 const&) = delete;
...
static_assert(::cordl_internals::size_check_v<
                  ::Amazon::Lambda::Model::__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8, 0xb0>,
              "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8,
                       _____1__state) == 0x10,
              "Offset mismatch!");
...
public:
  // Declarations
  using _Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8 =
...
NEED_NO_BOX(::Amazon::Lambda::Model::__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::__ListVersionsByFunctionPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListVersionsByFunctionResponse_ - PaginateAsync_d__8*,
