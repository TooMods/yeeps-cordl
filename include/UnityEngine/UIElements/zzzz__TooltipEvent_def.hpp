...
public:
  ...
  /// @brief Method Init, addr 0x2ccc81c, size 0x90, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2ccc8ac, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ccc924, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_rect, addr 0x2ccc810, size 0xc, virtual false, abstract: false, final false
  inline void set_rect(::UnityEngine::Rect value);

  /// @brief Method set_tooltip, addr 0x2ccc808, size 0x8, virtual false, abstract: false, final false
