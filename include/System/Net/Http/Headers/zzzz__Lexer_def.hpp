...
public:
  ...
  /// @brief Method EatChar, addr 0x16235c0, size 0x10, virtual false, abstract: false, final false
  inline void EatChar();

  /// @brief Method GetQuotedStringValue, addr 0x16211bc, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetQuotedStringValue(::System::Net::Http::Headers::Token start);

  /// @brief Method GetRemainingStringValue, addr 0x161f988, size 0x34, virtual false, abstract: false, final false
  inline ::StringW GetRemainingStringValue(int32_t position);

  /// @brief Method GetStringValue, addr 0x162773c, size 0x24, virtual false, abstract: false, final false
  inline ::StringW GetStringValue(::System::Net::Http::Headers::Token start, ::System::Net::Http::Headers::Token end);

  /// @brief Method GetStringValue, addr 0x161f964, size 0x24, virtual false, abstract: false, final false
  inline ::StringW GetStringValue(::System::Net::Http::Headers::Token token);

  /// @brief Method IsStarStringValue, addr 0x1622e2c, size 0x44, virtual false, abstract: false, final false
  inline bool IsStarStringValue(::System::Net::Http::Headers::Token token);

  /// @brief Method IsValidCharacter, addr 0x1627b08, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsValidCharacter(char16_t input);

  /// @brief Method IsValidToken, addr 0x1627a58, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsValidToken(::StringW input);

  static inline ::System::Net::Http::Headers::Lexer* New_ctor(::StringW stream);

  /// @brief Method PeekChar, addr 0x1623580, size 0x40, virtual false, abstract: false, final false
  inline int32_t PeekChar();

  /// @brief Method Scan, addr 0x161f670, size 0x2f4, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::Token Scan(bool recognizeDash);

  /// @brief Method ScanCommentOptional, addr 0x1627bb8, size 0x150, virtual false, abstract: false, final false
  inline bool ScanCommentOptional(ByRef<::StringW> value, ByRef<::System::Net::Http::Headers::Token> readToken);

  /// @brief Method TryGetDateValue, addr 0x16278dc, size 0xdc, virtual false, abstract: false, final false
  static inline bool TryGetDateValue(::StringW text, ByRef<::System::DateTimeOffset> value);

  /// @brief Method TryGetDateValue, addr 0x1627800, size 0xdc, virtual false, abstract: false, final false
  inline bool TryGetDateValue(::System::Net::Http::Headers::Token token, ByRef<::System::DateTimeOffset> value);

  /// @brief Method TryGetDoubleValue, addr 0x16279b8, size 0xa0, virtual false, abstract: false, final false
  inline bool TryGetDoubleValue(::System::Net::Http::Headers::Token token, ByRef<double_t> value);

  /// @brief Method TryGetNumericValue, addr 0x1627760, size 0xa0, virtual false, abstract: false, final false
  inline bool TryGetNumericValue(::System::Net::Http::Headers::Token token, ByRef<int32_t> value);

  /// @brief Method TryGetNumericValue, addr 0x1622e70, size 0xa0, virtual false, abstract: false, final false
  inline bool TryGetNumericValue(::System::Net::Http::Headers::Token token, ByRef<int64_t> value);

  /// @brief Method TryGetTimeSpanValue, addr 0x16210f4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x161f464, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Position, addr 0x162772c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Position, addr 0x1627734, size 0x8, virtual false, abstract: false, final false
