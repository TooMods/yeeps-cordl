...
public:
  ...
  /// @brief Method .ctor, addr 0x17163dc, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1716234, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Success, addr 0x17162d0, size 0x10, virtual false, abstract: false, final false
