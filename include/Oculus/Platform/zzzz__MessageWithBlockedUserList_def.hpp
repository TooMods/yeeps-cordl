...
public:
  // Declarations
  /// @brief Method GetBlockedUserList, addr 0x19b30d4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetDataFromMessage, addr 0x19b3110, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0a44, size 0x58, virtual false, abstract: false, final false
