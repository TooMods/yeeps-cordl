...
public:
  ...
  /// @brief Method Close, addr 0x12b6ec0, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x12b6e50, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x12b6ebc, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x12b6ec4, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method IsEnabled, addr 0x12b7a08, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceData, addr 0x12b779c, size 0x1a4, virtual true, abstract: false, final false
  inline void TraceData(::System::Diagnostics::TraceEventCache* eventCache, ::StringW source, ::System::Diagnostics::TraceEventType eventType, int32_t id,
                        ::ArrayW<::System::Object*, ::Array<::System::Object*>*> data);

  /// @brief Method TraceData, addr 0x12b6fc0, size 0x114, virtual true, abstract: false, final false
  inline void TraceData(::System::Diagnostics::TraceEventCache* eventCache, ::StringW source, ::System::Diagnostics::TraceEventType eventType, int32_t id, ::System::Object* data);

  /// @brief Method TraceEvent, addr 0x12b7940, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteFooter, addr 0x12b71e4, size 0x5b8, virtual false, abstract: false, final false
  inline void WriteFooter(::System::Diagnostics::TraceEventCache* eventCache);

  /// @brief Method WriteHeader, addr 0x12b70d4, size 0x110, virtual false, abstract: false, final false
  inline void WriteHeader(::StringW source, ::System::Diagnostics::TraceEventType eventType, int32_t id);

  /// @brief Method WriteIndent, addr 0x12b6eec, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12b6dc0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Filter, addr 0x12b6ec8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Diagnostics::TraceFilter* get_Filter();

  /// @brief Method get_IsThreadSafe, addr 0x12b6e48, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsThreadSafe();

  /// @brief Method get_Name, addr 0x12b6df8, size 0x50, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NeedIndent, addr 0x12b6ed0, size 0x8, virtual false, abstract: false, final false
  inline bool get_NeedIndent();

  /// @brief Method get_TraceOutputOptions, addr 0x12b6ee4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Diagnostics::TraceOptions get_TraceOutputOptions();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_IndentLevel, addr 0x12b69fc, size 0x1c, virtual false, abstract: false, final false
  inline void set_IndentLevel(int32_t value);

  /// @brief Method set_IndentSize, addr 0x12b6a18, size 0xac, virtual false, abstract: false, final false
  inline void set_IndentSize(int32_t value);

  /// @brief Method set_NeedIndent, addr 0x12b6ed8, size 0xc, virtual false, abstract: false, final false
