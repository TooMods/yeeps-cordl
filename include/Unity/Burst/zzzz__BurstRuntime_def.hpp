...
public:
  ...
  /// @brief Method .ctor, addr 0x2626010, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetHashCode32, addr 0x2625c34, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode64, addr 0x2625cdc, size 0x24, virtual false, abstract: false, final false
  static inline int64_t GetHashCode64(::System::Type* type);

  /// @brief Method GetUTF8LiteralPointer, addr 0x2625fc0, size 0x50, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<uint8_t> GetUTF8LiteralPointer(::StringW str, ByRef<int32_t> byteCount);

  /// @brief Method HashStringWithFNV1A32, addr 0x2625c58, size 0x84, virtual false, abstract: false, final false
  static inline int32_t HashStringWithFNV1A32(::StringW text);

  /// @brief Method HashStringWithFNV1A64, addr 0x2625d00, size 0x8c, virtual false, abstract: false, final false
  static inline int64_t HashStringWithFNV1A64(::StringW text);

  /// @brief Method Initialize, addr 0x2625f54, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method LoadAdditionalLibrary, addr 0x2625d8c, size 0x6c, virtual false, abstract: false, final false
  static inline bool LoadAdditionalLibrary(::StringW pathToLibBurstGenerated);

  /// @brief Method LoadAdditionalLibraryInternal, addr 0x2625df8, size 0x15c, virtual false, abstract: false, final false
  static inline bool LoadAdditionalLibraryInternal(::StringW pathToLibBurstGenerated);

  /// @brief Method Log, addr 0x2625fa8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method PreventDiscardAttributeStrip, addr 0x2625f58, size 0x50, virtual false, abstract: false, final false
  static inline void PreventDiscardAttributeStrip();
