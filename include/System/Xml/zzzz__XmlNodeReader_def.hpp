...
public:
  ...
  /// @brief Method Close, addr 0xfa5d80, size 0xc, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method FinishReadBinary, addr 0xfa5474, size 0x24, virtual false, abstract: false, final false
  inline void FinishReadBinary();

  /// @brief Method GetAttribute, addr 0xfa533c, size 0x70, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t attributeIndex);

  /// @brief Method GetAttribute, addr 0xfa5278, size 0x30, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0xfa52a8, size 0x94, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW namespaceURI);

  /// @brief Method IsInReadingStates, addr 0xfa4e10, size 0x10, virtual false, abstract: false, final false
  inline bool IsInReadingStates();

  /// @brief Method LookupNamespace, addr 0xfa5e88, size 0x38, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0xfa53ac, size 0xc8, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0xfa5498, size 0x1e4, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t attributeIndex);

  /// @brief Method MoveToElement, addr 0xfa5834, size 0xe0, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0xfa567c, size 0xd8, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0xfa5754, size 0xe0, virtual true, abstract: false, final false
  inline bool MoveToNextAttribute();

  static inline ::System::Xml::XmlNodeReader* New_ctor(::System::Xml::XmlNode* node);

  /// @brief Method ReSetReadingMarks, addr 0xfa5bcc, size 0x24, virtual false, abstract: false, final false
  inline void ReSetReadingMarks();

  /// @brief Method Read, addr 0xfa5914, size 0x8, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method Read, addr 0xfa591c, size 0x104, virtual false, abstract: false, final false
  inline bool Read(bool fSkipChildren);

  /// @brief Method ReadAtZeroLevel, addr 0xfa5cec, size 0x70, virtual false, abstract: false, final false
  inline bool ReadAtZeroLevel(bool fSkipChildren);

  /// @brief Method ReadAttributeValue, addr 0xfa5f4c, size 0x4c, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadForward, addr 0xfa5bf0, size 0xe4, virtual false, abstract: false, final false
  inline bool ReadForward(bool fSkipChildren);

  /// @brief Method ReadNextNode, addr 0xfa5a20, size 0x1ac, virtual false, abstract: false, final false
  inline bool ReadNextNode(bool fSkipChildren);

  /// @brief Method ReadString, addr 0xfa5d9c, size 0xac, virtual true, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ResolveEntity, addr 0xfa5ec0, size 0x8c, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method SetEndOfFile, addr 0xfa5cd4, size 0x18, virtual false, abstract: false, final false
  inline void SetEndOfFile();

  /// @brief Method Skip, addr 0xfa5d94, size 0x8, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0xfa5f98, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0xfa5fc8, size 0x5c, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0xfa5fb0, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfa4d20, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* node);

  /// @brief Method get_AttributeCount, addr 0xfa523c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0xfa509c, size 0x2c, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CanResolveEntity, addr 0xfa50c8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanResolveEntity();

  /// @brief Method get_Depth, addr 0xfa5094, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_DtdInfo, addr 0xfa6024, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::IDtdInfo* get_DtdInfo();

  /// @brief Method get_EOF, addr 0xfa5d5c, size 0x24, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_HasAttributes, addr 0xfa5e48, size 0x24, virtual true, abstract: false, final false
  inline bool get_HasAttributes();

  /// @brief Method get_IsDefault, addr 0xfa5100, size 0x30, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0xfa50d0, size 0x30, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LocalName, addr 0xfa4eac, size 0x70, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xfa4e3c, size 0x70, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0xfa5e6c, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0xfa4f1c, size 0x84, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0xfa4e20, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0xfa4fa0, size 0x84, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_ReadState, addr 0xfa5d8c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_SchemaInfo, addr 0xfa51f8, size 0x44, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Value, addr 0xfa5024, size 0x70, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XmlLang, addr 0xfa5174, size 0x84, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0xfa5130, size 0x44, virtual true, abstract: false, final false
