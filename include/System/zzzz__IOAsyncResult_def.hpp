...
public:
  ...
  /// @brief Method Init, addr 0x1715738, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1715730, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1715758, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::AsyncCallback* async_callback, ::System::Object* async_state);

  /// @brief Method get_AsyncCallback, addr 0x1715784, size 0x8, virtual false, abstract: false, final false
  inline ::System::AsyncCallback* get_AsyncCallback();

  /// @brief Method get_AsyncState, addr 0x171578c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x1715794, size 0x124, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x17158b8, size 0x8, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_IsCompleted, addr 0x17158cc, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCompleted();

  /// @brief Convert to "::System::IAsyncResult"
  constexpr ::System::IAsyncResult* i___System__IAsyncResult() noexcept;

  /// @brief Method set_CompletedSynchronously, addr 0x17158c0, size 0xc, virtual false, abstract: false, final false
  inline void set_CompletedSynchronously(bool value);

  /// @brief Method set_IsCompleted, addr 0x17158d4, size 0xd8, virtual false, abstract: false, final false
