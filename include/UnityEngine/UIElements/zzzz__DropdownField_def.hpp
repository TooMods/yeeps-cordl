...
public:
  ...
  /// @brief Method Init, addr 0x2cd667c, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd67f8, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddMenuItems, addr 0x2cd58a4, size 0x308, virtual false, abstract: false, final false
  inline void AddMenuItems(::UnityEngine::UIElements::IGenericMenu* menu);

  /// @brief Method ChangeValueFromMenu, addr 0x2cd5bb4, size 0x10, virtual false, abstract: false, final false
  inline void ChangeValueFromMenu(::StringW menuItem);

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x2cd5e10, size 0x180, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method GetListItemToDisplay, addr 0x2cd5444, size 0xac, virtual false, abstract: false, final false
  inline ::StringW GetListItemToDisplay(::StringW value);

  /// @brief Method GetValueToDisplay, addr 0x2cd53b8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValueWithoutNotify, addr 0x2cd5d00, size 0x110, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::StringW newValue);

  /// @brief Method ShowMenu, addr 0x2cd5f90, size 0x180, virtual false, abstract: false, final false
  inline void ShowMenu();

  /// @brief Method UpdateMixedValueContent, addr 0x2cd63e4, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd558c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2cd5594, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_textElement, addr 0x2cd53b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextElement* get_textElement();

  /// @brief Method get_value, addr 0x2cd5c34, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_choices, addr 0x2cd5bc4, size 0x70, virtual true, abstract: false, final false
  inline void set_choices(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_index, addr 0x2cd54f0, size 0x9c, virtual false, abstract: false, final false
  inline void set_index(int32_t value);

  /// @brief Method set_value, addr 0x2cd5c7c, size 0x84, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cd6634, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method DoMeasure, addr 0x2cd68e4, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd584c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddMenuItems>b__0, addr 0x2cd6988, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd5bac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
