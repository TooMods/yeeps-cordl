...
public:
  ...
  /// @brief Method Reset, addr 0x20998b4, size 0x10, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x209984c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
