...
public:
  ...
  __declspec(property(get = get_Parameters))::System::Security::Cryptography::CspParameters* Parameters;
  ...
  /// @brief Method CanSecure, addr 0x289a7e0, size 0xa0, virtual false, abstract: false, final false
  static inline bool CanSecure(::StringW path);

  /// @brief Method Copy, addr 0x2898ed4, size 0x98, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::CspParameters* Copy(::System::Security::Cryptography::CspParameters* p);

  /// @brief Method FromXml, addr 0x2899fb4, size 0x120, virtual false, abstract: false, final false
  inline void FromXml(::StringW xml);

  /// @brief Method IsMachineProtected, addr 0x289a73c, size 0x90, virtual false, abstract: false, final false
  static inline bool IsMachineProtected(::StringW path);

  /// @brief Method IsUserProtected, addr 0x289a6ac, size 0x90, virtual false, abstract: false, final false
  static inline bool IsUserProtected(::StringW path);

  /// @brief Method Load, addr 0x2899e00, size 0x1b4, virtual false, abstract: false, final false
  inline bool Load();
  ...
  /// @brief Method ProtectMachine, addr 0x289a534, size 0x90, virtual false, abstract: false, final false
  static inline bool ProtectMachine(::StringW path);

  /// @brief Method ProtectUser, addr 0x289a5c4, size 0x90, virtual false, abstract: false, final false
  static inline bool ProtectUser(::StringW path);

  /// @brief Method Remove, addr 0x289a654, size 0x14, virtual false, abstract: false, final false
  inline void Remove();

  /// @brief Method Save, addr 0x289a0d4, size 0x24c, virtual false, abstract: false, final false
  inline void Save();

  /// @brief Method ToXml, addr 0x289a320, size 0x214, virtual false, abstract: false, final false
  inline ::StringW ToXml();

  /// @brief Method _CanSecure, addr 0x289a7cc, size 0x4, virtual false, abstract: false, final false
  static inline bool _CanSecure(::cordl_internals::Ptr<char16_t> root);

  /// @brief Method _IsMachineProtected, addr 0x289a7dc, size 0x4, virtual false, abstract: false, final false
  static inline bool _IsMachineProtected(::cordl_internals::Ptr<char16_t> path);

  /// @brief Method _IsUserProtected, addr 0x289a7d8, size 0x4, virtual false, abstract: false, final false
  static inline bool _IsUserProtected(::cordl_internals::Ptr<char16_t> path);

  /// @brief Method _ProtectMachine, addr 0x289a7d4, size 0x4, virtual false, abstract: false, final false
  static inline bool _ProtectMachine(::cordl_internals::Ptr<char16_t> path);

  /// @brief Method _ProtectUser, addr 0x289a7d0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2898e48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::CspParameters* parameters);

  /// @brief Method .ctor, addr 0x2898e50, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanChange, addr 0x2899de8, size 0x10, virtual false, abstract: false, final false
  inline bool get_CanChange();

  /// @brief Method get_ContainerName, addr 0x2899118, size 0x100, virtual false, abstract: false, final false
  inline ::StringW get_ContainerName();

  /// @brief Method get_Filename, addr 0x2898f6c, size 0x1ac, virtual false, abstract: false, final false
  inline ::StringW get_Filename();

  /// @brief Method get_KeyValue, addr 0x2899dcc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_KeyValue();

  /// @brief Method get_MachinePath, addr 0x2899294, size 0x59c, virtual false, abstract: false, final false
  static inline ::StringW get_MachinePath();

  /// @brief Method get_Parameters, addr 0x2899df8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::CspParameters* get_Parameters();

  /// @brief Method get_UseDefaultKeyContainer, addr 0x289a880, size 0x20, virtual false, abstract: false, final false
  inline bool get_UseDefaultKeyContainer();

  /// @brief Method get_UseMachineKeyStore, addr 0x2899274, size 0x20, virtual false, abstract: false, final false
  inline bool get_UseMachineKeyStore();

  /// @brief Method get_UserPath, addr 0x2899830, size 0x59c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_KeyValue, addr 0x2899dd4, size 0x14, virtual false, abstract: false, final false
