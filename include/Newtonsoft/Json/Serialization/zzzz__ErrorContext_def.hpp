...
public:
  ...
  /// @brief Method .ctor, addr 0xf0c788, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* originalObject, ::System::Object* member, ::StringW path, ::System::Exception* error);

  /// @brief Method get_Error, addr 0xf0c7dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Exception* get_Error();

  /// @brief Method get_Handled, addr 0xf0c7fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_Handled();

  /// @brief Method get_Member, addr 0xf0c7ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Member();

  /// @brief Method get_OriginalObject, addr 0xf0c7e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_OriginalObject();

  /// @brief Method get_Path, addr 0xf0c7f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Path();

  /// @brief Method get_Traced, addr 0xf0c7c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_Traced();

  /// @brief Method set_Handled, addr 0xf0c804, size 0xc, virtual false, abstract: false, final false
  inline void set_Handled(bool value);

  /// @brief Method set_Traced, addr 0xf0c7d0, size 0xc, virtual false, abstract: false, final false
