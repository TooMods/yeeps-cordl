...
public:
  ...
  /// @brief Method Equals, addr 0x2904c24, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2904ca4, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord other);

  /// @brief Method GetHashCode, addr 0x2904bb8, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_glyphIndex, addr 0x2904ba4, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method get_glyphValueRecord, addr 0x2904bac, size 0xc, virtual false, abstract: false, final false
