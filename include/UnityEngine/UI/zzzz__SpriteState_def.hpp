...
public:
  ...
  /// @brief Method Equals, addr 0x29111f8, size 0x108, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UI::SpriteState other);

  /// @brief Method get_disabledSprite, addr 0x29111e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_disabledSprite();

  /// @brief Method get_highlightedSprite, addr 0x29111b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_highlightedSprite();

  /// @brief Method get_pressedSprite, addr 0x29111c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_pressedSprite();

  /// @brief Method get_selectedSprite, addr 0x29111d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disabledSprite, addr 0x29111f0, size 0x8, virtual false, abstract: false, final false
  inline void set_disabledSprite(::UnityEngine::Sprite* value);

  /// @brief Method set_highlightedSprite, addr 0x29111c0, size 0x8, virtual false, abstract: false, final false
  inline void set_highlightedSprite(::UnityEngine::Sprite* value);

  /// @brief Method set_pressedSprite, addr 0x29111d0, size 0x8, virtual false, abstract: false, final false
  inline void set_pressedSprite(::UnityEngine::Sprite* value);

  /// @brief Method set_selectedSprite, addr 0x29111e0, size 0x8, virtual false, abstract: false, final false
