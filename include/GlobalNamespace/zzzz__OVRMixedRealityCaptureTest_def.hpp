...
public:
  ...
  /// @brief Method Initialize, addr 0x16f4524, size 0x224, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRMixedRealityCaptureTest* New_ctor();

  /// @brief Method Start, addr 0x16f4474, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x16f4b70, size 0x738, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDefaultExternalCamera, addr 0x16f4748, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16f52a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
