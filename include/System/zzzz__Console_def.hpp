...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2e7edd0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e7ed0c, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoWindowsConsoleCancelEvent, addr 0x2e7ec10, size 0x60, virtual false, abstract: false, final false
  static inline bool DoWindowsConsoleCancelEvent(int32_t keyCode);

  /// @brief Method GetConsoleCP, addr 0x2e7eb3c, size 0x68, virtual false, abstract: false, final false
  static inline int32_t GetConsoleCP();

  /// @brief Method GetConsoleOutputCP, addr 0x2e7eba4, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t GetConsoleOutputCP();

  /// @brief Method GetInputCodePage, addr 0x2e7da20, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t GetInputCodePage();

  /// @brief Method GetOutputCodePage, addr 0x2e7da6c, size 0x4c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoConsoleCancelEvent, addr 0x2e7e944, size 0x1f8, virtual false, abstract: false, final false
  static inline void DoConsoleCancelEvent();

  /// @brief Method Open, addr 0x2e7e200, size 0x15c, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* Open(void* handle, ::System::IO::FileAccess access, int32_t bufferSize);

  /// @brief Method OpenStandardError, addr 0x2e7e0c0, size 0x90, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* OpenStandardError(int32_t bufferSize);

  /// @brief Method OpenStandardInput, addr 0x2e7dfa0, size 0x90, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* OpenStandardInput(int32_t bufferSize);

  /// @brief Method OpenStandardOutput, addr 0x2e7e030, size 0x90, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* OpenStandardOutput(int32_t bufferSize);

  /// @brief Method ReadKey, addr 0x2e7e7b8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::ConsoleKeyInfo ReadKey();

  /// @brief Method ReadKey, addr 0x2e7e810, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::ConsoleKeyInfo ReadKey(bool intercept);

  /// @brief Method SetOut, addr 0x2e7e35c, size 0xe4, virtual false, abstract: false, final false
  static inline void SetOut(::System::IO::TextWriter* newOut);

  /// @brief Method SetupStreams, addr 0x2e7dab8, size 0x3b0, virtual false, abstract: false, final false
  static inline void SetupStreams(::System::Text::Encoding* inputEncoding, ::System::Text::Encoding* outputEncoding);

  /// @brief Method Write, addr 0x2e7e440, size 0x74, virtual false, abstract: false, final false
  static inline void Write(::StringW value);

  /// @brief Method WriteLine, addr 0x2e7e4b4, size 0x6c, virtual false, abstract: false, final false
  static inline void WriteLine();

  /// @brief Method WriteLine, addr 0x2e7e67c, size 0x8c, virtual false, abstract: false, final false
  static inline void WriteLine(::StringW format, ::System::Object* arg0, ::System::Object* arg1);

  /// @brief Method WriteLine, addr 0x2e7e608, size 0x74, virtual false, abstract: false, final false
  static inline void WriteLine(::StringW value);

  /// @brief Method WriteLine, addr 0x2e7e594, size 0x74, virtual false, abstract: false, final false
  static inline void WriteLine(::System::Object* value);

  /// @brief Method WriteLine, addr 0x2e7e520, size 0x74, virtual false, abstract: false, final false
  static inline void WriteLine(int32_t value);
  ...
  /// @brief Method get_Error, addr 0x2e7e150, size 0x58, virtual false, abstract: false, final false
  static inline ::System::IO::TextWriter* get_Error();

  /// @brief Method get_InputEncoding, addr 0x2e7e708, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_InputEncoding();

  /// @brief Method get_Out, addr 0x2e7e1a8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::IO::TextWriter* get_Out();

  /// @brief Method get_OutputEncoding, addr 0x2e7e760, size 0x58, virtual false, abstract: false, final false
