...
// Type: Unity.Services.Authentication.Internal::IPlayerId
...
public:
  ...
  /// @brief Method add_PlayerIdChanged, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method remove_PlayerIdChanged, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void remove_PlayerIdChanged(::System::Action_1<::StringW>* value);

  // Ctor Parameters [CppParam { name: "", ty: "IPlayerId", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IPlayerId(IPlayerId&&) = delete;
