...
public:
  ...
  /// @brief Method Finalize, addr 0x15cda90, size 0x110, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCharacters, addr 0x15cdff8, size 0x44, virtual false, abstract: false, final false
  inline void GetCharacters(::System::Collections::Generic::List_1<::UnityEngine::UICharInfo>* characters);

  /// @brief Method GetCharactersInternal, addr 0x15ce03c, size 0x44, virtual false, abstract: false, final false
  inline void GetCharactersInternal(::System::Object* characters);

  /// @brief Method GetLines, addr 0x15ce080, size 0x44, virtual false, abstract: false, final false
  inline void GetLines(::System::Collections::Generic::List_1<::UnityEngine::UILineInfo>* lines);

  /// @brief Method GetLinesInternal, addr 0x15ce0c4, size 0x44, virtual false, abstract: false, final false
  inline void GetLinesInternal(::System::Object* lines);

  /// @brief Method GetPreferredHeight, addr 0x15ce2ac, size 0x70, virtual false, abstract: false, final false
  inline float_t GetPreferredHeight(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetPreferredWidth, addr 0x15ce190, size 0x74, virtual false, abstract: false, final false
  inline float_t GetPreferredWidth(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetVertices, addr 0x15ce108, size 0x44, virtual false, abstract: false, final false
  inline void GetVertices(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* vertices);

  /// @brief Method GetVerticesInternal, addr 0x15ce14c, size 0x44, virtual false, abstract: false, final false
  inline void GetVerticesInternal(::System::Object* vertices);

  /// @brief Method Internal_Create, addr 0x15cda68, size 0x28, virtual false, abstract: false, final false
  static inline void* Internal_Create();

  /// @brief Method Internal_Destroy, addr 0x15cdc40, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(void* ptr);

  /// @brief Method Invalidate, addr 0x15cdff0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate, addr 0x15ce204, size 0x50, virtual false, abstract: false, final false
  inline bool Populate(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateAlways, addr 0x15ce55c, size 0x108, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateAlways(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithError, addr 0x15ce4cc, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateWithError(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithErrors, addr 0x15ce31c, size 0x1b0, virtual false, abstract: false, final false
  inline bool PopulateWithErrors(::StringW str, ::UnityEngine::TextGenerationSettings settings, ::UnityEngine::GameObject* context);

  /// @brief Method Populate_Internal, addr 0x15ce664, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate_Internal, addr 0x15ce9a4, size 0x14c, virtual false, abstract: false, final false
  inline bool Populate_Internal(::StringW str, ::UnityEngine::Font* font, ::UnityEngine::Color color, int32_t fontSize, float_t scaleFactor, float_t lineSpacing, ::UnityEngine::FontStyle style,
  ...
  /// @brief Method Populate_Internal_Injected, addr 0x15ceaf0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x15cdba0, size 0xa0, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method ValidatedSettings, addr 0x15cdcfc, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x15cd914, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x15cd91c, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_characterCount, addr 0x15cdcc0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_characterCount();

  /// @brief Method get_characterCountVisible, addr 0x15cdc7c, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_characterCountVisible();

  /// @brief Method get_characters, addr 0x15ce86c, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UICharInfo>* get_characters();

  /// @brief Method get_lineCount, addr 0x15ce968, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_lineCount();

  /// @brief Method get_lines, addr 0x15ce8c8, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UILineInfo>* get_lines();

  /// @brief Method get_rectExtents, addr 0x15ce254, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rectExtents();

  /// @brief Method get_rectExtents_Injected, addr 0x15ce924, size 0x44, virtual false, abstract: false, final false
  inline void get_rectExtents_Injected(ByRef<::UnityEngine::Rect> ret);

  /// @brief Method get_verts, addr 0x15ce810, size 0x5c, virtual false, abstract: false, final false
