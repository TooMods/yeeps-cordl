...
public:
  ...
  /// @brief Method <SetAndVerifySelectionCallback>b__0, addr 0x2c9e394, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c9dc20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AuthenticateAsClient, addr 0x2c9dc28, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method AuthenticateAsClientAsync, addr 0x2c9dcfc, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginAuthenticateAsClient, addr 0x2c9dc7c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginRead, addr 0x2c9e268, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x2c9e31c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckDisposed, addr 0x2c9d6a8, size 0x60, virtual false, abstract: false, final false
  inline void CheckDisposed();

  /// @brief Method Dispose, addr 0x2c9e05c, size 0xac, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndAuthenticateAsClient, addr 0x2c9dcf0, size 0xc, virtual true, abstract: false, final false
  inline void EndAuthenticateAsClient(::System::IAsyncResult* asyncResult);

  /// @brief Method EndRead, addr 0x2c9e2d4, size 0x48, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x2c9e388, size 0xc, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Flush, addr 0x2c9e038, size 0x24, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x2c9e014, size 0x24, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method GetProvider, addr 0x2c9d72c, size 0x70, virtual false, abstract: false, final false
  static inline ::Mono::Net::Security::MobileTlsProvider* GetProvider();

  static inline ::System::Net::Security::SslStream* New_ctor(::System::IO::Stream* innerStream);
  ...
  /// @brief Method Read, addr 0x2c9e108, size 0x54, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAsync, addr 0x2c9e1b0, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Seek, addr 0x2c9dfb4, size 0x60, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetAndVerifySelectionCallback, addr 0x2c9d984, size 0x178, virtual false, abstract: false, final false
  inline void SetAndVerifySelectionCallback(::System::Net::Security::LocalCertificateSelectionCallback* callback);

  /// @brief Method SetAndVerifyValidationCallback, addr 0x2c9d8a4, size 0xe0, virtual false, abstract: false, final false
  inline void SetAndVerifyValidationCallback(::System::Net::Security::RemoteCertificateValidationCallback* callback);

  /// @brief Method SetLength, addr 0x2c9df78, size 0x3c, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x2c9e15c, size 0x54, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteAsync, addr 0x2c9e20c, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c9aa28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* innerStream);

  /// @brief Method .ctor, addr 0x2c9d79c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* innerStream, bool leaveInnerStreamOpen);

  /// @brief Method .ctor, addr 0x2c9dafc, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c9d808, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c9d814, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* innerStream, bool leaveInnerStreamOpen, ::System::Net::Security::RemoteCertificateValidationCallback* userCertificateValidationCallback,
                    ::System::Net::Security::LocalCertificateSelectionCallback* userCertificateSelectionCallback);

  /// @brief Method get_CanRead, addr 0x2c9dda8, size 0x18, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x2c9dda0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x2c9ddc0, size 0x20, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x2c9dde0, size 0x18, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Impl, addr 0x2c9d690, size 0x18, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Impl();

  /// @brief Method get_InternalTargetHost, addr 0x2c9d708, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_InternalTargetHost();

  /// @brief Method get_IsAuthenticated, addr 0x2c9dd50, size 0x2c, virtual true, abstract: false, final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_Length, addr 0x2c9dec8, size 0x28, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_LocalCertificate, addr 0x2c9dd7c, size 0x24, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate();

  /// @brief Method get_Position, addr 0x2c9def0, size 0x28, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_ReadTimeout, addr 0x2c9ddf8, size 0x2c, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_WriteTimeout, addr 0x2c9de60, size 0x2c, virtual true, abstract: false, final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_Position, addr 0x2c9df18, size 0x60, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x2c9de24, size 0x3c, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_WriteTimeout, addr 0x2c9de8c, size 0x3c, virtual true, abstract: false, final false
