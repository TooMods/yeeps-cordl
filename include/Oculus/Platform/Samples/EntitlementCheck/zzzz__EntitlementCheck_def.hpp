...
public:
  ...
  /// @brief Method EntitlementCheckCallback, addr 0x1e67c58, size 0x30, virtual false, abstract: false, final false
  inline void EntitlementCheckCallback(::Oculus::Platform::Message* msg);

  /// @brief Method HandleEntitlementCheckResult, addr 0x1e679dc, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x1e67828, size 0x1b4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x1e67c88, size 0x1010, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_UserFailedEntitlementCheck, addr 0x1e67540, size 0xb8, virtual false, abstract: false, final false
  static inline void add_UserFailedEntitlementCheck(::System::Action* value);

  /// @brief Method add_UserPassedEntitlementCheck, addr 0x1e676b0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_UserFailedEntitlementCheck, addr 0x1e675f8, size 0xb8, virtual false, abstract: false, final false
  static inline void remove_UserFailedEntitlementCheck(::System::Action* value);

  /// @brief Method remove_UserPassedEntitlementCheck, addr 0x1e6776c, size 0xbc, virtual false, abstract: false, final false
