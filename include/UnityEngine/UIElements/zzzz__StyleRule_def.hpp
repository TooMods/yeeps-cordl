...
public:
  ...
  /// @brief Method .ctor, addr 0x302ab7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_properties, addr 0x302ab74, size 0x8, virtual false, abstract: false, final false
