...
public:
  ...
  /// @brief Method .ctor, addr 0x2f578d4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XAttribute* attribute);

  /// @brief Method get_Attribute, addr 0x2f58434, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XAttribute* get_Attribute();

  /// @brief Method get_LocalName, addr 0x2f584ec, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x2f58510, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_ParentNode, addr 0x2f58534, size 0x44, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode();

  /// @brief Method get_Value, addr 0x2f584ac, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x2f584c8, size 0x24, virtual true, abstract: false, final false
