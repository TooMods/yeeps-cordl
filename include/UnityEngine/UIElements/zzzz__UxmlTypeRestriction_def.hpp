...
public:
  ...
  /// @brief Method Equals, addr 0x27de934, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27de940, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
