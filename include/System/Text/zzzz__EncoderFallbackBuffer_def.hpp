...
public:
  ...
  /// @brief Method InternalFallback, addr 0x1e10040, size 0x1a8, virtual true, abstract: false, final false
  inline bool InternalFallback(char16_t ch, ByRef<::cordl_internals::Ptr<char16_t>> chars);

  /// @brief Method InternalGetNextChar, addr 0x1e1000c, size 0x34, virtual false, abstract: false, final false
  inline char16_t InternalGetNextChar();

  /// @brief Method InternalInitialize, addr 0x1e0fff0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalReset, addr 0x1e0ffd8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1e0ffb0, size 0x28, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ThrowLastCharRecursive, addr 0x1e101e8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e0f428, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
