...
public:
  ...
  /// @brief Method AddCache, addr 0x188f43c, size 0x48, virtual false, abstract: false, final false
  inline void AddCache(::System::Data::DataRelation* relation);

  /// @brief Method AddCore, addr 0x188f484, size 0xc0, virtual true, abstract: false, final false
  inline void AddCore(::System::Data::DataRelation* relation);

  /// @brief Method EnsureDataSet, addr 0x188f0b0, size 0x44, virtual false, abstract: false, final false
  inline void EnsureDataSet();

  /// @brief Method GetDataSet, addr 0x188f0f4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCache, addr 0x188f544, size 0xd4, virtual false, abstract: false, final false
  inline void RemoveCache(::System::Data::DataRelation* relation);

  /// @brief Method RemoveCore, addr 0x188f618, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x188effc, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, bool fParentCollection);

  /// @brief Method add_RelationPropertyChanged, addr 0x188f304, size 0x9c, virtual false, abstract: false, final false
  inline void add_RelationPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method get_Item, addr 0x188f118, size 0x100, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x188f218, size 0xec, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(::StringW name);

  /// @brief Method get_List, addr 0x188f0a8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* get_List();

  /// @brief Method remove_RelationPropertyChanged, addr 0x188f3a0, size 0x9c, virtual false, abstract: false, final false
