...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x1e045a0, size 0x94, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<char16_t>* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1e04658, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method ToString, addr 0x1e04588, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e04490, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW characters);

  /// @brief Method get_Count, addr 0x1e04510, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x1e04518, size 0x70, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x1e0469c, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x1e0465c, size 0x34, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x1e04690, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1e046a8, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x1e04634, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::LowLevel::IMECompositionString compositionString);

  /// @brief Method get_Current, addr 0x1e046a0, size 0x8, virtual true, abstract: false, final true
