...
public:
  ...
  /// @brief Method ToString, addr 0x1030bb8, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method CreateSecureString, addr 0x10318a8, size 0xac, virtual false, abstract: false, final false
  static inline ::System::Security::SecureString* CreateSecureString(::StringW plainString);

  /// @brief Method CreateString, addr 0x10316f8, size 0x1b0, virtual false, abstract: false, final false
