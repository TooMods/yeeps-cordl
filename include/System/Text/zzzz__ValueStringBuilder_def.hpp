...
public:
  ...
  /// @brief Method Append, addr 0x285ae3c, size 0x7c, virtual false, abstract: false, final false
  inline void Append(char16_t c);

  /// @brief Method Append, addr 0x2859b98, size 0xdc, virtual false, abstract: false, final false
  inline void Append(char16_t c, int32_t count);

  /// @brief Method Append, addr 0x285af38, size 0xac, virtual false, abstract: false, final false
  inline void Append(::StringW s);

  /// @brief Method Append, addr 0x2859ab8, size 0xe0, virtual false, abstract: false, final false
  inline void Append(::cordl_internals::Ptr<char16_t> value, int32_t length);

  /// @brief Method AppendSlow, addr 0x285afe4, size 0x130, virtual false, abstract: false, final false
  inline void AppendSlow(::StringW s);

  /// @brief Method AppendSpan, addr 0x285b114, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Span_1<char16_t> AppendSpan(int32_t length);

  /// @brief Method Dispose, addr 0x285b1d4, size 0xf8, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Grow, addr 0x285abf8, size 0x244, virtual false, abstract: false, final false
  inline void Grow(int32_t requiredAdditionalCapacity);

  /// @brief Method GrowAndAppend, addr 0x285aeb8, size 0x80, virtual false, abstract: false, final false
  inline void GrowAndAppend(char16_t c);

  /// @brief Method Insert, addr 0x28554c8, size 0x1d0, virtual false, abstract: false, final false
  inline void Insert(int32_t index, char16_t value, int32_t count);

  /// @brief Method ToString, addr 0x2855924, size 0x198, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryCopyTo, addr 0x2855698, size 0x28c, virtual false, abstract: false, final false
  inline bool TryCopyTo(::System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten);

  /// @brief Method .ctor, addr 0x28554b8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Span_1<char16_t> initialBuffer);

  /// @brief Method get_Length, addr 0x285abf0, size 0x8, virtual false, abstract: false, final false
