...
public:
  ...
  /// @brief Method GetAxisRaw, addr 0x2a3479c, size 0xc, virtual true, abstract: false, final true
  inline float_t GetAxisRaw(::StringW axis);

  /// @brief Method GetButtonDown, addr 0x2a34790, size 0xc, virtual true, abstract: false, final true
  inline bool GetButtonDown(::StringW button);

  /// @brief Method GetTouch, addr 0x2a347b0, size 0x38, virtual true, abstract: false, final true
  inline ::UnityEngine::Touch GetTouch(int32_t index);

  static inline ::UnityEngine::UIElements::__DefaultEventSystem__Input* New_ctor();

  /// @brief Method .ctor, addr 0x2a33068, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mousePresent, addr 0x2a347e8, size 0x8, virtual true, abstract: false, final true
  inline bool get_mousePresent();

  /// @brief Method get_touchCount, addr 0x2a347a8, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_touchCount();
...
public:
  ...
  /// @brief Method GetAxisRaw, addr 0x2a347f8, size 0x8, virtual true, abstract: false, final true
  inline float_t GetAxisRaw(::StringW axis);

  /// @brief Method GetButtonDown, addr 0x2a347f0, size 0x8, virtual true, abstract: false, final true
  inline bool GetButtonDown(::StringW button);

  /// @brief Method GetTouch, addr 0x2a34808, size 0x14, virtual true, abstract: false, final true
  inline ::UnityEngine::Touch GetTouch(int32_t index);

  static inline ::UnityEngine::UIElements::__DefaultEventSystem__NoInput* New_ctor();

  /// @brief Method .ctor, addr 0x2a33070, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mousePresent, addr 0x2a3481c, size 0x8, virtual true, abstract: false, final true
  inline bool get_mousePresent();

  /// @brief Method get_touchCount, addr 0x2a34800, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_touchCount();
...
public:
  ...
  /// @brief Method <ProcessTouchEvents>b__30_0, addr 0x2a34b1c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendIMGUIEvents>b__23_0, addr 0x2a34890, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendIMGUIEvents_b__23_0(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendIMGUIEvents>b__23_1, addr 0x2a348f4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendIMGUIEvents>b__23_2, addr 0x2a34980, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendInputEvents>b__24_0, addr 0x2a34a34, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__24_0(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendInputEvents>b__24_1, addr 0x2a34a54, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__24_1(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendInputEvents>b__24_2, addr 0x2a34ab8, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__24_2(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <.cctor>b__41_0, addr 0x2a34be8, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__41_0();

  /// @brief Method .ctor, addr 0x2a34888, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetDefaultInput, addr 0x2a32ed4, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__DefaultEventSystem__IInput* GetDefaultInput();

  /// @brief Method GetLocalScreenPosition, addr 0x2a33e48, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRawMoveVector, addr 0x2a34320, size 0x2b8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetRawMoveVector();

  /// @brief Method MakeTouchEvent, addr 0x2a34190, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTouchEvents, addr 0x2a331dc, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method SendIMGUIEvents, addr 0x2a3362c, size 0x4c0, virtual false, abstract: false, final false
  inline void SendIMGUIEvents();

  /// @brief Method SendInputEvents, addr 0x2a33aec, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldIgnoreEventsOnAppNotFocused, addr 0x2a33078, size 0x20, virtual false, abstract: false, final false
  inline bool ShouldIgnoreEventsOnAppNotFocused();

  /// @brief Method ShouldSendMoveFromInput, addr 0x2a33e64, size 0x2b8, virtual false, abstract: false, final false
  inline bool ShouldSendMoveFromInput();

  /// @brief Method Update, addr 0x2a33170, size 0x6c, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::UIElements::__DefaultEventSystem__UpdateMode updateMode);

  /// @brief Method UpdateFocusedPanel, addr 0x2a3411c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a345d8, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Func_1<bool>* getStaticF_IsEditorRemoteConnected();

  /// @brief Method get_focusedPanel, addr 0x2a33098, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseRuntimePanel* get_focusedPanel();

  /// @brief Method get_input, addr 0x2a32eb0, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__DefaultEventSystem__IInput* get_input();

  /// @brief Method get_isAppFocused, addr 0x2a32ea8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isAppFocused();

  static inline void setStaticF_IsEditorRemoteConnected(::System::Func_1<bool>* value);

  /// @brief Method set_focusedPanel, addr 0x2a330a0, size 0x78, virtual false, abstract: false, final false
