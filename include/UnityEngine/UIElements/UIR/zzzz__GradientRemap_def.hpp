...
public:
  ...
  /// @brief Method Reset, addr 0x2099b6c, size 0x68, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2099b10, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
