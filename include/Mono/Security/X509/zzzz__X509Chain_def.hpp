...
public:
  ...
  /// @brief Method Build, addr 0x2467de4, size 0x3a8, virtual false, abstract: false, final false
  inline bool Build(::Mono::Security::X509::X509Certificate* leaf);

  /// @brief Method FindCertificateParent, addr 0x246818c, size 0x1f0, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* FindCertificateParent(::Mono::Security::X509::X509Certificate* child);

  /// @brief Method FindCertificateRoot, addr 0x246837c, size 0x240, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* FindCertificateRoot(::Mono::Security::X509::X509Certificate* potentialRoot);

  /// @brief Method IsParent, addr 0x24685bc, size 0x144, virtual false, abstract: false, final false
  inline bool IsParent(::Mono::Security::X509::X509Certificate* child, ::Mono::Security::X509::X509Certificate* parent);

  /// @brief Method IsTrusted, addr 0x24687ec, size 0x2c, virtual false, abstract: false, final false
  inline bool IsTrusted(::Mono::Security::X509::X509Certificate* potentialTrusted);

  /// @brief Method IsValid, addr 0x2468700, size 0xac, virtual false, abstract: false, final false
  inline bool IsValid(::Mono::Security::X509::X509Certificate* cert);

  /// @brief Method LoadCertificates, addr 0x2467dcc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x24687ac, size 0x40, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2467c18, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TrustAnchors, addr 0x2467c84, size 0x7c, virtual false, abstract: false, final false
