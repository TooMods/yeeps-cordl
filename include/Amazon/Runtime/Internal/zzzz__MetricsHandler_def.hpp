...
template <typename T> struct __MetricsHandler___InvokeAsync_d__1_1;
}
...
// Write type traits
MARK_REF_PTR_T(::Amazon::Runtime::Internal::MetricsHandler);
MARK_GEN_VAL_T(::Amazon::Runtime::Internal::__MetricsHandler___InvokeAsync_d__1_1);
...
template <typename T>
// Is value type: true
// CS Name: ::MetricsHandler::<InvokeAsync>d__1`1<T>
struct CORDL_TYPE __MetricsHandler___InvokeAsync_d__1_1 {
public:
  // Declarations
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __MetricsHandler___InvokeAsync_d__1_1();
  ...
  // "", def_value: None }, CppParam { name: "__4__this", ty: "::Amazon::Runtime::Internal::MetricsHandler*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty:
  // "::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<T>", modifiers: "", def_value: None }]
  constexpr __MetricsHandler___InvokeAsync_d__1_1(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T> __t__builder,
                                                  ::Amazon::Runtime::IExecutionContext* executionContext, ::Amazon::Runtime::Internal::MetricsHandler* __4__this,
  ...
  ::Amazon::Runtime::Internal::MetricsHandler* __4__this;
...
// Type: Amazon.Runtime.Internal::MetricsHandler
// SizeInfo { instance_size: 40, native_size: -1, calculated_instance_size: 40, calculated_native_size: 40, minimum_alignment: 8, natural_alignment: 0, packing: None, specified_packing: None }
namespace Amazon::Runtime::Internal {
// Is value type: false
// CS Name: ::Amazon.Runtime.Internal::MetricsHandler*
class CORDL_TYPE MetricsHandler : public ::Amazon::Runtime::Internal::PipelineHandler {
public:
  // Declarations
  template <typename T> using _InvokeAsync_d__1_1 = ::Amazon::Runtime::Internal::__MetricsHandler___InvokeAsync_d__1_1<T>;
  ...
  /// @brief Method InvokeSync, addr 0x23e5dfc, size 0x2c4, virtual true, abstract: false, final false
  inline void InvokeSync(::Amazon::Runtime::IExecutionContext* executionContext);

  static inline ::Amazon::Runtime::Internal::MetricsHandler* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x23e60c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Amazon::Runtime::Internal::MetricsHandler, 0x28>, "Size mismatch!");

} // namespace Amazon::Runtime::Internal
NEED_NO_BOX(::Amazon::Runtime::Internal::MetricsHandler);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Runtime::Internal::MetricsHandler*, "Amazon.Runtime.Internal", "MetricsHandler");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Amazon::Runtime::Internal::__MetricsHandler___InvokeAsync_d__1_1, "Amazon.Runtime.Internal", "MetricsHandler/<InvokeAsync>d__1`1");
