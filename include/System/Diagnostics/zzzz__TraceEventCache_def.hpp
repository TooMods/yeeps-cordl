...
public:
  ...
  /// @brief Method GetProcessId, addr 0x12b6314, size 0x54, virtual false, abstract: false, final false
  static inline int32_t GetProcessId();

  /// @brief Method GetThreadId, addr 0x12b63d8, size 0x20, virtual false, abstract: false, final false
  static inline int32_t GetThreadId();

  /// @brief Method InitProcessInfo, addr 0x12b6460, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12b6864, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Callstack, addr 0x12b6244, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_Callstack();

  /// @brief Method get_DateTime, addr 0x12b627c, size 0x94, virtual false, abstract: false, final false
  inline ::System::DateTime get_DateTime();

  /// @brief Method get_LogicalOperationStack, addr 0x12b6264, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Stack* get_LogicalOperationStack();

  /// @brief Method get_ProcessId, addr 0x12b6310, size 0x4, virtual false, abstract: false, final false
  inline int32_t get_ProcessId();

  /// @brief Method get_ThreadId, addr 0x12b6368, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_ThreadId();

  /// @brief Method get_Timestamp, addr 0x12b63f8, size 0x64, virtual false, abstract: false, final false
