...
public:
  ...
  /// @brief Method BuiltinUpdate, addr 0x29e11c4, size 0x28, virtual false, abstract: false, final false
  static inline bool BuiltinUpdate();

  /// @brief Method Dispose, addr 0x29e11ec, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x29e11f0, size 0x4, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Internal_BuiltinRuntimeReflectionSystem_New, addr 0x29e11f4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method TickRealtimeProbes, addr 0x29e119c, size 0x28, virtual true, abstract: false, final true
  inline bool TickRealtimeProbes();

  /// @brief Method .ctor, addr 0x29e1250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
