...
public:
  ...
  /// @brief Method Create, addr 0x30d79f4, size 0x140, virtual false, abstract: false, final false
  static inline ::System::LazyHelper* Create(::System::Threading::LazyThreadSafetyMode mode, bool useDefaultConstructor);

  /// @brief Method CreateViaDefaultConstructor, addr 0x30d7b34, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowException, addr 0x30d79d8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30d7988, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::LazyThreadSafetyMode mode, ::System::Exception* exception);

  /// @brief Method .ctor, addr 0x30d7960, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_State, addr 0x30d7958, size 0x8, virtual false, abstract: false, final false
