...
public:
  ...
  /// @brief Method .ctor, addr 0x2f4404c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW javaStackTrace);

  /// @brief Method get_StackTrace, addr 0x2f49d30, size 0x24, virtual true, abstract: false, final false
