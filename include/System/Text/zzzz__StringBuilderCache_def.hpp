...
public:
  ...
  /// @brief Method Acquire, addr 0x133213c, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Text::StringBuilder* Acquire(int32_t capacity);

  /// @brief Method GetStringAndRelease, addr 0x1332204, size 0x3c, virtual false, abstract: false, final false
  static inline ::StringW GetStringAndRelease(::System::Text::StringBuilder* sb);

  /// @brief Method Release, addr 0x1336200, size 0x78, virtual false, abstract: false, final false
