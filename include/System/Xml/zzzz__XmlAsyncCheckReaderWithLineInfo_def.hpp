...
public:
  ...
  /// @brief Method HasLineInfo, addr 0x14cd48c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14cc5a4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlReader* reader);

  /// @brief Method get_LineNumber, addr 0x14cd52c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x14cd5d0, size 0xa4, virtual true, abstract: false, final false
