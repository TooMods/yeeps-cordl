...
public:
  ...
  /// @brief Method Initialize, addr 0x29e3264, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29e319c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x29e321c, size 0x48, virtual false, abstract: false, final false
