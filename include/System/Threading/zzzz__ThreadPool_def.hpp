...
public:
  ...
  /// @brief Method EnsureVMInitialized, addr 0xece798, size 0x94, virtual false, abstract: false, final false
  static inline void EnsureVMInitialized();

  /// @brief Method InitializeVMTp, addr 0xece944, size 0x4, virtual false, abstract: false, final false
  static inline void InitializeVMTp(ByRef<bool> enableWorkerTracking);

  /// @brief Method NotifyWorkItemComplete, addr 0xecd964, size 0x4, virtual false, abstract: false, final false
  static inline bool NotifyWorkItemComplete();

  /// @brief Method NotifyWorkItemProgress, addr 0xece950, size 0x10, virtual false, abstract: false, final false
  static inline void NotifyWorkItemProgress();

  /// @brief Method NotifyWorkItemProgressNative, addr 0xece960, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyWorkItemProgressNative();

  /// @brief Method NotifyWorkItemQueued, addr 0xeccc58, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueUserWorkItem, addr 0xece76c, size 0x2c, virtual false, abstract: false, final false
  static inline bool QueueUserWorkItem(::System::Threading::WaitCallback* callBack);

  /// @brief Method QueueUserWorkItem, addr 0xece484, size 0x28, virtual false, abstract: false, final false
  static inline bool QueueUserWorkItem(::System::Threading::WaitCallback* callBack, ::System::Object* state);

  /// @brief Method QueueUserWorkItemHelper, addr 0xece64c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterWaitForSingleObject, addr 0xece4d4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterWaitForSingleObject, addr 0xece1fc, size 0x1d4, virtual false, abstract: false, final false
  static inline ::System::Threading::RegisteredWaitHandle* RegisterWaitForSingleObject(::System::Threading::WaitHandle* waitObject, ::System::Threading::WaitOrTimerCallback* callBack,
  ...
  /// @brief Method RegisterWaitForSingleObject, addr 0xece558, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Threading::RegisteredWaitHandle* RegisterWaitForSingleObject(::System::Threading::WaitHandle* waitObject, ::System::Threading::WaitOrTimerCallback* callBack,
                                                                                       ::System::Object* state, ::System::TimeSpan timeout, bool executeOnlyOnce);

  /// @brief Method ReportThreadStatus, addr 0xece948, size 0x8, virtual false, abstract: false, final false
  static inline void ReportThreadStatus(bool isWorking);

  /// @brief Method RequestWorkerThread, addr 0xecc5e4, size 0x4, virtual false, abstract: false, final false
  static inline bool RequestWorkerThread();

  /// @brief Method TryPopCustomWorkItem, addr 0xece8a8, size 0x9c, virtual false, abstract: false, final false
  static inline bool TryPopCustomWorkItem(::System::Threading::IThreadPoolWorkItem* workItem);

  /// @brief Method UnsafeQueueCustomWorkItem, addr 0xece82c, size 0x7c, virtual false, abstract: false, final false
  static inline void UnsafeQueueCustomWorkItem(::System::Threading::IThreadPoolWorkItem* workItem, bool forceGlobal);

  /// @brief Method UnsafeQueueUserWorkItem, addr 0xece4ac, size 0x28, virtual false, abstract: false, final false
  static inline bool UnsafeQueueUserWorkItem(::System::Threading::WaitCallback* callBack, ::System::Object* state);

  /// @brief Method get_IsThreadPoolThread, addr 0xece964, size 0x20, virtual false, abstract: false, final false
