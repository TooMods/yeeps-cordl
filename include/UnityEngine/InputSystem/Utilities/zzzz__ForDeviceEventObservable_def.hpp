...
public:
  ...
  /// @brief Method OnCompleted, addr 0x2270384, size 0x4, virtual true, abstract: false, final true
  inline void OnCompleted();

  /// @brief Method OnError, addr 0x2270388, size 0x58, virtual true, abstract: false, final true
  inline void OnError(::System::Exception* error);

  /// @brief Method OnNext, addr 0x22703e0, size 0x184, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2270348, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Subscribe, addr 0x2270258, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x227021c, size 0x3c, virtual false, abstract: false, final false
