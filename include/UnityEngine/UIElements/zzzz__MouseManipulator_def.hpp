...
public:
  ...
  /// @brief Method CanStartManipulation, addr 0x2a38dd8, size 0x17c, virtual false, abstract: false, final false
  inline bool CanStartManipulation(::UnityEngine::UIElements::IMouseEvent* e);

  /// @brief Method CanStopManipulation, addr 0x2a38f54, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a38d58, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activators, addr 0x2a38d48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::ManipulatorActivationFilter>* get_activators();

  /// @brief Method set_activators, addr 0x2a38d50, size 0x8, virtual false, abstract: false, final false
