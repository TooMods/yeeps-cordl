...
public:
  ...
  /// @brief Method .ctor, addr 0x21c7468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Guid, addr 0x21c7458, size 0x8, virtual false, abstract: false, final false
  inline void set_Guid(::StringW value);

  /// @brief Method set_Name, addr 0x21c7460, size 0x8, virtual false, abstract: false, final false
