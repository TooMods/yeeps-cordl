...
public:
  ...
  /// @brief Method RegisterEngineFactories, addr 0x27b097c, size 0xb2c, virtual false, abstract: false, final false
  static inline void RegisterEngineFactories();

  /// @brief Method RegisterFactory, addr 0x27b1778, size 0x470, virtual false, abstract: false, final false
  static inline void RegisterFactory(::UnityEngine::UIElements::IUxmlFactory* factory);

  /// @brief Method RegisterUserFactories, addr 0x27b14a8, size 0x2d0, virtual false, abstract: false, final false
  static inline void RegisterUserFactories();

  /// @brief Method TryGetValue, addr 0x27b1be8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_factories, addr 0x27b08cc, size 0xb0, virtual false, abstract: false, final false
