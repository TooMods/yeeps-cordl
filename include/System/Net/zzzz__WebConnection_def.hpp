...
public:
  ...
  /// @brief Method <Connect>b__16_0, addr 0x1045f2c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method <Connect>b__16_1, addr 0x1045fcc, size 0xf4, virtual false, abstract: false, final false
  inline void _Connect_b__16_1(::System::IAsyncResult* asyncResult);

  /// @brief Method .ctor, addr 0x1045f24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x10460c0, size 0x8c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1046988, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1046994, size 0x674, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1047008, size 0x1058, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2de0ae0, size 0x4e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2de1174, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method CanReuse, addr 0x1044ff0, size 0x30, virtual false, abstract: false, final false
  inline bool CanReuse();

  /// @brief Method CanReuseConnection, addr 0x1043898, size 0x42c, virtual false, abstract: false, final false
  inline bool CanReuseConnection(::System::Net::WebOperation* operation);

  /// @brief Method CheckReusable, addr 0x1045020, size 0x9c, virtual false, abstract: false, final false
  inline bool CheckReusable();

  /// @brief Method Close, addr 0x1045b14, size 0xc8, virtual false, abstract: false, final false
  inline void Close(bool reset);

  /// @brief Method CloseSocket, addr 0x1045bdc, size 0x26c, virtual false, abstract: false, final false
  inline void CloseSocket();

  /// @brief Method Connect, addr 0x10450bc, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Continue, addr 0x1042700, size 0x168, virtual false, abstract: false, final false
  inline bool Continue(::System::Net::WebOperation* next);

  /// @brief Method CreateStream, addr 0x10451a0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x104356c, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1045e50, size 0x38, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetException, addr 0x10453c4, size 0x188, virtual false, abstract: false, final false
  static inline ::System::Net::WebException* GetException(::System::Net::WebExceptionStatus status, ::System::Exception* error);

  /// @brief Method InitConnection, addr 0x10452c0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareSharingNtlm, addr 0x1045734, size 0x31c, virtual false, abstract: false, final false
  inline bool PrepareSharingNtlm(::System::Net::WebOperation* operation);

  /// @brief Method ReadLine, addr 0x104554c, size 0x1e8, virtual false, abstract: false, final false
  static inline bool ReadLine(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, ByRef<int32_t> start, int32_t max, ByRef<::StringW> output);

  /// @brief Method Reset, addr 0x1045a50, size 0xb8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ResetNtlm, addr 0x1045b08, size 0xc, virtual false, abstract: false, final false
  inline void ResetNtlm();

  /// @brief Method StartOperation, addr 0x1043cc4, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1043ec0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePoint* sPoint);

  /// @brief Method get_Closed, addr 0x1043574, size 0x10, virtual false, abstract: false, final false
  inline bool get_Closed();

  /// @brief Method get_IdleSince, addr 0x1045e48, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_IdleSince();

  /// @brief Method get_NtlmAuthenticated, addr 0x1045e88, size 0x8, virtual false, abstract: false, final false
  inline bool get_NtlmAuthenticated();

  /// @brief Method get_NtlmCredential, addr 0x1045e9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::NetworkCredential* get_NtlmCredential();

  /// @brief Method get_ServicePoint, addr 0x1044fe8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method get_UnsafeAuthenticatedConnectionSharing, addr 0x1045eac, size 0x8, virtual false, abstract: false, final false
  inline bool get_UnsafeAuthenticatedConnectionSharing();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_NtlmAuthenticated, addr 0x1045e90, size 0xc, virtual false, abstract: false, final false
  inline void set_NtlmAuthenticated(bool value);

  /// @brief Method set_NtlmCredential, addr 0x1045ea4, size 0x8, virtual false, abstract: false, final false
  inline void set_NtlmCredential(::System::Net::NetworkCredential* value);

  /// @brief Method set_UnsafeAuthenticatedConnectionSharing, addr 0x1045eb4, size 0xc, virtual false, abstract: false, final false
