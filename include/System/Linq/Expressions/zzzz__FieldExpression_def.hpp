...
public:
  ...
  /// @brief Method GetMember, addr 0x1839f8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1839f0c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression, ::System::Reflection::FieldInfo* member);

  /// @brief Method get_Type, addr 0x1839f94, size 0x24, virtual true, abstract: false, final true
