...
public:
  ...
  /// @brief Method ExpandPrime, addr 0x21c7c4c, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ExpandPrime(int32_t oldSize);

  /// @brief Method GetPrime, addr 0x21c7abc, size 0x190, virtual false, abstract: false, final false
  static inline int32_t GetPrime(int32_t min);

  /// @brief Method IsPrime, addr 0x21c7a0c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SerializationInfoTable, addr 0x21c7cd0, size 0xe0, virtual false, abstract: false, final false
