...
public:
  ...
  /// @brief Method Append, addr 0x1b641b4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Push, addr 0x1b64240, size 0x134, virtual false, abstract: false, final false
  inline void Push(::System::Linq::Expressions::Expression* node, int32_t depth);

  /// @brief Method ToExpression, addr 0x1b64374, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b64448, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetInstanceRestriction, addr 0x1b63f54, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeRestriction, addr 0x1b63cdc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeRestriction, addr 0x1b63e0c, size 0xbc, virtual false, abstract: false, final false
  static inline ::System::Dynamic::BindingRestrictions* GetTypeRestriction(::System::Dynamic::DynamicMetaObject* obj);

  /// @brief Method Merge, addr 0x1b63b74, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToExpression, addr 0x1b6408c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ToExpression();

  /// @brief Method .ctor, addr 0x1b63b6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
