...
public:
  ...
  /// @brief Method MarkModified, addr 0x125fb54, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x125f7d0, size 0x384, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x125f79c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRMeshData meshData);

  /// @brief Method get_MeshData, addr 0x125f774, size 0x10, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMeshData get_MeshData();

  /// @brief Method set_MeshData, addr 0x125f784, size 0x18, virtual false, abstract: false, final false
