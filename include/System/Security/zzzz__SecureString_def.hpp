...
public:
  ...
  /// @brief Method Alloc, addr 0x1ea4578, size 0x17c, virtual false, abstract: false, final false
  inline void Alloc(int32_t length, bool realloc);

  /// @brief Method Decrypt, addr 0x1ea48e0, size 0x4, virtual false, abstract: false, final false
  inline void Decrypt();

  /// @brief Method Dispose, addr 0x1ea48a8, size 0x38, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Encrypt, addr 0x1ea4840, size 0x4, virtual false, abstract: false, final false
  inline void Encrypt();

  /// @brief Method GetBuffer, addr 0x1ea48e4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea4554, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ea46f4, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::cordl_internals::Ptr<char16_t> value, int32_t length);

  /// @brief Method get_Length, addr 0x1ea4844, size 0x64, virtual false, abstract: false, final false
