...
public:
  ...
  /// @brief Method AreEqual, addr 0x2a8ac1c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method AreEqual, addr 0x2a8afa0, size 0x8c, virtual false, abstract: false, final false
  static inline void AreEqual(int32_t expected, int32_t actual);

  /// @brief Method AreNotEqual, addr 0x2a8aed8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Fail, addr 0x2a8a720, size 0x128, virtual false, abstract: false, final false
  static inline void Fail(::StringW message, ::StringW userMessage);

  /// @brief Method IsFalse, addr 0x2a8a848, size 0x80, virtual false, abstract: false, final false
  static inline void IsFalse(bool condition, ::StringW message);

  /// @brief Method IsNotNull, addr 0x2a8aaec, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNull, addr 0x2a8a8c8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTrue, addr 0x2a8a5a4, size 0x6c, virtual false, abstract: false, final false
  static inline void IsTrue(bool condition);

  /// @brief Method IsTrue, addr 0x2a8a610, size 0x80, virtual false, abstract: false, final false
