...
public:
  ...
  /// @brief Method Clone, addr 0x18b47b8, size 0x168, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  static inline ::System::Xml::Schema::XmlSchemaSimpleTypeUnion* New_ctor();

  /// @brief Method SetBaseMemberTypes, addr 0x18b47b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18b4920, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseMemberTypes, addr 0x18b47a8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::Schema::XmlSchemaSimpleType*, ::Array<::System::Xml::Schema::XmlSchemaSimpleType*>*> get_BaseMemberTypes();

  /// @brief Method get_BaseTypes, addr 0x18b4790, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_BaseTypes();

  /// @brief Method get_MemberTypes, addr 0x18b4798, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::XmlQualifiedName*, ::Array<::System::Xml::XmlQualifiedName*>*> get_MemberTypes();

  /// @brief Method set_MemberTypes, addr 0x18b47a0, size 0x8, virtual false, abstract: false, final false
