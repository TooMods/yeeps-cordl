...
public:
  ...
  /// @brief Method SqlTruncateExceptionSerialization, addr 0x1e406e0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e354e8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e40658, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1e40634, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x1e40680, size 0x60, virtual false, abstract: false, final false
