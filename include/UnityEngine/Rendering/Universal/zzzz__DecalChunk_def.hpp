...
public:
  ...
  /// @brief Method Dispose, addr 0x2c681f4, size 0x4, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalChunk* New_ctor();

  /// @brief Method Push, addr 0x2c681e4, size 0x10, virtual true, abstract: false, final false
  inline void Push();
  ...
  /// @brief Method ResizeNativeArray, addr 0x2c681f8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c682c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_capacity, addr 0x2c681c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_capacity();

  /// @brief Method get_count, addr 0x2c681b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_count();

  /// @brief Method get_currentJobHandle, addr 0x2c681d0, size 0xc, virtual false, abstract: false, final false
  inline ::Unity::Jobs::JobHandle get_currentJobHandle();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_capacity, addr 0x2c681c8, size 0x8, virtual false, abstract: false, final false
  inline void set_capacity(int32_t value);

  /// @brief Method set_count, addr 0x2c681b8, size 0x8, virtual false, abstract: false, final false
  inline void set_count(int32_t value);

  /// @brief Method set_currentJobHandle, addr 0x2c681dc, size 0x8, virtual false, abstract: false, final false
