...
public:
  ...
  /// @brief Method CopyFrom, addr 0x19789a8, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x197cd3c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
