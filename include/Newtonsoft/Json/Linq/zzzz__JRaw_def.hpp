...
public:
  ...
  /// @brief Method CloneToken, addr 0x1345cc0, size 0x64, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken();

  /// @brief Method Create, addr 0x1345948, size 0x378, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JRaw* Create(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CreateAsync, addr 0x1345838, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1345934, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JRaw* other);

  /// @brief Method .ctor, addr 0x134593c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1345d24, size 0x598, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x13462bc, size 0x58, virtual true, abstract: false, final true
