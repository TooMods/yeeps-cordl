...
public:
  ...
  /// @brief Method IsMatch, addr 0x171c3cc, size 0x6c, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW text, int32_t index, int32_t beglimit, int32_t endlimit);

  /// @brief Method MatchPattern, addr 0x171c2a8, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Scan, addr 0x171c438, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x171bdf4, size 0x4b4, virtual false, abstract: false, final false
