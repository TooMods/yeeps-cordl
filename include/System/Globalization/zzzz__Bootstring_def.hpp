...
public:
  ...
  /// @brief Method Adapt, addr 0x21c4698, size 0x78, virtual false, abstract: false, final false
  inline int32_t Adapt(int32_t delta, int32_t numPoints, bool firstTime);

  /// @brief Method Decode, addr 0x21c433c, size 0x2d8, virtual false, abstract: false, final false
  inline ::StringW Decode(::StringW s, int32_t offset);

  /// @brief Method DecodeDigit, addr 0x21c4710, size 0x38, virtual false, abstract: false, final false
  inline int32_t DecodeDigit(char16_t c);

  /// @brief Method Encode, addr 0x21c3bb4, size 0x344, virtual false, abstract: false, final false
  inline ::StringW Encode(::StringW s, int32_t offset);

  /// @brief Method EncodeDigit, addr 0x21c4680, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c4614, size 0x6c, virtual false, abstract: false, final false
