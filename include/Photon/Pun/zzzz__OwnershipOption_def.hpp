...
// Type: Photon.Pun::OwnershipOption
...
public:
  ...
  /// @brief Field Request value: static_cast<int32_t>(0x2)
  static ::Photon::Pun::OwnershipOption const Request;

  /// @brief Field Takeover value: static_cast<int32_t>(0x1)
...
static_assert(::cordl_internals::size_check_v<::Photon::Pun::OwnershipOption, 0x4>, "Size mismatch!");
