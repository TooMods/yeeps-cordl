...
public:
  ...
  /// @brief Method MoveNext, addr 0x21ee2f8, size 0x254, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Unity::XR::Oculus::__OculusRestarter___PauseAndRestartCoroutine_d__22* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x21ee58c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x21ee594, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x21ee5d4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x21ee2dc, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x21ee54c, size 0x40, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x21ee208, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x21ee608, size 0x42c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Unity::XR::Oculus::__OculusRestarter___RestartCoroutine_d__23* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x21eeb48, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x21eeb50, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x21eeb90, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x21ee5dc, size 0x2c, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method <>m__Finally1, addr 0x21eea34, size 0x114, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x21ee2ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method PauseAndRestart, addr 0x21ee070, size 0x120, virtual false, abstract: false, final false
  inline void PauseAndRestart();

  /// @brief Method PauseAndRestartCoroutine, addr 0x21ee190, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* PauseAndRestartCoroutine(float_t pauseTimeInSeconds);

  /// @brief Method ResetCallbacks, addr 0x21edd10, size 0x68, virtual false, abstract: false, final false
  inline void ResetCallbacks();

  /// @brief Method RestartCoroutine, addr 0x21ee230, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21ee2d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Instance, addr 0x21ede9c, size 0x1d4, virtual false, abstract: false, final false
  static inline ::UnityW<::Unity::XR::Oculus::OculusRestarter> get_Instance();

  /// @brief Method get_PauseAndRestartAttempts, addr 0x21ede44, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_PauseAndRestartAttempts();

  /// @brief Method get_TimeBetweenRestartAttempts, addr 0x21edd88, size 0x58, virtual false, abstract: false, final false
  static inline float_t get_TimeBetweenRestartAttempts();

  /// @brief Method get_isRunning, addr 0x21edd78, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_TimeBetweenRestartAttempts, addr 0x21edde0, size 0x64, virtual false, abstract: false, final false
