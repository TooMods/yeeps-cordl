...
public:
  ...
  /// @brief Method <.cctor>b__25_0, addr 0x27d7c44, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__25_0();

  /// @brief Method <.cctor>b__25_1, addr 0x27d7c4c, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__25_1();

  /// @brief Method .ctor, addr 0x27d7c3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnItemUnscheduled, addr 0x27d7a9c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetStartTime, addr 0x27d7a40, size 0x5c, virtual false, abstract: false, final false
  inline void ResetStartTime();

  /// @brief Method ShouldUnschedule, addr 0x27d7aa0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27d79cc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_delayMs, addr 0x27d79a4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_delayMs();

  /// @brief Method get_endTimeMs, addr 0x27d79c4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_endTimeMs();

  /// @brief Method get_intervalMs, addr 0x27d79b4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_intervalMs();

  /// @brief Method get_startMs, addr 0x27d7994, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_delayMs, addr 0x27d79ac, size 0x8, virtual false, abstract: false, final false
  inline void set_delayMs(int64_t value);

  /// @brief Method set_intervalMs, addr 0x27d79bc, size 0x8, virtual false, abstract: false, final false
  inline void set_intervalMs(int64_t value);

  /// @brief Method set_startMs, addr 0x27d799c, size 0x8, virtual false, abstract: false, final false
