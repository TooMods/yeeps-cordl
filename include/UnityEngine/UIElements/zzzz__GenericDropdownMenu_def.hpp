...
namespace UnityEngine::UIElements {
struct __GenericDropdownMenu____c__DisplayClass27_0;
}
...
MARK_VAL_T(::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0);
// Type: ::MenuItem
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cdd9a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace UnityEngine::UIElements {
// Is value type: true
// CS Name: ::GenericDropdownMenu::<>c__DisplayClass27_0
struct CORDL_TYPE __GenericDropdownMenu____c__DisplayClass27_0 {
public:
  // Declarations
  // Ctor Parameters []
  // @brief default ctor
  constexpr __GenericDropdownMenu____c__DisplayClass27_0();
  ...
  // "", def_value: None }]
  constexpr __GenericDropdownMenu____c__DisplayClass27_0(::UnityEngine::UIElements::GenericDropdownMenu* __4__this, int32_t selectedIndex) noexcept;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0, 0x10>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0, __4__this) == 0x0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0, selectedIndex) == 0x8, "Offset mismatch!");
...
public:
  ...
  using __c__DisplayClass27_0 = ::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0;
  ...
  /// @brief Method AddItem, addr 0x2cdd5b0, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method AddItem, addr 0x2cdd588, size 0x28, virtual true, abstract: false, final true
  inline void AddItem(::StringW itemName, bool isChecked, ::System::Action* action);

  /// @brief Method AddSeparator, addr 0x2cdd8f0, size 0xb0, virtual true, abstract: false, final true
  inline void AddSeparator(::StringW path);

  /// @brief Method Apply, addr 0x2cdcac4, size 0x184, virtual false, abstract: false, final false
  inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op);

  /// @brief Method Apply, addr 0x2cdca88, size 0x3c, virtual false, abstract: false, final false
  inline void Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op, ::UnityEngine::UIElements::EventBase* sourceEvent);

  /// @brief Method ChangeSelectedIndex, addr 0x2cdd454, size 0x134, virtual false, abstract: false, final false
  inline void ChangeSelectedIndex(int32_t newIndex, int32_t previousIndex);

  /// @brief Method DropDown, addr 0x2cdd9a8, size 0x75c, virtual true, abstract: false, final true
  inline void DropDown(::UnityEngine::Rect position, ::UnityEngine::UIElements::VisualElement* targetElement, bool anchored);

  /// @brief Method EnsureVisibilityInParent, addr 0x2cde104, size 0x6e4, virtual false, abstract: false, final false
  inline void EnsureVisibilityInParent();

  /// @brief Method GetSelectedIndex, addr 0x2cdcc48, size 0xa0, virtual false, abstract: false, final false
  inline int32_t GetSelectedIndex();

  /// @brief Method Hide, addr 0x2cdc9a0, size 0xe8, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::UnityEngine::UIElements::GenericDropdownMenu* New_ctor();

  /// @brief Method OnAttachToPanel, addr 0x2cdc1c4, size 0x438, virtual false, abstract: false, final false
  inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnContainerGeometryChanged, addr 0x2cde7ec, size 0x4, virtual false, abstract: false, final false
  inline void OnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnDetachFromPanel, addr 0x2cdc5fc, size 0x3a4, virtual false, abstract: false, final false
  inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnFocusOut, addr 0x2cdd308, size 0x148, virtual false, abstract: false, final false
  inline void OnFocusOut(::UnityEngine::UIElements::FocusOutEvent* evt);

  /// @brief Method OnParentResized, addr 0x2cdd450, size 0x4, virtual false, abstract: false, final false
  inline void OnParentResized(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnPointerDown, addr 0x2cdce4c, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnPointerMove, addr 0x2cdd0a0, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* evt);

  /// @brief Method OnPointerUp, addr 0x2cdd1cc, size 0x13c, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* evt);

  /// @brief Method OnTargetElementDetachFromPanel, addr 0x2cde7e8, size 0x4, virtual false, abstract: false, final false
  inline void OnTargetElementDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method UpdateSelection, addr 0x2cdcf78, size 0x128, virtual false, abstract: false, final false
  inline void UpdateSelection(::UnityEngine::UIElements::VisualElement* target);

  /// @brief Method <Apply>g__UpdateSelectionDown|27_0, addr 0x2cdcd90, size 0xbc, virtual false, abstract: false, final false
  inline void _Apply_g__UpdateSelectionDown_27_0(int32_t newIndex, ByRef<::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0> _cordl_fixed_empty_name_whitespace);

  /// @brief Method <Apply>g__UpdateSelectionUp|27_1, addr 0x2cdcce8, size 0xa8, virtual false, abstract: false, final false
  inline void _Apply_g__UpdateSelectionUp_27_1(int32_t newIndex, ByRef<::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0> _cordl_fixed_empty_name_whitespace);
  ...
  /// @brief Method .ctor, addr 0x2cd6110, size 0x2d4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_contentContainer, addr 0x2cdc1a0, size 0x24, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::__GenericDropdownMenu____c__DisplayClass27_0, "UnityEngine.UIElements", "GenericDropdownMenu/<>c__DisplayClass27_0");
