...
public:
  ...
  /// @brief Method .ctor, addr 0x12b5d68, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* switchLevelType);

  /// @brief Method set_SwitchLevelType, addr 0x12b5d94, size 0xc0, virtual false, abstract: false, final false
