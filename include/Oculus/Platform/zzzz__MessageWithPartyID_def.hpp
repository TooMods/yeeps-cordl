...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4f58, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(void* c_message);

  /// @brief Method GetPartyID, addr 0x19b4f1c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetPartyID();

  static inline ::Oculus::Platform::MessageWithPartyID* New_ctor(void* c_message);

  /// @brief Method .ctor, addr 0x19b4ec4, size 0x58, virtual false, abstract: false, final false
