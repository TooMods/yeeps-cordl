...
public:
  ...
  /// @brief Method .ctor, addr 0x1d3ca14, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t numChannels, uint32_t frequencyHz, uint32_t maxBufferSize);

  /// @brief Method get_frequencyHz, addr 0x1d3ca30, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_frequencyHz();

  /// @brief Method get_maxBufferSize, addr 0x1d3ca40, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_maxBufferSize();

  /// @brief Method get_numChannels, addr 0x1d3ca20, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_numChannels();

  /// @brief Method set_frequencyHz, addr 0x1d3ca38, size 0x8, virtual false, abstract: false, final false
  inline void set_frequencyHz(uint32_t value);

  /// @brief Method set_maxBufferSize, addr 0x1d3ca48, size 0x8, virtual false, abstract: false, final false
  inline void set_maxBufferSize(uint32_t value);

  /// @brief Method set_numChannels, addr 0x1d3ca28, size 0x8, virtual false, abstract: false, final false
