...
public:
  ...
  /// @brief Method Add, addr 0xf626d4, size 0x820, virtual false, abstract: false, final false
  inline void Add(::System::Net::Cookie* cookie, bool throwOnError);

  /// @brief Method AddRemoveDomain, addr 0xf625ac, size 0x128, virtual false, abstract: false, final false
  inline void AddRemoveDomain(::StringW key, ::System::Net::PathList* value);

  /// @brief Method AgeCookies, addr 0xf63528, size 0x153c, virtual false, abstract: false, final false
  inline bool AgeCookies(::StringW domain);

  /// @brief Method BuildCookieCollectionFromDomainMatches, addr 0xf65a3c, size 0x804, virtual false, abstract: false, final false
  ...
  /// @brief Method CookieCutter, addr 0xf64ebc, size 0x6d4, virtual false, abstract: false, final false
  inline ::System::Net::CookieCollection* CookieCutter(::System::Uri* uri, ::StringW headerName, ::StringW setCookieHeader, bool isThrow);

  /// @brief Method ExpireCollection, addr 0xf64a90, size 0x16c, virtual false, abstract: false, final false
  inline int32_t ExpireCollection(::System::Net::CookieCollection* cc);

  /// @brief Method GetCookieHeader, addr 0xf66470, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW GetCookieHeader(::System::Uri* uri);

  /// @brief Method GetCookieHeader, addr 0xf66540, size 0x398, virtual false, abstract: false, final false
  inline ::StringW GetCookieHeader(::System::Uri* uri, ByRef<::StringW> optCookie2);

  /// @brief Method InternalGetCookies, addr 0xf65590, size 0x4ac, virtual false, abstract: false, final false
  inline ::System::Net::CookieCollection* InternalGetCookies(::System::Uri* uri);

  /// @brief Method IsLocalDomain, addr 0xf64c20, size 0x29c, virtual false, abstract: false, final false
  inline bool IsLocalDomain(::StringW host);

  /// @brief Method MergeUpdateCollections, addr 0xf66264, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf624b8, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();
