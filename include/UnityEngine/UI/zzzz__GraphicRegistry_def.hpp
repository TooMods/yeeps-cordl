...
public:
  ...
  /// @brief Method DisableGraphicForCanvas, addr 0x20020f4, size 0x180, virtual false, abstract: false, final false
  static inline void DisableGraphicForCanvas(::UnityEngine::Canvas* c, ::UnityEngine::UI::Graphic* graphic);

  /// @brief Method DisableRaycastGraphicForCanvas, addr 0x2006898, size 0x180, virtual false, abstract: false, final false
  static inline void DisableRaycastGraphicForCanvas(::UnityEngine::Canvas* c, ::UnityEngine::UI::Graphic* graphic);

  /// @brief Method GetGraphicsForCanvas, addr 0x2006a18, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRaycastableGraphicsForCanvas, addr 0x2005e10, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterGraphicForCanvas, addr 0x2002498, size 0x1f4, virtual false, abstract: false, final false
  static inline void RegisterGraphicForCanvas(::UnityEngine::Canvas* c, ::UnityEngine::UI::Graphic* graphic);

  /// @brief Method RegisterRaycastGraphicForCanvas, addr 0x2001970, size 0x1f4, virtual false, abstract: false, final false
  static inline void RegisterRaycastGraphicForCanvas(::UnityEngine::Canvas* c, ::UnityEngine::UI::Graphic* graphic);

  /// @brief Method UnregisterGraphicForCanvas, addr 0x2002e9c, size 0x1a4, virtual false, abstract: false, final false
  static inline void UnregisterGraphicForCanvas(::UnityEngine::Canvas* c, ::UnityEngine::UI::Graphic* graphic);

  /// @brief Method UnregisterRaycastGraphicForCanvas, addr 0x20017f4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2006648, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x20067f0, size 0xa8, virtual false, abstract: false, final false
