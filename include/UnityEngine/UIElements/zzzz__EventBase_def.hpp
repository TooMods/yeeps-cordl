...
public:
  ...
  /// @brief Method Init, addr 0x2ccd67c, size 0x4, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2ccd680, size 0x140, virtual false, abstract: false, final false
  inline void LocalInit();

  /// @brief Method MarkReceivedByDispatcher, addr 0x2ccd570, size 0x88, virtual false, abstract: false, final false
  inline void MarkReceivedByDispatcher();

  static inline ::UnityEngine::UIElements::EventBase* New_ctor();

  /// @brief Method PostDispatch, addr 0x2ccd37c, size 0x4, virtual true, abstract: false, final false
  inline void PostDispatch();

  /// @brief Method PostDispatch, addr 0x2ccd380, size 0x28, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method PreDispatch, addr 0x2ccd36c, size 0x4, virtual true, abstract: false, final false
  inline void PreDispatch();

  /// @brief Method PreDispatch, addr 0x2ccd370, size 0xc, virtual true, abstract: false, final false
  inline void PreDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method PreventDefault, addr 0x2cc20e8, size 0x18, virtual false, abstract: false, final false
  inline void PreventDefault();

  /// @brief Method RegisterEventType, addr 0x2ccd168, size 0x50, virtual false, abstract: false, final false
  static inline int64_t RegisterEventType();

  /// @brief Method SetTriggerEventId, addr 0x2ccd1e8, size 0x8, virtual false, abstract: false, final false
  inline void SetTriggerEventId(uint64_t id);

  /// @brief Method Skip, addr 0x2ccb55c, size 0x58, virtual false, abstract: false, final false
  inline bool Skip(::UnityEngine::UIElements::IEventHandler* h);

  /// @brief Method StopImmediatePropagation, addr 0x2ccd414, size 0x10, virtual false, abstract: false, final false
  inline void StopImmediatePropagation();

  /// @brief Method StopPropagation, addr 0x2cc20d8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ccd7dc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bubbles, addr 0x2ccd2ec, size 0xc, virtual false, abstract: false, final false
  inline bool get_bubbles();

  /// @brief Method get_currentTarget, addr 0x2ccd45c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IEventHandler* get_currentTarget();

  /// @brief Method get_dispatch, addr 0x2ccd548, size 0xc, virtual false, abstract: false, final false
  inline bool get_dispatch();

  /// @brief Method get_dispatched, addr 0x2ccd5f8, size 0xc, virtual false, abstract: false, final false
  inline bool get_dispatched();

  /// @brief Method get_eventId, addr 0x2ccd1d0, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_eventId();

  /// @brief Method get_eventTypeId, addr 0x2ccd1b8, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_eventTypeId();

  /// @brief Method get_ignoreCompositeRoots, addr 0x2ccc380, size 0xc, virtual false, abstract: false, final false
  inline bool get_ignoreCompositeRoots();

  /// @brief Method get_imguiEvent, addr 0x2ccca54, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Event* get_imguiEvent();

  /// @brief Method get_imguiEventIsValid, addr 0x2ccd644, size 0xc, virtual false, abstract: false, final false
  inline bool get_imguiEventIsValid();

  /// @brief Method get_isDefaultPrevented, addr 0x2ccd424, size 0xc, virtual false, abstract: false, final false
  inline bool get_isDefaultPrevented();

  /// @brief Method get_isImmediatePropagationStopped, addr 0x2ccb1c4, size 0xc, virtual false, abstract: false, final false
  inline bool get_isImmediatePropagationStopped();

  /// @brief Method get_isPropagationStopped, addr 0x2ccbd00, size 0xc, virtual false, abstract: false, final false
  inline bool get_isPropagationStopped();

  /// @brief Method get_leafTarget, addr 0x2ccd3c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IEventHandler* get_leafTarget();

  /// @brief Method get_lifeCycleStatus, addr 0x2ccd35c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__EventBase__LifeCycleStatus get_lifeCycleStatus();

  /// @brief Method get_originalMousePosition, addr 0x2ccd66c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_originalMousePosition();

  /// @brief Method get_path, addr 0x2ccd200, size 0xe0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PropagationPaths* get_path();

  /// @brief Method get_pooled, addr 0x2ccd864, size 0xc, virtual false, abstract: false, final false
  inline bool get_pooled();

  /// @brief Method get_processed, addr 0x2ccd604, size 0xc, virtual false, abstract: false, final false
  inline bool get_processed();

  /// @brief Method get_processedByFocusController, addr 0x2ccd610, size 0xc, virtual false, abstract: false, final false
  inline bool get_processedByFocusController();

  /// @brief Method get_propagateToIMGUI, addr 0x2ccc7f4, size 0xc, virtual false, abstract: false, final false
  inline bool get_propagateToIMGUI();

  /// @brief Method get_propagation, addr 0x2ccd1f0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__EventBase__EventPropagation get_propagation();

  /// @brief Method get_propagationPhase, addr 0x2ccd44c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PropagationPhase get_propagationPhase();

  /// @brief Method get_skipDisabledElements, addr 0x2ccb1d0, size 0xc, virtual false, abstract: false, final false
  inline bool get_skipDisabledElements();

  /// @brief Method get_skipElements, addr 0x2ccd3d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::IEventHandler*>* get_skipElements();

  /// @brief Method get_stopDispatch, addr 0x2ccd638, size 0xc, virtual false, abstract: false, final false
  inline bool get_stopDispatch();

  /// @brief Method get_target, addr 0x2cc49dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IEventHandler* get_target();

  /// @brief Method get_timestamp, addr 0x2ccd1c0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_timestamp();

  /// @brief Method get_tricklesDown, addr 0x2ccd2e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentTarget, addr 0x2ccd464, size 0xe4, virtual true, abstract: false, final false
  inline void set_currentTarget(::UnityEngine::UIElements::IEventHandler* value);

  /// @brief Method set_dispatch, addr 0x2cca520, size 0x20, virtual false, abstract: false, final false
  inline void set_dispatch(bool value);

  /// @brief Method set_dispatched, addr 0x2ccd554, size 0x1c, virtual false, abstract: false, final false
  inline void set_dispatched(bool value);

  /// @brief Method set_eventId, addr 0x2ccd1d8, size 0x8, virtual false, abstract: false, final false
  inline void set_eventId(uint64_t value);

  /// @brief Method set_ignoreCompositeRoots, addr 0x2ccc908, size 0x1c, virtual false, abstract: false, final false
  inline void set_ignoreCompositeRoots(bool value);

  /// @brief Method set_imguiEvent, addr 0x2cc931c, size 0xb4, virtual false, abstract: false, final false
  inline void set_imguiEvent(::UnityEngine::Event* value);

  /// @brief Method set_imguiEventIsValid, addr 0x2ccd650, size 0x1c, virtual false, abstract: false, final false
  inline void set_imguiEventIsValid(bool value);

  /// @brief Method set_isDefaultPrevented, addr 0x2ccd430, size 0x1c, virtual false, abstract: false, final false
  inline void set_isDefaultPrevented(bool value);

  /// @brief Method set_isImmediatePropagationStopped, addr 0x2ccd3f8, size 0x1c, virtual false, abstract: false, final false
  inline void set_isImmediatePropagationStopped(bool value);

  /// @brief Method set_isPropagationStopped, addr 0x2ccd3dc, size 0x1c, virtual false, abstract: false, final false
  inline void set_isPropagationStopped(bool value);

  /// @brief Method set_leafTarget, addr 0x2ccd3cc, size 0x8, virtual false, abstract: false, final false
  inline void set_leafTarget(::UnityEngine::UIElements::IEventHandler* value);

  /// @brief Method set_lifeCycleStatus, addr 0x2ccd364, size 0x8, virtual false, abstract: false, final false
  inline void set_lifeCycleStatus(::UnityEngine::UIElements::__EventBase__LifeCycleStatus value);

  /// @brief Method set_originalMousePosition, addr 0x2ccd674, size 0x8, virtual false, abstract: false, final false
  inline void set_originalMousePosition(::UnityEngine::Vector2 value);

  /// @brief Method set_path, addr 0x2ccd2f8, size 0x64, virtual false, abstract: false, final false
  inline void set_path(::UnityEngine::UIElements::PropagationPaths* value);

  /// @brief Method set_pooled, addr 0x2ccd7c0, size 0x1c, virtual false, abstract: false, final false
  inline void set_pooled(bool value);

  /// @brief Method set_processed, addr 0x2ccd3a8, size 0x1c, virtual false, abstract: false, final false
  inline void set_processed(bool value);

  /// @brief Method set_processedByFocusController, addr 0x2ccd61c, size 0x1c, virtual false, abstract: false, final false
  inline void set_processedByFocusController(bool value);

  /// @brief Method set_propagateToIMGUI, addr 0x2cca590, size 0x1c, virtual false, abstract: false, final false
  inline void set_propagateToIMGUI(bool value);

  /// @brief Method set_propagation, addr 0x2ccd1f8, size 0x8, virtual false, abstract: false, final false
  inline void set_propagation(::UnityEngine::UIElements::__EventBase__EventPropagation value);

  /// @brief Method set_propagationPhase, addr 0x2ccd454, size 0x8, virtual false, abstract: false, final false
  inline void set_propagationPhase(::UnityEngine::UIElements::PropagationPhase value);

  /// @brief Method set_skipDisabledElements, addr 0x2cca558, size 0x1c, virtual false, abstract: false, final false
  inline void set_skipDisabledElements(bool value);

  /// @brief Method set_stopDispatch, addr 0x2cca574, size 0x1c, virtual false, abstract: false, final false
  inline void set_stopDispatch(bool value);

  /// @brief Method set_target, addr 0x2cca540, size 0x18, virtual false, abstract: false, final false
  inline void set_target(::UnityEngine::UIElements::IEventHandler* value);

  /// @brief Method set_timestamp, addr 0x2ccd1c8, size 0x8, virtual false, abstract: false, final false
  inline void set_timestamp(int64_t value);

  /// @brief Method set_triggerEventId, addr 0x2ccd1e0, size 0x8, virtual false, abstract: false, final false
