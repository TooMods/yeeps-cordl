...
public:
  ...
  /// @brief Method PauseHaptics, addr 0x1e01794, size 0x110, virtual false, abstract: false, final false
  inline void PauseHaptics(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResetHaptics, addr 0x1e01ac4, size 0x90, virtual false, abstract: false, final false
  inline void ResetHaptics(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResumeHaptics, addr 0x1e018f4, size 0x8c, virtual false, abstract: false, final false
  inline void ResumeHaptics(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method SetMotorSpeeds, addr 0x1e01980, size 0x144, virtual false, abstract: false, final false
  inline void SetMotorSpeeds(::UnityEngine::InputSystem::InputDevice* device, float_t lowFrequency, float_t highFrequency);

  /// @brief Method get_highFrequencyMotorSpeed, addr 0x1e016cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_highFrequencyMotorSpeed();

  /// @brief Method get_isRumbling, addr 0x1e016dc, size 0xb8, virtual false, abstract: false, final false
  inline bool get_isRumbling();

  /// @brief Method get_lowFrequencyMotorSpeed, addr 0x1e016bc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lowFrequencyMotorSpeed();

  /// @brief Method set_highFrequencyMotorSpeed, addr 0x1e016d4, size 0x8, virtual false, abstract: false, final false
  inline void set_highFrequencyMotorSpeed(float_t value);

  /// @brief Method set_lowFrequencyMotorSpeed, addr 0x1e016c4, size 0x8, virtual false, abstract: false, final false
