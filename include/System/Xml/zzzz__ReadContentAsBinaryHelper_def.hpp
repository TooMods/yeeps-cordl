...
public:
  ...
  /// @brief Method Finish, addr 0x14cb3b4, size 0x140, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method MoveToNextContentNode, addr 0x14cb4f4, size 0xd8, virtual false, abstract: false, final false
  inline bool MoveToNextContentNode(bool moveIfOnContentNode);

  /// @brief Method Reset, addr 0x14cb5cc, size 0xc, virtual false, abstract: false, final false
  inline void Reset();
