...
public:
  ...
  /// @brief Method CheckIsEditorScript, addr 0x283b29c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultExecutionOrderFor, addr 0x283b37c, size 0x78, virtual false, abstract: false, final false
  static inline int32_t GetDefaultExecutionOrderFor(::System::Type* klass);

  /// @brief Method GetExecuteMode, addr 0x283b188, size 0x114, virtual false, abstract: false, final false
  static inline int32_t GetExecuteMode(::System::Type* klass);

  /// @brief Method GetParentTypeDisallowingMultipleInclusion, addr 0x283ac4c, size 0x100, virtual false, abstract: false, final false
  static inline ::System::Type* GetParentTypeDisallowingMultipleInclusion(::System::Type* type);

  /// @brief Method GetRequiredComponents, addr 0x283ad4c, size 0x43c, virtual false, abstract: false, final false
