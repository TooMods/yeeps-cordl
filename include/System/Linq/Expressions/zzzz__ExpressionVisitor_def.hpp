...
public:
  ...
  /// @brief Method ValidateBinary, addr 0x18378a8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateChildType, addr 0x18388e4, size 0xcc, virtual false, abstract: false, final false
  static inline void ValidateChildType(::System::Type* before, ::System::Type* after, ::StringW methodName);

  /// @brief Method ValidateUnary, addr 0x18387d8, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Visit, addr 0x183758c, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method Visit, addr 0x1837568, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitArguments, addr 0x18377c0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method VisitLoop, addr 0x1837e5c, size 0x84, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitLoop(::System::Linq::Expressions::LoopExpression* node);

  /// @brief Method VisitMember, addr 0x1837f8c, size 0x30, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMember(::System::Linq::Expressions::MemberExpression* node);

  /// @brief Method VisitMethodCall, addr 0x1838140, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMethodCall(::System::Linq::Expressions::MethodCallExpression* node);

  /// @brief Method VisitNewArray, addr 0x18381e4, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitNewArray(::System::Linq::Expressions::NewArrayExpression* node);

  /// @brief Method VisitParameter, addr 0x1838334, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitParameter(::System::Linq::Expressions::ParameterExpression* node);

  /// @brief Method VisitParameters, addr 0x18377c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method VisitTry, addr 0x18383f8, size 0x108, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTry(::System::Linq::Expressions::TryExpression* node);

  /// @brief Method VisitTypeBinary, addr 0x18385fc, size 0x30, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTypeBinary(::System::Linq::Expressions::TypeBinaryExpression* node);

  /// @brief Method VisitUnary, addr 0x18386dc, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitUnary(::System::Linq::Expressions::UnaryExpression* node);

  /// @brief Method .ctor, addr 0x18351e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
