...
public:
  ...
  /// @brief Method GetCachedFontAsset, addr 0x2cc6724, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateLocalizationFontAsset, addr 0x2cc7114, size 0x4c0, virtual false, abstract: false, final false
  static inline void UpdateLocalizationFontAsset();

  /// @brief Method .ctor, addr 0x2cc75d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_defaultPanelTextSettings, addr 0x2cc6c2c, size 0x134, virtual false, abstract: false, final false
