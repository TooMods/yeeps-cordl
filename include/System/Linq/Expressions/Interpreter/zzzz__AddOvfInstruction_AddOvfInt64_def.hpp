...
public:
  ...
  /// @brief Method Run, addr 0x183fa24, size 0x1e8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x183f570, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
