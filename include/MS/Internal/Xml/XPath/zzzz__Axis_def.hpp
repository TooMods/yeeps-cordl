...
public:
  ...
  /// @brief Method .ctor, addr 0x1b2e27c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::__Axis__AxisType axisType, ::MS::Internal::Xml::XPath::AstNode* input);

  /// @brief Method .ctor, addr 0x1b2e1e4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AbbrAxis, addr 0x1b2e338, size 0x8, virtual false, abstract: false, final false
  inline bool get_AbbrAxis();

  /// @brief Method get_Input, addr 0x1b2e308, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::AstNode* get_Input();

  /// @brief Method get_Name, addr 0x1b2e320, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x1b2e328, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x1b2e318, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_ReturnType, addr 0x1b2e300, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x1b2e2f8, size 0x8, virtual true, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::__AstNode__AstType get_Type();

  /// @brief Method get_TypeOfAxis, addr 0x1b2e330, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::__Axis__AxisType get_TypeOfAxis();

  /// @brief Method get_Urn, addr 0x1b2e340, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Urn();

  /// @brief Method set_Input, addr 0x1b2e310, size 0x8, virtual false, abstract: false, final false
  inline void set_Input(::MS::Internal::Xml::XPath::AstNode* value);

  /// @brief Method set_Urn, addr 0x1b2e348, size 0x8, virtual false, abstract: false, final false
