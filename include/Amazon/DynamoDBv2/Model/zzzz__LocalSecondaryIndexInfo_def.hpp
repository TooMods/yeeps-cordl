...
CORDL_MODULE_EXPORT(LocalSecondaryIndexInfo)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo);
// Type: Amazon.DynamoDBv2.Model::LocalSecondaryIndexInfo
// SizeInfo { instance_size: 40, native_size: -1, calculated_instance_size: 40, calculated_native_size: 40, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::LocalSecondaryIndexInfo*
class CORDL_TYPE LocalSecondaryIndexInfo : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method IsSetIndexName, addr 0x104bb48, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetIndexName();

  /// @brief Method IsSetKeySchema, addr 0x104bb68, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetKeySchema();

  /// @brief Method IsSetProjection, addr 0x104bbcc, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetProjection();

  static inline ::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x104bbdc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IndexName, addr 0x104bb38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IndexName();

  /// @brief Method get_KeySchema, addr 0x104bb58, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::DynamoDBv2::Model::KeySchemaElement*>* get_KeySchema();

  /// @brief Method get_Projection, addr 0x104bbbc, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::Model::Projection* get_Projection();

  /// @brief Method set_IndexName, addr 0x104bb40, size 0x8, virtual false, abstract: false, final false
  inline void set_IndexName(::StringW value);

  /// @brief Method set_KeySchema, addr 0x104bb60, size 0x8, virtual false, abstract: false, final false
  inline void set_KeySchema(::System::Collections::Generic::List_1<::Amazon::DynamoDBv2::Model::KeySchemaElement*>* value);

  /// @brief Method set_Projection, addr 0x104bbc4, size 0x8, virtual false, abstract: false, final false
  inline void set_Projection(::Amazon::DynamoDBv2::Model::Projection* value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr LocalSecondaryIndexInfo();

public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalSecondaryIndexInfo", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalSecondaryIndexInfo(LocalSecondaryIndexInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalSecondaryIndexInfo", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalSecondaryIndexInfo(LocalSecondaryIndexInfo const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo, 0x28>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo, ____indexName) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo, ____keySchema) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo, ____projection) == 0x20, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::LocalSecondaryIndexInfo*, "Amazon.DynamoDBv2.Model", "LocalSecondaryIndexInfo");
