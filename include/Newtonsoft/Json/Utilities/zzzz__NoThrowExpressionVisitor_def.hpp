...
public:
  ...
  /// @brief Method VisitConditional, addr 0x1530f10, size 0xfc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitConditional(::System::Linq::Expressions::ConditionalExpression* node);

  /// @brief Method .ctor, addr 0x1530d84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
