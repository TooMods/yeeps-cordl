...
public:
  ...
  /// @brief Method .ctor, addr 0x203c400, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddMonthNames, addr 0x203b294, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearTokenHashTable, addr 0x20375b0, size 0x10, virtual false, abstract: false, final false
  inline void ClearTokenHashTable();

  /// @brief Method Clone, addr 0x20373a8, size 0x100, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method CompareStringIgnoreCaseOptimized, addr 0x203c43c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTokenHashTable, addr 0x2039dcc, size 0x8f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAbbreviatedDayName, addr 0x2038490, size 0x100, virtual false, abstract: false, final false
  inline ::StringW GetAbbreviatedDayName(::System::DayOfWeek dayofweek);

  /// @brief Method GetAbbreviatedEraName, addr 0x2037744, size 0xec, virtual false, abstract: false, final false
  inline ::StringW GetAbbreviatedEraName(int32_t era);

  /// @brief Method GetAbbreviatedMonthName, addr 0x2038dbc, size 0x104, virtual false, abstract: false, final false
  inline ::StringW GetAbbreviatedMonthName(int32_t month);

  /// @brief Method GetAllDateTimePatterns, addr 0x20386fc, size 0x37c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetAllDateTimePatterns(char16_t format);

  /// @brief Method GetCombinedPatterns, addr 0x2038590, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDayName, addr 0x2038cbc, size 0x100, virtual false, abstract: false, final false
  inline ::StringW GetDayName(::System::DayOfWeek dayofweek);

  /// @brief Method GetEraName, addr 0x2037614, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW GetEraName(int32_t era);

  /// @brief Method GetFormat, addr 0x2037310, size 0x98, virtual true, abstract: false, final true
  inline ::System::Object* GetFormat(::System::Type* formatType);

  /// @brief Method GetInstance, addr 0x2037150, size 0x1c0, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* GetInstance(::System::IFormatProvider* provider);

  /// @brief Method GetJapaneseCalendarDTFI, addr 0x2039aa4, size 0x194, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* GetJapaneseCalendarDTFI();

  /// @brief Method GetMergedPatterns, addr 0x2038fc4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMonthName, addr 0x2038ec0, size 0x104, virtual false, abstract: false, final false
  inline ::StringW GetMonthName(int32_t month);

  /// @brief Method GetTaiwanCalendarDTFI, addr 0x2039c38, size 0x194, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* GetTaiwanCalendarDTFI();

  /// @brief Method InitializeFormatFlags, addr 0x20396b4, size 0x13c, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatFlags InitializeFormatFlags();

  /// @brief Method InitializeOverridableProperties, addr 0x2036b68, size 0x11c, virtual false, abstract: false, final false
  inline void InitializeOverridableProperties(::System::Globalization::CultureData* cultureData, int32_t calendarId);

  /// @brief Method InsertAtCurrentHashNode, addr 0x203c240, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertHash, addr 0x203a6bc, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAllowedJapaneseTokenFollowedByNonSpaceLetter, addr 0x203bb6c, size 0x108, virtual false, abstract: false, final false
  inline bool IsAllowedJapaneseTokenFollowedByNonSpaceLetter(::StringW tokenString, char16_t nextCh);

  /// @brief Method IsHebrewChar, addr 0x203bb58, size 0x14, virtual false, abstract: false, final false
  static inline bool IsHebrewChar(char16_t ch);

  /// @brief Method IsJapaneseCalendar, addr 0x203b67c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateSpecialTokenHashTable, addr 0x203a9b8, size 0x8dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadOnly, addr 0x20391a8, size 0x104, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* ReadOnly(::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method Tokenize, addr 0x203bc74, size 0x5cc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseHebrewNumber, addr 0x203b7b8, size 0x134, virtual false, abstract: false, final false
  static inline bool TryParseHebrewNumber(ByRef<::System::__DTString> str, ByRef<bool> badFormat, ByRef<int32_t> number);

  /// @brief Method ValidateStyles, addr 0x20395dc, size 0xd8, virtual false, abstract: false, final false
  static inline void ValidateStyles(::System::Globalization::DateTimeStyles style, ::StringW parameterName);

  /// @brief Method YearMonthAdjustment, addr 0x2039970, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20369c8, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2036c84, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AMDesignator, addr 0x20374a8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_AMDesignator();

  /// @brief Method get_AbbreviatedDayNames, addr 0x2037fc4, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedDayNames();

  /// @brief Method get_AbbreviatedEnglishEraNames, addr 0x2037830, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedEnglishEraNames();

  /// @brief Method get_AbbreviatedEraNames, addr 0x20376f0, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedEraNames();

  /// @brief Method get_AbbreviatedMonthNames, addr 0x20380cc, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedMonthNames();

  /// @brief Method get_AllLongDatePatterns, addr 0x2038aec, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllLongDatePatterns();

  /// @brief Method get_AllLongTimePatterns, addr 0x2038bd4, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllLongTimePatterns();

  /// @brief Method get_AllShortDatePatterns, addr 0x2038a78, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllShortDatePatterns();

  /// @brief Method get_AllShortTimePatterns, addr 0x2038b60, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllShortTimePatterns();

  /// @brief Method get_AllYearMonthPatterns, addr 0x2038c48, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllYearMonthPatterns();

  /// @brief Method get_Calendar, addr 0x20374d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::Calendar* get_Calendar();

  /// @brief Method get_CompareInfo, addr 0x2039558, size 0x84, virtual false, abstract: false, final false
  inline ::System::Globalization::CompareInfo* get_CompareInfo();

  /// @brief Method get_Culture, addr 0x2036798, size 0x84, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Culture();

  /// @brief Method get_CultureName, addr 0x203676c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_CurrentInfo, addr 0x2037044, size 0x10c, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* get_CurrentInfo();

  /// @brief Method get_DateSeparator, addr 0x2037884, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DateSeparator();

  /// @brief Method get_DateTimeOffsetPattern, addr 0x2037d2c, size 0x19c, virtual false, abstract: false, final false
  inline ::StringW get_DateTimeOffsetPattern();

  /// @brief Method get_DayNames, addr 0x2038048, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_DayNames();

  /// @brief Method get_EraNames, addr 0x20375c0, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_EraNames();

  /// @brief Method get_FormatFlags, addr 0x20381fc, size 0x18, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatFlags get_FormatFlags();

  /// @brief Method get_FullDateTimePattern, addr 0x20378d8, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_FullDateTimePattern();

  /// @brief Method get_FullTimeSpanNegativePattern, addr 0x20394f0, size 0x68, virtual false, abstract: false, final false
  inline ::StringW get_FullTimeSpanNegativePattern();

  /// @brief Method get_FullTimeSpanPositivePattern, addr 0x203941c, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW get_FullTimeSpanPositivePattern();

  /// @brief Method get_GeneralLongTimePattern, addr 0x2037cb8, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_GeneralLongTimePattern();

  /// @brief Method get_GeneralShortTimePattern, addr 0x2037c44, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_GeneralShortTimePattern();

  /// @brief Method get_HasForceTwoDigitYears, addr 0x2039914, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasForceTwoDigitYears();

  /// @brief Method get_HasSpacesInDayNames, addr 0x2038214, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasSpacesInDayNames();

  /// @brief Method get_HasSpacesInMonthNames, addr 0x20381d4, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasSpacesInMonthNames();

  /// @brief Method get_HasYearMonthAdjustment, addr 0x2039948, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasYearMonthAdjustment();

  /// @brief Method get_InvariantInfo, addr 0x2036f74, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* get_InvariantInfo();

  /// @brief Method get_IsReadOnly, addr 0x20374dc, size 0xa4, virtual false, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LanguageName, addr 0x203681c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_LanguageName();

  /// @brief Method get_LongDatePattern, addr 0x203794c, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_LongDatePattern();

  /// @brief Method get_LongTimePattern, addr 0x2037988, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_LongTimePattern();

  /// @brief Method get_MonthDayPattern, addr 0x2037a48, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_MonthDayPattern();

  /// @brief Method get_MonthGenitiveNames, addr 0x203939c, size 0x80, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_MonthGenitiveNames();

  /// @brief Method get_MonthNames, addr 0x2038150, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_MonthNames();

  /// @brief Method get_OptionalCalendars, addr 0x2037580, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Globalization::CalendarId, ::Array<::System::Globalization::CalendarId>*> get_OptionalCalendars();

  /// @brief Method get_PMDesignator, addr 0x2037a9c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_PMDesignator();

  /// @brief Method get_RFC1123Pattern, addr 0x2037ac8, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_RFC1123Pattern();

  /// @brief Method get_ShortDatePattern, addr 0x2037b08, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_ShortDatePattern();

  /// @brief Method get_ShortTimePattern, addr 0x2037b98, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_ShortTimePattern();

  /// @brief Method get_SortableDateTimePattern, addr 0x2037c04, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_SortableDateTimePattern();

  /// @brief Method get_TimeSeparator, addr 0x2037ec8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_TimeSeparator();

  /// @brief Method get_UnclonedLongDatePatterns, addr 0x20379c4, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedLongDatePatterns();

  /// @brief Method get_UnclonedLongTimePatterns, addr 0x2037a18, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedLongTimePatterns();

  /// @brief Method get_UnclonedShortDatePatterns, addr 0x2037b44, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedShortDatePatterns();

  /// @brief Method get_UnclonedShortTimePatterns, addr 0x2037bd4, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedShortTimePatterns();

  /// @brief Method get_UnclonedYearMonthPatterns, addr 0x2037f70, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedYearMonthPatterns();

  /// @brief Method get_UniversalSortableDateTimePattern, addr 0x2037ef4, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_UniversalSortableDateTimePattern();

  /// @brief Method get_YearMonthPattern, addr 0x2037f34, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method internalGetAbbreviatedDayOfWeekNames, addr 0x2036848, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedDayOfWeekNames();

  /// @brief Method internalGetAbbreviatedDayOfWeekNamesCore, addr 0x203685c, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedDayOfWeekNamesCore();

  /// @brief Method internalGetAbbreviatedMonthNames, addr 0x2036908, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedMonthNames();

  /// @brief Method internalGetAbbreviatedMonthNamesCore, addr 0x203691c, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedMonthNamesCore();

  /// @brief Method internalGetDayOfWeekNames, addr 0x20368a8, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetDayOfWeekNames();

  /// @brief Method internalGetDayOfWeekNamesCore, addr 0x20368bc, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetDayOfWeekNamesCore();

  /// @brief Method internalGetGenitiveMonthNames, addr 0x20383a8, size 0x94, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetGenitiveMonthNames(bool abbreviated);

  /// @brief Method internalGetLeapYearMonthNames, addr 0x203843c, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetLeapYearMonthNames();

  /// @brief Method internalGetMonthName, addr 0x203823c, size 0x16c, virtual false, abstract: false, final false
  inline ::StringW internalGetMonthName(int32_t month, ::System::Globalization::MonthNameStyles style, bool abbreviated);

  /// @brief Method internalGetMonthNames, addr 0x2036968, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetMonthNames();

  /// @brief Method internalGetMonthNamesCore, addr 0x203697c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Calendar, addr 0x2036cc8, size 0x2ac, virtual false, abstract: false, final false
