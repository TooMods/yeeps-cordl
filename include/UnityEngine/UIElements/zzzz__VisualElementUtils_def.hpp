...
public:
  ...
  /// @brief Method GetFoldoutDepth, addr 0x27d2290, size 0xe4, virtual false, abstract: false, final false
  static inline int32_t GetFoldoutDepth(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method GetListAndFoldoutDepth, addr 0x27d3c90, size 0x114, virtual false, abstract: false, final false
  static inline int32_t GetListAndFoldoutDepth(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method GetUniqueName, addr 0x27d3b7c, size 0x114, virtual false, abstract: false, final false
