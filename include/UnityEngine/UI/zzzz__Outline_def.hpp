...
public:
  // Declarations
  /// @brief Method ModifyMesh, addr 0x2917ea8, size 0x80914, virtual true, abstract: false, final false
  inline void ModifyMesh(::UnityEngine::UI::VertexHelper* vh);

  static inline ::UnityEngine::UI::Outline* New_ctor();

  /// @brief Method .ctor, addr 0x2917ea0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
