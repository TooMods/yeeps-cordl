...
public:
  ...
  __declspec(property(put = set_motionVectors)) bool motionVectors;
  ...
  /// @brief Method FallbackLightmapperByRef, addr 0x2a99058, size 0x1c, virtual false, abstract: false, final false
  static inline void FallbackLightmapperByRef(void* lightmapperPtr);

  /// @brief Method FallbackMixedLightingModeByRef, addr 0x2a989dc, size 0x134, virtual false, abstract: false, final false
  static inline void FallbackMixedLightingModeByRef(void* fallbackModePtr);

  /// @brief Method IsAutoAmbientProbeBakingSupported, addr 0x2a98f68, size 0x78, virtual false, abstract: false, final false
  static inline void IsAutoAmbientProbeBakingSupported(void* isSupportedPtr);

  /// @brief Method IsAutoDefaultReflectionProbeBakingSupported, addr 0x2a98fe0, size 0x78, virtual false, abstract: false, final false
  static inline void IsAutoDefaultReflectionProbeBakingSupported(void* isSupportedPtr);

  /// @brief Method IsLightmapBakeTypeSupported, addr 0x2a98c84, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsLightmapBakeTypeSupported(::UnityEngine::LightmapBakeType bakeType);

  /// @brief Method IsLightmapBakeTypeSupportedByRef, addr 0x2a98cf0, size 0xf0, virtual false, abstract: false, final false
  static inline void IsLightmapBakeTypeSupportedByRef(::UnityEngine::LightmapBakeType bakeType, void* isSupportedPtr);

  /// @brief Method IsLightmapperSupportedByRef, addr 0x2a98e6c, size 0x84, virtual false, abstract: false, final false
  static inline void IsLightmapperSupportedByRef(int32_t lightmapper, void* isSupportedPtr);

  /// @brief Method IsLightmapsModeSupportedByRef, addr 0x2a98de0, size 0x8c, virtual false, abstract: false, final false
  static inline void IsLightmapsModeSupportedByRef(::UnityEngine::LightmapsMode mode, void* isSupportedPtr);

  /// @brief Method IsMixedLightingModeSupported, addr 0x2a98b10, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsMixedLightingModeSupported(::UnityEngine::MixedLightingMode mixedMode);

  /// @brief Method IsMixedLightingModeSupportedByRef, addr 0x2a98b7c, size 0x108, virtual false, abstract: false, final false
  static inline void IsMixedLightingModeSupportedByRef(::UnityEngine::MixedLightingMode mixedMode, void* isSupportedPtr);

  /// @brief Method IsUIOverlayRenderedBySRP, addr 0x2a98ef0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a9170c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Rendering::SupportedRenderingFeatures* getStaticF_s_Active();

  /// @brief Method get_active, addr 0x2a988e0, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::SupportedRenderingFeatures* get_active();

  /// @brief Method get_autoAmbientProbeBaking, addr 0x2a989cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_autoAmbientProbeBaking();

  /// @brief Method get_autoDefaultReflectionProbeBaking, addr 0x2a989d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_autoDefaultReflectionProbeBaking();

  /// @brief Method get_defaultMixedLightingModes, addr 0x2a98988, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::__SupportedRenderingFeatures__LightmapMixedBakeModes get_defaultMixedLightingModes();

  /// @brief Method get_enlighten, addr 0x2a989b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_enlighten();

  /// @brief Method get_enlightenLightmapper, addr 0x2a989a8, size 0x8, virtual false, abstract: false, final false
  inline bool get_enlightenLightmapper();

  /// @brief Method get_lightmapBakeTypes, addr 0x2a98998, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LightmapBakeType get_lightmapBakeTypes();

  /// @brief Method get_lightmapsModes, addr 0x2a989a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LightmapsMode get_lightmapsModes();

  /// @brief Method get_mixedLightingModes, addr 0x2a98990, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::__SupportedRenderingFeatures__LightmapMixedBakeModes get_mixedLightingModes();

  /// @brief Method get_rendersUIOverlay, addr 0x2a989c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_active, addr 0x2a9179c, size 0x5c, virtual false, abstract: false, final false
  static inline void set_active(::UnityEngine::Rendering::SupportedRenderingFeatures* value);

  /// @brief Method set_motionVectors, addr 0x2a989b8, size 0xc, virtual false, abstract: false, final false
  inline void set_motionVectors(bool value);
