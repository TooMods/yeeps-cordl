...
public:
  ...
  /// @brief Method Process, addr 0x21dbe08, size 0xb4, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x21dbebc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x21dbefc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
