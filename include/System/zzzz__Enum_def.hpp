...
public:
  // Declarations
  /// @brief Method GetEnumParseException, addr 0x2c0076c, size 0x17c, virtual false, abstract: false, final false
  inline ::System::Exception* GetEnumParseException();

  /// @brief Method Init, addr 0x2c00090, size 0x64, virtual false, abstract: false, final false
  inline void Init(bool canMethodThrow);

  /// @brief Method SetFailure, addr 0x2c00924, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x2c008e8, size 0x3c, virtual false, abstract: false, final false
  inline void SetFailure(::System::__Enum__ParseFailureKind failure, ::StringW failureParameter);

  /// @brief Method SetFailure, addr 0x2c00ee8, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2bff52c, size 0x2c, virtual false, abstract: false, final false
