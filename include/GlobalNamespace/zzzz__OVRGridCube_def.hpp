...
public:
  ...
  /// @brief Method CreateCubeGrid, addr 0x16ef400, size 0x3a8, virtual false, abstract: false, final false
  inline void CreateCubeGrid();

  /// @brief Method CubeGridSwitchColor, addr 0x16ef7a8, size 0x188, virtual false, abstract: false, final false
  inline void CubeGridSwitchColor(bool CubeSwitchColor);

  static inline ::GlobalNamespace::OVRGridCube* New_ctor();

  /// @brief Method SetOVRCameraController, addr 0x16ef3f4, size 0xc, virtual false, abstract: false, final false
  inline void SetOVRCameraController(ByRef<::GlobalNamespace::OVRCameraRig*> cameraController);

  /// @brief Method Update, addr 0x16ef1d8, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCubeGrid, addr 0x16ef1dc, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16ef930, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
