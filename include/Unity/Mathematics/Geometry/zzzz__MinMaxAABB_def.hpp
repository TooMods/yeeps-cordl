...
public:
  ...
  /// @brief Method Contains, addr 0x2434c94, size 0x70, virtual false, abstract: false, final false
  inline bool Contains(::Unity::Mathematics::Geometry::MinMaxAABB aabb);

  /// @brief Method Contains, addr 0x2434c30, size 0x64, virtual false, abstract: false, final false
  inline bool Contains(::Unity::Mathematics::float3 point);

  /// @brief Method CreateFromCenterAndExtents, addr 0x2434ad8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFromCenterAndHalfExtents, addr 0x2434b10, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method Encapsulate, addr 0x2434da4, size 0x270, virtual false, abstract: false, final false
  inline void Encapsulate(::Unity::Mathematics::Geometry::MinMaxAABB aabb);

  /// @brief Method Encapsulate, addr 0x2435014, size 0x2a8, virtual false, abstract: false, final false
  inline void Encapsulate(::Unity::Mathematics::float3 point);

  /// @brief Method Equals, addr 0x24352bc, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Mathematics::Geometry::MinMaxAABB other);

  /// @brief Method Expand, addr 0x2434d78, size 0x2c, virtual false, abstract: false, final false
  inline void Expand(float_t signedDistance);

  /// @brief Method Overlaps, addr 0x2434d04, size 0x74, virtual false, abstract: false, final false
  inline bool Overlaps(::Unity::Mathematics::Geometry::MinMaxAABB aabb);

  /// @brief Method ToString, addr 0x2435328, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2434ac8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Mathematics::float3 min, ::Unity::Mathematics::float3 max);

  /// @brief Method get_Center, addr 0x2434b88, size 0x30, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::float3 get_Center();

  /// @brief Method get_Extents, addr 0x2434b38, size 0x20, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::float3 get_Extents();

  /// @brief Method get_HalfExtents, addr 0x2434b58, size 0x30, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::float3 get_HalfExtents();

  /// @brief Method get_IsValid, addr 0x2434bb8, size 0x44, virtual false, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_SurfaceArea, addr 0x2434bfc, size 0x34, virtual false, abstract: false, final false
