...
public:
  ...
  /// @brief Method Equals, addr 0x19fa7c8, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimatorControllerPlayable other);

  /// @brief Method GetHandle, addr 0x19fa7bc, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetHandle, addr 0x19fa6b4, size 0x108, virtual false, abstract: false, final false
  inline void SetHandle(::UnityEngine::Playables::PlayableHandle handle);

  /// @brief Method .ctor, addr 0x19fa63c, size 0x78, virtual false, abstract: false, final false
