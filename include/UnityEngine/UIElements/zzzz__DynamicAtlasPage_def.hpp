...
public:
  ...
  /// @brief Method Commit, addr 0x12868c8, size 0x40, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method CreateAtlasTexture, addr 0x1286d74, size 0x138, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> CreateAtlasTexture();

  /// @brief Method Dispose, addr 0x1285ffc, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1286068, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x12867cc, size 0xfc, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::UIR::__Allocator2D__Alloc2D alloc);

  /// @brief Method TryAdd, addr 0x12862a8, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x128648c, size 0x19c, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::Texture2D* image, ::UnityEngine::RectInt rect);

  /// @brief Method UpdateAtlasTexture, addr 0x1286908, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1285de0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x1285dc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> get_atlas();

  /// @brief Method get_disposed, addr 0x1285fe8, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_filterMode, addr 0x1285dd8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::FilterMode get_filterMode();

  /// @brief Method get_format, addr 0x1285dd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureFormat get_format();

  /// @brief Method get_textureId, addr 0x1285db0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atlas, addr 0x1285dc8, size 0x8, virtual false, abstract: false, final false
  inline void set_atlas(::UnityEngine::RenderTexture* value);

  /// @brief Method set_disposed, addr 0x1285ff0, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_textureId, addr 0x1285db8, size 0x8, virtual false, abstract: false, final false
