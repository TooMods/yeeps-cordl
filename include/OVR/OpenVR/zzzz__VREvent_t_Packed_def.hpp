...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x2a75994, size 0x20, virtual false, abstract: false, final false
  inline void Unpack(ByRef<::OVR::OpenVR::VREvent_t> unpacked);

  /// @brief Method .ctor, addr 0x2a7b018, size 0x38, virtual false, abstract: false, final false
