...
public:
  ...
  /// @brief Method BindBinaryOperation, addr 0x1b656c0, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method BindConvert, addr 0x1b65188, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindConvert(::System::Dynamic::ConvertBinder* binder);

  /// @brief Method BindCreateInstance, addr 0x1b655d0, size 0x80, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindCreateInstance(::System::Dynamic::CreateInstanceBinder* binder,
                                                                  ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method BindDeleteIndex, addr 0x1b65460, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method BindDeleteMember, addr 0x1b652e8, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindDeleteMember(::System::Dynamic::DeleteMemberBinder* binder);

  /// @brief Method BindGetIndex, addr 0x1b65360, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindGetIndex(::System::Dynamic::GetIndexBinder* binder,
                                                            ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> indexes);

  /// @brief Method BindGetMember, addr 0x1b65200, size 0x70, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindGetMember(::System::Dynamic::GetMemberBinder* binder);

  /// @brief Method BindInvoke, addr 0x1b65558, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindInvoke(::System::Dynamic::InvokeBinder* binder,
                                                          ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method BindInvokeMember, addr 0x1b654e0, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindInvokeMember(::System::Dynamic::InvokeMemberBinder* binder,
                                                                ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method BindSetIndex, addr 0x1b653d8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method BindSetMember, addr 0x1b65270, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method BindUnaryOperation, addr 0x1b65650, size 0x70, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindUnaryOperation(::System::Dynamic::UnaryOperationBinder* binder);

  /// @brief Method Create, addr 0x1b657bc, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Dynamic::DynamicMetaObject* Create(::System::Object* value, ::System::Linq::Expressions::Expression* expression);

  /// @brief Method GetDynamicMemberNames, addr 0x1b65740, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b6500c, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression, ::System::Dynamic::BindingRestrictions* restrictions);

  /// @brief Method .ctor, addr 0x1b650dc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Expression, addr 0x1b65100, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Expression();

  /// @brief Method get_HasValue, addr 0x1b63eec, size 0x68, virtual false, abstract: false, final false
  inline bool get_HasValue();

  /// @brief Method get_LimitType, addr 0x1b63fe8, size 0x34, virtual false, abstract: false, final false
  inline ::System::Type* get_LimitType();

  /// @brief Method get_Restrictions, addr 0x1b65108, size 0x8, virtual false, abstract: false, final false
  inline ::System::Dynamic::BindingRestrictions* get_Restrictions();

  /// @brief Method get_RuntimeType, addr 0x1b65110, size 0x78, virtual false, abstract: false, final false
  inline ::System::Type* get_RuntimeType();

  /// @brief Method get_Value, addr 0x1b63ec8, size 0x24, virtual false, abstract: false, final false
