...
public:
  ...
  /// @brief Method AdjustLineOffset, addr 0x23b8920, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Approximately, addr 0x23b5654, size 0x30, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method ConvertToFloat, addr 0x23b5ef0, size 0x80, virtual false, abstract: false, final false
  static inline float_t ConvertToFloat(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startIndex, int32_t length);

  /// @brief Method ConvertToFloat, addr 0x23b5f70, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method FillCharacterVertexBuffers, addr 0x23b78b0, size 0x880, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSpriteVertexBuffers, addr 0x23b8130, size 0x7f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyle, addr 0x23b770c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTagHashCode, addr 0x23b7678, size 0x94, virtual false, abstract: false, final false
  static inline int32_t GetTagHashCode(ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> text, int32_t index, ByRef<int32_t> closeIndex);

  /// @brief Method GetTagHashCode, addr 0x23b77f8, size 0xb8, virtual false, abstract: false, final false
  static inline int32_t GetTagHashCode(ByRef<::StringW> text, int32_t index, ByRef<int32_t> closeIndex);

  /// @brief Method GetUtf16, addr 0x23b6aa8, size 0xcc, virtual false, abstract: false, final false
  static inline int32_t GetUtf16(::StringW text, int32_t i);

  /// @brief Method GetUtf32, addr 0x23b697c, size 0x12c, virtual false, abstract: false, final false
  static inline int32_t GetUtf32(::StringW text, int32_t i);

  /// @brief Method HexCharsToColor, addr 0x23b5c6c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method HexCharsToColor, addr 0x23b5684, size 0x5bc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 HexCharsToColor(::ArrayW<char16_t, ::Array<char16_t>*> hexChars, int32_t tagCount);

  /// @brief Method HexToInt, addr 0x23b5c40, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t hex);

  /// @brief Method IsTagName, addr 0x23b7278, size 0xcc, virtual false, abstract: false, final false
  static inline bool IsTagName(ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> text, ::StringW tag, int32_t index);

  /// @brief Method IsTagName, addr 0x23b6b74, size 0xa8, virtual false, abstract: false, final false
  static inline bool IsTagName(ByRef<::StringW> text, ::StringW tag, int32_t index);

  /// @brief Method LegacyAlignmentToNewAlignment, addr 0x23b8c5c, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextAlignment LegacyAlignmentToNewAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method LegacyStyleToNewStyle, addr 0x23b8c4c, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::FontStyles LegacyStyleToNewStyle(::UnityEngine::FontStyle fontStyle);

  /// @brief Method PackUV, addr 0x23b60d4, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 PackUV(float_t x, float_t y, float_t scale);

  /// @brief Method ReplaceClosingStyleTag, addr 0x23b6f50, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x23b7344, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x23b6c1c, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizeLineExtents, addr 0x23b8aa0, size 0x1ac, virtual false, abstract: false, final false
  static inline void ResizeLineExtents(int32_t size, ::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method StringToCharArray, addr 0x23b6134, size 0x848, virtual false, abstract: false, final false
