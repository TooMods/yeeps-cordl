...
public:
  ...
  /// @brief Method GetProxyType, addr 0x184b61c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::RuntimeType* GetProxyType();

  /// @brief Method InCurrentContext, addr 0x184b724, size 0x40, virtual false, abstract: false, final false
  inline bool InCurrentContext();

  /// @brief Method LoadRemoteFieldNew, addr 0x184b764, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreRemoteField, addr 0x184c448, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x184c720, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsContextBoundObject, addr 0x184b6ec, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsContextBoundObject();

  /// @brief Method get_TargetContext, addr 0x184b708, size 0x1c, virtual false, abstract: false, final false
