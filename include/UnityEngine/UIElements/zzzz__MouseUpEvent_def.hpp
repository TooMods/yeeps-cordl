...
public:
  // Declarations
  /// @brief Method GetPooled, addr 0x2ccfdf8, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerCancelEvent* pointerEvent);

  /// @brief Method GetPooled, addr 0x2ccf260, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerMoveEvent* pointerEvent);

  /// @brief Method GetPooled, addr 0x2ccf920, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerUpEvent* pointerEvent);

  /// @brief Method Init, addr 0x2cd0894, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd08e8, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  /// @brief Method MakeFromPointerEvent, addr 0x2cd0948, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd08f4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
