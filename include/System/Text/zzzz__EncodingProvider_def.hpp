...
public:
  ...
  /// @brief Method GetEncoding, addr 0x1e127a0, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetEncodingFromProvider, addr 0x1e1289c, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* GetEncodingFromProvider(int32_t codepage);

  /// @brief Method GetEncodingFromProvider, addr 0x1e12a54, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncodingFromProvider, addr 0x1e12978, size 0xdc, virtual false, abstract: false, final false
