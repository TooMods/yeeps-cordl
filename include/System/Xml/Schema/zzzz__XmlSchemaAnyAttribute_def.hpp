...
public:
  ...
  /// @brief Method Allows, addr 0x1ce2298, size 0x28, virtual false, abstract: false, final false
  inline bool Allows(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method BuildNamespaceList, addr 0x1ce2158, size 0x94, virtual false, abstract: false, final false
  inline void BuildNamespaceList(::StringW targetNamespace);

  /// @brief Method BuildNamespaceListV1Compat, addr 0x1ce21ec, size 0xac, virtual false, abstract: false, final false
  inline void BuildNamespaceListV1Compat(::StringW targetNamespace);

  /// @brief Method Intersection, addr 0x1ce22e4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSubset, addr 0x1ce22c0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Union, addr 0x1ce239c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce2394, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NamespaceList, addr 0x1ce213c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* get_NamespaceList();

  /// @brief Method get_ProcessContents, addr 0x1ce212c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContents();

  /// @brief Method get_ProcessContentsCorrect, addr 0x1ce2144, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect();

  /// @brief Method set_Namespace, addr 0x1ce2124, size 0x8, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_ProcessContents, addr 0x1ce2134, size 0x8, virtual false, abstract: false, final false
