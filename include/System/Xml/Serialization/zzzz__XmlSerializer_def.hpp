...
public:
  ...
  /// @brief Method CreateWriter, addr 0x3043d88, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateReader, addr 0x3043110, size 0x40, virtual true, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationReader* CreateReader();

  /// @brief Method CreateReader, addr 0x3043294, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationReader* CreateReader(::System::Xml::Serialization::XmlMapping* typeMapping);

  /// @brief Method CreateWriter, addr 0x3043150, size 0x40, virtual true, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationWriter* CreateWriter();

  /// @brief Method CreateWriter, addr 0x3043b7c, size 0x20c, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationWriter* CreateWriter(::System::Xml::Serialization::XmlMapping* typeMapping);

  /// @brief Method Deserialize, addr 0x30432f8, size 0x2e4, virtual true, abstract: false, final false
  inline ::System::Object* Deserialize(::System::Xml::Serialization::XmlSerializationReader* reader);

  /// @brief Method Deserialize, addr 0x3043190, size 0x94, virtual false, abstract: false, final false
  inline ::System::Object* Deserialize(::System::IO::TextReader* textReader);

  /// @brief Method Deserialize, addr 0x3043224, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method OnUnknownAttribute, addr 0x3043070, size 0x28, virtual true, abstract: false, final false
  inline void OnUnknownAttribute(::System::Xml::Serialization::XmlAttributeEventArgs* e);

  /// @brief Method OnUnknownElement, addr 0x3043098, size 0x28, virtual true, abstract: false, final false
  inline void OnUnknownElement(::System::Xml::Serialization::XmlElementEventArgs* e);

  /// @brief Method OnUnknownNode, addr 0x30430c0, size 0x28, virtual true, abstract: false, final false
  inline void OnUnknownNode(::System::Xml::Serialization::XmlNodeEventArgs* e);

  /// @brief Method OnUnreferencedObject, addr 0x30430e8, size 0x28, virtual true, abstract: false, final false
  inline void OnUnreferencedObject(::System::Xml::Serialization::UnreferencedObjectEventArgs* e);

  /// @brief Method Serialize, addr 0x30435dc, size 0x1f4, virtual true, abstract: false, final false
  inline void Serialize(::System::Object* o, ::System::Xml::Serialization::XmlSerializationWriter* writer);

  /// @brief Method Serialize, addr 0x30437d0, size 0x90, virtual false, abstract: false, final false
  inline void Serialize(::System::IO::TextWriter* textWriter, ::System::Object* o);

  /// @brief Method Serialize, addr 0x3043b74, size 0x8, virtual false, abstract: false, final false
  inline void Serialize(::System::Xml::XmlWriter* xmlWriter, ::System::Object* o);

  /// @brief Method Serialize, addr 0x3043860, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3042ee4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mapping, addr 0x3043068, size 0x8, virtual false, abstract: false, final false
