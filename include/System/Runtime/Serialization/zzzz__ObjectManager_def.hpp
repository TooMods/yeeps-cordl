...
public:
  ...
  /// @brief Method AddObjectHolder, addr 0x1aa93f0, size 0x12c, virtual false, abstract: false, final false
  inline void AddObjectHolder(::System::Runtime::Serialization::ObjectHolder* holder);

  /// @brief Method AddOnDeserialization, addr 0x1aaca6c, size 0x80, virtual true, abstract: false, final false
  inline void AddOnDeserialization(::System::Runtime::Serialization::DeserializationEventHandler* handler);

  /// @brief Method AddOnDeserialized, addr 0x1aacaec, size 0x94, virtual true, abstract: false, final false
  inline void AddOnDeserialized(::System::Object* obj);

  /// @brief Method CanCallGetType, addr 0x1aa9234, size 0x8, virtual false, abstract: false, final false
  inline bool CanCallGetType(::System::Object* obj);

  /// @brief Method CompleteISerializableObject, addr 0x1aa9cc8, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method CompleteObject, addr 0x1aaa88c, size 0x624, virtual false, abstract: false, final false
  inline void CompleteObject(::System::Runtime::Serialization::ObjectHolder* holder, bool bObjectFullyComplete);

  /// @brief Method DoFixups, addr 0x1aabddc, size 0x308, virtual true, abstract: false, final false
  inline void DoFixups();

  /// @brief Method DoNewlyRegisteredObjectFixups, addr 0x1aaa51c, size 0xd8, virtual false, abstract: false, final false
  inline void DoNewlyRegisteredObjectFixups(::System::Runtime::Serialization::ObjectHolder* holder);

  /// @brief Method DoValueTypeFixup, addr 0x1aa9fbc, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method FindObjectHolder, addr 0x1aa92c0, size 0x58, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ObjectHolder* FindObjectHolder(int64_t objectID);

  /// @brief Method FindOrCreateObjectHolder, addr 0x1aa9318, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ObjectHolder* FindOrCreateObjectHolder(int64_t objectID);

  /// @brief Method FixupSpecialObject, addr 0x1aa9828, size 0x23c, virtual false, abstract: false, final false
  inline void FixupSpecialObject(::System::Runtime::Serialization::ObjectHolder* holder);

  /// @brief Method GetCompletionInfo, addr 0x1aa951c, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructor, addr 0x1aabca0, size 0x13c, virtual false, abstract: false, final false
  static inline ::System::Reflection::RuntimeConstructorInfo* GetConstructor(::System::RuntimeType* t);

  /// @brief Method GetObject, addr 0x1aab0b4, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method RaiseDeserializationEvent, addr 0x1aaca20, size 0x4c, virtual true, abstract: false, final false
  inline void RaiseDeserializationEvent();

  /// @brief Method RaiseOnDeserializedEvent, addr 0x1aacb80, size 0x8c, virtual true, abstract: false, final false
  inline void RaiseOnDeserializedEvent(::System::Object* obj);

  /// @brief Method RaiseOnDeserializingEvent, addr 0x1aacc0c, size 0x8c, virtual false, abstract: false, final false
  inline void RaiseOnDeserializingEvent(::System::Object* obj);

  /// @brief Method RecordArrayElementFixup, addr 0x1aac8b8, size 0x168, virtual true, abstract: false, final false
  inline void RecordArrayElementFixup(int64_t arrayToBeFixed, ::ArrayW<int32_t, ::Array<int32_t>*> indices, int64_t objectRequired);

  /// @brief Method RecordDelayedFixup, addr 0x1aac750, size 0x168, virtual true, abstract: false, final false
  inline void RecordDelayedFixup(int64_t objectToBeFixed, ::StringW memberName, int64_t objectRequired);

  /// @brief Method RecordFixup, addr 0x1aac470, size 0x2a4, virtual true, abstract: false, final false
  inline void RecordFixup(int64_t objectToBeFixed, ::System::Reflection::MemberInfo* member, int64_t objectRequired);

  /// @brief Method RegisterFixup, addr 0x1aac25c, size 0xe4, virtual false, abstract: false, final false
  inline void RegisterFixup(::System::Runtime::Serialization::FixupHolder* fixup, int64_t objectToBeFixed, int64_t objectRequired);

  /// @brief Method RegisterObject, addr 0x1aab34c, size 0x5c4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterString, addr 0x1aab168, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveObjectReference, addr 0x1aaa5f4, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1aa91b4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SpecialFixupObjects, addr 0x1aa924c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ObjectHolderList* get_SpecialFixupObjects();

  /// @brief Method get_TopObject, addr 0x1aa9244, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_TopObject();

  /// @brief Method set_TopObject, addr 0x1aa923c, size 0x8, virtual false, abstract: false, final false
