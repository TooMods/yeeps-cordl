...
public:
  ...
  /// @brief Method HandleSelfFittingAlongAxis, addr 0x26ed828, size 0xe4, virtual false, abstract: false, final false
  inline void HandleSelfFittingAlongAxis(int32_t axis);

  static inline ::UnityEngine::UI::ContentSizeFitter* New_ctor();

  /// @brief Method OnDisable, addr 0x26ed7a8, size 0x7c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26ed78c, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnRectTransformDimensionsChange, addr 0x26ed824, size 0x4, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method SetDirty, addr 0x26ed5f0, size 0x84, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method SetLayoutHorizontal, addr 0x26ed924, size 0x24, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x26ed948, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ed784, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_horizontalFit, addr 0x26ed574, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__ContentSizeFitter__FitMode get_horizontalFit();

  /// @brief Method get_rectTransform, addr 0x26ed6f0, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_verticalFit, addr 0x26ed674, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_horizontalFit, addr 0x26ed57c, size 0x74, virtual false, abstract: false, final false
  inline void set_horizontalFit(::UnityEngine::UI::__ContentSizeFitter__FitMode value);

  /// @brief Method set_verticalFit, addr 0x26ed67c, size 0x74, virtual false, abstract: false, final false
