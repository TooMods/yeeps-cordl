...
public:
  ...
  /// @brief Method GetPooled, addr 0x2cd25d4, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::InputEvent* GetPooled(::StringW previousData, ::StringW newData);

  /// @brief Method Init, addr 0x2cd256c, size 0x58, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd25c4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd2658, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_newData, addr 0x2cd2564, size 0x8, virtual false, abstract: false, final false
  inline void set_newData(::StringW value);

  /// @brief Method set_previousData, addr 0x2cd255c, size 0x8, virtual false, abstract: false, final false
