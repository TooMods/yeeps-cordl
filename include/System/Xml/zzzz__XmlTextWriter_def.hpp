...
public:
  // Declarations
  /// @brief Method Init, addr 0x14b9688, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Set, addr 0x14bdd78, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNamespace, addr 0x14bdbd8, size 0x1a0, virtual false, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW ns, bool declared);

  /// @brief Method AddToNamespaceHashtable, addr 0x14bdd90, size 0xe8, virtual false, abstract: false, final false
  inline void AddToNamespaceHashtable(int32_t namespaceIndex);

  /// @brief Method AutoComplete, addr 0x14ba60c, size 0x504, virtual false, abstract: false, final false
  inline void AutoComplete(::System::Xml::__XmlTextWriter__Token token);

  /// @brief Method AutoCompleteAll, addr 0x14ba004, size 0x54, virtual false, abstract: false, final false
  inline void AutoCompleteAll();

  /// @brief Method Close, addr 0x14bd208, size 0x128, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method FindPrefix, addr 0x14bb0a0, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW FindPrefix(::StringW ns);

  /// @brief Method Flush, addr 0x14bd330, size 0x20, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushEncoders, addr 0x14bd8c8, size 0x24, virtual false, abstract: false, final false
  inline void FlushEncoders();

  /// @brief Method GeneratePrefix, addr 0x14bbfec, size 0x114, virtual false, abstract: false, final false
  inline ::StringW GeneratePrefix();

  /// @brief Method HandleSpecialAttribute, addr 0x14bd9c0, size 0x218, virtual false, abstract: false, final false
  inline void HandleSpecialAttribute();

  /// @brief Method Indent, addr 0x14bd458, size 0xd0, virtual false, abstract: false, final false
  inline void Indent(bool beforeEndElement);

  /// @brief Method InternalWriteEndElement, addr 0x14bb50c, size 0x2e8, virtual false, abstract: false, final false
  inline void InternalWriteEndElement(bool longFormat);

  /// @brief Method InternalWriteProcessingInstruction, addr 0x14bc7c4, size 0xfc, virtual false, abstract: false, final false
  inline void InternalWriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method LookupNamespace, addr 0x14bafc4, size 0xdc, virtual false, abstract: false, final false
  inline int32_t LookupNamespace(::StringW prefix);

  /// @brief Method LookupNamespaceInCurrentScope, addr 0x14bbec0, size 0x12c, virtual false, abstract: false, final false
  inline int32_t LookupNamespaceInCurrentScope(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x14bd350, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method PopNamespaces, addr 0x14bd8ec, size 0xd4, virtual false, abstract: false, final false
  inline void PopNamespaces(int32_t indexFrom, int32_t indexTo);

  /// @brief Method PushNamespace, addr 0x14bb168, size 0x234, virtual false, abstract: false, final false
  inline void PushNamespace(::StringW prefix, ::StringW ns, bool declared);

  /// @brief Method PushStack, addr 0x14baef8, size 0xcc, virtual false, abstract: false, final false
  inline void PushStack();

  /// @brief Method StartDocument, addr 0x14b9aa8, size 0x378, virtual false, abstract: false, final false
  inline void StartDocument(int32_t standalone);

  /// @brief Method ValidateName, addr 0x14ba44c, size 0x1c0, virtual false, abstract: false, final false
  inline void ValidateName(::StringW name, bool isNCName);

  /// @brief Method VerifyPrefixXml, addr 0x14bb39c, size 0x168, virtual false, abstract: false, final false
  inline void VerifyPrefixXml(::StringW prefix, ::StringW ns);

  /// @brief Method WriteBase64, addr 0x14bcfc8, size 0x14c, virtual true, abstract: false, final false
  inline void WriteBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBinHex, addr 0x14bd114, size 0xd0, virtual true, abstract: false, final false
  inline void WriteBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteCData, addr 0x14bc1a0, size 0x1d0, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x14bc98c, size 0xc0, virtual true, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteChars, addr 0x14bcd58, size 0xd8, virtual true, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteComment, addr 0x14bc370, size 0x20c, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteDocType, addr 0x14ba058, size 0x3f4, virtual true, abstract: false, final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteEndAttribute, addr 0x14bc100, size 0xa0, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndAttributeQuote, addr 0x14bd528, size 0x4c, virtual false, abstract: false, final false
  inline void WriteEndAttributeQuote();

  /// @brief Method WriteEndDocument, addr 0x14b9e34, size 0x1d0, virtual true, abstract: false, final false
  inline void WriteEndDocument();

  /// @brief Method WriteEndElement, addr 0x14bb504, size 0x8, virtual true, abstract: false, final false
  inline void WriteEndElement();

  /// @brief Method WriteEndStartTag, addr 0x14bd574, size 0x354, virtual false, abstract: false, final false
  inline void WriteEndStartTag(bool empty);

  /// @brief Method WriteEntityRef, addr 0x14bc8c0, size 0xcc, virtual true, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteFullEndElement, addr 0x14bb7f4, size 0x8, virtual true, abstract: false, final false
  inline void WriteFullEndElement();

  /// @brief Method WriteProcessingInstruction, addr 0x14bc57c, size 0x248, virtual true, abstract: false, final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteRaw, addr 0x14bce30, size 0xd8, virtual true, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw, addr 0x14bcf08, size 0xc0, virtual true, abstract: false, final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteStartAttribute, addr 0x14bb7fc, size 0x6c4, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartDocument, addr 0x14b9aa0, size 0x8, virtual true, abstract: false, final false
  inline void WriteStartDocument();

  /// @brief Method WriteStartDocument, addr 0x14b9e20, size 0x14, virtual true, abstract: false, final false
  inline void WriteStartDocument(bool standalone);

  /// @brief Method WriteStartElement, addr 0x14bab10, size 0x3e8, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteString, addr 0x14bcbc4, size 0xcc, virtual true, abstract: false, final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity, addr 0x14bcc90, size 0xc8, virtual true, abstract: false, final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteWhitespace, addr 0x14bca4c, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14b9564, size 0x124, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x14b97c4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::StringW filename, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x14b96f4, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* w, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x14b984c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseStream, addr 0x14b98e0, size 0x9c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* get_BaseStream();

  /// @brief Method get_WriteState, addr 0x14bd1e4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Formatting, addr 0x14b99f8, size 0x14, virtual false, abstract: false, final false
  inline void set_Formatting(::System::Xml::Formatting value);

  /// @brief Method set_Namespaces, addr 0x14b997c, size 0x7c, virtual false, abstract: false, final false
  inline void set_Namespaces(bool value);

  /// @brief Method set_QuoteChar, addr 0x14b9a0c, size 0x94, virtual false, abstract: false, final false
