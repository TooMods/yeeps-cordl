...
public:
  // Declarations
  /// @brief Method ReadCfwsReverse, addr 0x1ae466c, size 0x2e4, virtual false, abstract: false, final false
  static inline int32_t ReadCfwsReverse(::StringW data, int32_t index);

  /// @brief Method ReadFwsReverse, addr 0x1ae4460, size 0x20c, virtual false, abstract: false, final false
