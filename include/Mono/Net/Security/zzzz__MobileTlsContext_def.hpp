...
public:
  ...
  /// @brief Method Dispose, addr 0x242a918, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x242c6d4, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x242c6d8, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectClientCertificate, addr 0x2425060, size 0x504, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateCertificate, addr 0x2423f18, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2423204, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AskForClientCertificate, addr 0x242c6b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_AskForClientCertificate();

  /// @brief Method get_ClientCertificates, addr 0x242c6bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x242c69c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LocalServerCertificate, addr 0x242c6c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalServerCertificate();

  /// @brief Method get_Parent, addr 0x242c694, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ServerName, addr 0x242c6ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ServerName();

  /// @brief Method get_Settings, addr 0x2423b90, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* get_Settings();

  /// @brief Method get_TargetHost, addr 0x242c6a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TargetHost();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_LocalServerCertificate, addr 0x242c6cc, size 0x8, virtual false, abstract: false, final false
