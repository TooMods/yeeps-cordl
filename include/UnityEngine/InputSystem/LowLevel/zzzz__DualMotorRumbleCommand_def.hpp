...
public:
  ...
  /// @brief Method Create, addr 0x1e018a4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1e02f0c, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1e02f3c, size 0x30, virtual true, abstract: false, final true
