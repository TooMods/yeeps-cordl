...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4530, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingVideoStats, addr 0x19b44f4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b449c, size 0x58, virtual false, abstract: false, final false
