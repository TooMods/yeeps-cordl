...
public:
  // Declarations
  /// @brief Method GetAppDownloadProgressResult, addr 0x19b278c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AppDownloadProgressResult* GetAppDownloadProgressResult();

  /// @brief Method GetDataFromMessage, addr 0x19b27c8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b067c, size 0x58, virtual false, abstract: false, final false
