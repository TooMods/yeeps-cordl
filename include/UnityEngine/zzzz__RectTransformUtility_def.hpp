...
public:
  ...
  /// @brief Method FlipLayoutAxes, addr 0x2017444, size 0x250, virtual false, abstract: false, final false
  static inline void FlipLayoutAxes(::UnityEngine::RectTransform* rect, bool keepPositioning, bool recursive);

  /// @brief Method FlipLayoutOnAxis, addr 0x2017180, size 0x2c4, virtual false, abstract: false, final false
  static inline void FlipLayoutOnAxis(::UnityEngine::RectTransform* rect, int32_t axis, bool keepPositioning, bool recursive);

  /// @brief Method GetTransposed, addr 0x2017694, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetTransposed(::UnityEngine::Vector2 input);

  /// @brief Method PixelAdjustPoint, addr 0x201673c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method PixelAdjustPoint_Injected, addr 0x20167e0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method PixelAdjustRect, addr 0x201683c, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect PixelAdjustRect(::UnityEngine::RectTransform* rectTransform, ::UnityEngine::Canvas* canvas);

  /// @brief Method PixelAdjustRect_Injected, addr 0x20168dc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInRectangle, addr 0x2016930, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInRectangle_Injected, addr 0x20169d8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method RectangleContainsScreenPoint, addr 0x2016a34, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method RectangleContainsScreenPoint, addr 0x2016b08, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ScreenPointToLocalPointInRectangle, addr 0x2016fd0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ScreenPointToRay, addr 0x2016ea0, size 0x130, virtual false, abstract: false, final false
  static inline ::UnityEngine::Ray ScreenPointToRay(::UnityEngine::Camera* cam, ::UnityEngine::Vector2 screenPos);

  /// @brief Method ScreenPointToWorldPointInRectangle, addr 0x2016bb4, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method WorldToScreenPoint, addr 0x20170d0, size 0xb0, virtual false, abstract: false, final false
