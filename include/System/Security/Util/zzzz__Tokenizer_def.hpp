...
public:
  ...
  /// @brief Method CompareStringAndChars, addr 0x1ea815c, size 0x94, virtual false, abstract: false, final false
  inline bool CompareStringAndChars(::StringW str, ::ArrayW<char16_t, ::Array<char16_t>*> a, int32_t l);

  /// @brief Method HashCharArray, addr 0x1ea806c, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t HashCharArray(::ArrayW<char16_t, ::Array<char16_t>*> a, int32_t l);

  /// @brief Method HashString, addr 0x1ea8000, size 0x6c, virtual false, abstract: false, final false
  static inline uint32_t HashString(::StringW str);

  /// @brief Method MakeString, addr 0x1ea27ac, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea80c8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Read, addr 0x1ea81f0, size 0x3c, virtual true, abstract: false, final false
  inline int32_t Read();
  ...
  /// @brief Method .ctor, addr 0x1ea7de4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::StreamReader* input);

  /// @brief Method get_NumCharEncountered, addr 0x1ea822c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BasicInitialization, addr 0x1ea7d10, size 0x78, virtual false, abstract: false, final false
  inline void BasicInitialization();

  /// @brief Method ChangeFormat, addr 0x1ea7554, size 0x224, virtual false, abstract: false, final false
  inline void ChangeFormat(::System::Text::Encoding* encoding);

  /// @brief Method GetStringToken, addr 0x1ea7ef8, size 0x18, virtual false, abstract: false, final false
  inline ::StringW GetStringToken();

  /// @brief Method GetTokens, addr 0x1ea6d14, size 0x7e0, virtual false, abstract: false, final false
  ...
  /// @brief Method Recycle, addr 0x1ea7d88, size 0x5c, virtual false, abstract: false, final false
  inline void Recycle();
  ...
  /// @brief Method .ctor, addr 0x1ea7cc8, size 0x48, virtual false, abstract: false, final false
