...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::Filtering::XRInteractionStrengthFilterDelegate);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__delegateToProcess_k__BackingField, put = __cordl_internal_set__delegateToProcess_k__BackingField))::System::Func_4<
      ::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* _delegateToProcess_k__BackingField;

  __declspec(property(get = get_canProcess, put = set_canProcess)) bool canProcess;

  __declspec(property(get = get_delegateToProcess, put = set_delegateToProcess))::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*,
                                                                                                 ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* delegateToProcess;
  ...
  static inline ::UnityEngine::XR::Interaction::Toolkit::Filtering::XRInteractionStrengthFilterDelegate*
  New_ctor(::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* delegateToProcess);

  /// @brief Method Process, addr 0x2fee87c, size 0x24, virtual true, abstract: false, final true
  ...
  constexpr ::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>*&
  __cordl_internal_get__delegateToProcess_k__BackingField();

  constexpr ::cordl_internals::to_const_pointer<
      ::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>*> const&
  ...
  constexpr void __cordl_internal_set__delegateToProcess_k__BackingField(
      ::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* value);

  /// @brief Method .ctor, addr 0x2fee7fc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* delegateToProcess);

  /// @brief Method get_canProcess, addr 0x2fee7e8, size 0x8, virtual true, abstract: false, final true
  inline bool get_canProcess();

  /// @brief Method get_delegateToProcess, addr 0x2fee7d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* get_delegateToProcess();
  ...
  /// @brief Method set_canProcess, addr 0x2fee7f0, size 0xc, virtual false, abstract: false, final false
  inline void set_canProcess(bool value);

  /// @brief Method set_delegateToProcess, addr 0x2fee7e0, size 0x8, virtual false, abstract: false, final false
  inline void set_delegateToProcess(::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRInteractionStrengthFilterDelegate", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRInteractionStrengthFilterDelegate(XRInteractionStrengthFilterDelegate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRInteractionStrengthFilterDelegate", modifiers: "const&", def_value: None }]
  ...
  ::System::Func_4<::UnityEngine::XR::Interaction::Toolkit::IXRInteractor*, ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable*, float_t, float_t>* ____delegateToProcess_k__BackingField;
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::XR::Interaction::Toolkit::Filtering::XRInteractionStrengthFilterDelegate, 0x20>, "Size mismatch!");
