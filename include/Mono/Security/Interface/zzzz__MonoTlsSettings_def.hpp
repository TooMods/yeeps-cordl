...
public:
  ...
  /// @brief Method Clone, addr 0x1cc738c, size 0x60, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* Clone();

  /// @brief Method CloneWithValidator, addr 0x1cc73f4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyDefaultSettings, addr 0x1cc7374, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cc72cc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1cc7474, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CallbackNeedsCertificateChain, addr 0x1cc7228, size 0x8, virtual false, abstract: false, final false
  inline bool get_CallbackNeedsCertificateChain();

  /// @brief Method get_CertificateSearchPaths, addr 0x1cc7264, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_CertificateSearchPaths();

  /// @brief Method get_CertificateValidationTime, addr 0x1cc7230, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::DateTime> get_CertificateValidationTime();

  /// @brief Method get_CertificateValidator, addr 0x1cc73ec, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::ICertificateValidator* get_CertificateValidator();

  /// @brief Method get_ClientCertificateIssuers, addr 0x1cc7288, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ClientCertificateIssuers();

  /// @brief Method get_ClientCertificateSelectionCallback, addr 0x1cc7208, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoLocalCertificateSelectionCallback* get_ClientCertificateSelectionCallback();

  /// @brief Method get_DefaultSettings, addr 0x1cc72e0, size 0x94, virtual false, abstract: false, final false
  static inline ::Mono::Security::Interface::MonoTlsSettings* get_DefaultSettings();

  /// @brief Method get_DisallowUnauthenticatedCertificateRequest, addr 0x1cc7298, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisallowUnauthenticatedCertificateRequest();

  /// @brief Method get_EnabledCiphers, addr 0x1cc72bc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::Mono::Security::Interface::CipherSuiteCode, ::Array<::Mono::Security::Interface::CipherSuiteCode>*> get_EnabledCiphers();

  /// @brief Method get_EnabledProtocols, addr 0x1cc72ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::Mono::Security::Interface::TlsProtocols> get_EnabledProtocols();

  /// @brief Method get_RemoteCertificateValidationCallback, addr 0x1cc71f8, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoRemoteCertificateValidationCallback* get_RemoteCertificateValidationCallback();

  /// @brief Method get_SendCloseNotify, addr 0x1cc7274, size 0x8, virtual false, abstract: false, final false
  inline bool get_SendCloseNotify();

  /// @brief Method get_TrustAnchors, addr 0x1cc7244, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_TrustAnchors();

  /// @brief Method get_UseServicePointManagerCallback, addr 0x1cc7218, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<bool> get_UseServicePointManagerCallback();

  /// @brief Method get_UserSettings, addr 0x1cc7254, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CertificateSearchPaths, addr 0x1cc726c, size 0x8, virtual false, abstract: false, final false
  inline void set_CertificateSearchPaths(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_CertificateValidationTime, addr 0x1cc723c, size 0x8, virtual false, abstract: false, final false
  inline void set_CertificateValidationTime(::System::Nullable_1<::System::DateTime> value);

  /// @brief Method set_ClientCertificateIssuers, addr 0x1cc7290, size 0x8, virtual false, abstract: false, final false
  inline void set_ClientCertificateIssuers(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_ClientCertificateSelectionCallback, addr 0x1cc7210, size 0x8, virtual false, abstract: false, final false
  inline void set_ClientCertificateSelectionCallback(::Mono::Security::Interface::MonoLocalCertificateSelectionCallback* value);

  /// @brief Method set_DisallowUnauthenticatedCertificateRequest, addr 0x1cc72a0, size 0xc, virtual false, abstract: false, final false
  inline void set_DisallowUnauthenticatedCertificateRequest(bool value);

  /// @brief Method set_EnabledCiphers, addr 0x1cc72c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EnabledProtocols, addr 0x1cc72b4, size 0x8, virtual false, abstract: false, final false
  inline void set_EnabledProtocols(::System::Nullable_1<::Mono::Security::Interface::TlsProtocols> value);

  /// @brief Method set_RemoteCertificateValidationCallback, addr 0x1cc7200, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_SendCloseNotify, addr 0x1cc727c, size 0xc, virtual false, abstract: false, final false
  inline void set_SendCloseNotify(bool value);

  /// @brief Method set_TrustAnchors, addr 0x1cc724c, size 0x8, virtual false, abstract: false, final false
  inline void set_TrustAnchors(::System::Security::Cryptography::X509Certificates::X509CertificateCollection* value);

  /// @brief Method set_UseServicePointManagerCallback, addr 0x1cc7220, size 0x8, virtual false, abstract: false, final false
  inline void set_UseServicePointManagerCallback(::System::Nullable_1<bool> value);

  /// @brief Method set_UserSettings, addr 0x1cc725c, size 0x8, virtual false, abstract: false, final false
