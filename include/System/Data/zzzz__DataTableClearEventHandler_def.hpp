...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x18a2e24, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18a2cf4, size 0x130, virtual false, abstract: false, final false
