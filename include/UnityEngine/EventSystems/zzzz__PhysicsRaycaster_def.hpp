...
public:
  ...
  /// @brief Method Compare, addr 0x2b71690, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2b716d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ComputeRayAndDistance, addr 0x2b70d2c, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x2b71278, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b70518, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_depth, addr 0x2b71194, size 0xc4, virtual true, abstract: false, final false
  inline int32_t get_depth();

  /// @brief Method get_eventCamera, addr 0x2b710f0, size 0xa4, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_eventMask, addr 0x2b71258, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_eventMask();

  /// @brief Method get_finalEventMask, addr 0x2b7102c, size 0xc4, virtual false, abstract: false, final false
  inline int32_t get_finalEventMask();

  /// @brief Method get_maxRayIntersections, addr 0x2b71268, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxRayIntersections();

  /// @brief Method set_eventMask, addr 0x2b71260, size 0x8, virtual false, abstract: false, final false
  inline void set_eventMask(::UnityEngine::LayerMask value);

  /// @brief Method set_maxRayIntersections, addr 0x2b71270, size 0x8, virtual false, abstract: false, final false
