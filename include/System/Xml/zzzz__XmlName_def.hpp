...
public:
  ...
  /// @brief Method Create, addr 0xf9d424, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0xf9db48, size 0xc, virtual true, abstract: false, final false
  inline bool Equals(::System::Xml::Schema::IXmlSchemaInfo* schemaInfo);

  /// @brief Method GetHashCode, addr 0xf9db54, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf9d518, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashCode, addr 0xf9d954, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_HashCode();

  /// @brief Method get_IsDefault, addr 0xf9db18, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsNil, addr 0xf9db20, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsNil();

  /// @brief Method get_LocalName, addr 0xf9d93c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_MemberType, addr 0xf9db28, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType();

  /// @brief Method get_Name, addr 0xf9d964, size 0x1ac, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NamespaceURI, addr 0xf9d944, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_OwnerDocument, addr 0xf9d95c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_OwnerDocument();

  /// @brief Method get_Prefix, addr 0xf9d94c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_SchemaAttribute, addr 0xf9db40, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute();

  /// @brief Method get_SchemaElement, addr 0xf9db38, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement();

  /// @brief Method get_SchemaType, addr 0xf9db30, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType();

  /// @brief Method get_Validity, addr 0xf9db10, size 0x8, virtual true, abstract: false, final false
