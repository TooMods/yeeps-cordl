...
public:
  ...
  /// @brief Method Equals, addr 0x304472c, size 0x138, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x3044864, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30443bc, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Serialization::XmlTypeMapMember* member, ::System::Xml::Serialization::TypeData* type);

  /// @brief Method get_ChoiceValue, addr 0x3044470, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_ChoiceValue();

  /// @brief Method get_DataTypeName, addr 0x3041508, size 0x30, virtual false, abstract: false, final false
  inline ::StringW get_DataTypeName();

  /// @brief Method get_DataTypeNamespace, addr 0x3041538, size 0x88, virtual false, abstract: false, final false
  inline ::StringW get_DataTypeNamespace();

  /// @brief Method get_ElementName, addr 0x3044480, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_ExplicitOrder, addr 0x304471c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ExplicitOrder();

  /// @brief Method get_Form, addr 0x30444a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x30444c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsTextElement, addr 0x3044518, size 0x4c, virtual false, abstract: false, final false
  inline bool get_IsTextElement();

  /// @brief Method get_IsUnnamedAnyElement, addr 0x3044624, size 0x54, virtual false, abstract: false, final false
  inline bool get_IsUnnamedAnyElement();

  /// @brief Method get_MappedType, addr 0x30444b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* get_MappedType();

  /// @brief Method get_Member, addr 0x30444d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapMember* get_Member();

  /// @brief Method get_MultiReferenceType, addr 0x30444e4, size 0x20, virtual false, abstract: false, final false
  inline bool get_MultiReferenceType();

  /// @brief Method get_Namespace, addr 0x3044490, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_TypeData, addr 0x3044468, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_TypeData();

  /// @brief Method get_WrappedElement, addr 0x3044504, size 0x8, virtual false, abstract: false, final false
  inline bool get_WrappedElement();

  /// @brief Method set_ChoiceValue, addr 0x3044478, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceValue(::System::Object* value);

  /// @brief Method set_ElementName, addr 0x3044488, size 0x8, virtual false, abstract: false, final false
  inline void set_ElementName(::StringW value);

  /// @brief Method set_ExplicitOrder, addr 0x3044724, size 0x8, virtual false, abstract: false, final false
  inline void set_ExplicitOrder(int32_t value);

  /// @brief Method set_Form, addr 0x30444a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Form(::System::Xml::Schema::XmlSchemaForm value);

  /// @brief Method set_IsNullable, addr 0x30444c8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_IsTextElement, addr 0x3044564, size 0xc0, virtual false, abstract: false, final false
  inline void set_IsTextElement(bool value);

  /// @brief Method set_IsUnnamedAnyElement, addr 0x3044678, size 0xa4, virtual false, abstract: false, final false
  inline void set_IsUnnamedAnyElement(bool value);

  /// @brief Method set_MappedType, addr 0x30444b8, size 0x8, virtual false, abstract: false, final false
  inline void set_MappedType(::System::Xml::Serialization::XmlTypeMapping* value);

  /// @brief Method set_Namespace, addr 0x3044498, size 0x8, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_NestingLevel, addr 0x30444dc, size 0x8, virtual false, abstract: false, final false
  inline void set_NestingLevel(int32_t value);

  /// @brief Method set_WrappedElement, addr 0x304450c, size 0xc, virtual false, abstract: false, final false
