...
public:
  ...
  /// @brief Method .ctor, addr 0x1b36404, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_names>b__2_0, addr 0x1b3640c, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddTypeRegistration, addr 0x1b36140, size 0x168, virtual false, abstract: false, final false
  inline void AddTypeRegistration(::StringW name, ::System::Type* type);

  /// @brief Method FindNameForType, addr 0x1b35f20, size 0x220, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::InternedString FindNameForType(::System::Type* type);

  /// @brief Method Initialize, addr 0x1b35eac, size 0x74, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method LookupTypeRegistration, addr 0x1b362a8, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Type* LookupTypeRegistration(::StringW name);

  /// @brief Method get_internedNames, addr 0x1b35e5c, size 0x50, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::InternedString>* get_internedNames();

  /// @brief Method get_names, addr 0x1b35d34, size 0x128, virtual false, abstract: false, final false
