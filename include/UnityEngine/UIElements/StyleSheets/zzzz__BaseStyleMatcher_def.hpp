...
public:
  ...
  /// @brief Method DropContext, addr 0x2153520, size 0x50, virtual false, abstract: false, final false
  inline void DropContext();

  /// @brief Method Initialize, addr 0x21533dc, size 0x54, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Match, addr 0x2153570, size 0xb4, virtual false, abstract: false, final false
  inline bool Match(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchAndAnd, addr 0x2153bf0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchCombinator, addr 0x215388c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchDataType, addr 0x2153958, size 0xfc, virtual false, abstract: false, final false
  inline bool MatchDataType(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchExpression, addr 0x215362c, size 0x114, virtual false, abstract: false, final false
  inline bool MatchExpression(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchExpressionWithMultiplier, addr 0x2153740, size 0x14c, virtual false, abstract: false, final false
  inline bool MatchExpressionWithMultiplier(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchGroup, addr 0x2153a54, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchJuxtaposition, addr 0x2153c20, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchMany, addr 0x2153c8c, size 0x180, virtual false, abstract: false, final false
  inline int32_t MatchMany(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchManyByOrder, addr 0x2153e0c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchOr, addr 0x2153b08, size 0xd0, virtual false, abstract: false, final false
  inline bool MatchOr(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchOrOr, addr 0x2153bd8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveNext, addr 0x2153430, size 0x44, virtual false, abstract: false, final false
  inline void MoveNext();

  static inline ::UnityEngine::UIElements::StyleSheets::BaseStyleMatcher* New_ctor();

  /// @brief Method RestoreContext, addr 0x21534c8, size 0x58, virtual false, abstract: false, final false
  inline void RestoreContext();

  /// @brief Method SaveContext, addr 0x2153474, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2153f9c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Text::RegularExpressions::Regex* getStaticF_s_CustomIdentRegex();

  /// @brief Method get_currentIndex, addr 0x21533bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentIndex();

  /// @brief Method get_hasCurrent, addr 0x2153394, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_matchedVariableCount, addr 0x21533cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentIndex, addr 0x21533c4, size 0x8, virtual false, abstract: false, final false
  inline void set_currentIndex(int32_t value);

  /// @brief Method set_matchedVariableCount, addr 0x21533d4, size 0x8, virtual false, abstract: false, final false
