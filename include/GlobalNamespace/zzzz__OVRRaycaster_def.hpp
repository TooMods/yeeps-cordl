...
public:
  ...
  /// @brief Method <GraphicRaycast>b__16_0, addr 0x16fb804, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16fb7fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetScreenPosition, addr 0x16fb4b8, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetScreenPosition(::UnityEngine::EventSystems::RaycastResult raycastResult);

  /// @brief Method GraphicRaycast, addr 0x16fa924, size 0x69c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFocussed, addr 0x16fb4f0, size 0x118, virtual false, abstract: false, final false
  inline bool IsFocussed();

  static inline ::GlobalNamespace::OVRRaycaster* New_ctor();

  /// @brief Method OnPointerEnter, addr 0x16fb608, size 0x104, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* e);

  /// @brief Method RayIntersectsRectTransform, addr 0x16fb27c, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x16fafc0, size 0x6c, virtual true, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList);

  /// @brief Method Raycast, addr 0x16fa24c, size 0x6d8, virtual false, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList,
                      ::UnityEngine::Ray ray, bool checkForBlocking);

  /// @brief Method RaycastPointer, addr 0x16fb02c, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x16fa0fc, size 0x150, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x16f9fa4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>* getStaticF_s_SortedGraphics();

  /// @brief Method get_canvas, addr 0x16fa044, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_canvas();

  /// @brief Method get_eventCamera, addr 0x16fa0d8, size 0x1c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_sortOrderPriority, addr 0x16fa0f4, size 0x8, virtual true, abstract: false, final false
