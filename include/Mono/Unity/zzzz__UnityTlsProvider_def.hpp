...
public:
  ...
  /// @brief Method CreateSslStream, addr 0x24256f8, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateCertificate, addr 0x242581c, size 0x978, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2426194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ID, addr 0x2425678, size 0x58, virtual true, abstract: false, final false
  inline ::System::Guid get_ID();

  /// @brief Method get_Name, addr 0x2425638, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_SupportedProtocols, addr 0x24256f0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Authentication::SslProtocols get_SupportedProtocols();

  /// @brief Method get_SupportsCleanShutdown, addr 0x24256e8, size 0x8, virtual true, abstract: false, final false
  inline bool get_SupportsCleanShutdown();

  /// @brief Method get_SupportsConnectionInfo, addr 0x24256e0, size 0x8, virtual true, abstract: false, final false
  inline bool get_SupportsConnectionInfo();

  /// @brief Method get_SupportsMonoExtensions, addr 0x24256d8, size 0x8, virtual true, abstract: false, final false
  inline bool get_SupportsMonoExtensions();

  /// @brief Method get_SupportsSslStream, addr 0x24256d0, size 0x8, virtual true, abstract: false, final false
  inline bool get_SupportsSslStream();

  /// @brief Method x509verify_callback, addr 0x24255d4, size 0x64, virtual false, abstract: false, final false
