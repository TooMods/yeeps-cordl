...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c73108, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c73030, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::StepCounter* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c73084, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c73180, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::StepCounter* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x1c72f9c, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::StepCounter* get_current();

  /// @brief Method get_stepCounter, addr 0x1c72f8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x1c72fe4, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::StepCounter* value);

  /// @brief Method set_stepCounter, addr 0x1c72f94, size 0x8, virtual false, abstract: false, final false
