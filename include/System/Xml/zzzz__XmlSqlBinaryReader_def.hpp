...
public:
  // Declarations
  /// @brief Method CheckPrefixNS, addr 0x2832cfc, size 0x124, virtual false, abstract: false, final false
  inline void CheckPrefixNS(::StringW prefix, ::StringW namespaceUri);

  /// @brief Method Clear, addr 0x282e238, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Equals, addr 0x2836094, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x2836000, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetNSHashCode, addr 0x2836048, size 0x4c, virtual false, abstract: false, final false
  inline int32_t GetNSHashCode(::System::Xml::SecureStringHasher* hasher);

  /// @brief Method MatchNs, addr 0x2832914, size 0x50, virtual false, abstract: false, final false
  inline bool MatchNs(::StringW lname, ::StringW nsUri);

  /// @brief Method MatchPrefix, addr 0x2832964, size 0x50, virtual false, abstract: false, final false
  inline bool MatchPrefix(::StringW prefix, ::StringW lname);

  /// @brief Method Set, addr 0x2831e58, size 0xc, virtual false, abstract: false, final false
  inline void Set(::StringW prefix, ::StringW lname, ::StringW nsUri);

  /// @brief Method ToString, addr 0x2833b54, size 0x70, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2832ff0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW prefix, ::StringW lname, ::StringW nsUri);

  /// @brief Method op_Equality, addr 0x283614c, size 0x60, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Clear, addr 0x2833d08, size 0x10, virtual false, abstract: false, final false
  inline ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl* Clear();

  /// @brief Method Set, addr 0x2834960, size 0x20, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method AdjustPosition, addr 0x2832240, size 0x14, virtual false, abstract: false, final false
  inline void AdjustPosition(int32_t adj);

  /// @brief Method GetLocalnameAndNamespaceUri, addr 0x2833b3c, size 0x14, virtual false, abstract: false, final false
  inline void GetLocalnameAndNamespaceUri(ByRef<::StringW> localname, ByRef<::StringW> namespaceUri);

  /// @brief Method GetLocalnameAndNamespaceUriAndHash, addr 0x2833bc4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchHashNS, addr 0x2833bec, size 0x20, virtual false, abstract: false, final false
  inline bool MatchHashNS(int32_t hash, ::StringW localname, ::StringW namespaceUri);

  /// @brief Method MatchNS, addr 0x2833b50, size 0x4, virtual false, abstract: false, final false
  inline bool MatchNS(::StringW localname, ::StringW namespaceUri);

  /// @brief Method Set, addr 0x28334d0, size 0x1c, virtual false, abstract: false, final false
  inline void Set(::System::Xml::__XmlSqlBinaryReader__QName n, int32_t pos);

  /// @brief Method Set, addr 0x2832ffc, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x28318f8, size 0x58, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Init, addr 0x282e150, size 0xe8, virtual false, abstract: false, final false
  inline void Init();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2834980, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddInitNamespace, addr 0x282e28c, size 0xd8, virtual false, abstract: false, final false
  inline void AddInitNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method AddName, addr 0x2831950, size 0x134, virtual false, abstract: false, final false
  inline void AddName();

  /// @brief Method AddQName, addr 0x2831b4c, size 0x27c, virtual false, abstract: false, final false
  inline void AddQName();

  /// @brief Method CDATAValue, addr 0x282f134, size 0x104, virtual false, abstract: false, final false
  inline ::StringW CDATAValue();

  /// @brief Method CheckAllowContent, addr 0x28348f8, size 0x68, virtual false, abstract: false, final false
  inline void CheckAllowContent();

  /// @brief Method CheckText, addr 0x2834a6c, size 0x1c4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType CheckText(bool attr);

  /// @brief Method CheckTextIsWS, addr 0x2834c30, size 0x98, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType CheckTextIsWS();

  /// @brief Method CheckValueTokenBounds, addr 0x28350d4, size 0x60, virtual false, abstract: false, final false
  inline void CheckValueTokenBounds();

  /// @brief Method ClearAttributes, addr 0x2832ac0, size 0x10, virtual false, abstract: false, final false
  inline void ClearAttributes();

  /// @brief Method Close, addr 0x2830870, size 0x6c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Fill, addr 0x2831f70, size 0x1c, virtual false, abstract: false, final false
  inline void Fill(int32_t require);

  /// @brief Method FillAllowEOF, addr 0x283201c, size 0x224, virtual false, abstract: false, final false
  inline bool FillAllowEOF();

  /// @brief Method Fill_, addr 0x2832254, size 0x78, virtual false, abstract: false, final false
  inline void Fill_(int32_t require);

  /// @brief Method FinishCDATA, addr 0x2833c0c, size 0xa8, virtual false, abstract: false, final false
  inline void FinishCDATA();

  /// @brief Method FinishEndElement, addr 0x2833cb4, size 0x54, virtual false, abstract: false, final false
  inline void FinishEndElement();

  /// @brief Method GenerateImpliedXmlnsAttrs, addr 0x2832ec4, size 0x12c, virtual false, abstract: false, final false
  inline void GenerateImpliedXmlnsAttrs();

  /// @brief Method GenerateTokenTypeMap, addr 0x282e364, size 0xa28, virtual false, abstract: false, final false
  inline void GenerateTokenTypeMap();

  /// @brief Method GetAttribute, addr 0x28300ac, size 0x94, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x282ff60, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0x282fdac, size 0x12c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW ns);

  /// @brief Method GetAttributeText, addr 0x282fa18, size 0x124, virtual false, abstract: false, final false
  inline ::StringW GetAttributeText(int32_t i);

  /// @brief Method GetDouble, addr 0x2835aac, size 0xd4, virtual false, abstract: false, final false
  inline double_t GetDouble(int32_t offset);

  /// @brief Method GetInt16, addr 0x2835400, size 0x44, virtual false, abstract: false, final false
  inline int16_t GetInt16(int32_t pos);

  /// @brief Method GetInt32, addr 0x2835444, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetInt32(int32_t pos);

  /// @brief Method GetInt64, addr 0x28354b8, size 0xd0, virtual false, abstract: false, final false
  inline int64_t GetInt64(int32_t pos);

  /// @brief Method GetSingle, addr 0x2835a34, size 0x78, virtual false, abstract: false, final false
  inline float_t GetSingle(int32_t offset);

  /// @brief Method GetString, addr 0x282efc0, size 0x174, virtual false, abstract: false, final false
  inline ::StringW GetString(int32_t pos, int32_t cch);

  /// @brief Method GetStringAligned, addr 0x28328e8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetStringAligned(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t cch);

  /// @brief Method GetUInt16, addr 0x2835588, size 0x44, virtual false, abstract: false, final false
  inline uint16_t GetUInt16(int32_t pos);

  /// @brief Method GetUInt32, addr 0x28355cc, size 0x74, virtual false, abstract: false, final false
  inline uint32_t GetUInt32(int32_t pos);

  /// @brief Method GetUInt64, addr 0x2835640, size 0xd0, virtual false, abstract: false, final false
  inline uint64_t GetUInt64(int32_t pos);

  /// @brief Method GetValueType, addr 0x2830784, size 0xec, virtual false, abstract: false, final false
  inline ::System::Type* GetValueType(::System::Xml::BinXmlToken token);

  /// @brief Method GetXsdKatmaiTokenLength, addr 0x2834fec, size 0xe8, virtual false, abstract: false, final false
  inline int32_t GetXsdKatmaiTokenLength(::System::Xml::BinXmlToken token);

  /// @brief Method GrowAttributes, addr 0x2832a3c, size 0x84, virtual false, abstract: false, final false
  inline void GrowAttributes();

  /// @brief Method GrowElements, addr 0x28329b4, size 0x88, virtual false, abstract: false, final false
  inline void GrowElements();

  /// @brief Method HashCheckForDuplicateAttributes, addr 0x28338f0, size 0x24c, virtual false, abstract: false, final false
  inline void HashCheckForDuplicateAttributes();

  /// @brief Method ImplReadCDATA, addr 0x283431c, size 0x34, virtual false, abstract: false, final false
  inline void ImplReadCDATA();

  /// @brief Method ImplReadComment, addr 0x28342f0, size 0x2c, virtual false, abstract: false, final false
  inline void ImplReadComment();

  /// @brief Method ImplReadData, addr 0x2834788, size 0x170, virtual false, abstract: false, final false
  inline void ImplReadData(::System::Xml::BinXmlToken tokenType);

  /// @brief Method ImplReadDoctype, addr 0x2834028, size 0x264, virtual false, abstract: false, final false
  inline void ImplReadDoctype();

  /// @brief Method ImplReadElement, addr 0x2833d18, size 0x248, virtual false, abstract: false, final false
  inline void ImplReadElement();

  /// @brief Method ImplReadEndElement, addr 0x2833f60, size 0xc8, virtual false, abstract: false, final false
  inline void ImplReadEndElement();

  /// @brief Method ImplReadEndNest, addr 0x28343f8, size 0x30, virtual false, abstract: false, final false
  inline void ImplReadEndNest();

  /// @brief Method ImplReadNest, addr 0x2834350, size 0xa8, virtual false, abstract: false, final false
  inline void ImplReadNest();

  /// @brief Method ImplReadPI, addr 0x283428c, size 0x64, virtual false, abstract: false, final false
  inline void ImplReadPI();

  /// @brief Method ImplReadXmlText, addr 0x2834428, size 0x360, virtual false, abstract: false, final false
  inline void ImplReadXmlText();

  /// @brief Method LocateAttribute, addr 0x282ffcc, size 0xe0, virtual false, abstract: false, final false
  inline int32_t LocateAttribute(::StringW name);

  /// @brief Method LocateAttribute, addr 0x282fed8, size 0x88, virtual false, abstract: false, final false
  inline int32_t LocateAttribute(::StringW name, ::StringW ns);

  /// @brief Method LookupNamespace, addr 0x28308e4, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0x2830140, size 0x7c, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x2830298, size 0xa8, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x283043c, size 0xb8, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x2830340, size 0x78, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x28303b8, size 0x84, virtual true, abstract: false, final false
  inline bool MoveToNextAttribute();

  /// @brief Method NameFlush, addr 0x2831e64, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method NextToken, addr 0x28327a4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken NextToken();

  /// @brief Method NextToken1, addr 0x283272c, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken NextToken1();

  /// @brief Method NextToken2, addr 0x28326b4, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken NextToken2(::System::Xml::BinXmlToken token);

  /// @brief Method ParseMB32, addr 0x2831f40, size 0x30, virtual false, abstract: false, final false
  inline int32_t ParseMB32();

  /// @brief Method ParseMB32, addr 0x28324bc, size 0xf0, virtual false, abstract: false, final false
  inline int32_t ParseMB32(int32_t pos);

  /// @brief Method ParseMB32_, addr 0x2832418, size 0xa4, virtual false, abstract: false, final false
  inline int32_t ParseMB32_(uint8_t b);

  /// @brief Method ParseMB64, addr 0x28325ac, size 0x30, virtual false, abstract: false, final false
  inline int32_t ParseMB64();

  /// @brief Method ParseText, addr 0x2831a84, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW ParseText();

  /// @brief Method PeekNextToken, addr 0x2832808, size 0x28, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken PeekNextToken();

  /// @brief Method PeekToken, addr 0x28325dc, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken PeekToken();

  /// @brief Method PopNamespaces, addr 0x2832e20, size 0xa4, virtual false, abstract: false, final false
  inline void PopNamespaces(::System::Xml::__XmlSqlBinaryReader__NamespaceDecl* firstInScopeChain);

  /// @brief Method PositionOnAttribute, addr 0x28301d8, size 0xc0, virtual false, abstract: false, final false
  inline void PositionOnAttribute(int32_t i);

  /// @brief Method PushNamespace, addr 0x2832ad0, size 0x22c, virtual false, abstract: false, final false
  inline void PushNamespace(::StringW prefix, ::StringW ns, bool implied);

  /// @brief Method ReScanOverValue, addr 0x2830778, size 0xc, virtual false, abstract: false, final false
  inline void ReScanOverValue(::System::Xml::BinXmlToken token);

  /// @brief Method Read, addr 0x2830a58, size 0x1d0, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeValue, addr 0x2830504, size 0x18c, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadByte, addr 0x2832348, size 0x5c, virtual false, abstract: false, final false
  inline uint8_t ReadByte();

  /// @brief Method ReadDoc, addr 0x2830fe0, size 0x37c, virtual false, abstract: false, final false
  inline bool ReadDoc();

  /// @brief Method ReadInit, addr 0x2830c28, size 0x3b8, virtual false, abstract: false, final false
  inline bool ReadInit(bool skipXmlDecl);

  /// @brief Method ReadNameRef, addr 0x2831dc8, size 0x90, virtual false, abstract: false, final false
  inline int32_t ReadNameRef();

  /// @brief Method ReadQNameRef, addr 0x2831f8c, size 0x90, virtual false, abstract: false, final false
  inline int32_t ReadQNameRef();

  /// @brief Method ReadToken, addr 0x2832644, size 0x70, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken ReadToken();

  /// @brief Method ReadUShort, addr 0x28323a4, size 0x74, virtual false, abstract: false, final false
  inline uint16_t ReadUShort();

  /// @brief Method RescanNextToken, addr 0x2830690, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken RescanNextToken();

  /// @brief Method ResolveEntity, addr 0x2830998, size 0x40, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ScanAttributes, addr 0x2833018, size 0x4b8, virtual false, abstract: false, final false
  inline void ScanAttributes();

  /// @brief Method ScanOverAnyValue, addr 0x2834cc8, size 0x324, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType ScanOverAnyValue(::System::Xml::BinXmlToken token, bool attr, bool checkChars);

  /// @brief Method ScanOverValue, addr 0x28335fc, size 0x128, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType ScanOverValue(::System::Xml::BinXmlToken token, bool attr, bool checkChars);

  /// @brief Method ScanText, addr 0x2832830, size 0xb8, virtual false, abstract: false, final false
  inline int32_t ScanText(ByRef<int32_t> start);

  /// @brief Method SimpleCheckForDuplicateAttributes, addr 0x28337b0, size 0x140, virtual false, abstract: false, final false
  inline void SimpleCheckForDuplicateAttributes();

  /// @brief Method SkipExtn, addr 0x2831eb4, size 0x8c, virtual false, abstract: false, final false
  inline void SkipExtn();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x283135c, size 0x380, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x28316dc, size 0x19c, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method ThrowNotSupported, addr 0x2833724, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowNotSupported(::StringW res);

  /// @brief Method ThrowUnexpectedToken, addr 0x28318b0, size 0x48, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowUnexpectedToken(::System::Xml::BinXmlToken token);

  /// @brief Method ThrowXmlException, addr 0x28322cc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowXmlException(::StringW res);

  /// @brief Method ThrowXmlException, addr 0x28334ec, size 0x110, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowXmlException(::StringW res, ::StringW arg1, ::StringW arg2);

  /// @brief Method UpdateFromTextReader, addr 0x28301bc, size 0x1c, virtual false, abstract: false, final false
  inline bool UpdateFromTextReader(bool needUpdate);

  /// @brief Method UpdateFromTextReader, addr 0x28349c4, size 0xa8, virtual false, abstract: false, final false
  inline void UpdateFromTextReader();

  /// @brief Method ValueAsDateTimeString, addr 0x2835b80, size 0x304, virtual false, abstract: false, final false
  inline ::StringW ValueAsDateTimeString();

  /// @brief Method ValueAsDecimal, addr 0x2835844, size 0x1a0, virtual false, abstract: false, final false
  inline ::System::Decimal ValueAsDecimal();

  /// @brief Method ValueAsDouble, addr 0x2835710, size 0x134, virtual false, abstract: false, final false
  inline double_t ValueAsDouble();

  /// @brief Method ValueAsLong, addr 0x283520c, size 0x1f4, virtual false, abstract: false, final false
  inline int64_t ValueAsLong();

  /// @brief Method ValueAsString, addr 0x282f36c, size 0x6ac, virtual false, abstract: false, final false
  inline ::StringW ValueAsString(::System::Xml::BinXmlToken token);

  /// @brief Method ValueAsULong, addr 0x28359e4, size 0x50, virtual false, abstract: false, final false
  inline uint64_t ValueAsULong();

  /// @brief Method VerifyVersion, addr 0x2831878, size 0x38, virtual false, abstract: false, final false
  inline void VerifyVersion(int32_t requiredVersion, ::System::Xml::BinXmlToken token);

  /// @brief Method XmlDeclValue, addr 0x282f238, size 0x134, virtual false, abstract: false, final false
  inline ::StringW XmlDeclValue();

  /// @brief Method XsdKatmaiTimeScaleToValueLength, addr 0x2835134, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x282dcac, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeCount, addr 0x282fd58, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0x282fbe0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_Depth, addr 0x282fb3c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_EOF, addr 0x28304f4, size 0x10, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_IsEmptyElement, addr 0x282fbe8, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LocalName, addr 0x282ee94, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NameTable, addr 0x28308dc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x282ee9c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x282ee8c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x282eea4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_ReadState, addr 0x28309d8, size 0x80, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_Settings, addr 0x282ed8c, size 0x100, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_Value, addr 0x282eeac, size 0x114, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_ValueType, addr 0x282fd50, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlLang, addr 0x282fc8c, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x282fc0c, size 0x80, virtual true, abstract: false, final false
