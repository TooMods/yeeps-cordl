...
public:
  ...
  /// @brief Method GetPositionInfo, addr 0xfa72fc, size 0xbc, virtual false, abstract: false, final false
  static inline ::System::Xml::PositionInfo* GetPositionInfo(::System::Object* o);

  /// @brief Method HasLineInfo, addr 0xfa72e4, size 0x8, virtual true, abstract: false, final false
  inline bool HasLineInfo();

  static inline ::System::Xml::PositionInfo* New_ctor();

  /// @brief Method .ctor, addr 0xfa73e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LineNumber, addr 0xfa72ec, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0xfa72f4, size 0x8, virtual true, abstract: false, final false
