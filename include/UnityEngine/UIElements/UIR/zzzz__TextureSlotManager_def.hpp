...
public:
  ...
  /// @brief Method Bind, addr 0x127d098, size 0x218, virtual false, abstract: false, final false
  inline void Bind(::UnityEngine::UIElements::TextureId id, int32_t slot, ::UnityEngine::MaterialPropertyBlock* mat);

  /// @brief Method FindOldestSlot, addr 0x127cfc8, size 0xd0, virtual false, abstract: false, final false
  inline int32_t FindOldestSlot();

  /// @brief Method IndexOf, addr 0x127ce8c, size 0xd4, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::TextureId id);

  /// @brief Method MarkUsed, addr 0x127cf60, size 0x58, virtual false, abstract: false, final false
  inline void MarkUsed(int32_t slotIndex);

  static inline ::UnityEngine::UIElements::UIR::TextureSlotManager* New_ctor();

  /// @brief Method Reset, addr 0x127ccf4, size 0x12c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method StartNewBatch, addr 0x127ce20, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x127cb8c, size 0x168, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FreeSlots, addr 0x127cfb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_FreeSlots, addr 0x127cfc0, size 0x8, virtual false, abstract: false, final false
