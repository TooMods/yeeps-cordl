...
public:
  ...
  /// @brief Method .ctor, addr 0x1346480, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MergeArrayHandling, addr 0x13464a0, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::MergeArrayHandling get_MergeArrayHandling();

  /// @brief Method get_MergeNullValueHandling, addr 0x134650c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::MergeNullValueHandling get_MergeNullValueHandling();

  /// @brief Method get_PropertyNameComparison, addr 0x1346578, size 0x8, virtual false, abstract: false, final false
  inline ::System::StringComparison get_PropertyNameComparison();

  /// @brief Method set_MergeArrayHandling, addr 0x13464a8, size 0x64, virtual false, abstract: false, final false
  inline void set_MergeArrayHandling(::Newtonsoft::Json::Linq::MergeArrayHandling value);

  /// @brief Method set_MergeNullValueHandling, addr 0x1346514, size 0x64, virtual false, abstract: false, final false
  inline void set_MergeNullValueHandling(::Newtonsoft::Json::Linq::MergeNullValueHandling value);

  /// @brief Method set_PropertyNameComparison, addr 0x1346580, size 0x64, virtual false, abstract: false, final false
