...
public:
  ...
  /// @brief Method Decode, addr 0x14ca7ec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ca7f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsFull, addr 0x14ca7e4, size 0x8, virtual true, abstract: false, final false
