...
public:
  ...
  /// @brief Method Dump, addr 0x1ab2a98, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn* New_ctor();

  /// @brief Method Write, addr 0x1ab2950, size 0x148, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab2940, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
