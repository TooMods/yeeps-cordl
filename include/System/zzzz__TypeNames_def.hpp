...
public:
  ...
  /// @brief Method Equals, addr 0x10d9d04, size 0x60, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x10d9c0c, size 0xd0, virtual true, abstract: false, final true
  inline bool Equals(::System::TypeName* other);

  /// @brief Method GetHashCode, addr 0x10d9cdc, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::__TypeNames__ATypeName* New_ctor();

  /// @brief Method .ctor, addr 0x10d9d64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
