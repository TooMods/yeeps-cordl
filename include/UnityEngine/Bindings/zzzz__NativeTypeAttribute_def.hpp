...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7be4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a7c00, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Bindings::CodegenOptions codegenOptions);

  /// @brief Method .ctor, addr 0x23a7d30, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Bindings::CodegenOptions codegenOptions, ::StringW intermediateStructName);

  /// @brief Method .ctor, addr 0x23a7c28, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  /// @brief Method set_CodegenOptions, addr 0x23a7bdc, size 0x8, virtual true, abstract: false, final true
  inline void set_CodegenOptions(::UnityEngine::Bindings::CodegenOptions value);

  /// @brief Method set_Header, addr 0x23a7bcc, size 0x8, virtual true, abstract: false, final true
  inline void set_Header(::StringW value);

  /// @brief Method set_IntermediateScriptingStructName, addr 0x23a7bd4, size 0x8, virtual false, abstract: false, final false
