...
//  Writing Method size for method: ::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::*)()>(
    &::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x1d94a8c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0*>::get(), ".ctor",
                                                 std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0._IsDirectChild_b__0
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::*)(
    ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*)>(&::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::_IsDirectChild_b__0)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x1d94a9c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0*>::get(),
                                    "<IsDirectChild>b__0", std::span<Il2CppClass const* const, 0>(),
...
constexpr ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>& UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::__cordl_internal_get_widget() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___widget;
}
constexpr ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> const& UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::__cordl_internal_get_widget() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___widget;
}
constexpr void UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::__cordl_internal_set_widget(::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0* UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0*>());
}
inline void UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0*>::get(), ".ctor",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
inline bool UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::_IsDirectChild_b__0(::UnityEngine::Rendering::UI::DebugUIHandlerWidget* x) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0*>::get(), "<IsDirectChild>b__0",
                                  std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Rendering::UI::DebugUIHandlerWidget*>::get() })));
  return ::cordl_internals::RunMethodRethrow<bool, false>(this, ___internal_method, x);
}
// Ctor Parameters []
constexpr ::UnityEngine::Rendering::UI::__DebugUIHandlerContainer____c__DisplayClass3_0::__DebugUIHandlerContainer____c__DisplayClass3_0() {}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> (
  ...
  constexpr static std::size_t addrs = 0x1d916ac;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> (
  ...
  constexpr static std::size_t size = 0x90;
  constexpr static std::size_t addrs = 0x1d913b8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::UI::DebugUIHandlerContainer::*)(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*)>(
  ...
  constexpr static std::size_t addrs = 0x1d912b4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>>* (
  ...
  constexpr static std::size_t addrs = 0x1d94668;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::UI::DebugUIHandlerContainer::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x1d94a94;
