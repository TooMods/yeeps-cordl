...
public:
  ...
  /// @brief Method Dump, addr 0x1ab3af8, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped* New_ctor();

  /// @brief Method Read, addr 0x1ab3ac8, size 0x30, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x1ab3a9c, size 0x8, virtual false, abstract: false, final false
  inline void Set(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE typeInformation);

  /// @brief Method Set, addr 0x1ab3a90, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x1ab3aa4, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab3a88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
