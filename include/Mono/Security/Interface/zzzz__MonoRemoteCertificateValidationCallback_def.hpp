...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x246ea38, size 0x1014, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246e960, size 0xd8, virtual false, abstract: false, final false
