...
public:
  ...
  /// @brief Method SetCompleted, addr 0xed7500, size 0x28, virtual false, abstract: false, final false
  inline void SetCompleted();

  /// @brief Method UnregisterCancellationCallback, addr 0xed7528, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed3dd0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Invoke, addr 0xedbdac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xed9360, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InvokeMayRunArbitraryCode, addr 0xedbdb4, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method <Delay>b__247_0, addr 0xedc2a4, size 0x60, virtual false, abstract: false, final false
  inline void _Delay_b__247_0(::System::Object* state);

  /// @brief Method <Delay>b__247_1, addr 0xedc304, size 0x60, virtual false, abstract: false, final false
  inline void _Delay_b__247_1(::System::Object* state);

  /// @brief Method <.cctor>b__271_0, addr 0xedc364, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::__Task__ContingentProperties* __cctor_b__271_0();

  /// @brief Method <.cctor>b__271_1, addr 0xedc3d0, size 0x20, virtual false, abstract: false, final false
  inline bool __cctor_b__271_1(::System::Threading::Tasks::Task* t);

  /// @brief Method <.cctor>b__271_2, addr 0xedc3f0, size 0xc, virtual false, abstract: false, final false
  inline bool __cctor_b__271_2(::System::Object* tc);

  /// @brief Method .ctor, addr 0xedc29c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddCompletionAction, addr 0xed9fd0, size 0x8, virtual false, abstract: false, final false
  inline void AddCompletionAction(::System::Threading::Tasks::ITaskCompletionAction* action);

  /// @brief Method AddCompletionAction, addr 0xed93c0, size 0xd4, virtual false, abstract: false, final false
  inline void AddCompletionAction(::System::Threading::Tasks::ITaskCompletionAction* action, bool addBeforeOthers);

  /// @brief Method AddException, addr 0xed4d54, size 0x8, virtual false, abstract: false, final false
  inline void AddException(::System::Object* exceptionObject);

  /// @brief Method AddException, addr 0xed67b8, size 0x198, virtual false, abstract: false, final false
  inline void AddException(::System::Object* exceptionObject, bool representsCancellation);

  /// @brief Method AddExceptionsFromChildren, addr 0xed70c4, size 0x43c, virtual false, abstract: false, final false
  inline void AddExceptionsFromChildren();

  /// @brief Method AddNewChild, addr 0xed41d4, size 0x74, virtual false, abstract: false, final false
  inline void AddNewChild();

  /// @brief Method AddTaskContinuation, addr 0xed87fc, size 0x94, virtual false, abstract: false, final false
  inline bool AddTaskContinuation(::System::Object* tc, bool addBeforeOthers);

  /// @brief Method AddTaskContinuationComplex, addr 0xed9fd8, size 0x320, virtual false, abstract: false, final false
  inline bool AddTaskContinuationComplex(::System::Object* tc, bool addBeforeOthers);

  /// @brief Method AddToActiveTasks, addr 0xedb7e4, size 0x164, virtual false, abstract: false, final false
  static inline bool AddToActiveTasks(::System::Threading::Tasks::Task* task);

  /// @brief Method AnyTaskRequiresNotifyDebuggerOfWaitCompletion, addr 0xed509c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignCancellationToken, addr 0xed4248, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method AtomicStateUpdate, addr 0xed4b70, size 0x88, virtual false, abstract: false, final false
  inline bool AtomicStateUpdate(int32_t newBits, int32_t illegalBits);

  /// @brief Method AtomicStateUpdate, addr 0xed4ef0, size 0xa0, virtual false, abstract: false, final false
  inline bool AtomicStateUpdate(int32_t newBits, int32_t illegalBits, ByRef<int32_t> oldFlags);

  /// @brief Method CancellationCleanupLogic, addr 0xed4c34, size 0x120, virtual false, abstract: false, final false
  inline void CancellationCleanupLogic();

  /// @brief Method ConfigureAwait, addr 0xed25d0, size 0x34, virtual false, abstract: false, final false
  inline ::System::Runtime::CompilerServices::ConfiguredTaskAwaitable ConfigureAwait(bool continueOnCapturedContext);

  /// @brief Method ContinueWith, addr 0xed9740, size 0x74, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_1<::System::Threading::Tasks::Task*>* continuationAction);

  /// @brief Method ContinueWith, addr 0xed9990, size 0x14, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_1<::System::Threading::Tasks::Task*>* continuationAction, ::System::Threading::CancellationToken cancellationToken,
                                                        ::System::Threading::Tasks::TaskContinuationOptions continuationOptions, ::System::Threading::Tasks::TaskScheduler* scheduler);

  /// @brief Method ContinueWith, addr 0xed9918, size 0x78, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_1<::System::Threading::Tasks::Task*>* continuationAction,
                                                        ::System::Threading::Tasks::TaskContinuationOptions continuationOptions);

  /// @brief Method ContinueWith, addr 0xed97b4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ContinueWith, addr 0xed9e9c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ContinueWith, addr 0xed9ca4, size 0x88, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_2<::System::Threading::Tasks::Task*, ::System::Object*>* continuationAction, ::System::Object* state,
                                                        ::System::Threading::Tasks::TaskContinuationOptions continuationOptions);

  /// @brief Method ContinueWith, addr 0xed9d2c, size 0x170, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_2<::System::Threading::Tasks::Task*, ::System::Object*>* continuationAction, ::System::Object* state,
                                                        ::System::Threading::Tasks::TaskScheduler* scheduler, ::System::Threading::CancellationToken cancellationToken,
                                                        ::System::Threading::Tasks::TaskContinuationOptions continuationOptions);

  /// @brief Method ContinueWithCore, addr 0xed9b84, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method CreationOptionsFromContinuationOptions, addr 0xed99a4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Delay, addr 0xeda6f8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* Delay(int32_t millisecondsDelay);

  /// @brief Method Delay, addr 0xeda750, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0xed666c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0xed66d8, size 0xe0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DisregardChild, addr 0xed47e4, size 0x48, virtual false, abstract: false, final false
  inline void DisregardChild();

  /// @brief Method EnsureContingentPropertiesInitialized, addr 0xed456c, size 0x40, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::__Task__ContingentProperties* EnsureContingentPropertiesInitialized(bool needsProtection);

  /// @brief Method EnsureContingentPropertiesInitializedCore, addr 0xed6250, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0xed7f20, size 0xac, virtual false, abstract: false, final false
  inline void Execute();

  /// @brief Method ExecuteEntry, addr 0xed80dc, size 0x11c, virtual false, abstract: false, final false
  inline bool ExecuteEntry(bool bPreventDoubleExecution);

  /// @brief Method ExecuteWithThreadLocal, addr 0xed81f8, size 0x1a4, virtual false, abstract: false, final false
  inline void ExecuteWithThreadLocal(ByRef<::System::Threading::Tasks::Task*> currentTaskSlot);

  /// @brief Method ExecutionContextCallback, addr 0xed839c, size 0x78, virtual false, abstract: false, final false
  static inline void ExecutionContextCallback(::System::Object* obj);

  /// @brief Method Finish, addr 0xed4d5c, size 0x18c, virtual false, abstract: false, final false
  inline void Finish(bool bUserDelegateExecuted);

  /// @brief Method FinishContinuations, addr 0xed7838, size 0x6e8, virtual false, abstract: false, final false
  inline void FinishContinuations();

  /// @brief Method FinishStageThree, addr 0xed7630, size 0x50, virtual false, abstract: false, final false
  inline void FinishStageThree();

  /// @brief Method FinishStageTwo, addr 0xed6e4c, size 0x278, virtual false, abstract: false, final false
  inline void FinishStageTwo();

  /// @brief Method FromCanceled, addr 0xed3228, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method FromCancellation, addr 0xeda2f8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method FromException, addr 0xed2cb0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAwaiter, addr 0xed25c4, size 0x4, virtual false, abstract: false, final false
  inline ::System::Runtime::CompilerServices::TaskAwaiter GetAwaiter();

  /// @brief Method GetCancellationExceptionDispatchInfo, addr 0xed6cd0, size 0x30, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo();

  /// @brief Method GetExceptionDispatchInfos, addr 0xed6b38, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExceptions, addr 0xed6034, size 0x14c, virtual false, abstract: false, final false
  inline ::System::AggregateException* GetExceptions(bool includeTaskCanceledExceptions);

  /// @brief Method HandleException, addr 0xed7fcc, size 0x108, virtual false, abstract: false, final false
  inline void HandleException(::System::Exception* unhandledException);

  /// @brief Method InnerInvoke, addr 0xed8414, size 0xb4, virtual true, abstract: false, final false
  inline void InnerInvoke();

  /// @brief Method InternalCancel, addr 0xed4608, size 0x1dc, virtual false, abstract: false, final false
  inline bool InternalCancel(bool bCancelNonExecutingOnly);

  /// @brief Method InternalCurrentIfAttached, addr 0xed5e88, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalRunSynchronously, addr 0xed562c, size 0x2e8, virtual false, abstract: false, final false
  inline void InternalRunSynchronously(::System::Threading::Tasks::TaskScheduler* scheduler, bool waitForCompletion);

  /// @brief Method InternalStartNew, addr 0xed5d24, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalWait, addr 0xed8a4c, size 0x6ec, virtual false, abstract: false, final false
  inline bool InternalWait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method InternalWhenAll, addr 0xedad50, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsCompletedMethod, addr 0xed540c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsCompletedMethod(int32_t flags);

  /// @brief Method LogFinishCompletionNotification, addr 0xed96ec, size 0x54, virtual false, abstract: false, final false
  inline void LogFinishCompletionNotification();

  /// @brief Method MarkAborted, addr 0xedba8c, size 0x4, virtual true, abstract: false, final true
  inline void MarkAborted(::System::Threading::ThreadAbortException* e);

  /// @brief Method MarkStarted, addr 0xed516c, size 0xc, virtual false, abstract: false, final false
  inline bool MarkStarted();

  static inline ::System::Threading::Tasks::Task* New_ctor();

  static inline ::System::Threading::Tasks::Task* New_ctor(::System::Action* action);
  ...
  /// @brief Method NotifyDebuggerOfWaitCompletion, addr 0xed5074, size 0x28, virtual false, abstract: false, final false
  inline void NotifyDebuggerOfWaitCompletion();

  /// @brief Method NotifyDebuggerOfWaitCompletionIfNecessary, addr 0xed500c, size 0x50, virtual false, abstract: false, final false
  inline bool NotifyDebuggerOfWaitCompletionIfNecessary();

  /// @brief Method OptionsMethod, addr 0xed4ee8, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskCreationOptions OptionsMethod(int32_t flags);

  /// @brief Method ProcessChildCompletion, addr 0xed7680, size 0x1b8, virtual false, abstract: false, final false
  inline void ProcessChildCompletion(::System::Threading::Tasks::Task* childTask);

  /// @brief Method RecordInternalCancellationRequest, addr 0xed9494, size 0x48, virtual false, abstract: false, final false
  inline void RecordInternalCancellationRequest();

  /// @brief Method RecordInternalCancellationRequest, addr 0xed94dc, size 0x8c, virtual false, abstract: false, final false
  inline void RecordInternalCancellationRequest(::System::Threading::CancellationToken tokenToRecord);

  /// @brief Method RecordInternalCancellationRequest, addr 0xed4bf8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveContinuation, addr 0xed491c, size 0x254, virtual false, abstract: false, final false
  inline void RemoveContinuation(::System::Object* continuationObject);

  /// @brief Method RemoveFromActiveTasks, addr 0xedb948, size 0x144, virtual false, abstract: false, final false
  static inline void RemoveFromActiveTasks(int32_t taskId);

  /// @brief Method Run, addr 0xeda3c0, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* Run(::System::Action* action);

  /// @brief Method Run, addr 0xeda490, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* Run(::System::Func_1<::System::Threading::Tasks::Task*>* function);

  /// @brief Method Run, addr 0xeda4e8, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleAndStart, addr 0xed541c, size 0x210, virtual false, abstract: false, final false
  inline void ScheduleAndStart(bool needsProtection);

  /// @brief Method SetCancellationAcknowledged, addr 0xed84c8, size 0x2c, virtual false, abstract: false, final false
  inline void SetCancellationAcknowledged();

  /// @brief Method SetContinuationForAwait, addr 0xed84f4, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNotificationForWaitCompletion, addr 0xed4f90, size 0x7c, virtual false, abstract: false, final false
  inline void SetNotificationForWaitCompletion(bool enabled);

  /// @brief Method SpinThenBlockingWait, addr 0xed5b0c, size 0x19c, virtual false, abstract: false, final false
  inline bool SpinThenBlockingWait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method SpinWait, addr 0xed92a4, size 0xbc, virtual false, abstract: false, final false
  inline bool SpinWait(int32_t millisecondsTimeout);

  /// @brief Method Start, addr 0xed5178, size 0x5c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Start, addr 0xed5274, size 0x198, virtual false, abstract: false, final false
  inline void Start(::System::Threading::Tasks::TaskScheduler* scheduler);

  /// @brief Method System.IAsyncResult.get_AsyncWaitHandle, addr 0xed6348, size 0x88, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* System_IAsyncResult_get_AsyncWaitHandle();

  /// @brief Method System.IAsyncResult.get_CompletedSynchronously, addr 0xed64cc, size 0x8, virtual true, abstract: false, final true
  inline bool System_IAsyncResult_get_CompletedSynchronously();

  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0xed80d4, size 0x8, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method TaskCancelCallback, addr 0xed482c, size 0xf0, virtual false, abstract: false, final false
  static inline void TaskCancelCallback(::System::Object* o);

  /// @brief Method TaskConstructorCore, addr 0xed3f40, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowIfExceptional, addr 0xed6d00, size 0x48, virtual false, abstract: false, final false
  inline void ThrowIfExceptional(bool includeTaskCanceledExceptions);

  /// @brief Method TrySetCanceled, addr 0xed3650, size 0x8, virtual false, abstract: false, final false
  inline bool TrySetCanceled(::System::Threading::CancellationToken tokenToRecord);

  /// @brief Method TrySetCanceled, addr 0xed2c5c, size 0x54, virtual false, abstract: false, final false
  inline bool TrySetCanceled(::System::Threading::CancellationToken tokenToRecord, ::System::Object* cancellationException);

  /// @brief Method TrySetException, addr 0xed3658, size 0x70, virtual false, abstract: false, final false
  inline bool TrySetException(::System::Object* exceptionObject);

  /// @brief Method UpdateExceptionObservedStatus, addr 0xed6d48, size 0xd4, virtual false, abstract: false, final false
  inline void UpdateExceptionObservedStatus();

  /// @brief Method Wait, addr 0xed8a44, size 0x8, virtual false, abstract: false, final false
  inline bool Wait(int32_t millisecondsTimeout);

  /// @brief Method Wait, addr 0xed8928, size 0x11c, virtual false, abstract: false, final false
  inline bool Wait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Wait, addr 0xed891c, size 0xc, virtual false, abstract: false, final false
  inline void Wait();

  /// @brief Method WhenAll, addr 0xedab98, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method WhenAny, addr 0xedaf94, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method WhenAny, addr 0xedb368, size 0x47c, virtual false, abstract: false, final false
  ...
  /// @brief Method WrappedTryRunInline, addr 0xed9138, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed3df4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xed4098, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Action* action);

  /// @brief Method .ctor, addr 0xed4190, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method .ctor, addr 0xed40c8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed3d10, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed3e1c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AsyncState, addr 0xed64c4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_CancellationToken, addr 0xed20b0, size 0x24, virtual false, abstract: false, final false
  inline ::System::Threading::CancellationToken get_CancellationToken();

  /// @brief Method get_CapturedContext, addr 0xed65fc, size 0x70, virtual false, abstract: false, final false
  inline ::System::Threading::ExecutionContext* get_CapturedContext();

  /// @brief Method get_CompletedEvent, addr 0xed63d0, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Threading::ManualResetEventSlim* get_CompletedEvent();

  /// @brief Method get_CompletedTask, addr 0xed6534, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* get_CompletedTask();

  /// @brief Method get_CreationOptions, addr 0xed41c0, size 0x14, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::TaskCreationOptions get_CreationOptions();

  /// @brief Method get_CurrentStackGuard, addr 0xed5f24, size 0xb4, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::StackGuard* get_CurrentStackGuard();

  /// @brief Method get_Exception, addr 0xed5fe0, size 0x3c, virtual false, abstract: false, final false
  inline ::System::AggregateException* get_Exception();

  /// @brief Method get_ExceptionRecorded, addr 0xed658c, size 0x54, virtual false, abstract: false, final false
  inline bool get_ExceptionRecorded();

  /// @brief Method get_ExecutingTaskScheduler, addr 0xed64d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::TaskScheduler* get_ExecutingTaskScheduler();

  /// @brief Method get_Factory, addr 0xed64dc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskFactory* get_Factory();

  /// @brief Method get_Id, addr 0xed39cc, size 0x90, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_InternalCurrent, addr 0xed5e30, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* get_InternalCurrent();

  /// @brief Method get_IsCanceled, addr 0xed61e0, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsCanceled();

  /// @brief Method get_IsCancellationAcknowledged, addr 0xed6330, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsCancellationAcknowledged();

  /// @brief Method get_IsCancellationRequested, addr 0xed6200, size 0x50, virtual false, abstract: false, final false
  inline bool get_IsCancellationRequested();

  /// @brief Method get_IsCompleted, addr 0xed2340, size 0x64, virtual true, abstract: false, final true
  inline bool get_IsCompleted();

  /// @brief Method get_IsCompletedSuccessfully, addr 0xed3050, size 0x28, virtual false, abstract: false, final false
  inline bool get_IsCompletedSuccessfully();

  /// @brief Method get_IsDelegateInvoked, addr 0xed6e34, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsDelegateInvoked();

  /// @brief Method get_IsExceptionObservedByParent, addr 0xed6e1c, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsExceptionObservedByParent();

  /// @brief Method get_IsFaulted, addr 0xed601c, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsFaulted();

  /// @brief Method get_IsWaitNotificationEnabled, addr 0xed505c, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsWaitNotificationEnabled();

  /// @brief Method get_IsWaitNotificationEnabledOrNotRanToCompletion, addr 0xed512c, size 0x28, virtual false, abstract: false, final false
  inline bool get_IsWaitNotificationEnabledOrNotRanToCompletion();

  /// @brief Method get_Options, addr 0xed45ac, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::TaskCreationOptions get_Options();

  /// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion, addr 0xed5154, size 0x18, virtual true, abstract: false, final false
  inline bool get_ShouldNotifyDebuggerOfWaitCompletion();

  /// @brief Method get_Status, addr 0xed6180, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CapturedContext, addr 0xed44d4, size 0x98, virtual false, abstract: false, final false
