...
public:
  ...
  /// @brief Method Constant, addr 0x183dd8c, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Linq::Expressions::ConstantExpression* Constant(bool value);

  /// @brief Method Constant, addr 0x183ddf8, size 0x160, virtual false, abstract: false, final false
