...
public:
  ...
  /// @brief Method Equals, addr 0x1ae4da0, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x1ae4e04, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1ae4cfc, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ae49d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW address);

  /// @brief Method .ctor, addr 0x1ae49dc, size 0x254, virtual false, abstract: false, final false
  inline void _ctor(::StringW address, ::StringW displayName, ::System::Text::Encoding* displayNameEncoding);

  /// @brief Method .ctor, addr 0x1ae4950, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Address, addr 0x1ae4c38, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_Address();

  /// @brief Method get_DisplayName, addr 0x1ae4c30, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_SmtpAddress, addr 0x1ae4c84, size 0x78, virtual false, abstract: false, final false
