...
template <typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<T>*> const& UnityEngine::Rendering::ObservableList_1<T>::__cordl_internal_get_m_List() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_List;
}
...
template <typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*> const& UnityEngine::Rendering::ObservableList_1<T>::__cordl_internal_get_ItemAdded() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ItemAdded;
}
template <typename T> constexpr void UnityEngine::Rendering::ObservableList_1<T>::__cordl_internal_set_ItemAdded(::UnityEngine::Rendering::ListChangedEventHandler_1<T>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___ItemAdded)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
template <typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*> const& UnityEngine::Rendering::ObservableList_1<T>::__cordl_internal_get_ItemRemoved() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ItemRemoved;
}
template <typename T> constexpr void UnityEngine::Rendering::ObservableList_1<T>::__cordl_internal_set_ItemRemoved(::UnityEngine::Rendering::ListChangedEventHandler_1<T>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___ItemRemoved)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
