...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x1d0a3fc, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x1d0bf74, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Category, addr 0x1d09174, size 0x94, virtual false, abstract: false, final false
  inline uint8_t Category(int32_t cp);

  /// @brief Method ClearBuffer, addr 0x1d0a3e0, size 0x1c, virtual false, abstract: false, final false
  inline void ClearBuffer(::cordl_internals::Ptr<uint8_t> buffer, int32_t size);

  /// @brief Method Compare, addr 0x1d0aadc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareFlagPair, addr 0x1d0bf84, size 0x20, virtual false, abstract: false, final false
  inline int32_t CompareFlagPair(bool b1, bool b2);

  /// @brief Method CompareInternal, addr 0x1d0ab90, size 0x13e4, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSortKeyRaw, addr 0x1d0a418, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSurrogateSortKeyRaw, addr 0x1d0a990, size 0xb4, virtual false, abstract: false, final false
  inline void FillSurrogateSortKeyRaw(int32_t i, ::Mono::Globalization::Unicode::SortKeyBuffer* buf);

  /// @brief Method FilterExtender, addr 0x1d09ae0, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method FilterOptions, addr 0x1d098d0, size 0xec, virtual false, abstract: false, final false
  inline int32_t FilterOptions(int32_t i, ::System::Globalization::CompareOptions opt);

  /// @brief Method GetContraction, addr 0x1d0943c, size 0xc0, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW s, int32_t start, int32_t end);

  /// @brief Method GetContraction, addr 0x1d094fc, size 0x124, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW s, int32_t start, int32_t end,
                                                                     ::ArrayW<::Mono::Globalization::Unicode::Contraction*, ::Array<::Mono::Globalization::Unicode::Contraction*>*> clist);

  /// @brief Method GetExtenderType, addr 0x1d099bc, size 0x104, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::__SimpleCollator__ExtenderType GetExtenderType(int32_t i);

  /// @brief Method GetNeutralCulture, addr 0x1d09104, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* GetNeutralCulture(::System::Globalization::CultureInfo* info);

  /// @brief Method GetSortKey, addr 0x1d09dd8, size 0x20, virtual true, abstract: false, final true
  inline ::System::Globalization::SortKey* GetSortKey(::StringW s, ::System::Globalization::CompareOptions options);

  /// @brief Method GetSortKey, addr 0x1d09df8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSortKey, addr 0x1d0a040, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTailContraction, addr 0x1d09620, size 0xc0, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW s, int32_t start, int32_t end);

  /// @brief Method GetTailContraction, addr 0x1d096e0, size 0x1f0, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW s, int32_t start, int32_t end,
                                                                         ::ArrayW<::Mono::Globalization::Unicode::Contraction*, ::Array<::Mono::Globalization::Unicode::Contraction*>*> clist);

  /// @brief Method IndexOf, addr 0x1d0c484, size 0x1f4, virtual true, abstract: false, final true
  inline int32_t IndexOf(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method IndexOf, addr 0x1d0c678, size 0x49c, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfOrdinal, addr 0x1d0cb14, size 0xd8, virtual false, abstract: false, final false
  inline int32_t IndexOfOrdinal(::StringW s, ::StringW target, int32_t start, int32_t length);

  /// @brief Method IndexOfOrdinal, addr 0x1d0cbec, size 0x70, virtual false, abstract: false, final false
  inline int32_t IndexOfOrdinal(::StringW s, char16_t target, int32_t start, int32_t length);

  /// @brief Method IndexOfSortKey, addr 0x1d0cc5c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHalfKana, addr 0x1d093c8, size 0x74, virtual false, abstract: false, final false
  static inline bool IsHalfKana(int32_t cp, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsIgnorable, addr 0x1d09cf4, size 0x84, virtual false, abstract: false, final false
  static inline bool IsIgnorable(int32_t i, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsPrefix, addr 0x1d0bfc4, size 0xb0, virtual false, abstract: false, final false
  inline bool IsPrefix(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsPrefix, addr 0x1d0c074, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPrefix, addr 0x1d0bfa4, size 0x20, virtual true, abstract: false, final true
  inline bool IsPrefix(::StringW src, ::StringW target, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsSafe, addr 0x1d09d78, size 0x60, virtual false, abstract: false, final false
  inline bool IsSafe(int32_t i);

  /// @brief Method IsSuffix, addr 0x1d0c0fc, size 0x94, virtual false, abstract: false, final false
  inline bool IsSuffix(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsSuffix, addr 0x1d0c0dc, size 0x20, virtual true, abstract: false, final true
  inline bool IsSuffix(::StringW src, ::StringW target, ::System::Globalization::CompareOptions opt);

  /// @brief Method LastIndexOf, addr 0x1d0c190, size 0x18c, virtual true, abstract: false, final true
  inline int32_t LastIndexOf(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method LastIndexOf, addr 0x1d0ceb0, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOfOrdinal, addr 0x1d0d3d0, size 0x134, virtual false, abstract: false, final false
  inline int32_t LastIndexOfOrdinal(::StringW s, ::StringW target, int32_t start, int32_t length);

  /// @brief Method LastIndexOfSortKey, addr 0x1d0d504, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Level1, addr 0x1d09208, size 0x94, virtual false, abstract: false, final false
  inline uint8_t Level1(int32_t cp);

  /// @brief Method Level2, addr 0x1d0929c, size 0x12c, virtual false, abstract: false, final false
  inline uint8_t Level2(int32_t cp, ::Mono::Globalization::Unicode::__SimpleCollator__ExtenderType ext);

  /// @brief Method MatchesBackward, addr 0x1d0d5a8, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesBackwardCore, addr 0x1d0dcec, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesForward, addr 0x1d0ccf8, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesForwardCore, addr 0x1d0d76c, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesPrimitive, addr 0x1d0dac0, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method QuickIndexOf, addr 0x1d0c31c, size 0x168, virtual false, abstract: false, final false
  inline int32_t QuickIndexOf(::StringW s, ::StringW target, int32_t start, int32_t length, ByRef<bool> testWasUnable);

  /// @brief Method SetCJKTable, addr 0x1d09028, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Globalization.ISimpleCollator.Compare, addr 0x1d0aad8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method ToDashTypeValue, addr 0x1d09ac0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d08cfc, size 0x32c, virtual false, abstract: false, final false
