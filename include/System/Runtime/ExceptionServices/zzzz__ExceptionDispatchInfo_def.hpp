...
public:
  ...
  /// @brief Method Capture, addr 0x1b437a4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Throw, addr 0x1b43870, size 0x44, virtual false, abstract: false, final false
  inline void Throw();

  /// @brief Method Throw, addr 0x1b43d20, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b43be8, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* exception);

  /// @brief Method get_BinaryStackTraceArray, addr 0x1b43d10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_BinaryStackTraceArray();

  /// @brief Method get_SourceException, addr 0x1b43d18, size 0x8, virtual false, abstract: false, final false
