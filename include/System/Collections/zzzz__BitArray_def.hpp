...
public:
  ...
  /// @brief Method Clone, addr 0x21cfce0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x21cfce8, size 0x1ac, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::__BitArray__BitArrayEnumeratorSimple* New_ctor(::System::Collections::BitArray* bitarray);

  /// @brief Method Reset, addr 0x21cfff0, size 0x7c, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x21cfca0, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::BitArray* bitarray);

  /// @brief Method get_Current, addr 0x21cfe94, size 0x15c, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clone, addr 0x21cfbe0, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x21cf634, size 0x524, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method Get, addr 0x21cf204, size 0xe4, virtual false, abstract: false, final false
  inline bool Get(int32_t index);

  /// @brief Method GetArrayLength, addr 0x21cf0e8, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetArrayLength(int32_t n, int32_t div);

  /// @brief Method GetEnumerator, addr 0x21cfc40, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method Set, addr 0x21cf2f0, size 0xfc, virtual false, abstract: false, final false
  inline void Set(int32_t index, bool value);

  /// @brief Method SetAll, addr 0x21cf3ec, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21cf104, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::BitArray* bits);

  /// @brief Method .ctor, addr 0x21cef84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t length);

  /// @brief Method .ctor, addr 0x21cef8c, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(int32_t length, bool defaultValue);

  /// @brief Method get_Count, addr 0x21cfb58, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x21cfbd8, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x21cf200, size 0x4, virtual false, abstract: false, final false
  inline bool get_Item(int32_t index);

  /// @brief Method get_Length, addr 0x21cf45c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_SyncRoot, addr 0x21cfb60, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x21cf2e8, size 0x8, virtual false, abstract: false, final false
  inline void set_Item(int32_t index, bool value);

  /// @brief Method set_Length, addr 0x21cf464, size 0x1d0, virtual false, abstract: false, final false
