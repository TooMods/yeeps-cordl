...
public:
  ...
  /// @brief Method Compare, addr 0x2f04b9c, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x2f04cb4, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2f04bf0, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x2f04d4c, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x2f04c40, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method GetObjectData, addr 0x2f04d80, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f048ac, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CompareInfo* compareInfo, ::System::Globalization::CompareOptions options);

  /// @brief Method .ctor, addr 0x2f043d0, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CultureInfo* culture, ::System::Globalization::CompareOptions options);

  /// @brief Method .ctor, addr 0x2f04990, size 0x20c, virtual false, abstract: false, final false
