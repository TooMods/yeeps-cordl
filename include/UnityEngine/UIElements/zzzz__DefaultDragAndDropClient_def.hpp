...
public:
  ...
  /// @brief Method StartDrag, addr 0x27dd59c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27dd57c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x27db8d4, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IDragAndDropData* get_data();

  /// @brief Method get_userData, addr 0x27dd584, size 0x18, virtual true, abstract: false, final true
