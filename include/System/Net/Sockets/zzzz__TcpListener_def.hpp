...
public:
  ...
  /// @brief Method BeginAcceptTcpClient, addr 0x2c8ea90, size 0xb4, virtual false, abstract: false, final false
  inline ::System::IAsyncResult* BeginAcceptTcpClient(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method EndAcceptTcpClient, addr 0x2c8eb44, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x2c8e838, size 0x8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Start, addr 0x2c8e840, size 0x18c, virtual false, abstract: false, final false
  inline void Start(int32_t backlog);

  /// @brief Method Stop, addr 0x2c8e9cc, size 0xc4, virtual false, abstract: false, final false
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x2c8e668, size 0x1a0, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* localaddr, int32_t port);

  /// @brief Method get_LocalEndpoint, addr 0x2c8e808, size 0x30, virtual false, abstract: false, final false
