...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x26ebb48, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x26ebc08, size 0x28, virtual true, abstract: false, final false
  inline char16_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x26ebb34, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e2b70, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e24f4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e253c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e2584, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ebc34, size 0x10c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::__InputField___CaretBlink_d__172* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x26ebd40, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x26ebd48, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x26ebd88, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x26ebc30, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26e47a8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ebd94, size 0x2a8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::__InputField___MouseDragOutsideRect_d__194* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x26ec03c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x26ec044, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x26ec084, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x26ebd90, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x26e6e0c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method ActivateInputField, addr 0x26eb584, size 0x120, virtual false, abstract: false, final false
  inline void ActivateInputField();

  /// @brief Method ActivateInputFieldInternal, addr 0x26e5280, size 0x350, virtual false, abstract: false, final false
  inline void ActivateInputFieldInternal();

  /// @brief Method Append, addr 0x26e891c, size 0xbc, virtual true, abstract: false, final false
  inline void Append(::StringW input);

  /// @brief Method Append, addr 0x26e89d8, size 0x270, virtual true, abstract: false, final false
  inline void Append(char16_t input);

  /// @brief Method AssignPositioningIfNeeded, addr 0x26e55d0, size 0x500, virtual false, abstract: false, final false
  inline void AssignPositioningIfNeeded();

  /// @brief Method Awake, addr 0x26e4000, size 0xc0, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method Backspace, addr 0x26e7418, size 0x104, virtual false, abstract: false, final false
  inline void Backspace();

  /// @brief Method CalculateLayoutInputHorizontal, addr 0x26eb7a4, size 0x4, virtual true, abstract: false, final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x26eb7a8, size 0x4, virtual true, abstract: false, final false
  inline void CalculateLayoutInputVertical();

  /// @brief Method CaretBlink, addr 0x26e4740, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* CaretBlink();

  /// @brief Method ClampPos, addr 0x26e3d94, size 0x38, virtual false, abstract: false, final false
  inline void ClampPos(ByRef<int32_t> pos);

  /// @brief Method CreateCursorVerts, addr 0x26eb434, size 0x150, virtual false, abstract: false, final false
  inline void CreateCursorVerts();

  /// @brief Method DeactivateInputField, addr 0x26e4560, size 0x17c, virtual false, abstract: false, final false
  inline void DeactivateInputField();

  /// @brief Method Delete, addr 0x26e7668, size 0x1b4, virtual false, abstract: false, final false
  inline void Delete();

  /// @brief Method DetermineCharacterLine, addr 0x26e7e2c, size 0x110, virtual false, abstract: false, final false
  inline int32_t DetermineCharacterLine(int32_t charPos, ::UnityEngine::TextGenerator* generator);

  /// @brief Method DoStateTransition, addr 0x26eb778, size 0x2c, virtual true, abstract: false, final false
  inline void DoStateTransition(::UnityEngine::UI::__Selectable__SelectionState state, bool instant);

  /// @brief Method EnforceContentType, addr 0x26e3948, size 0xbc, virtual false, abstract: false, final false
  inline void EnforceContentType();

  /// @brief Method EnforceTextHOverflow, addr 0x26e25cc, size 0x94, virtual false, abstract: false, final false
  inline void EnforceTextHOverflow();

  /// @brief Method FindtNextWordBegin, addr 0x26e7cd0, size 0xbc, virtual false, abstract: false, final false
  inline int32_t FindtNextWordBegin();

  /// @brief Method FindtPrevWordBegin, addr 0x26e7d8c, size 0xa0, virtual false, abstract: false, final false
  inline int32_t FindtPrevWordBegin();

  /// @brief Method ForceLabelUpdate, addr 0x26e9920, size 0x4, virtual false, abstract: false, final false
  inline void ForceLabelUpdate();

  /// @brief Method ForwardSpace, addr 0x26e751c, size 0xa4, virtual false, abstract: false, final false
  inline void ForwardSpace();

  /// @brief Method GenerateCaret, addr 0x26ea004, size 0x9d4, virtual false, abstract: false, final false
  inline void GenerateCaret(::UnityEngine::UI::VertexHelper* vbo, ::UnityEngine::Vector2 roundingOffset);

  /// @brief Method GenerateHighlight, addr 0x26ea9d8, size 0xa5c, virtual false, abstract: false, final false
  inline void GenerateHighlight(::UnityEngine::UI::VertexHelper* vbo, ::UnityEngine::Vector2 roundingOffset);

  /// @brief Method GetCharacterIndexFromPosition, addr 0x26e66bc, size 0x294, virtual false, abstract: false, final false
  inline int32_t GetCharacterIndexFromPosition(::UnityEngine::Vector2 pos);

  /// @brief Method GetLineEndPosition, addr 0x26e6950, size 0x164, virtual false, abstract: false, final false
  static inline int32_t GetLineEndPosition(::UnityEngine::TextGenerator* gen, int32_t line);

  /// @brief Method GetLineStartPosition, addr 0x26e97d0, size 0x150, virtual false, abstract: false, final false
  static inline int32_t GetLineStartPosition(::UnityEngine::TextGenerator* gen, int32_t line);

  /// @brief Method GetSelectedString, addr 0x26e75c0, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW GetSelectedString();

  /// @brief Method GetUnclampedCharacterLineFromPosition, addr 0x26e64ac, size 0x210, virtual false, abstract: false, final false
  inline int32_t GetUnclampedCharacterLineFromPosition(::UnityEngine::Vector2 pos, ::UnityEngine::TextGenerator* generator);

  /// @brief Method GraphicUpdateComplete, addr 0x26e9d88, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method InPlaceEditing, addr 0x26e4abc, size 0x30, virtual false, abstract: false, final false
  inline bool InPlaceEditing();

  /// @brief Method InPlaceEditingChanged, addr 0x26e4aec, size 0x84, virtual false, abstract: false, final false
  inline bool InPlaceEditingChanged();

  /// @brief Method Insert, addr 0x26e87bc, size 0xe0, virtual false, abstract: false, final false
  inline void Insert(char16_t c);

  /// @brief Method IsSelectionVisible, addr 0x26e9764, size 0x6c, virtual false, abstract: false, final false
  inline bool IsSelectionVisible();

  /// @brief Method IsValidChar, addr 0x26e7ad4, size 0x70, virtual false, abstract: false, final false
  inline bool IsValidChar(char16_t c);

  /// @brief Method KeyPressed, addr 0x26e7040, size 0x3d8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__EditState KeyPressed(::UnityEngine::Event* evt);

  /// @brief Method LateUpdate, addr 0x26e4c58, size 0x628, virtual true, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LayoutComplete, addr 0x26e9d84, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  /// @brief Method LineDownCharacterPosition, addr 0x26e8294, size 0x2b4, virtual false, abstract: false, final false
  inline int32_t LineDownCharacterPosition(int32_t originalPos, bool goToLastChar);

  /// @brief Method LineUpCharacterPosition, addr 0x26e7f3c, size 0x358, virtual false, abstract: false, final false
  inline int32_t LineUpCharacterPosition(int32_t originalPos, bool goToFirstChar);

  /// @brief Method MarkGeometryAsDirty, addr 0x26e3240, size 0x58, virtual false, abstract: false, final false
  inline void MarkGeometryAsDirty();

  /// @brief Method MayDrag, addr 0x26e6ab4, size 0xd8, virtual false, abstract: false, final false
  inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method MouseDragOutsideRect, addr 0x26e6d98, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* MouseDragOutsideRect(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method MoveDown, addr 0x26e7ac8, size 0xc, virtual false, abstract: false, final false
  inline void MoveDown(bool shift);

  /// @brief Method MoveDown, addr 0x26e8548, size 0x134, virtual false, abstract: false, final false
  inline void MoveDown(bool shift, bool goToLastChar);

  /// @brief Method MoveLeft, addr 0x26e7864, size 0x12c, virtual false, abstract: false, final false
  inline void MoveLeft(bool shift, bool ctrl);

  /// @brief Method MoveRight, addr 0x26e7990, size 0x12c, virtual false, abstract: false, final false
  inline void MoveRight(bool shift, bool ctrl);

  /// @brief Method MoveTextEnd, addr 0x26e4950, size 0x60, virtual false, abstract: false, final false
  inline void MoveTextEnd(bool shift);

  /// @brief Method MoveTextStart, addr 0x26e49b0, size 0x7c, virtual false, abstract: false, final false
  inline void MoveTextStart(bool shift);

  /// @brief Method MoveUp, addr 0x26e7abc, size 0xc, virtual false, abstract: false, final false
  inline void MoveUp(bool shift);

  /// @brief Method MoveUp, addr 0x26e867c, size 0x140, virtual false, abstract: false, final false
  inline void MoveUp(bool shift, bool goToFirstChar);

  static inline ::UnityEngine::UI::InputField* New_ctor();

  /// @brief Method OnBeginDrag, addr 0x26e6b8c, size 0x20, virtual true, abstract: false, final false
  inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnDeselect, addr 0x26eb704, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselect(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnDestroy, addr 0x26e46dc, size 0x64, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x26e432c, size 0x234, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrag, addr 0x26e6bac, size 0x1ec, virtual true, abstract: false, final false
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEnable, addr 0x26e40c0, size 0x26c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEndDrag, addr 0x26e6e34, size 0x1c, virtual true, abstract: false, final false
  inline void OnEndDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnFillVBO, addr 0x26e9d8c, size 0x278, virtual false, abstract: false, final false
  inline void OnFillVBO(::UnityEngine::Mesh* vbo);

  /// @brief Method OnFocus, addr 0x26e4918, size 0x4, virtual false, abstract: false, final false
  inline void OnFocus();

  /// @brief Method OnPointerClick, addr 0x26eb6e0, size 0x24, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerDown, addr 0x26e6e50, size 0x1f0, virtual true, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSelect, addr 0x26eb6a4, size 0x3c, virtual true, abstract: false, final false
  inline void OnSelect(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnSubmit, addr 0x26eb730, size 0x48, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnUpdateSelected, addr 0x26e7b48, size 0x188, virtual true, abstract: false, final false
  inline void OnUpdateSelected(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method ProcessEvent, addr 0x26e7b44, size 0x4, virtual false, abstract: false, final false
  inline void ProcessEvent(::UnityEngine::Event* e);

  /// @brief Method Rebuild, addr 0x26e9924, size 0x10, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate update);

  /// @brief Method ScreenToLocal, addr 0x26e623c, size 0x270, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 ScreenToLocal(::UnityEngine::Vector2 screen);

  /// @brief Method SelectAll, addr 0x26e491c, size 0x34, virtual false, abstract: false, final false
  inline void SelectAll();

  /// @brief Method SendOnEndEdit, addr 0x26e889c, size 0x80, virtual false, abstract: false, final false
  inline void SendOnEndEdit();

  /// @brief Method SendOnSubmit, addr 0x26e5ad0, size 0x80, virtual false, abstract: false, final false
  inline void SendOnSubmit();

  /// @brief Method SendOnValueChanged, addr 0x26e2c48, size 0x80, virtual false, abstract: false, final false
  inline void SendOnValueChanged();

  /// @brief Method SendOnValueChangedAndUpdateLabel, addr 0x26e6224, size 0x18, virtual false, abstract: false, final false
  inline void SendOnValueChangedAndUpdateLabel();

  /// @brief Method SetCaretActive, addr 0x26e3170, size 0x54, virtual false, abstract: false, final false
  inline void SetCaretActive();

  /// @brief Method SetCaretVisible, addr 0x26e47d0, size 0x38, virtual false, abstract: false, final false
  inline void SetCaretVisible();

  /// @brief Method SetDrawRangeToContainCaretPosition, addr 0x26e8c48, size 0xb1c, virtual false, abstract: false, final false
  inline void SetDrawRangeToContainCaretPosition(int32_t caretPos);

  /// @brief Method SetText, addr 0x26e285c, size 0x30c, virtual false, abstract: false, final false
  inline void SetText(::StringW value, bool sendCallback);

  /// @brief Method SetTextWithoutNotify, addr 0x26e2b68, size 0x8, virtual false, abstract: false, final false
  inline void SetTextWithoutNotify(::StringW input);

  /// @brief Method SetToCustom, addr 0x26e3bb0, size 0x18, virtual false, abstract: false, final false
  inline void SetToCustom();

  /// @brief Method SetToCustomIfContentTypeIsNot, addr 0x26e3acc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method TouchScreenKeyboardShouldBeUsed, addr 0x26e4a3c, size 0x80, virtual false, abstract: false, final false
  inline bool TouchScreenKeyboardShouldBeUsed();

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x26ebb2c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform();

  /// @brief Method UpdateCaretFromKeyboard, addr 0x26e4b70, size 0xe8, virtual false, abstract: false, final false
  inline void UpdateCaretFromKeyboard();

  /// @brief Method UpdateCaretMaterial, addr 0x26e4808, size 0x110, virtual false, abstract: false, final false
  inline void UpdateCaretMaterial();

  /// @brief Method UpdateGeometry, addr 0x26e9934, size 0x450, virtual false, abstract: false, final false
  inline void UpdateGeometry();

  /// @brief Method UpdateLabel, addr 0x26e2cc8, size 0x41c, virtual false, abstract: false, final false
  inline void UpdateLabel();

  /// @brief Method UpdateTouchKeyboardFromEditChanges, addr 0x26e781c, size 0x48, virtual false, abstract: false, final false
  inline void UpdateTouchKeyboardFromEditChanges();

  /// @brief Method Validate, addr 0x26e5b50, size 0x6d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e235c, size 0x198, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_asteriskChar, addr 0x26e3d10, size 0x8, virtual false, abstract: false, final false
  inline char16_t get_asteriskChar();

  /// @brief Method get_cachedInputTextGenerator, addr 0x26e2708, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerator* get_cachedInputTextGenerator();

  /// @brief Method get_caretBlinkRate, addr 0x26e30ec, size 0x8, virtual false, abstract: false, final false
  inline float_t get_caretBlinkRate();

  /// @brief Method get_caretColor, addr 0x26e35a4, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_caretColor();

  /// @brief Method get_caretPosition, addr 0x26e3eb4, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_caretPosition();

  /// @brief Method get_caretPositionInternal, addr 0x26e3dcc, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_caretPositionInternal();

  /// @brief Method get_caretSelectPositionInternal, addr 0x26e3e28, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_caretSelectPositionInternal();

  /// @brief Method get_caretWidth, addr 0x26e31c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_caretWidth();

  /// @brief Method get_characterLimit, addr 0x26e3804, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_characterLimit();

  /// @brief Method get_characterValidation, addr 0x26e3c5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__CharacterValidation get_characterValidation();

  /// @brief Method get_clipboard, addr 0x26e4a2c, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW get_clipboard();

  /// @brief Method get_compositionString, addr 0x26e22c8, size 0x94, virtual false, abstract: false, final false
  inline ::StringW get_compositionString();

  /// @brief Method get_contentType, addr 0x26e38cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__ContentType get_contentType();

  /// @brief Method get_customCaretColor, addr 0x26e3614, size 0x8, virtual false, abstract: false, final false
  inline bool get_customCaretColor();

  /// @brief Method get_flexibleHeight, addr 0x26eba7c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleHeight();

  /// @brief Method get_flexibleWidth, addr 0x26eb910, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleWidth();

  /// @brief Method get_hasSelection, addr 0x26e3e84, size 0x30, virtual false, abstract: false, final false
  inline bool get_hasSelection();

  /// @brief Method get_input, addr 0x26e21b8, size 0x110, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_input();

  /// @brief Method get_inputType, addr 0x26e3b24, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__InputType get_inputType();

  /// @brief Method get_isFocused, addr 0x26e30e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isFocused();

  /// @brief Method get_keyboardType, addr 0x26e3bd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TouchScreenKeyboardType get_keyboardType();

  /// @brief Method get_layoutPriority, addr 0x26eba84, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_layoutPriority();

  /// @brief Method get_lineType, addr 0x26e3a04, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__LineType get_lineType();

  /// @brief Method get_mesh, addr 0x26e2660, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_mesh();

  /// @brief Method get_minHeight, addr 0x26eb918, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minHeight();

  /// @brief Method get_minWidth, addr 0x26eb7ac, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minWidth();

  /// @brief Method get_multiLine, addr 0x26e3cfc, size 0x14, virtual false, abstract: false, final false
  inline bool get_multiLine();

  /// @brief Method get_onEndEdit, addr 0x26e3678, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__EndEditEvent* get_onEndEdit();

  /// @brief Method get_onSubmit, addr 0x26e36d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__SubmitEvent* get_onSubmit();

  /// @brief Method get_onValidateInput, addr 0x26e37a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__OnValidateInput* get_onValidateInput();

  /// @brief Method get_onValueChange, addr 0x26e3738, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__OnChangeEvent* get_onValueChange();

  /// @brief Method get_onValueChanged, addr 0x26e379c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__InputField__OnChangeEvent* get_onValueChanged();

  /// @brief Method get_placeholder, addr 0x26e3544, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Graphic> get_placeholder();

  /// @brief Method get_preferredHeight, addr 0x26eb920, size 0x15c, virtual true, abstract: false, final false
  inline float_t get_preferredHeight();

  /// @brief Method get_preferredWidth, addr 0x26eb7b4, size 0x15c, virtual true, abstract: false, final false
  inline float_t get_preferredWidth();

  /// @brief Method get_readOnly, addr 0x26e3ce8, size 0x8, virtual false, abstract: false, final false
  inline bool get_readOnly();

  /// @brief Method get_selectionAnchorPosition, addr 0x26e3fb8, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_selectionAnchorPosition();

  /// @brief Method get_selectionColor, addr 0x26e3638, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_selectionColor();

  /// @brief Method get_selectionFocusPosition, addr 0x26e3fdc, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_selectionFocusPosition();

  /// @brief Method get_shouldActivateOnSelect, addr 0x26e2820, size 0x2c, virtual true, abstract: false, final false
  inline bool get_shouldActivateOnSelect();

  /// @brief Method get_shouldHideMobileInput, addr 0x26e27cc, size 0x48, virtual false, abstract: false, final false
  inline bool get_shouldHideMobileInput();

  /// @brief Method get_text, addr 0x26e284c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_textComponent, addr 0x26e3298, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Text> get_textComponent();

  /// @brief Method get_touchScreenKeyboard, addr 0x26e3bc8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TouchScreenKeyboard* get_touchScreenKeyboard();

  /// @brief Method get_wasCanceled, addr 0x26e3d8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_asteriskChar, addr 0x26e3d18, size 0x74, virtual false, abstract: false, final false
  inline void set_asteriskChar(char16_t value);

  /// @brief Method set_caretBlinkRate, addr 0x26e30f4, size 0x7c, virtual false, abstract: false, final false
  inline void set_caretBlinkRate(float_t value);

  /// @brief Method set_caretColor, addr 0x26e35e8, size 0x2c, virtual false, abstract: false, final false
  inline void set_caretColor(::UnityEngine::Color value);

  /// @brief Method set_caretPosition, addr 0x26e3ed8, size 0x28, virtual false, abstract: false, final false
  inline void set_caretPosition(int32_t value);

  /// @brief Method set_caretPositionInternal, addr 0x26e3df0, size 0x38, virtual false, abstract: false, final false
  inline void set_caretPositionInternal(int32_t value);

  /// @brief Method set_caretSelectPositionInternal, addr 0x26e3e4c, size 0x38, virtual false, abstract: false, final false
  inline void set_caretSelectPositionInternal(int32_t value);

  /// @brief Method set_caretWidth, addr 0x26e31cc, size 0x74, virtual false, abstract: false, final false
  inline void set_caretWidth(int32_t value);

  /// @brief Method set_characterLimit, addr 0x26e380c, size 0xc0, virtual false, abstract: false, final false
  inline void set_characterLimit(int32_t value);

  /// @brief Method set_characterValidation, addr 0x26e3c64, size 0x84, virtual false, abstract: false, final false
  inline void set_characterValidation(::UnityEngine::UI::__InputField__CharacterValidation value);

  /// @brief Method set_clipboard, addr 0x26e4a34, size 0x8, virtual false, abstract: false, final false
  static inline void set_clipboard(::StringW value);

  /// @brief Method set_contentType, addr 0x26e38d4, size 0x74, virtual false, abstract: false, final false
  inline void set_contentType(::UnityEngine::UI::__InputField__ContentType value);

  /// @brief Method set_customCaretColor, addr 0x26e361c, size 0x1c, virtual false, abstract: false, final false
  inline void set_customCaretColor(bool value);

  /// @brief Method set_inputType, addr 0x26e3b2c, size 0x84, virtual false, abstract: false, final false
  inline void set_inputType(::UnityEngine::UI::__InputField__InputType value);

  /// @brief Method set_keyboardType, addr 0x26e3bd8, size 0x84, virtual false, abstract: false, final false
  inline void set_keyboardType(::UnityEngine::TouchScreenKeyboardType value);

  /// @brief Method set_lineType, addr 0x26e3a0c, size 0xc0, virtual false, abstract: false, final false
  inline void set_lineType(::UnityEngine::UI::__InputField__LineType value);

  /// @brief Method set_onEndEdit, addr 0x26e3680, size 0x58, virtual false, abstract: false, final false
  inline void set_onEndEdit(::UnityEngine::UI::__InputField__EndEditEvent* value);

  /// @brief Method set_onSubmit, addr 0x26e36e0, size 0x58, virtual false, abstract: false, final false
  inline void set_onSubmit(::UnityEngine::UI::__InputField__SubmitEvent* value);

  /// @brief Method set_onValidateInput, addr 0x26e37ac, size 0x58, virtual false, abstract: false, final false
  inline void set_onValidateInput(::UnityEngine::UI::__InputField__OnValidateInput* value);

  /// @brief Method set_onValueChange, addr 0x26e3740, size 0x4, virtual false, abstract: false, final false
  inline void set_onValueChange(::UnityEngine::UI::__InputField__OnChangeEvent* value);

  /// @brief Method set_onValueChanged, addr 0x26e3744, size 0x58, virtual false, abstract: false, final false
  inline void set_onValueChanged(::UnityEngine::UI::__InputField__OnChangeEvent* value);

  /// @brief Method set_placeholder, addr 0x26e354c, size 0x58, virtual false, abstract: false, final false
  inline void set_placeholder(::UnityEngine::UI::Graphic* value);

  /// @brief Method set_readOnly, addr 0x26e3cf0, size 0xc, virtual false, abstract: false, final false
  inline void set_readOnly(bool value);

  /// @brief Method set_selectionAnchorPosition, addr 0x26e3f00, size 0x5c, virtual false, abstract: false, final false
  inline void set_selectionAnchorPosition(int32_t value);

  /// @brief Method set_selectionColor, addr 0x26e364c, size 0x2c, virtual false, abstract: false, final false
  inline void set_selectionColor(::UnityEngine::Color value);

  /// @brief Method set_selectionFocusPosition, addr 0x26e3f5c, size 0x5c, virtual false, abstract: false, final false
  inline void set_selectionFocusPosition(int32_t value);

  /// @brief Method set_shouldActivateOnSelect, addr 0x26e2814, size 0xc, virtual true, abstract: false, final false
  inline void set_shouldActivateOnSelect(bool value);

  /// @brief Method set_shouldHideMobileInput, addr 0x26e2774, size 0x58, virtual false, abstract: false, final false
  inline void set_shouldHideMobileInput(bool value);

  /// @brief Method set_text, addr 0x26e2854, size 0x8, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_textComponent, addr 0x26e32a0, size 0x2a4, virtual false, abstract: false, final false
