...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::XR::Interaction::Toolkit::Filtering::XRTargetEvaluatorEnabledAttribute::*)()>(
    &::UnityEngine::XR::Interaction::Toolkit::Filtering::XRTargetEvaluatorEnabledAttribute::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2fee708;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::XR::Interaction::Toolkit::Filtering::XRTargetEvaluatorEnabledAttribute*>::get(),
...
inline ::UnityEngine::XR::Interaction::Toolkit::Filtering::XRTargetEvaluatorEnabledAttribute* UnityEngine::XR::Interaction::Toolkit::Filtering::XRTargetEvaluatorEnabledAttribute::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::XR::Interaction::Toolkit::Filtering::XRTargetEvaluatorEnabledAttribute*>());
}
