...
public:
  ...
  /// @brief Method .ctor, addr 0x1e0b72c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <set_onUpdate>b__0, addr 0x1e0be90, size 0x1e8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1e0b84c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <set_onBeforeUpdate>b__0, addr 0x1e0c078, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1e0b96c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <set_onShouldRunUpdate>b__0, addr 0x1e0c09c, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AllocateDeviceId, addr 0x1e0b434, size 0x50, virtual true, abstract: false, final true
  inline int32_t AllocateDeviceId();

  /// @brief Method DeviceCommand, addr 0x1e0b548, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method OnFocusChanged, addr 0x1e0bdac, size 0x28, virtual false, abstract: false, final false
  inline void OnFocusChanged(bool focus);

  /// @brief Method OnShutdown, addr 0x1e0bd48, size 0x24, virtual false, abstract: false, final false
  inline void OnShutdown();

  /// @brief Method OnWantsToShutdown, addr 0x1e0bd6c, size 0x40, virtual false, abstract: false, final false
  inline bool OnWantsToShutdown();

  /// @brief Method QueueEvent, addr 0x1e0b4dc, size 0x6c, virtual true, abstract: false, final true
  inline void QueueEvent(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> ptr);

  /// @brief Method RegisterAnalyticsEvent, addr 0x1e0be0c, size 0x4, virtual false, abstract: false, final false
  inline void RegisterAnalyticsEvent(::StringW name, int32_t maxPerHour, int32_t maxPropertiesPerEvent);

  /// @brief Method SendAnalyticsEvent, addr 0x1e0be10, size 0x4, virtual false, abstract: false, final false
  inline void SendAnalyticsEvent(::StringW name, ::System::Object* data);

  /// @brief Method Update, addr 0x1e0b484, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1e0be14, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::LowLevel::NativeInputRuntime* getStaticF_instance();

  /// @brief Method get_currentTime, addr 0x1e0bc44, size 0x50, virtual true, abstract: false, final true
  inline double_t get_currentTime();

  /// @brief Method get_currentTimeForFixedUpdate, addr 0x1e0bc94, size 0x2c, virtual true, abstract: false, final true
  inline double_t get_currentTimeForFixedUpdate();

  /// @brief Method get_currentTimeOffsetToRealtimeSinceStartup, addr 0x1e0bcc0, size 0x50, virtual true, abstract: false, final true
  inline double_t get_currentTimeOffsetToRealtimeSinceStartup();

  /// @brief Method get_isInBatchMode, addr 0x1e0be04, size 0x8, virtual true, abstract: false, final true
  inline bool get_isInBatchMode();

  /// @brief Method get_isPlayerFocused, addr 0x1e0bbcc, size 0x8, virtual true, abstract: false, final true
  inline bool get_isPlayerFocused();

  /// @brief Method get_onBeforeUpdate, addr 0x1e0b734, size 0x8, virtual true, abstract: false, final true
  inline ::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* get_onBeforeUpdate();

  /// @brief Method get_onDeviceDiscovered, addr 0x1e0b974, size 0x50, virtual true, abstract: false, final true
  inline ::System::Action_2<int32_t, ::StringW>* get_onDeviceDiscovered();

  /// @brief Method get_onPlayerFocusChanged, addr 0x1e0baf4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Action_1<bool>* get_onPlayerFocusChanged();

  /// @brief Method get_onShouldRunUpdate, addr 0x1e0b854, size 0x8, virtual true, abstract: false, final true
  inline ::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType, bool>* get_onShouldRunUpdate();

  /// @brief Method get_onShutdown, addr 0x1e0ba1c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Action* get_onShutdown();

  /// @brief Method get_onUpdate, addr 0x1e0b614, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* get_onUpdate();

  /// @brief Method get_pollingFrequency, addr 0x1e0bbd4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_pollingFrequency();

  /// @brief Method get_runInBackground, addr 0x1e0bd18, size 0x30, virtual true, abstract: false, final true
  inline bool get_runInBackground();

  /// @brief Method get_screenOrientation, addr 0x1e0bdfc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::ScreenOrientation get_screenOrientation();

  /// @brief Method get_screenSize, addr 0x1e0bdd4, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 get_screenSize();

  /// @brief Method get_unscaledGameTime, addr 0x1e0bd10, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_onBeforeUpdate, addr 0x1e0b73c, size 0x110, virtual true, abstract: false, final true
  inline void set_onBeforeUpdate(::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* value);

  /// @brief Method set_onDeviceDiscovered, addr 0x1e0b9c4, size 0x58, virtual true, abstract: false, final true
  inline void set_onDeviceDiscovered(::System::Action_2<int32_t, ::StringW>* value);

  /// @brief Method set_onPlayerFocusChanged, addr 0x1e0bafc, size 0xd0, virtual true, abstract: false, final true
  inline void set_onPlayerFocusChanged(::System::Action_1<bool>* value);

  /// @brief Method set_onShouldRunUpdate, addr 0x1e0b85c, size 0x110, virtual true, abstract: false, final true
  inline void set_onShouldRunUpdate(::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType, bool>* value);

  /// @brief Method set_onShutdown, addr 0x1e0ba24, size 0xd0, virtual true, abstract: false, final true
  inline void set_onShutdown(::System::Action* value);

  /// @brief Method set_onUpdate, addr 0x1e0b61c, size 0x110, virtual true, abstract: false, final true
  inline void set_onUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* value);

  /// @brief Method set_pollingFrequency, addr 0x1e0bbdc, size 0x68, virtual true, abstract: false, final true
