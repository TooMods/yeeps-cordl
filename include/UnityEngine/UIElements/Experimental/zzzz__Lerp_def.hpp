...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x1f325dc, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color Interpolate(::UnityEngine::Color start, ::UnityEngine::Color end, float_t ratio);

  /// @brief Method Interpolate, addr 0x1f32614, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method Interpolate, addr 0x1f325cc, size 0x10, virtual false, abstract: false, final false
