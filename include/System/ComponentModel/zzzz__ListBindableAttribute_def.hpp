...
public:
  ...
  /// @brief Method Equals, addr 0x1afbd14, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1afbdac, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x1afbdb4, size 0x84, virtual true, abstract: false, final false
  inline bool IsDefaultAttribute();

  static inline ::System::ComponentModel::ListBindableAttribute* New_ctor(::System::ComponentModel::BindableSupport flags);
  ...
  /// @brief Method .ctor, addr 0x1afbcd0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::BindableSupport flags);

  /// @brief Method .ctor, addr 0x1afbca8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ListBindable, addr 0x1afbd0c, size 0x8, virtual false, abstract: false, final false
