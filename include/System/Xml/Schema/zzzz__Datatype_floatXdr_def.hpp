...
public:
  ...
  /// @brief Method ParseValue, addr 0x2fbd210, size 0x284, virtual true, abstract: false, final false
  inline ::System::Object* ParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr);

  /// @brief Method .ctor, addr 0x2fb1fa8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
