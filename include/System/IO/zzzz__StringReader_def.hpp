...
public:
  ...
  /// @brief Method Close, addr 0x1fc2e4c, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x1fc2e5c, size 0x10, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::System::IO::StringReader* New_ctor(::StringW s);

  /// @brief Method Peek, addr 0x1fc2e6c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x1fc2ea8, size 0x44, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x1fc2eec, size 0x1bc, virtual true, abstract: false, final false
  inline int32_t Read(ByRef<::ArrayW<char16_t, ::Array<char16_t>*>> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x1fc3280, size 0x1f0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x1fc30e4, size 0x114, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x1fc30a8, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW ReadToEnd();

  /// @brief Method ReadToEndAsync, addr 0x1fc31f8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc2d80, size 0xcc, virtual false, abstract: false, final false
