...
public:
  ...
  /// @brief Method Equals, addr 0x135133c, size 0x98, virtual true, abstract: false, final true
  inline bool Equals(::Newtonsoft::Json::Linq::JToken* x, ::Newtonsoft::Json::Linq::JToken* y);

  /// @brief Method GetHashCode, addr 0x13513d4, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x13468a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
