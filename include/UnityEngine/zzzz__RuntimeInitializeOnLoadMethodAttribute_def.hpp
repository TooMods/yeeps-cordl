...
public:
  ...
  /// @brief Method .ctor, addr 0x283b4c4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x283b4e8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::RuntimeInitializeLoadType loadType);

  /// @brief Method set_loadType, addr 0x283b4e0, size 0x8, virtual false, abstract: false, final false
