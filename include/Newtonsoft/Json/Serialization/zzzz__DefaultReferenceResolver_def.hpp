...
public:
  ...
  /// @brief Method AddReference, addr 0xf0b850, size 0x6c, virtual true, abstract: false, final true
  inline void AddReference(::System::Object* context, ::StringW reference, ::System::Object* value);

  /// @brief Method GetMappings, addr 0xf0b4c8, size 0x110, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::StringW, ::System::Object*>* GetMappings(::System::Object* context);

  /// @brief Method GetReference, addr 0xf0b75c, size 0xf4, virtual true, abstract: false, final true
  inline ::StringW GetReference(::System::Object* context, ::System::Object* value);

  /// @brief Method IsReferenced, addr 0xf0b8bc, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method ResolveReference, addr 0xf0b6e8, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf0b930, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
