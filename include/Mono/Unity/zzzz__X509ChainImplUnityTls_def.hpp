...
public:
  ...
  /// @brief Method AddStatus, addr 0x2426654, size 0x10c, virtual true, abstract: false, final false
  inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error);

  /// @brief Method Build, addr 0x2426768, size 0x8, virtual true, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Dispose, addr 0x24267b0, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2426770, size 0x40, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2424d0c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Unity::__UnityTls__unitytls_x509list_ref nativeCertificateChain, bool reverseOrder);

  /// @brief Method get_ChainElements, addr 0x2426378, size 0x2dc, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x2426760, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_IsValid, addr 0x2426348, size 0x28, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_NativeCertificateChain, addr 0x2426370, size 0x8, virtual false, abstract: false, final false
