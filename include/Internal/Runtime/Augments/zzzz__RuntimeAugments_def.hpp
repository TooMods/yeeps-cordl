...
public:
  ...
  /// @brief Method ReportUnhandledException, addr 0x28a7de4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callbacks, addr 0x28a7e04, size 0x58, virtual false, abstract: false, final false
