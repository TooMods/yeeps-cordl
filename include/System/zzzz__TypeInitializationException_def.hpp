...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2f0a294, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f0a100, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f0a158, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW fullTypeName, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x2f0a1d8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW fullTypeName, ::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x2f0a210, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_TypeName, addr 0x2f0a39c, size 0x54, virtual false, abstract: false, final false
