...
public:
  ...
  /// @brief Method Equals, addr 0x161f264, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x161f318, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::AuthenticationHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x161f25c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x161f9c8, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x161f5c0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x161f394, size 0xd0, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Net::Http::Headers::AuthenticationHeaderValue*> parsedValue);

  /// @brief Method TryParseElement, addr 0x161f48c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x161f234, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameter, addr 0x161f23c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Parameter();

  /// @brief Method get_Scheme, addr 0x161f24c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Scheme();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Parameter, addr 0x161f244, size 0x8, virtual false, abstract: false, final false
  inline void set_Parameter(::StringW value);

  /// @brief Method set_Scheme, addr 0x161f254, size 0x8, virtual false, abstract: false, final false
