...
public:
  ...
  /// @brief Method AddListener, addr 0x29e40b8, size 0x2c, virtual false, abstract: false, final false
  inline void AddListener(::UnityEngine::Events::UnityAction* call);

  /// @brief Method FindMethod_Impl, addr 0x29e4194, size 0x64, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* FindMethod_Impl(::StringW name, ::System::Type* targetObjType);

  /// @brief Method GetDelegate, addr 0x29e40e4, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Events::BaseInvokableCall* GetDelegate(::UnityEngine::Events::UnityAction* action);

  /// @brief Method GetDelegate, addr 0x29e41f8, size 0x70, virtual true, abstract: false, final false
  inline ::UnityEngine::Events::BaseInvokableCall* GetDelegate(::System::Object* target, ::System::Reflection::MethodInfo* theFunction);

  /// @brief Method Invoke, addr 0x29e4268, size 0x180, virtual false, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Events::UnityEvent* New_ctor();

  /// @brief Method RemoveListener, addr 0x29e4150, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29e40b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
