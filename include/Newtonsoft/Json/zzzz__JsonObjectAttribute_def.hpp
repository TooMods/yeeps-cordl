...
public:
  ...
  /// @brief Method .ctor, addr 0x25c8f44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c8f74, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW id);

  /// @brief Method .ctor, addr 0x25c8f4c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::MemberSerialization memberSerialization);

  /// @brief Method get_ItemNullValueHandling, addr 0x25c8dfc, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::NullValueHandling get_ItemNullValueHandling();

  /// @brief Method get_ItemRequired, addr 0x25c8ea0, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Required get_ItemRequired();

  /// @brief Method get_MemberSerialization, addr 0x25c8d48, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::MemberSerialization get_MemberSerialization();

  /// @brief Method get_MissingMemberHandling, addr 0x25c8d58, size 0x3c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::MissingMemberHandling get_MissingMemberHandling();

  /// @brief Method set_ItemNullValueHandling, addr 0x25c8e38, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemNullValueHandling(::Newtonsoft::Json::NullValueHandling value);

  /// @brief Method set_ItemRequired, addr 0x25c8edc, size 0x68, virtual false, abstract: false, final false
  inline void set_ItemRequired(::Newtonsoft::Json::Required value);

  /// @brief Method set_MemberSerialization, addr 0x25c8d50, size 0x8, virtual false, abstract: false, final false
  inline void set_MemberSerialization(::Newtonsoft::Json::MemberSerialization value);

  /// @brief Method set_MissingMemberHandling, addr 0x25c8d94, size 0x68, virtual false, abstract: false, final false
