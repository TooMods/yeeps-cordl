...
public:
  ...
  /// @brief Method GetHashCode, addr 0x1ab0398, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ab0160, size 0x3c, virtual false, abstract: false, final false
