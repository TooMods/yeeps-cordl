...
public:
  ...
  /// @brief Method Dispose, addr 0x161dde8, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1615cc4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1615988, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
