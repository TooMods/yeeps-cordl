...
public:
  ...
  /// @brief Method TryGetValueFromBagAsString, addr 0x27dec24, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27deb74, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x27deb98, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x27deba0, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_obsoleteNames, addr 0x27deba8, size 0x5c, virtual false, abstract: false, final false
  inline void set_obsoleteNames(::System::Collections::Generic::IEnumerable_1<::StringW>* value);

  /// @brief Method set_restriction, addr 0x27dec1c, size 0x8, virtual false, abstract: false, final false
  inline void set_restriction(::UnityEngine::UIElements::UxmlTypeRestriction* value);

  /// @brief Method set_type, addr 0x27dec04, size 0x8, virtual false, abstract: false, final false
  inline void set_type(::StringW value);

  /// @brief Method set_typeNamespace, addr 0x27dec0c, size 0x8, virtual false, abstract: false, final false
  inline void set_typeNamespace(::StringW value);

  /// @brief Method set_use, addr 0x27dec14, size 0x8, virtual false, abstract: false, final false
