...
public:
  ...
  /// @brief Method InitEvent, addr 0x14d3918, size 0x8, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType);

  /// @brief Method InitEvent, addr 0x14d390c, size 0xc, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::System::Object* o);

  /// @brief Method InitEvent, addr 0x14d38d4, size 0xc, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1);

  /// @brief Method InitEvent, addr 0x14d38e0, size 0xc, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2);

  /// @brief Method InitEvent, addr 0x14d38ec, size 0x10, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3);

  /// @brief Method InitEvent, addr 0x14d38fc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EventType, addr 0x14d3920, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::__XmlEventCache__XmlEventType get_EventType();

  /// @brief Method get_Object, addr 0x14d3940, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Object();

  /// @brief Method get_String1, addr 0x14d3928, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_String1();

  /// @brief Method get_String2, addr 0x14d3930, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_String2();

  /// @brief Method get_String3, addr 0x14d3938, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddEvent, addr 0x14d3008, size 0x48, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType);

  /// @brief Method AddEvent, addr 0x14d3354, size 0x50, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::System::Object* o);

  /// @brief Method AddEvent, addr 0x14d3178, size 0x50, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1);

  /// @brief Method AddEvent, addr 0x14d31e4, size 0x5c, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2);

  /// @brief Method AddEvent, addr 0x14d30ec, size 0x64, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3);

  /// @brief Method AddEvent, addr 0x14d3068, size 0x70, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3, ::System::Object* o);

  /// @brief Method Close, addr 0x14d353c, size 0x8, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x14d355c, size 0xb0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndEvents, addr 0x14cf0dc, size 0x14, virtual false, abstract: false, final false
  inline void EndEvents();

  /// @brief Method EventsToWriter, addr 0x14cf0f0, size 0x6f4, virtual false, abstract: false, final false
  inline void EventsToWriter(::System::Xml::XmlWriter* writer);

  /// @brief Method Flush, addr 0x14d3544, size 0x8, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method NewEvent, addr 0x14d36cc, size 0x208, virtual false, abstract: false, final false
  inline int32_t NewEvent();

  static inline ::System::Xml::XmlEventCache* New_ctor(::StringW baseUri, bool hasRootNode);

  /// @brief Method StartElementContent, addr 0x14d3684, size 0x8, virtual true, abstract: false, final false
  inline void StartElementContent();

  /// @brief Method ToBytes, addr 0x14d345c, size 0xb4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBase64, addr 0x14d3430, size 0x2c, virtual true, abstract: false, final false
  inline void WriteBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBinHex, addr 0x14d3510, size 0x2c, virtual true, abstract: false, final false
  inline void WriteBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteCData, addr 0x14d316c, size 0xc, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x14d32e8, size 0x6c, virtual true, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteChars, addr 0x14d3270, size 0x30, virtual true, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteComment, addr 0x14d31c8, size 0xc, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteDocType, addr 0x14d3050, size 0x18, virtual true, abstract: false, final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteEndAttribute, addr 0x14d3164, size 0x8, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndBase64, addr 0x14d36c4, size 0x8, virtual true, abstract: false, final false
  inline void WriteEndBase64();

  /// @brief Method WriteEndElement, addr 0x14d368c, size 0x14, virtual true, abstract: false, final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteEntityRef, addr 0x14d32dc, size 0xc, virtual true, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteFullEndElement, addr 0x14d36a0, size 0x14, virtual true, abstract: false, final false
  inline void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteNamespaceDeclaration, addr 0x14d36b4, size 0x10, virtual true, abstract: false, final false
  inline void WriteNamespaceDeclaration(::StringW prefix, ::StringW ns);

  /// @brief Method WriteProcessingInstruction, addr 0x14d31d4, size 0x10, virtual true, abstract: false, final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteRaw, addr 0x14d32a0, size 0x30, virtual true, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw, addr 0x14d32d0, size 0xc, virtual true, abstract: false, final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteStartAttribute, addr 0x14d3150, size 0x14, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartElement, addr 0x14d30d8, size 0x14, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteString, addr 0x14d324c, size 0x24, virtual true, abstract: false, final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity, addr 0x14d33a4, size 0x8c, virtual true, abstract: false, final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteValue, addr 0x14d354c, size 0x10, virtual true, abstract: false, final false
  inline void WriteValue(::StringW value);

  /// @brief Method WriteWhitespace, addr 0x14d3240, size 0xc, virtual true, abstract: false, final false
  inline void WriteWhitespace(::StringW ws);

  /// @brief Method WriteXmlDeclaration, addr 0x14d360c, size 0x6c, virtual true, abstract: false, final false
  inline void WriteXmlDeclaration(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteXmlDeclaration, addr 0x14d3678, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ce5cc, size 0x30, virtual false, abstract: false, final false
