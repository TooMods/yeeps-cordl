...
public:
  ...
  /// @brief Method <GetChildPrivateFields>b__41_0, addr 0xefe5e4, size 0x18, virtual false, abstract: false, final false
  inline bool _GetChildPrivateFields_b__41_0(::System::Reflection::FieldInfo* f);

  /// @brief Method <GetDefaultConstructor>b__11_0, addr 0xefe538, size 0x6c, virtual false, abstract: false, final false
  inline bool _GetDefaultConstructor_b__11_0(::System::Reflection::ConstructorInfo* c);

  /// @brief Method <GetFieldsAndProperties>b__31_0, addr 0xefe5a4, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _GetFieldsAndProperties_b__31_0(::System::Reflection::MemberInfo* m);

  /// @brief Method <GetMemberInfoFromType>b__39_0, addr 0xefe5c4, size 0x20, virtual false, abstract: false, final false
  inline ::System::Type* _GetMemberInfoFromType_b__39_0(::System::Reflection::ParameterInfo* p);

  /// @brief Method .ctor, addr 0xefe530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetFieldsAndProperties>b__1, addr 0xefe604, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefe5fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetChildPrivateProperties>b__0, addr 0xefe6a8, size 0x54, virtual false, abstract: false, final false
  inline bool _GetChildPrivateProperties_b__0(::System::Reflection::PropertyInfo* p);

  /// @brief Method <GetChildPrivateProperties>b__1, addr 0xefe6fc, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefe6a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetChildPrivateProperties>b__2, addr 0xefe7f0, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefe7e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <IsMethodOverridden>b__0, addr 0xefe90c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefe904, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanReadMemberValue, addr 0x1539bd4, size 0x154, virtual false, abstract: false, final false
  static inline bool CanReadMemberValue(::System::Reflection::MemberInfo* member, bool nonPublic);

  /// @brief Method CanSetMemberValue, addr 0x1539d28, size 0x188, virtual false, abstract: false, final false
  static inline bool CanSetMemberValue(::System::Reflection::MemberInfo* member, bool nonPublic, bool canSetReadOnly);

  /// @brief Method EnsureNotByRefType, addr 0x153aaf8, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Type* EnsureNotByRefType(::System::Type* t);

  /// @brief Method EnsureNotNullableType, addr 0x153aa84, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Type* EnsureNotNullableType(::System::Type* t);

  /// @brief Method GetAssemblyDelimiterIndex, addr 0x153d354, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributes, addr 0x153b674, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBaseDefinition, addr 0x153a470, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* GetBaseDefinition(::System::Reflection::PropertyInfo* propertyInfo);

  /// @brief Method GetChildPrivateFields, addr 0x153d694, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildPrivateProperties, addr 0x153d888, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCollectionItemType, addr 0x153b11c, size 0x228, virtual false, abstract: false, final false
  static inline ::System::Type* GetCollectionItemType(::System::Type* type);

  /// @brief Method GetDefaultConstructor, addr 0x153aa2c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type* t);

  /// @brief Method GetDefaultConstructor, addr 0x153a8fc, size 0x130, virtual false, abstract: false, final false
  static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type* t, bool nonPublic);

  /// @brief Method GetDefaultValue, addr 0x153dee8, size 0x238, virtual false, abstract: false, final false
  static inline ::System::Object* GetDefaultValue(::System::Type* type);

  /// @brief Method GetDictionaryKeyValueTypes, addr 0x153b344, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFields, addr 0x153cc68, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldsAndProperties, addr 0x153c1d0, size 0xa98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFullyQualifiedTypeName, addr 0x153a6a8, size 0x130, virtual false, abstract: false, final false
  static inline ::StringW GetFullyQualifiedTypeName(::System::Type* t, ::Newtonsoft::Json::Serialization::ISerializationBinder* binder);

  /// @brief Method GetMemberInfoFromType, addr 0x153d42c, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMemberUnderlyingType, addr 0x1539ec0, size 0x2d0, virtual false, abstract: false, final false
  static inline ::System::Type* GetMemberUnderlyingType(::System::Reflection::MemberInfo* member);

  /// @brief Method GetMemberValue, addr 0x153bc04, size 0x384, virtual false, abstract: false, final false
  static inline ::System::Object* GetMemberValue(::System::Reflection::MemberInfo* member, ::System::Object* target);

  /// @brief Method GetObjectType, addr 0x152a7bc, size 0x10, virtual false, abstract: false, final false
  static inline ::System::Type* GetObjectType(::System::Object* v);

  /// @brief Method GetProperties, addr 0x153cd88, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeName, addr 0x153a5c8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method HasDefaultConstructor, addr 0x1539ae4, size 0xe8, virtual false, abstract: false, final false
  static inline bool HasDefaultConstructor(::System::Type* t, bool nonPublic);

  /// @brief Method ImplementsGenericDefinition, addr 0x1527758, size 0x74, virtual false, abstract: false, final false
  static inline bool ImplementsGenericDefinition(::System::Type* type, ::System::Type* genericInterfaceDefinition);

  /// @brief Method ImplementsGenericDefinition, addr 0x153abec, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method InheritsGenericDefinition, addr 0x153ae5c, size 0x74, virtual false, abstract: false, final false
  static inline bool InheritsGenericDefinition(::System::Type* type, ::System::Type* genericClassDefinition);

  /// @brief Method InheritsGenericDefinition, addr 0x153aed0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method InheritsGenericDefinitionInternal, addr 0x153b028, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsByRefLikeType, addr 0x153b570, size 0x104, virtual false, abstract: false, final false
  static inline bool IsByRefLikeType(::System::Type* type);

  /// @brief Method IsGenericDefinition, addr 0x153ab48, size 0xa4, virtual false, abstract: false, final false
  static inline bool IsGenericDefinition(::System::Type* type, ::System::Type* genericInterfaceDefinition);

  /// @brief Method IsIndexedProperty, addr 0x153bb88, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsIndexedProperty(::System::Reflection::PropertyInfo* property);

  /// @brief Method IsMethodOverridden, addr 0x153ddec, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsMethodOverridden(::System::Type* currentType, ::System::Type* methodDeclaringType, ::StringW method);

  /// @brief Method IsNullable, addr 0x152a378, size 0x98, virtual false, abstract: false, final false
  static inline bool IsNullable(::System::Type* t);

  /// @brief Method IsNullableType, addr 0x152879c, size 0xe8, virtual false, abstract: false, final false
  static inline bool IsNullableType(::System::Type* t);

  /// @brief Method IsOverridenGenericMember, addr 0x153d088, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPublic, addr 0x153a538, size 0x90, virtual false, abstract: false, final false
  static inline bool IsPublic(::System::Reflection::PropertyInfo* property);

  /// @brief Method IsVirtual, addr 0x153a38c, size 0xe4, virtual false, abstract: false, final false
  static inline bool IsVirtual(::System::Reflection::PropertyInfo* propertyInfo);

  /// @brief Method RemoveAssemblyDetails, addr 0x153a7d8, size 0x124, virtual false, abstract: false, final false
  static inline ::StringW RemoveAssemblyDetails(::StringW fullyQualifiedTypeName);

  /// @brief Method RemoveFlag, addr 0x153d878, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMemberValue, addr 0x153bf88, size 0x248, virtual false, abstract: false, final false
  static inline void SetMemberValue(::System::Reflection::MemberInfo* member, ::System::Object* target, ::System::Object* value);

  /// @brief Method SplitFullyQualifiedTypeName, addr 0x153d258, size 0xfc, virtual false, abstract: false, final false
