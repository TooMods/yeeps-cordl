...
public:
  ...
  /// @brief Method _AndroidJavaClass, addr 0x2f4d7a8, size 0xc0, virtual false, abstract: false, final false
  inline void _AndroidJavaClass(::StringW className);

  /// @brief Method .ctor, addr 0x2f4a08c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW className);

  /// @brief Method .ctor, addr 0x2f4cfbc, size 0xf4, virtual false, abstract: false, final false
