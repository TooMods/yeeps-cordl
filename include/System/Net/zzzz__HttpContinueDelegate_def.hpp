...
public:
  // Declarations
  /// @brief Method Invoke, addr 0xf52cd8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf52c14, size 0xc4, virtual false, abstract: false, final false
