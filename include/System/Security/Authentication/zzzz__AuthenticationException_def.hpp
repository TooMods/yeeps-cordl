...
public:
  ...
  /// @brief Method .ctor, addr 0x12c0084, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12c00dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x12c00e4, size 0x8, virtual false, abstract: false, final false
