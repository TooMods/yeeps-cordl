...
public:
  // Declarations
  /// @brief Method GetPoseFromProvider, addr 0x2437688, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetPoseFromProvider, addr 0x24376ac, size 0x88, virtual true, abstract: false, final false
  inline bool TryGetPoseFromProvider(ByRef<::UnityEngine::Pose> output);

  /// @brief Method .ctor, addr 0x2437734, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
