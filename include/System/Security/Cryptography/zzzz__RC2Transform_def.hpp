...
public:
  ...
  /// @brief Method ECB, addr 0x196ace4, size 0x930, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x196a79c, size 0x548, virtual false, abstract: false, final false
