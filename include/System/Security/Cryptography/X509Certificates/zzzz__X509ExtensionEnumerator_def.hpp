...
public:
  ...
  /// @brief Method MoveNext, addr 0x122e8b4, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x122e954, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x122e810, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x122e610, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x122e720, size 0xf0, virtual false, abstract: false, final false
