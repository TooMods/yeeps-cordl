...
public:
  ...
  /// @brief Method .ctor, addr 0x27b8f68, size 0x68, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetBestOverall, addr 0x27b898c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Order, addr 0x27b9144, size 0xec, virtual false, abstract: false, final false
  inline int32_t Order(::UnityEngine::UIElements::VisualElement* a, ::UnityEngine::UIElements::VisualElement* b);

  /// @brief Method StrictOrder, addr 0x27b9558, size 0x84, virtual false, abstract: false, final false
  inline int32_t StrictOrder(::UnityEngine::UIElements::VisualElement* a, ::UnityEngine::UIElements::VisualElement* b);

  /// @brief Method StrictOrder, addr 0x27b9230, size 0x1f4, virtual false, abstract: false, final false
  inline int32_t StrictOrder(::UnityEngine::Rect ra, ::UnityEngine::Rect rb);

  /// @brief Method TieBreaker, addr 0x27b9424, size 0x134, virtual false, abstract: false, final false
  inline int32_t TieBreaker(::UnityEngine::Rect ra, ::UnityEngine::Rect rb);

  /// @brief Method ValidateElement, addr 0x27b9080, size 0xc4, virtual false, abstract: false, final false
  inline bool ValidateElement(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method ValidateHierarchyTraversal, addr 0x27b8fd0, size 0xb0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetFocusChangeDirection, addr 0x27b7c88, size 0x438, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLeafFocusable, addr 0x27b8ac8, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetLeafFocusable(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method GetLeafFocusableRecursive, addr 0x27b8d30, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetLeafFocusableRecursive(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method GetNextFocusable, addr 0x27b80c0, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetNextFocusable2D, addr 0x27b8374, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRootFocusable, addr 0x27b8904, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetRootFocusable(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method IsActive, addr 0x27b8b28, size 0xd8, virtual false, abstract: false, final false
  static inline bool IsActive(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method IsFocusRoot, addr 0x27b8c80, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsFocusRoot(::UnityEngine::UIElements::VisualElement* focusable);

  /// @brief Method IsFocusable, addr 0x27b8c00, size 0x40, virtual false, abstract: false, final false
  static inline bool IsFocusable(::UnityEngine::UIElements::Focusable* focusable);

  /// @brief Method IsLeaf, addr 0x27b8c40, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27b714c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_focusController, addr 0x27b7c64, size 0x24, virtual false, abstract: false, final false
