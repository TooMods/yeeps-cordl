...
// Write type traits
MARK_REF_PTR_T(::Photon::Chat::AuthenticationValues);
// Type: Photon.Chat::AuthenticationValues
// SizeInfo { instance_size: 56, native_size: -1, calculated_instance_size: 56, calculated_native_size: 56, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Photon::Chat {
// Is value type: false
// CS Name: ::Photon.Chat::AuthenticationValues*
...
public:
  ...
  __declspec(property(get = get_AuthType, put = set_AuthType))::Photon::Chat::CustomAuthenticationType AuthType;
  ...
  __declspec(property(get = __cordl_internal_get_authType, put = __cordl_internal_set_authType))::Photon::Chat::CustomAuthenticationType authType;

  /// @brief Method AddAuthParameter, addr 0x1810cd0, size 0x1cc, virtual true, abstract: false, final false
  inline void AddAuthParameter(::StringW key, ::StringW value);

  /// @brief Method CopyTo, addr 0x1811034, size 0x30, virtual false, abstract: false, final false
  inline ::Photon::Chat::AuthenticationValues* CopyTo(::Photon::Chat::AuthenticationValues* copy);

  static inline ::Photon::Chat::AuthenticationValues* New_ctor();

  static inline ::Photon::Chat::AuthenticationValues* New_ctor(::StringW userId);

  /// @brief Method SetAuthPostData, addr 0x1810cc0, size 0x8, virtual true, abstract: false, final false
  inline void SetAuthPostData(::ArrayW<uint8_t, ::Array<uint8_t>*> byteData);

  /// @brief Method SetAuthPostData, addr 0x1810cc8, size 0x8, virtual true, abstract: false, final false
  inline void SetAuthPostData(::System::Collections::Generic::Dictionary_2<::StringW, ::System::Object*>* dictData);

  /// @brief Method SetAuthPostData, addr 0x1810c84, size 0x3c, virtual true, abstract: false, final false
  inline void SetAuthPostData(::StringW stringData);

  /// @brief Method ToString, addr 0x1810e9c, size 0x198, virtual true, abstract: false, final false
  ...
  constexpr ::Photon::Chat::CustomAuthenticationType const& __cordl_internal_get_authType() const;

  constexpr ::Photon::Chat::CustomAuthenticationType& __cordl_internal_get_authType();
  ...
  constexpr void __cordl_internal_set_authType(::Photon::Chat::CustomAuthenticationType value);

  /// @brief Method .ctor, addr 0x180b098, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1810c54, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW userId);

  /// @brief Method get_AuthGetParameters, addr 0x1810c14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AuthGetParameters();

  /// @brief Method get_AuthPostData, addr 0x1810c24, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_AuthPostData();

  /// @brief Method get_AuthType, addr 0x1810c04, size 0x8, virtual false, abstract: false, final false
  inline ::Photon::Chat::CustomAuthenticationType get_AuthType();

  /// @brief Method get_Token, addr 0x1810c34, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Token();

  /// @brief Method get_UserId, addr 0x1810c44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_UserId();

  /// @brief Method set_AuthGetParameters, addr 0x1810c1c, size 0x8, virtual false, abstract: false, final false
  inline void set_AuthGetParameters(::StringW value);

  /// @brief Method set_AuthPostData, addr 0x1810c2c, size 0x8, virtual false, abstract: false, final false
  inline void set_AuthPostData(::System::Object* value);

  /// @brief Method set_AuthType, addr 0x1810c0c, size 0x8, virtual false, abstract: false, final false
  inline void set_AuthType(::Photon::Chat::CustomAuthenticationType value);

  /// @brief Method set_Token, addr 0x1810c3c, size 0x8, virtual false, abstract: false, final false
  inline void set_Token(::System::Object* value);

  /// @brief Method set_UserId, addr 0x1810c4c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::Photon::Chat::CustomAuthenticationType ___authType;
...
static_assert(::cordl_internals::size_check_v<::Photon::Chat::AuthenticationValues, 0x38>, "Size mismatch!");

static_assert(offsetof(::Photon::Chat::AuthenticationValues, ___authType) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Photon::Chat::AuthenticationValues, ____AuthGetParameters_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Photon::Chat::AuthenticationValues, ____AuthPostData_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Photon::Chat::AuthenticationValues, ____Token_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Photon::Chat::AuthenticationValues, ____UserId_k__BackingField) == 0x30, "Offset mismatch!");
