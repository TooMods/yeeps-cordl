...
// Write type traits
MARK_VAL_T(::Unity::Services::Vivox::ConnectionState);
// Type: Unity.Services.Vivox::ConnectionState
// SizeInfo { instance_size: 4, native_size: 4, calculated_instance_size: 4, calculated_native_size: 20, minimum_alignment: 4, natural_alignment: 4, packing: None, specified_packing: None }
namespace Unity::Services::Vivox {
// Is value type: true
// CS Name: ::Unity.Services.Vivox::ConnectionState
...
public:
  ...
  static ::Unity::Services::Vivox::ConnectionState const Connected;

  /// @brief Field Connecting value: static_cast<int32_t>(0x1)
  static ::Unity::Services::Vivox::ConnectionState const Connecting;

  /// @brief Field Disconnected value: static_cast<int32_t>(0x0)
  static ::Unity::Services::Vivox::ConnectionState const Disconnected;

  /// @brief Field Disconnecting value: static_cast<int32_t>(0x3)
  static ::Unity::Services::Vivox::ConnectionState const Disconnecting;
...
static_assert(::cordl_internals::size_check_v<::Unity::Services::Vivox::ConnectionState, 0x4>, "Size mismatch!");

static_assert(offsetof(::Unity::Services::Vivox::ConnectionState, value__) == 0x0, "Offset mismatch!");

} // namespace Unity::Services::Vivox
DEFINE_IL2CPP_ARG_TYPE(::Unity::Services::Vivox::ConnectionState, "Unity.Services.Vivox", "ConnectionState");
