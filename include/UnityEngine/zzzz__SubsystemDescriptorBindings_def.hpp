...
public:
  // Declarations
  /// @brief Method Create, addr 0x27c776c, size 0x3c, virtual false, abstract: false, final false
  static inline void* Create(void* descriptorPtr);

  /// @brief Method GetId, addr 0x27c771c, size 0x3c, virtual false, abstract: false, final false
