...
public:
  ...
  /// @brief Method BuildCertificatesCollection, addr 0x246935c, size 0x1d4, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection* BuildCertificatesCollection(::StringW storeName);

  /// @brief Method BuildCrlsCollection, addr 0x24695c0, size 0x1c0, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* BuildCrlsCollection(::StringW storeName);

  /// @brief Method CheckStore, addr 0x2469a6c, size 0xdc, virtual false, abstract: false, final false
  inline bool CheckStore(::StringW path, bool throwException);

  /// @brief Method Load, addr 0x2469780, size 0x20c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Load(::StringW filename);

  /// @brief Method LoadCertificate, addr 0x246998c, size 0x70, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* LoadCertificate(::StringW filename);

  /// @brief Method LoadCrl, addr 0x24699fc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24692f4, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool crl, bool newFormat);

  /// @brief Method get_Certificates, addr 0x2469334, size 0x28, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates();

  /// @brief Method get_Crls, addr 0x2469530, size 0x90, virtual false, abstract: false, final false
