...
public:
  ...
  /// @brief Method Reset, addr 0x283fe64, size 0xc, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x283fe34, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(float_t time);

  /// @brief Method get_keepWaiting, addr 0x283fdcc, size 0x68, virtual true, abstract: false, final false
  inline bool get_keepWaiting();

  /// @brief Method get_waitTime, addr 0x283fdbc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_waitTime();

  /// @brief Method set_waitTime, addr 0x283fdc4, size 0x8, virtual false, abstract: false, final false
