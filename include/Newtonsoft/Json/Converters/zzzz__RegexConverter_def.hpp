...
public:
  // Declarations
  /// @brief Method CanConvert, addr 0x11afbf0, size 0x7c, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  /// @brief Method HasFlag, addr 0x11af740, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::System::Text::RegularExpressions::RegexOptions options, ::System::Text::RegularExpressions::RegexOptions flag);

  /// @brief Method IsRegex, addr 0x11afc6c, size 0x88, virtual false, abstract: false, final false
  inline bool IsRegex(::System::Type* objectType);

  static inline ::Newtonsoft::Json::Converters::RegexConverter* New_ctor();

  /// @brief Method ReadJson, addr 0x11af74c, size 0xb0, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method ReadRegexObject, addr 0x11af7fc, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadRegexString, addr 0x11afa84, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Object* ReadRegexString(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method WriteBson, addr 0x11af444, size 0x138, virtual false, abstract: false, final false
  inline void WriteBson(::Newtonsoft::Json::Bson::BsonWriter* writer, ::System::Text::RegularExpressions::Regex* regex);

  /// @brief Method WriteJson, addr 0x11af57c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x11af324, size 0x120, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method .ctor, addr 0x11afcf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
