...
public:
  ...
  /// @brief Method AddName, addr 0xfef0e0, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method GetName, addr 0xfeef84, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method Grow, addr 0xfef344, size 0x124, virtual false, abstract: false, final false
  inline void Grow();
  ...
  /// @brief Method .ctor, addr 0xfeeee4, size 0x84, virtual false, abstract: false, final false
