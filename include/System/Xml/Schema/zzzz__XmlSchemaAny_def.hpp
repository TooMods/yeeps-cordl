...
public:
  ...
  /// @brief Method Allows, addr 0x1ce20a4, size 0x28, virtual false, abstract: false, final false
  inline bool Allows(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method BuildNamespaceList, addr 0x1ce1f64, size 0x94, virtual false, abstract: false, final false
  inline void BuildNamespaceList(::StringW targetNamespace);

  /// @brief Method BuildNamespaceListV1Compat, addr 0x1ce1ff8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce20cc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NameString, addr 0x1ce1a68, size 0x4fc, virtual true, abstract: false, final false
  inline ::StringW get_NameString();

  /// @brief Method get_Namespace, addr 0x1ce19dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_NamespaceList, addr 0x1ce19f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* get_NamespaceList();

  /// @brief Method get_ProcessContentsCorrect, addr 0x1ce1a54, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect();

  /// @brief Method get_ResolvedNamespace, addr 0x1ce19fc, size 0x58, virtual false, abstract: false, final false
  inline ::StringW get_ResolvedNamespace();

  /// @brief Method set_Namespace, addr 0x1ce19e4, size 0x8, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_ProcessContents, addr 0x1ce19ec, size 0x8, virtual false, abstract: false, final false
