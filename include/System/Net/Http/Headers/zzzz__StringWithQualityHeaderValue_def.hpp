...
public:
  ...
  /// @brief Method Equals, addr 0x162c664, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x162c74c, size 0x8c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::StringWithQualityHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x162c65c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x162caf0, size 0x10c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x162c7d8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x162c888, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x162c630, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Quality, addr 0x162c638, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<double_t> get_Quality();

  /// @brief Method get_Value, addr 0x162c64c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Quality, addr 0x162c644, size 0x8, virtual false, abstract: false, final false
  inline void set_Quality(::System::Nullable_1<double_t> value);

  /// @brief Method set_Value, addr 0x162c654, size 0x8, virtual false, abstract: false, final false
