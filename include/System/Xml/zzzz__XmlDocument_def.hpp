...
public:
  ...
  /// @brief Method AddAttrXmlName, addr 0xfef6a8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDefaultAttributes, addr 0xff4a88, size 0x288, virtual false, abstract: false, final false
  inline void AddDefaultAttributes(::System::Xml::XmlElement* elem);

  /// @brief Method AddElementWithId, addr 0xff1a78, size 0x1f4, virtual false, abstract: false, final false
  inline void AddElementWithId(::StringW id, ::System::Xml::XmlElement* elem);

  /// @brief Method AddIdInfo, addr 0xff347c, size 0xc0, virtual false, abstract: false, final false
  inline bool AddIdInfo(::System::Xml::XmlName* eleName, ::System::Xml::XmlName* attrName);

  /// @brief Method AddXmlName, addr 0xff344c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method AfterEvent, addr 0xff6b74, size 0x54, virtual true, abstract: false, final false
  inline void AfterEvent(::System::Xml::XmlNodeChangedEventArgs* args);

  /// @brief Method AppendChildForLoad, addr 0xff6e98, size 0x1d4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* AppendChildForLoad(::System::Xml::XmlNode* newChild, ::System::Xml::XmlDocument* doc);

  /// @brief Method BeforeEvent, addr 0xff6b20, size 0x54, virtual true, abstract: false, final false
  inline void BeforeEvent(::System::Xml::XmlNodeChangedEventArgs* args);

  /// @brief Method CanInsertAfter, addr 0xff4464, size 0xf8, virtual true, abstract: false, final false
  inline bool CanInsertAfter(::System::Xml::XmlNode* newChild, ::System::Xml::XmlNode* refChild);

  /// @brief Method CanInsertBefore, addr 0xff430c, size 0x158, virtual true, abstract: false, final false
  inline bool CanInsertBefore(::System::Xml::XmlNode* newChild, ::System::Xml::XmlNode* refChild);

  /// @brief Method CheckName, addr 0xfef578, size 0xd8, virtual false, abstract: false, final false
  static inline void CheckName(::StringW name);

  /// @brief Method CloneNode, addr 0xff3c60, size 0x60, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method CreateAttribute, addr 0xff455c, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW name);

  /// @brief Method CreateAttribute, addr 0xff59e8, size 0xa0, virtual true, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateAttribute, addr 0xff52dc, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW qualifiedName, ::StringW namespaceURI);

  /// @brief Method CreateCDataSection, addr 0xff46ac, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlCDataSection* CreateCDataSection(::StringW data);

  /// @brief Method CreateComment, addr 0xff4728, size 0x74, virtual true, abstract: false, final false
  inline ::System::Xml::XmlComment* CreateComment(::StringW data);

  /// @brief Method CreateDefaultAttribute, addr 0xff5a88, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateDefaultAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateDocumentFragment, addr 0xff48f4, size 0x60, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDocumentFragment* CreateDocumentFragment();

  /// @brief Method CreateDocumentType, addr 0xff479c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0xff49d8, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW name);

  /// @brief Method CreateElement, addr 0xff5b14, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateElement, addr 0xff5380, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW qualifiedName, ::StringW namespaceURI);

  /// @brief Method CreateEntityReference, addr 0xff4f1c, size 0x70, virtual true, abstract: false, final false
  inline ::System::Xml::XmlEntityReference* CreateEntityReference(::StringW name);

  /// @brief Method CreateProcessingInstruction, addr 0xff507c, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlProcessingInstruction* CreateProcessingInstruction(::StringW target, ::StringW data);

  /// @brief Method CreateSignificantWhitespace, addr 0xff51f4, size 0x74, virtual true, abstract: false, final false
  inline ::System::Xml::XmlSignificantWhitespace* CreateSignificantWhitespace(::StringW text);

  /// @brief Method CreateTextNode, addr 0xff5180, size 0x74, virtual true, abstract: false, final false
  inline ::System::Xml::XmlText* CreateTextNode(::StringW text);

  /// @brief Method CreateWhitespace, addr 0xff5268, size 0x74, virtual true, abstract: false, final false
  inline ::System::Xml::XmlWhitespace* CreateWhitespace(::StringW text);

  /// @brief Method CreateXmlDeclaration, addr 0xff50f8, size 0x88, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDeclaration* CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method GetDefaultAttribute, addr 0xff17d0, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method GetElement, addr 0xff3610, size 0x650, virtual false, abstract: false, final false
  inline ::System::WeakReference* GetElement(::System::Collections::ArrayList* elementList, ::System::Xml::XmlElement* elem);

  /// @brief Method GetEntityNode, addr 0xff6c10, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlEntity* GetEntityNode(::StringW name);

  /// @brief Method GetEventArgs, addr 0xff6a20, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetIDInfoByElement, addr 0xff1a64, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::XmlName* GetIDInfoByElement(::System::Xml::XmlName* eleName);

  /// @brief Method GetIDInfoByElement_, addr 0xff353c, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlName* GetIDInfoByElement_(::System::Xml::XmlName* eleName);

  /// @brief Method GetInsertEventArgsForLoad, addr 0xfefea8, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeChangedEventArgs* GetInsertEventArgsForLoad(::System::Xml::XmlNode* node, ::System::Xml::XmlNode* newParent);

  /// @brief Method GetResolver, addr 0xff3f78, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method GetSchemaElementDecl, addr 0xff4d10, size 0x110, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetSchemaElementDecl(::System::Xml::XmlElement* elem);

  /// @brief Method GetXmlName, addr 0xff3464, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HasNodeTypeInNextSiblings, addr 0xff42a8, size 0x64, virtual false, abstract: false, final false
  inline bool HasNodeTypeInNextSiblings(::System::Xml::XmlNodeType nt, ::System::Xml::XmlNode* refNode);

  /// @brief Method HasNodeTypeInPrevSiblings, addr 0xff41f8, size 0xb0, virtual false, abstract: false, final false
  inline bool HasNodeTypeInPrevSiblings(::System::Xml::XmlNodeType nt, ::System::Xml::XmlNode* refNode);

  /// @brief Method ImportAttributes, addr 0xff58d4, size 0x114, virtual false, abstract: false, final false
  inline void ImportAttributes(::System::Xml::XmlNode* fromElem, ::System::Xml::XmlNode* toElem);

  /// @brief Method ImportChildren, addr 0xff3cc0, size 0x9c, virtual false, abstract: false, final false
  inline void ImportChildren(::System::Xml::XmlNode* fromNode, ::System::Xml::XmlNode* toNode, bool deep);

  /// @brief Method ImportNodeInternal, addr 0xff5424, size 0x4b0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ImportNodeInternal(::System::Xml::XmlNode* node, bool deep);

  /// @brief Method IsValidChildType, addr 0xff4108, size 0xf0, virtual true, abstract: false, final false
  inline bool IsValidChildType(::System::Xml::XmlNodeType type);

  /// @brief Method Load, addr 0xff5fe0, size 0x110, virtual true, abstract: false, final false
  inline void Load(::System::Xml::XmlReader* reader);

  /// @brief Method LoadXml, addr 0xff6330, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method PrepareDefaultAttribute, addr 0xff4e20, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadNode, addr 0xff5d80, size 0xd8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* ReadNode(::System::Xml::XmlReader* reader);

  /// @brief Method RemoveElementWithId, addr 0xff1c6c, size 0x138, virtual false, abstract: false, final false
  inline void RemoveElementWithId(::StringW id, ::System::Xml::XmlElement* elem);

  /// @brief Method Save, addr 0xff64f0, size 0x200, virtual true, abstract: false, final false
  inline void Save(::System::Xml::XmlWriter* w);

  /// @brief Method SetBaseURI, addr 0xff6e90, size 0x8, virtual false, abstract: false, final false
  inline void SetBaseURI(::StringW inBaseURI);

  /// @brief Method SetDefaultNamespace, addr 0xff461c, size 0x90, virtual false, abstract: false, final false
  inline void SetDefaultNamespace(::StringW prefix, ::StringW localName, ByRef<::StringW> namespaceURI);

  /// @brief Method SetupReader, addr 0xff5f80, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReader* SetupReader(::System::Xml::XmlTextReader* tr);

  /// @brief Method WriteContentTo, addr 0xff6724, size 0x2fc, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* xw);

  /// @brief Method WriteTo, addr 0xff6714, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff2f0c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xff2fd8, size 0x3c8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlImplementation* imp);

  /// @brief Method .ctor, addr 0xff33a0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ActualLoadingStatus, addr 0xff5d78, size 0x8, virtual false, abstract: false, final false
  inline bool get_ActualLoadingStatus();

  /// @brief Method get_BaseURI, addr 0xff6e88, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CanReportValidity, addr 0xff3f68, size 0x8, virtual false, abstract: false, final false
  inline bool get_CanReportValidity();

  /// @brief Method get_Declaration, addr 0xff3df8, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDeclaration* get_Declaration();

  /// @brief Method get_DocumentElement, addr 0xff3eb4, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* get_DocumentElement();

  /// @brief Method get_DocumentType, addr 0xff3d6c, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDocumentType* get_DocumentType();

  /// @brief Method get_DtdSchemaInfo, addr 0xff343c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_DtdSchemaInfo();

  /// @brief Method get_Encoding, addr 0xff6bec, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Encoding();

  /// @brief Method get_Entities, addr 0xff5cec, size 0x70, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNamedNodeMap* get_Entities();

  /// @brief Method get_HasSetResolver, addr 0xff3f70, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasSetResolver();

  /// @brief Method get_Implementation, addr 0xff3e9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlImplementation* get_Implementation();

  /// @brief Method get_IsContainer, addr 0xff3f40, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsLoading, addr 0xff5d64, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsLoading();

  /// @brief Method get_IsReadOnly, addr 0xff5ce4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LastNode, addr 0xff3f48, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlLinkedNode* get_LastNode();

  /// @brief Method get_LocalName, addr 0xff3eac, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xff3ea4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0xfeef68, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NodeType, addr 0xff3d5c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_OwnerDocument, addr 0xff3f58, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_OwnerDocument();

  /// @brief Method get_ParentNode, addr 0xff3d64, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* get_ParentNode();

  /// @brief Method get_SchemaInfo, addr 0xff6d44, size 0x144, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Standalone, addr 0xff66f0, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0xff6bc8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DtdSchemaInfo, addr 0xff3444, size 0x8, virtual false, abstract: false, final false
  inline void set_DtdSchemaInfo(::System::Xml::Schema::SchemaInfo* value);

  /// @brief Method set_Entities, addr 0xff5d5c, size 0x8, virtual false, abstract: false, final false
  inline void set_Entities(::System::Xml::XmlNamedNodeMap* value);

  /// @brief Method set_InnerText, addr 0xff6480, size 0x60, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_InnerXml, addr 0xff64e0, size 0x10, virtual true, abstract: false, final false
  inline void set_InnerXml(::StringW value);

  /// @brief Method set_IsLoading, addr 0xff5d6c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsLoading(bool value);

  /// @brief Method set_LastNode, addr 0xff3f50, size 0x8, virtual true, abstract: false, final false
  inline void set_LastNode(::System::Xml::XmlLinkedNode* value);

  /// @brief Method set_Schemas, addr 0xff3f60, size 0x8, virtual false, abstract: false, final false
  inline void set_Schemas(::System::Xml::Schema::XmlSchemaSet* value);

  /// @brief Method set_XmlResolver, addr 0xff3f80, size 0x188, virtual true, abstract: false, final false
