...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2a479a0, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::UIElements::SavePersistentViewData* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2a478e4, size 0xbc, virtual false, abstract: false, final false
