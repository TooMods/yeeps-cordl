...
public:
  ...
  /// @brief Method GetOp, addr 0x1b3d0b8, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method PutOp, addr 0x1b3cae0, size 0x88, virtual false, abstract: false, final false
  inline void PutOp(::System::Runtime::Serialization::Formatters::Binary::ObjectProgress* op);

  /// @brief Method ReadArray, addr 0x1b3b908, size 0x5a8, virtual false, abstract: false, final false
  inline void ReadArray(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadArrayAsBytes, addr 0x1b3d9f0, size 0x338, virtual false, abstract: false, final false
  inline void ReadArrayAsBytes(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ReadAssembly, addr 0x1b3aaa0, size 0x278, virtual false, abstract: false, final false
  inline void ReadAssembly(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadBegin, addr 0x1b3a9d4, size 0x4, virtual false, abstract: false, final false
  inline void ReadBegin();

  /// @brief Method ReadBoolean, addr 0x1b3cb68, size 0x20, virtual false, abstract: false, final false
  inline bool ReadBoolean();

  /// @brief Method ReadByte, addr 0x1b3cb88, size 0x20, virtual false, abstract: false, final false
  inline uint8_t ReadByte();

  /// @brief Method ReadBytes, addr 0x1b3cba8, size 0x24, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBytes(int32_t length);

  /// @brief Method ReadBytes, addr 0x1b3cbcc, size 0x7c, virtual false, abstract: false, final false
  inline void ReadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> byteA, int32_t offset, int32_t size);

  /// @brief Method ReadChar, addr 0x1b3cc48, size 0x20, virtual false, abstract: false, final false
  inline char16_t ReadChar();

  /// @brief Method ReadChars, addr 0x1b3cc68, size 0x24, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> ReadChars(int32_t length);

  /// @brief Method ReadCrossAppDomainMap, addr 0x1b3b078, size 0x1d0, virtual false, abstract: false, final false
  inline void ReadCrossAppDomainMap();

  /// @brief Method ReadDateTime, addr 0x1b3ce5c, size 0x7c, virtual false, abstract: false, final false
  inline ::System::DateTime ReadDateTime();

  /// @brief Method ReadDecimal, addr 0x1b3cc8c, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Decimal ReadDecimal();

  /// @brief Method ReadDouble, addr 0x1b3cd64, size 0x24, virtual false, abstract: false, final false
  inline double_t ReadDouble();

  /// @brief Method ReadEnd, addr 0x1b3c798, size 0x4, virtual false, abstract: false, final false
  inline void ReadEnd();

  /// @brief Method ReadInt16, addr 0x1b3cd88, size 0x24, virtual false, abstract: false, final false
  inline int16_t ReadInt16();

  /// @brief Method ReadInt32, addr 0x1b3cdac, size 0x24, virtual false, abstract: false, final false
  inline int32_t ReadInt32();

  /// @brief Method ReadInt64, addr 0x1b3cdd0, size 0x24, virtual false, abstract: false, final false
  inline int64_t ReadInt64();

  /// @brief Method ReadMemberPrimitiveTyped, addr 0x1b3beb0, size 0x388, virtual false, abstract: false, final false
  inline void ReadMemberPrimitiveTyped();

  /// @brief Method ReadMemberPrimitiveUnTyped, addr 0x1b3c79c, size 0x2ac, virtual false, abstract: false, final false
  inline void ReadMemberPrimitiveUnTyped();

  /// @brief Method ReadMemberReference, addr 0x1b3c238, size 0x1f0, virtual false, abstract: false, final false
  inline void ReadMemberReference();

  /// @brief Method ReadMessageEnd, addr 0x1b3c620, size 0x178, virtual false, abstract: false, final false
  inline void ReadMessageEnd();

  /// @brief Method ReadObject, addr 0x1b3ad18, size 0x360, virtual false, abstract: false, final false
  inline void ReadObject();

  /// @brief Method ReadObjectNull, addr 0x1b3c428, size 0x1f8, virtual false, abstract: false, final false
  inline void ReadObjectNull(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectString, addr 0x1b3b378, size 0x590, virtual false, abstract: false, final false
  inline void ReadObjectString(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMap, addr 0x1b3b248, size 0xa0, virtual false, abstract: false, final false
  inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMap, addr 0x1b3d1a4, size 0x418, virtual false, abstract: false, final false
  inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap* record);

  /// @brief Method ReadObjectWithMapTyped, addr 0x1b3b2e8, size 0x90, virtual false, abstract: false, final false
  inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMapTyped, addr 0x1b3d5bc, size 0x434, virtual false, abstract: false, final false
  inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped* record);

  /// @brief Method ReadSByte, addr 0x1b3cdf4, size 0x20, virtual false, abstract: false, final false
  inline int8_t ReadSByte();

  /// @brief Method ReadSerializationHeaderRecord, addr 0x1b3a9d8, size 0xc8, virtual false, abstract: false, final false
  inline void ReadSerializationHeaderRecord();

  /// @brief Method ReadSingle, addr 0x1b3cd40, size 0x24, virtual false, abstract: false, final false
  inline float_t ReadSingle();

  /// @brief Method ReadString, addr 0x1b3ce14, size 0x24, virtual false, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ReadTimeSpan, addr 0x1b3ce38, size 0x24, virtual false, abstract: false, final false
  inline ::System::TimeSpan ReadTimeSpan();

  /// @brief Method ReadUInt16, addr 0x1b3ced8, size 0x24, virtual false, abstract: false, final false
  inline uint16_t ReadUInt16();

  /// @brief Method ReadUInt32, addr 0x1b3cefc, size 0x24, virtual false, abstract: false, final false
  inline uint32_t ReadUInt32();

  /// @brief Method ReadUInt64, addr 0x1b3cf20, size 0x24, virtual false, abstract: false, final false
  inline uint64_t ReadUInt64();

  /// @brief Method ReadValue, addr 0x1b3dd28, size 0x420, virtual false, abstract: false, final false
  inline ::System::Object* ReadValue(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method Run, addr 0x1b3a3f8, size 0x5dc, virtual false, abstract: false, final false
  inline void Run();
  ...
  /// @brief Method .ctor, addr 0x1b3a014, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AssemIdToAssemblyTable, addr 0x1b3a2a0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_AssemIdToAssemblyTable();

  /// @brief Method get_ObjectMapIdTable, addr 0x1b3a1cc, size 0x68, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_ObjectMapIdTable();

  /// @brief Method get_SystemAssemblyInfo, addr 0x1b3a120, size 0xac, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* get_SystemAssemblyInfo();

  /// @brief Method get_prs, addr 0x1b3a384, size 0x6c, virtual false, abstract: false, final false
