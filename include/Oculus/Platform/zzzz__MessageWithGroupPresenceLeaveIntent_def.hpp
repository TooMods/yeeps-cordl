...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3750, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetDataFromMessage(void* c_message);

  /// @brief Method GetGroupPresenceLeaveIntent, addr 0x19b3714, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0d04, size 0x58, virtual false, abstract: false, final false
