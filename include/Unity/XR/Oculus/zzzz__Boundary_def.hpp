...
public:
  ...
  /// @brief Method GetBoundaryConfigured, addr 0x21ea720, size 0x4, virtual false, abstract: false, final false
  static inline bool GetBoundaryConfigured();

  /// @brief Method GetBoundaryDimensions, addr 0x21ea728, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBoundaryVisible, addr 0x21ea730, size 0x4, virtual false, abstract: false, final false
  static inline bool GetBoundaryVisible();

  /// @brief Method SetBoundaryVisible, addr 0x21ea738, size 0x8, virtual false, abstract: false, final false
