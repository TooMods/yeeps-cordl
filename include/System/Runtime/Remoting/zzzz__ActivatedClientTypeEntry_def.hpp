...
public:
  ...
  /// @brief Method ToString, addr 0x1974258, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1974100, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW appUrl);

  /// @brief Method get_ApplicationUrl, addr 0x1974240, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ContextAttributes, addr 0x1974248, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ObjectType, addr 0x1974250, size 0x8, virtual false, abstract: false, final false
