...
public:
  ...
  /// @brief Method .ctor, addr 0x304ef64, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x304eefc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t dim);

  /// @brief Method get_Dvalue, addr 0x304f344, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Decimal, ::Array<::System::Decimal>*> get_Dvalue();

  /// @brief Method get_IsDecimal, addr 0x304f330, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDecimal();

  /// @brief Method set_IsDecimal, addr 0x304f338, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x304f0d0, size 0x260, virtual false, abstract: false, final false
  inline bool Equals(::System::Xml::Schema::TypedObject* other);

  /// @brief Method ListDValueEquals, addr 0x304efc0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDecimal, addr 0x304eca4, size 0x258, virtual false, abstract: false, final false
  inline void SetDecimal();

  /// @brief Method ToString, addr 0x304ec9c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304eb40, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj, ::StringW svalue, ::System::Xml::Schema::XmlSchemaDatatype* xsdtype);

  /// @brief Method get_Dim, addr 0x304eae8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Dim();

  /// @brief Method get_Dvalue, addr 0x304eb14, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Decimal, ::Array<::System::Decimal>*> get_Dvalue();

  /// @brief Method get_IsDecimal, addr 0x304eaf8, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsDecimal();

  /// @brief Method get_IsList, addr 0x304eaf0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsList();

  /// @brief Method get_Type, addr 0x304eb38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* get_Type();

  /// @brief Method get_Value, addr 0x304eb30, size 0x8, virtual false, abstract: false, final false
