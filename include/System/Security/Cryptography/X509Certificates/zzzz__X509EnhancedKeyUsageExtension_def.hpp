...
public:
  ...
  /// @brief Method CopyFrom, addr 0x122d894, size 0x1e0, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Decode, addr 0x122d3d0, size 0x26c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> extension);

  /// @brief Method Encode, addr 0x122d7d0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x122da74, size 0x2dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122d260, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x122d304, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* encodedEnhancedKeyUsages, bool critical);

  /// @brief Method .ctor, addr 0x122d63c, size 0x194, virtual false, abstract: false, final false
