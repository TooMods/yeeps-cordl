...
public:
  ...
  /// @brief Method Convert, addr 0xee1b10, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0xee1e08, size 0x22c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0xee16d4, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount, addr 0xee16e0, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0xee1844, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0xee1a68, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetChars(::System::ReadOnlySpan_1<uint8_t> bytes, ::System::Span_1<char16_t> chars, bool flush);

  /// @brief Method GetChars, addr 0xee1850, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xee15cc, size 0x108, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0xee15ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0xee15b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::DecoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0xee0eec, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0xee15bc, size 0x10, virtual false, abstract: false, final false
