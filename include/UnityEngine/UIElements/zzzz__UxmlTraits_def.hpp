...
public:
  ...
  /// @brief Method Init, addr 0x27b0840, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27b0814, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_canHaveAnyAttribute, addr 0x27b0834, size 0xc, virtual false, abstract: false, final false
