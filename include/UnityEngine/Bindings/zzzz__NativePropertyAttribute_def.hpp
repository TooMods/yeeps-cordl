...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7b44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a7b4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x23a7b50, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFree, ::UnityEngine::Bindings::TargetType targetType);

  /// @brief Method .ctor, addr 0x23a7b80, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFree, ::UnityEngine::Bindings::TargetType targetType, bool isThreadSafe);

  /// @brief Method set_TargetType, addr 0x23a7b3c, size 0x8, virtual false, abstract: false, final false
