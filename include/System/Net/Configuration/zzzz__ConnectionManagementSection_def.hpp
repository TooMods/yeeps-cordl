...
public:
  // Declarations
  __declspec(property(get = get_ConnectionManagement))::System::Net::Configuration::ConnectionManagementElementCollection* ConnectionManagement;

  __declspec(property(get = get_Properties))::System::Configuration::ConfigurationPropertyCollection* Properties;

  static inline ::System::Net::Configuration::ConnectionManagementSection* New_ctor();

  /// @brief Method .ctor, addr 0x18cd5fc, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConnectionManagement, addr 0x18cd634, size 0x38, virtual false, abstract: false, final false
  inline ::System::Net::Configuration::ConnectionManagementElementCollection* get_ConnectionManagement();

  /// @brief Method get_Properties, addr 0x18cd66c, size 0x38, virtual true, abstract: false, final false
