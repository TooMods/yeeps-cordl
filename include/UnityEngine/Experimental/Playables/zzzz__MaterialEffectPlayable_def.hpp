...
public:
  ...
  /// @brief Method Equals, addr 0x29e1264, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Playables::MaterialEffectPlayable other);

  /// @brief Method GetHandle, addr 0x29e1258, size 0xc, virtual true, abstract: false, final true
