...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x1942ab8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BuildExpression, addr 0x19410d0, size 0x238, virtual false, abstract: false, final false
  inline void BuildExpression(int32_t pri);

  /// @brief Method CheckToken, addr 0x19413c0, size 0x44, virtual false, abstract: false, final false
  inline void CheckToken(::System::Data::Tokens token);

  /// @brief Method IsAlpha, addr 0x19427ac, size 0x2c, virtual false, abstract: false, final false
  inline bool IsAlpha(char16_t ch);

  /// @brief Method IsAlphaNumeric, addr 0x1942668, size 0x3c, virtual false, abstract: false, final false
  inline bool IsAlphaNumeric(char16_t ch);

  /// @brief Method IsDigit, addr 0x1942474, size 0x14, virtual false, abstract: false, final false
  inline bool IsDigit(char16_t ch);

  /// @brief Method IsWhiteSpace, addr 0x1942828, size 0x14, virtual false, abstract: false, final false
  inline bool IsWhiteSpace(char16_t ch);

  /// @brief Method LoadExpression, addr 0x193f6c0, size 0xc4, virtual false, abstract: false, final false
  inline void LoadExpression(::StringW data);

  static inline ::System::Data::ExpressionParser* New_ctor(::System::Data::DataTable* table);

  /// @brief Method NodePeek, addr 0x1941604, size 0x44, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* NodePeek();

  /// @brief Method NodePop, addr 0x1941688, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* NodePop();

  /// @brief Method NodePush, addr 0x1941444, size 0x94, virtual false, abstract: false, final false
  inline void NodePush(::System::Data::ExpressionNode* node);

  /// @brief Method Parse, addr 0x193f7f8, size 0xd40, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* Parse();

  /// @brief Method ParseAggregateArgument, addr 0x1941760, size 0x2c4, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* ParseAggregateArgument(::System::Data::FunctionId aggregate);

  /// @brief Method Scan, addr 0x1940c8c, size 0x3b4, virtual false, abstract: false, final false
  inline ::System::Data::Tokens Scan();

  /// @brief Method ScanBinaryConstant, addr 0x1942470, size 0x4, virtual false, abstract: false, final false
  inline void ScanBinaryConstant();

  /// @brief Method ScanDate, addr 0x19420bc, size 0xa0, virtual false, abstract: false, final false
  inline void ScanDate();

  /// @brief Method ScanName, addr 0x19426a4, size 0x68, virtual false, abstract: false, final false
  inline void ScanName();

  /// @brief Method ScanName, addr 0x194222c, size 0x110, virtual false, abstract: false, final false
  inline void ScanName(char16_t chEnd, char16_t esc, ::StringW charsToEscape);

  /// @brief Method ScanNumeric, addr 0x194233c, size 0x134, virtual false, abstract: false, final false
  inline void ScanNumeric();

  /// @brief Method ScanReserved, addr 0x1942488, size 0x1e0, virtual false, abstract: false, final false
  inline void ScanReserved();

  /// @brief Method ScanString, addr 0x194215c, size 0xd0, virtual false, abstract: false, final false
  inline void ScanString(char16_t escape);

  /// @brief Method ScanToken, addr 0x1941398, size 0x28, virtual false, abstract: false, final false
  inline void ScanToken(::System::Data::Tokens token);

  /// @brief Method ScanWhite, addr 0x1942064, size 0x58, virtual false, abstract: false, final false
  inline void ScanWhite();

  /// @brief Method StartScan, addr 0x1940ba4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x193f61c, size 0xa4, virtual false, abstract: false, final false
