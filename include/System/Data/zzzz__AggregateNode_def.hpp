...
public:
  ...
  /// @brief Method Bind, addr 0x1935adc, size 0x1ec, virtual false, abstract: false, final false
  static inline void Bind(::System::Data::DataRelation* relation, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method Bind, addr 0x193576c, size 0x270, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method DependsOn, addr 0x19360dc, size 0x7c, virtual true, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Eval, addr 0x1935cc8, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x1935ff0, size 0x74, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t, ::Array<int32_t>*> records);

  /// @brief Method Eval, addr 0x1935cdc, size 0x2d4, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method HasLocalAggregate, addr 0x19360c4, size 0x8, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x19360cc, size 0x10, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x19360b4, size 0x8, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x19360bc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Optimize, addr 0x1936174, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1935610, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::System::Data::FunctionId aggregateType, ::StringW columnName);

  /// @brief Method .ctor, addr 0x193561c, size 0xd8, virtual false, abstract: false, final false
