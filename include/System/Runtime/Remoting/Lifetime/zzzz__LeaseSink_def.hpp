...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x1851248, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method RenewLease, addr 0x1850fb8, size 0x290, virtual false, abstract: false, final false
  inline void RenewLease(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method SyncProcessMessage, addr 0x1850f08, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1850ee0, size 0x28, virtual false, abstract: false, final false
