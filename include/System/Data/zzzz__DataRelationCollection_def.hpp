...
public:
  ...
  /// @brief Method Add, addr 0x188dad4, size 0x298, virtual false, abstract: false, final false
  inline void Add(::System::Data::DataRelation* relation);

  /// @brief Method AddCore, addr 0x188dd6c, size 0x2b0, virtual true, abstract: false, final false
  inline void AddCore(::System::Data::DataRelation* relation);

  /// @brief Method AssignName, addr 0x188e20c, size 0x24, virtual false, abstract: false, final false
  inline ::StringW AssignName();

  /// @brief Method Clear, addr 0x188e2e8, size 0x23c, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x188e524, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method InternalIndexOf, addr 0x188e53c, size 0x180, virtual false, abstract: false, final false
  inline int32_t InternalIndexOf(::StringW name);

  /// @brief Method MakeName, addr 0x188e230, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW MakeName(int32_t index);

  static inline ::System::Data::DataRelationCollection* New_ctor();

  /// @brief Method OnCollectionChanged, addr 0x188e6bc, size 0xd0, virtual true, abstract: false, final false
  inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method OnCollectionChanging, addr 0x188e78c, size 0xd0, virtual true, abstract: false, final false
  inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method RegisterName, addr 0x188e85c, size 0x1c4, virtual false, abstract: false, final false
  inline void RegisterName(::StringW name);

  /// @brief Method Remove, addr 0x188ea20, size 0x1c4, virtual false, abstract: false, final false
  inline void Remove(::System::Data::DataRelation* relation);

  /// @brief Method RemoveAt, addr 0x188ebe4, size 0x74, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveCore, addr 0x188ec58, size 0x1e8, virtual true, abstract: false, final false
  inline void RemoveCore(::System::Data::DataRelation* relation);

  /// @brief Method UnregisterName, addr 0x188ee40, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x188ef6c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_CollectionChanged, addr 0x188e01c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ObjectID, addr 0x188dacc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method remove_CollectionChanged, addr 0x188e114, size 0xf8, virtual false, abstract: false, final false
