...
public:
  ...
  /// @brief Method get_Document, addr 0x1b32e08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XPath::XPathDocument* get_Document();

  /// @brief Method get_LineNumberBase, addr 0x1b32e10, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumberBase();

  /// @brief Method get_LinePositionBase, addr 0x1b32e18, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePositionBase();

  /// @brief Method get_LocalName, addr 0x1b32de0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x1b32de8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_PageInfo, addr 0x1b32dd8, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo();

  /// @brief Method get_ParentPage, addr 0x1b32e00, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode, ::Array<::MS::Internal::Xml::Cache::XPathNode>*> get_ParentPage();

  /// @brief Method get_Prefix, addr 0x1b32df0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_SiblingPage, addr 0x1b32df8, size 0x8, virtual false, abstract: false, final false
