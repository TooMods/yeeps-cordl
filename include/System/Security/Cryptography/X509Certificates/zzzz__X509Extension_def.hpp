...
public:
  ...
  /// @brief Method CopyFrom, addr 0x122dea0, size 0x130, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method FormatUnkownData, addr 0x122dd50, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122d2fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x122de64, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::ArrayW<uint8_t, ::Array<uint8_t>*> rawData, bool critical);

  /// @brief Method get_Critical, addr 0x122de8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Critical();

  /// @brief Method set_Critical, addr 0x122de94, size 0xc, virtual false, abstract: false, final false
