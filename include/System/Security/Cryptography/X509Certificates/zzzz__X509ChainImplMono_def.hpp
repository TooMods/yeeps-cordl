...
public:
  ...
  /// @brief Method AddStatus, addr 0x12cc394, size 0x4, virtual true, abstract: false, final false
  inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error);

  /// @brief Method Build, addr 0x12cc398, size 0x5c4, virtual true, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method BuildChainFrom, addr 0x12cc95c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCrls, addr 0x12cebf0, size 0x394, virtual false, abstract: false, final false
  static inline ::Mono::Security::X509::X509Crl* CheckCrls(::StringW subject, ::StringW ski, ::Mono::Security::X509::X509Store* store);

  /// @brief Method CheckRevocation, addr 0x12ce180, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckRevocation, addr 0x12ce24c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckRevocationOnChain, addr 0x12cdbe8, size 0x1f0, virtual false, abstract: false, final false
  inline void CheckRevocationOnChain(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag);

  /// @brief Method FindCrl, addr 0x12ce424, size 0x174, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Crl* FindCrl(::System::Security::Cryptography::X509Certificates::X509Certificate2* caCertificate);

  /// @brief Method FindParent, addr 0x12cd240, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAuthorityKeyIdentifier, addr 0x12cd5a8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAuthorityKeyIdentifier, addr 0x12ce0f4, size 0x8c, virtual false, abstract: false, final false
  static inline ::StringW GetAuthorityKeyIdentifier(::Mono::Security::X509::X509Crl* crl);

  /// @brief Method GetAuthorityKeyIdentifier, addr 0x12cdf98, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW GetAuthorityKeyIdentifier(::Mono::Security::X509::X509Extension* ext);

  /// @brief Method GetSubjectKeyIdentifier, addr 0x12cd640, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW GetSubjectKeyIdentifier(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method IsChainComplete, addr 0x12cd354, size 0xc8, virtual false, abstract: false, final false
  inline bool IsChainComplete(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method IsSelfIssued, addr 0x12cd6f8, size 0x48, virtual false, abstract: false, final false
  inline bool IsSelfIssued(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method IsSignedWith, addr 0x12cde64, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareForNextCertificate, addr 0x12cd9e8, size 0x200, virtual false, abstract: false, final false
  inline void PrepareForNextCertificate(int32_t n);

  /// @brief Method Process, addr 0x12cd740, size 0x2a8, virtual false, abstract: false, final false
  inline void Process(int32_t n);

  /// @brief Method ProcessCertificateExtensions, addr 0x12cdea0, size 0xf8, virtual false, abstract: false, final false
  inline void ProcessCertificateExtensions(::System::Security::Cryptography::X509Certificates::X509ChainElement* element);

  /// @brief Method ProcessCrlEntryExtensions, addr 0x12ce598, size 0x310, virtual false, abstract: false, final false
  inline bool ProcessCrlEntryExtensions(::Mono::Security::X509::__X509Crl__X509CrlEntry* entry);

  /// @brief Method ProcessCrlExtensions, addr 0x12ce8a8, size 0x348, virtual false, abstract: false, final false
  inline bool ProcessCrlExtensions(::Mono::Security::X509::X509Crl* crl);

  /// @brief Method Reset, addr 0x12ccb58, size 0xcc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SelectBestFromCollection, addr 0x12cd41c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateChain, addr 0x12cca44, size 0x114, virtual false, abstract: false, final false
  inline void ValidateChain(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag);

  /// @brief Method WrapUp, addr 0x12cddd8, size 0x8c, virtual false, abstract: false, final false
  inline void WrapUp();
  ...
  /// @brief Method .ctor, addr 0x12cc2cc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertificateAuthorities, addr 0x12ccecc, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_CertificateAuthorities();

  /// @brief Method get_CertificateCollection, addr 0x12cd174, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_CertificateCollection();

  /// @brief Method get_ChainElements, addr 0x12cc384, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x12cc38c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_IsValid, addr 0x12cc37c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_LMCAStore, addr 0x12ccf8c, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Store* get_LMCAStore();

  /// @brief Method get_LMRootStore, addr 0x12ccce4, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Store* get_LMRootStore();

  /// @brief Method get_Roots, addr 0x12ccc24, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_Roots();

  /// @brief Method get_UserCAStore, addr 0x12cd080, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Store* get_UserCAStore();

  /// @brief Method get_UserRootStore, addr 0x12ccdd8, size 0xf4, virtual false, abstract: false, final false
