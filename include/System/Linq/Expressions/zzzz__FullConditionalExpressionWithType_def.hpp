...
public:
  ...
  /// @brief Method .ctor, addr 0x182e368, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x182e554, size 0x8, virtual true, abstract: false, final true
