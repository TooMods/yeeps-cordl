...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x1035f0c, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW hostName, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x1036038, size 0xc, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x1036aec, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1035e38, size 0xd4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BeginGetHostAddresses, addr 0x1035ca8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method EndGetHostAddresses, addr 0x1035f2c, size 0x10c, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> EndGetHostAddresses(::System::IAsyncResult* asyncResult);

  /// @brief Method Error_11001, addr 0x1036050, size 0x6c, virtual false, abstract: false, final false
  static inline void Error_11001(::StringW hostName);

  /// @brief Method GetHostAddresses, addr 0x10367c8, size 0x1dc, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> GetHostAddresses(::StringW hostNameOrAddress);

  /// @brief Method GetHostAddressesAsync, addr 0x10369d0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHostByAddr_icall, addr 0x1036048, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHostByAddressFromString, addr 0x10363d0, size 0x12c, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostByAddressFromString(::StringW address, bool parse);

  /// @brief Method GetHostByName, addr 0x10366dc, size 0xec, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostByName(::StringW hostName);

  /// @brief Method GetHostByName_icall, addr 0x1036044, size 0x4, virtual false, abstract: false, final false
  static inline bool GetHostByName_icall(::StringW host, ByRef<::StringW> h_name, ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_aliases,
                                         ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_addr_list, int32_t hint);

  /// @brief Method GetHostEntry, addr 0x1036670, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::System::Net::IPAddress* address);

  /// @brief Method GetHostEntry, addr 0x10364fc, size 0x174, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::StringW hostNameOrAddress);

  /// @brief Method GetHostName, addr 0x10369a4, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW GetHostName();

  /// @brief Method GetHostName_icall, addr 0x103604c, size 0x4, virtual false, abstract: false, final false
  static inline bool GetHostName_icall(ByRef<::StringW> h_name);

  /// @brief Method hostent_to_IPHostEntry, addr 0x10360bc, size 0x314, virtual false, abstract: false, final false
