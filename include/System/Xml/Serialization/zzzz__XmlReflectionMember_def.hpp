...
public:
  ...
  /// @brief Method .ctor, addr 0x12a3938, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Type* type, ::System::Xml::Serialization::XmlAttributes* attributes);

  /// @brief Method get_DeclaringType, addr 0x12a5d64, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_DeclaringType();

  /// @brief Method get_IsReturnValue, addr 0x12a5d4c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReturnValue();

  /// @brief Method get_MemberName, addr 0x12a5d54, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MemberName();

  /// @brief Method get_MemberType, addr 0x12a5d5c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_MemberType();

  /// @brief Method get_XmlAttributes, addr 0x12a2c34, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAttributes* get_XmlAttributes();

  /// @brief Method set_DeclaringType, addr 0x12a5d6c, size 0x8, virtual false, abstract: false, final false
