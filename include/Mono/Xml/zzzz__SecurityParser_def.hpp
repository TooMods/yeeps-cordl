...
public:
  ...
  /// @brief Method LoadXml, addr 0x1d04038, size 0x8c, virtual false, abstract: false, final false
  inline void LoadXml(::StringW xml);

  static inline ::Mono::Xml::SecurityParser* New_ctor();

  /// @brief Method OnChars, addr 0x1d045a4, size 0x80, virtual true, abstract: false, final true
  inline void OnChars(::StringW ch);

  /// @brief Method OnEndElement, addr 0x1d0451c, size 0x88, virtual true, abstract: false, final true
  inline void OnEndElement(::StringW name);

  /// @brief Method OnEndParsing, addr 0x1d04624, size 0x4, virtual true, abstract: false, final true
  inline void OnEndParsing(::Mono::Xml::SmallXmlParser* parser);

  /// @brief Method OnIgnorableWhitespace, addr 0x1d0429c, size 0x4, virtual true, abstract: false, final true
  inline void OnIgnorableWhitespace(::StringW s);

  /// @brief Method OnProcessingInstruction, addr 0x1d04298, size 0x4, virtual true, abstract: false, final true
  inline void OnProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method OnStartElement, addr 0x1d042a0, size 0x27c, virtual true, abstract: false, final true
  inline void OnStartElement(::StringW name, ::Mono::Xml::__SmallXmlParser__IAttrList* attrs);

  /// @brief Method OnStartParsing, addr 0x1d04294, size 0x4, virtual true, abstract: false, final true
  inline void OnStartParsing(::Mono::Xml::SmallXmlParser* parser);

  /// @brief Method ToXml, addr 0x1d0428c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d03eb8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
