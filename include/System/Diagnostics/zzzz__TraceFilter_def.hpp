...
public:
  // Declarations
  /// @brief Method ShouldTrace, addr 0x12b68d4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldTrace, addr 0x12b6900, size 0x24, virtual false, abstract: false, final false
  inline bool ShouldTrace(::System::Diagnostics::TraceEventCache* cache, ::StringW source, ::System::Diagnostics::TraceEventType eventType, int32_t id, ::StringW formatOrMessage,
                          ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args, ::System::Object* data1);
