...
public:
  ...
  /// @brief Method Process, addr 0x21dba88, size 0x34, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x21dbabc, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21dbb80, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
