...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x12b02e4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12b01b8, size 0x12c, virtual false, abstract: false, final false
