...
public:
  ...
  /// @brief Method CreateStringWriter, addr 0xeff428, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::IO::StringWriter* CreateStringWriter(int32_t capacity);

  /// @brief Method EndsWith, addr 0xeffbf4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatWith, addr 0xefeea0, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW FormatWith(::StringW format, ::System::IFormatProvider* provider, ::System::Object* arg0);

  /// @brief Method FormatWith, addr 0xefefb4, size 0xdc, virtual false, abstract: false, final false
  static inline ::StringW FormatWith(::StringW format, ::System::IFormatProvider* provider, ::System::Object* arg0, ::System::Object* arg1);

  /// @brief Method FormatWith, addr 0xeff090, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatWith, addr 0xeff198, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatWith, addr 0xefef48, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHighSurrogate, addr 0xeffb00, size 0x58, virtual false, abstract: false, final false
  static inline bool IsHighSurrogate(char16_t c);

  /// @brief Method IsLowSurrogate, addr 0xeffb58, size 0x58, virtual false, abstract: false, final false
  static inline bool IsLowSurrogate(char16_t c);

  /// @brief Method IsNullOrEmpty, addr 0xefee98, size 0x8, virtual false, abstract: false, final false
  static inline bool IsNullOrEmpty(::StringW value);

  /// @brief Method IsWhiteSpace, addr 0xeff328, size 0x100, virtual false, abstract: false, final false
  static inline bool IsWhiteSpace(::StringW s);

  /// @brief Method StartsWith, addr 0xeffbb0, size 0x44, virtual false, abstract: false, final false
  static inline bool StartsWith(::StringW source, char16_t value);

  /// @brief Method ToCamelCase, addr 0xeff5b8, size 0x1e8, virtual false, abstract: false, final false
  static inline ::StringW ToCamelCase(::StringW s);

  /// @brief Method ToCharAsUnicode, addr 0xeff4fc, size 0xbc, virtual false, abstract: false, final false
  static inline void ToCharAsUnicode(char16_t c, ::ArrayW<char16_t, ::Array<char16_t>*> buffer);

  /// @brief Method ToKebabCase, addr 0xeffaf8, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToKebabCase(::StringW s);

  /// @brief Method ToLower, addr 0xeff7a0, size 0x90, virtual false, abstract: false, final false
  static inline char16_t ToLower(char16_t c);

  /// @brief Method ToSeparatedCase, addr 0xeff838, size 0x2c0, virtual false, abstract: false, final false
  static inline ::StringW ToSeparatedCase(::StringW s, char16_t separator);

  /// @brief Method ToSnakeCase, addr 0xeff830, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToSnakeCase(::StringW s);

  /// @brief Method Trim, addr 0xeffc34, size 0x1c4, virtual false, abstract: false, final false
