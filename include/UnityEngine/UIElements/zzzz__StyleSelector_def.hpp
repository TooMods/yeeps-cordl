...
public:
  ...
  /// @brief Method <ToString>b__10_0, addr 0x302a898, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__10_0(::UnityEngine::UIElements::StyleSelectorPart p);

  /// @brief Method .ctor, addr 0x302a890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToString, addr 0x302a6dc, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x302a81c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_parts, addr 0x302a6bc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::UIElements::StyleSelectorPart, ::Array<::UnityEngine::UIElements::StyleSelectorPart>*> get_parts();

  /// @brief Method get_previousRelationship, addr 0x302a6cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSelectorRelationship get_previousRelationship();

  /// @brief Method set_parts, addr 0x302a6c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_previousRelationship, addr 0x302a6d4, size 0x8, virtual false, abstract: false, final false
