...
CORDL_MODULE_EXPORT(ConditionCheck)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::Model::ConditionCheck);
// Type: Amazon.DynamoDBv2.Model::ConditionCheck
// SizeInfo { instance_size: 64, native_size: -1, calculated_instance_size: 64, calculated_native_size: 64, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::ConditionCheck*
class CORDL_TYPE ConditionCheck : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method IsSetConditionExpression, addr 0x1227bb4, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetConditionExpression();

  /// @brief Method IsSetExpressionAttributeNames, addr 0x1227bd4, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetExpressionAttributeNames();

  /// @brief Method IsSetExpressionAttributeValues, addr 0x1227c3c, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetExpressionAttributeValues();

  /// @brief Method IsSetKey, addr 0x1227ca4, size 0x58, virtual false, abstract: false, final false
  inline bool IsSetKey();

  /// @brief Method IsSetReturnValuesOnConditionCheckFailure, addr 0x1227d0c, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetReturnValuesOnConditionCheckFailure();

  /// @brief Method IsSetTableName, addr 0x1227d7c, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetTableName();

  static inline ::Amazon::DynamoDBv2::Model::ConditionCheck* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x1227d8c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConditionExpression, addr 0x1227ba4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ConditionExpression();

  /// @brief Method get_ExpressionAttributeNames, addr 0x1227bc4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* get_ExpressionAttributeNames();

  /// @brief Method get_ExpressionAttributeValues, addr 0x1227c2c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Key, addr 0x1227c94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* get_Key();

  /// @brief Method get_ReturnValuesOnConditionCheckFailure, addr 0x1227cfc, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::DynamoDBv2::ReturnValuesOnConditionCheckFailure* get_ReturnValuesOnConditionCheckFailure();

  /// @brief Method get_TableName, addr 0x1227d6c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TableName();

  /// @brief Method set_ConditionExpression, addr 0x1227bac, size 0x8, virtual false, abstract: false, final false
  inline void set_ConditionExpression(::StringW value);

  /// @brief Method set_ExpressionAttributeNames, addr 0x1227bcc, size 0x8, virtual false, abstract: false, final false
  inline void set_ExpressionAttributeNames(::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* value);

  /// @brief Method set_ExpressionAttributeValues, addr 0x1227c34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Key, addr 0x1227c9c, size 0x8, virtual false, abstract: false, final false
  inline void set_Key(::System::Collections::Generic::Dictionary_2<::StringW, ::Amazon::DynamoDBv2::Model::AttributeValue*>* value);

  /// @brief Method set_ReturnValuesOnConditionCheckFailure, addr 0x1227d04, size 0x8, virtual false, abstract: false, final false
  inline void set_ReturnValuesOnConditionCheckFailure(::Amazon::DynamoDBv2::ReturnValuesOnConditionCheckFailure* value);

  /// @brief Method set_TableName, addr 0x1227d74, size 0x8, virtual false, abstract: false, final false
  inline void set_TableName(::StringW value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ConditionCheck();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ConditionCheck", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConditionCheck(ConditionCheck&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConditionCheck", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConditionCheck(ConditionCheck const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::ConditionCheck, 0x40>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ConditionCheck, ____conditionExpression) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ConditionCheck, ____expressionAttributeNames) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ConditionCheck, ____expressionAttributeValues) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ConditionCheck, ____key) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ConditionCheck, ____returnValuesOnConditionCheckFailure) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ConditionCheck, ____tableName) == 0x38, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::Model
NEED_NO_BOX(::Amazon::DynamoDBv2::Model::ConditionCheck);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::Model::ConditionCheck*, "Amazon.DynamoDBv2.Model", "ConditionCheck");
