...
public:
  ...
  /// @brief Method .ctor, addr 0x198b824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t min, int64_t max);

  /// @brief Method .ctor, addr 0x198b82c, size 0x8, virtual false, abstract: false, final false
