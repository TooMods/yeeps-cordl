...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x2433280, size 0x8, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x2433130, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(void* existingHandle, bool ownsHandle);

  /// @brief Method .ctor, addr 0x2433254, size 0x2c, virtual false, abstract: false, final false
