...
public:
  ...
  /// @brief Method .ctor, addr 0x1a54ec0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EmitDefaultValue, addr 0x1a54f0c, size 0x8, virtual false, abstract: false, final false
  inline bool get_EmitDefaultValue();

  /// @brief Method get_IsRequired, addr 0x1a54ef8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsRequired();

  /// @brief Method get_Name, addr 0x1a54ed8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Order, addr 0x1a54ef0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method set_EmitDefaultValue, addr 0x1a54f14, size 0xc, virtual false, abstract: false, final false
  inline void set_EmitDefaultValue(bool value);

  /// @brief Method set_IsRequired, addr 0x1a54f00, size 0xc, virtual false, abstract: false, final false
  inline void set_IsRequired(bool value);

  /// @brief Method set_Name, addr 0x1a54ee0, size 0x10, virtual false, abstract: false, final false
