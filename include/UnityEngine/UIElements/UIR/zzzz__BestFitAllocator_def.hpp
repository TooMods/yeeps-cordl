...
public:
  ...
  /// @brief Method .ctor, addr 0x20a1e00, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_size, addr 0x20a1ba8, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method CreateBlock, addr 0x20a1da8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetBlock, addr 0x20a1e48, size 0x4, virtual false, abstract: false, final false
  static inline void ResetBlock(::UnityEngine::UIElements::UIR::__BestFitAllocator__Block* block);

  /// @brief Method .ctor, addr 0x20a1a70, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Allocate, addr 0x2098764, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size);

  /// @brief Method BestFitFindAvailableBlock, addr 0x20a1b68, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::__BestFitAllocator__Block* BestFitFindAvailableBlock(uint32_t size);

  /// @brief Method CoalesceBlockWithPrevious, addr 0x20a1ca0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Free, addr 0x2098c54, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitBlock, addr 0x20a1bb4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x209899c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t size);

  /// @brief Method get_highWatermark, addr 0x2098eb0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_highWatermark();

  /// @brief Method get_totalSize, addr 0x20a1b60, size 0x8, virtual false, abstract: false, final false
