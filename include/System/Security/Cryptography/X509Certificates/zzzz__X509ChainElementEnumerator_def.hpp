...
public:
  ...
  /// @brief Method MoveNext, addr 0x12cc09c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x12cc13c, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x12cbff8, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12cbc38, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* enumerable);

  /// @brief Method get_Current, addr 0x12cbf08, size 0xf0, virtual false, abstract: false, final false
