...
public:
  ...
  /// @brief Method FinishSetup, addr 0x21efb9c, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21efc58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_back, addr 0x21efb7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_back();

  /// @brief Method get_touchpad, addr 0x21efb8c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_touchpad();

  /// @brief Method set_back, addr 0x21efb84, size 0x8, virtual false, abstract: false, final false
  inline void set_back(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_touchpad, addr 0x21efb94, size 0x8, virtual false, abstract: false, final false
