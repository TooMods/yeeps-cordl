...
public:
  // Declarations
  /// @brief Method EnsureElevatedPermissions, addr 0x1ea65e0, size 0x4, virtual false, abstract: false, final false
  static inline void EnsureElevatedPermissions();

  /// @brief Method get_SecurityEnabled, addr 0x1ea2f6c, size 0x8, virtual false, abstract: false, final false
