...
public:
  ...
  /// @brief Method Reset, addr 0x2b6545c, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Use, addr 0x2b65464, size 0xc, virtual true, abstract: false, final false
  inline void Use();
  ...
  /// @brief Method .ctor, addr 0x2b65478, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_used, addr 0x2b65470, size 0x8, virtual true, abstract: false, final false
