...
public:
  ...
  /// @brief Method BeginRead, addr 0x2defb80, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x2df01a8, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x2def96c, size 0x68, virtual false, abstract: false, final false
  inline void Close(int32_t timeout);

  /// @brief Method Dispose, addr 0x2def9d4, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x2deff24, size 0x21c, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x2df054c, size 0x21c, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x2defadc, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x2df1938, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x2df193c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2deeb24, size 0x30c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Read, addr 0x2deee98, size 0x274, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> destination);

  /// @brief Method ReadAsync, addr 0x2df07d0, size 0x3c0, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadAsync, addr 0x2df0e54, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x2def1fc, size 0x84, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x2deead4, size 0x50, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x2df19c4, size 0x50, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method SetSocketTimeoutOption, addr 0x2dee5a4, size 0x1cc, virtual false, abstract: false, final false
  inline void SetSocketTimeoutOption(::System::Net::Sockets::SocketShutdown mode, int32_t timeout, bool silent);

  /// @brief Method Write, addr 0x2def280, size 0x30c, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Write, addr 0x2def5f4, size 0x274, virtual true, abstract: false, final false
  inline void Write(::System::ReadOnlySpan_1<uint8_t> source);

  /// @brief Method WriteAsync, addr 0x2df10ac, size 0x374, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x2df16e4, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteByte, addr 0x2def8f4, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dee108, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket);

  /// @brief Method .ctor, addr 0x2dee114, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket, ::System::IO::FileAccess access, bool ownsSocket);

  /// @brief Method .ctor, addr 0x2dee2c4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket, bool ownsSocket);

  /// @brief Method get_CanRead, addr 0x2dee2d0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x2dee2d8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x2dee2e8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x2dee2e0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_DataAvailable, addr 0x2dee880, size 0xa8, virtual true, abstract: false, final false
  inline bool get_DataAvailable();

  /// @brief Method get_InternalSocket, addr 0x2df1b64, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_InternalSocket();

  /// @brief Method get_Length, addr 0x2dee9e4, size 0x50, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x2deea34, size 0x50, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_ReadTimeout, addr 0x2dee2f0, size 0x88, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_WriteTimeout, addr 0x2dee770, size 0x88, virtual true, abstract: false, final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_Position, addr 0x2deea84, size 0x50, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x2dee51c, size 0x88, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_WriteTimeout, addr 0x2dee7f8, size 0x88, virtual true, abstract: false, final false
