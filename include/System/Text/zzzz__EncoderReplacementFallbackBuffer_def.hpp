...
public:
  ...
  /// @brief Method Fallback, addr 0x1e11274, size 0x140, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknown, int32_t index);

  /// @brief Method Fallback, addr 0x1e113b4, size 0x218, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index);

  /// @brief Method GetNextChar, addr 0x1e115cc, size 0x50, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method MovePrevious, addr 0x1e1161c, size 0x30, virtual true, abstract: false, final false
  inline bool MovePrevious();

  static inline ::System::Text::EncoderReplacementFallbackBuffer* New_ctor(::System::Text::EncoderReplacementFallback* fallback);

  /// @brief Method Reset, addr 0x1e11658, size 0x14, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e11170, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::EncoderReplacementFallback* fallback);

  /// @brief Method get_Remaining, addr 0x1e1164c, size 0xc, virtual true, abstract: false, final false
