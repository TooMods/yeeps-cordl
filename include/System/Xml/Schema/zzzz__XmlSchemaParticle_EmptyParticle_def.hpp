...
public:
  ...
  /// @brief Method .ctor, addr 0x18ac380, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x18ac3d4, size 0x8, virtual true, abstract: false, final false
