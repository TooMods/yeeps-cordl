...
public:
  ...
  /// @brief Field Network value: static_cast<int32_t>(0x0)
  static ::System::Net::Mail::SmtpDeliveryMethod const Network;

  /// @brief Field PickupDirectoryFromIis value: static_cast<int32_t>(0x2)
  static ::System::Net::Mail::SmtpDeliveryMethod const PickupDirectoryFromIis;

  /// @brief Field SpecifiedPickupDirectory value: static_cast<int32_t>(0x1)
...
static_assert(::cordl_internals::size_check_v<::System::Net::Mail::SmtpDeliveryMethod, 0x4>, "Size mismatch!");
