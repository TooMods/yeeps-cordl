...
public:
  ...
  /// @brief Method EndElement, addr 0x304e630, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method PopKS, addr 0x304ea48, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::KeySequence* PopKS();

  /// @brief Method PushKS, addr 0x304e678, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304e4bc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree, ::System::Xml::Schema::ConstraintStruct* cs);

  /// @brief Method get_lastDepth, addr 0x304e588, size 0xa8, virtual false, abstract: false, final false
