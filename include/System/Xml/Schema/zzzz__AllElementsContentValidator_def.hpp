...
public:
  ...
  /// @brief Method AddElement, addr 0x2fad3d0, size 0x148, virtual false, abstract: false, final false
  inline bool AddElement(::System::Xml::XmlQualifiedName* name, ::System::Object* particle, bool isEmptiable);

  /// @brief Method CompleteValidation, addr 0x2fad714, size 0x50, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x2fad764, size 0x424, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x2fadb88, size 0x4cc, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x2fad538, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x2fad5cc, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fad2bc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType, int32_t size, bool isEmptiable);

  /// @brief Method get_IsEmptiable, addr 0x2fad518, size 0x20, virtual true, abstract: false, final false
