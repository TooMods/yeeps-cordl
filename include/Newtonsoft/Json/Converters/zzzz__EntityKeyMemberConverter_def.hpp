...
public:
  ...
  /// @brief Method CanConvert, addr 0x11ad4a4, size 0x50, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  /// @brief Method EnsureReflectionObject, addr 0x11acfcc, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAndAssertProperty, addr 0x11ad0f8, size 0xfc, virtual false, abstract: false, final false
  static inline void ReadAndAssertProperty(::Newtonsoft::Json::JsonReader* reader, ::StringW propertyName);

  /// @brief Method ReadJson, addr 0x11ad1f4, size 0x2b0, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x11acc70, size 0x35c, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method .ctor, addr 0x11ad4f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
