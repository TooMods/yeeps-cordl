...
public:
  ...
  /// @brief Method GetArrayRank, addr 0x2612ffc, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetArrayRank();

  /// @brief Method IsArrayImpl, addr 0x2612fcc, size 0x8, virtual true, abstract: false, final true
  inline bool IsArrayImpl();

  /// @brief Method IsByRefImpl, addr 0x2612fd4, size 0x8, virtual true, abstract: false, final true
  inline bool IsByRefImpl();

  /// @brief Method IsPointerImpl, addr 0x2612fdc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2612f6c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::SignatureType* elementType, int32_t rank, bool isMultiDim);

  /// @brief Method get_IsSZArray, addr 0x2612fe4, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsSZArray();

  /// @brief Method get_IsVariableBoundArray, addr 0x2612ff4, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsVariableBoundArray();

  /// @brief Method get_Suffix, addr 0x2613004, size 0xc8, virtual true, abstract: false, final true
