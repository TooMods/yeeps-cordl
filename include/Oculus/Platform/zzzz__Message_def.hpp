...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x19b2210, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x19b2230, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x19b21fc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x198c1ec, size 0x12c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x19b2314, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x19b23c8, size 0xc, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Message* EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x19b2300, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b223c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method Finalize, addr 0x19aea50, size 0x8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetAbuseReportRecording, addr 0x19aea80, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording();

  /// @brief Method GetAchievementDefinitions, addr 0x19aea88, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementDefinitionList* GetAchievementDefinitions();

  /// @brief Method GetAchievementProgressList, addr 0x19aea90, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementProgressList* GetAchievementProgressList();

  /// @brief Method GetAchievementUpdate, addr 0x19aea98, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate();

  /// @brief Method GetAppDownloadProgressResult, addr 0x19aeaa0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AppDownloadProgressResult* GetAppDownloadProgressResult();

  /// @brief Method GetAppDownloadResult, addr 0x19aeaa8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AppDownloadResult* GetAppDownloadResult();

  /// @brief Method GetApplicationInviteList, addr 0x19aeab0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationInviteList* GetApplicationInviteList();

  /// @brief Method GetApplicationVersion, addr 0x19aeab8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion();

  /// @brief Method GetAssetDetails, addr 0x19aeac0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetails* GetAssetDetails();

  /// @brief Method GetAssetDetailsList, addr 0x19aeac8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetailsList* GetAssetDetailsList();

  /// @brief Method GetAssetFileDeleteResult, addr 0x19aead0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDeleteResult* GetAssetFileDeleteResult();

  /// @brief Method GetAssetFileDownloadCancelResult, addr 0x19aead8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult();

  /// @brief Method GetAssetFileDownloadResult, addr 0x19aeae0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult();

  /// @brief Method GetAssetFileDownloadUpdate, addr 0x19aeae8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetAssetFileDownloadUpdate();

  /// @brief Method GetAvatarEditorResult, addr 0x19aeaf0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AvatarEditorResult* GetAvatarEditorResult();

  /// @brief Method GetBlockedUserList, addr 0x19aeaf8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetChallenge, addr 0x19aeb00, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetChallengeEntryList, addr 0x19aeb08, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeEntryList* GetChallengeEntryList();

  /// @brief Method GetChallengeList, addr 0x19aeb10, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataStore, addr 0x19aeb18, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* GetDataStore();

  /// @brief Method GetDestinationList, addr 0x19aeb20, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::DestinationList* GetDestinationList();

  /// @brief Method GetError, addr 0x19aea68, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Error* GetError();

  /// @brief Method GetGroupPresenceJoinIntent, addr 0x19aeb28, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetGroupPresenceJoinIntent();

  /// @brief Method GetGroupPresenceLeaveIntent, addr 0x19aeb30, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetGroupPresenceLeaveIntent();

  /// @brief Method GetHttpTransferUpdate, addr 0x19aea70, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::HttpTransferUpdate* GetHttpTransferUpdate();

  /// @brief Method GetInstalledApplicationList, addr 0x19aeb38, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InstalledApplicationList* GetInstalledApplicationList();

  /// @brief Method GetInvitePanelResultInfo, addr 0x19aeb40, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetInvitePanelResultInfo();

  /// @brief Method GetLaunchBlockFlowResult, addr 0x19aeb48, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchBlockFlowResult* GetLaunchBlockFlowResult();

  /// @brief Method GetLaunchFriendRequestFlowResult, addr 0x19aeb50, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchFriendRequestFlowResult* GetLaunchFriendRequestFlowResult();

  /// @brief Method GetLaunchInvitePanelFlowResult, addr 0x19aeb58, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetLaunchInvitePanelFlowResult();

  /// @brief Method GetLaunchReportFlowResult, addr 0x19aeb60, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchReportFlowResult* GetLaunchReportFlowResult();

  /// @brief Method GetLaunchUnblockFlowResult, addr 0x19aeb68, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchUnblockFlowResult* GetLaunchUnblockFlowResult();

  /// @brief Method GetLeaderboardDidUpdate, addr 0x19aeb70, size 0x8, virtual true, abstract: false, final false
  inline bool GetLeaderboardDidUpdate();

  /// @brief Method GetLeaderboardEntryList, addr 0x19aeb78, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardEntryList* GetLeaderboardEntryList();

  /// @brief Method GetLeaderboardList, addr 0x19aeb80, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetLeaderboardList();

  /// @brief Method GetLinkedAccountList, addr 0x19aeb88, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetLinkedAccountList();

  /// @brief Method GetLivestreamingApplicationStatus, addr 0x19aeb90, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingApplicationStatus* GetLivestreamingApplicationStatus();

  /// @brief Method GetLivestreamingStartResult, addr 0x19aeb98, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetLivestreamingStartResult();

  /// @brief Method GetLivestreamingStatus, addr 0x19aeba0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetLivestreamingStatus();

  /// @brief Method GetLivestreamingVideoStats, addr 0x19aeba8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetLivestreamingVideoStats();

  /// @brief Method GetMicrophoneAvailabilityState, addr 0x19aebb0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetMicrophoneAvailabilityState();

  /// @brief Method GetNetSyncConnection, addr 0x19aebb8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetNetSyncConnection();

  /// @brief Method GetNetSyncSessionList, addr 0x19aebc0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionList* GetNetSyncSessionList();

  /// @brief Method GetNetSyncSessionsChangedNotification, addr 0x19aebc8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionsChangedNotification* GetNetSyncSessionsChangedNotification();

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x19aebd0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetNetSyncSetSessionPropertyResult();

  /// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x19aebd8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetNetSyncVoipAttenuationValueList();

  /// @brief Method GetOrgScopedID, addr 0x19aebe0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetOrgScopedID();

  /// @brief Method GetParty, addr 0x19aebe8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetParty();

  /// @brief Method GetPartyID, addr 0x19aebf0, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetPartyID();

  /// @brief Method GetPartyUpdateNotification, addr 0x19aebf8, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyUpdateNotification* GetPartyUpdateNotification();

  /// @brief Method GetPidList, addr 0x19aec00, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PidList* GetPidList();

  /// @brief Method GetPlatformInitialize, addr 0x19aea78, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PlatformInitialize* GetPlatformInitialize();

  /// @brief Method GetProductList, addr 0x19aec08, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ProductList* GetProductList();

  /// @brief Method GetPurchase, addr 0x19aec10, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Purchase* GetPurchase();

  /// @brief Method GetPurchaseList, addr 0x19aec18, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PurchaseList* GetPurchaseList();

  /// @brief Method GetRejoinDialogResult, addr 0x19aec20, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::RejoinDialogResult* GetRejoinDialogResult();

  /// @brief Method GetSdkAccountList, addr 0x19aec28, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetSdkAccountList();

  /// @brief Method GetSendInvitesResult, addr 0x19aec30, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SendInvitesResult* GetSendInvitesResult();

  /// @brief Method GetShareMediaResult, addr 0x19aec38, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetShareMediaResult();

  /// @brief Method GetString, addr 0x19aec40, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method GetSystemVoipState, addr 0x19aec48, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SystemVoipState* GetSystemVoipState();

  /// @brief Method GetUser, addr 0x19aec50, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetUser();

  /// @brief Method GetUserAccountAgeCategory, addr 0x19aec58, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserAccountAgeCategory* GetUserAccountAgeCategory();

  /// @brief Method GetUserCapabilityList, addr 0x19aec60, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserCapabilityList* GetUserCapabilityList();

  /// @brief Method GetUserDataStoreUpdateResponse, addr 0x19aec68, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserDataStoreUpdateResponse* GetUserDataStoreUpdateResponse();

  /// @brief Method GetUserList, addr 0x19aec70, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserList* GetUserList();

  /// @brief Method GetUserProof, addr 0x19aec78, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserProof* GetUserProof();

  /// @brief Method GetUserReportID, addr 0x19aec80, size 0x8, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetUserReportID();

  static inline ::Oculus::Platform::Message* New_ctor(void* c_message);

  /// @brief Method ParseMessageHandle, addr 0x19aec88, size 0x18ec, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Message* ParseMessageHandle(void* messageHandle);

  /// @brief Method PopMessage, addr 0x1991190, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19ae7a0, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HandleExtraMessageTypes, addr 0x19b21b4, size 0x48, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::__Message__ExtraMessageTypesHandler* get_HandleExtraMessageTypes();

  /// @brief Method get_IsError, addr 0x198cf98, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsError();

  /// @brief Method get_RequestID, addr 0x19aea60, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_RequestID();

  /// @brief Method get_Type, addr 0x19aea58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_HandleExtraMessageTypes, addr 0x19b2168, size 0x4c, virtual false, abstract: false, final false
