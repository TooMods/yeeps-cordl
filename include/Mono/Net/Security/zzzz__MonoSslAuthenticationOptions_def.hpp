...
public:
  ...
  /// @brief Method .ctor, addr 0x242c784, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ServerCertSelectionDelegate, addr 0x242c77c, size 0x8, virtual false, abstract: false, final false
