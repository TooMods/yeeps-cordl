...
public:
  ...
  /// @brief Method .ctor, addr 0x1d1ef60, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1d1efc4, size 0xc0, virtual false, abstract: false, final false
