...
public:
  ...
  /// @brief Method Reset, addr 0x20a041c, size 0x1cc, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x209af80, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();
