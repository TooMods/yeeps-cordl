...
public:
  ...
  /// @brief Method CanonicalizeValue, addr 0x26175b4, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Object* CanonicalizeValue(::System::Object* value);

  /// @brief Method Equals, addr 0x261767c, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x26176ec, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x2617844, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x2616c34, size 0x8f8, virtual false, abstract: false, final false
  inline ::StringW ToString(bool typed);

  /// @brief Method .ctor, addr 0x261022c, size 0x2b0, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* argumentType, ::System::Object* value);

  /// @brief Method .ctor, addr 0x261752c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value);

  /// @brief Method get_ArgumentType, addr 0x261766c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ArgumentType();

  /// @brief Method get_Value, addr 0x2617674, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Value();

  /// @brief Method op_Equality, addr 0x2617750, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x26177c8, size 0x7c, virtual false, abstract: false, final false
