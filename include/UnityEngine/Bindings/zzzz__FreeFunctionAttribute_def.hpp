...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7d98, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a7db8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x23a7dd4, size 0x30, virtual false, abstract: false, final false
