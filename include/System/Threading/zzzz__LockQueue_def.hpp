...
public:
  ...
  /// @brief Method Pulse, addr 0xecfe58, size 0xb8, virtual false, abstract: false, final false
  inline void Pulse();

  /// @brief Method Wait, addr 0xecfbe4, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecfbbc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::ReaderWriterLock* rwlock);

  /// @brief Method get_IsEmpty, addr 0xecfd98, size 0xc0, virtual false, abstract: false, final false
