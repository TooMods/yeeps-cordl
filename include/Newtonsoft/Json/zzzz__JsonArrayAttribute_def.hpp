...
public:
  ...
  /// @brief Method .ctor, addr 0x25c4770, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c4780, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool allowNullItems);

  /// @brief Method .ctor, addr 0x25c47a8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW id);

  /// @brief Method get_AllowNullItems, addr 0x25c475c, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowNullItems();

  /// @brief Method set_AllowNullItems, addr 0x25c4764, size 0xc, virtual false, abstract: false, final false
