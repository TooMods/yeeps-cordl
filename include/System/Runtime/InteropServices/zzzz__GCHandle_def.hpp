...
public:
  ...
  /// @brief Method AddrOfPinnedObject, addr 0x1b416d8, size 0xe8, virtual false, abstract: false, final false
  inline void* AddrOfPinnedObject();

  /// @brief Method Alloc, addr 0x1b417c4, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Runtime::InteropServices::GCHandle Alloc(::System::Object* value);

  /// @brief Method Alloc, addr 0x1b41818, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCurrentDomain, addr 0x1b41a54, size 0x4, virtual false, abstract: false, final false
  static inline bool CheckCurrentDomain(void* handle);

  /// @brief Method Equals, addr 0x1b41a60, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Free, addr 0x1b41880, size 0xdc, virtual false, abstract: false, final false
  inline void Free();

  /// @brief Method FreeHandle, addr 0x1b4195c, size 0x4, virtual false, abstract: false, final false
  static inline void FreeHandle(void* handle);

  /// @brief Method FromIntPtr, addr 0x1b41ae8, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Runtime::InteropServices::GCHandle FromIntPtr(void* value);

  /// @brief Method GetAddrOfPinnedObject, addr 0x1b417c0, size 0x4, virtual false, abstract: false, final false
  static inline void* GetAddrOfPinnedObject(void* handle);

  /// @brief Method GetHashCode, addr 0x1b41ae0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTarget, addr 0x1b416ac, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Object* GetTarget(void* handle);

  /// @brief Method GetTargetHandle, addr 0x1b415ec, size 0x4, virtual false, abstract: false, final false
  static inline void* GetTargetHandle(::System::Object* obj, void* handle, ::System::Runtime::InteropServices::GCHandleType type);

  /// @brief Method ToIntPtr, addr 0x1b41aec, size 0x4, virtual false, abstract: false, final false
  static inline void* ToIntPtr(::System::Runtime::InteropServices::GCHandle value);

  /// @brief Method .ctor, addr 0x1b41508, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(void* h);

  /// @brief Method .ctor, addr 0x1b41510, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj);

  /// @brief Method .ctor, addr 0x1b41578, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, ::System::Runtime::InteropServices::GCHandleType type);

  /// @brief Method get_IsAllocated, addr 0x1b415f0, size 0x54, virtual false, abstract: false, final false
  inline bool get_IsAllocated();

  /// @brief Method get_Target, addr 0x1b41644, size 0x68, virtual false, abstract: false, final false
  inline ::System::Object* get_Target();

  /// @brief Method op_Equality, addr 0x1b41a58, size 0x8, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Runtime::InteropServices::GCHandle a, ::System::Runtime::InteropServices::GCHandle b);

  /// @brief Method op_Explicit, addr 0x1b41964, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x1b41960, size 0x4, virtual false, abstract: false, final false
  static inline void* op_Explicit_void_(::System::Runtime::InteropServices::GCHandle value);

  /// @brief Method set_Target, addr 0x1b416b0, size 0x28, virtual false, abstract: false, final false
