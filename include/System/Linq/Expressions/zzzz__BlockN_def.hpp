...
public:
  ...
  /// @brief Method GetExpression, addr 0x182cfbc, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182d104, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182d14c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182cf98, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* expressions);

  /// @brief Method get_ExpressionCount, addr 0x182d064, size 0xa0, virtual true, abstract: false, final false
