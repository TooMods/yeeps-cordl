...
public:
  ...
  /// @brief Method GetCustomAttributes, addr 0x2620fb4, size 0x70, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCustomAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetCustomAttributes, addr 0x2620f4c, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCustomAttributes(bool inherit);

  /// @brief Method GetGuidInternal, addr 0x2621224, size 0x4, virtual false, abstract: false, final false
  static inline void GetGuidInternal(void* _cordl_module, ::ArrayW<uint8_t, ::Array<uint8_t>*> guid);

  /// @brief Method GetModuleVersionId, addr 0x26211a4, size 0x80, virtual true, abstract: false, final false
  inline ::System::Guid GetModuleVersionId();

  /// @brief Method GetObjectData, addr 0x2621094, size 0x98, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRuntimeAssembly, addr 0x262112c, size 0x78, virtual false, abstract: false, final false
  inline ::System::Reflection::RuntimeAssembly* GetRuntimeAssembly();

  /// @brief Method IsDefined, addr 0x2621024, size 0x70, virtual true, abstract: false, final false
  inline bool IsDefined(::System::Type* attributeType, bool inherit);

  /// @brief Method IsResource, addr 0x2620f44, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2621228, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Assembly, addr 0x2620f1c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::Assembly* get_Assembly();

  /// @brief Method get_FullyQualifiedName, addr 0x2620f3c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_FullyQualifiedName();

  /// @brief Method get_ModuleVersionId, addr 0x2620f2c, size 0x10, virtual true, abstract: false, final false
  inline ::System::Guid get_ModuleVersionId();

  /// @brief Method get_ScopeName, addr 0x2620f24, size 0x8, virtual true, abstract: false, final false
