...
public:
  ...
  /// @brief Method CreateMask, addr 0x18ec6a4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t CreateMask();

  /// @brief Method CreateMask, addr 0x18ec6ac, size 0x70, virtual false, abstract: false, final false
  static inline int32_t CreateMask(int32_t previous);

  /// @brief Method Equals, addr 0x18ec71c, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x18ec794, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x18ec8c8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x18ec7f8, size 0xd0, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Collections::Specialized::BitVector32 value);

  /// @brief Method get_Item, addr 0x18ec670, size 0x18, virtual false, abstract: false, final false
  inline bool get_Item(int32_t bit);

  /// @brief Method set_Item, addr 0x18ec688, size 0x1c, virtual false, abstract: false, final false
