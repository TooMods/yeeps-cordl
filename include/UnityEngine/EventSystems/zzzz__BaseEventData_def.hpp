...
public:
  ...
  /// @brief Method .ctor, addr 0x2b65434, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::EventSystems::EventSystem* eventSystem);

  /// @brief Method get_currentInputModule, addr 0x2b65480, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::EventSystems::BaseInputModule> get_currentInputModule();

  /// @brief Method get_selectedObject, addr 0x2b6549c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_selectedObject();

  /// @brief Method set_selectedObject, addr 0x2b654b8, size 0x1c, virtual false, abstract: false, final false
