...
public:
  ...
  /// @brief Method .ctor, addr 0x2f64e84, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, ::Newtonsoft::Json::Bson::BsonType type);

  /// @brief Method get_Type, addr 0x2f64ebc, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonType get_Type();

  /// @brief Method get_Value, addr 0x2f64eb4, size 0x8, virtual false, abstract: false, final false
