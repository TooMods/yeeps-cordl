...
public:
  ...
  /// @brief Method Accept, addr 0x18399a8, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x1837dc4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1839904, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::LabelTarget* label, ::System::Linq::Expressions::Expression* defaultValue);

  /// @brief Method get_DefaultValue, addr 0x18399a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_DefaultValue();

  /// @brief Method get_NodeType, addr 0x1839990, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Target, addr 0x1839998, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::LabelTarget* get_Target();

  /// @brief Method get_Type, addr 0x1839974, size 0x1c, virtual true, abstract: false, final true
