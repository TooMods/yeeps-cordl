...
public:
  ...
  /// @brief Method Init, addr 0x203ed64, size 0x3f8, virtual false, abstract: false, final false
  inline void Init(::System::ReadOnlySpan_1<char16_t> format, bool useInvariantFieldLengths);

  /// @brief Method InitInvariant, addr 0x203f384, size 0x210, virtual false, abstract: false, final false
  static inline ::System::Globalization::__TimeSpanFormat__FormatLiterals InitInvariant(bool isNegative);

  /// @brief Method get_DayHourSep, addr 0x203f214, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_DayHourSep();

  /// @brief Method get_End, addr 0x203f2c4, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_End();

  /// @brief Method get_HourMinuteSep, addr 0x203f240, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_HourMinuteSep();

  /// @brief Method get_MinuteSecondSep, addr 0x203f26c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_MinuteSecondSep();

  /// @brief Method get_SecondFractionSep, addr 0x203f298, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_SecondFractionSep();

  /// @brief Method get_Start, addr 0x203f1ec, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AppendNonNegativeInt32, addr 0x203dc6c, size 0xf8, virtual false, abstract: false, final false
  static inline void AppendNonNegativeInt32(::System::Text::StringBuilder* sb, int32_t n, int32_t digits);

  /// @brief Method Format, addr 0x203dd64, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::TimeSpan value, ::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method FormatCustomized, addr 0x203e66c, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatStandard, addr 0x203e1e0, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatToBuilder, addr 0x203de1c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x203e0c4, size 0x11c, virtual false, abstract: false, final false
