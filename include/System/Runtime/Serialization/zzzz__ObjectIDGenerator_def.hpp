...
public:
  ...
  /// @brief Method FindElement, addr 0x1aa8b4c, size 0xc4, virtual false, abstract: false, final false
  inline int32_t FindElement(::System::Object* obj, ByRef<bool> found);

  /// @brief Method GetId, addr 0x1aa8c10, size 0x184, virtual true, abstract: false, final false
  inline int64_t GetId(::System::Object* obj, ByRef<bool> firstTime);

  /// @brief Method HasId, addr 0x1aa904c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rehash, addr 0x1aa8d94, size 0x2b8, virtual false, abstract: false, final false
  inline void Rehash();
  ...
  /// @brief Method .ctor, addr 0x1aa8a74, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
