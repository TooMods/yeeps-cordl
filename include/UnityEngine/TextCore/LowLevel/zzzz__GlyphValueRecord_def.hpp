...
public:
  ...
  /// @brief Method Equals, addr 0x2904a84, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2904afc, size 0xa8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::LowLevel::GlyphValueRecord other);

  /// @brief Method GetHashCode, addr 0x2904a20, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_xAdvance, addr 0x29049fc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_xAdvance();

  /// @brief Method get_xPlacement, addr 0x29049ec, size 0x8, virtual false, abstract: false, final false
  inline float_t get_xPlacement();

  /// @brief Method get_yAdvance, addr 0x2904a04, size 0x8, virtual false, abstract: false, final false
  inline float_t get_yAdvance();

  /// @brief Method get_yPlacement, addr 0x29049f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x2904a0c, size 0x14, virtual false, abstract: false, final false
