...
public:
  ...
  /// @brief Method Equals, addr 0x2a92a2c, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a929b8, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderTargetBlendState other);

  /// @brief Method GetHashCode, addr 0x2a92aa4, size 0xa0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x2a92994, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultValue, addr 0x2a92988, size 0xc, virtual false, abstract: false, final false
