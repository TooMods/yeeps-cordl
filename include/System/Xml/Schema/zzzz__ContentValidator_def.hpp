...
public:
  ...
  /// @brief Method AddParticleToExpected, addr 0x3052690, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method AddParticleToExpected, addr 0x3052700, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method CompleteValidation, addr 0x3052678, size 0x8, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x3052680, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x3052688, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x3052644, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x3052648, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3052578, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType);

  /// @brief Method .ctor, addr 0x30525a8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ContentType, addr 0x30525e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_IsEmptiable, addr 0x305260c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsEmptiable();

  /// @brief Method get_IsOpen, addr 0x3052614, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsOpen();

  /// @brief Method get_PreserveWhitespace, addr 0x30525f0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsOpen, addr 0x3052638, size 0xc, virtual false, abstract: false, final false
