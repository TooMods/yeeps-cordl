...
public:
  // Declarations
  /// @brief Method CanConvert, addr 0x11a9600, size 0x88, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  static inline ::Newtonsoft::Json::Converters::BsonObjectIdConverter* New_ctor();

  /// @brief Method ReadJson, addr 0x11a9464, size 0x19c, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x11a9364, size 0x100, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method .ctor, addr 0x11a9688, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
