...
public:
  ...
  /// @brief Method .ctor, addr 0x2f63ba4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BytesInSequence, addr 0x2f64754, size 0x1d0, virtual false, abstract: false, final false
  inline int32_t BytesInSequence(uint8_t b);

  /// @brief Method Close, addr 0x2f63adc, size 0x38, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EnsureBuffers, addr 0x2f643b0, size 0xac, virtual false, abstract: false, final false
  inline void EnsureBuffers();

  /// @brief Method GetLastFullCharStop, addr 0x2f6445c, size 0x84, virtual false, abstract: false, final false
  inline int32_t GetLastFullCharStop(int32_t start);

  /// @brief Method GetString, addr 0x2f644e0, size 0x274, virtual false, abstract: false, final false
  inline ::StringW GetString(int32_t length);

  /// @brief Method MovePosition, addr 0x2f642c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PopContext, addr 0x2f64220, size 0xa4, virtual false, abstract: false, final false
  inline void PopContext();

  /// @brief Method PushContext, addr 0x2f63bcc, size 0xa8, virtual false, abstract: false, final false
  inline void PushContext(::Newtonsoft::Json::Bson::__BsonReader__ContainerContext* newContext);

  /// @brief Method Read, addr 0x2f6339c, size 0x1a8, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadBinary, addr 0x2f64320, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBinary(ByRef<::Newtonsoft::Json::Bson::BsonBinaryType> binaryType);

  /// @brief Method ReadByte, addr 0x2f641ec, size 0x34, virtual false, abstract: false, final false
  inline uint8_t ReadByte();

  /// @brief Method ReadBytes, addr 0x2f63c74, size 0x38, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBytes(int32_t count);

  /// @brief Method ReadCodeWScope, addr 0x2f638f8, size 0x1e4, virtual false, abstract: false, final false
  inline bool ReadCodeWScope();

  /// @brief Method ReadDouble, addr 0x2f642e8, size 0x38, virtual false, abstract: false, final false
  inline double_t ReadDouble();

  /// @brief Method ReadElement, addr 0x2f630dc, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW ReadElement();

  /// @brief Method ReadInt32, addr 0x2f63b14, size 0x38, virtual false, abstract: false, final false
  inline int32_t ReadInt32();

  /// @brief Method ReadInt64, addr 0x2f64378, size 0x38, virtual false, abstract: false, final false
  inline int64_t ReadInt64();

  /// @brief Method ReadLengthString, addr 0x2f63b4c, size 0x58, virtual false, abstract: false, final false
  inline ::StringW ReadLengthString();

  /// @brief Method ReadNormal, addr 0x2f63544, size 0x1fc, virtual false, abstract: false, final false
  inline bool ReadNormal();

  /// @brief Method ReadReference, addr 0x2f63740, size 0x1b8, virtual false, abstract: false, final false
  inline bool ReadReference();

  /// @brief Method ReadString, addr 0x2f6312c, size 0x270, virtual false, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ReadType, addr 0x2f630f8, size 0x34, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonType ReadType();

  /// @brief Method ReadType, addr 0x2f63cac, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f63000, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::BinaryReader* reader);

  /// @brief Method .ctor, addr 0x2f6300c, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::BinaryReader* reader, bool readRootValueAsArray, ::System::DateTimeKind dateTimeKindHandling);

  /// @brief Method .ctor, addr 0x2f62ef4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream);

  /// @brief Method .ctor, addr 0x2f62f00, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DateTimeKindHandling, addr 0x2f62ee4, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTimeKind get_DateTimeKindHandling();

  /// @brief Method get_JsonNet35BinaryCompatibility, addr 0x2f62ebc, size 0x8, virtual false, abstract: false, final false
  inline bool get_JsonNet35BinaryCompatibility();

  /// @brief Method get_ReadRootValueAsArray, addr 0x2f62ed0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DateTimeKindHandling, addr 0x2f62eec, size 0x8, virtual false, abstract: false, final false
  inline void set_DateTimeKindHandling(::System::DateTimeKind value);

  /// @brief Method set_JsonNet35BinaryCompatibility, addr 0x2f62ec4, size 0xc, virtual false, abstract: false, final false
  inline void set_JsonNet35BinaryCompatibility(bool value);

  /// @brief Method set_ReadRootValueAsArray, addr 0x2f62ed8, size 0xc, virtual false, abstract: false, final false
