...
public:
  // Declarations
  /// @brief Method CeilToPixelGrid, addr 0x2a358ec, size 0x14, virtual false, abstract: false, final false
  static inline float_t CeilToPixelGrid(float_t v, float_t pixelsPerPoint, float_t offset);

  /// @brief Method RoundToPixelGrid, addr 0x2a358d0, size 0x1c, virtual false, abstract: false, final false
