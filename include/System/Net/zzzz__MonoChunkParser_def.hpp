...
public:
  ...
  /// @brief Method Read, addr 0x103e8d0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103f3cc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetChunkSize, addr 0x103ea8c, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalWrite, addr 0x103e950, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x103e5b4, size 0x4, virtual false, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method ReadBody, addr 0x103ed94, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCRLF, addr 0x103eecc, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFromChunks, addr 0x103e5b8, size 0x318, virtual false, abstract: false, final false
  inline int32_t ReadFromChunks(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method ReadTrailer, addr 0x103efcc, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveChunkExtension, addr 0x103f44c, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW RemoveChunkExtension(::StringW input);

  /// @brief Method ThrowProtocolViolation, addr 0x103f3f4, size 0x58, virtual false, abstract: false, final false
  static inline void ThrowProtocolViolation(::StringW message);

  /// @brief Method Write, addr 0x103e930, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103e4fc, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebHeaderCollection* headers);

  /// @brief Method get_ChunkLeft, addr 0x103f3c0, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_ChunkLeft();

  /// @brief Method get_DataAvailable, addr 0x103f2c0, size 0x100, virtual false, abstract: false, final false
  inline bool get_DataAvailable();

  /// @brief Method get_WantMore, addr 0x103f298, size 0x28, virtual false, abstract: false, final false
