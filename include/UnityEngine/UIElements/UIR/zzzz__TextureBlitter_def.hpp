...
public:
  ...
  /// @brief Method BeginBlit, addr 0x12948b4, size 0x1fc, virtual false, abstract: false, final false
  inline void BeginBlit(::UnityEngine::RenderTexture* dst);

  /// @brief Method BlitOneNow, addr 0x1286eac, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Commit, addr 0x1286c88, size 0xec, virtual false, abstract: false, final false
  inline void Commit(::UnityEngine::RenderTexture* dst);

  /// @brief Method Dispose, addr 0x128623c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x129470c, size 0x7c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DoBlit, addr 0x1294ab0, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndBlit, addr 0x1294fcc, size 0xe0, virtual false, abstract: false, final false
  inline void EndBlit();

  static inline ::UnityEngine::UIElements::UIR::TextureBlitter* New_ctor(int32_t capacity);

  /// @brief Method QueueBlit, addr 0x1286628, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1285f34, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x12946f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x1294700, size 0xc, virtual false, abstract: false, final false
