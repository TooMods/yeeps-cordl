...
public:
  ...
  /// @brief Method OnAfterInputUpdate, addr 0x1eb4900, size 0x4, virtual false, abstract: false, final false
  inline void OnAfterInputUpdate();

  /// @brief Method OnButtonActionTriggered, addr 0x1eb470c, size 0x1f4, virtual false, abstract: false, final false
  inline void OnButtonActionTriggered(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnDisable, addr 0x1eb4118, size 0x23c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x1eb3d0c, size 0x40c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetAction, addr 0x1eb37fc, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActionCallback, addr 0x1eb39c8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method TryEnableHardwareCursor, addr 0x1eb3520, size 0x21c, virtual false, abstract: false, final false
  inline void TryEnableHardwareCursor();

  /// @brief Method TryFindCanvas, addr 0x1eb374c, size 0x54, virtual false, abstract: false, final false
  inline void TryFindCanvas();

  /// @brief Method UpdateMotion, addr 0x1eb4354, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1eb4904, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_backButtonAction, addr 0x1eb3c24, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_backButtonAction();

  /// @brief Method get_cursorGraphic, addr 0x1eb373c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Graphic> get_cursorGraphic();

  /// @brief Method get_cursorMode, addr 0x1eb3420, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::UI::__VirtualMouseInput__CursorMode get_cursorMode();

  /// @brief Method get_cursorSpeed, addr 0x1eb3410, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cursorSpeed();

  /// @brief Method get_cursorTransform, addr 0x1eb3400, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_cursorTransform();

  /// @brief Method get_forwardButtonAction, addr 0x1eb3b80, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_forwardButtonAction();

  /// @brief Method get_leftButtonAction, addr 0x1eb3924, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_leftButtonAction();

  /// @brief Method get_middleButtonAction, addr 0x1eb3adc, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_middleButtonAction();

  /// @brief Method get_rightButtonAction, addr 0x1eb3a38, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_rightButtonAction();

  /// @brief Method get_scrollSpeed, addr 0x1eb37a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scrollSpeed();

  /// @brief Method get_scrollWheelAction, addr 0x1eb3cc8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_scrollWheelAction();

  /// @brief Method get_stickAction, addr 0x1eb37b8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_stickAction();

  /// @brief Method get_virtualMouse, addr 0x1eb37b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Mouse* get_virtualMouse();

  /// @brief Method set_backButtonAction, addr 0x1eb3c38, size 0x90, virtual false, abstract: false, final false
  inline void set_backButtonAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_cursorGraphic, addr 0x1eb3744, size 0x8, virtual false, abstract: false, final false
  inline void set_cursorGraphic(::UnityEngine::UI::Graphic* value);

  /// @brief Method set_cursorMode, addr 0x1eb3428, size 0xf8, virtual false, abstract: false, final false
  inline void set_cursorMode(::UnityEngine::InputSystem::UI::__VirtualMouseInput__CursorMode value);

  /// @brief Method set_cursorSpeed, addr 0x1eb3418, size 0x8, virtual false, abstract: false, final false
  inline void set_cursorSpeed(float_t value);

  /// @brief Method set_cursorTransform, addr 0x1eb3408, size 0x8, virtual false, abstract: false, final false
  inline void set_cursorTransform(::UnityEngine::RectTransform* value);

  /// @brief Method set_forwardButtonAction, addr 0x1eb3b94, size 0x90, virtual false, abstract: false, final false
  inline void set_forwardButtonAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_leftButtonAction, addr 0x1eb3938, size 0x90, virtual false, abstract: false, final false
  inline void set_leftButtonAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_middleButtonAction, addr 0x1eb3af0, size 0x90, virtual false, abstract: false, final false
  inline void set_middleButtonAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_rightButtonAction, addr 0x1eb3a4c, size 0x90, virtual false, abstract: false, final false
  inline void set_rightButtonAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_scrollSpeed, addr 0x1eb37a8, size 0x8, virtual false, abstract: false, final false
  inline void set_scrollSpeed(float_t value);

  /// @brief Method set_scrollWheelAction, addr 0x1eb3cdc, size 0x30, virtual false, abstract: false, final false
  inline void set_scrollWheelAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_stickAction, addr 0x1eb37cc, size 0x30, virtual false, abstract: false, final false
