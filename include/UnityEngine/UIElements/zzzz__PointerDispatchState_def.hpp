...
public:
  ...
  /// @brief Method ActivateCompatibilityMouseEvents, addr 0x2a35f20, size 0x34, virtual false, abstract: false, final false
  inline void ActivateCompatibilityMouseEvents(int32_t pointerId);

  /// @brief Method CapturePointer, addr 0x2a35ac0, size 0x13c, virtual false, abstract: false, final false
  inline void CapturePointer(::UnityEngine::UIElements::IEventHandler* handler, int32_t pointerId);

  /// @brief Method GetCapturingElement, addr 0x2a35d38, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IEventHandler* GetCapturingElement(int32_t pointerId);

  /// @brief Method HasPointerCapture, addr 0x2a35a50, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method PreventCompatibilityMouseEvents, addr 0x2a36018, size 0x30, virtual false, abstract: false, final false
  inline void PreventCompatibilityMouseEvents(int32_t pointerId);

  /// @brief Method ProcessPointerCapture, addr 0x2a36364, size 0x958, virtual false, abstract: false, final false
  inline void ProcessPointerCapture(int32_t pointerId);

  /// @brief Method ReleasePointer, addr 0x2a35c34, size 0x3c, virtual false, abstract: false, final false
  inline void ReleasePointer(::UnityEngine::UIElements::IEventHandler* handler, int32_t pointerId);

  /// @brief Method ReleasePointer, addr 0x2a35e2c, size 0x30, virtual false, abstract: false, final false
  inline void ReleasePointer(int32_t pointerId);

  /// @brief Method Reset, addr 0x2a36d94, size 0x90, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ShouldSendCompatibilityMouseEvents, addr 0x2a3616c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a36cbc, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
