...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0xfc0370, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0xfc0404, size 0xc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0xfc035c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc0284, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xfbfe3c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(bool supportsPassthrough, bool supportsColorPassthrough, uint32_t maxColorLutResolution);

  /// @brief Method get_MaxColorLutResolution, addr 0xfc0420, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_MaxColorLutResolution();

  /// @brief Method get_SupportsColorPassthrough, addr 0xfc0418, size 0x8, virtual false, abstract: false, final false
  inline bool get_SupportsColorPassthrough();

  /// @brief Method get_SupportsPassthrough, addr 0xfc0410, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <FindMainCamera>b__434_0, addr 0xfc04b0, size 0x80, virtual false, abstract: false, final false
  inline int32_t _FindMainCamera_b__434_0(::UnityEngine::Camera* c0, ::UnityEngine::Camera* c1);

  /// @brief Method <InitOVRManager>b__418_0, addr 0xfc0494, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW _InitOVRManager_b__418_0(float_t f);

  /// @brief Method .ctor, addr 0xfc048c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0xfbb560, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateMixedRealityCaptureConfigurationFileFromCmd, addr 0xfb97e0, size 0xac, virtual false, abstract: false, final false
  static inline bool CreateMixedRealityCaptureConfigurationFileFromCmd();

  /// @brief Method DeregisterEventListener, addr 0xfb948c, size 0x58, virtual false, abstract: false, final false
  inline void DeregisterEventListener(::GlobalNamespace::__OVRManager__EventListener* listener);

  /// @brief Method FindMainCamera, addr 0xfb8aac, size 0x678, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Camera> FindMainCamera();

  /// @brief Method FixedUpdate, addr 0xfbf32c, size 0x50, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetCurrentDisplaySubsystem, addr 0xfbb71c, size 0x190, virtual false, abstract: false, final false
  static inline Il2CppObject* GetCurrentDisplaySubsystem();

  /// @brief Method GetCurrentDisplaySubsystemDescriptor, addr 0xfbb8ac, size 0x190, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::XRDisplaySubsystemDescriptor* GetCurrentDisplaySubsystemDescriptor();

  /// @brief Method GetCurrentInputSubsystem, addr 0xfbba3c, size 0x190, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::XRInputSubsystem* GetCurrentInputSubsystem();

  /// @brief Method GetOpenVRControllerOffset, addr 0xfb8654, size 0x1e4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRPose GetOpenVRControllerOffset(::UnityEngine::XR::XRNode hand);

  /// @brief Method GetPassthroughCapabilities, addr 0xfbfce0, size 0x15c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__PassthroughCapabilities* GetPassthroughCapabilities();

  /// @brief Method GetSpaceWarp, addr 0xfb9124, size 0x58, virtual false, abstract: false, final false
  static inline bool GetSpaceWarp();

  /// @brief Method HasInsightPassthroughInitFailed, addr 0xfbfedc, size 0x60, virtual false, abstract: false, final false
  static inline bool HasInsightPassthroughInitFailed();

  /// @brief Method InitOVRManager, addr 0xfb99f0, size 0x10e4, virtual false, abstract: false, final false
  inline void InitOVRManager();

  /// @brief Method InitPermissionRequest, addr 0xfbb290, size 0xec, virtual false, abstract: false, final false
  inline void InitPermissionRequest();

  /// @brief Method Initialize, addr 0xfbb000, size 0x290, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeInsightPassthrough, addr 0xfbb37c, size 0x1e4, virtual false, abstract: false, final false
  static inline bool InitializeInsightPassthrough();

  /// @brief Method IsAdaptiveResSupportedByEngine, addr 0xfb6d70, size 0x8, virtual false, abstract: false, final false
  static inline bool IsAdaptiveResSupportedByEngine();

  /// @brief Method IsInsightPassthroughInitPending, addr 0xfbff3c, size 0x60, virtual false, abstract: false, final false
  static inline bool IsInsightPassthroughInitPending();

  /// @brief Method IsInsightPassthroughInitialized, addr 0xfbfe7c, size 0x60, virtual false, abstract: false, final false
  static inline bool IsInsightPassthroughInitialized();

  /// @brief Method IsInsightPassthroughSupported, addr 0xfbfc90, size 0x50, virtual false, abstract: false, final false
  static inline bool IsInsightPassthroughSupported();

  /// @brief Method IsMultimodalHandsControllersSupported, addr 0xfbfc40, size 0x50, virtual false, abstract: false, final false
  static inline bool IsMultimodalHandsControllersSupported();

  /// @brief Method IsPassthroughRecommended, addr 0xfbff9c, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsPassthroughRecommended();

  /// @brief Method IsUnityAlphaOrBetaVersion, addr 0xfb9938, size 0xb8, virtual false, abstract: false, final false
  static inline bool IsUnityAlphaOrBetaVersion();

  /// @brief Method LateUpdate, addr 0xfbf140, size 0x1ec, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadMixedRealityCaptureConfigurationFileFromCmd, addr 0xfb988c, size 0xac, virtual false, abstract: false, final false
  static inline bool LoadMixedRealityCaptureConfigurationFileFromCmd();

  /// @brief Method MixedRealityEnabledFromCmd, addr 0xfb95dc, size 0xac, virtual false, abstract: false, final false
  static inline bool MixedRealityEnabledFromCmd();

  static inline ::GlobalNamespace::OVRManager* New_ctor();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_capturingCameraDevice, addr 0xfb70c0, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRManager__CameraDevice OVRMixedRealityCaptureConfiguration_get_capturingCameraDevice();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_chromaKeyColor, addr 0xfb7128, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color OVRMixedRealityCaptureConfiguration_get_chromaKeyColor();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_chromaKeySimilarity, addr 0xfb7140, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_chromaKeySimilarity();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_chromaKeySmoothRange, addr 0xfb7150, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_chromaKeySmoothRange();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_chromaKeySpillRange, addr 0xfb7160, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_chromaKeySpillRange();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_compositionMethod, addr 0xfb7080, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRManager__CompositionMethod OVRMixedRealityCaptureConfiguration_get_compositionMethod();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_depthQuality, addr 0xfb7184, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRManager__DepthQuality OVRMixedRealityCaptureConfiguration_get_depthQuality();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_dynamicCullingMask, addr 0xfb706c, size 0x8, virtual true, abstract: false, final true
  inline bool OVRMixedRealityCaptureConfiguration_get_dynamicCullingMask();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_dynamicLightingDepthVariationClampingValue, addr 0xfb71a4, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_dynamicLightingDepthVariationClampingValue();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_dynamicLightingSmoothFactor, addr 0xfb7194, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_dynamicLightingSmoothFactor();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_enableMixedReality, addr 0xfb7038, size 0x8, virtual true, abstract: false, final true
  inline bool OVRMixedRealityCaptureConfiguration_get_enableMixedReality();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_externalCompositionBackdropColorQuest, addr 0xfb70a8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color OVRMixedRealityCaptureConfiguration_get_externalCompositionBackdropColorQuest();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_externalCompositionBackdropColorRift, addr 0xfb7090, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color OVRMixedRealityCaptureConfiguration_get_externalCompositionBackdropColorRift();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_extraHiddenLayers, addr 0xfb704c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::LayerMask OVRMixedRealityCaptureConfiguration_get_extraHiddenLayers();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_extraVisibleLayers, addr 0xfb705c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::LayerMask OVRMixedRealityCaptureConfiguration_get_extraVisibleLayers();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_flipCameraFrameHorizontally, addr 0xfb70d0, size 0x8, virtual true, abstract: false, final true
  inline bool OVRMixedRealityCaptureConfiguration_get_flipCameraFrameHorizontally();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_flipCameraFrameVertically, addr 0xfb70e4, size 0x8, virtual true, abstract: false, final true
  inline bool OVRMixedRealityCaptureConfiguration_get_flipCameraFrameVertically();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_handPoseStateLatency, addr 0xfb70f8, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_handPoseStateLatency();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_instantiateMixedRealityCameraGameObject, addr 0xfb7218, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMixedRealityCaptureConfiguration.get_mrcActivationMode, addr 0xfb7208, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRManager__MrcActivationMode OVRMixedRealityCaptureConfiguration_get_mrcActivationMode();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_sandwichCompositionBufferedFrames, addr 0xfb7118, size 0x8, virtual true, abstract: false, final true
  inline int32_t OVRMixedRealityCaptureConfiguration_get_sandwichCompositionBufferedFrames();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_sandwichCompositionRenderLatency, addr 0xfb7108, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_sandwichCompositionRenderLatency();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_useDynamicLighting, addr 0xfb7170, size 0x8, virtual true, abstract: false, final true
  inline bool OVRMixedRealityCaptureConfiguration_get_useDynamicLighting();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_virtualGreenScreenApplyDepthCulling, addr 0xfb71e4, size 0x8, virtual true, abstract: false, final true
  inline bool OVRMixedRealityCaptureConfiguration_get_virtualGreenScreenApplyDepthCulling();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_virtualGreenScreenBottomY, addr 0xfb71d4, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_virtualGreenScreenBottomY();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_virtualGreenScreenDepthTolerance, addr 0xfb71f8, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_virtualGreenScreenDepthTolerance();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_virtualGreenScreenTopY, addr 0xfb71c4, size 0x8, virtual true, abstract: false, final true
  inline float_t OVRMixedRealityCaptureConfiguration_get_virtualGreenScreenTopY();

  /// @brief Method OVRMixedRealityCaptureConfiguration.get_virtualGreenScreenType, addr 0xfb71b4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMixedRealityCaptureConfiguration.set_capturingCameraDevice, addr 0xfb70c8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMixedRealityCaptureConfiguration.set_chromaKeyColor, addr 0xfb7134, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_chromaKeyColor(::UnityEngine::Color value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_chromaKeySimilarity, addr 0xfb7148, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_chromaKeySimilarity(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_chromaKeySmoothRange, addr 0xfb7158, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_chromaKeySmoothRange(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_chromaKeySpillRange, addr 0xfb7168, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_chromaKeySpillRange(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_compositionMethod, addr 0xfb7088, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMixedRealityCaptureConfiguration.set_depthQuality, addr 0xfb718c, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_depthQuality(::GlobalNamespace::__OVRManager__DepthQuality value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_dynamicCullingMask, addr 0xfb7074, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_dynamicCullingMask(bool value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_dynamicLightingDepthVariationClampingValue, addr 0xfb71ac, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_dynamicLightingDepthVariationClampingValue(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_dynamicLightingSmoothFactor, addr 0xfb719c, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_dynamicLightingSmoothFactor(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_enableMixedReality, addr 0xfb7040, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_enableMixedReality(bool value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_externalCompositionBackdropColorQuest, addr 0xfb70b4, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_externalCompositionBackdropColorQuest(::UnityEngine::Color value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_externalCompositionBackdropColorRift, addr 0xfb709c, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_externalCompositionBackdropColorRift(::UnityEngine::Color value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_extraHiddenLayers, addr 0xfb7054, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_extraHiddenLayers(::UnityEngine::LayerMask value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_extraVisibleLayers, addr 0xfb7064, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_extraVisibleLayers(::UnityEngine::LayerMask value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_flipCameraFrameHorizontally, addr 0xfb70d8, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_flipCameraFrameHorizontally(bool value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_flipCameraFrameVertically, addr 0xfb70ec, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_flipCameraFrameVertically(bool value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_handPoseStateLatency, addr 0xfb7100, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_handPoseStateLatency(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_instantiateMixedRealityCameraGameObject, addr 0xfb7220, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMixedRealityCaptureConfiguration.set_mrcActivationMode, addr 0xfb7210, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRMixedRealityCaptureConfiguration.set_sandwichCompositionBufferedFrames, addr 0xfb7120, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_sandwichCompositionBufferedFrames(int32_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_sandwichCompositionRenderLatency, addr 0xfb7110, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_sandwichCompositionRenderLatency(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_useDynamicLighting, addr 0xfb7178, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_useDynamicLighting(bool value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_virtualGreenScreenApplyDepthCulling, addr 0xfb71ec, size 0xc, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_virtualGreenScreenApplyDepthCulling(bool value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_virtualGreenScreenBottomY, addr 0xfb71dc, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_virtualGreenScreenBottomY(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_virtualGreenScreenDepthTolerance, addr 0xfb7200, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_virtualGreenScreenDepthTolerance(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_virtualGreenScreenTopY, addr 0xfb71cc, size 0x8, virtual true, abstract: false, final true
  inline void OVRMixedRealityCaptureConfiguration_set_virtualGreenScreenTopY(float_t value);

  /// @brief Method OVRMixedRealityCaptureConfiguration.set_virtualGreenScreenType, addr 0xfb71bc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OnApplicationFocus, addr 0xfbf4a0, size 0x88, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool focus);

  /// @brief Method OnApplicationPause, addr 0xfbf418, size 0x88, virtual false, abstract: false, final false
  inline void OnApplicationPause(bool pause);

  /// @brief Method OnApplicationQuit, addr 0xfbf528, size 0x68, virtual false, abstract: false, final false
  inline void OnApplicationQuit();

  /// @brief Method OnDestroy, addr 0xfbf37c, size 0x9c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0xfbf088, size 0xb8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPermissionGranted, addr 0xfb7e80, size 0xdc, virtual false, abstract: false, final false
  static inline void OnPermissionGranted(::StringW permissionId);

  /// @brief Method PassthroughInitializedOrPending, addr 0xfbfc30, size 0x10, virtual false, abstract: false, final false
  static inline bool PassthroughInitializedOrPending(::GlobalNamespace::__OVRManager__PassthroughInitializationState state);

  /// @brief Method PlatformUIConfirmQuit, addr 0xfbf5dc, size 0x8c, virtual false, abstract: false, final false
  static inline void PlatformUIConfirmQuit();

  /// @brief Method RegisterEventListener, addr 0xfb9434, size 0x58, virtual false, abstract: false, final false
  inline void RegisterEventListener(::GlobalNamespace::__OVRManager__EventListener* listener);

  /// @brief Method ReturnToLauncher, addr 0xfbf590, size 0x4c, virtual false, abstract: false, final false
  inline void ReturnToLauncher();

  /// @brief Method SetColorScaleAndOffset, addr 0xfb8494, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentXRDevice, addr 0xfbb5cc, size 0x150, virtual false, abstract: false, final false
  inline void SetCurrentXRDevice();

  /// @brief Method SetDepthSubmission, addr 0xfb917c, size 0x1c, virtual false, abstract: false, final false
  static inline bool SetDepthSubmission(bool enable);

  /// @brief Method SetOpenVRLocalPose, addr 0xfb854c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSpaceWarp, addr 0xfb8838, size 0x274, virtual false, abstract: false, final false
  static inline void SetSpaceWarp(bool enabled);

  /// @brief Method ShutdownInsightPassthrough, addr 0xfbddc4, size 0x130, virtual false, abstract: false, final false
  static inline void ShutdownInsightPassthrough();

  /// @brief Method StaticInitializeMixedRealityCapture, addr 0xfbaad4, size 0x52c, virtual false, abstract: false, final false
  static inline void StaticInitializeMixedRealityCapture(::GlobalNamespace::OVRMixedRealityCaptureConfiguration* configuration);

  /// @brief Method StaticShutdownMixedRealityCapture, addr 0xfbdcbc, size 0x108, virtual false, abstract: false, final false
  static inline void StaticShutdownMixedRealityCapture(::GlobalNamespace::OVRMixedRealityCaptureConfiguration* configuration);

  /// @brief Method StaticUpdateMixedRealityCapture, addr 0xfbe9a0, size 0x4c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0xfbbbcc, size 0x20f0, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateHMDEvents, addr 0xfbdef4, size 0xaac, virtual false, abstract: false, final false
  inline void UpdateHMDEvents();

  /// @brief Method UpdateInsightPassthrough, addr 0xfbee64, size 0x224, virtual false, abstract: false, final false
  static inline void UpdateInsightPassthrough(bool shouldBeEnabled);

  /// @brief Method UseDirectCompositionFromCmd, addr 0xfb9688, size 0xac, virtual false, abstract: false, final false
  static inline bool UseDirectCompositionFromCmd();

  /// @brief Method UseExternalCompositionFromCmd, addr 0xfb9734, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc0008, size 0x118, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_AudioInChanged, addr 0xfb4ca0, size 0xdc, virtual false, abstract: false, final false
  static inline void add_AudioInChanged(::System::Action* value);

  /// @brief Method add_AudioOutChanged, addr 0xfb4ae8, size 0xdc, virtual false, abstract: false, final false
  static inline void add_AudioOutChanged(::System::Action* value);

  /// @brief Method add_DisplayRefreshRateChanged, addr 0xfb51c8, size 0xf4, virtual false, abstract: false, final false
  static inline void add_DisplayRefreshRateChanged(::System::Action_2<float_t, float_t>* value);

  /// @brief Method add_HMDAcquired, addr 0xfb3d28, size 0xdc, virtual false, abstract: false, final false
  static inline void add_HMDAcquired(::System::Action* value);

  /// @brief Method add_HMDLost, addr 0xfb3ee0, size 0xdc, virtual false, abstract: false, final false
  static inline void add_HMDLost(::System::Action* value);

  /// @brief Method add_HMDMounted, addr 0xfb4098, size 0xdc, virtual false, abstract: false, final false
  static inline void add_HMDMounted(::System::Action* value);

  /// @brief Method add_HMDUnmounted, addr 0xfb4250, size 0xdc, virtual false, abstract: false, final false
  static inline void add_HMDUnmounted(::System::Action* value);

  /// @brief Method add_HSWDismissed, addr 0xfb64d8, size 0xdc, virtual false, abstract: false, final false
  static inline void add_HSWDismissed(::System::Action* value);

  /// @brief Method add_InputFocusAcquired, addr 0xfb4778, size 0xdc, virtual false, abstract: false, final false
  static inline void add_InputFocusAcquired(::System::Action* value);

  /// @brief Method add_InputFocusLost, addr 0xfb4930, size 0xdc, virtual false, abstract: false, final false
  static inline void add_InputFocusLost(::System::Action* value);

  /// @brief Method add_SceneCaptureComplete, addr 0xfb62f0, size 0xf4, virtual false, abstract: false, final false
  static inline void add_SceneCaptureComplete(::System::Action_2<uint64_t, bool>* value);

  /// @brief Method add_ShareSpacesComplete, addr 0xfb5f20, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_SpaceEraseComplete, addr 0xfb5d38, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_SpaceListSaveComplete, addr 0xfb6108, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_SpaceQueryComplete, addr 0xfb5968, size 0xf4, virtual false, abstract: false, final false
  static inline void add_SpaceQueryComplete(::System::Action_2<uint64_t, bool>* value);

  /// @brief Method add_SpaceQueryResults, addr 0xfb5780, size 0xf4, virtual false, abstract: false, final false
  static inline void add_SpaceQueryResults(::System::Action_1<uint64_t>* value);

  /// @brief Method add_SpaceSaveComplete, addr 0xfb5b50, size 0xf4, virtual false, abstract: false, final false
  static inline void add_SpaceSaveComplete(::System::Action_4<uint64_t, ::GlobalNamespace::OVRSpace, bool, ::System::Guid>* value);

  /// @brief Method add_SpaceSetComponentStatusComplete, addr 0xfb5598, size 0xf4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method add_SpatialAnchorCreateComplete, addr 0xfb53b0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_TrackingAcquired, addr 0xfb4e58, size 0xdc, virtual false, abstract: false, final false
  static inline void add_TrackingAcquired(::System::Action* value);

  /// @brief Method add_TrackingLost, addr 0xfb5010, size 0xdc, virtual false, abstract: false, final false
  static inline void add_TrackingLost(::System::Action* value);

  /// @brief Method add_VrFocusAcquired, addr 0xfb4408, size 0xdc, virtual false, abstract: false, final false
  static inline void add_VrFocusAcquired(::System::Action* value);

  /// @brief Method add_VrFocusLost, addr 0xfb45c0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsSimultaneousHandsAndControllersSupported, addr 0xfb92c4, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsSimultaneousHandsAndControllersSupported();

  /// @brief Method get_audioInId, addr 0xfb681c, size 0x50, virtual false, abstract: false, final false
  static inline ::StringW get_audioInId();

  /// @brief Method get_audioOutId, addr 0xfb67cc, size 0x50, virtual false, abstract: false, final false
  static inline ::StringW get_audioOutId();

  /// @brief Method get_batteryLevel, addr 0xfb7434, size 0x8c, virtual false, abstract: false, final false
  static inline float_t get_batteryLevel();

  /// @brief Method get_batteryStatus, addr 0xfb754c, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t get_batteryStatus();

  /// @brief Method get_batteryTemperature, addr 0xfb74c0, size 0x8c, virtual false, abstract: false, final false
  static inline float_t get_batteryTemperature();

  /// @brief Method get_boundary, addr 0xfb3ac0, size 0x58, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRBoundary* get_boundary();

  /// @brief Method get_chromatic, addr 0xfb69f8, size 0x8c, virtual false, abstract: false, final false
  inline bool get_chromatic();

  /// @brief Method get_colorGamut, addr 0xfb6cb0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRManager__ColorSpace get_colorGamut();

  /// @brief Method get_cpuLevel, addr 0xfb789c, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t get_cpuLevel();

  /// @brief Method get_display, addr 0xfb3958, size 0x58, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRDisplay* get_display();

  /// @brief Method get_eyeFovPremultipliedAlphaModeEnabled, addr 0xfb6f90, size 0x50, virtual false, abstract: false, final false
  static inline bool get_eyeFovPremultipliedAlphaModeEnabled();

  /// @brief Method get_eyeTextureFormat, addr 0xfb7b60, size 0x50, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__EyeTextureFormat get_eyeTextureFormat();

  /// @brief Method get_eyeTrackedFoveatedRenderingEnabled, addr 0xfb7c58, size 0x50, virtual false, abstract: false, final false
  static inline bool get_eyeTrackedFoveatedRenderingEnabled();

  /// @brief Method get_eyeTrackedFoveatedRenderingSupported, addr 0xfb7c08, size 0x50, virtual false, abstract: false, final false
  static inline bool get_eyeTrackedFoveatedRenderingSupported();

  /// @brief Method get_fixedFoveatedRenderingLevel, addr 0xfb8054, size 0x50, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__FixedFoveatedRenderingLevel get_fixedFoveatedRenderingLevel();

  /// @brief Method get_fixedFoveatedRenderingSupported, addr 0xfb8004, size 0x50, virtual false, abstract: false, final false
  static inline bool get_fixedFoveatedRenderingSupported();

  /// @brief Method get_foveatedRenderingLevel, addr 0xfb7f5c, size 0x50, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__FoveatedRenderingLevel get_foveatedRenderingLevel();

  /// @brief Method get_gpuLevel, addr 0xfb79b8, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t get_gpuLevel();

  /// @brief Method get_gpuUtilLevel, addr 0xfb8394, size 0xb0, virtual false, abstract: false, final false
  static inline float_t get_gpuUtilLevel();

  /// @brief Method get_gpuUtilSupported, addr 0xfb8344, size 0x50, virtual false, abstract: false, final false
  static inline bool get_gpuUtilSupported();

  /// @brief Method get_hasInputFocus, addr 0xfb69a8, size 0x50, virtual false, abstract: false, final false
  static inline bool get_hasInputFocus();

  /// @brief Method get_hasVrFocus, addr 0xfb686c, size 0xd8, virtual false, abstract: false, final false
  static inline bool get_hasVrFocus();

  /// @brief Method get_headPoseRelativeOffsetRotation, addr 0xfb6d78, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headPoseRelativeOffsetRotation();

  /// @brief Method get_headPoseRelativeOffsetTranslation, addr 0xfb6e6c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headPoseRelativeOffsetTranslation();

  /// @brief Method get_instance, addr 0xfb38a4, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRManager> get_instance();

  /// @brief Method get_isHmdPresent, addr 0xfb6690, size 0xd8, virtual false, abstract: false, final false
  static inline bool get_isHmdPresent();

  /// @brief Method get_isPowerSavingActive, addr 0xfb7ad4, size 0x8c, virtual false, abstract: false, final false
  static inline bool get_isPowerSavingActive();

  /// @brief Method get_isSupportedPlatform, addr 0xfb92e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isSupportedPlatform();

  /// @brief Method get_isUserPresent, addr 0xfb92f8, size 0xd8, virtual false, abstract: false, final false
  inline bool get_isUserPresent();

  /// @brief Method get_monoscopic, addr 0xfb6b14, size 0x90, virtual false, abstract: false, final false
  inline bool get_monoscopic();

  /// @brief Method get_nativeColorGamut, addr 0xfb6d20, size 0x50, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRManager__ColorSpace get_nativeColorGamut();

  /// @brief Method get_pluginVersion, addr 0xfb953c, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Version* get_pluginVersion();

  /// @brief Method get_profile, addr 0xfb3c28, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRProfile> get_profile();

  /// @brief Method get_runtimeSettings, addr 0xfb3b74, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRRuntimeSettings> get_runtimeSettings();

  /// @brief Method get_sdkVersion, addr 0xfb958c, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Version* get_sdkVersion();

  /// @brief Method get_sharpenType, addr 0xfb6c40, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__LayerSharpenType get_sharpenType();

  /// @brief Method get_suggestedCpuPerfLevel, addr 0xfb7664, size 0x8c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__ProcessorPerformanceLevel get_suggestedCpuPerfLevel();

  /// @brief Method get_suggestedGpuPerfLevel, addr 0xfb7780, size 0x8c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__ProcessorPerformanceLevel get_suggestedGpuPerfLevel();

  /// @brief Method get_systemHeadsetType, addr 0xfb8444, size 0x50, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__SystemHeadsetType get_systemHeadsetType();

  /// @brief Method get_tiledMultiResLevel, addr 0xfb829c, size 0x50, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRManager__TiledMultiResLevel get_tiledMultiResLevel();

  /// @brief Method get_tiledMultiResSupported, addr 0xfb824c, size 0x50, virtual false, abstract: false, final false
  static inline bool get_tiledMultiResSupported();

  /// @brief Method get_tracker, addr 0xfb3a0c, size 0x58, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTracker* get_tracker();

  /// @brief Method get_trackingOriginType, addr 0xfb9198, size 0x90, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRManager__TrackingOrigin get_trackingOriginType();

  /// @brief Method get_useDynamicFixedFoveatedRendering, addr 0xfb81a4, size 0x50, virtual false, abstract: false, final false
  static inline bool get_useDynamicFixedFoveatedRendering();

  /// @brief Method get_useDynamicFoveatedRendering, addr 0xfb80fc, size 0x50, virtual false, abstract: false, final false
  static inline bool get_useDynamicFoveatedRendering();

  /// @brief Method get_utilitiesVersion, addr 0xfb94e4, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Version* get_utilitiesVersion();

  /// @brief Method get_volumeLevel, addr 0xfb75d8, size 0x8c, virtual false, abstract: false, final false
  static inline float_t get_volumeLevel();

  /// @brief Method get_vsyncCount, addr 0xfb7318, size 0x8c, virtual false, abstract: false, final false
  inline int32_t get_vsyncCount();

  /// @brief Method get_xrApi, addr 0xfb7228, size 0x50, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRManager__XrApi get_xrApi();

  /// @brief Method get_xrInstance, addr 0xfb7278, size 0x50, virtual false, abstract: false, final false
  inline uint64_t get_xrInstance();

  /// @brief Method get_xrSession, addr 0xfb72c8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_AudioInChanged, addr 0xfb4d7c, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_AudioInChanged(::System::Action* value);

  /// @brief Method remove_AudioOutChanged, addr 0xfb4bc4, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_AudioOutChanged(::System::Action* value);

  /// @brief Method remove_DisplayRefreshRateChanged, addr 0xfb52bc, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_DisplayRefreshRateChanged(::System::Action_2<float_t, float_t>* value);

  /// @brief Method remove_HMDAcquired, addr 0xfb3e04, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_HMDAcquired(::System::Action* value);

  /// @brief Method remove_HMDLost, addr 0xfb3fbc, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_HMDLost(::System::Action* value);

  /// @brief Method remove_HMDMounted, addr 0xfb4174, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_HMDMounted(::System::Action* value);

  /// @brief Method remove_HMDUnmounted, addr 0xfb432c, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_HMDUnmounted(::System::Action* value);

  /// @brief Method remove_HSWDismissed, addr 0xfb65b4, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_HSWDismissed(::System::Action* value);

  /// @brief Method remove_InputFocusAcquired, addr 0xfb4854, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_InputFocusAcquired(::System::Action* value);

  /// @brief Method remove_InputFocusLost, addr 0xfb4a0c, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_InputFocusLost(::System::Action* value);

  /// @brief Method remove_SceneCaptureComplete, addr 0xfb63e4, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_SceneCaptureComplete(::System::Action_2<uint64_t, bool>* value);

  /// @brief Method remove_ShareSpacesComplete, addr 0xfb6014, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_SpaceEraseComplete, addr 0xfb5e2c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_SpaceListSaveComplete, addr 0xfb61fc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_SpaceQueryComplete, addr 0xfb5a5c, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_SpaceQueryComplete(::System::Action_2<uint64_t, bool>* value);

  /// @brief Method remove_SpaceQueryResults, addr 0xfb5874, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_SpaceQueryResults(::System::Action_1<uint64_t>* value);

  /// @brief Method remove_SpaceSaveComplete, addr 0xfb5c44, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_SpaceSaveComplete(::System::Action_4<uint64_t, ::GlobalNamespace::OVRSpace, bool, ::System::Guid>* value);

  /// @brief Method remove_SpaceSetComponentStatusComplete, addr 0xfb568c, size 0xf4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method remove_SpatialAnchorCreateComplete, addr 0xfb54a4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_TrackingAcquired, addr 0xfb4f34, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_TrackingAcquired(::System::Action* value);

  /// @brief Method remove_TrackingLost, addr 0xfb50ec, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_TrackingLost(::System::Action* value);

  /// @brief Method remove_VrFocusAcquired, addr 0xfb44e4, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_VrFocusAcquired(::System::Action* value);

  /// @brief Method remove_VrFocusLost, addr 0xfb469c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_boundary, addr 0xfb3b18, size 0x5c, virtual false, abstract: false, final false
  static inline void set_boundary(::GlobalNamespace::OVRBoundary* value);

  /// @brief Method set_chromatic, addr 0xfb6a84, size 0x90, virtual false, abstract: false, final false
  inline void set_chromatic(bool value);

  /// @brief Method set_colorGamut, addr 0xfb6cb8, size 0x68, virtual false, abstract: false, final false
  inline void set_colorGamut(::GlobalNamespace::__OVRManager__ColorSpace value);

  /// @brief Method set_cpuLevel, addr 0xfb7928, size 0x90, virtual false, abstract: false, final false
  static inline void set_cpuLevel(int32_t value);

  /// @brief Method set_display, addr 0xfb39b0, size 0x5c, virtual false, abstract: false, final false
  static inline void set_display(::GlobalNamespace::OVRDisplay* value);

  /// @brief Method set_eyeFovPremultipliedAlphaModeEnabled, addr 0xfb6fe0, size 0x58, virtual false, abstract: false, final false
  static inline void set_eyeFovPremultipliedAlphaModeEnabled(bool value);

  /// @brief Method set_eyeTextureFormat, addr 0xfb7bb0, size 0x58, virtual false, abstract: false, final false
  static inline void set_eyeTextureFormat(::GlobalNamespace::__OVRManager__EyeTextureFormat value);

  /// @brief Method set_eyeTrackedFoveatedRenderingEnabled, addr 0xfb7ca8, size 0x1d8, virtual false, abstract: false, final false
  static inline void set_eyeTrackedFoveatedRenderingEnabled(bool value);

  /// @brief Method set_fixedFoveatedRenderingLevel, addr 0xfb80a4, size 0x58, virtual false, abstract: false, final false
  static inline void set_fixedFoveatedRenderingLevel(::GlobalNamespace::__OVRManager__FixedFoveatedRenderingLevel value);

  /// @brief Method set_foveatedRenderingLevel, addr 0xfb7fac, size 0x58, virtual false, abstract: false, final false
  static inline void set_foveatedRenderingLevel(::GlobalNamespace::__OVRManager__FoveatedRenderingLevel value);

  /// @brief Method set_gpuLevel, addr 0xfb7a44, size 0x90, virtual false, abstract: false, final false
  static inline void set_gpuLevel(int32_t value);

  /// @brief Method set_hasVrFocus, addr 0xfb6944, size 0x64, virtual false, abstract: false, final false
  static inline void set_hasVrFocus(bool value);

  /// @brief Method set_headPoseRelativeOffsetRotation, addr 0xfb6d84, size 0xe8, virtual false, abstract: false, final false
  inline void set_headPoseRelativeOffsetRotation(::UnityEngine::Vector3 value);

  /// @brief Method set_headPoseRelativeOffsetTranslation, addr 0xfb6e78, size 0x118, virtual false, abstract: false, final false
  inline void set_headPoseRelativeOffsetTranslation(::UnityEngine::Vector3 value);

  /// @brief Method set_instance, addr 0xfb38fc, size 0x5c, virtual false, abstract: false, final false
  static inline void set_instance(::GlobalNamespace::OVRManager* value);

  /// @brief Method set_isHmdPresent, addr 0xfb6768, size 0x64, virtual false, abstract: false, final false
  static inline void set_isHmdPresent(bool value);

  /// @brief Method set_isSupportedPlatform, addr 0xfb92ec, size 0xc, virtual false, abstract: false, final false
  inline void set_isSupportedPlatform(bool value);

  /// @brief Method set_isUserPresent, addr 0xfb93d0, size 0x64, virtual false, abstract: false, final false
  inline void set_isUserPresent(bool value);

  /// @brief Method set_monoscopic, addr 0xfb6ba4, size 0x9c, virtual false, abstract: false, final false
  inline void set_monoscopic(bool value);

  /// @brief Method set_runtimeSettings, addr 0xfb3bcc, size 0x5c, virtual false, abstract: false, final false
  static inline void set_runtimeSettings(::GlobalNamespace::OVRRuntimeSettings* value);

  /// @brief Method set_sharpenType, addr 0xfb6c48, size 0x68, virtual false, abstract: false, final false
  inline void set_sharpenType(::GlobalNamespace::__OVRPlugin__LayerSharpenType value);

  /// @brief Method set_suggestedCpuPerfLevel, addr 0xfb76f0, size 0x90, virtual false, abstract: false, final false
  static inline void set_suggestedCpuPerfLevel(::GlobalNamespace::__OVRManager__ProcessorPerformanceLevel value);

  /// @brief Method set_suggestedGpuPerfLevel, addr 0xfb780c, size 0x90, virtual false, abstract: false, final false
  static inline void set_suggestedGpuPerfLevel(::GlobalNamespace::__OVRManager__ProcessorPerformanceLevel value);

  /// @brief Method set_tiledMultiResLevel, addr 0xfb82ec, size 0x58, virtual false, abstract: false, final false
  static inline void set_tiledMultiResLevel(::GlobalNamespace::__OVRManager__TiledMultiResLevel value);

  /// @brief Method set_tracker, addr 0xfb3a64, size 0x5c, virtual false, abstract: false, final false
  static inline void set_tracker(::GlobalNamespace::OVRTracker* value);

  /// @brief Method set_trackingOriginType, addr 0xfb9228, size 0x9c, virtual false, abstract: false, final false
  inline void set_trackingOriginType(::GlobalNamespace::__OVRManager__TrackingOrigin value);

  /// @brief Method set_useDynamicFixedFoveatedRendering, addr 0xfb81f4, size 0x58, virtual false, abstract: false, final false
  static inline void set_useDynamicFixedFoveatedRendering(bool value);

  /// @brief Method set_useDynamicFoveatedRendering, addr 0xfb814c, size 0x58, virtual false, abstract: false, final false
  static inline void set_useDynamicFoveatedRendering(bool value);

  /// @brief Method set_vsyncCount, addr 0xfb73a4, size 0x90, virtual false, abstract: false, final false
