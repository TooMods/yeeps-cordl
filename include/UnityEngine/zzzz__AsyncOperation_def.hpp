...
public:
  ...
  /// @brief Method Finalize, addr 0x283d268, size 0xbc, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method InternalDestroy, addr 0x283d324, size 0x3c, virtual false, abstract: false, final false
  static inline void InternalDestroy(void* ptr);

  /// @brief Method InvokeCompletionEvent, addr 0x283d360, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x283d5f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_completed, addr 0x283d390, size 0xfc, virtual false, abstract: false, final false
  inline void add_completed(::System::Action_1<::UnityEngine::AsyncOperation*>* value);

  /// @brief Method get_isDone, addr 0x283d48c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_isDone();

  /// @brief Method get_progress, addr 0x283d570, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_progress();

  /// @brief Method remove_completed, addr 0x283d4c8, size 0xa8, virtual false, abstract: false, final false
  inline void remove_completed(::System::Action_1<::UnityEngine::AsyncOperation*>* value);

  /// @brief Method set_allowSceneActivation, addr 0x283d5ac, size 0x44, virtual false, abstract: false, final false
