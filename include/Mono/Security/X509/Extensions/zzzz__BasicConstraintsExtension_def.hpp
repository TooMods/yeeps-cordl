...
public:
  ...
  /// @brief Method Decode, addr 0x246a4b8, size 0x138, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x246a5f0, size 0x134, virtual true, abstract: false, final false
  inline void Encode();
  ...
  /// @brief Method ToString, addr 0x246a72c, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24688c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_CertificateAuthority, addr 0x246a724, size 0x8, virtual false, abstract: false, final false
