...
public:
  ...
  /// @brief Method GetCharacters, addr 0x2474400, size 0xe8, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::HashSet_1<uint32_t>* GetCharacters(::UnityEngine::TextAsset* file);

  /// @brief Method LoadLineBreakingRules, addr 0x2474064, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24744e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_followingCharactersLookup, addr 0x2474378, size 0x88, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::HashSet_1<uint32_t>* get_followingCharactersLookup();

  /// @brief Method get_leadingCharactersLookup, addr 0x2473fdc, size 0x88, virtual false, abstract: false, final false
