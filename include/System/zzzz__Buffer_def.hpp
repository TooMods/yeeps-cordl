...
public:
  // Declarations
  /// @brief Method BlockCopy, addr 0x2bf97d8, size 0x1c0, virtual false, abstract: false, final false
  static inline void BlockCopy(::System::Array* src, int32_t srcOffset, ::System::Array* dst, int32_t dstOffset, int32_t count);

  /// @brief Method ByteLength, addr 0x2bf973c, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t ByteLength(::System::Array* array);

  /// @brief Method IndexOfByte, addr 0x2bf9560, size 0x110, virtual false, abstract: false, final false
  static inline int32_t IndexOfByte(::cordl_internals::Ptr<uint8_t> src, uint8_t value, int32_t index, int32_t count);

  /// @brief Method InternalBlockCopy, addr 0x2bf955c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalMemcpy, addr 0x2bf9738, size 0x4, virtual false, abstract: false, final false
  static inline void InternalMemcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t count);

  /// @brief Method Memcpy, addr 0x2bf96cc, size 0x6c, virtual false, abstract: false, final false
  static inline void Memcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t len, bool useICall);

  /// @brief Method Memcpy, addr 0x2bf9698, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method Memmove, addr 0x2bf9a18, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method MemoryCopy, addr 0x2bf9998, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ZeroMemory, addr 0x2bf9674, size 0x24, virtual false, abstract: false, final false
  static inline void ZeroMemory(::cordl_internals::Ptr<uint8_t> src, int64_t len);

  /// @brief Method _ByteLength, addr 0x2bf9670, size 0x4, virtual false, abstract: false, final false
  static inline int32_t _ByteLength(::System::Array* array);

  /// @brief Method memcpy1, addr 0x2bf9b4c, size 0xac, virtual false, abstract: false, final false
  static inline void memcpy1(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy2, addr 0x2bf9ad0, size 0x7c, virtual false, abstract: false, final false
  static inline void memcpy2(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy4, addr 0x2bf9a44, size 0x8c, virtual false, abstract: false, final false
