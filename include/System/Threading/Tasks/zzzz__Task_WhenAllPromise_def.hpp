...
public:
  ...
  /// @brief Method Invoke, addr 0xedbef4, size 0x2c8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xedae20, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Threading::Tasks::Task*, ::Array<::System::Threading::Tasks::Task*>*> tasks);

  /// @brief Method get_InvokeMayRunArbitraryCode, addr 0xedc230, size 0x8, virtual true, abstract: false, final true
  inline bool get_InvokeMayRunArbitraryCode();

  /// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion, addr 0xedc1bc, size 0x74, virtual true, abstract: false, final false
