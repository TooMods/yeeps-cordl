...
public:
  ...
  /// @brief Method DoAssemblyLoad, addr 0x2e7b6a0, size 0x98, virtual false, abstract: false, final false
  inline void DoAssemblyLoad(::System::Reflection::Assembly* assembly);

  /// @brief Method DoAssemblyResolve, addr 0x2e7b738, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method DoDomainUnload, addr 0x2e7be50, size 0x24, virtual false, abstract: false, final false
  inline void DoDomainUnload();

  /// @brief Method DoResourceResolve, addr 0x2e7bd18, size 0x138, virtual false, abstract: false, final false
  inline ::System::Reflection::Assembly* DoResourceResolve(::StringW name, ::System::Reflection::Assembly* requesting);

  /// @brief Method DoTypeResolve, addr 0x2e7ba48, size 0x2d0, virtual false, abstract: false, final false
  inline ::System::Reflection::Assembly* DoTypeResolve(::StringW name);

  /// @brief Method GetAssemblies, addr 0x2e7ae00, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Reflection::Assembly*, ::Array<::System::Reflection::Assembly*>*> GetAssemblies();

  /// @brief Method GetAssemblies, addr 0x2e7adf8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Reflection::Assembly*, ::Array<::System::Reflection::Assembly*>*> GetAssemblies(bool refOnly);

  /// @brief Method GetData, addr 0x2e7ae08, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* GetData(::StringW name);

  /// @brief Method GetMarshalledDomainObjRef, addr 0x2e7be74, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMarshalledDomainObjRef();

  /// @brief Method GetProcessGuid, addr 0x2e7b5f4, size 0x88, virtual false, abstract: false, final false
  static inline ::StringW GetProcessGuid();

  /// @brief Method InitializeLifetimeService, addr 0x2e7ae0c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* InitializeLifetimeService();

  /// @brief Method InternalGetContext, addr 0x2e7b458, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::Contexts::Context* InternalGetContext();

  /// @brief Method InternalGetDefaultContext, addr 0x2e7b45c, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::Contexts::Context* InternalGetDefaultContext();

  /// @brief Method InternalGetProcessGuid, addr 0x2e7b460, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW InternalGetProcessGuid(::StringW newguid);

  /// @brief Method InternalIsFinalizingForUnload, addr 0x2e7b67c, size 0x4, virtual false, abstract: false, final false
  static inline bool InternalIsFinalizingForUnload(int32_t domain_id);

  /// @brief Method InternalPopDomainRef, addr 0x2e7b450, size 0x4, virtual false, abstract: false, final false
  static inline void InternalPopDomainRef();

  /// @brief Method InternalPushDomainRefByID, addr 0x2e7b44c, size 0x4, virtual false, abstract: false, final false
  static inline void InternalPushDomainRefByID(int32_t domain_id);

  /// @brief Method InternalSetContext, addr 0x2e7b454, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetDomain, addr 0x2e7b448, size 0x4, virtual false, abstract: false, final false
  static inline ::System::AppDomain* InternalSetDomain(::System::AppDomain* context);

  /// @brief Method InternalSetDomainByID, addr 0x2e7b444, size 0x4, virtual false, abstract: false, final false
  static inline ::System::AppDomain* InternalSetDomainByID(int32_t domain_id);

  /// @brief Method InvokeInDomainByID, addr 0x2e7b464, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAppXModel, addr 0x2e7addc, size 0x8, virtual false, abstract: false, final false
  static inline bool IsAppXModel();

  /// @brief Method IsFinalizingForUnload, addr 0x2e7b680, size 0x14, virtual false, abstract: false, final false
  inline bool IsFinalizingForUnload();

  /// @brief Method Load, addr 0x2e7ae1c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Reflection::Assembly* Load(::System::Reflection::AssemblyName* assemblyRef);

  /// @brief Method Load, addr 0x2e7ae24, size 0x3e0, virtual true, abstract: false, final true
  inline ::System::Reflection::Assembly* Load(::System::Reflection::AssemblyName* assemblyRef, ::System::Security::Policy::Evidence* assemblySecurity);

  /// @brief Method Load, addr 0x2e7b310, size 0x24, virtual true, abstract: false, final true
  inline ::System::Reflection::Assembly* Load(::StringW assemblyString);

  /// @brief Method Load, addr 0x2e7b334, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAssembly, addr 0x2e7ae14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSatellite, addr 0x2e7b204, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMessageInDomain, addr 0x2e7bf4c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2e7b69c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e7ade4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_DomainUnload, addr 0x2e7c07c, size 0x98, virtual true, abstract: false, final true
  inline void add_DomainUnload(::System::EventHandler* value);

  /// @brief Method add_UnhandledException, addr 0x2e7c490, size 0x98, virtual true, abstract: false, final true
  inline void add_UnhandledException(::System::UnhandledExceptionEventHandler* value);

  /// @brief Method getCurDomain, addr 0x2e7adf0, size 0x4, virtual false, abstract: false, final false
  static inline ::System::AppDomain* getCurDomain();

  /// @brief Method getDomainID, addr 0x2e7b694, size 0x8, virtual false, abstract: false, final false
  inline int32_t getDomainID();

  /// @brief Method getFriendlyName, addr 0x2e7adec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentDomain, addr 0x2e7adf4, size 0x4, virtual false, abstract: false, final false
  static inline ::System::AppDomain* get_CurrentDomain();

  /// @brief Method get_IsFullyTrusted, addr 0x2e7c5c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsFullyTrusted();

  /// @brief Method get_IsHomogenous, addr 0x2e7c5c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsHomogenous();

  /// @brief Method remove_DomainUnload, addr 0x2e7c288, size 0x98, virtual true, abstract: false, final true
  inline void remove_DomainUnload(::System::EventHandler* value);

  /// @brief Method remove_UnhandledException, addr 0x2e7c528, size 0x98, virtual true, abstract: false, final true
