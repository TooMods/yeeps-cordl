...
public:
  ...
  /// @brief Method CalcAlongAxis, addr 0x26eee4c, size 0x2a4, virtual false, abstract: false, final false
  inline void CalcAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method GetChildSizes, addr 0x26efaa0, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method SetChildrenAlongAxis, addr 0x26ef108, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26eee20, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_childControlHeight, addr 0x26ef910, size 0x8, virtual false, abstract: false, final false
  inline bool get_childControlHeight();

  /// @brief Method get_childControlWidth, addr 0x26ef8ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_childControlWidth();

  /// @brief Method get_childForceExpandHeight, addr 0x26ef848, size 0x8, virtual false, abstract: false, final false
  inline bool get_childForceExpandHeight();

  /// @brief Method get_childForceExpandWidth, addr 0x26ef7e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_childForceExpandWidth();

  /// @brief Method get_childScaleHeight, addr 0x26ef9d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_childScaleHeight();

  /// @brief Method get_childScaleWidth, addr 0x26ef974, size 0x8, virtual false, abstract: false, final false
  inline bool get_childScaleWidth();

  /// @brief Method get_reverseArrangement, addr 0x26efa3c, size 0x8, virtual false, abstract: false, final false
  inline bool get_reverseArrangement();

  /// @brief Method get_spacing, addr 0x26ef780, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spacing();

  /// @brief Method set_childControlHeight, addr 0x26ef918, size 0x5c, virtual false, abstract: false, final false
  inline void set_childControlHeight(bool value);

  /// @brief Method set_childControlWidth, addr 0x26ef8b4, size 0x5c, virtual false, abstract: false, final false
  inline void set_childControlWidth(bool value);

  /// @brief Method set_childForceExpandHeight, addr 0x26ef850, size 0x5c, virtual false, abstract: false, final false
  inline void set_childForceExpandHeight(bool value);

  /// @brief Method set_childForceExpandWidth, addr 0x26ef7ec, size 0x5c, virtual false, abstract: false, final false
  inline void set_childForceExpandWidth(bool value);

  /// @brief Method set_childScaleHeight, addr 0x26ef9e0, size 0x5c, virtual false, abstract: false, final false
  inline void set_childScaleHeight(bool value);

  /// @brief Method set_childScaleWidth, addr 0x26ef97c, size 0x5c, virtual false, abstract: false, final false
  inline void set_childScaleWidth(bool value);

  /// @brief Method set_reverseArrangement, addr 0x26efa44, size 0x5c, virtual false, abstract: false, final false
  inline void set_reverseArrangement(bool value);

  /// @brief Method set_spacing, addr 0x26ef788, size 0x5c, virtual false, abstract: false, final false
