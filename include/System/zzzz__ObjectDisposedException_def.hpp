...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2efcfa8, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2efce1c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2efcf20, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2efceb4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectName);

  /// @brief Method .ctor, addr 0x2efce7c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectName, ::StringW message);

  /// @brief Method get_Message, addr 0x2efd198, size 0xd4, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_ObjectName, addr 0x2efd0b0, size 0x54, virtual false, abstract: false, final false
