...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x10e5030, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::System::Threading::ThreadStart* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x10e4f74, size 0xbc, virtual false, abstract: false, final false
