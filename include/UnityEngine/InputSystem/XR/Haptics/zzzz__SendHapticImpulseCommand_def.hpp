...
public:
  ...
  /// @brief Method Create, addr 0x1d3868c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1d3cb10, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1d3cb40, size 0x30, virtual true, abstract: false, final true
