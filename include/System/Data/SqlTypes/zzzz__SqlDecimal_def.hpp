...
public:
  ...
  /// @brief Method AddULong, addr 0x1e32988, size 0x1a0, virtual false, abstract: false, final false
  inline void AddULong(uint32_t ulAdd);

  /// @brief Method AdjustScale, addr 0x1e332f8, size 0x310, virtual false, abstract: false, final false
  inline void AdjustScale(int32_t digits, bool fRound);

  /// @brief Method BGetPrecUI4, addr 0x1e31440, size 0x138, virtual false, abstract: false, final false
  static inline uint8_t BGetPrecUI4(uint32_t value);

  /// @brief Method BGetPrecUI8, addr 0x1e31644, size 0x244, virtual false, abstract: false, final false
  static inline uint8_t BGetPrecUI8(uint64_t dwlVal);

  /// @brief Method CalculatePrecision, addr 0x1e30d78, size 0x218, virtual false, abstract: false, final false
  inline uint8_t CalculatePrecision();

  /// @brief Method ChFromDigit, addr 0x1e322e8, size 0x8, virtual false, abstract: false, final false
  static inline char16_t ChFromDigit(uint32_t uiDigit);

  /// @brief Method CheckValidPrecScale, addr 0x1e319cc, size 0xe4, virtual false, abstract: false, final false
  static inline void CheckValidPrecScale(uint8_t bPrec, uint8_t bScale);

  /// @brief Method CompareNm, addr 0x1e35708, size 0x1e4, virtual false, abstract: false, final false
  inline ::System::Data::SqlTypes::EComparison CompareNm(::System::Data::SqlTypes::SqlDecimal snumOp);

  /// @brief Method CompareTo, addr 0x1e361e4, size 0x1a8, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlDecimal value);

  /// @brief Method CompareTo, addr 0x1e360e0, size 0x104, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method DWL, addr 0x1e356fc, size 0xc, virtual false, abstract: false, final false
  static inline uint64_t DWL(uint32_t lo, uint32_t hi);

  /// @brief Method DivByULong, addr 0x1e3535c, size 0x18c, virtual false, abstract: false, final false
  inline uint32_t DivByULong(uint32_t iDivisor);

  /// @brief Method Equals, addr 0x1e3638c, size 0x12c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FGt10_38, addr 0x1e33760, size 0x74, virtual false, abstract: false, final false
  inline bool FGt10_38();

  /// @brief Method FGt10_38, addr 0x1e3527c, size 0x88, virtual false, abstract: false, final false
  inline bool FGt10_38(::ArrayW<uint32_t, ::Array<uint32_t>*> rglData);

  /// @brief Method FZero, addr 0x1e31ab0, size 0x20, virtual false, abstract: false, final false
  inline bool FZero();

  /// @brief Method GetHashCode, addr 0x1e364b8, size 0x110, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x1e3680c, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method GreaterThan, addr 0x1e35be0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method HI, addr 0x1e356f0, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t HI(uint64_t x);

  /// @brief Method LAbsCmp, addr 0x1e33608, size 0x158, virtual false, abstract: false, final false
  inline int32_t LAbsCmp(::System::Data::SqlTypes::SqlDecimal snumOp);

  /// @brief Method LO, addr 0x1e356f8, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t LO(uint64_t x);

  /// @brief Method LessThan, addr 0x1e35b2c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method MpDiv, addr 0x1e344ac, size 0x830, virtual false, abstract: false, final false
  ...
  /// @brief Method MpDiv1, addr 0x1e32214, size 0xd4, virtual false, abstract: false, final false
  static inline void MpDiv1(::ArrayW<uint32_t, ::Array<uint32_t>*> rgulU, ByRef<int32_t> ciulU, uint32_t iulD, ByRef<uint32_t> iulR);

  /// @brief Method MpMove, addr 0x1e35520, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method MpMul1, addr 0x1e355fc, size 0xf4, virtual false, abstract: false, final false
  static inline void MpMul1(::ArrayW<uint32_t, ::Array<uint32_t>*> piulD, ByRef<int32_t> ciulD, uint32_t iulX);

  /// @brief Method MpNormalize, addr 0x1e355b0, size 0x4c, virtual false, abstract: false, final false
  static inline void MpNormalize(::ArrayW<uint32_t, ::Array<uint32_t>*> rgulU, ByRef<int32_t> ciulU);

  /// @brief Method MpSet, addr 0x1e35584, size 0x2c, virtual false, abstract: false, final false
  static inline void MpSet(::ArrayW<uint32_t, ::Array<uint32_t>*> rgulD, ByRef<int32_t> ciulD, uint32_t iulN);

  /// @brief Method MultByULong, addr 0x1e3279c, size 0x1ec, virtual false, abstract: false, final false
  inline void MultByULong(uint32_t uiMultiplier);

  /// @brief Method Parse, addr 0x1e322f0, size 0x434, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDecimal Parse(::StringW s);

  /// @brief Method SetPositive, addr 0x1e31ad0, size 0x68, virtual false, abstract: false, final false
  inline void SetPositive();

  /// @brief Method SetSignBit, addr 0x1e31d84, size 0x84, virtual false, abstract: false, final false
  inline void SetSignBit(bool fPositive);

  /// @brief Method SetToZero, addr 0x1e32724, size 0x78, virtual false, abstract: false, final false
  inline void SetToZero();

  /// @brief Method StoreFromWorkingArray, addr 0x1e35304, size 0x58, virtual false, abstract: false, final false
  inline void StoreFromWorkingArray(::ArrayW<uint32_t, ::Array<uint32_t>*> rguiData);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x1e365c8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x1e365d0, size 0x164, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x1e36734, size 0xd8, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToDecimal, addr 0x1e31bac, size 0x124, virtual false, abstract: false, final false
  inline ::System::Decimal ToDecimal();

  /// @brief Method ToDouble, addr 0x1e32b28, size 0x130, virtual false, abstract: false, final false
  inline double_t ToDouble();

  /// @brief Method ToSqlDouble, addr 0x1e35c94, size 0x80, virtual false, abstract: false, final false
  inline ::System::Data::SqlTypes::SqlDouble ToSqlDouble();

  /// @brief Method ToSqlInt64, addr 0x1e35da4, size 0x80, virtual false, abstract: false, final false
  inline ::System::Data::SqlTypes::SqlInt64 ToSqlInt64();

  /// @brief Method ToSqlMoney, addr 0x1e35fc0, size 0x80, virtual false, abstract: false, final false
  inline ::System::Data::SqlTypes::SqlMoney ToSqlMoney();

  /// @brief Method ToString, addr 0x1e31f38, size 0x2dc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method VerifyPrecision, addr 0x1e30f90, size 0x21c, virtual false, abstract: false, final false
  inline bool VerifyPrecision(uint8_t precision);

  /// @brief Method ZeroToMaxLen, addr 0x1e34cdc, size 0x7c, virtual false, abstract: false, final false
  static inline void ZeroToMaxLen(::ArrayW<uint32_t, ::Array<uint32_t>*> rgulData, int32_t cUI4sCur);

  /// @brief Method .ctor, addr 0x1e311ac, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(bool fNull);

  /// @brief Method .ctor, addr 0x1e31888, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint32_t, ::Array<uint32_t>*> rglData, uint8_t bLen, uint8_t bPrec, uint8_t bScale, bool fPositive);

  /// @brief Method .ctor, addr 0x1e31214, size 0x158, virtual false, abstract: false, final false
  inline void _ctor(::System::Decimal value);

  /// @brief Method .ctor, addr 0x1e3136c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method .ctor, addr 0x1e31578, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Data, addr 0x1e31e5c, size 0xdc, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_Data();

  /// @brief Method get_IsNull, addr 0x1e31b38, size 0x70, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_IsPositive, addr 0x1e31cd0, size 0xb4, virtual false, abstract: false, final false
  inline bool get_IsPositive();

  /// @brief Method get_Scale, addr 0x1e31e08, size 0x54, virtual false, abstract: false, final false
  inline uint8_t get_Scale();

  /// @brief Method get_Value, addr 0x1e31ba8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x1e32db8, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Division, addr 0x1e340b8, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1e358ec, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThan, addr 0x1e35a6c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e34d58, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e34e00, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e34f08, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e35010, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e350b8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e32c58, size 0x18, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDecimal op_Implicit___System__Data__SqlTypes__SqlDecimal(::System::Decimal x);

  /// @brief Method op_Implicit, addr 0x1e32c70, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDecimal op_Implicit___System__Data__SqlTypes__SqlDecimal(int64_t x);

  /// @brief Method op_LessThan, addr 0x1e359ac, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Multiply, addr 0x1e338b4, size 0x804, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Subtraction, addr 0x1e337d4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_UnaryNegation, addr 0x1e32cd8, size 0xe0, virtual false, abstract: false, final false
