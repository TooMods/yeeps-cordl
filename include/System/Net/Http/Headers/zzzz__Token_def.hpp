...
public:
  ...
  /// @brief Method ToString, addr 0x1627670, size 0x68, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x161f9bc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EndPosition, addr 0x1627654, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_EndPosition();

  /// @brief Method get_Kind, addr 0x1627664, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::__Token__Type get_Kind();

  /// @brief Method get_StartPosition, addr 0x1627644, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_StartPosition();

  /// @brief Method op_Implicit, addr 0x162766c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EndPosition, addr 0x162765c, size 0x8, virtual false, abstract: false, final false
  inline void set_EndPosition(int32_t value);

  /// @brief Method set_StartPosition, addr 0x162764c, size 0x8, virtual false, abstract: false, final false
