...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b40c8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(void* c_message);

  /// @brief Method GetLinkedAccountList, addr 0x19b408c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b4034, size 0x58, virtual false, abstract: false, final false
