...
public:
  ...
  /// @brief Method .ctor, addr 0x1b2e7dc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReturnType, addr 0x1b2e820, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x1b2e818, size 0x8, virtual true, abstract: false, final false
