...
public:
  ...
  /// @brief Method CanBeActivated, addr 0x2092868, size 0x3c, virtual true, abstract: false, final true
  inline bool CanBeActivated();

  /// @brief Method Every, addr 0x2092228, size 0xa4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IVisualElementScheduledItem* Every(int64_t intervalMs);

  /// @brief Method ExecuteLater, addr 0x2092660, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method OnItemUnscheduled, addr 0x20922cc, size 0x3c, virtual true, abstract: false, final false
  inline void OnItemUnscheduled();

  /// @brief Method OnPanelActivate, addr 0x209269c, size 0xf0, virtual true, abstract: false, final true
  inline void OnPanelActivate();

  /// @brief Method OnPanelDeactivate, addr 0x209278c, size 0xdc, virtual true, abstract: false, final true
  inline void OnPanelDeactivate();

  /// @brief Method Pause, addr 0x2092644, size 0x1c, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x2083870, size 0x1c, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method StartingIn, addr 0x2092220, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2092150, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* handler);

  /// @brief Method get_element, addr 0x2092140, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_element, addr 0x2092148, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method PerformTimerUpdate, addr 0x20928a4, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);

  /// @brief Method .ctor, addr 0x2083810, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method PerformTimerUpdate, addr 0x20928d8, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);

  /// @brief Method .ctor, addr 0x2083938, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x2092964, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2092bec, size 0x4d0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_focusIndex, addr 0x2092954, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UxmlIntAttributeDescription* get_focusIndex();

  /// @brief Method get_focusable, addr 0x209295c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x208d78c, size 0x7c, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method BringToFront, addr 0x208e488, size 0xb4, virtual false, abstract: false, final false
  inline void BringToFront(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method Clear, addr 0x208dc14, size 0x344, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ElementAt, addr 0x20936e0, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method Equals, addr 0x2093700, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x20936e4, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::UIElements::__VisualElement__Hierarchy other);

  /// @brief Method GetHashCode, addr 0x2093778, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf, addr 0x208e160, size 0x60, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Insert, addr 0x208d894, size 0x31c, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method MoveChildElement, addr 0x20935cc, size 0x114, virtual false, abstract: false, final false
  inline void MoveChildElement(::UnityEngine::UIElements::VisualElement* child, int32_t currentIndex, int32_t nextIndex);

  /// @brief Method PlaceBehind, addr 0x208e6f8, size 0xd8, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* child, ::UnityEngine::UIElements::VisualElement* over);

  /// @brief Method PutChildAtIndex, addr 0x20930c4, size 0x140, virtual false, abstract: false, final false
  inline void PutChildAtIndex(::UnityEngine::UIElements::VisualElement* child, int32_t index);

  /// @brief Method ReleaseChildList, addr 0x20934ec, size 0xe0, virtual false, abstract: false, final false
  inline void ReleaseChildList();

  /// @brief Method Remove, addr 0x208e808, size 0xf4, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method RemoveAt, addr 0x209322c, size 0x244, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveChildAtIndex, addr 0x2093470, size 0x7c, virtual false, abstract: false, final false
  inline void RemoveChildAtIndex(int32_t index);

  /// @brief Method SendToBack, addr 0x208e574, size 0x98, virtual false, abstract: false, final false
  inline void SendToBack(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method SetParent, addr 0x2093204, size 0x28, virtual false, abstract: false, final false
  inline void SetParent(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method .ctor, addr 0x208a0d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method get_Item, addr 0x208dfd0, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_childCount, addr 0x208e094, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_parent, addr 0x2086bd4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method op_Equality, addr 0x20936f4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x208d6dc, size 0xb0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method AddStyleSheetPath, addr 0x208ee20, size 0x234, virtual false, abstract: false, final false
  inline void AddStyleSheetPath(::StringW sheetPath);

  /// @brief Method AddToClassList, addr 0x208c0cc, size 0x208, virtual false, abstract: false, final false
  inline void AddToClassList(::StringW className);

  /// @brief Method AssignMeasureFunction, addr 0x208cd08, size 0x8c, virtual false, abstract: false, final false
  inline void AssignMeasureFunction();

  /// @brief Method AssignStyleValues, addr 0x208f3fc, size 0x15e0, virtual false, abstract: false, final false
  ...
  /// @brief Method BringToFront, addr 0x208e450, size 0x38, virtual false, abstract: false, final false
  inline void BringToFront();

  /// @brief Method CalculateConservativeRect, addr 0x2085cc4, size 0x3d4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect CalculateConservativeRect(ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Rect rect);

  /// @brief Method ChangeIMGUIContainerCount, addr 0x2089e1c, size 0x30, virtual false, abstract: false, final false
  inline void ChangeIMGUIContainerCount(int32_t delta);

  /// @brief Method CheckUserKeyArgument, addr 0x208d478, size 0x168, virtual false, abstract: false, final false
  static inline void CheckUserKeyArgument(::UnityEngine::PropertyName key);

  /// @brief Method ClassListContains, addr 0x208d3d0, size 0xa8, virtual false, abstract: false, final false
  inline bool ClassListContains(::StringW cls);

  /// @brief Method Clear, addr 0x208dbb0, size 0x64, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CombineClipRects, addr 0x20896e8, size 0xf8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect CombineClipRects(::UnityEngine::Rect rect, ::UnityEngine::Rect parentRect);

  /// @brief Method ComputeAAAlignedBound, addr 0x20897e0, size 0x1d0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeAAAlignedBound(::UnityEngine::Rect position, ::UnityEngine::Matrix4x4 mat);

  /// @brief Method Contains, addr 0x208e8fc, size 0x34, virtual false, abstract: false, final false
  inline bool Contains(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method ContainsPoint, addr 0x208cc44, size 0x48, virtual true, abstract: false, final false
  inline bool ContainsPoint(::UnityEngine::Vector2 localPoint);

  /// @brief Method DoMeasure, addr 0x208cdb4, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method ElementAt, addr 0x208df58, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method ElementAtTreePath, addr 0x208e1c0, size 0x1a8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAtTreePath(::System::Collections::Generic::List_1<int32_t>* childIndexes);

  /// @brief Method EnableInClassList, addr 0x208c2d4, size 0xc, virtual false, abstract: false, final false
  inline void EnableInClassList(::StringW className, bool enable);

  /// @brief Method EnsureWorldTransformAndClipUpToDate, addr 0x2089070, size 0x3c, virtual false, abstract: false, final false
  inline void EnsureWorldTransformAndClipUpToDate();

  /// @brief Method ExecuteDefaultAction, addr 0x208a104, size 0x6a8, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method FinalizeLayout, addr 0x208ceec, size 0x4c, virtual false, abstract: false, final false
  inline void FinalizeLayout();

  /// @brief Method FindCommonAncestor, addr 0x208e930, size 0x118, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* FindCommonAncestor(::UnityEngine::UIElements::VisualElement* other);

  /// @brief Method FindElementInTree, addr 0x208e368, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Focus, addr 0x208ab14, size 0x54, virtual true, abstract: false, final true
  inline void Focus();

  /// @brief Method GatherAllChildren, addr 0x208b4fc, size 0xd8, virtual false, abstract: false, final false
  inline void GatherAllChildren(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* elements);

  /// @brief Method GetAnimationSystem, addr 0x208f1e4, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementAnimationSystem* GetAnimationSystem();

  /// @brief Method GetClassesForIteration, addr 0x208d3c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* GetClassesForIteration();

  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x208c784, size 0x74, virtual false, abstract: false, final false
  inline ::StringW GetFullHierarchicalViewDataKey();

  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x208c6f0, size 0x94, virtual false, abstract: false, final false
  inline void GetFullHierarchicalViewDataKey(::System::Text::StringBuilder* key);

  /// @brief Method GetNextElementDepthFirst, addr 0x208eb40, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetNextElementDepthFirst();

  /// @brief Method GetPivotedMatrixWithLayout, addr 0x2085430, size 0x1d0, virtual false, abstract: false, final false
  inline void GetPivotedMatrixWithLayout(ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method GetPreviousElementDepthFirst, addr 0x208ec30, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetPreviousElementDepthFirst();

  /// @brief Method GetProperty, addr 0x20834dc, size 0x80, virtual false, abstract: false, final false
  inline ::System::Object* GetProperty(::UnityEngine::PropertyName key);

  /// @brief Method GetRoot, addr 0x208ea48, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRoot();

  /// @brief Method GetRootVisualContainer, addr 0x208eb08, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRootVisualContainer();

  /// @brief Method GetStylePropertyAnimationSystem, addr 0x2083b14, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* GetStylePropertyAnimationSystem();

  /// @brief Method GetTooltipRect, addr 0x208ab10, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::Rect GetTooltipRect();

  /// @brief Method HasChangedPanel, addr 0x208b7b0, size 0x2bc, virtual false, abstract: false, final false
  inline void HasChangedPanel(::UnityEngine::UIElements::BaseVisualElementPanel* prevPanel);

  /// @brief Method HasProperty, addr 0x2083668, size 0x80, virtual false, abstract: false, final false
  inline bool HasProperty(::UnityEngine::PropertyName key);

  /// @brief Method IncrementVersion, addr 0x2086640, size 0x28, virtual false, abstract: false, final false
  inline void IncrementVersion(::UnityEngine::UIElements::VersionChangeType changeType);

  /// @brief Method IndexOf, addr 0x208e0e4, size 0x7c, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Insert, addr 0x208d808, size 0x8c, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method InvokeGenerateVisualContent, addr 0x208c4bc, size 0x234, virtual false, abstract: false, final false
  inline void InvokeGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext* mgc);

  /// @brief Method InvokeHierarchyChanged, addr 0x208bbd4, size 0x20, virtual false, abstract: false, final false
  inline void InvokeHierarchyChanged(::UnityEngine::UIElements::HierarchyChangeType changeType);

  /// @brief Method IsViewDataPersitenceSupportedOnChildren, addr 0x208cb94, size 0x74, virtual false, abstract: false, final false
  inline bool IsViewDataPersitenceSupportedOnChildren(bool existingState);

  /// @brief Method MarkDirtyRepaint, addr 0x208c488, size 0x24, virtual false, abstract: false, final false
  inline void MarkDirtyRepaint();

  /// @brief Method MarkRenderHintsClean, addr 0x2086e6c, size 0x10, virtual false, abstract: false, final false
  inline void MarkRenderHintsClean();

  /// @brief Method Max, addr 0x2085b24, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Max(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method Measure, addr 0x208cdc4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Min, addr 0x2085b08, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Min(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method MultiplyMatrix34, addr 0x2086240, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyMatrix44Point2, addr 0x2086200, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 MultiplyMatrix44Point2(ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector2 point);

  /// @brief Method MultiplyVector2, addr 0x2086224, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnViewDataReady, addr 0x208cc40, size 0x4, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method OnViewDataReady, addr 0x208cc08, size 0x38, virtual false, abstract: false, final false
  inline void OnViewDataReady(bool enablePersistence);

  /// @brief Method OrderMinMaxRect, addr 0x2086098, size 0xd4, virtual false, abstract: false, final false
  static inline void OrderMinMaxRect(ByRef<::UnityEngine::Rect> rect);

  /// @brief Method OverwriteFromViewData, addr 0x208c7f8, size 0x320, virtual false, abstract: false, final false
  inline void OverwriteFromViewData(::System::Object* obj, ::StringW key);

  /// @brief Method PlaceBehind, addr 0x208e60c, size 0xec, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* sibling);

  /// @brief Method PropagateEnabledToChildren, addr 0x208c2f4, size 0xb0, virtual false, abstract: false, final false
  inline void PropagateEnabledToChildren(bool value);

  /// @brief Method ReadCurrentValues, addr 0x20909dc, size 0xee4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAnimation, addr 0x208f278, size 0x10c, virtual false, abstract: false, final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method RegisterRunningAnimations, addr 0x208bb3c, size 0x6c, virtual false, abstract: false, final false
  inline void RegisterRunningAnimations();

  /// @brief Method RemoveFromClassList, addr 0x208bfa4, size 0x128, virtual false, abstract: false, final false
  inline void RemoveFromClassList(::StringW className);

  /// @brief Method RemoveFromHierarchy, addr 0x208e7d0, size 0x38, virtual false, abstract: false, final false
  inline void RemoveFromHierarchy();

  /// @brief Method RemoveMeasureFunction, addr 0x208cd94, size 0x20, virtual false, abstract: false, final false
  inline void RemoveMeasureFunction();

  /// @brief Method ResolveLengthValue, addr 0x208f054, size 0x190, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFloat ResolveLengthValue(::UnityEngine::UIElements::Length length, bool isRow);

  /// @brief Method ResolveRotation, addr 0x20859c0, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion ResolveRotation();

  /// @brief Method ResolveScale, addr 0x2085a08, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveScale();

  /// @brief Method ResolveTransformOrigin, addr 0x2085600, size 0x3c0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTransformOrigin();

  /// @brief Method ResolveTranslate, addr 0x2085154, size 0x234, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTranslate();

  /// @brief Method RetargetElement, addr 0x208ed18, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* RetargetElement(::UnityEngine::UIElements::VisualElement* retargetAgainst);

  /// @brief Method SaveViewData, addr 0x208cb18, size 0x7c, virtual false, abstract: false, final false
  inline void SaveViewData();

  /// @brief Method SendEvent, addr 0x208bba8, size 0x18, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e);

  /// @brief Method SendEvent, addr 0x208bbc0, size 0x14, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e, ::UnityEngine::UIElements::DispatchMode dispatchMode);

  /// @brief Method SendToBack, addr 0x208e53c, size 0x38, virtual false, abstract: false, final false
  inline void SendToBack();

  /// @brief Method SetComputedStyle, addr 0x208cfc8, size 0x1cc, virtual false, abstract: false, final false
  inline void SetComputedStyle(ByRef<::UnityEngine::UIElements::ComputedStyle> newStyle);

  /// @brief Method SetEnabled, addr 0x208a0e0, size 0x24, virtual false, abstract: false, final false
  inline void SetEnabled(bool value);

  /// @brief Method SetEnabledFromHierarchyPrivate, addr 0x208bbf4, size 0x37c, virtual false, abstract: false, final false
  inline bool SetEnabledFromHierarchyPrivate(bool state);

  /// @brief Method SetInlineRule, addr 0x208cf38, size 0x90, virtual false, abstract: false, final false
  inline void SetInlineRule(::UnityEngine::UIElements::StyleSheet* sheet, ::UnityEngine::UIElements::StyleRule* rule);

  /// @brief Method SetPanel, addr 0x208ab68, size 0x994, virtual false, abstract: false, final false
  inline void SetPanel(::UnityEngine::UIElements::BaseVisualElementPanel* p);

  /// @brief Method SetProperty, addr 0x20836e8, size 0x78, virtual false, abstract: false, final false
  inline void SetProperty(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method SetPropertyInternal, addr 0x2086870, size 0x254, virtual false, abstract: false, final false
  inline void SetPropertyInternal(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method SetTooltip, addr 0x208aa34, size 0xdc, virtual false, abstract: false, final false
  inline void SetTooltip(::UnityEngine::UIElements::TooltipEvent* e);

  /// @brief Method ShouldClip, addr 0x2088688, size 0x2c, virtual false, abstract: false, final false
  inline bool ShouldClip();

  /// @brief Method Start, addr 0x2091990, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method SubstractBorderPadding, addr 0x20890ac, size 0x63c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect SubstractBorderPadding(::UnityEngine::Rect worldRect);

  /// @brief Method ToString, addr 0x208d194, size 0x234, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TransformAlignedRect, addr 0x208616c, size 0x94, virtual false, abstract: false, final false
  static inline void TransformAlignedRect(ByRef<::UnityEngine::Matrix4x4> matrix, ByRef<::UnityEngine::Rect> rect);

  /// @brief Method TransformAlignedRectToParentSpace, addr 0x2085b40, size 0x184, virtual false, abstract: false, final false
  inline void TransformAlignedRectToParentSpace(ByRef<::UnityEngine::Rect> rect);

  /// @brief Method TranslateMatrix34, addr 0x2086418, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateMatrix34InPlace, addr 0x2086504, size 0x5c, virtual false, abstract: false, final false
  static inline void TranslateMatrix34InPlace(ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector3 rhs);

  /// @brief Method TryConvertLengthUnits, addr 0x2083e88, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTransformOriginUnits, addr 0x2084d60, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTranslateUnits, addr 0x20849fc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetPropertyInternal, addr 0x2086718, size 0xe8, virtual false, abstract: false, final false
  inline bool TryGetPropertyInternal(::UnityEngine::PropertyName key, ByRef<::System::Object*> value);

  /// @brief Method UnityEngine.UIElements.Experimental.ITransitionAnimations.Start, addr 0x20918c0, size 0xc8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>*
  ...
  /// @brief Method UnityEngine.UIElements.IExperimentalFeatures.get_animation, addr 0x208d660, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_backgroundColor, addr 0x2091b14, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_backgroundColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomColor, addr 0x2091b20, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderBottomColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomLeftRadius, addr 0x2091b2c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomRightRadius, addr 0x2091b48, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomWidth, addr 0x2091b64, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftColor, addr 0x2091b80, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderLeftColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftWidth, addr 0x2091b8c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderLeftWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightColor, addr 0x2091ba8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderRightColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightWidth, addr 0x2091bb4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderRightWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopColor, addr 0x2091bd0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderTopColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopLeftRadius, addr 0x2091bdc, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopRightRadius, addr 0x2091bf8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopWidth, addr 0x2091c14, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_bottom, addr 0x2091c30, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_bottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_color, addr 0x2091c4c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_color();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_display, addr 0x2091c58, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::DisplayStyle UnityEngine_UIElements_IResolvedStyle_get_display();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexGrow, addr 0x2091c64, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexGrow();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexShrink, addr 0x2091c70, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexShrink();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_height, addr 0x2091c7c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_height();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_left, addr 0x2091c98, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_left();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginBottom, addr 0x2091cb4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginLeft, addr 0x2091cd0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginRight, addr 0x2091cec, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginTop, addr 0x2091d08, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minHeight, addr 0x2091d24, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minHeight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minWidth, addr 0x2091d4c, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_opacity, addr 0x2091d74, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_opacity();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingBottom, addr 0x2091d80, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingLeft, addr 0x2091d9c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingRight, addr 0x2091db8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingTop, addr 0x2091dd4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_right, addr 0x2091df0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_right();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_scale, addr 0x2091e0c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Scale UnityEngine_UIElements_IResolvedStyle_get_scale();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_top, addr 0x2091e18, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_top();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_transformOrigin, addr 0x2091e34, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_transformOrigin();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_translate, addr 0x2091e38, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_translate();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityBackgroundImageTintColor, addr 0x2091e3c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityBackgroundImageTintColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceLeft, addr 0x2091e48, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceRight, addr 0x2091e54, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineColor, addr 0x2091e60, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineWidth, addr 0x2091e6c, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_visibility, addr 0x2091e78, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Visibility UnityEngine_UIElements_IResolvedStyle_get_visibility();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_whiteSpace, addr 0x2091e84, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::WhiteSpace UnityEngine_UIElements_IResolvedStyle_get_whiteSpace();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_width, addr 0x2091e90, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_width();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAllAnimations, addr 0x2084e5c, size 0xe0, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_CancelAllAnimations();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAnimation, addr 0x2084d8c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.GetAllAnimations, addr 0x2085004, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2083f80, size 0x150, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2084474, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x20841ec, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2084344, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2083d50, size 0x138, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2084a28, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x208471c, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2084590, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2084bb0, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x208484c, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2083b30, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2083c34, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.StartEnum, addr 0x20840d0, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.UpdateAnimation, addr 0x2084f3c, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_completedAnimationCount, addr 0x2083b04, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_completedAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_runningAnimationCount, addr 0x2083af4, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_runningAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_completedAnimationCount, addr 0x2083b0c, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_completedAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_runningAnimationCount, addr 0x2083afc, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_runningAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.ITransform.get_position, addr 0x2086e80, size 0xa0, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_position();

  /// @brief Method UnityEngine.UIElements.ITransform.get_scale, addr 0x20870fc, size 0xb4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_scale();

  /// @brief Method UnityEngine.UIElements.ITransform.set_position, addr 0x2086f20, size 0x16c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITransform_set_position(::UnityEngine::Vector3 value);

  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x2083764, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x208388c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method UnregisterAnimation, addr 0x208f384, size 0x78, virtual false, abstract: false, final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterRunningAnimations, addr 0x208ba6c, size 0xd0, virtual false, abstract: false, final false
  inline void UnregisterRunningAnimations();

  /// @brief Method UpdateBoundingBox, addr 0x208800c, size 0x3ac, virtual false, abstract: false, final false
  inline void UpdateBoundingBox();

  /// @brief Method UpdateCursorStyle, addr 0x208a7ac, size 0x288, virtual false, abstract: false, final false
  inline void UpdateCursorStyle(int64_t eventType);

  /// @brief Method UpdateHoverPseudoState, addr 0x2089a4c, size 0xcc, virtual false, abstract: false, final false
  inline void UpdateHoverPseudoState();

  /// @brief Method UpdateWorldBoundingBox, addr 0x20883f8, size 0xfc, virtual false, abstract: false, final false
  inline void UpdateWorldBoundingBox();

  /// @brief Method UpdateWorldClip, addr 0x2088d84, size 0x280, virtual false, abstract: false, final false
  inline void UpdateWorldClip();

  /// @brief Method UpdateWorldTransform, addr 0x20889ec, size 0x2a4, virtual false, abstract: false, final false
  inline void UpdateWorldTransform();

  /// @brief Method UpdateWorldTransformInverse, addr 0x2088cb8, size 0x58, virtual false, abstract: false, final false
  inline void UpdateWorldTransformInverse();

  /// @brief Method WillChangePanel, addr 0x208b5d4, size 0x1dc, virtual false, abstract: false, final false
  inline void WillChangePanel(::UnityEngine::UIElements::BaseVisualElementPanel* destinationPanel);

  /// @brief Method <AssignMeasureFunction>b__281_0, addr 0x209213c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2089e4c, size 0x28c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0x208df5c, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_boundingBox, addr 0x2087fd0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBox();

  /// @brief Method get_boundingBoxInParentSpace, addr 0x20884f4, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBoxInParentSpace();

  /// @brief Method get_canGrabFocus, addr 0x2086ac4, size 0x110, virtual true, abstract: false, final false
  inline bool get_canGrabFocus();

  /// @brief Method get_childCount, addr 0x208e030, size 0x64, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_computedStyle, addr 0x2085b00, size 0x8, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::UIElements::ComputedStyle> get_computedStyle();

  /// @brief Method get_containedPointerIds, addr 0x2089a3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_containedPointerIds();

  /// @brief Method get_contentContainer, addr 0x208d6d0, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_contentRect, addr 0x2087acc, size 0x214, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_contentRect();

  /// @brief Method get_customStyle, addr 0x208ed7c, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ICustomStyle* get_customStyle();

  /// @brief Method get_defaultMaterial, addr 0x208d5e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_defaultMaterial();

  /// @brief Method get_disableClipping, addr 0x208d688, size 0xc, virtual false, abstract: false, final false
  inline bool get_disableClipping();

  /// @brief Method get_elementPanel, addr 0x208d6c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVisualElementPanel* get_elementPanel();

  /// @brief Method get_enableViewDataPersistence, addr 0x2086668, size 0xc, virtual false, abstract: false, final false
  inline bool get_enableViewDataPersistence();

  /// @brief Method get_enabledInHierarchy, addr 0x2086ca8, size 0x10, virtual false, abstract: false, final false
  inline bool get_enabledInHierarchy();

  /// @brief Method get_enabledSelf, addr 0x208c2e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabledSelf();

  /// @brief Method get_experimental, addr 0x208d65c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IExperimentalFeatures* get_experimental();

  /// @brief Method get_focusController, addr 0x2086cb8, size 0xb0, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::FocusController* get_focusController();

  /// @brief Method get_fullTypeName, addr 0x2089b88, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_generateVisualContent, addr 0x208c4ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* get_generateVisualContent();

  /// @brief Method get_hasCompletedAnimations, addr 0x2083a48, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasCompletedAnimations();

  /// @brief Method get_hasDefaultRotationAndScale, addr 0x2085a30, size 0xd0, virtual false, abstract: false, final false
  inline bool get_hasDefaultRotationAndScale();

  /// @brief Method get_hasInlineStyle, addr 0x2089dd4, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasInlineStyle();

  /// @brief Method get_hasRunningAnimations, addr 0x2083998, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasRunningAnimations();

  /// @brief Method get_hierarchy, addr 0x208d664, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__VisualElement__Hierarchy get_hierarchy();

  /// @brief Method get_isBoundingBoxDirty, addr 0x2087f60, size 0xc, virtual false, abstract: false, final false
  inline bool get_isBoundingBoxDirty();

  /// @brief Method get_isCompositeRoot, addr 0x2086560, size 0xc, virtual false, abstract: false, final false
  inline bool get_isCompositeRoot();

  /// @brief Method get_isHierarchyDisplayed, addr 0x2086598, size 0xc, virtual false, abstract: false, final false
  inline bool get_isHierarchyDisplayed();

  /// @brief Method get_isLayoutManual, addr 0x20871b0, size 0xc, virtual false, abstract: false, final false
  inline bool get_isLayoutManual();

  /// @brief Method get_isParentEnabledInHierarchy, addr 0x208bf70, size 0x34, virtual false, abstract: false, final false
  inline bool get_isParentEnabledInHierarchy();

  /// @brief Method get_isRootVisualContainer, addr 0x208d674, size 0x8, virtual false, abstract: false, final false
  inline bool get_isRootVisualContainer();

  /// @brief Method get_isWorldBoundingBoxDirty, addr 0x2087f98, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldBoundingBoxDirty();

  /// @brief Method get_isWorldClipDirty, addr 0x2088d10, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldClipDirty();

  /// @brief Method get_isWorldTransformDirty, addr 0x208893c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldTransformDirty();

  /// @brief Method get_isWorldTransformInverseDirty, addr 0x2088974, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldTransformInverseDirty();

  /// @brief Method get_layout, addr 0x2085388, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_layout();

  /// @brief Method get_localBound, addr 0x20887a8, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_localBound();

  /// @brief Method get_name, addr 0x2089b28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_paddingRect, addr 0x2087ce0, size 0x214, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_paddingRect();

  /// @brief Method get_panel, addr 0x2086d68, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IPanel* get_panel();

  /// @brief Method get_parent, addr 0x2086bf0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method get_pickingMode, addr 0x2089b18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PickingMode get_pickingMode();

  /// @brief Method get_positionWithLayout, addr 0x20850f0, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_positionWithLayout();

  /// @brief Method get_pseudoStates, addr 0x20899b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PseudoStates get_pseudoStates();

  /// @brief Method get_rect, addr 0x2087ef4, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rect();

  /// @brief Method get_renderHints, addr 0x2086d94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RenderHints get_renderHints();

  /// @brief Method get_requireMeasureFunction, addr 0x208cc8c, size 0xc, virtual false, abstract: false, final false
  inline bool get_requireMeasureFunction();

  /// @brief Method get_resolvedStyle, addr 0x2086ca4, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IResolvedStyle* get_resolvedStyle();

  /// @brief Method get_scaledPixelsPerPoint, addr 0x20871e8, size 0x14, virtual false, abstract: false, final false
  inline float_t get_scaledPixelsPerPoint();

  /// @brief Method get_schedule, addr 0x2083760, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IVisualElementScheduler* get_schedule();

  /// @brief Method get_style, addr 0x208708c, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStyle* get_style();

  /// @brief Method get_styleAnimation, addr 0x2083a44, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimations* get_styleAnimation();

  /// @brief Method get_styleInitialized, addr 0x2089de4, size 0xc, virtual false, abstract: false, final false
  inline bool get_styleInitialized();

  /// @brief Method get_styleSheets, addr 0x208edfc, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementStyleSheetSet get_styleSheets();

  /// @brief Method get_subRenderTargetMode, addr 0x208d5e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__VisualElement__RenderTargetMode get_subRenderTargetMode();

  /// @brief Method get_tooltip, addr 0x2083448, size 0x94, virtual false, abstract: false, final false
  inline ::StringW get_tooltip();

  /// @brief Method get_transform, addr 0x2086e7c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITransform* get_transform();

  /// @brief Method get_typeData, addr 0x2089ba0, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__VisualElement__TypeData* get_typeData();

  /// @brief Method get_typeName, addr 0x2089d14, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_typeName();

  /// @brief Method get_usageHints, addr 0x2086d70, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UsageHints get_usageHints();

  /// @brief Method get_userData, addr 0x20866a0, size 0x78, virtual false, abstract: false, final false
  inline ::System::Object* get_userData();

  /// @brief Method get_viewDataKey, addr 0x20865d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_viewDataKey();

  /// @brief Method get_visible, addr 0x2086bf8, size 0xac, virtual false, abstract: false, final false
  inline bool get_visible();

  /// @brief Method get_worldBound, addr 0x20886d8, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBound();

  /// @brief Method get_worldBoundingBox, addr 0x20883b8, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBoundingBox();

  /// @brief Method get_worldClip, addr 0x2088d48, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClip();

  /// @brief Method get_worldClipIsInfinite, addr 0x2089040, size 0x30, virtual false, abstract: false, final false
  inline bool get_worldClipIsInfinite();

  /// @brief Method get_worldClipMinusGroup, addr 0x2089004, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClipMinusGroup();

  /// @brief Method get_worldTransform, addr 0x20889ac, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_worldTransform();

  /// @brief Method get_worldTransformInverse, addr 0x2088c90, size 0x28, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::Matrix4x4> get_worldTransformInverse();

  /// @brief Method get_worldTransformRef, addr 0x20886b4, size 0x24, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::Matrix4x4> get_worldTransformRef();

  /// @brief Method get_yogaNode, addr 0x2089dc4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_containedPointerIds, addr 0x2089a44, size 0x8, virtual false, abstract: false, final false
  inline void set_containedPointerIds(int32_t value);

  /// @brief Method set_disableClipping, addr 0x208d694, size 0x2c, virtual false, abstract: false, final false
  inline void set_disableClipping(bool value);

  /// @brief Method set_elementPanel, addr 0x208d6c8, size 0x8, virtual false, abstract: false, final false
  inline void set_elementPanel(::UnityEngine::UIElements::BaseVisualElementPanel* value);

  /// @brief Method set_enableViewDataPersistence, addr 0x2086674, size 0x2c, virtual false, abstract: false, final false
  inline void set_enableViewDataPersistence(bool value);

  /// @brief Method set_enabledSelf, addr 0x208c2e8, size 0xc, virtual false, abstract: false, final false
  inline void set_enabledSelf(bool value);

  /// @brief Method set_generateVisualContent, addr 0x208c4b4, size 0x8, virtual false, abstract: false, final false
  inline void set_generateVisualContent(::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* value);

  /// @brief Method set_hierarchy, addr 0x208d66c, size 0x8, virtual false, abstract: false, final false
  inline void set_hierarchy(::UnityEngine::UIElements::__VisualElement__Hierarchy value);

  /// @brief Method set_isBoundingBoxDirty, addr 0x2087f6c, size 0x2c, virtual false, abstract: false, final false
  inline void set_isBoundingBoxDirty(bool value);

  /// @brief Method set_isCompositeRoot, addr 0x208656c, size 0x2c, virtual false, abstract: false, final false
  inline void set_isCompositeRoot(bool value);

  /// @brief Method set_isHierarchyDisplayed, addr 0x20865a4, size 0x2c, virtual false, abstract: false, final false
  inline void set_isHierarchyDisplayed(bool value);

  /// @brief Method set_isLayoutManual, addr 0x20871bc, size 0x2c, virtual false, abstract: false, final false
  inline void set_isLayoutManual(bool value);

  /// @brief Method set_isRootVisualContainer, addr 0x208d67c, size 0xc, virtual false, abstract: false, final false
  inline void set_isRootVisualContainer(bool value);

  /// @brief Method set_isWorldBoundingBoxDirty, addr 0x2087fa4, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldBoundingBoxDirty(bool value);

  /// @brief Method set_isWorldClipDirty, addr 0x2088d1c, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldClipDirty(bool value);

  /// @brief Method set_isWorldTransformDirty, addr 0x2088948, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldTransformDirty(bool value);

  /// @brief Method set_isWorldTransformInverseDirty, addr 0x2088980, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldTransformInverseDirty(bool value);

  /// @brief Method set_layout, addr 0x20871fc, size 0x8d0, virtual false, abstract: false, final false
  inline void set_layout(::UnityEngine::Rect value);

  /// @brief Method set_name, addr 0x2089b30, size 0x58, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_pickingMode, addr 0x2089b20, size 0x8, virtual false, abstract: false, final false
  inline void set_pickingMode(::UnityEngine::UIElements::PickingMode value);

  /// @brief Method set_pseudoStates, addr 0x20899b8, size 0x84, virtual false, abstract: false, final false
  inline void set_pseudoStates(::UnityEngine::UIElements::PseudoStates value);

  /// @brief Method set_renderHints, addr 0x2086e20, size 0x4c, virtual false, abstract: false, final false
  inline void set_renderHints(::UnityEngine::UIElements::RenderHints value);

  /// @brief Method set_requireMeasureFunction, addr 0x208cc98, size 0x70, virtual false, abstract: false, final false
  inline void set_requireMeasureFunction(bool value);

  /// @brief Method set_styleInitialized, addr 0x2089df0, size 0x2c, virtual false, abstract: false, final false
  inline void set_styleInitialized(bool value);

  /// @brief Method set_tooltip, addr 0x208355c, size 0x10c, virtual false, abstract: false, final false
  inline void set_tooltip(::StringW value);

  /// @brief Method set_usageHints, addr 0x2086d9c, size 0x84, virtual false, abstract: false, final false
  inline void set_usageHints(::UnityEngine::UIElements::UsageHints value);

  /// @brief Method set_userData, addr 0x2086800, size 0x70, virtual false, abstract: false, final false
  inline void set_userData(::System::Object* value);

  /// @brief Method set_viewDataKey, addr 0x20865d8, size 0x68, virtual false, abstract: false, final false
  inline void set_viewDataKey(::StringW value);

  /// @brief Method set_visible, addr 0x208c3a4, size 0xe4, virtual false, abstract: false, final false
  inline void set_visible(bool value);

  /// @brief Method set_visualTreeAssetSource, addr 0x208d6d4, size 0x8, virtual false, abstract: false, final false
  inline void set_visualTreeAssetSource(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method set_yogaNode, addr 0x2089dcc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x209290c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x208d5f0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_fullTypeName, addr 0x2089ccc, size 0x48, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_type, addr 0x20930bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_type();

  /// @brief Method get_typeName, addr 0x2089d2c, size 0x98, virtual false, abstract: false, final false
  inline ::StringW get_typeName();
...
public:
  ...
  /// @brief Method LogCustomPropertyWarning, addr 0x2093af0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method SetContext, addr 0x208edf0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValue, addr 0x2093ef4, size 0xc4, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<::StringW> property, ByRef<::StringW> value);

  /// @brief Method TryGetValue, addr 0x20939a4, size 0x14c, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x2093cf4, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x2093bf4, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x2093df4, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x2093790, size 0x9c, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<float_t> property, ByRef<float_t> value);

  /// @brief Method TryGetValue, addr 0x20938e4, size 0xc0, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<int32_t> property, ByRef<int32_t> value);

  /// @brief Method TryGetValue, addr 0x209382c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2092134, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UnityEngine.UIElements.Experimental.ITransitionAnimations.Start>b__0, addr 0x2093fb8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2091988, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
