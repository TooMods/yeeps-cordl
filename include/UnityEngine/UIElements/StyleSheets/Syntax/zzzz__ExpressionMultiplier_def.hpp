...
public:
  ...
  /// @brief Method SetType, addr 0x215a820, size 0x61de4, virtual false, abstract: false, final false
  inline void SetType(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType value);

  /// @brief Method .ctor, addr 0x215a810, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType type);

  /// @brief Method get_type, addr 0x2153624, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType get_type();

  /// @brief Method set_type, addr 0x215a5a0, size 0x4, virtual false, abstract: false, final false
