...
public:
  ...
  /// @brief Method F, addr 0x1d2838c, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t F(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method G, addr 0x1d28398, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t G(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method H, addr 0x1d283a8, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t H(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HashCore, addr 0x1d268f8, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x1d26a78, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method I, addr 0x1d283b4, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t I(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method Initialize, addr 0x1d268b4, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x1d26830, size 0x84, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method J, addr 0x1d283c4, size 0x100c, virtual false, abstract: false, final false
  static inline uint32_t J(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method MDTransform, addr 0x1d26c4c, size 0x1740, virtual false, abstract: false, final false
  ...
  /// @brief Method _EndHash, addr 0x1d26a7c, size 0x1d0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method _HashData, addr 0x1d268fc, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d1f084, size 0x124, virtual false, abstract: false, final false
  inline void _ctor();
