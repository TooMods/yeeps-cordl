...
public:
  ...
  /// @brief Method get_Cases, addr 0x183c7d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::SwitchCase*>* get_Cases();

  /// @brief Method get_Comparison, addr 0x183c7e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Comparison();

  /// @brief Method get_DefaultBody, addr 0x183c7d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_DefaultBody();

  /// @brief Method get_SwitchValue, addr 0x183c7c8, size 0x8, virtual false, abstract: false, final false
