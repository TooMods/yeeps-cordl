...
public:
  ...
  /// @brief Method Cleanup, addr 0x10429bc, size 0xf0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Close, addr 0x1043114, size 0x31c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method CreateOrReuseConnection, addr 0x1042aac, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method EnqueueOperation, addr 0x10430bc, size 0x58, virtual false, abstract: false, final false
  inline void EnqueueOperation(::System::Net::WebOperation* operation);

  /// @brief Method FindIdleConnection, addr 0x1043584, size 0x314, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation* operation);

  /// @brief Method GetNextOperation, addr 0x1042c84, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* GetNextOperation();

  /// @brief Method IsEmpty, addr 0x104213c, size 0x74, virtual false, abstract: false, final false
  inline bool IsEmpty();
  ...
  /// @brief Method RemoveConnection, addr 0x1042868, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1041aa8, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePointScheduler* scheduler, ::StringW name);

  static inline int32_t getStaticF_nextId();

  /// @brief Method get_Scheduler, addr 0x1043564, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Set>b__4_0, addr 0x1043fa8, size 0x9c, virtual false, abstract: false, final false
  inline bool _Set_b__4_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x1043fa0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Reset, addr 0x104233c, size 0xc4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Set, addr 0x1041c7c, size 0x230, virtual false, abstract: false, final false
  inline void Set();

  /// @brief Method WaitAsync, addr 0x1043ee8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1041a00, size 0xa8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1044044, size 0xaf4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1044b38, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1044b44, size 0x44c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1044f90, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Cleanup, addr 0x1041f7c, size 0x1c0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CloseConnectionGroup, addr 0x1040ccc, size 0x110, virtual false, abstract: false, final false
  inline bool CloseConnectionGroup(::StringW groupName);

  /// @brief Method CloseIdleConnection, addr 0x1042c4c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalCleanup, addr 0x1042e40, size 0x80, virtual false, abstract: false, final false
  inline void FinalCleanup();

  /// @brief Method GetConnectionGroup, addr 0x1042ec0, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnConnectionClosed, addr 0x104343c, size 0x1c, virtual false, abstract: false, final false
  inline void OnConnectionClosed(::System::Net::WebConnection* connection);

  /// @brief Method OnConnectionCreated, addr 0x1043430, size 0xc, virtual false, abstract: false, final false
  inline void OnConnectionCreated(::System::Net::WebConnection* connection);

  /// @brief Method OperationCompleted, addr 0x10424e0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveIdleConnection, addr 0x10428f0, size 0xcc, virtual false, abstract: false, final false
  inline void RemoveIdleConnection(::System::Net::WebConnection* connection);

  /// @brief Method RemoveOperation, addr 0x1042d74, size 0xcc, virtual false, abstract: false, final false
  inline void RemoveOperation(::System::Net::WebOperation* operation);

  /// @brief Method Run, addr 0x1041bb4, size 0xc8, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method RunScheduler, addr 0x1041eac, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RunScheduler();

  /// @brief Method RunSchedulerIteration, addr 0x10421b0, size 0x18c, virtual false, abstract: false, final false
  inline void RunSchedulerIteration();

  /// @brief Method SchedulerIteration, addr 0x1042400, size 0xe0, virtual false, abstract: false, final false
  inline bool SchedulerIteration(::System::Net::__ServicePointScheduler__ConnectionGroup* group);

  /// @brief Method SendRequest, addr 0x1040af8, size 0xe8, virtual false, abstract: false, final false
  inline void SendRequest(::System::Net::WebOperation* operation, ::StringW groupName);

  /// @brief Method WaitAsync, addr 0x1043458, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method <Run>b__31_0, addr 0x1043560, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1040134, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePoint* servicePoint, int32_t connectionLimit, int32_t maxIdleTime);

  static inline int32_t getStaticF_nextId();

  /// @brief Method get_MaxIdleTime, addr 0x10419f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxIdleTime();

  /// @brief Method get_ServicePoint, addr 0x10419e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  static inline void setStaticF_nextId(int32_t value);

  /// @brief Method set_ServicePoint, addr 0x10419f0, size 0x8, virtual false, abstract: false, final false
