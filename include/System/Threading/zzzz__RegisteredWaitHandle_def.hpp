...
public:
  ...
  /// @brief Method DoCallBack, addr 0xed0abc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Unregister, addr 0xed0bc0, size 0xf4, virtual false, abstract: false, final false
  inline bool Unregister(::System::Threading::WaitHandle* waitObject);

  /// @brief Method Wait, addr 0xed0590, size 0x52c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xece3d0, size 0xb4, virtual false, abstract: false, final false
