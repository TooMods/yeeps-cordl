...
template <typename T> inline int32_t UnityEngine::Rendering::DynamicArrayExtensions::Partition(::ArrayW<T, ::Array<T>*> data, int32_t left, int32_t right) {
...
template <typename T> inline void UnityEngine::Rendering::DynamicArrayExtensions::QuickSort(::ArrayW<T, ::Array<T>*> data, int32_t left, int32_t right) {
  static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
