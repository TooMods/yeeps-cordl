...
public:
  ...
  /// @brief Method Flatten, addr 0x2b0b068, size 0x3c0, virtual false, abstract: false, final false
  inline ::System::AggregateException* Flatten();

  /// @brief Method GetObjectData, addr 0x2b0af14, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2b0b5b4, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0a000, size 0x114, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b0ad2c, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2b0a7d4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0a394, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Exception*, ::Array<::System::Exception*>*> innerExceptions);

  /// @brief Method .ctor, addr 0x2b0a278, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::System::Exception*>* innerExceptions);

  /// @brief Method .ctor, addr 0x2b0a114, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x2b0a82c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0a8f0, size 0x43c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0a3ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::ArrayW<::System::Exception*, ::Array<::System::Exception*>*> innerExceptions);

  /// @brief Method .ctor, addr 0x2b0a2d0, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Collections::Generic::IEnumerable_1<::System::Exception*>* innerExceptions);

  /// @brief Method .ctor, addr 0x2b0a3f0, size 0x3c0, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Collections::Generic::IList_1<::System::Exception*>* innerExceptions);

  /// @brief Method get_InnerExceptions, addr 0x2b0b060, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Exception*>* get_InnerExceptions();

  /// @brief Method get_Message, addr 0x2b0b428, size 0x18c, virtual true, abstract: false, final false
