...
public:
  ...
  /// @brief Method Equals, addr 0x125ac10, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x125ac80, size 0xac, virtual false, abstract: false, final false
  static inline bool Equals(::System::Xml::Serialization::TypeMember* tm1, ::System::Xml::Serialization::TypeMember* tm2);

  /// @brief Method GetHashCode, addr 0x125abc8, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Xml::Serialization::TypeMember* New_ctor(::System::Type* type, ::StringW member);

  /// @brief Method ToString, addr 0x125ad2c, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x125ab9c, size 0x2c, virtual false, abstract: false, final false
