...
public:
  ...
  /// @brief Method Equals, addr 0x112ade0, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x112aec8, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::ViaHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x112add8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x112b2c8, size 0x1b8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x112af94, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x112b044, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x112ad90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Comment, addr 0x112ad98, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Comment();

  /// @brief Method get_ProtocolName, addr 0x112ada8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ProtocolName();

  /// @brief Method get_ProtocolVersion, addr 0x112adb8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ProtocolVersion();

  /// @brief Method get_ReceivedBy, addr 0x112adc8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ReceivedBy();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Comment, addr 0x112ada0, size 0x8, virtual false, abstract: false, final false
  inline void set_Comment(::StringW value);

  /// @brief Method set_ProtocolName, addr 0x112adb0, size 0x8, virtual false, abstract: false, final false
  inline void set_ProtocolName(::StringW value);

  /// @brief Method set_ProtocolVersion, addr 0x112adc0, size 0x8, virtual false, abstract: false, final false
  inline void set_ProtocolVersion(::StringW value);

  /// @brief Method set_ReceivedBy, addr 0x112add0, size 0x8, virtual false, abstract: false, final false
