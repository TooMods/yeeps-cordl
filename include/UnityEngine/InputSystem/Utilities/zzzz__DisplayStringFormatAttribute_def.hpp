...
public:
  ...
  /// @brief Method .ctor, addr 0x226a6e8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW formatString);

  /// @brief Method get_formatString, addr 0x226a6d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_formatString();

  /// @brief Method set_formatString, addr 0x226a6e0, size 0x8, virtual false, abstract: false, final false
