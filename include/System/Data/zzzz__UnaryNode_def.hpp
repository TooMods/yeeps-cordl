...
public:
  ...
  /// @brief Method Bind, addr 0x1c96b24, size 0x28, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method DependsOn, addr 0x1c97410, size 0x24, virtual true, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Eval, addr 0x1c96b4c, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x1c97370, size 0x20, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t, ::Array<int32_t>*> recordNos);

  /// @brief Method Eval, addr 0x1c96b60, size 0x40, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method EvalUnaryOp, addr 0x1c96ba0, size 0x7d0, virtual false, abstract: false, final false
  inline ::System::Object* EvalUnaryOp(int32_t op, ::System::Object* vl);

  /// @brief Method HasLocalAggregate, addr 0x1c973d0, size 0x20, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x1c973f0, size 0x20, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x1c97390, size 0x20, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x1c973b0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Optimize, addr 0x1c97434, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c96af4, size 0x30, virtual false, abstract: false, final false
