...
public:
  // Declarations
  /// @brief Method Compare, addr 0x1f38534, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1f38520, size 0x14, virtual false, abstract: false, final false
