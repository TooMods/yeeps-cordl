...
public:
  ...
  /// @brief Method Dispose, addr 0x10e8ef4, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Hold, addr 0x10e8ec8, size 0x24, virtual false, abstract: false, final false
