...
public:
  ...
  /// @brief Method Create, addr 0x1e043a8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x1e0439c, size 0xc, virtual true, abstract: false, final true
