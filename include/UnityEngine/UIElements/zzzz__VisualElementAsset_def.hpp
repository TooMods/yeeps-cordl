...
public:
  ...
  /// @brief Method AddProperty, addr 0x27b5588, size 0x4, virtual false, abstract: false, final false
  inline void AddProperty(::StringW propertyName, ::StringW propertyValue);

  /// @brief Method OnAfterDeserialize, addr 0x27b5400, size 0x188, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x27b53fc, size 0x4, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method SetOrAddProperty, addr 0x27b558c, size 0x210, virtual false, abstract: false, final false
  inline void SetOrAddProperty(::StringW propertyName, ::StringW propertyValue);

  /// @brief Method TryGetAttributeValue, addr 0x27b579c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_classes, addr 0x27b3f80, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_classes();

  /// @brief Method get_fullTypeName, addr 0x27b3d7c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_hasStylesheetPaths, addr 0x27b3f88, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasStylesheetPaths();

  /// @brief Method get_hasStylesheets, addr 0x27b4018, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasStylesheets();

  /// @brief Method get_id, addr 0x27b2be8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_orderInDocument, addr 0x27b3af8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_orderInDocument();

  /// @brief Method get_parentId, addr 0x27b29bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_parentId();

  /// @brief Method get_ruleIndex, addr 0x27b3ab4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ruleIndex();

  /// @brief Method get_stylesheetPaths, addr 0x27b3f98, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_stylesheetPaths();

  /// @brief Method get_stylesheets, addr 0x27b4028, size 0x80, virtual false, abstract: false, final false
