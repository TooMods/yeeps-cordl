...
public:
  ...
  /// @brief Method <ProcessEventAtTarget>b__99_0, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ProcessEventAtTarget_b__99_0();
