...
public:
  ...
  /// @brief Method Complete_internal, addr 0x2c902fc, size 0x28, virtual false, abstract: false, final false
  inline void Complete_internal();

  /// @brief Method Dispose, addr 0x2c901c0, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2c901ac, size 0x14, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x2c9019c, size 0x10, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::System::Net::Sockets::SocketAsyncEventArgs* New_ctor(bool flowExecutionContext);

  /// @brief Method OnCompleted, addr 0x2c90324, size 0x28, virtual true, abstract: false, final false
  inline void OnCompleted(::System::Net::Sockets::SocketAsyncEventArgs* e);

  /// @brief Method SetBuffer, addr 0x2c90370, size 0xf4, virtual false, abstract: false, final false
  inline void SetBuffer(::System::Memory_1<uint8_t> buffer);

  /// @brief Method SetBytesTransferred, addr 0x2c8c33c, size 0x8, virtual false, abstract: false, final false
  inline void SetBytesTransferred(int32_t value);

  /// @brief Method SetCurrentSocket, addr 0x2c9022c, size 0x8, virtual false, abstract: false, final false
  inline void SetCurrentSocket(::System::Net::Sockets::Socket* socket);

  /// @brief Method SetLastOperation, addr 0x2c90234, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c88ac4, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool flowExecutionContext);

  /// @brief Method get_AcceptSocket, addr 0x2c9013c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_AcceptSocket();

  /// @brief Method get_BufferList, addr 0x2c90368, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::ArraySegment_1<uint8_t>>* get_BufferList();

  /// @brief Method get_BytesTransferred, addr 0x2c9014c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_BytesTransferred();

  /// @brief Method get_Count, addr 0x2c90360, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_CurrentSocket, addr 0x2c90224, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_CurrentSocket();

  /// @brief Method get_MemoryBuffer, addr 0x2c9034c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Memory_1<uint8_t> get_MemoryBuffer();

  /// @brief Method get_Offset, addr 0x2c90358, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Offset();

  /// @brief Method get_SocketError, addr 0x2c9016c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::SocketError get_SocketError();

  /// @brief Method get_UserToken, addr 0x2c90184, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_UserToken();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_AcceptSocket, addr 0x2c90144, size 0x8, virtual false, abstract: false, final false
  inline void set_AcceptSocket(::System::Net::Sockets::Socket* value);

  /// @brief Method set_BytesTransferred, addr 0x2c90154, size 0x8, virtual false, abstract: false, final false
  inline void set_BytesTransferred(int32_t value);

  /// @brief Method set_LastOperation, addr 0x2c9015c, size 0x8, virtual false, abstract: false, final false
  inline void set_LastOperation(::System::Net::Sockets::SocketAsyncOperation value);

  /// @brief Method set_RemoteEndPoint, addr 0x2c90164, size 0x8, virtual false, abstract: false, final false
  inline void set_RemoteEndPoint(::System::Net::EndPoint* value);

  /// @brief Method set_SocketError, addr 0x2c90174, size 0x8, virtual false, abstract: false, final false
  inline void set_SocketError(::System::Net::Sockets::SocketError value);

  /// @brief Method set_SocketFlags, addr 0x2c9017c, size 0x8, virtual false, abstract: false, final false
  inline void set_SocketFlags(::System::Net::Sockets::SocketFlags value);

  /// @brief Method set_UserToken, addr 0x2c9018c, size 0x8, virtual false, abstract: false, final false
