...
public:
  ...
  /// @brief Method MoveNext, addr 0x2deb118, size 0x8dc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2deb9f4, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method <ProcessRead>b__0, addr 0x2deba4c, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* _ProcessRead_b__0(::System::Threading::CancellationToken ct);

  /// @brief Method <ProcessRead>b__1, addr 0x2deba88, size 0x3c, virtual false, abstract: false, final false
  inline void _ProcessRead_b__1();

  /// @brief Method <ProcessRead>b__2, addr 0x2debac4, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2debae4, size 0x568, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2dec04c, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2dec0a4, size 0x954, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2dec9f8, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2deca04, size 0x6b8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2ded0bc, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Close_internal, addr 0x2dea67c, size 0x88, virtual true, abstract: false, final false
  inline void Close_internal(ByRef<bool> disposed);

  /// @brief Method GetReadException, addr 0x2dea704, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResponse, addr 0x2dea998, size 0x780, virtual false, abstract: false, final false
  inline bool GetResponse(::System::Net::BufferOffsetSize* buffer, ByRef<int32_t> pos, ByRef<::System::Net::ReadState> state);

  /// @brief Method InitReadAsync, addr 0x2de54c8, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* InitReadAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Initialize, addr 0x2de9ec8, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessRead, addr 0x2de9ae4, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAllAsync, addr 0x2dea4ec, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ReadAllAsync(bool resending, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ReadAllAsyncInner, addr 0x2dea3ec, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsync, addr 0x2de99b0, size 0x134, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method TryReadFromBufferedContent, addr 0x2de9d6c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x2dea5e0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2de5448, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebRequestStream* request);

  /// @brief Method get_CanRead, addr 0x2de998c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite, addr 0x2de9994, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_ChunkedRead, addr 0x2de999c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ChunkedRead();

  /// @brief Method get_ExpectContent, addr 0x2de9e38, size 0x90, virtual false, abstract: false, final false
  inline bool get_ExpectContent();

  /// @brief Method get_Headers, addr 0x2de9938, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_KeepAlive, addr 0x2de9978, size 0x8, virtual false, abstract: false, final false
  inline bool get_KeepAlive();

  /// @brief Method get_RequestStream, addr 0x2de9930, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebRequestStream* get_RequestStream();

  /// @brief Method get_StatusCode, addr 0x2de9948, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpStatusCode get_StatusCode();

  /// @brief Method get_StatusDescription, addr 0x2de9958, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_StatusDescription();

  /// @brief Method get_Version, addr 0x2de9968, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Method set_ChunkedRead, addr 0x2de99a4, size 0xc, virtual false, abstract: false, final false
  inline void set_ChunkedRead(bool value);

  /// @brief Method set_Headers, addr 0x2de9940, size 0x8, virtual false, abstract: false, final false
  inline void set_Headers(::System::Net::WebHeaderCollection* value);

  /// @brief Method set_KeepAlive, addr 0x2de9980, size 0xc, virtual false, abstract: false, final false
  inline void set_KeepAlive(bool value);

  /// @brief Method set_StatusCode, addr 0x2de9950, size 0x8, virtual false, abstract: false, final false
  inline void set_StatusCode(::System::Net::HttpStatusCode value);

  /// @brief Method set_StatusDescription, addr 0x2de9960, size 0x8, virtual false, abstract: false, final false
  inline void set_StatusDescription(::StringW value);

  /// @brief Method set_Version, addr 0x2de9970, size 0x8, virtual false, abstract: false, final false
