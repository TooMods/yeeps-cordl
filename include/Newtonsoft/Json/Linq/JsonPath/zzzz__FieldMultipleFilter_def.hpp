...
public:
  ...
  /// @brief Method <ExecuteFilter>b__2_0, addr 0x11a18a8, size 0x50, virtual false, abstract: false, final false
  inline ::StringW _ExecuteFilter_b__2_0(::StringW n);

  /// @brief Method .ctor, addr 0x11a18a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x11a19b0, size 0x6f4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::JsonPath::__FieldMultipleFilter___ExecuteFilter_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x11a21f4, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x11a21a4, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x11a22a8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x11a21ac, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x11a21ec, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x11a18f8, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x11a20f4, size 0xb0, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x11a20a4, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x11a1808, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ExecuteFilter, addr 0x11a177c, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a1754, size 0x28, virtual false, abstract: false, final false
