...
// Write type traits
MARK_REF_PTR_T(::ExitGames::Client::Photon::SocketUdp);
...
public:
  ...
  /// @brief Method Connect, addr 0x2ab9e44, size 0x1a8, virtual true, abstract: false, final false
  inline bool Connect();

  /// @brief Method Disconnect, addr 0x2ab9fec, size 0x240, virtual true, abstract: false, final false
  inline bool Disconnect();

  /// @brief Method Dispose, addr 0x2ab9d30, size 0x114, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DnsAndConnect, addr 0x2aba6a0, size 0x654, virtual false, abstract: false, final false
  inline void DnsAndConnect();

  /// @brief Method Finalize, addr 0x2ab9c9c, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::ExitGames::Client::Photon::SocketUdp* New_ctor(::ExitGames::Client::Photon::PeerBase* npeer);

  /// @brief Method Receive, addr 0x2aba694, size 0xc, virtual true, abstract: false, final false
  inline ::ExitGames::Client::Photon::PhotonSocketError Receive(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> data);

  /// @brief Method ReceiveLoop, addr 0x2abacf4, size 0x978, virtual false, abstract: false, final false
  inline void ReceiveLoop();

  /// @brief Method Send, addr 0x2aba22c, size 0x468, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ab9b68, size 0x134, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SocketUdp", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SocketUdp(SocketUdp&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SocketUdp", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::ExitGames::Client::Photon::SocketUdp, 0x60>, "Size mismatch!");

static_assert(offsetof(::ExitGames::Client::Photon::SocketUdp, ___sock) == 0x50, "Offset mismatch!");

static_assert(offsetof(::ExitGames::Client::Photon::SocketUdp, ___syncer) == 0x58, "Offset mismatch!");
