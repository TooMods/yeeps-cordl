...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x260f500, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260f3d0, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x260f25c, size 0x8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetAddMethod, addr 0x260f10c, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEventFromHandle, addr 0x260f2e8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x260f26c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetRemoveMethod, addr 0x260f120, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x260f0f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EventHandlerType, addr 0x260f134, size 0x128, virtual true, abstract: false, final false
  inline ::System::Type* get_EventHandlerType();

  /// @brief Method get_MemberType, addr 0x260f104, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MemberTypes get_MemberType();

  /// @brief Method internal_from_handle_type, addr 0x260f2e4, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Reflection::EventInfo* internal_from_handle_type(void* event_handle, void* type_handle);

  /// @brief Method op_Equality, addr 0x260f27c, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::EventInfo* left, ::System::Reflection::EventInfo* right);

  /// @brief Method op_Inequality, addr 0x260f2a8, size 0x3c, virtual false, abstract: false, final false
