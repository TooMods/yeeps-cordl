...
public:
  ...
  /// @brief Method .ctor, addr 0xf6249c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Net::CookieVariant variant);

  /// @brief Method get_Name, addr 0xf624a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Variant, addr 0xf624b0, size 0x8, virtual false, abstract: false, final false
