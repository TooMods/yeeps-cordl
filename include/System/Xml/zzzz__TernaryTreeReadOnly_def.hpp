...
public:
  ...
  /// @brief Method FindCaseInsensitiveString, addr 0x14ca35c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14cb5d8, size 0x28, virtual false, abstract: false, final false
