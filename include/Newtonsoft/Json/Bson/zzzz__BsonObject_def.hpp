...
public:
  ...
  /// @brief Method Add, addr 0x2f64a88, size 0x134, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x2f62a20, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2f64c04, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f64c08, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x2f64bfc, size 0x8, virtual true, abstract: false, final false
