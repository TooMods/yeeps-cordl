...
public:
  ...
  /// @brief Method DeactivateModule, addr 0x2b6fc38, size 0x4, virtual true, abstract: false, final false
  inline void DeactivateModule();

  /// @brief Method FakeTouches, addr 0x2b6f364, size 0x124, virtual false, abstract: false, final false
  inline void FakeTouches();

  /// @brief Method IsModuleSupported, addr 0x2b6f230, size 0x38, virtual true, abstract: false, final false
  inline bool IsModuleSupported();

  static inline ::UnityEngine::EventSystems::TouchInputModule* New_ctor();

  /// @brief Method Process, addr 0x2b6f33c, size 0x28, virtual true, abstract: false, final false
  inline void Process();

  /// @brief Method ProcessTouchEvents, addr 0x2b6f488, size 0x148, virtual false, abstract: false, final false
  inline void ProcessTouchEvents();

  /// @brief Method ProcessTouchPress, addr 0x2b6f5d0, size 0x668, virtual false, abstract: false, final false
  inline void ProcessTouchPress(::UnityEngine::EventSystems::PointerEventData* pointerEvent, bool pressed, bool released);

  /// @brief Method ShouldActivateModule, addr 0x2b6f268, size 0xa4, virtual true, abstract: false, final false
  inline bool ShouldActivateModule();

  /// @brief Method ToString, addr 0x2b6fc3c, size 0x250, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateModule, addr 0x2b6f0e0, size 0x150, virtual true, abstract: false, final false
  inline void UpdateModule();

  /// @brief Method UseFakeInput, addr 0x2b6f30c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6f0b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowActivationOnStandalone, addr 0x2b6f0b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_allowActivationOnStandalone();

  /// @brief Method get_forceModuleActive, addr 0x2b6f0cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_forceModuleActive();

  /// @brief Method set_allowActivationOnStandalone, addr 0x2b6f0c0, size 0xc, virtual false, abstract: false, final false
  inline void set_allowActivationOnStandalone(bool value);

  /// @brief Method set_forceModuleActive, addr 0x2b6f0d4, size 0xc, virtual false, abstract: false, final false
