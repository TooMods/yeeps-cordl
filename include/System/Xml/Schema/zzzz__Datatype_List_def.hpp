...
public:
  ...
  /// @brief Method Compare, addr 0x2fb5008, size 0x2a0, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  /// @brief Method CreateValueConverter, addr 0x2fb4d64, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x2fb597c, size 0x424, virtual true, abstract: false, final false
  inline ::System::Exception* TryParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr, ByRef<::System::Object*> typedValue);

  /// @brief Method TryParseValue, addr 0x2fb5384, size 0x5f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fb3dd4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::DatatypeImplementation* type, int32_t minListSize);

  /// @brief Method get_FacetsChecker, addr 0x2fb52fc, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ItemType, addr 0x2fb537c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::DatatypeImplementation* get_ItemType();

  /// @brief Method get_ListValueType, addr 0x2fb52d8, size 0x24, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TokenizedType, addr 0x2fb52b8, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  /// @brief Method get_TypeCode, addr 0x2fb5354, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValidRestrictionFlags, addr 0x2fb5374, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::RestrictionFlags get_ValidRestrictionFlags();

  /// @brief Method get_ValueType, addr 0x2fb52a8, size 0x10, virtual true, abstract: false, final false
