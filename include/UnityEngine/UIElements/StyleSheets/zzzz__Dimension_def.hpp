...
public:
  ...
  /// @brief Method Equals, addr 0x1f39018, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1f38ff0, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleSheets::Dimension other);

  /// @brief Method GetHashCode, addr 0x1f390a4, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToAngle, addr 0x1f38238, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Angle ToAngle();

  /// @brief Method ToLength, addr 0x1f35564, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length ToLength();

  /// @brief Method ToString, addr 0x1f34990, size 0x130, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTime, addr 0x1f35594, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimeValue ToTime();

  /// @brief Method .ctor, addr 0x1f38fbc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x1f38fc8, size 0x28, virtual false, abstract: false, final false
