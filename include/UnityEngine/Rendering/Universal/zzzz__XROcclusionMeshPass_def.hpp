...
// Type: UnityEngine.Rendering.Universal::XROcclusionMeshPass
...
public:
  // Declarations
  /// @brief Method Execute, addr 0x27288c8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2728834, size 0x94, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::Universal::XROcclusionMeshPass, 0xd8>, "Size mismatch!");
