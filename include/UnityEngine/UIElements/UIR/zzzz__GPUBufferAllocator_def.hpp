...
public:
  ...
  /// @brief Method Allocate, addr 0x209d89c, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size, bool shortLived);

  /// @brief Method Free, addr 0x209d9d8, size 0x84, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::UIElements::UIR::Alloc alloc);

  /// @brief Method HighLowCollide, addr 0x20a1ee0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20a1e4c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint32_t maxSize);

  /// @brief Method get_isEmpty, addr 0x20a1f18, size 0x3c, virtual false, abstract: false, final false
