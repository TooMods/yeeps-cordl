...
public:
  ...
  /// @brief Method GetOrMakeVariables, addr 0x182d1d0, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method ReuseOrValidateVariables, addr 0x182d220, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182d1ac, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>* variables);

  /// @brief Method get_VariablesList, addr 0x182d218, size 0x8, virtual false, abstract: false, final false
