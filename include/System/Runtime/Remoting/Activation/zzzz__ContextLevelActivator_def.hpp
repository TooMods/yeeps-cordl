...
public:
  ...
  /// @brief Method Activate, addr 0x185a794, size 0x334, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1859c38, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Activation::IActivator* next);

  /// @brief Method get_NextActivator, addr 0x185a78c, size 0x8, virtual true, abstract: false, final true
