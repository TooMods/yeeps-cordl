...
public:
  ...
  /// @brief Method Accept, addr 0x182e7b0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182e734, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_NodeType, addr 0x182e7a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x182e7a0, size 0x8, virtual true, abstract: false, final true
