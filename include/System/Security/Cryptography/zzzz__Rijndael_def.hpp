...
public:
  ...
  /// @brief Method Create, addr 0x1d23224, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::Rijndael* Create();

  /// @brief Method Create, addr 0x1d2335c, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::Rijndael* Create(::StringW algName);

  static inline ::System::Security::Cryptography::Rijndael* New_ctor();

  /// @brief Method .ctor, addr 0x1d231a8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
