...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c73394, size 0x3c8, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c732bc, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  /// @brief Method MergeForward, addr 0x1c74780, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method OnNextUpdate, addr 0x1c7375c, size 0x2d8, virtual false, abstract: false, final false
  inline void OnNextUpdate();

  /// @brief Method OnRemoved, addr 0x1c73310, size 0x84, virtual true, abstract: false, final false
  inline void OnRemoved();

  /// @brief Method OnStateEvent, addr 0x1c73a34, size 0x63c, virtual false, abstract: false, final false
  inline void OnStateEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr);

  /// @brief Method TriggerTap, addr 0x1c74070, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.ICustomDeviceReset.Reset, addr 0x1c743a0, size 0x3e0, virtual true, abstract: false, final true
  inline void UnityEngine_InputSystem_LowLevel_ICustomDeviceReset_Reset();

  /// @brief Method UnityEngine.InputSystem.LowLevel.IEventMerger.MergeForward, addr 0x1c74898, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.GetStateOffsetForEvent, addr 0x1c74144, size 0x23c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnNextUpdate, addr 0x1c7413c, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_OnNextUpdate();

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnStateEvent, addr 0x1c74140, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1c748a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_current, addr 0x1c73228, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Touchscreen* get_current();

  /// @brief Method get_primaryTouch, addr 0x1c73188, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::TouchControl* get_primaryTouch();

  /// @brief Method get_touchControlArray, addr 0x1c731ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_touches, addr 0x1c73198, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x1c73270, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::Touchscreen* value);

  /// @brief Method set_primaryTouch, addr 0x1c73190, size 0x8, virtual false, abstract: false, final false
  inline void set_primaryTouch(::UnityEngine::InputSystem::Controls::TouchControl* value);

  /// @brief Method set_touchControlArray, addr 0x1c731b4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_touches, addr 0x1c731a4, size 0x8, virtual false, abstract: false, final false
