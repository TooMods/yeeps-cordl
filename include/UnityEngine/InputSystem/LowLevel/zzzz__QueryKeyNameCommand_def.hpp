...
public:
  ...
  /// @brief Method Create, addr 0x1e02510, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyNameCommand Create(::UnityEngine::InputSystem::Key key);

  /// @brief Method ReadKeyName, addr 0x1e024d0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1e024a0, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1e024e0, size 0x30, virtual true, abstract: false, final true
