...
public:
  ...
  /// @brief Method Init, addr 0x1b39ee0, size 0x20, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x1b39f60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsSealed, addr 0x1b39c3c, size 0x4c, virtual false, abstract: false, final false
  inline bool get_IsSealed();

  /// @brief Method get_NIname, addr 0x1b3f020, size 0x38, virtual false, abstract: false, final false
  inline ::StringW get_NIname();

  /// @brief Method set_NIname, addr 0x1b3f058, size 0x8, virtual false, abstract: false, final false
