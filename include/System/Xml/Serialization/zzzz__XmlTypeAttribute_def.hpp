...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x3044318, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IncludeInSchema, addr 0x30442b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IncludeInSchema();

  /// @brief Method get_Namespace, addr 0x30442bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_TypeName, addr 0x30442c4, size 0x54, virtual false, abstract: false, final false
