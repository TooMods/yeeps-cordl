...
public:
  ...
  /// @brief Method Process, addr 0x21db16c, size 0x68, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x21db1d4, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21db27c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxOrDefault, addr 0x21db0fc, size 0x70, virtual false, abstract: false, final false
  inline float_t get_maxOrDefault();

  /// @brief Method get_minOrDefault, addr 0x21db08c, size 0x70, virtual false, abstract: false, final false
