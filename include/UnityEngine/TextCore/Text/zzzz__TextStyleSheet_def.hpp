...
public:
  ...
  /// @brief Method GetStyle, addr 0x2473c74, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(int32_t hashCode);

  /// @brief Method GetStyle, addr 0x2473ec0, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(::StringW name);

  /// @brief Method LoadStyleDictionaryInternal, addr 0x2473cfc, size 0x1c4, virtual false, abstract: false, final false
  inline void LoadStyleDictionaryInternal();

  static inline ::UnityEngine::TextCore::Text::TextStyleSheet* New_ctor();

  /// @brief Method RefreshStyles, addr 0x2473f58, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2473f5c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_styles, addr 0x2473c6c, size 0x8, virtual false, abstract: false, final false
