...
public:
  ...
  /// @brief Method CalendarIdToCultureName, addr 0x2049850, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW CalendarIdToCultureName(int32_t calendarId);

  /// @brief Method GetCalendarData, addr 0x2046d5c, size 0xa8, virtual false, abstract: false, final false
  static inline ::System::Globalization::CalendarData* GetCalendarData(int32_t calendarId);

  /// @brief Method GetJapaneseEnglishEraNames, addr 0x2049670, size 0xf0, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetJapaneseEnglishEraNames();

  /// @brief Method GetJapaneseEraNames, addr 0x2049760, size 0xf0, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetJapaneseEraNames();

  /// @brief Method InitializeAbbreviatedEraNames, addr 0x2049374, size 0x2fc, virtual false, abstract: false, final false
  inline void InitializeAbbreviatedEraNames(::StringW localeName, int32_t calendarId);

  /// @brief Method InitializeEraNames, addr 0x2048fb8, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x204745c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2048998, size 0x564, virtual false, abstract: false, final false
  inline void _ctor(::StringW localeName, int32_t calendarId, bool bUseUserOverrides);

  /// @brief Method fill_calendar_data, addr 0x204991c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method nativeGetCalendarData, addr 0x2048efc, size 0xbc, virtual false, abstract: false, final false
  static inline bool nativeGetCalendarData(::System::Globalization::CalendarData* data, ::StringW localeName, int32_t calendarId);

  /// @brief Method nativeGetTwoDigitYearMax, addr 0x2047454, size 0x8, virtual false, abstract: false, final false
