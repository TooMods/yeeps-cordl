...
public:
  ...
  /// @brief Method ConvertToJNIArray, addr 0x2f51da0, size 0x4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x2f4d490, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJavaProxy, addr 0x2f4c2d4, size 0x184, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method CreateJavaRunnable, addr 0x2f4f93c, size 0x4, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method DeleteJNIArgArray, addr 0x2f51da4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2f51a70, size 0x48, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass);

  /// @brief Method GetConstructorID, addr 0x2f502f4, size 0x4, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass, ::StringW signature);

  /// @brief Method GetConstructorID, addr 0x2f4d494, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetFieldID, addr 0x2f51b1c, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName);

  /// @brief Method GetFieldID, addr 0x2f51b80, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature);

  /// @brief Method GetFieldID, addr 0x2f51b78, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodID, addr 0x2f51ab8, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName);

  /// @brief Method GetMethodID, addr 0x2f51b14, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x2f4c588, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodID, addr 0x2f4d6a8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x2f51dac, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x2f51da8, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method get_debug, addr 0x2f51a0c, size 0x28, virtual false, abstract: false, final false
  static inline bool get_debug();

  /// @brief Method set_debug, addr 0x2f51a34, size 0x3c, virtual false, abstract: false, final false
