...
public:
  ...
  /// @brief Method Awake, addr 0x25b6974, size 0x7c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetBodyState, addr 0x25b6bdc, size 0x84, virtual false, abstract: false, final false
  inline void GetBodyState(::GlobalNamespace::__OVRPlugin__Step step);

  static inline ::GlobalNamespace::OVRBody* New_ctor();

  /// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x25b6fb4, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x25b6d64, size 0x250, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRSkeleton__SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData();

  /// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x25b6d5c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__OVRSkeleton__SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType();

  /// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x25b6fd4, size 0x8, virtual true, abstract: false, final true
  inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled();

  /// @brief Method OnDestroy, addr 0x25b6d48, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x25b6cc0, size 0x88, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x25b69f0, size 0x114, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPermissionGranted, addr 0x25b6c60, size 0x60, virtual false, abstract: false, final false
  inline void OnPermissionGranted(::StringW permissionId);

  /// @brief Method StartBodyTracking, addr 0x25b6b04, size 0xd8, virtual false, abstract: false, final false
  inline bool StartBodyTracking();

  /// @brief Method Update, addr 0x25b6d54, size 0x8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25b6fcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF__trackingInstanceCount();

  /// @brief Method get_BodyState, addr 0x25b68ec, size 0x88, virtual false, abstract: false, final false
