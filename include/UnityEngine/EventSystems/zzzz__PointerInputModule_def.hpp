...
public:
  ...
  /// @brief Method .ctor, addr 0x2b6cf6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_button, addr 0x2b6cf5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::__PointerEventData__InputButton get_button();

  /// @brief Method get_eventData, addr 0x2b6cf4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::__PointerInputModule__MouseButtonEventData* get_eventData();

  /// @brief Method set_button, addr 0x2b6cf64, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::EventSystems::__PointerEventData__InputButton value);

  /// @brief Method set_eventData, addr 0x2b6cf54, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x2b6cf74, size 0xb4, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x2b6d038, size 0xb8, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x2b6d104, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x2b6c4fc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6ced0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x2b6d028, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x2b6d0f0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6d29c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClearSelection, addr 0x2b6c910, size 0x1c0, virtual false, abstract: false, final false
  inline void ClearSelection();

  /// @brief Method CopyFromTo, addr 0x2b6c0b8, size 0x90, virtual false, abstract: false, final false
  inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData* from, ::UnityEngine::EventSystems::PointerEventData* to);

  /// @brief Method DeselectIfSelectionChanged, addr 0x2b6cd40, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastPointerEventData, addr 0x2b6c534, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t id);

  /// @brief Method GetMousePointerEventData, addr 0x2b6c1c4, size 0x14, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::__PointerInputModule__MouseState* GetMousePointerEventData();

  /// @brief Method GetMousePointerEventData, addr 0x2b6c1d8, size 0x324, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::__PointerInputModule__MouseState* GetMousePointerEventData(int32_t id);

  /// @brief Method GetPointerData, addr 0x2b6bc04, size 0xe8, virtual false, abstract: false, final false
  inline bool GetPointerData(int32_t id, ByRef<::UnityEngine::EventSystems::PointerEventData*> data, bool create);

  /// @brief Method GetTouchPointerEventData, addr 0x2b6bd48, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPointerOverGameObject, addr 0x2b6c874, size 0x9c, virtual true, abstract: false, final false
  inline bool IsPointerOverGameObject(int32_t pointerId);

  static inline ::UnityEngine::EventSystems::PointerInputModule* New_ctor();

  /// @brief Method ProcessDrag, addr 0x2b6c5c8, size 0x2ac, virtual true, abstract: false, final false
  inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method ProcessMove, addr 0x2b6c584, size 0x44, virtual true, abstract: false, final false
  inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method RemovePointerData, addr 0x2b6bcec, size 0x5c, virtual false, abstract: false, final false
  inline void RemovePointerData(::UnityEngine::EventSystems::PointerEventData* data);

  /// @brief Method ShouldStartDrag, addr 0x2b6c554, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method StateForMouseButton, addr 0x2b6c148, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::__PointerEventData__FramePressState StateForMouseButton(int32_t buttonId);

  /// @brief Method ToString, addr 0x2b6cad0, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6ce2c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
