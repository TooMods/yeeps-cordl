...
public:
  ...
  /// @brief Method FinishSetup, addr 0x187e80c, size 0x1cc, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x187e544, size 0x80, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::Mouse* New_ctor();

  /// @brief Method OnAdded, addr 0x187e610, size 0x5c, virtual true, abstract: false, final false
  inline void OnAdded();

  /// @brief Method OnNextUpdate, addr 0x187eb78, size 0x90, virtual false, abstract: false, final false
  inline void OnNextUpdate();

  /// @brief Method OnRemoved, addr 0x187e66c, size 0x80, virtual true, abstract: false, final false
  inline void OnRemoved();

  /// @brief Method OnStateEvent, addr 0x187ec90, size 0x44, virtual false, abstract: false, final false
  inline void OnStateEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr);

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnNextUpdate, addr 0x187ed20, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_OnNextUpdate();

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnStateEvent, addr 0x187ed24, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method WarpCursorPosition, addr 0x187e768, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x187ed28, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_backButton, addr 0x187e480, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_backButton();

  /// @brief Method get_clickCount, addr 0x187e4a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_clickCount();

  /// @brief Method get_current, addr 0x187e4b0, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Mouse* get_current();

  /// @brief Method get_forwardButton, addr 0x187e490, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_forwardButton();

  /// @brief Method get_leftButton, addr 0x187e450, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_leftButton();

  /// @brief Method get_middleButton, addr 0x187e460, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_middleButton();

  /// @brief Method get_rightButton, addr 0x187e470, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_rightButton();

  /// @brief Method get_scroll, addr 0x187e440, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_backButton, addr 0x187e488, size 0x8, virtual false, abstract: false, final false
  inline void set_backButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_clickCount, addr 0x187e4a8, size 0x8, virtual false, abstract: false, final false
  inline void set_clickCount(::UnityEngine::InputSystem::Controls::IntegerControl* value);

  /// @brief Method set_current, addr 0x187e4f8, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::Mouse* value);

  /// @brief Method set_forwardButton, addr 0x187e498, size 0x8, virtual false, abstract: false, final false
  inline void set_forwardButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_leftButton, addr 0x187e458, size 0x8, virtual false, abstract: false, final false
  inline void set_leftButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_middleButton, addr 0x187e468, size 0x8, virtual false, abstract: false, final false
  inline void set_middleButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_rightButton, addr 0x187e478, size 0x8, virtual false, abstract: false, final false
  inline void set_rightButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_scroll, addr 0x187e448, size 0x8, virtual false, abstract: false, final false
