...
public:
  ...
  /// @brief Method OpcodeBacktracks, addr 0x1676cd8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1676c08, size 0xd0, virtual false, abstract: false, final false
