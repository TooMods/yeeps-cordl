...
public:
  ...
  /// @brief Method CreateInstance, addr 0x184b454, size 0x104, virtual true, abstract: false, final false
  inline ::System::MarshalByRefObject* CreateInstance(::System::Type* serverType);

  /// @brief Method CreateProxy, addr 0x184b5a0, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesForNewContext, addr 0x184b610, size 0x4, virtual true, abstract: false, final true
  inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage* msg);

  /// @brief Method IsContextOK, addr 0x184b614, size 0x8, virtual true, abstract: false, final true
