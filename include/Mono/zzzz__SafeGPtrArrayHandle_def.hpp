...
public:
  ...
  /// @brief Method Dispose, addr 0x1d03d68, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x1d03d48, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(void* ptr);

  /// @brief Method get_Item, addr 0x1d03da0, size 0x4, virtual false, abstract: false, final false
  inline void* get_Item(int32_t i);

  /// @brief Method get_Length, addr 0x1d03d84, size 0x1c, virtual false, abstract: false, final false
