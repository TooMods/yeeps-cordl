...
public:
  ...
  /// @brief Method Run, addr 0x1b612a4, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x1b61170, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
