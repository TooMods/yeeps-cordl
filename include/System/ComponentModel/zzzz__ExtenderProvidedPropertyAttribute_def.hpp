...
public:
  ...
  /// @brief Method Create, addr 0x1af85e8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x1af8bb0, size 0xd4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1af8c84, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x1af8c8c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1af8b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ExtenderProperty, addr 0x1af8b80, size 0x8, virtual false, abstract: false, final false
  inline ::System::ComponentModel::PropertyDescriptor* get_ExtenderProperty();

  /// @brief Method get_Provider, addr 0x1af8b90, size 0x8, virtual false, abstract: false, final false
  inline ::System::ComponentModel::IExtenderProvider* get_Provider();

  /// @brief Method get_ReceiverType, addr 0x1af8ba0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ReceiverType();

  /// @brief Method set_ExtenderProperty, addr 0x1af8b88, size 0x8, virtual false, abstract: false, final false
  inline void set_ExtenderProperty(::System::ComponentModel::PropertyDescriptor* value);

  /// @brief Method set_Provider, addr 0x1af8b98, size 0x8, virtual false, abstract: false, final false
  inline void set_Provider(::System::ComponentModel::IExtenderProvider* value);

  /// @brief Method set_ReceiverType, addr 0x1af8ba8, size 0x8, virtual false, abstract: false, final false
