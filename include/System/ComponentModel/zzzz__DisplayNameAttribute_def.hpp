...
public:
  ...
  /// @brief Method Equals, addr 0x1ae7e0c, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1ae7ed8, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x1ae7f00, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ae7d70, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ae7dcc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName);

  static inline ::System::ComponentModel::DisplayNameAttribute* getStaticF_Default();

  /// @brief Method get_DisplayName, addr 0x1ae7df4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_DisplayNameValue, addr 0x1ae7dfc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisplayNameValue, addr 0x1ae7e04, size 0x8, virtual false, abstract: false, final false
