...
public:
  ...
  /// @brief Method AddCall, addr 0x29e3f0c, size 0x18, virtual false, abstract: false, final false
  inline void AddCall(::UnityEngine::Events::BaseInvokableCall* call);

  /// @brief Method DirtyPersistentCalls, addr 0x29e3a90, size 0x28, virtual false, abstract: false, final false
  inline void DirtyPersistentCalls();

  /// @brief Method FindMethod, addr 0x29e2af8, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* FindMethod(::UnityEngine::Events::PersistentCall* call);

  /// @brief Method FindMethod, addr 0x29e3abc, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPersistentEventCount, addr 0x29e3ec0, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetPersistentEventCount();

  /// @brief Method GetValidMethodInfo, addr 0x29e3d1c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareInvoke, addr 0x29e3f3c, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke();

  /// @brief Method RebuildPersistentCallsIfNeeded, addr 0x29e3ed8, size 0x34, virtual false, abstract: false, final false
  inline void RebuildPersistentCallsIfNeeded();

  /// @brief Method RemoveListener, addr 0x29e3f24, size 0x18, virtual false, abstract: false, final false
  inline void RemoveListener(::System::Object* targetObj, ::System::Reflection::MethodInfo* method);

  /// @brief Method ToString, addr 0x29e3f5c, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x29e3ab8, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x29e3a8c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x29e39f0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
