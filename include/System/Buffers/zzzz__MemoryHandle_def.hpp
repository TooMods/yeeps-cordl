...
public:
  ...
  /// @brief Method Dispose, addr 0x2609960, size 0xc8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x260994c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Pointer, addr 0x2609958, size 0x8, virtual false, abstract: false, final false
