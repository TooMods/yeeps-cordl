...
public:
  // Declarations
  /// @brief Method Add, addr 0x2a84ba4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x2a84ba8, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
