...
public:
  ...
  /// @brief Method ResolvePropertyName, addr 0xf0b4b8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ResolvePropertyName(::StringW name);

  /// @brief Method .ctor, addr 0xf0b4c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
