...
public:
  ...
  /// @brief Method Finalize, addr 0x2bf51a8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bf5180, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::LocalDataStore* store);

  /// @brief Method get_Store, addr 0x2bf5260, size 0x8, virtual false, abstract: false, final false
