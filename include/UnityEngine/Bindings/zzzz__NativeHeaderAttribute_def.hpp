...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7760, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  /// @brief Method set_Header, addr 0x23a7758, size 0x8, virtual true, abstract: false, final true
