...
public:
  ...
  /// @brief Method Cull, addr 0x1ff7d08, size 0x10c, virtual false, abstract: false, final false
  inline void Cull();

  /// @brief Method Disable, addr 0x1ff8fb0, size 0x5c, virtual false, abstract: false, final false
  static inline void Disable(::UnityEngine::UI::IClipper* c);

  static inline ::UnityEngine::UI::ClipperRegistry* New_ctor();

  /// @brief Method Register, addr 0x1ff8ee4, size 0x70, virtual false, abstract: false, final false
  static inline void Register(::UnityEngine::UI::IClipper* c);

  /// @brief Method Unregister, addr 0x1ff8f54, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ff8e68, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UI::ClipperRegistry* getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x1ff7c8c, size 0x7c, virtual false, abstract: false, final false
