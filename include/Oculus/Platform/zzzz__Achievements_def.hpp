...
public:
  // Declarations
  /// @brief Method AddCount, addr 0x19bbcb4, size 0x170, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementUpdate*>* AddCount(::StringW name, uint64_t count);

  /// @brief Method AddFields, addr 0x19bbe24, size 0x170, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementUpdate*>* AddFields(::StringW name, ::StringW fields);

  /// @brief Method GetAllDefinitions, addr 0x19bbf94, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementDefinitionList*>* GetAllDefinitions();

  /// @brief Method GetAllProgress, addr 0x19bc0ec, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementProgressList*>* GetAllProgress();

  /// @brief Method GetDefinitionsByName, addr 0x19bc244, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAchievementDefinitionListPage, addr 0x19bc68c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAchievementProgressListPage, addr 0x19bc868, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProgressByName, addr 0x19bc3b8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method Unlock, addr 0x19bc52c, size 0x160, virtual false, abstract: false, final false
