...
public:
  ...
  /// @brief Method AddArgument, addr 0x1941a64, size 0x1dc, virtual false, abstract: false, final false
  inline void AddArgument(::System::Data::ExpressionNode* argument);

  /// @brief Method Bind, addr 0x194334c, size 0x2d8, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method Check, addr 0x1941c40, size 0x1a0, virtual false, abstract: false, final false
  inline void Check();

  /// @brief Method DependsOn, addr 0x1945a88, size 0x88, virtual true, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Eval, addr 0x1943624, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x1945854, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t, ::Array<int32_t>*> recordNos);

  /// @brief Method Eval, addr 0x1943638, size 0x940, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method EvalFunction, addr 0x19441f8, size 0x165c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDataType, addr 0x1943f78, size 0x280, virtual false, abstract: false, final false
  inline ::System::Type* GetDataType(::System::Data::ExpressionNode* node);

  /// @brief Method HasLocalAggregate, addr 0x1945990, size 0x7c, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x1945a0c, size 0x7c, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x1945884, size 0x90, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x1945914, size 0x7c, virtual true, abstract: false, final false
  inline bool IsTableConstant();

  static inline ::System::Data::FunctionNode* New_ctor(::System::Data::DataTable* table, ::StringW name);

  /// @brief Method Optimize, addr 0x1945b10, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19414d8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aggregate, addr 0x19416c4, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Data::FunctionId get_Aggregate();

  /// @brief Method get_IsAggregate, addr 0x1945cc0, size 0x234, virtual false, abstract: false, final false
