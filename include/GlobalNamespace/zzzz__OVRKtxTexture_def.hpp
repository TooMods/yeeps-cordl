...
public:
  // Declarations
  /// @brief Method Load, addr 0xfb3644, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb3894, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
