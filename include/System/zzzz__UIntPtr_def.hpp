...
public:
  ...
  /// @brief Method Equals, addr 0x10dc180, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x10dc1f8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method System.IEquatable<System.UIntPtr>.Equals, addr 0x10dc35c, size 0x10, virtual true, abstract: false, final true
  inline bool System_IEquatable_System_UIntPtr__Equals(void* other);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x10dc270, size 0xa4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToString, addr 0x10dc200, size 0x70, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x10dc178, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::cordl_internals::Ptr<void> value);

  /// @brief Method .ctor, addr 0x10dc16c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t value);

  /// @brief Method .ctor, addr 0x10dc104, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(uint64_t value);

  static inline void* getStaticF_Zero();

  /// @brief Method get_Size, addr 0x10dc164, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x10dc314, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(void* value1, void* value2);

  /// @brief Method op_Explicit, addr 0x10dc330, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t op_Explicit_uint32_t(void* value);

  /// @brief Method op_Explicit, addr 0x10dc32c, size 0x4, virtual false, abstract: false, final false
  static inline uint64_t op_Explicit_uint64_t(void* value);

  /// @brief Method op_Explicit, addr 0x10dc354, size 0x8, virtual false, abstract: false, final false
  static inline void* op_Explicit_void_(uint32_t value);

  /// @brief Method op_Explicit, addr 0x10dc334, size 0x20, virtual false, abstract: false, final false
  static inline void* op_Explicit_void_(uint64_t value);

  /// @brief Method op_Inequality, addr 0x10dc320, size 0xc, virtual false, abstract: false, final false
