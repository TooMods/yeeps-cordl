...
public:
  ...
  /// @brief Method AddActionMap, addr 0x1ac9268, size 0x1610, virtual false, abstract: false, final false
  inline void AddActionMap(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method ApplyParameters, addr 0x1acada4, size 0x684, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignCompositePartIndex, addr 0x1acab6c, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x1ac9138, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method InstantiateBindingComposite, addr 0x1aca878, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method StartWithPreviousResolve, addr 0x1ac9180, size 0xe8, virtual false, abstract: false, final false
  inline void StartWithPreviousResolve(::UnityEngine::InputSystem::InputActionState* state, bool isFullResolve);

  /// @brief Method get_totalActionCount, addr 0x1ac9120, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalActionCount();

  /// @brief Method get_totalBindingCount, addr 0x1ac9128, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalBindingCount();

  /// @brief Method get_totalControlCount, addr 0x1ac9130, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalControlCount();

  /// @brief Method get_totalMapCount, addr 0x1ac9118, size 0x8, virtual false, abstract: false, final false
