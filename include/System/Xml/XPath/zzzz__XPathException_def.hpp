...
public:
  ...
  /// @brief Method Create, addr 0x1253c4c, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Xml::XPath::XPathException* Create(::StringW res);

  /// @brief Method Create, addr 0x1253d24, size 0xf0, virtual false, abstract: false, final false
  static inline ::System::Xml::XPath::XPathException* Create(::StringW res, ::StringW arg);

  /// @brief Method Create, addr 0x1253e14, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Xml::XPath::XPathException* Create(::StringW res, ::StringW arg, ::StringW arg2);

  /// @brief Method CreateMessage, addr 0x1253894, size 0x13c, virtual false, abstract: false, final false
  static inline ::StringW CreateMessage(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method GetObjectData, addr 0x12539d0, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1253ab8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1253620, size 0x274, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x1253b0c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x1253cd4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x1253bf0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Exception* inner);

  /// @brief Method get_Message, addr 0x1253f30, size 0x18, virtual true, abstract: false, final false
