...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3508, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* GetDataFromMessage(void* c_message);

  /// @brief Method GetDataStore, addr 0x19b34cc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0bfc, size 0x58, virtual false, abstract: false, final false
