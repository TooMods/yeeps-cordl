...
public:
  ...
  /// @brief Method AddHandler, addr 0x14c2444, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IValidationEventHandling.SendEvent, addr 0x14c365c, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IValidationEventHandling.get_EventHandler, addr 0x14c3654, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x14c241c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddDefaultAttribute, addr 0x14c34d4, size 0x1c, virtual false, abstract: false, final false
  inline bool AddDefaultAttribute(::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method Close, addr 0x14c2e98, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetAttribute, addr 0x14c2980, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x14c295c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW localName, ::StringW namespaceURI);

  /// @brief Method GetAttribute, addr 0x14c2938, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetNamespacesInScope, addr 0x14c323c, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method GetResolver, addr 0x14c2344, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method HasLineInfo, addr 0x14c3060, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method LookupNamespace, addr 0x14c2ecc, size 0x24, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x14c32f8, size 0xac, virtual false, abstract: false, final false
  inline ::StringW LookupPrefix(::StringW namespaceName);

  /// @brief Method MoveOffEntityReference, addr 0x14c2f8c, size 0xb8, virtual false, abstract: false, final false
  inline void MoveOffEntityReference();

  /// @brief Method MoveToAttribute, addr 0x14c29a4, size 0x40, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x14c29e4, size 0x30, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x14c2a94, size 0x40, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x14c2a14, size 0x40, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x14c2a54, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method ParseDtdFromParserContext, addr 0x14c2c98, size 0x178, virtual false, abstract: false, final false
  inline void ParseDtdFromParserContext();

  /// @brief Method ProcessCoreReaderEvent, addr 0x14c2bac, size 0xec, virtual false, abstract: false, final false
  inline void ProcessCoreReaderEvent();

  /// @brief Method Read, addr 0x14c2ad4, size 0xd8, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeValue, addr 0x14c2ef0, size 0x60, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadString, addr 0x14c3044, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ResolveEntity, addr 0x14c2f58, size 0x34, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ResolveEntityInternally, addr 0x14c2e10, size 0x88, virtual false, abstract: false, final false
  inline void ResolveEntityInternally();

  /// @brief Method SetupValidation, addr 0x14c24c4, size 0x140, virtual false, abstract: false, final false
  inline void SetupValidation(::System::Xml::ValidationType valType);

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x14c3238, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x14c32e4, size 0x10, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x14c32f4, size 0x4, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method ValidateDefaultAttributeOnUse, addr 0x14c3514, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateDtd, addr 0x14c33b4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14c1ff4, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeCount, addr 0x14c2914, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0x14c27b8, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CanResolveEntity, addr 0x14c2f50, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanResolveEntity();

  /// @brief Method get_Depth, addr 0x14c2798, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_DtdInfo, addr 0x14c34f0, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::IDtdInfo* get_DtdInfo();

  /// @brief Method get_EOF, addr 0x14c28cc, size 0x24, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_IsDefault, addr 0x14c2800, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0x14c27dc, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LineNumber, addr 0x14c3068, size 0xe8, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x14c3150, size 0xe8, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x14c2718, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x14c26f8, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x14c28f0, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceManager, addr 0x14c3440, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNamespaceManager* get_NamespaceManager();

  /// @brief Method get_NamespaceURI, addr 0x14c2738, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_Namespaces, addr 0x14c1fd8, size 0x1c, virtual false, abstract: false, final false
  inline bool get_Namespaces();

  /// @brief Method get_NodeType, addr 0x14c26d8, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x14c2758, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0x14c2824, size 0x24, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0x14c2890, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_Schemas, addr 0x14c33ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaCollection* get_Schemas();

  /// @brief Method get_Settings, addr 0x14c2604, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_StandAlone, addr 0x14c3464, size 0x1c, virtual false, abstract: false, final false
  inline bool get_StandAlone();

  /// @brief Method get_TypedValueObject, addr 0x14c349c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* get_TypedValueObject();

  /// @brief Method get_ValidationType, addr 0x14c33a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ValidationType get_ValidationType();

  /// @brief Method get_Validator, addr 0x14c3430, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BaseValidator* get_Validator();

  /// @brief Method get_Value, addr 0x14c2778, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XmlLang, addr 0x14c286c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x14c2848, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method set_SchemaTypeObject, addr 0x14c3480, size 0x1c, virtual false, abstract: false, final false
  inline void set_SchemaTypeObject(::System::Object* value);

  /// @brief Method set_TypedValueObject, addr 0x14c34b8, size 0x1c, virtual false, abstract: false, final false
  inline void set_TypedValueObject(::System::Object* value);

  /// @brief Method set_Validator, addr 0x14c3438, size 0x8, virtual false, abstract: false, final false
