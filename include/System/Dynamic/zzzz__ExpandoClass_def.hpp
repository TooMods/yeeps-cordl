...
public:
  ...
  /// @brief Method FindNewClass, addr 0x1b66428, size 0x400, virtual false, abstract: false, final false
  inline ::System::Dynamic::ExpandoClass* FindNewClass(::StringW newKey);

  /// @brief Method GetTransitionList, addr 0x1b66828, size 0x130, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::WeakReference*>* GetTransitionList(int32_t hashCode);

  /// @brief Method GetValueIndex, addr 0x1b66958, size 0x10, virtual false, abstract: false, final false
  inline int32_t GetValueIndex(::StringW name, bool caseInsensitive, ::System::Dynamic::ExpandoObject* obj);

  /// @brief Method GetValueIndexCaseInsensitive, addr 0x1b66968, size 0x1b0, virtual false, abstract: false, final false
  inline int32_t GetValueIndexCaseInsensitive(::StringW name, ::System::Dynamic::ExpandoObject* obj);

  /// @brief Method GetValueIndexCaseSensitive, addr 0x1b66b18, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b66360, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1b663f8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Keys, addr 0x1b66c34, size 0x8, virtual false, abstract: false, final false
