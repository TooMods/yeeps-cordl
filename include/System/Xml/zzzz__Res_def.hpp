...
public:
  // Declarations
  /// @brief Method GetString, addr 0x12476bc, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetString(::StringW name);

  /// @brief Method GetString, addr 0x12452e8, size 0x10, virtual false, abstract: false, final false
