...
public:
  ...
  /// @brief Method CheckConstraint, addr 0x2406acc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateForProperty, addr 0x2406b68, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2406cb0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2406cbc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConstraintName, addr 0x2406508, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ConstraintName();

  /// @brief Method get_ExtendedProperties, addr 0x2406a60, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_InCollection, addr 0x2406a14, size 0x8, virtual true, abstract: false, final false
  inline bool get_InCollection();

  /// @brief Method get_SchemaName, addr 0x24069ac, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get__DataSet, addr 0x2406ca8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* get__DataSet();

  /// @brief Method set_ConstraintName, addr 0x2406510, size 0x1d0, virtual true, abstract: false, final false
  inline void set_ConstraintName(::StringW value);

  /// @brief Method set_InCollection, addr 0x2406a1c, size 0x44, virtual true, abstract: false, final false
  inline void set_InCollection(bool value);

  /// @brief Method set_SchemaName, addr 0x24069e4, size 0x30, virtual false, abstract: false, final false
