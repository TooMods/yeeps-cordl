...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*> const& __cordl_internal_get_ItemAdded() const;

  constexpr ::UnityEngine::Rendering::ListChangedEventHandler_1<T>*& __cordl_internal_get_ItemRemoved();

  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*> const& __cordl_internal_get_ItemRemoved() const;

  constexpr ::System::Collections::Generic::IList_1<T>*& __cordl_internal_get_m_List();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<T>*> const& __cordl_internal_get_m_List() const;
