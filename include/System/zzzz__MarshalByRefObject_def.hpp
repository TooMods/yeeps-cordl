...
public:
  ...
  /// @brief Method CreateObjRef, addr 0x2e81c00, size 0x40, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type* requestedType);

  /// @brief Method InitializeLifetimeService, addr 0x2e81c40, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e7ade8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ObjectIdentity, addr 0x2e81b80, size 0x40, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::ServerIdentity* get_ObjectIdentity();

  /// @brief Method set_ObjectIdentity, addr 0x2e81bc0, size 0x40, virtual false, abstract: false, final false
