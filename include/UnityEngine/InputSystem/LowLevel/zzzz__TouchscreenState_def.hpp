...
public:
  ...
  /// @brief Method get_Format, addr 0x1e03880, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x1e038bc, size 0x30, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_primaryTouch, addr 0x1e038b0, size 0x4, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::TouchState> get_primaryTouch();

  /// @brief Method get_touches, addr 0x1e038b4, size 0x8, virtual false, abstract: false, final false
