...
CORDL_MODULE_EXPORT(AsyncResult_1)
...
// Write type traits
MARK_GEN_REF_PTR_T(::Unity::Services::Vivox::AsyncResult_1);
// Type: Unity.Services.Vivox::AsyncResult`1
...
template <typename T>
// Is value type: false
// CS Name: ::Unity.Services.Vivox::AsyncResult`1<T>*
class CORDL_TYPE AsyncResult_1 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Field <AsyncState>k__BackingField, offset 0x30, size 0x8
  ...
  /// @brief Field <Callback>k__BackingField, offset 0x28, size 0x8
  ...
  /// @brief Field <CompletedSynchronously>k__BackingField, offset 0x38, size 0x1
  ...
  /// @brief Field <IsCompleted>k__BackingField, offset 0x39, size 0x1
  ...
  static inline ::Unity::Services::Vivox::AsyncResult_1<T>* New_ctor(::System::AsyncCallback* callback);

  /// @brief Method SetComplete, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void SetComplete(::System::Exception* exception);

  /// @brief Method SetComplete, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void SetComplete(T result);

  /// @brief Method SetCompletedSynchronously, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void SetCompletedSynchronously(T result);
  ...
  /// @brief Method get_AsyncState, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
  ...
  /// @brief Method get_CompletedSynchronously, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
  ...
  /// @brief Method set_AsyncState, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CompletedSynchronously, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void set_CompletedSynchronously(bool value);

  /// @brief Method set_IsCompleted, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr AsyncResult_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "AsyncResult_1", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsyncResult_1(AsyncResult_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsyncResult_1", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsyncResult_1(AsyncResult_1 const&) = delete;
  ...
  /// @brief Field <Callback>k__BackingField, offset: 0x28, size: 0x8, def value: None
  ::System::AsyncCallback* ____Callback_k__BackingField;

  /// @brief Field <AsyncState>k__BackingField, offset: 0x30, size: 0x8, def value: None
  ::System::Object* ____AsyncState_k__BackingField;

  /// @brief Field <CompletedSynchronously>k__BackingField, offset: 0x38, size: 0x1, def value: None
  bool ____CompletedSynchronously_k__BackingField;

  /// @brief Field <IsCompleted>k__BackingField, offset: 0x39, size: 0x1, def value: None
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Services::Vivox::AsyncResult_1, "Unity.Services.Vivox", "AsyncResult`1");
