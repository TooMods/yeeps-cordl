...
public:
  ...
  /// @brief Method AddID, addr 0x1cde678, size 0x90, virtual false, abstract: false, final false
  inline void AddID(::StringW name, ::System::Object* node);

  /// @brief Method CheckDefaultValue, addr 0x1cd9720, size 0x47c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForwardRefs, addr 0x1cde7cc, size 0x104, virtual false, abstract: false, final false
  inline void CheckForwardRefs();

  /// @brief Method CheckValue, addr 0x1cdd458, size 0x5ec, virtual false, abstract: false, final false
  inline void CheckValue(::StringW value, ::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CompleteValidation, addr 0x1cde708, size 0xc4, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method FindId, addr 0x1cde9a4, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Object* FindId(::StringW name);

  /// @brief Method Init, addr 0x1cdbedc, size 0x1a8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method LoadSchema, addr 0x1cddae0, size 0x194, virtual false, abstract: false, final false
  inline void LoadSchema(::StringW uri);

  /// @brief Method LoadSchemaFromLocation, addr 0x1cddd20, size 0x650, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x1cdda44, size 0x9c, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method ProcessElement, addr 0x1cdc958, size 0xa8, virtual false, abstract: false, final false
  inline void ProcessElement();

  /// @brief Method ProcessInlineSchema, addr 0x1cdc2b8, size 0x208, virtual false, abstract: false, final false
  inline void ProcessInlineSchema();

  /// @brief Method ProcessTokenizedType, addr 0x1cde470, size 0x208, virtual false, abstract: false, final false
  inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType ttype, ::StringW name);

  /// @brief Method Push, addr 0x1cdc11c, size 0xd4, virtual false, abstract: false, final false
  inline void Push(::System::Xml::XmlQualifiedName* elementName);

  /// @brief Method QualifiedName, addr 0x1cddc74, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* QualifiedName(::StringW name, ::StringW ns);

  /// @brief Method ThoroughGetElementDecl, addr 0x1cdca0c, size 0x314, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* ThoroughGetElementDecl();

  /// @brief Method Validate, addr 0x1cdc1f0, size 0xb8, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method ValidateChildElement, addr 0x1cdc810, size 0x148, virtual false, abstract: false, final false
  inline void ValidateChildElement();

  /// @brief Method ValidateElement, addr 0x1cdc4c0, size 0x190, virtual false, abstract: false, final false
  inline void ValidateElement();

  /// @brief Method ValidateEndElement, addr 0x1cdc650, size 0x1c0, virtual false, abstract: false, final false
  inline void ValidateEndElement();

  /// @brief Method ValidateEndStartElement, addr 0x1cdd0fc, size 0x35c, virtual false, abstract: false, final false
  inline void ValidateEndStartElement();

  /// @brief Method ValidateStartElement, addr 0x1cdcd20, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cdc084, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cdbe5c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::BaseValidator* validator);

  /// @brief Method get_HasSchema, addr 0x1cde414, size 0x24, virtual false, abstract: false, final false
  inline bool get_HasSchema();

  /// @brief Method get_IsInlineSchemaStarted, addr 0x1cdc2a8, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsInlineSchemaStarted();

  /// @brief Method get_PreserveWhitespace, addr 0x1cde438, size 0x38, virtual true, abstract: false, final false
