...
public:
  ...
  /// @brief Method Add, addr 0x21cc960, size 0xe4, virtual true, abstract: false, final false
  inline void Add(::System::Object* key, ::System::Object* value);

  /// @brief Method Clear, addr 0x21cca44, size 0xd4, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x21ccb18, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Contains, addr 0x21ccbfc, size 0xec, virtual true, abstract: false, final false
  inline bool Contains(::System::Object* key);

  /// @brief Method ContainsKey, addr 0x21ccce8, size 0xec, virtual true, abstract: false, final false
  inline bool ContainsKey(::System::Object* key);

  /// @brief Method ContainsValue, addr 0x21ccdd4, size 0xec, virtual true, abstract: false, final false
  inline bool ContainsValue(::System::Object* key);

  /// @brief Method CopyTo, addr 0x21ccec0, size 0xe4, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetByIndex, addr 0x21ccfa4, size 0xec, virtual true, abstract: false, final false
  inline ::System::Object* GetByIndex(int32_t index);

  /// @brief Method GetEnumerator, addr 0x21cd090, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetKey, addr 0x21cd174, size 0xec, virtual true, abstract: false, final false
  inline ::System::Object* GetKey(int32_t index);

  /// @brief Method GetKeyList, addr 0x21cd260, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Collections::IList* GetKeyList();

  /// @brief Method GetValueList, addr 0x21cd344, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Collections::IList* GetValueList();

  /// @brief Method IndexOfKey, addr 0x21cd428, size 0x154, virtual true, abstract: false, final false
  inline int32_t IndexOfKey(::System::Object* key);

  /// @brief Method IndexOfValue, addr 0x21cd57c, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x21cd744, size 0xdc, virtual true, abstract: false, final false
  inline void Remove(::System::Object* key);

  /// @brief Method RemoveAt, addr 0x21cd668, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21cc604, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::SortedList* list);

  /// @brief Method get_Count, addr 0x21cc654, size 0xe4, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x21cc764, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x21cc740, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x21cc788, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x21cc790, size 0xec, virtual true, abstract: false, final false
  inline ::System::Object* get_Item(::System::Object* key);

  /// @brief Method get_SyncRoot, addr 0x21cc738, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_SyncRoot();

  /// @brief Method set_Item, addr 0x21cc87c, size 0xe4, virtual true, abstract: false, final false
