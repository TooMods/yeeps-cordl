...
public:
  ...
  /// @brief Method Awake, addr 0x1d3958c, size 0x2c, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method BindActions, addr 0x1d391ac, size 0x20, virtual false, abstract: false, final false
  inline void BindActions();

  /// @brief Method BindPosition, addr 0x1d38914, size 0x1a8, virtual false, abstract: false, final false
  inline void BindPosition();

  /// @brief Method BindRotation, addr 0x1d38c8c, size 0x1a8, virtual false, abstract: false, final false
  inline void BindRotation();

  /// @brief Method BindTrackingState, addr 0x1d39004, size 0x1a8, virtual false, abstract: false, final false
  inline void BindTrackingState();

  /// @brief Method HasStereoCamera, addr 0x1d395b8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeforeRender, addr 0x1d39a44, size 0x20, virtual true, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method OnDestroy, addr 0x1d397a0, size 0x2c, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x1d396f4, size 0xac, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x1d3963c, size 0xb8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPositionCanceled, addr 0x1d3924c, size 0x58, virtual false, abstract: false, final false
  inline void OnPositionCanceled(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnPositionPerformed, addr 0x1d391ec, size 0x60, virtual false, abstract: false, final false
  inline void OnPositionPerformed(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnRotationCanceled, addr 0x1d39304, size 0x50, virtual false, abstract: false, final false
  inline void OnRotationCanceled(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnRotationPerformed, addr 0x1d392a4, size 0x60, virtual false, abstract: false, final false
  inline void OnRotationPerformed(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnTrackingStateCanceled, addr 0x1d393b0, size 0x8, virtual false, abstract: false, final false
  inline void OnTrackingStateCanceled(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnTrackingStatePerformed, addr 0x1d39354, size 0x5c, virtual false, abstract: false, final false
  inline void OnTrackingStatePerformed(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method OnUpdate, addr 0x1d39a28, size 0x1c, virtual true, abstract: false, final false
  inline void OnUpdate();

  /// @brief Method PerformUpdate, addr 0x1d39a64, size 0x1c, virtual true, abstract: false, final false
  inline void PerformUpdate();

  /// @brief Method ReadTrackingState, addr 0x1d398f0, size 0x138, virtual false, abstract: false, final false
  inline void ReadTrackingState();

  /// @brief Method Reset, addr 0x1d393b8, size 0x1d4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetLocalTransform, addr 0x1d39a80, size 0xf8, virtual true, abstract: false, final false
  inline void SetLocalTransform(::UnityEngine::Vector3 newPosition, ::UnityEngine::Quaternion newRotation);

  /// @brief Method UnbindActions, addr 0x1d391cc, size 0x20, virtual false, abstract: false, final false
  inline void UnbindActions();

  /// @brief Method UnbindPosition, addr 0x1d387c4, size 0x150, virtual false, abstract: false, final false
  inline void UnbindPosition();

  /// @brief Method UnbindRotation, addr 0x1d38b3c, size 0x150, virtual false, abstract: false, final false
  inline void UnbindRotation();

  /// @brief Method UnbindTrackingState, addr 0x1d38eb4, size 0x150, virtual false, abstract: false, final false
  inline void UnbindTrackingState();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x1d39c24, size 0x78, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x1d39c20, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UpdateCallback, addr 0x1d397cc, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d39c9c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ignoreTrackingState, addr 0x1d38730, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreTrackingState();

  /// @brief Method get_positionAction, addr 0x1d39b78, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_positionAction();

  /// @brief Method get_positionInput, addr 0x1d38744, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_positionInput();

  /// @brief Method get_rotationAction, addr 0x1d39bcc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_rotationAction();

  /// @brief Method get_rotationInput, addr 0x1d38abc, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_rotationInput();

  /// @brief Method get_trackingStateInput, addr 0x1d38e34, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_trackingStateInput();

  /// @brief Method get_trackingType, addr 0x1d38710, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::__TrackedPoseDriver__TrackingType get_trackingType();

  /// @brief Method get_updateType, addr 0x1d38720, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::__TrackedPoseDriver__UpdateType get_updateType();

  /// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
  constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

  /// @brief Method set_ignoreTrackingState, addr 0x1d38738, size 0xc, virtual false, abstract: false, final false
  inline void set_ignoreTrackingState(bool value);

  /// @brief Method set_positionAction, addr 0x1d39b84, size 0x48, virtual false, abstract: false, final false
  inline void set_positionAction(::UnityEngine::InputSystem::InputAction* value);

  /// @brief Method set_positionInput, addr 0x1d38758, size 0x6c, virtual false, abstract: false, final false
  inline void set_positionInput(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_rotationAction, addr 0x1d39bd8, size 0x48, virtual false, abstract: false, final false
  inline void set_rotationAction(::UnityEngine::InputSystem::InputAction* value);

  /// @brief Method set_rotationInput, addr 0x1d38ad0, size 0x6c, virtual false, abstract: false, final false
  inline void set_rotationInput(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_trackingStateInput, addr 0x1d38e48, size 0x6c, virtual false, abstract: false, final false
  inline void set_trackingStateInput(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_trackingType, addr 0x1d38718, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingType(::UnityEngine::InputSystem::XR::__TrackedPoseDriver__TrackingType value);

  /// @brief Method set_updateType, addr 0x1d38728, size 0x8, virtual false, abstract: false, final false
