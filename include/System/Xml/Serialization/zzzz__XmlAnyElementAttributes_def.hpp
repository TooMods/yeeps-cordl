...
public:
  ...
  /// @brief Method Add, addr 0x125e308, size 0xb8, virtual false, abstract: false, final false
  inline int32_t Add(::System::Xml::Serialization::XmlAnyElementAttribute* attribute);

  /// @brief Method AddKeyHash, addr 0x125e3c0, size 0xcc, virtual false, abstract: false, final false
  inline void AddKeyHash(::System::Text::StringBuilder* sb);

  static inline ::System::Xml::Serialization::XmlAnyElementAttributes* New_ctor();

  /// @brief Method .ctor, addr 0x125e76c, size 0x1008, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x125e208, size 0x100, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAnyElementAttribute* get_Item(int32_t index);

  /// @brief Method get_Order, addr 0x125e48c, size 0x2e0, virtual false, abstract: false, final false
