...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadUpdate, addr 0x19b2f24, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetAssetFileDownloadUpdate();

  /// @brief Method GetDataFromMessage, addr 0x19b2f60, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0994, size 0x58, virtual false, abstract: false, final false
