...
public:
  ...
  /// @brief Method ParsedToString, addr 0x1626d38, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x162640c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* parsed, ::System::Func_2<::System::Object*, ::StringW>* converter);

  /// @brief Method get_HasStringValues, addr 0x1626d74, size 0x54, virtual false, abstract: false, final false
  inline bool get_HasStringValues();

  /// @brief Method get_Values, addr 0x162643c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Values();

  /// @brief Method set_Values, addr 0x1626dc8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1626dec, size 0x2c4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Net::Http::Headers::__HttpHeaders___GetEnumerator_d__19* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.Collections.Generic.IEnumerable<System.String>>>.get_Current, addr 0x1627100,
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x162710c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x162714c, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1626dd0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x16270b0, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x16266b0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x1625adc, size 0xa8, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::StringW value);

  /// @brief Method Add, addr 0x1625b84, size 0x88, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::System::Collections::Generic::IEnumerable_1<::StringW>* values);

  /// @brief Method AddInternal, addr 0x1625d78, size 0x694, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckName, addr 0x1625c0c, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HeaderInfo* CheckName(::StringW name);

  /// @brief Method GetAllHeaderValues, addr 0x16267f8, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x1617568, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method GetKnownHeaderKind, addr 0x1619b8c, size 0x100, virtual false, abstract: false, final false
  static inline ::System::Net::Http::Headers::HttpHeaderKind GetKnownHeaderKind(::StringW name);

  /// @brief Method GetSingleHeaderString, addr 0x1619c8c, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x16266dc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x16266d8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method ToString, addr 0x16269c4, size 0x374, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryAddWithoutValidation, addr 0x16264bc, size 0xa8, virtual false, abstract: false, final false
  inline bool TryAddWithoutValidation(::StringW name, ::StringW value);

  /// @brief Method TryAddWithoutValidation, addr 0x1617a38, size 0xb0, virtual false, abstract: false, final false
  inline bool TryAddWithoutValidation(::StringW name, ::System::Collections::Generic::IEnumerable_1<::StringW>* values);

  /// @brief Method TryCheckName, addr 0x1626564, size 0xe4, virtual false, abstract: false, final false
  inline bool TryCheckName(::StringW name, ByRef<::System::Net::Http::Headers::HeaderInfo*> headerInfo);

  /// @brief Method TryGetValues, addr 0x1626740, size 0xb8, virtual false, abstract: false, final false
  inline bool TryGetValues(::StringW name, ByRef<::System::Collections::Generic::IEnumerable_1<::StringW>*> values);
  ...
  /// @brief Method .ctor, addr 0x16259f8, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x16237f4, size 0x24, virtual false, abstract: false, final false
