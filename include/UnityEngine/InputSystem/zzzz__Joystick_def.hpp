...
public:
  ...
  /// @brief Method FinishSetup, addr 0x187b5b8, size 0x13c, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x187b6f4, size 0x4c, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::Joystick* New_ctor();

  /// @brief Method OnAdded, addr 0x187b740, size 0x78, virtual true, abstract: false, final false
  inline void OnAdded();

  /// @brief Method OnRemoved, addr 0x187b7b8, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x187b8d0, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_all, addr 0x187b538, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Joystick*> get_all();

  /// @brief Method get_current, addr 0x187b4a4, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Joystick* get_current();

  /// @brief Method get_hatswitch, addr 0x187b494, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_hatswitch();

  /// @brief Method get_stick, addr 0x187b474, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::StickControl* get_stick();

  /// @brief Method get_trigger, addr 0x187b464, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_trigger();

  /// @brief Method get_twist, addr 0x187b484, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x187b4ec, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::Joystick* value);

  /// @brief Method set_hatswitch, addr 0x187b49c, size 0x8, virtual false, abstract: false, final false
  inline void set_hatswitch(::UnityEngine::InputSystem::Controls::Vector2Control* value);

  /// @brief Method set_stick, addr 0x187b47c, size 0x8, virtual false, abstract: false, final false
  inline void set_stick(::UnityEngine::InputSystem::Controls::StickControl* value);

  /// @brief Method set_trigger, addr 0x187b46c, size 0x8, virtual false, abstract: false, final false
  inline void set_trigger(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_twist, addr 0x187b48c, size 0x8, virtual false, abstract: false, final false
