...
public:
  ...
  /// @brief Method Cleanup, addr 0xfbfb48, size 0xe8, virtual false, abstract: false, final false
  static inline void Cleanup();

  /// @brief Method RecenterPose, addr 0xfc0530, size 0x94, virtual false, abstract: false, final false
  static inline void RecenterPose();

  /// @brief Method Update, addr 0xfbf668, size 0x4e0, virtual false, abstract: false, final false
