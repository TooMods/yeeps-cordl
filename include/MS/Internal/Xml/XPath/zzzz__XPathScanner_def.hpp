...
public:
  ...
  /// @brief Method NextChar, addr 0x1b31b90, size 0x54, virtual false, abstract: false, final false
  inline bool NextChar();

  /// @brief Method NextLex, addr 0x1b3075c, size 0x3bc, virtual false, abstract: false, final false
  inline bool NextLex();

  /// @brief Method ScanFraction, addr 0x1b31c60, size 0xb0, virtual false, abstract: false, final false
  inline double_t ScanFraction();

  /// @brief Method ScanName, addr 0x1b31e98, size 0x78, virtual false, abstract: false, final false
  inline ::StringW ScanName();

  /// @brief Method ScanNumber, addr 0x1b31dc0, size 0xd8, virtual false, abstract: false, final false
  inline double_t ScanNumber();

  /// @brief Method ScanString, addr 0x1b31d10, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW ScanString();

  /// @brief Method SkipSpace, addr 0x1b31c24, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b2ea38, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::StringW xpathExpr);

  /// @brief Method get_CanBeFunction, addr 0x1b31c1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_CanBeFunction();

  /// @brief Method get_CurrentChar, addr 0x1b31bec, size 0x8, virtual false, abstract: false, final false
  inline char16_t get_CurrentChar();

  /// @brief Method get_Kind, addr 0x1b31bf4, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::__XPathScanner__LexKind get_Kind();

  /// @brief Method get_Name, addr 0x1b31bfc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NumberValue, addr 0x1b31c14, size 0x8, virtual false, abstract: false, final false
  inline double_t get_NumberValue();

  /// @brief Method get_Prefix, addr 0x1b31c04, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_SourceText, addr 0x1b31be4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SourceText();

  /// @brief Method get_StringValue, addr 0x1b31c0c, size 0x8, virtual false, abstract: false, final false
