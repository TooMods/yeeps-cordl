...
public:
  ...
  /// @brief Method ConstructChildPos, addr 0x3052054, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ConstructPos, addr 0x3052130, size 0x118, virtual true, abstract: false, final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method ExpandTree, addr 0x30522d8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30518a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x3052248, size 0x90, virtual true, abstract: false, final false
