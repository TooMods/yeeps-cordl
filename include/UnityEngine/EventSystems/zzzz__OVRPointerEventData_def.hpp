...
// SizeInfo { instance_size: 400, native_size: -1, calculated_instance_size: 400, calculated_native_size: 400, minimum_alignment: 8, natural_alignment: 4, packing: None, specified_packing: None }
namespace UnityEngine::EventSystems {
// Is value type: false
...
public:
  // Declarations
  /// @brief Field swipeStart, offset 0x188, size 0x8
  ...
  /// @brief Field worldSpaceRay, offset 0x170, size 0x18
  ...
  /// @brief Method ToString, addr 0x2a80bf8, size 0x3b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a7eae4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field worldSpaceRay, offset: 0x170, size: 0x18, def value: None
  ::UnityEngine::Ray ___worldSpaceRay;

  /// @brief Field swipeStart, offset: 0x188, size: 0x8, def value: None
  ::UnityEngine::Vector2 ___swipeStart;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::EventSystems::OVRPointerEventData, 0x190>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::EventSystems::OVRPointerEventData, ___worldSpaceRay) == 0x170, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::EventSystems::OVRPointerEventData, ___swipeStart) == 0x188, "Offset mismatch!");
