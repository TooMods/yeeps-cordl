...
public:
  ...
  /// @brief Method ToString, addr 0x2a8fa8c, size 0x29c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2a8f9ec, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t indexStart, int32_t indexCount, ::UnityEngine::MeshTopology topology);

  /// @brief Method get_baseVertex, addr 0x2a8fa5c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_baseVertex();

  /// @brief Method get_bounds, addr 0x2a8fa04, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_bounds();

  /// @brief Method get_firstVertex, addr 0x2a8fa6c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_firstVertex();

  /// @brief Method get_indexCount, addr 0x2a8fa4c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_indexCount();

  /// @brief Method get_indexStart, addr 0x2a8fa3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_indexStart();

  /// @brief Method get_topology, addr 0x2a8fa2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::MeshTopology get_topology();

  /// @brief Method get_vertexCount, addr 0x2a8fa7c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_vertexCount();

  /// @brief Method set_baseVertex, addr 0x2a8fa64, size 0x8, virtual false, abstract: false, final false
  inline void set_baseVertex(int32_t value);

  /// @brief Method set_bounds, addr 0x2a8fa18, size 0x14, virtual false, abstract: false, final false
  inline void set_bounds(::UnityEngine::Bounds value);

  /// @brief Method set_firstVertex, addr 0x2a8fa74, size 0x8, virtual false, abstract: false, final false
  inline void set_firstVertex(int32_t value);

  /// @brief Method set_indexCount, addr 0x2a8fa54, size 0x8, virtual false, abstract: false, final false
  inline void set_indexCount(int32_t value);

  /// @brief Method set_indexStart, addr 0x2a8fa44, size 0x8, virtual false, abstract: false, final false
  inline void set_indexStart(int32_t value);

  /// @brief Method set_topology, addr 0x2a8fa34, size 0x8, virtual false, abstract: false, final false
  inline void set_topology(::UnityEngine::MeshTopology value);

  /// @brief Method set_vertexCount, addr 0x2a8fa84, size 0x8, virtual false, abstract: false, final false
