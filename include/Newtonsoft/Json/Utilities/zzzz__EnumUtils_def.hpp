...
public:
  ...
  /// @brief Method <InitializeValuesAndNames>b__3_0, addr 0x153288c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _InitializeValuesAndNames_b__3_0(::System::Runtime::Serialization::EnumMemberAttribute* a);

  /// @brief Method .ctor, addr 0x1532884, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FindIndexByName, addr 0x153252c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumValuesAndNames, addr 0x1531cb0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeValuesAndNames, addr 0x15310c8, size 0x500, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalFlagsFormat, addr 0x1531b14, size 0x19c, virtual false, abstract: false, final false
  static inline ::StringW InternalFlagsFormat(::Newtonsoft::Json::Utilities::EnumInfo* entry, uint64_t result);

  /// @brief Method MatchName, addr 0x1532624, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseEnum, addr 0x1531d6c, size 0x7c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUInt64, addr 0x15315c8, size 0x330, virtual false, abstract: false, final false
  static inline uint64_t ToUInt64(::System::Object* value);

  /// @brief Method TryToString, addr 0x15318f8, size 0xa0, virtual false, abstract: false, final false
  static inline bool TryToString(::System::Type* enumType, ::System::Object* value, bool camelCase, ByRef<::StringW> name);

  /// @brief Method TryToString, addr 0x1531998, size 0x17c, virtual false, abstract: false, final false
