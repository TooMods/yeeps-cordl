...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2036408, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20361ac, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x203624c, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2036238, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW paramName, ::StringW message);

  /// @brief Method get_DefaultMessage, addr 0x20361f8, size 0x40, virtual false, abstract: false, final false
  static inline ::StringW get_DefaultMessage();

  /// @brief Method get_FormatedInvalidCultureId, addr 0x203657c, size 0x134, virtual false, abstract: false, final false
  inline ::StringW get_FormatedInvalidCultureId();

  /// @brief Method get_InvalidCultureId, addr 0x203656c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_InvalidCultureId();

  /// @brief Method get_InvalidCultureName, addr 0x2036574, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_InvalidCultureName();

  /// @brief Method get_Message, addr 0x20366b0, size 0xbc, virtual true, abstract: false, final false
