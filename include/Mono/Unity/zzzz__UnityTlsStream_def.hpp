...
public:
  // Declarations
  /// @brief Method CreateContext, addr 0x24262d8, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2425788, size 0x94, virtual false, abstract: false, final false
