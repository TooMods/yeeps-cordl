...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x148c3c8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x148c3d4, size 0xa4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRSceneLoader___DelayCanvasPosUpdate_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x148c478, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x148c480, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x148c4c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x148c3d0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x148c1bc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x148c4cc, size 0x34c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRSceneLoader___onCheckSceneCoroutine_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x148c818, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x148c820, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x148c860, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x148c4c8, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x148c1e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method Awake, addr 0x148aeac, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DelayCanvasPosUpdate, addr 0x148b064, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DelayCanvasPosUpdate();

  /// @brief Method DestroyAllGameObjects, addr 0x148c20c, size 0x110, virtual false, abstract: false, final false
  inline void DestroyAllGameObjects();

  /// @brief Method GetSceneInfo, addr 0x148b0cc, size 0x28c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSceneLoader__SceneInfo GetSceneInfo();

  /// @brief Method LoadScene, addr 0x148b358, size 0x8ac, virtual false, abstract: false, final false
  inline void LoadScene(::GlobalNamespace::__OVRSceneLoader__SceneInfo sceneInfo);

  /// @brief Method LoadSceneOperation_completed, addr 0x148bc04, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x148af18, size 0x14c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x148bd48, size 0x274, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCanvasPosition, addr 0x148bfbc, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x148c31c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method onCheckSceneCoroutine, addr 0x148bce0, size 0x68, virtual false, abstract: false, final false
