...
public:
  // Declarations
  /// @brief Method LookupNamespace, addr 0x2fc0e4c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  static inline ::System::Xml::Schema::__DtdValidator__NamespaceManager* New_ctor();

  /// @brief Method .ctor, addr 0x2fc0e44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddID, addr 0x2fc04c0, size 0x90, virtual false, abstract: false, final false
  inline void AddID(::StringW name, ::System::Object* node);

  /// @brief Method CheckDefaultValue, addr 0x2fc09b8, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForwardRefs, addr 0x2fc0168, size 0x108, virtual false, abstract: false, final false
  inline void CheckForwardRefs();

  /// @brief Method CheckValue, addr 0x2fbf934, size 0x570, virtual false, abstract: false, final false
  inline void CheckValue(::StringW value, ::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CompleteValidation, addr 0x2fc0078, size 0x48, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method FindId, addr 0x2fc0550, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Object* FindId(::StringW name);

  /// @brief Method GenEntity, addr 0x2fbef68, size 0x15c, virtual false, abstract: false, final false
  inline bool GenEntity(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method GetEntity, addr 0x2fc056c, size 0x94, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaEntity* GetEntity(::System::Xml::XmlQualifiedName* qname, bool fParameterEntity);

  /// @brief Method Init, addr 0x2fbe900, size 0x13c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method MeetsStandAloneConstraint, addr 0x2fbee18, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x2fc00c0, size 0xa8, virtual false, abstract: false, final false
  inline bool Pop();

  /// @brief Method ProcessElement, addr 0x2fbf3b0, size 0x118, virtual false, abstract: false, final false
  inline void ProcessElement();

  /// @brief Method ProcessTokenizedType, addr 0x2fc02a8, size 0x218, virtual false, abstract: false, final false
  inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType ttype, ::StringW name);

  /// @brief Method Push, addr 0x2fbea3c, size 0xd8, virtual false, abstract: false, final false
  inline void Push(::System::Xml::XmlQualifiedName* elementName);

  /// @brief Method SetDefaultTypedValue, addr 0x2fc0600, size 0x3b8, virtual false, abstract: false, final false
  static inline void SetDefaultTypedValue(::System::Xml::Schema::SchemaAttDef* attdef, ::System::Xml::IDtdParserAdapter* readerAdapter);

  /// @brief Method Validate, addr 0x2fbeb14, size 0x1fc, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method ValidateChildElement, addr 0x2fbf268, size 0x148, virtual false, abstract: false, final false
  inline void ValidateChildElement();

  /// @brief Method ValidateElement, addr 0x2fbed10, size 0x108, virtual false, abstract: false, final false
  inline void ValidateElement();

  /// @brief Method ValidateEndElement, addr 0x2fbf0c4, size 0x1a4, virtual false, abstract: false, final false
  inline void ValidateEndElement();

  /// @brief Method ValidateEndStartElement, addr 0x2fbfea4, size 0x1d4, virtual false, abstract: false, final false
  inline void ValidateEndStartElement();

  /// @brief Method ValidatePIComment, addr 0x2fbeeb8, size 0xb0, virtual false, abstract: false, final false
  inline void ValidatePIComment();

  /// @brief Method ValidateStartElement, addr 0x2fbf4c8, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fbe864, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PreserveWhitespace, addr 0x2fc0270, size 0x38, virtual true, abstract: false, final false
