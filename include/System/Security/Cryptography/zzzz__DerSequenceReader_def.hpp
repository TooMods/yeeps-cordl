...
public:
  ...
  /// @brief Method <ReadT61String>b__45_0, addr 0x12c16b4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* _ReadT61String_b__45_0();

  /// @brief Method <ReadT61String>b__45_1, addr 0x12c1718, size 0x44, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* _ReadT61String_b__45_1();

  /// @brief Method <ReadTime>b__51_0, addr 0x12c175c, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatInfo* _ReadTime_b__51_0();

  /// @brief Method .ctor, addr 0x12c16ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckTag, addr 0x12c0dec, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method EatLength, addr 0x12c02a0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t EatLength();

  /// @brief Method EatTag, addr 0x12c0220, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method PeekTag, addr 0x12c02ec, size 0x98, virtual false, abstract: false, final false
  inline uint8_t PeekTag();

  /// @brief Method ReadBMPString, addr 0x12c15c8, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadBMPString();

  /// @brief Method ReadBitString, addr 0x12c07fc, size 0x148, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBitString();

  /// @brief Method ReadBoolean, addr 0x12c05ac, size 0xcc, virtual false, abstract: false, final false
  inline bool ReadBoolean();

  /// @brief Method ReadCollectionWithTag, addr 0x12c0d14, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadContentAsBytes, addr 0x12c0748, size 0xb4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadContentAsBytes();

  /// @brief Method ReadGeneralizedTime, addr 0x12c133c, size 0x4c, virtual false, abstract: false, final false
  inline ::System::DateTime ReadGeneralizedTime();

  /// @brief Method ReadIA5String, addr 0x12c0f14, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadIA5String();

  /// @brief Method ReadInteger, addr 0x12c0678, size 0xb4, virtual false, abstract: false, final false
  inline int32_t ReadInteger();

  /// @brief Method ReadIntegerBytes, addr 0x12c072c, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadIntegerBytes();

  /// @brief Method ReadNextEncodedValue, addr 0x12c03d4, size 0xb8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadNextEncodedValue();

  /// @brief Method ReadOctetString, addr 0x12c0944, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadOctetString();

  /// @brief Method ReadOidAsString, addr 0x12c0960, size 0x2bc, virtual false, abstract: false, final false
  inline ::StringW ReadOidAsString();

  /// @brief Method ReadPrintableString, addr 0x12c0e94, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadPrintableString();

  /// @brief Method ReadSequence, addr 0x12c0e84, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DerSequenceReader* ReadSequence();

  /// @brief Method ReadSet, addr 0x12c0e8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DerSequenceReader* ReadSet();

  /// @brief Method ReadT61String, addr 0x12c0f94, size 0x2d8, virtual false, abstract: false, final false
  inline ::StringW ReadT61String();

  /// @brief Method ReadTime, addr 0x12c1388, size 0x240, virtual false, abstract: false, final false
  inline ::System::DateTime ReadTime(::System::Security::Cryptography::__DerSequenceReader__DerTag timeTag, ::StringW formatString);

  /// @brief Method ReadUtcTime, addr 0x12c12f0, size 0x4c, virtual false, abstract: false, final false
  inline ::System::DateTime ReadUtcTime();

  /// @brief Method ReadUtf8String, addr 0x12c0c1c, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadUtf8String();

  /// @brief Method ReadX509Date, addr 0x12c126c, size 0x84, virtual false, abstract: false, final false
  inline ::System::DateTime ReadX509Date();

  /// @brief Method ScanContentLength, addr 0x12c048c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipValue, addr 0x12c0384, size 0x50, virtual false, abstract: false, final false
  inline void SkipValue();

  /// @brief Method TrimTrailingNulls, addr 0x12c0c9c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c00f4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x12c0118, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t length);

  /// @brief Method .ctor, addr 0x12c012c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasData, addr 0x12c02dc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ContentLength, addr 0x12c00ec, size 0x8, virtual false, abstract: false, final false
