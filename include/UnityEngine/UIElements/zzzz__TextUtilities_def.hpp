...
public:
  // Declarations
  /// @brief Method ComputeTextScaling, addr 0x2cc6104, size 0xfc, virtual false, abstract: false, final false
  static inline float_t ComputeTextScaling(::UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint);

  /// @brief Method GetFont, addr 0x2cc695c, size 0xf0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> GetFont(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams textParam);

  /// @brief Method GetFont, addr 0x2cc6a4c, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> GetFont(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetFontAsset, addr 0x2cc5a48, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFontAsset, addr 0x2cc672c, size 0x16c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> GetFontAsset(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetTextCoreSettingsForElement, addr 0x2cc6d60, size 0x3b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextSettingsFrom, addr 0x2cc5990, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextSettingsFrom, addr 0x2cc6898, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFontAssigned, addr 0x2cc6ba8, size 0x84, virtual false, abstract: false, final false
  static inline bool IsFontAssigned(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams textParams);

  /// @brief Method IsFontAssigned, addr 0x2cc665c, size 0xc8, virtual false, abstract: false, final false
  static inline bool IsFontAssigned(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method MeasureVisualElementTextSize, addr 0x2cc6200, size 0x45c, virtual false, abstract: false, final false
