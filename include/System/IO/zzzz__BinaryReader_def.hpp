...
public:
  ...
  /// @brief Method Close, addr 0x1fc0984, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x1fc09d8, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1fc0994, size 0x44, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FillBuffer, addr 0x1fc1dbc, size 0x124, virtual true, abstract: false, final false
  inline void FillBuffer(int32_t numBytes);

  /// @brief Method InternalReadChars, addr 0x1fc1650, size 0x2f8, virtual false, abstract: false, final false
  inline int32_t InternalReadChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method InternalReadOneChar, addr 0x1fc0a00, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x1fc09e8, size 0x18, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x1fc1aa8, size 0x184, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Read7BitEncodedInt, addr 0x1fc15a8, size 0xa8, virtual false, abstract: false, final false
  inline int32_t Read7BitEncodedInt();

  /// @brief Method ReadBoolean, addr 0x1fc0c68, size 0x48, virtual true, abstract: false, final false
  inline bool ReadBoolean();

  /// @brief Method ReadByte, addr 0x1fc0cb0, size 0x34, virtual true, abstract: false, final false
  inline uint8_t ReadByte();

  /// @brief Method ReadBytes, addr 0x1fc1c2c, size 0x190, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBytes(int32_t count);

  /// @brief Method ReadChar, addr 0x1fc0d24, size 0x24, virtual true, abstract: false, final false
  inline char16_t ReadChar();

  /// @brief Method ReadChars, addr 0x1fc1948, size 0x160, virtual true, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> ReadChars(int32_t count);

  /// @brief Method ReadDecimal, addr 0x1fc10fc, size 0x214, virtual true, abstract: false, final false
  inline ::System::Decimal ReadDecimal();

  /// @brief Method ReadDouble, addr 0x1fc10cc, size 0x30, virtual true, abstract: false, final false
  inline double_t ReadDouble();

  /// @brief Method ReadInt16, addr 0x1fc0d48, size 0x48, virtual true, abstract: false, final false
  inline int16_t ReadInt16();

  /// @brief Method ReadInt32, addr 0x1fc0dd8, size 0xf4, virtual true, abstract: false, final false
  inline int32_t ReadInt32();

  /// @brief Method ReadInt64, addr 0x1fc0f3c, size 0xb0, virtual true, abstract: false, final false
  inline int64_t ReadInt64();

  /// @brief Method ReadSByte, addr 0x1fc0ce4, size 0x40, virtual true, abstract: false, final false
  inline int8_t ReadSByte();

  /// @brief Method ReadSingle, addr 0x1fc109c, size 0x30, virtual true, abstract: false, final false
  inline float_t ReadSingle();

  /// @brief Method ReadString, addr 0x1fc1310, size 0x298, virtual true, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ReadUInt16, addr 0x1fc0d90, size 0x48, virtual true, abstract: false, final false
  inline uint16_t ReadUInt16();

  /// @brief Method ReadUInt32, addr 0x1fc0ecc, size 0x70, virtual true, abstract: false, final false
  inline uint32_t ReadUInt32();

  /// @brief Method ReadUInt64, addr 0x1fc0fec, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc067c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x1fc0974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x1fc06f4, size 0x280, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, ::System::Text::Encoding* encoding, bool leaveOpen);

  /// @brief Method get_BaseStream, addr 0x1fc097c, size 0x8, virtual true, abstract: false, final false
