...
public:
  ...
  /// @brief Method Fallback, addr 0x1e0f878, size 0xb4, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknown, int32_t index);

  /// @brief Method Fallback, addr 0x1e0f95c, size 0x260, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index);

  /// @brief Method GetNextChar, addr 0x1e0fdb4, size 0x8, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method MovePrevious, addr 0x1e0fdbc, size 0x8, virtual true, abstract: false, final false
  inline bool MovePrevious();

  static inline ::System::Text::EncoderExceptionFallbackBuffer* New_ctor();

  /// @brief Method .ctor, addr 0x1e0f804, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Remaining, addr 0x1e0fdc4, size 0x8, virtual true, abstract: false, final false
