...
public:
  ...
  /// @brief Method <Rebuild>b__12_0, addr 0x26f2178, size 0xbc, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_0(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_1, addr 0x26f2234, size 0xbc, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_1(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_2, addr 0x26f22f0, size 0xc0, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_2(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_3, addr 0x26f23b0, size 0xc0, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_3(::UnityEngine::Component* e);

  /// @brief Method <StripDisabledBehavioursFromList>b__10_0, addr 0x26f20ec, size 0x8c, virtual false, abstract: false, final false
  inline bool _StripDisabledBehavioursFromList_b__10_0(::UnityEngine::Component* e);

  /// @brief Method <.cctor>b__5_0, addr 0x26f2074, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::LayoutRebuilder* __cctor_b__5_0();

  /// @brief Method <.cctor>b__5_1, addr 0x26f20d0, size 0x1c, virtual false, abstract: false, final false
  inline void __cctor_b__5_1(::UnityEngine::UI::LayoutRebuilder* x);

  /// @brief Method .ctor, addr 0x26f206c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x26f0d64, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Equals, addr 0x26f1f44, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method ForceRebuildLayoutImmediate, addr 0x26f1100, size 0xdc, virtual false, abstract: false, final false
  static inline void ForceRebuildLayoutImmediate(::UnityEngine::RectTransform* layoutRoot);

  /// @brief Method GetHashCode, addr 0x26f1f3c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GraphicUpdateComplete, addr 0x26f1f38, size 0x4, virtual true, abstract: false, final true
  inline void GraphicUpdateComplete();

  /// @brief Method Initialize, addr 0x26f0d30, size 0x34, virtual false, abstract: false, final false
  inline void Initialize(::UnityEngine::RectTransform* controller);

  /// @brief Method IsDestroyed, addr 0x26f0fa4, size 0x60, virtual true, abstract: false, final true
  inline bool IsDestroyed();

  /// @brief Method LayoutComplete, addr 0x26f1eb8, size 0x80, virtual true, abstract: false, final true
  inline void LayoutComplete();

  /// @brief Method MarkLayoutForRebuild, addr 0x26ec484, size 0x3ec, virtual false, abstract: false, final false
  static inline void MarkLayoutForRebuild(::UnityEngine::RectTransform* rect);

  /// @brief Method MarkLayoutRootForRebuild, addr 0x26f1d54, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutCalculation, addr 0x26f1490, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutControl, addr 0x26f1790, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReapplyDrivenProperties, addr 0x26f0f48, size 0x54, virtual false, abstract: false, final false
  static inline void ReapplyDrivenProperties(::UnityEngine::RectTransform* driven);

  /// @brief Method Rebuild, addr 0x26f11dc, size 0x2b4, virtual true, abstract: false, final true
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method StripDisabledBehavioursFromList, addr 0x26f1004, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x26f1f94, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidController, addr 0x26f1b60, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f2000, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Pool::ObjectPool_1<::UnityEngine::UI::LayoutRebuilder*>* getStaticF_s_Rebuilders();

  /// @brief Method get_transform, addr 0x26f0f9c, size 0x8, virtual true, abstract: false, final true
