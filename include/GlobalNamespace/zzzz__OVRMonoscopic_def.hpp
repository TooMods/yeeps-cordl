...
public:
  ...
  /// @brief Method Update, addr 0x16f54ac, size 0xf0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16f559c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
