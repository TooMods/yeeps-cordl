...
public:
  ...
  /// @brief Method AppendText, addr 0x133617c, size 0x24, virtual true, abstract: false, final false
  inline void AppendText(::System::Text::StringBuilder* sb);

  /// @brief Method CloneNode, addr 0x13361a0, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x1336088, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x132e20c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XText* other);

  /// @brief Method .ctor, addr 0x132e190, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_NodeType, addr 0x1336078, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x1336080, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x132fe84, size 0xf4, virtual false, abstract: false, final false
