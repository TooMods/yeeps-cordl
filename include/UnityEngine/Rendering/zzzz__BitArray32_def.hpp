...
public:
  ...
  /// @brief Method BitAnd, addr 0x17c5d6c, size 0x98, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::IBitArray* BitAnd(::UnityEngine::Rendering::IBitArray* other);

  /// @brief Method BitNot, addr 0x17c5eac, size 0x60, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::IBitArray* BitNot();

  /// @brief Method BitOr, addr 0x17c5e0c, size 0x98, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::IBitArray* BitOr(::UnityEngine::Rendering::IBitArray* other);

  /// @brief Method Equals, addr 0x17c5f2c, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x17c5fa4, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x17c5cbc, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<uint32_t>* bitIndexTrue);

  /// @brief Method .ctor, addr 0x17c5cb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t initValue);

  /// @brief Method get_Item, addr 0x17c5c40, size 0x18, virtual true, abstract: false, final true
  inline bool get_Item(uint32_t index);

  /// @brief Method get_allFalse, addr 0x17c5a50, size 0x10, virtual true, abstract: false, final true
  inline bool get_allFalse();

  /// @brief Method get_allTrue, addr 0x17c5a60, size 0x10, virtual true, abstract: false, final true
  inline bool get_allTrue();

  /// @brief Method get_capacity, addr 0x17c5a48, size 0x8, virtual true, abstract: false, final true
  inline uint32_t get_capacity();

  /// @brief Method get_humanizedData, addr 0x17c5ad0, size 0x170, virtual true, abstract: false, final true
  inline ::StringW get_humanizedData();

  /// @brief Method get_humanizedVersion, addr 0x17c5a70, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseAnd, addr 0x17c5e04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseOr, addr 0x17c5ea4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x17c5f14, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Rendering::BitArray32 a, ::UnityEngine::Rendering::BitArray32 b);

  /// @brief Method op_Inequality, addr 0x17c5f20, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::Rendering::BitArray32 a, ::UnityEngine::Rendering::BitArray32 b);

  /// @brief Method op_OnesComplement, addr 0x17c5f0c, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::BitArray32 op_OnesComplement(::UnityEngine::Rendering::BitArray32 a);

  /// @brief Method set_Item, addr 0x17c5c6c, size 0x24, virtual true, abstract: false, final true
