...
public:
  ...
  /// @brief Method Update, addr 0x16fb860, size 0xe0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16fb940, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
