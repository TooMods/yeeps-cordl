...
public:
  ...
  /// @brief Method AllocateNative, addr 0x1e0212c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e01be8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::Utilities::FourCC type, int32_t sizeInBytes);

  /// @brief Method get_payloadPtr, addr 0x1e02124, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> get_payloadPtr();

  /// @brief Method get_payloadSizeInBytes, addr 0x1e02118, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_payloadSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x1e021dc, size 0x8, virtual true, abstract: false, final true
