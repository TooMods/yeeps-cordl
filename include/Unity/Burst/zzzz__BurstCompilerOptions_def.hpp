...
public:
  ...
  /// @brief Method AddOption, addr 0x2625ad0, size 0x4c, virtual false, abstract: false, final false
  static inline void AddOption(::System::Text::StringBuilder* builder, ::StringW option);

  /// @brief Method CheckIsSecondaryUnityProcess, addr 0x2625c2c, size 0x8, virtual false, abstract: false, final false
  static inline bool CheckIsSecondaryUnityProcess();

  /// @brief Method Clone, addr 0x2624a98, size 0x158, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompilerOptions* Clone();

  /// @brief Method DeserialiseCompilationOptionsSafe, addr 0x2624654, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserialiseStringArraySafe, addr 0x26243a4, size 0x178, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> DeserialiseStringArraySafe(::StringW input);

  /// @brief Method GetBurstCompileAttribute, addr 0x2624c7c, size 0x44c, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstCompileAttribute* GetBurstCompileAttribute(::System::Reflection::MemberInfo* memberInfo);

  /// @brief Method GetOption, addr 0x26259e8, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW GetOption(::StringW optionName, ::System::Object* value);

  /// @brief Method GetOptions, addr 0x262538c, size 0x65c, virtual false, abstract: false, final false
  inline ::StringW GetOptions(bool isJit, ::Unity::Burst::BurstCompileAttribute* attr, bool isForILPostProcessing);

  /// @brief Method HasBurstCompileAttribute, addr 0x2623100, size 0xc4, virtual false, abstract: false, final false
  static inline bool HasBurstCompileAttribute(::System::Reflection::MemberInfo* member);

  /// @brief Method MaybePreventChangingOption, addr 0x26248e8, size 0x4, virtual false, abstract: false, final false
  inline void MaybePreventChangingOption();

  /// @brief Method MaybeTriggerRecompilation, addr 0x262494c, size 0x4, virtual false, abstract: false, final false
  inline void MaybeTriggerRecompilation();

  /// @brief Method MergeAttributes, addr 0x2625144, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnOptionsChanged, addr 0x26248ec, size 0x1c, virtual false, abstract: false, final false
  inline void OnOptionsChanged();

  /// @brief Method SerialiseCompilationOptionsSafe, addr 0x262451c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method SerialiseStringArraySafe, addr 0x262427c, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW SerialiseStringArraySafe(::ArrayW<::StringW, ::Array<::StringW>*> array);

  /// @brief Method TryGetAttribute, addr 0x26250c8, size 0x7c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::Assembly* assembly, ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetAttribute, addr 0x2624bf0, size 0x8c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::MemberInfo* member, ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetOptions, addr 0x262526c, size 0x120, virtual false, abstract: false, final false
  inline bool TryGetOptions(::System::Reflection::MemberInfo* member, bool isJit, ByRef<::StringW> flagsOut, bool isForILPostProcessing);
  ...
  /// @brief Method .ctor, addr 0x262472c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2623d24, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DisableOptimizations, addr 0x26249c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisableOptimizations();

  /// @brief Method get_EnableBurstCompilation, addr 0x26248e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompilation();

  /// @brief Method get_EnableBurstCompileSynchronously, addr 0x2624908, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompileSynchronously();

  /// @brief Method get_EnableBurstDebug, addr 0x2624988, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstDebug();

  /// @brief Method get_EnableBurstSafetyChecks, addr 0x2624944, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstSafetyChecks();

  /// @brief Method get_EnableBurstTimings, addr 0x26249d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstTimings();

  /// @brief Method get_EnableFastMath, addr 0x26249cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableFastMath();

  /// @brief Method get_ForceEnableBurstSafetyChecks, addr 0x2624950, size 0x8, virtual false, abstract: false, final false
  inline bool get_ForceEnableBurstSafetyChecks();

  /// @brief Method get_IsEnabled, addr 0x262486c, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsEnabled();

  /// @brief Method get_IsGlobal, addr 0x2624864, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsGlobal();

  /// @brief Method get_OptionsChanged, addr 0x2624a88, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_OptionsChanged();

  /// @brief Method get_RequiresSynchronousCompilation, addr 0x2624a14, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisableOptimizations, addr 0x26249c8, size 0x4, virtual false, abstract: false, final false
  inline void set_DisableOptimizations(bool value);

  /// @brief Method set_EnableBurstCompilation, addr 0x2624734, size 0x100, virtual false, abstract: false, final false
  inline void set_EnableBurstCompilation(bool value);

  /// @brief Method set_EnableBurstCompileSynchronously, addr 0x2624910, size 0x34, virtual false, abstract: false, final false
  inline void set_EnableBurstCompileSynchronously(bool value);

  /// @brief Method set_EnableBurstDebug, addr 0x2624990, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstDebug(bool value);

  /// @brief Method set_EnableBurstSafetyChecks, addr 0x2624834, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstSafetyChecks(bool value);

  /// @brief Method set_EnableBurstTimings, addr 0x26249e0, size 0x34, virtual false, abstract: false, final false
  inline void set_EnableBurstTimings(bool value);

  /// @brief Method set_EnableFastMath, addr 0x26249d4, size 0x4, virtual false, abstract: false, final false
  inline void set_EnableFastMath(bool value);

  /// @brief Method set_ForceEnableBurstSafetyChecks, addr 0x2624958, size 0x30, virtual false, abstract: false, final false
  inline void set_ForceEnableBurstSafetyChecks(bool value);

  /// @brief Method set_OptionsChanged, addr 0x2624a90, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field OptionCompilationDefines offset 0xffffffff size 0x8
  static constexpr ::ConstString OptionCompilationDefines{ u"compilation-defines=" };
