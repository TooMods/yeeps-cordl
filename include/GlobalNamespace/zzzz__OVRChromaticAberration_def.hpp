...
public:
  ...
  /// @brief Method Start, addr 0x14ea3e4, size 0x9c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x14ea480, size 0xf0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x14ea570, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
