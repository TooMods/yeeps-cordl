...
public:
  ...
  /// @brief Method ExtractFormattedStackTrace, addr 0x283e2f0, size 0x6a8, virtual false, abstract: false, final false
  static inline ::StringW ExtractFormattedStackTrace(::System::Diagnostics::StackTrace* stackTrace);

  /// @brief Method ExtractStackTrace, addr 0x283e18c, size 0x164, virtual false, abstract: false, final false
  static inline ::StringW ExtractStackTrace();

  /// @brief Method ExtractStringFromExceptionInternal, addr 0x283e998, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method SetProjectFolder, addr 0x283e0b0, size 0xdc, virtual false, abstract: false, final false
