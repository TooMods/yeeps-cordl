...
constexpr ::UnityEngine::Rendering::Universal::DefaultMaterialType UnityEngine::Rendering::Universal::DefaultMaterialType::Standard{ static_cast<int32_t>(0x0) };
...
constexpr ::UnityEngine::Rendering::Universal::DefaultMaterialType UnityEngine::Rendering::Universal::DefaultMaterialType::UnityBuiltinDefault{ static_cast<int32_t>(0x4) };
constexpr ::UnityEngine::Rendering::Universal::DefaultMaterialType UnityEngine::Rendering::Universal::DefaultMaterialType::SpriteMask{ static_cast<int32_t>(0x5) };
constexpr ::UnityEngine::Rendering::Universal::DefaultMaterialType UnityEngine::Rendering::Universal::DefaultMaterialType::Decal{ static_cast<int32_t>(0x6) };
