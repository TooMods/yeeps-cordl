...
public:
  ...
  /// @brief Method Clear, addr 0x2b717e4, size 0xa8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ToString, addr 0x2b6624c, size 0x6d8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_gameObject, addr 0x2b7173c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_isValid, addr 0x2b7174c, size 0x98, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method set_gameObject, addr 0x2b71744, size 0x8, virtual false, abstract: false, final false
