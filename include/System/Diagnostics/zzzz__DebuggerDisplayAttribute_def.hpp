...
public:
  ...
  /// @brief Method .ctor, addr 0x21c50b8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method set_Name, addr 0x21c5128, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Type, addr 0x21c5130, size 0x8, virtual false, abstract: false, final false
