...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x27dfcc8, size 0x40, virtual false, abstract: false, final false
  inline int64_t _GetValueFromBag_b__3_0(::StringW s, int64_t l);

  /// @brief Method .ctor, addr 0x27dfcc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToLong, addr 0x27dfc20, size 0x3c, virtual false, abstract: false, final false
  static inline int64_t ConvertValueToLong(::StringW v, int64_t defaultValue);

  /// @brief Method GetValueFromBag, addr 0x27dfabc, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27dfa20, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
