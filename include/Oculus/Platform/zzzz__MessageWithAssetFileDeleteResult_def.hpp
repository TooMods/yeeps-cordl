...
public:
  // Declarations
  /// @brief Method GetAssetFileDeleteResult, addr 0x19b2c9c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDeleteResult* GetAssetFileDeleteResult();

  /// @brief Method GetDataFromMessage, addr 0x19b2cd8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b088c, size 0x58, virtual false, abstract: false, final false
