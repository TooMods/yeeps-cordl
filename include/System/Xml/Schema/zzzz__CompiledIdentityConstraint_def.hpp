...
public:
  ...
  /// @brief Method .ctor, addr 0x304de1c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x304de88, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Fields, addr 0x304de14, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::Schema::Asttree*, ::Array<::System::Xml::Schema::Asttree*>*> get_Fields();

  /// @brief Method get_Role, addr 0x304de04, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::__CompiledIdentityConstraint__ConstraintRole get_Role();

  /// @brief Method get_Selector, addr 0x304de0c, size 0x8, virtual false, abstract: false, final false
