...
public:
  ...
  /// @brief Method BaseEquals, addr 0x1257fc0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1257f8c, size 0x34, virtual false, abstract: false, final false
