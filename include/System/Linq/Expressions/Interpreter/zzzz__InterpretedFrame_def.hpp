...
public:
  ...
  /// @brief Method MoveNext, addr 0x1a95e00, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerable<System.Linq.Expressions.Interpreter.InterpretedFrameInfo>.GetEnumerator, addr 0x1a95f38, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Linq.Expressions.Interpreter.InterpretedFrameInfo>.get_Current, addr 0x1a95e90, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1a95fdc, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1a95e9c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1a95edc, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1a95dfc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1a95624, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dup, addr 0x1a95518, size 0x8c, virtual false, abstract: false, final false
  inline void Dup();

  /// @brief Method Enter, addr 0x1a958a8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::InterpretedFrame* Enter();

  /// @brief Method GetDebugInfo, addr 0x1a95294, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::DebugInfo* GetDebugInfo(int32_t instructionIndex);

  /// @brief Method GetStackTraceDebugInfo, addr 0x1a955ac, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Goto, addr 0x1a95cc8, size 0x134, virtual false, abstract: false, final false
  inline int32_t Goto(int32_t labelIndex, ::System::Object* value, bool gotoExceptionHandler);

  /// @brief Method IsJumpHappened, addr 0x1a95960, size 0x10, virtual false, abstract: false, final false
  inline bool IsJumpHappened();

  /// @brief Method Leave, addr 0x1a95910, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x1a954e0, size 0x38, virtual false, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method Pop, addr 0x1a8afa8, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method PopPendingContinuation, addr 0x1a95c44, size 0x84, virtual false, abstract: false, final false
  inline void PopPendingContinuation();

  /// @brief Method Push, addr 0x1a8afe4, size 0x6c, virtual false, abstract: false, final false
  inline void Push(::System::Object* value);

  /// @brief Method Push, addr 0x1a8b59c, size 0xc8, virtual false, abstract: false, final false
  inline void Push(bool value);

  /// @brief Method Push, addr 0x1a8ea10, size 0xbc, virtual false, abstract: false, final false
  inline void Push(int16_t value);

  /// @brief Method Push, addr 0x1a8eb64, size 0x78, virtual false, abstract: false, final false
  inline void Push(int32_t value);

  /// @brief Method Push, addr 0x1a95400, size 0xbc, virtual false, abstract: false, final false
  inline void Push(int8_t value);

  /// @brief Method Push, addr 0x1a8b1f8, size 0xbc, virtual false, abstract: false, final false
  inline void Push(uint16_t value);

  /// @brief Method Push, addr 0x1a8b050, size 0xbc, virtual false, abstract: false, final false
  inline void Push(uint8_t value);

  /// @brief Method PushContinuation, addr 0x1a95980, size 0x3c, virtual false, abstract: false, final false
  inline void PushContinuation(int32_t continuation);

  /// @brief Method PushPendingContinuation, addr 0x1a95bc4, size 0x80, virtual false, abstract: false, final false
  inline void PushPendingContinuation();

  /// @brief Method RemoveContinuation, addr 0x1a95970, size 0x10, virtual false, abstract: false, final false
  inline void RemoveContinuation();

  /// @brief Method SaveTraceToException, addr 0x1a95658, size 0x250, virtual false, abstract: false, final false
  inline void SaveTraceToException(::System::Exception* exception);

  /// @brief Method SetStackDepth, addr 0x1a954bc, size 0x24, virtual false, abstract: false, final false
  inline void SetStackDepth(int32_t depth);

  /// @brief Method YieldToCurrentContinuation, addr 0x1a959bc, size 0x78, virtual false, abstract: false, final false
  inline int32_t YieldToCurrentContinuation();

  /// @brief Method YieldToPendingContinuation, addr 0x1a95a34, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1a951a4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Name, addr 0x1a953e4, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Parent, addr 0x1a955a4, size 0x8, virtual false, abstract: false, final false
