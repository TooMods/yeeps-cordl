...
public:
  ...
  /// @brief Method EnqueueRumble, addr 0x1d3c728, size 0xa8, virtual false, abstract: false, final false
  inline void EnqueueRumble(::ArrayW<uint8_t, ::Array<uint8_t>*> samples);

  /// @brief Method .ctor, addr 0x1d3c5c8, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method get_capabilities, addr 0x1d3c59c, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::Haptics::HapticCapabilities get_capabilities();

  /// @brief Method get_device, addr 0x1d3c5b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_capabilities, addr 0x1d3c5ac, size 0xc, virtual false, abstract: false, final false
  inline void set_capabilities(::UnityEngine::InputSystem::XR::Haptics::HapticCapabilities value);

  /// @brief Method set_device, addr 0x1d3c5c0, size 0x8, virtual false, abstract: false, final false
