...
namespace Amazon::Lambda::Model {
class __ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ - PaginateAsync_d__8;
}
namespace Amazon::Lambda::Model {
...
MARK_REF_PTR_T(::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
               PaginateAsync_d__8);
...
class CORDL_TYPE __ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
    PaginateAsync_d__8 : public ::System::Object {
public:
  // Declarations
  __declspec(property(
      get = System_Collections_Generic_IAsyncEnumerator_Amazon_Lambda_Model_ListProvisionedConcurrencyConfigsResponse__get_Current))::Amazon::Lambda::Model::ListProvisionedConcurrencyConfigsResponse*
      System_Collections_Generic_IAsyncEnumerator_Amazon_Lambda_Model_ListProvisionedConcurrencyConfigsResponse__Current;
  ...
  __declspec(property(
      ...
      put = __cordl_internal_set___u__1))::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::Lambda::Model::ListProvisionedConcurrencyConfigsResponse*>
      __u__1;
  ...
  static inline ::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ - PaginateAsync_d__8();

public:
  // Ctor Parameters [CppParam { name: "", ty:
  // "__ListProvisionedConcurrencyConfigsPaginator___Amazon-Runtime-IPaginator_Amazon-Lambda-Model-ListProvisionedConcurrencyConfigsResponse_-PaginateAsync_d__8", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
  ...
  // Ctor Parameters [CppParam { name: "", ty:
  // "__ListProvisionedConcurrencyConfigsPaginator___Amazon-Runtime-IPaginator_Amazon-Lambda-Model-ListProvisionedConcurrencyConfigsResponse_-PaginateAsync_d__8", modifiers: "const&", def_value: None
  // }]
  // @brief delete copy ctor to prevent accidental deref copies
  __ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
      PaginateAsync_d__8(__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
                         PaginateAsync_d__8 const&) = delete;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model -
                                                  ListProvisionedConcurrencyConfigsResponse_ - PaginateAsync_d__8,
                                              0xb0>,
              "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
                           PaginateAsync_d__8,
                       _____1__state) == 0x10,
              "Offset mismatch!");
...
public:
  // Declarations
  using _Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ - PaginateAsync_d__8 =
      ::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ - PaginateAsync_d__8;
...
NEED_NO_BOX(::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
            PaginateAsync_d__8);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::__ListProvisionedConcurrencyConfigsPaginator___Amazon - Runtime - IPaginator_Amazon - Lambda - Model - ListProvisionedConcurrencyConfigsResponse_ -
                           PaginateAsync_d__8*,
                       "Amazon.Lambda.Model",
                       "ListProvisionedConcurrencyConfigsPaginator/<Amazon-Runtime-IPaginator<Amazon-Lambda-Model-ListProvisionedConcurrencyConfigsResponse>-PaginateAsync>d__8");
