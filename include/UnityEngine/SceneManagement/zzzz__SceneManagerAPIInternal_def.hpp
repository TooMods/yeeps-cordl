...
public:
  // Declarations
  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x29de4b8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal_Injected, addr 0x29de518, size 0x5c, virtual false, abstract: false, final false
