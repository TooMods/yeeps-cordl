...
public:
  ...
  /// @brief Method .ctor, addr 0x1870f0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_onAnyButtonPress>b__79_0, addr 0x1870f14, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method <get_onAnyButtonPress>b__79_1, addr 0x18710c4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddDevice, addr 0x186df1c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x186de18, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x186e034, size 0xbc, virtual false, abstract: false, final false
  static inline void AddDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method AddDeviceUsage, addr 0x186ede8, size 0xa0, virtual false, abstract: false, final false
  static inline void AddDeviceUsage(::UnityEngine::InputSystem::InputDevice* device, ::StringW usage);

  /// @brief Method AddDeviceUsage, addr 0x186ee88, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableAllEnabledActions, addr 0x187099c, size 0x8, virtual false, abstract: false, final false
  static inline void DisableAllEnabledActions();

  /// @brief Method DisableDevice, addr 0x186e61c, size 0x80, virtual false, abstract: false, final false
  static inline void DisableDevice(::UnityEngine::InputSystem::InputDevice* device, bool keepSendingEvents);

  /// @brief Method EnableDevice, addr 0x186e5a8, size 0x74, virtual false, abstract: false, final false
  static inline void EnableDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method EnsureInitialized, addr 0x1870e1c, size 0x4, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method FindControl, addr 0x186f030, size 0x140, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputControl* FindControl(::StringW path);

  /// @brief Method FindControls, addr 0x186f1d0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method FlushDisconnectedDevices, addr 0x186e160, size 0x64, virtual false, abstract: false, final false
  static inline void FlushDisconnectedDevices();

  /// @brief Method GetDevice, addr 0x186e1c4, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputDevice* GetDevice(::StringW nameOrLayout);

  /// @brief Method GetDevice, addr 0x186e230, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeviceById, addr 0x186e434, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputDevice* GetDeviceById(int32_t deviceId);

  /// @brief Method GetNameOfBaseLayout, addr 0x186cc58, size 0x11c, virtual false, abstract: false, final false
  static inline ::StringW GetNameOfBaseLayout(::StringW layoutName);

  /// @brief Method GetUnsupportedDevices, addr 0x186e4a0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnsupportedDevices, addr 0x186e53c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeInPlayer, addr 0x1870c08, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFirstLayoutBasedOnSecond, addr 0x186cd74, size 0x150, virtual false, abstract: false, final false
  static inline bool IsFirstLayoutBasedOnSecond(::StringW firstLayoutName, ::StringW secondLayoutName);

  /// @brief Method ListEnabledActions, addr 0x18709a4, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::InputAction*>* ListEnabledActions();

  /// @brief Method ListEnabledActions, addr 0x1870a40, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t ListEnabledActions(::System::Collections::Generic::List_1<::UnityEngine::InputSystem::InputAction*>* actions);

  /// @brief Method ListInteractions, addr 0x18706bc, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListInteractions();

  /// @brief Method ListLayouts, addr 0x186ca3c, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListLayouts();

  /// @brief Method ListLayoutsBasedOn, addr 0x186caa4, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListLayoutsBasedOn(::StringW baseLayout);

  /// @brief Method ListProcessors, addr 0x186d380, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayout, addr 0x186cb6c, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* LoadLayout(::StringW name);

  /// @brief Method PauseHaptics, addr 0x186e948, size 0x130, virtual false, abstract: false, final false
  static inline void PauseHaptics();

  /// @brief Method PerformDefaultPluginInitialization, addr 0x1870e20, size 0x38, virtual false, abstract: false, final false
  static inline void PerformDefaultPluginInitialization();

  /// @brief Method QueueConfigChangeEvent, addr 0x186f5b8, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x186f4d8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueTextEvent, addr 0x186f7d0, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterBindingComposite, addr 0x1870734, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterInteraction, addr 0x1870454, size 0x18c, virtual false, abstract: false, final false
  static inline void RegisterInteraction(::System::Type* type, ::StringW name);

  /// @brief Method RegisterLayout, addr 0x186c5dc, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayout, addr 0x186c438, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayoutBuilder, addr 0x186c7d4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayoutMatcher, addr 0x186c758, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayoutOverride, addr 0x186c6d8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterProcessor, addr 0x186cec4, size 0x3e0, virtual false, abstract: false, final false
  static inline void RegisterProcessor(::System::Type* type, ::StringW name);

  /// @brief Method RemoveDevice, addr 0x186e0f0, size 0x70, virtual false, abstract: false, final false
  static inline void RemoveDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method RemoveDeviceUsage, addr 0x186ef0c, size 0xa0, virtual false, abstract: false, final false
  static inline void RemoveDeviceUsage(::UnityEngine::InputSystem::InputDevice* device, ::StringW usage);

  /// @brief Method RemoveDeviceUsage, addr 0x186efac, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveLayout, addr 0x186c958, size 0x6c, virtual false, abstract: false, final false
  static inline void RemoveLayout(::StringW name);

  /// @brief Method ResetDevice, addr 0x186e7f8, size 0x80, virtual false, abstract: false, final false
  static inline void ResetDevice(::UnityEngine::InputSystem::InputDevice* device, bool alsoResetDontResetControls);

  /// @brief Method ResetHaptics, addr 0x186ebac, size 0x134, virtual false, abstract: false, final false
  static inline void ResetHaptics();

  /// @brief Method ResumeHaptics, addr 0x186ea78, size 0x134, virtual false, abstract: false, final false
  static inline void ResumeHaptics();

  /// @brief Method RunInitialUpdate, addr 0x1870e58, size 0x50, virtual false, abstract: false, final false
  static inline void RunInitialUpdate();

  /// @brief Method RunInitializeInPlayer, addr 0x1870da0, size 0x7c, virtual false, abstract: false, final false
  static inline void RunInitializeInPlayer();

  /// @brief Method SetDeviceUsage, addr 0x186ece0, size 0x84, virtual false, abstract: false, final false
  static inline void SetDeviceUsage(::UnityEngine::InputSystem::InputDevice* device, ::StringW usage);

  /// @brief Method SetDeviceUsage, addr 0x186ed64, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindMatchingLayout, addr 0x186c9c4, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW TryFindMatchingLayout(::UnityEngine::InputSystem::Layouts::InputDeviceDescription deviceDescription);

  /// @brief Method TryGetBindingComposite, addr 0x18708c0, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Type* TryGetBindingComposite(::StringW name);

  /// @brief Method TryGetInteraction, addr 0x18705e0, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Type* TryGetInteraction(::StringW name);

  /// @brief Method TryGetProcessor, addr 0x186d2a4, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Type* TryGetProcessor(::StringW name);

  /// @brief Method TryResetDevice, addr 0x186e878, size 0x58, virtual false, abstract: false, final false
  static inline bool TryResetDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method TrySyncDevice, addr 0x186e69c, size 0xd4, virtual false, abstract: false, final false
  static inline bool TrySyncDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Update, addr 0x186f9f8, size 0x64, virtual false, abstract: false, final false
  static inline void Update();

  /// @brief Method Update, addr 0x186fa5c, size 0x158, virtual false, abstract: false, final false
  static inline void Update(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method add_onActionChange, addr 0x18702e4, size 0xb8, virtual false, abstract: false, final false
  static inline void add_onActionChange(::System::Action_2<::System::Object*, ::UnityEngine::InputSystem::InputActionChange>* value);

  /// @brief Method add_onAfterUpdate, addr 0x186fe70, size 0x12c, virtual false, abstract: false, final false
  static inline void add_onAfterUpdate(::System::Action* value);

  /// @brief Method add_onBeforeUpdate, addr 0x186fc18, size 0x12c, virtual false, abstract: false, final false
  static inline void add_onBeforeUpdate(::System::Action* value);

  /// @brief Method add_onDeviceChange, addr 0x186d4f8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onDeviceCommand, addr 0x186d7f0, size 0x17c, virtual false, abstract: false, final false
  static inline void add_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method add_onFindLayoutForDevice, addr 0x186dae8, size 0x12c, virtual false, abstract: false, final false
  static inline void add_onFindLayoutForDevice(::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate* value);

  /// @brief Method add_onLayoutChange, addr 0x186c1e0, size 0x12c, virtual false, abstract: false, final false
  static inline void add_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method add_onSettingsChange, addr 0x187020c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_devices, addr 0x186d3f8, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_disconnectedDevices, addr 0x186d45c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isProcessingEvents, addr 0x186f260, size 0x64, virtual false, abstract: false, final false
  static inline bool get_isProcessingEvents();

  /// @brief Method get_metrics, addr 0x1870b68, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputMetrics get_metrics();

  /// @brief Method get_onAnyButtonPress, addr 0x186f2d0, size 0x208, virtual false, abstract: false, final false
  static inline ::System::IObservable_1<::UnityEngine::InputSystem::InputControl*>* get_onAnyButtonPress();

  /// @brief Method get_onEvent, addr 0x186f2c4, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputEventListener get_onEvent();

  /// @brief Method get_pollingFrequency, addr 0x186dd40, size 0x64, virtual false, abstract: false, final false
  static inline float_t get_pollingFrequency();

  /// @brief Method get_remoting, addr 0x1870a9c, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputRemoting* get_remoting();

  /// @brief Method get_settings, addr 0x186fbb4, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::InputSettings> get_settings();

  /// @brief Method get_version, addr 0x1870af4, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Version* get_version();

  /// @brief Method remove_onActionChange, addr 0x187039c, size 0xb8, virtual false, abstract: false, final false
  static inline void remove_onActionChange(::System::Action_2<::System::Object*, ::UnityEngine::InputSystem::InputActionChange>* value);

  /// @brief Method remove_onAfterUpdate, addr 0x186ff9c, size 0x12c, virtual false, abstract: false, final false
  static inline void remove_onAfterUpdate(::System::Action* value);

  /// @brief Method remove_onBeforeUpdate, addr 0x186fd44, size 0x12c, virtual false, abstract: false, final false
  static inline void remove_onBeforeUpdate(::System::Action* value);

  /// @brief Method remove_onDeviceChange, addr 0x186d674, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDeviceCommand, addr 0x186d96c, size 0x17c, virtual false, abstract: false, final false
  static inline void remove_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method remove_onFindLayoutForDevice, addr 0x186dc14, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onLayoutChange, addr 0x186c30c, size 0x12c, virtual false, abstract: false, final false
  static inline void remove_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method remove_onSettingsChange, addr 0x1870278, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_onEvent, addr 0x186f2cc, size 0x4, virtual false, abstract: false, final false
  static inline void set_onEvent(::UnityEngine::InputSystem::LowLevel::InputEventListener value);

  /// @brief Method set_pollingFrequency, addr 0x186dda4, size 0x74, virtual false, abstract: false, final false
  static inline void set_pollingFrequency(float_t value);

  /// @brief Method set_settings, addr 0x18700c8, size 0x144, virtual false, abstract: false, final false
...
public:
  ...
  static constexpr ::ConstString kAssemblyVersion{ u"1.5.0" };

  /// @brief Field kDocUrl offset 0xffffffff size 0x8
  static constexpr ::ConstString kDocUrl{ u"https://docs.unity3d.com/Packages/com.unity.inputsystem@1.5" };
