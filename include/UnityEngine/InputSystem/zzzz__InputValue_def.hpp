...
public:
  ...
  /// @brief Method Get, addr 0x1d2e750, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d2e830, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isPressed, addr 0x1d2e7b4, size 0x7c, virtual false, abstract: false, final false
