...
public:
  ...
  /// @brief Method get_collider, addr 0x22345dc, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider2D> get_collider();

  /// @brief Method get_distance, addr 0x22345cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_fraction, addr 0x22345d4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fraction();

  /// @brief Method get_normal, addr 0x22345c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_normal();

  /// @brief Method get_point, addr 0x22345bc, size 0x8, virtual false, abstract: false, final false
