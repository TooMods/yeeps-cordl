...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x18cc77c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18cbf24, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x18cc7e4, size 0x88, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x18cc720, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInvalid, addr 0x18cc790, size 0x54, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckResult, addr 0x18cc17c, size 0x134, virtual false, abstract: false, final false
  inline void CheckResult(int32_t result, ::StringW where);

  /// @brief Method CloseZStream, addr 0x18cc778, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CloseZStream(void* stream);

  /// @brief Method Create, addr 0x18ca704, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateZStream, addr 0x18cbfe8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x18ca994, size 0x104, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x18cc080, size 0x98, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x18cc118, size 0x64, virtual false, abstract: false, final false
  static inline int32_t Flush(::System::IO::Compression::__DeflateStreamNative__SafeDeflateStreamHandle* stream);

  /// @brief Method Flush, addr 0x18cb0a4, size 0x54, virtual false, abstract: false, final false
  inline void Flush();

  static inline ::System::IO::Compression::DeflateStreamNative* New_ctor();

  /// @brief Method ReadZStream, addr 0x18caae0, size 0x78, virtual false, abstract: false, final false
  inline int32_t ReadZStream(void* buffer, int32_t length);

  /// @brief Method ReadZStream, addr 0x18cc2b0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnmanagedRead, addr 0x18cc3a8, size 0x1a4, virtual false, abstract: false, final false
  inline int32_t UnmanagedRead(void* buffer, int32_t length);

  /// @brief Method UnmanagedRead, addr 0x18cbda4, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t UnmanagedRead(void* buffer, int32_t length, void* data);

  /// @brief Method UnmanagedWrite, addr 0x18cc54c, size 0x1d4, virtual false, abstract: false, final false
  inline int32_t UnmanagedWrite(void* buffer, int32_t length);

  /// @brief Method UnmanagedWrite, addr 0x18cbe60, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t UnmanagedWrite(void* buffer, int32_t length, void* data);

  /// @brief Method WriteZStream, addr 0x18cc32c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteZStream, addr 0x18cad88, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18cbf1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
