...
public:
  ...
  /// @brief Method IsFeatureEnabled, addr 0x1d2aadc, size 0x7c, virtual false, abstract: false, final false
  inline bool IsFeatureEnabled(::StringW featureName);

  static inline ::UnityEngine::InputSystem::InputSettings* New_ctor();

  /// @brief Method OnChange, addr 0x1d2a44c, size 0xcc, virtual false, abstract: false, final false
  inline void OnChange();

  /// @brief Method SetInternalFeatureFlag, addr 0x1d2a8d0, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d2ab58, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_backgroundBehavior, addr 0x1d2a684, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputSettings__BackgroundBehavior get_backgroundBehavior();

  /// @brief Method get_buttonReleaseThreshold, addr 0x1d2a5c4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_buttonReleaseThreshold();

  /// @brief Method get_compensateForScreenOrientation, addr 0x1d2a518, size 0x8, virtual false, abstract: false, final false
  inline bool get_compensateForScreenOrientation();

  /// @brief Method get_defaultButtonPressPoint, addr 0x1d2a588, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultButtonPressPoint();

  /// @brief Method get_defaultDeadzoneMax, addr 0x1d2a568, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultDeadzoneMax();

  /// @brief Method get_defaultDeadzoneMin, addr 0x1d2a548, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultDeadzoneMin();

  /// @brief Method get_defaultHoldTime, addr 0x1d2a624, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultHoldTime();

  /// @brief Method get_defaultSlowTapTime, addr 0x1d2a604, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultSlowTapTime();

  /// @brief Method get_defaultTapTime, addr 0x1d2a5e4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultTapTime();

  /// @brief Method get_disableRedundantEventsMerging, addr 0x1d2a888, size 0x8, virtual false, abstract: false, final false
  inline bool get_disableRedundantEventsMerging();

  /// @brief Method get_editorInputBehaviorInPlayMode, addr 0x1d2a6a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputSettings__EditorInputBehaviorInPlayMode get_editorInputBehaviorInPlayMode();

  /// @brief Method get_filterNoiseOnCurrent, addr 0x1d2a53c, size 0x8, virtual false, abstract: false, final false
  inline bool get_filterNoiseOnCurrent();

  /// @brief Method get_maxEventBytesPerUpdate, addr 0x1d2a6c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxEventBytesPerUpdate();

  /// @brief Method get_maxQueuedEventsPerUpdate, addr 0x1d2a6e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxQueuedEventsPerUpdate();

  /// @brief Method get_multiTapDelayTime, addr 0x1d2a664, size 0x8, virtual false, abstract: false, final false
  inline float_t get_multiTapDelayTime();

  /// @brief Method get_shortcutKeysConsumeInput, addr 0x1d2a8ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_shortcutKeysConsumeInput();

  /// @brief Method get_supportedDevices, addr 0x1d2a704, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::StringW> get_supportedDevices();

  /// @brief Method get_tapRadius, addr 0x1d2a644, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tapRadius();

  /// @brief Method get_updateMode, addr 0x1d2a42c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_backgroundBehavior, addr 0x1d2a68c, size 0x18, virtual false, abstract: false, final false
  inline void set_backgroundBehavior(::UnityEngine::InputSystem::__InputSettings__BackgroundBehavior value);

  /// @brief Method set_buttonReleaseThreshold, addr 0x1d2a5cc, size 0x18, virtual false, abstract: false, final false
  inline void set_buttonReleaseThreshold(float_t value);

  /// @brief Method set_compensateForScreenOrientation, addr 0x1d2a520, size 0x1c, virtual false, abstract: false, final false
  inline void set_compensateForScreenOrientation(bool value);

  /// @brief Method set_defaultButtonPressPoint, addr 0x1d2a590, size 0x34, virtual false, abstract: false, final false
  inline void set_defaultButtonPressPoint(float_t value);

  /// @brief Method set_defaultDeadzoneMax, addr 0x1d2a570, size 0x18, virtual false, abstract: false, final false
  inline void set_defaultDeadzoneMax(float_t value);

  /// @brief Method set_defaultDeadzoneMin, addr 0x1d2a550, size 0x18, virtual false, abstract: false, final false
  inline void set_defaultDeadzoneMin(float_t value);

  /// @brief Method set_defaultHoldTime, addr 0x1d2a62c, size 0x18, virtual false, abstract: false, final false
  inline void set_defaultHoldTime(float_t value);

  /// @brief Method set_defaultSlowTapTime, addr 0x1d2a60c, size 0x18, virtual false, abstract: false, final false
  inline void set_defaultSlowTapTime(float_t value);

  /// @brief Method set_defaultTapTime, addr 0x1d2a5ec, size 0x18, virtual false, abstract: false, final false
  inline void set_defaultTapTime(float_t value);

  /// @brief Method set_disableRedundantEventsMerging, addr 0x1d2a890, size 0x1c, virtual false, abstract: false, final false
  inline void set_disableRedundantEventsMerging(bool value);

  /// @brief Method set_editorInputBehaviorInPlayMode, addr 0x1d2a6ac, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_filterNoiseOnCurrent, addr 0x1d2a544, size 0x4, virtual false, abstract: false, final false
  inline void set_filterNoiseOnCurrent(bool value);

  /// @brief Method set_maxEventBytesPerUpdate, addr 0x1d2a6cc, size 0x18, virtual false, abstract: false, final false
  inline void set_maxEventBytesPerUpdate(int32_t value);

  /// @brief Method set_maxQueuedEventsPerUpdate, addr 0x1d2a6ec, size 0x18, virtual false, abstract: false, final false
  inline void set_maxQueuedEventsPerUpdate(int32_t value);

  /// @brief Method set_multiTapDelayTime, addr 0x1d2a66c, size 0x18, virtual false, abstract: false, final false
  inline void set_multiTapDelayTime(float_t value);

  /// @brief Method set_shortcutKeysConsumeInput, addr 0x1d2a8b4, size 0x1c, virtual false, abstract: false, final false
  inline void set_shortcutKeysConsumeInput(bool value);

  /// @brief Method set_supportedDevices, addr 0x1d2a764, size 0x124, virtual false, abstract: false, final false
  inline void set_supportedDevices(::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::StringW> value);

  /// @brief Method set_tapRadius, addr 0x1d2a64c, size 0x18, virtual false, abstract: false, final false
  inline void set_tapRadius(float_t value);

  /// @brief Method set_updateMode, addr 0x1d2a434, size 0x18, virtual false, abstract: false, final false
