...
public:
  ...
  /// @brief Method Awake, addr 0x14df0d0, size 0x1e4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ComputeOpacity, addr 0x14e05dc, size 0x24, virtual false, abstract: false, final false
  inline float_t ComputeOpacity(float_t distance, float_t innerThreshold, float_t outerThreshold);

  /// @brief Method DisableHandObjects, addr 0x14dff40, size 0xec, virtual false, abstract: false, final false
  inline void DisableHandObjects();

  /// @brief Method GetHandDistanceToKeyboard, addr 0x14e002c, size 0x2d0, virtual false, abstract: false, final false
  inline float_t GetHandDistanceToKeyboard(::GlobalNamespace::OVRSkeleton* handSkeleton);

  /// @brief Method LateUpdate, addr 0x14df764, size 0x7dc, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OVRTrackedKeyboardHands* New_ctor();

  /// @brief Method RetargetHandTrackingToHandPresence, addr 0x14df5b8, size 0x170, virtual false, abstract: false, final false
  inline void RetargetHandTrackingToHandPresence();

  /// @brief Method SetHandModelsEnabled, addr 0x14e03d4, size 0x208, virtual false, abstract: false, final false
  inline void SetHandModelsEnabled(bool enableLeftModel, bool enableRightModel);

  /// @brief Method ShouldEnableModel, addr 0x14e0368, size 0x6c, virtual false, abstract: false, final false
  inline bool ShouldEnableModel(float_t distance);

  /// @brief Method ShouldEnablePassthrough, addr 0x14e02fc, size 0x6c, virtual false, abstract: false, final false
  inline bool ShouldEnablePassthrough(float_t distance);

  /// @brief Method Start, addr 0x14df2b4, size 0x304, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopHandPresence, addr 0x14e0600, size 0x30, virtual false, abstract: false, final false
  inline void StopHandPresence();

  /// @brief Method TrackedKeyboardActiveUpdated, addr 0x14e0630, size 0xc, virtual false, abstract: false, final false
  inline void TrackedKeyboardActiveUpdated(::GlobalNamespace::__OVRTrackedKeyboard__TrackedKeyboardSetActiveEvent e);

  /// @brief Method TrackedKeyboardVisibilityChanged, addr 0x14e063c, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14e07ec, size 0x750, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AreControllersActive, addr 0x14df728, size 0x3c, virtual false, abstract: false, final false
  inline bool get_AreControllersActive();

  /// @brief Method get_LeftHandOverKeyboard, addr 0x14df0bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_LeftHandOverKeyboard();

  /// @brief Method get_RightHandOverKeyboard, addr 0x14df0a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LeftHandOverKeyboard, addr 0x14df0c4, size 0xc, virtual false, abstract: false, final false
  inline void set_LeftHandOverKeyboard(bool value);

  /// @brief Method set_RightHandOverKeyboard, addr 0x14df0b0, size 0xc, virtual false, abstract: false, final false
