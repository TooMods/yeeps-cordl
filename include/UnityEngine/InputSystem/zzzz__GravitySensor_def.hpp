...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c71e54, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c71ecc, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::GravitySensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c71f20, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c71fa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::GravitySensor* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x1c71dc0, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::GravitySensor* get_current();

  /// @brief Method get_gravity, addr 0x1c71db0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x1c71e08, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::GravitySensor* value);

  /// @brief Method set_gravity, addr 0x1c71db8, size 0x8, virtual false, abstract: false, final false
