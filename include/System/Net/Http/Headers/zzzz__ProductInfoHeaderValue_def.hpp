...
public:
  ...
  /// @brief Method Equals, addr 0x162a4c0, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x162a580, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x162a4b8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x162a940, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x162a5ac, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x162a754, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x162a490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x162a428, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::ProductHeaderValue* product);

  /// @brief Method get_Comment, addr 0x162a498, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Comment();

  /// @brief Method get_Product, addr 0x162a4a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::ProductHeaderValue* get_Product();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Comment, addr 0x162a4a0, size 0x8, virtual false, abstract: false, final false
  inline void set_Comment(::StringW value);

  /// @brief Method set_Product, addr 0x162a4b0, size 0x8, virtual false, abstract: false, final false
