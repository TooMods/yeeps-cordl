...
public:
  ...
  /// @brief Method Equals, addr 0x29e1bdc, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x29e1bd0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle();

  /// @brief Method .ctor, addr 0x29e1bc8, size 0x8, virtual false, abstract: false, final false
