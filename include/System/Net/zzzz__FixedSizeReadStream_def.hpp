...
public:
  ...
  /// @brief Method MoveNext, addr 0x1036c58, size 0x2b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1036f08, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ProcessReadAsync, addr 0x1036b30, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1036b08, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* innerStream, int64_t contentLength);

  /// @brief Method get_ContentLength, addr 0x1036b00, size 0x8, virtual false, abstract: false, final false
