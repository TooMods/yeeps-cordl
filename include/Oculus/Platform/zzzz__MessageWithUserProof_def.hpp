...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5d68, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserProof* GetDataFromMessage(void* c_message);

  /// @brief Method GetUserProof, addr 0x19b5d2c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b17ac, size 0x58, virtual false, abstract: false, final false
