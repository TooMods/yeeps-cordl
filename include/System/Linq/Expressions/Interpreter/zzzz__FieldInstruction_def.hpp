...
public:
  ...
  /// @brief Method ToString, addr 0x1a8b69c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1a8b66c, size 0x28, virtual false, abstract: false, final false
