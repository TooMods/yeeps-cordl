...
public:
  ...
  /// @brief Method Dispose, addr 0x18f7ca8, size 0x3c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x18f7ce4, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeMeshReadyDelegate, addr 0x18f7c08, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18f7c60, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
