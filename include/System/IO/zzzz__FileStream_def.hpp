...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x1fc72c0, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x1fc74cc, size 0x28, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x1fc8da4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc71e8, size 0xd8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x1fc7f40, size 0xa8, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x1fc8150, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x1fc8db8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc7e68, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method BeginRead, addr 0x1fc6f44, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x1fc7aa4, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x1fc881c, size 0x334, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x1fc7368, size 0x164, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x1fc7fe8, size 0x168, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method ExposeHandle, addr 0x1fc5f9c, size 0x28, virtual false, abstract: false, final false
  inline void ExposeHandle();

  /// @brief Method Finalize, addr 0x1fc8778, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x1fc8700, size 0x78, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x1fc8b54, size 0x88, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method FlushBuffer, addr 0x1fc6614, size 0x178, virtual false, abstract: false, final false
  inline void FlushBuffer();

  /// @brief Method FlushBufferIfDirty, addr 0x1fc62a0, size 0x10, virtual false, abstract: false, final false
  inline void FlushBufferIfDirty();

  /// @brief Method GetSecureFileName, addr 0x1fc5454, size 0x78, virtual false, abstract: false, final false
  inline ::StringW GetSecureFileName(::StringW filename);

  /// @brief Method GetSecureFileName, addr 0x1fc4f48, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW GetSecureFileName(::StringW filename, bool full);

  /// @brief Method Init, addr 0x1fc3e14, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitBuffer, addr 0x1fc5d10, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x1fc6b88, size 0x268, virtual true, abstract: false, final false
  inline int32_t Read(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> array, int32_t offset, int32_t count);

  /// @brief Method ReadAsync, addr 0x1fc8bdc, size 0x4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ReadByte, addr 0x1fc678c, size 0x148, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ReadData, addr 0x1fc68d4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInternal, addr 0x1fc6df0, size 0x9c, virtual false, abstract: false, final false
  inline int32_t ReadInternal(::ArrayW<uint8_t, ::Array<uint8_t>*> dest, int32_t offset, int32_t count);

  /// @brief Method ReadSegment, addr 0x1fc6e8c, size 0xb8, virtual false, abstract: false, final false
  inline int32_t ReadSegment(::ArrayW<uint8_t, ::Array<uint8_t>*> dest, int32_t dest_offset, int32_t count);

  /// @brief Method RefillBuffer, addr 0x1fc69fc, size 0x30, virtual false, abstract: false, final false
  inline void RefillBuffer();

  /// @brief Method Seek, addr 0x1fc815c, size 0x264, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x1fc83c0, size 0x210, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x1fc74f4, size 0x23c, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method WriteAsync, addr 0x1fc8be0, size 0x4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method WriteByte, addr 0x1fc6a2c, size 0x15c, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t value);

  /// @brief Method WriteInternal, addr 0x1fc7730, size 0x1b4, virtual false, abstract: false, final false
  inline void WriteInternal(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t offset, int32_t count);

  /// @brief Method WriteSegment, addr 0x1fc7a2c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc3c58, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(void* handle, ::System::IO::FileAccess access, bool ownsHandle, int32_t bufferSize);

  /// @brief Method .ctor, addr 0x1fc3c68, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc40fc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::System::IO::FileMode mode, ::System::IO::FileAccess access);

  /// @brief Method .ctor, addr 0x1fc4140, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::System::IO::FileMode mode, ::System::IO::FileAccess access, ::System::IO::FileShare share);

  /// @brief Method .ctor, addr 0x1fc488c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc4164, size 0x728, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc4128, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc48d4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1fc48ac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x1fc6104, size 0x14, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x1fc612c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x1fc6118, size 0x14, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x1fc613c, size 0x164, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Name, addr 0x1fc6134, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Position, addr 0x1fc63d8, size 0x170, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_SafeFileHandle, addr 0x1fc65d8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Position, addr 0x1fc6548, size 0x90, virtual true, abstract: false, final false
