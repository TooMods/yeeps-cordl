...
public:
  ...
  /// @brief Method MoveNext, addr 0x26f0c58, size 0x88, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::__LayoutGroup___DelayedSetDirty_d__56* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x26f0ce0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x26f0ce8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x26f0d28, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x26f0c54, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26f0c2c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculateLayoutInputHorizontal, addr 0x26edf1c, size 0x3bc, virtual true, abstract: false, final false
  ...
  /// @brief Method DelayedSetDirty, addr 0x26f0bc4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DelayedSetDirty(::UnityEngine::RectTransform* rectTransform);

  /// @brief Method GetAlignmentOnAxis, addr 0x26efbb8, size 0x4c, virtual false, abstract: false, final false
  inline float_t GetAlignmentOnAxis(int32_t axis);

  /// @brief Method GetStartOffset, addr 0x26eec00, size 0x164, virtual false, abstract: false, final false
  inline float_t GetStartOffset(int32_t axis, float_t requiredSpaceWithoutPadding);

  /// @brief Method GetTotalFlexibleSize, addr 0x26f013c, size 0x74, virtual false, abstract: false, final false
  inline float_t GetTotalFlexibleSize(int32_t axis);

  /// @brief Method GetTotalMinSize, addr 0x26f01b0, size 0x74, virtual false, abstract: false, final false
  inline float_t GetTotalMinSize(int32_t axis);

  /// @brief Method GetTotalPreferredSize, addr 0x26f00c8, size 0x74, virtual false, abstract: false, final false
  inline float_t GetTotalPreferredSize(int32_t axis);

  static inline ::UnityEngine::UI::LayoutGroup* New_ctor();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x26f09ac, size 0x4, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x26f0930, size 0x7c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26f0840, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnRectTransformDimensionsChange, addr 0x26f0b90, size 0x30, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method OnTransformChildrenChanged, addr 0x26f0bc0, size 0x4, virtual true, abstract: false, final false
  inline void OnTransformChildrenChanged();

  /// @brief Method SetChildAlongAxis, addr 0x26f09b0, size 0xa8, virtual false, abstract: false, final false
  inline void SetChildAlongAxis(::UnityEngine::RectTransform* rect, int32_t axis, float_t pos);

  /// @brief Method SetChildAlongAxis, addr 0x26eed64, size 0xb0, virtual false, abstract: false, final false
  inline void SetChildAlongAxis(::UnityEngine::RectTransform* rect, int32_t axis, float_t pos, float_t size);

  /// @brief Method SetChildAlongAxisWithScale, addr 0x26efe88, size 0x240, virtual false, abstract: false, final false
  inline void SetChildAlongAxisWithScale(::UnityEngine::RectTransform* rect, int32_t axis, float_t pos, float_t scaleFactor);

  /// @brief Method SetChildAlongAxisWithScale, addr 0x26efc04, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDirty, addr 0x26f085c, size 0xd4, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method SetLayoutHorizontal, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutInputForAxis, addr 0x26ee2d8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26edc24, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_childAlignment, addr 0x26f079c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextAnchor get_childAlignment();

  /// @brief Method get_flexibleHeight, addr 0x26f0830, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleHeight();

  /// @brief Method get_flexibleWidth, addr 0x26f0818, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleWidth();

  /// @brief Method get_isRootLayoutGroup, addr 0x26f0a58, size 0x138, virtual false, abstract: false, final false
  inline bool get_isRootLayoutGroup();

  /// @brief Method get_layoutPriority, addr 0x26f0838, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_layoutPriority();

  /// @brief Method get_minHeight, addr 0x26f0820, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minHeight();

  /// @brief Method get_minWidth, addr 0x26f0808, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minWidth();

  /// @brief Method get_padding, addr 0x26f0738, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_padding();

  /// @brief Method get_preferredHeight, addr 0x26f0828, size 0x8, virtual true, abstract: false, final false
  inline float_t get_preferredHeight();

  /// @brief Method get_preferredWidth, addr 0x26f0810, size 0x8, virtual true, abstract: false, final false
  inline float_t get_preferredWidth();

  /// @brief Method get_rectChildren, addr 0x26f0800, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::RectTransform>>* get_rectChildren();

  /// @brief Method get_rectTransform, addr 0x26ee584, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method set_childAlignment, addr 0x26f07a4, size 0x5c, virtual false, abstract: false, final false
  inline void set_childAlignment(::UnityEngine::TextAnchor value);

  /// @brief Method set_padding, addr 0x26f0740, size 0x5c, virtual false, abstract: false, final false
