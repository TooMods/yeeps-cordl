...
public:
  ...
  /// @brief Method .ctor, addr 0x1b377cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ResolveType, addr 0x1b377fc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b377d4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Bind, addr 0x1abd430, size 0x58, virtual false, abstract: false, final false
  inline ::System::Type* Bind(::StringW assemblyString, ::StringW typeString);

  /// @brief Method CheckSerializable, addr 0x1abb11c, size 0x138, virtual false, abstract: false, final false
  inline void CheckSerializable(::System::Type* t);

  /// @brief Method CheckTypeForwardedTo, addr 0x1abda2c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReadObjectInfo, addr 0x1ab3e98, size 0x30, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* CreateReadObjectInfo(::System::Type* objectType);

  /// @brief Method CreateReadObjectInfo, addr 0x1ab4678, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CrossAppDomainArray, addr 0x1abb364, size 0x30, virtual false, abstract: false, final false
  inline ::System::Object* CrossAppDomainArray(int32_t index);

  /// @brief Method Deserialize, addr 0x1ab69c8, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method FastBindToType, addr 0x1abd488, size 0x2f4, virtual false, abstract: false, final false
  inline ::System::Type* FastBindToType(::StringW assemblyName, ::StringW typeName);

  /// @brief Method GetId, addr 0x1abd348, size 0xe8, virtual false, abstract: false, final false
  inline int64_t GetId(int64_t objectId);

  /// @brief Method GetSimplyNamedTypeFromAssembly, addr 0x1abd7dc, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method GetType, addr 0x1ab172c, size 0x1ac, virtual false, abstract: false, final false
  inline ::System::Type* GetType(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* assemblyInfo, ::StringW name);

  /// @brief Method HasSurrogate, addr 0x1abb048, size 0xd4, virtual false, abstract: false, final false
  inline bool HasSurrogate(::System::Type* t);

  /// @brief Method InitFullDeserialization, addr 0x1abb254, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method NextRectangleMap, addr 0x1abc964, size 0xc4, virtual false, abstract: false, final false
  inline void NextRectangleMap(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method Parse, addr 0x1abb394, size 0x14c, virtual false, abstract: false, final false
  inline void Parse(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArray, addr 0x1abc2b8, size 0x6a4, virtual false, abstract: false, final false
  inline void ParseArray(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArrayMember, addr 0x1abca28, size 0x7a0, virtual false, abstract: false, final false
  inline void ParseArrayMember(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArrayMemberEnd, addr 0x1abd208, size 0x28, virtual false, abstract: false, final false
  inline void ParseArrayMemberEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseError, addr 0x1abbfe0, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMember, addr 0x1abba58, size 0x4c8, virtual false, abstract: false, final false
  inline void ParseMember(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseMemberEnd, addr 0x1abbf20, size 0xc0, virtual false, abstract: false, final false
  inline void ParseMemberEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseObject, addr 0x1abb518, size 0x314, virtual false, abstract: false, final false
  inline void ParseObject(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseObjectEnd, addr 0x1abb82c, size 0x22c, virtual false, abstract: false, final false
  inline void ParseObjectEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseSerializedStreamHeader, addr 0x1abb4e0, size 0x1c, virtual false, abstract: false, final false
  inline void ParseSerializedStreamHeader(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseSerializedStreamHeaderEnd, addr 0x1abb4fc, size 0x1c, virtual false, abstract: false, final false
  inline void ParseSerializedStreamHeaderEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseString, addr 0x1abd1c8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterObject, addr 0x1abc95c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterObject, addr 0x1abd230, size 0x118, virtual false, abstract: false, final false
  inline void RegisterObject(::System::Object* obj, ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr, ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* objectPr,
                             bool bIsString);

  /// @brief Method ResolveSimpleAssemblyName, addr 0x1abd77c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ab68b4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TopObject, addr 0x1abb02c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_TopObject();

  /// @brief Method get_ValueFixupStack, addr 0x1abafa8, size 0x84, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SerStack* get_ValueFixupStack();

  /// @brief Method set_TopObject, addr 0x1abb034, size 0x14, virtual false, abstract: false, final false
