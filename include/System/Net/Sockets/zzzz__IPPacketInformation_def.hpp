...
public:
  // Declarations
  /// @brief Method Equals, addr 0x2c8d4fc, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0x2c8d598, size 0x44, virtual true, abstract: false, final false
