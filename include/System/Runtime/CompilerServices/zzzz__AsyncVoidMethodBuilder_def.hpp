...
public:
  ...
  /// @brief Method Create, addr 0x1b45824, size 0x40, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder Create();

  /// @brief Method NotifySynchronizationContextOfCompletion, addr 0x1b459fc, size 0xa4, virtual false, abstract: false, final false
  inline void NotifySynchronizationContextOfCompletion();

  /// @brief Method SetException, addr 0x1b45aa0, size 0x134, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SetResult, addr 0x1b45934, size 0x5c, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetStateMachine, addr 0x1b45864, size 0x8, virtual false, abstract: false, final false
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);

  /// @brief Method Start, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TStateMachine> inline void Start(ByRef<TStateMachine> stateMachine);

  /// @brief Method get_Task, addr 0x1b45990, size 0x6c, virtual false, abstract: false, final false
