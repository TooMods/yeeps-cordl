...
public:
  ...
  /// @brief Method Run, addr 0x1840df4, size 0x15c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x1840628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
