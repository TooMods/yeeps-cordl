...
public:
  ...
  /// @brief Method MoveNext, addr 0x169a688, size 0x11c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRScreenFade___Fade_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x169a7a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x169a7ac, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x169a7ec, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x169a684, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x169a630, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Fade, addr 0x169a2cc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Fade(float_t startAlpha, float_t endAlpha);

  /// @brief Method FadeIn, addr 0x169a2a4, size 0x28, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeOut, addr 0x169a348, size 0x28, virtual false, abstract: false, final false
  inline void FadeOut();

  static inline ::GlobalNamespace::OVRScreenFade* New_ctor();

  /// @brief Method OnDestroy, addr 0x169a3b0, size 0x154, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x169a398, size 0x18, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnLevelFinishedLoading, addr 0x169a370, size 0x28, virtual false, abstract: false, final false
  inline void OnLevelFinishedLoading(int32_t level);

  /// @brief Method SetExplicitFade, addr 0x169a628, size 0x8, virtual false, abstract: false, final false
  inline void SetExplicitFade(float_t level);

  /// @brief Method SetMaterialAlpha, addr 0x169a520, size 0x108, virtual false, abstract: false, final false
  inline void SetMaterialAlpha();

  /// @brief Method SetUIFade, addr 0x169a504, size 0x1c, virtual false, abstract: false, final false
  inline void SetUIFade(float_t level);

  /// @brief Method Start, addr 0x1699e08, size 0x49c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x169a658, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::GlobalNamespace::OVRScreenFade> getStaticF__instance_k__BackingField();

  /// @brief Method get_currentAlpha, addr 0x1699d4c, size 0xbc, virtual false, abstract: false, final false
  inline float_t get_currentAlpha();

  /// @brief Method get_instance, addr 0x1699cb8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_instance, addr 0x1699d00, size 0x4c, virtual false, abstract: false, final false
