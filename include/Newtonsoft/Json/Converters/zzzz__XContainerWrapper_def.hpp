...
public:
  ...
  /// @brief Method AppendChild, addr 0x2f57b08, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method WrapNode, addr 0x2f57cfc, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f56b64, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* container);

  /// @brief Method get_ChildNodes, addr 0x2f56d08, size 0x408, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_Container, addr 0x2f58208, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XContainer* get_Container();

  /// @brief Method get_HasChildNodes, addr 0x2f5714c, size 0x28, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_ParentNode, addr 0x2f58280, size 0x44, virtual true, abstract: false, final false
