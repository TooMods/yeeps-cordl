...
public:
  ...
  /// @brief Method .ctor, addr 0x304e3b0, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::CompiledIdentityConstraint* constraint);

  /// @brief Method get_TableDim, addr 0x304e3a8, size 0x8, virtual false, abstract: false, final false
