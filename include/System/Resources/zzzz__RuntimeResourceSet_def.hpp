...
public:
  ...
  /// @brief Method Dispose, addr 0x1b476bc, size 0x124, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetEnumerator, addr 0x1b477e0, size 0x4, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorHelper, addr 0x1b477e4, size 0x100, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper();

  /// @brief Method GetObject, addr 0x1b482e8, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW key);

  /// @brief Method GetObject, addr 0x1b482f4, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW key, bool ignoreCase);

  /// @brief Method GetObject, addr 0x1b47958, size 0x914, virtual false, abstract: false, final false
  inline ::System::Object* GetObject(::StringW key, bool ignoreCase, bool isString);

  /// @brief Method GetString, addr 0x1b478e8, size 0x70, virtual true, abstract: false, final false
  inline ::StringW GetString(::StringW key);

  /// @brief Method GetString, addr 0x1b4826c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveResourceLocator, addr 0x1b48300, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1b478e4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1b4747c, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::StringW fileName);

  /// @brief Method .ctor, addr 0x1b475bc, size 0x100, virtual false, abstract: false, final false
