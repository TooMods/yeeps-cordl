...
public:
  ...
  /// @brief Method Init, addr 0x2a3e5e8, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a3e774, size 0x120, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DoMeasure, addr 0x2a3e0f4, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method ElideText, addr 0x2a3dc1c, size 0x4cc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent, addr 0x2a3d4b0, size 0x17c, virtual true, abstract: false, final false
  inline void HandleEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method MeasureTextSize, addr 0x2a3e0e8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnGenerateVisualContent, addr 0x2a3d968, size 0x120, virtual false, abstract: false, final false
  inline void OnGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext* mgc);

  /// @brief Method OnGeometryChanged, addr 0x2a3d62c, size 0x4, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* e);

  /// @brief Method ShouldElide, addr 0x2a3da88, size 0x68, virtual false, abstract: false, final false
  inline bool ShouldElide();

  /// @brief Method TextLibraryCanElide, addr 0x2a3daf0, size 0xc0, virtual false, abstract: false, final false
  inline bool TextLibraryCanElide();

  /// @brief Method UnityEngine.UIElements.INotifyValueChanged<System.String>.SetValueWithoutNotify, addr 0x2a3e474, size 0x6c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_INotifyValueChanged_System_String__SetValueWithoutNotify(::StringW newValue);

  /// @brief Method UnityEngine.UIElements.INotifyValueChanged<System.String>.get_value, addr 0x2a3e154, size 0x54, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_UIElements_INotifyValueChanged_System_String__get_value();

  /// @brief Method UnityEngine.UIElements.INotifyValueChanged<System.String>.set_value, addr 0x2a3e1a8, size 0x2cc, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_INotifyValueChanged_System_String__set_value(::StringW value);

  /// @brief Method UpdateTooltip, addr 0x2a3dbb0, size 0x6c, virtual false, abstract: false, final false
  inline void UpdateTooltip();

  /// @brief Method UpdateVisibleText, addr 0x2a3d630, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a3d2e8, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_displayTooltipWhenElided, addr 0x2a3d910, size 0x8, virtual false, abstract: false, final false
  inline bool get_displayTooltipWhenElided();

  /// @brief Method get_enableRichText, addr 0x2a3d8e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_enableRichText();

  /// @brief Method get_isElided, addr 0x2a3d954, size 0x8, virtual false, abstract: false, final false
  inline bool get_isElided();

  /// @brief Method get_text, addr 0x2a3d7ac, size 0x94, virtual true, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_textHandle, addr 0x2a3d4a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_displayTooltipWhenElided, addr 0x2a3d918, size 0x3c, virtual false, abstract: false, final false
  inline void set_displayTooltipWhenElided(bool value);

  /// @brief Method set_enableRichText, addr 0x2a3d8f0, size 0x20, virtual false, abstract: false, final false
  inline void set_enableRichText(bool value);

  /// @brief Method set_isElided, addr 0x2a3d95c, size 0xc, virtual false, abstract: false, final false
  inline void set_isElided(bool value);

  /// @brief Method set_text, addr 0x2a3d840, size 0xa8, virtual true, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_textHandle, addr 0x2a3d4a8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a3e5a0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
