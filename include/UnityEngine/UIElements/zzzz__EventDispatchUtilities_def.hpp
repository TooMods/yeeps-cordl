...
public:
  // Declarations
  /// @brief Method ExecuteDefaultAction, addr 0x2cd2ea0, size 0x1a8, virtual false, abstract: false, final false
  static inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method PropagateEvent, addr 0x2ccb5b4, size 0x74c, virtual false, abstract: false, final false
  static inline void PropagateEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method PropagateToIMGUIContainer, addr 0x2ccbd0c, size 0x224, virtual false, abstract: false, final false
