...
// Type: ::ButtonState
// SizeInfo { instance_size: 152, native_size: -1, calculated_instance_size: 152, calculated_native_size: 163, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::InputSystem::UI {
// Is value type: true
...
public:
  ...
  /// @brief Method CopyPressStateFrom, addr 0x1eae534, size 0x68, virtual false, abstract: false, final false
  inline void CopyPressStateFrom(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method CopyPressStateTo, addr 0x1eacff0, size 0xa0, virtual false, abstract: false, final false
  inline void CopyPressStateTo(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEndFrame, addr 0x1eb26cc, size 0xc, virtual false, abstract: false, final false
  inline void OnEndFrame();

  /// @brief Method get_clickedOnSameGameObject, addr 0x1eb2704, size 0x8, virtual false, abstract: false, final false
  inline bool get_clickedOnSameGameObject();

  /// @brief Method get_ignoreNextClick, addr 0x1eb26e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreNextClick();

  /// @brief Method get_isPressed, addr 0x1eb26d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isPressed();

  /// @brief Method get_pressTime, addr 0x1eb26f4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressTime();

  /// @brief Method get_wasPressedThisFrame, addr 0x1eae524, size 0x10, virtual false, abstract: false, final false
  inline bool get_wasPressedThisFrame();

  /// @brief Method get_wasReleasedThisFrame, addr 0x1eade7c, size 0x14, virtual false, abstract: false, final false
  inline bool get_wasReleasedThisFrame();

  /// @brief Method set_clickedOnSameGameObject, addr 0x1eb270c, size 0xc, virtual false, abstract: false, final false
  inline void set_clickedOnSameGameObject(bool value);

  /// @brief Method set_ignoreNextClick, addr 0x1eb26e8, size 0xc, virtual false, abstract: false, final false
  inline void set_ignoreNextClick(bool value);

  /// @brief Method set_isPressed, addr 0x1eb183c, size 0x54, virtual false, abstract: false, final false
  inline void set_isPressed(bool value);

  /// @brief Method set_pressTime, addr 0x1eb26fc, size 0x8, virtual false, abstract: false, final false
...
// SizeInfo { instance_size: 544, native_size: -1, calculated_instance_size: 544, calculated_native_size: 556, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::InputSystem::UI {
// Is value type: true
...
public:
  ...
  /// @brief Method CopyTouchOrPenStateFrom, addr 0x1eb1eac, size 0xc8, virtual false, abstract: false, final false
  inline void CopyTouchOrPenStateFrom(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnFrameFinished, addr 0x1eb1e64, size 0x48, virtual false, abstract: false, final false
  inline void OnFrameFinished();

  /// @brief Method .ctor, addr 0x1eb124c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::UI::ExtendedPointerEventData* eventData);

  /// @brief Method get_altitudeAngle, addr 0x1eb2638, size 0x8, virtual false, abstract: false, final false
  inline float_t get_altitudeAngle();

  /// @brief Method get_azimuthAngle, addr 0x1eb2614, size 0x8, virtual false, abstract: false, final false
  inline float_t get_azimuthAngle();

  /// @brief Method get_pointerType, addr 0x1ead0dc, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::UI::UIPointerType get_pointerType();

  /// @brief Method get_pressure, addr 0x1eb25f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x1eb2680, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_screenPosition, addr 0x1eb25b4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_scrollDelta, addr 0x1eb25e4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_scrollDelta();

  /// @brief Method get_twist, addr 0x1eb265c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_twist();

  /// @brief Method get_worldOrientation, addr 0x1eb25d0, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_worldOrientation();

  /// @brief Method get_worldPosition, addr 0x1eb25c0, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_worldPosition();

  /// @brief Method set_altitudeAngle, addr 0x1eb2640, size 0x1c, virtual false, abstract: false, final false
  inline void set_altitudeAngle(float_t value);

  /// @brief Method set_azimuthAngle, addr 0x1eb261c, size 0x1c, virtual false, abstract: false, final false
  inline void set_azimuthAngle(float_t value);

  /// @brief Method set_pressure, addr 0x1eb25f8, size 0x1c, virtual false, abstract: false, final false
  inline void set_pressure(float_t value);

  /// @brief Method set_radius, addr 0x1eb268c, size 0x40, virtual false, abstract: false, final false
  inline void set_radius(::UnityEngine::Vector2 value);

  /// @brief Method set_screenPosition, addr 0x1eb120c, size 0x40, virtual false, abstract: false, final false
  inline void set_screenPosition(::UnityEngine::Vector2 value);

  /// @brief Method set_scrollDelta, addr 0x1eb1a58, size 0x40, virtual false, abstract: false, final false
  inline void set_scrollDelta(::UnityEngine::Vector2 value);

  /// @brief Method set_twist, addr 0x1eb2664, size 0x1c, virtual false, abstract: false, final false
  inline void set_twist(float_t value);

  /// @brief Method set_worldOrientation, addr 0x1eb1b7c, size 0x58, virtual false, abstract: false, final false
  inline void set_worldOrientation(::UnityEngine::Quaternion value);

  /// @brief Method set_worldPosition, addr 0x1eb1c58, size 0x54, virtual false, abstract: false, final false
