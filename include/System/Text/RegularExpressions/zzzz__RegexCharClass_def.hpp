...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x1676b60, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x1676b78, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1676b70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x1676bfc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddCategory, addr 0x171d2c4, size 0x1c, virtual false, abstract: false, final false
  inline void AddCategory(::StringW category);

  /// @brief Method AddCategoryFromName, addr 0x171cdc8, size 0x210, virtual false, abstract: false, final false
  inline void AddCategoryFromName(::StringW categoryName, bool invert, bool caseInsensitive, ::StringW pattern);

  /// @brief Method AddChar, addr 0x171c850, size 0x8, virtual false, abstract: false, final false
  inline void AddChar(char16_t c);

  /// @brief Method AddCharClass, addr 0x171c978, size 0x174, virtual false, abstract: false, final false
  inline void AddCharClass(::System::Text::RegularExpressions::RegexCharClass* cc);

  /// @brief Method AddDigit, addr 0x171d834, size 0xb4, virtual false, abstract: false, final false
  inline void AddDigit(bool ecma, bool negate, ::StringW pattern);

  /// @brief Method AddLowercase, addr 0x171d2e0, size 0x13c, virtual false, abstract: false, final false
  inline void AddLowercase(::System::Globalization::CultureInfo* culture);

  /// @brief Method AddLowercaseRange, addr 0x171d41c, size 0x230, virtual false, abstract: false, final false
  inline void AddLowercaseRange(char16_t chMin, char16_t chMax, ::System::Globalization::CultureInfo* culture);

  /// @brief Method AddRange, addr 0x171c858, size 0x120, virtual false, abstract: false, final false
  inline void AddRange(char16_t first, char16_t last);

  /// @brief Method AddSet, addr 0x171cb94, size 0x22c, virtual false, abstract: false, final false
  inline void AddSet(::StringW set);

  /// @brief Method AddSpace, addr 0x171d740, size 0xf4, virtual false, abstract: false, final false
  inline void AddSpace(bool ecma, bool negate);

  /// @brief Method AddSubtraction, addr 0x171cdc0, size 0x8, virtual false, abstract: false, final false
  inline void AddSubtraction(::System::Text::RegularExpressions::RegexCharClass* sub);

  /// @brief Method AddWord, addr 0x171d64c, size 0xf4, virtual false, abstract: false, final false
  inline void AddWord(bool ecma, bool negate);

  /// @brief Method Canonicalize, addr 0x171e758, size 0x23c, virtual false, abstract: false, final false
  inline void Canonicalize();

  /// @brief Method CharInCategory, addr 0x171e084, size 0x188, virtual false, abstract: false, final false
  static inline bool CharInCategory(char16_t ch, ::StringW set, int32_t start, int32_t mySetLength, int32_t myCategoryLength);

  /// @brief Method CharInCategoryGroup, addr 0x171e20c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method CharInClass, addr 0x171dd64, size 0x68, virtual false, abstract: false, final false
  static inline bool CharInClass(char16_t ch, ::StringW set);

  /// @brief Method CharInClassInternal, addr 0x171df74, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method CharInClassRecursive, addr 0x171de4c, size 0x128, virtual false, abstract: false, final false
  static inline bool CharInClassRecursive(char16_t ch, ::StringW set, int32_t start);

  /// @brief Method GetRangeAt, addr 0x171cb34, size 0x60, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::__RegexCharClass__SingleRange GetRangeAt(int32_t i);

  /// @brief Method IsECMAWordChar, addr 0x171dcf8, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsECMAWordChar(char16_t ch);

  /// @brief Method IsEmpty, addr 0x171da1c, size 0xc0, virtual false, abstract: false, final false
  static inline bool IsEmpty(::StringW charClass);

  /// @brief Method IsMergeable, addr 0x171d900, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsMergeable(::StringW charClass);

  /// @brief Method IsNegated, addr 0x171d99c, size 0x28, virtual false, abstract: false, final false
  static inline bool IsNegated(::StringW set);

  /// @brief Method IsSingleton, addr 0x171dadc, size 0x10c, virtual false, abstract: false, final false
  static inline bool IsSingleton(::StringW set);

  /// @brief Method IsSingletonInverse, addr 0x171dbe8, size 0x110, virtual false, abstract: false, final false
  static inline bool IsSingletonInverse(::StringW set);

  /// @brief Method IsSubtraction, addr 0x171d9c4, size 0x58, virtual false, abstract: false, final false
  static inline bool IsSubtraction(::StringW charClass);

  /// @brief Method IsWordChar, addr 0x171ddcc, size 0x80, virtual false, abstract: false, final false
  static inline bool IsWordChar(char16_t ch);

  /// @brief Method NegateCategory, addr 0x171cfd8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x171e2dc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexCharClass* Parse(::StringW charClass);

  /// @brief Method ParseRecursive, addr 0x171e334, size 0x288, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexCharClass* ParseRecursive(::StringW charClass, int32_t start);

  /// @brief Method RangeCount, addr 0x171caec, size 0x48, virtual false, abstract: false, final false
  inline int32_t RangeCount();

  /// @brief Method SetFromProperty, addr 0x171d060, size 0x264, virtual false, abstract: false, final false
  static inline ::StringW SetFromProperty(::StringW capname, bool invert, ::StringW pattern);

  /// @brief Method SingletonChar, addr 0x171d8e8, size 0x18, virtual false, abstract: false, final false
  static inline char16_t SingletonChar(::StringW set);

  /// @brief Method ToStringClass, addr 0x171e5bc, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x171c71c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x171c7d8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanMerge, addr 0x171c824, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Negate, addr 0x171c844, size 0xc, virtual false, abstract: false, final false
