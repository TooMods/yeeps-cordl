...
public:
  ...
  /// @brief Method Clone, addr 0x1ce2664, size 0xd0, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  static inline ::System::Xml::Schema::XmlSchemaAttribute* New_ctor();

  /// @brief Method SetAttributeType, addr 0x1ce263c, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributeType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method SetQualifiedName, addr 0x1ce2634, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce2734, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AttDef, addr 0x1ce2644, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaAttDef* get_AttDef();

  /// @brief Method get_AttributeSchemaType, addr 0x1ce2614, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_AttributeSchemaType();

  /// @brief Method get_Datatype, addr 0x1ce261c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* get_Datatype();

  /// @brief Method get_DefaultValue, addr 0x1ce246c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DefaultValue();

  /// @brief Method get_FixedValue, addr 0x1ce247c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FixedValue();

  /// @brief Method get_Form, addr 0x1ce248c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_Name, addr 0x1ce249c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x1ce2654, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_QualifiedName, addr 0x1ce260c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_RefName, addr 0x1ce24ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_RefName();

  /// @brief Method get_SchemaType, addr 0x1ce25ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_SchemaType();

  /// @brief Method get_SchemaTypeName, addr 0x1ce254c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_SchemaTypeName();

  /// @brief Method get_Use, addr 0x1ce25fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaUse get_Use();

  /// @brief Method set_AttDef, addr 0x1ce264c, size 0x8, virtual false, abstract: false, final false
  inline void set_AttDef(::System::Xml::Schema::SchemaAttDef* value);

  /// @brief Method set_DefaultValue, addr 0x1ce2474, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValue(::StringW value);

  /// @brief Method set_FixedValue, addr 0x1ce2484, size 0x8, virtual false, abstract: false, final false
  inline void set_FixedValue(::StringW value);

  /// @brief Method set_Form, addr 0x1ce2494, size 0x8, virtual false, abstract: false, final false
  inline void set_Form(::System::Xml::Schema::XmlSchemaForm value);

  /// @brief Method set_Name, addr 0x1ce24a4, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x1ce265c, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_RefName, addr 0x1ce24b4, size 0x98, virtual false, abstract: false, final false
  inline void set_RefName(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_SchemaType, addr 0x1ce25f4, size 0x8, virtual false, abstract: false, final false
  inline void set_SchemaType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_SchemaTypeName, addr 0x1ce2554, size 0x98, virtual false, abstract: false, final false
  inline void set_SchemaTypeName(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_Use, addr 0x1ce2604, size 0x8, virtual false, abstract: false, final false
