...
public:
  ...
  /// @brief Method Add, addr 0x201253c, size 0xa8, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::GUILayoutEntry* e);

  /// @brief Method ApplyOptions, addr 0x2011fc8, size 0x124, virtual true, abstract: false, final false
  inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*, ::Array<::UnityEngine::GUILayoutOption*>*> options);

  /// @brief Method ApplyStyleSettings, addr 0x20120ec, size 0x78, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::UnityEngine::GUIStyle* style);

  /// @brief Method CalcHeight, addr 0x2013548, size 0x614, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x20125e4, size 0x688, virtual true, abstract: false, final false
  inline void CalcWidth();

  /// @brief Method GetNext, addr 0x201220c, size 0x330, virtual false, abstract: false, final false
  inline ::UnityEngine::GUILayoutEntry* GetNext();

  static inline ::UnityEngine::GUILayoutGroup* New_ctor();

  /// @brief Method ResetCursor, addr 0x2010180, size 0x8, virtual false, abstract: false, final false
  inline void ResetCursor();

  /// @brief Method SetHorizontal, addr 0x2012d8c, size 0x7bc, virtual true, abstract: false, final false
  inline void SetHorizontal(float_t x, float_t width);

  /// @brief Method SetVertical, addr 0x2013bd4, size 0x7cc, virtual true, abstract: false, final false
  inline void SetVertical(float_t y, float_t height);

  /// @brief Method ToString, addr 0x20143a0, size 0x424, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2011e20, size 0x118, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::GUILayoutEntry* getStaticF_none();

  /// @brief Method get_marginBottom, addr 0x2011e18, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginBottom();

  /// @brief Method get_marginLeft, addr 0x2011e00, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginLeft();

  /// @brief Method get_marginRight, addr 0x2011e08, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginRight();

  /// @brief Method get_marginTop, addr 0x2011e10, size 0x8, virtual true, abstract: false, final false
