...
public:
  ...
  /// @brief Method .ctor, addr 0x283ef94, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t order);

  /// @brief Method get_order, addr 0x283b3f4, size 0x8, virtual false, abstract: false, final false
