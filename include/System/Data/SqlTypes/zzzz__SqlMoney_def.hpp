...
public:
  ...
  /// @brief Method CompareTo, addr 0x1e3d3c4, size 0x138, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlMoney value);

  /// @brief Method CompareTo, addr 0x1e3d2dc, size 0xe8, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method Equals, addr 0x1e3d4fc, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x1e3d5d8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x1e3d858, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method GreaterThan, addr 0x1e3d174, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method LessThan, addr 0x1e3d0f0, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlBoolean LessThan(::System::Data::SqlTypes::SqlMoney x, ::System::Data::SqlTypes::SqlMoney y);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x1e3d5f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x1e3d5fc, size 0x14c, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x1e3d748, size 0x110, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToDecimal, addr 0x1e3517c, size 0x100, virtual false, abstract: false, final false
  inline ::System::Decimal ToDecimal();

  /// @brief Method ToDouble, addr 0x1e376bc, size 0x6c, virtual false, abstract: false, final false
  inline double_t ToDouble();

  /// @brief Method ToSqlDecimal, addr 0x1e3d254, size 0x88, virtual false, abstract: false, final false
  inline ::System::Data::SqlTypes::SqlDecimal ToSqlDecimal();

  /// @brief Method ToSqlDouble, addr 0x1e3d1f8, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Data::SqlTypes::SqlDouble ToSqlDouble();

  /// @brief Method ToString, addr 0x1e3c5cc, size 0xa4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1e3c22c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool fNull);

  /// @brief Method .ctor, addr 0x1e3c3c8, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::System::Decimal value);

  /// @brief Method .ctor, addr 0x1e3c248, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method .ctor, addr 0x1e3c2c4, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(int64_t value);

  /// @brief Method .ctor, addr 0x1e3c238, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsNull, addr 0x1e3516c, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Value, addr 0x1e3c4f8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x1e3c764, size 0x194, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlMoney op_Addition(::System::Data::SqlTypes::SqlMoney x, ::System::Data::SqlTypes::SqlMoney y);

  /// @brief Method op_Division, addr 0x1e3cb94, size 0x10c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlMoney op_Division(::System::Data::SqlTypes::SqlMoney x, ::System::Data::SqlTypes::SqlMoney y);

  /// @brief Method op_Equality, addr 0x1e3ceec, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x1e36040, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThan, addr 0x1e3d044, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e3cca0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e3cd34, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e3cdc8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e3ce58, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1e3c544, size 0x2c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlMoney op_Implicit___System__Data__SqlTypes__SqlMoney(::System::Decimal x);

  /// @brief Method op_Implicit, addr 0x1e3c570, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlMoney op_Implicit___System__Data__SqlTypes__SqlMoney(int64_t x);

  /// @brief Method op_LessThan, addr 0x1e3cf98, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Multiply, addr 0x1e3ca88, size 0x10c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlMoney op_Multiply(::System::Data::SqlTypes::SqlMoney x, ::System::Data::SqlTypes::SqlMoney y);

  /// @brief Method op_Subtraction, addr 0x1e3c8f8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method op_UnaryNegation, addr 0x1e3c670, size 0xf4, virtual false, abstract: false, final false
