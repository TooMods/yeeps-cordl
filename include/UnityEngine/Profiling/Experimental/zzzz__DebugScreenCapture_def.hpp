...
public:
  ...
  /// @brief Method set_height, addr 0x2a880a4, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_imageFormat, addr 0x2a88094, size 0x8, virtual false, abstract: false, final false
  inline void set_imageFormat(::UnityEngine::TextureFormat value);

  /// @brief Method set_rawImageDataReference, addr 0x2a8808c, size 0x8, virtual false, abstract: false, final false
  inline void set_rawImageDataReference(::Unity::Collections::NativeArray_1<uint8_t> value);

  /// @brief Method set_width, addr 0x2a8809c, size 0x8, virtual false, abstract: false, final false
