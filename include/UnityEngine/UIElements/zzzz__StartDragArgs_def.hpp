...
public:
  ...
  /// @brief Method .ctor, addr 0x27d9b78, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW title, ::System::Object* userData);

  /// @brief Method get_userData, addr 0x27d9c30, size 0x8, virtual false, abstract: false, final false
