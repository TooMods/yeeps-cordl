...
#include <cstdint>
CORDL_MODULE_EXPORT(CreateEventSourceMappingResponse)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::Lambda::Model::CreateEventSourceMappingResponse);
// Type: Amazon.Lambda.Model::CreateEventSourceMappingResponse
// SizeInfo { instance_size: 224, native_size: -1, calculated_instance_size: 224, calculated_native_size: 224, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::Amazon.Lambda.Model::CreateEventSourceMappingResponse*
class CORDL_TYPE CreateEventSourceMappingResponse : public ::Amazon::Runtime::AmazonWebServiceResponse {
public:
  // Declarations
  ...
  /// @brief Method IsSetBatchSize, addr 0x2bc57a8, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetBatchSize();

  /// @brief Method IsSetBisectBatchOnFunctionError, addr 0x2bc5888, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetBisectBatchOnFunctionError();

  /// @brief Method IsSetDestinationConfig, addr 0x2bc58d4, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetDestinationConfig();

  /// @brief Method IsSetEventSourceArn, addr 0x2bc58f4, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetEventSourceArn();

  /// @brief Method IsSetFunctionArn, addr 0x2bc5914, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetFunctionArn();

  /// @brief Method IsSetFunctionResponseTypes, addr 0x2bc5934, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetFunctionResponseTypes();

  /// @brief Method IsSetLastModified, addr 0x2bc5a34, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetLastModified();

  /// @brief Method IsSetLastProcessingResult, addr 0x2bc5a80, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetLastProcessingResult();

  /// @brief Method IsSetMaximumBatchingWindowInSeconds, addr 0x2bc5b34, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaximumBatchingWindowInSeconds();

  /// @brief Method IsSetMaximumRecordAgeInSeconds, addr 0x2bc5c14, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaximumRecordAgeInSeconds();

  /// @brief Method IsSetMaximumRetryAttempts, addr 0x2bc5cf4, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaximumRetryAttempts();

  /// @brief Method IsSetParallelizationFactor, addr 0x2bc5dd4, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetParallelizationFactor();

  /// @brief Method IsSetQueues, addr 0x2bc5e20, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetQueues();

  /// @brief Method IsSetSelfManagedEventSource, addr 0x2bc5e84, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetSelfManagedEventSource();

  /// @brief Method IsSetSourceAccessConfigurations, addr 0x2bc5ea4, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetSourceAccessConfigurations();

  /// @brief Method IsSetStartingPosition, addr 0x2bc5f08, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetStartingPosition();

  /// @brief Method IsSetStartingPositionTimestamp, addr 0x2bc6014, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetStartingPositionTimestamp();

  /// @brief Method IsSetState, addr 0x2bc6060, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetState();

  /// @brief Method IsSetStateTransitionReason, addr 0x2bc6080, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetStateTransitionReason();

  /// @brief Method IsSetTopics, addr 0x2bc60a0, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetTopics();

  /// @brief Method IsSetTumblingWindowInSeconds, addr 0x2bc6198, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetTumblingWindowInSeconds();

  /// @brief Method IsSetUUID, addr 0x2bc61e4, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetUUID();

  static inline ::Amazon::Lambda::Model::CreateEventSourceMappingResponse* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x2bc61f4, size 0x100, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BatchSize, addr 0x2bc5704, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_BatchSize();

  /// @brief Method get_BisectBatchOnFunctionError, addr 0x2bc57e4, size 0x3c, virtual false, abstract: false, final false
  inline bool get_BisectBatchOnFunctionError();

  /// @brief Method get_DestinationConfig, addr 0x2bc58c4, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::DestinationConfig* get_DestinationConfig();

  /// @brief Method get_EventSourceArn, addr 0x2bc58e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EventSourceArn();

  /// @brief Method get_FunctionArn, addr 0x2bc5904, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FunctionArn();

  /// @brief Method get_FunctionResponseTypes, addr 0x2bc5924, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_FunctionResponseTypes();

  /// @brief Method get_LastModified, addr 0x2bc5988, size 0x3c, virtual false, abstract: false, final false
  inline ::System::DateTime get_LastModified();

  /// @brief Method get_LastProcessingResult, addr 0x2bc5a70, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LastProcessingResult();

  /// @brief Method get_MaximumBatchingWindowInSeconds, addr 0x2bc5a90, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaximumBatchingWindowInSeconds();

  /// @brief Method get_MaximumRecordAgeInSeconds, addr 0x2bc5b70, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaximumRecordAgeInSeconds();

  /// @brief Method get_MaximumRetryAttempts, addr 0x2bc5c50, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaximumRetryAttempts();

  /// @brief Method get_ParallelizationFactor, addr 0x2bc5d30, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_ParallelizationFactor();

  /// @brief Method get_Queues, addr 0x2bc5e10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Queues();

  /// @brief Method get_SelfManagedEventSource, addr 0x2bc5e74, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::SelfManagedEventSource* get_SelfManagedEventSource();

  /// @brief Method get_SourceAccessConfigurations, addr 0x2bc5e94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::Lambda::Model::SourceAccessConfiguration*>* get_SourceAccessConfigurations();

  /// @brief Method get_StartingPosition, addr 0x2bc5ef8, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::EventSourcePosition* get_StartingPosition();

  /// @brief Method get_StartingPositionTimestamp, addr 0x2bc5f68, size 0x3c, virtual false, abstract: false, final false
  inline ::System::DateTime get_StartingPositionTimestamp();

  /// @brief Method get_State, addr 0x2bc6050, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_State();

  /// @brief Method get_StateTransitionReason, addr 0x2bc6070, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_StateTransitionReason();

  /// @brief Method get_Topics, addr 0x2bc6090, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Topics();

  /// @brief Method get_TumblingWindowInSeconds, addr 0x2bc60f4, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_TumblingWindowInSeconds();

  /// @brief Method get_UUID, addr 0x2bc61d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_UUID();

  /// @brief Method set_BatchSize, addr 0x2bc5740, size 0x68, virtual false, abstract: false, final false
  inline void set_BatchSize(int32_t value);

  /// @brief Method set_BisectBatchOnFunctionError, addr 0x2bc5820, size 0x68, virtual false, abstract: false, final false
  inline void set_BisectBatchOnFunctionError(bool value);

  /// @brief Method set_DestinationConfig, addr 0x2bc58cc, size 0x8, virtual false, abstract: false, final false
  inline void set_DestinationConfig(::Amazon::Lambda::Model::DestinationConfig* value);

  /// @brief Method set_EventSourceArn, addr 0x2bc58ec, size 0x8, virtual false, abstract: false, final false
  inline void set_EventSourceArn(::StringW value);

  /// @brief Method set_FunctionArn, addr 0x2bc590c, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionArn(::StringW value);

  /// @brief Method set_FunctionResponseTypes, addr 0x2bc592c, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionResponseTypes(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_LastModified, addr 0x2bc59c4, size 0x70, virtual false, abstract: false, final false
  inline void set_LastModified(::System::DateTime value);

  /// @brief Method set_LastProcessingResult, addr 0x2bc5a78, size 0x8, virtual false, abstract: false, final false
  inline void set_LastProcessingResult(::StringW value);

  /// @brief Method set_MaximumBatchingWindowInSeconds, addr 0x2bc5acc, size 0x68, virtual false, abstract: false, final false
  inline void set_MaximumBatchingWindowInSeconds(int32_t value);

  /// @brief Method set_MaximumRecordAgeInSeconds, addr 0x2bc5bac, size 0x68, virtual false, abstract: false, final false
  inline void set_MaximumRecordAgeInSeconds(int32_t value);

  /// @brief Method set_MaximumRetryAttempts, addr 0x2bc5c8c, size 0x68, virtual false, abstract: false, final false
  inline void set_MaximumRetryAttempts(int32_t value);

  /// @brief Method set_ParallelizationFactor, addr 0x2bc5d6c, size 0x68, virtual false, abstract: false, final false
  inline void set_ParallelizationFactor(int32_t value);

  /// @brief Method set_Queues, addr 0x2bc5e18, size 0x8, virtual false, abstract: false, final false
  inline void set_Queues(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_SelfManagedEventSource, addr 0x2bc5e7c, size 0x8, virtual false, abstract: false, final false
  inline void set_SelfManagedEventSource(::Amazon::Lambda::Model::SelfManagedEventSource* value);

  /// @brief Method set_SourceAccessConfigurations, addr 0x2bc5e9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_StartingPosition, addr 0x2bc5f00, size 0x8, virtual false, abstract: false, final false
  inline void set_StartingPosition(::Amazon::Lambda::EventSourcePosition* value);

  /// @brief Method set_StartingPositionTimestamp, addr 0x2bc5fa4, size 0x70, virtual false, abstract: false, final false
  inline void set_StartingPositionTimestamp(::System::DateTime value);

  /// @brief Method set_State, addr 0x2bc6058, size 0x8, virtual false, abstract: false, final false
  inline void set_State(::StringW value);

  /// @brief Method set_StateTransitionReason, addr 0x2bc6078, size 0x8, virtual false, abstract: false, final false
  inline void set_StateTransitionReason(::StringW value);

  /// @brief Method set_Topics, addr 0x2bc6098, size 0x8, virtual false, abstract: false, final false
  inline void set_Topics(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_TumblingWindowInSeconds, addr 0x2bc6130, size 0x68, virtual false, abstract: false, final false
  inline void set_TumblingWindowInSeconds(int32_t value);

  /// @brief Method set_UUID, addr 0x2bc61dc, size 0x8, virtual false, abstract: false, final false
  inline void set_UUID(::StringW value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr CreateEventSourceMappingResponse();

public:
  // Ctor Parameters [CppParam { name: "", ty: "CreateEventSourceMappingResponse", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CreateEventSourceMappingResponse(CreateEventSourceMappingResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CreateEventSourceMappingResponse", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CreateEventSourceMappingResponse(CreateEventSourceMappingResponse const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::CreateEventSourceMappingResponse, 0xe0>, "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____batchSize) == 0x24, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____bisectBatchOnFunctionError) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____destinationConfig) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____eventSourceArn) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____functionArn) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____functionResponseTypes) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____lastModified) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____lastProcessingResult) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____maximumBatchingWindowInSeconds) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____maximumRecordAgeInSeconds) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____maximumRetryAttempts) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____parallelizationFactor) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____queues) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____selfManagedEventSource) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____sourceAccessConfigurations) == 0x98, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____startingPosition) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____startingPositionTimestamp) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____state) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____stateTransitionReason) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____topics) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____tumblingWindowInSeconds) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::CreateEventSourceMappingResponse, ____uuid) == 0xd8, "Offset mismatch!");

} // namespace Amazon::Lambda::Model
NEED_NO_BOX(::Amazon::Lambda::Model::CreateEventSourceMappingResponse);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::CreateEventSourceMappingResponse*, "Amazon.Lambda.Model", "CreateEventSourceMappingResponse");
