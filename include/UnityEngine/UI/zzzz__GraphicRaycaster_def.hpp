...
public:
  ...
  /// @brief Method <Raycast>b__27_0, addr 0x20065fc, size 0x4c, virtual false, abstract: false, final false
  inline int32_t _Raycast_b__27_0(::UnityEngine::UI::Graphic* g1, ::UnityEngine::UI::Graphic* g2);

  /// @brief Method .ctor, addr 0x20065f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Raycast, addr 0x2005ecc, size 0x570, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x200518c, size 0xc84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x20050f8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UI::Graphic>>* getStaticF_s_SortedGraphics();

  /// @brief Method get_blockingMask, addr 0x20050e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_blockingMask();

  /// @brief Method get_blockingObjects, addr 0x20050d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::__GraphicRaycaster__BlockingObjects get_blockingObjects();

  /// @brief Method get_canvas, addr 0x2004fdc, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_canvas();

  /// @brief Method get_eventCamera, addr 0x200643c, size 0xc8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_ignoreReversedGraphics, addr 0x20050c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreReversedGraphics();

  /// @brief Method get_renderOrderPriority, addr 0x2005070, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_renderOrderPriority();

  /// @brief Method get_sortOrderPriority, addr 0x2004f94, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_blockingMask, addr 0x20050f0, size 0x8, virtual false, abstract: false, final false
  inline void set_blockingMask(::UnityEngine::LayerMask value);

  /// @brief Method set_blockingObjects, addr 0x20050e0, size 0x8, virtual false, abstract: false, final false
  inline void set_blockingObjects(::UnityEngine::UI::__GraphicRaycaster__BlockingObjects value);

  /// @brief Method set_ignoreReversedGraphics, addr 0x20050cc, size 0xc, virtual false, abstract: false, final false
