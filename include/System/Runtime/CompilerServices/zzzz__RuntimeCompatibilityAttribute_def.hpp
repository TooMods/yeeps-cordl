...
public:
  ...
  /// @brief Method .ctor, addr 0x1b446bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_WrapNonExceptionThrows, addr 0x1b446c4, size 0xc, virtual false, abstract: false, final false
