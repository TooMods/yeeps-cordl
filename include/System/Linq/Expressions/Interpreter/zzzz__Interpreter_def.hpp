...
public:
  ...
  /// @brief Method Run, addr 0x1a960d8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1a95fe0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ClosureSize, addr 0x1a96064, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_ClosureSize();

  /// @brief Method get_ClosureVariables, addr 0x1a960d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Instructions, addr 0x1a960bc, size 0x14, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::InstructionArray get_Instructions();

  /// @brief Method get_LocalCount, addr 0x1a9605c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LocalCount();

  /// @brief Method get_Name, addr 0x1a96054, size 0x8, virtual false, abstract: false, final false
