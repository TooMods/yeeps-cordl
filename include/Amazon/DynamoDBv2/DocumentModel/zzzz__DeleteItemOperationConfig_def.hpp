...
CORDL_MODULE_EXPORT(DeleteItemOperationConfig)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig);
// Type: Amazon.DynamoDBv2.DocumentModel::DeleteItemOperationConfig
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 44, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::DynamoDBv2::DocumentModel {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.DocumentModel::DeleteItemOperationConfig*
class CORDL_TYPE DeleteItemOperationConfig : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x141f140, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConditionalExpression, addr 0x141f45c, size 0x8, virtual true, abstract: false, final true
  inline ::Amazon::DynamoDBv2::DocumentModel::Expression* get_ConditionalExpression();

  /// @brief Method get_Expected, addr 0x141f47c, size 0x8, virtual true, abstract: false, final true
  inline ::Amazon::DynamoDBv2::DocumentModel::Document* get_Expected();

  /// @brief Method get_ExpectedState, addr 0x141f46c, size 0x8, virtual true, abstract: false, final true
  inline ::Amazon::DynamoDBv2::DocumentModel::ExpectedState* get_ExpectedState();

  /// @brief Method get_ReturnValues, addr 0x141f48c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ConditionalExpression, addr 0x141f464, size 0x8, virtual true, abstract: false, final true
  inline void set_ConditionalExpression(::Amazon::DynamoDBv2::DocumentModel::Expression* value);

  /// @brief Method set_Expected, addr 0x141f484, size 0x8, virtual true, abstract: false, final true
  inline void set_Expected(::Amazon::DynamoDBv2::DocumentModel::Document* value);

  /// @brief Method set_ExpectedState, addr 0x141f474, size 0x8, virtual true, abstract: false, final true
  inline void set_ExpectedState(::Amazon::DynamoDBv2::DocumentModel::ExpectedState* value);

  /// @brief Method set_ReturnValues, addr 0x141f494, size 0x8, virtual false, abstract: false, final false
  inline void set_ReturnValues(::Amazon::DynamoDBv2::DocumentModel::ReturnValues value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr DeleteItemOperationConfig();

public:
  // Ctor Parameters [CppParam { name: "", ty: "DeleteItemOperationConfig", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeleteItemOperationConfig(DeleteItemOperationConfig&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeleteItemOperationConfig", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeleteItemOperationConfig(DeleteItemOperationConfig const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig, 0x30>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig, ____ConditionalExpression_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig, ____ExpectedState_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig, ____Expected_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig, ____ReturnValues_k__BackingField) == 0x28, "Offset mismatch!");

} // namespace Amazon::DynamoDBv2::DocumentModel
NEED_NO_BOX(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::DynamoDBv2::DocumentModel::DeleteItemOperationConfig*, "Amazon.DynamoDBv2.DocumentModel", "DeleteItemOperationConfig");
