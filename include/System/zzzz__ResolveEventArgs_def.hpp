...
public:
  ...
  /// @brief Method .ctor, addr 0x2eff6bc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x2eff728, size 0x70, virtual false, abstract: false, final false
