...
public:
  ...
  /// @brief Method .ctor, addr 0x25c45f8, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x25c4334, size 0x1b8, virtual false, abstract: false, final false
  inline ::StringW Add(::StringW key);

  /// @brief Method AddEntry, addr 0x25c44ec, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW AddEntry(::StringW str, int32_t hashCode);

  /// @brief Method Get, addr 0x25c40fc, size 0x188, virtual true, abstract: false, final false
  inline ::StringW Get(::ArrayW<char16_t, ::Array<char16_t>*> key, int32_t start, int32_t length);

  /// @brief Method Grow, addr 0x25c4638, size 0x124, virtual false, abstract: false, final false
  inline void Grow();

  static inline ::Newtonsoft::Json::DefaultJsonNameTable* New_ctor();

  /// @brief Method TextEquals, addr 0x25c4284, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c408c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
