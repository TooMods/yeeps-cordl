...
public:
  ...
  /// @brief Method .ctor, addr 0x2f57664, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XProcessingInstruction* processingInstruction);

  /// @brief Method get_LocalName, addr 0x2f581ac, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_ProcessingInstruction, addr 0x2f58134, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XProcessingInstruction* get_ProcessingInstruction();

  /// @brief Method get_Value, addr 0x2f581c8, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x2f581e4, size 0x24, virtual true, abstract: false, final false
