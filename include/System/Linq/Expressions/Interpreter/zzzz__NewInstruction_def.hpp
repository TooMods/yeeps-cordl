...
public:
  ...
  /// @brief Method GetArgs, addr 0x1b5788c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x1b5773c, size 0x150, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x1b579f8, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b576bc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::ConstructorInfo* constructor, int32_t argumentCount);

  /// @brief Method get_ConsumedStack, addr 0x1b576ec, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x1b576fc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1b576f4, size 0x8, virtual true, abstract: false, final false
