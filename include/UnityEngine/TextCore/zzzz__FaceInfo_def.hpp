...
public:
  ...
  __declspec(property(get = get_pointSize)) int32_t pointSize;
  ...
  /// @brief Method get_ascentLine, addr 0x29027e8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_ascentLine();

  /// @brief Method get_baseline, addr 0x2902810, size 0x8, virtual false, abstract: false, final false
  inline float_t get_baseline();

  /// @brief Method get_capLine, addr 0x29027f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_capLine();

  /// @brief Method get_descentLine, addr 0x2902818, size 0x8, virtual false, abstract: false, final false
  inline float_t get_descentLine();

  /// @brief Method get_faceIndex, addr 0x29027b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_faceIndex();

  /// @brief Method get_familyName, addr 0x29027b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_familyName();

  /// @brief Method get_lineHeight, addr 0x29027e0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lineHeight();

  /// @brief Method get_meanLine, addr 0x2902800, size 0x8, virtual false, abstract: false, final false
  inline float_t get_meanLine();

  /// @brief Method get_pointSize, addr 0x29027c8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_pointSize();

  /// @brief Method get_scale, addr 0x29027d0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scale();

  /// @brief Method get_strikethroughOffset, addr 0x2902850, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strikethroughOffset();

  /// @brief Method get_styleName, addr 0x29027c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_styleName();

  /// @brief Method get_subscriptOffset, addr 0x2902830, size 0x8, virtual false, abstract: false, final false
  inline float_t get_subscriptOffset();

  /// @brief Method get_subscriptSize, addr 0x2902838, size 0x8, virtual false, abstract: false, final false
  inline float_t get_subscriptSize();

  /// @brief Method get_superscriptOffset, addr 0x2902820, size 0x8, virtual false, abstract: false, final false
  inline float_t get_superscriptOffset();

  /// @brief Method get_superscriptSize, addr 0x2902828, size 0x8, virtual false, abstract: false, final false
  inline float_t get_superscriptSize();

  /// @brief Method get_tabWidth, addr 0x2902860, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tabWidth();

  /// @brief Method get_underlineOffset, addr 0x2902840, size 0x8, virtual false, abstract: false, final false
  inline float_t get_underlineOffset();

  /// @brief Method get_underlineThickness, addr 0x2902848, size 0x8, virtual false, abstract: false, final false
  inline float_t get_underlineThickness();

  /// @brief Method set_capLine, addr 0x29027f8, size 0x8, virtual false, abstract: false, final false
  inline void set_capLine(float_t value);

  /// @brief Method set_meanLine, addr 0x2902808, size 0x8, virtual false, abstract: false, final false
  inline void set_meanLine(float_t value);

  /// @brief Method set_scale, addr 0x29027d8, size 0x8, virtual false, abstract: false, final false
  inline void set_scale(float_t value);

  /// @brief Method set_strikethroughOffset, addr 0x2902858, size 0x8, virtual false, abstract: false, final false
