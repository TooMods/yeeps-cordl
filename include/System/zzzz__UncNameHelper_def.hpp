...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x1715318, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCanonicalName, addr 0x1715314, size 0x4, virtual false, abstract: false, final false
