...
public:
  ...
  /// @brief Method .ctor, addr 0x1ab71f4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW fullTypeName, ::StringW assemblyString, bool hasTypeForwardedFrom);

  /// @brief Method get_AssemblyString, addr 0x1abaf98, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AssemblyString();

  /// @brief Method get_FullTypeName, addr 0x1abaf90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FullTypeName();

  /// @brief Method get_HasTypeForwardedFrom, addr 0x1abafa0, size 0x8, virtual false, abstract: false, final false
