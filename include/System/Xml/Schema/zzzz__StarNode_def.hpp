...
public:
  ...
  /// @brief Method ConstructPos, addr 0x30523d0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3052474, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x305246c, size 0x8, virtual true, abstract: false, final false
