...
public:
  ...
  /// @brief Method GetBinding, addr 0x2dedacc, size 0x1fc, virtual false, abstract: false, final false
  static inline ::System::Net::Cache::RequestCacheBinding* GetBinding(::StringW internedScheme);

  /// @brief Method LoadConfigSettings, addr 0x2dedcc8, size 0x184, virtual false, abstract: false, final false
