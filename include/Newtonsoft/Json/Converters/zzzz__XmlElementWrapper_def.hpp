...
public:
  ...
  /// @brief Method GetPrefixOfNamespace, addr 0x2f55af8, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method SetAttributeNode, addr 0x2f55a10, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f55738, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlElement* element);

  /// @brief Method get_IsEmpty, addr 0x2f55b1c, size 0x1c, virtual true, abstract: false, final true
