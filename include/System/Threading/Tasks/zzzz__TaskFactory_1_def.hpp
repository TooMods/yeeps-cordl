...
namespace System::Threading::Tasks {
template <typename TResult> class __TaskFactory_1____c__DisplayClass32_0;
}
namespace System::Threading::Tasks {
...
MARK_GEN_REF_PTR_T(::System::Threading::Tasks::__TaskFactory_1____c__DisplayClass32_0);
...
// Is value type: false
// CS Name: ::TaskFactory`1::<>c__DisplayClass32_0<TResult>*
class CORDL_TYPE __TaskFactory_1____c__DisplayClass32_0 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::System::Threading::Tasks::__TaskFactory_1____c__DisplayClass32_0<TResult>* New_ctor();
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::TaskScheduler*> const& __cordl_internal_get_scheduler() const;

  constexpr ::System::Threading::Tasks::Task*& __cordl_internal_get_t();

  constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task*> const& __cordl_internal_get_t() const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __TaskFactory_1____c__DisplayClass32_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__TaskFactory_1____c__DisplayClass32_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __TaskFactory_1____c__DisplayClass32_0(__TaskFactory_1____c__DisplayClass32_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__TaskFactory_1____c__DisplayClass32_0", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __TaskFactory_1____c__DisplayClass32_0(__TaskFactory_1____c__DisplayClass32_0 const&) = delete;
...
public:
  ...
  using __c__DisplayClass32_0 = ::System::Threading::Tasks::__TaskFactory_1____c__DisplayClass32_0<TResult>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Threading::Tasks::__TaskFactory_1____c__DisplayClass32_0, "System.Threading.Tasks", "TaskFactory`1/<>c__DisplayClass32_0");
