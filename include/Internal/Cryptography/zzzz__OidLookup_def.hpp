...
public:
  ...
  /// @brief Method <.cctor>b__10_0, addr 0x2431558, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__10_0(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method <.cctor>b__10_1, addr 0x2431594, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__10_1(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method .ctor, addr 0x2431550, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method NativeFriendlyNameToOid, addr 0x242f4e8, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method NativeOidToFriendlyName, addr 0x242effc, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUseCache, addr 0x242eff4, size 0x8, virtual false, abstract: false, final false
  static inline bool ShouldUseCache(::System::Security::Cryptography::OidGroup oidGroup);

  /// @brief Method ToFriendlyName, addr 0x242ee14, size 0x1e0, virtual false, abstract: false, final false
  static inline ::StringW ToFriendlyName(::StringW oid, ::System::Security::Cryptography::OidGroup oidGroup, bool fallBackToAllGroups);

  /// @brief Method ToOid, addr 0x242f334, size 0x1b4, virtual false, abstract: false, final false
