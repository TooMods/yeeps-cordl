...
public:
  ...
  /// @brief Method ExecuteDefaultAction, addr 0x2ce1854, size 0x158, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x2ce1850, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ce1790, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_editorEngine, addr 0x2ce1770, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextEditorEngine* get_editorEngine();

  /// @brief Method get_textInputField, addr 0x2ce1780, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITextInputField* get_textInputField();

  /// @brief Method set_editorEngine, addr 0x2ce1778, size 0x8, virtual false, abstract: false, final false
  inline void set_editorEngine(::UnityEngine::UIElements::TextEditorEngine* value);

  /// @brief Method set_textInputField, addr 0x2ce1788, size 0x8, virtual false, abstract: false, final false
