...
public:
  // Declarations
  /// @brief Method GetApplicationVersion, addr 0x19b2a14, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion();

  /// @brief Method GetDataFromMessage, addr 0x19b2a50, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0784, size 0x58, virtual false, abstract: false, final false
