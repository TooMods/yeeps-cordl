...
public:
  ...
  /// @brief Method .ctor, addr 0x18b4a44, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Choice, addr 0x18b4a3c, size 0x8, virtual false, abstract: false, final false
