...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c72520, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c72448, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::MagneticFieldSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c7249c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c72598, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::MagneticFieldSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x1c723b4, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::MagneticFieldSensor* get_current();

  /// @brief Method get_magneticField, addr 0x1c723a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x1c723fc, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::MagneticFieldSensor* value);

  /// @brief Method set_magneticField, addr 0x1c723ac, size 0x8, virtual false, abstract: false, final false
