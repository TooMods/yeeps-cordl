...
public:
  ...
  /// @brief Method Reset, addr 0x303905c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x30390a8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAllIndices, addr 0x3038f84, size 0xd8, virtual false, abstract: false, final false
  inline void SetAllIndices(::ArrayW<uint16_t, ::Array<uint16_t>*> indices);

  /// @brief Method SetAllVertices, addr 0x3038eac, size 0xd8, virtual false, abstract: false, final false
  inline void SetAllVertices(::ArrayW<::UnityEngine::UIElements::Vertex, ::Array<::UnityEngine::UIElements::Vertex>*> vertices);

  /// @brief Method SetNextIndex, addr 0x3038e48, size 0x64, virtual false, abstract: false, final false
  inline void SetNextIndex(uint16_t index);

  /// @brief Method SetNextVertex, addr 0x3038dac, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3038d08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_indexCount, addr 0x3038d58, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_indexCount();

  /// @brief Method get_uvRegion, addr 0x3038da0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_uvRegion();

  /// @brief Method get_vertexCount, addr 0x3038d10, size 0x48, virtual false, abstract: false, final false
