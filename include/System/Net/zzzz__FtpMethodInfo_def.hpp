...
public:
  ...
  /// @brief Method GetMethodInfo, addr 0x123df94, size 0x164, virtual false, abstract: false, final false
  static inline ::System::Net::FtpMethodInfo* GetMethodInfo(::StringW method);

  /// @brief Method HasFlag, addr 0x123bbbc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x123df50, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCommandOnly, addr 0x123bd60, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCommandOnly();

  /// @brief Method get_IsDownload, addr 0x123cb70, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsDownload();

  /// @brief Method get_IsUpload, addr 0x123cb64, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsUpload();

  /// @brief Method get_ShouldParseForResponseUri, addr 0x123a424, size 0xc, virtual false, abstract: false, final false
