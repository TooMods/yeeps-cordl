...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4d50, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetDataFromMessage(void* c_message);

  /// @brief Method GetParty, addr 0x19b4d14, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetParty();

  static inline ::Oculus::Platform::MessageWithParty* New_ctor(void* c_message);

  /// @brief Method .ctor, addr 0x19b4cbc, size 0x58, virtual false, abstract: false, final false
