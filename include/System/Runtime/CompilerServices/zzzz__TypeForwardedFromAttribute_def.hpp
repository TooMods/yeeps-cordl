...
public:
  ...
  /// @brief Method .ctor, addr 0x1b44a0c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyFullName);

  /// @brief Method get_AssemblyFullName, addr 0x1b44a90, size 0x8, virtual false, abstract: false, final false
