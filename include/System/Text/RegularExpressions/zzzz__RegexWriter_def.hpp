...
public:
  // Declarations
  /// @brief Method Dispose, addr 0x1682d50, size 0x54, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Emit, addr 0x1683964, size 0xe4, virtual false, abstract: false, final false
  inline void Emit(int32_t op);

  /// @brief Method Emit, addr 0x1682da4, size 0x14c, virtual false, abstract: false, final false
  inline void Emit(int32_t op, int32_t opd1);

  /// @brief Method Emit, addr 0x1683a48, size 0x1ac, virtual false, abstract: false, final false
  inline void Emit(int32_t op, int32_t opd1, int32_t opd2);

  /// @brief Method EmitFragment, addr 0x1682ef0, size 0xa10, virtual false, abstract: false, final false
  inline void EmitFragment(int32_t nodetype, ::System::Text::RegularExpressions::RegexNode* node, int32_t curIndex);

  /// @brief Method MapCapnum, addr 0x1683d40, size 0x15f78, virtual false, abstract: false, final false
  inline int32_t MapCapnum(int32_t capnum);

  /// @brief Method PatchJump, addr 0x1683900, size 0x64, virtual false, abstract: false, final false
  inline void PatchJump(int32_t offset, int32_t jumpDest);

  /// @brief Method RegexCodeFromRegexTree, addr 0x16828f0, size 0x460, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexCode* RegexCodeFromRegexTree(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method StringCode, addr 0x1683bf4, size 0x14c, virtual false, abstract: false, final false
  inline int32_t StringCode(::StringW str);

  /// @brief Method Write, addr 0x16827ec, size 0x104, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexCode* Write(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method .ctor, addr 0x16826a4, size 0x148, virtual false, abstract: false, final false
