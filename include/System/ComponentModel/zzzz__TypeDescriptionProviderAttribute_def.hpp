...
public:
  ...
  static inline ::System::ComponentModel::TypeDescriptionProviderAttribute* New_ctor(::System::Type* type);
  ...
  /// @brief Method .ctor, addr 0x1b0e750, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x1b0e6d8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName);

  /// @brief Method get_TypeName, addr 0x1b0e838, size 0x8, virtual false, abstract: false, final false
