...
public:
  ...
  /// @brief Method Finalize, addr 0x1990dbc, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::AvatarEditorOptions* New_ctor();

  /// @brief Method SetSourceOverride, addr 0x1990c5c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1990b90, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x1990d64, size 0x58, virtual false, abstract: false, final false
