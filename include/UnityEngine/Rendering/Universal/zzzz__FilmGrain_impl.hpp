...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::Universal::FilmGrain::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2726b00;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::Universal::FilmGrain::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2726bcc;
...
constexpr UnityEngine::Rendering::Universal::FilmGrain::operator ::UnityEngine::Rendering::Universal::IPostProcessComponent*() noexcept {
...
constexpr ::UnityEngine::Rendering::Universal::IPostProcessComponent* UnityEngine::Rendering::Universal::FilmGrain::i___UnityEngine__Rendering__Universal__IPostProcessComponent() noexcept {
  return static_cast<::UnityEngine::Rendering::Universal::IPostProcessComponent*>(static_cast<void*>(this));
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::Universal::FilmGrainLookupParameter*> const& UnityEngine::Rendering::Universal::FilmGrain::__cordl_internal_get_type() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___type;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ClampedFloatParameter*> const& UnityEngine::Rendering::Universal::FilmGrain::__cordl_internal_get_intensity() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___intensity;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::ClampedFloatParameter*> const& UnityEngine::Rendering::Universal::FilmGrain::__cordl_internal_get_response() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___response;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::NoInterpTextureParameter*> const& UnityEngine::Rendering::Universal::FilmGrain::__cordl_internal_get_texture() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___texture;
}
