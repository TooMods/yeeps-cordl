...
public:
  // Declarations
  /// @brief Method GetEndOfFile, addr 0x25745dc, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Exception* GetEndOfFile();

  /// @brief Method GetReadNotSupported, addr 0x257465c, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Exception* GetReadNotSupported();

  /// @brief Method GetStreamIsClosed, addr 0x2574564, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Exception* GetStreamIsClosed();

  /// @brief Method GetWriteNotSupported, addr 0x25746d0, size 0x74, virtual false, abstract: false, final false
