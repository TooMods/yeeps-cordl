...
public:
  ...
  /// @brief Method get_parentBoneIndex, addr 0x1d3b420, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_parentBoneIndex();

  /// @brief Method get_position, addr 0x1d3b430, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_rotation, addr 0x1d3b448, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method set_parentBoneIndex, addr 0x1d3b428, size 0x8, virtual false, abstract: false, final false
  inline void set_parentBoneIndex(uint32_t value);

  /// @brief Method set_position, addr 0x1d3b43c, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method set_rotation, addr 0x1d3b454, size 0xc, virtual false, abstract: false, final false
