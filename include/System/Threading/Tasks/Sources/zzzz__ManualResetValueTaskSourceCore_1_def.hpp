...
namespace System::Threading::Tasks::Sources {
template <typename TResult> class __ManualResetValueTaskSourceCore_1____c;
}
...
// Write type traits
MARK_GEN_REF_PTR_T(::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c);
...
// Is value type: false
// CS Name: ::ManualResetValueTaskSourceCore`1::<>c<TResult>*
class CORDL_TYPE __ManualResetValueTaskSourceCore_1____c : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>9, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF___9, put = setStaticF___9))::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c<TResult>* __9;

  /// @brief Field <>9__19_0, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF___9__19_0, put = setStaticF___9__19_0))::System::Threading::SendOrPostCallback* __9__19_0;

  /// @brief Field <>9__21_0, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF___9__21_0, put = setStaticF___9__21_0))::System::Threading::ContextCallback* __9__21_0;

  /// @brief Field <>9__22_0, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF___9__22_0, put = setStaticF___9__22_0))::System::Threading::SendOrPostCallback* __9__22_0;

  static inline ::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c<TResult>* New_ctor();
  ...
  inline void _SignalCompletion_b__21_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c<TResult>* getStaticF___9();

  static inline ::System::Threading::SendOrPostCallback* getStaticF___9__19_0();

  static inline ::System::Threading::ContextCallback* getStaticF___9__21_0();

  static inline ::System::Threading::SendOrPostCallback* getStaticF___9__22_0();

  static inline void setStaticF___9(::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c<TResult>* value);

  static inline void setStaticF___9__19_0(::System::Threading::SendOrPostCallback* value);

  static inline void setStaticF___9__21_0(::System::Threading::ContextCallback* value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __ManualResetValueTaskSourceCore_1____c();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__ManualResetValueTaskSourceCore_1____c", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __ManualResetValueTaskSourceCore_1____c(__ManualResetValueTaskSourceCore_1____c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__ManualResetValueTaskSourceCore_1____c", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __ManualResetValueTaskSourceCore_1____c(__ManualResetValueTaskSourceCore_1____c const&) = delete;
...
// SizeInfo { instance_size: 64, native_size: 75, calculated_instance_size: 64, calculated_native_size: 75, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace System::Threading::Tasks::Sources {
// cpp template
template <typename TResult>
// Is value type: true
...
public:
  // Declarations
  using __c = ::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c<TResult>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Threading::Tasks::Sources::__ManualResetValueTaskSourceCore_1____c, "System.Threading.Tasks.Sources", "ManualResetValueTaskSourceCore`1/<>c");
