...
public:
  ...
  /// @brief Method AddAttDef, addr 0x1cacaa4, size 0x154, virtual false, abstract: false, final false
  inline void AddAttDef(::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CheckAttributes, addr 0x1cacc88, size 0x2a8, virtual false, abstract: false, final false
  inline void CheckAttributes(::System::Collections::Hashtable* presence, bool standalone);

  /// @brief Method Clone, addr 0x1cac99c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* Clone();

  /// @brief Method CreateAnyTypeElementDecl, addr 0x1cac7e8, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::SchemaElementDecl* CreateAnyTypeElementDecl();

  /// @brief Method GetAttDef, addr 0x1cacbf8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IDtdAttributeListInfo.LookupAttribute, addr 0x1cac8b4, size 0xb8, virtual true, abstract: false, final true
  inline ::System::Xml::IDtdAttributeInfo* System_Xml_IDtdAttributeListInfo_LookupAttribute(::StringW prefix, ::StringW localName);

  /// @brief Method System.Xml.IDtdAttributeListInfo.LookupDefaultAttributes, addr 0x1cac96c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdAttributeListInfo.get_HasNonCDataAttributes, addr 0x1cac8ac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1cac554, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1cac610, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaDatatype* dtype);

  /// @brief Method .ctor, addr 0x1cac714, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AnyAttribute, addr 0x1caca74, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AttDefs, addr 0x1cacc78, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*, ::System::Xml::Schema::SchemaAttDef*>* get_AttDefs();

  /// @brief Method get_Block, addr 0x1caca28, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block();

  /// @brief Method get_Constraints, addr 0x1caca84, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ContentValidator, addr 0x1caca64, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* get_ContentValidator();

  /// @brief Method get_DefaultAttDefs, addr 0x1cacc70, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::Xml::IDtdDefaultAttributeInfo*>* get_DefaultAttDefs();

  /// @brief Method get_HasDefaultAttribute, addr 0x1caca4c, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasDefaultAttribute();

  /// @brief Method get_HasNonCDataAttribute, addr 0x1cac988, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasNonCDataAttribute();

  /// @brief Method get_HasRequiredAttribute, addr 0x1caca5c, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasRequiredAttribute();

  /// @brief Method get_IsAbstract, addr 0x1caca00, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAbstract();

  /// @brief Method get_IsIdDeclared, addr 0x1cac974, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsIdDeclared();

  /// @brief Method get_IsNillable, addr 0x1caca14, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNillable();

  /// @brief Method get_IsNotationDeclared, addr 0x1caca38, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNotationDeclared();

  /// @brief Method get_ProhibitedAttributes, addr 0x1cacc80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SchemaElement, addr 0x1caca94, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AnyAttribute, addr 0x1caca7c, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Block, addr 0x1caca30, size 0x8, virtual false, abstract: false, final false
  inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_Constraints, addr 0x1caca8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ContentValidator, addr 0x1caca6c, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentValidator(::System::Xml::Schema::ContentValidator* value);

  /// @brief Method set_HasNonCDataAttribute, addr 0x1cac990, size 0xc, virtual false, abstract: false, final false
  inline void set_HasNonCDataAttribute(bool value);

  /// @brief Method set_IsAbstract, addr 0x1caca08, size 0xc, virtual false, abstract: false, final false
  inline void set_IsAbstract(bool value);

  /// @brief Method set_IsIdDeclared, addr 0x1cac97c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsIdDeclared(bool value);

  /// @brief Method set_IsNillable, addr 0x1caca1c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNillable(bool value);

  /// @brief Method set_IsNotationDeclared, addr 0x1caca40, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNotationDeclared(bool value);

  /// @brief Method set_SchemaElement, addr 0x1caca9c, size 0x8, virtual false, abstract: false, final false
