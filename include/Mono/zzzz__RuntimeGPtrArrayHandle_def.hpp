...
public:
  ...
  /// @brief Method DestroyAndFree, addr 0x1d03a2c, size 0x1c, virtual false, abstract: false, final false
  static inline void DestroyAndFree(ByRef<::Mono::RuntimeGPtrArrayHandle> h);

  /// @brief Method GPtrArrayFree, addr 0x1d03a28, size 0x4, virtual false, abstract: false, final false
  static inline void GPtrArrayFree(::cordl_internals::Ptr<::Mono::__RuntimeStructs__GPtrArray> value);

  /// @brief Method Lookup, addr 0x1d039bc, size 0x6c, virtual false, abstract: false, final false
  inline void* Lookup(int32_t i);

  /// @brief Method .ctor, addr 0x1d0397c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(void* ptr);

  /// @brief Method get_Item, addr 0x1d039b8, size 0x4, virtual false, abstract: false, final false
  inline void* get_Item(int32_t i);

  /// @brief Method get_Length, addr 0x1d0399c, size 0x1c, virtual false, abstract: false, final false
