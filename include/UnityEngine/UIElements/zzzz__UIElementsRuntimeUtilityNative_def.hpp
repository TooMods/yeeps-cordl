...
public:
  ...
  /// @brief Method RegisterPlayerloopCallback, addr 0x264ef40, size 0x28, virtual false, abstract: false, final false
  static inline void RegisterPlayerloopCallback();

  /// @brief Method RepaintOverlayPanels, addr 0x264ee78, size 0x64, virtual false, abstract: false, final false
  static inline void RepaintOverlayPanels();

  /// @brief Method UnregisterPlayerloopCallback, addr 0x264ef68, size 0x28, virtual false, abstract: false, final false
  static inline void UnregisterPlayerloopCallback();

  /// @brief Method UpdateRuntimePanels, addr 0x264eedc, size 0x64, virtual false, abstract: false, final false
  static inline void UpdateRuntimePanels();

  /// @brief Method VisualElementCreation, addr 0x264ef90, size 0x28, virtual false, abstract: false, final false
