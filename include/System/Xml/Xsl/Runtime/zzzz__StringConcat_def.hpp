...
public:
  ...
  /// @brief Method Clear, addr 0x3048ec8, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ConcatNoDelimiter, addr 0x3048fd0, size 0x2b8, virtual false, abstract: false, final false
  inline void ConcatNoDelimiter(::StringW s);

  /// @brief Method GetResult, addr 0x3048edc, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetResult();

  /// @brief Method get_Count, addr 0x3048ed4, size 0x8, virtual false, abstract: false, final false
