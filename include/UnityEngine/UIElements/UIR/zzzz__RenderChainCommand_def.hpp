...
public:
  ...
  /// @brief Method Blit, addr 0x20a2684, size 0x170, virtual false, abstract: false, final false
  inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* destination, float_t depth);

  /// @brief Method CombineScissorRects, addr 0x20a24cc, size 0x1b8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect CombineScissorRects(::UnityEngine::Rect r0, ::UnityEngine::Rect r1);

  /// @brief Method ExecuteNonDrawMesh, addr 0x20a0830, size 0xbbc, virtual false, abstract: false, final false
  ...
  /// @brief Method RectPointsToPixelsAndFlipYAxis, addr 0x20a20c8, size 0x404, virtual false, abstract: false, final false
  static inline ::UnityEngine::RectInt RectPointsToPixelsAndFlipYAxis(::UnityEngine::Rect rect, float_t pixelsPerPoint);

  /// @brief Method Reset, addr 0x20a20a4, size 0x24, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x20a27f4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
