...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce7154, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FacetType, addr 0x1ce7144, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::FacetType get_FacetType();

  /// @brief Method get_IsFixed, addr 0x1ce7088, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFixed();

  /// @brief Method get_Value, addr 0x1ce7078, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_FacetType, addr 0x1ce714c, size 0x8, virtual false, abstract: false, final false
  inline void set_FacetType(::System::Xml::Schema::FacetType value);

  /// @brief Method set_IsFixed, addr 0x1ce7090, size 0xb4, virtual true, abstract: false, final false
  inline void set_IsFixed(bool value);

  /// @brief Method set_Value, addr 0x1ce7080, size 0x8, virtual false, abstract: false, final false
