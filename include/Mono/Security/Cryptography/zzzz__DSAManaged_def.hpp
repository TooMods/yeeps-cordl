...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x28a3b44, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a3a14, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateSignature, addr 0x28a2f24, size 0x328, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateSignature(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbHash);

  /// @brief Method Dispose, addr 0x28a370c, size 0x1d0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExportParameters, addr 0x28a2998, size 0x278, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x28a1c60, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Generate, addr 0x28a1d00, size 0x4c, virtual false, abstract: false, final false
  inline void Generate();

  /// @brief Method GenerateKeyPair, addr 0x28a2274, size 0xe0, virtual false, abstract: false, final false
  inline void GenerateKeyPair();

  /// @brief Method GenerateParams, addr 0x28a1d4c, size 0x528, virtual false, abstract: false, final false
  inline void GenerateParams(int32_t keyLength);

  /// @brief Method ImportParameters, addr 0x28a2c7c, size 0x2a8, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeArray, addr 0x28a28f4, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> NormalizeArray(::ArrayW<uint8_t, ::Array<uint8_t>*> array);

  /// @brief Method VerifySignature, addr 0x28a324c, size 0x4c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a1b80, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(int32_t dwKeySize);

  /// @brief Method add, addr 0x28a2434, size 0xa4, virtual false, abstract: false, final false
  inline void add(::ArrayW<uint8_t, ::Array<uint8_t>*> a, ::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t value);

  /// @brief Method add_KeyGenerated, addr 0x28a38dc, size 0x9c, virtual false, abstract: false, final false
  inline void add_KeyGenerated(::Mono::Security::Cryptography::__DSAManaged__KeyGeneratedEventHandler* value);

  /// @brief Method get_KeyExchangeAlgorithm, addr 0x28a2838, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_KeyExchangeAlgorithm();

  /// @brief Method get_KeySize, addr 0x28a280c, size 0x2c, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x28a2840, size 0x74, virtual false, abstract: false, final false
  inline bool get_PublicOnly();

  /// @brief Method get_Random, addr 0x28a24d8, size 0x20, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::RandomNumberGenerator* get_Random();

  /// @brief Method get_SignatureAlgorithm, addr 0x28a28b4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_SignatureAlgorithm();

  /// @brief Method remove_KeyGenerated, addr 0x28a3978, size 0x9c, virtual false, abstract: false, final false
