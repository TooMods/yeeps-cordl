...
public:
  ...
  /// @brief Method ResetCursor, addr 0x2a3d278, size 0x68, virtual true, abstract: false, final true
  inline void ResetCursor();

  /// @brief Method SetCursor, addr 0x2a3d188, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a3d2e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isCursorOverriden, addr 0x2a3d174, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isCursorOverriden, addr 0x2a3d17c, size 0xc, virtual false, abstract: false, final false
