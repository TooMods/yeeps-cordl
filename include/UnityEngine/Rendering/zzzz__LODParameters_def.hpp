...
public:
  ...
  /// @brief Method Equals, addr 0x2a92864, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a927c8, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::LODParameters other);

  /// @brief Method GetHashCode, addr 0x2a928f4, size 0x94, virtual true, abstract: false, final false
