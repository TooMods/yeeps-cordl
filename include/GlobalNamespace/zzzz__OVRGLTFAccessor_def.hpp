...
public:
  ...
  /// @brief Method GetDataCount, addr 0x25bf064, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetDataCount();

  /// @brief Method GetMaxValueForType, addr 0x25c0580, size 0x28, virtual false, abstract: false, final false
  inline float_t GetMaxValueForType(::GlobalNamespace::OVRGLTFComponentType type);

  /// @brief Method GetStrideForType, addr 0x25bf280, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsBoneWeights, addr 0x25c0a24, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsColor, addr 0x25c00f8, size 0x488, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsFloat, addr 0x25bf498, size 0x210, virtual false, abstract: false, final false
  inline void ReadAsFloat(::GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<float_t, ::Array<float_t>*>> data, int32_t offset);

  /// @brief Method ReadAsInt, addr 0x25bf06c, size 0x214, virtual false, abstract: false, final false
  inline void ReadAsInt(::GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> data, int32_t offset);

  /// @brief Method ReadAsMatrix4x4, addr 0x25c05a8, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsTexture, addr 0x25c0914, size 0x110, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadAsTexture(::GlobalNamespace::OVRBinaryChunk chunk);

  /// @brief Method ReadAsVector2, addr 0x25bf710, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsVector3, addr 0x25bf96c, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsVector4, addr 0x25bfd04, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadElementAsFloat, addr 0x25bf6a8, size 0x68, virtual false, abstract: false, final false
  inline float_t ReadElementAsFloat(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t index);

  /// @brief Method ReadElementAsUint, addr 0x25bf2a8, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToOVRType, addr 0x25bef00, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25bebc0, size 0x340, virtual false, abstract: false, final false
