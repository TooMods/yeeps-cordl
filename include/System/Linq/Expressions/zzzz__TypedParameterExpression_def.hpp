...
public:
  ...
  /// @brief Method .ctor, addr 0x183c650, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW name);

  /// @brief Method get_Type, addr 0x183c730, size 0x8, virtual true, abstract: false, final true
