...
public:
  ...
  /// @brief Method Add, addr 0x1cadd50, size 0x8e0, virtual false, abstract: false, final false
  inline void Add(::System::Xml::Schema::SchemaInfo* sinfo, ::System::Xml::Schema::ValidationEventHandler* eventhandler);

  /// @brief Method Contains, addr 0x1cad890, size 0x58, virtual false, abstract: false, final false
  inline bool Contains(::StringW ns);

  /// @brief Method Finish, addr 0x1cae630, size 0x1b4, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method GetAttributeXdr, addr 0x1cad8e8, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeXsd, addr 0x1cada38, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeXsd, addr 0x1cadc50, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetElement, addr 0x1cad820, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* GetElement(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method GetElementDecl, addr 0x1cad730, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetElementDecl(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method GetTypeDecl, addr 0x1cad7a8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetTypeDecl(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method HasSchema, addr 0x1cad838, size 0x58, virtual false, abstract: false, final false
  inline bool HasSchema(::StringW ns);

  static inline ::System::Xml::Schema::SchemaInfo* New_ctor();

  /// @brief Method System.Xml.IDtdInfo.LookupAttributeList, addr 0x1cae7f4, size 0xcc, virtual true, abstract: false, final true
  inline ::System::Xml::IDtdAttributeListInfo* System_Xml_IDtdInfo_LookupAttributeList(::StringW prefix, ::StringW localName);

  /// @brief Method System.Xml.IDtdInfo.LookupEntity, addr 0x1cae8c0, size 0xb8, virtual true, abstract: false, final true
  inline ::System::Xml::IDtdEntityInfo* System_Xml_IDtdInfo_LookupEntity(::StringW name);

  /// @brief Method System.Xml.IDtdInfo.get_HasDefaultAttributes, addr 0x1cae7e4, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdInfo_get_HasDefaultAttributes();

  /// @brief Method System.Xml.IDtdInfo.get_HasNonCDataAttributes, addr 0x1cae7ec, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdInfo_get_HasNonCDataAttributes();

  /// @brief Method System.Xml.IDtdInfo.get_InternalDtdSubset, addr 0x1cae980, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdInfo_get_InternalDtdSubset();

  /// @brief Method System.Xml.IDtdInfo.get_Name, addr 0x1cae978, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1cad3a4, size 0x1ac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AttributeDecls, addr 0x1cad698, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DocTypeName, addr 0x1cad550, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_DocTypeName();

  /// @brief Method get_ElementDecls, addr 0x1cad568, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ElementDeclsByType, addr 0x1cad690, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ErrorCount, addr 0x1cad720, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ErrorCount();

  /// @brief Method get_GeneralEntities, addr 0x1cad578, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Notations, addr 0x1cad6a0, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::System::Xml::Schema::SchemaNotation*>* get_Notations();

  /// @brief Method get_ParameterEntities, addr 0x1cad5f8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SchemaType, addr 0x1cad678, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaType get_SchemaType();

  /// @brief Method get_TargetNamespaces, addr 0x1cad688, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, bool>* get_TargetNamespaces();

  /// @brief Method get_UndeclaredElementDecls, addr 0x1cad570, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DocTypeName, addr 0x1cad558, size 0x8, virtual false, abstract: false, final false
  inline void set_DocTypeName(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_ErrorCount, addr 0x1cad728, size 0x8, virtual false, abstract: false, final false
  inline void set_ErrorCount(int32_t value);

  /// @brief Method set_InternalDtdSubset, addr 0x1cad560, size 0x8, virtual false, abstract: false, final false
  inline void set_InternalDtdSubset(::StringW value);

  /// @brief Method set_SchemaType, addr 0x1cad680, size 0x8, virtual false, abstract: false, final false
