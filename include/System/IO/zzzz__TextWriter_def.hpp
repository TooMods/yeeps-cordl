...
public:
  ...
  /// @brief Method <FlushAsync>b__67_0, addr 0x2583e58, size 0xac, virtual false, abstract: false, final false
  inline void _FlushAsync_b__67_0(::System::Object* state);

  /// @brief Method <WriteAsync>b__56_0, addr 0x2583c38, size 0xac, virtual false, abstract: false, final false
  inline void _WriteAsync_b__56_0(::System::Object* state);

  /// @brief Method <WriteAsync>b__57_0, addr 0x2583ce4, size 0xac, virtual false, abstract: false, final false
  inline void _WriteAsync_b__57_0(::System::Object* state);

  /// @brief Method <WriteAsync>b__59_0, addr 0x2583d90, size 0xc8, virtual false, abstract: false, final false
  inline void _WriteAsync_b__59_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x2583c30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Close, addr 0x2582c50, size 0x6c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x2582cc0, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2582cbc, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x2582d2c, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x257fe00, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method Synchronized, addr 0x2583364, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::IO::TextWriter* Synchronized(::System::IO::TextWriter* writer);

  /// @brief Method Write, addr 0x2582d3c, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer);

  /// @brief Method Write, addr 0x2582d5c, size 0x1b4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x25830a8, size 0x54, virtual true, abstract: false, final false
  inline void Write(::StringW format, ::System::Object* arg0);

  /// @brief Method Write, addr 0x25830fc, size 0x64, virtual true, abstract: false, final false
  inline void Write(::StringW format, ::System::Object* arg0, ::System::Object* arg1);

  /// @brief Method Write, addr 0x2582f60, size 0x38, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x2582f98, size 0x110, virtual true, abstract: false, final false
  inline void Write(::System::Object* value);

  /// @brief Method Write, addr 0x2582d38, size 0x4, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method Write, addr 0x2582f10, size 0x50, virtual true, abstract: false, final false
  inline void Write(int32_t value);

  /// @brief Method WriteAsync, addr 0x257f918, size 0x250, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteAsync, addr 0x257f2b0, size 0x240, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::StringW value);

  /// @brief Method WriteAsync, addr 0x257ed4c, size 0x240, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(char16_t value);

  /// @brief Method WriteLine, addr 0x2583160, size 0x14, virtual true, abstract: false, final false
  inline void WriteLine();

  /// @brief Method WriteLine, addr 0x2583300, size 0x64, virtual true, abstract: false, final false
  inline void WriteLine(::StringW format, ::System::Object* arg0, ::System::Object* arg1);

  /// @brief Method WriteLine, addr 0x25831a4, size 0x3c, virtual true, abstract: false, final false
  inline void WriteLine(::StringW value);

  /// @brief Method WriteLine, addr 0x25831e0, size 0x120, virtual true, abstract: false, final false
  inline void WriteLine(::System::Object* value);

  /// @brief Method WriteLine, addr 0x2583174, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x257d938, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x257d1a4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FormatProvider, addr 0x2582be8, size 0x68, virtual true, abstract: false, final false
  inline ::System::IFormatProvider* get_FormatProvider();

  /// @brief Method get_NewLine, addr 0x2582d30, size 0x8, virtual true, abstract: false, final false
