...
public:
  ...
  /// @brief Method Equals, addr 0x2099144, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x20991d4, size 0xe8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::UIR::TextCoreSettings other);

  /// @brief Method GetHashCode, addr 0x20992bc, size 0x198, virtual true, abstract: false, final false
