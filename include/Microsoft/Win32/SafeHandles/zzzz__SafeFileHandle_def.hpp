...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x28a79b8, size 0x7c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x28a792c, size 0x28, virtual false, abstract: false, final false
