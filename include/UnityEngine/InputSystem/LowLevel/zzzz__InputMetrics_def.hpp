...
public:
  ...
  /// @brief Method get_averageEventBytesPerFrame, addr 0x1e0b184, size 0x18, virtual false, abstract: false, final false
  inline float_t get_averageEventBytesPerFrame();

  /// @brief Method get_averageLagTimePerEvent, addr 0x1e0b1b0, size 0x14, virtual false, abstract: false, final false
  inline double_t get_averageLagTimePerEvent();

  /// @brief Method get_averageProcessingTimePerEvent, addr 0x1e0b19c, size 0x14, virtual false, abstract: false, final false
  inline double_t get_averageProcessingTimePerEvent();

  /// @brief Method get_currentControlCount, addr 0x1e0b114, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentControlCount();

  /// @brief Method get_currentLayoutCount, addr 0x1e0b124, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentLayoutCount();

  /// @brief Method get_currentNumDevices, addr 0x1e0b0e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentNumDevices();

  /// @brief Method get_currentStateSizeInBytes, addr 0x1e0b104, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentStateSizeInBytes();

  /// @brief Method get_maxNumDevices, addr 0x1e0b0d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxNumDevices();

  /// @brief Method get_maxStateSizeInBytes, addr 0x1e0b0f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxStateSizeInBytes();

  /// @brief Method get_totalEventBytes, addr 0x1e0b134, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalEventBytes();

  /// @brief Method get_totalEventCount, addr 0x1e0b144, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalEventCount();

  /// @brief Method get_totalEventLagTime, addr 0x1e0b174, size 0x8, virtual false, abstract: false, final false
  inline double_t get_totalEventLagTime();

  /// @brief Method get_totalEventProcessingTime, addr 0x1e0b164, size 0x8, virtual false, abstract: false, final false
  inline double_t get_totalEventProcessingTime();

  /// @brief Method get_totalUpdateCount, addr 0x1e0b154, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalUpdateCount();

  /// @brief Method set_currentControlCount, addr 0x1e0b11c, size 0x8, virtual false, abstract: false, final false
  inline void set_currentControlCount(int32_t value);

  /// @brief Method set_currentLayoutCount, addr 0x1e0b12c, size 0x8, virtual false, abstract: false, final false
  inline void set_currentLayoutCount(int32_t value);

  /// @brief Method set_currentNumDevices, addr 0x1e0b0ec, size 0x8, virtual false, abstract: false, final false
  inline void set_currentNumDevices(int32_t value);

  /// @brief Method set_currentStateSizeInBytes, addr 0x1e0b10c, size 0x8, virtual false, abstract: false, final false
  inline void set_currentStateSizeInBytes(int32_t value);

  /// @brief Method set_maxNumDevices, addr 0x1e0b0dc, size 0x8, virtual false, abstract: false, final false
  inline void set_maxNumDevices(int32_t value);

  /// @brief Method set_maxStateSizeInBytes, addr 0x1e0b0fc, size 0x8, virtual false, abstract: false, final false
  inline void set_maxStateSizeInBytes(int32_t value);

  /// @brief Method set_totalEventBytes, addr 0x1e0b13c, size 0x8, virtual false, abstract: false, final false
  inline void set_totalEventBytes(int32_t value);

  /// @brief Method set_totalEventCount, addr 0x1e0b14c, size 0x8, virtual false, abstract: false, final false
  inline void set_totalEventCount(int32_t value);

  /// @brief Method set_totalEventLagTime, addr 0x1e0b17c, size 0x8, virtual false, abstract: false, final false
  inline void set_totalEventLagTime(double_t value);

  /// @brief Method set_totalEventProcessingTime, addr 0x1e0b16c, size 0x8, virtual false, abstract: false, final false
  inline void set_totalEventProcessingTime(double_t value);

  /// @brief Method set_totalUpdateCount, addr 0x1e0b15c, size 0x8, virtual false, abstract: false, final false
