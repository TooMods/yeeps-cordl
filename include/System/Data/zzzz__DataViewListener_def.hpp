...
public:
  ...
  /// @brief Method ChildRelationCollectionChanged, addr 0x1932a2c, size 0xc8, virtual false, abstract: false, final false
  inline void ChildRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method CleanUp, addr 0x1932af4, size 0x1c, virtual false, abstract: false, final false
  inline void CleanUp(bool updateListeners);

  /// @brief Method ColumnCollectionChanged, addr 0x1932bd8, size 0xc8, virtual false, abstract: false, final false
  inline void ColumnCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method IndexListChanged, addr 0x1932d70, size 0xb4, virtual false, abstract: false, final false
  inline void IndexListChanged(::System::ComponentModel::ListChangedEventArgs* e);

  /// @brief Method MaintainDataView, addr 0x1932ca0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParentRelationCollectionChanged, addr 0x1932b10, size 0xc8, virtual false, abstract: false, final false
  inline void ParentRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method RegisterListChangedEvent, addr 0x19334c8, size 0xe4, virtual false, abstract: false, final false
  inline void RegisterListChangedEvent(::System::Data::Index* index);

  /// @brief Method RegisterListener, addr 0x1933000, size 0x220, virtual false, abstract: false, final false
  inline void RegisterListener(::System::Data::DataTable* table);

  /// @brief Method RegisterMetaDataEvents, addr 0x1932e24, size 0x1dc, virtual false, abstract: false, final false
  inline void RegisterMetaDataEvents(::System::Data::DataTable* table);

  /// @brief Method UnregisterListChangedEvent, addr 0x19335ac, size 0x104, virtual false, abstract: false, final false
  inline void UnregisterListChangedEvent();

  /// @brief Method UnregisterMetaDataEvents, addr 0x1933220, size 0x8, virtual false, abstract: false, final false
  inline void UnregisterMetaDataEvents();

  /// @brief Method UnregisterMetaDataEvents, addr 0x1933228, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19329ac, size 0x80, virtual false, abstract: false, final false
