...
public:
  ...
  /// @brief Method Dispose, addr 0x1e057f4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x1e0577c, size 0x6c, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x1e057e8, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1e05800, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x1e0558c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputEventBuffer buffer);

  /// @brief Method get_Current, addr 0x1e057f8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AdvanceToNextEvent, addr 0x1e05458, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateEvent, addr 0x1e05178, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendEvent, addr 0x1e050f8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Clone, addr 0x1e05628, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventBuffer Clone();

  /// @brief Method Contains, addr 0x1e04c4c, size 0x88, virtual false, abstract: false, final false
  inline bool Contains(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> eventPtr);

  /// @brief Method Dispose, addr 0x1e055c8, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetEnumerator, addr 0x1e05518, size 0x74, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* GetEnumerator();

  /// @brief Method Reset, addr 0x1e05440, size 0x18, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1e055c4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.ICloneable.Clone, addr 0x1e05710, size 0x68, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method .ctor, addr 0x1e04fac, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e04dec, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_bufferPtr, addr 0x1e04da0, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventPtr get_bufferPtr();

  /// @brief Method get_capacityInBytes, addr 0x1e04d38, size 0x5c, virtual false, abstract: false, final false
  inline int64_t get_capacityInBytes();

  /// @brief Method get_data, addr 0x1e04d94, size 0xc, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> get_data();

  /// @brief Method get_eventCount, addr 0x1e04d28, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_eventCount();

  /// @brief Method get_sizeInBytes, addr 0x1e04d30, size 0x8, virtual false, abstract: false, final false
