...
public:
  ...
  /// @brief Method ToDebugString, addr 0x1b51718, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b516f0, size 0x28, virtual false, abstract: false, final false
