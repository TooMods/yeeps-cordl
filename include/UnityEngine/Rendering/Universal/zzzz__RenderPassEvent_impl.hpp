...
constexpr ::UnityEngine::Rendering::Universal::RenderPassEvent UnityEngine::Rendering::Universal::RenderPassEvent::BeforeRenderingPrepasses{ static_cast<int32_t>(0x97) };
