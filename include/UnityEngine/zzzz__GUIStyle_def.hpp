...
public:
  ...
  /// @brief Method CalcHeight, addr 0x2016300, size 0x54, virtual false, abstract: false, final false
  inline float_t CalcHeight(::UnityEngine::GUIContent* content, float_t width);

  /// @brief Method CalcMinMaxWidth, addr 0x2016400, size 0x28, virtual false, abstract: false, final false
  inline void CalcMinMaxWidth(::UnityEngine::GUIContent* content, ByRef<float_t> minWidth, ByRef<float_t> maxWidth);

  /// @brief Method CalcSize, addr 0x20162f8, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalcSize(::UnityEngine::GUIContent* content);

  /// @brief Method CalcSizeWithConstraints, addr 0x20162fc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalcSizeWithConstraints(::UnityEngine::GUIContent* content, ::UnityEngine::Vector2 constraints);

  /// @brief Method Draw, addr 0x201623c, size 0x14, virtual false, abstract: false, final false
  inline void Draw(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID);

  /// @brief Method Draw, addr 0x2016250, size 0xa0, virtual false, abstract: false, final false
  inline void Draw(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID, bool on, bool hover);

  /// @brief Method Draw, addr 0x2016218, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Draw, addr 0x2016204, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x2015f1c, size 0x144, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCursorPixelPosition, addr 0x20162f0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorStringIndex, addr 0x20162f4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRectOffsetPtr, addr 0x20155cc, size 0x44, virtual false, abstract: false, final false
  inline void* GetRectOffsetPtr(int32_t idx);

  /// @brief Method GetStyleStatePtr, addr 0x2015588, size 0x44, virtual false, abstract: false, final false
  inline void* GetStyleStatePtr(int32_t idx);

  /// @brief Method Internal_CalcHeight, addr 0x2015c2c, size 0x54, virtual false, abstract: false, final false
  inline float_t Internal_CalcHeight(::UnityEngine::GUIContent* content, float_t width);

  /// @brief Method Internal_CalcMinMaxWidth, addr 0x2015c80, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 Internal_CalcMinMaxWidth(::UnityEngine::GUIContent* content);

  /// @brief Method Internal_CalcMinMaxWidth_Injected, addr 0x2015cdc, size 0x54, virtual false, abstract: false, final false
  inline void Internal_CalcMinMaxWidth_Injected(::UnityEngine::GUIContent* content, ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method Internal_CalcSize, addr 0x2015abc, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 Internal_CalcSize(::UnityEngine::GUIContent* content);

  /// @brief Method Internal_CalcSizeWithConstraints, addr 0x2015b6c, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 Internal_CalcSizeWithConstraints(::UnityEngine::GUIContent* content, ::UnityEngine::Vector2 maxSize);

  /// @brief Method Internal_CalcSizeWithConstraints_Injected, addr 0x2015bd0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CalcSize_Injected, addr 0x2015b18, size 0x54, virtual false, abstract: false, final false
  inline void Internal_CalcSize_Injected(::UnityEngine::GUIContent* content, ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method Internal_Copy, addr 0x2015508, size 0x44, virtual false, abstract: false, final false
  static inline void* Internal_Copy(::UnityEngine::GUIStyle* self, ::UnityEngine::GUIStyle* other);

  /// @brief Method Internal_Create, addr 0x20154cc, size 0x3c, virtual false, abstract: false, final false
  static inline void* Internal_Create(::UnityEngine::GUIStyle* self);

  /// @brief Method Internal_Destroy, addr 0x201554c, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(void* self);

  /// @brief Method Internal_Draw, addr 0x201564c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Draw2, addr 0x201575c, size 0x74, virtual false, abstract: false, final false
  inline void Internal_Draw2(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID, bool on);

  /// @brief Method Internal_Draw2_Injected, addr 0x20157d0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Draw_Injected, addr 0x20156d8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorPixelPosition, addr 0x201583c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorPixelPosition_Injected, addr 0x20158b0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorStringIndex, addr 0x201591c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorStringIndex_Injected, addr 0x2015980, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetLineHeight, addr 0x2015610, size 0x3c, virtual false, abstract: false, final false
  static inline float_t Internal_GetLineHeight(void* target);

  /// @brief Method Internal_GetSelectedRenderedText, addr 0x20159dc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetSelectedRenderedText_Injected, addr 0x2015a50, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTooltipActive, addr 0x2015e00, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultFont, addr 0x2010554, size 0x3c, virtual false, abstract: false, final false
  static inline void SetDefaultFont(::UnityEngine::Font* font);

  /// @brief Method SetMouseTooltip, addr 0x2015d30, size 0x8c, virtual false, abstract: false, final false
  static inline void SetMouseTooltip(::StringW tooltip, ::UnityEngine::Rect screenRect);

  /// @brief Method SetMouseTooltip_Injected, addr 0x2015dbc, size 0x44, virtual false, abstract: false, final false
  static inline void SetMouseTooltip_Injected(::StringW tooltip, ByRef<::UnityEngine::Rect> screenRect);

  /// @brief Method ToString, addr 0x2016428, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2010808, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2015e3c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_border, addr 0x2016060, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_border();

  /// @brief Method get_fixedHeight, addr 0x2013b98, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_fixedHeight();

  /// @brief Method get_fixedWidth, addr 0x2012d50, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_fixedWidth();

  /// @brief Method get_font, addr 0x201523c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> get_font();

  /// @brief Method get_imagePosition, addr 0x20152bc, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::ImagePosition get_imagePosition();

  /// @brief Method get_isHeightDependantOnWidth, addr 0x2016354, size 0xac, virtual false, abstract: false, final false
  inline bool get_isHeightDependantOnWidth();

  /// @brief Method get_lineHeight, addr 0x2016108, size 0xfc, virtual false, abstract: false, final false
  inline float_t get_lineHeight();

  /// @brief Method get_margin, addr 0x2012164, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_margin();

  /// @brief Method get_name, addr 0x201174c, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_none, addr 0x2011f38, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIStyle* get_none();

  /// @brief Method get_normal, addr 0x20117dc, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyleState* get_normal();

  /// @brief Method get_padding, addr 0x2012c6c, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_padding();

  /// @brief Method get_rawName, addr 0x20151bc, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_rawName();

  /// @brief Method get_stretchHeight, addr 0x2013b5c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_stretchHeight();

  /// @brief Method get_stretchWidth, addr 0x2012d14, size 0x3c, virtual false, abstract: false, final false
  inline bool get_stretchWidth();

  /// @brief Method get_wordWrap, addr 0x201533c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_alignment, addr 0x20152f8, size 0x44, virtual false, abstract: false, final false
  inline void set_alignment(::UnityEngine::TextAnchor value);

  /// @brief Method set_clipping, addr 0x20153bc, size 0x44, virtual false, abstract: false, final false
  inline void set_clipping(::UnityEngine::TextClipping value);

  /// @brief Method set_font, addr 0x2015278, size 0x44, virtual false, abstract: false, final false
  inline void set_font(::UnityEngine::Font* value);

  /// @brief Method set_fontSize, addr 0x2015400, size 0x44, virtual false, abstract: false, final false
  inline void set_fontSize(int32_t value);

  /// @brief Method set_fontStyle, addr 0x2015444, size 0x44, virtual false, abstract: false, final false
  inline void set_fontStyle(::UnityEngine::FontStyle value);

  /// @brief Method set_name, addr 0x2010890, size 0x48, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_rawName, addr 0x20151f8, size 0x44, virtual false, abstract: false, final false
  inline void set_rawName(::StringW value);

  /// @brief Method set_richText, addr 0x2015488, size 0x44, virtual false, abstract: false, final false
  inline void set_richText(bool value);

  /// @brief Method set_stretchHeight, addr 0x2011798, size 0x44, virtual false, abstract: false, final false
  inline void set_stretchHeight(bool value);

  /// @brief Method set_wordWrap, addr 0x2015378, size 0x44, virtual false, abstract: false, final false
