...
public:
  ...
  /// @brief Method Equals, addr 0xf9dd54, size 0x3d4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetIsDefault, addr 0xf9dbcc, size 0x1c, virtual false, abstract: false, final false
  inline void SetIsDefault(bool value);

  /// @brief Method SetIsNil, addr 0xf9dbe8, size 0x1c, virtual false, abstract: false, final false
  inline void SetIsNil(bool value);

  /// @brief Method SetValidity, addr 0xf9dbb8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf9d570, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsDefault, addr 0xf9dc34, size 0xc, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsNil, addr 0xf9dc40, size 0xc, virtual true, abstract: false, final false
  inline bool get_IsNil();

  /// @brief Method get_MemberType, addr 0xf9dc4c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType();

  /// @brief Method get_SchemaAttribute, addr 0xf9dcd8, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute();

  /// @brief Method get_SchemaElement, addr 0xf9dc5c, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement();

  /// @brief Method get_SchemaType, addr 0xf9dc54, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType();

  /// @brief Method get_Validity, addr 0xf9dc04, size 0x30, virtual true, abstract: false, final false
