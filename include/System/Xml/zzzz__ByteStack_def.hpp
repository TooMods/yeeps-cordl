...
public:
  ...
  /// @brief Method Pop, addr 0x28365e4, size 0x4c, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x2836514, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28364a4, size 0x70, virtual false, abstract: false, final false
