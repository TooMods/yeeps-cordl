...
public:
  // Declarations
  /// @brief Method AcceptInt, addr 0x2270bf4, size 0x5c, virtual false, abstract: false, final false
  inline void AcceptInt(::System::ReadOnlySpan_1<char16_t> str);

  /// @brief Method AcceptSingleChar, addr 0x2270a88, size 0x3c, virtual false, abstract: false, final false
  inline bool AcceptSingleChar(::System::ReadOnlySpan_1<char16_t> str, char16_t c);

  /// @brief Method AcceptString, addr 0x2270ac4, size 0x130, virtual false, abstract: false, final false
  inline bool AcceptString(::System::ReadOnlySpan_1<char16_t> input, ByRef<::System::ReadOnlySpan_1<char16_t>> output);

  /// @brief Method ExpectInt, addr 0x2270728, size 0x12c, virtual false, abstract: false, final false
  inline int32_t ExpectInt(::System::ReadOnlySpan_1<char16_t> str);

  /// @brief Method ExpectSingleChar, addr 0x2270620, size 0x108, virtual false, abstract: false, final false
  inline void ExpectSingleChar(::System::ReadOnlySpan_1<char16_t> str, char16_t c);

  /// @brief Method ExpectString, addr 0x2270854, size 0x234, virtual false, abstract: false, final false
