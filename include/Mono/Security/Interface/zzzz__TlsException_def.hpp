...
public:
  ...
  /// @brief Method .ctor, addr 0x1cc75bc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::Interface::Alert* alert, ::StringW message);

  /// @brief Method .ctor, addr 0x1cc7630, size 0x7c, virtual false, abstract: false, final false
