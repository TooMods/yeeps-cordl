...
public:
  ...
  /// @brief Method .ctor, addr 0x262a5d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckResult, addr 0x262a52c, size 0x58, virtual false, abstract: false, final false
  static inline void CheckResult(::cordl_internals::Ptr<void> result);

  /// @brief Method CheckSizeOf, addr 0x262a4bc, size 0x70, virtual false, abstract: false, final false
  static inline void CheckSizeOf(uint32_t sizeOf);

  /// @brief Method GetOrCreateSharedStaticInternal, addr 0x262a584, size 0x50, virtual false, abstract: false, final false
