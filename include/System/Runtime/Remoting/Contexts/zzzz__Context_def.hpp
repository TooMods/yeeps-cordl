...
public:
  ...
  /// @brief Method AllocateDataSlot, addr 0x1854218, size 0x64, virtual false, abstract: false, final false
  static inline ::System::LocalDataStoreSlot* AllocateDataSlot();

  /// @brief Method AllocateNamedDataSlot, addr 0x185427c, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::LocalDataStoreSlot* AllocateNamedDataSlot(::StringW name);

  /// @brief Method CreateEnvoySink, addr 0x18534d4, size 0x204, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* CreateEnvoySink(::System::MarshalByRefObject* serverObject);

  /// @brief Method CreateNewContext, addr 0x18536e0, size 0x844, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateServerObjectSinkChain, addr 0x1853254, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoCallBack, addr 0x1853f24, size 0x174, virtual false, abstract: false, final false
  inline void DoCallBack(::System::Runtime::Remoting::Contexts::CrossContextDelegate* deleg);

  /// @brief Method Finalize, addr 0x18517ec, size 0xd0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method FreeNamedDataSlot, addr 0x18542e8, size 0x6c, virtual false, abstract: false, final false
  static inline void FreeNamedDataSlot(::StringW name);

  /// @brief Method Freeze, addr 0x1852e58, size 0x1ac, virtual true, abstract: false, final false
  inline void Freeze();

  /// @brief Method GetClientContextSinkChain, addr 0x184ee44, size 0x208, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* GetClientContextSinkChain();

  /// @brief Method GetData, addr 0x18543c0, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Object* GetData(::System::LocalDataStoreSlot* slot);

  /// @brief Method GetDynamicPropertyCollection, addr 0x1851ad8, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNamedDataSlot, addr 0x1854354, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::LocalDataStoreSlot* GetNamedDataSlot(::StringW name);

  /// @brief Method GetProperty, addr 0x1852ac4, size 0x1e8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::Contexts::IContextProperty* GetProperty(::StringW name);

  /// @brief Method GetServerContextSinkChain, addr 0x1853060, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyDynamicSinks, addr 0x1852a00, size 0x84, virtual false, abstract: false, final false
  inline void NotifyDynamicSinks(bool start, ::System::Runtime::Remoting::Messaging::IMessage* req_msg, bool client_site, bool async);

  /// @brief Method NotifyGlobalDynamicSinks, addr 0x1852200, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterContext, addr 0x1851760, size 0x4, virtual false, abstract: false, final false
  static inline void RegisterContext(::System::Runtime::Remoting::Contexts::Context* ctx);

  /// @brief Method RegisterDynamicProperty, addr 0x1851a60, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseContext, addr 0x1851764, size 0x4, virtual false, abstract: false, final false
  static inline void ReleaseContext(::System::Runtime::Remoting::Contexts::Context* ctx);

  /// @brief Method SetData, addr 0x18543f0, size 0x40, virtual false, abstract: false, final false
  static inline void SetData(::System::LocalDataStoreSlot* slot, ::System::Object* data);

  /// @brief Method SetProperty, addr 0x1852cac, size 0x1ac, virtual true, abstract: false, final false
  inline void SetProperty(::System::Runtime::Remoting::Contexts::IContextProperty* prop);

  /// @brief Method SwitchToContext, addr 0x18536d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1853004, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnregisterDynamicProperty, addr 0x1851fa8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1851768, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ContextID, addr 0x18518c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ContextID();

  /// @brief Method get_ContextProperties, addr 0x18518cc, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method get_DefaultContext, addr 0x18518bc, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Runtime::Remoting::Contexts::Context* get_DefaultContext();

  /// @brief Method get_HasDynamicSinks, addr 0x1852a84, size 0x40, virtual false, abstract: false, final false
  inline bool get_HasDynamicSinks();

  /// @brief Method get_HasExitSinks, addr 0x184ed8c, size 0xb8, virtual false, abstract: false, final false
  inline bool get_HasExitSinks();

  /// @brief Method get_HasGlobalDynamicSinks, addr 0x185295c, size 0xa4, virtual false, abstract: false, final false
  static inline bool get_HasGlobalDynamicSinks();

  /// @brief Method get_IsDefaultContext, addr 0x1851940, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsDefaultContext();

  /// @brief Method get_MyLocalStore, addr 0x18540a4, size 0x174, virtual false, abstract: false, final false
  inline ::System::LocalDataStore* get_MyLocalStore();

  /// @brief Method get_NeedsContextSink, addr 0x1851950, size 0xe0, virtual false, abstract: false, final false
