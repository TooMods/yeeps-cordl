...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x14ca7c8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ca69c, size 0x12c, virtual false, abstract: false, final false
