...
public:
  ...
  /// @brief Method DeserializeInTheCurrentDomain, addr 0x1974e4c, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* DeserializeInTheCurrentDomain(int32_t domainId, ::ArrayW<uint8_t, ::Array<uint8_t>*> tInfo);

  /// @brief Method GetObjectData, addr 0x1975ad4, size 0x1d8, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRealObject, addr 0x1975cac, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method SerializeType, addr 0x1974f78, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> SerializeType();

  /// @brief Method UpdateChannelInfo, addr 0x1974dc4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1974da8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1975500, size 0x534, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x1974ff4, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW url, ::System::Object* remoteChannelData);

  /// @brief Method .ctor, addr 0x1974e20, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ChannelInfo, addr 0x1975a9c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::IChannelInfo* get_ChannelInfo();

  /// @brief Method get_EnvoyInfo, addr 0x1975aa4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::IEnvoyInfo* get_EnvoyInfo();

  /// @brief Method get_IsReferenceToWellKnow, addr 0x1975a34, size 0x68, virtual false, abstract: false, final false
  inline bool get_IsReferenceToWellKnow();

  /// @brief Method get_ServerType, addr 0x1975da8, size 0x144, virtual false, abstract: false, final false
  inline ::System::Type* get_ServerType();

  /// @brief Method get_TypeInfo, addr 0x1975ab4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::IRemotingTypeInfo* get_TypeInfo();

  /// @brief Method get_URI, addr 0x1975ac4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_EnvoyInfo, addr 0x1975aac, size 0x8, virtual true, abstract: false, final false
  inline void set_EnvoyInfo(::System::Runtime::Remoting::IEnvoyInfo* value);

  /// @brief Method set_TypeInfo, addr 0x1975abc, size 0x8, virtual true, abstract: false, final false
  inline void set_TypeInfo(::System::Runtime::Remoting::IRemotingTypeInfo* value);

  /// @brief Method set_URI, addr 0x1975acc, size 0x8, virtual true, abstract: false, final false
