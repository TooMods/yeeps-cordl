...
public:
  // Declarations
  /// @brief Method Create, addr 0x25c8920, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c8770, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c88a0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x25c87c8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25c8830, size 0x70, virtual false, abstract: false, final false
