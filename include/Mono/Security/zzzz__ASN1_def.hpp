...
public:
  ...
  /// @brief Method Add, addr 0x1d0ec70, size 0x8c, virtual false, abstract: false, final false
  inline ::Mono::Security::ASN1* Add(::Mono::Security::ASN1* asn1);

  /// @brief Method Decode, addr 0x1d0eaa0, size 0x124, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> asn1, ByRef<int32_t> anPos, int32_t anLength);

  /// @brief Method DecodeTLV, addr 0x1d0f394, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1d0ecfc, size 0x698, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1d0f4b8, size 0x290, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d0e928, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x1d0e8cc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t tag);

  /// @brief Method .ctor, addr 0x1d0e8f8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(uint8_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method get_Count, addr 0x1d0ebc4, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Value, addr 0x1d0ebe0, size 0x90, virtual false, abstract: false, final false
