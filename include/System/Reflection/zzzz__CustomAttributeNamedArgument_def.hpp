...
public:
  ...
  /// @brief Method Equals, addr 0x26166c0, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2616738, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x26168a8, size 0x38c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2616214, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2616468, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* memberInfo, ::System::Reflection::CustomAttributeTypedArgument typedArgument);

  /// @brief Method .ctor, addr 0x261623c, size 0x22c, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* memberInfo, ::System::Object* value);

  /// @brief Method get_IsField, addr 0x2616598, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsField();

  /// @brief Method get_MemberInfo, addr 0x26165a8, size 0x118, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_MemberInfo();

  /// @brief Method get_MemberName, addr 0x26165a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MemberName();

  /// @brief Method get_TypedValue, addr 0x261658c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::CustomAttributeTypedArgument get_TypedValue();

  /// @brief Method op_Equality, addr 0x26167a4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x2616824, size 0x84, virtual false, abstract: false, final false
