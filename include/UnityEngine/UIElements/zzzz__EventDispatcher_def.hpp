...
public:
  ...
  /// @brief Method ApplyDispatchingStrategies, addr 0x27d34f0, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseGate, addr 0x27d2864, size 0x10, virtual false, abstract: false, final false
  inline void CloseGate();

  /// @brief Method CreateForRuntime, addr 0x27d29bc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispatch, addr 0x27d2bf4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method OpenGate, addr 0x27d288c, size 0x88, virtual false, abstract: false, final false
  inline void OpenGate();

  /// @brief Method ProcessEvent, addr 0x27d2d58, size 0x3d0, virtual false, abstract: false, final false
  inline void ProcessEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method ProcessEventQueue, addr 0x27d3128, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27d2a1c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dispatchImmediately, addr 0x27d2bc8, size 0x20, virtual false, abstract: false, final false
  inline bool get_dispatchImmediately();

  /// @brief Method get_pointerState, addr 0x27d29b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_processingEvents, addr 0x27d2be8, size 0xc, virtual false, abstract: false, final false
