...
public:
  ...
  /// @brief Method NotifyDisconnectedObject, addr 0x184b0d8, size 0x304, virtual false, abstract: false, final false
  static inline void NotifyDisconnectedObject(::System::Object* obj);

  /// @brief Method NotifyMarshaledObject, addr 0x184aab8, size 0x310, virtual false, abstract: false, final false
  static inline void NotifyMarshaledObject(::System::Object* obj, ::System::Runtime::Remoting::ObjRef* _cordl_or);

  /// @brief Method NotifyUnmarshaledObject, addr 0x184adc8, size 0x310, virtual false, abstract: false, final false
