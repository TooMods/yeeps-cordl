...
public:
  ...
  /// @brief Method TryGetAvailableDisplayRefreshRates, addr 0x21eb95c, size 0x1b8, virtual false, abstract: false, final false
  static inline bool TryGetAvailableDisplayRefreshRates(ByRef<::ArrayW<float_t, ::Array<float_t>*>> refreshRates);

  /// @brief Method TryGetDisplayRefreshRate, addr 0x21ebb20, size 0x4, virtual false, abstract: false, final false
  static inline bool TryGetDisplayRefreshRate(ByRef<float_t> refreshRate);

  /// @brief Method TrySetCPULevel, addr 0x21eb924, size 0x18, virtual false, abstract: false, final false
  static inline bool TrySetCPULevel(int32_t level);

  /// @brief Method TrySetDisplayRefreshRate, addr 0x21ebb18, size 0x4, virtual false, abstract: false, final false
  static inline bool TrySetDisplayRefreshRate(float_t refreshRate);

  /// @brief Method TrySetGPULevel, addr 0x21eb940, size 0x18, virtual false, abstract: false, final false
