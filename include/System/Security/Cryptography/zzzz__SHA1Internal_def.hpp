...
public:
  ...
  /// @brief Method AddLength, addr 0x196d9a4, size 0xf0, virtual false, abstract: false, final false
  inline void AddLength(uint64_t length, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t position);

  /// @brief Method FillBuff, addr 0x196d770, size 0x234, virtual false, abstract: false, final false
  static inline void FillBuff(::ArrayW<uint32_t, ::Array<uint32_t>*> buff);

  /// @brief Method HashCore, addr 0x196c824, size 0x100, virtual false, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x196ce3c, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method InitialiseBuff, addr 0x196d0d0, size 0x6a0, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x196c79c, size 0x88, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::System::Security::Cryptography::SHA1Internal* New_ctor();

  /// @brief Method ProcessBlock, addr 0x196c924, size 0x518, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inputBuffer, uint32_t inputOffset);

  /// @brief Method ProcessFinalBlock, addr 0x196cf14, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x196c700, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field BLOCK_SIZE_BYTES offset 0xffffffff size 0x4
  static constexpr int32_t BLOCK_SIZE_BYTES{ static_cast<int32_t>(0x40) };
