...
public:
  ...
  /// @brief Method SetExecutionContextHelper, addr 0x10edc40, size 0x8, virtual false, abstract: false, final false
  inline void SetExecutionContextHelper(::System::Threading::ExecutionContext* ec);

  /// @brief Method ThreadStart, addr 0x10ede54, size 0xf4, virtual false, abstract: false, final false
  inline void ThreadStart();

  /// @brief Method ThreadStart, addr 0x10edd54, size 0x100, virtual false, abstract: false, final false
  inline void ThreadStart(::System::Object* obj);

  /// @brief Method ThreadStart_Context, addr 0x10edc48, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10edc18, size 0x28, virtual false, abstract: false, final false
