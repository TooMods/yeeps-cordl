...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0xfc4fa4, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0xfc4fc4, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0xfc4f90, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::GlobalNamespace::__OVROverlay__ExternalSurfaceObjectCreated* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0xfc4ed4, size 0xbc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0xfc37e8, size 0x2f0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BlitSubImage, addr 0xfc28e4, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputePoseAndScale, addr 0xfc3e6c, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeSubmit, addr 0xfc41f4, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLayer, addr 0xfc0c88, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLayerTextures, addr 0xfc1098, size 0x548, virtual false, abstract: false, final false
  inline bool CreateLayerTextures(bool useMipmaps, ::GlobalNamespace::__OVRPlugin__Sizei size, bool isHdr);

  /// @brief Method DestroyLayer, addr 0xfc1704, size 0x2cc, virtual false, abstract: false, final false
  inline void DestroyLayer();

  /// @brief Method DestroyLayerTextures, addr 0xfc15e0, size 0x124, virtual false, abstract: false, final false
  inline void DestroyLayerTextures();

  /// @brief Method GetBlitRect, addr 0xfc2778, size 0x16c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetBlitRect(int32_t eyeId);

  /// @brief Method GetCurrentLayerDesc, addr 0xfc2280, size 0x4f8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__LayerDesc GetCurrentLayerDesc();

  /// @brief Method InitOVROverlay, addr 0xfc3bc4, size 0x16c, virtual false, abstract: false, final false
  inline void InitOVROverlay();

  /// @brief Method IsPassthroughShape, addr 0xfc0c30, size 0x58, virtual false, abstract: false, final false
  static inline bool IsPassthroughShape(::GlobalNamespace::__OVROverlay__OverlayShape shape);

  /// @brief Method LatchLayerTextures, addr 0xfc1e14, size 0x46c, virtual false, abstract: false, final false
  inline bool LatchLayerTextures();

  /// @brief Method LateUpdate, addr 0xfc4794, size 0x524, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method NeedsTexturesForShape, addr 0xfc0bd0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0xfc3e54, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0xfc3d30, size 0x124, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0xfc3b54, size 0x70, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OpenVROverlayUpdate, addr 0xfc4494, size 0x300, virtual false, abstract: false, final false
  inline void OpenVROverlayUpdate(::UnityEngine::Vector3 scale, ::GlobalNamespace::OVRPose pose);

  /// @brief Method OverrideOverlayTextureInfo, addr 0xfc0a1c, size 0xbc, virtual false, abstract: false, final false
  inline void OverrideOverlayTextureInfo(::UnityEngine::Texture* srcTexture, void* nativePtr, ::UnityEngine::XR::XRNode node);

  /// @brief Method PopulateLayer, addr 0xfc2ce8, size 0x698, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPerLayerColorScaleAndOffset, addr 0xfc1e00, size 0x14, virtual false, abstract: false, final false
  inline void SetPerLayerColorScaleAndOffset(::UnityEngine::Vector4 scale, ::UnityEngine::Vector4 offset);

  /// @brief Method SetSrcDestRects, addr 0xfc19d0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupEditorPreview, addr 0xfc0a18, size 0x4, virtual false, abstract: false, final false
  inline void SetupEditorPreview();

  /// @brief Method SubmitLayer, addr 0xfc3380, size 0x468, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateTextureRectMatrix, addr 0xfc19ec, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc4cb8, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_OpenVROverlayKey, addr 0xfc3ad8, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW get_OpenVROverlayKey();

  /// @brief Method get_layerId, addr 0xfc0ad8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layerId();

  /// @brief Method get_layout, addr 0xfc0ae8, size 0xcc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__LayerLayout get_layout();

  /// @brief Method get_previewInEditor, addr 0xfc09f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_previewInEditor();

  /// @brief Method get_texturesPerStage, addr 0xfc0bb4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_layerId, addr 0xfc0ae0, size 0x8, virtual false, abstract: false, final false
  inline void set_layerId(int32_t value);

  /// @brief Method set_previewInEditor, addr 0xfc0a00, size 0x18, virtual false, abstract: false, final false
