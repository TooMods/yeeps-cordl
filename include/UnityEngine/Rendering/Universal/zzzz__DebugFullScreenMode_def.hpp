...
// Type: UnityEngine.Rendering.Universal::DebugFullScreenMode
...
public:
  ...
  enum struct __DebugFullScreenMode_Unwrapped : int32_t {
    ...
    __E_AdditionalLightsShadowMap = static_cast<int32_t>(0x2),
    __E_MainLightShadowMap = static_cast<int32_t>(0x3),
  };
  ...
  /// @brief Field AdditionalLightsShadowMap value: static_cast<int32_t>(0x2)
  ...
  /// @brief Field MainLightShadowMap value: static_cast<int32_t>(0x3)
