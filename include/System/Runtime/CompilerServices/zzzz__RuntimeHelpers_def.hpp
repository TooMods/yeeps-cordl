...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x1b46eb4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetHashCode(::System::Object* o);

  /// @brief Method GetObjectValue, addr 0x1b46ebc, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Object* GetObjectValue(::System::Object* obj);

  /// @brief Method InitializeArray, addr 0x1b46e0c, size 0xa8, virtual false, abstract: false, final false
  static inline void InitializeArray(::System::Array* array, ::System::RuntimeFieldHandle fldHandle);

  /// @brief Method InitializeArray, addr 0x1b46e08, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareConstrainedRegions, addr 0x1b46f8c, size 0x4, virtual false, abstract: false, final false
  static inline void PrepareConstrainedRegions();

  /// @brief Method RunClassConstructor, addr 0x1b46ec4, size 0xc0, virtual false, abstract: false, final false
  static inline void RunClassConstructor(::System::RuntimeTypeHandle type);

  /// @brief Method RunClassConstructor, addr 0x1b46ec0, size 0x4, virtual false, abstract: false, final false
  static inline void RunClassConstructor(void* type);

  /// @brief Method SufficientExecutionStack, addr 0x1b46f84, size 0x4, virtual false, abstract: false, final false
  static inline bool SufficientExecutionStack();

  /// @brief Method TryEnsureSufficientExecutionStack, addr 0x1b46f88, size 0x4, virtual false, abstract: false, final false
  static inline bool TryEnsureSufficientExecutionStack();

  /// @brief Method get_OffsetToStringData, addr 0x1b42648, size 0x4, virtual false, abstract: false, final false
