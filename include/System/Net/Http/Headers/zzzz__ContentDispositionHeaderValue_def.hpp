...
public:
  ...
  /// @brief Method Equals, addr 0x16221b4, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x162227c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x1622154, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x16222f8, size 0x58, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x1622350, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1621e20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1621e28, size 0x278, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::ContentDispositionHeaderValue* source);

  /// @brief Method get_Parameters, addr 0x16220a0, size 0x80, virtual false, abstract: false, final false
