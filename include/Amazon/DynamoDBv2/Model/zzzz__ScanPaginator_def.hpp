...
#include <cstdint>
CORDL_MODULE_EXPORT(ScanPaginator)
...
public:
  ...
  __declspec(property(get = __cordl_internal_get___2__current, put = __cordl_internal_set___2__current))::Amazon::DynamoDBv2::Model::ScanResponse* __2__current;
  ...
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this))::Amazon::DynamoDBv2::Model::ScanPaginator* __4__this;
  ...
  constexpr operator ::System::Collections::Generic::IAsyncEnumerable_1<::Amazon::DynamoDBv2::Model::ScanResponse*>*() noexcept;

  /// @brief Convert operator to "::System::Collections::Generic::IAsyncEnumerator_1<::Amazon::DynamoDBv2::Model::ScanResponse*>"
  constexpr operator ::System::Collections::Generic::IAsyncEnumerator_1<::Amazon::DynamoDBv2::Model::ScanResponse*>*() noexcept;
  ...
  /// @brief Method System.Collections.Generic.IAsyncEnumerator<Amazon.DynamoDBv2.Model.ScanResponse>.MoveNextAsync, addr 0x1058354, size 0x138, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask_1<bool> System_Collections_Generic_IAsyncEnumerator_Amazon_DynamoDBv2_Model_ScanResponse__MoveNextAsync();

  /// @brief Method System.Collections.Generic.IAsyncEnumerator<Amazon.DynamoDBv2.Model.ScanResponse>.get_Current, addr 0x105848c, size 0x8, virtual true, abstract: false, final true
  inline ::Amazon::DynamoDBv2::Model::ScanResponse* System_Collections_Generic_IAsyncEnumerator_Amazon_DynamoDBv2_Model_ScanResponse__get_Current();

  /// @brief Method System.IAsyncDisposable.DisposeAsync, addr 0x10586e4, size 0xfc, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask System_IAsyncDisposable_DisposeAsync();

  /// @brief Method System.Threading.Tasks.Sources.IValueTaskSource.GetResult, addr 0x10585bc, size 0x58, virtual true, abstract: false, final true
  inline void System_Threading_Tasks_Sources_IValueTaskSource_GetResult(int16_t token);

  /// @brief Method System.Threading.Tasks.Sources.IValueTaskSource.GetStatus, addr 0x1058614, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Threading.Tasks.Sources.IValueTaskSource<System.Boolean>.GetStatus, addr 0x10584ec, size 0x58, virtual true, abstract: false, final true
  ...
  constexpr ::Amazon::DynamoDBv2::Model::ScanResponse*& __cordl_internal_get___2__current();

  constexpr ::cordl_internals::to_const_pointer<::Amazon::DynamoDBv2::Model::ScanResponse*> const& __cordl_internal_get___2__current() const;
  ...
  constexpr ::Amazon::DynamoDBv2::Model::ScanPaginator*& __cordl_internal_get___4__this();

  constexpr ::cordl_internals::to_const_pointer<::Amazon::DynamoDBv2::Model::ScanPaginator*> const& __cordl_internal_get___4__this() const;
  ...
  constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::DynamoDBv2::Model::ScanResponse*> const& __cordl_internal_get___u__1() const;

  constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::DynamoDBv2::Model::ScanResponse*>& __cordl_internal_get___u__1();
  ...
  constexpr void __cordl_internal_set___u__1(::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::DynamoDBv2::Model::ScanResponse*> value);
  ...
  /// @brief Method .ctor, addr 0x1057e30, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  ::Amazon::DynamoDBv2::Model::ScanResponse* _____2__current;
  ...
  ::Amazon::DynamoDBv2::Model::ScanPaginator* _____4__this;
  ...
  ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Amazon::DynamoDBv2::Model::ScanResponse*> _____u__1;
...
namespace Amazon::DynamoDBv2::Model {
// Is value type: false
// CS Name: ::Amazon.DynamoDBv2.Model::ScanPaginator*
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__request, put = __cordl_internal_set__request))::Amazon::DynamoDBv2::Model::ScanRequest* _request;

  /// @brief Convert operator to "::Amazon::DynamoDBv2::Model::IScanPaginator"
  constexpr operator ::Amazon::DynamoDBv2::Model::IScanPaginator*() noexcept;

  /// @brief Convert operator to "::Amazon::Runtime::IPaginator_1<::Amazon::DynamoDBv2::Model::ScanResponse*>"
  constexpr operator ::Amazon::Runtime::IPaginator_1<::Amazon::DynamoDBv2::Model::ScanResponse*>*() noexcept;

  /// @brief Method Amazon.Runtime.IPaginator<Amazon.DynamoDBv2.Model.ScanResponse>.PaginateAsync, addr 0x1057dbc, size 0x74, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IAsyncEnumerable_1<::Amazon::DynamoDBv2::Model::ScanResponse*>*
  Amazon_Runtime_IPaginator_Amazon_DynamoDBv2_Model_ScanResponse__PaginateAsync(::System::Threading::CancellationToken cancellationToken);

  static inline ::Amazon::DynamoDBv2::Model::ScanPaginator* New_ctor(::Amazon::DynamoDBv2::IAmazonDynamoDB* client, ::Amazon::DynamoDBv2::Model::ScanRequest* request);
  ...
  constexpr ::Amazon::DynamoDBv2::Model::ScanRequest*& __cordl_internal_get__request();

  constexpr ::cordl_internals::to_const_pointer<::Amazon::DynamoDBv2::Model::ScanRequest*> const& __cordl_internal_get__request() const;
  ...
  constexpr void __cordl_internal_set__request(::Amazon::DynamoDBv2::Model::ScanRequest* value);

  /// @brief Method .ctor, addr 0x105665c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Amazon::DynamoDBv2::IAmazonDynamoDB* client, ::Amazon::DynamoDBv2::Model::ScanRequest* request);

  /// @brief Method get_Responses, addr 0x1057d44, size 0x78, virtual true, abstract: false, final true
  ...
  constexpr ::Amazon::DynamoDBv2::Model::IScanPaginator* i___Amazon__DynamoDBv2__Model__IScanPaginator() noexcept;

  /// @brief Convert to "::Amazon::Runtime::IPaginator_1<::Amazon::DynamoDBv2::Model::ScanResponse*>"
  constexpr ::Amazon::Runtime::IPaginator_1<::Amazon::DynamoDBv2::Model::ScanResponse*>* i___Amazon__Runtime__IPaginator_1___Amazon__DynamoDBv2__Model__ScanResponse__() noexcept;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ScanPaginator();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ScanPaginator", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScanPaginator(ScanPaginator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScanPaginator", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScanPaginator(ScanPaginator const&) = delete;
  ...
  ::Amazon::DynamoDBv2::Model::ScanRequest* ____request;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Amazon::DynamoDBv2::Model::ScanPaginator, 0x28>, "Size mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ScanPaginator, ____client) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ScanPaginator, ____request) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Amazon::DynamoDBv2::Model::ScanPaginator, ____isPaginatorInUse) == 0x20, "Offset mismatch!");
