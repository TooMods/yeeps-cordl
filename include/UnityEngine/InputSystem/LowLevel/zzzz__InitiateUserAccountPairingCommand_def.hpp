...
public:
  ...
  /// @brief Method Create, addr 0x1e01dac, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1e01d4c, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1e01d7c, size 0x30, virtual true, abstract: false, final true
