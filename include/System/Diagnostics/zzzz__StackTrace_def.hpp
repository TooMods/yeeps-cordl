...
public:
  ...
  /// @brief Method AddFrames, addr 0x21c5b3c, size 0x4b0, virtual false, abstract: false, final false
  inline bool AddFrames(::System::Text::StringBuilder* sb, bool separator, ByRef<bool> isAsync);

  /// @brief Method ConvertAsyncStateMachineMethod, addr 0x21c6644, size 0x460, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAotId, addr 0x21c5a74, size 0xc8, virtual false, abstract: false, final false
  static inline ::StringW GetAotId();

  /// @brief Method GetFrame, addr 0x21c5a14, size 0x60, virtual true, abstract: false, final false
  inline ::System::Diagnostics::StackFrame* GetFrame(int32_t index);

  /// @brief Method GetFullNameForStackTrace, addr 0x21c5fec, size 0x658, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x21c6aa4, size 0x15c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x21c6c00, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c5674, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x21c5900, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, bool fNeedFileInfo);

  /// @brief Method .ctor, addr 0x21c590c, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, int32_t skipFrames, bool fNeedFileInfo);

  /// @brief Method .ctor, addr 0x21c5894, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool fNeedFileInfo);

  /// @brief Method .ctor, addr 0x21c58c4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FrameCount, addr 0x21c59fc, size 0x18, virtual true, abstract: false, final false
  inline int32_t get_FrameCount();

  /// @brief Method get_trace, addr 0x21c58f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method init_frames, addr 0x21c5698, size 0x1fc, virtual false, abstract: false, final false
