...
public:
  ...
  /// @brief Method <ActiveToggles>b__14_0, addr 0x2914e90, size 0x18, virtual false, abstract: false, final false
  inline bool _ActiveToggles_b__14_0(::UnityEngine::UI::Toggle* x);

  /// @brief Method <AnyTogglesOn>b__13_0, addr 0x2914e78, size 0x18, virtual false, abstract: false, final false
  inline bool _AnyTogglesOn_b__13_0(::UnityEngine::UI::Toggle* x);

  /// @brief Method .ctor, addr 0x2914e70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActiveToggles, addr 0x2914b98, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::UI::Toggle>>* ActiveToggles();

  /// @brief Method AnyTogglesOn, addr 0x29147b0, size 0x13c, virtual false, abstract: false, final false
  inline bool AnyTogglesOn();

  /// @brief Method EnsureValidState, addr 0x2913e50, size 0x3ec, virtual false, abstract: false, final false
  inline void EnsureValidState();

  /// @brief Method GetFirstActiveToggle, addr 0x2914c94, size 0x88, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Toggle> GetFirstActiveToggle();

  static inline ::UnityEngine::UI::ToggleGroup* New_ctor();

  /// @brief Method NotifyToggleOn, addr 0x2914684, size 0x10c, virtual false, abstract: false, final false
  inline void NotifyToggleOn(::UnityEngine::UI::Toggle* toggle, bool sendCallback);

  /// @brief Method OnEnable, addr 0x2914a24, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterToggle, addr 0x29145b0, size 0xd4, virtual false, abstract: false, final false
  inline void RegisterToggle(::UnityEngine::UI::Toggle* toggle);

  /// @brief Method SetAllTogglesOff, addr 0x2914d1c, size 0xf0, virtual false, abstract: false, final false
  inline void SetAllTogglesOff(bool sendCallback);

  /// @brief Method Start, addr 0x2914a08, size 0x1c, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterToggle, addr 0x2914520, size 0x90, virtual false, abstract: false, final false
  inline void UnregisterToggle(::UnityEngine::UI::Toggle* toggle);

  /// @brief Method ValidateToggleIsInGroup, addr 0x2914a40, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x291498c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowSwitchOff, addr 0x2914978, size 0x8, virtual false, abstract: false, final false
  inline bool get_allowSwitchOff();

  /// @brief Method set_allowSwitchOff, addr 0x2914980, size 0xc, virtual false, abstract: false, final false
