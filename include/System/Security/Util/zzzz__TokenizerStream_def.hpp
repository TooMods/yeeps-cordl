...
public:
  ...
  /// @brief Method AddString, addr 0x1ea7f10, size 0xf0, virtual false, abstract: false, final false
  inline void AddString(::StringW str);

  /// @brief Method AddToken, addr 0x1ea7e10, size 0xe8, virtual false, abstract: false, final false
  inline void AddToken(int16_t token);

  /// @brief Method GetNextFullToken, addr 0x1ea7b44, size 0x70, virtual false, abstract: false, final false
  inline int16_t GetNextFullToken();

  /// @brief Method GetNextString, addr 0x1ea6af8, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW GetNextString();

  /// @brief Method GetNextToken, addr 0x1ea6a6c, size 0x14, virtual false, abstract: false, final false
  inline int16_t GetNextToken();

  /// @brief Method GetTokenCount, addr 0x1ea82e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetTokenCount();

  /// @brief Method GoToPosition, addr 0x1ea74f4, size 0x60, virtual false, abstract: false, final false
  inline void GoToPosition(int32_t position);

  static inline ::System::Security::Util::TokenizerStream* New_ctor();

  /// @brief Method Reset, addr 0x1ea7b28, size 0x1c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method TagLastToken, addr 0x1ea6a84, size 0x74, virtual false, abstract: false, final false
  inline void TagLastToken(int16_t tag);

  /// @brief Method ThrowAwayNextString, addr 0x1ea6a80, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea7a80, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
