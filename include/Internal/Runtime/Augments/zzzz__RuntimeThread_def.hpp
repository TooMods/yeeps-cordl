...
public:
  ...
  /// @brief Method Create, addr 0x28a7f60, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcessorId, addr 0x28a8068, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Sleep, addr 0x28a8040, size 0x8, virtual false, abstract: false, final false
  static inline void Sleep(int32_t millisecondsTimeout);

  /// @brief Method SpinWait, addr 0x28a8050, size 0x18, virtual false, abstract: false, final false
  static inline bool SpinWait(int32_t iterations);

  /// @brief Method Start, addr 0x28a8024, size 0x1c, virtual false, abstract: false, final false
  inline void Start(::System::Object* state);

  /// @brief Method Yield, addr 0x28a8048, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a7f38, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsBackground, addr 0x28a8004, size 0x20, virtual false, abstract: false, final false
