...
public:
  ...
  /// @brief Method <SortCharacterTable>b__144_0, addr 0x23afd50, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortCharacterTable_b__144_0(::UnityEngine::TextCore::Text::Character* c);

  /// @brief Method <SortGlyphTable>b__145_0, addr 0x23afd68, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphTable_b__145_0(::UnityEngine::TextCore::Glyph* c);

  /// @brief Method .ctor, addr 0x23afd48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddCharacterToLookupCache, addr 0x23a9edc, size 0x68, virtual false, abstract: false, final false
  inline void AddCharacterToLookupCache(uint32_t unicode, ::UnityEngine::TextCore::Text::Character* character);

  /// @brief Method AddSynthesizedCharacter, addr 0x23a9c28, size 0x254, virtual false, abstract: false, final false
  inline void AddSynthesizedCharacter(uint32_t unicode, bool isFontFaceLoaded, bool addImmediately);

  /// @brief Method AddSynthesizedCharactersAndFaceMetrics, addr 0x23a92c8, size 0x1d8, virtual false, abstract: false, final false
  inline void AddSynthesizedCharactersAndFaceMetrics();

  /// @brief Method Awake, addr 0x23a917c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClearAtlasTextures, addr 0x23af3f8, size 0x1f4, virtual false, abstract: false, final false
  inline void ClearAtlasTextures(bool setAtlasSizeToZero);

  /// @brief Method ClearFontAssetData, addr 0x23af1d0, size 0x30, virtual false, abstract: false, final false
  inline void ClearFontAssetData(bool setAtlasSizeToZero);

  /// @brief Method ClearFontAssetDataInternal, addr 0x23af5ec, size 0x1c, virtual false, abstract: false, final false
  inline void ClearFontAssetDataInternal();

  /// @brief Method ClearFontAssetTables, addr 0x23af200, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x23a85e0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x23a8e2c, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> CreateFontAsset(::UnityEngine::Font* font);

  /// @brief Method CreateFontAsset, addr 0x23a8f68, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x23a8ea8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x23a8854, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAssetInstance, addr 0x23a89d0, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAtlasTextures, addr 0x23a91e4, size 0xc4, virtual false, abstract: false, final false
  inline void DestroyAtlasTextures();

  /// @brief Method GetCharacters, addr 0x23abb98, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW GetCharacters(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method GetCharactersArray, addr 0x23abc78, size 0xe4, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCharactersArray(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method GetGlyphIndex, addr 0x23abd5c, size 0xdc, virtual false, abstract: false, final false
  inline uint32_t GetGlyphIndex(uint32_t unicode);

  /// @brief Method HasCharacter, addr 0x23aa448, size 0x31c, virtual false, abstract: false, final false
  inline bool HasCharacter(char16_t character, bool searchFallbacks, bool tryAddCharacter);

  /// @brief Method HasCharacter, addr 0x23aa3e8, size 0x60, virtual false, abstract: false, final false
  inline bool HasCharacter(int32_t character);

  /// @brief Method HasCharacter_Internal, addr 0x23ab2d8, size 0x224, virtual false, abstract: false, final false
  inline bool HasCharacter_Internal(uint32_t character, bool searchFallbacks, bool tryAddCharacter);

  /// @brief Method HasCharacters, addr 0x23abae4, size 0xb4, virtual false, abstract: false, final false
  inline bool HasCharacters(::StringW text);

  /// @brief Method HasCharacters, addr 0x23ab6a4, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCharacters, addr 0x23ab4fc, size 0x1a8, virtual false, abstract: false, final false
  inline bool HasCharacters(::StringW text, ByRef<::System::Collections::Generic::List_1<char16_t>*> missingCharacters);

  /// @brief Method InitializeCharacterLookupDictionary, addr 0x23a9730, size 0x19c, virtual false, abstract: false, final false
  inline void InitializeCharacterLookupDictionary();

  /// @brief Method InitializeDictionaryLookupTables, addr 0x23a92a8, size 0x20, virtual false, abstract: false, final false
  inline void InitializeDictionaryLookupTables();

  /// @brief Method InitializeGlyphLookupDictionary, addr 0x23a94a8, size 0x288, virtual false, abstract: false, final false
  inline void InitializeGlyphLookupDictionary();

  /// @brief Method InitializeGlyphPaidAdjustmentRecordsLookupDictionary, addr 0x23a98cc, size 0x23c, virtual false, abstract: false, final false
  inline void InitializeGlyphPaidAdjustmentRecordsLookupDictionary();

  /// @brief Method LoadFontFace, addr 0x23a9b20, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x23a9180, size 0x64, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ReadFontAssetDefinition, addr 0x23a8044, size 0x380, virtual false, abstract: false, final false
  inline void ReadFontAssetDefinition();

  /// @brief Method RegisterAtlasTextureForApply, addr 0x23ac434, size 0x12c, virtual false, abstract: false, final false
  static inline void RegisterAtlasTextureForApply(::UnityEngine::Texture2D* texture);

  /// @brief Method RegisterFontAssetForFontFeatureUpdate, addr 0x23abe38, size 0x12c, virtual false, abstract: false, final false
  static inline void RegisterFontAssetForFontFeatureUpdate(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method SetupNewAtlasTexture, addr 0x23ae4b8, size 0x230, virtual false, abstract: false, final false
  inline void SetupNewAtlasTexture();

  /// @brief Method SortAllTables, addr 0x23aa3c0, size 0x28, virtual false, abstract: false, final false
  inline void SortAllTables();

  /// @brief Method SortCharacterTable, addr 0x23a9f44, size 0x13c, virtual false, abstract: false, final false
  inline void SortCharacterTable();

  /// @brief Method SortFontFeatureTable, addr 0x23aa1bc, size 0x18, virtual false, abstract: false, final false
  inline void SortFontFeatureTable();

  /// @brief Method SortGlyphTable, addr 0x23aa080, size 0x13c, virtual false, abstract: false, final false
  inline void SortGlyphTable();

  /// @brief Method TryAddCharacterInternal, addr 0x23aa764, size 0xb74, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddCharacters, addr 0x23ad814, size 0x20, virtual false, abstract: false, final false
  inline bool TryAddCharacters(::StringW characters, bool includeFontFeatures);

  /// @brief Method TryAddCharacters, addr 0x23ad834, size 0xbac, virtual false, abstract: false, final false
  inline bool TryAddCharacters(::StringW characters, ByRef<::StringW> missingCharacters, bool includeFontFeatures);

  /// @brief Method TryAddCharacters, addr 0x23ac734, size 0x20, virtual false, abstract: false, final false
  inline bool TryAddCharacters(::ArrayW<uint32_t, ::Array<uint32_t>*> unicodes, bool includeFontFeatures);

  /// @brief Method TryAddCharacters, addr 0x23ac754, size 0xbf4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToAtlasTextures, addr 0x23aec5c, size 0x4, virtual false, abstract: false, final false
  inline void TryAddGlyphsToAtlasTextures();

  /// @brief Method TryAddGlyphsToNewAtlasTexture, addr 0x23ad388, size 0x48c, virtual false, abstract: false, final false
  inline bool TryAddGlyphsToNewAtlasTexture();

  /// @brief Method TryGetCharacter_and_QueueRenderToTexture, addr 0x23ae6e8, size 0x574, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateAtlasTexture, addr 0x23aec60, size 0x174, virtual false, abstract: false, final false
  inline void UpdateAtlasTexture();

  /// @brief Method UpdateAtlasTexturesInQueue, addr 0x23ac560, size 0x184, virtual false, abstract: false, final false
  static inline void UpdateAtlasTexturesInQueue();

  /// @brief Method UpdateFontAssetData, addr 0x23af608, size 0x124, virtual false, abstract: false, final false
  inline void UpdateFontAssetData();

  /// @brief Method UpdateFontAssetInUpdateQueue, addr 0x23ac6e4, size 0x50, virtual false, abstract: false, final false
  static inline void UpdateFontAssetInUpdateQueue();

  /// @brief Method UpdateFontFeaturesForFontAssetsInQueue, addr 0x23abf64, size 0x178, virtual false, abstract: false, final false
  static inline void UpdateFontFeaturesForFontAssetsInQueue();

  /// @brief Method UpdateGlyphAdjustmentRecords, addr 0x23ac0dc, size 0x358, virtual false, abstract: false, final false
  inline void UpdateGlyphAdjustmentRecords();

  /// @brief Method UpdateGlyphAdjustmentRecords, addr 0x23aee98, size 0x330, virtual false, abstract: false, final false
  inline void UpdateGlyphAdjustmentRecords(::ArrayW<uint32_t, ::Array<uint32_t>*> glyphIndexes);

  /// @brief Method UpdateGlyphAdjustmentRecords, addr 0x23af1c8, size 0x4, virtual false, abstract: false, final false
  inline void UpdateGlyphAdjustmentRecords(::System::Collections::Generic::List_1<uint32_t>* glyphIndexes);

  /// @brief Method UpdateGlyphAdjustmentRecords, addr 0x23af1cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23af734, size 0x2a8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_atlasHeight, addr 0x23a84dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasHeight();

  /// @brief Method get_atlasPadding, addr 0x23a84ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasPadding();

  /// @brief Method get_atlasPopulationMode, addr 0x23a7ee4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::AtlasPopulationMode get_atlasPopulationMode();

  /// @brief Method get_atlasRenderMode, addr 0x23a84fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::LowLevel::GlyphRenderMode get_atlasRenderMode();

  /// @brief Method get_atlasTexture, addr 0x23a83f8, size 0x90, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_atlasTexture();

  /// @brief Method get_atlasTextureCount, addr 0x23a8498, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_atlasTextureCount();

  /// @brief Method get_atlasTextures, addr 0x23a8488, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Texture2D>, ::Array<::UnityW<::UnityEngine::Texture2D>>*> get_atlasTextures();

  /// @brief Method get_atlasWidth, addr 0x23a84cc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasWidth();

  /// @brief Method get_boldStyleSpacing, addr 0x23a85b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_boldStyleSpacing();

  /// @brief Method get_boldStyleWeight, addr 0x23a85a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_boldStyleWeight();

  /// @brief Method get_characterLookupTable, addr 0x23a83d4, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<uint32_t, ::UnityEngine::TextCore::Text::Character*>* get_characterLookupTable();

  /// @brief Method get_characterTable, addr 0x23a83c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::Character*>* get_characterTable();

  /// @brief Method get_clearDynamicDataOnBuild, addr 0x23a84b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_clearDynamicDataOnBuild();

  /// @brief Method get_faceInfo, addr 0x23a7ef4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::FaceInfo get_faceInfo();

  /// @brief Method get_fallbackFontAssetTable, addr 0x23a853c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>* get_fallbackFontAssetTable();

  /// @brief Method get_familyNameHashCode, addr 0x23a7f28, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_familyNameHashCode();

  /// @brief Method get_fontAssetCreationEditorSettings, addr 0x23a854c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::FontAssetCreationEditorSettings get_fontAssetCreationEditorSettings();

  /// @brief Method get_fontFeatureTable, addr 0x23a852c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::FontFeatureTable* get_fontFeatureTable();

  /// @brief Method get_fontWeightTable, addr 0x23a8000, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_freeGlyphRects, addr 0x23a851c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::GlyphRect>* get_freeGlyphRects();

  /// @brief Method get_glyphLookupTable, addr 0x23a8020, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<uint32_t, ::UnityEngine::TextCore::Glyph*>* get_glyphLookupTable();

  /// @brief Method get_glyphTable, addr 0x23a8010, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Glyph*>* get_glyphTable();

  /// @brief Method get_isMultiAtlasTexturesEnabled, addr 0x23a84a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isMultiAtlasTexturesEnabled();

  /// @brief Method get_italicStyleSlant, addr 0x23a85c0, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_italicStyleSlant();

  /// @brief Method get_regularStyleSpacing, addr 0x23a8590, size 0x8, virtual false, abstract: false, final false
  inline float_t get_regularStyleSpacing();

  /// @brief Method get_regularStyleWeight, addr 0x23a8580, size 0x8, virtual false, abstract: false, final false
  inline float_t get_regularStyleWeight();

  /// @brief Method get_sourceFontFile, addr 0x23a7ed4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> get_sourceFontFile();

  /// @brief Method get_styleNameHashCode, addr 0x23a7fcc, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_styleNameHashCode();

  /// @brief Method get_tabMultiple, addr 0x23a85d0, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_tabMultiple();

  /// @brief Method get_usedGlyphRects, addr 0x23a850c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atlasHeight, addr 0x23a84e4, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasHeight(int32_t value);

  /// @brief Method set_atlasPadding, addr 0x23a84f4, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasPadding(int32_t value);

  /// @brief Method set_atlasPopulationMode, addr 0x23a7eec, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasPopulationMode(::UnityEngine::TextCore::Text::AtlasPopulationMode value);

  /// @brief Method set_atlasRenderMode, addr 0x23a8504, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasRenderMode(::UnityEngine::TextCore::LowLevel::GlyphRenderMode value);

  /// @brief Method set_atlasTextures, addr 0x23a8490, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasTextures(::ArrayW<::UnityEngine::Texture2D*, ::Array<::UnityEngine::Texture2D*>*> value);

  /// @brief Method set_atlasWidth, addr 0x23a84d4, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasWidth(int32_t value);

  /// @brief Method set_boldStyleSpacing, addr 0x23a85b8, size 0x8, virtual false, abstract: false, final false
  inline void set_boldStyleSpacing(float_t value);

  /// @brief Method set_boldStyleWeight, addr 0x23a85a8, size 0x8, virtual false, abstract: false, final false
  inline void set_boldStyleWeight(float_t value);

  /// @brief Method set_characterTable, addr 0x23a83cc, size 0x8, virtual false, abstract: false, final false
  inline void set_characterTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::Character*>* value);

  /// @brief Method set_clearDynamicDataOnBuild, addr 0x23a84c0, size 0xc, virtual false, abstract: false, final false
  inline void set_clearDynamicDataOnBuild(bool value);

  /// @brief Method set_faceInfo, addr 0x23a7f10, size 0x18, virtual false, abstract: false, final false
  inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo value);

  /// @brief Method set_fallbackFontAssetTable, addr 0x23a8544, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_familyNameHashCode, addr 0x23a7fc4, size 0x8, virtual false, abstract: false, final false
  inline void set_familyNameHashCode(int32_t value);

  /// @brief Method set_fontAssetCreationEditorSettings, addr 0x23a8568, size 0x18, virtual false, abstract: false, final false
  inline void set_fontAssetCreationEditorSettings(::UnityEngine::TextCore::Text::FontAssetCreationEditorSettings value);

  /// @brief Method set_fontFeatureTable, addr 0x23a8534, size 0x8, virtual false, abstract: false, final false
  inline void set_fontFeatureTable(::UnityEngine::TextCore::Text::FontFeatureTable* value);

  /// @brief Method set_fontWeightTable, addr 0x23a8008, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_freeGlyphRects, addr 0x23a8524, size 0x8, virtual false, abstract: false, final false
  inline void set_freeGlyphRects(::System::Collections::Generic::List_1<::UnityEngine::TextCore::GlyphRect>* value);

  /// @brief Method set_glyphTable, addr 0x23a8018, size 0x8, virtual false, abstract: false, final false
  inline void set_glyphTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Glyph*>* value);

  /// @brief Method set_isMultiAtlasTexturesEnabled, addr 0x23a84ac, size 0xc, virtual false, abstract: false, final false
  inline void set_isMultiAtlasTexturesEnabled(bool value);

  /// @brief Method set_italicStyleSlant, addr 0x23a85c8, size 0x8, virtual false, abstract: false, final false
  inline void set_italicStyleSlant(uint8_t value);

  /// @brief Method set_regularStyleSpacing, addr 0x23a8598, size 0x8, virtual false, abstract: false, final false
  inline void set_regularStyleSpacing(float_t value);

  /// @brief Method set_regularStyleWeight, addr 0x23a8588, size 0x8, virtual false, abstract: false, final false
  inline void set_regularStyleWeight(float_t value);

  /// @brief Method set_sourceFontFile, addr 0x23a7edc, size 0x8, virtual false, abstract: false, final false
  inline void set_sourceFontFile(::UnityEngine::Font* value);

  /// @brief Method set_styleNameHashCode, addr 0x23a7ff8, size 0x8, virtual false, abstract: false, final false
  inline void set_styleNameHashCode(int32_t value);

  /// @brief Method set_tabMultiple, addr 0x23a85d8, size 0x8, virtual false, abstract: false, final false
  inline void set_tabMultiple(uint8_t value);

  /// @brief Method set_usedGlyphRects, addr 0x23a8514, size 0x8, virtual false, abstract: false, final false
