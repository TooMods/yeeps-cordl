...
public:
  ...
  /// @brief Method GetBuiltInComplexType, addr 0x18b4bdc, size 0x24c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* GetBuiltInComplexType(::System::Xml::XmlQualifiedName* qualifiedName);

  /// @brief Method GetBuiltInSimpleType, addr 0x18b4aa8, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetBuiltInSimpleType(::System::Xml::XmlQualifiedName* qualifiedName);

  /// @brief Method GetBuiltInSimpleType, addr 0x18b4b84, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetBuiltInSimpleType(::System::Xml::Schema::XmlTypeCode typeCode);

  /// @brief Method IsDerivedFrom, addr 0x18b5040, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDerivedFromDatatype, addr 0x18b5238, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBaseSchemaType, addr 0x18b4fd4, size 0x8, virtual false, abstract: false, final false
  inline void SetBaseSchemaType(::System::Xml::Schema::XmlSchemaType* value);

  /// @brief Method SetContentType, addr 0x18b5038, size 0x8, virtual false, abstract: false, final false
  inline void SetContentType(::System::Xml::Schema::XmlSchemaContentType value);

  /// @brief Method SetDatatype, addr 0x18b4fe4, size 0x8, virtual false, abstract: false, final false
  inline void SetDatatype(::System::Xml::Schema::XmlSchemaDatatype* value);

  /// @brief Method SetDerivedBy, addr 0x18b4fdc, size 0x8, virtual false, abstract: false, final false
  inline void SetDerivedBy(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetFinalResolved, addr 0x18b4fcc, size 0x8, virtual false, abstract: false, final false
  inline void SetFinalResolved(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetQualifiedName, addr 0x18b4fa8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18b4234, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseXmlSchemaType, addr 0x18b4e50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_BaseXmlSchemaType();

  /// @brief Method get_Datatype, addr 0x18b4e60, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* get_Datatype();

  /// @brief Method get_DerivedBy, addr 0x18b4e58, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_DerivedBy();

  /// @brief Method get_ElementDecl, addr 0x18b4fec, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* get_ElementDecl();

  /// @brief Method get_Final, addr 0x18b4e38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Final();

  /// @brief Method get_FinalResolved, addr 0x18b4e48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_FinalResolved();

  /// @brief Method get_IsMixed, addr 0x18b4e68, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method get_Name, addr 0x18b4e28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x18b530c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_QualifiedName, addr 0x18b3d54, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_Redefined, addr 0x18b5028, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_Redefined();

  /// @brief Method get_SchemaContentType, addr 0x18b4fa0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_SchemaContentType();

  /// @brief Method get_TypeCode, addr 0x18b4e74, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueConverter, addr 0x18b4f28, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* get_ValueConverter();

  /// @brief Method set_ElementDecl, addr 0x18b5004, size 0x24, virtual false, abstract: false, final false
  inline void set_ElementDecl(::System::Xml::Schema::SchemaElementDecl* value);

  /// @brief Method set_Final, addr 0x18b4e40, size 0x8, virtual false, abstract: false, final false
  inline void set_Final(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_IsMixed, addr 0x18b4e70, size 0x4, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method set_Name, addr 0x18b4e30, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x18b5314, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Redefined, addr 0x18b5030, size 0x8, virtual false, abstract: false, final false
