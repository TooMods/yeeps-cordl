...
public:
  ...
  /// @brief Method Awake, addr 0x149439c, size 0x200, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetUuidsToQuery, addr 0x14946b0, size 0x64c, virtual false, abstract: false, final false
  inline void GetUuidsToQuery();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x149459c, size 0x114, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  /// @brief Method LoadRoom, addr 0x148d3a0, size 0xf0, virtual false, abstract: false, final false
  inline void LoadRoom();

  static inline ::GlobalNamespace::OVRSceneRoom* New_ctor();

  /// @brief Method OnDestroy, addr 0x14958a8, size 0xb8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnFetchAnchorsCompleted, addr 0x1494cfc, size 0x3d4, virtual false, abstract: false, final false
  inline void OnFetchAnchorsCompleted(bool success);

  /// @brief Method OnLocalizationCompleted, addr 0x14950d0, size 0x3a4, virtual false, abstract: false, final false
  inline void OnLocalizationCompleted(bool success, ::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method UpdateRoomInformation, addr 0x1495474, size 0x434, virtual false, abstract: false, final false
  inline void UpdateRoomInformation(::GlobalNamespace::OVRScenePlane* plane);

  /// @brief Method <Awake>b__24_0, addr 0x1495bb4, size 0x60, virtual false, abstract: false, final false
  inline int32_t _Awake_b__24_0(::GlobalNamespace::OVRScenePlane* planeA, ::GlobalNamespace::OVRScenePlane* planeB);

  /// @brief Method <Awake>g__TryGetUuid|24_1, addr 0x1495c14, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1495960, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Ceiling, addr 0x149437c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Ceiling();

  /// @brief Method get_Floor, addr 0x149436c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Floor();

  /// @brief Method get_Walls, addr 0x149438c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Ceiling, addr 0x1494384, size 0x8, virtual false, abstract: false, final false
  inline void set_Ceiling(::GlobalNamespace::OVRScenePlane* value);

  /// @brief Method set_Floor, addr 0x1494374, size 0x8, virtual false, abstract: false, final false
  inline void set_Floor(::GlobalNamespace::OVRScenePlane* value);

  /// @brief Method set_Walls, addr 0x1494394, size 0x8, virtual false, abstract: false, final false
