...
public:
  ...
  /// @brief Method CloneNode, addr 0x132e304, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x132e290, size 0x74, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method .ctor, addr 0x132e208, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XCData* other);

  /// @brief Method .ctor, addr 0x132e18c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_NodeType, addr 0x132e288, size 0x8, virtual true, abstract: false, final false
