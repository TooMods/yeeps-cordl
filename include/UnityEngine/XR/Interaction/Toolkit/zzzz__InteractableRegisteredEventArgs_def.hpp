...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::XR::Interaction::Toolkit::InteractableRegisteredEventArgs);
// Type: UnityEngine.XR.Interaction.Toolkit::InteractableRegisteredEventArgs
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cfeeb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_interactable, addr 0x2cfee2c, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::XR::Interaction::Toolkit::XRBaseInteractable> get_interactable();

  /// @brief Method get_interactableObject, addr 0x2cfee1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::Interaction::Toolkit::IXRInteractable* get_interactableObject();

  /// @brief Method set_interactable, addr 0x2cfeea8, size 0x8, virtual false, abstract: false, final false
  inline void set_interactable(::UnityEngine::XR::Interaction::Toolkit::XRBaseInteractable* value);

  /// @brief Method set_interactableObject, addr 0x2cfee24, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InteractableRegisteredEventArgs", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InteractableRegisteredEventArgs(InteractableRegisteredEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InteractableRegisteredEventArgs", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::XR::Interaction::Toolkit::InteractableRegisteredEventArgs, 0x20>, "Size mismatch!");
