...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x1b4dedc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b4deb4, size 0x28, virtual false, abstract: false, final false
