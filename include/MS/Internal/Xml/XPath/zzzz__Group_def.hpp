...
public:
  ...
  /// @brief Method .ctor, addr 0x1b2e6f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::AstNode* groupNode);

  /// @brief Method get_ReturnType, addr 0x1b2e724, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x1b2e71c, size 0x8, virtual true, abstract: false, final false
