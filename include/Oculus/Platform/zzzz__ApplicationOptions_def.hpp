...
public:
  ...
  /// @brief Method Finalize, addr 0x1990a40, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::ApplicationOptions* New_ctor();

  /// @brief Method SetDeeplinkMessage, addr 0x19904dc, size 0x68, virtual false, abstract: false, final false
  inline void SetDeeplinkMessage(::StringW value);

  /// @brief Method SetDestinationApiName, addr 0x19905e4, size 0x68, virtual false, abstract: false, final false
  inline void SetDestinationApiName(::StringW value);

  /// @brief Method SetLobbySessionId, addr 0x19906ec, size 0x68, virtual false, abstract: false, final false
  inline void SetLobbySessionId(::StringW value);

  /// @brief Method SetMatchSessionId, addr 0x19907f4, size 0x68, virtual false, abstract: false, final false
  inline void SetMatchSessionId(::StringW value);

  /// @brief Method SetRoomId, addr 0x19908fc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1990410, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x19909e8, size 0x58, virtual false, abstract: false, final false
