...
public:
  ...
  /// @brief Method .ctor, addr 0x10a0160, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaException* ex);

  /// @brief Method get_Exception, addr 0x10a01f0, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaException* get_Exception();

  /// @brief Method get_Message, addr 0x1094f2c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_Path, addr 0x10a01f8, size 0x1c, virtual false, abstract: false, final false
