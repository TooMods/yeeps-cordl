...
public:
  ...
  /// @brief Method ClearMustFlush, addr 0x1e10df8, size 0x8, virtual false, abstract: false, final false
  inline void ClearMustFlush();

  /// @brief Method Convert, addr 0x1e10964, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x1e10c30, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x1e102dc, size 0x1d8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count, bool flush);

  /// @brief Method GetByteCount, addr 0x1e104b4, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, bool flush);

  /// @brief Method GetBytes, addr 0x1e105ac, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e10844, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1e102bc, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e10278, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_Encoding, addr 0x1e10dd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_HasState, addr 0x1e10de8, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasState();

  /// @brief Method get_MustFlush, addr 0x1e10de0, size 0x8, virtual false, abstract: false, final false
