...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4b48, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x19b4b0c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b4ab4, size 0x58, virtual false, abstract: false, final false
