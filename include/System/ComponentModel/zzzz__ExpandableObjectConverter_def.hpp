...
public:
  // Declarations
  /// @brief Method GetProperties, addr 0x1af8328, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x1af8390, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ExpandableObjectConverter* New_ctor();

  /// @brief Method .ctor, addr 0x1af8320, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
