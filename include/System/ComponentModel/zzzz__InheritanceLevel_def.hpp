...
public:
  ...
  /// @brief Field Inherited value: static_cast<int32_t>(0x1)
  static ::System::ComponentModel::InheritanceLevel const Inherited;

  /// @brief Field InheritedReadOnly value: static_cast<int32_t>(0x2)
  static ::System::ComponentModel::InheritanceLevel const InheritedReadOnly;

  /// @brief Field NotInherited value: static_cast<int32_t>(0x3)
...
static_assert(::cordl_internals::size_check_v<::System::ComponentModel::InheritanceLevel, 0x4>, "Size mismatch!");
