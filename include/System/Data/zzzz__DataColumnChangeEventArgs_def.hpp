...
public:
  ...
  /// @brief Method InitializeColumnChangeEvent, addr 0x2412424, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2412328, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataRow* row);

  /// @brief Method .ctor, addr 0x2412394, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataRow* row, ::System::Data::DataColumn* column, ::System::Object* value);

  /// @brief Method get_ProposedValue, addr 0x2412414, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_ProposedValue();

  /// @brief Method set_ProposedValue, addr 0x241241c, size 0x8, virtual false, abstract: false, final false
