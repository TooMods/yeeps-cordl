...
public:
  // Declarations
  /// @brief Method GetEquivalentImguiEvent, addr 0x2cd237c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd243c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
