...
public:
  ...
  /// @brief Method CreateMemberCalls, addr 0x153038c, size 0x4dc, virtual false, abstract: false, final false
  static inline void CreateMemberCalls();

  /// @brief Method CreateSharpArgumentInfoArray, addr 0x15300bc, size 0x2d0, virtual false, abstract: false, final false
  static inline ::System::Object* CreateSharpArgumentInfoArray(::ArrayW<int32_t, ::Array<int32_t>*> values);

  /// @brief Method GetMember, addr 0x1530868, size 0x1d4, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::CallSiteBinder* GetMember(::StringW name, ::System::Type* context);

  /// @brief Method Init, addr 0x152fed4, size 0x1e8, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method SetMember, addr 0x1530a3c, size 0x1d4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetDynamicMemberNames, addr 0x152fdec, size 0xe8, virtual false, abstract: false, final false
