...
public:
  ...
  /// @brief Method FindElement, addr 0x3040970, size 0x6d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetChoice, addr 0x3045450, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3045424, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ChoiceMember, addr 0x3045430, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ChoiceMember();

  /// @brief Method get_ChoiceTypeData, addr 0x3045440, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_ChoiceTypeData();

  /// @brief Method get_ElementInfo, addr 0x303f530, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ElementInfo();

  /// @brief Method get_IsXmlTextCollector, addr 0x3045460, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsXmlTextCollector();

  /// @brief Method set_ChoiceMember, addr 0x3045438, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceMember(::StringW value);

  /// @brief Method set_ChoiceTypeData, addr 0x3045448, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceTypeData(::System::Xml::Serialization::TypeData* value);

  /// @brief Method set_ElementInfo, addr 0x3045428, size 0x8, virtual false, abstract: false, final false
  inline void set_ElementInfo(::System::Xml::Serialization::XmlTypeMapElementInfoList* value);

  /// @brief Method set_IsXmlTextCollector, addr 0x3045468, size 0xc, virtual false, abstract: false, final false
