...
public:
  ...
  /// @brief Field AcknowledgingDisconnect value: static_cast<uint8_t>(0x5u)
  ...
  /// @brief Field Zombie value: static_cast<uint8_t>(0x6u)
...
static_assert(::cordl_internals::size_check_v<::ExitGames::Client::Photon::ConnectionStateValue, 0x1>, "Size mismatch!");
