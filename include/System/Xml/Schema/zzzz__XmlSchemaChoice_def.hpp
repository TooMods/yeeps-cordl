...
public:
  ...
  /// @brief Method SetItems, addr 0x1ce2ec0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce2ec8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x1ce2eb8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Items, addr 0x1ce2eb0, size 0x8, virtual true, abstract: false, final false
