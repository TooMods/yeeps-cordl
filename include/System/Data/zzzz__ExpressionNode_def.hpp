...
public:
  ...
  /// @brief Method BindTable, addr 0x1940b38, size 0x8, virtual false, abstract: false, final false
  inline void BindTable(::System::Data::DataTable* table);

  /// @brief Method DependsOn, addr 0x1940b40, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method IsFloat, addr 0x1940b48, size 0x20, virtual false, abstract: false, final false
  static inline bool IsFloat(::System::Data::Common::StorageType type);

  /// @brief Method IsFloatSql, addr 0x1940b68, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsFloatSql(::System::Data::Common::StorageType type);

  /// @brief Method IsInteger, addr 0x193df88, size 0x24, virtual false, abstract: false, final false
  static inline bool IsInteger(::System::Data::Common::StorageType type);

  /// @brief Method IsIntegerSql, addr 0x193db88, size 0x38, virtual false, abstract: false, final false
  static inline bool IsIntegerSql(::System::Data::Common::StorageType type);

  /// @brief Method IsNumeric, addr 0x193df68, size 0x20, virtual false, abstract: false, final false
  static inline bool IsNumeric(::System::Data::Common::StorageType type);

  /// @brief Method IsNumericSql, addr 0x193e0b0, size 0x64, virtual false, abstract: false, final false
  static inline bool IsNumericSql(::System::Data::Common::StorageType type);

  /// @brief Method IsSigned, addr 0x193ddd4, size 0x48, virtual false, abstract: false, final false
  static inline bool IsSigned(::System::Data::Common::StorageType type);

  /// @brief Method IsSignedSql, addr 0x193def4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method IsUnsigned, addr 0x193de1c, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsUnsigned(::System::Data::Common::StorageType type);

  /// @brief Method IsUnsignedSql, addr 0x193df2c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19356f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_FormatProvider, addr 0x193d0f0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::IFormatProvider* get_FormatProvider();

  /// @brief Method get_IsSqlColumn, addr 0x1940b28, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSqlColumn();

  /// @brief Method get_table, addr 0x1940b30, size 0x8, virtual false, abstract: false, final false
