...
public:
  ...
  /// @brief Method Copy, addr 0x128c32c, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::InheritedData Copy();

  /// @brief Method CopyFrom, addr 0x128c348, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::InheritedData> other);

  /// @brief Method Equals, addr 0x128c5a8, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x128c55c, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::InheritedData other);

  /// @brief Method GetHashCode, addr 0x128c650, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x128c35c, size 0x200, virtual false, abstract: false, final false
