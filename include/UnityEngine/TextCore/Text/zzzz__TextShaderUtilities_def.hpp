...
public:
  ...
  /// @brief Method GetPadding, addr 0x2471228, size 0x6a8, virtual false, abstract: false, final false
  static inline float_t GetPadding(::UnityEngine::Material* material, bool enableExtraPadding, bool isBold);

  /// @brief Method GetShaderPropertyIDs, addr 0x24702a8, size 0x988, virtual false, abstract: false, final false
  static inline void GetShaderPropertyIDs();

  /// @brief Method IsMaskingEnabled, addr 0x247108c, size 0x19c, virtual false, abstract: false, final false
  static inline bool IsMaskingEnabled(::UnityEngine::Material* material);

  /// @brief Method UpdateShaderRatios, addr 0x2470c30, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShaderRef_MobileBitmap, addr 0x246ffbc, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileBitmap();

  /// @brief Method get_ShaderRef_MobileSDF, addr 0x246fe60, size 0x15c, virtual false, abstract: false, final false
