...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x304b264, size 0x4, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method DetectValidationType, addr 0x304af20, size 0x344, virtual false, abstract: false, final false
  inline ::System::Xml::ValidationType DetectValidationType();

  /// @brief Method FindId, addr 0x304b268, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x304ae3c, size 0xe4, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method .ctor, addr 0x304acf0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PreserveWhitespace, addr 0x304ae34, size 0x8, virtual true, abstract: false, final false
