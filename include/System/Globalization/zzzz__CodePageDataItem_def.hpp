...
public:
  ...
  /// @brief Method CreateString, addr 0x227affc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227af58, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(int32_t dataIndex);

  static inline ::ArrayW<char16_t, ::Array<char16_t>*> getStaticF_sep();

  /// @brief Method get_WebName, addr 0x227b0b0, size 0xbc, virtual false, abstract: false, final false
