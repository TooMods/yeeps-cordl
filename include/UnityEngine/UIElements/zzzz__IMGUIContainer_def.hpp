...
public:
  ...
  /// @brief Method .ctor, addr 0x27d26a8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x27d25cc, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x27d263c, size 0x18, virtual true, abstract: false, final false
  inline void Dispose(bool disposeManaged);

  /// @brief Method DoIMGUIRepaint, addr 0x27d0d60, size 0x390, virtual false, abstract: false, final false
  inline void DoIMGUIRepaint();

  /// @brief Method DoMeasure, addr 0x27d2374, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method DoOnGUI, addr 0x27cfd18, size 0xd1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteDefaultAction, addr 0x27d1e40, size 0x2e8, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method GetCurrentClipRect, addr 0x27d1b44, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetCurrentClipRect();

  /// @brief Method GetCurrentTransformAndClip, addr 0x27d1c7c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent, addr 0x27d0a34, size 0x90, virtual true, abstract: false, final false
  inline void HandleEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method HandleIMGUIEvent, addr 0x27d1578, size 0x10, virtual false, abstract: false, final false
  inline bool HandleIMGUIEvent(::UnityEngine::Event* e, bool canAffectFocus);

  /// @brief Method HandleIMGUIEvent, addr 0x27d1bb0, size 0xcc, virtual false, abstract: false, final false
  inline bool HandleIMGUIEvent(::UnityEngine::Event* e, ::System::Action* onGUIHandler, bool canAffectFocus);

  /// @brief Method HandleIMGUIEvent, addr 0x27d10f0, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsContainerCapturingTheMouse, addr 0x27d1588, size 0x114, virtual false, abstract: false, final false
  inline bool IsContainerCapturingTheMouse();

  /// @brief Method IsDockAreaMouseUp, addr 0x27d1a20, size 0x124, virtual false, abstract: false, final false
  static inline bool IsDockAreaMouseUp(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method IsEventInsideLocalWindow, addr 0x27d18a0, size 0x180, virtual false, abstract: false, final false
  inline bool IsEventInsideLocalWindow(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method IsLocalEvent, addr 0x27d169c, size 0x204, virtual false, abstract: false, final false
  inline bool IsLocalEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method MarkDirtyLayout, addr 0x27cd328, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method OnGenerateVisualContent, addr 0x27cf9c4, size 0x12c, virtual false, abstract: false, final false
  inline void OnGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext* mgc);

  /// @brief Method RestoreGlobals, addr 0x27cfc00, size 0x118, virtual false, abstract: false, final false
  inline void RestoreGlobals();

  /// @brief Method SaveGlobals, addr 0x27cfaf0, size 0x110, virtual false, abstract: false, final false
  inline void SaveGlobals();

  /// @brief Method SendEventToIMGUI, addr 0x27d0ac4, size 0x29c, virtual false, abstract: false, final false
  inline bool SendEventToIMGUI(::UnityEngine::UIElements::EventBase* evt, bool canAffectFocus, bool verifyBounds);

  /// @brief Method SendEventToIMGUIRaw, addr 0x27d13e8, size 0x100, virtual false, abstract: false, final false
  inline bool SendEventToIMGUIRaw(::UnityEngine::UIElements::EventBase* evt, bool canAffectFocus, bool verifyBounds);

  /// @brief Method SetFoldoutDepthClass, addr 0x27d2128, size 0x168, virtual false, abstract: false, final false
  inline void SetFoldoutDepthClass();

  /// @brief Method VerifyBounds, addr 0x27d14e8, size 0x90, virtual false, abstract: false, final false
  inline bool VerifyBounds(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method <DoOnGUI>b__56_0, addr 0x27d2654, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27cf784, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27cf78c, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cache, addr 0x27cf2c0, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::__GUILayoutUtility__LayoutCache* get_cache();

  /// @brief Method get_canGrabFocus, addr 0x27cf398, size 0x20, virtual true, abstract: false, final false
  inline bool get_canGrabFocus();

  /// @brief Method get_contextType, addr 0x27cf380, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ContextType get_contextType();

  /// @brief Method get_cullingEnabled, addr 0x27cf2b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_cullingEnabled();

  /// @brief Method get_focusOnlyIfHasFocusableControls, addr 0x27cf390, size 0x8, virtual false, abstract: false, final false
  inline bool get_focusOnlyIfHasFocusableControls();

  /// @brief Method get_guiState, addr 0x27ce1ec, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::ObjectGUIState* get_guiState();

  /// @brief Method get_lastWorldClip, addr 0x27cf290, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_lastWorldClip();

  /// @brief Method get_layoutMeasuredHeight, addr 0x27cf358, size 0x28, virtual false, abstract: false, final false
  inline float_t get_layoutMeasuredHeight();

  /// @brief Method get_layoutMeasuredWidth, addr 0x27cf330, size 0x28, virtual false, abstract: false, final false
  inline float_t get_layoutMeasuredWidth();

  /// @brief Method get_onGUIHandler, addr 0x27cf230, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_contextType, addr 0x27cf388, size 0x8, virtual false, abstract: false, final false
  inline void set_contextType(::UnityEngine::UIElements::ContextType value);

  /// @brief Method set_lastWorldClip, addr 0x27cf2a4, size 0x14, virtual false, abstract: false, final false
  inline void set_lastWorldClip(::UnityEngine::Rect value);

  /// @brief Method set_onGUIHandler, addr 0x27cf238, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x27d2660, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
