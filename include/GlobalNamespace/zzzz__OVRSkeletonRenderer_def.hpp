...
public:
  ...
  /// @brief Method get_IsDataHighConfidence, addr 0x169e52c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x169e518, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_RootScale, addr 0x169e508, size 0x8, virtual false, abstract: false, final false
  inline float_t get_RootScale();

  /// @brief Method get_ShouldUseSystemGestureMaterial, addr 0x169e540, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldUseSystemGestureMaterial();

  /// @brief Method set_IsDataHighConfidence, addr 0x169e534, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x169e520, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_RootScale, addr 0x169e510, size 0x8, virtual false, abstract: false, final false
  inline void set_RootScale(float_t value);

  /// @brief Method set_ShouldUseSystemGestureMaterial, addr 0x169e548, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Update, addr 0x169de88, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x169d928, size 0x1d8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Update, addr 0x169e058, size 0x310, virtual false, abstract: false, final false
  inline void Update(float_t scale, bool shouldRender, bool shouldUseSystemGestureMaterial, ::GlobalNamespace::__OVRSkeletonRenderer__ConfidenceBehavior confidenceBehavior,
                     ::GlobalNamespace::__OVRSkeletonRenderer__SystemGestureBehavior systemGestureBehavior);
  ...
  /// @brief Method .ctor, addr 0x169db00, size 0x1c0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x169d044, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Initialize, addr 0x169d1dc, size 0x74c, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRSkeletonRenderer* New_ctor();

  /// @brief Method OnDestroy, addr 0x169e368, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ShouldInitialize, addr 0x169d1a8, size 0x34, virtual false, abstract: false, final false
  inline bool ShouldInitialize();

  /// @brief Method Start, addr 0x169d0fc, size 0xac, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x169dcc0, size 0x1c8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x169e494, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Quaternion getStaticF__capsuleRotationOffset();

  /// @brief Method get_IsDataHighConfidence, addr 0x169d01c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x169d008, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_IsInitialized, addr 0x169cff4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_ShouldUseSystemGestureMaterial, addr 0x169d030, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldUseSystemGestureMaterial();

  static inline void setStaticF__capsuleRotationOffset(::UnityEngine::Quaternion value);

  /// @brief Method set_IsDataHighConfidence, addr 0x169d024, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x169d010, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_IsInitialized, addr 0x169cffc, size 0xc, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_ShouldUseSystemGestureMaterial, addr 0x169d038, size 0xc, virtual false, abstract: false, final false
  inline void set_ShouldUseSystemGestureMaterial(bool value);
