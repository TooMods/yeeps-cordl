...
public:
  ...
  /// @brief Method MoveNext, addr 0x14918d4, size 0x98, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRSceneModelLoader___AttemptToLoadSceneModel_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x149196c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1491974, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x14919b4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x14918d0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1491458, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AttemptToLoadSceneModel, addr 0x14913f0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* AttemptToLoadSceneModel();

  /// @brief Method LoadSceneModel, addr 0x1491484, size 0xf4, virtual false, abstract: false, final false
  inline void LoadSceneModel();

  static inline ::GlobalNamespace::OVRSceneModelLoader* New_ctor();

  /// @brief Method OnNewSceneModelAvailable, addr 0x14916f4, size 0x9c, virtual true, abstract: false, final false
  inline void OnNewSceneModelAvailable();

  /// @brief Method OnNoSceneModelToLoad, addr 0x1491614, size 0xe0, virtual true, abstract: false, final false
  inline void OnNoSceneModelToLoad();

  /// @brief Method OnSceneCaptureReturnedWithoutError, addr 0x1491790, size 0x9c, virtual true, abstract: false, final false
  inline void OnSceneCaptureReturnedWithoutError();

  /// @brief Method OnSceneModelLoadedSuccessfully, addr 0x1491578, size 0x9c, virtual true, abstract: false, final false
  inline void OnSceneModelLoadedSuccessfully();

  /// @brief Method OnStart, addr 0x1491480, size 0x4, virtual true, abstract: false, final false
  inline void OnStart();

  /// @brief Method OnUnexpectedErrorWithSceneCapture, addr 0x149182c, size 0x9c, virtual true, abstract: false, final false
  inline void OnUnexpectedErrorWithSceneCapture();

  /// @brief Method Start, addr 0x1491158, size 0x298, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x14918c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SceneManager, addr 0x1491148, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRSceneManager> get_SceneManager();

  /// @brief Method set_SceneManager, addr 0x1491150, size 0x8, virtual false, abstract: false, final false
