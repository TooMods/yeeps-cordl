...
public:
  ...
  /// @brief Method IsValid, addr 0x12564bc, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValid(char16_t c);

  /// @brief Method IsValidStart, addr 0x1256538, size 0x64, virtual false, abstract: false, final false
  static inline bool IsValidStart(char16_t c);

  /// @brief Method MakePascal, addr 0x1256194, size 0x1a8, virtual false, abstract: false, final false
  static inline ::StringW MakePascal(::StringW identifier);

  /// @brief Method MakeValid, addr 0x125633c, size 0x180, virtual false, abstract: false, final false
