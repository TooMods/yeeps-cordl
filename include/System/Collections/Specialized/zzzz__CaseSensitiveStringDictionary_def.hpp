...
public:
  // Declarations
  /// @brief Method Add, addr 0x18c74c4, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18c74bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
