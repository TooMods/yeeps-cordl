...
public:
  ...
  /// @brief Method CreateMessage, addr 0x1ce6980, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW CreateMessage(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method GetObjectData, addr 0x1ce6a44, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSchemaObject, addr 0x1ce6fc0, size 0x8, virtual false, abstract: false, final false
  inline void SetSchemaObject(::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method SetSource, addr 0x1ce6fc8, size 0x28, virtual false, abstract: false, final false
  inline void SetSource(::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method SetSource, addr 0x1cddd14, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce6bb4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ce65c8, size 0x3b8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x1ce6bc8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1ce6cfc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x1ce6bd8, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x1cde8d0, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x1ce6ed8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method .ctor, addr 0x1cd9ce0, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::StringW sourceUri, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x1ce6d90, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x1ce6d08, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce6e60, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method .ctor, addr 0x1cd9b9c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ce6e54, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method .ctor, addr 0x1ce6de8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW sourceUri, int32_t lineNumber, int32_t linePosition);

  /// @brief Method get_Args, addr 0x1ce6f98, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Args();

  /// @brief Method get_GetRes, addr 0x1ce6f90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_GetRes();

  /// @brief Method get_LineNumber, addr 0x1ce6fa8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x1ce6fb0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Message, addr 0x1ce6ff0, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_SourceSchemaObject, addr 0x1ce6fb8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* get_SourceSchemaObject();

  /// @brief Method get_SourceUri, addr 0x1ce6fa0, size 0x8, virtual false, abstract: false, final false
