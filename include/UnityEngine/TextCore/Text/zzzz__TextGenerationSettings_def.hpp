...
public:
  ...
  /// @brief Method Equals, addr 0x23b117c, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23b0d94, size 0x3e8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::Text::TextGenerationSettings* other);

  /// @brief Method GetHashCode, addr 0x23b1244, size 0x5c0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::TextCore::Text::TextGenerationSettings* New_ctor();

  /// @brief Method ToString, addr 0x23b1804, size 0x1794, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b2f98, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
