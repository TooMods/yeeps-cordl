...
CORDL_MODULE_EXPORT(ITranscribedMessage)
...
// Write type traits
MARK_REF_PTR_T(::Unity::Services::Vivox::ITranscribedMessage);
// Type: Unity.Services.Vivox::ITranscribedMessage
// SizeInfo { instance_size: 0, native_size: -1, calculated_instance_size: 16, calculated_native_size: 16, minimum_alignment: 8, natural_alignment: 0, packing: None, specified_packing: None }
namespace Unity::Services::Vivox {
// Is value type: false
// CS Name: ::Unity.Services.Vivox::ITranscribedMessage*
class CORDL_TYPE ITranscribedMessage {
public:
  // Declarations
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ITranscribedMessage", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ITranscribedMessage(ITranscribedMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ITranscribedMessage", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ITranscribedMessage(ITranscribedMessage const&) = delete;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
} // namespace Unity::Services::Vivox
NEED_NO_BOX(::Unity::Services::Vivox::ITranscribedMessage);
DEFINE_IL2CPP_ARG_TYPE(::Unity::Services::Vivox::ITranscribedMessage*, "Unity.Services.Vivox", "ITranscribedMessage");
