...
public:
  ...
  /// @brief Method CloneNode, addr 0xff7a44, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteContentTo, addr 0xff7b44, size 0x4, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* w);

  /// @brief Method WriteTo, addr 0xff7b18, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff482c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW publicId, ::StringW systemId, ::StringW internalSubset, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_DtdSchemaInfo, addr 0xff7b48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_DtdSchemaInfo();

  /// @brief Method get_Entities, addr 0xff6cd4, size 0x70, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNamedNodeMap* get_Entities();

  /// @brief Method get_InternalSubset, addr 0xff7b08, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InternalSubset();

  /// @brief Method get_IsReadOnly, addr 0xff7a80, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LocalName, addr 0xff7a34, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xff7a2c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0xff7a3c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Notations, addr 0xff7a88, size 0x70, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNamedNodeMap* get_Notations();

  /// @brief Method get_ParseWithNamespaces, addr 0xff7b10, size 0x8, virtual false, abstract: false, final false
  inline bool get_ParseWithNamespaces();

  /// @brief Method get_PublicId, addr 0xff7af8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PublicId();

  /// @brief Method get_SystemId, addr 0xff7b00, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SystemId();

  /// @brief Method set_DtdSchemaInfo, addr 0xff7b50, size 0x8, virtual false, abstract: false, final false
