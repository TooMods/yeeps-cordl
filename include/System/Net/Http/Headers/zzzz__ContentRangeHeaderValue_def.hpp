...
public:
  ...
  /// @brief Method Equals, addr 0x162281c, size 0x148, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1622964, size 0xec, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::ContentRangeHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x1622814, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x1622f10, size 0x260, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x1622a50, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1622780, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_From, addr 0x16227d0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int64_t> get_From();

  /// @brief Method get_Length, addr 0x16227e4, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int64_t> get_Length();

  /// @brief Method get_To, addr 0x16227f8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int64_t> get_To();

  /// @brief Method get_Unit, addr 0x162280c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Unit();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_From, addr 0x16227dc, size 0x8, virtual false, abstract: false, final false
  inline void set_From(::System::Nullable_1<int64_t> value);

  /// @brief Method set_Length, addr 0x16227f0, size 0x8, virtual false, abstract: false, final false
  inline void set_Length(::System::Nullable_1<int64_t> value);

  /// @brief Method set_To, addr 0x1622804, size 0x8, virtual false, abstract: false, final false
