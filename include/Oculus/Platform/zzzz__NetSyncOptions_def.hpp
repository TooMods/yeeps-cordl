...
public:
  ...
  /// @brief Method Finalize, addr 0x19b6568, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::NetSyncOptions* New_ctor();

  /// @brief Method SetVoipGroup, addr 0x19b63d8, size 0x68, virtual false, abstract: false, final false
  inline void SetVoipGroup(::StringW value);

  /// @brief Method SetVoipStreamDefault, addr 0x19b6440, size 0x68, virtual false, abstract: false, final false
  inline void SetVoipStreamDefault(::Oculus::Platform::NetSyncVoipStreamMode value);

  /// @brief Method SetZoneId, addr 0x19b64a8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b6374, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x19b6510, size 0x58, virtual false, abstract: false, final false
