...
public:
  // Declarations
  /// @brief Method Dump, addr 0x1ab3ce0, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  /// @brief Method Dump, addr 0x1ab3ce4, size 0x4, virtual false, abstract: false, final false
  inline void Dump(::System::IO::Stream* sout);

  static inline ::System::Runtime::Serialization::Formatters::Binary::MessageEnd* New_ctor();

  /// @brief Method Read, addr 0x1ab3cdc, size 0x4, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Write, addr 0x1ab3cb4, size 0x28, virtual true, abstract: false, final true
  inline void Write(::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method .ctor, addr 0x1ab3cac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
