...
public:
  ...
  /// @brief Method Clear, addr 0x2415750, size 0xa8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clear, addr 0x24154c0, size 0xac, virtual false, abstract: false, final false
  inline void Clear(::System::Data::DataColumn* column);

  /// @brief Method GetColumnError, addr 0x24156b4, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW GetColumnError(::System::Data::DataColumn* column);

  /// @brief Method GetColumnsInError, addr 0x24157f8, size 0xe8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> GetColumnsInError();

  /// @brief Method IndexOf, addr 0x241556c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColumnError, addr 0x24153e0, size 0xe0, virtual false, abstract: false, final false
  inline void SetColumnError(::System::Data::DataColumn* column, ::StringW error);

  /// @brief Method SetText, addr 0x24152f4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2415200, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2415258, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::StringW rowError);

  /// @brief Method get_HasErrors, addr 0x24153ac, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasErrors();

  /// @brief Method get_Text, addr 0x241534c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Text();

  /// @brief Method set_Text, addr 0x2415354, size 0x58, virtual false, abstract: false, final false
