...
public:
  // Declarations
  /// @brief Method NormalizeOrThrow, addr 0x2c9ffcc, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW NormalizeOrThrow(::StringW input);

  /// @brief Method ParseAddress, addr 0x2c9f5ec, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data);

  /// @brief Method ParseAddress, addr 0x2c9f61c, size 0x380, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data, bool expectMultipleAddresses, ByRef<int32_t> index);

  /// @brief Method ParseDisplayName, addr 0x2c9fdc0, size 0x20c, virtual false, abstract: false, final false
  static inline ::StringW ParseDisplayName(::StringW data, ByRef<int32_t> index, bool expectMultipleAddresses);

  /// @brief Method ParseDomain, addr 0x2c9fa00, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW ParseDomain(::StringW data, ByRef<int32_t> index);

  /// @brief Method ParseLocalPart, addr 0x2c9fae8, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCfwsAndThrowIfIncomplete, addr 0x2c9f99c, size 0x64, virtual false, abstract: false, final false
