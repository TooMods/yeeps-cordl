...
public:
  ...
  /// @brief Method AddFC, addr 0x1677d84, size 0xac, virtual false, abstract: false, final false
  inline bool AddFC(::System::Text::RegularExpressions::RegexFC* fc, bool concatenate);

  /// @brief Method GetFirstChars, addr 0x167713c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1677e30, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(char16_t ch, bool _cordl_not, bool nullable, bool caseInsensitive);

  /// @brief Method .ctor, addr 0x1677f24, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::StringW charClass, bool nullable, bool caseInsensitive);

  /// @brief Method .ctor, addr 0x1677d04, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(bool nullable);

  /// @brief Method get_CaseInsensitive, addr 0x1677fb8, size 0x8, virtual false, abstract: false, final false
  inline bool get_CaseInsensitive();

  /// @brief Method set_CaseInsensitive, addr 0x1677fc0, size 0xc, virtual false, abstract: false, final false
