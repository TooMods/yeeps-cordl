...
public:
  ...
  /// @brief Method GetByteCount, addr 0x124ebec, size 0x60, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetBytes, addr 0x124ec4c, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes(::StringW s);

  /// @brief Method GetBytes, addr 0x124ec54, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x124ec64, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetChars, addr 0x124ec84, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetDecoder, addr 0x124ebe4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x124ecc4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetMaxByteCount, addr 0x124ec5c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x124eca4, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x124efcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CodePage, addr 0x124ecbc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_CodePage();

  /// @brief Method get_UCS4_2143, addr 0x124ee4c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_UCS4_2143();

  /// @brief Method get_UCS4_3412, addr 0x124ef0c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_UCS4_3412();

  /// @brief Method get_UCS4_Bigendian, addr 0x124ed8c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_UCS4_Bigendian();

  /// @brief Method get_UCS4_Littleendian, addr 0x124eccc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_UCS4_Littleendian();

  /// @brief Method get_WebName, addr 0x124ebd8, size 0xc, virtual true, abstract: false, final false
