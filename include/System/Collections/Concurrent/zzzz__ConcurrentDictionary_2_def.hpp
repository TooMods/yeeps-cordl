...
public:
  ...
  inline TValue AddOrUpdate(TKey key, TValue addValue, ::System::Func_3<TKey, TValue, TValue>* updateValueFactory);
  ...
  /// @brief Method TryUpdateInternal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline bool TryUpdateInternal(TKey key, int32_t hashcode, TValue newValue, TValue comparisonValue);
