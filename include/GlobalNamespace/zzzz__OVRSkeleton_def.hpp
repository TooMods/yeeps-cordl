...
public:
  ...
  /// @brief Method get_BoneRotations, addr 0x169cec0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf, ::Array<::GlobalNamespace::__OVRPlugin__Quatf>*> get_BoneRotations();

  /// @brief Method get_BoneTranslations, addr 0x169cef8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::__OVRPlugin__Vector3f, ::Array<::GlobalNamespace::__OVRPlugin__Vector3f>*> get_BoneTranslations();

  /// @brief Method get_IsDataHighConfidence, addr 0x169cee4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x169ced0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_RootPose, addr 0x169ce80, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Posef get_RootPose();

  /// @brief Method get_RootScale, addr 0x169ceb0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_RootScale();

  /// @brief Method get_SkeletonChangedCount, addr 0x169cf08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SkeletonChangedCount();

  /// @brief Method set_BoneRotations, addr 0x169cec8, size 0x8, virtual false, abstract: false, final false
  inline void set_BoneRotations(::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf, ::Array<::GlobalNamespace::__OVRPlugin__Quatf>*> value);

  /// @brief Method set_BoneTranslations, addr 0x169cf00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDataHighConfidence, addr 0x169ceec, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x169ced8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_RootPose, addr 0x169ce94, size 0x1c, virtual false, abstract: false, final false
  inline void set_RootPose(::GlobalNamespace::__OVRPlugin__Posef value);

  /// @brief Method set_RootScale, addr 0x169ceb8, size 0x8, virtual false, abstract: false, final false
  inline void set_RootScale(float_t value);

  /// @brief Method set_SkeletonChangedCount, addr 0x169cf10, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x169a8ec, size 0x210, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method BoneLabelFromBoneId, addr 0x169c1d4, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method FixedUpdate, addr 0x169cb14, size 0x2a8, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetBoneTransform, addr 0x169bbf8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> GetBoneTransform(::GlobalNamespace::__OVRSkeleton__BoneId boneId);

  /// @brief Method GetCurrentEndBoneId, addr 0x169cdcc, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSkeleton__BoneId GetCurrentEndBoneId();

  /// @brief Method GetCurrentMaxSkinnableBoneId, addr 0x169cdf0, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSkeleton__BoneId GetCurrentMaxSkinnableBoneId();

  /// @brief Method GetCurrentNumBones, addr 0x169ce14, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetCurrentNumBones();

  /// @brief Method GetCurrentNumSkinnableBones, addr 0x169ce38, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetCurrentNumSkinnableBones();

  /// @brief Method GetCurrentStartBoneId, addr 0x169cdbc, size 0x10, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSkeleton__BoneId GetCurrentStartBoneId();

  /// @brief Method GetSkeletonType, addr 0x169a860, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSkeleton__SkeletonType GetSkeletonType();

  /// @brief Method Initialize, addr 0x169ad84, size 0x94, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeBindPose, addr 0x169ae24, size 0x504, virtual false, abstract: false, final false
  inline void InitializeBindPose();

  /// @brief Method InitializeBones, addr 0x169bc00, size 0x5cc, virtual true, abstract: false, final false
  inline void InitializeBones();

  /// @brief Method InitializeCapsules, addr 0x169b328, size 0x8d0, virtual false, abstract: false, final false
  inline void InitializeCapsules();

  /// @brief Method IsBodySkeleton, addr 0x169c6f0, size 0xc, virtual false, abstract: false, final false
  static inline bool IsBodySkeleton(::GlobalNamespace::__OVRSkeleton__SkeletonType type);

  /// @brief Method IsHandSkeleton, addr 0x169ae18, size 0xc, virtual false, abstract: false, final false
  static inline bool IsHandSkeleton(::GlobalNamespace::__OVRSkeleton__SkeletonType type);

  /// @brief Method IsValidBone, addr 0x169a870, size 0x6c, virtual false, abstract: false, final false
  inline bool IsValidBone(::GlobalNamespace::__OVRSkeleton__BoneId bone);

  static inline ::GlobalNamespace::OVRSkeleton* New_ctor();

  /// @brief Method SearchSkeletonDataProvider, addr 0x169aafc, size 0x124, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRSkeleton__IOVRSkeletonDataProvider* SearchSkeletonDataProvider();

  /// @brief Method SetSkeletonType, addr 0x169a868, size 0x8, virtual true, abstract: false, final false
  inline void SetSkeletonType(::GlobalNamespace::__OVRSkeleton__SkeletonType type);

  /// @brief Method ShouldInitialize, addr 0x169acc0, size 0xc4, virtual false, abstract: false, final false
  inline bool ShouldInitialize();

  /// @brief Method Start, addr 0x169ac20, size 0xa0, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x169c704, size 0x4, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateSkeleton, addr 0x169c708, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x169ce5c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BindPoses, addr 0x169a840, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBone*>* get_BindPoses();

  /// @brief Method get_Bones, addr 0x169a830, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBone*>* get_Bones();

  /// @brief Method get_Capsules, addr 0x169a850, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBoneCapsule*>* get_Capsules();

  /// @brief Method get_IsDataHighConfidence, addr 0x169a81c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x169a808, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_IsInitialized, addr 0x169a7f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_SkeletonChangedCount, addr 0x169a8dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SkeletonChangedCount();

  /// @brief Method set_BindPoses, addr 0x169a848, size 0x8, virtual false, abstract: false, final false
  inline void set_BindPoses(::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBone*>* value);

  /// @brief Method set_Bones, addr 0x169a838, size 0x8, virtual false, abstract: false, final false
  inline void set_Bones(::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBone*>* value);

  /// @brief Method set_Capsules, addr 0x169a858, size 0x8, virtual false, abstract: false, final false
  inline void set_Capsules(::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBoneCapsule*>* value);

  /// @brief Method set_IsDataHighConfidence, addr 0x169a824, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x169a810, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_IsInitialized, addr 0x169a7fc, size 0xc, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_SkeletonChangedCount, addr 0x169a8e4, size 0x8, virtual false, abstract: false, final false
  inline void set_SkeletonChangedCount(int32_t value);
