...
public:
  ...
  /// @brief Method Finalize, addr 0x19c3e88, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::VoipOptions* New_ctor();

  /// @brief Method SetBitrateForNewConnections, addr 0x19c3db8, size 0x68, virtual false, abstract: false, final false
  inline void SetBitrateForNewConnections(::Oculus::Platform::VoipBitrate value);

  /// @brief Method SetCreateNewConnectionUseDtx, addr 0x19c3e20, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19c3d54, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x19ba61c, size 0x58, virtual false, abstract: false, final false
