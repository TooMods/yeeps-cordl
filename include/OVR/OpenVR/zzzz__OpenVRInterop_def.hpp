...
public:
  // Declarations
  /// @brief Method GetGenericInterface, addr 0x2a7ad88, size 0x9c, virtual false, abstract: false, final false
  static inline void* GetGenericInterface(ByRefConst<::StringW> pchInterfaceVersion, ByRef<::OVR::OpenVR::EVRInitError> peError);

  /// @brief Method GetInitToken, addr 0x2a7aebc, size 0x68, virtual false, abstract: false, final false
  static inline uint32_t GetInitToken();

  /// @brief Method GetStringForHmdError, addr 0x2a7ad0c, size 0x7c, virtual false, abstract: false, final false
  static inline void* GetStringForHmdError(::OVR::OpenVR::EVRInitError error);

  /// @brief Method InitInternal, addr 0x2a7aa94, size 0x84, virtual false, abstract: false, final false
  static inline uint32_t InitInternal(ByRef<::OVR::OpenVR::EVRInitError> peError, ::OVR::OpenVR::EVRApplicationType eApplicationType);

  /// @brief Method InitInternal2, addr 0x2a7ab18, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHmdPresent, addr 0x2a7ac2c, size 0x70, virtual false, abstract: false, final false
  static inline bool IsHmdPresent();

  /// @brief Method IsInterfaceVersionValid, addr 0x2a7ae24, size 0x98, virtual false, abstract: false, final false
  static inline bool IsInterfaceVersionValid(ByRefConst<::StringW> pchInterfaceVersion);

  /// @brief Method IsRuntimeInstalled, addr 0x2a7ac9c, size 0x70, virtual false, abstract: false, final false
  static inline bool IsRuntimeInstalled();

  static inline ::OVR::OpenVR::OpenVRInterop* New_ctor();

  /// @brief Method ShutdownInternal, addr 0x2a7abc8, size 0x64, virtual false, abstract: false, final false
  static inline void ShutdownInternal();

  /// @brief Method .ctor, addr 0x2a7af24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
