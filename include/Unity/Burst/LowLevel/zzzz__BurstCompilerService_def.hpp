...
public:
  ...
  /// @brief Method CompileAsyncDelegateMethod, addr 0x27e1524, size 0x44, virtual false, abstract: false, final false
  static inline int32_t CompileAsyncDelegateMethod(::System::Object* delegateMethod, ::StringW compilerOptions);

  /// @brief Method GetAsyncCompiledAsyncDelegateMethod, addr 0x27e1568, size 0x3c, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> GetAsyncCompiledAsyncDelegateMethod(int32_t userID);

  /// @brief Method GetCurrentExecutionMode, addr 0x27e1634, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t GetCurrentExecutionMode();

  /// @brief Method GetDisassembly, addr 0x27e14e0, size 0x44, virtual false, abstract: false, final false
  static inline ::StringW GetDisassembly(::System::Reflection::MethodInfo* m, ::StringW compilerOptions);

  /// @brief Method GetOrCreateSharedMemory, addr 0x27e15a4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadBurstLibrary, addr 0x27e16c8, size 0x3c, virtual false, abstract: false, final false
  static inline bool LoadBurstLibrary(::StringW fullPathToLibBurstGenerated);

  /// @brief Method Log, addr 0x27e165c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentExecutionMode, addr 0x27e15f8, size 0x3c, virtual false, abstract: false, final false
