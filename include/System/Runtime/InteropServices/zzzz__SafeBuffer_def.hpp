...
public:
  ...
  /// @brief Method AcquirePointer, addr 0x1b3feac, size 0x108, virtual false, abstract: false, final false
  inline void AcquirePointer(ByRef<::cordl_internals::Ptr<uint8_t>> pointer);

  /// @brief Method NotInitialized, addr 0x1b3ffb4, size 0x74, virtual false, abstract: false, final false
  static inline ::System::InvalidOperationException* NotInitialized();

  /// @brief Method ReleasePointer, addr 0x1b400f8, size 0xdc, virtual false, abstract: false, final false
