...
public:
  ...
  /// @brief Method NullCheck, addr 0x1a8b8c4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDebugString, addr 0x1a8f0b4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1a8f05c, size 0x58, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1a8b694, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConsumedContinuations, addr 0x1a8efd4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedContinuations();

  /// @brief Method get_ConsumedStack, addr 0x1a8efc4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_ContinuationsBalance, addr 0x1a8f020, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ProducedContinuations, addr 0x1a8efdc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ProducedContinuations();

  /// @brief Method get_ProducedStack, addr 0x1a8efcc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ProducedStack();

  /// @brief Method get_StackBalance, addr 0x1a8efe4, size 0x3c, virtual false, abstract: false, final false
