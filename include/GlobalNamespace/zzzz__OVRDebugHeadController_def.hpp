...
public:
  ...
  /// @brief Method Awake, addr 0x25bc318, size 0xf0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRDebugHeadController* New_ctor();

  /// @brief Method Start, addr 0x25bc408, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x25bc40c, size 0x524, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25bc930, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
