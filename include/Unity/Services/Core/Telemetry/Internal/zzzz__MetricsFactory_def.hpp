...
// Type: Unity.Services.Core.Telemetry.Internal::MetricsFactory
...
public:
  ...
  /// @brief Method Create, addr 0x270cfac, size 0xe4, virtual true, abstract: false, final true
  inline ::Unity::Services::Core::Telemetry::Internal::IMetrics* Create(::StringW packageName);

  static inline ::Unity::Services::Core::Telemetry::Internal::MetricsFactory* New_ctor(::Unity::Services::Core::Telemetry::Internal::MetricsHandler* handler,
  ...
  /// @brief Method .ctor, addr 0x270cec8, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Services::Core::Telemetry::Internal::MetricsHandler* handler, ::Unity::Services::Core::Configuration::Internal::IProjectConfiguration* projectConfig);

  /// @brief Method get_CommonTags, addr 0x270ceb8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IReadOnlyDictionary_2<::StringW, ::StringW>* get_CommonTags();

  /// @brief Method get_Handler, addr 0x270cec0, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::Unity::Services::Core::Telemetry::Internal::MetricsFactory, 0x28>, "Size mismatch!");

static_assert(offsetof(::Unity::Services::Core::Telemetry::Internal::MetricsFactory, ___m_ProjectConfig) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Core::Telemetry::Internal::MetricsFactory, ____CommonTags_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Unity::Services::Core::Telemetry::Internal::MetricsFactory, ____Handler_k__BackingField) == 0x20, "Offset mismatch!");
