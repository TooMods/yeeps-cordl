...
public:
  ...
  /// @brief Method Update, addr 0x1b4df10, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b4dee0, size 0x30, virtual false, abstract: false, final false
