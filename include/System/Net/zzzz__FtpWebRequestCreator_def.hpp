...
public:
  ...
  /// @brief Method Create, addr 0xf50e48, size 0x64, virtual true, abstract: false, final true
  inline ::System::Net::WebRequest* Create(::System::Uri* uri);

  static inline ::System::Net::FtpWebRequestCreator* New_ctor();

  /// @brief Method .ctor, addr 0xf50e40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
