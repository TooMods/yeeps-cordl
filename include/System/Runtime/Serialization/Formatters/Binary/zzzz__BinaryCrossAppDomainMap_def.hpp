...
public:
  ...
  /// @brief Method Dump, addr 0x1ab2be8, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainMap* New_ctor();

  /// @brief Method Read, addr 0x1ab2bc0, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab2bb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
