...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1c7271c, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x1c72644, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::LightSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x1c72698, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c72794, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::LightSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x1c725b0, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LightSensor* get_current();

  /// @brief Method get_lightLevel, addr 0x1c725a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x1c725f8, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::LightSensor* value);

  /// @brief Method set_lightLevel, addr 0x1c725a8, size 0x8, virtual false, abstract: false, final false
