...
public:
  ...
  /// @brief Method AddProperty, addr 0xf0421c, size 0x2bc, virtual false, abstract: false, final false
  inline void AddProperty(::Newtonsoft::Json::Serialization::JsonProperty* property);

  /// @brief Method GetClosestMatchProperty, addr 0xf044d8, size 0x40, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonProperty* GetClosestMatchProperty(::StringW propertyName);

  /// @brief Method GetKeyForItem, addr 0xf102d8, size 0x18, virtual true, abstract: false, final false
  inline ::StringW GetKeyForItem(::Newtonsoft::Json::Serialization::JsonProperty* item);

  /// @brief Method GetProperty, addr 0xf102f0, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValue, addr 0xf103dc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf040c0, size 0x15c, virtual false, abstract: false, final false
