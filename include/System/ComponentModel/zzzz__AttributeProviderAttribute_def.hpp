...
public:
  ...
  /// @brief Method .ctor, addr 0x1aeade4, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x1aeacc8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName);

  /// @brief Method .ctor, addr 0x1aead40, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW propertyName);

  /// @brief Method get_PropertyName, addr 0x1aeaed4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PropertyName();

  /// @brief Method get_TypeName, addr 0x1aeaecc, size 0x8, virtual false, abstract: false, final false
