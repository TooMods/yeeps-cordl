...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadCancelResult, addr 0x19b2d74, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult();

  /// @brief Method GetDataFromMessage, addr 0x19b2db0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b08e4, size 0x58, virtual false, abstract: false, final false
