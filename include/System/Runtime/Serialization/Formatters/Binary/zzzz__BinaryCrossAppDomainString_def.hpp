...
public:
  ...
  /// @brief Method Dump, addr 0x1ab2bb4, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainString* New_ctor();

  /// @brief Method Read, addr 0x1ab2b70, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1ab2b68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
