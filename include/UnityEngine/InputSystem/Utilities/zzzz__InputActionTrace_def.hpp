...
public:
  ...
  /// @brief Method ReadValue, addr 0x2269c10, size 0x104, virtual false, abstract: false, final false
  inline void ReadValue(::cordl_internals::Ptr<void> buffer, int32_t bufferSize);

  /// @brief Method ReadValueAsObject, addr 0x22699cc, size 0x244, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method ToString, addr 0x22691e8, size 0x2f4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_action, addr 0x226989c, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_control, addr 0x22698d0, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_duration, addr 0x2269990, size 0x30, virtual false, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_interaction, addr 0x2269910, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::IInputInteraction* get_interaction();

  /// @brief Method get_phase, addr 0x22698c4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_startTime, addr 0x2269984, size 0xc, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_time, addr 0x2269968, size 0x1c, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_valueSizeInBytes, addr 0x22699c0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x2269d84, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x2269d14, size 0x64, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x2269d78, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2269dec, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x22694f4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::Utilities::InputActionTrace* trace);

  /// @brief Method get_Current, addr 0x2269d88, size 0x64, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Clear, addr 0x2268c2c, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CloneActionStateBeforeBindingsChange, addr 0x22697a4, size 0xf8, virtual false, abstract: false, final false
  inline void CloneActionStateBeforeBindingsChange(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method Dispose, addr 0x22694dc, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeInternal, addr 0x2268d14, size 0x100, virtual false, abstract: false, final false
  inline void DisposeInternal();

  /// @brief Method Finalize, addr 0x2268c80, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetEnumerator, addr 0x2269170, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method HookOnActionChange, addr 0x226863c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnActionChange, addr 0x2269540, size 0x264, virtual false, abstract: false, final false
  inline void OnActionChange(::System::Object* actionOrMapOrAsset, ::UnityEngine::InputSystem::InputActionChange change);

  /// @brief Method RecordAction, addr 0x2268a5c, size 0x1d0, virtual false, abstract: false, final false
  inline void RecordAction(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method SubscribeTo, addr 0x226829c, size 0x134, virtual false, abstract: false, final false
  inline void SubscribeTo(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method SubscribeTo, addr 0x226844c, size 0x114, virtual false, abstract: false, final false
  inline void SubscribeTo(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method SubscribeToAll, addr 0x2268560, size 0xdc, virtual false, abstract: false, final false
  inline void SubscribeToAll();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x226953c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method ToString, addr 0x2268e14, size 0x35c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnhookOnActionChange, addr 0x22689f0, size 0x6c, virtual false, abstract: false, final false
  inline void UnhookOnActionChange();

  /// @brief Method UnsubscribeFrom, addr 0x2268700, size 0x11c, virtual false, abstract: false, final false
  inline void UnsubscribeFrom(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method UnsubscribeFrom, addr 0x226881c, size 0xfc, virtual false, abstract: false, final false
  inline void UnsubscribeFrom(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method UnsubscribeFromAll, addr 0x2268918, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2268218, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2268220, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor, addr 0x22683d0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method get_buffer, addr 0x2268200, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventBuffer get_buffer();

  /// @brief Method get_count, addr 0x2268210, size 0x8, virtual false, abstract: false, final false
