...
public:
  ...
  /// @brief Method .ctor, addr 0x1d1ee34, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1d1ee98, size 0xc8, virtual false, abstract: false, final false
