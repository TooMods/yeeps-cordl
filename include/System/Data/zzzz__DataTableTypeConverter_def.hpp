...
public:
  // Declarations
  /// @brief Method GetPropertiesSupported, addr 0x18a4c80, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::Data::DataTableTypeConverter* New_ctor();

  /// @brief Method .ctor, addr 0x18a4bcc, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();
