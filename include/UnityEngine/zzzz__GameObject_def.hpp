...
public:
  ...
  __declspec(property(put = set_isStatic)) bool isStatic;
  ...
  /// @brief Method AddComponent, addr 0x283b7a8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTag, addr 0x283ba28, size 0x44, virtual false, abstract: false, final false
  inline bool CompareTag(::StringW tag);

  /// @brief Method CreatePrimitive, addr 0x283b510, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> CreatePrimitive(::UnityEngine::PrimitiveType type);

  /// @brief Method Find, addr 0x283bd74, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> Find(::StringW name);

  /// @brief Method FindGameObjectsWithTag, addr 0x283ba6c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponent, addr 0x283b54c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentFastPath, addr 0x283b590, size 0x54, virtual false, abstract: false, final false
  inline void GetComponentFastPath(::System::Type* type, void* oneFurtherThanResultValue);

  /// @brief Method GetComponentInChildren, addr 0x283b5e4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentInParent, addr 0x283b638, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentsInternal, addr 0x283b68c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_AddComponentWithType, addr 0x283b764, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Component> Internal_AddComponentWithType(::System::Type* componentType);

  /// @brief Method Internal_CreateGameObject, addr 0x283bb9c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SendMessage, addr 0x283baa8, size 0x5c, virtual false, abstract: false, final false
  inline void SendMessage(::StringW methodName, ::System::Object* value, ::UnityEngine::SendMessageOptions options);

  /// @brief Method SetActive, addr 0x283b8a8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetComponentFastPath, addr 0x283b710, size 0x54, virtual false, abstract: false, final false
  inline void TryGetComponentFastPath(::System::Type* type, void* oneFurtherThanResultValue);

  /// @brief Method .ctor, addr 0x283bbe0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x283bb04, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x283bc64, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> components);

  /// @brief Method get_activeInHierarchy, addr 0x283b928, size 0x3c, virtual false, abstract: false, final false
  inline bool get_activeInHierarchy();

  /// @brief Method get_activeSelf, addr 0x283b8ec, size 0x3c, virtual false, abstract: false, final false
  inline bool get_activeSelf();

  /// @brief Method get_gameObject, addr 0x283be7c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_layer, addr 0x283b828, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_layer();

  /// @brief Method get_scene, addr 0x283bdb0, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::SceneManagement::Scene get_scene();

  /// @brief Method get_sceneCullingMask, addr 0x283be40, size 0x3c, virtual false, abstract: false, final false
  inline uint64_t get_sceneCullingMask();

  /// @brief Method get_scene_Injected, addr 0x283bdfc, size 0x44, virtual false, abstract: false, final false
  inline void get_scene_Injected(ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method get_tag, addr 0x283b9a8, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_tag();

  /// @brief Method get_transform, addr 0x283b7ec, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method set_isStatic, addr 0x283b964, size 0x44, virtual false, abstract: false, final false
  inline void set_isStatic(bool value);

  /// @brief Method set_layer, addr 0x283b864, size 0x44, virtual false, abstract: false, final false
  inline void set_layer(int32_t value);

  /// @brief Method set_tag, addr 0x283b9e4, size 0x44, virtual false, abstract: false, final false
