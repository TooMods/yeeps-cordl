...
public:
  ...
  /// @brief Method CasOnlyDemand, addr 0x1ea2fc0, size 0x78, virtual false, abstract: false, final false
  inline void CasOnlyDemand(int32_t skip);

  /// @brief Method CopyTo, addr 0x1ea3c1c, size 0x178, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method Demand, addr 0x1ea3d94, size 0x228, virtual true, abstract: false, final true
  inline void Demand();

  /// @brief Method Equals, addr 0x1ea3a04, size 0x19c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetEnumerator, addr 0x1ea436c, size 0x24, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetHashCode, addr 0x1ea3bd8, size 0x44, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsEmpty, addr 0x1ea3fbc, size 0x3a0, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsUnrestricted, addr 0x1ea435c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x1ea4408, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method ToString, addr 0x1ea4390, size 0x2c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToXml, addr 0x1ea3518, size 0x45c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea3294, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ea2f74, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::IPermission* perm);

  /// @brief Method .ctor, addr 0x1ea3380, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x1ea43bc, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x1ea43e0, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x1ea4404, size 0x4, virtual true, abstract: false, final false
