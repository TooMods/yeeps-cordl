...
public:
  ...
  /// @brief Method AddID, addr 0x1b2d948, size 0x90, virtual false, abstract: false, final false
  inline void AddID(::StringW name, ::System::Object* node);

  /// @brief Method AddIdentityConstraints, addr 0x1b2d9f4, size 0x404, virtual false, abstract: false, final false
  inline void AddIdentityConstraints();

  /// @brief Method AttributeIdentityConstraints, addr 0x1b2ce50, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForwardRefs, addr 0x1b29c70, size 0x108, virtual false, abstract: false, final false
  inline void CheckForwardRefs();

  /// @brief Method CheckValue, addr 0x1b2bb80, size 0x464, virtual false, abstract: false, final false
  inline void CheckValue(::StringW value, ::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CompleteValidation, addr 0x1b29c6c, size 0x4, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method ElementIdentityConstraints, addr 0x1b2ddf8, size 0x348, virtual false, abstract: false, final false
  inline void ElementIdentityConstraints();

  /// @brief Method EndElementIdentityConstraints, addr 0x1b2bff4, size 0xd18, virtual false, abstract: false, final false
  inline void EndElementIdentityConstraints();

  /// @brief Method FastGetElementDecl, addr 0x1b2a1e4, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* FastGetElementDecl(::System::Object* particle);

  /// @brief Method FindId, addr 0x1b2d9d8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Object* FindId(::StringW name);

  /// @brief Method Init, addr 0x1b29174, size 0x334, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method IsXSDRoot, addr 0x1b29f64, size 0x50, virtual false, abstract: false, final false
  inline bool IsXSDRoot(::StringW localName, ::StringW ns);

  /// @brief Method LoadSchema, addr 0x1b2b9bc, size 0x1c4, virtual false, abstract: false, final false
  inline void LoadSchema(::StringW uri, ::StringW url);

  /// @brief Method LoadSchemaFromLocation, addr 0x1b2d130, size 0x5d8, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x1b2cd0c, size 0xc0, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method ProcessElement, addr 0x1b29fb4, size 0x230, virtual false, abstract: false, final false
  inline void ProcessElement(::System::Object* particle);

  /// @brief Method ProcessInlineSchema, addr 0x1b29678, size 0x2b4, virtual false, abstract: false, final false
  inline void ProcessInlineSchema();

  /// @brief Method ProcessTokenizedType, addr 0x1b2d740, size 0x208, virtual false, abstract: false, final false
  inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType ttype, ::StringW name);

  /// @brief Method ProcessXsiAttributes, addr 0x1b2a2c0, size 0x7d4, virtual false, abstract: false, final false
  inline void ProcessXsiAttributes(ByRef<::System::Xml::XmlQualifiedName*> xsiType, ByRef<::StringW> xsiNil);

  /// @brief Method Push, addr 0x1b294cc, size 0xe4, virtual false, abstract: false, final false
  inline void Push(::System::Xml::XmlQualifiedName* elementName);

  /// @brief Method ThoroughGetElementDecl, addr 0x1b2aa94, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnWrapUnion, addr 0x1b2cdcc, size 0x84, virtual false, abstract: false, final false
  inline ::System::Object* UnWrapUnion(::System::Object* typedValue);

  /// @brief Method Validate, addr 0x1b295b0, size 0xb8, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method ValidateChildElement, addr 0x1b29d78, size 0x1ec, virtual false, abstract: false, final false
  inline ::System::Object* ValidateChildElement();

  /// @brief Method ValidateElement, addr 0x1b2992c, size 0x15c, virtual false, abstract: false, final false
  inline void ValidateElement();

  /// @brief Method ValidateEndElement, addr 0x1b29a88, size 0x1e4, virtual false, abstract: false, final false
  inline void ValidateEndElement();

  /// @brief Method ValidateEndStartElement, addr 0x1b2b5d8, size 0x3e4, virtual false, abstract: false, final false
  inline void ValidateEndStartElement();

  /// @brief Method ValidateStartElement, addr 0x1b2af20, size 0x6b8, virtual false, abstract: false, final false
  inline void ValidateStartElement();

  /// @brief Method ValidateStartElementIdentityConstraints, addr 0x1b2aed4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b294a8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b29150, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasIdentityConstraints, addr 0x1b2bfe4, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasIdentityConstraints();

  /// @brief Method get_HasSchema, addr 0x1b2aeb0, size 0x24, virtual false, abstract: false, final false
  inline bool get_HasSchema();

  /// @brief Method get_IsInlineSchemaStarted, addr 0x1b29668, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsInlineSchemaStarted();

  /// @brief Method get_PreserveWhitespace, addr 0x1b2d708, size 0x38, virtual true, abstract: false, final false
