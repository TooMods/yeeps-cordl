...
public:
  // Declarations
  /// @brief Method CloneByteArray, addr 0x28a80bc, size 0x78, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CloneByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> src);

  /// @brief Method GenerateRandom, addr 0x28a8134, size 0x1a8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateRandom(int32_t count);

  /// @brief Method NibbleToHex, addr 0x28a8448, size 0x1c, virtual false, abstract: false, final false
  static inline char16_t NibbleToHex(uint8_t b);

  /// @brief Method ToHexArrayUpper, addr 0x28a835c, size 0xec, virtual false, abstract: false, final false
  static inline ::ArrayW<char16_t, ::Array<char16_t>*> ToHexArrayUpper(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method ToHexStringUpper, addr 0x28a8464, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW ToHexStringUpper(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteInt, addr 0x28a82dc, size 0x80, virtual false, abstract: false, final false
  static inline void WriteInt(uint32_t i, ::ArrayW<uint8_t, ::Array<uint8_t>*> arr, int32_t offset);
