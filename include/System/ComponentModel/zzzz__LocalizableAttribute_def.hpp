...
// Write type traits
MARK_REF_PTR_T(::System::ComponentModel::LocalizableAttribute);
...
public:
  ...
  static __declspec(property(get = getStaticF_Default, put = setStaticF_Default))::System::ComponentModel::LocalizableAttribute* Default;

  __declspec(property(get = get_IsLocalizable)) bool IsLocalizable;

  /// @brief Field No, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_No, put = setStaticF_No))::System::ComponentModel::LocalizableAttribute* No;

  /// @brief Field Yes, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_Yes, put = setStaticF_Yes))::System::ComponentModel::LocalizableAttribute* Yes;
  ...
  /// @brief Method Equals, addr 0x1ae8600, size 0xe4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1ae86e4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x1ae86ec, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ae85d0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsLocalizable, addr 0x1ae85f8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalizableAttribute", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalizableAttribute(LocalizableAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalizableAttribute", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::System::ComponentModel::LocalizableAttribute, 0x18>, "Size mismatch!");
