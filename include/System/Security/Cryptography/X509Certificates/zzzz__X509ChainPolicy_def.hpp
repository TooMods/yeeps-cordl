...
public:
  ...
  /// @brief Method Reset, addr 0x122cc30, size 0xfc, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x122cc14, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ExtraStore, addr 0x122cd2c, size 0x27c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_ExtraStore();

  /// @brief Method get_RevocationFlag, addr 0x122cfa8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509RevocationFlag get_RevocationFlag();

  /// @brief Method get_RevocationMode, addr 0x122cfb0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509RevocationMode get_RevocationMode();

  /// @brief Method get_VerificationFlags, addr 0x122d01c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509VerificationFlags get_VerificationFlags();

  /// @brief Method get_VerificationTime, addr 0x122d088, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_VerificationTime();

  /// @brief Method set_RevocationMode, addr 0x122cfb8, size 0x64, virtual false, abstract: false, final false
  inline void set_RevocationMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode value);

  /// @brief Method set_VerificationFlags, addr 0x122d024, size 0x64, virtual false, abstract: false, final false
