...
public:
  ...
  /// @brief Method .ctor, addr 0x1489c80, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_eyeDepth, addr 0x1489c0c, size 0x50, virtual false, abstract: false, final false
  inline float_t get_eyeDepth();

  /// @brief Method get_eyeHeight, addr 0x1489bbc, size 0x50, virtual false, abstract: false, final false
  inline float_t get_eyeHeight();

  /// @brief Method get_id, addr 0x14899c8, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_id();

  /// @brief Method get_ipd, addr 0x1489a88, size 0x134, virtual false, abstract: false, final false
  inline float_t get_ipd();

  /// @brief Method get_locale, addr 0x1489a48, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_locale();

  /// @brief Method get_neckHeight, addr 0x1489c5c, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_neckHeight();

  /// @brief Method get_state, addr 0x1489c78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRProfile__State get_state();

  /// @brief Method get_userName, addr 0x1489a08, size 0x40, virtual false, abstract: false, final false
