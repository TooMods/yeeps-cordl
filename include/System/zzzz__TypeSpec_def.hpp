...
public:
  ...
  /// @brief Method AddModifier, addr 0x10dbed4, size 0xf0, virtual false, abstract: false, final false
  inline void AddModifier(::System::ModifierSpec* md);

  /// @brief Method AddName, addr 0x10dbdc0, size 0x110, virtual false, abstract: false, final false
  inline void AddName(::StringW type_name);

  /// @brief Method BoundCheck, addr 0x10dc074, size 0x88, virtual false, abstract: false, final false
  static inline void BoundCheck(int32_t idx, ::StringW s);

  /// @brief Method GetDisplayFullName, addr 0x10da1e4, size 0x454, virtual false, abstract: false, final false
  inline ::StringW GetDisplayFullName(::System::__TypeSpec__DisplayNameFormat flags);

  /// @brief Method GetModifierString, addr 0x10da660, size 0x1f4, virtual false, abstract: false, final false
  inline ::System::Text::StringBuilder* GetModifierString(::System::Text::StringBuilder* sb);

  static inline ::System::TypeSpec* New_ctor();

  /// @brief Method Parse, addr 0x10da92c, size 0xb88, virtual false, abstract: false, final false
  static inline ::System::TypeSpec* Parse(::StringW name, ByRef<int32_t> p, bool is_recurse, bool allow_aqn);

  /// @brief Method Parse, addr 0x10da854, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::TypeSpec* Parse(::StringW typeName);

  /// @brief Method ParsedTypeIdentifier, addr 0x10dbed0, size 0x4, virtual false, abstract: false, final false
  static inline ::System::TypeIdentifier* ParsedTypeIdentifier(::StringW displayName);

  /// @brief Method Resolve, addr 0x10db4b4, size 0x90c, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipSpace, addr 0x10dbfc4, size 0xb0, virtual false, abstract: false, final false
  static inline void SkipSpace(::StringW name, ByRef<int32_t> pos);

  /// @brief Method UnescapeInternalName, addr 0x10d9e2c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10dc0fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DisplayFullName, addr 0x10da638, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_DisplayFullName();

  /// @brief Method get_HasModifiers, addr 0x10da1d4, size 0x10, virtual false, abstract: false, final false
