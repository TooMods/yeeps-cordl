...
public:
  ...
  /// @brief Method .ctor, addr 0x1b2e4d0, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::__Function__FunctionType ftype, ::MS::Internal::Xml::XPath::AstNode* arg);

  /// @brief Method .ctor, addr 0x1b2e38c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b2e424, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReturnType, addr 0x1b2e5e0, size 0x80, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x1b2e5d8, size 0x8, virtual true, abstract: false, final false
