...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2467530, size 0x5c, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetUnsignedBigInteger, addr 0x2466454, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method PEM, addr 0x2466320, size 0x134, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PEM(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Parse, addr 0x2465a18, size 0x908, virtual false, abstract: false, final false
  inline void Parse(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method VerifySignature, addr 0x246729c, size 0x18c, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm* aa);

  /// @brief Method VerifySignature, addr 0x24670ac, size 0xc8, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method VerifySignature, addr 0x2467174, size 0x128, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::RSA* rsa);

  /// @brief Method WasCurrent, addr 0x2466fd4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245b888, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::StringW getStaticF_encoding_error();

  /// @brief Method get_DSA, addr 0x245f218, size 0x29c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DSA* get_DSA();

  /// @brief Method get_Extensions, addr 0x24664f8, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions();

  /// @brief Method get_Hash, addr 0x2466500, size 0x294, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Hash();

  /// @brief Method get_IsCurrent, addr 0x2466f74, size 0x60, virtual false, abstract: false, final false
  inline bool get_IsCurrent();

  /// @brief Method get_IsSelfSigned, addr 0x2467428, size 0x108, virtual false, abstract: false, final false
  inline bool get_IsSelfSigned();

  /// @brief Method get_IssuerName, addr 0x2466794, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IssuerName();

  /// @brief Method get_KeyAlgorithm, addr 0x246679c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_KeyAlgorithm();

  /// @brief Method get_KeyAlgorithmParameters, addr 0x24667a4, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyAlgorithmParameters();

  /// @brief Method get_PublicKey, addr 0x2466820, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_PublicKey();

  /// @brief Method get_RSA, addr 0x2466894, size 0x18c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSA* get_RSA();

  /// @brief Method get_RawData, addr 0x2466a30, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x2466aa4, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_SerialNumber();

  /// @brief Method get_Signature, addr 0x2466b18, size 0x43c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Signature();

  /// @brief Method get_SubjectName, addr 0x2466f54, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_SubjectName();

  /// @brief Method get_ValidFrom, addr 0x2466f5c, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValidFrom();

  /// @brief Method get_ValidUntil, addr 0x2466f64, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValidUntil();

  /// @brief Method get_Version, addr 0x2466f6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DSA, addr 0x24664e8, size 0x10, virtual false, abstract: false, final false
  inline void set_DSA(::System::Security::Cryptography::DSA* value);

  /// @brief Method set_KeyAlgorithmParameters, addr 0x2466818, size 0x8, virtual true, abstract: false, final false
  inline void set_KeyAlgorithmParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_RSA, addr 0x2466a20, size 0x10, virtual true, abstract: false, final false
