...
public:
  ...
  /// @brief Field inputHorizontal, offset 0x60, size 0x4
  ...
  /// @brief Field inputRotateAxisX, offset 0x50, size 0x4
  ...
  /// @brief Field inputRotateAxisY, offset 0x54, size 0x4
  ...
  /// @brief Field m_LookSpeedController, offset 0x18, size 0x4
  ...
  /// @brief Field m_LookSpeedMouse, offset 0x1c, size 0x4
  ...
  /// @brief Field speedAction, offset 0x40, size 0x8
  ...
  /// @brief Field yMoveAction, offset 0x48, size 0x8
  ...
  /// @brief Method OnEnable, addr 0x1bcea9c, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterInputs, addr 0x1bceaa0, size 0x78c, virtual false, abstract: false, final false
  inline void RegisterInputs();

  /// @brief Method Update, addr 0x1bcf4bc, size 0x3a0, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateInputs, addr 0x1bcf22c, size 0x290, virtual false, abstract: false, final false
  ...
  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> const& __cordl_internal_get_lookAction() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> const& __cordl_internal_get_moveAction() const;

  constexpr ::UnityEngine::InputSystem::InputAction*& __cordl_internal_get_speedAction();

  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> const& __cordl_internal_get_speedAction() const;

  constexpr ::UnityEngine::InputSystem::InputAction*& __cordl_internal_get_yMoveAction();

  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> const& __cordl_internal_get_yMoveAction() const;
  ...
  /// @brief Method .ctor, addr 0x1bcf8e4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field m_LookSpeedController, offset: 0x18, size: 0x4, def value: None
  float_t ___m_LookSpeedController;

  /// @brief Field m_LookSpeedMouse, offset: 0x1c, size: 0x4, def value: None
  float_t ___m_LookSpeedMouse;

  /// @brief Field m_MoveSpeed, offset: 0x20, size: 0x4, def value: None
  float_t ___m_MoveSpeed;

  /// @brief Field m_MoveSpeedIncrement, offset: 0x24, size: 0x4, def value: None
  float_t ___m_MoveSpeedIncrement;

  /// @brief Field m_Turbo, offset: 0x28, size: 0x4, def value: None
  float_t ___m_Turbo;

  /// @brief Field lookAction, offset: 0x30, size: 0x8, def value: None
  ::UnityEngine::InputSystem::InputAction* ___lookAction;

  /// @brief Field moveAction, offset: 0x38, size: 0x8, def value: None
  ::UnityEngine::InputSystem::InputAction* ___moveAction;

  /// @brief Field speedAction, offset: 0x40, size: 0x8, def value: None
  ::UnityEngine::InputSystem::InputAction* ___speedAction;

  /// @brief Field yMoveAction, offset: 0x48, size: 0x8, def value: None
  ::UnityEngine::InputSystem::InputAction* ___yMoveAction;

  /// @brief Field inputRotateAxisX, offset: 0x50, size: 0x4, def value: None
  float_t ___inputRotateAxisX;

  /// @brief Field inputRotateAxisY, offset: 0x54, size: 0x4, def value: None
  float_t ___inputRotateAxisY;

  /// @brief Field inputChangeSpeed, offset: 0x58, size: 0x4, def value: None
  float_t ___inputChangeSpeed;

  /// @brief Field inputVertical, offset: 0x5c, size: 0x4, def value: None
  float_t ___inputVertical;

  /// @brief Field inputHorizontal, offset: 0x60, size: 0x4, def value: None
  float_t ___inputHorizontal;

  /// @brief Field inputYAxis, offset: 0x64, size: 0x4, def value: None
  float_t ___inputYAxis;

  /// @brief Field leftShiftBoost, offset: 0x68, size: 0x1, def value: None
  bool ___leftShiftBoost;

  /// @brief Field leftShift, offset: 0x69, size: 0x1, def value: None
  bool ___leftShift;

  /// @brief Field fire1, offset: 0x6a, size: 0x1, def value: None
  bool ___fire1;

  /// @brief Field k_MouseSensitivityMultiplier offset 0xffffffff size 0x4
  static constexpr float_t k_MouseSensitivityMultiplier{ 0.01 };

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::FreeCamera, 0x70>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___m_LookSpeedController) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___m_LookSpeedMouse) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___m_MoveSpeed) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___m_MoveSpeedIncrement) == 0x24, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___m_Turbo) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___lookAction) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___moveAction) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___speedAction) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___yMoveAction) == 0x48, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___inputRotateAxisX) == 0x50, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___inputRotateAxisY) == 0x54, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___inputChangeSpeed) == 0x58, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___inputVertical) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___inputHorizontal) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___inputYAxis) == 0x64, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___leftShiftBoost) == 0x68, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___leftShift) == 0x69, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::FreeCamera, ___fire1) == 0x6a, "Offset mismatch!");
