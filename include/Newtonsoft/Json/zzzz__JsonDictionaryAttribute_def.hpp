...
public:
  ...
  /// @brief Method .ctor, addr 0x25c8740, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c8748, size 0x28, virtual false, abstract: false, final false
