...
public:
  ...
  /// @brief Method Close, addr 0xf59470, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0xf59474, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0xf594e0, size 0x8c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetObjectData, addr 0xf5946c, size 0x4, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetResponseStream, addr 0xf59574, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0xf59460, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf50fd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xf59458, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Headers, addr 0xf595bc, size 0x24, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_IsFromCache, addr 0xf5956c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFromCache();

  /// @brief Method get_ResponseUri, addr 0xf59598, size 0x24, virtual true, abstract: false, final false
