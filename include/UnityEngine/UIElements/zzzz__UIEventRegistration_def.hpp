...
public:
  ...
  /// @brief Method <.cctor>b__1_0, addr 0x27cd008, size 0x4c, virtual false, abstract: false, final false
  inline void __cctor_b__1_0();

  /// @brief Method <.cctor>b__1_1, addr 0x27cd054, size 0x4c, virtual false, abstract: false, final false
  inline void __cctor_b__1_1();

  /// @brief Method <.cctor>b__1_2, addr 0x27cd0a0, size 0x64, virtual false, abstract: false, final false
  inline bool __cctor_b__1_2(int32_t i, void* ptr);

  /// @brief Method <.cctor>b__1_3, addr 0x27cd104, size 0x4c, virtual false, abstract: false, final false
  inline void __cctor_b__1_3();

  /// @brief Method <.cctor>b__1_4, addr 0x27cd150, size 0x54, virtual false, abstract: false, final false
  inline bool __cctor_b__1_4(::System::Exception* exception);

  /// @brief Method <.cctor>b__1_5, addr 0x27cd1a4, size 0x4c, virtual false, abstract: false, final false
  inline void __cctor_b__1_5();

  /// @brief Method .ctor, addr 0x27cd000, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CleanupRoots, addr 0x27ccbe4, size 0x1dc, virtual false, abstract: false, final false
  static inline void CleanupRoots();

  /// @brief Method EndContainerGUIFromException, addr 0x27cc7a8, size 0x218, virtual false, abstract: false, final false
  static inline bool EndContainerGUIFromException(::System::Exception* exception);

  /// @brief Method MakeCurrentIMGUIContainerDirty, addr 0x27ccdc0, size 0x1dc, virtual false, abstract: false, final false
  static inline void MakeCurrentIMGUIContainerDirty();

  /// @brief Method ProcessEvent, addr 0x27cc9c0, size 0x224, virtual false, abstract: false, final false
  static inline bool ProcessEvent(int32_t instanceID, void* nativeEventPtr);

  /// @brief Method RegisterUIElementSystem, addr 0x27cc370, size 0x84, virtual false, abstract: false, final false
  static inline void RegisterUIElementSystem(::UnityEngine::UIElements::IUIElementsUtility* utility);

  /// @brief Method ReleaseCapture, addr 0x27cc5cc, size 0x1dc, virtual false, abstract: false, final false
  static inline void ReleaseCapture();

  /// @brief Method TakeCapture, addr 0x27cc3f4, size 0x1d8, virtual false, abstract: false, final false
