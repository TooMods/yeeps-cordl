...
public:
  ...
  /// @brief Method Clone, addr 0x21ced84, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x21ced8c, size 0xe4, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::__Stack__StackEnumerator* New_ctor(::System::Collections::Stack* stack);

  /// @brief Method Reset, addr 0x21cef04, size 0x80, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x21ceb20, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Stack* stack);

  /// @brief Method get_Current, addr 0x21cee70, size 0x94, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x21ce748, size 0x30, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x21ce778, size 0x90, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x21ce808, size 0x2b8, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x21ceac0, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x21ceb60, size 0x88, virtual true, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method Pop, addr 0x21cebe8, size 0x98, virtual true, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0x21cec80, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21ce598, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x21ce5f4, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_Count, addr 0x21ce6c0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x21ce6c8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x21ce6d0, size 0x78, virtual true, abstract: false, final false
