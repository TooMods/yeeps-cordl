...
public:
  ...
  /// @brief Method Init, addr 0x2cd4800, size 0x390, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd4b90, size 0x408, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AdjustScrollers, addr 0x27c5a54, size 0x19c, virtual false, abstract: false, final false
  inline void AdjustScrollers();

  /// @brief Method ApplyScrollInertia, addr 0x27c4ad4, size 0x1b8, virtual false, abstract: false, final false
  inline void ApplyScrollInertia();

  /// @brief Method ApplyTouchScrolling, addr 0x27c5840, size 0x214, virtual false, abstract: false, final false
  inline bool ApplyTouchScrolling(::UnityEngine::Vector2 newScrollOffset);

  /// @brief Method ComputeElasticOffset, addr 0x27c4760, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeInitialSpringBackVelocity, addr 0x27c484c, size 0xfc, virtual false, abstract: false, final false
  inline void ComputeInitialSpringBackVelocity();

  /// @brief Method ComputeTouchScrolling, addr 0x27c534c, size 0x3ec, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__ScrollView__TouchScrollingResult ComputeTouchScrolling(::UnityEngine::Vector2 position);

  /// @brief Method GetDeltaDistance, addr 0x27c2b50, size 0x50, virtual false, abstract: false, final false
  inline float_t GetDeltaDistance(float_t viewMin, float_t viewMax, float_t childBoundaryMin, float_t childBoundaryMax);

  /// @brief Method GetXDeltaOffset, addr 0x27c28d8, size 0x278, virtual false, abstract: false, final false
  inline float_t GetXDeltaOffset(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method GetYDeltaOffset, addr 0x27c2660, size 0x278, virtual false, abstract: false, final false
  inline float_t GetYDeltaOffset(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method InitTouchScrolling, addr 0x27c5014, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAttachToPanel, addr 0x27c3764, size 0x4b4, virtual false, abstract: false, final false
  inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnDetachFromPanel, addr 0x27c3d24, size 0x460, virtual false, abstract: false, final false
  inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnGeometryChanged, addr 0x27c460c, size 0x154, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnHorizontalScrollDragElementChanged, addr 0x27c2378, size 0x94, virtual false, abstract: false, final false
  inline void OnHorizontalScrollDragElementChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnPointerCancel, addr 0x27c5738, size 0x60, virtual false, abstract: false, final false
  inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent* evt);

  /// @brief Method OnPointerCapture, addr 0x27c4184, size 0xfc, virtual false, abstract: false, final false
  inline void OnPointerCapture(::UnityEngine::UIElements::PointerCaptureEvent* evt);

  /// @brief Method OnPointerCaptureOut, addr 0x27c4280, size 0xc0, virtual false, abstract: false, final false
  inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent* evt);

  /// @brief Method OnPointerDown, addr 0x27c4ddc, size 0x238, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnPointerMove, addr 0x27c5150, size 0x1fc, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* evt);

  /// @brief Method OnPointerUp, addr 0x27c5798, size 0xa8, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* evt);

  /// @brief Method OnRootCustomStyleResolved, addr 0x27c612c, size 0x4, virtual false, abstract: false, final false
  inline void OnRootCustomStyleResolved(::UnityEngine::UIElements::CustomStyleResolvedEvent* evt);

  /// @brief Method OnScrollWheel, addr 0x27c5da0, size 0x38c, virtual false, abstract: false, final false
  inline void OnScrollWheel(::UnityEngine::UIElements::WheelEvent* evt);

  /// @brief Method OnScrollersGeometryChanged, addr 0x27c5bf0, size 0x1b0, virtual false, abstract: false, final false
  inline void OnScrollersGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnVerticalScrollDragElementChanged, addr 0x27c240c, size 0x94, virtual false, abstract: false, final false
  inline void OnVerticalScrollDragElementChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method PostPointerUpAnimation, addr 0x27c4c8c, size 0x150, virtual false, abstract: false, final false
  inline void PostPointerUpAnimation();

  /// @brief Method ReadSingleLineHeight, addr 0x27c3c18, size 0x10c, virtual false, abstract: false, final false
  inline void ReadSingleLineHeight();

  /// @brief Method ReleaseScrolling, addr 0x27c4340, size 0x2cc, virtual false, abstract: false, final false
  inline bool ReleaseScrolling(int32_t pointerId, ::UnityEngine::UIElements::IEventHandler* target);

  /// @brief Method ScrollTo, addr 0x27c24a0, size 0x1c0, virtual false, abstract: false, final false
  inline void ScrollTo(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method SetScrollViewMode, addr 0x27c35e0, size 0x168, virtual false, abstract: false, final false
  inline void SetScrollViewMode(::UnityEngine::UIElements::ScrollViewMode mode);

  /// @brief Method SpringBack, addr 0x27c4948, size 0x18c, virtual false, abstract: false, final false
  inline void SpringBack();

  /// @brief Method UpdateContentViewTransform, addr 0x27c1bf8, size 0x268, virtual false, abstract: false, final false
  inline void UpdateContentViewTransform();

  /// @brief Method UpdateHorizontalSliderPageSize, addr 0x27c1e68, size 0x20c, virtual false, abstract: false, final false
  inline void UpdateHorizontalSliderPageSize();

  /// @brief Method UpdateScrollers, addr 0x27c12bc, size 0x518, virtual false, abstract: false, final false
  inline void UpdateScrollers(bool displayHorizontal, bool displayVertical);

  /// @brief Method UpdateVerticalSliderPageSize, addr 0x27c207c, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__103_0, addr 0x27c6368, size 0x30, virtual false, abstract: false, final false
  inline void __ctor_b__103_0(float_t value);

  /// @brief Method <.ctor>b__103_1, addr 0x27c6398, size 0x1030, virtual false, abstract: false, final false
  inline void __ctor_b__103_1(float_t value);

  /// @brief Method .ctor, addr 0x27c2bd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27c2be0, size 0xa00, virtual false, abstract: false, final false
  ...
  /// @brief Method get_contentContainer, addr 0x27c2bd0, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_contentViewport, addr 0x27c2ba0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentViewport();

  /// @brief Method get_elasticity, addr 0x27c22b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_elasticity();

  /// @brief Method get_hasInertia, addr 0x27c2288, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasInertia();

  /// @brief Method get_horizontalScroller, addr 0x27c2bb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Scroller* get_horizontalScroller();

  /// @brief Method get_horizontalScrollerVisibility, addr 0x27c11a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ScrollerVisibility get_horizontalScrollerVisibility();

  /// @brief Method get_isHorizontalScrollDisplayed, addr 0x27c1a6c, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isHorizontalScrollDisplayed();

  /// @brief Method get_isVerticalScrollDisplayed, addr 0x27c19ac, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isVerticalScrollDisplayed();

  /// @brief Method get_mode, addr 0x27c3748, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ScrollViewMode get_mode();

  /// @brief Method get_needsHorizontal, addr 0x27c123c, size 0x40, virtual false, abstract: false, final false
  inline bool get_needsHorizontal();

  /// @brief Method get_needsVertical, addr 0x27c127c, size 0x40, virtual false, abstract: false, final false
  inline bool get_needsVertical();

  /// @brief Method get_nestedInteractionKind, addr 0x27c2368, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__ScrollView__NestedInteractionKind get_nestedInteractionKind();

  /// @brief Method get_scrollDecelerationRate, addr 0x27c2298, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scrollDecelerationRate();

  /// @brief Method get_scrollOffset, addr 0x27c1b2c, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_scrollOffset();

  /// @brief Method get_scrollableHeight, addr 0x27c1928, size 0x84, virtual false, abstract: false, final false
  inline float_t get_scrollableHeight();

  /// @brief Method get_scrollableWidth, addr 0x27c18a4, size 0x84, virtual false, abstract: false, final false
  inline float_t get_scrollableWidth();

  /// @brief Method get_touchScrollBehavior, addr 0x27c22c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__ScrollView__TouchScrollBehavior get_touchScrollBehavior();

  /// @brief Method get_verticalScroller, addr 0x27c2bc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Scroller* get_verticalScroller();

  /// @brief Method get_verticalScrollerVisibility, addr 0x27c17d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_contentViewport, addr 0x27c2ba8, size 0x8, virtual false, abstract: false, final false
  inline void set_contentViewport(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_elasticity, addr 0x27c22b8, size 0x10, virtual false, abstract: false, final false
  inline void set_elasticity(float_t value);

  /// @brief Method set_horizontalPageSize, addr 0x27c1e60, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalPageSize(float_t value);

  /// @brief Method set_horizontalScroller, addr 0x27c2bb8, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScroller(::UnityEngine::UIElements::Scroller* value);

  /// @brief Method set_horizontalScrollerVisibility, addr 0x27c11b0, size 0x8c, virtual false, abstract: false, final false
  inline void set_horizontalScrollerVisibility(::UnityEngine::UIElements::ScrollerVisibility value);

  /// @brief Method set_mode, addr 0x27c3750, size 0x14, virtual false, abstract: false, final false
  inline void set_mode(::UnityEngine::UIElements::ScrollViewMode value);

  /// @brief Method set_nestedInteractionKind, addr 0x27c2370, size 0x8, virtual false, abstract: false, final false
  inline void set_nestedInteractionKind(::UnityEngine::UIElements::__ScrollView__NestedInteractionKind value);

  /// @brief Method set_scrollDecelerationRate, addr 0x27c22a0, size 0x10, virtual false, abstract: false, final false
  inline void set_scrollDecelerationRate(float_t value);

  /// @brief Method set_scrollOffset, addr 0x27c1b74, size 0x84, virtual false, abstract: false, final false
  inline void set_scrollOffset(::UnityEngine::Vector2 value);

  /// @brief Method set_showHorizontal, addr 0x27c186c, size 0x1c, virtual false, abstract: false, final false
  inline void set_showHorizontal(bool value);

  /// @brief Method set_showVertical, addr 0x27c1888, size 0x1c, virtual false, abstract: false, final false
  inline void set_showVertical(bool value);

  /// @brief Method set_touchScrollBehavior, addr 0x27c22d0, size 0x98, virtual false, abstract: false, final false
  inline void set_touchScrollBehavior(::UnityEngine::UIElements::__ScrollView__TouchScrollBehavior value);

  /// @brief Method set_verticalPageSize, addr 0x27c2074, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalPageSize(float_t value);

  /// @brief Method set_verticalScroller, addr 0x27c2bc8, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScroller(::UnityEngine::UIElements::Scroller* value);

  /// @brief Method set_verticalScrollerVisibility, addr 0x27c17dc, size 0x90, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cd47b8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
