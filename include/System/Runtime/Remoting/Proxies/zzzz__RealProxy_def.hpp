...
public:
  ...
  /// @brief Method AttachServer, addr 0x184daf0, size 0x8, virtual false, abstract: false, final false
  inline void AttachServer(::System::MarshalByRefObject* s);

  /// @brief Method GetAppDomainTarget, addr 0x184db00, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Object* GetAppDomainTarget();

  /// @brief Method GetObjectData, addr 0x184c9e4, size 0x98, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetProxiedType, addr 0x184c938, size 0xac, virtual false, abstract: false, final false
  inline ::System::Type* GetProxiedType();

  /// @brief Method GetTransparentProxy, addr 0x184d98c, size 0x164, virtual true, abstract: false, final false
  inline ::System::Object* GetTransparentProxy();

  /// @brief Method InternalGetProxyType, addr 0x184c934, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Type* InternalGetProxyType(::System::Object* transparentProxy);

  /// @brief Method InternalGetTransparentProxy, addr 0x184d988, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method PrivateInvoke, addr 0x184bb74, size 0x8d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessResponse, addr 0x184d284, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTargetDomain, addr 0x184daf8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x184c728, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x184c738, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* classToProxy);

  /// @brief Method .ctor, addr 0x184c8c8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* classToProxy, ::System::Runtime::Remoting::ClientIdentity* identity);

  /// @brief Method .ctor, addr 0x184c798, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* classToProxy, void* stub, ::System::Object* stubData);

  /// @brief Method get_ObjectIdentity, addr 0x184ca7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Identity* get_ObjectIdentity();

  /// @brief Method set_ObjectIdentity, addr 0x184ca84, size 0x8, virtual false, abstract: false, final false
