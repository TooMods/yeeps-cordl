...
public:
  ...
  /// @brief Method Create, addr 0x27de1f0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27de1f8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_uxmlName, addr 0x27de13c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x27de17c, size 0x74, virtual true, abstract: false, final false
