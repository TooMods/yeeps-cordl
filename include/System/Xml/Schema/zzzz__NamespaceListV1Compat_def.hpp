...
public:
  // Declarations
  /// @brief Method Allows, addr 0x1e74e30, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e74e2c, size 0x4, virtual false, abstract: false, final false
