...
public:
  ...
  /// @brief Method GetArgument, addr 0x183ba2c, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x183baf8, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x183b9f0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x183baf0, size 0x8, virtual true, abstract: false, final false
