...
public:
  ...
  /// @brief Method Awake, addr 0x16f8198, size 0x1c8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetHaltUpdateMovement, addr 0x16f9d6c, size 0xc, virtual false, abstract: false, final false
  inline void GetHaltUpdateMovement(ByRef<bool> haltUpdateMovement);

  /// @brief Method GetMoveScaleMultiplier, addr 0x16f9d2c, size 0xc, virtual false, abstract: false, final false
  inline void GetMoveScaleMultiplier(ByRef<float_t> moveScaleMultiplier);

  /// @brief Method GetRotationScaleMultiplier, addr 0x16f9d40, size 0xc, virtual false, abstract: false, final false
  inline void GetRotationScaleMultiplier(ByRef<float_t> rotationScaleMultiplier);

  /// @brief Method GetSkipMouseRotation, addr 0x16f9d54, size 0xc, virtual false, abstract: false, final false
  inline void GetSkipMouseRotation(ByRef<bool> skipMouseRotation);

  /// @brief Method Jump, addr 0x16f9c08, size 0x80, virtual false, abstract: false, final false
  inline bool Jump();

  static inline ::GlobalNamespace::OVRPlayerController* New_ctor();

  /// @brief Method OnDisable, addr 0x16f8364, size 0x19c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x16f8360, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResetOrientation, addr 0x16f9d84, size 0xc4, virtual false, abstract: false, final false
  inline void ResetOrientation();

  /// @brief Method SetHaltUpdateMovement, addr 0x16f9d78, size 0xc, virtual false, abstract: false, final false
  inline void SetHaltUpdateMovement(bool haltUpdateMovement);

  /// @brief Method SetMoveScaleMultiplier, addr 0x16f9d38, size 0x8, virtual false, abstract: false, final false
  inline void SetMoveScaleMultiplier(float_t moveScaleMultiplier);

  /// @brief Method SetRotationScaleMultiplier, addr 0x16f9d4c, size 0x8, virtual false, abstract: false, final false
  inline void SetRotationScaleMultiplier(float_t rotationScaleMultiplier);

  /// @brief Method SetSkipMouseRotation, addr 0x16f9d60, size 0xc, virtual false, abstract: false, final false
  inline void SetSkipMouseRotation(bool skipMouseRotation);

  /// @brief Method Start, addr 0x16f80d4, size 0xc4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Stop, addr 0x16f9c88, size 0xa4, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x16f8500, size 0x1fc, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateController, addr 0x16f86fc, size 0x6f0, virtual true, abstract: false, final false
  inline void UpdateController();

  /// @brief Method UpdateMovement, addr 0x16f8dec, size 0xc94, virtual true, abstract: false, final false
  inline void UpdateMovement();

  /// @brief Method UpdateTransform, addr 0x16f9a80, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16f9e48, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_CameraUpdated, addr 0x16f7e54, size 0x9c, virtual false, abstract: false, final false
  inline void add_CameraUpdated(::System::Action* value);

  /// @brief Method add_PreCharacterMove, addr 0x16f7f8c, size 0x9c, virtual false, abstract: false, final false
  inline void add_PreCharacterMove(::System::Action* value);

  /// @brief Method add_TransformUpdated, addr 0x16f7cf4, size 0xb0, virtual false, abstract: false, final false
  inline void add_TransformUpdated(::System::Action_1<::UnityW<::UnityEngine::Transform>>* value);

  /// @brief Method get_InitialYRotation, addr 0x16f80c4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_InitialYRotation();

  /// @brief Method remove_CameraUpdated, addr 0x16f7ef0, size 0x9c, virtual false, abstract: false, final false
  inline void remove_CameraUpdated(::System::Action* value);

  /// @brief Method remove_PreCharacterMove, addr 0x16f8028, size 0x9c, virtual false, abstract: false, final false
  inline void remove_PreCharacterMove(::System::Action* value);

  /// @brief Method remove_TransformUpdated, addr 0x16f7da4, size 0xb0, virtual false, abstract: false, final false
  inline void remove_TransformUpdated(::System::Action_1<::UnityW<::UnityEngine::Transform>>* value);

  /// @brief Method set_InitialYRotation, addr 0x16f80cc, size 0x8, virtual false, abstract: false, final false
