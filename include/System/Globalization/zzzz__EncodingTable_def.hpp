...
public:
  ...
  /// @brief Method ENC, addr 0x227b254, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Globalization::InternalEncodingDataItem ENC(::StringW name, uint16_t cp);

  /// @brief Method GetCodePageDataItem, addr 0x2280c00, size 0x2e8, virtual false, abstract: false, final false
  static inline ::System::Globalization::CodePageDataItem* GetCodePageDataItem(int32_t codepage);

  /// @brief Method GetCodePageFromName, addr 0x228097c, size 0x284, virtual false, abstract: false, final false
  static inline int32_t GetCodePageFromName(::StringW name);

  /// @brief Method GetNumEncodingItems, addr 0x227b1f0, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetNumEncodingItems();

  /// @brief Method MapCodePageDataItem, addr 0x227b25c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method internalGetCodePageFromName, addr 0x2280728, size 0x254, virtual false, abstract: false, final false
