...
public:
  ...
  /// @brief Method Clone, addr 0x2f0dde0, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method CompareTo, addr 0x2f0df30, size 0x68, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Version* value);

  /// @brief Method CompareTo, addr 0x2f0de60, size 0xbc, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* version);

  /// @brief Method Equals, addr 0x2f0df98, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2f0dffc, size 0x60, virtual true, abstract: false, final true
  inline bool Equals(::System::Version* obj);

  /// @brief Method GetHashCode, addr 0x2f0e05c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x2f0dce4, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Version* Parse(::StringW input);

  /// @brief Method ParseVersion, addr 0x2f0e520, size 0x4d4, virtual false, abstract: false, final false
  static inline ::System::Version* ParseVersion(::System::ReadOnlySpan_1<char16_t> input, bool throwOnFailure);

  /// @brief Method System.ISpanFormattable.TryFormat, addr 0x2f0e4f4, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method ToCachedStringBuilder, addr 0x2f0e154, size 0x24c, virtual false, abstract: false, final false
  inline ::System::Text::StringBuilder* ToCachedStringBuilder(int32_t fieldCount);

  /// @brief Method ToString, addr 0x2f0e078, size 0x28, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x2f0e0c8, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW ToString(int32_t fieldCount);

  /// @brief Method TryFormat, addr 0x2f0e3a0, size 0x2c, virtual false, abstract: false, final false
  inline bool TryFormat(::System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten);

  /// @brief Method TryFormat, addr 0x2f0e3cc, size 0x128, virtual false, abstract: false, final false
  inline bool TryFormat(::System::Span_1<char16_t> destination, int32_t fieldCount, ByRef<int32_t> charsWritten);

  /// @brief Method TryParse, addr 0x2f0e9f4, size 0x6c, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Version*> result);

  /// @brief Method TryParseComponent, addr 0x2f0ea88, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f0dd80, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f0dbe0, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(int32_t major, int32_t minor);

  /// @brief Method .ctor, addr 0x2f0dae8, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(int32_t major, int32_t minor, int32_t build);

  /// @brief Method .ctor, addr 0x2f0d9c4, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(int32_t major, int32_t minor, int32_t build, int32_t revision);

  /// @brief Method .ctor, addr 0x2f0dca0, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::StringW version);

  /// @brief Method .ctor, addr 0x2f0dda4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Version* version);

  /// @brief Method get_Build, addr 0x2f0de50, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Build();

  /// @brief Method get_DefaultFormatFieldCount, addr 0x2f0e0a0, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_DefaultFormatFieldCount();

  /// @brief Method get_Major, addr 0x2f0de40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Major();

  /// @brief Method get_Minor, addr 0x2f0de48, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Minor();

  /// @brief Method get_Revision, addr 0x2f0de58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2f0df1c, size 0x14, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Version* v1, ::System::Version* v2);

  /// @brief Method op_GreaterThan, addr 0x2f0ec6c, size 0x10, virtual false, abstract: false, final false
  static inline bool op_GreaterThan(::System::Version* v1, ::System::Version* v2);

  /// @brief Method op_GreaterThanOrEqual, addr 0x2f0ec7c, size 0x10, virtual false, abstract: false, final false
  static inline bool op_GreaterThanOrEqual(::System::Version* v1, ::System::Version* v2);

  /// @brief Method op_Inequality, addr 0x2f0ea60, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Inequality(::System::Version* v1, ::System::Version* v2);

  /// @brief Method op_LessThan, addr 0x2f0eba0, size 0x64, virtual false, abstract: false, final false
  static inline bool op_LessThan(::System::Version* v1, ::System::Version* v2);

  /// @brief Method op_LessThanOrEqual, addr 0x2f0ec04, size 0x68, virtual false, abstract: false, final false
