...
public:
  ...
  /// @brief Method ToString, addr 0x1839a10, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18399d4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW name);

  /// @brief Method get_Name, addr 0x1839a00, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Type, addr 0x1839a08, size 0x8, virtual false, abstract: false, final false
