...
public:
  ...
  /// @brief Method MoveNext, addr 0x12c1fd8, size 0x50, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Security::Cryptography::OidEnumerator* New_ctor(::System::Security::Cryptography::OidCollection* oids);

  /// @brief Method Reset, addr 0x12c2028, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x12c1fd4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12c1db8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::OidCollection* oids);

  /// @brief Method get_Current, addr 0x12c1fb4, size 0x20, virtual false, abstract: false, final false
