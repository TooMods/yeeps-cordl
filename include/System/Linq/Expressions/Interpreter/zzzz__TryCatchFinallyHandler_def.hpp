...
public:
  ...
  /// @brief Method FilterPasses, addr 0x1a99280, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasHandler, addr 0x1a99134, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1a990dc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(int32_t tryStart, int32_t tryEnd, int32_t gotoEndLabelIndex, int32_t finallyStart, int32_t finallyEnd,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*, ::Array<::System::Linq::Expressions::Interpreter::ExceptionHandler*>*> handlers);

  /// @brief Method .ctor, addr 0x1a99090, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(int32_t tryStart, int32_t tryEnd, int32_t gotoEndTargetIndex,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*, ::Array<::System::Linq::Expressions::Interpreter::ExceptionHandler*>*> handlers);

  /// @brief Method get_Handlers, addr 0x1a99078, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCatchBlockExist, addr 0x1a99080, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCatchBlockExist();

  /// @brief Method get_IsFinallyBlockExist, addr 0x1a99064, size 0x14, virtual false, abstract: false, final false
