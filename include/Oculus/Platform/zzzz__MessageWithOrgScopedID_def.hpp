...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b4c20, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetDataFromMessage(void* c_message);

  /// @brief Method GetOrgScopedID, addr 0x19b4be4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b117c, size 0x58, virtual false, abstract: false, final false
