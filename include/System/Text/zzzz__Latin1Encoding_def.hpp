...
public:
  ...
  /// @brief Method GetBestFitUnicodeToBytesData, addr 0x1e13500, size 0x58, virtual true, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> GetBestFitUnicodeToBytesData();

  /// @brief Method GetByteCount, addr 0x1e12d00, size 0x200, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t charCount, ::System::Text::EncoderNLS* encoder);

  /// @brief Method GetBytes, addr 0x1e12f00, size 0x378, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x1e13278, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* decoder);

  /// @brief Method GetChars, addr 0x1e13280, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMaxByteCount, addr 0x1e132f4, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x1e133fc, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x1e12c18, size 0xe8, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x1e12bc0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e12bcc, size 0x4c, virtual false, abstract: false, final false
