...
public:
  ...
  /// @brief Method .ctor, addr 0x161e2fc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x161cfb4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1619ac4, size 0x70, virtual false, abstract: false, final false
