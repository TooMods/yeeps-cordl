...
public:
  ...
  /// @brief Method And, addr 0x304d758, size 0xb8, virtual false, abstract: false, final false
  inline void And(::System::Xml::Schema::BitSet* other);

  /// @brief Method Clear, addr 0x304d578, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x304da34, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BitSet* Clone();

  /// @brief Method EnsureLength, addr 0x304d628, size 0x94, virtual false, abstract: false, final false
  inline void EnsureLength(int32_t nRequiredLength);

  /// @brief Method Equals, addr 0x304d8ec, size 0x148, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Get, addr 0x304d51c, size 0x5c, virtual false, abstract: false, final false
  inline bool Get(int32_t index);

  /// @brief Method GetHashCode, addr 0x304d8b4, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Intersects, addr 0x304db70, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method NextSet, addr 0x304d6bc, size 0x9c, virtual false, abstract: false, final false
  inline int32_t NextSet(int32_t startFrom);

  /// @brief Method Or, addr 0x304d810, size 0xa4, virtual false, abstract: false, final false
  inline void Or(::System::Xml::Schema::BitSet* other);

  /// @brief Method Set, addr 0x304d5cc, size 0x5c, virtual false, abstract: false, final false
  inline void Set(int32_t index);

  /// @brief Method Subscript, addr 0x304d508, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304d490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x304d498, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t count);

  /// @brief Method get_Count, addr 0x304d510, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsEmpty, addr 0x304db08, size 0x68, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Item, addr 0x304d518, size 0x4, virtual false, abstract: false, final false
