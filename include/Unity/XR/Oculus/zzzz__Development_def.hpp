...
public:
  ...
  /// @brief Method OverrideDeveloperModeStart, addr 0x21ea7a0, size 0xcc, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStart();

  /// @brief Method OverrideDeveloperModeStop, addr 0x21ea874, size 0x74, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStop();

  /// @brief Method TrySetDeveloperMode, addr 0x21ea748, size 0x58, virtual false, abstract: false, final false
