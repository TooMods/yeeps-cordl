...
public:
  ...
  /// @brief Method CheckTicksRange, addr 0x204b4d0, size 0x198, virtual false, abstract: false, final false
  inline void CheckTicksRange(int64_t ticks);

  /// @brief Method DateToTicks, addr 0x204b850, size 0x80, virtual false, abstract: false, final false
  static inline int64_t DateToTicks(int32_t year, int32_t month, int32_t day);

  /// @brief Method GetAbsoluteDate, addr 0x204b668, size 0x1e8, virtual false, abstract: false, final false
  static inline int64_t GetAbsoluteDate(int32_t year, int32_t month, int32_t day);

  /// @brief Method GetDatePart, addr 0x204b2c4, size 0x20c, virtual true, abstract: false, final false
  inline int32_t GetDatePart(int64_t ticks, int32_t part);

  /// @brief Method GetDayOfMonth, addr 0x204ba8c, size 0x40, virtual false, abstract: false, final false
  inline int32_t GetDayOfMonth(::System::DateTime time);

  /// @brief Method GetDayOfWeek, addr 0x204bacc, size 0x8c, virtual false, abstract: false, final false
  inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime time);

  /// @brief Method GetDaysInMonth, addr 0x204bb58, size 0x18c, virtual false, abstract: false, final false
  inline int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method GetDaysInYear, addr 0x204bce4, size 0x70, virtual false, abstract: false, final false
  inline int32_t GetDaysInYear(int32_t year, int32_t era);

  /// @brief Method GetEra, addr 0x204bd54, size 0xd0, virtual false, abstract: false, final false
  inline int32_t GetEra(::System::DateTime time);

  /// @brief Method GetGregorianYear, addr 0x204b28c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetGregorianYear(int32_t year, int32_t era);

  /// @brief Method GetMonth, addr 0x204bf14, size 0x40, virtual false, abstract: false, final false
  inline int32_t GetMonth(::System::DateTime time);

  /// @brief Method GetMonthsInYear, addr 0x204bf54, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetMonthsInYear(int32_t year, int32_t era);

  /// @brief Method GetYear, addr 0x204bf6c, size 0xf0, virtual false, abstract: false, final false
  inline int32_t GetYear(::System::DateTime time);

  /// @brief Method GetYearOffset, addr 0x204af98, size 0x2f4, virtual false, abstract: false, final false
  inline int32_t GetYearOffset(int32_t year, int32_t era, bool throwOnError);

  /// @brief Method IsLeapYear, addr 0x204c05c, size 0x70, virtual false, abstract: false, final false
  inline bool IsLeapYear(int32_t year, int32_t era);

  /// @brief Method IsValidYear, addr 0x204b2a8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method TimeToTicks, addr 0x204b8d0, size 0x1bc, virtual false, abstract: false, final false
  static inline int64_t TimeToTicks(int32_t hour, int32_t minute, int32_t second, int32_t millisecond);

  /// @brief Method ToDateTime, addr 0x204c0cc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method ToFourDigitYear, addr 0x204c1d0, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x204af20, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Eras, addr 0x204be24, size 0xf0, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_Eras();

  /// @brief Method get_MaxYear, addr 0x204af18, size 0x8, virtual false, abstract: false, final false
