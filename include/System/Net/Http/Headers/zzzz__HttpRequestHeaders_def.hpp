...
public:
  ...
  static __declspec(property(get = getStaticF___9__30_0, put = setStaticF___9__30_0))::System::Predicate_1<::System::Net::Http::Headers::NameValueWithParametersHeaderValue*>* __9__30_0;
  ...
  /// @brief Method .ctor, addr 0x16274e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_ConnectionClose>b__19_0, addr 0x16274f0, size 0x50, virtual false, abstract: false, final false
  inline bool _get_ConnectionClose_b__19_0(::StringW l);

  /// @brief Method <get_ExpectContinue>b__29_0, addr 0x1627540, size 0x58, virtual false, abstract: false, final false
  inline bool _get_ExpectContinue_b__29_0(::System::Net::Http::Headers::TransferCodingHeaderValue* l);

  /// @brief Method <get_TransferEncodingChunked>b__71_0, addr 0x16275ec, size 0x58, virtual false, abstract: false, final false
  inline bool _get_TransferEncodingChunked_b__71_0(::System::Net::Http::Headers::TransferCodingHeaderValue* l);

  /// @brief Method <set_ExpectContinue>b__30_0, addr 0x1627598, size 0x54, virtual false, abstract: false, final false
  inline bool _set_ExpectContinue_b__30_0(::System::Net::Http::Headers::NameValueWithParametersHeaderValue* l);
  ...
  static inline ::System::Predicate_1<::System::Net::Http::Headers::NameValueWithParametersHeaderValue*>* getStaticF___9__30_0();
  ...
  static inline void setStaticF___9__30_0(::System::Predicate_1<::System::Net::Http::Headers::NameValueWithParametersHeaderValue*>* value);
...
public:
  ...
  __declspec(property(get = get_Expect))::System::Net::Http::Headers::HttpHeaderValueCollection_1<::System::Net::Http::Headers::NameValueWithParametersHeaderValue*>* Expect;

  __declspec(property(get = get_ExpectContinue, put = set_ExpectContinue))::System::Nullable_1<bool> ExpectContinue;
  ...
  /// @brief Method AddHeaders, addr 0x161ad80, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x161a4b4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Connection, addr 0x1616990, size 0x68, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpHeaderValueCollection_1<::StringW>* get_Connection();

  /// @brief Method get_ConnectionClose, addr 0x1617280, size 0x184, virtual false, abstract: false, final false
  inline ::System::Nullable_1<bool> get_ConnectionClose();

  /// @brief Method get_Expect, addr 0x16271a8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpHeaderValueCollection_1<::System::Net::Http::Headers::NameValueWithParametersHeaderValue*>* get_Expect();

  /// @brief Method get_ExpectContinue, addr 0x1617404, size 0x164, virtual false, abstract: false, final false
  inline ::System::Nullable_1<bool> get_ExpectContinue();

  /// @brief Method get_Host, addr 0x16175d0, size 0x68, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_TransferEncoding, addr 0x1627210, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TransferEncodingChunked, addr 0x1619758, size 0x164, virtual false, abstract: false, final false
  inline ::System::Nullable_1<bool> get_TransferEncodingChunked();

  /// @brief Method set_ExpectContinue, addr 0x1627278, size 0x204, virtual false, abstract: false, final false
  inline void set_ExpectContinue(::System::Nullable_1<bool> value);
