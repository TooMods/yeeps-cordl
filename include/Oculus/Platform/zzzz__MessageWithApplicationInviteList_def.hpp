...
public:
  // Declarations
  /// @brief Method GetApplicationInviteList, addr 0x19b293c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationInviteList* GetApplicationInviteList();

  /// @brief Method GetDataFromMessage, addr 0x19b2978, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b072c, size 0x58, virtual false, abstract: false, final false
