...
public:
  // Declarations
  /// @brief Method GetInnerUV, addr 0x2a86f2c, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetInnerUV(::UnityEngine::Sprite* sprite);

  /// @brief Method GetMinSize, addr 0x2a86f5c, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetMinSize(::UnityEngine::Sprite* sprite);

  /// @brief Method GetOuterUV, addr 0x2a86f3c, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetOuterUV(::UnityEngine::Sprite* sprite);

  /// @brief Method GetPadding, addr 0x2a86f4c, size 0x10, virtual false, abstract: false, final false
