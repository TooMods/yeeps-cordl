...
public:
  ...
  /// @brief Method .ctor, addr 0x12a688c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x12aa860, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callback, addr 0x12aa89c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationCollectionFixupCallback* get_Callback();

  /// @brief Method get_Collection, addr 0x12aa8a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Collection();

  /// @brief Method get_CollectionItems, addr 0x12aa8b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_CollectionItems();

  /// @brief Method get_Id, addr 0x12aa8ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Id();

  /// @brief Method set_CollectionItems, addr 0x12aa8bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x12aa8c4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* o, ::System::Xml::Serialization::XmlSerializationFixupCallback* callback, int32_t count);

  /// @brief Method get_Callback, addr 0x12aa944, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationFixupCallback* get_Callback();

  /// @brief Method get_Ids, addr 0x12aa94c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Ids();

  /// @brief Method get_Source, addr 0x12aa954, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x12a8c40, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* list, int32_t index, ::StringW id);

  /// @brief Method get_Collection, addr 0x12aa95c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Array* get_Collection();

  /// @brief Method get_Id, addr 0x12aa96c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_Index, addr 0x12aa964, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFixup, addr 0x12a666c, size 0xb4, virtual false, abstract: false, final false
  inline void AddFixup(::System::Xml::Serialization::__XmlSerializationReader__CollectionFixup* fixup);

  /// @brief Method AddFixup, addr 0x12a6764, size 0x44, virtual false, abstract: false, final false
  inline void AddFixup(::System::Xml::Serialization::__XmlSerializationReader__CollectionItemFixup* fixup);

  /// @brief Method AddFixup, addr 0x12a6720, size 0x44, virtual false, abstract: false, final false
  inline void AddFixup(::System::Xml::Serialization::__XmlSerializationReader__Fixup* fixup);

  /// @brief Method AddReadCallback, addr 0x12a67a8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTarget, addr 0x12a6894, size 0xa8, virtual false, abstract: false, final false
  inline void AddTarget(::StringW id, ::System::Object* o);

  /// @brief Method CreateReadOnlyCollectionException, addr 0x12a6a9c, size 0x98, virtual false, abstract: false, final false
  inline ::System::Exception* CreateReadOnlyCollectionException(::StringW name);

  /// @brief Method CreateUnknownConstantException, addr 0x12a6b34, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Exception* CreateUnknownConstantException(::StringW value, ::System::Type* enumType);

  /// @brief Method CreateUnknownNodeException, addr 0x12a6bd4, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Exception* CreateUnknownNodeException();

  /// @brief Method CreateUnknownTypeException, addr 0x12a6c70, size 0x208, virtual false, abstract: false, final false
  inline ::System::Exception* CreateUnknownTypeException(::System::Xml::XmlQualifiedName* type);

  /// @brief Method CurrentTag, addr 0x12a693c, size 0x160, virtual false, abstract: false, final false
  inline ::StringW CurrentTag();

  /// @brief Method EnsureArrayIndex, addr 0x12a6e78, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Array* EnsureArrayIndex(::System::Array* a, int32_t index, ::System::Type* elementType);

  /// @brief Method EnsureArrayList, addr 0x12a6504, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* EnsureArrayList(::System::Collections::ArrayList* list);

  /// @brief Method EnsureHashtable, addr 0x12a6568, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* EnsureHashtable(::System::Collections::Hashtable* hash);

  /// @brief Method GetCallbackInfo, addr 0x12a7d10, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNullAttr, addr 0x12a6f04, size 0xa8, virtual false, abstract: false, final false
  inline bool GetNullAttr();

  /// @brief Method GetTarget, addr 0x12a6fac, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Object* GetTarget(::StringW id);

  /// @brief Method GetXsiType, addr 0x12a7080, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x12a61dc, size 0x328, virtual false, abstract: false, final false
  inline void Initialize(::System::Xml::XmlReader* reader, ::System::Xml::Serialization::XmlSerializer* eventSource);

  /// @brief Method IsXmlnsAttribute, addr 0x12a7298, size 0xa0, virtual false, abstract: false, final false
  inline bool IsXmlnsAttribute(::StringW name);

  static inline ::System::Xml::Serialization::XmlSerializationReader* New_ctor();

  /// @brief Method OnUnknownNode, addr 0x12aa0d4, size 0x280, virtual false, abstract: false, final false
  inline void OnUnknownNode(::System::Xml::XmlNode* node, ::System::Object* o, ::StringW qnames);

  /// @brief Method ParseWsdlArrayType, addr 0x12a7338, size 0x184, virtual false, abstract: false, final false
  inline void ParseWsdlArrayType(::System::Xml::XmlAttribute* attr);

  /// @brief Method ReadElementQualifiedName, addr 0x12a74bc, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ReadElementQualifiedName();

  /// @brief Method ReadEndElement, addr 0x12a77f0, size 0x98, virtual false, abstract: false, final false
  inline void ReadEndElement();

  /// @brief Method ReadList, addr 0x12a7df0, size 0x4e0, virtual false, abstract: false, final false
  inline bool ReadList(ByRef<::System::Object*> resultList);

  /// @brief Method ReadNull, addr 0x12a7888, size 0xc8, virtual false, abstract: false, final false
  inline bool ReadNull();

  /// @brief Method ReadNullableQualifiedName, addr 0x12a7984, size 0x28, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ReadNullableQualifiedName();

  /// @brief Method ReadNullableString, addr 0x12a79ac, size 0x48, virtual false, abstract: false, final false
  inline ::StringW ReadNullableString();

  /// @brief Method ReadReferencedElement, addr 0x12a79f4, size 0x58, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencedElement();

  /// @brief Method ReadReferencedElement, addr 0x12a7a4c, size 0x2c4, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencedElement(::StringW name, ::StringW ns);

  /// @brief Method ReadReferencedElements, addr 0x12a8c80, size 0xea8, virtual false, abstract: false, final false
  inline void ReadReferencedElements();

  /// @brief Method ReadReferencingElement, addr 0x12a9bc4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencingElement(ByRef<::StringW> fixupReference);

  /// @brief Method ReadReferencingElement, addr 0x12a9c28, size 0x314, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencingElement(::StringW name, ::StringW ns, bool elementCanBeType, ByRef<::StringW> fixupReference);

  /// @brief Method ReadReferencingElement, addr 0x12a8c34, size 0xc, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencingElement(::StringW name, ::StringW ns, ByRef<::StringW> fixupReference);

  /// @brief Method ReadSerializable, addr 0x12a9f3c, size 0x190, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::IXmlSerializable* ReadSerializable(::System::Xml::Serialization::IXmlSerializable* serializable);

  /// @brief Method ReadTypedPrimitive, addr 0x12a82d0, size 0x964, virtual false, abstract: false, final false
  inline ::System::Object* ReadTypedPrimitive(::System::Xml::XmlQualifiedName* qname, bool reportUnknown);

  /// @brief Method ReadTypedPrimitive, addr 0x12aa0cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* ReadTypedPrimitive(::System::Xml::XmlQualifiedName* type);

  /// @brief Method ReadXmlDocument, addr 0x12aa3bc, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* ReadXmlDocument(bool wrapped);

  /// @brief Method ReadXmlNode, addr 0x12aa354, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ReadXmlNode(bool wrapped);

  /// @brief Method ShrinkArray, addr 0x12aa4d8, size 0x90, virtual false, abstract: false, final false
  inline ::System::Array* ShrinkArray(::System::Array* a, int32_t length, ::System::Type* elementType, bool isNullable);

  /// @brief Method TargetReady, addr 0x12a7064, size 0x1c, virtual false, abstract: false, final false
  inline bool TargetReady(::StringW id);

  /// @brief Method ToXmlQualifiedName, addr 0x12a75b8, size 0x238, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ToXmlQualifiedName(::StringW value);

  /// @brief Method UnknownAttribute, addr 0x12aa568, size 0x160, virtual false, abstract: false, final false
  inline void UnknownAttribute(::System::Object* o, ::System::Xml::XmlAttribute* attr, ::StringW qnames);

  /// @brief Method UnknownElement, addr 0x12aa6c8, size 0x160, virtual false, abstract: false, final false
  inline void UnknownElement(::System::Object* o, ::System::Xml::XmlElement* elem, ::StringW qnames);

  /// @brief Method UnknownNode, addr 0x12a7950, size 0x34, virtual false, abstract: false, final false
  inline void UnknownNode(::System::Object* o);

  /// @brief Method UnknownNode, addr 0x12aa828, size 0x38, virtual false, abstract: false, final false
  inline void UnknownNode(::System::Object* o, ::StringW qnames);

  /// @brief Method UnreferencedObject, addr 0x12a9b28, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a65cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Document, addr 0x12a65d4, size 0x90, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_Document();

  /// @brief Method get_Reader, addr 0x12a6664, size 0x8, virtual false, abstract: false, final false
