...
public:
  ...
  /// @brief Method AddMatch, addr 0x1717d34, size 0x224, virtual true, abstract: false, final false
  inline void AddMatch(int32_t cap, int32_t start, int32_t len);

  /// @brief Method BalanceMatch, addr 0x1717f58, size 0xd8, virtual true, abstract: false, final false
  inline void BalanceMatch(int32_t cap);

  /// @brief Method GroupToStringImpl, addr 0x1717b74, size 0x198, virtual true, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> GroupToStringImpl(int32_t groupnum);

  /// @brief Method IsMatched, addr 0x1718068, size 0x90, virtual true, abstract: false, final false
  inline bool IsMatched(int32_t cap);

  /// @brief Method LastGroupToStringImpl, addr 0x1717d0c, size 0x28, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> LastGroupToStringImpl();

  /// @brief Method MatchIndex, addr 0x17180f8, size 0x8c, virtual true, abstract: false, final false
  inline int32_t MatchIndex(int32_t cap);

  /// @brief Method MatchLength, addr 0x1718184, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method NextMatch, addr 0x17178b4, size 0x30, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* NextMatch();

  /// @brief Method RemoveMatch, addr 0x1718030, size 0x38, virtual true, abstract: false, final false
  inline void RemoveMatch(int32_t cap);

  /// @brief Method Reset, addr 0x17177e0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method Tidy, addr 0x1718210, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x171840c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1717618, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Empty, addr 0x1717788, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::Match* get_Empty();

  /// @brief Method get_Groups, addr 0x1717844, size 0x70, virtual true, abstract: false, final false
