...
public:
  ...
  /// @brief Method GetASN1, addr 0x245af58, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245acc0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x245adcc, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method .ctor, addr 0x245ad5c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x245ad38, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method get_ASN1, addr 0x245af54, size 0x4, virtual false, abstract: false, final false
  inline ::Mono::Security::ASN1* get_ASN1();

  /// @brief Method get_Content, addr 0x245b00c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::ASN1* get_Content();

  /// @brief Method get_ContentType, addr 0x245b01c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ContentType();

  /// @brief Method set_Content, addr 0x245b014, size 0x8, virtual false, abstract: false, final false
  inline void set_Content(::Mono::Security::ASN1* value);

  /// @brief Method set_ContentType, addr 0x245b024, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x245b02c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x245b048, size 0x2d8, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_EncryptedContent, addr 0x245b328, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_EncryptedContent();

  /// @brief Method get_EncryptionAlgorithm, addr 0x245b320, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OidToName, addr 0x245be98, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245b39c, size 0x4e4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_Certificates, addr 0x245c06c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates();

  /// @brief Method get_ContentInfo, addr 0x245c074, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::__PKCS7__ContentInfo* get_ContentInfo();

  /// @brief Method get_SignerInfo, addr 0x245c07c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::__PKCS7__SignerInfo* get_SignerInfo();

  /// @brief Method set_HashName, addr 0x245c04c, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x245be08, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x245ba90, size 0x378, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_AuthenticatedAttributes, addr 0x245c238, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_AuthenticatedAttributes();

  /// @brief Method get_HashName, addr 0x245c240, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_HashName();

  /// @brief Method get_IssuerName, addr 0x245c1bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IssuerName();

  /// @brief Method get_SerialNumber, addr 0x245c1c4, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_SerialNumber();

  /// @brief Method get_Signature, addr 0x245c250, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Signature();

  /// @brief Method get_UnauthenticatedAttributes, addr 0x245c2c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_UnauthenticatedAttributes();

  /// @brief Method get_Version, addr 0x245c2cc, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_Version();

  /// @brief Method set_HashName, addr 0x245c248, size 0x8, virtual false, abstract: false, final false
  inline void set_HashName(::StringW value);
