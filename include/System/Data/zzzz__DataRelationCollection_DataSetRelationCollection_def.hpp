...
public:
  ...
  /// @brief Method AddCore, addr 0x188f9a0, size 0x574, virtual true, abstract: false, final false
  inline void AddCore(::System::Data::DataRelation* relation);

  /// @brief Method Clear, addr 0x188f778, size 0x34, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method FinishInitRelations, addr 0x1890164, size 0x288, virtual false, abstract: false, final false
  inline void FinishInitRelations();

  /// @brief Method GetDataSet, addr 0x188f7ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCore, addr 0x188ff14, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x188f6d8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet);

  /// @brief Method get_Item, addr 0x188f7b4, size 0x100, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x188f8b4, size 0xec, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(::StringW name);

  /// @brief Method get_List, addr 0x188f770, size 0x8, virtual true, abstract: false, final false
