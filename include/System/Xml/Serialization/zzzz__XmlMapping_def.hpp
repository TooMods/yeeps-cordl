...
public:
  ...
  /// @brief Method SetKey, addr 0x129e9cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129e990, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName, ::StringW ns);

  /// @brief Method get_ElementName, addr 0x129e9bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Format, addr 0x129e9f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::SerializationFormat get_Format();

  /// @brief Method get_Namespace, addr 0x129e9c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ObjectMap, addr 0x129e9d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::ObjectMap* get_ObjectMap();

  /// @brief Method get_RelatedMaps, addr 0x129e9e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_RelatedMaps();

  /// @brief Method get_Source, addr 0x129ea04, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::SerializationSource* get_Source();

  /// @brief Method set_Format, addr 0x129e9fc, size 0x8, virtual false, abstract: false, final false
  inline void set_Format(::System::Xml::Serialization::SerializationFormat value);

  /// @brief Method set_ObjectMap, addr 0x129e9dc, size 0x8, virtual false, abstract: false, final false
  inline void set_ObjectMap(::System::Xml::Serialization::ObjectMap* value);

  /// @brief Method set_RelatedMaps, addr 0x129e9ec, size 0x8, virtual false, abstract: false, final false
