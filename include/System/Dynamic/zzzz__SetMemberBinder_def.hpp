...
public:
  ...
  /// @brief Method Bind, addr 0x1def20c, size 0xd4, virtual true, abstract: false, final true
  inline ::System::Dynamic::DynamicMetaObject* Bind(::System::Dynamic::DynamicMetaObject* target,
                                                    ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method FallbackSetMember, addr 0x1def2e8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1def120, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool ignoreCase);

  /// @brief Method get_IgnoreCase, addr 0x1def204, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreCase();

  /// @brief Method get_IsStandardBinder, addr 0x1def2e0, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsStandardBinder();

  /// @brief Method get_Name, addr 0x1def1fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ReturnType, addr 0x1def190, size 0x6c, virtual true, abstract: false, final true
