...
public:
  ...
  /// @brief Field Bytes value: static_cast<uint8_t>(0x2u)
  static ::Unity::Profiling::ProfilerMarkerDataUnit const Bytes;

  /// @brief Field Count value: static_cast<uint8_t>(0x3u)
  static ::Unity::Profiling::ProfilerMarkerDataUnit const Count;

  /// @brief Field FrequencyHz value: static_cast<uint8_t>(0x5u)
  static ::Unity::Profiling::ProfilerMarkerDataUnit const FrequencyHz;

  /// @brief Field Percent value: static_cast<uint8_t>(0x4u)
  static ::Unity::Profiling::ProfilerMarkerDataUnit const Percent;

  /// @brief Field TimeNanoseconds value: static_cast<uint8_t>(0x1u)
  static ::Unity::Profiling::ProfilerMarkerDataUnit const TimeNanoseconds;

  /// @brief Field Undefined value: static_cast<uint8_t>(0x0u)
