...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x21c2fa0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c2ecc, size 0xd4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckNeutral, addr 0x2282818, size 0x4, virtual false, abstract: false, final false
  inline void CheckNeutral();

  /// @brief Method Clone, addr 0x2281fbc, size 0x198, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Construct, addr 0x2281988, size 0x20, virtual false, abstract: false, final false
  inline void Construct();

  /// @brief Method ConstructCurrentCulture, addr 0x2281494, size 0x1e4, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* ConstructCurrentCulture();

  /// @brief Method ConstructCurrentUICulture, addr 0x2281898, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* ConstructCurrentUICulture();

  /// @brief Method ConstructInvariant, addr 0x2282cf8, size 0x14c, virtual false, abstract: false, final false
  inline void ConstructInvariant(bool read_only);

  /// @brief Method ConstructLocaleFromName, addr 0x22832dc, size 0x8c, virtual false, abstract: false, final false
  inline bool ConstructLocaleFromName(::StringW name);

  /// @brief Method CreateCalendar, addr 0x22819a8, size 0x238, virtual false, abstract: false, final false
  static inline ::System::Globalization::Calendar* CreateCalendar(int32_t calendarType);

  /// @brief Method CreateCulture, addr 0x22835d8, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* CreateCulture(::StringW name, bool reference);

  /// @brief Method CreateNotFoundException, addr 0x2283368, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Exception* CreateNotFoundException(::StringW name);

  /// @brief Method CreateSpecificCulture, addr 0x228167c, size 0x21c, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* CreateSpecificCulture(::StringW name);

  /// @brief Method CreateSpecificCultureFromNeutral, addr 0x228364c, size 0x2754, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* CreateSpecificCultureFromNeutral(::StringW name);

  /// @brief Method CreateTextInfo, addr 0x2281f44, size 0x78, virtual false, abstract: false, final false
  inline ::System::Globalization::TextInfo* CreateTextInfo(bool readOnly);

  /// @brief Method Equals, addr 0x2282154, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetCultureInfo, addr 0x2276300, size 0x244, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* GetCultureInfo(int32_t culture);

  /// @brief Method GetCultureInfo, addr 0x2276544, size 0x22c, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* GetCultureInfo(::StringW name);

  /// @brief Method GetCultureInfoForUserPreferredLanguageInAppX, addr 0x2285f10, size 0xe0, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* GetCultureInfoForUserPreferredLanguageInAppX();

  /// @brief Method GetCultures, addr 0x2282200, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFormat, addr 0x2282be0, size 0x110, virtual true, abstract: false, final false
  inline ::System::Object* GetFormat(::System::Type* formatType);

  /// @brief Method GetHashCode, addr 0x22824d0, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTextInfoData, addr 0x2282440, size 0x18, virtual false, abstract: false, final false
  inline ::System::Globalization::__CultureInfo__Data GetTextInfoData();

  /// @brief Method InitializeUserPreferredCultureInfoInAppX, addr 0x2285f00, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCultureInfoChangedInAppX, addr 0x22813c4, size 0xa0, virtual false, abstract: false, final false
  static inline void OnCultureInfoChangedInAppX(::StringW language);

  /// @brief Method ReadOnly, addr 0x22824dc, size 0x194, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* ReadOnly(::System::Globalization::CultureInfo* ci);

  /// @brief Method ToString, addr 0x2282670, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method VerifyCultureName, addr 0x228607c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2283430, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2281e1c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t culture);

  /// @brief Method .ctor, addr 0x2282e44, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t culture, bool useUserOverride);

  /// @brief Method .ctor, addr 0x2282e50, size 0x260, virtual false, abstract: false, final false
  inline void _ctor(int32_t culture, bool useUserOverride, bool read_only);

  /// @brief Method .ctor, addr 0x2273d00, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x227a2a0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool useUserOverride);

  /// @brief Method .ctor, addr 0x22830b0, size 0x22c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool useUserOverride, bool read_only);

  /// @brief Method construct_internal_locale_from_lcid, addr 0x2282cf0, size 0x4, virtual false, abstract: false, final false
  inline bool construct_internal_locale_from_lcid(int32_t lcid);

  /// @brief Method construct_internal_locale_from_name, addr 0x2282cf4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Calendar, addr 0x2281904, size 0x84, virtual true, abstract: false, final false
  inline ::System::Globalization::Calendar* get_Calendar();

  /// @brief Method get_CalendarType, addr 0x2282458, size 0x78, virtual false, abstract: false, final false
  inline int32_t get_CalendarType();

  /// @brief Method get_CompareInfo, addr 0x2282678, size 0x158, virtual true, abstract: false, final false
  inline ::System::Globalization::CompareInfo* get_CompareInfo();

  /// @brief Method get_CurrentCulture, addr 0x2272720, size 0x20, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_CurrentCulture();

  /// @brief Method get_CurrentUICulture, addr 0x2281474, size 0x20, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_CurrentUICulture();

  /// @brief Method get_DateTimeFormat, addr 0x2282978, size 0x160, virtual true, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatInfo* get_DateTimeFormat();

  /// @brief Method get_DefaultThreadCurrentCulture, addr 0x2285da0, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_DefaultThreadCurrentCulture();

  /// @brief Method get_DefaultThreadCurrentUICulture, addr 0x2285e00, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_DefaultThreadCurrentUICulture();

  /// @brief Method get_EnglishName, addr 0x2282ba8, size 0x30, virtual true, abstract: false, final false
  inline ::StringW get_EnglishName();

  /// @brief Method get_HasInvariantCultureName, addr 0x2285ff0, size 0x8c, virtual false, abstract: false, final false
  inline bool get_HasInvariantCultureName();

  /// @brief Method get_InvariantCulture, addr 0x227249c, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_InvariantCulture();

  /// @brief Method get_IsNeutralCulture, addr 0x22827d0, size 0x48, virtual true, abstract: false, final false
  inline bool get_IsNeutralCulture();

  /// @brief Method get_IsReadOnly, addr 0x2282bd8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LCID, addr 0x22818f4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_LCID();

  /// @brief Method get_Name, addr 0x22818fc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NumberFormat, addr 0x228281c, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Globalization::NumberFormatInfo* get_NumberFormat();

  /// @brief Method get_Parent, addr 0x2281be0, size 0x23c, virtual true, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Parent();

  /// @brief Method get_SortName, addr 0x2285e60, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SortName();

  /// @brief Method get_Territory, addr 0x22818e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Territory();

  /// @brief Method get_TextInfo, addr 0x2281e28, size 0x11c, virtual true, abstract: false, final false
  inline ::System::Globalization::TextInfo* get_TextInfo();

  /// @brief Method get_UserDefaultCulture, addr 0x2285eb4, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_UserDefaultCulture();

  /// @brief Method get_UserDefaultUICulture, addr 0x2285e68, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* get_UserDefaultUICulture();

  /// @brief Method get__cultureData, addr 0x2281464, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureData* get__cultureData();

  /// @brief Method get__isInherited, addr 0x228146c, size 0x8, virtual false, abstract: false, final false
  inline bool get__isInherited();

  /// @brief Method get__name, addr 0x22818ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get__name();

  /// @brief Method get_current_locale_name, addr 0x2281678, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method insert_into_shared_tables, addr 0x2283450, size 0x188, virtual false, abstract: false, final false
  static inline void insert_into_shared_tables(::System::Globalization::CultureInfo* c);

  /// @brief Method internal_get_cultures, addr 0x2282430, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DateTimeFormat, addr 0x2282ad8, size 0xd0, virtual true, abstract: false, final false
  inline void set_DateTimeFormat(::System::Globalization::DateTimeFormatInfo* value);

  /// @brief Method set_NumberFormat, addr 0x22828a8, size 0xd0, virtual true, abstract: false, final false
