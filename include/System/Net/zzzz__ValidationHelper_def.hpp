...
public:
  ...
  /// @brief Method IsBlankString, addr 0xf52638, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsBlankString(::StringW stringValue);

  /// @brief Method MakeStringNull, addr 0xf51acc, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW MakeStringNull(::StringW stringValue);

  /// @brief Method ValidateTcpPort, addr 0xf52654, size 0xc, virtual false, abstract: false, final false
