...
public:
  ...
  /// @brief Method Equals, addr 0x1620210, size 0x384, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1620594, size 0x260, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::CacheControlHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x161fca8, size 0x568, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x1621258, size 0x6e0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x16207f4, size 0x8f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16210ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Extensions, addr 0x161fa24, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::ICollection_1<::System::Net::Http::Headers::NameValueHeaderValue*>* get_Extensions();

  /// @brief Method get_MaxAge, addr 0x161faa4, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::TimeSpan> get_MaxAge();

  /// @brief Method get_MaxStale, addr 0x161fab8, size 0x8, virtual false, abstract: false, final false
  inline bool get_MaxStale();

  /// @brief Method get_MaxStaleLimit, addr 0x161facc, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::TimeSpan> get_MaxStaleLimit();

  /// @brief Method get_MinFresh, addr 0x161fae0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::TimeSpan> get_MinFresh();

  /// @brief Method get_MustRevalidate, addr 0x161faf4, size 0x8, virtual false, abstract: false, final false
  inline bool get_MustRevalidate();

  /// @brief Method get_NoCache, addr 0x161fb08, size 0x8, virtual false, abstract: false, final false
  inline bool get_NoCache();

  /// @brief Method get_NoCacheHeaders, addr 0x161fb1c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::ICollection_1<::StringW>* get_NoCacheHeaders();

  /// @brief Method get_NoStore, addr 0x161fb9c, size 0x8, virtual false, abstract: false, final false
  inline bool get_NoStore();

  /// @brief Method get_NoTransform, addr 0x161fbb0, size 0x8, virtual false, abstract: false, final false
  inline bool get_NoTransform();

  /// @brief Method get_OnlyIfCached, addr 0x161fbc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyIfCached();

  /// @brief Method get_Private, addr 0x161fbd8, size 0x8, virtual false, abstract: false, final false
  inline bool get_Private();

  /// @brief Method get_PrivateHeaders, addr 0x161fbec, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::ICollection_1<::StringW>* get_PrivateHeaders();

  /// @brief Method get_ProxyRevalidate, addr 0x161fc6c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ProxyRevalidate();

  /// @brief Method get_Public, addr 0x161fc80, size 0x8, virtual false, abstract: false, final false
  inline bool get_Public();

  /// @brief Method get_SharedMaxAge, addr 0x161fc94, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::TimeSpan> get_SharedMaxAge();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_MaxAge, addr 0x161fab0, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxAge(::System::Nullable_1<::System::TimeSpan> value);

  /// @brief Method set_MaxStale, addr 0x161fac0, size 0xc, virtual false, abstract: false, final false
  inline void set_MaxStale(bool value);

  /// @brief Method set_MaxStaleLimit, addr 0x161fad8, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxStaleLimit(::System::Nullable_1<::System::TimeSpan> value);

  /// @brief Method set_MinFresh, addr 0x161faec, size 0x8, virtual false, abstract: false, final false
  inline void set_MinFresh(::System::Nullable_1<::System::TimeSpan> value);

  /// @brief Method set_MustRevalidate, addr 0x161fafc, size 0xc, virtual false, abstract: false, final false
  inline void set_MustRevalidate(bool value);

  /// @brief Method set_NoCache, addr 0x161fb10, size 0xc, virtual false, abstract: false, final false
  inline void set_NoCache(bool value);

  /// @brief Method set_NoStore, addr 0x161fba4, size 0xc, virtual false, abstract: false, final false
  inline void set_NoStore(bool value);

  /// @brief Method set_NoTransform, addr 0x161fbb8, size 0xc, virtual false, abstract: false, final false
  inline void set_NoTransform(bool value);

  /// @brief Method set_OnlyIfCached, addr 0x161fbcc, size 0xc, virtual false, abstract: false, final false
  inline void set_OnlyIfCached(bool value);

  /// @brief Method set_Private, addr 0x161fbe0, size 0xc, virtual false, abstract: false, final false
  inline void set_Private(bool value);

  /// @brief Method set_ProxyRevalidate, addr 0x161fc74, size 0xc, virtual false, abstract: false, final false
  inline void set_ProxyRevalidate(bool value);

  /// @brief Method set_Public, addr 0x161fc88, size 0xc, virtual false, abstract: false, final false
  inline void set_Public(bool value);

  /// @brief Method set_SharedMaxAge, addr 0x161fca0, size 0x8, virtual false, abstract: false, final false
