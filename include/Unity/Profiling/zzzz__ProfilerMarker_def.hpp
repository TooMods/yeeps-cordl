...
public:
  ...
  /// @brief Method Dispose, addr 0x27e07ac, size 0x90, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x27e06d0, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Auto, addr 0x27e0648, size 0x88, virtual false, abstract: false, final false
  inline ::Unity::Profiling::__ProfilerMarker__AutoScope Auto();

  /// @brief Method .ctor, addr 0x27e0598, size 0x54, virtual false, abstract: false, final false
