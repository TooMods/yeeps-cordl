...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x17d75f0, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x17d7590, size 0x60, virtual false, abstract: false, final false
