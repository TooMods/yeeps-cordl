...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x304c59c, size 0x4, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method CreateInstance, addr 0x304d2f0, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method FindId, addr 0x304c5a0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessEntity, addr 0x304d0f4, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEntity, addr 0x304cf10, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveTextValue, addr 0x304ca24, size 0x74, virtual false, abstract: false, final false
  inline void SaveTextValue(::StringW value);

  /// @brief Method SendValidationEvent, addr 0x304cbd4, size 0x60, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code);

  /// @brief Method SendValidationEvent, addr 0x304c84c, size 0xec, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0x304c938, size 0xec, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method SendValidationEvent, addr 0x304ce18, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method SendValidationEvent, addr 0x304cd20, size 0xf8, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW msg, ::System::Xml::Schema::XmlSeverityType severity);

  /// @brief Method SendValidationEvent, addr 0x304cc34, size 0x8, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException* e);

  /// @brief Method SendValidationEvent, addr 0x304cc3c, size 0xe4, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException* e, ::System::Xml::Schema::XmlSeverityType severity);

  /// @brief Method Validate, addr 0x304c598, size 0x4, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method ValidateText, addr 0x304c5a8, size 0x2a4, virtual false, abstract: false, final false
  inline void ValidateText();

  /// @brief Method ValidateWhitespace, addr 0x304ca98, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x304c340, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::BaseValidator* other);

  /// @brief Method .ctor, addr 0x304ad80, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseUri, addr 0x304c3cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_BaseUri();

  /// @brief Method get_EventHandler, addr 0x304c3dc, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ValidationEventHandler* get_EventHandler();

  /// @brief Method get_NameTable, addr 0x304c3ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_PositionInfo, addr 0x304c3b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::PositionInfo* get_PositionInfo();

  /// @brief Method get_PreserveWhitespace, addr 0x304c590, size 0x8, virtual true, abstract: false, final false
  inline bool get_PreserveWhitespace();

  /// @brief Method get_Reader, addr 0x304c39c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlValidatingReaderImpl* get_Reader();

  /// @brief Method get_SchemaCollection, addr 0x304c3a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaCollection* get_SchemaCollection();

  /// @brief Method get_SchemaInfo, addr 0x304c4ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_SchemaInfo();

  /// @brief Method get_SchemaNames, addr 0x304b270, size 0x94, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaNames* get_SchemaNames();

  /// @brief Method get_XmlResolver, addr 0x304c3bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* get_XmlResolver();

  /// @brief Method set_BaseUri, addr 0x304c3d4, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseUri(::System::Uri* value);

  /// @brief Method set_DtdInfo, addr 0x304c4b4, size 0xdc, virtual false, abstract: false, final false
  inline void set_DtdInfo(::System::Xml::IDtdInfo* value);

  /// @brief Method set_XmlResolver, addr 0x304c3c4, size 0x8, virtual false, abstract: false, final false
