...
public:
  ...
  /// @brief Method MoveNext, addr 0x2de613c, size 0x584, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2de66c0, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BeginRead, addr 0x2de5bd8, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2de60f0, size 0x4c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x2de5da8, size 0x124, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* r);

  /// @brief Method FinishReading, addr 0x2de5fec, size 0x104, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FinishReading(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Flush, addr 0x2de57c8, size 0x40, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GetException, addr 0x2de5808, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2de5970, size 0x268, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method ReadAsync, addr 0x2de5ecc, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method Seek, addr 0x2de5748, size 0x40, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x2de5708, size 0x40, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x2de5788, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2de55c0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* innerStream);

  /// @brief Method get_CanRead, addr 0x2de56f8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x2de56f0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x2de5700, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_InnerStream, addr 0x2de55b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* get_InnerStream();

  /// @brief Method get_Length, addr 0x2de5630, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Operation, addr 0x2de55b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* get_Operation();

  /// @brief Method get_Position, addr 0x2de5670, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x2de56b0, size 0x40, virtual true, abstract: false, final false
