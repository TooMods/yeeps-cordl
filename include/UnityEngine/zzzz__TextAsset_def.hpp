...
public:
  ...
  /// @brief Method DecodeString, addr 0x283d8f8, size 0x284, virtual false, abstract: false, final false
  static inline ::StringW DecodeString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method ToString, addr 0x283db7c, size 0x4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_bytes, addr 0x283d87c, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_bytes();

  /// @brief Method get_text, addr 0x283d8b8, size 0x40, virtual false, abstract: false, final false
