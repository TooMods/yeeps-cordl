...
public:
  ...
  /// @brief Method Fallback, addr 0xee236c, size 0x40, virtual true, abstract: false, final false
  inline bool Fallback(::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method GetNextChar, addr 0xee24ec, size 0x40, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method InternalFallback, addr 0xee2548, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xee2538, size 0x10, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method TryBestFit, addr 0xee23ac, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xee20cc, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InternalSyncObject, addr 0xee22c8, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Object* get_InternalSyncObject();

  /// @brief Method get_Remaining, addr 0xee252c, size 0xc, virtual true, abstract: false, final false
