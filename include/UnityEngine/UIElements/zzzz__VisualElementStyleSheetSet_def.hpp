...
public:
  ...
  /// @brief Method Add, addr 0x2a45e08, size 0x1d0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::StyleSheet* styleSheet);

  /// @brief Method Equals, addr 0x2a46118, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2a4610c, size 0xc, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::VisualElementStyleSheetSet other);

  /// @brief Method GetHashCode, addr 0x2a46194, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Remove, addr 0x2a45fd8, size 0x134, virtual false, abstract: false, final false
  inline bool Remove(::UnityEngine::UIElements::StyleSheet* styleSheet);

  /// @brief Method .ctor, addr 0x2a45e00, size 0x8, virtual false, abstract: false, final false
