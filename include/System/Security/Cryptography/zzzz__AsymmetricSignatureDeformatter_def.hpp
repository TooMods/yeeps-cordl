...
public:
  ...
  /// @brief Method VerifySignature, addr 0x1d19514, size 0xb8, virtual true, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::HashAlgorithm* hash, ::ArrayW<uint8_t, ::Array<uint8_t>*> rgbSignature);
  ...
  /// @brief Method .ctor, addr 0x1d1950c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
