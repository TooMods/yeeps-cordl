...
public:
  ...
  /// @brief Method GetExpression, addr 0x182cc5c, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182cd20, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182cd28, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182cc20, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x182cd18, size 0x8, virtual true, abstract: false, final false
