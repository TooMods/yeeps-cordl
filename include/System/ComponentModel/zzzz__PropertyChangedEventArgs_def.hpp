...
public:
  ...
  /// @brief Method .ctor, addr 0x1b0f82c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW propertyName);

  /// @brief Method get_PropertyName, addr 0x1b0f898, size 0x8, virtual true, abstract: false, final false
