...
public:
  // Declarations
  /// @brief Method WriteRawFloat4Packed, addr 0x1293cec, size 0xa8, virtual false, abstract: false, final false
  inline void WriteRawFloat4Packed(float_t f0, float_t f1, float_t f2, float_t f3, int32_t destX, int32_t destY);

  /// @brief Method WriteRawInt2Packed, addr 0x1293d94, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x1293760, size 0xec, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Add(int32_t count);

  /// @brief Method Commit, addr 0x1293e30, size 0x64, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method Dispose, addr 0x1293578, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x12935e4, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::UIR::GradientSettingsAtlas* New_ctor(int32_t length);

  /// @brief Method PrepareAtlas, addr 0x1293e94, size 0x168, virtual false, abstract: false, final false
  inline void PrepareAtlas();

  /// @brief Method Reset, addr 0x129368c, size 0xcc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Write, addr 0x129384c, size 0x4a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129365c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MustCommit, addr 0x1293e1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_MustCommit();

  /// @brief Method get_atlas, addr 0x1293758, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_atlas();

  /// @brief Method get_disposed, addr 0x1293564, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_length, addr 0x129355c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_MustCommit, addr 0x1293e24, size 0xc, virtual false, abstract: false, final false
  inline void set_MustCommit(bool value);

  /// @brief Method set_disposed, addr 0x129356c, size 0xc, virtual false, abstract: false, final false
