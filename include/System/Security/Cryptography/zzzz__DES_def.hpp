...
public:
  ...
  /// @brief Method Create, addr 0x1d1b5ec, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::DES* Create();

  /// @brief Method Create, addr 0x1d1b730, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::DES* Create(::StringW algName);

  /// @brief Method IsLegalKeySize, addr 0x1d1b7d4, size 0x20, virtual false, abstract: false, final false
  static inline bool IsLegalKeySize(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method IsSemiWeakKey, addr 0x1d1b1a8, size 0x238, virtual false, abstract: false, final false
  static inline bool IsSemiWeakKey(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method IsWeakKey, addr 0x1d1b05c, size 0x14c, virtual false, abstract: false, final false
  static inline bool IsWeakKey(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  static inline ::System::Security::Cryptography::DES* New_ctor();

  /// @brief Method QuadWordFromBigEndian, addr 0x1d1b7f4, size 0x98, virtual false, abstract: false, final false
  static inline uint64_t QuadWordFromBigEndian(::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method .ctor, addr 0x1d1aef8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Key, addr 0x1d1af74, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Key, addr 0x1d1b3e0, size 0x20c, virtual true, abstract: false, final false
