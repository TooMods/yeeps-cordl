...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x185524c, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::System::Runtime::Remoting::Contexts::CrossContextDelegate* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x1855190, size 0xbc, virtual false, abstract: false, final false
