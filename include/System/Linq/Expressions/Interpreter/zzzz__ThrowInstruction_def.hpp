...
public:
  ...
  /// @brief Method Run, addr 0x184534c, size 0x90, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method WrapThrownObject, addr 0x18453dc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18452cc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x1845344, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x18452fc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x184533c, size 0x8, virtual true, abstract: false, final false
