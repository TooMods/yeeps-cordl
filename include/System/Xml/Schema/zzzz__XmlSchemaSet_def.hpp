...
public:
  ...
  /// @brief Method Add, addr 0x18af390, size 0x1ac, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* Add(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method Add, addr 0x18af334, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* Add(::StringW targetNamespace, ::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method Add, addr 0x18accb8, size 0x984, virtual false, abstract: false, final false
  inline void Add(::System::Xml::Schema::XmlSchemaSet* schemas);

  /// @brief Method Add, addr 0x18b2880, size 0x3a8, virtual false, abstract: false, final false
  inline void Add(::StringW targetNamespace, ::System::Xml::XmlReader* reader, ::System::Collections::Hashtable* validatedNamespaces);

  /// @brief Method AddSchemaToSet, addr 0x18b250c, size 0x374, virtual false, abstract: false, final false
  inline void AddSchemaToSet(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method AddToTable, addr 0x18b3904, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearTables, addr 0x18b093c, size 0x5c, virtual false, abstract: false, final false
  inline void ClearTables();

  /// @brief Method Compile, addr 0x18b0494, size 0x4a8, virtual false, abstract: false, final false
  inline void Compile();

  /// @brief Method Contains, addr 0x18b0418, size 0x7c, virtual false, abstract: false, final false
  inline bool Contains(::StringW targetNamespace);

  /// @brief Method CopyFromCompiledSet, addr 0x18ad63c, size 0x1a84, virtual false, abstract: false, final false
  inline void CopyFromCompiledSet(::System::Xml::Schema::XmlSchemaSet* otherSet);

  /// @brief Method CopyTo, addr 0x18b237c, size 0x16c, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<::System::Xml::Schema::XmlSchema*, ::Array<::System::Xml::Schema::XmlSchema*>*> schemas, int32_t index);

  /// @brief Method FindSchemaByNSAndUrl, addr 0x18af0c0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEventHandler, addr 0x18b3d98, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler();

  /// @brief Method GetResolver, addr 0x18b3d7c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method GetSchemaByUri, addr 0x18b3da0, size 0x140, virtual false, abstract: false, final false
  inline bool GetSchemaByUri(::System::Uri* schemaUri, ByRef<::System::Xml::Schema::XmlSchema*> schema);

  /// @brief Method GetSchemaNames, addr 0x18b3be8, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaNames* GetSchemaNames(::System::Xml::XmlNameTable* nt);

  /// @brief Method GetTargetNamespace, addr 0x18aff98, size 0x5c, virtual false, abstract: false, final false
  inline ::StringW GetTargetNamespace(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method InternalValidationCallback, addr 0x18b3ee8, size 0x44, virtual false, abstract: false, final false
  inline void InternalValidationCallback(::System::Object* sender, ::System::Xml::Schema::ValidationEventArgs* e);

  /// @brief Method IsSchemaLoaded, addr 0x18b2c28, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSchema, addr 0x18b2ee4, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* ParseSchema(::StringW targetNamespace, ::System::Xml::XmlReader* reader);

  /// @brief Method PreprocessSchema, addr 0x18b2288, size 0xf4, virtual false, abstract: false, final false
  inline bool PreprocessSchema(ByRef<::System::Xml::Schema::XmlSchema*> schema, ::StringW targetNamespace);

  /// @brief Method ProcessNewSubstitutionGroups, addr 0x18b3050, size 0x4d8, virtual false, abstract: false, final false
  inline void ProcessNewSubstitutionGroups(::System::Xml::Schema::XmlSchemaObjectTable* substitutionGroupsTable, bool resolve);

  /// @brief Method Remove, addr 0x18b009c, size 0x37c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* Remove(::System::Xml::Schema::XmlSchema* schema, bool forceCompile);

  /// @brief Method RemoveRecursive, addr 0x18af53c, size 0xa5c, virtual false, abstract: false, final false
  inline bool RemoveRecursive(::System::Xml::Schema::XmlSchema* schemaToRemove);

  /// @brief Method RemoveSchemaFromCaches, addr 0x18b1b2c, size 0x5f8, virtual false, abstract: false, final false
  inline void RemoveSchemaFromCaches(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method RemoveSchemaFromGlobalTables, addr 0x18b1090, size 0xa9c, virtual false, abstract: false, final false
  inline void RemoveSchemaFromGlobalTables(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method Reprocess, addr 0x18b0998, size 0x6f8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* Reprocess(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method ResolveSubstitutionGroup, addr 0x18b3528, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Schemas, addr 0x18b24e8, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* Schemas();

  /// @brief Method Schemas, addr 0x18b2124, size 0x164, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* Schemas(::StringW targetNamespace);

  /// @brief Method SendValidationEvent, addr 0x18afff4, size 0xa8, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException* e, ::System::Xml::Schema::XmlSeverityType severity);

  /// @brief Method VerifyTables, addr 0x18b3c90, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18ac614, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x18ac678, size 0x28c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nameTable);

  /// @brief Method add_ValidationEventHandler, addr 0x18ac904, size 0xc8, virtual false, abstract: false, final false
  inline void add_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler* value);

  /// @brief Method get_CompilationSettings, addr 0x18aca74, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaCompilationSettings* get_CompilationSettings();

  /// @brief Method get_CompiledInfo, addr 0x18b3d6c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_CompiledInfo();

  /// @brief Method get_Count, addr 0x18aca84, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_GlobalAttributes, addr 0x18acb10, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalAttributes();

  /// @brief Method get_GlobalElements, addr 0x18acaa8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalElements();

  /// @brief Method get_GlobalTypes, addr 0x18acb78, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalTypes();

  /// @brief Method get_InternalSyncObject, addr 0x18ac59c, size 0x78, virtual false, abstract: false, final false
  inline ::System::Object* get_InternalSyncObject();

  /// @brief Method get_IsCompiled, addr 0x18aca50, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompiled();

  /// @brief Method get_ReaderSettings, addr 0x18b3d74, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_ReaderSettings();

  /// @brief Method get_SchemaLocations, addr 0x18acc48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_SchemaLocations();

  /// @brief Method get_SortedSchemas, addr 0x18b3ee0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::SortedList* get_SortedSchemas();

  /// @brief Method get_SubstitutionGroups, addr 0x18acbe0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_SubstitutionGroups();

  /// @brief Method get_TypeExtensions, addr 0x18acc50, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_TypeExtensions();

  /// @brief Method remove_ValidationEventHandler, addr 0x18ac9cc, size 0x84, virtual false, abstract: false, final false
  inline void remove_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler* value);

  /// @brief Method set_CompilationSettings, addr 0x18aca7c, size 0x8, virtual false, abstract: false, final false
  inline void set_CompilationSettings(::System::Xml::Schema::XmlSchemaCompilationSettings* value);

  /// @brief Method set_XmlResolver, addr 0x18aca58, size 0x1c, virtual false, abstract: false, final false
