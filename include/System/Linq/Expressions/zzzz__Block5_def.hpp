...
public:
  ...
  /// @brief Method GetExpression, addr 0x182ce10, size 0xc4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182cedc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182cee4, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182cdc4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x182ced4, size 0x8, virtual true, abstract: false, final false
