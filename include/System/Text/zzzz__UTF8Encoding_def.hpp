...
public:
  ...
  /// @brief Method Reset, addr 0x1e97308, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e97300, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF8Encoding* encoding);

  /// @brief Method get_HasState, addr 0x1e97328, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Reset, addr 0x1e97340, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x1e97338, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF8Encoding* encoding);

  /// @brief Method get_HasState, addr 0x1e97360, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasState();
...
public:
  ...
  /// @brief Method Equals, addr 0x1e1f5c8, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FallbackInvalidByteSequence, addr 0x1e1ee54, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method FallbackInvalidByteSequence, addr 0x1e1e690, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x1e1c2c4, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e1c448, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW chars);

  /// @brief Method GetByteCount, addr 0x1e1c4d8, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x1e1d32c, size 0x654, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, ::System::Text::EncoderNLS* baseEncoder);

  /// @brief Method GetBytes, addr 0x1e1c810, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1ca8c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1d9a8, size 0x7a8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x1e1c5b0, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytesUnknown, addr 0x1e1eec8, size 0x1f4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytesUnknown(ByRef<::cordl_internals::Ptr<uint8_t>> pSrc, int32_t ch);

  /// @brief Method GetCharCount, addr 0x1e1cb8c, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e1cd10, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetCharCount, addr 0x1e1e150, size 0x540, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars, addr 0x1e1cde8, size 0x27c, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x1e1d064, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x1e1e6d0, size 0x784, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x1e1f0bc, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x1e1f120, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetHashCode, addr 0x1e1f698, size 0x60, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMaxByteCount, addr 0x1e1f184, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x1e1f28c, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetPreamble, addr 0x1e1f394, size 0xd4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  /// @brief Method GetString, addr 0x1e1d164, size 0x1c8, virtual true, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method InRange, addr 0x1e1d980, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method PtrDiff, addr 0x1e1d994, size 0xc, virtual false, abstract: false, final false
  static inline int32_t PtrDiff(::cordl_internals::Ptr<char16_t> a, ::cordl_internals::Ptr<char16_t> b);

  /// @brief Method PtrDiff, addr 0x1e1d9a0, size 0x8, virtual false, abstract: false, final false
  static inline int32_t PtrDiff(::cordl_internals::Ptr<uint8_t> a, ::cordl_internals::Ptr<uint8_t> b);

  /// @brief Method SetDefaultFallbacks, addr 0x1e1c1f4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e1c144, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1e1c164, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool encoderShouldEmitUTF8Identifier);

  /// @brief Method .ctor, addr 0x1e1c194, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Preamble, addr 0x1e1f468, size 0x160, virtual true, abstract: false, final false
