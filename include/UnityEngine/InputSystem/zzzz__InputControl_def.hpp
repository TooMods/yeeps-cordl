...
public:
  ...
  /// @brief Method AddProcessor, addr 0x1873078, size 0x4, virtual true, abstract: false, final false
  inline void AddProcessor(::System::Object* first);

  /// @brief Method ApplyParameterChanges, addr 0x187251c, size 0x90, virtual false, abstract: false, final false
  inline void ApplyParameterChanges();

  /// @brief Method BakeOffsetIntoStateBlockRecursive, addr 0x1872f1c, size 0xb0, virtual false, abstract: false, final false
  inline void BakeOffsetIntoStateBlockRecursive(uint32_t offset);

  /// @brief Method CalculateOptimizedControlDataType, addr 0x1872514, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType();

  /// @brief Method CallFinishSetupRecursive, addr 0x1872e60, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method DebuggerDisplay, addr 0x1871d58, size 0x124, virtual false, abstract: false, final false
  inline ::StringW DebuggerDisplay();

  /// @brief Method EnsureOptimizationTypeHasNotChanged, addr 0x1872978, size 0x428, virtual false, abstract: false, final false
  inline void EnsureOptimizationTypeHasNotChanged();

  /// @brief Method EvaluateMagnitude, addr 0x1871cc4, size 0x2c, virtual false, abstract: false, final false
  inline float_t EvaluateMagnitude();

  /// @brief Method EvaluateMagnitude, addr 0x1871f0c, size 0x8, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method FinishSetup, addr 0x1872258, size 0x4, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method GetChildControl, addr 0x1872068, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeviceIndex, addr 0x1872288, size 0x1bc, virtual false, abstract: false, final false
  inline int32_t GetDeviceIndex();

  /// @brief Method IsValueConsideredPressed, addr 0x1872fcc, size 0xac, virtual false, abstract: false, final false
  inline bool IsValueConsideredPressed(float_t value);

  /// @brief Method MakeChildPath, addr 0x1872184, size 0xac, virtual false, abstract: false, final false
  inline ::StringW MakeChildPath(::StringW path);

  /// @brief Method MarkAsStale, addr 0x187307c, size 0xc, virtual false, abstract: false, final false
  inline void MarkAsStale();

  /// @brief Method MarkAsStaleRecursively, addr 0x18725ac, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshConfiguration, addr 0x1872284, size 0x4, virtual true, abstract: false, final false
  inline void RefreshConfiguration();

  /// @brief Method RefreshConfigurationIfNeeded, addr 0x1871784, size 0x34, virtual false, abstract: false, final false
  inline void RefreshConfigurationIfNeeded();

  /// @brief Method SetOptimizedControlDataType, addr 0x1872724, size 0x78, virtual false, abstract: false, final false
  inline void SetOptimizedControlDataType();

  /// @brief Method SetOptimizedControlDataTypeRecursively, addr 0x187279c, size 0x1dc, virtual false, abstract: false, final false
  inline void SetOptimizedControlDataTypeRecursively();

  /// @brief Method ToString, addr 0x1871cf0, size 0x68, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetChildControl, addr 0x1871fe4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueFromBufferIntoState, addr 0x1871f14, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteValueFromObjectIntoState, addr 0x1871f7c, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1872230, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x1871bd8, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_Item(::StringW path);

  /// @brief Method get_aliases, addr 0x1871a50, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::InternedString> get_aliases();

  /// @brief Method get_children, addr 0x1871970, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_children();

  /// @brief Method get_currentStatePtr, addr 0x1871ef8, size 0x14, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> get_currentStatePtr();

  /// @brief Method get_defaultStatePtr, addr 0x1872458, size 0x48, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> get_defaultStatePtr();

  /// @brief Method get_device, addr 0x1871960, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method get_displayName, addr 0x187172c, size 0x58, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_dontReset, addr 0x1872df0, size 0xc, virtual false, abstract: false, final false
  inline bool get_dontReset();

  /// @brief Method get_hasDefaultState, addr 0x1872e40, size 0x20, virtual false, abstract: false, final false
  inline bool get_hasDefaultState();

  /// @brief Method get_isButton, addr 0x1872dc8, size 0xc, virtual false, abstract: false, final false
  inline bool get_isButton();

  /// @brief Method get_isConfigUpToDate, addr 0x187225c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isConfigUpToDate();

  /// @brief Method get_isSetupFinished, addr 0x1872da0, size 0xc, virtual false, abstract: false, final false
  inline bool get_isSetupFinished();

  /// @brief Method get_layout, addr 0x1871940, size 0x10, virtual false, abstract: false, final false
  inline ::StringW get_layout();

  /// @brief Method get_magnitude, addr 0x1871cc0, size 0x4, virtual false, abstract: false, final false
  inline float_t get_magnitude();

  /// @brief Method get_name, addr 0x187171c, size 0x10, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_noiseMaskPtr, addr 0x18724a0, size 0x48, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> get_noiseMaskPtr();

  /// @brief Method get_noisy, addr 0x1871acc, size 0xc, virtual false, abstract: false, final false
  inline bool get_noisy();

  /// @brief Method get_optimizedControlDataType, addr 0x187250c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_optimizedControlDataType();

  /// @brief Method get_parent, addr 0x1871968, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_parent();

  /// @brief Method get_path, addr 0x187180c, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_path();

  /// @brief Method get_previousFrameStatePtr, addr 0x1872444, size 0x14, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> get_previousFrameStatePtr();

  /// @brief Method get_shortDisplayName, addr 0x18717c0, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_shortDisplayName();

  /// @brief Method get_stateBlock, addr 0x1871ac0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputStateBlock get_stateBlock();

  /// @brief Method get_stateOffsetRelativeToDeviceRoot, addr 0x18724e8, size 0x24, virtual false, abstract: false, final false
  inline uint32_t get_stateOffsetRelativeToDeviceRoot();

  /// @brief Method get_synthetic, addr 0x1871bb0, size 0xc, virtual false, abstract: false, final false
  inline bool get_synthetic();

  /// @brief Method get_usages, addr 0x18719e0, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::InternedString> get_usages();

  /// @brief Method get_usesStateFromOtherControl, addr 0x1872e18, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_variants, addr 0x1871950, size 0x10, virtual false, abstract: false, final false
  inline ::StringW get_variants();

  /// @brief Method set_displayName, addr 0x18717b8, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method set_dontReset, addr 0x1872dfc, size 0x1c, virtual false, abstract: false, final false
  inline void set_dontReset(bool value);

  /// @brief Method set_isButton, addr 0x1872dd4, size 0x1c, virtual false, abstract: false, final false
  inline void set_isButton(bool value);

  /// @brief Method set_isConfigUpToDate, addr 0x1872268, size 0x1c, virtual false, abstract: false, final false
  inline void set_isConfigUpToDate(bool value);

  /// @brief Method set_isSetupFinished, addr 0x1872dac, size 0x1c, virtual false, abstract: false, final false
  inline void set_isSetupFinished(bool value);

  /// @brief Method set_noisy, addr 0x1871ad8, size 0xd8, virtual false, abstract: false, final false
  inline void set_noisy(bool value);

  /// @brief Method set_shortDisplayName, addr 0x1871804, size 0x8, virtual false, abstract: false, final false
  inline void set_shortDisplayName(::StringW value);

  /// @brief Method set_synthetic, addr 0x1871bbc, size 0x1c, virtual false, abstract: false, final false
  inline void set_synthetic(bool value);

  /// @brief Method set_usesStateFromOtherControl, addr 0x1872e24, size 0x1c, virtual false, abstract: false, final false
