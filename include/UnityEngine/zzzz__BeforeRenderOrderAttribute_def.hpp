...
public:
  ...
  /// @brief Method .ctor, addr 0x27f87b8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t order);

  /// @brief Method get_order, addr 0x27f87a8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_order();

  /// @brief Method set_order, addr 0x27f87b0, size 0x8, virtual false, abstract: false, final false
