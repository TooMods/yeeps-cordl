...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x1e00144, size 0x8f4, virtual false, abstract: false, final false
  static inline void Initialize();

  static inline ::UnityEngine::InputSystem::Android::AndroidSupport* New_ctor();

  /// @brief Method OnFindLayoutForDevice, addr 0x1e00a38, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1e00d4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
