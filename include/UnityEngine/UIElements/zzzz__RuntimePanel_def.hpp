...
public:
  ...
  /// @brief Method Create, addr 0x27b6ef4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x27b71d0, size 0x80, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x27b6f54, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_panelSettings, addr 0x27b6eec, size 0x8, virtual true, abstract: false, final true
