...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x24333d0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidCanonical, addr 0x2433400, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x2433a5c, size 0x106c, virtual false, abstract: false, final false
  static inline bool Parse(::StringW name, ::cordl_internals::Ptr<uint8_t> numbers, int32_t start, int32_t end);

  /// @brief Method ParseCanonical, addr 0x2433344, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCanonicalName, addr 0x2433834, size 0x228, virtual false, abstract: false, final false
  static inline ::StringW ParseCanonicalName(::StringW str, int32_t start, int32_t end, ByRef<bool> isLoopback);

  /// @brief Method ParseHostNumber, addr 0x2433314, size 0x30, virtual false, abstract: false, final false
  static inline int32_t ParseHostNumber(::System::ReadOnlySpan_1<char16_t> str, int32_t start, int32_t end);

  /// @brief Method ParseNonCanonical, addr 0x2433540, size 0x2f4, virtual false, abstract: false, final false
