...
public:
  ...
  /// @brief Method .ctor, addr 0x2f64bc4, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, bool includeLength);

  /// @brief Method get_ByteCount, addr 0x2f64fc4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ByteCount();

  /// @brief Method get_IncludeLength, addr 0x2f64fd4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IncludeLength();

  /// @brief Method set_ByteCount, addr 0x2f64fcc, size 0x8, virtual false, abstract: false, final false
