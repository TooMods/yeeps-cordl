...
public:
  ...
  /// @brief Method Awake, addr 0x16ec658, size 0x104, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method GetFaceExpression, addr 0x16ec8a8, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__OVRFaceExpressions__FaceExpression GetFaceExpression(int32_t blendShapeIndex);

  /// @brief Method GetWeightValue, addr 0x16ec8b0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method RetrieveSkinnedMeshRenderer, addr 0x16ec608, size 0x48, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::SkinnedMeshRenderer> RetrieveSkinnedMeshRenderer();

  /// @brief Method SearchFaceExpressions, addr 0x16ec75c, size 0x58, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRFaceExpressions> SearchFaceExpressions();

  /// @brief Method Start, addr 0x16e9acc, size 0x50, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x16ec7b4, size 0xf4, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x16e9c9c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BlendShapeStrengthMultiplier, addr 0x16ec5f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_BlendShapeStrengthMultiplier();

  /// @brief Method get_FaceExpressions, addr 0x16ec5e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRFaceExpressions> get_FaceExpressions();

  /// @brief Method get_SkinnedMesh, addr 0x16ec650, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::SkinnedMeshRenderer> get_SkinnedMesh();

  /// @brief Method set_BlendShapeStrengthMultiplier, addr 0x16ec600, size 0x8, virtual false, abstract: false, final false
  inline void set_BlendShapeStrengthMultiplier(float_t value);

  /// @brief Method set_FaceExpressions, addr 0x16ec5f0, size 0x8, virtual false, abstract: false, final false
