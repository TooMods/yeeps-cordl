...
public:
  ...
  /// @brief Method get_NextPage, addr 0x1b32dd0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode, ::Array<::MS::Internal::Xml::Cache::XPathNode>*> get_NextPage();

  /// @brief Method get_NodeCount, addr 0x1b32dc8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NodeCount();

  /// @brief Method get_PageNumber, addr 0x1b32dc0, size 0x8, virtual false, abstract: false, final false
