...
public:
  ...
  /// @brief Method CreateContentReadStreamAsync, addr 0x161a198, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method SerializeToStreamAsync, addr 0x161a258, size 0x28, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SerializeToStreamAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method TryComputeLength, addr 0x161a280, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x161a110, size 0x80, virtual false, abstract: false, final false
