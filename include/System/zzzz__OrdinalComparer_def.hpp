...
public:
  ...
  /// @brief Method Compare, addr 0x2f04ed8, size 0x58, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x2f05038, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2f04f30, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x2f050d0, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x2f04fb0, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f04e6c, size 0x6c, virtual false, abstract: false, final false
