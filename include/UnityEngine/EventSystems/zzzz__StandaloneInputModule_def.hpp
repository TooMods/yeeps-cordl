...
public:
  ...
  /// @brief Method ActivateModule, addr 0x2b6da68, size 0x100, virtual true, abstract: false, final false
  inline void ActivateModule();

  /// @brief Method DeactivateModule, addr 0x2b6db68, size 0x4, virtual true, abstract: false, final false
  inline void DeactivateModule();

  /// @brief Method ForceAutoSelect, addr 0x2b6ed50, size 0x8, virtual true, abstract: false, final false
  inline bool ForceAutoSelect();

  /// @brief Method GetCurrentFocusedGameObject, addr 0x2b6f0ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> GetCurrentFocusedGameObject();

  /// @brief Method GetRawMoveVector, addr 0x2b6e998, size 0x110, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetRawMoveVector();

  static inline ::UnityEngine::EventSystems::StandaloneInputModule* New_ctor();

  /// @brief Method Process, addr 0x2b6db6c, size 0xa4, virtual true, abstract: false, final false
  inline void Process();

  /// @brief Method ProcessMouseEvent, addr 0x2b6debc, size 0x8, virtual false, abstract: false, final false
  inline void ProcessMouseEvent();

  /// @brief Method ProcessMouseEvent, addr 0x2b6eaa8, size 0x2a8, virtual false, abstract: false, final false
  inline void ProcessMouseEvent(int32_t id);

  /// @brief Method ProcessMousePress, addr 0x2b6ed58, size 0x354, virtual false, abstract: false, final false
  inline void ProcessMousePress(::UnityEngine::EventSystems::__PointerInputModule__MouseButtonEventData* data);

  /// @brief Method ProcessTouchEvents, addr 0x2b6dd58, size 0x164, virtual false, abstract: false, final false
  inline bool ProcessTouchEvents();

  /// @brief Method ProcessTouchPress, addr 0x2b6e334, size 0x664, virtual false, abstract: false, final false
  inline void ProcessTouchPress(::UnityEngine::EventSystems::PointerEventData* pointerEvent, bool pressed, bool released);

  /// @brief Method ReleaseMouse, addr 0x2b6d4c8, size 0x36c, virtual false, abstract: false, final false
  inline void ReleaseMouse(::UnityEngine::EventSystems::PointerEventData* pointerEvent, ::UnityEngine::GameObject* currentOverGo);

  /// @brief Method SendMoveEventToSelectedObject, addr 0x2b6dec4, size 0x264, virtual false, abstract: false, final false
  inline bool SendMoveEventToSelectedObject();

  /// @brief Method SendSubmitEventToSelectedObject, addr 0x2b6e128, size 0x20c, virtual false, abstract: false, final false
  inline bool SendSubmitEventToSelectedObject();

  /// @brief Method SendUpdateEventToSelectedObject, addr 0x2b6dc10, size 0x148, virtual false, abstract: false, final false
  inline bool SendUpdateEventToSelectedObject();

  /// @brief Method ShouldActivateModule, addr 0x2b6d834, size 0x234, virtual true, abstract: false, final false
  inline bool ShouldActivateModule();

  /// @brief Method ShouldIgnoreEventsOnNoFocus, addr 0x2b6d3f0, size 0x8, virtual false, abstract: false, final false
  inline bool ShouldIgnoreEventsOnNoFocus();

  /// @brief Method UpdateModule, addr 0x2b6d3f8, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6d2a4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowActivationOnMobileDevice, addr 0x2b6d368, size 0x8, virtual false, abstract: false, final false
  inline bool get_allowActivationOnMobileDevice();

  /// @brief Method get_cancelButton, addr 0x2b6d3e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_cancelButton();

  /// @brief Method get_forceModuleActive, addr 0x2b6d37c, size 0x8, virtual false, abstract: false, final false
  inline bool get_forceModuleActive();

  /// @brief Method get_horizontalAxis, addr 0x2b6d3b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_horizontalAxis();

  /// @brief Method get_inputActionsPerSecond, addr 0x2b6d390, size 0x8, virtual false, abstract: false, final false
  inline float_t get_inputActionsPerSecond();

  /// @brief Method get_inputMode, addr 0x2b6d360, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::__StandaloneInputModule__InputMode get_inputMode();

  /// @brief Method get_repeatDelay, addr 0x2b6d3a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_repeatDelay();

  /// @brief Method get_submitButton, addr 0x2b6d3d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_submitButton();

  /// @brief Method get_verticalAxis, addr 0x2b6d3c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_verticalAxis();

  /// @brief Method set_allowActivationOnMobileDevice, addr 0x2b6d370, size 0xc, virtual false, abstract: false, final false
  inline void set_allowActivationOnMobileDevice(bool value);

  /// @brief Method set_cancelButton, addr 0x2b6d3e8, size 0x8, virtual false, abstract: false, final false
  inline void set_cancelButton(::StringW value);

  /// @brief Method set_forceModuleActive, addr 0x2b6d384, size 0xc, virtual false, abstract: false, final false
  inline void set_forceModuleActive(bool value);

  /// @brief Method set_horizontalAxis, addr 0x2b6d3b8, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalAxis(::StringW value);

  /// @brief Method set_inputActionsPerSecond, addr 0x2b6d398, size 0x8, virtual false, abstract: false, final false
  inline void set_inputActionsPerSecond(float_t value);

  /// @brief Method set_repeatDelay, addr 0x2b6d3a8, size 0x8, virtual false, abstract: false, final false
  inline void set_repeatDelay(float_t value);

  /// @brief Method set_submitButton, addr 0x2b6d3d8, size 0x8, virtual false, abstract: false, final false
  inline void set_submitButton(::StringW value);

  /// @brief Method set_verticalAxis, addr 0x2b6d3c8, size 0x8, virtual false, abstract: false, final false
