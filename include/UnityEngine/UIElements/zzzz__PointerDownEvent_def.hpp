...
public:
  // Declarations
  /// @brief Method Init, addr 0x2cce688, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cce6d8, size 0x104, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerDownEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x2cce82c, size 0x264, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method .ctor, addr 0x2cce7dc, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
