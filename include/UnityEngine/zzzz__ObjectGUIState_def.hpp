...
public:
  ...
  /// @brief Method Destroy, addr 0x2d1788c, size 0xa0, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x2d1782c, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x2d1792c, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Create, addr 0x2d17804, size 0x28, virtual false, abstract: false, final false
  static inline void* Internal_Create();

  /// @brief Method Internal_Destroy, addr 0x2d179c0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d177bc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
