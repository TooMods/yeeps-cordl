...
public:
  ...
  /// @brief Method Copy, addr 0x2a415b4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Get, addr 0x2a41660, size 0xe0, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* Get(int32_t initialCapacity);

  /// @brief Method Release, addr 0x2a41740, size 0xb4, virtual false, abstract: false, final false
