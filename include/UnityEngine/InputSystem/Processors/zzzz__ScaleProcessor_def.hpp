...
public:
  ...
  /// @brief Method Process, addr 0x21dc09c, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x21dc0a8, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21dc12c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
