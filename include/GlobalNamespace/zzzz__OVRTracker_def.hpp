...
public:
  ...
  /// @brief Method GetFrustum, addr 0x14e19b0, size 0xa4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRTracker__Frustum GetFrustum(int32_t tracker);

  /// @brief Method GetPose, addr 0x14e1a54, size 0x2b0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose GetPose(int32_t tracker);

  /// @brief Method GetPoseValid, addr 0x14e1d04, size 0x104, virtual false, abstract: false, final false
  inline bool GetPoseValid(int32_t tracker);

  /// @brief Method GetPresent, addr 0x14e18ac, size 0x104, virtual false, abstract: false, final false
  inline bool GetPresent(int32_t tracker);

  static inline ::GlobalNamespace::OVRTracker* New_ctor();

  /// @brief Method .ctor, addr 0x14e1e08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_count, addr 0x14e1870, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_count();

  /// @brief Method get_isEnabled, addr 0x14e174c, size 0x90, virtual false, abstract: false, final false
  inline bool get_isEnabled();

  /// @brief Method get_isPositionTracked, addr 0x14e16fc, size 0x50, virtual false, abstract: false, final false
  inline bool get_isPositionTracked();

  /// @brief Method get_isPresent, addr 0x14e166c, size 0x90, virtual false, abstract: false, final false
  inline bool get_isPresent();

  /// @brief Method set_isEnabled, addr 0x14e17dc, size 0x94, virtual false, abstract: false, final false
