...
public:
  ...
  /// @brief Method Apply, addr 0x27ede64, size 0xc, virtual false, abstract: false, final false
  inline void Apply();

  /// @brief Method Apply, addr 0x27eddd8, size 0x8c, virtual false, abstract: false, final false
  inline void Apply(bool updateMipmaps, bool makeNoLongerReadable);

  /// @brief Method ApplyImpl, addr 0x27ecc04, size 0x54, virtual false, abstract: false, final false
  inline void ApplyImpl(bool updateMipmaps, bool makeNoLongerReadable);

  /// @brief Method CreateExternalTexture, addr 0x27ed964, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPixelBilinear, addr 0x27edc48, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::Color GetPixelBilinear(float_t u, float_t v);

  /// @brief Method GetPixelBilinearImpl, addr 0x27ecda4, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::Color GetPixelBilinearImpl(int32_t image, int32_t mip, float_t u, float_t v);

  /// @brief Method GetPixelBilinearImpl_Injected, addr 0x27ece2c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPixels, addr 0x27ee1c0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> GetPixels();

  /// @brief Method GetPixels, addr 0x27ee12c, size 0x94, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> GetPixels(int32_t miplevel);

  /// @brief Method GetPixels, addr 0x27ed204, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPixels32, addr 0x27ed278, size 0x44, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> GetPixels32(int32_t miplevel);

  /// @brief Method GetRawImageDataSize, addr 0x27ed174, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWritableImageData, addr 0x27ed130, size 0x44, virtual false, abstract: false, final false
  inline void* GetWritableImageData(int32_t frame);

  /// @brief Method Internal_Create, addr 0x27ecaf0, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CreateImpl, addr 0x27eca6c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadRawTextureData, addr 0x27edcb0, size 0x128, virtual false, abstract: false, final false
  inline void LoadRawTextureData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method LoadRawTextureDataImplArray, addr 0x27ed078, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPixels, addr 0x27ee088, size 0x8, virtual false, abstract: false, final false
  inline void ReadPixels(::UnityEngine::Rect source, int32_t destX, int32_t destY);

  /// @brief Method ReadPixels, addr 0x27edfe8, size 0xa0, virtual false, abstract: false, final false
  inline void ReadPixels(::UnityEngine::Rect source, int32_t destX, int32_t destY, bool recalculateMipMaps);

  /// @brief Method ReadPixelsImpl, addr 0x27ecf0c, size 0x74, virtual false, abstract: false, final false
  inline void ReadPixelsImpl(::UnityEngine::Rect source, int32_t destX, int32_t destY, bool recalculateMipMaps);

  /// @brief Method ReadPixelsImpl_Injected, addr 0x27ecf80, size 0x6c, virtual false, abstract: false, final false
  inline void ReadPixelsImpl_Injected(ByRef<::UnityEngine::Rect> source, int32_t destX, int32_t destY, bool recalculateMipMaps);

  /// @brief Method Reinitialize, addr 0x27ede70, size 0x8c, virtual false, abstract: false, final false
  inline bool Reinitialize(int32_t width, int32_t height);

  /// @brief Method Reinitialize, addr 0x27edefc, size 0xec, virtual false, abstract: false, final false
  inline bool Reinitialize(int32_t width, int32_t height, ::UnityEngine::TextureFormat format, bool hasMipMap);

  /// @brief Method ReinitializeImpl, addr 0x27ecc58, size 0x54, virtual false, abstract: false, final false
  inline bool ReinitializeImpl(int32_t width, int32_t height);

  /// @brief Method ReinitializeWithFormatImpl, addr 0x27ecea0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAllPixels32, addr 0x27ed1b0, size 0x54, virtual false, abstract: false, final false
  inline void SetAllPixels32(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors, int32_t miplevel);

  /// @brief Method SetPixel, addr 0x27eda88, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPixelDataImplArray, addr 0x27ed0bc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPixelImpl, addr 0x27eccac, size 0x84, virtual false, abstract: false, final false
  inline void SetPixelImpl(int32_t image, int32_t mip, int32_t x, int32_t y, ::UnityEngine::Color color);

  /// @brief Method SetPixelImpl_Injected, addr 0x27ecd30, size 0x74, virtual false, abstract: false, final false
  inline void SetPixelImpl_Injected(int32_t image, int32_t mip, int32_t x, int32_t y, ByRef<::UnityEngine::Color> color);

  /// @brief Method SetPixels, addr 0x27edbec, size 0x5c, virtual false, abstract: false, final false
  inline void SetPixels(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> colors);

  /// @brief Method SetPixels, addr 0x27edbe4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPixels, addr 0x27edb24, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPixels32, addr 0x27ee0e4, size 0x48, virtual false, abstract: false, final false
  inline void SetPixels32(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors);

  /// @brief Method SetPixels32, addr 0x27ee090, size 0x54, virtual false, abstract: false, final false
  inline void SetPixels32(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors, int32_t miplevel);

  /// @brief Method SetPixelsImpl, addr 0x27ecfec, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateFormat, addr 0x27ed3a4, size 0x134, virtual false, abstract: false, final false
  inline bool ValidateFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format, int32_t width, int32_t height);

  /// @brief Method ValidateFormat, addr 0x27ed2bc, size 0xe8, virtual false, abstract: false, final false
  inline bool ValidateFormat(::UnityEngine::TextureFormat format, int32_t width, int32_t height);

  /// @brief Method .ctor, addr 0x27ed5ac, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27ed65c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27ed4d8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27ed8d8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method .ctor, addr 0x27ed848, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::TextureFormat textureFormat, int32_t mipCount, bool linear);

  /// @brief Method .ctor, addr 0x27ed70c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_blackTexture, addr 0x27eca44, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> get_blackTexture();

  /// @brief Method get_format, addr 0x27ec9e0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextureFormat get_format();

  /// @brief Method get_isReadable, addr 0x27ecbc8, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method get_whiteTexture, addr 0x27eca1c, size 0x28, virtual false, abstract: false, final false
