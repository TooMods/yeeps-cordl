...
public:
  ...
  /// @brief Method Create, addr 0x1859030, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArgs, addr 0x185fd30, size 0x10, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetArgs(::System::Collections::ArrayList* args);

  /// @brief Method GetArguments, addr 0x185fbf0, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x185fa00, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodCallMessage* callMsg);

  /// @brief Method get_PropertiesCount, addr 0x185fd40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PropertiesCount();

  /// @brief Method get_Uri, addr 0x185f9f8, size 0x8, virtual false, abstract: false, final false
