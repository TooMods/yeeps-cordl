...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b5468, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::RejoinDialogResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetRejoinDialogResult, addr 0x19b542c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b13e4, size 0x58, virtual false, abstract: false, final false
