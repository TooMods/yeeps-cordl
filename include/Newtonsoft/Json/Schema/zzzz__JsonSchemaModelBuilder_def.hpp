...
public:
  ...
  /// @brief Method AddAdditionalItems, addr 0x109eb40, size 0x24, virtual false, abstract: false, final false
  inline void AddAdditionalItems(::Newtonsoft::Json::Schema::JsonSchemaNode* parentNode, ::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method AddAdditionalProperties, addr 0x109eb64, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method AddItem, addr 0x109e9e4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddProperties, addr 0x109e6e8, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddProperty, addr 0x109eb88, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSchema, addr 0x109d564, size 0x638, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x109d454, size 0xc8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaModel* Build(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method BuildNodeModel, addr 0x109db9c, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x109eccc, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
