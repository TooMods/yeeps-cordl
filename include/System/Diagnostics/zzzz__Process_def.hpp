...
public:
  ...
  __declspec(property(put = set_EnableRaisingEvents)) bool EnableRaisingEvents;
  ...
  /// @brief Method Close, addr 0x12bc198, size 0x158, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method CompletionCallback, addr 0x12bc130, size 0x18, virtual false, abstract: false, final false
  inline void CompletionCallback(::System::Object* context, bool wasSignaled);

  /// @brief Method CreatePipe, addr 0x12be7e8, size 0x19c, virtual false, abstract: false, final false
  static inline void CreatePipe(ByRef<void*> read, ByRef<void*> write, bool writeDirection);

  /// @brief Method CreateProcess_internal, addr 0x12be650, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x12bc148, size 0x50, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureState, addr 0x12bab98, size 0x138, virtual false, abstract: false, final false
  inline void EnsureState(::System::Diagnostics::__Process__State state);

  /// @brief Method EnsureWatchingForExit, addr 0x12bbb88, size 0x234, virtual false, abstract: false, final false
  inline void EnsureWatchingForExit();

  /// @brief Method FillUserInfo, addr 0x12be6a8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcess, addr 0x12b6590, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::Process* GetCurrentProcess();

  /// @brief Method GetProcessById, addr 0x12bc304, size 0x48, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::Process* GetProcessById(int32_t processId);

  /// @brief Method GetProcessById, addr 0x12bc34c, size 0x1d8, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::Process* GetProcessById(int32_t processId, ::StringW machineName);

  /// @brief Method GetProcessHandle, addr 0x12bc764, size 0x8, virtual false, abstract: false, final false
  inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* GetProcessHandle(int32_t access);

  /// @brief Method GetProcessHandle, addr 0x12bb040, size 0x4c4, virtual false, abstract: false, final false
  inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* GetProcessHandle(int32_t access, bool throwIfExited);

  /// @brief Method GetProcess_internal, addr 0x12be5b8, size 0x4, virtual false, abstract: false, final false
  static inline void* GetProcess_internal(int32_t pid);

  /// @brief Method IsLocalMachine, addr 0x12be5bc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method OnExited, addr 0x12bc524, size 0x240, virtual false, abstract: false, final false
  inline void OnExited();

  /// @brief Method OpenProcessHandle, addr 0x12bbb7c, size 0xc, virtual false, abstract: false, final false
  inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* OpenProcessHandle();

  /// @brief Method OpenProcessHandle, addr 0x12bb768, size 0xbc, virtual false, abstract: false, final false
  inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* OpenProcessHandle(int32_t access);

  /// @brief Method ProcessName_icall, addr 0x12be4d4, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW ProcessName_icall(void* handle);

  /// @brief Method ProcessName_internal, addr 0x12be4d8, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW ProcessName_internal(::Microsoft::Win32::SafeHandles::SafeProcessHandle* handle);

  /// @brief Method RaiseOnExited, addr 0x12bb658, size 0xe0, virtual false, abstract: false, final false
  inline void RaiseOnExited();

  /// @brief Method Refresh, addr 0x12bc2f0, size 0x14, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method ReleaseProcessHandle, addr 0x12bc108, size 0x28, virtual false, abstract: false, final false
  inline void ReleaseProcessHandle(::Microsoft::Win32::SafeHandles::SafeProcessHandle* handle);

  /// @brief Method SetProcessHandle, addr 0x12bc76c, size 0x1c, virtual false, abstract: false, final false
  inline void SetProcessHandle(::Microsoft::Win32::SafeHandles::SafeProcessHandle* processHandle);

  /// @brief Method SetProcessId, addr 0x12bc788, size 0x10, virtual false, abstract: false, final false
  inline void SetProcessId(int32_t processId);

  /// @brief Method ShellExecuteEx_internal, addr 0x12be64c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x12bc798, size 0xfc, virtual false, abstract: false, final false
  inline bool Start();

  /// @brief Method StartWithCreateProcess, addr 0x12bccb0, size 0x13d8, virtual false, abstract: false, final false
  inline bool StartWithCreateProcess(::System::Diagnostics::ProcessStartInfo* startInfo);

  /// @brief Method StartWithShellExecuteEx, addr 0x12bc8e8, size 0x3c8, virtual false, abstract: false, final false
  inline bool StartWithShellExecuteEx(::System::Diagnostics::ProcessStartInfo* startInfo);

  /// @brief Method StopWatchingForExit, addr 0x12bbdbc, size 0x114, virtual false, abstract: false, final false
  inline void StopWatchingForExit();

  /// @brief Method ToString, addr 0x12be088, size 0x16c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WaitForExit, addr 0x12be1f4, size 0x248, virtual false, abstract: false, final false
  inline bool WaitForExit(int32_t milliseconds);

  /// @brief Method WaitForExit, addr 0x12be43c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ba928, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12be444, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Microsoft::Win32::SafeHandles::SafeProcessHandle* handle, int32_t id);

  /// @brief Method .ctor, addr 0x12ba9b0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::StringW machineName, bool isRemoteMachine, int32_t processId, ::System::Diagnostics::ProcessInfo* processInfo);

  /// @brief Method add_Exited, addr 0x12bc008, size 0x80, virtual false, abstract: false, final false
  inline void add_Exited(::System::EventHandler* value);

  /// @brief Method get_Associated, addr 0x12baa4c, size 0x20, virtual false, abstract: false, final false
  inline bool get_Associated();

  /// @brief Method get_ExitCode, addr 0x12baa6c, size 0x12c, virtual false, abstract: false, final false
  inline int32_t get_ExitCode();

  /// @brief Method get_Handle, addr 0x12bb738, size 0x30, virtual false, abstract: false, final false
  inline void* get_Handle();

  /// @brief Method get_HasExited, addr 0x12bacd0, size 0x370, virtual false, abstract: false, final false
  inline bool get_HasExited();

  /// @brief Method get_Id, addr 0x12b6618, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_IsWindows, addr 0x12be984, size 0x34, virtual false, abstract: false, final false
  static inline bool get_IsWindows();

  /// @brief Method get_ProcessName, addr 0x12b6634, size 0x230, virtual false, abstract: false, final false
  inline ::StringW get_ProcessName();

  /// @brief Method get_StandardError, addr 0x12bbf6c, size 0x9c, virtual false, abstract: false, final false
  inline ::System::IO::StreamReader* get_StandardError();

  /// @brief Method get_StandardOutput, addr 0x12bbed0, size 0x9c, virtual false, abstract: false, final false
  inline ::System::IO::StreamReader* get_StandardOutput();

  /// @brief Method get_StartInfo, addr 0x12bb824, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Diagnostics::ProcessStartInfo* get_StartInfo();

  /// @brief Method get_SynchronizingObject, addr 0x12bb974, size 0x1a4, virtual false, abstract: false, final false
  inline ::System::ComponentModel::ISynchronizeInvoke* get_SynchronizingObject();

  /// @brief Method remove_Exited, addr 0x12bc088, size 0x80, virtual false, abstract: false, final false
  inline void remove_Exited(::System::EventHandler* value);

  /// @brief Method set_EnableRaisingEvents, addr 0x12bbb18, size 0x64, virtual false, abstract: false, final false
  inline void set_EnableRaisingEvents(bool value);

  /// @brief Method set_StartInfo, addr 0x12bb914, size 0x60, virtual false, abstract: false, final false
