...
public:
  ...
  /// @brief Method Equals, addr 0x1af4eb0, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1af4f30, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1af4e80, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  static inline ::System::ComponentModel::DefaultPropertyAttribute* getStaticF_Default();

  /// @brief Method get_Name, addr 0x1af4ea8, size 0x8, virtual false, abstract: false, final false
