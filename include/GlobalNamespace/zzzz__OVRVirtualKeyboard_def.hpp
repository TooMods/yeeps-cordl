...
public:
  ...
  /// @brief Method MoveNext, addr 0x14e6768, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x14e6804, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x14e680c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x14e684c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x14e6764, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x14e673c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyOverride, addr 0x14e6558, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Enqueue, addr 0x14e5880, size 0x1cc, virtual false, abstract: false, final false
  inline void Enqueue(::UnityEngine::Transform* interactorRootTransform, ::GlobalNamespace::__OVRPlugin__Posef interactorRootPose);

  /// @brief Method LateApply, addr 0x14e5644, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x14e669c, size 0xa0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method RevertInteractorOverrides, addr 0x14e6634, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14e6288, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x14e696c, size 0xd4, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::__OVRVirtualKeyboard__BaseInputSource* New_ctor();

  /// @brief Method OnUpdatedAnchors, addr 0x14e6948, size 0xc, virtual false, abstract: false, final false
  inline void OnUpdatedAnchors(::GlobalNamespace::OVRCameraRig* obj);

  /// @brief Method Update, addr 0x14e6954, size 0x18, virtual true, abstract: false, final true
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x14e6854, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method UpdateInput, addr 0x14e6aa0, size 0x18c, virtual true, abstract: false, final false
  inline void UpdateInput();
  ...
  /// @brief Method .ctor, addr 0x14e5a4c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TriggerIsPressed, addr 0x14e6a40, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UpdateInput>b__6_0, addr 0x14e6fcc, size 0x20, virtual false, abstract: false, final false
  inline bool _UpdateInput_b__6_0(::GlobalNamespace::OVRBone* b);

  /// @brief Method <UpdateInput>b__6_1, addr 0x14e6fec, size 0x20, virtual false, abstract: false, final false
  inline bool _UpdateInput_b__6_1(::GlobalNamespace::OVRBone* b);

  /// @brief Method .ctor, addr 0x14e6fc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method UpdateInput, addr 0x14e6c2c, size 0x334, virtual true, abstract: false, final false
  inline void UpdateInput();
  ...
  /// @brief Method .ctor, addr 0x14e5ab4, size 0x1c4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <LoadRuntimeVirtualKeyboardMesh>b__68_0, addr 0x14e7078, size 0x8c, virtual false, abstract: false, final false
  inline bool _LoadRuntimeVirtualKeyboardMesh_b__68_0(::StringW p);

  /// @brief Method <PopulateCollision>b__70_0, addr 0x14e7104, size 0x68, virtual false, abstract: false, final false
  inline bool _PopulateCollision_b__70_0(::UnityEngine::MeshFilter* mesh);

  /// @brief Method .ctor, addr 0x14e7070, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyHideFlags, addr 0x14e4520, size 0x7c, virtual false, abstract: false, final false
  static inline void ApplyHideFlags(::UnityEngine::Transform* t);

  /// @brief Method Awake, addr 0x14e26e4, size 0x524, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ChangeTextContext, addr 0x14e4068, size 0xe0, virtual false, abstract: false, final false
  inline void ChangeTextContext(::StringW textContext);

  /// @brief Method ChangeTextContextInternal, addr 0x14e262c, size 0xb8, virtual false, abstract: false, final false
  inline void ChangeTextContextInternal(::StringW textContext);

  /// @brief Method ComputeLocation, addr 0x14e35b4, size 0xb8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__VirtualKeyboardLocationInfo ComputeLocation(::UnityEngine::Transform* transform);

  /// @brief Method DestroyKeyboard, addr 0x14e2f04, size 0x15c, virtual false, abstract: false, final false
  inline void DestroyKeyboard();

  /// @brief Method HideKeyboard, addr 0x14e337c, size 0x14, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method LateUpdate, addr 0x14e5628, size 0x1c, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadRuntimeVirtualKeyboardMesh, addr 0x14e4148, size 0x3d8, virtual false, abstract: false, final false
  inline bool LoadRuntimeVirtualKeyboardMesh();

  /// @brief Method MaxElement, addr 0x14e4968, size 0x14, virtual false, abstract: false, final false
  inline float_t MaxElement(::UnityEngine::Vector3 vec);

  static inline ::GlobalNamespace::OVRVirtualKeyboard* New_ctor();

  /// @brief Method OnBackspace, addr 0x14e5e88, size 0x238, virtual false, abstract: false, final false
  inline void OnBackspace();

  /// @brief Method OnCommitText, addr 0x14e5c78, size 0x200, virtual false, abstract: false, final false
  inline void OnCommitText(::StringW text);

  /// @brief Method OnDestroy, addr 0x14e2c08, size 0x2fc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x14e3378, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x14e3060, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEnter, addr 0x14e60c0, size 0xd8, virtual false, abstract: false, final false
  inline void OnEnter();

  /// @brief Method OnEvent, addr 0x14e3f38, size 0x130, virtual true, abstract: false, final true
  inline void OnEvent(::GlobalNamespace::__OVRPlugin__EventDataBuffer eventDataBuffer);

  /// @brief Method OnKeyboardHidden, addr 0x14e61b0, size 0x14, virtual false, abstract: false, final false
  inline void OnKeyboardHidden();

  /// @brief Method OnKeyboardShown, addr 0x14e6198, size 0x18, virtual false, abstract: false, final false
  inline void OnKeyboardShown();

  /// @brief Method OnTextCommitFieldChange, addr 0x14e5e78, size 0x10, virtual false, abstract: false, final false
  inline void OnTextCommitFieldChange(::StringW textContext);

  /// @brief Method PopulateCollision, addr 0x14e459c, size 0x224, virtual false, abstract: false, final false
  inline void PopulateCollision();

  /// @brief Method SendVirtualKeyboardDirectInput, addr 0x14e3e68, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method SendVirtualKeyboardInput, addr 0x14e3c50, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method SendVirtualKeyboardRayInput, addr 0x14e3928, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method SetKeyboardVisibility, addr 0x14e4818, size 0x150, virtual false, abstract: false, final false
  inline void SetKeyboardVisibility(bool visible);

  /// @brief Method ShowKeyboard, addr 0x14e3064, size 0x314, virtual false, abstract: false, final false
  inline void ShowKeyboard();

  /// @brief Method SyncKeyboardLocation, addr 0x14e366c, size 0x2bc, virtual false, abstract: false, final false
  inline void SyncKeyboardLocation();

  /// @brief Method Update, addr 0x14e497c, size 0x30, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateAnimationState, addr 0x14e4ed0, size 0x758, virtual false, abstract: false, final false
  inline void UpdateAnimationState();

  /// @brief Method UpdateInputs, addr 0x14e49ac, size 0x524, virtual false, abstract: false, final false
  inline void UpdateInputs();

  /// @brief Method UpdateVisibleState, addr 0x14e47c0, size 0x58, virtual false, abstract: false, final false
  inline void UpdateVisibleState();

  /// @brief Method UseSuggestedLocation, addr 0x14e3390, size 0x224, virtual false, abstract: false, final false
  inline void UseSuggestedLocation(::GlobalNamespace::__OVRVirtualKeyboard__KeyboardPosition position);

  /// @brief Method <LoadRuntimeVirtualKeyboardMesh>b__68_1, addr 0x14e6328, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14e61c4, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_Backspace, addr 0x14e1f70, size 0x9c, virtual false, abstract: false, final false
  inline void add_Backspace(::System::Action* value);

  /// @brief Method add_CommitText, addr 0x14e1e10, size 0xb0, virtual false, abstract: false, final false
  inline void add_CommitText(::System::Action_1<::StringW>* value);

  /// @brief Method add_Enter, addr 0x14e20a8, size 0x9c, virtual false, abstract: false, final false
  inline void add_Enter(::System::Action* value);

  /// @brief Method add_KeyboardHidden, addr 0x14e2318, size 0x9c, virtual false, abstract: false, final false
  inline void add_KeyboardHidden(::System::Action* value);

  /// @brief Method add_KeyboardShown, addr 0x14e21e0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Collider, addr 0x14e2450, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_Collider();

  /// @brief Method get_TextCommitField, addr 0x14e2460, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_Backspace, addr 0x14e200c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_Backspace(::System::Action* value);

  /// @brief Method remove_CommitText, addr 0x14e1ec0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_CommitText(::System::Action_1<::StringW>* value);

  /// @brief Method remove_Enter, addr 0x14e2144, size 0x9c, virtual false, abstract: false, final false
  inline void remove_Enter(::System::Action* value);

  /// @brief Method remove_KeyboardHidden, addr 0x14e23b4, size 0x9c, virtual false, abstract: false, final false
  inline void remove_KeyboardHidden(::System::Action* value);

  /// @brief Method remove_KeyboardShown, addr 0x14e227c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Collider, addr 0x14e2458, size 0x8, virtual false, abstract: false, final false
  inline void set_Collider(::UnityEngine::Collider* value);

  /// @brief Method set_TextCommitField, addr 0x14e2468, size 0x1c4, virtual false, abstract: false, final false
