...
public:
  ...
  /// @brief Method Create, addr 0x1e02cbc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1e02c5c, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1e02c8c, size 0x30, virtual true, abstract: false, final true
