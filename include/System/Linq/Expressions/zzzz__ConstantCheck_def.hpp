...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x182df3c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x182df20, size 0x1c, virtual false, abstract: false, final false
