...
public:
  ...
  /// @brief Method AddAttributePSVI, addr 0xfee54c, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* AddAttributePSVI(int32_t attIndex);

  /// @brief Method CachingCallBack, addr 0xfeeebc, size 0x28, virtual false, abstract: false, final false
  inline void CachingCallBack(::System::Xml::XsdCachingReader* cachingReader);

  /// @brief Method ClearAttributesInfo, addr 0xfecda8, size 0x3c, virtual false, abstract: false, final false
  inline void ClearAttributesInfo();

  /// @brief Method Close, addr 0xfece08, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CreateDummyTextNode, addr 0xfed184, size 0x88, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* CreateDummyTextNode(::StringW attributeValue, int32_t depth);

  /// @brief Method GetAttribute, addr 0xfec234, size 0xdc, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0xfebe00, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0xfebff0, size 0x100, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW namespaceURI);

  /// @brief Method GetAttributePSVI, addr 0xfee698, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* GetAttributePSVI(::StringW localName, ::StringW ns);

  /// @brief Method GetAttributePSVI, addr 0xfec3c8, size 0x180, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* GetAttributePSVI(::StringW name);

  /// @brief Method GetCachingReader, addr 0xfee470, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Xml::XsdCachingReader* GetCachingReader();

  /// @brief Method GetDefaultAttribute, addr 0xfec0f0, size 0x144, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* GetDefaultAttribute(::StringW attrLocalName, ::StringW ns, bool updatePosition);

  /// @brief Method GetDefaultAttribute, addr 0xfebe6c, size 0x184, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* GetDefaultAttribute(::StringW name, bool updatePosition);

  /// @brief Method GetIsDefault, addr 0xfed294, size 0x270, virtual false, abstract: false, final false
  inline void GetIsDefault();

  /// @brief Method GetMemberType, addr 0xfed664, size 0xf8, virtual false, abstract: false, final false
  inline void GetMemberType();

  /// @brief Method GetOriginalAtomicValueStringOfElement, addr 0xfee3e0, size 0x90, virtual false, abstract: false, final false
  inline ::StringW GetOriginalAtomicValueStringOfElement();

  /// @brief Method GetStringValue, addr 0xfedc00, size 0x20, virtual false, abstract: false, final false
  inline ::System::Object* GetStringValue();

  /// @brief Method HasLineInfo, addr 0xfed850, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method Init, addr 0xfeb06c, size 0x32c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalReadContentAsObject, addr 0xfebd90, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject();

  /// @brief Method InternalReadContentAsObject, addr 0xfee740, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject(bool unwrapTypedValue);

  /// @brief Method InternalReadContentAsObject, addr 0xfee75c, size 0x21c, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject(bool unwrapTypedValue, ByRef<::StringW> originalStringValue);

  /// @brief Method IsXSDRoot, addr 0xfee1e8, size 0x50, virtual false, abstract: false, final false
  inline bool IsXSDRoot(::StringW localName, ::StringW ns);

  /// @brief Method LookupNamespace, addr 0xfecfec, size 0xac, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0xfec310, size 0xb8, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0xfec548, size 0x198, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0xfec98c, size 0x54, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0xfec6e0, size 0x154, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0xfec834, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessElementEvent, addr 0xfedc20, size 0x498, virtual false, abstract: false, final false
  inline void ProcessElementEvent();

  /// @brief Method ProcessEndElementEvent, addr 0xfee0b8, size 0x130, virtual false, abstract: false, final false
  inline void ProcessEndElementEvent();

  /// @brief Method ProcessInlineSchema, addr 0xfeccf8, size 0xb0, virtual false, abstract: false, final false
  inline void ProcessInlineSchema();

  /// @brief Method ProcessReaderEvent, addr 0xfecb30, size 0x1c8, virtual false, abstract: false, final false
  inline void ProcessReaderEvent();

  /// @brief Method Read, addr 0xfec9e0, size 0x150, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAheadForMemberType, addr 0xfeecf8, size 0x1c4, virtual false, abstract: false, final false
  inline void ReadAheadForMemberType();

  /// @brief Method ReadAttributeValue, addr 0xfed0d8, size 0xac, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadContentAsString, addr 0xfebb14, size 0x27c, virtual true, abstract: false, final false
  inline ::StringW ReadContentAsString();

  /// @brief Method ReadTillEndElement, addr 0xfeeac0, size 0x1b8, virtual false, abstract: false, final false
  inline ::System::Object* ReadTillEndElement();

  /// @brief Method ResolveEntity, addr 0xfed098, size 0x40, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ReturnBoxedValue, addr 0xfee978, size 0x148, virtual false, abstract: false, final false
  inline ::System::Object* ReturnBoxedValue(::System::Object* typedValue, ::System::Xml::Schema::XmlSchemaType* xmlType, bool unWrap);

  /// @brief Method SetupValidator, addr 0xfeb398, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method Skip, addr 0xfece78, size 0x16c, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method SwitchReader, addr 0xfeec78, size 0x80, virtual false, abstract: false, final false
  inline void SwitchReader();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0xfed9b8, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0xfeda78, size 0xc4, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0xfedb3c, size 0xc4, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_IsDefault, addr 0xfed20c, size 0x88, virtual true, abstract: false, final true
  inline bool System_Xml_Schema_IXmlSchemaInfo_get_IsDefault();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_IsNil, addr 0xfed504, size 0x4c, virtual true, abstract: false, final true
  inline bool System_Xml_Schema_IXmlSchemaInfo_get_IsNil();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_MemberType, addr 0xfed5e4, size 0x80, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaSimpleType* System_Xml_Schema_IXmlSchemaInfo_get_MemberType();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaAttribute, addr 0xfed80c, size 0x44, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaAttribute* System_Xml_Schema_IXmlSchemaInfo_get_SchemaAttribute();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaElement, addr 0xfed7b8, size 0x54, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaElement* System_Xml_Schema_IXmlSchemaInfo_get_SchemaElement();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaType, addr 0xfed75c, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaType* System_Xml_Schema_IXmlSchemaInfo_get_SchemaType();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_Validity, addr 0xfed550, size 0x94, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaValidity System_Xml_Schema_IXmlSchemaInfo_get_Validity();

  /// @brief Method ValidateAttributes, addr 0xfee238, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfeb578, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfeaed4, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlReader* reader, ::System::Xml::XmlResolver* xmlResolver, ::System::Xml::XmlReaderSettings* readerSettings,
                    ::System::Xml::Schema::XmlSchemaObject* partialValidationType);

  static inline ::System::Type* getStaticF_TypeOfString();

  /// @brief Method get_AttributeCount, addr 0xfebdf8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_AttributeSchemaInfo, addr 0xfebaf8, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaInfo* get_AttributeSchemaInfo();

  /// @brief Method get_AttributeXmlType, addr 0xfebdc8, size 0x30, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_AttributeXmlType();

  /// @brief Method get_BaseURI, addr 0xfeb93c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_Depth, addr 0xfeb900, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_EOF, addr 0xfecde4, size 0x24, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_ElementXmlType, addr 0xfebdac, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_ElementXmlType();

  /// @brief Method get_IsDefault, addr 0xfeb984, size 0x3c, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0xfeb960, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LineNumber, addr 0xfed858, size 0xb0, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0xfed908, size 0xb0, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0xfeb810, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0xfeb6dc, size 0x134, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0xfecfe4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0xfeb84c, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0xfeb654, size 0x88, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0xfeb888, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0xfeb9c0, size 0x24, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0xfece3c, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_SchemaInfo, addr 0xfeba2c, size 0x4, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Settings, addr 0xfeb580, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_Value, addr 0xfeb8c4, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_ValueType, addr 0xfeba30, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlLang, addr 0xfeba08, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0xfeb9e4, size 0x24, virtual true, abstract: false, final false
