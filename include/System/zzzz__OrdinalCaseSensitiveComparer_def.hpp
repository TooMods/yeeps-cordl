...
public:
  ...
  /// @brief Method Compare, addr 0x2f05134, size 0x10, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x2f05144, size 0x10, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x2f05154, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method GetObjectData, addr 0x2f05174, size 0xb4, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::OrdinalCaseSensitiveComparer* New_ctor();

  /// @brief Method .ctor, addr 0x2f0489c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
