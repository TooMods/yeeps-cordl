...
public:
  ...
  /// @brief Method .ctor, addr 0xecbf40, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xecbfbc, size 0x8, virtual false, abstract: false, final false
