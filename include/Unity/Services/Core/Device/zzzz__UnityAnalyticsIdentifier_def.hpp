...
// Type: Unity.Services.Core.Device::UnityAnalyticsIdentifier
...
public:
  ...
  /// @brief Method .ctor, addr 0x15565f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UserId, addr 0x1557620, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method set_UserId, addr 0x1557664, size 0x2c334, virtual true, abstract: false, final true
