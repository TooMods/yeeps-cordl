...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b57c8, size 0x54, virtual true, abstract: false, final false
  inline ::StringW GetDataFromMessage(void* c_message);

  /// @brief Method GetString, addr 0x19b578c, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW GetString();

  static inline ::Oculus::Platform::MessageWithString* New_ctor(void* c_message);

  /// @brief Method .ctor, addr 0x19b1544, size 0x58, virtual false, abstract: false, final false
