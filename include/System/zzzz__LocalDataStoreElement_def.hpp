...
public:
  ...
  /// @brief Method .ctor, addr 0x2bf5268, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int64_t cookie);

  /// @brief Method get_Cookie, addr 0x2bf52a0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_Cookie();

  /// @brief Method get_Value, addr 0x2bf5290, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Value();

  /// @brief Method set_Value, addr 0x2bf5298, size 0x8, virtual false, abstract: false, final false
