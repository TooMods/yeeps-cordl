...
public:
  // Declarations
  /// @brief Method Init, addr 0x2ccffd4, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2cd0028, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerLeaveEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2cd0034, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
