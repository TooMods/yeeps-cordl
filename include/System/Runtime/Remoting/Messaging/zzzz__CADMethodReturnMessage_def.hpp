...
public:
  ...
  /// @brief Method Create, addr 0x185fd48, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArgs, addr 0x1860294, size 0x10, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetArgs(::System::Collections::ArrayList* args);

  /// @brief Method GetArguments, addr 0x1860154, size 0x140, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetArguments();

  /// @brief Method GetException, addr 0x18602b4, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Exception* GetException(::System::Collections::ArrayList* args);

  /// @brief Method GetReturnValue, addr 0x18602a4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x185fdd8, size 0x37c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodReturnMessage* retMsg);

  /// @brief Method get_PropertiesCount, addr 0x1860358, size 0x8, virtual false, abstract: false, final false
