...
public:
  ...
  /// @brief Method ToString, addr 0x1331fd0, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1331f24, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDeclaration* other);

  /// @brief Method .ctor, addr 0x1331ee8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method get_Encoding, addr 0x1331fa8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Encoding();

  /// @brief Method get_Standalone, addr 0x1331fb8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x1331fc8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  /// @brief Method set_Encoding, addr 0x1331fb0, size 0x8, virtual false, abstract: false, final false
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x1331fc0, size 0x8, virtual false, abstract: false, final false
