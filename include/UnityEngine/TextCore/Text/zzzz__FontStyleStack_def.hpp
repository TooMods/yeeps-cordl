...
public:
  // Declarations
  /// @brief Method Add, addr 0x24722d0, size 0xfc, virtual false, abstract: false, final false
  inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles style);

  /// @brief Method Clear, addr 0x24722c4, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Remove, addr 0x24723cc, size 0x120, virtual false, abstract: false, final false
