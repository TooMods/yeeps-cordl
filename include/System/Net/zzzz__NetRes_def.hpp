...
public:
  // Declarations
  /// @brief Method GetWebStatusCodeString, addr 0xf5bf64, size 0x1dc, virtual false, abstract: false, final false
  static inline ::StringW GetWebStatusCodeString(::System::Net::FtpStatusCode statusCode, ::StringW statusDescription);

  /// @brief Method GetWebStatusString, addr 0xf52914, size 0xbc, virtual false, abstract: false, final false
  static inline ::StringW GetWebStatusString(::StringW Res, ::System::Net::WebExceptionStatus Status);

  /// @brief Method GetWebStatusString, addr 0xf5bf08, size 0x5c, virtual false, abstract: false, final false
