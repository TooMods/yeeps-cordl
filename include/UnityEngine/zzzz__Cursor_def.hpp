...
public:
  // Declarations
  /// @brief Method SetCursor, addr 0x27e657c, size 0x58, virtual false, abstract: false, final false
  static inline void SetCursor(::UnityEngine::Texture2D* texture, ::UnityEngine::Vector2 hotspot, ::UnityEngine::CursorMode cursorMode);

  /// @brief Method SetCursor_Injected, addr 0x27e65d4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lockState, addr 0x27e6664, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::CursorLockMode get_lockState();

  /// @brief Method set_lockState, addr 0x27e668c, size 0x3c, virtual false, abstract: false, final false
  static inline void set_lockState(::UnityEngine::CursorLockMode value);

  /// @brief Method set_visible, addr 0x27e6628, size 0x3c, virtual false, abstract: false, final false
