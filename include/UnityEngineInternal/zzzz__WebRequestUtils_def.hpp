...
public:
  ...
  /// @brief Method MakeInitialUrl, addr 0x30a6114, size 0x398, virtual false, abstract: false, final false
  static inline ::StringW MakeInitialUrl(::StringW targetUrl, ::StringW localUrl);

  /// @brief Method MakeUriString, addr 0x30a64ac, size 0x3f4, virtual false, abstract: false, final false
  static inline ::StringW MakeUriString(::System::Uri* targetUri, ::StringW targetUrl, bool prependProtocol);

  /// @brief Method RedirectTo, addr 0x30a6020, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW RedirectTo(::StringW baseUri, ::StringW redirectUri);

  /// @brief Method URLDecode, addr 0x30a68a0, size 0xa4, virtual false, abstract: false, final false
