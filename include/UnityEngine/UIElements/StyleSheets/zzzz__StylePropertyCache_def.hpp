...
public:
  ...
  /// @brief Method TryGetNonTerminalValue, addr 0x2152010, size 0x90, virtual false, abstract: false, final false
  static inline bool TryGetNonTerminalValue(::StringW name, ByRef<::StringW> syntax);

  /// @brief Method TryGetSyntax, addr 0x2151f80, size 0x90, virtual false, abstract: false, final false
