...
public:
  ...
  /// @brief Method Execute, addr 0x16a44a8, size 0x130, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x16a4880, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t resolution, int32_t slicesPerRow, int32_t channelCount, bool flipY);

  /// @brief Method get_ChannelCount, addr 0x16a4958, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ChannelCount();

  /// @brief Method get_FlipY, addr 0x16a4960, size 0x8, virtual false, abstract: false, final false
  inline bool get_FlipY();

  /// @brief Method get_Height, addr 0x16a4940, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Height();

  /// @brief Method get_Resolution, addr 0x16a4948, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Resolution();

  /// @brief Method get_SlicesPerRow, addr 0x16a4950, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SlicesPerRow();

  /// @brief Method get_Width, addr 0x16a4938, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x16a4898, size 0xa0, virtual true, abstract: false, final true
  inline void Execute(int32_t index);
...
public:
  ...
  /// @brief Method GetTextureSettings, addr 0x16a45d8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method MapColorValues, addr 0x16a46dc, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method TextureToColorByteMap, addr 0x16a3be4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetTextureLayout, addr 0x16a3f9c, size 0x23c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ChannelsToCount, addr 0x16a4350, size 0x10, virtual false, abstract: false, final false
  static inline int32_t ChannelsToCount(::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels channels);

  /// @brief Method Create, addr 0x16a2f7c, size 0xf0, virtual false, abstract: false, final false
  inline void Create(::GlobalNamespace::__OVRPlugin__PassthroughColorLutData lutData);

  /// @brief Method CreateLutData, addr 0x16a4380, size 0x94, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__PassthroughColorLutData CreateLutData(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> colorBytes);

  /// @brief Method CreateLutDataFromArray, addr 0x16a3108, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLutDataFromArray, addr 0x16a31f0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLutDataFromArray, addr 0x16a33b0, size 0x58, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__PassthroughColorLutData CreateLutDataFromArray(::ArrayW<uint8_t, ::Array<uint8_t>*> colors);

  /// @brief Method CreateLutDataFromTexture, addr 0x16a2f24, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x16a3cdc, size 0x114, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x16a3c98, size 0x44, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x16a4414, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChannelsForTextureFormat, addr 0x16a2c20, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResolutionFromSize, addr 0x16a41d8, size 0xb4, virtual false, abstract: false, final false
  static inline uint32_t GetResolutionFromSize(int32_t size);

  /// @brief Method GetTextureSize, addr 0x16a2b40, size 0xe0, virtual false, abstract: false, final false
  static inline int32_t GetTextureSize(::UnityEngine::Texture2D* texture);

  /// @brief Method GetTextureSizeFromByteArray, addr 0x16a3298, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPowerOfTwo, addr 0x16a4360, size 0x20, virtual false, abstract: false, final false
  static inline bool IsPowerOfTwo(uint32_t x);

  /// @brief Method IsResolutionAccepted, addr 0x16a428c, size 0xc4, virtual false, abstract: false, final false
  static inline bool IsResolutionAccepted(uint32_t resolution, int32_t size, ByRef<::StringW> errorMessage);

  /// @brief Method IsTextureSupported, addr 0x16a3df0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidUpdateResolution, addr 0x16a3ac8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateFrom, addr 0x16a3408, size 0xc0, virtual false, abstract: false, final false
  inline void UpdateFrom(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> colors);

  /// @brief Method UpdateFrom, addr 0x16a3708, size 0xc0, virtual false, abstract: false, final false
  inline void UpdateFrom(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors);

  /// @brief Method UpdateFrom, addr 0x16a3944, size 0xcc, virtual false, abstract: false, final false
  inline void UpdateFrom(::ArrayW<uint8_t, ::Array<uint8_t>*> colors);

  /// @brief Method UpdateFrom, addr 0x16a3a10, size 0xb8, virtual false, abstract: false, final false
  inline void UpdateFrom(::UnityEngine::Texture2D* lutTexture, bool flipY);

  /// @brief Method WriteColorsAsBytes, addr 0x16a34c8, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteColorsAsBytes, addr 0x16a37c8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16a306c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16a3154, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16a323c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x16a2aac, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture2D* initialLutTexture, bool flipY);

  /// @brief Method .ctor, addr 0x16a2cc0, size 0x264, virtual false, abstract: false, final false
  inline void _ctor(int32_t size, ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels channels);

  /// @brief Method get_Channels, addr 0x16a2a88, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels get_Channels();

  /// @brief Method get_IsInitialized, addr 0x16a2a98, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_Resolution, addr 0x16a2a78, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_Resolution();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Channels, addr 0x16a2a90, size 0x8, virtual false, abstract: false, final false
  inline void set_Channels(::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels value);

  /// @brief Method set_IsInitialized, addr 0x16a2aa0, size 0xc, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_Resolution, addr 0x16a2a80, size 0x8, virtual false, abstract: false, final false
