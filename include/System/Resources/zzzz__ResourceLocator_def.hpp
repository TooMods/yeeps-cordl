...
public:
  ...
  /// @brief Method CanCache, addr 0x260a024, size 0xc, virtual false, abstract: false, final false
  static inline bool CanCache(::System::Resources::ResourceTypeCode value);

  /// @brief Method .ctor, addr 0x260a000, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t dataPos, ::System::Object* value);

  /// @brief Method get_DataPosition, addr 0x260a00c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DataPosition();

  /// @brief Method get_Value, addr 0x260a014, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Value();

  /// @brief Method set_Value, addr 0x260a01c, size 0x8, virtual false, abstract: false, final false
