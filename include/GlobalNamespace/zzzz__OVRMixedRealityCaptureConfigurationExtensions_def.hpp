...
public:
  // Declarations
  /// @brief Method ApplyTo, addr 0x16f2dec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x16f2df0, size 0x1428, virtual false, abstract: false, final false
