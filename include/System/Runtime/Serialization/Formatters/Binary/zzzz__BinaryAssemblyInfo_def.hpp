...
public:
  ...
  /// @brief Method GetAssembly, addr 0x1ab2140, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ab20ec, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyString);

  /// @brief Method .ctor, addr 0x1ab2114, size 0x2c, virtual false, abstract: false, final false
