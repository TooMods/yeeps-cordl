...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b52b8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Purchase* GetDataFromMessage(void* c_message);

  /// @brief Method GetPurchase, addr 0x19b527c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b1334, size 0x58, virtual false, abstract: false, final false
