...
public:
  ...
  /// @brief Method Add, addr 0x12c724c, size 0x74, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method AddRange, addr 0x12c70ac, size 0x74, virtual false, abstract: false, final false
  inline void AddRange(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* certificates);

  /// @brief Method Contains, addr 0x12c72c0, size 0x384, virtual false, abstract: false, final false
  inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Find, addr 0x12c7710, size 0x1138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x12c8848, size 0x60, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Enumerator* GetEnumerator();

  /// @brief Method GetKeyIdentifier, addr 0x12c7644, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c7070, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12c7080, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x12c7120, size 0x12c, virtual false, abstract: false, final false
