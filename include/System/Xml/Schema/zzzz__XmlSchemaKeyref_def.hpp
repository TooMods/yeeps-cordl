...
public:
  ...
  /// @brief Method .ctor, addr 0x1ce762c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Refer, addr 0x1ce758c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Refer();

  /// @brief Method set_Refer, addr 0x1ce7594, size 0x98, virtual false, abstract: false, final false
