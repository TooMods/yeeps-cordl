...
public:
  ...
  /// @brief Method Compare, addr 0x2279b6c, size 0x174, virtual false, abstract: false, final false
  static inline int32_t Compare(::System::Globalization::SortKey* sortkey1, ::System::Globalization::SortKey* sortkey2);

  /// @brief Method Equals, addr 0x2279e4c, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x2279efc, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2279f64, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227a154, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2279db4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2279ce0, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(int32_t lcid, ::StringW source, ::System::Globalization::CompareOptions opt);

  /// @brief Method .ctor, addr 0x2279df4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyData, addr 0x2279e44, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyData();

  /// @brief Method get_OriginalString, addr 0x2279e3c, size 0x8, virtual true, abstract: false, final false
