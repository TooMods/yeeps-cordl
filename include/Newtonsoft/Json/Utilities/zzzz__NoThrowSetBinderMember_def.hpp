...
public:
  ...
  /// @brief Method FallbackSetMember, addr 0x1530dc4, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1530d8c, size 0x38, virtual false, abstract: false, final false
