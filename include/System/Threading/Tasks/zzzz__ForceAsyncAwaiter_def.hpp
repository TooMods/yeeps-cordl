...
public:
  ...
  /// @brief Method GetAwaiter, addr 0xed36d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::ForceAsyncAwaiter GetAwaiter();

  /// @brief Method GetResult, addr 0xed36e4, size 0x2c, virtual false, abstract: false, final false
  inline void GetResult();

  /// @brief Method OnCompleted, addr 0xed3710, size 0x58, virtual true, abstract: false, final true
  inline void OnCompleted(::System::Action* action);

  /// @brief Method UnsafeOnCompleted, addr 0xed3768, size 0x58, virtual true, abstract: false, final true
  inline void UnsafeOnCompleted(::System::Action* action);

  /// @brief Method .ctor, addr 0xed36cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  /// @brief Method get_IsCompleted, addr 0xed36dc, size 0x8, virtual false, abstract: false, final false
