...
public:
  ...
  /// @brief Method Reset, addr 0xfeae70, size 0x64, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0xfeae04, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
