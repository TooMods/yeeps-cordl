...
public:
  ...
  /// @brief Method CalculateSize, addr 0x2f62d3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t CalculateSize(int32_t stringByteCount);

  /// @brief Method CalculateSize, addr 0x2f6135c, size 0x89c, virtual false, abstract: false, final false
  inline int32_t CalculateSize(::Newtonsoft::Json::Bson::BsonToken* t);

  /// @brief Method CalculateSizeWithLength, addr 0x2f62d44, size 0x14, virtual false, abstract: false, final false
  inline int32_t CalculateSizeWithLength(int32_t stringByteCount, bool includeSize);

  /// @brief Method Close, addr 0x2f61314, size 0x20, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Flush, addr 0x2f612f4, size 0x20, virtual false, abstract: false, final false
  inline void Flush();

  static inline ::Newtonsoft::Json::Bson::BsonBinaryWriter* New_ctor(::System::IO::BinaryWriter* writer);

  /// @brief Method WriteString, addr 0x2f62ab0, size 0xa4, virtual false, abstract: false, final false
  inline void WriteString(::StringW s, int32_t byteCount, ::System::Nullable_1<int32_t> calculatedlengthPrefix);

  /// @brief Method WriteToken, addr 0x2f61334, size 0x28, virtual false, abstract: false, final false
  inline void WriteToken(::Newtonsoft::Json::Bson::BsonToken* t);

  /// @brief Method WriteTokenInternal, addr 0x2f61bf8, size 0xe28, virtual false, abstract: false, final false
  inline void WriteTokenInternal(::Newtonsoft::Json::Bson::BsonToken* t);

  /// @brief Method WriteUtf8Bytes, addr 0x2f62be4, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f612c4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::BinaryWriter* writer);

  static inline ::System::Text::Encoding* getStaticF_Encoding();

  /// @brief Method get_DateTimeKindHandling, addr 0x2f612b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTimeKind get_DateTimeKindHandling();

  static inline void setStaticF_Encoding(::System::Text::Encoding* value);

  /// @brief Method set_DateTimeKindHandling, addr 0x2f612bc, size 0x8, virtual false, abstract: false, final false
