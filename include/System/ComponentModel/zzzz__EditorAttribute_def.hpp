...
public:
  ...
  /// @brief Method Equals, addr 0x1af6e3c, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1af6ee0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::ComponentModel::EditorAttribute* New_ctor();

  static inline ::System::ComponentModel::EditorAttribute* New_ctor(::System::Type* type, ::System::Type* baseType);

  static inline ::System::ComponentModel::EditorAttribute* New_ctor(::StringW typeName, ::System::Type* baseType);
  ...
  /// @brief Method .ctor, addr 0x1af6ba4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1af6d3c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Type* baseType);

  /// @brief Method .ctor, addr 0x1af6c90, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::System::Type* baseType);

  /// @brief Method .ctor, addr 0x1af6c00, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW baseTypeName);

  /// @brief Method get_EditorBaseTypeName, addr 0x1af6da0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EditorBaseTypeName();

  /// @brief Method get_EditorTypeName, addr 0x1af6da8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EditorTypeName();

  /// @brief Method get_TypeId, addr 0x1af6db0, size 0x8c, virtual true, abstract: false, final false
