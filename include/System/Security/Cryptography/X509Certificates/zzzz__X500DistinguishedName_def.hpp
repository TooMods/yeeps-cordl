...
public:
  ...
  /// @brief Method AreEqual, addr 0x12c469c, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method Canonize, addr 0x12c44d0, size 0x1cc, virtual false, abstract: false, final false
  static inline ::StringW Canonize(::StringW s);

  /// @brief Method Decode, addr 0x12c42a8, size 0x158, virtual false, abstract: false, final false
  inline ::StringW Decode(::System::Security::Cryptography::X509Certificates::X500DistinguishedNameFlags flag);

  /// @brief Method DecodeRawData, addr 0x12c41a8, size 0xf8, virtual false, abstract: false, final false
  inline void DecodeRawData();

  /// @brief Method Format, addr 0x12c4474, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW Format(bool multiLine);

  /// @brief Method GetSeparator, addr 0x12c4400, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c4098, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encodedDistinguishedName);

  /// @brief Method get_Name, addr 0x12c42a0, size 0x8, virtual false, abstract: false, final false
