...
public:
  ...
  /// @brief Method CanDispatchEvent, addr 0x2ccd8e8, size 0x54, virtual true, abstract: false, final true
  inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method DispatchEvent, addr 0x2ccd93c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method SendEventToTarget, addr 0x2ccdbb0, size 0x24, virtual false, abstract: false, final false
  static inline void SendEventToTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method SetBestTargetForEvent, addr 0x2ccd974, size 0x23c, virtual false, abstract: false, final false
  static inline void SetBestTargetForEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method UpdateElementUnderPointer, addr 0x2ccdbd4, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ccde80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
