...
public:
  ...
  /// @brief Method DetermineValueTypeAndSize, addr 0x1b36b74, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateMagnitude, addr 0x1b369b8, size 0x40, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method FinishSetup, addr 0x1b36ae4, size 0x90, virtual true, abstract: false, final false
  inline void FinishSetup(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ModifierIsPressed, addr 0x1b369f8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x1b36a80, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x1b37048, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b37098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_valueSizeInBytes, addr 0x1b369b0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method get_valueType, addr 0x1b369a8, size 0x8, virtual true, abstract: false, final false
