...
public:
  ...
  /// @brief Method .ctor, addr 0x283fc6c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Func_1<bool>* predicate);

  /// @brief Method get_keepWaiting, addr 0x283fc48, size 0x24, virtual true, abstract: false, final false
