...
public:
  ...
  /// @brief Method MoveNext, addr 0x1333f48, size 0xa8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Xml::Linq::__XElement___GetAttributes_d__116* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Xml.Linq.XAttribute>.GetEnumerator, addr 0x1334040, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Xml.Linq.XAttribute>.get_Current, addr 0x1333ff0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Linq::XAttribute* System_Collections_Generic_IEnumerator_System_Xml_Linq_XAttribute__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x13340ec, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1333ff8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1334038, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1333f44, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1333660, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x13332cc, size 0xf0, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x13334f4, size 0x10c, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AppendAttribute, addr 0x13333bc, size 0x138, virtual false, abstract: false, final false
  inline void AppendAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AppendAttributeSkipNotify, addr 0x13319cc, size 0x38, virtual false, abstract: false, final false
  inline void AppendAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method Attribute, addr 0x1332c98, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XAttribute* Attribute(::System::Xml::Linq::XName* name);

  /// @brief Method Attributes, addr 0x1332cd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Xml::Linq::XAttribute*>* Attributes();

  /// @brief Method CloneNode, addr 0x1333600, size 0x60, virtual true, abstract: false, final false
  inline ::System::Xml::Linq::XNode* CloneNode();

  /// @brief Method GetAttributes, addr 0x1332cdc, size 0x88, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Xml::Linq::XAttribute*>* GetAttributes(::System::Xml::Linq::XName* name);

  /// @brief Method GetNamespaceOfPrefixInScope, addr 0x1332d70, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetNamespaceOfPrefixInScope(::StringW prefix, ::System::Xml::Linq::XElement* outOfScope);

  /// @brief Method GetPrefixOfNamespace, addr 0x132df68, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadElementFrom, addr 0x1333248, size 0x78, virtual false, abstract: false, final false
  inline void ReadElementFrom(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);

  /// @brief Method ReadElementFromImpl, addr 0x1333694, size 0x4f4, virtual false, abstract: false, final false
  inline void ReadElementFromImpl(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);

  /// @brief Method SetEndElementLineInfo, addr 0x1331c04, size 0x78, virtual false, abstract: false, final false
  inline void SetEndElementLineInfo(int32_t lineNumber, int32_t linePosition);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x133309c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x13330a4, size 0x1a4, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x13332c0, size 0xc, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ValidateNode, addr 0x1333e08, size 0x13c, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method WriteTo, addr 0x1332e64, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1331954, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XName* name);

  /// @brief Method .ctor, addr 0x1332a9c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XElement* other);

  /// @brief Method .ctor, addr 0x132f67c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XStreamingElement* other);

  /// @brief Method get_HasAttributes, addr 0x1332b5c, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasAttributes();

  /// @brief Method get_IsEmpty, addr 0x1332b6c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Name, addr 0x1332b7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XName* get_Name();

  /// @brief Method get_NodeType, addr 0x1332b84, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x1332b8c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Value, addr 0x1332c20, size 0x78, virtual false, abstract: false, final false
