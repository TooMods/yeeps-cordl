...
public:
  ...
  /// @brief Method Clone, addr 0x185cbe4, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x185cdb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasInfo, addr 0x185cc5c, size 0x10, virtual false, abstract: false, final false
