...
public:
  // Declarations
  /// @brief Method Init, addr 0x2ccf2ac, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2ccf2fc, size 0x104, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerStationaryEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2ccf400, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
