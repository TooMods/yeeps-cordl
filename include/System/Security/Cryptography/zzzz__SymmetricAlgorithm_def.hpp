...
public:
  ...
  __declspec(property(get = get_FeedbackSize, put = set_FeedbackSize)) int32_t FeedbackSize;
  ...
  __declspec(property(get = get_LegalBlockSizes))::ArrayW<::System::Security::Cryptography::KeySizes*, ::Array<::System::Security::Cryptography::KeySizes*>*> LegalBlockSizes;
  ...
  /// @brief Method Clear, addr 0x1c8b778, size 0x94, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Create, addr 0x1c8c0f4, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::SymmetricAlgorithm* Create();

  /// @brief Method Create, addr 0x1c8c150, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::SymmetricAlgorithm* Create(::StringW algName);

  /// @brief Method CreateDecryptor, addr 0x1c8c240, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x1c8c1f0, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x1c8b70c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x1c8b80c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidKeySize, addr 0x1c8bdd4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1c8b6e8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BlockSize, addr 0x1c8b858, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_BlockSize();

  /// @brief Method get_FeedbackSize, addr 0x1c8b950, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FeedbackSize();

  /// @brief Method get_IV, addr 0x1c8b9e4, size 0x94, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_IV();

  /// @brief Method get_Key, addr 0x1c8bbe0, size 0x94, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method get_KeySize, addr 0x1c8bf60, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_LegalBlockSizes, addr 0x1c8be70, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Security::Cryptography::KeySizes*, ::Array<::System::Security::Cryptography::KeySizes*>*> get_LegalBlockSizes();

  /// @brief Method get_LegalKeySizes, addr 0x1c8bee8, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Security::Cryptography::KeySizes*, ::Array<::System::Security::Cryptography::KeySizes*>*> get_LegalKeySizes();

  /// @brief Method get_Mode, addr 0x1c8bfec, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::CipherMode get_Mode();

  /// @brief Method get_Padding, addr 0x1c8c070, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::PaddingMode get_Padding();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_BlockSize, addr 0x1c8b860, size 0xf0, virtual true, abstract: false, final false
  inline void set_BlockSize(int32_t value);

  /// @brief Method set_FeedbackSize, addr 0x1c8b958, size 0x8c, virtual true, abstract: false, final false
  inline void set_FeedbackSize(int32_t value);

  /// @brief Method set_IV, addr 0x1c8ba78, size 0x168, virtual true, abstract: false, final false
  inline void set_IV(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_Key, addr 0x1c8bc74, size 0x160, virtual true, abstract: false, final false
  inline void set_Key(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_KeySize, addr 0x1c8bf68, size 0x84, virtual true, abstract: false, final false
  inline void set_KeySize(int32_t value);

  /// @brief Method set_Mode, addr 0x1c8bff4, size 0x7c, virtual true, abstract: false, final false
  inline void set_Mode(::System::Security::Cryptography::CipherMode value);

  /// @brief Method set_Padding, addr 0x1c8c078, size 0x7c, virtual true, abstract: false, final false
