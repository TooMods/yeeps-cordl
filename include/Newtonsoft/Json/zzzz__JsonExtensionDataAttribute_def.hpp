...
public:
  ...
  /// @brief Method .ctor, addr 0x25c8d20, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadData, addr 0x25c8d0c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadData();

  /// @brief Method get_WriteData, addr 0x25c8cf8, size 0x8, virtual false, abstract: false, final false
  inline bool get_WriteData();

  /// @brief Method set_ReadData, addr 0x25c8d14, size 0xc, virtual false, abstract: false, final false
  inline void set_ReadData(bool value);

  /// @brief Method set_WriteData, addr 0x25c8d00, size 0xc, virtual false, abstract: false, final false
