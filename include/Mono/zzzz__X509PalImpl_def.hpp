...
public:
  ...
  /// @brief Method ConvertData, addr 0x241fae4, size 0x10c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetCertContentType, addr 0x241fbf8, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFallback, addr 0x241f1ac, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFallback, addr 0x241f43c, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* ImportFallback(::ArrayW<uint8_t, ::Array<uint8_t>*> data,
  ...
  /// @brief Method PEM, addr 0x241f9b0, size 0x134, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PEM(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x241f9a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_signedData();

  /// @brief Method get_SupportsLegacyBasicConstraintsExtension, addr 0x241fbf0, size 0x8, virtual false, abstract: false, final false
