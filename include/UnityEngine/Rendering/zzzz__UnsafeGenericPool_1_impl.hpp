...
template <typename T> inline ::UnityEngine::Rendering::__ObjectPool_1__PooledObject<T> UnityEngine::Rendering::UnsafeGenericPool_1<T>::Get(ByRef<T> value) {
  ...
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::Rendering::__ObjectPool_1__PooledObject<T>, false>(nullptr, ___internal_method, value);
}
