...
public:
  ...
  /// @brief Method AddIdentityConstraints, addr 0x18be8ec, size 0x3f8, virtual false, abstract: false, final false
  inline void AddIdentityConstraints();

  /// @brief Method AddSchema, addr 0x18b5e2c, size 0x43c, virtual false, abstract: false, final false
  inline void AddSchema(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method AddXmlNamespaceSchema, addr 0x18bf094, size 0x88, virtual false, abstract: false, final false
  inline void AddXmlNamespaceSchema();

  /// @brief Method AttributeIdentityConstraints, addr 0x18b94e8, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildElementName, addr 0x18b9eec, size 0x12c, virtual false, abstract: false, final false
  static inline ::StringW BuildElementName(::StringW localName, ::StringW ns);

  /// @brief Method BuildElementName, addr 0x18bdb58, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW BuildElementName(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method CheckAttributeValue, addr 0x18b90b8, size 0x284, virtual false, abstract: false, final false
  inline ::System::Object* CheckAttributeValue(::System::Object* value, ::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CheckElementProperties, addr 0x18b80c4, size 0xb4, virtual false, abstract: false, final false
  inline void CheckElementProperties();

  /// @brief Method CheckElementValue, addr 0x18be5c0, size 0x258, virtual false, abstract: false, final false
  inline ::System::Object* CheckElementValue(::StringW stringValue);

  /// @brief Method CheckForwardRefs, addr 0x18baf6c, size 0xf0, virtual false, abstract: false, final false
  inline void CheckForwardRefs();

  /// @brief Method CheckIsXmlAttribute, addr 0x18b8e60, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaAttDef* CheckIsXmlAttribute(::System::Xml::XmlQualifiedName* attQName);

  /// @brief Method CheckMixedValueConstraint, addr 0x18bc0c4, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Object* CheckMixedValueConstraint(::StringW elementValue);

  /// @brief Method CheckRequiredAttributes, addr 0x18b9858, size 0x204, virtual false, abstract: false, final false
  inline void CheckRequiredAttributes(::System::Xml::Schema::SchemaElementDecl* currentElementDecl);

  /// @brief Method CheckStateTransition, addr 0x18b6d38, size 0x250, virtual false, abstract: false, final false
  inline void CheckStateTransition(::System::Xml::Schema::ValidatorState toState, ::StringW methodName);

  /// @brief Method CheckTokenizedTypes, addr 0x18b933c, size 0x18c, virtual false, abstract: false, final false
  inline void CheckTokenizedTypes(::System::Xml::Schema::XmlSchemaDatatype* dtype, ::System::Object* typedValue, bool attrValue);

  /// @brief Method CheckXsiTypeAndNil, addr 0x18b798c, size 0x5f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearPSVI, addr 0x18b6f88, size 0x44, virtual false, abstract: false, final false
  inline void ClearPSVI();

  /// @brief Method CompleteValidationError, addr 0x18bc1a0, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ElementIdentityConstraints, addr 0x18bece4, size 0x3b0, virtual false, abstract: false, final false
  inline void ElementIdentityConstraints();

  /// @brief Method ElementValidationError, addr 0x18bddd8, size 0x7e8, virtual false, abstract: false, final false
  ...
  /// @brief Method EndElementIdentityConstraints, addr 0x18bc648, size 0xd5c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndValidation, addr 0x18bae78, size 0xf4, virtual false, abstract: false, final false
  inline void EndValidation();

  /// @brief Method EnumerateAny, addr 0x18bfef4, size 0x230, virtual false, abstract: false, final false
  static inline void EnumerateAny(::System::Text::StringBuilder* builder, ::StringW namespaces);

  /// @brief Method FastGetElementDecl, addr 0x18b73d4, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method FindId, addr 0x18bf58c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* FindId(::StringW name);

  /// @brief Method GetConcatenatedValue, addr 0x18bbadc, size 0x20, virtual false, abstract: false, final false
  inline ::StringW GetConcatenatedValue();

  /// @brief Method GetDefaultAttributePrefix, addr 0x18bb60c, size 0x3f0, virtual false, abstract: false, final false
  inline ::StringW GetDefaultAttributePrefix(::StringW attributeNS);

  /// @brief Method GetSchemaElement, addr 0x18b81d4, size 0x108, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* GetSchemaElement();

  /// @brief Method GetSubstitutionGroupHead, addr 0x18bd92c, size 0x22c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* GetSubstitutionGroupHead(::System::Xml::XmlQualifiedName* member);

  /// @brief Method GetTypeName, addr 0x18be818, size 0x68, virtual false, abstract: false, final false
  inline ::StringW GetTypeName(::System::Xml::Schema::SchemaDeclBase* decl);

  /// @brief Method GetUnspecifiedDefaultAttributes, addr 0x18bb05c, size 0x5b0, virtual false, abstract: false, final false
  inline void GetUnspecifiedDefaultAttributes(::System::Collections::ArrayList* defaultAttributes, bool createNodeData);

  /// @brief Method Init, addr 0x18b5770, size 0x314, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method Initialize, addr 0x18b65b4, size 0x160, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Initialize, addr 0x18b6714, size 0x2c4, virtual false, abstract: false, final false
  inline void Initialize(::System::Xml::Schema::XmlSchemaObject* partialValidationType);

  /// @brief Method InternalValidateEndElement, addr 0x18ba658, size 0x4f8, virtual false, abstract: false, final false
  inline ::System::Object* InternalValidateEndElement(::System::Xml::Schema::XmlSchemaInfo* schemaInfo, ::System::Object* typedValue);

  /// @brief Method LoadSchema, addr 0x18bd3a4, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x18bad54, size 0x124, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method PrintExpectedElements, addr 0x18ba018, size 0x3fc, virtual false, abstract: false, final false
  static inline ::StringW PrintExpectedElements(::System::Collections::ArrayList* expected, bool getParticles);

  /// @brief Method PrintNames, addr 0x18bfd78, size 0x17c, virtual false, abstract: false, final false
  static inline ::StringW PrintNames(::System::Collections::ArrayList* expected);

  /// @brief Method PrintNamesWithNS, addr 0x18bf908, size 0x470, virtual false, abstract: false, final false
  static inline void PrintNamesWithNS(::System::Collections::ArrayList* expected, ::System::Text::StringBuilder* builder);

  /// @brief Method ProcessEntity, addr 0x18bf5a8, size 0x174, virtual false, abstract: false, final false
  inline void ProcessEntity(::StringW name);

  /// @brief Method ProcessSchemaLocations, addr 0x18b7624, size 0x368, virtual false, abstract: false, final false
  inline void ProcessSchemaLocations(::StringW xsiSchemaLocation, ::StringW xsiNoNamespaceSchemaLocation);

  /// @brief Method ProcessTokenizedType, addr 0x18bf2e8, size 0x2a4, virtual false, abstract: false, final false
  inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType ttype, ::StringW name, bool attrValue);

  /// @brief Method Push, addr 0x18b5a84, size 0xf0, virtual false, abstract: false, final false
  inline void Push(::System::Xml::XmlQualifiedName* elementName);

  /// @brief Method QNameString, addr 0x18b9e38, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW QNameString(::StringW localName, ::StringW ns);

  /// @brief Method RecompileSchemaSet, addr 0x18b5c00, size 0xc0, virtual false, abstract: false, final false
  inline void RecompileSchemaSet();

  /// @brief Method Reset, addr 0x18b5b74, size 0x8c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SaveTextValue, addr 0x18b9eac, size 0x40, virtual false, abstract: false, final false
  inline void SaveTextValue(::System::Object* value);

  /// @brief Method SendValidationEvent, addr 0x18be880, size 0x60, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code);

  /// @brief Method SendValidationEvent, addr 0x18b8ce4, size 0x17c, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0x18bdbc0, size 0x218, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW arg1, ::StringW arg2);

  /// @brief Method SendValidationEvent, addr 0x18b8f28, size 0x190, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method SendValidationEvent, addr 0x18b6418, size 0x19c, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Exception* innerException);

  /// @brief Method SendValidationEvent, addr 0x18bf11c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SendValidationEvent, addr 0x18b6268, size 0x1b0, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW msg, ::System::Xml::Schema::XmlSeverityType severity);

  /// @brief Method SendValidationEvent, addr 0x18bd878, size 0xb4, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException* e);

  /// @brief Method SendValidationEvent, addr 0x18bf844, size 0x8, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaValidationException* e);

  /// @brief Method SendValidationEvent, addr 0x18bf71c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendValidationEvent, addr 0x18bf84c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDtdSchemaInfo, addr 0x18bba40, size 0x10, virtual false, abstract: false, final false
  inline void SetDtdSchemaInfo(::System::Xml::IDtdInfo* dtdSchemaInfo);

  /// @brief Method SkipToEndElement, addr 0x18bab50, size 0x204, virtual false, abstract: false, final false
  inline void SkipToEndElement(::System::Xml::Schema::XmlSchemaInfo* schemaInfo);

  /// @brief Method ThrowDeclNotFoundWarningOrError, addr 0x18b7f7c, size 0x148, virtual false, abstract: false, final false
  inline void ThrowDeclNotFoundWarningOrError(bool declFound);

  /// @brief Method ValidateAtomicValue, addr 0x18bbd90, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateAtomicValue, addr 0x18bbafc, size 0x294, virtual false, abstract: false, final false
  inline ::System::Object* ValidateAtomicValue(::StringW stringValue, ByRef<::System::Xml::Schema::XmlSchemaSimpleType*> memberType);

  /// @brief Method ValidateAttribute, addr 0x18b833c, size 0x9a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateAttribute, addr 0x18b82dc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x18b69d8, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateElementContext, addr 0x18b6fcc, size 0x408, virtual false, abstract: false, final false
  inline ::System::Object* ValidateElementContext(::System::Xml::XmlQualifiedName* elementName, ByRef<bool> invalidElementInContext);

  /// @brief Method ValidateEndElement, addr 0x18ba650, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* ValidateEndElement(::System::Xml::Schema::XmlSchemaInfo* schemaInfo);

  /// @brief Method ValidateEndOfAttributes, addr 0x18b9790, size 0xc8, virtual false, abstract: false, final false
  inline void ValidateEndOfAttributes(::System::Xml::Schema::XmlSchemaInfo* schemaInfo);

  /// @brief Method ValidateStartElementIdentityConstraints, addr 0x18b8178, size 0x5c, virtual false, abstract: false, final false
  inline void ValidateStartElementIdentityConstraints();

  /// @brief Method ValidateText, addr 0x18b9abc, size 0x37c, virtual false, abstract: false, final false
  inline void ValidateText(::StringW elementStringValue, ::System::Xml::Schema::XmlValueGetter* elementValueGetter);

  /// @brief Method ValidateText, addr 0x18b9a5c, size 0x60, virtual false, abstract: false, final false
  inline void ValidateText(::System::Xml::Schema::XmlValueGetter* elementValue);

  /// @brief Method ValidateWhitespace, addr 0x18ba474, size 0x1dc, virtual false, abstract: false, final false
  inline void ValidateWhitespace(::StringW elementStringValue, ::System::Xml::Schema::XmlValueGetter* elementValueGetter);

  /// @brief Method ValidateWhitespace, addr 0x18ba414, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18b5584, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method add_ValidationEventHandler, addr 0x18b5d2c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentContentType, addr 0x18bba0c, size 0x34, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_CurrentContentType();

  /// @brief Method get_HasIdentityConstraints, addr 0x18b94c8, size 0x20, virtual false, abstract: false, final false
  inline bool get_HasIdentityConstraints();

  /// @brief Method get_HasSchema, addr 0x18bba94, size 0x48, virtual false, abstract: false, final false
  inline bool get_HasSchema();

  /// @brief Method get_ProcessIdentityConstraints, addr 0x18be8e0, size 0xc, virtual false, abstract: false, final false
  inline bool get_ProcessIdentityConstraints();

  /// @brief Method get_ProcessSchemaHints, addr 0x18b5cc0, size 0x10, virtual false, abstract: false, final false
  inline bool get_ProcessSchemaHints();

  /// @brief Method get_ReportValidationWarnings, addr 0x18bf838, size 0xc, virtual false, abstract: false, final false
  inline bool get_ReportValidationWarnings();

  /// @brief Method get_SchemaSet, addr 0x18bb9fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* get_SchemaSet();

  /// @brief Method get_StrictlyAssessed, addr 0x18bba50, size 0x44, virtual false, abstract: false, final false
  inline bool get_StrictlyAssessed();

  /// @brief Method get_ValidationFlags, addr 0x18bba04, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaValidationFlags get_ValidationFlags();

  /// @brief Method remove_ValidationEventHandler, addr 0x18b5dac, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LineInfoProvider, addr 0x18b5cd8, size 0x18, virtual false, abstract: false, final false
  inline void set_LineInfoProvider(::System::Xml::IXmlLineInfo* value);

  /// @brief Method set_SourceUri, addr 0x18b5cf0, size 0x34, virtual false, abstract: false, final false
  inline void set_SourceUri(::System::Uri* value);

  /// @brief Method set_ValidationEventSender, addr 0x18b5d24, size 0x8, virtual false, abstract: false, final false
  inline void set_ValidationEventSender(::System::Object* value);

  /// @brief Method set_XmlResolver, addr 0x18b5cd0, size 0x8, virtual false, abstract: false, final false
