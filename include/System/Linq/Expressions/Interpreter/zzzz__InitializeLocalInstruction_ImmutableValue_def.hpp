...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x1b52990, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x1b52924, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b528f4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Object* defaultValue);

  /// @brief Method get_InstructionName, addr 0x1b52a44, size 0x40, virtual true, abstract: false, final false
