...
public:
  ...
  /// @brief Method ReadUnprocessedValueFromState, addr 0x2264da8, size 0xc, virtual true, abstract: false, final false
  inline double_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x2264db4, size 0xc, virtual true, abstract: false, final false
  inline void WriteValueIntoState(double_t value, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method .ctor, addr 0x2264d20, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
