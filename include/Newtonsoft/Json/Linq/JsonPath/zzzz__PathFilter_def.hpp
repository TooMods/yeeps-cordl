...
public:
  ...
  /// @brief Method GetNextScanValue, addr 0x11a5150, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTokenIndex, addr 0x119f474, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119edc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
