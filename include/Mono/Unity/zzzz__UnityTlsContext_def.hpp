...
public:
  ...
  /// @brief Method CertificateCallback, addr 0x2424d94, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method CertificateCallback, addr 0x2422a34, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2423bac, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x24233b0, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishHandshake, addr 0x2423f68, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method PendingRenegotiation, addr 0x2423a90, size 0x8, virtual true, abstract: false, final false
  inline bool PendingRenegotiation();

  /// @brief Method ProcessHandshake, addr 0x2423da4, size 0x174, virtual true, abstract: false, final false
  inline bool ProcessHandshake();

  /// @brief Method Read, addr 0x2423708, size 0x1a8, virtual true, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadCallback, addr 0x2424500, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCallback, addr 0x24228bc, size 0xc8, virtual false, abstract: false, final false
  static inline void* ReadCallback(::cordl_internals::Ptr<void> userData, ::cordl_internals::Ptr<uint8_t> buffer, void* bufferLen,
                                   ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate> errorState);

  /// @brief Method Renegotiate, addr 0x2423a50, size 0x40, virtual true, abstract: false, final false
  inline void Renegotiate();

  /// @brief Method Shutdown, addr 0x2423a98, size 0xf8, virtual true, abstract: false, final false
  inline void Shutdown();

  /// @brief Method StartHandshake, addr 0x2423c24, size 0x180, virtual true, abstract: false, final false
  inline void StartHandshake();

  /// @brief Method VerifyCallback, addr 0x2424904, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyCallback, addr 0x2422984, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x24238b0, size 0x1a0, virtual true, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteCallback, addr 0x24240b0, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCallback, addr 0x24227f4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2422afc, size 0x708, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAuthenticated, addr 0x24236f0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_LocalClientCertificate, addr 0x24236f8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate();

  /// @brief Method get_RemoteCertificate, addr 0x2423700, size 0x8, virtual true, abstract: false, final false
