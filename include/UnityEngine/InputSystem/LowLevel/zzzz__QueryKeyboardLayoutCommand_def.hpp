...
public:
  ...
  /// @brief Method Create, addr 0x1e02448, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand Create();

  /// @brief Method ReadLayoutName, addr 0x1e023e4, size 0x10, virtual false, abstract: false, final false
  inline ::StringW ReadLayoutName();

  /// @brief Method WriteLayoutName, addr 0x1e023f4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x1e023b4, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x1e02418, size 0x30, virtual true, abstract: false, final true
