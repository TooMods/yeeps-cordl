...
public:
  ...
  /// @brief Method Accept, addr 0x182e450, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetFalse, addr 0x182e3f8, size 0x58, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetFalse();

  /// @brief Method Make, addr 0x182e164, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x182e478, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182e0f4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* test, ::System::Linq::Expressions::Expression* ifTrue);

  /// @brief Method get_IfFalse, addr 0x182e3ec, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_IfFalse();

  /// @brief Method get_IfTrue, addr 0x182e3e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_IfTrue();

  /// @brief Method get_NodeType, addr 0x182e3b4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Test, addr 0x182e3dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Test();

  /// @brief Method get_Type, addr 0x182e3bc, size 0x20, virtual true, abstract: false, final false
