...
public:
  ...
  /// @brief Method <.cctor>b__4_0, addr 0xed33ac, size 0x2a4, virtual false, abstract: false, final false
  inline void __cctor_b__4_0(::System::Object* state);

  /// @brief Method .ctor, addr 0xed33a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0xed2d1c, size 0x120, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AsTask, addr 0xed28cc, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* AsTask();

  /// @brief Method ConfigureAwait, addr 0xed3188, size 0x18, virtual false, abstract: false, final false
  inline ::System::Runtime::CompilerServices::ConfiguredValueTaskAwaitable ConfigureAwait(bool continueOnCapturedContext);

  /// @brief Method Equals, addr 0xed2820, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0xed28a8, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::System::Threading::Tasks::ValueTask other);

  /// @brief Method GetAwaiter, addr 0xed317c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Runtime::CompilerServices::ValueTaskAwaiter GetAwaiter();

  /// @brief Method GetHashCode, addr 0xed2808, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTaskForValueTaskSource, addr 0xed2984, size 0x2d8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* GetTaskForValueTaskSource(::System::Threading::Tasks::Sources::IValueTaskSource* t);

  /// @brief Method ThrowIfCompletedUnsuccessfully, addr 0xed3078, size 0x104, virtual false, abstract: false, final false
  inline void ThrowIfCompletedUnsuccessfully();

  /// @brief Method .ctor, addr 0xed27f4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj, int16_t token, bool continueOnCapturedContext);

  /// @brief Method .ctor, addr 0xed27b8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Sources::IValueTaskSource* source, int16_t token);

  /// @brief Method .ctor, addr 0xed2780, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  static inline ::System::Threading::Tasks::Task* getStaticF_s_canceledTask();

  /// @brief Method get_CompletedTask, addr 0xed26f8, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* get_CompletedTask();

  /// @brief Method get_IsCompleted, addr 0xed2e3c, size 0x104, virtual false, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method get_IsCompletedSuccessfully, addr 0xed2f40, size 0x110, virtual false, abstract: false, final false
