...
public:
  ...
  /// @brief Method MoveNext, addr 0x1aac1a0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1aad2d8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::ObjectHolderList* list, bool isFixupEnumerator);

  /// @brief Method get_Current, addr 0x1aac148, size 0x3c, virtual false, abstract: false, final false
