...
public:
  ...
  /// @brief Method GetCustomBlendShapeNameAndExpressionPairs, addr 0x16e9b4c, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method GetFaceExpression, addr 0x16e9b1c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x16e9ac8, size 0x4, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x16e9c84, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AllowDuplicateMapping, addr 0x16e9ab4, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowDuplicateMapping();

  /// @brief Method get_Mappings, addr 0x16e9a94, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_RetargetingValue, addr 0x16e9aa4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRCustomFace__RetargetingType get_RetargetingValue();

  /// @brief Method set_AllowDuplicateMapping, addr 0x16e9abc, size 0xc, virtual false, abstract: false, final false
  inline void set_AllowDuplicateMapping(bool value);

  /// @brief Method set_Mappings, addr 0x16e9a9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_RetargetingValue, addr 0x16e9aac, size 0x8, virtual false, abstract: false, final false
