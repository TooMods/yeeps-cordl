...
public:
  ...
  /// @brief Method Append2DigitNumber, addr 0x29a3e88, size 0x5c, virtual false, abstract: false, final false
  static inline void Append2DigitNumber(::System::Text::StringBuilder* result, int32_t val);

  /// @brief Method ExpandPredefinedFormat, addr 0x29a418c, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x299bd0c, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::DateTime dateTime, ::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method Format, addr 0x299eeb0, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomized, addr 0x29a28a4, size 0x10cc, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedRoundripTimeZone, addr 0x29a3c8c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedTimeZone, addr 0x29a3970, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDayOfWeek, addr 0x29a2410, size 0x34, virtual false, abstract: false, final false
  static inline ::StringW FormatDayOfWeek(int32_t dayOfWeek, int32_t repeat, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatDigits, addr 0x29a21b4, size 0x70, virtual false, abstract: false, final false
  static inline void FormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t value, int32_t len);

  /// @brief Method FormatDigits, addr 0x29a2224, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatHebrewMonthName, addr 0x29a2478, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatMonth, addr 0x29a2444, size 0x34, virtual false, abstract: false, final false
  static inline ::StringW FormatMonth(int32_t month, int32_t repeatCount, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatStringBuilder, addr 0x29a4e20, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRealFormat, addr 0x29a3ee4, size 0x2a8, virtual false, abstract: false, final false
  static inline ::StringW GetRealFormat(::System::ReadOnlySpan_1<char16_t> format, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method HebrewFormatDigits, addr 0x29a231c, size 0x7c, virtual false, abstract: false, final false
  static inline void HebrewFormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t digits);

  /// @brief Method InvalidFormatForLocal, addr 0x29a44fc, size 0x4, virtual false, abstract: false, final false
  static inline void InvalidFormatForLocal(::System::ReadOnlySpan_1<char16_t> format, ::System::DateTime dateTime);

  /// @brief Method IsUseGenitiveForm, addr 0x29a2758, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseNextChar, addr 0x29a26e8, size 0x70, virtual false, abstract: false, final false
  static inline int32_t ParseNextChar(::System::ReadOnlySpan_1<char16_t> format, int32_t pos);

  /// @brief Method ParseQuoteString, addr 0x29a2538, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseRepeatPattern, addr 0x29a2398, size 0x78, virtual false, abstract: false, final false
  static inline int32_t ParseRepeatPattern(::System::ReadOnlySpan_1<char16_t> format, int32_t pos, char16_t patternChar);

  /// @brief Method TryFormat, addr 0x299bf6c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x299f3a0, size 0x210, virtual false, abstract: false, final false
  static inline bool TryFormat(::System::DateTime dateTime, ::System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten, ::System::ReadOnlySpan_1<char16_t> format,
                               ::System::IFormatProvider* provider, ::System::TimeSpan offset);

  /// @brief Method TryFormatO, addr 0x29a4500, size 0x508, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatR, addr 0x29a4a08, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDigits, addr 0x29a5218, size 0xac, virtual false, abstract: false, final false
  static inline void WriteDigits(uint64_t value, ::System::Span_1<char16_t> buffer);

  /// @brief Method WriteFourDecimalDigits, addr 0x29a5178, size 0xa0, virtual false, abstract: false, final false
  static inline void WriteFourDecimalDigits(uint32_t value, ::System::Span_1<char16_t> buffer, int32_t startingIndex);

  /// @brief Method WriteTwoDecimalDigits, addr 0x29a512c, size 0x4c, virtual false, abstract: false, final false
