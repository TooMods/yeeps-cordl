...
public:
  ...
  /// @brief Method CopyToFrom, addr 0x1e0ec48, size 0x8c, virtual false, abstract: false, final false
  inline void CopyToFrom(::cordl_internals::Ptr<void> toStatePtr, ::cordl_internals::Ptr<void> fromStatePtr);

  /// @brief Method FloatToPrimitiveValue, addr 0x1e0ddc8, size 0x4a0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FloatToPrimitiveValue(float_t value);

  /// @brief Method GetPrimitiveFormatFromType, addr 0x1e0ce0c, size 0x4dc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC GetPrimitiveFormatFromType(::System::Type* type);

  /// @brief Method GetSizeOfPrimitiveFormatInBits, addr 0x1e0cb24, size 0x2e8, virtual false, abstract: false, final false
  static inline int32_t GetSizeOfPrimitiveFormatInBits(::UnityEngine::InputSystem::Utilities::FourCC type);

  /// @brief Method ReadDouble, addr 0x1e0e268, size 0x2fc, virtual false, abstract: false, final false
  inline double_t ReadDouble(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method ReadFloat, addr 0x1e0d6cc, size 0x2fc, virtual false, abstract: false, final false
  inline float_t ReadFloat(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method ReadInt, addr 0x1e0d340, size 0x1d0, virtual false, abstract: false, final false
  inline int32_t ReadInt(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method Write, addr 0x1e0e988, size 0x2c0, virtual false, abstract: false, final false
  inline void Write(::cordl_internals::Ptr<void> statePtr, ::UnityEngine::InputSystem::Utilities::PrimitiveValue value);

  /// @brief Method WriteDouble, addr 0x1e0e564, size 0x424, virtual false, abstract: false, final false
  inline void WriteDouble(::cordl_internals::Ptr<void> statePtr, double_t value);

  /// @brief Method WriteFloat, addr 0x1e0d9c8, size 0x400, virtual false, abstract: false, final false
  inline void WriteFloat(::cordl_internals::Ptr<void> statePtr, float_t value);

  /// @brief Method WriteInt, addr 0x1e0d510, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_alignedSizeInBytes, addr 0x1e040e8, size 0x10, virtual false, abstract: false, final false
  inline uint32_t get_alignedSizeInBytes();

  /// @brief Method get_bitOffset, addr 0x1e0d308, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_bitOffset();

  /// @brief Method get_byteOffset, addr 0x1e0d2f8, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_byteOffset();

  /// @brief Method get_effectiveBitOffset, addr 0x1e0d334, size 0xc, virtual false, abstract: false, final false
  inline uint32_t get_effectiveBitOffset();

  /// @brief Method get_effectiveByteOffset, addr 0x1e0d328, size 0xc, virtual false, abstract: false, final false
  inline uint32_t get_effectiveByteOffset();

  /// @brief Method get_format, addr 0x1e0d2e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_sizeInBits, addr 0x1e0d318, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bitOffset, addr 0x1e0d310, size 0x8, virtual false, abstract: false, final false
  inline void set_bitOffset(uint32_t value);

  /// @brief Method set_byteOffset, addr 0x1e0d300, size 0x8, virtual false, abstract: false, final false
  inline void set_byteOffset(uint32_t value);

  /// @brief Method set_format, addr 0x1e0d2f0, size 0x8, virtual false, abstract: false, final false
  inline void set_format(::UnityEngine::InputSystem::Utilities::FourCC value);

  /// @brief Method set_sizeInBits, addr 0x1e0d320, size 0x8, virtual false, abstract: false, final false
