...
public:
  ...
  /// @brief Method Awake, addr 0x1495f34, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x1496008, size 0x4, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  static inline ::GlobalNamespace::OVRSceneVolume* New_ctor();

  /// @brief Method SetChildOffset, addr 0x1495e54, size 0xe0, virtual false, abstract: false, final false
  inline void SetChildOffset();

  /// @brief Method SetChildScale, addr 0x1495d38, size 0xe0, virtual false, abstract: false, final false
  inline void SetChildScale();

  /// @brief Method UpdateTransform, addr 0x148ef50, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x149600c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Depth, addr 0x1495cc8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Depth();

  /// @brief Method get_Dimensions, addr 0x1495cd8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Dimensions();

  /// @brief Method get_Height, addr 0x1495cb8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method get_Offset, addr 0x1495ce4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Offset();

  /// @brief Method get_OffsetChildren, addr 0x1495e18, size 0x8, virtual false, abstract: false, final false
  inline bool get_OffsetChildren();

  /// @brief Method get_ScaleChildren, addr 0x1495cfc, size 0x8, virtual false, abstract: false, final false
  inline bool get_ScaleChildren();

  /// @brief Method get_Width, addr 0x1495ca8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Depth, addr 0x1495cd0, size 0x8, virtual false, abstract: false, final false
  inline void set_Depth(float_t value);

  /// @brief Method set_Height, addr 0x1495cc0, size 0x8, virtual false, abstract: false, final false
  inline void set_Height(float_t value);

  /// @brief Method set_Offset, addr 0x1495cf0, size 0xc, virtual false, abstract: false, final false
  inline void set_Offset(::UnityEngine::Vector3 value);

  /// @brief Method set_OffsetChildren, addr 0x1495e20, size 0x34, virtual false, abstract: false, final false
  inline void set_OffsetChildren(bool value);

  /// @brief Method set_ScaleChildren, addr 0x1495d04, size 0x34, virtual false, abstract: false, final false
  inline void set_ScaleChildren(bool value);

  /// @brief Method set_Width, addr 0x1495cb0, size 0x8, virtual false, abstract: false, final false
