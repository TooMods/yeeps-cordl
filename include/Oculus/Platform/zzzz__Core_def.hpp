...
public:
  ...
  /// @brief Method AsyncInitialize, addr 0x19b6ed8, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method AsyncInitialize, addr 0x198ba04, size 0x2c0, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW appId);

  /// @brief Method ForceInitialized, addr 0x19b6a04, size 0x5c, virtual false, abstract: false, final false
  static inline void ForceInitialized();

  /// @brief Method GetAppIDFromConfig, addr 0x19b6c04, size 0x40, virtual false, abstract: false, final false
  static inline ::StringW GetAppIDFromConfig();

  /// @brief Method Initialize, addr 0x19b7274, size 0x320, virtual false, abstract: false, final false
  static inline void Initialize(::StringW appId);

  /// @brief Method IsInitialized, addr 0x19b69ac, size 0x58, virtual false, abstract: false, final false
  static inline bool IsInitialized();

  static inline ::Oculus::Platform::Core* New_ctor();

  /// @brief Method .ctor, addr 0x19b76bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method getAppID, addr 0x19b6a60, size 0x1a4, virtual false, abstract: false, final false
