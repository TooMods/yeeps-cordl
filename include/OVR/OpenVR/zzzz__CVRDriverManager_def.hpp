...
public:
  ...
  /// @brief Method GetDriverCount, addr 0x2a7a2d0, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetDriverCount();

  /// @brief Method GetDriverHandle, addr 0x2a7a318, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetDriverHandle(::StringW pchDriverName);

  /// @brief Method GetDriverName, addr 0x2a7a2f4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a7a1bc, size 0x114, virtual false, abstract: false, final false
