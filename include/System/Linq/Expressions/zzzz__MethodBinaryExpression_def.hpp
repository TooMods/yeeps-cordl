...
public:
  ...
  /// @brief Method GetMethod, addr 0x2d26fc8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d26f3c, size 0x40, virtual false, abstract: false, final false
