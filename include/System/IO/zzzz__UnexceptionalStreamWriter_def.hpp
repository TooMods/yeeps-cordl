...
public:
  // Declarations
  /// @brief Method Flush, addr 0x1fcc8e8, size 0x84, virtual true, abstract: false, final false
  inline void Flush();

  static inline ::System::IO::UnexceptionalStreamWriter* New_ctor(::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method Write, addr 0x1fcc96c, size 0x84, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x1fcca74, size 0x84, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> value);

  /// @brief Method Write, addr 0x1fccaf8, size 0x84, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x1fcc9f0, size 0x84, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method .ctor, addr 0x1fcc870, size 0x78, virtual false, abstract: false, final false
