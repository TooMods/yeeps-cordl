...
public:
  ...
  /// @brief Method Load, addr 0x12645e0, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaximumBufferSamplesCount, addr 0x12658e8, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_MaximumBufferSamplesCount();

  /// @brief Method get_MinimumBufferSamplesCount, addr 0x1265780, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_MinimumBufferSamplesCount();

  /// @brief Method get_MinimumSafeSamplesQueued, addr 0x12656cc, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_MinimumSafeSamplesQueued();

  /// @brief Method get_OptimalBufferSamplesCount, addr 0x1265834, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_OptimalBufferSamplesCount();

  /// @brief Method get_SampleRateHz, addr 0x1265564, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_SampleRateHz();

  /// @brief Method get_SampleSizeInBytes, addr 0x1265618, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_MaximumBufferSamplesCount, addr 0x1265940, size 0x5c, virtual false, abstract: false, final false
  static inline void set_MaximumBufferSamplesCount(int32_t value);

  /// @brief Method set_MinimumBufferSamplesCount, addr 0x12657d8, size 0x5c, virtual false, abstract: false, final false
  static inline void set_MinimumBufferSamplesCount(int32_t value);

  /// @brief Method set_MinimumSafeSamplesQueued, addr 0x1265724, size 0x5c, virtual false, abstract: false, final false
  static inline void set_MinimumSafeSamplesQueued(int32_t value);

  /// @brief Method set_OptimalBufferSamplesCount, addr 0x126588c, size 0x5c, virtual false, abstract: false, final false
  static inline void set_OptimalBufferSamplesCount(int32_t value);

  /// @brief Method set_SampleRateHz, addr 0x12655bc, size 0x5c, virtual false, abstract: false, final false
  static inline void set_SampleRateHz(int32_t value);

  /// @brief Method set_SampleSizeInBytes, addr 0x1265670, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x12660a8, size 0x18, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Mix, addr 0x1265bd8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Preempt, addr 0x12659a0, size 0x18, virtual false, abstract: false, final false
  inline void Preempt(::GlobalNamespace::OVRHapticsClip* clip);

  /// @brief Method Queue, addr 0x1265ad8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1264984, size 0x98, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x1266230, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRHapticsClip* clip);

  /// @brief Method get_Clip, addr 0x1266470, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRHapticsClip* get_Clip();

  /// @brief Method get_ReadCount, addr 0x1266460, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ReadCount();

  /// @brief Method set_Clip, addr 0x1266478, size 0x8, virtual false, abstract: false, final false
  inline void set_Clip(::GlobalNamespace::OVRHapticsClip* value);

  /// @brief Method set_ReadCount, addr 0x1266468, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x12660c0, size 0x70, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Mix, addr 0x1265bf0, size 0x4b8, virtual false, abstract: false, final false
  inline void Mix(::GlobalNamespace::OVRHapticsClip* clip);

  static inline ::GlobalNamespace::__OVRHaptics__OVRHapticsOutput* New_ctor(uint32_t controller);

  /// @brief Method Preempt, addr 0x12659b8, size 0x120, virtual false, abstract: false, final false
  inline void Preempt(::GlobalNamespace::OVRHapticsClip* clip);

  /// @brief Method Process, addr 0x1264af8, size 0xa6c, virtual false, abstract: false, final false
  inline void Process();

  /// @brief Method Queue, addr 0x1265af0, size 0xe8, virtual false, abstract: false, final false
  inline void Queue(::GlobalNamespace::OVRHapticsClip* clip);
  ...
  /// @brief Method .ctor, addr 0x12647e0, size 0x1a4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Process, addr 0x1264a1c, size 0xdc, virtual false, abstract: false, final false
