...
public:
  ...
  /// @brief Method ApplyTo, addr 0x2a39378, size 0x24, virtual true, abstract: false, final false
  inline void ApplyTo(::UnityEngine::UIElements::FocusController* focusController, ::UnityEngine::UIElements::Focusable* f);

  /// @brief Method Dispose, addr 0x2a392f4, size 0x84, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetPooled, addr 0x2a3926c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a3939c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::VisualElementFocusChangeTarget*>* getStaticF_Pool();

  /// @brief Method get_target, addr 0x2a3943c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_target, addr 0x2a39444, size 0x8, virtual false, abstract: false, final false
