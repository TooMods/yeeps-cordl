...
public:
  ...
  /// @brief Method CreateCopy, addr 0x185bb14, size 0x254, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IllogicalCallContext* CreateCopy();

  /// @brief Method FreeNamedDataSlot, addr 0x185b9a8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x185bd68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Datastore, addr 0x185ba6c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_Datastore();

  /// @brief Method get_HasUserData, addr 0x185bae8, size 0x2c, virtual false, abstract: false, final false
  inline bool get_HasUserData();

  /// @brief Method get_HostContext, addr 0x185bad8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_HostContext();

  /// @brief Method set_HostContext, addr 0x185bae0, size 0x8, virtual false, abstract: false, final false
