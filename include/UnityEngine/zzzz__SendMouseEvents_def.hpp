...
public:
  // Declarations
  /// @brief Method Compare, addr 0x1e9706c, size 0xb4, virtual false, abstract: false, final false
  static inline bool Compare(::UnityEngine::__SendMouseEvents__HitInfo lhs, ::UnityEngine::__SendMouseEvents__HitInfo rhs);

  /// @brief Method SendMessage, addr 0x1e97048, size 0x24, virtual false, abstract: false, final false
  inline void SendMessage(::StringW name);

  /// @brief Method op_Implicit, addr 0x1e96fa8, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoSendMouseEvents, addr 0x1e9623c, size 0x94c, virtual false, abstract: false, final false
  static inline void DoSendMouseEvents(int32_t skipRTCameras);

  /// @brief Method SendEvents, addr 0x1e96b88, size 0x420, virtual false, abstract: false, final false
  static inline void SendEvents(int32_t i, ::UnityEngine::__SendMouseEvents__HitInfo hit);

  /// @brief Method SetMouseMoved, addr 0x1e961e0, size 0x5c, virtual false, abstract: false, final false
  static inline void SetMouseMoved();

  /// @brief Method UpdateMouse, addr 0x1e9601c, size 0x1c4, virtual false, abstract: false, final false
