...
public:
  ...
  /// @brief Method MoveNext, addr 0x1527230, size 0x384, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x15275b4, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Encode, addr 0x1526b68, size 0x198, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method EncodeAsync, addr 0x1526fa0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Flush, addr 0x1526ee8, size 0xb8, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x1527124, size 0x10c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method FulfillFromLeftover, addr 0x1526d00, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreLeftOverBytes, addr 0x1526dc4, size 0x124, virtual false, abstract: false, final false
  inline void StoreLeftOverBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, ByRef<int32_t> count);

  /// @brief Method ValidateEncode, addr 0x1526a98, size 0xd0, virtual false, abstract: false, final false
  inline void ValidateEncode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteChars, addr 0x1526da0, size 0x24, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method WriteCharsAsync, addr 0x152709c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1526a08, size 0x90, virtual false, abstract: false, final false
