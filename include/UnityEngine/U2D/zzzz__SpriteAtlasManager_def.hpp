...
public:
  ...
  /// @brief Method PostRegisteredAtlas, addr 0x2a8747c, size 0x6c, virtual false, abstract: false, final false
  static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas* spriteAtlas);

  /// @brief Method Register, addr 0x2a874e8, size 0x3c, virtual false, abstract: false, final false
  static inline void Register(::UnityEngine::U2D::SpriteAtlas* spriteAtlas);

  /// @brief Method RequestAtlas, addr 0x2a8721c, size 0xc0, virtual false, abstract: false, final false
  static inline bool RequestAtlas(::StringW tag);

  /// @brief Method add_atlasRegistered, addr 0x2a872dc, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_atlasRegistered, addr 0x2a873ac, size 0xd0, virtual false, abstract: false, final false
