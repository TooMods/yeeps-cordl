...
namespace Newtonsoft::Json::Linq {
class __JObject___GetEnumerator_d__63;
}
namespace Newtonsoft::Json::Linq {
...
MARK_REF_PTR_T(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63);
...
public:
  ...
  /// @brief Method <GetDynamicMemberNames>b__2_0, addr 0x134233c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _GetDynamicMemberNames_b__2_0(::Newtonsoft::Json::Linq::JProperty* p);

  /// @brief Method .ctor, addr 0x1342334, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  using _GetEnumerator_d__63 = ::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63;
  ...
  /// @brief Method Add, addr 0x133fcbc, size 0x84, virtual true, abstract: false, final true
  inline void Add(::StringW propertyName, ::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method CloneToken, addr 0x133ffdc, size 0x60, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken();

  /// @brief Method ContainsKey, addr 0x1340ec0, size 0x6c, virtual true, abstract: false, final true
  inline bool ContainsKey(::StringW propertyName);

  /// @brief Method DeepEquals, addr 0x133f080, size 0x9c, virtual true, abstract: false, final false
  inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken* node);

  /// @brief Method FromObject, addr 0x13408cc, size 0x20, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JObject* FromObject(::System::Object* o);

  /// @brief Method FromObject, addr 0x13408ec, size 0x18c, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JObject* FromObject(::System::Object* o, ::Newtonsoft::Json::JsonSerializer* jsonSerializer);

  /// @brief Method GetDeepHashCode, addr 0x134184c, size 0x4, virtual true, abstract: false, final false
  inline int32_t GetDeepHashCode();

  /// @brief Method GetEnumerator, addr 0x133fc54, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method GetMetaObject, addr 0x1341fbc, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* GetMetaObject(::System::Linq::Expressions::Expression* parameter);

  /// @brief Method GetValue, addr 0x1340d70, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* GetValue(::StringW propertyName);

  /// @brief Method GetValue, addr 0x1340d78, size 0x30, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* GetValue(::StringW propertyName, ::System::StringComparison comparison);

  /// @brief Method IndexOfItem, addr 0x133f470, size 0x28, virtual true, abstract: false, final false
  inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method InsertItem, addr 0x133f53c, size 0x6c, virtual true, abstract: false, final false
  inline bool InsertItem(int32_t index, ::Newtonsoft::Json::Linq::JToken* item, bool skipParentCheck);

  /// @brief Method InternalPropertyChanged, addr 0x133fe64, size 0x154, virtual false, abstract: false, final false
  inline void InternalPropertyChanged(::Newtonsoft::Json::Linq::JProperty* childProperty);

  /// @brief Method InternalPropertyChanging, addr 0x133ffb8, size 0x24, virtual false, abstract: false, final false
  inline void InternalPropertyChanging(::Newtonsoft::Json::Linq::JProperty* childProperty);

  /// @brief Method IsNull, addr 0x133fd40, size 0xa4, virtual false, abstract: false, final false
  static inline bool IsNull(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method Load, addr 0x1340500, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JObject* Load(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method Load, addr 0x1340508, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x133eb6c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x133eb78, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeItem, addr 0x133f83c, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method OnPropertyChanged, addr 0x1341878, size 0x98, virtual true, abstract: false, final false
  inline void OnPropertyChanged(::StringW propertyName);

  /// @brief Method OnPropertyChanging, addr 0x1341910, size 0x98, virtual true, abstract: false, final false
  inline void OnPropertyChanging(::StringW propertyName);

  /// @brief Method Parse, addr 0x13406dc, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JObject* Parse(::StringW json);

  /// @brief Method Parse, addr 0x13406e4, size 0x1e8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JObject* Parse(::StringW json, ::Newtonsoft::Json::Linq::JsonLoadSettings* settings);

  /// @brief Method Properties, addr 0x1340044, size 0x48, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JProperty*>* Properties();

  /// @brief Method Property, addr 0x134008c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JProperty* Property(::StringW name);

  /// @brief Method Property, addr 0x133c8dc, size 0x184, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JProperty* Property(::StringW name, ::System::StringComparison comparison);

  /// @brief Method PropertyValues, addr 0x1340094, size 0x13c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JEnumerable_1<::Newtonsoft::Json::Linq::JToken*> PropertyValues();

  /// @brief Method Remove, addr 0x134104c, size 0x20, virtual true, abstract: false, final true
  inline bool Remove(::StringW propertyName);

  /// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.Add, addr 0x1341158, size 0x9c, virtual true, abstract:
  /// false, final true
  ...
  /// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.Clear, addr 0x13411f4, size 0x10, virtual true, abstract:
  /// false, final true
  ...
  /// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.Contains, addr 0x1341204, size 0x80, virtual true,
  ...
  /// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.CopyTo, addr 0x1341284, size 0x47c, virtual true,
  /// abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.Remove, addr 0x1341708, size 0x144, virtual true,
  /// abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.get_IsReadOnly, addr 0x1341700, size 0x8, virtual true,
  /// abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IDictionary<System.String,Newtonsoft.Json.Linq.JToken>.get_Keys, addr 0x1340fdc, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IDictionary<System.String,Newtonsoft.Json.Linq.JToken>.get_Values, addr 0x1341118, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetAttributes, addr 0x1341db4, size 0x58, virtual true, abstract: false, final true
  inline ::System::ComponentModel::AttributeCollection* System_ComponentModel_ICustomTypeDescriptor_GetAttributes();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetClassName, addr 0x1341e0c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_ComponentModel_ICustomTypeDescriptor_GetClassName();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetComponentName, addr 0x1341e14, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_ComponentModel_ICustomTypeDescriptor_GetComponentName();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetConverter, addr 0x1341e1c, size 0x5c, virtual true, abstract: false, final true
  inline ::System::ComponentModel::TypeConverter* System_ComponentModel_ICustomTypeDescriptor_GetConverter();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetDefaultEvent, addr 0x1341e78, size 0x8, virtual true, abstract: false, final true
  inline ::System::ComponentModel::EventDescriptor* System_ComponentModel_ICustomTypeDescriptor_GetDefaultEvent();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetDefaultProperty, addr 0x1341e80, size 0x8, virtual true, abstract: false, final true
  inline ::System::ComponentModel::PropertyDescriptor* System_ComponentModel_ICustomTypeDescriptor_GetDefaultProperty();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEditor, addr 0x1341e88, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ComponentModel_ICustomTypeDescriptor_GetEditor(::System::Type* editorBaseType);

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEvents, addr 0x1341ee8, size 0x58, virtual true, abstract: false, final true
  inline ::System::ComponentModel::EventDescriptorCollection* System_ComponentModel_ICustomTypeDescriptor_GetEvents();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEvents, addr 0x1341e90, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetProperties, addr 0x13419a8, size 0x9c, virtual true, abstract: false, final true
  inline ::System::ComponentModel::PropertyDescriptorCollection* System_ComponentModel_ICustomTypeDescriptor_GetProperties();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetProperties, addr 0x1341a44, size 0x364, virtual true, abstract: false, final true
  ...
  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetPropertyOwner, addr 0x1341f40, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x1340da8, size 0x24, virtual false, abstract: false, final false
  inline bool TryGetValue(::StringW propertyName, ::System::StringComparison comparison, ByRef<::Newtonsoft::Json::Linq::JToken*> value);

  /// @brief Method TryGetValue, addr 0x13410dc, size 0x3c, virtual true, abstract: false, final true
  inline bool TryGetValue(::StringW propertyName, ByRef<::Newtonsoft::Json::Linq::JToken*> value);

  /// @brief Method ValidateToken, addr 0x133f5a8, size 0x21c, virtual true, abstract: false, final false
  inline void ValidateToken(::Newtonsoft::Json::Linq::JToken* o, ::Newtonsoft::Json::Linq::JToken* existing);

  /// @brief Method WriteTo, addr 0x1340c80, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x133e8c4, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method <WriteToAsync>g__AwaitProperties|0_0, addr 0x133ea64, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133c67c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x133eff8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Object*, ::Array<::System::Object*>*> content);

  /// @brief Method .ctor, addr 0x133effc, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* content);

  /// @brief Method .ctor, addr 0x133ef88, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JObject* other);

  /// @brief Method add_PropertyChanged, addr 0x133ec88, size 0x9c, virtual true, abstract: false, final true
  inline void add_PropertyChanged(::System::ComponentModel::PropertyChangedEventHandler* value);

  /// @brief Method add_PropertyChanging, addr 0x133edc0, size 0x9c, virtual true, abstract: false, final true
  inline void add_PropertyChanging(::System::ComponentModel::PropertyChangingEventHandler* value);

  /// @brief Method get_ChildrenTokens, addr 0x133ec80, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_ChildrenTokens();

  /// @brief Method get_Item, addr 0x13401d0, size 0x118, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(::System::Object* key);

  /// @brief Method get_Item, addr 0x13402e8, size 0x80, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(::StringW propertyName);

  /// @brief Method get_Type, addr 0x134003c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method remove_PropertyChanged, addr 0x133ed24, size 0x9c, virtual true, abstract: false, final true
  inline void remove_PropertyChanged(::System::ComponentModel::PropertyChangedEventHandler* value);

  /// @brief Method remove_PropertyChanging, addr 0x133ee5c, size 0x9c, virtual true, abstract: false, final true
  inline void remove_PropertyChanging(::System::ComponentModel::PropertyChangingEventHandler* value);

  /// @brief Method set_Item, addr 0x1340368, size 0x120, virtual true, abstract: false, final false
  inline void set_Item(::System::Object* key, ::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method set_Item, addr 0x1340488, size 0x78, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetDynamicMemberNames, addr 0x13421c0, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetMember, addr 0x13420b8, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method TrySetMember, addr 0x13420ec, size 0xd4, virtual true, abstract: false, final false
  inline bool TrySetMember(::Newtonsoft::Json::Linq::JObject* instance, ::System::Dynamic::SetMemberBinder* binder, ::System::Object* value);

  /// @brief Method .ctor, addr 0x1342070, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1342354, size 0x578, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x13428cc, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  static __declspec(property(get = getStaticF___9__30_0, put = setStaticF___9__30_0))::System::Func_2<::Newtonsoft::Json::Linq::JProperty*, ::Newtonsoft::Json::Linq::JToken*>* __9__30_0;

  static inline ::Newtonsoft::Json::Linq::__JObject____c* New_ctor();

  /// @brief Method <PropertyValues>b__30_0, addr 0x1342990, size 0x20, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* _PropertyValues_b__30_0(::Newtonsoft::Json::Linq::JProperty* p);

  /// @brief Method .ctor, addr 0x1342988, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Newtonsoft::Json::Linq::__JObject____c* getStaticF___9();

  static inline ::System::Func_2<::Newtonsoft::Json::Linq::JProperty*, ::Newtonsoft::Json::Linq::JToken*>* getStaticF___9__30_0();

  static inline void setStaticF___9(::Newtonsoft::Json::Linq::__JObject____c* value);

  static inline void setStaticF___9__30_0(::System::Func_2<::Newtonsoft::Json::Linq::JProperty*, ::Newtonsoft::Json::Linq::JToken*>* value);
...
// Type: ::<GetEnumerator>d__63
// SizeInfo { instance_size: 56, native_size: -1, calculated_instance_size: 56, calculated_native_size: 56, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Newtonsoft::Json::Linq {
// Is value type: false
// CS Name: ::JObject::<GetEnumerator>d__63*
class CORDL_TYPE __JObject___GetEnumerator_d__63 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x13429cc, size 0x2e4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.get_Current, addr 0x1342d60, size 0xc, virtual true,
  /// abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1342d6c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1342dac, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x13429b0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x1342cb0, size 0xb0, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x1341850, size 0x28, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __JObject___GetEnumerator_d__63();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__JObject___GetEnumerator_d__63", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __JObject___GetEnumerator_d__63(__JObject___GetEnumerator_d__63&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__JObject___GetEnumerator_d__63", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __JObject___GetEnumerator_d__63(__JObject___GetEnumerator_d__63 const&) = delete;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63, 0x38>, "Size mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63, _____4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63, _____7__wrap1) == 0x30, "Offset mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1342e08, size 0x370, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1343178, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
NEED_NO_BOX(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Linq::__JObject___GetEnumerator_d__63*, "Newtonsoft.Json.Linq", "JObject/<GetEnumerator>d__63");
