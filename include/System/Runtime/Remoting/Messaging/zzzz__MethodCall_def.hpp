...
public:
  ...
  /// @brief Method CastTo, addr 0x1863be0, size 0x190, virtual false, abstract: false, final false
  inline ::System::Type* CastTo(::StringW clientType, ::System::Type* serverType);

  /// @brief Method CopyFrom, addr 0x184f288, size 0x35c, virtual false, abstract: false, final false
  inline void CopyFrom(::System::Runtime::Remoting::Messaging::IMethodMessage* call);

  /// @brief Method GetArg, addr 0x1863bac, size 0x30, virtual true, abstract: false, final true
  inline ::System::Object* GetArg(int32_t argNum);

  /// @brief Method GetObjectData, addr 0x186148c, size 0x490, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetTypeNameFromAssemblyQualifiedName, addr 0x1863dac, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW GetTypeNameFromAssemblyQualifiedName(::StringW aqname);

  /// @brief Method Init, addr 0x1863bdc, size 0x4, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method InitDictionary, addr 0x1863a44, size 0x84, virtual true, abstract: false, final false
  inline void InitDictionary();

  /// @brief Method InitMethodProperty, addr 0x1860ed8, size 0x41c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveMethod, addr 0x18632d0, size 0x614, virtual false, abstract: false, final false
  inline void ResolveMethod();

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity, addr 0x1863e54, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Identity* System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity();

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri, addr 0x1863b9c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Runtime_Remoting_Messaging_IInternalMessage_get_Uri();

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity, addr 0x1863e5c, size 0x8, virtual true, abstract: false, final true
  inline void System_Runtime_Remoting_Messaging_IInternalMessage_set_TargetIdentity(::System::Runtime::Remoting::Identity* value);

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri, addr 0x1863ba4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x18608d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x18608dc, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x18630fc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::CADMethodCallMessage* msg);

  /// @brief Method get_ArgCount, addr 0x1863210, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_ArgCount();

  /// @brief Method get_Args, addr 0x186322c, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> get_Args();

  /// @brief Method get_GenericArguments, addr 0x1863d70, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> get_GenericArguments();

  /// @brief Method get_LogicalCallContext, addr 0x1863234, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext();

  /// @brief Method get_MethodBase, addr 0x18632a0, size 0x30, virtual true, abstract: false, final true
  inline ::System::Reflection::MethodBase* get_MethodBase();

  /// @brief Method get_MethodName, addr 0x18638e4, size 0x34, virtual true, abstract: false, final true
  inline ::StringW get_MethodName();

  /// @brief Method get_MethodSignature, addr 0x1863918, size 0x12c, virtual true, abstract: false, final true
  inline ::System::Object* get_MethodSignature();

  /// @brief Method get_Properties, addr 0x186194c, size 0x30, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* get_Properties();

  /// @brief Method get_TypeName, addr 0x1863b44, size 0x48, virtual true, abstract: false, final true
  inline ::StringW get_TypeName();

  /// @brief Method get_Uri, addr 0x1863b8c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Uri, addr 0x1863b94, size 0x8, virtual false, abstract: false, final false
