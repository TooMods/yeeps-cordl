...
public:
  ...
  /// @brief Method DetermineMoveDirection, addr 0x2cd26d4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPooled, addr 0x2cd2740, size 0xe0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::NavigationMoveEvent* GetPooled(::UnityEngine::Vector2 moveVector);

  /// @brief Method Init, addr 0x2cd2820, size 0x88, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x2cd28a8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_direction, addr 0x2cd2728, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__NavigationMoveEvent__Direction get_direction();

  /// @brief Method set_direction, addr 0x2cd2730, size 0x8, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UIElements::__NavigationMoveEvent__Direction value);

  /// @brief Method set_move, addr 0x2cd2738, size 0x8, virtual false, abstract: false, final false
