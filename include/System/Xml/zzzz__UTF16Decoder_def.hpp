...
public:
  ...
  /// @brief Method Convert, addr 0x124e838, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x124e504, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x124e514, size 0xec, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x124e600, size 0x238, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x124e4d4, size 0x30, virtual false, abstract: false, final false
