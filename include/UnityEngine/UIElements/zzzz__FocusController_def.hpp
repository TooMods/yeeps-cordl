...
public:
  ...
  /// @brief Method AboutToGrabFocus, addr 0x27cb890, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method AboutToReleaseFocus, addr 0x27cb508, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Blur, addr 0x27ca164, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method BlurLastFocusedElement, addr 0x27cb204, size 0x88, virtual false, abstract: false, final false
  inline void BlurLastFocusedElement();

  /// @brief Method DoFocusChange, addr 0x27cb28c, size 0x190, virtual false, abstract: false, final false
  inline void DoFocusChange(::UnityEngine::UIElements::Focusable* f);

  /// @brief Method FocusNextInDirection, addr 0x27cb41c, size 0xec, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Focusable* FocusNextInDirection(::UnityEngine::UIElements::FocusChangeDirection* direction);

  /// @brief Method GetFocusableParentForPointerEvent, addr 0x27cbce4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLeafFocusedElement, addr 0x27cb028, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Focusable* GetLeafFocusedElement();

  /// @brief Method GetRetargetedFocusedElement, addr 0x27cac74, size 0x204, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Focusable* GetRetargetedFocusedElement(::UnityEngine::UIElements::VisualElement* retargetAgainst);

  /// @brief Method GrabFocus, addr 0x27cba54, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFocused, addr 0x27caeb4, size 0x174, virtual false, abstract: false, final false
  inline bool IsFocused(::UnityEngine::UIElements::Focusable* f);

  /// @brief Method IsLocalElement, addr 0x27cae78, size 0x3c, virtual false, abstract: false, final false
  inline bool IsLocalElement(::UnityEngine::UIElements::Focusable* f);

  /// @brief Method IsPendingFocus, addr 0x27cb0cc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReevaluateFocus, addr 0x27cbc24, size 0xc0, virtual false, abstract: false, final false
  inline void ReevaluateFocus();

  /// @brief Method ReleaseFocus, addr 0x27cb6cc, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFocusToLastFocusedElement, addr 0x27cb17c, size 0x88, virtual false, abstract: false, final false
  inline void SetFocusToLastFocusedElement();

  /// @brief Method SwitchFocus, addr 0x27ca074, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchFocus, addr 0x27ca82c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchFocusOnEvent, addr 0x27ca3cc, size 0x2ec, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Focusable* SwitchFocusOnEvent(::UnityEngine::UIElements::EventBase* e);

  /// @brief Method SyncIMGUIFocus, addr 0x27cbdf8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27cab90, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::IFocusRing* focusRing);

  /// @brief Method get_focusRing, addr 0x27cac28, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IFocusRing* get_focusRing();

  /// @brief Method get_focusedElement, addr 0x27cac30, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Focusable* get_focusedElement();

  /// @brief Method get_imguiKeyboardControl, addr 0x27cbde8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_imguiKeyboardControl();

  /// @brief Method set_imguiKeyboardControl, addr 0x27cbdf0, size 0x8, virtual false, abstract: false, final false
