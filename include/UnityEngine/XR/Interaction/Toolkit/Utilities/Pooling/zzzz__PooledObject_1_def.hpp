...
// Type: UnityEngine.XR.Interaction.Toolkit.Utilities.Pooling::PooledObject`1
...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_ToReturn", ty: "T", modifiers: "", def_value: None }, CppParam { name: "m_Pool", ty:
  // "::UnityEngine::XR::Interaction::Toolkit::Utilities::Pooling::LinkedPool_1<T>*", modifiers: "", def_value: None }]
