...
public:
  ...
  /// @brief Method .ctor, addr 0x2a8b378, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(bool autoUpdateAPI, ::StringW sourceNamespace, ::StringW sourceAssembly, ::StringW sourceClassName);

  /// @brief Method .ctor, addr 0x2a8b3e4, size 0x44, virtual false, abstract: false, final false
