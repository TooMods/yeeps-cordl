...
public:
  ...
  /// @brief Method Equals, addr 0x260f5f4, size 0x8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetFieldFromHandle, addr 0x260f79c, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Reflection::FieldInfo* GetFieldFromHandle(::System::RuntimeFieldHandle handle);

  /// @brief Method GetFieldFromHandle, addr 0x260f854, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldOffset, addr 0x260f93c, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetFieldOffset();

  /// @brief Method GetHashCode, addr 0x260f5fc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetPseudoCustomAttributes, addr 0x260f990, size 0x214, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetPseudoCustomAttributes();

  /// @brief Method GetPseudoCustomAttributesData, addr 0x260fba4, size 0x58c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRawConstantValue, addr 0x260f748, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x260f66c, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method SetValueDirect, addr 0x260f6f8, size 0x50, virtual true, abstract: false, final false
  inline void SetValueDirect(::System::TypedReference obj, ::System::Object* value);

  /// @brief Method .ctor, addr 0x260f514, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsInitOnly, addr 0x260f524, size 0x20, virtual true, abstract: false, final true
  inline bool get_IsInitOnly();

  /// @brief Method get_IsLiteral, addr 0x260f544, size 0x20, virtual true, abstract: false, final true
  inline bool get_IsLiteral();

  /// @brief Method get_IsNotSerialized, addr 0x260f564, size 0x20, virtual true, abstract: false, final true
  inline bool get_IsNotSerialized();

  /// @brief Method get_IsPrivate, addr 0x260f5a4, size 0x28, virtual true, abstract: false, final true
  inline bool get_IsPrivate();

  /// @brief Method get_IsPublic, addr 0x260f5cc, size 0x28, virtual true, abstract: false, final true
  inline bool get_IsPublic();

  /// @brief Method get_IsStatic, addr 0x260f584, size 0x20, virtual true, abstract: false, final true
  inline bool get_IsStatic();

  /// @brief Method get_MemberType, addr 0x260f51c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MemberTypes get_MemberType();

  /// @brief Method get_marshal_info, addr 0x260f98c, size 0x4, virtual false, abstract: false, final false
  inline ::System::Runtime::InteropServices::MarshalAsAttribute* get_marshal_info();

  /// @brief Method internal_from_handle_type, addr 0x260f798, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Reflection::FieldInfo* internal_from_handle_type(void* field_handle, void* type_handle);

  /// @brief Method op_Equality, addr 0x260f604, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::FieldInfo* left, ::System::Reflection::FieldInfo* right);

  /// @brief Method op_Inequality, addr 0x260f630, size 0x3c, virtual false, abstract: false, final false
