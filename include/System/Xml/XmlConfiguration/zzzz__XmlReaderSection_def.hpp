...
public:
  // Declarations
  /// @brief Method CreateDefaultResolver, addr 0x3048e64, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlResolver* CreateDefaultResolver();

  /// @brief Method get_CollapseWhiteSpaceIntoEmptyString, addr 0x3048ec0, size 0x8, virtual false, abstract: false, final false
  static inline bool get_CollapseWhiteSpaceIntoEmptyString();

  /// @brief Method get_ProhibitDefaultUrlResolver, addr 0x3048e5c, size 0x8, virtual false, abstract: false, final false
