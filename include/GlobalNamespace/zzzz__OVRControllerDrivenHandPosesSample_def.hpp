...
public:
  ...
  /// @brief Method Awake, addr 0x25bbce4, size 0xdc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LateUpdate, addr 0x25bc30c, size 0x4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OVRControllerDrivenHandPosesSample* New_ctor();

  /// @brief Method OnDestroy, addr 0x25bc038, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x25bc040, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x25bc03c, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetControllerDrivenHandPosesTypeToControllerConforming, addr 0x25bbe90, size 0xd4, virtual false, abstract: false, final false
  inline void SetControllerDrivenHandPosesTypeToControllerConforming();

  /// @brief Method SetControllerDrivenHandPosesTypeToNatural, addr 0x25bbf64, size 0xd4, virtual false, abstract: false, final false
  inline void SetControllerDrivenHandPosesTypeToNatural();

  /// @brief Method SetControllerDrivenHandPosesTypeToNone, addr 0x25bbdc0, size 0xd0, virtual false, abstract: false, final false
  inline void SetControllerDrivenHandPosesTypeToNone();

  /// @brief Method Update, addr 0x25bc044, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateLineRenderer, addr 0x25bc048, size 0x50, virtual false, abstract: false, final false
  inline void UpdateLineRenderer();

  /// @brief Method UpdateLineRendererForHand, addr 0x25bc098, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25bc310, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
