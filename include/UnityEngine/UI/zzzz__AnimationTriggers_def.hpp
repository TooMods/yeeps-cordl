...
public:
  ...
  /// @brief Method .ctor, addr 0x1ff6b3c, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledTrigger, addr 0x1ff6b2c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_disabledTrigger();

  /// @brief Method get_highlightedTrigger, addr 0x1ff6afc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_highlightedTrigger();

  /// @brief Method get_normalTrigger, addr 0x1ff6aec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_normalTrigger();

  /// @brief Method get_pressedTrigger, addr 0x1ff6b0c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_pressedTrigger();

  /// @brief Method get_selectedTrigger, addr 0x1ff6b1c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_selectedTrigger();

  /// @brief Method set_disabledTrigger, addr 0x1ff6b34, size 0x8, virtual false, abstract: false, final false
  inline void set_disabledTrigger(::StringW value);

  /// @brief Method set_highlightedTrigger, addr 0x1ff6b04, size 0x8, virtual false, abstract: false, final false
  inline void set_highlightedTrigger(::StringW value);

  /// @brief Method set_normalTrigger, addr 0x1ff6af4, size 0x8, virtual false, abstract: false, final false
  inline void set_normalTrigger(::StringW value);

  /// @brief Method set_pressedTrigger, addr 0x1ff6b14, size 0x8, virtual false, abstract: false, final false
  inline void set_pressedTrigger(::StringW value);

  /// @brief Method set_selectedTrigger, addr 0x1ff6b24, size 0x8, virtual false, abstract: false, final false
