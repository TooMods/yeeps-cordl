...
public:
  ...
  /// @brief Method ClearSubsystems, addr 0x27c835c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIntegratedSubsystemByPtr, addr 0x27c7e90, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeIntegratedSubsystem, addr 0x27c8254, size 0x108, virtual false, abstract: false, final false
  static inline void InitializeIntegratedSubsystem(void* ptr, ::UnityEngine::IntegratedSubsystem* subsystem);

  /// @brief Method ReloadSubsystemsCompleted, addr 0x27c8174, size 0xe0, virtual false, abstract: false, final false
  static inline void ReloadSubsystemsCompleted();

  /// @brief Method ReloadSubsystemsStarted, addr 0x27c8094, size 0xe0, virtual false, abstract: false, final false
  static inline void ReloadSubsystemsStarted();

  /// @brief Method RemoveDeprecatedSubsystem, addr 0x27c7ca8, size 0x80, virtual false, abstract: false, final false
  static inline bool RemoveDeprecatedSubsystem(::UnityEngine::Subsystem* subsystem);

  /// @brief Method RemoveIntegratedSubsystemByPtr, addr 0x27c79fc, size 0x184, virtual false, abstract: false, final false
  static inline void RemoveIntegratedSubsystemByPtr(void* ptr);

  /// @brief Method RemoveStandaloneSubsystem, addr 0x27c8014, size 0x80, virtual false, abstract: false, final false
  static inline bool RemoveStandaloneSubsystem(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider* subsystem);

  /// @brief Method StaticConstructScriptingClassMap, addr 0x27c7e68, size 0x28, virtual false, abstract: false, final false
