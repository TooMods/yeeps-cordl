...
public:
  // Declarations
  /// @brief Method GetProperties, addr 0x1b11d28, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x1b11d90, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ComponentConverter* New_ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x1b11cbc, size 0x6c, virtual false, abstract: false, final false
