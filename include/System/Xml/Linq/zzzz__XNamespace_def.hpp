...
public:
  ...
  /// @brief Method EnsureNamespace, addr 0x1335110, size 0xec, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* EnsureNamespace(ByRef<::System::WeakReference*> refNmsp, ::StringW namespaceName);

  /// @brief Method Equals, addr 0x13352c8, size 0xc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method ExtractLocalName, addr 0x13352e8, size 0x18, virtual false, abstract: false, final false
  static inline ::StringW ExtractLocalName(::System::Xml::Linq::XName* n);

  /// @brief Method ExtractNamespace, addr 0x1335300, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW ExtractNamespace(::System::WeakReference* r);

  /// @brief Method Get, addr 0x1333b88, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* Get(::StringW namespaceName);

  /// @brief Method Get, addr 0x1334aec, size 0x2e8, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* Get(::StringW namespaceName, int32_t index, int32_t count);

  /// @brief Method GetHashCode, addr 0x13352d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetName, addr 0x13318f0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XName* GetName(::StringW localName);

  /// @brief Method GetName, addr 0x1334dd4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1335108, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1335010, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NamespaceName, addr 0x1335100, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceName();

  /// @brief Method get_None, addr 0x1334ee0, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* get_None();

  /// @brief Method get_Xml, addr 0x13351fc, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* get_Xml();

  /// @brief Method get_Xmlns, addr 0x133525c, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* get_Xmlns();

  /// @brief Method op_Equality, addr 0x1332d64, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::Linq::XNamespace* left, ::System::Xml::Linq::XNamespace* right);

  /// @brief Method op_Implicit, addr 0x13352bc, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* op_Implicit___System__Xml__Linq__XNamespace_(::StringW namespaceName);

  /// @brief Method op_Inequality, addr 0x13352dc, size 0xc, virtual false, abstract: false, final false
