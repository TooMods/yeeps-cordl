...
public:
  ...
  /// @brief Method Run, addr 0x1844570, size 0x200, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method SetTryHandler, addr 0x1844568, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x18444f0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t targetIndex);

  /// @brief Method get_Handler, addr 0x1844560, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::TryFaultHandler* get_Handler();

  /// @brief Method get_InstructionName, addr 0x1844518, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedContinuations, addr 0x1844558, size 0x8, virtual true, abstract: false, final false
