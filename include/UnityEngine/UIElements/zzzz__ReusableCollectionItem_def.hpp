...
public:
  ...
  /// @brief Method DetachElement, addr 0x1290830, size 0xf8, virtual true, abstract: false, final false
  inline void DetachElement();

  /// @brief Method Init, addr 0x12903e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnGeometryChanged, addr 0x1290c7c, size 0x20, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method PreAttachElement, addr 0x12906e8, size 0xbc, virtual true, abstract: false, final false
  inline void PreAttachElement();

  /// @brief Method SetSelected, addr 0x1290b8c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129092c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onGeometryChanged, addr 0x1290a2c, size 0xb0, virtual false, abstract: false, final false
  inline void add_onGeometryChanged(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>* value);

  /// @brief Method get_animator, addr 0x12909fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>* get_animator();

  /// @brief Method get_bindableElement, addr 0x12909ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_bindableElement();

  /// @brief Method get_id, addr 0x1290a1c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_index, addr 0x1290a0c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_rootElement, addr 0x12909e4, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_rootElement();

  /// @brief Method remove_onGeometryChanged, addr 0x1290adc, size 0xb0, virtual false, abstract: false, final false
  inline void remove_onGeometryChanged(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>* value);

  /// @brief Method set_animator, addr 0x1290a04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bindableElement, addr 0x12909f4, size 0x8, virtual false, abstract: false, final false
  inline void set_bindableElement(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_id, addr 0x1290a24, size 0x8, virtual false, abstract: false, final false
  inline void set_id(int32_t value);

  /// @brief Method set_index, addr 0x1290a14, size 0x8, virtual false, abstract: false, final false
