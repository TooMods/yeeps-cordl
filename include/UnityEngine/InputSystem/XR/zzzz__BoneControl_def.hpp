...
public:
  ...
  /// @brief Method FinishSetup, addr 0x1d3b528, size 0x114, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::XR::BoneControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x1d3b63c, size 0xf0, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::Bone ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x1d3b72c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d3b7b0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_parentBoneIndex, addr 0x1d3b4f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_parentBoneIndex();

  /// @brief Method get_position, addr 0x1d3b508, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_position();

  /// @brief Method get_rotation, addr 0x1d3b518, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_rotation();

  /// @brief Method set_parentBoneIndex, addr 0x1d3b500, size 0x8, virtual false, abstract: false, final false
  inline void set_parentBoneIndex(::UnityEngine::InputSystem::Controls::IntegerControl* value);

  /// @brief Method set_position, addr 0x1d3b510, size 0x8, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_rotation, addr 0x1d3b520, size 0x8, virtual false, abstract: false, final false
