...
public:
  ...
  /// @brief Method get_collider, addr 0x28f7a7c, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_distance, addr 0x28f7b40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_normal, addr 0x28f7b34, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_point, addr 0x28f7b28, size 0xc, virtual false, abstract: false, final false
