...
public:
  // Declarations
  /// @brief Method Init, addr 0x2ccf924, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2ccf974, size 0x104, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerCancelEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x2ccfac8, size 0x330, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method .ctor, addr 0x2ccfa78, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
