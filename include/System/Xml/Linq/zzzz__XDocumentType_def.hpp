...
public:
  ...
  /// @brief Method CloneNode, addr 0x1332a3c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x13329c8, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1331a88, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW publicId, ::StringW systemId, ::StringW internalSubset);

  /// @brief Method .ctor, addr 0x133291c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDocumentType* other);

  /// @brief Method get_InternalSubset, addr 0x13329a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InternalSubset();

  /// @brief Method get_Name, addr 0x13329a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x13329b0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_PublicId, addr 0x13329b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PublicId();

  /// @brief Method get_SystemId, addr 0x13329c0, size 0x8, virtual false, abstract: false, final false
