...
public:
  ...
  /// @brief Method Copy, addr 0x128d1d0, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::TransformData Copy();

  /// @brief Method CopyFrom, addr 0x128d1ec, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::TransformData> other);

  /// @brief Method Equals, addr 0x128d36c, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x128d328, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TransformData other);

  /// @brief Method GetHashCode, addr 0x128d40c, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x128d200, size 0x128, virtual false, abstract: false, final false
