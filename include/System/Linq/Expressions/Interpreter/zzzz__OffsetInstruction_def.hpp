...
public:
  ...
  /// @brief Method Fixup, addr 0x1842fec, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDebugString, addr 0x1843080, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x1843148, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1843214, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
