...
public:
  ...
  /// @brief Method Accept, addr 0x182c614, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetExpression, addr 0x182c684, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x182c6d4, size 0x28, virtual true, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::Expression*>* GetOrMakeExpressions();

  /// @brief Method GetOrMakeVariables, addr 0x182c6fc, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method ReturnReadOnlyExpressions, addr 0x182c77c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x182c754, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x182c5bc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ExpressionCount, addr 0x182c6ac, size 0x28, virtual true, abstract: false, final false
  inline int32_t get_ExpressionCount();

  /// @brief Method get_Expressions, addr 0x182c5a0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::Expression*>* get_Expressions();

  /// @brief Method get_NodeType, addr 0x182c63c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x182c644, size 0x40, virtual true, abstract: false, final false
  inline ::System::Type* get_Type();

  /// @brief Method get_Variables, addr 0x182c5ac, size 0x10, virtual false, abstract: false, final false
