...
public:
  ...
  /// @brief Method .ctor, addr 0xf5968c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, bool copyBuffer);

  /// @brief Method .ctor, addr 0xf595e0, size 0xac, virtual false, abstract: false, final false
