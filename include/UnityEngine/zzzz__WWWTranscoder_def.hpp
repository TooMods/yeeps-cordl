...
public:
  ...
  /// @brief Method Byte2Hex, addr 0x30a6d24, size 0x54, virtual false, abstract: false, final false
  static inline void Byte2Hex(uint8_t b, ::ArrayW<uint8_t, ::Array<uint8_t>*> hexChars, ByRef<uint8_t> byte0, ByRef<uint8_t> byte1);

  /// @brief Method ByteArrayContains, addr 0x30a7190, size 0x4c, virtual false, abstract: false, final false
  static inline bool ByteArrayContains(::ArrayW<uint8_t, ::Array<uint8_t>*> array, uint8_t b);

  /// @brief Method ByteSubArrayEquals, addr 0x30a74bc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Decode, addr 0x30a71dc, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x30a6de4, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Hex2Byte, addr 0x30a6c78, size 0xac, virtual false, abstract: false, final false
  static inline uint8_t Hex2Byte(::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t offset);

  /// @brief Method URLDecode, addr 0x30a6944, size 0x64, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> URLDecode(::ArrayW<uint8_t, ::Array<uint8_t>*> toEncode);

  /// @brief Method URLEncode, addr 0x30a6d78, size 0x6c, virtual false, abstract: false, final false
