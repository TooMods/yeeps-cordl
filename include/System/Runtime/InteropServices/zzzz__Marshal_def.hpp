...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x1b4395c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b42bb0, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x1b43970, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::System::ValueTuple_2<::System::Type*, ::StringW> lhs, ::System::ValueTuple_2<::System::Type*, ::StringW> rhs);

  /// @brief Method GetHashCode, addr 0x1b439e4, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1b43a38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetCustomMarshalerInstance>b__201_0, addr 0x1b43aac, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1b43aa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllocCoTaskMem, addr 0x1b41af0, size 0x4, virtual false, abstract: false, final false
  static inline void* AllocCoTaskMem(int32_t cb);

  /// @brief Method AllocHGlobal, addr 0x1b41af8, size 0x68, virtual false, abstract: false, final false
  static inline void* AllocHGlobal(int32_t cb);

  /// @brief Method AllocHGlobal, addr 0x1b41af4, size 0x4, virtual false, abstract: false, final false
  static inline void* AllocHGlobal(void* cb);

  /// @brief Method BufferToBSTR, addr 0x1b427d4, size 0x4, virtual false, abstract: false, final false
  static inline void* BufferToBSTR(::cordl_internals::Ptr<char16_t> ptr, int32_t slen);

  /// @brief Method ClearAnsi, addr 0x1b42258, size 0x9c, virtual false, abstract: false, final false
  static inline void ClearAnsi(void* ptr);

  /// @brief Method ClearBSTR, addr 0x1b420e0, size 0xac, virtual false, abstract: false, final false
  static inline void ClearBSTR(void* ptr);

  /// @brief Method ClearUnicode, addr 0x1b42310, size 0x90, virtual false, abstract: false, final false
  static inline void ClearUnicode(void* ptr);

  /// @brief Method Copy, addr 0x1b41c80, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(::ArrayW<uint8_t, ::Array<uint8_t>*> source, int32_t startIndex, void* destination, int32_t length);

  /// @brief Method Copy, addr 0x1b41eec, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(void* source, ::ArrayW<char16_t, ::Array<char16_t>*> destination, int32_t startIndex, int32_t length);

  /// @brief Method Copy, addr 0x1b41fe0, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(void* source, ::ArrayW<float_t, ::Array<float_t>*> destination, int32_t startIndex, int32_t length);

  /// @brief Method Copy, addr 0x1b41df8, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(void* source, ::ArrayW<uint8_t, ::Array<uint8_t>*> destination, int32_t startIndex, int32_t length);

  /// @brief Method FreeBSTR, addr 0x1b420d4, size 0x4, virtual false, abstract: false, final false
  static inline void FreeBSTR(void* ptr);

  /// @brief Method FreeCoTaskMem, addr 0x1b420d8, size 0x4, virtual false, abstract: false, final false
  static inline void FreeCoTaskMem(void* ptr);

  /// @brief Method FreeHGlobal, addr 0x1b420dc, size 0x4, virtual false, abstract: false, final false
  static inline void FreeHGlobal(void* hglobal);

  /// @brief Method GetCustomMarshalerInstance, addr 0x1b42f90, size 0x814, virtual false, abstract: false, final false
  static inline ::System::Runtime::InteropServices::ICustomMarshaler* GetCustomMarshalerInstance(::System::Type* type, ::StringW cookie);

  /// @brief Method GetDelegateForFunctionPointer, addr 0x1b42c84, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDelegateForFunctionPointerInternal, addr 0x1b42c80, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Delegate* GetDelegateForFunctionPointerInternal(void* ptr, ::System::Type* t);

  /// @brief Method GetFunctionPointerForDelegate, addr 0x1b42eec, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFunctionPointerForDelegateInternal, addr 0x1b42ee8, size 0x4, virtual false, abstract: false, final false
  static inline void* GetFunctionPointerForDelegateInternal(::System::Delegate* d);

  /// @brief Method GetHRForException, addr 0x1b424ec, size 0xc, virtual false, abstract: false, final false
  static inline int32_t GetHRForException(::System::Exception* e);

  /// @brief Method GetLastWin32Error, addr 0x1b42500, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetLastWin32Error();

  /// @brief Method IsComObject, addr 0x1b424f8, size 0x8, virtual false, abstract: false, final false
  static inline bool IsComObject(::System::Object* o);

  /// @brief Method OffsetOf, addr 0x1b42504, size 0x4, virtual false, abstract: false, final false
  static inline void* OffsetOf(::System::Type* t, ::StringW fieldName);

  /// @brief Method PtrToStringAnsi, addr 0x1b42508, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringAnsi(void* ptr);

  /// @brief Method PtrToStringAnsi, addr 0x1b4250c, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringAnsi(void* ptr, int32_t len);

  /// @brief Method PtrToStringUni, addr 0x1b42510, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringUni(void* ptr);

  /// @brief Method PtrToStringUni, addr 0x1b42514, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringUni(void* ptr, int32_t len);

  /// @brief Method PtrToStructure, addr 0x1b4251c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method PtrToStructure, addr 0x1b42518, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x1b422f4, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t ReadByte(void* ptr, int32_t ofs);

  /// @brief Method ReadInt16, addr 0x1b423ec, size 0x48, virtual false, abstract: false, final false
  static inline int16_t ReadInt16(void* ptr, int32_t ofs);

  /// @brief Method ReadInt32, addr 0x1b42520, size 0x40, virtual false, abstract: false, final false
  static inline int32_t ReadInt32(void* ptr);

  /// @brief Method ReadInt32, addr 0x1b4218c, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t ReadInt32(void* ptr, int32_t ofs);

  /// @brief Method SecureStringGlobalAllocator, addr 0x1b427d8, size 0x54, virtual false, abstract: false, final false
  static inline void* SecureStringGlobalAllocator(int32_t len);

  /// @brief Method SecureStringToBSTR, addr 0x1b4264c, size 0x188, virtual false, abstract: false, final false
  static inline void* SecureStringToBSTR(::System::Security::SecureString* s);

  /// @brief Method SecureStringToGlobalAllocUnicode, addr 0x1b42ac0, size 0xf0, virtual false, abstract: false, final false
  static inline void* SecureStringToGlobalAllocUnicode(::System::Security::SecureString* s);

  /// @brief Method SecureStringToUnicode, addr 0x1b4282c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method SizeOf, addr 0x1b42560, size 0x70, virtual false, abstract: false, final false
  static inline int32_t SizeOf(::System::Object* structure);

  /// @brief Method SizeOf, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline int32_t SizeOf(T structure);

  /// @brief Method SizeOf, addr 0x1b425d0, size 0x4, virtual false, abstract: false, final false
  static inline int32_t SizeOf(::System::Type* t);

  /// @brief Method StringToHGlobalAnsi, addr 0x1b425d8, size 0x70, virtual false, abstract: false, final false
  static inline void* StringToHGlobalAnsi(::StringW s);

  /// @brief Method StringToHGlobalAnsi, addr 0x1b425d4, size 0x4, virtual false, abstract: false, final false
  static inline void* StringToHGlobalAnsi(::cordl_internals::Ptr<char16_t> s, int32_t length);

  /// @brief Method StructureToPtr, addr 0x1b42c74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UnsafeAddrOfPinnedArrayElement, addr 0x1b42c7c, size 0x4, virtual false, abstract: false, final false
  static inline void* UnsafeAddrOfPinnedArrayElement(::System::Array* arr, int32_t index);

  /// @brief Method WriteByte, addr 0x1b421d8, size 0x24, virtual false, abstract: false, final false
  static inline void WriteByte(void* ptr, int32_t ofs, uint8_t val);

  /// @brief Method WriteInt16, addr 0x1b423a0, size 0x4c, virtual false, abstract: false, final false
  static inline void WriteInt16(void* ptr, int32_t ofs, int16_t val);

  /// @brief Method ZeroFreeBSTR, addr 0x1b421fc, size 0x5c, virtual false, abstract: false, final false
  static inline void ZeroFreeBSTR(void* s);

  /// @brief Method ZeroFreeGlobalAllocAnsi, addr 0x1b42434, size 0x5c, virtual false, abstract: false, final false
  static inline void ZeroFreeGlobalAllocAnsi(void* s);

  /// @brief Method ZeroFreeGlobalAllocUnicode, addr 0x1b42490, size 0x5c, virtual false, abstract: false, final false
  static inline void ZeroFreeGlobalAllocUnicode(void* s);

  /// @brief Method copy_from_unmanaged, addr 0x1b41d74, size 0x80, virtual false, abstract: false, final false
  static inline void copy_from_unmanaged(void* source, int32_t startIndex, ::System::Array* destination, int32_t length);

  /// @brief Method copy_from_unmanaged_fixed, addr 0x1b41df4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method copy_to_unmanaged, addr 0x1b41b98, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method copy_to_unmanaged_fixed, addr 0x1b41b60, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method skip_fixed, addr 0x1b41b64, size 0x34, virtual false, abstract: false, final false
