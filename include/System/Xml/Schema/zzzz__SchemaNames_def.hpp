...
public:
  ...
  /// @brief Method CreateTokenToQNameTable, addr 0x1cb1460, size 0x196c, virtual false, abstract: false, final false
  inline void CreateTokenToQNameTable();

  /// @brief Method IsXDRRoot, addr 0x1cb2e7c, size 0x50, virtual false, abstract: false, final false
  inline bool IsXDRRoot(::StringW localName, ::StringW ns);

  /// @brief Method IsXSDRoot, addr 0x1cb2e2c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SchemaTypeFromRoot, addr 0x1cb2dcc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cae988, size 0x2ad8, virtual false, abstract: false, final false
