...
public:
  ...
  /// @brief Method AddString, addr 0x1ea2298, size 0x14c, virtual false, abstract: false, final false
  inline void AddString(::StringW str, ByRef<int32_t> position);

  /// @brief Method AddToken, addr 0x1ea2a18, size 0x5c, virtual false, abstract: false, final false
  inline void AddToken(uint8_t b, ByRef<int32_t> position);

  /// @brief Method AppendString, addr 0x1ea23e4, size 0x98, virtual false, abstract: false, final false
  inline void AppendString(::StringW str, ByRef<int32_t> position);

  /// @brief Method EncodedStringSize, addr 0x1ea247c, size 0x20, virtual false, abstract: false, final false
  static inline int32_t EncodedStringSize(::StringW str);

  /// @brief Method GetElement, addr 0x1ea2a90, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Security::SecurityElement* GetElement(int32_t position, bool bCreate);

  /// @brief Method GetRootElement, addr 0x1ea2a74, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Security::SecurityElement* GetRootElement();

  /// @brief Method GetString, addr 0x1ea249c, size 0x310, virtual false, abstract: false, final false
  inline ::StringW GetString(ByRef<int32_t> position, bool bCreate);

  /// @brief Method GuaranteeSize, addr 0x1ea21f4, size 0xa4, virtual false, abstract: false, final false
  inline void GuaranteeSize(int32_t size);

  /// @brief Method InternalGetElement, addr 0x1ea2aac, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ea218c, size 0x68, virtual false, abstract: false, final false
