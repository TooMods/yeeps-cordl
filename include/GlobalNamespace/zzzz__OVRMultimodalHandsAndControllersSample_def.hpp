...
public:
  ...
  /// @brief Method Awake, addr 0xfc0788, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DisableMultiModality, addr 0xfc0900, size 0x80, virtual false, abstract: false, final false
  inline void DisableMultiModality();

  /// @brief Method EnableMultiModality, addr 0xfc0880, size 0x80, virtual false, abstract: false, final false
  inline void EnableMultiModality();

  static inline ::GlobalNamespace::OVRMultimodalHandsAndControllersSample* New_ctor();

  /// @brief Method OnDestroy, addr 0xfc078c, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0xfc0794, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0xfc0790, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0xfc0798, size 0xe8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0xfc0980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
