...
public:
  ...
  /// @brief Method Init, addr 0x1b3ca88, size 0x58, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x1b3a3f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
