...
public:
  ...
  /// @brief Method MoveNext, addr 0x1344158, size 0x60, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__JProperty__JPropertyList___GetEnumerator_d__1* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x13441b8, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x13441c0, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1344200, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1344154, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1343fac, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x1343fd8, size 0x8, virtual true, abstract: false, final true
  inline void Add(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Clear, addr 0x1343fe0, size 0x8, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x1343fe8, size 0x10, virtual true, abstract: false, final true
  inline bool Contains(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method CopyTo, addr 0x1343ff8, size 0x64, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::Newtonsoft::Json::Linq::JToken*, ::Array<::Newtonsoft::Json::Linq::JToken*>*> array, int32_t arrayIndex);

  /// @brief Method GetEnumerator, addr 0x1343f44, size 0x68, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x134388c, size 0x10, virtual true, abstract: false, final true
  inline int32_t IndexOf(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Insert, addr 0x1344094, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x134405c, size 0x20, virtual true, abstract: false, final true
  inline bool Remove(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method RemoveAt, addr 0x13440a4, size 0x10, virtual true, abstract: false, final true
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1343fd4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1343544, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x134407c, size 0x10, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x134408c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x13440b4, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x1344104, size 0x50, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1344208, size 0x224, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x134442c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ClearItems, addr 0x1343a94, size 0xb4, virtual true, abstract: false, final false
  inline void ClearItems();

  /// @brief Method CloneToken, addr 0x1343bf4, size 0x60, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken();

  /// @brief Method ContainsItem, addr 0x13439b8, size 0x24, virtual true, abstract: false, final false
  inline bool ContainsItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method DeepEquals, addr 0x1343b48, size 0xac, virtual true, abstract: false, final false
  inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken* node);

  /// @brief Method GetDeepHashCode, addr 0x1343ce0, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetDeepHashCode();

  /// @brief Method GetItem, addr 0x134354c, size 0x5c, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* GetItem(int32_t index);

  /// @brief Method IndexOfItem, addr 0x134385c, size 0x30, virtual true, abstract: false, final false
  inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method InsertItem, addr 0x134389c, size 0x11c, virtual true, abstract: false, final false
  inline bool InsertItem(int32_t index, ::Newtonsoft::Json::Linq::JToken* item, bool skipParentCheck);

  /// @brief Method Load, addr 0x1343d30, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JProperty* Load(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method Load, addr 0x1343d38, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x134339c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x13433a8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeItem, addr 0x13439dc, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveItem, addr 0x13436f4, size 0xb4, virtual true, abstract: false, final false
  inline bool RemoveItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method RemoveItemAt, addr 0x13437a8, size 0xb4, virtual true, abstract: false, final false
  inline void RemoveItemAt(int32_t index);

  /// @brief Method SetItem, addr 0x13435a8, size 0x14c, virtual true, abstract: false, final false
  inline void SetItem(int32_t index, ::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method WriteTo, addr 0x1343c60, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x13432a4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x1343184, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteValueAsync, addr 0x1343258, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133ca60, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x1343c5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> content);

  /// @brief Method .ctor, addr 0x1340dcc, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Object* content);

  /// @brief Method .ctor, addr 0x13434c0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JProperty* other);

  /// @brief Method get_ChildrenTokens, addr 0x13434b0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_ChildrenTokens();

  /// @brief Method get_Name, addr 0x13434b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Type, addr 0x1343c54, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JTokenType get_Type();

  /// @brief Method get_Value, addr 0x133c660, size 0x1c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Value();

  /// @brief Method set_Value, addr 0x133fde4, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1344438, size 0x5ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x13449e4, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
