...
public:
  ...
  /// @brief Method <PipelineCallback>b__0, addr 0x123cc90, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1239cc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AbortConnect, addr 0x1238758, size 0x8c, virtual false, abstract: false, final false
  inline void AbortConnect();

  /// @brief Method AcceptCallback, addr 0x12387e4, size 0x370, virtual false, abstract: false, final false
  static inline void AcceptCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method BuildCommandsList, addr 0x123acd8, size 0xde4, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckValid, addr 0x123c7b0, size 0x3b4, virtual true, abstract: false, final false
  inline bool CheckValid(::System::Net::ResponseDescription* response, ByRef<int32_t> validThrough, ByRef<int32_t> completeLength);

  /// @brief Method ClearState, addr 0x12393ec, size 0x90, virtual true, abstract: false, final false
  inline void ClearState();

  /// @brief Method ConnectCallback, addr 0x1238b54, size 0x1b4, virtual false, abstract: false, final false
  static inline void ConnectCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method CreateFtpDataSocket, addr 0x123c49c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFtpListenerSocket, addr 0x123bd70, size 0x17c, virtual false, abstract: false, final false
  inline void CreateFtpListenerSocket(::System::Net::FtpWebRequest* request);

  /// @brief Method FormatAddress, addr 0x123c51c, size 0x124, virtual false, abstract: false, final false
  inline ::StringW FormatAddress(::System::Net::IPAddress* address, int32_t Port);

  /// @brief Method FormatAddressV6, addr 0x123c640, size 0x110, virtual false, abstract: false, final false
  inline ::StringW FormatAddressV6(::System::Net::IPAddress* address, int32_t port);

  /// @brief Method FormatFtpCommand, addr 0x123babc, size 0x100, virtual false, abstract: false, final false
  inline ::StringW FormatFtpCommand(::StringW command, ::StringW parameter);

  /// @brief Method GetContentLengthFrom213Response, addr 0x123a788, size 0x140, virtual false, abstract: false, final false
  inline int64_t GetContentLengthFrom213Response(::StringW responseString);

  /// @brief Method GetLastModifiedFrom213Response, addr 0x123a8c8, size 0x360, virtual false, abstract: false, final false
  inline ::System::DateTime GetLastModifiedFrom213Response(::StringW str);

  /// @brief Method GetLoginDirectory, addr 0x123ac28, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW GetLoginDirectory(::StringW str);

  /// @brief Method GetPathInfo, addr 0x123bbcc, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPortCommandLine, addr 0x123beec, size 0x1fc, virtual false, abstract: false, final false
  inline ::StringW GetPortCommandLine(::System::Net::FtpWebRequest* request);

  /// @brief Method GetPortV4, addr 0x123c0e8, size 0x1f4, virtual false, abstract: false, final false
  inline int32_t GetPortV4(::StringW responseString);

  /// @brief Method GetPortV6, addr 0x123c2dc, size 0x1c0, virtual false, abstract: false, final false
  inline int32_t GetPortV6(::StringW responseString);

  /// @brief Method IsFtpDataStreamWriteable, addr 0x1239170, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method PipelineCallback, addr 0x123947c, size 0x844, virtual true, abstract: false, final false
  ...
  /// @brief Method QueueOrCreateDataConection, addr 0x1239cc8, size 0x670, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueOrCreateFtpDataStream, addr 0x1238ed0, size 0x2a0, virtual false, abstract: false, final false
  inline ::System::Net::__CommandStream__PipelineInstruction QueueOrCreateFtpDataStream(ByRef<::System::IO::Stream*> stream);

  /// @brief Method SSLHandshakeCallback, addr 0x1238d08, size 0x1c8, virtual false, abstract: false, final false
  static inline void SSLHandshakeCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method TryUpdateContentLength, addr 0x123a338, size 0xec, virtual false, abstract: false, final false
  inline void TryUpdateContentLength(::StringW str);

  /// @brief Method TryUpdateResponseUri, addr 0x123a430, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12386cc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BannerMessage, addr 0x123c768, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_BannerMessage();

  /// @brief Method get_ContentLength, addr 0x123c750, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method get_Credentials, addr 0x12385a4, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Net::NetworkCredential* get_Credentials();

  /// @brief Method get_ExitMessage, addr 0x123c798, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_ExitMessage();

  /// @brief Method get_LastModified, addr 0x123c758, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_LastModified();

  /// @brief Method get_ResponseUri, addr 0x123c760, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_ResponseUri();

  /// @brief Method get_WelcomeMessage, addr 0x123c780, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Credentials, addr 0x123864c, size 0x80, virtual false, abstract: false, final false
