...
public:
  ...
  /// @brief Method <.cctor>b__4_0, addr 0x10e8ba4, size 0x84, virtual false, abstract: false, final false
  inline void __cctor_b__4_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x10e8b9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cancel, addr 0x10e7790, size 0x1c, virtual false, abstract: false, final false
  inline void Cancel();

  /// @brief Method Cancel, addr 0x10e77ac, size 0x28, virtual false, abstract: false, final false
  inline void Cancel(bool throwOnFirstException);

  /// @brief Method CancelAfter, addr 0x10e7884, size 0xa4, virtual false, abstract: false, final false
  inline void CancelAfter(::System::TimeSpan delay);

  /// @brief Method CancelAfter, addr 0x10e7928, size 0x1ec, virtual false, abstract: false, final false
  inline void CancelAfter(int32_t millisecondsDelay);

  /// @brief Method CancellationCallbackCoreWork, addr 0x10e82ec, size 0xbc, virtual false, abstract: false, final false
  inline void CancellationCallbackCoreWork(::System::Threading::CancellationCallbackCoreWorkArguments args);

  /// @brief Method CancellationCallbackCoreWork_OnSyncContext, addr 0x10e83a8, size 0x78, virtual false, abstract: false, final false
  inline void CancellationCallbackCoreWork_OnSyncContext(::System::Object* obj);

  /// @brief Method CreateLinkedTokenSource, addr 0x10e87d4, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Threading::CancellationTokenSource* CreateLinkedTokenSource(::System::Threading::CancellationToken token);

  /// @brief Method CreateLinkedTokenSource, addr 0x10e851c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x10e7c2c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x10e7c98, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExecuteCallbackHandlers, addr 0x10e7e0c, size 0x4d4, virtual false, abstract: false, final false
  inline void ExecuteCallbackHandlers(bool throwOnFirstException);

  /// @brief Method InitializeWithTimer, addr 0x10e76d4, size 0xbc, virtual false, abstract: false, final false
  inline void InitializeWithTimer(int32_t millisecondsDelay);

  /// @brief Method InternalRegister, addr 0x10e55ac, size 0x2c8, virtual false, abstract: false, final false
  ...
  static inline ::System::Threading::CancellationTokenSource* New_ctor(int32_t millisecondsDelay);

  /// @brief Method NotifyCancellation, addr 0x10e77d4, size 0xb0, virtual false, abstract: false, final false
  inline void NotifyCancellation(bool throwOnFirstException);

  /// @brief Method ThrowIfDisposed, addr 0x10e75a4, size 0x54, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method ThrowObjectDisposedException, addr 0x10e7d28, size 0x54, virtual false, abstract: false, final false
  static inline void ThrowObjectDisposedException();

  /// @brief Method TimerCallbackLogic, addr 0x10e7b14, size 0x118, virtual false, abstract: false, final false
  static inline void TimerCallbackLogic(::System::Object* obj);

  /// @brief Method WaitForCallbackToComplete, addr 0x10e7374, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e7610, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x10e7644, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(int32_t millisecondsDelay);
  ...
  /// @brief Method get_ExecutingCallback, addr 0x10e75f8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Threading::CancellationCallbackInfo* get_ExecutingCallback();

  /// @brief Method get_IsCancellationCompleted, addr 0x10e7340, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsCancellationCompleted();

  /// @brief Method get_IsCancellationRequested, addr 0x10e51f8, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsCancellationRequested();

  /// @brief Method get_IsDisposed, addr 0x10e7560, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDisposed();

  /// @brief Method get_ThreadIDExecutingCallbacks, addr 0x10e735c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ThreadIDExecutingCallbacks();

  /// @brief Method get_Token, addr 0x10e758c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ThreadIDExecutingCallbacks, addr 0x10e7568, size 0x24, virtual false, abstract: false, final false
