...
public:
  ...
  /// @brief Method PeekBit, addr 0x2836338, size 0xc, virtual false, abstract: false, final false
  inline bool PeekBit();

  /// @brief Method PopBit, addr 0x28362cc, size 0x28, virtual false, abstract: false, final false
  inline bool PopBit();

  /// @brief Method PopCurr, addr 0x28362f4, size 0x44, virtual false, abstract: false, final false
  inline void PopCurr();

  /// @brief Method PushBit, addr 0x28361cc, size 0x38, virtual false, abstract: false, final false
  inline void PushBit(bool bit);

  /// @brief Method PushCurr, addr 0x2836204, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28361ac, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
