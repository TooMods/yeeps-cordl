...
#include <cstdint>
CORDL_MODULE_EXPORT(ListLayerVersionsRequest)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::Lambda::Model::ListLayerVersionsRequest);
// Type: Amazon.Lambda.Model::ListLayerVersionsRequest
// SizeInfo { instance_size: 88, native_size: -1, calculated_instance_size: 88, calculated_native_size: 88, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::Amazon.Lambda.Model::ListLayerVersionsRequest*
class CORDL_TYPE ListLayerVersionsRequest : public ::Amazon::Lambda::AmazonLambdaRequest {
public:
  // Declarations
  ...
  /// @brief Method IsSetCompatibleRuntime, addr 0x2bce250, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetCompatibleRuntime();

  /// @brief Method IsSetLayerName, addr 0x2bce2c0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetLayerName();

  /// @brief Method IsSetMarker, addr 0x2bce2e0, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetMarker();

  /// @brief Method IsSetMaxItems, addr 0x2bce394, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaxItems();

  static inline ::Amazon::Lambda::Model::ListLayerVersionsRequest* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x2bce3d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CompatibleRuntime, addr 0x2bce240, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Runtime* get_CompatibleRuntime();

  /// @brief Method get_LayerName, addr 0x2bce2b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LayerName();

  /// @brief Method get_Marker, addr 0x2bce2d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Marker();

  /// @brief Method get_MaxItems, addr 0x2bce2f0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaxItems();

  /// @brief Method set_CompatibleRuntime, addr 0x2bce248, size 0x8, virtual false, abstract: false, final false
  inline void set_CompatibleRuntime(::Amazon::Lambda::Runtime* value);

  /// @brief Method set_LayerName, addr 0x2bce2b8, size 0x8, virtual false, abstract: false, final false
  inline void set_LayerName(::StringW value);

  /// @brief Method set_Marker, addr 0x2bce2d8, size 0x8, virtual false, abstract: false, final false
  inline void set_Marker(::StringW value);

  /// @brief Method set_MaxItems, addr 0x2bce32c, size 0x68, virtual false, abstract: false, final false
  inline void set_MaxItems(int32_t value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ListLayerVersionsRequest();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ListLayerVersionsRequest", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListLayerVersionsRequest(ListLayerVersionsRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListLayerVersionsRequest", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListLayerVersionsRequest(ListLayerVersionsRequest const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::ListLayerVersionsRequest, 0x58>, "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayerVersionsRequest, ____compatibleRuntime) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayerVersionsRequest, ____layerName) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayerVersionsRequest, ____marker) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::ListLayerVersionsRequest, ____maxItems) == 0x50, "Offset mismatch!");

} // namespace Amazon::Lambda::Model
NEED_NO_BOX(::Amazon::Lambda::Model::ListLayerVersionsRequest);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::ListLayerVersionsRequest*, "Amazon.Lambda.Model", "ListLayerVersionsRequest");
