...
public:
  ...
  /// @brief Method ApplyDelta, addr 0x2ce7fdc, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPointerDown, addr 0x2ce85dc, size 0xc8, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* e);

  /// @brief Method OnPointerMove, addr 0x2ce86a4, size 0xb8, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* e);

  /// @brief Method OnPointerUp, addr 0x2ce875c, size 0xac, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* e);

  /// @brief Method RegisterCallbacksOnTarget, addr 0x2ce7c44, size 0x1cc, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x2ce7e10, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ce7b6c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_fixedPane, addr 0x2ce790c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_fixedPane();

  /// @brief Method get_fixedPaneMinDimension, addr 0x2ce7944, size 0x114, virtual false, abstract: false, final false
  inline float_t get_fixedPaneMinDimension();

  /// @brief Method get_flexedPane, addr 0x2ce7928, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_flexedPane();

  /// @brief Method get_flexedPaneMinDimension, addr 0x2ce7a58, size 0x114, virtual false, abstract: false, final false
