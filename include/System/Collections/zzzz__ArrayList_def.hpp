...
public:
  ...
  /// @brief Method Clone, addr 0x21d390c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x21d3914, size 0x1d0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Collections::__ArrayList__ArrayListEnumeratorSimple* New_ctor(::System::Collections::ArrayList* list);

  /// @brief Method Reset, addr 0x21d3bb8, size 0xd0, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x21d0c50, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  static inline ::System::Object* getStaticF_s_dummyObject();

  /// @brief Method get_Current, addr 0x21d3ae4, size 0xd4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Adapter, addr 0x21d06a4, size 0xb4, virtual false, abstract: false, final false
  static inline ::System::Collections::ArrayList* Adapter(::System::Collections::IList* list);

  /// @brief Method Add, addr 0x21d0780, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Add(::System::Object* value);

  /// @brief Method AddRange, addr 0x21d0884, size 0x1c, virtual true, abstract: false, final false
  inline void AddRange(::System::Collections::ICollection* c);

  /// @brief Method Clear, addr 0x21d08a0, size 0x3c, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x21d08dc, size 0x88, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Contains, addr 0x21d0964, size 0xc0, virtual true, abstract: false, final false
  inline bool Contains(::System::Object* item);

  /// @brief Method CopyTo, addr 0x21d0a24, size 0x14, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array);

  /// @brief Method CopyTo, addr 0x21d0a38, size 0xb0, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t arrayIndex);

  /// @brief Method CopyTo, addr 0x21d0ae8, size 0x108, virtual true, abstract: false, final false
  inline void CopyTo(int32_t index, ::System::Array* array, int32_t arrayIndex, int32_t count);

  /// @brief Method EnsureCapacity, addr 0x21d0828, size 0x5c, virtual false, abstract: false, final false
  inline void EnsureCapacity(int32_t min);

  /// @brief Method GetEnumerator, addr 0x21d0bf0, size 0x60, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x21d0d58, size 0x18, virtual true, abstract: false, final false
  inline int32_t IndexOf(::System::Object* value);

  /// @brief Method Insert, addr 0x21d0d70, size 0x134, virtual true, abstract: false, final false
  inline void Insert(int32_t index, ::System::Object* value);

  /// @brief Method InsertRange, addr 0x21d0ea4, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadOnly, addr 0x21d1108, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Collections::ArrayList* ReadOnly(::System::Collections::ArrayList* list);

  /// @brief Method Remove, addr 0x21d11dc, size 0x40, virtual true, abstract: false, final false
  inline void Remove(::System::Object* obj);

  /// @brief Method RemoveAt, addr 0x21d121c, size 0xe4, virtual true, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveRange, addr 0x21d1300, size 0x168, virtual true, abstract: false, final false
  inline void RemoveRange(int32_t index, int32_t count);

  /// @brief Method Sort, addr 0x21d1468, size 0x4c, virtual true, abstract: false, final false
  inline void Sort(::System::Collections::IComparer* comparer);

  /// @brief Method Sort, addr 0x21d14b4, size 0x104, virtual true, abstract: false, final false
  inline void Sort(int32_t index, int32_t count, ::System::Collections::IComparer* comparer);

  /// @brief Method ToArray, addr 0x21d15b8, size 0xd0, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> ToArray();

  /// @brief Method ToArray, addr 0x21d1688, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c96d4, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x21d01b0, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ICollection* c);

  /// @brief Method .ctor, addr 0x21d006c, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method get_Count, addr 0x21d0478, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x21d0480, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x21d0488, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x21d0490, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x21d0510, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x21d0498, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Capacity, addr 0x21d0360, size 0x118, virtual true, abstract: false, final false
  inline void set_Capacity(int32_t value);

  /// @brief Method set_Item, addr 0x21d05b8, size 0xec, virtual true, abstract: false, final false
