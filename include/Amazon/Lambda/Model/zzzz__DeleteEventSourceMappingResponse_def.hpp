...
#include <cstdint>
CORDL_MODULE_EXPORT(DeleteEventSourceMappingResponse)
...
// Write type traits
MARK_REF_PTR_T(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse);
// Type: Amazon.Lambda.Model::DeleteEventSourceMappingResponse
// SizeInfo { instance_size: 224, native_size: -1, calculated_instance_size: 224, calculated_native_size: 224, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace Amazon::Lambda::Model {
// Is value type: false
// CS Name: ::Amazon.Lambda.Model::DeleteEventSourceMappingResponse*
class CORDL_TYPE DeleteEventSourceMappingResponse : public ::Amazon::Runtime::AmazonWebServiceResponse {
public:
  // Declarations
  ...
  /// @brief Method IsSetBatchSize, addr 0x2bc6db8, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetBatchSize();

  /// @brief Method IsSetBisectBatchOnFunctionError, addr 0x2bc6e98, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetBisectBatchOnFunctionError();

  /// @brief Method IsSetDestinationConfig, addr 0x2bc6ee4, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetDestinationConfig();

  /// @brief Method IsSetEventSourceArn, addr 0x2bc6f04, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetEventSourceArn();

  /// @brief Method IsSetFunctionArn, addr 0x2bc6f24, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetFunctionArn();

  /// @brief Method IsSetFunctionResponseTypes, addr 0x2bc6f44, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetFunctionResponseTypes();

  /// @brief Method IsSetLastModified, addr 0x2bc7044, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetLastModified();

  /// @brief Method IsSetLastProcessingResult, addr 0x2bc7090, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetLastProcessingResult();

  /// @brief Method IsSetMaximumBatchingWindowInSeconds, addr 0x2bc7144, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaximumBatchingWindowInSeconds();

  /// @brief Method IsSetMaximumRecordAgeInSeconds, addr 0x2bc7224, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaximumRecordAgeInSeconds();

  /// @brief Method IsSetMaximumRetryAttempts, addr 0x2bc7304, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetMaximumRetryAttempts();

  /// @brief Method IsSetParallelizationFactor, addr 0x2bc73e4, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetParallelizationFactor();

  /// @brief Method IsSetQueues, addr 0x2bc7430, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetQueues();

  /// @brief Method IsSetSelfManagedEventSource, addr 0x2bc7494, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetSelfManagedEventSource();

  /// @brief Method IsSetSourceAccessConfigurations, addr 0x2bc74b4, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetSourceAccessConfigurations();

  /// @brief Method IsSetStartingPosition, addr 0x2bc7518, size 0x60, virtual false, abstract: false, final false
  inline bool IsSetStartingPosition();

  /// @brief Method IsSetStartingPositionTimestamp, addr 0x2bc7624, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetStartingPositionTimestamp();

  /// @brief Method IsSetState, addr 0x2bc7670, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetState();

  /// @brief Method IsSetStateTransitionReason, addr 0x2bc7690, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetStateTransitionReason();

  /// @brief Method IsSetTopics, addr 0x2bc76b0, size 0x54, virtual false, abstract: false, final false
  inline bool IsSetTopics();

  /// @brief Method IsSetTumblingWindowInSeconds, addr 0x2bc77a8, size 0x3c, virtual false, abstract: false, final false
  inline bool IsSetTumblingWindowInSeconds();

  /// @brief Method IsSetUUID, addr 0x2bc77f4, size 0x10, virtual false, abstract: false, final false
  inline bool IsSetUUID();

  static inline ::Amazon::Lambda::Model::DeleteEventSourceMappingResponse* New_ctor();
  ...
  /// @brief Method .ctor, addr 0x2bc7804, size 0x100, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BatchSize, addr 0x2bc6d14, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_BatchSize();

  /// @brief Method get_BisectBatchOnFunctionError, addr 0x2bc6df4, size 0x3c, virtual false, abstract: false, final false
  inline bool get_BisectBatchOnFunctionError();

  /// @brief Method get_DestinationConfig, addr 0x2bc6ed4, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::DestinationConfig* get_DestinationConfig();

  /// @brief Method get_EventSourceArn, addr 0x2bc6ef4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EventSourceArn();

  /// @brief Method get_FunctionArn, addr 0x2bc6f14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FunctionArn();

  /// @brief Method get_FunctionResponseTypes, addr 0x2bc6f34, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_FunctionResponseTypes();

  /// @brief Method get_LastModified, addr 0x2bc6f98, size 0x3c, virtual false, abstract: false, final false
  inline ::System::DateTime get_LastModified();

  /// @brief Method get_LastProcessingResult, addr 0x2bc7080, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LastProcessingResult();

  /// @brief Method get_MaximumBatchingWindowInSeconds, addr 0x2bc70a0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaximumBatchingWindowInSeconds();

  /// @brief Method get_MaximumRecordAgeInSeconds, addr 0x2bc7180, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaximumRecordAgeInSeconds();

  /// @brief Method get_MaximumRetryAttempts, addr 0x2bc7260, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_MaximumRetryAttempts();

  /// @brief Method get_ParallelizationFactor, addr 0x2bc7340, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_ParallelizationFactor();

  /// @brief Method get_Queues, addr 0x2bc7420, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Queues();

  /// @brief Method get_SelfManagedEventSource, addr 0x2bc7484, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::Model::SelfManagedEventSource* get_SelfManagedEventSource();

  /// @brief Method get_SourceAccessConfigurations, addr 0x2bc74a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Amazon::Lambda::Model::SourceAccessConfiguration*>* get_SourceAccessConfigurations();

  /// @brief Method get_StartingPosition, addr 0x2bc7508, size 0x8, virtual false, abstract: false, final false
  inline ::Amazon::Lambda::EventSourcePosition* get_StartingPosition();

  /// @brief Method get_StartingPositionTimestamp, addr 0x2bc7578, size 0x3c, virtual false, abstract: false, final false
  inline ::System::DateTime get_StartingPositionTimestamp();

  /// @brief Method get_State, addr 0x2bc7660, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_State();

  /// @brief Method get_StateTransitionReason, addr 0x2bc7680, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_StateTransitionReason();

  /// @brief Method get_Topics, addr 0x2bc76a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Topics();

  /// @brief Method get_TumblingWindowInSeconds, addr 0x2bc7704, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_TumblingWindowInSeconds();

  /// @brief Method get_UUID, addr 0x2bc77e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_UUID();

  /// @brief Method set_BatchSize, addr 0x2bc6d50, size 0x68, virtual false, abstract: false, final false
  inline void set_BatchSize(int32_t value);

  /// @brief Method set_BisectBatchOnFunctionError, addr 0x2bc6e30, size 0x68, virtual false, abstract: false, final false
  inline void set_BisectBatchOnFunctionError(bool value);

  /// @brief Method set_DestinationConfig, addr 0x2bc6edc, size 0x8, virtual false, abstract: false, final false
  inline void set_DestinationConfig(::Amazon::Lambda::Model::DestinationConfig* value);

  /// @brief Method set_EventSourceArn, addr 0x2bc6efc, size 0x8, virtual false, abstract: false, final false
  inline void set_EventSourceArn(::StringW value);

  /// @brief Method set_FunctionArn, addr 0x2bc6f1c, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionArn(::StringW value);

  /// @brief Method set_FunctionResponseTypes, addr 0x2bc6f3c, size 0x8, virtual false, abstract: false, final false
  inline void set_FunctionResponseTypes(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_LastModified, addr 0x2bc6fd4, size 0x70, virtual false, abstract: false, final false
  inline void set_LastModified(::System::DateTime value);

  /// @brief Method set_LastProcessingResult, addr 0x2bc7088, size 0x8, virtual false, abstract: false, final false
  inline void set_LastProcessingResult(::StringW value);

  /// @brief Method set_MaximumBatchingWindowInSeconds, addr 0x2bc70dc, size 0x68, virtual false, abstract: false, final false
  inline void set_MaximumBatchingWindowInSeconds(int32_t value);

  /// @brief Method set_MaximumRecordAgeInSeconds, addr 0x2bc71bc, size 0x68, virtual false, abstract: false, final false
  inline void set_MaximumRecordAgeInSeconds(int32_t value);

  /// @brief Method set_MaximumRetryAttempts, addr 0x2bc729c, size 0x68, virtual false, abstract: false, final false
  inline void set_MaximumRetryAttempts(int32_t value);

  /// @brief Method set_ParallelizationFactor, addr 0x2bc737c, size 0x68, virtual false, abstract: false, final false
  inline void set_ParallelizationFactor(int32_t value);

  /// @brief Method set_Queues, addr 0x2bc7428, size 0x8, virtual false, abstract: false, final false
  inline void set_Queues(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_SelfManagedEventSource, addr 0x2bc748c, size 0x8, virtual false, abstract: false, final false
  inline void set_SelfManagedEventSource(::Amazon::Lambda::Model::SelfManagedEventSource* value);

  /// @brief Method set_SourceAccessConfigurations, addr 0x2bc74ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_StartingPosition, addr 0x2bc7510, size 0x8, virtual false, abstract: false, final false
  inline void set_StartingPosition(::Amazon::Lambda::EventSourcePosition* value);

  /// @brief Method set_StartingPositionTimestamp, addr 0x2bc75b4, size 0x70, virtual false, abstract: false, final false
  inline void set_StartingPositionTimestamp(::System::DateTime value);

  /// @brief Method set_State, addr 0x2bc7668, size 0x8, virtual false, abstract: false, final false
  inline void set_State(::StringW value);

  /// @brief Method set_StateTransitionReason, addr 0x2bc7688, size 0x8, virtual false, abstract: false, final false
  inline void set_StateTransitionReason(::StringW value);

  /// @brief Method set_Topics, addr 0x2bc76a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Topics(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_TumblingWindowInSeconds, addr 0x2bc7740, size 0x68, virtual false, abstract: false, final false
  inline void set_TumblingWindowInSeconds(int32_t value);

  /// @brief Method set_UUID, addr 0x2bc77ec, size 0x8, virtual false, abstract: false, final false
  inline void set_UUID(::StringW value);

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr DeleteEventSourceMappingResponse();

public:
  // Ctor Parameters [CppParam { name: "", ty: "DeleteEventSourceMappingResponse", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeleteEventSourceMappingResponse(DeleteEventSourceMappingResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeleteEventSourceMappingResponse", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeleteEventSourceMappingResponse(DeleteEventSourceMappingResponse const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, 0xe0>, "Size mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____batchSize) == 0x24, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____bisectBatchOnFunctionError) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____destinationConfig) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____eventSourceArn) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____functionArn) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____functionResponseTypes) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____lastModified) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____lastProcessingResult) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____maximumBatchingWindowInSeconds) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____maximumRecordAgeInSeconds) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____maximumRetryAttempts) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____parallelizationFactor) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____queues) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____selfManagedEventSource) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____sourceAccessConfigurations) == 0x98, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____startingPosition) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____startingPositionTimestamp) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____state) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____stateTransitionReason) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____topics) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____tumblingWindowInSeconds) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse, ____uuid) == 0xd8, "Offset mismatch!");

} // namespace Amazon::Lambda::Model
NEED_NO_BOX(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse);
DEFINE_IL2CPP_ARG_TYPE(::Amazon::Lambda::Model::DeleteEventSourceMappingResponse*, "Amazon.Lambda.Model", "DeleteEventSourceMappingResponse");
