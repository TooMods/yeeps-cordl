...
public:
  ...
  /// @brief Method Add, addr 0x2412a90, size 0xc, virtual false, abstract: false, final false
  inline void Add(::System::Data::DataColumn* column);

  /// @brief Method AddAt, addr 0x2412a9c, size 0x258, virtual false, abstract: false, final false
  inline void AddAt(int32_t index, ::System::Data::DataColumn* column);

  /// @brief Method AddColumnsImplementingIChangeTrackingList, addr 0x2414230, size 0xcc, virtual false, abstract: false, final false
  inline void AddColumnsImplementingIChangeTrackingList(::System::Data::DataColumn* dataColumn);

  /// @brief Method ArrayAdd, addr 0x2412fe8, size 0x68, virtual false, abstract: false, final false
  inline void ArrayAdd(::System::Data::DataColumn* column);

  /// @brief Method ArrayAdd, addr 0x2412fa8, size 0x40, virtual false, abstract: false, final false
  inline void ArrayAdd(int32_t index, ::System::Data::DataColumn* column);

  /// @brief Method ArrayRemove, addr 0x24133ac, size 0x128, virtual false, abstract: false, final false
  inline void ArrayRemove(::System::Data::DataColumn* column);

  /// @brief Method AssignName, addr 0x24135d8, size 0x94, virtual false, abstract: false, final false
  inline ::StringW AssignName();

  /// @brief Method BaseAdd, addr 0x2412d1c, size 0x28c, virtual false, abstract: false, final false
  inline void BaseAdd(::System::Data::DataColumn* column);

  /// @brief Method BaseGroupSwitch, addr 0x24137bc, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method BaseRemove, addr 0x2413994, size 0xbc, virtual false, abstract: false, final false
  inline void BaseRemove(::System::Data::DataColumn* column);

  /// @brief Method CanRegisterName, addr 0x24149a8, size 0x64, virtual false, abstract: false, final false
  inline bool CanRegisterName(::StringW name);

  /// @brief Method CanRemove, addr 0x2413a50, size 0x65c, virtual false, abstract: false, final false
  inline bool CanRemove(::System::Data::DataColumn* column, bool fThrowException);

  /// @brief Method CheckIChangeTracking, addr 0x2413364, size 0x48, virtual false, abstract: false, final false
  inline void CheckIChangeTracking(::System::Data::DataColumn* column);

  /// @brief Method Clear, addr 0x24142fc, size 0x2d4, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x24145d0, size 0x94, virtual false, abstract: false, final false
  inline bool Contains(::StringW name);

  /// @brief Method Contains, addr 0x2414664, size 0x9c, virtual false, abstract: false, final false
  inline bool Contains(::StringW name, bool caseSensitive);

  /// @brief Method FinishInitCollection, addr 0x2414800, size 0xc4, virtual false, abstract: false, final false
  inline void FinishInitCollection();

  /// @brief Method IndexOf, addr 0x2414700, size 0x100, virtual false, abstract: false, final false
  inline int32_t IndexOf(::StringW columnName);

  /// @brief Method IndexOfCaseInsensitive, addr 0x2412894, size 0x15c, virtual false, abstract: false, final false
  inline int32_t IndexOfCaseInsensitive(::StringW name);

  /// @brief Method MakeName, addr 0x241366c, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW MakeName(int32_t index);

  static inline ::System::Data::DataColumnCollection* New_ctor(::System::Data::DataTable* table);

  /// @brief Method OnCollectionChanged, addr 0x2413050, size 0xa4, virtual false, abstract: false, final false
  inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method OnCollectionChanging, addr 0x2412cf4, size 0x28, virtual false, abstract: false, final false
  inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method OnColumnPropertyChanged, addr 0x240d084, size 0x58, virtual false, abstract: false, final false
  inline void OnColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method RegisterColumnName, addr 0x240cd90, size 0x1b8, virtual false, abstract: false, final false
  inline void RegisterColumnName(::StringW name, ::System::Data::DataColumn* column);

  /// @brief Method Remove, addr 0x2414a0c, size 0x118, virtual false, abstract: false, final false
  inline void Remove(::System::Data::DataColumn* column);

  /// @brief Method RemoveColumnsImplementingIChangeTrackingList, addr 0x24134d4, size 0x104, virtual false, abstract: false, final false
  inline void RemoveColumnsImplementingIChangeTrackingList(::System::Data::DataColumn* dataColumn);

  /// @brief Method UnregisterName, addr 0x240cf48, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2412574, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method add_CollectionChanged, addr 0x24130f4, size 0x9c, virtual false, abstract: false, final false
  inline void add_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method add_ColumnPropertyChanged, addr 0x241322c, size 0x9c, virtual false, abstract: false, final false
  inline void add_ColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method get_ColumnsImplementingIChangeTracking, addr 0x24126c0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ColumnsImplementingIChangeTracking();

  /// @brief Method get_ColumnsImplementingIChangeTrackingCount, addr 0x24126c8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ColumnsImplementingIChangeTrackingCount();

  /// @brief Method get_ColumnsImplementingIRevertibleChangeTrackingCount, addr 0x24126d0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ColumnsImplementingIRevertibleChangeTrackingCount();

  /// @brief Method get_Item, addr 0x24126d8, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x24091a4, size 0x148, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Item(::StringW name);

  /// @brief Method get_Item, addr 0x24129f0, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Item(::StringW name, ::StringW ns);

  /// @brief Method get_List, addr 0x24126b8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* get_List();

  /// @brief Method remove_CollectionChanged, addr 0x2413190, size 0x9c, virtual false, abstract: false, final false
  inline void remove_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method remove_ColumnPropertyChanged, addr 0x24132c8, size 0x9c, virtual false, abstract: false, final false
