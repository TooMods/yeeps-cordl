...
public:
  ...
  /// @brief Method Invoke, addr 0x2a41f90, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEditorKeyDown, addr 0x2a41e3c, size 0x4c, virtual false, abstract: false, final false
  inline void OnEditorKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnKeyDown, addr 0x2a41d54, size 0xe8, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnNavigationCancel, addr 0x2a420a4, size 0x24, virtual false, abstract: false, final false
  inline void OnNavigationCancel(::UnityEngine::UIElements::NavigationCancelEvent* evt);

  /// @brief Method OnNavigationMove, addr 0x2a420ec, size 0x68, virtual false, abstract: false, final false
  inline void OnNavigationMove(::UnityEngine::UIElements::NavigationMoveEvent* evt);

  /// @brief Method OnNavigationSubmit, addr 0x2a420c8, size 0x24, virtual false, abstract: false, final false
  inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent* evt);

  /// @brief Method OnRuntimeKeyDown, addr 0x2a41e88, size 0x4c, virtual false, abstract: false, final false
  inline void OnRuntimeKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method RegisterCallbacksOnTarget, addr 0x2a418ac, size 0x254, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x2a41b00, size 0x254, virtual true, abstract: false, final false
  inline void UnregisterCallbacksFromTarget();

  /// @brief Method <OnEditorKeyDown>g__GetOperation|6_0, addr 0x2a41fb0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method <OnRuntimeKeyDown>g__GetOperation|5_0, addr 0x2a41ed4, size 0xbc, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::KeyboardNavigationOperation
  ...
  /// @brief Method .ctor, addr 0x2a41884, size 0x28, virtual false, abstract: false, final false
