...
public:
  ...
  /// @brief Method .ctor, addr 0x23a7e98, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_ThrowsException, addr 0x23a7e8c, size 0xc, virtual true, abstract: false, final true
