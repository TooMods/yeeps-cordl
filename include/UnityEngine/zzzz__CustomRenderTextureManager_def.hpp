...
public:
  ...
  /// @brief Method InvokeOnTextureLoaded_Internal, addr 0x27f4a40, size 0x6c, virtual false, abstract: false, final false
  static inline void InvokeOnTextureLoaded_Internal(::UnityEngine::CustomRenderTexture* source);

  /// @brief Method InvokeOnTextureUnloaded_Internal, addr 0x27f4aac, size 0x6c, virtual false, abstract: false, final false
