...
public:
  ...
  /// @brief Method .ctor, addr 0x2f64a80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CalculatedSize, addr 0x2f64a70, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CalculatedSize();

  /// @brief Method get_Parent, addr 0x2f64a60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CalculatedSize, addr 0x2f64a78, size 0x8, virtual false, abstract: false, final false
  inline void set_CalculatedSize(int32_t value);

  /// @brief Method set_Parent, addr 0x2f64a68, size 0x8, virtual false, abstract: false, final false
