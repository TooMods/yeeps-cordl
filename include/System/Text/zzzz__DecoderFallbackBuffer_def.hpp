...
public:
  ...
  /// @brief Method InternalFallback, addr 0xee29bc, size 0x190, virtual true, abstract: false, final false
  ...
  /// @brief Method InternalFallback, addr 0xee2b4c, size 0x170, virtual true, abstract: false, final false
  inline int32_t InternalFallback(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, ::cordl_internals::Ptr<uint8_t> pBytes);

  /// @brief Method InternalInitialize, addr 0xee0f28, size 0x8, virtual false, abstract: false, final false
  inline void InternalInitialize(::cordl_internals::Ptr<uint8_t> byteStart, ::cordl_internals::Ptr<char16_t> charEnd);

  /// @brief Method InternalReset, addr 0xee11b8, size 0x10, virtual false, abstract: false, final false
  inline void InternalReset();

  static inline ::System::Text::DecoderFallbackBuffer* New_ctor();

  /// @brief Method Reset, addr 0xee2994, size 0x28, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ThrowLastBytesRecursive, addr 0xee2cbc, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xee2364, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
