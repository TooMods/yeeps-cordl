...
public:
  // Declarations
  /// @brief Method SetConnectionStatusChangedNotificationCallback, addr 0x19c0928, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSessionsChangedNotificationCallback, addr 0x19c099c, size 0x74, virtual false, abstract: false, final false
