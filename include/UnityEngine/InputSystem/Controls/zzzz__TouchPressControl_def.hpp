...
public:
  // Declarations
  /// @brief Method FinishSetup, addr 0x2266580, size 0xac, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Controls::TouchPressControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x226662c, size 0x104, virtual true, abstract: false, final false
  inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x22668c4, size 0x40, virtual true, abstract: false, final false
  inline void WriteValueIntoState(float_t value, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method .ctor, addr 0x2266904, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
