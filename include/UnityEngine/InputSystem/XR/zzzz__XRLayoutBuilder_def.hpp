...
public:
  ...
  /// @brief Method <OnFindLayoutForDevice>b__0, addr 0x1d3b3f8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d3a370, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Build, addr 0x1d3a6a4, size 0xb04, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* Build();

  /// @brief Method ConvertPotentialAliasToName, addr 0x1d3a380, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentControlName, addr 0x1d3a518, size 0x38, virtual false, abstract: false, final false
  inline ::StringW GetParentControlName(::StringW name);

  /// @brief Method GetSizeOfFeature, addr 0x1d39d44, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t GetSizeOfFeature(::UnityEngine::InputSystem::XR::XRFeatureDescriptor featureDescriptor);

  /// @brief Method IsPoseControl, addr 0x1d3a550, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSubControl, addr 0x1d3a4fc, size 0x1c, virtual false, abstract: false, final false
  inline bool IsSubControl(::StringW name);

  static inline ::UnityEngine::InputSystem::XR::XRLayoutBuilder* New_ctor();

  /// @brief Method OnFindLayoutForDevice, addr 0x1d39f1c, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method SanitizeString, addr 0x1d39dbc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1d3a378, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
