...
public:
  ...
  /// @brief Method Dispose, addr 0x196ffc0, size 0x50, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetCurrent, addr 0x1970010, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Security::Principal::WindowsIdentity* GetCurrent();

  /// @brief Method GetCurrentToken, addr 0x1970094, size 0x4, virtual false, abstract: false, final false
  static inline void* GetCurrentToken();

  /// @brief Method GetTokenName, addr 0x19701f8, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetTokenName(void* token);

  /// @brief Method Impersonate, addr 0x1970098, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method SetToken, addr 0x196fe24, size 0x160, virtual false, abstract: false, final false
  inline void SetToken(void* token);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x19701fc, size 0x2d8, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x19704d4, size 0x168, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x196ff84, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x196fda4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AuthenticationType, addr 0x1970188, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_AuthenticationType();

  /// @brief Method get_Name, addr 0x1970190, size 0x68, virtual true, abstract: false, final false
