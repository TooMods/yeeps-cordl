...
public:
  ...
  /// @brief Method DetermineVersion, addr 0x2e8dc2c, size 0xb0, virtual false, abstract: false, final false
  inline void DetermineVersion(int16_t magic);

  /// @brief Method Get, addr 0x2e88898, size 0x90, virtual false, abstract: false, final false
  inline ::StringW Get(::System::TermInfoStrings tstr);

  /// @brief Method Get, addr 0x2e88928, size 0x60, virtual false, abstract: false, final false
  inline int32_t Get(::System::TermInfoNumbers number);

  /// @brief Method GetInt16, addr 0x2e8dcdc, size 0x50, virtual false, abstract: false, final false
  inline int16_t GetInt16(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method GetString, addr 0x2e8dd2c, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method GetStringBytes, addr 0x2e8dda8, size 0x233f4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetStringBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method GetStringBytes, addr 0x2e8c7dc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadHeader, addr 0x2e8db38, size 0xc0, virtual false, abstract: false, final false
  inline void ReadHeader(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, ByRef<int32_t> position);

  /// @brief Method ReadNames, addr 0x2e8dbf8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e87fa0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW term, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method .ctor, addr 0x2e87cc8, size 0x2d8, virtual false, abstract: false, final false
