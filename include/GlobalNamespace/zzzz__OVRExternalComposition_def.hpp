...
public:
  ...
  /// @brief Method CacheAudioData, addr 0x25b20d0, size 0x138, virtual false, abstract: false, final false
  inline void CacheAudioData(::ArrayW<float_t, ::Array<float_t>*> data, int32_t channels);

  /// @brief Method CastMrcFrame, addr 0x25b0b80, size 0x200, virtual false, abstract: false, final false
  inline int32_t CastMrcFrame(int32_t castTextureIndex);

  /// @brief Method Cleanup, addr 0x25b1efc, size 0x1d4, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CleanupAudioFilter, addr 0x25b0a4c, size 0x134, virtual false, abstract: false, final false
  inline void CleanupAudioFilter();

  /// @brief Method CompositionMethod, addr 0x25af270, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__OVRManager__CompositionMethod CompositionMethod();

  /// @brief Method DisplayRefreshRateChanged, addr 0x25b2208, size 0x14, virtual false, abstract: false, final false
  inline void DisplayRefreshRateChanged(float_t fromRefreshRate, float_t toRefreshRate);

  /// @brief Method GetAndResetAudioData, addr 0x25b0d80, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshAudioFilter, addr 0x25b049c, size 0x5b0, virtual false, abstract: false, final false
  inline void RefreshAudioFilter(::UnityEngine::Camera* mainCamera);

  /// @brief Method RefreshCameraObjects, addr 0x25af858, size 0xc44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCameraTargetTexture, addr 0x25b0f5c, size 0x1e0, virtual false, abstract: false, final false
  inline void SetCameraTargetTexture(int32_t drawTextureIndex);

  /// @brief Method Update, addr 0x25b113c, size 0xcac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25af278, size 0x590, virtual false, abstract: false, final false
