...
public:
  ...
  /// @brief Method Equals, addr 0x22270cc, size 0x148, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x2227214, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22270c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Aggregate, addr 0x2221f54, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* Aggregate(::ArrayW<int32_t, ::Array<int32_t>*> records, ::System::Data::AggregateType kind);

  /// @brief Method Compare, addr 0x2221f84, size 0x1b4, virtual true, abstract: false, final false
  inline int32_t Compare(int32_t recordNo1, int32_t recordNo2);

  /// @brief Method CompareTo, addr 0x22227d4, size 0x1d8, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Object* valueNo1, ::System::Object* valueNo2);

  /// @brief Method CompareValueTo, addr 0x22225f0, size 0x1e4, virtual true, abstract: false, final false
  inline int32_t CompareValueTo(int32_t recordNo1, ::System::Object* value);

  /// @brief Method CompareWithFamilies, addr 0x2222138, size 0x4b8, virtual false, abstract: false, final false
  inline int32_t CompareWithFamilies(::System::Object* valueNo1, ::System::Object* valueNo2);

  /// @brief Method ConvertObjectToXml, addr 0x222645c, size 0x654, virtual true, abstract: false, final false
  inline ::StringW ConvertObjectToXml(::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x2226ab0, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertXmlToObject, addr 0x2223590, size 0x550, virtual true, abstract: false, final false
  inline ::System::Object* ConvertXmlToObject(::StringW s);

  /// @brief Method ConvertXmlToObject, addr 0x2223b54, size 0x6d0, virtual true, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x2222aa0, size 0x74, virtual true, abstract: false, final false
  inline void Copy(int32_t recordNo1, int32_t recordNo2);

  /// @brief Method CopyValue, addr 0x2226c5c, size 0x1f8, virtual true, abstract: false, final false
  inline void CopyValue(int32_t record, ::System::Object* store, ::System::Collections::BitArray* nullbits, int32_t storeIndex);

  /// @brief Method Get, addr 0x2222b14, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Object* Get(int32_t recordNo);

  /// @brief Method GetEmptyStorage, addr 0x2226c14, size 0x48, virtual true, abstract: false, final false
  inline ::System::Object* GetEmptyStorage(int32_t recordCount);

  /// @brief Method GetFamily, addr 0x22229ac, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Data::Common::__ObjectStorage__Families GetFamily(::System::Type* dataType);

  /// @brief Method GetXmlSerializer, addr 0x2223ae0, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Xml::Serialization::XmlSerializer* GetXmlSerializer(::System::Type* type);

  /// @brief Method GetXmlSerializer, addr 0x2225e8c, size 0x5d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNull, addr 0x2222b50, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x2222b88, size 0x950, virtual true, abstract: false, final false
  inline void Set(int32_t recordNo, ::System::Object* value);

  /// @brief Method SetCapacity, addr 0x22234d8, size 0xb8, virtual true, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetStorage, addr 0x2226e54, size 0x1b4, virtual true, abstract: false, final false
  inline void SetStorage(::System::Object* store, ::System::Collections::BitArray* nullbits);

  /// @brief Method VerifyIDynamicMetaObjectProvider, addr 0x22196a4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2217d74, size 0x1a0, virtual false, abstract: false, final false
