...
public:
  ...
  /// @brief Method Copy, addr 0x128d470, size 0x144, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::TransitionData Copy();

  /// @brief Method CopyFrom, addr 0x128d5b4, size 0x160, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::TransitionData> other);

  /// @brief Method Equals, addr 0x128d7ac, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x128d760, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TransitionData other);

  /// @brief Method GetHashCode, addr 0x128d85c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x128d714, size 0x4c, virtual false, abstract: false, final false
