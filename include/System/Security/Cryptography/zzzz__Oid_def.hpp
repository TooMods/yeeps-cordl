...
public:
  ...
  /// @brief Method FromOidValue, addr 0x12c196c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c1828, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12c1830, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method .ctor, addr 0x12c18e8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::Oid* oid);

  /// @brief Method .ctor, addr 0x12c18bc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW value, ::StringW friendlyName);

  /// @brief Method .ctor, addr 0x12c1aa8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW value, ::StringW friendlyName, ::System::Security::Cryptography::OidGroup group);

  /// @brief Method get_FriendlyName, addr 0x12c1af4, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_FriendlyName();

  /// @brief Method get_Value, addr 0x12c1ae4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x12c1aec, size 0x8, virtual false, abstract: false, final false
