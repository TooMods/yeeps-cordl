...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3be0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetLaunchInvitePanelFlowResult, addr 0x19b3ba4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0e64, size 0x58, virtual false, abstract: false, final false
