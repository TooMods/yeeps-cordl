...
public:
  ...
  /// @brief Method Acquire, addr 0x1285914, size 0x140, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId Acquire(::UnityEngine::Texture* tex);

  /// @brief Method AllocAndAcquire, addr 0x1285508, size 0x260, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId AllocAndAcquire(::UnityEngine::Texture* texture, bool dynamic);

  /// @brief Method AllocAndAcquireDynamic, addr 0x12854ec, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId AllocAndAcquireDynamic();

  /// @brief Method GetTexture, addr 0x12853b0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x1285a54, size 0x1f0, virtual false, abstract: false, final false
  inline void Release(::UnityEngine::UIElements::TextureId id);

  /// @brief Method UpdateDynamic, addr 0x1285768, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1285c44, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::TextureRegistry* getStaticF__instance_k__BackingField();

  /// @brief Method get_instance, addr 0x1285358, size 0x58, virtual false, abstract: false, final false
