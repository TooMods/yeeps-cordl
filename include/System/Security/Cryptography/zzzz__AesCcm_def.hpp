...
// Write type traits
MARK_REF_PTR_T(::System::Security::Cryptography::AesCcm);
...
public:
  ...
  /// @brief Method Decrypt, addr 0x196e238, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method Decrypt, addr 0x196e278, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x196e2b8, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Encrypt, addr 0x196e2bc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method Encrypt, addr 0x196e2fc, size 0x40, virtual false, abstract: false, final false
  ...
  static inline ::System::Security::Cryptography::AesCcm* New_ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  static inline ::System::Security::Cryptography::AesCcm* New_ctor(::System::ReadOnlySpan_1<uint8_t> key);

  /// @brief Method .ctor, addr 0x196e128, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor, addr 0x196e170, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<uint8_t> key);

  /// @brief Method get_NonceByteSizes, addr 0x196e1b8, size 0x40, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::KeySizes* get_NonceByteSizes();

  /// @brief Method get_TagByteSizes, addr 0x196e1f8, size 0x40, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AesCcm", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AesCcm(AesCcm&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AesCcm", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::System::Security::Cryptography::AesCcm, 0x10>, "Size mismatch!");
