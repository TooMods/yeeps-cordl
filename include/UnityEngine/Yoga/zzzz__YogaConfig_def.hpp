...
public:
  ...
  /// @brief Method Finalize, addr 0x264e6b0, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264e66c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264e5a8, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(void* ygConfig);

  static inline ::UnityEngine::Yoga::YogaConfig* getStaticF_Default();

  /// @brief Method get_Handle, addr 0x264c1ec, size 0x8, virtual false, abstract: false, final false
  inline void* get_Handle();

  /// @brief Method get_UseWebDefaults, addr 0x264e7b8, size 0x3c, virtual false, abstract: false, final false
  inline bool get_UseWebDefaults();

  static inline void setStaticF_Default(::UnityEngine::Yoga::YogaConfig* value);

  /// @brief Method set_PointScaleFactor, addr 0x264e838, size 0x4c, virtual false, abstract: false, final false
  inline void set_PointScaleFactor(float_t value);

  /// @brief Method set_UseWebDefaults, addr 0x264e7f4, size 0x44, virtual false, abstract: false, final false
