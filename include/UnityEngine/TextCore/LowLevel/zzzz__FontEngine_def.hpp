...
public:
  ...
  /// @brief Method GetFaceInfo, addr 0x2903148, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::FaceInfo GetFaceInfo();

  /// @brief Method GetFaceInfo_Internal, addr 0x29031e8, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetFaceInfo_Internal(ByRef<::UnityEngine::TextCore::FaceInfo> faceInfo);

  /// @brief Method GetGlyphIndex, addr 0x2903224, size 0x3c, virtual false, abstract: false, final false
  static inline uint32_t GetGlyphIndex(uint32_t unicode);

  /// @brief Method GetGlyphPairAdjustmentRecords, addr 0x29046d8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGlyphPairAdjustmentTable, addr 0x2904508, size 0x150, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord, ::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>
  GetGlyphPairAdjustmentTable(::ArrayW<uint32_t, ::Array<uint32_t>*> glyphIndexes);

  /// @brief Method GetPairAdjustmentRecordsFromMarshallingArray, addr 0x290469c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace, addr 0x2902f88, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace, addr 0x2902dc8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace, addr 0x2902ea8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_And_FaceIndex_Internal, addr 0x2902e54, size 0x54, virtual false, abstract: false, final false
  static inline int32_t LoadFontFace_With_Size_And_FaceIndex_Internal(::StringW filePath, int32_t pointSize, int32_t faceIndex);

  /// @brief Method LoadFontFace_With_Size_and_FaceIndex_FromFont_Internal, addr 0x2902f34, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_by_FamilyName_and_StyleName_Internal, addr 0x2903014, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulatePairAdjustmentRecordMarshallingArray_from_KernTable, addr 0x2904658, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAtlasTexture, addr 0x2904860, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTextureUploadMode, addr 0x29035b0, size 0x3c, virtual false, abstract: false, final false
  static inline void SetTextureUploadMode(bool shouldUploadImmediately);

  /// @brief Method TryAddGlyphToTexture, addr 0x29035ec, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphToTexture_Internal, addr 0x2903b1c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToTexture, addr 0x2903bb8, size 0x888, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToTexture_Internal, addr 0x2904460, size 0xa8, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method TryGetGlyphWithIndexValue, addr 0x2903408, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithIndexValue_Internal, addr 0x290355c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithUnicodeValue, addr 0x2903260, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithUnicodeValue_Internal, addr 0x29033b4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference, addr 0x2903068, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference_Internal, addr 0x29030f4, size 0x54, virtual false, abstract: false, final false
