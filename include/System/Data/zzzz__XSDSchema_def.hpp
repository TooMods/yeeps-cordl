...
public:
  ...
  /// @brief Method CompareTo, addr 0x1cf8da0, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1cf8d74, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddTablesToList, addr 0x1cf7264, size 0x200, virtual false, abstract: false, final false
  inline void AddTablesToList(::System::Collections::Generic::List_1<::System::Data::DataTable*>* tableList, ::System::Data::DataTable* dt);

  /// @brief Method BuildKey, addr 0x1cf3bb0, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method CollectElementsAnnotations, addr 0x1ce86e0, size 0x88, virtual false, abstract: false, final false
  inline void CollectElementsAnnotations(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method CollectElementsAnnotations, addr 0x1ce8768, size 0x9d0, virtual false, abstract: false, final false
  inline void CollectElementsAnnotations(::System::Xml::Schema::XmlSchema* schema, ::System::Collections::ArrayList* schemaList);

  /// @brief Method DatasetElementCount, addr 0x1ceb69c, size 0x248, virtual false, abstract: false, final false
  inline int32_t DatasetElementCount(::System::Xml::Schema::XmlSchemaObjectCollection* elements);

  /// @brief Method FindDatasetElement, addr 0x1ceba3c, size 0x4b0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* FindDatasetElement(::System::Xml::Schema::XmlSchemaObjectCollection* elements);

  /// @brief Method FindField, addr 0x1cf3a2c, size 0x184, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* FindField(::System::Data::DataTable* table, ::StringW field);

  /// @brief Method FindNameType, addr 0x1cf6fb4, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Data::__XSDSchema__NameType* FindNameType(::StringW name);

  /// @brief Method FindTypeNode, addr 0x1cee11c, size 0x314, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnnotated* FindTypeNode(::System::Xml::Schema::XmlSchemaAnnotated* node);

  /// @brief Method GetBooleanAttribute, addr 0x1ceb8e4, size 0x158, virtual false, abstract: false, final false
  inline bool GetBooleanAttribute(::System::Xml::Schema::XmlSchemaAnnotated* element, ::StringW attrName, bool defVal);

  /// @brief Method GetInstanceName, addr 0x1cea0d0, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW GetInstanceName(::System::Xml::Schema::XmlSchemaAnnotated* node);

  /// @brief Method GetMsdataAttribute, addr 0x1ce9138, size 0x118, virtual false, abstract: false, final false
  static inline ::StringW GetMsdataAttribute(::System::Xml::Schema::XmlSchemaAnnotated* node, ::StringW ln);

  /// @brief Method GetNamespaceFromPrefix, addr 0x1cf7464, size 0x42c, virtual false, abstract: false, final false
  inline ::StringW GetNamespaceFromPrefix(::StringW prefix);

  /// @brief Method GetParticle, addr 0x1cebeec, size 0x144, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* GetParticle(::System::Xml::Schema::XmlSchemaComplexType* ct);

  /// @brief Method GetParticleItems, addr 0x1ceb220, size 0x210, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* GetParticleItems(::System::Xml::Schema::XmlSchemaParticle* pt);

  /// @brief Method GetPrefix, addr 0x1cf542c, size 0x424, virtual false, abstract: false, final false
  inline ::StringW GetPrefix(::StringW ns);

  /// @brief Method GetStringAttribute, addr 0x1cee098, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetStringAttribute(::System::Xml::Schema::XmlSchemaAnnotated* element, ::StringW attrName, ::StringW defVal);

  /// @brief Method GetTableName, addr 0x1cf4798, size 0x118, virtual false, abstract: false, final false
  inline ::StringW GetTableName(::System::Xml::Schema::XmlSchemaIdentityConstraint* key);

  /// @brief Method GetTableNamespace, addr 0x1cf6d48, size 0x190, virtual false, abstract: false, final false
  inline ::StringW GetTableNamespace(::System::Xml::Schema::XmlSchemaIdentityConstraint* key);

  /// @brief Method HandleAttributeColumn, addr 0x1cf15a8, size 0x9a4, virtual false, abstract: false, final false
  inline void HandleAttributeColumn(::System::Xml::Schema::XmlSchemaAttribute* attrib, ::System::Data::DataTable* table, bool isBase);

  /// @brief Method HandleAttributeGroup, addr 0x1cf1f4c, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleAttributes, addr 0x1cf12ac, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColumnExpression, addr 0x1ce9bac, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleComplexType, addr 0x1cf2330, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConstraint, addr 0x1cf48b0, size 0x440, virtual false, abstract: false, final false
  inline void HandleConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint* keyNode);

  /// @brief Method HandleDataSet, addr 0x1cee5a8, size 0x12cc, virtual false, abstract: false, final false
  inline void HandleDataSet(::System::Xml::Schema::XmlSchemaElement* node, bool isNewDataSet);

  /// @brief Method HandleElementColumn, addr 0x1cf0594, size 0xd18, virtual false, abstract: false, final false
  inline void HandleElementColumn(::System::Xml::Schema::XmlSchemaElement* elem, ::System::Data::DataTable* table, bool isBase);

  /// @brief Method HandleKeyref, addr 0x1cf3fec, size 0x7ac, virtual false, abstract: false, final false
  inline void HandleKeyref(::System::Xml::Schema::XmlSchemaKeyref* keyref);

  /// @brief Method HandleParticle, addr 0x1cefb9c, size 0x9f8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleRefTableProperties, addr 0x1ce9fec, size 0xe4, virtual false, abstract: false, final false
  inline void HandleRefTableProperties(::System::Collections::ArrayList* RefTables, ::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method HandleRelation, addr 0x1cea1a8, size 0x838, virtual false, abstract: false, final false
  inline void HandleRelation(::System::Xml::XmlElement* node, bool fNested);

  /// @brief Method HandleRelations, addr 0x1cef874, size 0x328, virtual false, abstract: false, final false
  inline void HandleRelations(::System::Xml::Schema::XmlSchemaAnnotation* ann, bool fNested);

  /// @brief Method HandleSimpleContentColumn, addr 0x1cf291c, size 0x784, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSimpleTypeSimpleContentColumn, addr 0x1cf30a0, size 0x98c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleTable, addr 0x1cee430, size 0x178, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* HandleTable(::System::Xml::Schema::XmlSchemaElement* node);

  /// @brief Method HasAttributes, addr 0x1cea9e0, size 0x298, virtual false, abstract: false, final false
  inline bool HasAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method InstantiateSimpleTable, addr 0x1cf4cf0, size 0x73c, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* InstantiateSimpleTable(::System::Xml::Schema::XmlSchemaElement* node);

  /// @brief Method InstantiateTable, addr 0x1cf5850, size 0x14f8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDatasetParticle, addr 0x1ceac78, size 0x5a8, virtual false, abstract: false, final false
  inline bool IsDatasetParticle(::System::Xml::Schema::XmlSchemaParticle* pt);

  /// @brief Method IsTable, addr 0x1ceb430, size 0x26c, virtual false, abstract: false, final false
  inline bool IsTable(::System::Xml::Schema::XmlSchemaElement* node);

  /// @brief Method IsXsdType, addr 0x1cf71f4, size 0x70, virtual false, abstract: false, final false
  static inline bool IsXsdType(::StringW name);

  /// @brief Method LoadSchema, addr 0x1cec054, size 0x2044, virtual false, abstract: false, final false
  inline void LoadSchema(::System::Xml::Schema::XmlSchemaSet* schemaSet, ::System::Data::DataSet* ds);

  /// @brief Method LoadSchema, addr 0x1cec030, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDataType, addr 0x1cf7088, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Type* ParseDataType(::StringW dt);

  /// @brief Method QualifiedName, addr 0x1ce9250, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW QualifiedName(::StringW name);

  /// @brief Method SetExtProperties, addr 0x1ce981c, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExtProperties, addr 0x1ce9da8, size 0x244, virtual false, abstract: false, final false
  static inline void SetExtProperties(::System::Object* instance, ::System::Xml::XmlAttributeCollection* attrs);

  /// @brief Method SetProperties, addr 0x1ce92cc, size 0x550, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateAcceptRejectRule, addr 0x1cf3e7c, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Data::AcceptRejectRule TranslateAcceptRejectRule(::StringW strRule);

  /// @brief Method TranslateRule, addr 0x1cf3f00, size 0xec, virtual false, abstract: false, final false
  static inline ::System::Data::Rule TranslateRule(::StringW strRule);

  /// @brief Method XsdtoClr, addr 0x1cf6ed8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1cf7890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FromInference, addr 0x1ce86cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_FromInference, addr 0x1ce86d4, size 0xc, virtual false, abstract: false, final false
