...
public:
  ...
  /// @brief Method Equals, addr 0x10418f4, size 0xf4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1041824, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10412e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri, ::System::Uri* proxy, bool use_connect);

  /// @brief Method get_UsesProxy, addr 0x10417c4, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseConnectionGroup, addr 0x1041324, size 0x408, virtual false, abstract: false, final false
  static inline void CloseConnectionGroup(::StringW connectionGroupName);

  /// @brief Method FindServicePoint, addr 0x10381a0, size 0x668, virtual false, abstract: false, final false
  static inline ::System::Net::ServicePoint* FindServicePoint(::System::Uri* address, ::System::Net::IWebProxy* proxy);

  /// @brief Method GetLegacyCertificatePolicy, addr 0x10410a8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Net::ICertificatePolicy* GetLegacyCertificatePolicy();

  /// @brief Method RemoveServicePoint, addr 0x104172c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CheckCertificateRevocationList, addr 0x1041100, size 0x58, virtual false, abstract: false, final false
  static inline bool get_CheckCertificateRevocationList();

  /// @brief Method get_DnsRefreshTimeout, addr 0x1041158, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_DnsRefreshTimeout();

  /// @brief Method get_SecurityProtocol, addr 0x10411b0, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Net::SecurityProtocolType get_SecurityProtocol();

  /// @brief Method get_ServerCertValidationCallback, addr 0x1041208, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Net::ServerCertValidationCallback* get_ServerCertValidationCallback();

  /// @brief Method get_ServerCertificateValidationCallback, addr 0x1041260, size 0x88, virtual false, abstract: false, final false
