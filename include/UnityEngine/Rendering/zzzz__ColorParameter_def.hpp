...
// SizeInfo { instance_size: 40, native_size: -1, calculated_instance_size: 40, calculated_native_size: 39, minimum_alignment: 8, natural_alignment: 1, packing: None, specified_packing: None }
namespace UnityEngine::Rendering {
// Is value type: false
...
public:
  ...
  /// @brief Method Interp, addr 0x17d6b18, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x17d6a50, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color value, bool hdr, bool showAlpha, bool showEyeDropper, bool overrideState);

  /// @brief Method .ctor, addr 0x17d69c0, size 0x90, virtual false, abstract: false, final false
