...
public:
  // Declarations
  /// @brief Method FromInt32, addr 0x2459b08, size 0x150, virtual false, abstract: false, final false
  static inline ::Mono::Security::ASN1* FromInt32(int32_t value);

  /// @brief Method FromOid, addr 0x2459c70, size 0xe8, virtual false, abstract: false, final false
  static inline ::Mono::Security::ASN1* FromOid(::StringW oid);

  /// @brief Method FromUnsignedBigInteger, addr 0x2459d58, size 0x11c, virtual false, abstract: false, final false
  static inline ::Mono::Security::ASN1* FromUnsignedBigInteger(::ArrayW<uint8_t, ::Array<uint8_t>*> big);

  /// @brief Method ToDateTime, addr 0x245a218, size 0x55c, virtual false, abstract: false, final false
  static inline ::System::DateTime ToDateTime(::Mono::Security::ASN1* time);

  /// @brief Method ToInt32, addr 0x2459e74, size 0x118, virtual false, abstract: false, final false
  static inline int32_t ToInt32(::Mono::Security::ASN1* asn1);

  /// @brief Method ToOid, addr 0x2459f8c, size 0x28c, virtual false, abstract: false, final false
