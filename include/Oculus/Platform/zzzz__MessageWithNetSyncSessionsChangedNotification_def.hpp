...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b48e8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionsChangedNotification* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncSessionsChangedNotification, addr 0x19b48ac, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b1124, size 0x58, virtual false, abstract: false, final false
