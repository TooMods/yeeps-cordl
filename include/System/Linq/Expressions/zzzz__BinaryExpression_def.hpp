...
public:
  ...
  /// @brief Method Accept, addr 0x2d25abc, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetBinaryOpFromAssignmentOp, addr 0x2d250d4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConversion, addr 0x2d25924, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::LambdaExpression* GetConversion();

  /// @brief Method GetMethod, addr 0x2d237f8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetMethod();

  /// @brief Method IsOpAssignment, addr 0x2d237cc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x2d246e0, size 0x78, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Reduce();

  /// @brief Method ReduceIndex, addr 0x2d24b74, size 0x45c, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceIndex();

  /// @brief Method ReduceMember, addr 0x2d24758, size 0x41c, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceMember();

  /// @brief Method ReduceUserdefinedLifted, addr 0x2d25c4c, size 0x670, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceUserdefinedLifted();

  /// @brief Method ReduceVariable, addr 0x2d24fd0, size 0x104, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceVariable();

  /// @brief Method Update, addr 0x2d23800, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d23730, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* left, ::System::Linq::Expressions::Expression* right);

  /// @brief Method get_CanReduce, addr 0x2d237a8, size 0x24, virtual true, abstract: false, final false
  inline bool get_CanReduce();

  /// @brief Method get_Conversion, addr 0x2d2395c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::LambdaExpression* get_Conversion();

  /// @brief Method get_IsLifted, addr 0x2d2592c, size 0x190, virtual false, abstract: false, final false
  inline bool get_IsLifted();

  /// @brief Method get_IsLiftedLogical, addr 0x2d25ae4, size 0x168, virtual false, abstract: false, final false
  inline bool get_IsLiftedLogical();

  /// @brief Method get_IsLiftedToNull, addr 0x2d23d54, size 0x8c, virtual false, abstract: false, final false
  inline bool get_IsLiftedToNull();

  /// @brief Method get_IsReferenceComparison, addr 0x2d23968, size 0xd4, virtual false, abstract: false, final false
  inline bool get_IsReferenceComparison();

  /// @brief Method get_Left, addr 0x2d237e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Left();

  /// @brief Method get_Method, addr 0x2d237ec, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Method();

  /// @brief Method get_Right, addr 0x2d237dc, size 0x8, virtual false, abstract: false, final false
