...
public:
  ...
  /// @brief Method Copy, addr 0x128d8f8, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::VisualData Copy();

  /// @brief Method CopyFrom, addr 0x128d914, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::VisualData> other);

  /// @brief Method Equals, addr 0x128db60, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x128db14, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::VisualData other);

  /// @brief Method GetHashCode, addr 0x128dc08, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x128d928, size 0x1ec, virtual false, abstract: false, final false
