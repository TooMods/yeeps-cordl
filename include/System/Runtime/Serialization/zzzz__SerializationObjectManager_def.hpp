...
public:
  ...
  /// @brief Method AddOnSerialized, addr 0x186a1cc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method RaiseOnSerializedEvent, addr 0x186a25c, size 0x1020, virtual false, abstract: false, final false
  inline void RaiseOnSerializedEvent();

  /// @brief Method RegisterObject, addr 0x186a0bc, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x186a028, size 0x94, virtual false, abstract: false, final false
