...
public:
  ...
  /// @brief Method Equals, addr 0x1ae7434, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x1ae7500, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x1ae7528, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ae7398, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1ae73f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW description);

  static inline ::System::ComponentModel::DescriptionAttribute* getStaticF_Default();

  /// @brief Method get_Description, addr 0x1ae741c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_DescriptionValue, addr 0x1ae7424, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DescriptionValue, addr 0x1ae742c, size 0x8, virtual false, abstract: false, final false
