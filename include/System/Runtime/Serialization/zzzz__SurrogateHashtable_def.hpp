...
public:
  // Declarations
  /// @brief Method KeyEquals, addr 0x1ab03b8, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1ab000c, size 0x8, virtual false, abstract: false, final false
