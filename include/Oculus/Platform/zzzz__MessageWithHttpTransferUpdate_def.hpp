...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b6008, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::HttpTransferUpdate* GetDataFromMessage(void* c_message);

  /// @brief Method GetHttpTransferUpdate, addr 0x19b5fcc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b1804, size 0x58, virtual false, abstract: false, final false
