...
public:
  // Declarations
  /// @brief Method GetAchievementUpdate, addr 0x19b26b4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate();

  /// @brief Method GetDataFromMessage, addr 0x19b26f0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0624, size 0x58, virtual false, abstract: false, final false
