...
public:
  ...
  /// @brief Method CalculateLayoutInputHorizontal, addr 0x26f0364, size 0x4, virtual true, abstract: false, final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x26f0368, size 0x4, virtual true, abstract: false, final false
  inline void CalculateLayoutInputVertical();

  static inline ::UnityEngine::UI::LayoutElement* New_ctor();

  /// @brief Method OnBeforeTransformParentChanged, addr 0x26f0734, size 0x4, virtual true, abstract: false, final false
  inline void OnBeforeTransformParentChanged();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x26f0730, size 0x4, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x26f0714, size 0x1c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26f06f4, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnTransformParentChanged, addr 0x26f0710, size 0x4, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method SetDirty, addr 0x26f02ac, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f06d0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_flexibleHeight, addr 0x26f05d8, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleHeight();

  /// @brief Method get_flexibleWidth, addr 0x26f055c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_flexibleWidth();

  /// @brief Method get_ignoreLayout, addr 0x26f0230, size 0x8, virtual true, abstract: false, final false
  inline bool get_ignoreLayout();

  /// @brief Method get_layoutPriority, addr 0x26f0654, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_layoutPriority();

  /// @brief Method get_minHeight, addr 0x26f03e8, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minHeight();

  /// @brief Method get_minWidth, addr 0x26f036c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_minWidth();

  /// @brief Method get_preferredHeight, addr 0x26f04e0, size 0x8, virtual true, abstract: false, final false
  inline float_t get_preferredHeight();

  /// @brief Method get_preferredWidth, addr 0x26f0464, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_flexibleHeight, addr 0x26f05e0, size 0x74, virtual true, abstract: false, final false
  inline void set_flexibleHeight(float_t value);

  /// @brief Method set_flexibleWidth, addr 0x26f0564, size 0x74, virtual true, abstract: false, final false
  inline void set_flexibleWidth(float_t value);

  /// @brief Method set_ignoreLayout, addr 0x26f0238, size 0x74, virtual true, abstract: false, final false
  inline void set_ignoreLayout(bool value);

  /// @brief Method set_layoutPriority, addr 0x26f065c, size 0x74, virtual true, abstract: false, final false
  inline void set_layoutPriority(int32_t value);

  /// @brief Method set_minHeight, addr 0x26f03f0, size 0x74, virtual true, abstract: false, final false
  inline void set_minHeight(float_t value);

  /// @brief Method set_minWidth, addr 0x26f0374, size 0x74, virtual true, abstract: false, final false
  inline void set_minWidth(float_t value);

  /// @brief Method set_preferredHeight, addr 0x26f04e8, size 0x74, virtual true, abstract: false, final false
  inline void set_preferredHeight(float_t value);

  /// @brief Method set_preferredWidth, addr 0x26f046c, size 0x74, virtual true, abstract: false, final false
