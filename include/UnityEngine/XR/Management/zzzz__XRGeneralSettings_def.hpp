...
public:
  ...
  /// @brief Method AttemptInitializeXRSDKOnLoad, addr 0x22a8fa0, size 0xe4, virtual false, abstract: false, final false
  static inline void AttemptInitializeXRSDKOnLoad();

  /// @brief Method AttemptStartXRSDKOnBeforeSplashScreen, addr 0x22a92fc, size 0xe4, virtual false, abstract: false, final false
  static inline void AttemptStartXRSDKOnBeforeSplashScreen();

  /// @brief Method Awake, addr 0x22a8c2c, size 0x130, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DeInitXRSDK, addr 0x22a8e38, size 0xb0, virtual false, abstract: false, final false
  inline void DeInitXRSDK();

  /// @brief Method InitXRSDK, addr 0x22a9084, size 0x278, virtual false, abstract: false, final false
  inline void InitXRSDK();

  static inline ::UnityEngine::XR::Management::XRGeneralSettings* New_ctor();

  /// @brief Method OnDestroy, addr 0x22a8f9c, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Quit, addr 0x22a8d5c, size 0xdc, virtual false, abstract: false, final false
  static inline void Quit();

  /// @brief Method Start, addr 0x22a8ee8, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartXRSDK, addr 0x22a8eec, size 0xb0, virtual false, abstract: false, final false
  inline void StartXRSDK();

  /// @brief Method StopXRSDK, addr 0x22a96f8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22a9964, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AssignedSettings, addr 0x22a8c1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::XR::Management::XRManagerSettings> get_AssignedSettings();

  /// @brief Method get_InitManagerOnStart, addr 0x22a8c24, size 0x8, virtual false, abstract: false, final false
  inline bool get_InitManagerOnStart();

  /// @brief Method get_Instance, addr 0x22a8bc4, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::Management::XRGeneralSettings> get_Instance();

  /// @brief Method get_Manager, addr 0x22a8bb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Manager, addr 0x22a8bbc, size 0x8, virtual false, abstract: false, final false
