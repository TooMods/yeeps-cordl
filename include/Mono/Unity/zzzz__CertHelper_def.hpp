...
public:
  // Declarations
  /// @brief Method AddCertificateToNativeChain, addr 0x2420278, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCertificatesToNativeChain, addr 0x24200a0, size 0x1d8, virtual false, abstract: false, final false
