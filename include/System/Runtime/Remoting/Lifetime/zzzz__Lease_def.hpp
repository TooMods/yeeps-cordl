...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x185062c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x1850830, size 0x28, virtual true, abstract: false, final false
  inline ::System::TimeSpan EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x1850858, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1850500, size 0x12c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Activate, addr 0x184ff38, size 0xc, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method CheckNextSponsor, addr 0x18502bc, size 0x244, virtual false, abstract: false, final false
  inline void CheckNextSponsor();

  static inline ::System::Runtime::Remoting::Lifetime::Lease* New_ctor();

  /// @brief Method ProcessSponsorResponse, addr 0x185064c, size 0x1e4, virtual false, abstract: false, final false
  inline void ProcessSponsorResponse(::System::Object* state, bool timedOut);

  /// @brief Method Renew, addr 0x184ff4c, size 0x8c, virtual true, abstract: false, final true
  inline ::System::TimeSpan Renew(::System::TimeSpan renewalTime);

  /// @brief Method Unregister, addr 0x184ffd8, size 0x144, virtual true, abstract: false, final true
  inline void Unregister(::System::Runtime::Remoting::Lifetime::ISponsor* obj);

  /// @brief Method UpdateState, addr 0x185011c, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x184fd70, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CurrentLeaseTime, addr 0x184fec8, size 0x68, virtual true, abstract: false, final true
  inline ::System::TimeSpan get_CurrentLeaseTime();

  /// @brief Method get_CurrentState, addr 0x184ff30, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Lifetime::LeaseState get_CurrentState();

  /// @brief Method get_RenewOnCallTime, addr 0x184ff44, size 0x8, virtual true, abstract: false, final true
