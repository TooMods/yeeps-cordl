...
public:
  ...
  /// @brief Method .ctor, addr 0x23a786c, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x23a7864, size 0x8, virtual true, abstract: false, final true
