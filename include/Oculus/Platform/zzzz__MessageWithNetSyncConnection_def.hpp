...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b46e0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncConnection, addr 0x19b46a4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b10cc, size 0x58, virtual false, abstract: false, final false
