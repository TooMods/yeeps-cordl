...
public:
  ...
  /// @brief Method MoveNext, addr 0x169f2c0, size 0xb4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRSpectatorModeDomeTest___TimerCoroutine_d__20* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x169f374, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x169f37c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x169f3bc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x169f2bc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x169f0f0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x169e554, size 0x3c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Initialize, addr 0x169e640, size 0x228, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRSpectatorModeDomeTest* New_ctor();

  /// @brief Method OnApplicationPause, addr 0x169f258, size 0x20, virtual false, abstract: false, final false
  inline void OnApplicationPause();

  /// @brief Method OnApplicationQuit, addr 0x169f278, size 0x20, virtual false, abstract: false, final false
  inline void OnApplicationQuit();

  /// @brief Method SpectatorCameraDomePosition, addr 0x169f05c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x169e590, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TimerCoroutine, addr 0x169eff4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* TimerCoroutine();

  /// @brief Method Update, addr 0x169f118, size 0x140, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDefaultExternalCamera, addr 0x169e868, size 0x428, virtual false, abstract: false, final false
  inline void UpdateDefaultExternalCamera();

  /// @brief Method UpdateSpectatorCameraStatus, addr 0x169ec90, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x169f298, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
