...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129cb7c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129e950, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x129e978, size 0x8, virtual false, abstract: false, final false
