...
public:
  ...
  /// @brief Method Clear, addr 0x246fc5c, size 0x2c, virtual false, abstract: false, final false
  inline void Clear(bool uploadChanges);

  /// @brief Method ClearUnusedVertices, addr 0x247350c, size 0x3c, virtual false, abstract: false, final false
  inline void ClearUnusedVertices();

  /// @brief Method ResizeMeshInfo, addr 0x2473324, size 0x1e8, virtual false, abstract: false, final false
  inline void ResizeMeshInfo(int32_t size);

  /// @brief Method SortGeometry, addr 0x2473548, size 0x7c, virtual false, abstract: false, final false
  inline void SortGeometry(::UnityEngine::TextCore::Text::VertexSortingOrder order);

  /// @brief Method SwapVertexData, addr 0x24735c4, size 0x58c, virtual false, abstract: false, final false
  inline void SwapVertexData(int32_t src, int32_t dst);

  /// @brief Method .ctor, addr 0x2472fd0, size 0x354, virtual false, abstract: false, final false
