...
public:
  ...
  /// @brief Method Combine, addr 0x109d13c, size 0x318, virtual false, abstract: false, final false
  static inline void Combine(::Newtonsoft::Json::Schema::JsonSchemaModel* model, ::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method Create, addr 0x109ce2c, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x109ce00, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AdditionalItems, addr 0x109cd80, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaModel* get_AdditionalItems();

  /// @brief Method get_AdditionalProperties, addr 0x109cd70, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaModel* get_AdditionalProperties();

  /// @brief Method get_AllowAdditionalItems, addr 0x109cdb8, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowAdditionalItems();

  /// @brief Method get_AllowAdditionalProperties, addr 0x109cda4, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowAdditionalProperties();

  /// @brief Method get_Disallow, addr 0x109cdf0, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaType get_Disallow();

  /// @brief Method get_DivisibleBy, addr 0x109ccac, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<double_t> get_DivisibleBy();

  /// @brief Method get_Enum, addr 0x109cde0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_Enum();

  /// @brief Method get_ExclusiveMaximum, addr 0x109ccfc, size 0x8, virtual false, abstract: false, final false
  inline bool get_ExclusiveMaximum();

  /// @brief Method get_ExclusiveMinimum, addr 0x109cce8, size 0x8, virtual false, abstract: false, final false
  inline bool get_ExclusiveMinimum();

  /// @brief Method get_Items, addr 0x109cd40, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::JsonSchemaModel*>* get_Items();

  /// @brief Method get_Maximum, addr 0x109ccd4, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<double_t> get_Maximum();

  /// @brief Method get_MaximumItems, addr 0x109cd20, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_MaximumItems();

  /// @brief Method get_MaximumLength, addr 0x109cc9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_MaximumLength();

  /// @brief Method get_Minimum, addr 0x109ccc0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<double_t> get_Minimum();

  /// @brief Method get_MinimumItems, addr 0x109cd10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_MinimumItems();

  /// @brief Method get_MinimumLength, addr 0x109cc8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_MinimumLength();

  /// @brief Method get_PatternProperties, addr 0x109cd60, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::Newtonsoft::Json::Schema::JsonSchemaModel*>* get_PatternProperties();

  /// @brief Method get_Patterns, addr 0x109cd30, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::StringW>* get_Patterns();

  /// @brief Method get_PositionalItemsValidation, addr 0x109cd90, size 0x8, virtual false, abstract: false, final false
  inline bool get_PositionalItemsValidation();

  /// @brief Method get_Properties, addr 0x109cd50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::Newtonsoft::Json::Schema::JsonSchemaModel*>* get_Properties();

  /// @brief Method get_Required, addr 0x109cc68, size 0x8, virtual false, abstract: false, final false
  inline bool get_Required();

  /// @brief Method get_Type, addr 0x109cc7c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaType get_Type();

  /// @brief Method get_UniqueItems, addr 0x109cdcc, size 0x8, virtual false, abstract: false, final false
  inline bool get_UniqueItems();

  /// @brief Method set_AdditionalItems, addr 0x109cd88, size 0x8, virtual false, abstract: false, final false
  inline void set_AdditionalItems(::Newtonsoft::Json::Schema::JsonSchemaModel* value);

  /// @brief Method set_AdditionalProperties, addr 0x109cd78, size 0x8, virtual false, abstract: false, final false
  inline void set_AdditionalProperties(::Newtonsoft::Json::Schema::JsonSchemaModel* value);

  /// @brief Method set_AllowAdditionalItems, addr 0x109cdc0, size 0xc, virtual false, abstract: false, final false
  inline void set_AllowAdditionalItems(bool value);

  /// @brief Method set_AllowAdditionalProperties, addr 0x109cdac, size 0xc, virtual false, abstract: false, final false
  inline void set_AllowAdditionalProperties(bool value);

  /// @brief Method set_Disallow, addr 0x109cdf8, size 0x8, virtual false, abstract: false, final false
  inline void set_Disallow(::Newtonsoft::Json::Schema::JsonSchemaType value);

  /// @brief Method set_DivisibleBy, addr 0x109ccb8, size 0x8, virtual false, abstract: false, final false
  inline void set_DivisibleBy(::System::Nullable_1<double_t> value);

  /// @brief Method set_Enum, addr 0x109cde8, size 0x8, virtual false, abstract: false, final false
  inline void set_Enum(::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* value);

  /// @brief Method set_ExclusiveMaximum, addr 0x109cd04, size 0xc, virtual false, abstract: false, final false
  inline void set_ExclusiveMaximum(bool value);

  /// @brief Method set_ExclusiveMinimum, addr 0x109ccf0, size 0xc, virtual false, abstract: false, final false
  inline void set_ExclusiveMinimum(bool value);

  /// @brief Method set_Items, addr 0x109cd48, size 0x8, virtual false, abstract: false, final false
  inline void set_Items(::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::JsonSchemaModel*>* value);

  /// @brief Method set_Maximum, addr 0x109cce0, size 0x8, virtual false, abstract: false, final false
  inline void set_Maximum(::System::Nullable_1<double_t> value);

  /// @brief Method set_MaximumItems, addr 0x109cd28, size 0x8, virtual false, abstract: false, final false
  inline void set_MaximumItems(::System::Nullable_1<int32_t> value);

  /// @brief Method set_MaximumLength, addr 0x109cca4, size 0x8, virtual false, abstract: false, final false
  inline void set_MaximumLength(::System::Nullable_1<int32_t> value);

  /// @brief Method set_Minimum, addr 0x109cccc, size 0x8, virtual false, abstract: false, final false
  inline void set_Minimum(::System::Nullable_1<double_t> value);

  /// @brief Method set_MinimumItems, addr 0x109cd18, size 0x8, virtual false, abstract: false, final false
  inline void set_MinimumItems(::System::Nullable_1<int32_t> value);

  /// @brief Method set_MinimumLength, addr 0x109cc94, size 0x8, virtual false, abstract: false, final false
  inline void set_MinimumLength(::System::Nullable_1<int32_t> value);

  /// @brief Method set_PatternProperties, addr 0x109cd68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Patterns, addr 0x109cd38, size 0x8, virtual false, abstract: false, final false
  inline void set_Patterns(::System::Collections::Generic::IList_1<::StringW>* value);

  /// @brief Method set_PositionalItemsValidation, addr 0x109cd98, size 0xc, virtual false, abstract: false, final false
  inline void set_PositionalItemsValidation(bool value);

  /// @brief Method set_Properties, addr 0x109cd58, size 0x8, virtual false, abstract: false, final false
  inline void set_Properties(::System::Collections::Generic::IDictionary_2<::StringW, ::Newtonsoft::Json::Schema::JsonSchemaModel*>* value);

  /// @brief Method set_Required, addr 0x109cc70, size 0xc, virtual false, abstract: false, final false
  inline void set_Required(bool value);

  /// @brief Method set_Type, addr 0x109cc84, size 0x8, virtual false, abstract: false, final false
  inline void set_Type(::Newtonsoft::Json::Schema::JsonSchemaType value);

  /// @brief Method set_UniqueItems, addr 0x109cdd4, size 0xc, virtual false, abstract: false, final false
