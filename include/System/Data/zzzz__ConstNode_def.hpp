...
public:
  ...
  /// @brief Method Bind, addr 0x193f434, size 0x8, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method Eval, addr 0x193f43c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x193f450, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t, ::Array<int32_t>*> recordNos);

  /// @brief Method Eval, addr 0x193f444, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method HasLocalAggregate, addr 0x193f46c, size 0x8, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x193f474, size 0x8, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x193f45c, size 0x8, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x193f464, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Optimize, addr 0x193f47c, size 0x4, virtual true, abstract: false, final false
  inline ::System::Data::ExpressionNode* Optimize();

  /// @brief Method SmallestDecimal, addr 0x193efa8, size 0x48c, virtual false, abstract: false, final false
  inline ::System::Object* SmallestDecimal(::System::Object* constant);

  /// @brief Method SmallestNumeric, addr 0x193e990, size 0x618, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x193e988, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::System::Data::ValueType type, ::System::Object* constant);

  /// @brief Method .ctor, addr 0x193bf14, size 0x2d4, virtual false, abstract: false, final false
