...
public:
  ...
  /// @brief Method Convert, addr 0x21c3258, size 0x22c, virtual false, abstract: false, final false
  inline ::StringW Convert(::StringW input, int32_t index, int32_t count, bool toAscii);

  /// @brief Method Equals, addr 0x21c3084, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetAscii, addr 0x21c3120, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetAscii(::StringW unicode);

  /// @brief Method GetAscii, addr 0x21c3184, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW GetAscii(::StringW unicode, int32_t index, int32_t count);

  /// @brief Method GetHashCode, addr 0x21c3110, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUnicode, addr 0x21c4204, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetUnicode(::StringW ascii);

  /// @brief Method GetUnicode, addr 0x21c4268, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW GetUnicode(::StringW ascii, int32_t index, int32_t count);

  /// @brief Method NamePrep, addr 0x21c3898, size 0x14c, virtual false, abstract: false, final false
  inline ::StringW NamePrep(::StringW s, int32_t offset);

  static inline ::System::Globalization::IdnMapping* New_ctor();

  /// @brief Method ToAscii, addr 0x21c3484, size 0x23c, virtual false, abstract: false, final false
  inline ::StringW ToAscii(::StringW s, int32_t offset);

  /// @brief Method ToUnicode, addr 0x21c36c0, size 0x1d8, virtual false, abstract: false, final false
  inline ::StringW ToUnicode(::StringW s, int32_t offset);

  /// @brief Method VerifyLength, addr 0x21c3ef8, size 0xcc, virtual false, abstract: false, final false
  inline void VerifyLength(::StringW s, int32_t offset);

  /// @brief Method VerifyProhibitedCharacters, addr 0x21c3fc4, size 0x240, virtual false, abstract: false, final false
  inline void VerifyProhibitedCharacters(::StringW s, int32_t offset);

  /// @brief Method VerifyStd3AsciiRules, addr 0x21c39e4, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c2fb4, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
