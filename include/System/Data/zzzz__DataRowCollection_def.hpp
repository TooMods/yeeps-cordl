...
public:
  // Declarations
  /// @brief Method CompareNode, addr 0x18946bc, size 0x2c, virtual true, abstract: false, final false
  inline int32_t CompareNode(::System::Data::DataRow* record1, ::System::Data::DataRow* record2);

  /// @brief Method CompareSateliteTreeNode, addr 0x18946e8, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1893fbc, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x18940b0, size 0x20, virtual false, abstract: false, final false
  inline void Add(::System::Data::DataRow* row);

  /// @brief Method AddWithColumnEvents, addr 0x1894378, size 0x60, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* AddWithColumnEvents(::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method ArrayAdd, addr 0x18943d8, size 0x68, virtual false, abstract: false, final false
  inline void ArrayAdd(::System::Data::DataRow* row);

  /// @brief Method ArrayClear, addr 0x18944b8, size 0x50, virtual false, abstract: false, final false
  inline void ArrayClear();

  /// @brief Method ArrayInsert, addr 0x1894440, size 0x78, virtual false, abstract: false, final false
  inline void ArrayInsert(::System::Data::DataRow* row, int32_t pos);

  /// @brief Method ArrayRemove, addr 0x1894508, size 0x94, virtual false, abstract: false, final false
  inline void ArrayRemove(::System::Data::DataRow* row);

  /// @brief Method CopyTo, addr 0x189459c, size 0x68, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* ar, int32_t index);

  /// @brief Method CopyTo, addr 0x1894604, size 0x68, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<::System::Data::DataRow*, ::Array<::System::Data::DataRow*>*> array, int32_t index);

  /// @brief Method DiffInsertAt, addr 0x18940d0, size 0x210, virtual false, abstract: false, final false
  inline void DiffInsertAt(::System::Data::DataRow* row, int32_t pos);

  /// @brief Method GetEnumerator, addr 0x189466c, size 0x50, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x18942e0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1893f20, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_Count, addr 0x1894008, size 0x50, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x1894058, size 0x58, virtual false, abstract: false, final false
