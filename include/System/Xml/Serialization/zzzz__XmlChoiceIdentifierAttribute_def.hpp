...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x129ccb0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MemberName, addr 0x129d148, size 0x54, virtual false, abstract: false, final false
