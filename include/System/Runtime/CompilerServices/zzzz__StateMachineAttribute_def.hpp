...
public:
  ...
  /// @brief Method .ctor, addr 0x1b43dc4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* stateMachineType);

  /// @brief Method get_StateMachineType, addr 0x1b44984, size 0x8, virtual false, abstract: false, final false
