...
class __ResourceFallbackManager___GetEnumerator_d__5;
}
namespace System {
class IDisposable;
}
...
MARK_REF_PTR_T(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5);
// Type: ::<GetEnumerator>d__5
// SizeInfo { instance_size: 56, native_size: -1, calculated_instance_size: 56, calculated_native_size: 56, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace System::Resources {
// Is value type: false
// CS Name: ::ResourceFallbackManager::<GetEnumerator>d__5*
class CORDL_TYPE __ResourceFallbackManager___GetEnumerator_d__5 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IEnumerator_System_Globalization_CultureInfo__get_Current))::System::Globalization::
      CultureInfo* System_Collections_Generic_IEnumerator_System_Globalization_CultureInfo__Current;
  ...
  /// @brief Method MoveNext, addr 0x1b47264, size 0x1c8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Globalization.CultureInfo>.get_Current, addr 0x1b4742c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1b47434, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1b47474, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1b47260, size 0x4, virtual true, abstract: false, final true
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CultureInfo*> const& __cordl_internal_get___2__current() const;

  constexpr ::System::Resources::ResourceFallbackManager*& __cordl_internal_get___4__this();

  constexpr ::cordl_internals::to_const_pointer<::System::Resources::ResourceFallbackManager*> const& __cordl_internal_get___4__this() const;

  constexpr ::System::Globalization::CultureInfo*& __cordl_internal_get__currentCulture_5__3();

  constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CultureInfo*> const& __cordl_internal_get__currentCulture_5__3() const;
  ...
  /// @brief Method .ctor, addr 0x1b47238, size 0x28, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __ResourceFallbackManager___GetEnumerator_d__5();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__ResourceFallbackManager___GetEnumerator_d__5", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __ResourceFallbackManager___GetEnumerator_d__5(__ResourceFallbackManager___GetEnumerator_d__5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__ResourceFallbackManager___GetEnumerator_d__5", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __ResourceFallbackManager___GetEnumerator_d__5(__ResourceFallbackManager___GetEnumerator_d__5 const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5, 0x38>, "Size mismatch!");

static_assert(offsetof(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5, _____4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5, ____reachedNeutralResourcesCulture_5__2) == 0x28, "Offset mismatch!");

static_assert(offsetof(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5, ____currentCulture_5__3) == 0x30, "Offset mismatch!");
...
public:
  // Declarations
  using _GetEnumerator_d__5 = ::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5;
  ...
  /// @brief Method GetEnumerator, addr 0x1b471d0, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1b471cc, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  constexpr ::System::Globalization::CultureInfo*& __cordl_internal_get_m_neutralResourcesCulture();

  constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CultureInfo*> const& __cordl_internal_get_m_neutralResourcesCulture() const;

  constexpr ::System::Globalization::CultureInfo*& __cordl_internal_get_m_startingCulture();

  constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CultureInfo*> const& __cordl_internal_get_m_startingCulture() const;
  ...
  /// @brief Method .ctor, addr 0x1b47144, size 0x88, virtual false, abstract: false, final false
...
NEED_NO_BOX(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5);
DEFINE_IL2CPP_ARG_TYPE(::System::Resources::__ResourceFallbackManager___GetEnumerator_d__5*, "System.Resources", "ResourceFallbackManager/<GetEnumerator>d__5");
