...
public:
  ...
  /// @brief Method Encode, addr 0x282a2f8, size 0x334, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Flush, addr 0x282a62c, size 0xa8, virtual false, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x282a29c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
