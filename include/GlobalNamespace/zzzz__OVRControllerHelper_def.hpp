...
public:
  ...
  /// @brief Method InitializeControllerModels, addr 0x14ea5f0, size 0x49c, virtual false, abstract: false, final false
  inline void InitializeControllerModels();

  /// @brief Method InputFocusAquired, addr 0x14eb30c, size 0xc, virtual false, abstract: false, final false
  inline void InputFocusAquired();

  /// @brief Method InputFocusLost, addr 0x14eb318, size 0x8, virtual false, abstract: false, final false
  inline void InputFocusLost();

  static inline ::GlobalNamespace::OVRControllerHelper* New_ctor();

  /// @brief Method Start, addr 0x14ea580, size 0x70, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x14eaa8c, size 0x880, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x14eb320, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
