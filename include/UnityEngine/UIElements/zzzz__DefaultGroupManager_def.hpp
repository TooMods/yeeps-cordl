...
public:
  ...
  /// @brief Method OnOptionSelectionChanged, addr 0x2a461ac, size 0x1d0, virtual true, abstract: false, final true
  inline void OnOptionSelectionChanged(::UnityEngine::UIElements::IGroupBoxOption* selectedOption);

  /// @brief Method RegisterOption, addr 0x2a4637c, size 0xd4, virtual true, abstract: false, final true
  inline void RegisterOption(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnregisterOption, addr 0x2a46450, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a464a8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
