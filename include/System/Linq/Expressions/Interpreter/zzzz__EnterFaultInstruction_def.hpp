...
public:
  ...
  /// @brief Method Create, addr 0x1844b44, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x1844c60, size 0x48, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x1844ad4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstructionName, addr 0x1844afc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1844b3c, size 0x8, virtual true, abstract: false, final false
