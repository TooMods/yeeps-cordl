...
public:
  // Declarations
  /// @brief Method GetCurrent, addr 0x19c0b5c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Party*>* GetCurrent();

  /// @brief Method SetPartyUpdateNotificationCallback, addr 0x19c0cb4, size 0x74, virtual false, abstract: false, final false
