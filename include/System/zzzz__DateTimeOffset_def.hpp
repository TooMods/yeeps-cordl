...
public:
  ...
  /// @brief Method Compare, addr 0x299de0c, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t Compare(::System::DateTimeOffset first, ::System::DateTimeOffset second);

  /// @brief Method CompareTo, addr 0x299dfc8, size 0xa8, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::DateTimeOffset other);

  /// @brief Method Equals, addr 0x299e070, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x299e12c, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::System::DateTimeOffset other);

  /// @brief Method FromUnixTimeSeconds, addr 0x299e160, size 0x174, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset FromUnixTimeSeconds(int64_t seconds);

  /// @brief Method GetHashCode, addr 0x299e6e0, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Parse, addr 0x299e6f8, size 0x70, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset Parse(::StringW input, ::System::IFormatProvider* formatProvider);

  /// @brief Method Parse, addr 0x299e768, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExact, addr 0x299eab4, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method System.IComparable.CompareTo, addr 0x299de98, size 0x130, virtual true, abstract: false, final true
  inline int32_t System_IComparable_CompareTo(::System::Object* obj);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x299e2d4, size 0x180, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x299e454, size 0xcc, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToString, addr 0x299ee18, size 0x98, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x299f21c, size 0xa8, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method ToString, addr 0x299f180, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW ToString(::System::IFormatProvider* formatProvider);

  /// @brief Method ToUniversalTime, addr 0x299f5b0, size 0x2c, virtual false, abstract: false, final false
  inline ::System::DateTimeOffset ToUniversalTime();

  /// @brief Method ToUnixTimeSeconds, addr 0x299ede0, size 0x38, virtual false, abstract: false, final false
  inline int64_t ToUnixTimeSeconds();

  /// @brief Method TryFormat, addr 0x299f2c4, size 0xdc, virtual true, abstract: false, final true
  ...
  /// @brief Method TryParse, addr 0x299f5dc, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x299f8d0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x299fc1c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateDate, addr 0x299d4c4, size 0xa8, virtual false, abstract: false, final false
  static inline ::System::DateTime ValidateDate(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method ValidateOffset, addr 0x299d3b0, size 0x114, virtual false, abstract: false, final false
  static inline int16_t ValidateOffset(::System::TimeSpan offset);

  /// @brief Method ValidateStyles, addr 0x299e8d4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x299d56c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime);

  /// @brief Method .ctor, addr 0x299d630, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method .ctor, addr 0x299e520, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x299d31c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(int64_t ticks, ::System::TimeSpan offset);

  /// @brief Method .ctor, addr 0x299d98c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x299d8b0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x299d7e4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ClockDateTime, addr 0x299dae0, size 0xa0, virtual false, abstract: false, final false
  inline ::System::DateTime get_ClockDateTime();

  /// @brief Method get_DateTime, addr 0x299dadc, size 0x4, virtual false, abstract: false, final false
  inline ::System::DateTime get_DateTime();

  /// @brief Method get_Day, addr 0x299dc40, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Day();

  /// @brief Method get_Hour, addr 0x299dc60, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_Hour();

  /// @brief Method get_LocalDateTime, addr 0x299dbf4, size 0x20, virtual false, abstract: false, final false
  inline ::System::DateTime get_LocalDateTime();

  /// @brief Method get_Millisecond, addr 0x299dca4, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_Millisecond();

  /// @brief Method get_Minute, addr 0x299dcf4, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_Minute();

  /// @brief Method get_Month, addr 0x299dd38, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Month();

  /// @brief Method get_Now, addr 0x299da70, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset get_Now();

  /// @brief Method get_Offset, addr 0x299dc14, size 0x2c, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_Offset();

  /// @brief Method get_Second, addr 0x299dd58, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_Second();

  /// @brief Method get_Ticks, addr 0x299dd9c, size 0x14, virtual false, abstract: false, final false
  inline int64_t get_Ticks();

  /// @brief Method get_TimeOfDay, addr 0x299ddb0, size 0x3c, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_TimeOfDay();

  /// @brief Method get_UtcDateTime, addr 0x299db80, size 0x74, virtual false, abstract: false, final false
  inline ::System::DateTime get_UtcDateTime();

  /// @brief Method get_Year, addr 0x299ddec, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x299ffc4, size 0x84, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::DateTimeOffset left, ::System::DateTimeOffset right);

  /// @brief Method op_Implicit, addr 0x299ff18, size 0x28, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset op_Implicit___System__DateTimeOffset(::System::DateTime dateTime);

  /// @brief Method op_Inequality, addr 0x29a0048, size 0x84, virtual false, abstract: false, final false
  static inline bool op_Inequality(::System::DateTimeOffset left, ::System::DateTimeOffset right);

  /// @brief Method op_Subtraction, addr 0x299ff40, size 0x84, virtual false, abstract: false, final false
