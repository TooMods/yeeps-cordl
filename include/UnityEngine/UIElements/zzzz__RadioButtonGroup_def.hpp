...
public:
  ...
  /// @brief Method Init, addr 0x2cbcd90, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cbcec8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RadioButtonValueChangedCallback, addr 0x2cea02c, size 0xf8, virtual false, abstract: false, final false
  inline void RadioButtonValueChangedCallback(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method SetValueWithoutNotify, addr 0x2cea124, size 0x60, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(int32_t newValue);

  /// @brief Method UpdateRadioButtons, addr 0x2ce9c7c, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ce9e68, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2ce9e74, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_choices, addr 0x2ce96e4, size 0x598, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2cbcd48, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
