...
public:
  ...
  /// @brief Method DeserializeElement, addr 0x16d4668, size 0x38, virtual true, abstract: false, final false
  inline void DeserializeElement(::System::Xml::XmlReader* reader, bool serializeCollectionKey);

  /// @brief Method InitializeDefault, addr 0x16d46a0, size 0x38, virtual true, abstract: false, final false
  inline void InitializeDefault();

  /// @brief Method IsModified, addr 0x16d46d8, size 0x38, virtual true, abstract: false, final false
  inline bool IsModified();

  /// @brief Method PostDeserialize, addr 0x16d4710, size 0x38, virtual true, abstract: false, final false
  inline void PostDeserialize();

  /// @brief Method Reset, addr 0x16d4748, size 0x38, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method ResetModified, addr 0x16d4780, size 0x38, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method get_Properties, addr 0x16d4630, size 0x38, virtual true, abstract: false, final false
