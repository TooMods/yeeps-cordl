...
public:
  ...
  /// @brief Method Create, addr 0x1a91f98, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1a96f90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x1a96f40, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x1a96f50, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x1a96f48, size 0x8, virtual true, abstract: false, final false
