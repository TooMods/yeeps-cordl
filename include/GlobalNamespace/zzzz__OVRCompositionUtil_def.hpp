...
public:
  // Declarations
  /// @brief Method BuildBoundaryMesh, addr 0x25aede0, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaximumBoundaryDistance, addr 0x25ae74c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorldPosition, addr 0x25ae6b8, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetWorldPosition(::UnityEngine::Camera* camera, ::UnityEngine::Vector3 trackingSpacePosition);

  /// @brief Method GetWorldPosition, addr 0x25ae67c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeDestroy, addr 0x25ae590, size 0x78, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::GameObject* obj);

  /// @brief Method SafeDestroy, addr 0x25ae608, size 0x74, virtual false, abstract: false, final false
  static inline void SafeDestroy(ByRef<::UnityEngine::GameObject*> obj);

  /// @brief Method .ctor, addr 0x25af260, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
