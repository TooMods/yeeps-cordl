...
public:
  ...
  /// @brief Method .ctor, addr 0x1858200, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(int32_t domainId);

  /// @brief Method get_DomainID, addr 0x18582a8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DomainID();

  /// @brief Method get_ProcessID, addr 0x18582b0, size 0x8, virtual false, abstract: false, final false
