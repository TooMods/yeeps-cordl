...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2ce11a8, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();
  ...
  /// @brief Method .ctor, addr 0x2ce10ec, size 0xbc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2ce1278, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::UIElements::__TextEditorEngine__OnIndexChangeFunction* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2ce11bc, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method OnCursorIndexChange, addr 0x2ce10a4, size 0x24, virtual true, abstract: false, final false
  inline void OnCursorIndexChange();

  /// @brief Method OnDetectFocusChange, addr 0x2ce1080, size 0x24, virtual true, abstract: false, final false
  inline void OnDetectFocusChange();

  /// @brief Method OnSelectIndexChange, addr 0x2ce10c8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ce0fcc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::__TextEditorEngine__OnDetectFocusChangeFunction* detectFocusChange,
                    ::UnityEngine::UIElements::__TextEditorEngine__OnIndexChangeFunction* indexChangeFunction);

  /// @brief Method get_localPosition, addr 0x2ce0ff8, size 0x88, virtual true, abstract: false, final false
