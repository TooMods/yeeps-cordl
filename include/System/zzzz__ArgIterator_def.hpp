...
public:
  // Declarations
  /// @brief Method Equals, addr 0x2e7d7c4, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x2e7d814, size 0x8, virtual true, abstract: false, final false
