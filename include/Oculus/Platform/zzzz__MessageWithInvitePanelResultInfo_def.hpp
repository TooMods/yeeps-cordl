...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x19b3958, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(void* c_message);

  /// @brief Method GetInvitePanelResultInfo, addr 0x19b391c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b0d5c, size 0x58, virtual false, abstract: false, final false
