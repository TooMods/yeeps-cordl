...
public:
  ...
  /// @brief Method Decode, addr 0x282aa90, size 0x1e8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decode(::ArrayW<char16_t, ::Array<char16_t>*> chars, bool allowOddChars);

  /// @brief Method Decode, addr 0x282a76c, size 0x158, virtual true, abstract: false, final false
  inline int32_t Decode(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startPos, int32_t len);

  /// @brief Method Decode, addr 0x282a8c4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsFull, addr 0x282a75c, size 0x10, virtual true, abstract: false, final false
