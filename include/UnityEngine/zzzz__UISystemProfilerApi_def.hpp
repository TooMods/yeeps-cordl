...
public:
  ...
  /// @brief Method AddMarker, addr 0x20190cc, size 0x44, virtual false, abstract: false, final false
  static inline void AddMarker(::StringW name, ::UnityEngine::Object* obj);

  /// @brief Method BeginSample, addr 0x2019054, size 0x3c, virtual false, abstract: false, final false
  static inline void BeginSample(::UnityEngine::__UISystemProfilerApi__SampleType type);

  /// @brief Method EndSample, addr 0x2019090, size 0x3c, virtual false, abstract: false, final false
