...
public:
  // Declarations
  /// @brief Method GetAssetDetails, addr 0x19b2aec, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetails* GetAssetDetails();

  /// @brief Method GetDataFromMessage, addr 0x19b2b28, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x19b07dc, size 0x58, virtual false, abstract: false, final false
